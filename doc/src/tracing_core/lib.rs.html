...
</pre></div><pre class="rust"><code><span class="doccomment">//! Core primitives for `tracing`.
//!
...
<span class="doccomment">/// Statically constructs an [`Identifier`] for the provided [`Callsite`].
///
...
</span><span class="macro">macro_rules!</span> identify_callsite {
    (<span class="macro-nonterminal">$callsite</span>:expr) =&gt; {
        <span class="macro-nonterminal">$crate::callsite::Identifier</span>(<span class="macro-nonterminal">$callsite</span>)
    };
}

<span class="doccomment">/// Statically constructs new span [metadata].
///
/// /// For example:
/// ```rust
...
/// [`Metadata::new`]: metadata::Metadata::new
    ...
    (
        ...
        level: <span class="macro-nonterminal">$level</span>:expr,
        fields: <span class="macro-nonterminal">$fields</span>:expr,
        callsite: <span class="macro-nonterminal">$callsite</span>:expr,
        ...
        <span class="macro-nonterminal">$</span><span class="macro">crate::metadata!</span> {
            ...
            level: <span class="macro-nonterminal">$level</span>,
            fields: <span class="macro-nonterminal">$fields</span>,
            callsite: <span class="macro-nonterminal">$callsite</span>,
    ...
    (
        ...
        <span class="macro-nonterminal">$crate::metadata::Metadata::new</span>(
            <span class="macro-nonterminal">$name</span>,
            <span class="macro-nonterminal">$target</span>,
            <span class="macro-nonterminal">$level</span>,
            ::core::option::Option::Some(<span class="macro">file!</span>()),
            ::core::option::Option::Some(<span class="macro">line!</span>()),
            ::core::option::Option::Some(<span class="macro">module_path!</span>()),
            <span class="macro-nonterminal">$crate::field::FieldSet::new</span>(<span class="macro-nonterminal">$fields</span>, <span class="macro-nonterminal">$</span><span class="macro">crate::identify_callsite!</span>(<span class="macro-nonterminal">$callsite</span>)),
            <span class="macro-nonterminal">$kind</span>,
        )
    };
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>lazy;

<span class="comment">// Trimmed-down vendored version of spin 0.5.2 (0387621)
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>spin;

<span class="attr">#[cfg(not(feature = <span class="string">"std"</span>))]
#[doc(hidden)]
</span><span class="kw">pub type </span>Once = <span class="self">self</span>::spin::Once&lt;()&gt;;

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">pub use </span>stdlib::sync::Once;

<span class="kw">pub mod </span>callsite;
...
<span class="kw">pub use </span><span class="self">self</span>::{metadata::Kind, subscriber::Interest};
