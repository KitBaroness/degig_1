...
</pre></div><pre class="rust"><code><span class="doccomment">//! Collectors collect and record trace data.
</span><span class="kw">use crate</span>::{span, Dispatch, Event, LevelFilter, Metadata};
...
<span class="doccomment">/// Trait representing the functions required to collect trace data.
///
...
/// [`event_enabled`]: Subscriber::event_enabled
</span><span class="kw">pub trait </span>Subscriber: <span class="lifetime">'static </span>{
    <span class="doccomment">/// Invoked when this subscriber becomes a [`Dispatch`].
    ///
    ...
    </span><span class="kw">fn </span>on_register_dispatch(<span class="kw-2">&amp;</span><span class="self">self</span>, subscriber: <span class="kw-2">&amp;</span>Dispatch) {
        <span class="kw">let _ </span>= subscriber;
    }
    ...
    /// [cs-reg]: crate::callsite#registering-callsites
    </span><span class="kw">fn </span>register_callsite(<span class="kw-2">&amp;</span><span class="self">self</span>, metadata: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Metadata&lt;<span class="lifetime">'static</span>&gt;) -&gt; Interest {
        <span class="kw">if </span><span class="self">self</span>.enabled(metadata) {
            Interest::always()
    ...
    <span class="doccomment">/// Returns true if a span or event with the specified [metadata] would be
    /// recorded.
    ///
    ...
    /// [`register_callsite`]: Subscriber::register_callsite()
    </span><span class="kw">fn </span>enabled(<span class="kw-2">&amp;</span><span class="self">self</span>, metadata: <span class="kw-2">&amp;</span>Metadata&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool;
    ...
    <span class="doccomment">/// Visit the construction of a new span, returning a new [span ID] for the
    ...
    <span class="comment">// === Notification methods ===============================================

    </span><span class="doccomment">/// Record a set of values on a span.
    ///
    ...
    </span><span class="kw">fn </span>record(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id, values: <span class="kw-2">&amp;</span>span::Record&lt;<span class="lifetime">'_</span>&gt;);
    ...
    </span><span class="kw">fn </span>record_follows_from(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id, follows: <span class="kw-2">&amp;</span>span::Id);

    <span class="doccomment">/// Determine if an [`Event`] should be recorded.
    ///
    ...
    </span><span class="kw">fn </span>event_enabled(<span class="kw-2">&amp;</span><span class="self">self</span>, event: <span class="kw-2">&amp;</span>Event&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool {
        <span class="kw">let _ </span>= event;
    ...
    </span><span class="kw">fn </span>event(<span class="kw-2">&amp;</span><span class="self">self</span>, event: <span class="kw-2">&amp;</span>Event&lt;<span class="lifetime">'_</span>&gt;);

    <span class="doccomment">/// Records that a span has been entered.
    ///
    ...
    ///
    /// [span ID]: super::span::Id
    </span><span class="kw">fn </span>enter(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id);
    ...
    ///
    /// [span ID]: super::span::Id
    </span><span class="kw">fn </span>exit(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id);
    ...
    /// [span ID]: super::span::Id
    /// [`try_close`]: Subscriber::try_close
    </span><span class="kw">fn </span>clone_span(<span class="kw-2">&amp;</span><span class="self">self</span>, id: <span class="kw-2">&amp;</span>span::Id) -&gt; span::Id {
        id.clone()
    }

    <span class="doccomment">/// **This method is deprecated.**
    ///
    ...
    ///
    /// [`try_close`]: Subscriber::try_close
    </span><span class="attr">#[deprecated(since = <span class="string">"0.1.2"</span>, note = <span class="string">"use `Subscriber::try_close` instead"</span>)]
    </span><span class="kw">fn </span>drop_span(<span class="kw-2">&amp;</span><span class="self">self</span>, _id: span::Id) {}
    ...
    </span><span class="kw">fn </span>try_close(<span class="kw-2">&amp;</span><span class="self">self</span>, id: span::Id) -&gt; bool {
        <span class="attr">#[allow(deprecated)]
        </span><span class="self">self</span>.drop_span(id);
    ...
    </span><span class="kw">fn </span>current_span(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; span::Current {
        span::Current::unknown()
    }

    <span class="comment">// === Downcasting methods ================================================

    </span><span class="doccomment">/// If `self` is the same type as the provided `TypeId`, returns an untyped
    ...
    /// [`downcast_ref`]: #method.downcast_ref
        ...
        <span class="kw">if </span>id == TypeId::of::&lt;<span class="self">Self</span>&gt;() {
            <span class="prelude-val">Some</span>(<span class="self">self </span><span class="kw">as </span><span class="kw-2">*const </span><span class="self">Self </span><span class="kw">as </span><span class="kw-2">*const </span>())
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>}
    }
...
<span class="kw">impl dyn </span>Subscriber {
    <span class="doccomment">/// Returns `true` if this `Subscriber` is the same type as `T`.
    </span><span class="kw">pub fn </span>is&lt;T: Any&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.downcast_ref::&lt;T&gt;().is_some()
    }

    <span class="doccomment">/// Returns some reference to this `Subscriber` value if it is of type `T`,
    /// or `None` if it isn't.
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>raw = <span class="self">self</span>.downcast_raw(TypeId::of::&lt;T&gt;())<span class="question-mark">?</span>;
            <span class="kw">if </span>raw.is_null() {
                <span class="prelude-val">None
            </span>} <span class="kw">else </span>{
                <span class="prelude-val">Some</span>(<span class="kw-2">&amp;*</span>(raw <span class="kw">as </span><span class="kw-2">*const </span><span class="kw">_</span>))
            }
        }
    }
}

<span class="kw">impl dyn </span>Subscriber + Send {
    <span class="doccomment">/// Returns `true` if this [`Subscriber`] is the same type as `T`.
    </span><span class="kw">pub fn </span>is&lt;T: Any&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.downcast_ref::&lt;T&gt;().is_some()
    }
...
<span class="kw">impl dyn </span>Subscriber + Sync {
    <span class="doccomment">/// Returns `true` if this [`Subscriber`] is the same type as `T`.
    </span><span class="kw">pub fn </span>is&lt;T: Any&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.downcast_ref::&lt;T&gt;().is_some()
    }
...
<span class="kw">impl dyn </span>Subscriber + Send + Sync {
    <span class="doccomment">/// Returns `true` if this [`Subscriber`] is the same type as `T`.
    </span><span class="kw">pub fn </span>is&lt;T: Any&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.downcast_ref::&lt;T&gt;().is_some()
    }
...
<span class="doccomment">/// Indicates a [`Subscriber`]'s interest in a particular callsite.
///
...
</span><span class="kw">pub struct </span>Interest(InterestKind);

<span class="attr">#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
</span><span class="kw">enum </span>InterestKind {
    Never = <span class="number">0</span>,
    Sometimes = <span class="number">1</span>,
    Always = <span class="number">2</span>,
}

<span class="kw">impl </span>Interest {
    <span class="doccomment">/// Returns an `Interest` indicating that the subscriber is never interested
    ...
    </span><span class="kw">pub fn </span>never() -&gt; <span class="self">Self </span>{
        Interest(InterestKind::Never)
    }

    <span class="doccomment">/// Returns an `Interest` indicating the subscriber is sometimes interested
    /// in being notified about a callsite.
    ///
    ...
    </span><span class="kw">pub fn </span>sometimes() -&gt; <span class="self">Self </span>{
        Interest(InterestKind::Sometimes)
    }

    <span class="doccomment">/// Returns an `Interest` indicating the subscriber is always interested in
    ...
    </span><span class="kw">pub fn </span>always() -&gt; <span class="self">Self </span>{
        Interest(InterestKind::Always)
    }

    <span class="doccomment">/// Returns `true` if the subscriber is never interested in being notified
    /// about this callsite.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>is_never(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="macro">matches!</span>(<span class="self">self</span>.<span class="number">0</span>, InterestKind::Never)
    }

    <span class="doccomment">/// Returns `true` if the subscriber is sometimes interested in being notified
    /// about this callsite.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>is_sometimes(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="macro">matches!</span>(<span class="self">self</span>.<span class="number">0</span>, InterestKind::Sometimes)
    }

    <span class="doccomment">/// Returns `true` if the subscriber is always interested in being notified
    /// about this callsite.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>is_always(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="macro">matches!</span>(<span class="self">self</span>.<span class="number">0</span>, InterestKind::Always)
    }

    <span class="doccomment">/// Returns the common interest between these two Interests.
    ///
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>and(<span class="self">self</span>, rhs: Interest) -&gt; <span class="self">Self </span>{
        <span class="kw">if </span><span class="self">self</span>.<span class="number">0 </span>== rhs.<span class="number">0 </span>{
...
<span class="doccomment">/// A no-op [`Subscriber`].
///
...
</span><span class="kw">pub struct </span>NoSubscriber(());

<span class="kw">impl </span>Subscriber <span class="kw">for </span>NoSubscriber {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>register_callsite(<span class="kw-2">&amp;</span><span class="self">self</span>, <span class="kw">_</span>: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Metadata&lt;<span class="lifetime">'static</span>&gt;) -&gt; Interest {
        Interest::never()
    }
    ...
    <span class="kw">fn </span>new_span(<span class="kw-2">&amp;</span><span class="self">self</span>, <span class="kw">_</span>: <span class="kw-2">&amp;</span>span::Attributes&lt;<span class="lifetime">'_</span>&gt;) -&gt; span::Id {
        span::Id::from_u64(<span class="number">0xDEAD</span>)
    }

    <span class="kw">fn </span>event(<span class="kw-2">&amp;</span><span class="self">self</span>, _event: <span class="kw-2">&amp;</span>Event&lt;<span class="lifetime">'_</span>&gt;) {}

    <span class="kw">fn </span>record(<span class="kw-2">&amp;</span><span class="self">self</span>, _span: <span class="kw-2">&amp;</span>span::Id, _values: <span class="kw-2">&amp;</span>span::Record&lt;<span class="lifetime">'_</span>&gt;) {}

    <span class="kw">fn </span>record_follows_from(<span class="kw-2">&amp;</span><span class="self">self</span>, _span: <span class="kw-2">&amp;</span>span::Id, _follows: <span class="kw-2">&amp;</span>span::Id) {}

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>enabled(<span class="kw-2">&amp;</span><span class="self">self</span>, _metadata: <span class="kw-2">&amp;</span>Metadata&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool {
        <span class="bool-val">false
    </span>}

    <span class="kw">fn </span>enter(<span class="kw-2">&amp;</span><span class="self">self</span>, _span: <span class="kw-2">&amp;</span>span::Id) {}
    <span class="kw">fn </span>exit(<span class="kw-2">&amp;</span><span class="self">self</span>, _span: <span class="kw-2">&amp;</span>span::Id) {}
}

<span class="kw">impl </span>NoSubscriber {
    <span class="doccomment">/// Returns a new `NoSubscriber`.
...
<span class="kw">impl</span>&lt;S&gt; Subscriber <span class="kw">for </span>Box&lt;S&gt;
<span class="kw">where
    </span>S: Subscriber + <span class="question-mark">?</span>Sized,
{
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>register_callsite(<span class="kw-2">&amp;</span><span class="self">self</span>, metadata: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Metadata&lt;<span class="lifetime">'static</span>&gt;) -&gt; Interest {
        <span class="self">self</span>.as_ref().register_callsite(metadata)
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.as_ref().max_level_hint()
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>new_span(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Attributes&lt;<span class="lifetime">'_</span>&gt;) -&gt; span::Id {
        <span class="self">self</span>.as_ref().new_span(span)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>record(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id, values: <span class="kw-2">&amp;</span>span::Record&lt;<span class="lifetime">'_</span>&gt;) {
        <span class="self">self</span>.as_ref().record(span, values)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>record_follows_from(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id, follows: <span class="kw-2">&amp;</span>span::Id) {
        <span class="self">self</span>.as_ref().record_follows_from(span, follows)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>event_enabled(<span class="kw-2">&amp;</span><span class="self">self</span>, event: <span class="kw-2">&amp;</span>Event&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool {
        <span class="self">self</span>.as_ref().event_enabled(event)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>event(<span class="kw-2">&amp;</span><span class="self">self</span>, event: <span class="kw-2">&amp;</span>Event&lt;<span class="lifetime">'_</span>&gt;) {
        <span class="self">self</span>.as_ref().event(event)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>enter(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id) {
        <span class="self">self</span>.as_ref().enter(span)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>exit(<span class="kw-2">&amp;</span><span class="self">self</span>, span: <span class="kw-2">&amp;</span>span::Id) {
        <span class="self">self</span>.as_ref().exit(span)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>clone_span(<span class="kw-2">&amp;</span><span class="self">self</span>, id: <span class="kw-2">&amp;</span>span::Id) -&gt; span::Id {
        <span class="self">self</span>.as_ref().clone_span(id)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>try_close(<span class="kw-2">&amp;</span><span class="self">self</span>, id: span::Id) -&gt; bool {
        <span class="self">self</span>.as_ref().try_close(id)
    }

    <span class="attr">#[inline]
    #[allow(deprecated)]
    </span><span class="kw">fn </span>drop_span(<span class="kw-2">&amp;</span><span class="self">self</span>, id: span::Id) {
        <span class="self">self</span>.as_ref().try_close(id);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>current_span(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; span::Current {
        <span class="self">self</span>.as_ref().current_span()
    }

    <span class="attr">#[inline]
    </span><span class="kw">unsafe fn </span>downcast_raw(<span class="kw-2">&amp;</span><span class="self">self</span>, id: TypeId) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">*const </span>()&gt; {
        <span class="kw">if </span>id == TypeId::of::&lt;<span class="self">Self</span>&gt;() {
            <span class="kw">return </span><span class="prelude-val">Some</span>(<span class="self">self </span><span class="kw">as </span><span class="kw-2">*const </span><span class="self">Self </span><span class="kw">as </span><span class="kw-2">*const </span><span class="kw">_</span>);
        }

        <span class="self">self</span>.as_ref().downcast_raw(id)
    }
}

<span class="kw">impl</span>&lt;S&gt; Subscriber <span class="kw">for </span>Arc&lt;S&gt;
<span class="kw">where
    </span>S: Subscriber + <span class="question-mark">?</span>Sized,
{
    <span class="attr">#[inline]
