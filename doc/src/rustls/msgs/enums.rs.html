...
</pre></div><pre class="rust"><code><span class="attr">#![allow(clippy::upper_case_acronyms)]
#![allow(non_camel_case_types)]
</span><span class="doccomment">/// This file is autogenerated.  See https://github.com/ctz/tls-hacking/
...
<span class="macro">enum_builder!</span> {
    ...
    EnumVal{
        ...
        TransportParameters =&gt; <span class="number">0x0039</span>,
        ...
        TransportParametersDraft =&gt; <span class="number">0xffa5
    </span>}
}
...
<span class="kw">impl </span>ECPointFormat {
    <span class="kw">pub const </span>SUPPORTED: [<span class="self">Self</span>; <span class="number">1</span>] = [<span class="self">Self</span>::Uncompressed];
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="doccomment">//! These tests are intended to provide coverage and
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>test_enum8&lt;T: Codec&gt;(first: T, last: T) {
        <span class="kw">let </span>first_v = get8(<span class="kw-2">&amp;</span>first);
        <span class="kw">let </span>last_v = get8(<span class="kw-2">&amp;</span>last);

        <span class="kw">for </span>val <span class="kw">in </span>first_v..last_v + <span class="number">1 </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>buf = Vec::new();
            val.encode(<span class="kw-2">&amp;mut </span>buf);
            <span class="macro">assert_eq!</span>(buf.len(), <span class="number">1</span>);

            <span class="kw">let </span>t = T::read_bytes(<span class="kw-2">&amp;</span>buf).unwrap();
            <span class="macro">assert_eq!</span>(val, get8(<span class="kw-2">&amp;</span>t));
        }
    }

    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>test_enum16&lt;T: Codec&gt;(first: T, last: T) {
        <span class="kw">let </span>first_v = get16(<span class="kw-2">&amp;</span>first);
        <span class="kw">let </span>last_v = get16(<span class="kw-2">&amp;</span>last);

        <span class="kw">for </span>val <span class="kw">in </span>first_v..last_v + <span class="number">1 </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>buf = Vec::new();
            val.encode(<span class="kw-2">&amp;mut </span>buf);
            <span class="macro">assert_eq!</span>(buf.len(), <span class="number">2</span>);

            <span class="kw">let </span>t = T::read_bytes(<span class="kw-2">&amp;</span>buf).unwrap();
            <span class="macro">assert_eq!</span>(val, get16(<span class="kw-2">&amp;</span>t));
        }
    }

    <span class="kw">fn </span>get8&lt;T: Codec&gt;(enum_value: <span class="kw-2">&amp;</span>T) -&gt; u8 {
        <span class="kw">let </span>enc = enum_value.get_encoding();
        <span class="macro">assert_eq!</span>(enc.len(), <span class="number">1</span>);
        enc[<span class="number">0</span>]
    }

    <span class="kw">fn </span>get16&lt;T: Codec&gt;(enum_value: <span class="kw-2">&amp;</span>T) -&gt; u16 {
        <span class="kw">let </span>enc = enum_value.get_encoding();
        <span class="macro">assert_eq!</span>(enc.len(), <span class="number">2</span>);
        (enc[<span class="number">0</span>] <span class="kw">as </span>u16 &gt;&gt; <span class="number">8</span>) | (enc[<span class="number">1</span>] <span class="kw">as </span>u16)
    }
}
