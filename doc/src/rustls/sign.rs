...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::enums::{SignatureAlgorithm, SignatureScheme};
<span class="kw">use </span><span class="kw">crate</span>::error::Error;
<span class="kw">use </span><span class="kw">crate</span>::key;
<span class="kw">use </span><span class="kw">crate</span>::x509::{wrap_in_asn1_len, wrap_in_sequence};

<span class="kw">use </span>ring::io::der;
<span class="kw">use </span>ring::rand::{SecureRandom, SystemRandom};
<span class="kw">use </span>ring::signature::{<span class="self">self</span>, EcdsaKeyPair, Ed25519KeyPair, RsaKeyPair};
...
<span class="doccomment">/// A thing that can sign a message.
    ...
    </span><span class="kw">fn </span>scheme(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; SignatureScheme;
}
...
/// optional stapled OCSP response and/or SCT list.
    ...
    </span><span class="kw">pub </span>key: Arc&lt;<span class="kw">dyn </span>SigningKey&gt;,
...
<span class="kw">impl </span>CertifiedKey {
    ...
    </span><span class="kw">pub fn </span>new(cert: Vec&lt;key::Certificate&gt;, key: Arc&lt;<span class="kw">dyn </span>SigningKey&gt;) -&gt; <span class="self">Self </span>{
    ...
    </span><span class="kw">pub fn </span>end_entity_cert(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>key::Certificate, SignError&gt; {
        <span class="self">self</span>.cert.first().ok_or(SignError(()))
    }
}

<span class="doccomment">/// Parse `der` as any supported key encoding/type, returning
/// the first which works.
</span><span class="kw">pub fn </span>any_supported_type(der: <span class="kw-2">&amp;</span>key::PrivateKey) -&gt; <span class="prelude-ty">Result</span>&lt;Arc&lt;<span class="kw">dyn </span>SigningKey&gt;, SignError&gt; {
    <span class="kw">if let </span><span class="prelude-val">Ok</span>(rsa) = RsaSigningKey::new(der) {
        <span class="prelude-val">Ok</span>(Arc::new(rsa))
...
/// (PEM section starting with 'BEGIN PRIVATE KEY') encodings are supported.
</span><span class="kw">pub fn </span>any_ecdsa_type(der: <span class="kw-2">&amp;</span>key::PrivateKey) -&gt; <span class="prelude-ty">Result</span>&lt;Arc&lt;<span class="kw">dyn </span>SigningKey&gt;, SignError&gt; {
    <span class="kw">if let </span><span class="prelude-val">Ok</span>(ecdsa_p256) = EcdsaSigningKey::new(
        ...
        <span class="kw">return </span><span class="prelude-val">Ok</span>(Arc::new(ecdsa_p256));
    }
    ...
    <span class="kw">if let </span><span class="prelude-val">Ok</span>(ecdsa_p384) = EcdsaSigningKey::new(
        ...
        <span class="kw">return </span><span class="prelude-val">Ok</span>(Arc::new(ecdsa_p384));
    }

    <span class="prelude-val">Err</span>(SignError(()))
}

<span class="doccomment">/// Parse `der` as any EdDSA key type, returning the first which works.
</span><span class="kw">pub fn </span>any_eddsa_type(der: <span class="kw-2">&amp;</span>key::PrivateKey) -&gt; <span class="prelude-ty">Result</span>&lt;Arc&lt;<span class="kw">dyn </span>SigningKey&gt;, SignError&gt; {
    <span class="kw">if let </span><span class="prelude-val">Ok</span>(ed25519) = Ed25519SigningKey::new(der, SignatureScheme::ED25519) {
        <span class="kw">return </span><span class="prelude-val">Ok</span>(Arc::new(ed25519));
    }

    <span class="comment">// TODO: Add support for Ed448

    </span><span class="prelude-val">Err</span>(SignError(()))
}
...
<span class="kw">impl </span>RsaSigningKey {
    ...
    /// PKCS#1 or PKCS#8 format.
    </span><span class="kw">pub fn </span>new(der: <span class="kw-2">&amp;</span>key::PrivateKey) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, SignError&gt; {
        RsaKeyPair::from_der(<span class="kw-2">&amp;</span>der.<span class="number">0</span>)
            ...
            .map(|s| <span class="self">Self </span>{ key: Arc::new(s) })
            .map_err(|<span class="kw">_</span>| SignError(()))
    }
}
...
<span class="kw">impl </span>SigningKey <span class="kw">for </span>RsaSigningKey {
    <span class="kw">fn </span>choose_scheme(<span class="kw-2">&amp;</span><span class="self">self</span>, offered: <span class="kw-2">&amp;</span>[SignatureScheme]) -&gt; <span class="prelude-ty">Option</span>&lt;Box&lt;<span class="kw">dyn </span>Signer&gt;&gt; {
        ALL_RSA_SCHEMES
            ...
            .map(|scheme| RsaSigner::new(Arc::clone(<span class="kw-2">&amp;</span><span class="self">self</span>.key), <span class="kw-2">*</span>scheme))
    }
...
<span class="kw">impl </span>Signer <span class="kw">for </span>RsaSigner {
    <span class="kw">fn </span>sign(<span class="kw-2">&amp;</span><span class="self">self</span>, message: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;u8&gt;, Error&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>sig = <span class="macro">vec!</span>[<span class="number">0</span>; <span class="self">self</span>.key.public().modulus_len()];
        ...
        <span class="self">self</span>.key
            ...
            .map_err(|<span class="kw">_</span>| Error::General(<span class="string">"signing failed"</span>.to_string()))
    }

    <span class="kw">fn </span>scheme(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; SignatureScheme {
...
<span class="kw">impl </span>EcdsaSigningKey {
    <span class="doccomment">/// Make a new `ECDSASigningKey` from a DER encoding in PKCS#8 or SEC1
    ...
    /// scheme.
        ...
        <span class="kw">let </span>rng = SystemRandom::new();
        EcdsaKeyPair::from_pkcs8(sigalg, <span class="kw-2">&amp;</span>der.<span class="number">0</span>, <span class="kw-2">&amp;</span>rng)
            .map_err(|<span class="kw">_</span>| ())
            .or_else(|<span class="kw">_</span>| <span class="self">Self</span>::convert_sec1_to_pkcs8(scheme, sigalg, <span class="kw-2">&amp;</span>der.<span class="number">0</span>, <span class="kw-2">&amp;</span>rng))
            .map(|kp| <span class="self">Self </span>{
                key: Arc::new(kp),
                scheme,
            })
    }

    <span class="doccomment">/// Convert a SEC1 encoding to PKCS8, and ask ring to parse it.  This
    /// can be removed once https://github.com/briansmith/ring/pull/1456
    /// (or equivalent) is landed.
    </span><span class="kw">fn </span>convert_sec1_to_pkcs8(
        scheme: SignatureScheme,
        sigalg: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>signature::EcdsaSigningAlgorithm,
        maybe_sec1_der: <span class="kw-2">&amp;</span>[u8],
        rng: <span class="kw-2">&amp;</span><span class="kw">dyn </span>SecureRandom,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;EcdsaKeyPair, ()&gt; {
        <span class="kw">let </span>pkcs8_prefix = <span class="kw">match </span>scheme {
            SignatureScheme::ECDSA_NISTP256_SHA256 =&gt; <span class="kw-2">&amp;</span>PKCS8_PREFIX_ECDSA_NISTP256,
            SignatureScheme::ECDSA_NISTP384_SHA384 =&gt; <span class="kw-2">&amp;</span>PKCS8_PREFIX_ECDSA_NISTP384,
            <span class="kw">_ </span>=&gt; <span class="macro">unreachable!</span>(), <span class="comment">// all callers are in this file
        </span>};

        <span class="comment">// wrap sec1 encoding in an OCTET STRING
        </span><span class="kw">let </span><span class="kw-2">mut </span>sec1_wrap = Vec::with_capacity(maybe_sec1_der.len() + <span class="number">8</span>);
        sec1_wrap.extend_from_slice(maybe_sec1_der);
        wrap_in_asn1_len(<span class="kw-2">&amp;mut </span>sec1_wrap);
        sec1_wrap.insert(<span class="number">0</span>, der::Tag::OctetString <span class="kw">as </span>u8);

        <span class="kw">let </span><span class="kw-2">mut </span>pkcs8 = Vec::with_capacity(pkcs8_prefix.len() + sec1_wrap.len() + <span class="number">4</span>);
        pkcs8.extend_from_slice(pkcs8_prefix);
        pkcs8.extend_from_slice(<span class="kw-2">&amp;</span>sec1_wrap);
        wrap_in_sequence(<span class="kw-2">&amp;mut </span>pkcs8);

        EcdsaKeyPair::from_pkcs8(sigalg, <span class="kw-2">&amp;</span>pkcs8, rng).map_err(|<span class="kw">_</span>| ())
    }
}

<span class="comment">// This is (line-by-line):
// - INTEGER Version = 0
// - SEQUENCE (privateKeyAlgorithm)
//   - id-ecPublicKey OID
//   - prime256v1 OID
</span><span class="kw">const </span>PKCS8_PREFIX_ECDSA_NISTP256: <span class="kw-2">&amp;</span>[u8] = <span class="string">b"\x02\x01\x00\
      \x30\x13\
      \x06\x07\x2a\x86\x48\xce\x3d\x02\x01\
      \x06\x08\x2a\x86\x48\xce\x3d\x03\x01\x07"</span>;
...
//   - id-ecPublicKey OID
//   - secp384r1 OID
</span><span class="kw">const </span>PKCS8_PREFIX_ECDSA_NISTP384: <span class="kw-2">&amp;</span>[u8] = <span class="string">b"\x02\x01\x00\
     \x30\x10\
     \x06\x07\x2a\x86\x48\xce\x3d\x02\x01\
     \x06\x05\x2b\x81\x04\x00\x22"</span>;
    ...
    <span class="kw">fn </span>choose_scheme(<span class="kw-2">&amp;</span><span class="self">self</span>, offered: <span class="kw-2">&amp;</span>[SignatureScheme]) -&gt; <span class="prelude-ty">Option</span>&lt;Box&lt;<span class="kw">dyn </span>Signer&gt;&gt; {
        <span class="kw">if </span>offered.contains(<span class="kw-2">&amp;</span><span class="self">self</span>.scheme) {
            <span class="prelude-val">Some</span>(Box::new(EcdsaSigner {
                key: Arc::clone(<span class="kw-2">&amp;</span><span class="self">self</span>.key),
...
<span class="kw">impl </span>Signer <span class="kw">for </span>EcdsaSigner {
    <span class="kw">fn </span>sign(<span class="kw-2">&amp;</span><span class="self">self</span>, message: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;u8&gt;, Error&gt; {
        ...
        <span class="self">self</span>.key
            ...
            .map_err(|<span class="kw">_</span>| Error::General(<span class="string">"signing failed"</span>.into()))
...
<span class="kw">impl </span>Ed25519SigningKey {
    ...
    </span><span class="kw">fn </span>new(der: <span class="kw-2">&amp;</span>key::PrivateKey, scheme: SignatureScheme) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, SignError&gt; {
...
<span class="doccomment">/// Errors while signing
</span><span class="attr">#[derive(Debug)]
</span><span class="kw">pub struct </span>SignError(());

<span class="kw">impl </span>fmt::Display <span class="kw">for </span>SignError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        f.write_str(<span class="string">"sign error"</span>)
    }
}

<span class="kw">impl </span>StdError <span class="kw">for </span>SignError {}

<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_ecdsa_nistp256_pkcs8() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/nistp256key.pkcs8.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
}

<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_ecdsa_nistp256_sec1() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/nistp256key.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
}
...
<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_ecdsa_nistp384_pkcs8() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/nistp384key.pkcs8.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
}
...
<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_ecdsa_nistp384_sec1() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/nistp384key.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
}
...
<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_eddsa_pkcs8() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/eddsakey.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_err());
}

<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_rsa2048_pkcs8() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/rsa2048key.pkcs8.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_err());
}
...
<span class="attr">#[test]
</span><span class="kw">fn </span>can_load_rsa2048_pkcs1() {
    <span class="kw">let </span>key = key::PrivateKey(<span class="macro">include_bytes!</span>(<span class="string">"testdata/rsa2048key.pkcs1.der"</span>).to_vec());
    <span class="macro">assert!</span>(any_supported_type(<span class="kw-2">&amp;</span>key).is_ok());
    <span class="macro">assert!</span>(any_eddsa_type(<span class="kw-2">&amp;</span>key).is_err());
    <span class="macro">assert!</span>(any_ecdsa_type(<span class="kw-2">&amp;</span>key).is_err());
}
