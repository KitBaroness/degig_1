...
<span class="doccomment">/// This type contains a private key by value.
///
...
</span><span class="kw">pub struct </span>PrivateKey(<span class="kw">pub </span>Vec&lt;u8&gt;);

<span class="doccomment">/// This type contains a single certificate by value.
///
...
/// }
/// ```
</span><span class="attr">#[derive(Clone, Eq, Hash, Ord, PartialEq, PartialOrd)]
</span><span class="kw">pub struct </span>Certificate(<span class="kw">pub </span>Vec&lt;u8&gt;);
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Certificate {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        <span class="kw">use </span><span class="kw">super</span>::bs_debug::BsDebug;
        f.debug_tuple(<span class="string">"Certificate"</span>)
            .field(<span class="kw-2">&amp;</span>BsDebug(<span class="kw-2">&amp;</span><span class="self">self</span>.<span class="number">0</span>))
            .finish()
    }
}

<span class="doccomment">/// wrapper around internal representation of a parsed certificate. This is used in order to avoid parsing twice when specifying custom verification
...
</span><span class="kw">pub struct </span>ParsedCertificate&lt;<span class="lifetime">'a</span>&gt;(<span class="kw">pub</span>(<span class="kw">crate</span>) webpki::EndEntityCert&lt;<span class="lifetime">'a</span>&gt;);

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>Certificate&gt; <span class="kw">for </span>ParsedCertificate&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">type </span>Error = Error;
    <span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Certificate) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        webpki::EndEntityCert::try_from(value.<span class="number">0</span>.as_ref())
            .map_err(<span class="kw">crate</span>::verify::pki_error)
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span><span class="kw">super</span>::Certificate;

    <span class="attr">#[test]
    </span><span class="kw">fn </span>certificate_debug() {
        <span class="macro">assert_eq!</span>(
            <span class="string">"Certificate(b\"ab\")"</span>,
            <span class="macro">format!</span>(<span class="string">"{:?}"</span>, Certificate(<span class="string">b"ab"</span>.to_vec()))
        );
    }
}
