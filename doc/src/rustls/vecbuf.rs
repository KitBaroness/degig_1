...
<span class="kw">impl </span>ChunkVecBuffer {
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_full(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.limit
            .map(|limit| <span class="self">self</span>.len() &gt; limit)
            .unwrap_or_default()
    }
    ...
    </span><span class="doccomment">/// Read data out of this object, writing it into `cursor`.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>read_buf(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>cursor: core::io::BorrowedCursor&lt;<span class="lifetime">'_</span>&gt;) -&gt; io::Result&lt;()&gt; {
        <span class="kw">while </span>!<span class="self">self</span>.is_empty() &amp;&amp; cursor.capacity() &gt; <span class="number">0 </span>{
            <span class="kw">let </span>chunk = <span class="self">self</span>.chunks[<span class="number">0</span>].as_slice();
            <span class="kw">let </span>used = cmp::min(chunk.len(), cursor.capacity());
            cursor.append(<span class="kw-2">&amp;</span>chunk[..used]);
            <span class="self">self</span>.consume(used);
        }
...
<span class="attr">#[cfg(test)]
    ...
    #[test]
        ...
        <span class="kw">use </span>core::io::BorrowedBuf;
