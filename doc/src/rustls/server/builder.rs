...
<span class="kw">impl </span>ConfigBuilder&lt;ServerConfig, WantsVerifier&gt; {
    ...
    <span class="doccomment">/// Disable client authentication.
        ...
        <span class="self">self</span>.with_client_cert_verifier(verify::NoClientAuth::boxed())
    }
}
