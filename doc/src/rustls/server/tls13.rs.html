...
</span><span class="kw">use </span><span class="kw">crate</span>::check::inappropriate_message;
<span class="attr">#[cfg(feature = <span class="string">"quic"</span>)]
...
<span class="kw">use </span><span class="kw">crate</span>::msgs::handshake::{NewSessionTicketExtension, NewSessionTicketPayloadTLS13};
...
<span class="kw">use </span><span class="kw">crate</span>::server::ServerConfig;
<span class="attr">#[cfg(feature = <span class="string">"secret_extraction"</span>)]
</span><span class="kw">use </span><span class="kw">crate</span>::suites::PartiallyExtractedSecrets;
<span class="kw">use </span><span class="kw">crate</span>::ticketer;
<span class="kw">use </span><span class="kw">crate</span>::tls13::key_schedule::{KeyScheduleTraffic, KeyScheduleTrafficWithClientFinishedPending};
...
<span class="kw">use </span><span class="kw">super</span>::hs::{<span class="self">self</span>, HandshakeHashOrBuffer, ServerContext};
...
<span class="kw">mod </span>client_hello {
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">enum </span>EarlyDataDecision {
        Disabled,
    ...
    <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) <span class="kw">struct </span>CompleteClientHelloHandling {
        ...
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) suite: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Tls13CipherSuite,
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) randoms: ConnectionRandoms,
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) done_retry: bool,
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) send_tickets: usize,
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) extra_exts: Vec&lt;ServerExtension&gt;,
    }

    <span class="kw">fn </span>max_early_data_size(configured: u32) -&gt; usize {
        <span class="kw">if </span>configured != <span class="number">0 </span>{
            configured <span class="kw">as </span>usize
        } <span class="kw">else </span>{
            <span class="comment">// The relevant max_early_data_size may in fact be unknowable: if
    ...
    <span class="kw">impl </span>CompleteClientHelloHandling {
        <span class="kw">fn </span>check_binder(
            ...
            <span class="kw">let </span>binder_plaintext = <span class="kw">match </span><span class="kw-2">&amp;</span>client_hello.payload {
            ...
            <span class="kw">let </span>handshake_hash = <span class="self">self
                ...
                .get_hash_given(<span class="kw-2">&amp;</span>binder_plaintext);

            <span class="kw">let </span>key_schedule = KeyScheduleEarly::new(suite, psk);
        ...
        <span class="kw">fn </span>attempt_tls13_ticket_decryption(
            ...
            <span class="kw">if </span><span class="self">self</span>.config.ticketer.enabled() {
                <span class="self">self</span>.config
                    .ticketer
                    .decrypt(ticket)
                    .and_then(|plain| persist::ServerSessionValue::read_bytes(<span class="kw-2">&amp;</span>plain).ok())
            } <span class="kw">else </span>{
                <span class="self">self</span>.config
                    .session_storage
                    .take(ticket)
        ...
        <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::server) <span class="kw">fn </span>handle_client_hello(
            ...
            <span class="kw-2">mut </span>sigschemes_ext: Vec&lt;SignatureScheme&gt;,
        ) -&gt; hs::NextStateOrError {
            ...
            <span class="kw">let </span>early_data_requested = client_hello.early_data_extension_offered();

            <span class="comment">// EarlyData extension is illegal in second ClientHello
            </span><span class="kw">if </span><span class="self">self</span>.done_retry &amp;&amp; early_data_requested {
            ...
            <span class="comment">// choose a share that we support
            </span><span class="kw">let </span>chosen_share = <span class="self">self
                </span>.config
                .kx_groups
                .iter()
                .find_map(|group| {
            ...
            <span class="kw">let </span>chosen_share = <span class="kw">match </span>chosen_share {
                ...
                <span class="prelude-val">None </span>=&gt; {
                    ...
                    </span><span class="kw">let </span>retry_group_maybe = <span class="self">self
                        </span>.config
                        .kx_groups
                        .iter()
                        .find(|group| groups_ext.contains(<span class="kw-2">&amp;</span>group.name))
                        .cloned();

                    <span class="self">self</span>.transcript.add_message(chm);
                    ...
                    <span class="kw">if let </span><span class="prelude-val">Some</span>(group) = retry_group_maybe {
                        ...
                        <span class="kw">let </span>skip_early_data = max_early_data_size(<span class="self">self</span>.config.max_early_data_size);

                        <span class="kw">let </span>next = Box::new(hs::ExpectClientHello {
                            config: <span class="self">self</span>.config,
                            transcript: HandshakeHashOrBuffer::Hash(<span class="self">self</span>.transcript),
                        ...
                        <span class="kw">return if </span>early_data_requested {
                            <span class="prelude-val">Ok</span>(Box::new(ExpectAndSkipRejectedEarlyData {
            ...
            <span class="kw">if let </span><span class="prelude-val">Some</span>(psk_offer) = client_hello.get_psk() {
                ...
                <span class="comment">// "A client MUST provide a "psk_key_exchange_modes" extension if it
                //  offers a "pre_shared_key" extension. If clients offer
                //  "pre_shared_key" without a "psk_key_exchange_modes" extension,
                //  servers MUST abort the handshake." - RFC8446 4.2.9
                </span><span class="kw">if </span>client_hello.get_psk_modes().is_none() {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(cx.common.send_fatal_alert(
                ...
                <span class="kw">for </span>(i, psk_id) <span class="kw">in </span>psk_offer.identities.iter().enumerate() {
                    <span class="kw">let </span>resume = <span class="kw">match </span><span class="self">self
                        </span>.attempt_tls13_ticket_decryption(<span class="kw-2">&amp;</span>psk_id.identity.<span class="number">0</span>)
                        .map(|resumedata| {
                            resumedata.set_freshness(psk_id.obfuscated_ticket_age, time_now)
                        })
                        .filter(|resumedata| {
                            hs::can_resume(<span class="self">self</span>.suite.into(), <span class="kw-2">&amp;</span>cx.data.sni, <span class="bool-val">false</span>, resumedata)
                        }) {
                        <span class="prelude-val">Some</span>(resume) =&gt; resume,
                        <span class="prelude-val">None </span>=&gt; <span class="kw">continue</span>,
                    };

                    <span class="kw">if </span>!<span class="self">self</span>.check_binder(
                        <span class="self">self</span>.suite,
                        chm,
                        <span class="kw-2">&amp;</span>resume.master_secret.<span class="number">0</span>,
            ...
            <span class="kw">if </span>!client_hello.psk_mode_offered(PSKKeyExchangeMode::PSK_DHE_KE) {
                ...
                <span class="self">self</span>.send_tickets = <span class="number">0</span>;
                chosen_psk_index = <span class="prelude-val">None</span>;
                resumedata = <span class="prelude-val">None</span>;
            } <span class="kw">else </span>{
                <span class="self">self</span>.send_tickets = <span class="self">self</span>.config.send_tls13_tickets;
            }

            <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>resume) = resumedata {
                cx.data.received_resumption_data = <span class="prelude-val">Some</span>(resume.application_data.<span class="number">0</span>.clone());
                cx.common
                    .peer_certificates
                    .clone_from(<span class="kw-2">&amp;</span>resume.client_cert_chain);
            }

            <span class="kw">let </span>full_handshake = resumedata.is_none();
            <span class="self">self</span>.transcript.add_message(chm);
            <span class="kw">let </span>key_schedule = emit_server_hello(
                <span class="kw-2">&amp;mut </span><span class="self">self</span>.transcript,
            ...
            <span class="kw">let </span>doing_early_data = emit_encrypted_extensions(
                <span class="kw-2">&amp;mut </span><span class="self">self</span>.transcript,
                <span class="self">self</span>.suite,
                cx,
            ...
            <span class="kw">let </span>doing_client_auth = <span class="kw">if </span>full_handshake {
                <span class="kw">let </span>client_auth =
                    emit_certificate_req_tls13(<span class="kw-2">&amp;mut </span><span class="self">self</span>.transcript, cx, <span class="kw-2">&amp;</span><span class="self">self</span>.config)<span class="question-mark">?</span>;
                ...
                emit_certificate_verify_tls13(
                    ...
                    cx.common,
                    server_key.get_key(),
                    <span class="kw-2">&amp;</span>sigschemes_ext,
                )<span class="question-mark">?</span>;
                client_auth
            } <span class="kw">else </span>{
            ...
            <span class="comment">// If we're not doing early data, then the next messages we receive
            // are encrypted with the handshake keys.
            </span><span class="kw">match </span>doing_early_data {
                EarlyDataDecision::Disabled =&gt; {
                    key_schedule.set_handshake_decrypter(<span class="prelude-val">None</span>, cx.common);
                    cx.data.early_data.reject();
                }
                EarlyDataDecision::RequestedButRejected =&gt; {
                    <span class="macro">debug!</span>(<span class="string">"Client requested early_data, but not accepted: switching to handshake keys with trial decryption"</span>);
                    key_schedule.set_handshake_decrypter(
                        <span class="prelude-val">Some</span>(max_early_data_size(<span class="self">self</span>.config.max_early_data_size)),
                        cx.common,
                    );
                    cx.data.early_data.reject();
                }
                EarlyDataDecision::Accepted =&gt; {
                    cx.data
                        .early_data
                        .accept(<span class="self">self</span>.config.max_early_data_size <span class="kw">as </span>usize);
                }
            }

            cx.common.check_aligned_handshake()<span class="question-mark">?</span>;
            <span class="kw">let </span>key_schedule_traffic = emit_finished_tls13(
                <span class="kw-2">&amp;mut </span><span class="self">self</span>.transcript,
                <span class="kw-2">&amp;</span><span class="self">self</span>.randoms,
                cx,
                key_schedule,
            ...
            <span class="kw">if </span>!doing_client_auth &amp;&amp; <span class="self">self</span>.config.send_half_rtt_data {
                <span class="comment">// Application data can be sent immediately after Finished, in one
                // flight.  However, if client auth is enabled, we don't want to send
                // application data to an unauthenticated peer.
                </span>cx.common.start_outgoing_traffic();
            }
            ...
            } <span class="kw">else if </span>doing_early_data == EarlyDataDecision::Accepted &amp;&amp; !cx.common.is_quic() {
                <span class="comment">// Not used for QUIC: RFC 9001 §8.3: Clients MUST NOT send the EndOfEarlyData
                // message. A server MUST treat receipt of a CRYPTO frame in a 0-RTT packet as a
                // connection error of type PROTOCOL_VIOLATION.
                </span><span class="prelude-val">Ok</span>(Box::new(ExpectEarlyData {
                    config: <span class="self">self</span>.config,
                    transcript: <span class="self">self</span>.transcript,
                    suite: <span class="self">self</span>.suite,
                    key_schedule: key_schedule_traffic,
    ...
    <span class="kw">fn </span>emit_server_hello(
    ...
    ) -&gt; <span class="prelude-ty">Result</span>&lt;KeyScheduleHandshake, Error&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>extensions = Vec::new();

        <span class="comment">// Prepare key exchange
        </span><span class="kw">let </span>kx = kx::KeyExchange::choose(share.group, <span class="kw-2">&amp;</span>config.kx_groups)
            .and_then(kx::KeyExchange::start)
            .ok_or(Error::FailedToGetRandomBytes)<span class="question-mark">?</span>;

        <span class="kw">let </span>kse = KeyShareEntry::new(share.group, kx.pubkey.as_ref());
        ...
        <span class="kw">let </span>client_hello_hash = transcript.get_hash_given(<span class="kw-2">&amp;</span>[]);
        ...
        </span><span class="kw">let </span>key_schedule_pre_handshake = <span class="kw">if let </span><span class="prelude-val">Some</span>(psk) = resuming_psk {
            <span class="kw">let </span>early_key_schedule = KeyScheduleEarly::new(suite, psk);
        ...
        </span><span class="kw">let </span>key_schedule = kx.complete(<span class="kw-2">&amp;</span>share.payload.<span class="number">0</span>, |secret| {
            key_schedule_pre_handshake.into_handshake(secret)
        })<span class="question-mark">?</span>;

        <span class="kw">let </span>handshake_hash = transcript.get_current_hash();
        <span class="kw">let </span>key_schedule = key_schedule.derive_server_handshake_secrets(
            handshake_hash,
            <span class="kw-2">&amp;*</span>config.key_log,
            <span class="kw-2">&amp;</span>randoms.client,
            cx.common,
    ...
    <span class="kw">fn </span>emit_fake_ccs(common: <span class="kw-2">&amp;mut </span>CommonState) {
    ...
    <span class="kw">fn </span>emit_hello_retry_request(
        transcript: <span class="kw-2">&amp;mut </span>HandshakeHash,
        suite: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Tls13CipherSuite,
    ...
    <span class="attr">#[cfg_attr(not(feature = <span class="string">"quic"</span>), allow(clippy::needless_pass_by_ref_mut))]
    </span><span class="kw">fn </span>decide_if_early_data_allowed(
        cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;,
        client_hello: <span class="kw-2">&amp;</span>ClientHelloPayload,
        ...
        <span class="kw">let </span>early_data_requested = client_hello.early_data_extension_offered();
        <span class="kw">let </span>rejected_or_disabled = <span class="kw">match </span>early_data_requested {
            <span class="bool-val">true </span>=&gt; EarlyDataDecision::RequestedButRejected,
            <span class="bool-val">false </span>=&gt; EarlyDataDecision::Disabled,
        };

        <span class="kw">let </span>resume = <span class="kw">match </span>resumedata {
            <span class="prelude-val">Some</span>(resume) =&gt; resume,
            <span class="prelude-val">None </span>=&gt; {
                <span class="comment">// never any early data if not resuming.
                </span><span class="kw">return </span>rejected_or_disabled;
            }
        };

        <span class="comment">/* Non-zero max_early_data_size controls whether early_data is allowed at all.
         * We also require stateful resumption. */
        </span><span class="kw">let </span>early_data_configured = config.max_early_data_size &gt; <span class="number">0 </span>&amp;&amp; !config.ticketer.enabled();

        <span class="comment">/* "For PSKs provisioned via NewSessionTicket, a server MUST validate
         ...
         *
         * (RFC8446, 4.2.10) */
        </span><span class="kw">let </span>early_data_possible = early_data_requested
            &amp;&amp; resume.is_fresh()
            &amp;&amp; <span class="prelude-val">Some</span>(resume.version) == cx.common.negotiated_version
            &amp;&amp; resume.cipher_suite == suite.common.suite
            &amp;&amp; resume.alpn.as_ref().map(|x| <span class="kw-2">&amp;</span>x.<span class="number">0</span>) == cx.common.alpn_protocol.as_ref();

        <span class="kw">if </span>early_data_configured &amp;&amp; early_data_possible &amp;&amp; !cx.data.early_data.was_rejected() {
            EarlyDataDecision::Accepted
        } <span class="kw">else </span>{
            <span class="attr">#[cfg(feature = <span class="string">"quic"</span>)]
            </span><span class="kw">if </span>cx.common.is_quic() {
                <span class="comment">// Clobber value set in tls13::emit_server_hello
                </span>cx.common.quic.early_secret = <span class="prelude-val">None</span>;
            }
    ...
    <span class="kw">fn </span>emit_encrypted_extensions(
        ...
        config: <span class="kw-2">&amp;</span>ServerConfig,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;EarlyDataDecision, Error&gt; {
        ...
        <span class="kw">let </span>early_data = decide_if_early_data_allowed(cx, hello, resumedata, suite, config);
        <span class="kw">if </span>early_data == EarlyDataDecision::Accepted {
        ...
        transcript.add_message(<span class="kw-2">&amp;</span>ee);
        cx.common.send_msg(ee, <span class="bool-val">true</span>);
        <span class="prelude-val">Ok</span>(early_data)
    }
    ...
    <span class="kw">fn </span>emit_certificate_req_tls13(
        ...
        <span class="kw">let </span>schemes = config
            .verifier
        ...
        transcript.add_message(<span class="kw-2">&amp;</span>m);
        cx.common.send_msg(m, <span class="bool-val">true</span>);
    ...
    <span class="kw">fn </span>emit_certificate_tls13(
        ...
        ocsp_response: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>[u8]&gt;,
        sct_list: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>[u8]&gt;,
    ) {
        <span class="kw">let </span><span class="kw-2">mut </span>cert_entries = <span class="macro">vec!</span>[];
        <span class="kw">for </span>cert <span class="kw">in </span>cert_chain {
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(end_entity_cert) = cert_entries.first_mut() {
            ...
            </span><span class="kw">if let </span><span class="prelude-val">Some</span>(ocsp) = ocsp_response {
                <span class="kw">let </span>cst = CertificateStatus::new(ocsp.to_owned());
                end_entity_cert
                    .exts
            ...
            </span><span class="kw">if let </span><span class="prelude-val">Some</span>(sct_list) = sct_list {
                end_entity_cert
                    .exts
        ...
        common.send_msg(c, <span class="bool-val">true</span>);
    }
    ...
    <span class="kw">fn </span>emit_certificate_verify_tls13(
        ...
        <span class="kw">let </span>message = verify::construct_tls13_server_verify_message(<span class="kw-2">&amp;</span>transcript.get_current_hash());
    ...
    <span class="kw">fn </span>emit_finished_tls13(
        ...
        transcript.add_message(<span class="kw-2">&amp;</span>m);
        <span class="kw">let </span>hash_at_server_fin = transcript.get_current_hash();
        cx.common.send_msg(m, <span class="bool-val">true</span>);
        ...
        </span>key_schedule.into_traffic_with_client_finished_pending(
            hash_at_server_fin,
            <span class="kw-2">&amp;*</span>config.key_log,
            <span class="kw-2">&amp;</span>randoms.client,
            cx.common,
...
<span class="kw">struct </span>ExpectAndSkipRejectedEarlyData {
    skip_data_left: usize,
    next: Box&lt;hs::ExpectClientHello&gt;,
}

<span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectAndSkipRejectedEarlyData {
    <span class="kw">fn </span>handle(<span class="kw-2">mut </span><span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;, m: Message) -&gt; hs::NextStateOrError {
        <span class="comment">/* "The server then ignores early data by skipping all records with an external
         *  content type of "application_data" (indicating that they are encrypted),
         *  up to the configured max_early_data_size."
         * (RFC8446, 14.2.10) */
        </span><span class="kw">if let </span>MessagePayload::ApplicationData(<span class="kw-2">ref </span>skip_data) = m.payload {
            <span class="kw">if </span>skip_data.<span class="number">0</span>.len() &lt;= <span class="self">self</span>.skip_data_left {
                <span class="self">self</span>.skip_data_left -= skip_data.<span class="number">0</span>.len();
                <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="self">self</span>);
            }
        }

        <span class="self">self</span>.next.handle(cx, m)
    }
}
...
<span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectCertificate {
    <span class="kw">fn </span>handle(<span class="kw-2">mut </span><span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;, m: Message) -&gt; hs::NextStateOrError {
        ...
        // here are illegal.
            ...
            <span class="kw">return </span><span class="prelude-val">Err</span>(PeerMisbehaved::UnsolicitedCertExtension.into());
        }

        <span class="kw">let </span>client_cert = certp.convert();

        <span class="kw">let </span>mandatory = <span class="self">self
            </span>.config
            .verifier
            .client_auth_mandatory();

        <span class="kw">let </span>(end_entity, intermediates) = <span class="kw">match </span>client_cert.split_first() {
            <span class="prelude-val">None </span>=&gt; {
                <span class="kw">if </span>!mandatory {
                    ...
                    <span class="kw">return </span><span class="prelude-val">Ok</span>(Box::new(ExpectFinished {
                        config: <span class="self">self</span>.config,
                        suite: <span class="self">self</span>.suite,
            ...
            <span class="prelude-val">Some</span>(chain) =&gt; chain,
        };
...
<span class="kw">struct </span>ExpectCertificateVerify {
    config: Arc&lt;ServerConfig&gt;,
    transcript: HandshakeHash,
    suite: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Tls13CipherSuite,
    key_schedule: KeyScheduleTrafficWithClientFinishedPending,
...
<span class="comment">// --- Process (any number of) early ApplicationData messages,
//     followed by a terminating handshake EndOfEarlyData message ---

</span><span class="kw">struct </span>ExpectEarlyData {
    config: Arc&lt;ServerConfig&gt;,
    transcript: HandshakeHash,
    suite: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Tls13CipherSuite,
    key_schedule: KeyScheduleTrafficWithClientFinishedPending,
...
<span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectEarlyData {
    <span class="kw">fn </span>handle(<span class="kw-2">mut </span><span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;, m: Message) -&gt; hs::NextStateOrError {
        <span class="kw">match </span>m.payload {
            MessagePayload::ApplicationData(payload) =&gt; {
                <span class="kw">match </span>cx
                    .data
                    .early_data
                    .take_received_plaintext(payload)
                {
                    <span class="bool-val">true </span>=&gt; <span class="prelude-val">Ok</span>(<span class="self">self</span>),
                    <span class="bool-val">false </span>=&gt; <span class="prelude-val">Err</span>(cx.common.send_fatal_alert(
            ...
            payload =&gt; <span class="prelude-val">Err</span>(inappropriate_handshake_message(
                ...
                <span class="kw-2">&amp;</span>[HandshakeType::EndOfEarlyData],
            )),
        }
    }
}
...
<span class="comment">// --- Process client's Finished ---
    ...
    transcript: <span class="kw-2">&amp;</span>HandshakeHash,
    suite: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>Tls13CipherSuite,
...
<span class="kw">impl </span>ExpectFinished {
    <span class="kw">fn </span>emit_ticket(
        ...
        <span class="kw">let </span>nonce = rand::random_vec(<span class="number">32</span>)<span class="question-mark">?</span>;
        <span class="kw">let </span>now = ticketer::TimeBase::now()<span class="question-mark">?</span>;
        <span class="kw">let </span>age_add = rand::random_u32()<span class="question-mark">?</span>;
        <span class="kw">let </span>plain =
            get_server_session_value(transcript, suite, key_schedule, cx, <span class="kw-2">&amp;</span>nonce, now, age_add)
                .get_encoding();

        <span class="kw">let </span>stateless = config.ticketer.enabled();
        <span class="kw">let </span>(ticket, lifetime) = <span class="kw">if </span>stateless {
            <span class="kw">let </span>ticket = <span class="kw">match </span>config.ticketer.encrypt(<span class="kw-2">&amp;</span>plain) {
            ...
            <span class="kw">let </span>id = rand::random_vec(<span class="number">32</span>)<span class="question-mark">?</span>;
            <span class="kw">let </span>stored = config
                .session_storage
                .put(id.clone(), plain);
            ...
            </span>(id, stateful_lifetime)
        };

        <span class="kw">let </span><span class="kw-2">mut </span>payload = NewSessionTicketPayloadTLS13::new(lifetime, age_add, nonce, ticket);

        <span class="kw">if </span>config.max_early_data_size &gt; <span class="number">0 </span>{
            <span class="kw">if </span>!stateless {
                payload
                    .exts
                ...
                <span class="comment">// We implement RFC8446 section 8.1: by enforcing that 0-RTT is
                // only possible if using stateful resumption
                </span><span class="macro">warn!</span>(<span class="string">"early_data with stateless resumption is not allowed"</span>);
            }
        }
        ...
        <span class="macro">trace!</span>(<span class="string">"sending new ticket {:?} (stateless: {})"</span>, m, stateless);
        cx.common.send_msg(m, <span class="bool-val">true</span>);
        <span class="prelude-val">Ok</span>(())
    }
}
...
<span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectFinished {
    <span class="kw">fn </span>handle(<span class="kw-2">mut </span><span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;, m: Message) -&gt; hs::NextStateOrError {
        ...
        <span class="kw">let </span>handshake_hash = <span class="self">self</span>.transcript.get_current_hash();
        <span class="kw">let </span>(key_schedule_traffic, expect_verify_data) = <span class="self">self
            </span>.key_schedule
            .sign_client_finish(<span class="kw-2">&amp;</span>handshake_hash, cx.common);
        ...
        <span class="kw">for _ in </span><span class="number">0</span>..<span class="self">self</span>.send_tickets {
            <span class="self">Self</span>::emit_ticket(
                <span class="kw-2">&amp;</span><span class="self">self</span>.transcript,
                <span class="self">self</span>.suite,
                cx,
                <span class="kw-2">&amp;</span>key_schedule_traffic,
                <span class="kw-2">&amp;</span><span class="self">self</span>.config,
            )<span class="question-mark">?</span>;
        }

        <span class="comment">// Application data may now flow, even if we have client auth enabled.
        </span>cx.common.start_traffic();

        <span class="attr">#[cfg(feature = <span class="string">"quic"</span>)]
        </span>{
            <span class="kw">if </span>cx.common.protocol == Protocol::Quic {
...
<span class="kw">impl </span>ExpectTraffic {
    <span class="kw">fn </span>handle_key_update(
        ...
        common.check_aligned_handshake()<span class="question-mark">?</span>;
...
<span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectTraffic {
    <span class="kw">fn </span>handle(<span class="kw-2">mut </span><span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>ServerContext, m: Message) -&gt; hs::NextStateOrError {
        <span class="kw">match </span>m.payload {
            ...
            MessagePayload::Handshake {
                ...
                ..
            } =&gt; <span class="self">self</span>.handle_key_update(cx.common, <span class="kw-2">&amp;</span>key_update)<span class="question-mark">?</span>,
            payload =&gt; {
...
<span class="attr">#[cfg(feature = <span class="string">"quic"</span>)]
</span><span class="kw">struct </span>ExpectQuicTraffic {
    key_schedule: KeyScheduleTraffic,
    _fin_verified: verify::FinishedMessageVerified,
}

<span class="attr">#[cfg(feature = <span class="string">"quic"</span>)]
</span><span class="kw">impl </span>State&lt;ServerConnectionData&gt; <span class="kw">for </span>ExpectQuicTraffic {
    <span class="kw">fn </span>handle(<span class="self">self</span>: Box&lt;<span class="self">Self</span>&gt;, _cx: <span class="kw-2">&amp;mut </span>ServerContext&lt;<span class="lifetime">'_</span>&gt;, m: Message) -&gt; hs::NextStateOrError {
        <span class="comment">// reject all messages
        </span><span class="prelude-val">Err</span>(inappropriate_message(<span class="kw-2">&amp;</span>m.payload, <span class="kw-2">&amp;</span>[]))
    }
