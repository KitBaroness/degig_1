...
</span><span class="attr">#![warn(missing_docs, unreachable_pub, clippy::use_self)]
#![cfg_attr(docsrs, feature(doc_cfg))]

#[cfg(feature = <span class="string">"acceptor"</span>)]
</span><span class="doccomment">/// TLS acceptor implementing hyper's `Accept` trait.
</span><span class="kw">pub mod </span>acceptor;
...
<span class="attr">#[cfg(feature = <span class="string">"logging"</span>)]
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">use </span>log::{debug, trace};
}
