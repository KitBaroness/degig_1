...
<span class="doccomment">/// Derive macro available if borsh is built with `features = ["unstable__schema"]`.
...
<span class="doccomment">/// Derive macro available if borsh is built with `features = ["derive"]`.
</span><span class="attr">#[cfg(feature = <span class="string">"derive"</span>)]
</span><span class="kw">pub use </span>borsh_derive::{BorshDeserialize, BorshSerialize};
