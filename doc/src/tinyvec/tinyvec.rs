...
</pre></div><pre class="rust"><code><span class="attr">#![cfg(feature = <span class="string">"alloc"</span>)]
...
<span class="attr">#[cfg(feature = <span class="string">"rustc_1_57"</span>)]
...
<span class="attr">#[<span class="macro-nonterminal">doc</span>(hidden)] </span><span class="comment">// Internal implementation details of `tiny_vec!`
...
/// let some_ints = tiny_vec!([i32; 4] =&gt; 1, 2, 3);
/// ```
</span><span class="attr">#[cfg_attr(docs_rs, doc(cfg(feature = <span class="string">"alloc"</span>)))]
...
<span class="kw">impl</span>&lt;A: Array&gt; TinyVec&lt;A&gt; {
  ...
  </span><span class="attr">#[cfg(feature = <span class="string">"rustc_1_40"</span>)]
  #[inline]
  ...
  <span class="doccomment">/// Move all values from `other` into this vec.
  </span><span class="attr">#[cfg(not(feature = <span class="string">"rustc_1_40"</span>))]
  #[inline]
  </span><span class="kw">pub fn </span>append(<span class="kw-2">&amp;mut </span><span class="self">self</span>, other: <span class="kw-2">&amp;mut </span><span class="self">Self</span>) {
  ...
  </span><span class="attr">#[cfg(feature = <span class="string">"nightly_slice_partition_dedup"</span>)]
  #[inline(always)]
