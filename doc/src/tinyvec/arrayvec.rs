...
<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
</span><span class="kw">use </span>serde::de::{
  Deserialize, Deserializer, Error <span class="kw">as </span>DeserializeError, SeqAccess, Visitor,
};
<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
</span><span class="kw">use </span>serde::ser::{Serialize, SerializeSeq, Serializer};

<span class="doccomment">/// Helper to make an `ArrayVec`.
///
...
/// ```
...
</span><span class="macro">macro_rules!</span> array_vec {
  (<span class="macro-nonterminal">$array_type</span>:ty =&gt; $(<span class="macro-nonterminal">$elem</span>:expr),* $(,)<span class="question-mark">?</span>) =&gt; {
    {
      <span class="kw">let </span><span class="kw-2">mut </span>av: <span class="macro-nonterminal">$crate::ArrayVec</span>&lt;<span class="macro-nonterminal">$array_type</span>&gt; = Default::default();
      $( av.push(<span class="macro-nonterminal">$elem</span>); )*
      av
    }
  };
  (<span class="macro-nonterminal">$array_type</span>:ty) =&gt; {
    <span class="macro-nonterminal">$crate::ArrayVec</span>::&lt;<span class="macro-nonterminal">$array_type</span>&gt;::default()
  };
  ($(<span class="macro-nonterminal">$elem</span>:expr),<span class="kw-2">*</span>) =&gt; {
    <span class="macro-nonterminal">$</span><span class="macro">crate::array_vec!</span>(<span class="kw">_ </span>=&gt; $(<span class="macro-nonterminal">$elem</span>),<span class="kw-2">*</span>)
  };
  (<span class="macro-nonterminal">$elem</span>:expr; <span class="macro-nonterminal">$n</span>:expr) =&gt; {
    <span class="macro-nonterminal">$crate::ArrayVec::from</span>([<span class="macro-nonterminal">$elem</span>; <span class="macro-nonterminal">$n</span>])
  };
  () =&gt; {
    <span class="macro-nonterminal">$</span><span class="macro">crate::array_vec!</span>(<span class="kw">_</span>)
  };
}

<span class="doccomment">/// An array-backed, vector-like data structure.
///
...
/// ```
</span><span class="attr">#[<span class="macro-nonterminal">repr</span>(C)]
</span><span class="kw">pub struct </span>ArrayVec&lt;A&gt; {
  len: u16,
  <span class="kw">pub</span>(<span class="kw">crate</span>) data: A,
}

<span class="kw">impl</span>&lt;A&gt; Clone <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A: Array + Clone,
  A::Item: Clone,
{
  <span class="attr">#[inline]
    ...
    <span class="self">Self </span>{ data: <span class="self">self</span>.data.clone(), len: <span class="self">self</span>.len }
  }
  ...
  <span class="attr">#[inline]
    ...
    <span class="kw">let </span>iter = <span class="self">self
      ...
      .iter_mut()
      .zip(o.data.as_slice())
      .take(<span class="self">self</span>.len.max(o.len) <span class="kw">as </span>usize);
    <span class="kw">for </span>(dst, src) <span class="kw">in </span>iter {
      dst.clone_from(src)
    }
    <span class="kw">if let </span><span class="prelude-val">Some</span>(to_drop) =
      <span class="self">self</span>.data.as_slice_mut().get_mut((o.len <span class="kw">as </span>usize)..(<span class="self">self</span>.len <span class="kw">as </span>usize))
    {
      to_drop.iter_mut().for_each(|x| drop(take(x)));
    }
    <span class="self">self</span>.len = o.len;
  }
}

<span class="kw">impl</span>&lt;A&gt; Copy <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A: Array + Copy,
  A::Item: Copy,
{
...
<span class="kw">impl</span>&lt;A: Array&gt; Default <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
    <span class="self">Self </span>{ len: <span class="number">0</span>, data: A::default() }
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; Deref <span class="kw">for </span>ArrayVec&lt;A&gt; {
  ...
  #[must_use]
    ...
    <span class="kw-2">&amp;</span><span class="self">self</span>.data.as_slice()[..<span class="self">self</span>.len <span class="kw">as </span>usize]
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; DerefMut <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
    ...
    <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[..<span class="self">self</span>.len <span class="kw">as </span>usize]
  }
}

<span class="kw">impl</span>&lt;A: Array, I: SliceIndex&lt;[A::Item]&gt;&gt; Index&lt;I&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
...
<span class="kw">impl</span>&lt;A: Array, I: SliceIndex&lt;[A::Item]&gt;&gt; IndexMut&lt;I&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
...
</span><span class="kw">impl</span>&lt;A: Array&gt; Serialize <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
#[cfg_attr(docs_rs, doc(cfg(feature = <span class="string">"serde"</span>)))]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, A: Array&gt; Deserialize&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="attr">#[cfg(all(feature = <span class="string">"arbitrary"</span>, feature = <span class="string">"nightly_const_generics"</span>))]
#[cfg_attr(
  docs_rs,
  doc(cfg(all(feature = <span class="string">"arbitrary"</span>, feature = <span class="string">"nightly_const_generics"</span>)))
)]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, <span class="kw">const </span>N: usize&gt; arbitrary::Arbitrary&lt;<span class="lifetime">'a</span>&gt; <span class="kw">for </span>ArrayVec&lt;[T; N]&gt;
<span class="kw">where
  </span>T: arbitrary::Arbitrary&lt;<span class="lifetime">'a</span>&gt; + Default,
{
  <span class="kw">fn </span>arbitrary(u: <span class="kw-2">&amp;mut </span>arbitrary::Unstructured&lt;<span class="lifetime">'a</span>&gt;) -&gt; arbitrary::Result&lt;<span class="self">Self</span>&gt; {
    <span class="kw">let </span>v = &lt;[T; N]&gt;::arbitrary(u)<span class="question-mark">?</span>;
    <span class="kw">let </span>av = ArrayVec::from(v);
    <span class="prelude-val">Ok</span>(av)
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; ArrayVec&lt;A&gt; {
  ...
  /// ```
    ...
    <span class="macro">assert!</span>(
      <span class="self">self</span>.try_append(other).is_none(),
      <span class="string">"ArrayVec::append&gt; total length {} exceeds capacity {}!"</span>,
  ...
  </span><span class="kw">pub fn </span>try_append&lt;<span class="lifetime">'other</span>&gt;(
    <span class="kw-2">&amp;mut </span><span class="self">self</span>, other: <span class="kw-2">&amp;</span><span class="lifetime">'other </span><span class="kw-2">mut </span><span class="self">Self</span>,
  ) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'other </span><span class="kw-2">mut </span><span class="self">Self</span>&gt; {
    <span class="kw">let </span>new_len = <span class="self">self</span>.len() + other.len();
    <span class="kw">if </span>new_len &gt; A::CAPACITY {
      <span class="kw">return </span><span class="prelude-val">Some</span>(other);
    }

    <span class="kw">let </span>iter = other.iter_mut().map(take);
  ...
  <span class="doccomment">/// A `*mut` pointer to the backing array.
  ///
  /// ## Safety
  ///
  ...
  #[must_use]
  </span><span class="kw">pub fn </span>as_mut_ptr(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">*mut </span>A::Item {
    <span class="self">self</span>.data.as_slice_mut().as_mut_ptr()
  }

  <span class="doccomment">/// Performs a `deref_mut`, into unique slice form.
  </span><span class="attr">#[inline(always)]
  #[must_use]
  </span><span class="kw">pub fn </span>as_mut_slice(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>[A::Item] {
  ...
  #[must_use]
  </span><span class="kw">pub fn </span>as_ptr(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">*const </span>A::Item {
    <span class="self">self</span>.data.as_slice().as_ptr()
  }

  <span class="doccomment">/// Performs a `deref`, into shared slice form.
  </span><span class="attr">#[inline(always)]
  #[must_use]
  </span><span class="kw">pub fn </span>as_slice(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[A::Item] {
    <span class="self">self</span>.deref()
  }

  <span class="doccomment">/// The capacity of the `ArrayVec`.
  ///
  ...
  #[must_use]
    ...
    <span class="comment">// Note: This shouldn't use A::CAPACITY, because unsafe code can't rely on
    ...
    </span><span class="self">self</span>.data.as_slice().len()
  }

  <span class="doccomment">/// Truncates the `ArrayVec` down to length 0.
  </span><span class="attr">#[inline(always)]
  ...
  </span><span class="kw">pub fn </span>drain&lt;R&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, range: R) -&gt; ArrayVecDrain&lt;<span class="lifetime">'_</span>, A::Item&gt;
  <span class="kw">where
    </span>R: RangeBounds&lt;usize&gt;,
  {
    ArrayVecDrain::new(<span class="self">self</span>, range)
  }

  <span class="doccomment">/// Returns the inner array of the `ArrayVec`.
  ///
  ...
  <span class="doccomment">/// Clone each element of the slice into this `ArrayVec`.
  ///
  /// ## Panics
    ...
    </span>A::Item: Clone,
  {
    ...
    <span class="kw">let </span>new_len = <span class="self">self</span>.len <span class="kw">as </span>usize + sli.len();
    <span class="macro">assert!</span>(
      new_len &lt;= A::CAPACITY,
      <span class="string">"ArrayVec::extend_from_slice&gt; total length {} exceeds capacity {}!"</span>,
      new_len,
      A::CAPACITY
    );

    <span class="kw">let </span>target = <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.len <span class="kw">as </span>usize..new_len];
  ...
  /// ```
  ...
  </span><span class="kw">pub fn </span>fill&lt;I: IntoIterator&lt;Item = A::Item&gt;&gt;(
    <span class="kw-2">&amp;mut </span><span class="self">self</span>, iter: I,
  ) -&gt; I::IntoIter {
    <span class="comment">// If this is written as a call to push for each element in iter, the
    ...
    </span><span class="kw">let </span><span class="kw-2">mut </span>iter = iter.into_iter();
    <span class="kw">let </span><span class="kw-2">mut </span>pushed = <span class="number">0</span>;
    <span class="kw">let </span>to_take = <span class="self">self</span>.capacity() - <span class="self">self</span>.len();
    <span class="kw">let </span>target = <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.len <span class="kw">as </span>usize..];
    <span class="kw">for </span>element <span class="kw">in </span>iter.by_ref().take(to_take) {
      target[pushed] = element;
      pushed += <span class="number">1</span>;
    }
    <span class="self">self</span>.len += pushed <span class="kw">as </span>u16;
    iter
  }
  ...
  #[allow(clippy::match_wild_err_arm)]
    ...
    <span class="kw">match </span><span class="self">Self</span>::try_from_array_len(data, len) {
      ...
      <span class="prelude-val">Err</span>(<span class="kw">_</span>) =&gt; <span class="macro">panic!</span>(
        <span class="string">"ArrayVec::from_array_len&gt; length {} exceeds capacity {}!"</span>,
        len,
        A::CAPACITY
      ),
    }
  ...
  /// ```
    ...
    <span class="kw">let </span>x = <span class="self">self</span>.try_insert(index, item);
    <span class="macro">assert!</span>(x.is_none(), <span class="string">"ArrayVec::insert&gt; capacity overflow!"</span>);
  }

  <span class="doccomment">/// Tries to insert an item at the position given, moving all following
  /// elements +1 index.
  ...
  /// ```
    ...
    <span class="kw-2">&amp;mut </span><span class="self">self</span>, index: usize, <span class="kw-2">mut </span>item: A::Item,
  ) -&gt; <span class="prelude-ty">Option</span>&lt;A::Item&gt; {
    <span class="macro">assert!</span>(
      index &lt;= <span class="self">self</span>.len <span class="kw">as </span>usize,
      <span class="string">"ArrayVec::try_insert&gt; index {} is out of bounds {}"</span>,
      index,
      <span class="self">self</span>.len
    );

    <span class="comment">// A previous implementation used self.try_push and slice::rotate_right
    ...
    </span><span class="kw">if </span>(<span class="self">self</span>.len <span class="kw">as </span>usize) &lt; A::CAPACITY {
    ...
    <span class="kw">let </span>target = <span class="kw-2">&amp;mut </span><span class="self">self</span>.as_mut_slice()[index..];
    <span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..target.len() {
      core::mem::swap(<span class="kw-2">&amp;mut </span>item, <span class="kw-2">&amp;mut </span>target[i]);
    }
    <span class="kw">return </span><span class="prelude-val">None</span>;
  }
  ...
  <span class="doccomment">/// The length of the `ArrayVec` (in elements).
  </span><span class="attr">#[inline(always)]
  #[must_use]
  ...
  <span class="doccomment">/// Makes a new, empty `ArrayVec`.
  </span><span class="attr">#[inline(always)]
  #[must_use]
  ...
  </span><span class="kw">pub fn </span>pop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;A::Item&gt; {
    <span class="kw">if </span><span class="self">self</span>.len &gt; <span class="number">0 </span>{
      <span class="self">self</span>.len -= <span class="number">1</span>;
      <span class="kw">let </span>out = take(<span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.len <span class="kw">as </span>usize]);
  ...
  /// ```
    ...
    <span class="kw">let </span>x = <span class="self">self</span>.try_push(val);
    <span class="macro">assert!</span>(x.is_none(), <span class="string">"ArrayVec::push&gt; capacity overflow!"</span>);
  }

  <span class="doccomment">/// Tries to place an element onto the end of the vec.\
  /// Returns back the element if the capacity is exhausted,
  /// otherwise returns None.
  /// ```rust
  /// # use tinyvec::*;
  ...
  </span><span class="kw">pub fn </span>try_push(<span class="kw-2">&amp;mut </span><span class="self">self</span>, val: A::Item) -&gt; <span class="prelude-ty">Option</span>&lt;A::Item&gt; {
    <span class="macro">debug_assert!</span>(<span class="self">self</span>.len <span class="kw">as </span>usize &lt;= A::CAPACITY);

    <span class="kw">let </span>itemref = <span class="kw">match </span><span class="self">self</span>.data.as_slice_mut().get_mut(<span class="self">self</span>.len <span class="kw">as </span>usize) {
      <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Some</span>(val),
      <span class="prelude-val">Some</span>(x) =&gt; x,
    };

    <span class="kw-2">*</span>itemref = val;
    <span class="self">self</span>.len += <span class="number">1</span>;
    <span class="kw">return </span><span class="prelude-val">None</span>;
  }
  ...
  /// ```
  ...
  </span><span class="kw">pub fn </span>remove(<span class="kw-2">&amp;mut </span><span class="self">self</span>, index: usize) -&gt; A::Item {
    <span class="kw">let </span>targets: <span class="kw-2">&amp;mut </span>[A::Item] = <span class="kw-2">&amp;mut </span><span class="self">self</span>.deref_mut()[index..];
    <span class="kw">let </span>item = take(<span class="kw-2">&amp;mut </span>targets[<span class="number">0</span>]);

    <span class="comment">// A previous implementation used rotate_left
    // rotate_right and rotate_left generate a huge amount of code and fail to
    // inline; calling them here incurs the cost of all the cases they
    // handle even though we're rotating a usually-small array by a constant
    // 1 offset. This swap-based implementation benchmarks much better for
    ...
    </span><span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..targets.len() - <span class="number">1 </span>{
      targets.swap(i, i + <span class="number">1</span>);
    }
    <span class="self">self</span>.len -= <span class="number">1</span>;
    item
  }

  <span class="doccomment">/// As [`resize_with`](ArrayVec::resize_with)
  ...
  </span><span class="kw">pub fn </span>resize_with&lt;F: FnMut() -&gt; A::Item&gt;(
    <span class="kw-2">&amp;mut </span><span class="self">self</span>, new_len: usize, <span class="kw-2">mut </span>f: F,
  ) {
    <span class="kw">match </span>new_len.checked_sub(<span class="self">self</span>.len <span class="kw">as </span>usize) {
      <span class="prelude-val">None </span>=&gt; <span class="self">self</span>.truncate(new_len),
  ...
  /// ```
  ...
  </span><span class="kw">pub fn </span>retain&lt;F: FnMut(<span class="kw-2">&amp;</span>A::Item) -&gt; bool&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>acceptable: F) {
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>rest = JoinOnDrop {
      items: <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[..<span class="self">self</span>.len <span class="kw">as </span>usize],
      done_end: <span class="number">0</span>,
      tail_start: <span class="number">0</span>,
    };

    <span class="kw">let </span>len = <span class="self">self</span>.len <span class="kw">as </span>usize;
    <span class="kw">for </span>idx <span class="kw">in </span><span class="number">0</span>..len {
  ...
  ///   regarding what you find in the inactive portion of the vec.
    ...
    <span class="kw">if </span>new_len &gt; A::CAPACITY {
      ...
      // are more "fail-fast".
        ...
        <span class="string">"ArrayVec::set_len&gt; new length {} exceeds capacity {}"</span>,
        new_len,
        A::CAPACITY
      )
    }

    <span class="kw">let </span>new_len: u16 = new_len
      .try_into()
      .expect(<span class="string">"ArrayVec::set_len&gt; new length is not in range 0..=u16::MAX"</span>);
  ...
  /// ```
    ...
    <span class="comment">// FIXME: should this just use drain into the output?
    </span><span class="kw">if </span>at &gt; <span class="self">self</span>.len() {
      <span class="macro">panic!</span>(
        <span class="string">"ArrayVec::split_off&gt; at value {} exceeds length of {}"</span>,
        at, <span class="self">self</span>.len
      );
    }
    <span class="kw">let </span><span class="kw-2">mut </span>new = <span class="self">Self</span>::default();
    <span class="kw">let </span>moves = <span class="kw-2">&amp;mut </span><span class="self">self</span>.as_mut_slice()[at..];
    <span class="kw">let </span>split_len = moves.len();
    <span class="kw">let </span>targets = <span class="kw-2">&amp;mut </span>new.data.as_slice_mut()[..split_len];
    moves.swap_with_slice(targets);

    <span class="comment">/* moves.len() &lt;= u16::MAX, so these are surely in u16 range */
    </span>new.len = split_len <span class="kw">as </span>u16;
    <span class="self">self</span>.len = at <span class="kw">as </span>u16;
    new
  }
  ...
  ) -&gt; ArrayVecSplice&lt;<span class="lifetime">'_</span>, A, core::iter::Fuse&lt;I::IntoIter&gt;&gt;
  <span class="kw">where
    </span>R: RangeBounds&lt;usize&gt;,
    I: IntoIterator&lt;Item = A::Item&gt;,
  {
    ...
    <span class="macro">assert!</span>(
      start &lt;= end,
      <span class="string">"ArrayVec::splice&gt; Illegal range, {} to {}"</span>,
      start,
      end
    );
    <span class="macro">assert!</span>(
      end &lt;= <span class="self">self</span>.len(),
      <span class="string">"ArrayVec::splice&gt; Range ends at {} but length is only {}!"</span>,
      end,
      <span class="self">self</span>.len()
    );
  ...
  </span><span class="kw">pub fn </span>swap_remove(<span class="kw-2">&amp;mut </span><span class="self">self</span>, index: usize) -&gt; A::Item {
    <span class="macro">assert!</span>(
      index &lt; <span class="self">self</span>.len(),
      <span class="string">"ArrayVec::swap_remove&gt; index {} is out of bounds {}"</span>,
      index,
      <span class="self">self</span>.len
    );
  ...
  /// If the vec is already shorter than the input, nothing happens.
    ...
    <span class="kw">if </span>new_len &gt;= <span class="self">self</span>.len <span class="kw">as </span>usize {
      <span class="kw">return</span>;
    }

    <span class="kw">if </span>needs_drop::&lt;A::Item&gt;() {
      <span class="kw">let </span>len = <span class="self">self</span>.len <span class="kw">as </span>usize;
      <span class="self">self</span>.data.as_slice_mut()[new_len..len]
        .iter_mut()
        .map(take)
        .for_each(drop);
    }

    <span class="comment">/* new_len is less than self.len */
    </span><span class="self">self</span>.len = new_len <span class="kw">as </span>u16;
  }
  ...
  /// error, and you'll get the array back in the `Err`.
    ...
    <span class="comment">/* Note(Soveu): Should we allow A::CAPACITY &gt; u16::MAX for now? */
    </span><span class="kw">if </span>len &lt;= A::CAPACITY {
      <span class="prelude-val">Ok</span>(<span class="self">Self </span>{ data, len: len <span class="kw">as </span>u16 })
    } <span class="kw">else </span>{
      <span class="prelude-val">Err</span>(data)
    }
  }
}

<span class="kw">impl</span>&lt;A&gt; ArrayVec&lt;A&gt; {
  <span class="doccomment">/// Wraps up an array as a new empty `ArrayVec`.
  ///
  /// If you want to simply use the full array, use `from` instead.
  ///
  /// ## Examples
  ...
  #[must_use]
  </span><span class="kw">pub const fn </span>from_array_empty(data: A) -&gt; <span class="self">Self </span>{
    <span class="self">Self </span>{ data, len: <span class="number">0 </span>}
  }
}

<span class="attr">#[cfg(feature = <span class="string">"grab_spare_slice"</span>)]
</span><span class="kw">impl</span>&lt;A: Array&gt; ArrayVec&lt;A&gt; {
  ...
  </span><span class="kw">pub fn </span>grab_spare_slice(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[A::Item] {
    <span class="kw-2">&amp;</span><span class="self">self</span>.data.as_slice()[<span class="self">self</span>.len <span class="kw">as </span>usize..]
  }
  ...
  </span><span class="kw">pub fn </span>grab_spare_slice_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>[A::Item] {
    <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.len <span class="kw">as </span>usize..]
  }
}

<span class="attr">#[cfg(feature = <span class="string">"nightly_slice_partition_dedup"</span>)]
</span><span class="kw">impl</span>&lt;A: Array&gt; ArrayVec&lt;A&gt; {
  <span class="doccomment">/// De-duplicates the vec contents.
  </span><span class="attr">#[inline(always)]
...
<span class="doccomment">/// Splicing iterator for `ArrayVec`
/// See [`ArrayVec::splice`](ArrayVec::&lt;A&gt;::splice)
</span><span class="kw">pub struct </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A: Array, I: Iterator&lt;Item = A::Item&gt;&gt; {
  parent: <span class="kw-2">&amp;</span><span class="lifetime">'p </span><span class="kw-2">mut </span>ArrayVec&lt;A&gt;,
  removal_start: usize,
  removal_end: usize,
  replacement: I,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, A: Array, I: Iterator&lt;Item = A::Item&gt;&gt; Iterator
  <span class="kw">for </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A, I&gt;
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, A, I&gt; ExactSizeIterator <span class="kw">for </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A, I&gt;
<span class="kw">where
  </span>A: Array,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, A, I&gt; FusedIterator <span class="kw">for </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A, I&gt;
<span class="kw">where
  </span>A: Array,
  I: Iterator&lt;Item = A::Item&gt;,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, A, I&gt; DoubleEndedIterator <span class="kw">for </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A, I&gt;
<span class="kw">where
  </span>A: Array,
  ...
  <span class="kw">for </span>ArrayVecSplice&lt;<span class="lifetime">'p</span>, A, I&gt;
{
  <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
    ...
    <span class="comment">// FIXME: reserve lower bound of size_hint

    </span><span class="kw">for </span>replacement <span class="kw">in </span><span class="self">self</span>.replacement.by_ref() {
...
<span class="kw">impl</span>&lt;A: Array&gt; AsMut&lt;[A::Item]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
...
<span class="kw">impl</span>&lt;A: Array&gt; AsRef&lt;[A::Item]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
...
<span class="kw">impl</span>&lt;A: Array&gt; Borrow&lt;[A::Item]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
...
<span class="kw">impl</span>&lt;A: Array&gt; BorrowMut&lt;[A::Item]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
...
<span class="kw">impl</span>&lt;A: Array&gt; Extend&lt;A::Item&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline]
...
<span class="kw">impl</span>&lt;A: Array&gt; From&lt;A&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline(always)]
  #[must_use]
  </span><span class="doccomment">/// The output has a length equal to the full array.
  ///
  /// If you want to select a length, use
  /// [`from_array_len`](ArrayVec::from_array_len)
  </span><span class="kw">fn </span>from(data: A) -&gt; <span class="self">Self </span>{
    <span class="kw">let </span>len: u16 = data
      .as_slice()
      .len()
      .try_into()
      .expect(<span class="string">"ArrayVec::from&gt; length must be in range 0..=u16::MAX"</span>);
    <span class="self">Self </span>{ len, data }
  }
}

<span class="doccomment">/// The error type returned when a conversion from a slice to an [`ArrayVec`]
/// fails.
</span><span class="attr">#[derive(Debug, Copy, Clone)]
</span><span class="kw">pub struct </span>TryFromSliceError(());

<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>TryFromSliceError {
  <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
    f.write_str(<span class="string">"could not convert slice to ArrayVec"</span>)
  }
}

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>std::error::Error <span class="kw">for </span>TryFromSliceError {}

<span class="kw">impl</span>&lt;T, A&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'_ </span>[T]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  ...
  A: Array&lt;Item = T&gt;,
{
  ...
  <span class="attr">#[inline]
  #[must_use]
  </span><span class="doccomment">/// The output has a length equal to that of the slice, with the same capacity
  /// as `A`.
  </span><span class="kw">fn </span>try_from(slice: <span class="kw-2">&amp;</span>[T]) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
    <span class="kw">if </span>slice.len() &gt; A::CAPACITY {
      <span class="prelude-val">Err</span>(TryFromSliceError(()))
    } <span class="kw">else </span>{
      <span class="kw">let </span><span class="kw-2">mut </span>arr = ArrayVec::new();
      <span class="comment">// We do not use ArrayVec::extend_from_slice, because it looks like LLVM
...
<span class="kw">impl</span>&lt;A: Array&gt; FromIterator&lt;A::Item&gt; <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="attr">#[inline]
  #[must_use]
...
<span class="doccomment">/// Iterator for consuming an `ArrayVec` and returning owned elements.
</span><span class="kw">pub struct </span>ArrayVecIterator&lt;A: Array&gt; {
  base: u16,
  tail: u16,
  data: A,
}

<span class="kw">impl</span>&lt;A: Array&gt; ArrayVecIterator&lt;A&gt; {
  <span class="doccomment">/// Returns the remaining items of this iterator as a slice.
  </span><span class="attr">#[inline]
  #[must_use]
  </span><span class="kw">pub fn </span>as_slice(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[A::Item] {
    <span class="kw-2">&amp;</span><span class="self">self</span>.data.as_slice()[<span class="self">self</span>.base <span class="kw">as </span>usize..<span class="self">self</span>.tail <span class="kw">as </span>usize]
  }
}
<span class="kw">impl</span>&lt;A: Array&gt; FusedIterator <span class="kw">for </span>ArrayVecIterator&lt;A&gt; {}
<span class="kw">impl</span>&lt;A: Array&gt; Iterator <span class="kw">for </span>ArrayVecIterator&lt;A&gt; {
  <span class="kw">type </span>Item = A::Item;
  <span class="attr">#[inline]
    ...
    <span class="kw">let </span>slice =
      <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.base <span class="kw">as </span>usize..<span class="self">self</span>.tail <span class="kw">as </span>usize];
    <span class="kw">let </span>itemref = slice.first_mut()<span class="question-mark">?</span>;
    <span class="self">self</span>.base += <span class="number">1</span>;
    <span class="kw">return </span><span class="prelude-val">Some</span>(take(itemref));
  }
  <span class="attr">#[inline(always)]
  #[must_use]
  </span><span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
    <span class="kw">let </span>s = <span class="self">self</span>.tail - <span class="self">self</span>.base;
    <span class="kw">let </span>s = s <span class="kw">as </span>usize;
    (s, <span class="prelude-val">Some</span>(s))
  }
  <span class="attr">#[inline(always)]
  </span><span class="kw">fn </span>count(<span class="self">self</span>) -&gt; usize {
    <span class="self">self</span>.size_hint().<span class="number">0
  </span>}
  <span class="attr">#[inline]
  ...
  <span class="attr">#[inline]
  </span><span class="kw">fn </span>nth(<span class="kw-2">&amp;mut </span><span class="self">self</span>, n: usize) -&gt; <span class="prelude-ty">Option</span>&lt;A::Item&gt; {
    <span class="kw">let </span>slice = <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut();
    <span class="kw">let </span>slice = <span class="kw-2">&amp;mut </span>slice[<span class="self">self</span>.base <span class="kw">as </span>usize..<span class="self">self</span>.tail <span class="kw">as </span>usize];

    <span class="kw">if let </span><span class="prelude-val">Some</span>(x) = slice.get_mut(n) {
      <span class="comment">/* n is in range [0 .. self.tail - self.base) so in u16 range */
      </span><span class="self">self</span>.base += n <span class="kw">as </span>u16 + <span class="number">1</span>;
      <span class="kw">return </span><span class="prelude-val">Some</span>(take(x));
    }

    <span class="self">self</span>.base = <span class="self">self</span>.tail;
    <span class="kw">return </span><span class="prelude-val">None</span>;
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; DoubleEndedIterator <span class="kw">for </span>ArrayVecIterator&lt;A&gt; {
  <span class="attr">#[inline]
    ...
    <span class="kw">let </span>slice =
      <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[<span class="self">self</span>.base <span class="kw">as </span>usize..<span class="self">self</span>.tail <span class="kw">as </span>usize];
    <span class="kw">let </span>item = slice.last_mut()<span class="question-mark">?</span>;
    <span class="self">self</span>.tail -= <span class="number">1</span>;
    <span class="kw">return </span><span class="prelude-val">Some</span>(take(item));
  }
  <span class="attr">#[cfg(feature = <span class="string">"rustc_1_40"</span>)]
  #[inline]
    ...
    <span class="kw">let </span>base = <span class="self">self</span>.base <span class="kw">as </span>usize;
    <span class="kw">let </span>tail = <span class="self">self</span>.tail <span class="kw">as </span>usize;
    <span class="kw">let </span>slice = <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[base..tail];
    <span class="kw">let </span>n = n.saturating_add(<span class="number">1</span>);

    <span class="kw">if let </span><span class="prelude-val">Some</span>(n) = slice.len().checked_sub(n) {
      <span class="kw">let </span>item = <span class="kw-2">&amp;mut </span>slice[n];
      <span class="comment">/* n is in [0..self.tail - self.base] range, so in u16 range */
      </span><span class="self">self</span>.tail = <span class="self">self</span>.base + n <span class="kw">as </span>u16;
      <span class="kw">return </span><span class="prelude-val">Some</span>(take(item));
    }

    <span class="self">self</span>.tail = <span class="self">self</span>.base;
    <span class="kw">return </span><span class="prelude-val">None</span>;
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; Debug <span class="kw">for </span>ArrayVecIterator&lt;A&gt;
<span class="kw">where
  </span>A::Item: Debug,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
    ...
    f.debug_tuple(<span class="string">"ArrayVecIterator"</span>).field(<span class="kw-2">&amp;</span><span class="self">self</span>.as_slice()).finish()
  }
}

<span class="kw">impl</span>&lt;A: Array&gt; IntoIterator <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="kw">type </span>Item = A::Item;
  <span class="kw">type </span>IntoIter = ArrayVecIterator&lt;A&gt;;
  <span class="attr">#[inline(always)]
  #[must_use]
  </span><span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::IntoIter {
    ArrayVecIterator { base: <span class="number">0</span>, tail: <span class="self">self</span>.len, data: <span class="self">self</span>.data }
  }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A: Array&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>ArrayVec&lt;A&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A: Array&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>ArrayVec&lt;A&gt; {
...
<span class="kw">impl</span>&lt;A: Array&gt; PartialEq <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: PartialEq,
{
  <span class="attr">#[inline]
...
<span class="kw">impl</span>&lt;A: Array&gt; Eq <span class="kw">for </span>ArrayVec&lt;A&gt; <span class="kw">where </span>A::Item: Eq {}

<span class="kw">impl</span>&lt;A: Array&gt; PartialOrd <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;A: Array&gt; Ord <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Ord,
{
  <span class="attr">#[inline]
...
<span class="kw">impl</span>&lt;A: Array&gt; PartialEq&lt;<span class="kw-2">&amp;</span>A&gt; <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: PartialEq,
{
  <span class="attr">#[inline]
...
<span class="kw">impl</span>&lt;A: Array&gt; PartialEq&lt;<span class="kw-2">&amp;</span>[A::Item]&gt; <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: PartialEq,
{
  <span class="attr">#[inline]
...
<span class="kw">impl</span>&lt;A: Array&gt; Hash <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Hash,
{
  <span class="attr">#[inline]
...
<span class="attr">#[cfg(feature = <span class="string">"experimental_write_impl"</span>)]
</span><span class="kw">impl</span>&lt;A: Array&lt;Item = u8&gt;&gt; core::fmt::Write <span class="kw">for </span>ArrayVec&lt;A&gt; {
  <span class="kw">fn </span>write_str(<span class="kw-2">&amp;mut </span><span class="self">self</span>, s: <span class="kw-2">&amp;</span>str) -&gt; core::fmt::Result {
    ...
    <span class="kw">if </span>my_len + str_len &lt;= A::CAPACITY {
      <span class="kw">let </span>remainder = <span class="kw-2">&amp;mut </span><span class="self">self</span>.data.as_slice_mut()[my_len..];
...
</span><span class="kw">impl</span>&lt;A: Array&gt; Binary <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Binary,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
...
<span class="kw">impl</span>&lt;A: Array&gt; Debug <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Debug,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
...
<span class="kw">impl</span>&lt;A: Array&gt; Display <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Display,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
...
<span class="kw">impl</span>&lt;A: Array&gt; LowerExp <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;A: Array&gt; LowerHex <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;A: Array&gt; Octal <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Octal,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
...
<span class="kw">impl</span>&lt;A: Array&gt; Pointer <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
  </span>A::Item: Pointer,
{
  <span class="attr">#[allow(clippy::missing_inline_in_public_items)]
...
<span class="kw">impl</span>&lt;A: Array&gt; UpperExp <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;A: Array&gt; UpperHex <span class="kw">for </span>ArrayVec&lt;A&gt;
<span class="kw">where
...
<span class="attr">#[cfg(all(feature = <span class="string">"alloc"</span>, feature = <span class="string">"rustc_1_57"</span>))]
</span><span class="kw">use </span>alloc::collections::TryReserveError;

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;A: Array&gt; ArrayVec&lt;A&gt; {
  <span class="doccomment">/// Drains all elements to a Vec, but reserves additional space
  /// ```
  /// # use tinyvec::*;
  /// let mut av = array_vec!([i32; 7] =&gt; 1, 2, 3);
  ...
  /// ```
  </span><span class="kw">pub fn </span>drain_to_vec_and_reserve(<span class="kw-2">&amp;mut </span><span class="self">self</span>, n: usize) -&gt; Vec&lt;A::Item&gt; {
    <span class="kw">let </span>cap = n + <span class="self">self</span>.len();
    <span class="kw">let </span><span class="kw-2">mut </span>v = Vec::with_capacity(cap);
    <span class="kw">let </span>iter = <span class="self">self</span>.iter_mut().map(take);
    v.extend(iter);
    <span class="self">self</span>.set_len(<span class="number">0</span>);
    <span class="kw">return </span>v;
  }

  <span class="doccomment">/// Tries to drain all elements to a Vec, but reserves additional space.
  ///
  /// # Errors
  ///
  ...
  /// assert_eq!(v.capacity(), 13);
  /// ```
  </span><span class="attr">#[cfg(feature = <span class="string">"rustc_1_57"</span>)]
  </span><span class="kw">pub fn </span>try_drain_to_vec_and_reserve(
    <span class="kw-2">&amp;mut </span><span class="self">self</span>, n: usize,
  ) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;A::Item&gt;, TryReserveError&gt; {
    <span class="kw">let </span>cap = n + <span class="self">self</span>.len();
    <span class="kw">let </span><span class="kw-2">mut </span>v = Vec::new();
    v.try_reserve(cap)<span class="question-mark">?</span>;
    <span class="kw">let </span>iter = <span class="self">self</span>.iter_mut().map(take);
    v.extend(iter);
    <span class="self">self</span>.set_len(<span class="number">0</span>);
  ...
  <span class="doccomment">/// Drains all elements to a Vec
  /// ```
  /// # use tinyvec::*;
  /// let mut av = array_vec!([i32; 7] =&gt; 1, 2, 3);
  ...
  /// ```
  </span><span class="kw">pub fn </span>drain_to_vec(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; Vec&lt;A::Item&gt; {
    <span class="self">self</span>.drain_to_vec_and_reserve(<span class="number">0</span>)
  }

  <span class="doccomment">/// Tries to drain all elements to a Vec.
  ///
  /// # Errors
  ///
  /// If the allocator reports a failure, then an error is returned.
  ...
  </span><span class="kw">pub fn </span>try_drain_to_vec(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;A::Item&gt;, TryReserveError&gt; {
    <span class="self">self</span>.try_drain_to_vec_and_reserve(<span class="number">0</span>)
  }
}

<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
</span><span class="kw">struct </span>ArrayVecVisitor&lt;A: Array&gt;(PhantomData&lt;A&gt;);

<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, A: Array&gt; Visitor&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span>ArrayVecVisitor&lt;A&gt;
<span class="kw">where
  </span>A::Item: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
{
  <span class="kw">type </span>Value = ArrayVec&lt;A&gt;;
  ...
  {
    <span class="kw">let </span><span class="kw-2">mut </span>new_arrayvec: ArrayVec&lt;A&gt; = Default::default();

    <span class="kw">let </span><span class="kw-2">mut </span>idx = <span class="number">0usize</span>;
    <span class="kw">while let </span><span class="prelude-val">Some</span>(value) = seq.next_element()<span class="question-mark">? </span>{
      <span class="kw">if </span>new_arrayvec.len() &gt;= new_arrayvec.capacity() {
        <span class="kw">return </span><span class="prelude-val">Err</span>(DeserializeError::invalid_length(idx, <span class="kw-2">&amp;</span><span class="self">self</span>));
      }
      new_arrayvec.push(value);
      idx = idx + <span class="number">1</span>;
    }

    <span class="prelude-val">Ok</span>(new_arrayvec)
  }
}
