...
</pre></div><pre class="rust"><code><span class="doccomment">//! Collection of encryption-related data structures and algorithms used in the Solana zk-token
//! protocol.
//!
...
<span class="kw">pub mod </span>discrete_log;
<span class="kw">pub mod </span>elgamal;
<span class="kw">pub mod </span>grouped_elgamal;
<span class="kw">pub mod </span>pedersen;
