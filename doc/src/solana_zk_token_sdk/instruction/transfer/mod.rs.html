...
</pre></div><pre class="rust"><code><span class="kw">mod </span>encryption;
<span class="kw">mod </span>with_fee;
<span class="kw">mod </span>without_fee;
...
</span><span class="kw">pub fn </span>split_u64(amount: u64, bit_length: usize) -&gt; (u64, u64) {
    <span class="kw">if </span>bit_length == <span class="number">64 </span>{
        (amount, <span class="number">0</span>)
    } <span class="kw">else </span>{
        <span class="kw">let </span>lo = amount &lt;&lt; (<span class="number">64 </span>- bit_length) &gt;&gt; (<span class="number">64 </span>- bit_length);
        <span class="kw">let </span>hi = amount &gt;&gt; bit_length;
        (lo, hi)
    }
}

<span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
</span><span class="kw">pub fn </span>combine_lo_hi_u64(amount_lo: u64, amount_hi: u64, bit_length: usize) -&gt; u64 {
    <span class="kw">if </span>bit_length == <span class="number">64 </span>{
        amount_lo
    } <span class="kw">else </span>{
...
<span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
</span><span class="kw">fn </span>combine_lo_hi_ciphertexts(
    ciphertext_lo: <span class="kw-2">&amp;</span>ElGamalCiphertext,
    ciphertext_hi: <span class="kw-2">&amp;</span>ElGamalCiphertext,
    bit_length: usize,
) -&gt; ElGamalCiphertext {
    <span class="kw">let </span>two_power = (<span class="number">1_u64</span>) &lt;&lt; bit_length;
    ciphertext_lo + <span class="kw-2">&amp;</span>(ciphertext_hi * <span class="kw-2">&amp;</span>Scalar::from(two_power))
}

<span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
</span><span class="kw">pub fn </span>combine_lo_hi_commitments(
    comm_lo: <span class="kw-2">&amp;</span>PedersenCommitment,
    comm_hi: <span class="kw-2">&amp;</span>PedersenCommitment,
    bit_length: usize,
) -&gt; PedersenCommitment {
    <span class="kw">let </span>two_power = (<span class="number">1_u64</span>) &lt;&lt; bit_length;
    comm_lo + comm_hi * <span class="kw-2">&amp;</span>Scalar::from(two_power)
}

<span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
</span><span class="kw">pub fn </span>combine_lo_hi_openings(
    opening_lo: <span class="kw-2">&amp;</span>PedersenOpening,
    opening_hi: <span class="kw-2">&amp;</span>PedersenOpening,
    bit_length: usize,
) -&gt; PedersenOpening {
    <span class="kw">let </span>two_power = (<span class="number">1_u64</span>) &lt;&lt; bit_length;
    opening_lo + opening_hi * <span class="kw-2">&amp;</span>Scalar::from(two_power)
}
...
#[repr(C)]
    ...
    </span><span class="kw">pub </span>fee_rate_basis_points: u16,
    <span class="doccomment">/// Maximum fee assessed on transfers, expressed as an amount of tokens
    </span><span class="kw">pub </span>maximum_fee: u64,
}
