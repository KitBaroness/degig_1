...
</pre></div><pre class="rust"><code><span class="doccomment">//! The ciphertext-ciphertext equality proof instruction.
//!
...
#[repr(C)]
    ...
    <span class="kw">pub </span>proof: pod::CiphertextCiphertextEqualityProof,
}
...
#[repr(C)]
    ...
    <span class="kw">pub </span>source_pubkey: pod::ElGamalPubkey, <span class="comment">// 32 bytes

    </span><span class="kw">pub </span>destination_pubkey: pod::ElGamalPubkey, <span class="comment">// 32 bytes

    </span><span class="kw">pub </span>source_ciphertext: pod::ElGamalCiphertext, <span class="comment">// 64 bytes

    </span><span class="kw">pub </span>destination_ciphertext: pod::ElGamalCiphertext, <span class="comment">// 64 bytes
</span>}
...
<span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
    ...
    <span class="kw">pub fn </span>new(
        ...
        <span class="kw">let </span>pod_source_pubkey = pod::ElGamalPubkey(source_keypair.pubkey().to_bytes());
        <span class="kw">let </span>pod_destination_pubkey = pod::ElGamalPubkey(destination_pubkey.to_bytes());
        <span class="kw">let </span>pod_source_ciphertext = pod::ElGamalCiphertext(source_ciphertext.to_bytes());
        <span class="kw">let </span>pod_destination_ciphertext = pod::ElGamalCiphertext(destination_ciphertext.to_bytes());
    ...
    <span class="kw">for </span>CiphertextCiphertextEqualityProofData
{
    ...
    <span class="attr">#[cfg(not(target_os = <span class="string">"solana"</span>))]
        ...
        <span class="kw">let </span>source_pubkey = <span class="self">self</span>.context.source_pubkey.try_into()<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>source_ciphertext = <span class="self">self</span>.context.source_ciphertext.try_into()<span class="question-mark">?</span>;
        <span class="kw">let </span>destination_ciphertext = <span class="self">self</span>.context.destination_ciphertext.try_into()<span class="question-mark">?</span>;
...
#[cfg(not(target_os = <span class="string">"solana"</span>))]
    ...
    <span class="kw">fn </span>new_transcript(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Transcript {
        <span class="kw">let </span><span class="kw-2">mut </span>transcript = Transcript::new(<span class="string">b"CiphertextCiphertextEqualityProof"</span>);

        transcript.append_pubkey(<span class="string">b"source-pubkey"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.source_pubkey);
        ...
        transcript.append_ciphertext(<span class="string">b"source-ciphertext"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.source_ciphertext);
        transcript.append_ciphertext(<span class="string">b"destination-ciphertext"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.destination_ciphertext);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>source_ciphertext = source_keypair.pubkey().encrypt(amount);
        ...
        <span class="kw">let </span>destination_ciphertext = destination_keypair
            .pubkey()
            .encrypt_with(amount, <span class="kw-2">&amp;</span>destination_opening);
        ...
        <span class="kw">let </span>amount = u64::max_value();
        <span class="kw">let </span>source_ciphertext = source_keypair.pubkey().encrypt(amount);
