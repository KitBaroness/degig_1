...
</pre></div><pre class="rust"><code><span class="kw">mod </span>auth_encryption;
<span class="kw">mod </span>elgamal;
<span class="kw">mod </span>grouped_elgamal;
<span class="kw">mod </span>instruction;
<span class="kw">mod </span>pedersen;
<span class="kw">mod </span>range_proof;
<span class="kw">mod </span>sigma_proofs;

<span class="kw">use </span>{
    <span class="kw">crate</span>::zk_token_proof_instruction::ProofType,
...
<span class="attr">#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Pod, Zeroable)]
#[repr(transparent)]
</span><span class="kw">pub struct </span>PodProofType(u8);
<span class="kw">impl </span>From&lt;ProofType&gt; <span class="kw">for </span>PodProofType {
    <span class="kw">fn </span>from(proof_type: ProofType) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>(ToPrimitive::to_u8(<span class="kw-2">&amp;</span>proof_type).unwrap())
    }
}
<span class="kw">impl </span>TryFrom&lt;PodProofType&gt; <span class="kw">for </span>ProofType {
    <span class="kw">type </span>Error = InstructionError;

    <span class="kw">fn </span>try_from(pod: PodProofType) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        FromPrimitive::from_u8(pod.<span class="number">0</span>).ok_or(<span class="self">Self</span>::Error::InvalidAccountData)
    }
}

<span class="attr">#[derive(Clone, Copy, Pod, Zeroable, PartialEq, Eq)]
#[repr(transparent)]
