...
</pre></div><pre class="rust"><code><span class="doccomment">//! The public-key (validity) proof system.
//!
...
#[cfg(not(target_os = <span class="string">"solana"</span>))]
    ...
    /// * `transcript` - The transcript that does the bookkeeping for the Fiat-Shamir heuristic
        ...
        <span class="comment">// extract the relvant scalar and Ristretto points from the input
