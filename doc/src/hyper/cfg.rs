...
</pre></div><pre class="rust"><code><span class="macro">macro_rules!</span> cfg_feature {
    (
...
<span class="macro">macro_rules!</span> cfg_proto {
...
<span class="macro">cfg_proto!</span> {
    <span class="macro">macro_rules!</span> cfg_client {
        ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
            <span class="macro">cfg_feature!</span> {
    ...
    <span class="macro">macro_rules!</span> cfg_server {
        ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
            <span class="macro">cfg_feature!</span> {
