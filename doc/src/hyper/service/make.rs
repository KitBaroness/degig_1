...
// by anyone, only used as bounds.
    ...
    <span class="kw">fn </span>poll_ready_ref(<span class="kw-2">&amp;mut </span><span class="self">self</span>, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::MakeError&gt;&gt;;
...
<span class="kw">mod </span>sealed {
    ...
    <span class="attr">#[allow(unreachable_pub)] </span><span class="comment">// This is intentional.
