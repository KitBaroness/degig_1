...
</pre></div><pre class="rust"><code><span class="doccomment">//! Asynchronous Services
//!
...
<span class="attr">#[cfg(all(any(feature = <span class="string">"http1"</span>, feature = <span class="string">"http2"</span>), feature = <span class="string">"client"</span>))]
...
<span class="attr">#[cfg(all(any(feature = <span class="string">"http1"</span>, feature = <span class="string">"http2"</span>), feature = <span class="string">"server"</span>))]
