...
</pre></div><pre class="rust"><code><span class="doccomment">//! Runtime components
//!
...
</span><span class="kw">pub trait </span>Executor&lt;Fut&gt; {
    <span class="doccomment">/// Place the future into the executor to be run.
    </span><span class="kw">fn </span>execute(<span class="kw-2">&amp;</span><span class="self">self</span>, fut: Fut);
}
