...
</pre></div><pre class="rust"><code><span class="doccomment">//! HTTP extensions.

</span><span class="kw">use </span>bytes::Bytes;
<span class="attr">#[cfg(any(feature = <span class="string">"http1"</span>, feature = <span class="string">"ffi"</span>))]
...
<span class="attr">#[cfg(any(feature = <span class="string">"http1"</span>, feature = <span class="string">"ffi"</span>))]
</span><span class="kw">mod </span>h1_reason_phrase;
<span class="attr">#[cfg(any(feature = <span class="string">"http1"</span>, feature = <span class="string">"ffi"</span>))]
</span><span class="kw">pub use </span>h1_reason_phrase::ReasonPhrase;
...
<span class="attr">#[cfg(feature = <span class="string">"http2"</span>)]
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>from_inner(inner: h2::ext::Protocol) -&gt; <span class="self">Self </span>{
...
<span class="attr">#[cfg(feature = <span class="string">"http1"</span>)]
    ...
    <span class="attr">#[cfg(any(test, feature = <span class="string">"ffi"</span>))]
...
<span class="attr">#[cfg(all(feature = <span class="string">"http1"</span>, feature = <span class="string">"ffi"</span>))]
