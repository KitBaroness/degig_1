...
</pre></div><pre class="rust"><code><span class="kw">use </span>std::marker::Unpin;
...
<span class="kw">impl</span>&lt;T&gt; Rewind&lt;T&gt; {
    <span class="attr">#[cfg(any(all(feature = <span class="string">"http2"</span>, feature = <span class="string">"server"</span>), test))]
    ...
    <span class="attr">#[cfg(any(all(feature = <span class="string">"http1"</span>, feature = <span class="string">"http2"</span>, feature = <span class="string">"server"</span>), test))]
    ...
    <span class="kw">fn </span>poll_read(
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">mut </span>prefix) = <span class="self">self</span>.pre.take() {
            <span class="comment">// If there are no remaining bytes, let the bytes get dropped.
                ...
                <span class="comment">// Put back what's left
                </span><span class="kw">if </span>!prefix.is_empty() {
