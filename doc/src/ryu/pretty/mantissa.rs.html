...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::digit_table::DIGIT_TABLE;
...
<span class="attr">#[cfg_attr(feature = <span class="string">"no-panic"</span>, inline)]
    ...
    <span class="kw">if </span>(output &gt;&gt; <span class="number">32</span>) != <span class="number">0 </span>{
        ...
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(c0 <span class="kw">as </span>isize),
            result.offset(-<span class="number">2</span>),
            <span class="number">2</span>,
        );
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(c1 <span class="kw">as </span>isize),
            result.offset(-<span class="number">4</span>),
            <span class="number">2</span>,
        );
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(d0 <span class="kw">as </span>isize),
            result.offset(-<span class="number">6</span>),
            <span class="number">2</span>,
        );
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(d1 <span class="kw">as </span>isize),
            result.offset(-<span class="number">8</span>),
            <span class="number">2</span>,
        );
...
<span class="attr">#[cfg_attr(feature = <span class="string">"no-panic"</span>, inline)]
    ...
    <span class="kw">while </span>output &gt;= <span class="number">10_000 </span>{
        <span class="kw">let </span>c = output - <span class="number">10_000 </span>* (output / <span class="number">10_000</span>);
    ...
    <span class="kw">if </span>output &gt;= <span class="number">100 </span>{
        <span class="kw">let </span>c = (output % <span class="number">100</span>) &lt;&lt; <span class="number">1</span>;
        output /= <span class="number">100</span>;
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(c <span class="kw">as </span>isize),
            result.offset(-<span class="number">2</span>),
            <span class="number">2</span>,
        );
    ...
    <span class="kw">if </span>output &gt;= <span class="number">10 </span>{
        <span class="kw">let </span>c = output &lt;&lt; <span class="number">1</span>;
        ptr::copy_nonoverlapping(
            DIGIT_TABLE.as_ptr().offset(c <span class="kw">as </span>isize),
            result.offset(-<span class="number">2</span>),
            <span class="number">2</span>,
