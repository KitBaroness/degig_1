...
<span class="attr">#[cfg_attr(feature = <span class="string">"no-panic"</span>, inline)]
    ...
    <span class="kw">if </span>k &gt;= <span class="number">100 </span>{
        ...
        <span class="kw">let </span>d = DIGIT_TABLE.as_ptr().offset(k * <span class="number">2</span>);
