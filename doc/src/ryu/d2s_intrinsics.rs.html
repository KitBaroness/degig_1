...
<span class="attr">#[cfg_attr(feature = <span class="string">"no-panic"</span>, inline)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>pow5_factor(<span class="kw-2">mut </span>value: u64) -&gt; u32 {
    <span class="kw">const </span>M_INV_5: u64 = <span class="number">14757395258967641293</span>; <span class="comment">// 5 * m_inv_5 = 1 (mod 2^64)
    </span><span class="kw">const </span>N_DIV_5: u64 = <span class="number">3689348814741910323</span>; <span class="comment">// #{ n | n = 0 (mod 2^64) } = 2^64 / 5
    </span><span class="kw">let </span><span class="kw-2">mut </span>count = <span class="number">0u32</span>;
    <span class="kw">loop </span>{
        <span class="macro">debug_assert!</span>(value != <span class="number">0</span>);
        value = value.wrapping_mul(M_INV_5);
        <span class="kw">if </span>value &gt; N_DIV_5 {
