...
</pre></div><pre class="rust"><code><span class="doccomment">//! [![github]](https://github.com/dtolnay/ryu)&amp;ensp;[![crates-io]](https://crates.io/crates/ryu)&amp;ensp;[![docs-rs]](https://docs.rs/ryu)
//!
...
#![doc(html_root_url = <span class="string">"https://docs.rs/ryu/1.0.17"</span>)]
#![allow(
