...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::job::{ArcJob, StackJob};
<span class="kw">use </span><span class="kw">crate</span>::latch::{CountLatch, LatchRef};
    ...
    R: Send,
{
    ...
    <span class="kw">let </span>latch = CountLatch::with_count(n_threads, current_thread);
    <span class="kw">let </span>jobs: Vec&lt;<span class="kw">_</span>&gt; = (<span class="number">0</span>..n_threads)
        .map(|<span class="kw">_</span>| StackJob::new(<span class="kw-2">&amp;</span>f, LatchRef::new(<span class="kw-2">&amp;</span>latch)))
        .collect();
