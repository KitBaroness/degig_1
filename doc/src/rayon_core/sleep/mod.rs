...
</pre></div><pre class="rust"><code><span class="doccomment">//! Code that decides when workers should go to sleep. See README.md
//! for an overview.
...
<span class="kw">impl </span>Sleep {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(n_threads: usize) -&gt; Sleep {
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>start_looking(<span class="kw-2">&amp;</span><span class="self">self</span>, worker_index: usize) -&gt; IdleState {
    ...
    <span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>work_found(<span class="kw-2">&amp;</span><span class="self">self</span>) {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span>idle_state.rounds &lt; ROUNDS_UNTIL_SLEEPY {
            ...
            idle_state.jobs_counter = <span class="self">self</span>.announce_sleepy();
            idle_state.rounds += <span class="number">1</span>;
            thread::yield_now();
    ...
    </span><span class="kw">fn </span>announce_sleepy(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; JobsEventCounter {
        <span class="self">self</span>.counters
    ...
    ///   We'll try to get at least one thread per job.
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new_injected_jobs(<span class="kw-2">&amp;</span><span class="self">self</span>, num_jobs: u32, queue_was_empty: bool) {
        ...
        <span class="self">self</span>.new_jobs(num_jobs, queue_was_empty)
    }
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new_internal_jobs(<span class="kw-2">&amp;</span><span class="self">self</span>, num_jobs: u32, queue_was_empty: bool) {
        <span class="self">self</span>.new_jobs(num_jobs, queue_was_empty)
    }

    <span class="doccomment">/// Common helper for `new_injected_jobs` and `new_internal_jobs`.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>new_jobs(<span class="kw-2">&amp;</span><span class="self">self</span>, num_jobs: u32, queue_was_empty: bool) {
