...
</pre></div><pre class="rust"><code><span class="attr">#[cfg(feature = <span class="string">"raw"</span>)]
</span><span class="kw">use </span><span class="kw">crate</span>::raw::RawTable;
...
<span class="kw">use </span><span class="kw">super</span>::map::{<span class="self">self</span>, DefaultHashBuilder, HashMap, Keys};
<span class="kw">use </span><span class="kw">crate</span>::raw::{Allocator, Global, RawExtractIf};
...
</span><span class="kw">pub struct </span>HashSet&lt;T, S = DefaultHashBuilder, A: Allocator = Global&gt; {
...
<span class="attr">#[cfg(feature = <span class="string">"ahash"</span>)]
</span><span class="kw">impl</span>&lt;T: Hash + Eq, A: Allocator&gt; HashSet&lt;T, DefaultHashBuilder, A&gt; {
    <span class="doccomment">/// Creates an empty `HashSet`.
    ///
    /// The hash set is initially created with a capacity of 0, so it will not allocate until it
    /// is first inserted into.
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; HashSet&lt;T, S, A&gt; {
    ...
    </span>A: Allocator,
{
    ...
    </span><span class="kw">pub const fn </span>with_hasher_in(hasher: S, alloc: A) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
    ...
    A: Allocator,
{
    ...
    <span class="kw">where
        </span>Q: Hash + Equivalent&lt;T&gt; + ToOwned&lt;Owned = T&gt;,
    {
        <span class="comment">// Although the raw entry gives us `&amp;mut T`, we only return `&amp;T` to be consistent with
        // `get`. Key mutation is "raw" because you're not supposed to affect `Eq` or `Hash`.
        </span><span class="self">self</span>.map
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; HashSet&lt;T, S, A&gt; {
    <span class="doccomment">/// Returns a reference to the [`RawTable`] used underneath [`HashSet`].
    ...
    </span><span class="kw">pub fn </span>raw_table(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>RawTable&lt;(T, ()), A&gt; {
        <span class="self">self</span>.map.raw_table()
    }

    <span class="doccomment">/// Returns a mutable reference to the [`RawTable`] used underneath [`HashSet`].
    /// This function is only available if the `raw` feature of the crate is enabled.
    ///
    /// # Note
    ///
    ...
    #[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">pub fn </span>raw_table_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>RawTable&lt;(T, ()), A&gt; {
        <span class="self">self</span>.map.raw_table_mut()
    }
}
...
</span><span class="kw">pub struct </span>IntoIter&lt;K, A: Allocator = Global&gt; {
...
</span><span class="kw">pub struct </span>Drain&lt;<span class="lifetime">'a</span>, K, A: Allocator = Global&gt; {
...
</span><span class="kw">pub struct </span>ExtractIf&lt;<span class="lifetime">'a</span>, K, F, A: Allocator = Global&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>K) -&gt; bool,
{
    f: F,
    inner: RawExtractIf&lt;<span class="lifetime">'a</span>, (K, ()), A&gt;,
}
...
</span><span class="kw">pub struct </span>Intersection&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
...
</span><span class="kw">pub struct </span>Difference&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
    <span class="comment">// iterator of the first set
    </span>iter: Iter&lt;<span class="lifetime">'a</span>, T&gt;,
    <span class="comment">// the second set
    </span>other: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashSet&lt;T, S, A&gt;,
...
</span><span class="kw">pub struct </span>SymmetricDifference&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
...
</span><span class="kw">pub struct </span>Union&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
    iter: Chain&lt;Iter&lt;<span class="lifetime">'a</span>, T&gt;, Difference&lt;<span class="lifetime">'a</span>, T, S, A&gt;&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S, A: Allocator&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashSet&lt;T, S, A&gt; {
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; IntoIterator <span class="kw">for </span>HashSet&lt;T, S, A&gt; {
...
<span class="kw">impl</span>&lt;K, A: Allocator&gt; Iterator <span class="kw">for </span>IntoIter&lt;K, A&gt; {
    ...
    <span class="kw">where
        ...
        F: FnMut(B, <span class="self">Self</span>::Item) -&gt; B,
    {
        <span class="self">self</span>.iter.fold(init, |acc, (k, ())| f(acc, k))
    }
}
<span class="kw">impl</span>&lt;K, A: Allocator&gt; ExactSizeIterator <span class="kw">for </span>IntoIter&lt;K, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.iter.len()
    }
}
<span class="kw">impl</span>&lt;K, A: Allocator&gt; FusedIterator <span class="kw">for </span>IntoIter&lt;K, A&gt; {}

<span class="kw">impl</span>&lt;K: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>IntoIter&lt;K, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;K, A: Allocator&gt; Iterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, K, A&gt; {
    <span class="kw">type </span>Item = K;
...
<span class="kw">impl</span>&lt;K, A: Allocator&gt; ExactSizeIterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, K, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.iter.len()
    }
}
<span class="kw">impl</span>&lt;K, A: Allocator&gt; FusedIterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, K, A&gt; {}

<span class="kw">impl</span>&lt;K: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, K, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        <span class="kw">let </span>entries_iter = <span class="self">self</span>.iter.iter().map(|(k, <span class="kw">_</span>)| k);
        f.debug_list().entries(entries_iter).finish()
    }
...
<span class="kw">impl</span>&lt;K, F, A: Allocator&gt; Iterator <span class="kw">for </span>ExtractIf&lt;<span class="lifetime">'_</span>, K, F, A&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>K) -&gt; bool,
{
    <span class="kw">type </span>Item = K;
    ...
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
        ...
        <span class="self">self</span>.inner
            .next(|<span class="kw-2">&amp;mut </span>(<span class="kw-2">ref </span>k, ())| (<span class="self">self</span>.f)(k))
            .map(|(k, ())| k)
    }
...
<span class="kw">impl</span>&lt;K, F, A: Allocator&gt; FusedIterator <span class="kw">for </span>ExtractIf&lt;<span class="lifetime">'_</span>, K, F, A&gt; <span class="kw">where </span>F: FnMut(<span class="kw-2">&amp;</span>K) -&gt; bool {}

<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; Clone <span class="kw">for </span>Intersection&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        Intersection {
            iter: <span class="self">self</span>.iter.clone(),
    ...
    A: Allocator,
{
    ...
    <span class="kw">where
        ...
        F: FnMut(B, <span class="self">Self</span>::Item) -&gt; B,
    {
        <span class="self">self</span>.iter.fold(init, |acc, elt| {
            <span class="kw">if </span><span class="self">self</span>.other.contains(elt) {
                f(acc, elt)
            } <span class="kw">else </span>{
                acc
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; Clone <span class="kw">for </span>Difference&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        Difference {
            iter: <span class="self">self</span>.iter.clone(),
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; Clone <span class="kw">for </span>SymmetricDifference&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        SymmetricDifference {
            iter: <span class="self">self</span>.iter.clone(),
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; Clone <span class="kw">for </span>Union&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"inline-more"</span>, inline)]
    </span><span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        Union {
            iter: <span class="self">self</span>.iter.clone(),
...
<span class="kw">impl</span>&lt;T: fmt::Debug, S, A: Allocator&gt; fmt::Debug <span class="kw">for </span>Entry&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
/// assert_eq!(set.len(), 2);
/// ```
</span><span class="kw">pub struct </span>OccupiedEntry&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
    inner: map::OccupiedEntry&lt;<span class="lifetime">'a</span>, T, (), S, A&gt;,
}

<span class="kw">impl</span>&lt;T: fmt::Debug, S, A: Allocator&gt; fmt::Debug <span class="kw">for </span>OccupiedEntry&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
/// ```
</span><span class="kw">pub struct </span>VacantEntry&lt;<span class="lifetime">'a</span>, T, S, A: Allocator = Global&gt; {
    inner: map::VacantEntry&lt;<span class="lifetime">'a</span>, T, (), S, A&gt;,
}

<span class="kw">impl</span>&lt;T: fmt::Debug, S, A: Allocator&gt; fmt::Debug <span class="kw">for </span>VacantEntry&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_tuple(<span class="string">"VacantEntry"</span>).field(<span class="self">self</span>.get()).finish()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S, A: Allocator&gt; Entry&lt;<span class="lifetime">'a</span>, T, S, A&gt; {
...
<span class="kw">impl</span>&lt;T, S, A: Allocator&gt; OccupiedEntry&lt;<span class="lifetime">'_</span>, T, S, A&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S, A: Allocator&gt; VacantEntry&lt;<span class="lifetime">'a</span>, T, S, A&gt; {
...
<span class="attr">#[allow(dead_code)]
    ...
    <span class="kw">fn </span>into_iter&lt;<span class="lifetime">'new</span>, A: Allocator&gt;(v: IntoIter&lt;<span class="kw-2">&amp;</span><span class="lifetime">'static </span>str, A&gt;) -&gt; IntoIter&lt;<span class="kw-2">&amp;</span><span class="lifetime">'new </span>str, A&gt; {
        v
    }
    <span class="kw">fn </span>difference&lt;<span class="lifetime">'a</span>, <span class="lifetime">'new</span>, A: Allocator&gt;(
    ...
    <span class="kw">fn </span>symmetric_difference&lt;<span class="lifetime">'a</span>, <span class="lifetime">'new</span>, A: Allocator&gt;(
    ...
    <span class="kw">fn </span>intersection&lt;<span class="lifetime">'a</span>, <span class="lifetime">'new</span>, A: Allocator&gt;(
    ...
    <span class="kw">fn </span>union&lt;<span class="lifetime">'a</span>, <span class="lifetime">'new</span>, A: Allocator&gt;(
    ...
    <span class="kw">fn </span>drain&lt;<span class="lifetime">'new</span>, A: Allocator&gt;(d: Drain&lt;<span class="lifetime">'static</span>, <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str, A&gt;) -&gt; Drain&lt;<span class="lifetime">'new</span>, <span class="kw-2">&amp;</span><span class="lifetime">'new </span>str, A&gt; {
        d
    }
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>set_str = <span class="macro">format!</span>(<span class="string">"{set:?}"</span>);
    ...
    #[allow(clippy::needless_borrow)]
        ...
        a.extend([<span class="number">2</span>, <span class="number">3</span>, <span class="number">4</span>]);
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_extract_if() {
        {
            ...
            <span class="kw">let </span>drained = set.extract_if(|<span class="kw-2">&amp;</span>k| k % <span class="number">2 </span>== <span class="number">0</span>);
        ...
        {
            <span class="kw">let </span><span class="kw-2">mut </span>set: HashSet&lt;i32&gt; = (<span class="number">0</span>..<span class="number">8</span>).collect();
            set.extract_if(|<span class="kw-2">&amp;</span>k| k % <span class="number">2 </span>== <span class="number">0</span>).for_each(drop);
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>collect() {
        <span class="comment">// At the time of writing, this hits the ZST case in from_base_index
        // (and without the `map`, it does not).
        </span><span class="kw">let </span><span class="kw-2">mut </span>_set: HashSet&lt;<span class="kw">_</span>&gt; = (<span class="number">0</span>..<span class="number">3</span>).map(|<span class="kw">_</span>| ()).collect();
    }
}
