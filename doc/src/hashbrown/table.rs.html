...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::{fmt, iter::FusedIterator, marker::PhantomData};
...
<span class="doccomment">/// Low-level hash table with explicit hashing.
///
...
</span><span class="kw">pub struct </span>HashTable&lt;T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="kw">pub</span>(<span class="kw">crate</span>) raw: RawTable&lt;T, A&gt;,
}

<span class="kw">impl</span>&lt;T&gt; HashTable&lt;T, Global&gt; {
    <span class="doccomment">/// Creates an empty `HashTable`.
    ///
    ...
    <span class="doccomment">/// Creates an empty `HashTable` with the specified capacity.
    ///
...
<span class="kw">impl</span>&lt;T, A&gt; HashTable&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="doccomment">/// Creates an empty `HashTable` using the given allocator.
    ///
    /// The hash table is initially created with a capacity of 0, so it will not allocate until it
    /// is first inserted into.
    ///
    ...
    <span class="doccomment">/// Creates an empty `HashTable` with the specified capacity using the given allocator.
    ///
    /// The hash table will be able to hold at least `capacity` elements without
    /// reallocating. If `capacity` is 0, the hash table will not allocate.
    ///
    ...
    <span class="doccomment">/// Returns a reference to the underlying allocator.
        ...
        <span class="self">self</span>.raw.allocator()
    }

    <span class="doccomment">/// Returns a reference to an entry in the table with the given hash and
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>find(<span class="kw-2">&amp;</span><span class="self">self</span>, hash: u64, eq: <span class="kw">impl </span>FnMut(<span class="kw-2">&amp;</span>T) -&gt; bool) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>T&gt; {
        <span class="self">self</span>.raw.get(hash, eq)
    }

    <span class="doccomment">/// Returns a mutable reference to an entry in the table with the given hash
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>find_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>, hash: u64, eq: <span class="kw">impl </span>FnMut(<span class="kw-2">&amp;</span>T) -&gt; bool) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;mut </span>T&gt; {
        <span class="self">self</span>.raw.get_mut(hash, eq)
    }

    <span class="doccomment">/// Returns an `OccupiedEntry` for an entry in the table with the given hash
    /// and which satisfies the equality function passed.
    ///
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>find_entry(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        hash: u64,
        eq: <span class="kw">impl </span>FnMut(<span class="kw-2">&amp;</span>T) -&gt; bool,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;OccupiedEntry&lt;<span class="lifetime">'_</span>, T, A&gt;, AbsentEntry&lt;<span class="lifetime">'_</span>, T, A&gt;&gt; {
        <span class="kw">match </span><span class="self">self</span>.raw.find(hash, eq) {
            <span class="prelude-val">Some</span>(bucket) =&gt; <span class="prelude-val">Ok</span>(OccupiedEntry {
                hash,
                bucket,
                table: <span class="self">self</span>,
            }),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">Err</span>(AbsentEntry { table: <span class="self">self </span>}),
        }
    }

    <span class="doccomment">/// Returns an `Entry` for an entry in the table with the given hash
    /// and which satisfies the equality function passed.
    ///
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>entry(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        hash: u64,
        eq: <span class="kw">impl </span>FnMut(<span class="kw-2">&amp;</span>T) -&gt; bool,
        hasher: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span>T) -&gt; u64,
    ) -&gt; Entry&lt;<span class="lifetime">'_</span>, T, A&gt; {
        <span class="kw">match </span><span class="self">self</span>.raw.find_or_find_insert_slot(hash, eq, hasher) {
            <span class="prelude-val">Ok</span>(bucket) =&gt; Entry::Occupied(OccupiedEntry {
                hash,
                bucket,
                table: <span class="self">self</span>,
            }),
            <span class="prelude-val">Err</span>(insert_slot) =&gt; Entry::Vacant(VacantEntry {
                hash,
                insert_slot,
                table: <span class="self">self</span>,
            }),
    ...
    <span class="doccomment">/// Inserts an element into the `HashTable` with the given hash value, but
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>insert_unique(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        hash: u64,
        value: T,
        hasher: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span>T) -&gt; u64,
    ) -&gt; OccupiedEntry&lt;<span class="lifetime">'_</span>, T, A&gt; {
        <span class="kw">let </span>bucket = <span class="self">self</span>.raw.insert(hash, value, hasher);
        OccupiedEntry {
            hash,
            bucket,
            table: <span class="self">self</span>,
    ...
    <span class="doccomment">/// Clears the table, removing all values.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.raw.clear();
    }

    <span class="doccomment">/// Shrinks the capacity of the table as much as possible. It will drop
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>shrink_to_fit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, hasher: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span>T) -&gt; u64) {
        <span class="self">self</span>.raw.shrink_to(<span class="self">self</span>.len(), hasher)
    }

    <span class="doccomment">/// Shrinks the capacity of the table with a lower limit. It will drop
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>shrink_to(<span class="kw-2">&amp;mut </span><span class="self">self</span>, min_capacity: usize, hasher: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span>T) -&gt; u64) {
        <span class="self">self</span>.raw.shrink_to(min_capacity, hasher);
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.raw.reserve(additional, hasher)
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.raw.try_reserve(additional, hasher)
    }

    <span class="doccomment">/// Returns the number of elements the table can hold without reallocating.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.raw.capacity()
    }
    ...
    /// ```
        ...
        Iter {
            inner: <span class="kw">unsafe </span>{ <span class="self">self</span>.raw.iter() },
            marker: PhantomData,
        }
    }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>retain(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>f: <span class="kw">impl </span>FnMut(<span class="kw-2">&amp;mut </span>T) -&gt; bool) {
        <span class="comment">// Here we only use `iter` as a temporary, preventing use-after-free
        </span><span class="kw">unsafe </span>{
            <span class="kw">for </span>item <span class="kw">in </span><span class="self">self</span>.raw.iter() {
                <span class="kw">if </span>!f(item.as_mut()) {
                    <span class="self">self</span>.raw.erase(item);
                }
            }
        }
    }
    ...
    /// ```
        ...
        Drain {
            inner: <span class="self">self</span>.raw.drain(),
        }
    }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>extract_if&lt;F&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, f: F) -&gt; ExtractIf&lt;<span class="lifetime">'_</span>, T, F, A&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;mut </span>T) -&gt; bool,
    {
        ExtractIf {
            f,
            inner: RawExtractIf {
                iter: <span class="kw">unsafe </span>{ <span class="self">self</span>.raw.iter() },
                table: <span class="kw-2">&amp;mut </span><span class="self">self</span>.raw,
            },
        }
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.raw.get_many_mut(hashes, eq)
    }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub unsafe fn </span>get_many_unchecked_mut&lt;<span class="kw">const </span>N: usize&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        hashes: [u64; N],
        eq: <span class="kw">impl </span>FnMut(usize, <span class="kw-2">&amp;</span>T) -&gt; bool,
    ) -&gt; <span class="prelude-ty">Option</span>&lt;[<span class="kw-2">&amp;</span><span class="lifetime">'_ </span><span class="kw-2">mut </span>T; N]&gt; {
        <span class="self">self</span>.raw.get_many_unchecked_mut(hashes, eq)
    }
}

<span class="kw">impl</span>&lt;T, A&gt; IntoIterator <span class="kw">for </span>HashTable&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    ...
    <span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; IntoIter&lt;T, A&gt; {
        IntoIter {
            inner: <span class="self">self</span>.raw.into_iter(),
        }
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashTable&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
...
<span class="kw">impl</span>&lt;T, A&gt; Default <span class="kw">for </span>HashTable&lt;T, A&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;T, A&gt; Clone <span class="kw">for </span>HashTable&lt;T, A&gt;
<span class="kw">where
    </span>T: Clone,
    A: Allocator + Clone,
{
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            raw: <span class="self">self</span>.raw.clone(),
        }
    }
}

<span class="kw">impl</span>&lt;T, A&gt; fmt::Debug <span class="kw">for </span>HashTable&lt;T, A&gt;
<span class="kw">where
    </span>T: fmt::Debug,
    A: Allocator,
{
...
<span class="doccomment">/// A view into a single entry in a table, which may either be vacant or occupied.
///
...
/// # }
/// ```
</span><span class="kw">pub enum </span>Entry&lt;<span class="lifetime">'a</span>, T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
    ...
    /// # }
    /// ```
    </span>Occupied(OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A&gt;),
    ...
    /// # }
    /// ```
    </span>Vacant(VacantEntry&lt;<span class="lifetime">'a</span>, T, A&gt;),
}

<span class="kw">impl</span>&lt;T: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>Entry&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; Entry&lt;<span class="lifetime">'a</span>, T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="doccomment">/// Sets the value of the entry, replacing any existing value if there is
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>insert(<span class="self">self</span>, value: T) -&gt; OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A&gt; {
        <span class="kw">match </span><span class="self">self </span>{
            Entry::Occupied(<span class="kw-2">mut </span>entry) =&gt; {
                <span class="kw-2">*</span>entry.get_mut() = value;
                entry
            }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>or_insert(<span class="self">self</span>, default: T) -&gt; OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A&gt; {
        <span class="kw">match </span><span class="self">self </span>{
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>or_insert_with(<span class="self">self</span>, default: <span class="kw">impl </span>FnOnce() -&gt; T) -&gt; OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A&gt; {
        <span class="kw">match </span><span class="self">self </span>{
            Entry::Occupied(entry) =&gt; entry,
            Entry::Vacant(entry) =&gt; entry.insert(default()),
        }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>and_modify(<span class="self">self</span>, f: <span class="kw">impl </span>FnOnce(<span class="kw-2">&amp;mut </span>T)) -&gt; <span class="self">Self </span>{
        <span class="kw">match </span><span class="self">self </span>{
            Entry::Occupied(<span class="kw-2">mut </span>entry) =&gt; {
                f(entry.get_mut());
...
<span class="doccomment">/// A view into an occupied entry in a `HashTable`.
...
/// # }
/// ```
</span><span class="kw">pub struct </span>OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
    hash: u64,
    bucket: Bucket&lt;T&gt;,
    table: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt;,
}

<span class="kw">unsafe impl</span>&lt;T, A&gt; Send <span class="kw">for </span>OccupiedEntry&lt;<span class="lifetime">'_</span>, T, A&gt;
<span class="kw">where
    </span>T: Send,
    A: Send + Allocator,
{
}
<span class="kw">unsafe impl</span>&lt;T, A&gt; Sync <span class="kw">for </span>OccupiedEntry&lt;<span class="lifetime">'_</span>, T, A&gt;
<span class="kw">where
    </span>T: Sync,
    A: Sync + Allocator,
{
...
<span class="kw">impl</span>&lt;T: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>OccupiedEntry&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; OccupiedEntry&lt;<span class="lifetime">'a</span>, T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="doccomment">/// Takes the value out of the entry, and returns it along with a
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>remove(<span class="self">self</span>) -&gt; (T, VacantEntry&lt;<span class="lifetime">'a</span>, T, A&gt;) {
        <span class="kw">let </span>(val, slot) = <span class="kw">unsafe </span>{ <span class="self">self</span>.table.raw.remove(<span class="self">self</span>.bucket) };
        (
            val,
            VacantEntry {
    ...
    /// ```
        ...
        <span class="kw">unsafe </span>{ <span class="self">self</span>.bucket.as_ref() }
    }
    ...
    /// ```
        ...
        <span class="kw">unsafe </span>{ <span class="self">self</span>.bucket.as_mut() }
    }
    ...
    <span class="doccomment">/// Converts the OccupiedEntry into a mutable reference to the underlying
    /// table.
    </span><span class="kw">pub fn </span>into_table(<span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt; {
        <span class="self">self</span>.table
    }
}

<span class="doccomment">/// A view into a vacant entry in a `HashTable`.
/// It is part of the [`Entry`] enum.
///
/// [`Entry`]: enum.Entry.html
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>VacantEntry&lt;<span class="lifetime">'a</span>, T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
    hash: u64,
...
<span class="kw">impl</span>&lt;T: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>VacantEntry&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.write_str(<span class="string">"VacantEntry"</span>)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; VacantEntry&lt;<span class="lifetime">'a</span>, T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="doccomment">/// Inserts a new element into the table with the hash that was used to
    ...
    /// ```
        ...
        <span class="kw">let </span>bucket = <span class="kw">unsafe </span>{
            <span class="self">self</span>.table
                .raw
                .insert_in_slot(<span class="self">self</span>.hash, <span class="self">self</span>.insert_slot, value)
        };
        OccupiedEntry {
            hash: <span class="self">self</span>.hash,
            bucket,
    ...
    <span class="doccomment">/// Converts the VacantEntry into a mutable reference to the underlying
    /// table.
    </span><span class="kw">pub fn </span>into_table(<span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt; {
        <span class="self">self</span>.table
    }
...
<span class="doccomment">/// Type representing the absence of an entry, as returned by [`HashTable::find_entry`].
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>AbsentEntry&lt;<span class="lifetime">'a</span>, T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
    table: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt;,
...
<span class="kw">impl</span>&lt;T: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>AbsentEntry&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.write_str(<span class="string">"AbsentEntry"</span>)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, A&gt; AbsentEntry&lt;<span class="lifetime">'a</span>, T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="doccomment">/// Converts the AbsentEntry into a mutable reference to the underlying
    /// table.
    </span><span class="kw">pub fn </span>into_table(<span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>HashTable&lt;T, A&gt; {
        <span class="self">self</span>.table
    }
...
<span class="doccomment">/// An iterator over the entries of a `HashTable` in arbitrary order.
/// The iterator element type is `&amp;'a T`.
///
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Iterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    <span class="kw">fn </span>fold&lt;B, F&gt;(<span class="self">self</span>, init: B, <span class="kw-2">mut </span>f: F) -&gt; B
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
        F: FnMut(B, <span class="self">Self</span>::Item) -&gt; B,
    {
        <span class="self">self</span>.inner
            .fold(init, |acc, bucket| <span class="kw">unsafe </span>{ f(acc, bucket.as_ref()) })
    }
}
...
<span class="doccomment">/// A mutable iterator over the entries of a `HashTable` in arbitrary order.
/// The iterator element type is `&amp;'a mut T`.
///
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Iterator <span class="kw">for </span>IterMut&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    {
        <span class="self">self</span>.inner
            .fold(init, |acc, bucket| <span class="kw">unsafe </span>{ f(acc, bucket.as_mut()) })
    }
}
...
<span class="doccomment">/// An owning iterator over the entries of a `HashTable` in arbitrary order.
...
</span><span class="kw">pub struct </span>IntoIter&lt;T, A = Global&gt;
<span class="kw">where
    </span>A: Allocator,
{
...
<span class="kw">impl</span>&lt;T, A&gt; Iterator <span class="kw">for </span>IntoIter&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="kw">type </span>Item = T;
...
<span class="kw">impl</span>&lt;T, A&gt; ExactSizeIterator <span class="kw">for </span>IntoIter&lt;T, A&gt;
<span class="kw">where
    </span>A: Allocator,
{
    <span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
...
<span class="kw">impl</span>&lt;T, A&gt; FusedIterator <span class="kw">for </span>IntoIter&lt;T, A&gt; <span class="kw">where </span>A: Allocator {}

<span class="doccomment">/// A draining iterator over the items of a `HashTable`.
///
...
</span><span class="kw">pub struct </span>Drain&lt;<span class="lifetime">'a</span>, T, A: Allocator = Global&gt; {
    inner: RawDrain&lt;<span class="lifetime">'a</span>, T, A&gt;,
}

<span class="kw">impl</span>&lt;T, A: Allocator&gt; Drain&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="doccomment">/// Returns a iterator of references over the remaining items.
    </span><span class="kw">fn </span>iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Iter&lt;<span class="lifetime">'_</span>, T&gt; {
        Iter {
...
<span class="kw">impl</span>&lt;T, A: Allocator&gt; Iterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">type </span>Item = T;
...
<span class="kw">impl</span>&lt;T, A: Allocator&gt; ExactSizeIterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.inner.len()
    }
}
<span class="kw">impl</span>&lt;T, A: Allocator&gt; FusedIterator <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, T, A&gt; {}

<span class="kw">impl</span>&lt;T: fmt::Debug, A: Allocator&gt; fmt::Debug <span class="kw">for </span>Drain&lt;<span class="lifetime">'_</span>, T, A&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_list().entries(<span class="self">self</span>.iter()).finish()
    }
}

<span class="doccomment">/// A draining iterator over entries of a `HashTable` which don't satisfy the predicate `f`.
///
...
</span><span class="kw">pub struct </span>ExtractIf&lt;<span class="lifetime">'a</span>, T, F, A: Allocator = Global&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;mut </span>T) -&gt; bool,
{
    f: F,
    inner: RawExtractIf&lt;<span class="lifetime">'a</span>, T, A&gt;,
}

<span class="kw">impl</span>&lt;T, F, A: Allocator&gt; Iterator <span class="kw">for </span>ExtractIf&lt;<span class="lifetime">'_</span>, T, F, A&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;mut </span>T) -&gt; bool,
{
    <span class="kw">type </span>Item = T;
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.inner.next(|val| (<span class="self">self</span>.f)(val))
    }
...
<span class="kw">impl</span>&lt;T, F, A: Allocator&gt; FusedIterator <span class="kw">for </span>ExtractIf&lt;<span class="lifetime">'_</span>, T, F, A&gt; <span class="kw">where </span>F: FnMut(<span class="kw-2">&amp;mut </span>T) -&gt; bool {}
