...
</pre></div><pre class="rust"><code><span class="doccomment">//! This crate is a Rust port of Google's high-performance [SwissTable] hash
...
#![cfg_attr(feature = <span class="string">"nightly"</span>, warn(fuzzy_provenance_casts))]
...
<span class="attr">#[cfg(feature = <span class="string">"raw"</span>)]
...
<span class="attr">#[cfg(not(feature = <span class="string">"raw"</span>))]
</span><span class="kw">mod </span>raw;

<span class="kw">mod </span>external_trait_impls;
<span class="kw">mod </span>map;
<span class="attr">#[cfg(feature = <span class="string">"rustc-internal-api"</span>)]
...
<span class="kw">pub mod </span>hash_table {
    <span class="doccomment">//! A hash table implemented with quadratic probing and SIMD lookup.
    </span><span class="kw">pub use </span><span class="kw">crate</span>::table::<span class="kw-2">*</span>;

    <span class="attr">#[cfg(feature = <span class="string">"rayon"</span>)]
    </span><span class="doccomment">/// [rayon]-based parallel iterator types for hash tables.
    /// You will rarely need to interact with it directly unless you have need
    /// to name one of the iterator types.
    ///
    /// [rayon]: https://docs.rs/rayon/1.0/rayon
    </span><span class="kw">pub mod </span>rayon {
        <span class="kw">pub use </span><span class="kw">crate</span>::external_trait_impls::rayon::table::<span class="kw-2">*</span>;
    }
}
...
<span class="kw">pub use </span><span class="kw">crate</span>::table::HashTable;

<span class="attr">#[cfg(feature = <span class="string">"equivalent"</span>)]
</span><span class="kw">pub use </span>equivalent::Equivalent;

<span class="comment">// This is only used as a fallback when building as part of `std`.
</span><span class="attr">#[cfg(not(feature = <span class="string">"equivalent"</span>))]
</span><span class="doccomment">/// Key equivalence trait.
///
...
/// Equivalent values must hash to the same value.
</span><span class="kw">pub trait </span>Equivalent&lt;K: <span class="question-mark">?</span>Sized&gt; {
    <span class="doccomment">/// Checks if this value is equivalent to the given key.
    ///
    ...
    /// the same value.
    </span><span class="kw">fn </span>equivalent(<span class="kw-2">&amp;</span><span class="self">self</span>, key: <span class="kw-2">&amp;</span>K) -&gt; bool;
}

<span class="attr">#[cfg(not(feature = <span class="string">"equivalent"</span>))]
</span><span class="kw">impl</span>&lt;Q: <span class="question-mark">?</span>Sized, K: <span class="question-mark">?</span>Sized&gt; Equivalent&lt;K&gt; <span class="kw">for </span>Q
<span class="kw">where
    </span>Q: Eq,
    K: core::borrow::Borrow&lt;Q&gt;,
{
    <span class="kw">fn </span>equivalent(<span class="kw-2">&amp;</span><span class="self">self</span>, key: <span class="kw-2">&amp;</span>K) -&gt; bool {
        <span class="self">self </span>== key.borrow()
    }
}
