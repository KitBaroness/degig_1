<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/eager-0.1.0/src/eager.rs`."><title>eager.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="eager" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../eager/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="macro">macro_rules!</span> eager{
	(
		$(<span class="macro-nonterminal">$all</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[][][][]]
			]
...
#[doc(hidden)]
</span><span class="macro">macro_rules!</span> eager_internal{
<span class="comment">// Handle return from eager macro expansion
	</span>(
		@from_macro[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt <span class="macro-nonterminal">$prefix</span>:tt[$(<span class="macro-nonterminal">$postfix</span>:tt)<span class="kw-2">*</span>]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		$(<span class="macro-nonterminal">$expanded</span>:tt)*
	) =&gt; {
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[<span class="macro-nonterminal">$lazy $modefix $prefix </span>[]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$expanded</span>)* $(<span class="macro-nonterminal">$postfix</span>)*
		}
	};
<span class="comment">// Decode input stream
	</span>(	<span class="comment">// If the next token is a block, check it (brace type)
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt [$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[<span class="macro-nonterminal">$lazy </span>[][][]]
				[<span class="macro-nonterminal">$lazy $modefix </span>[$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>]{}]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)*
		}
	};
	(	<span class="comment">// If the next token is a block, check it (parenthesis type)
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt [$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
	...
	(	<span class="comment">// If the next token is a block, check it (bracket type)
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt [$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
...
<span class="comment">// eager/lazy mode changes
	</span>(	<span class="comment">// If the next token is an 'eager!' macro call and we are already
		// in eager mode, ignore it, extracting the body. (brace type)
		</span>@check_expansion[
			[[]<span class="macro-nonterminal">$modefix</span>:tt[$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		<span class="macro">eager!</span>{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[]<span class="macro-nonterminal">$modefix</span>[$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)* $(<span class="macro-nonterminal">$rest</span>)*
		}
	};
	(	<span class="comment">// If the next token is an 'eager!' macro call and we are already
	...
	(	<span class="comment">// If the next token is an 'lazy!' macro call and we are already
		// in lazy mode, ignore it, extracting the body. (brace type)
		</span>@check_expansion[
			[[@lazy]<span class="macro-nonterminal">$modefix</span>:tt[$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		<span class="macro">lazy!</span>{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[@lazy]<span class="macro-nonterminal">$modefix</span>[$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)* $(<span class="macro-nonterminal">$rest</span>)*
		}
	...
	(	<span class="comment">// If the next token is an 'eager!' macro call and we are
		// in lazy mode (brace type)
		</span>@check_expansion[
			[[@lazy][][$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		<span class="macro">eager!</span>{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[][$(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)*
		}
	...
	(	<span class="comment">// If the next token is an 'lazy!' macro call and we are
		// in eager mode, ignore it, extracting the body. (brace type)
		</span>@check_expansion[
			[[][][$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		<span class="macro">lazy!</span>{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[@lazy][$(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)*
		}
...
<span class="comment">// end eager/lazy mode switches
	</span>(	<span class="comment">// If the next token isn't any of the above
		// it is safe to add it to the prefix
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt [$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][]]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
		<span class="macro-nonterminal">$next</span>:tt $(<span class="macro-nonterminal">$rest</span>:tt)*
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[<span class="macro-nonterminal">$lazy $modefix</span>[<span class="macro-nonterminal">$next </span>$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$rest</span>)*
		}
	};
<span class="comment">// Done decoding input
// Expanding macros in eager mode
	</span>(	<span class="comment">// When there is no more input, the last input was a macro call,
		// and we are in eager mode, call the macro eagerly
		// (brace type)
		</span>@check_expansion[
			[[]<span class="macro-nonterminal">$modefix</span>:tt[! <span class="macro-nonterminal">$macro_name</span>:tt $(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$postfix</span>:tt)<span class="kw-2">*</span>]{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>}]
			$(<span class="macro-nonterminal">$rest_decoded</span>:tt)*
		]
	)=&gt;{
		<span class="macro-nonterminal">$</span><span class="macro">macro_name!</span>{
			@<span class="macro-nonterminal">eager</span>[
				[[]<span class="macro-nonterminal">$modefix</span>[$(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$postfix</span>)<span class="kw-2">*</span>]]
				$(<span class="macro-nonterminal">$rest_decoded</span>)*
			]
			$(<span class="macro-nonterminal">$body</span>)*
		}
	};
	(	<span class="comment">// When there is no more input and the last input was a macro call,
		// and we are in eager mode, call the macro eagerly
		// (parenthesis type)
		</span>@check_expansion[
			[[]<span class="macro-nonterminal">$modefix</span>:tt[! <span class="macro-nonterminal">$macro_name</span>:tt $(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$postfix</span>:tt)<span class="kw-2">*</span>]($(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>)]
...
<span class="comment">// Promote modefix to input
	</span>(	<span class="comment">// When there is no more input, but there is some postfix,
		// if the current mode is eager, redecode the postfix in lazy mode
		</span>@check_expansion[
			[[][$(<span class="macro-nonterminal">$modefix</span>:tt)+] <span class="macro-nonterminal">$prefix</span>:tt []]
			$(<span class="macro-nonterminal">$rest</span>:tt)*
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[[@lazy][] <span class="macro-nonterminal">$prefix </span>[]]
				$(<span class="macro-nonterminal">$rest</span>)*
			]
			$(<span class="macro-nonterminal">$modefix</span>)+
		}
	};
	(	<span class="comment">// When there is no more input, but there is some postfix,
		// if the current mode is lazy, redecode the postfix in eager mode
		</span>@check_expansion[
			[[@lazy][$(<span class="macro-nonterminal">$modefix</span>:tt)+] <span class="macro-nonterminal">$prefix</span>:tt []]
			$(<span class="macro-nonterminal">$rest</span>:tt)*
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
...
<span class="comment">// end Promote modefix to input
// Promote prefix
	</span>(	<span class="comment">// When there is no more input and the last input wasn't a macro call in eager mode
		// insert it into the previous block (brace type)
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy_0</span>:tt <span class="macro-nonterminal">$modefix_0</span>:tt [<span class="macro-nonterminal">$last</span>:tt $(<span class="macro-nonterminal">$last_rest</span>:tt)<span class="kw-2">*</span>] []]
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt <span class="macro-nonterminal">$prefix</span>:tt <span class="macro-nonterminal">$postfix</span>:tt {$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>}]
			$(<span class="macro-nonterminal">$rest</span>:tt)*
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[<span class="macro-nonterminal">$lazy_0 $modefix_0 </span>[$(<span class="macro-nonterminal">$last_rest</span>)<span class="kw-2">*</span>] []]
				[<span class="macro-nonterminal">$lazy $modefix $prefix $postfix </span>{<span class="macro-nonterminal">$last </span>$(<span class="macro-nonterminal">$body</span>)<span class="kw-2">*</span>}]
				$(<span class="macro-nonterminal">$rest</span>)*
			]
		}
	};
	(	<span class="comment">// When there is no more input and the last input wasn't a macro call in eager mode
	...
	(	<span class="comment">// When there is no more input, prefix or postfix,
		// but there is a previous block, remove the input catcher
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy_0</span>:tt[][][]]
			$([<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt <span class="macro-nonterminal">$prefix</span>:tt <span class="macro-nonterminal">$postfix</span>:tt <span class="macro-nonterminal">$body</span>:tt])+
			
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				$([<span class="macro-nonterminal">$lazy $modefix $prefix $postfix $body</span>])+
			]
		}
	};
<span class="comment">// end promote prefix
// Promote block to prefix
	</span>(	<span class="comment">// When there is no more input but a block,
		// the block must have already been checked,
		// therefore, begin promoting to prefix (brace type)
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt <span class="macro-nonterminal">$modefix</span>:tt [$(<span class="macro-nonterminal">$prefix</span>:tt)<span class="kw-2">*</span>][$(<span class="macro-nonterminal">$postfix</span>:tt)<span class="kw-2">*</span>]{$(<span class="macro-nonterminal">$body</span>:tt)<span class="kw-2">*</span>}]
			$(<span class="macro-nonterminal">$rest</span>:tt)*
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@check_expansion[
				[<span class="macro-nonterminal">$lazy $modefix </span>[{$(<span class="macro-nonterminal">$body</span>)<span class="kw-2">*</span>} $(<span class="macro-nonterminal">$prefix</span>)<span class="kw-2">*</span>][]]
				$(<span class="macro-nonterminal">$rest</span>)*
			]
			$(<span class="macro-nonterminal">$postfix</span>)*
		}
	};
	(	<span class="comment">// When there is no more input and but a block
		// the block must have already been checked,
...
<span class="comment">// End Promote block to prefix
// Finished
	</span>(	<span class="comment">// When there is no more input and no block
		// output the result, reversing it to ensure correct order
		</span>@check_expansion[
			[<span class="macro-nonterminal">$lazy</span>:tt [][$(<span class="macro-nonterminal">$result</span>:tt)<span class="kw-2">*</span>][]]
		]
	)=&gt;{
		<span class="macro">eager_internal!</span>{
			@reverse_tt[
				[$(<span class="macro-nonterminal">$result</span>)<span class="kw-2">*</span>]
				[]
			]
		}
	};
	
<span class="comment">// To finish, reverse-output the result
	</span>(
		<span class="comment">// While there is more to reverse
		</span>@reverse_tt[
			[<span class="macro-nonterminal">$to_reverse_next</span>:tt $(<span class="macro-nonterminal">$to_reverse_rest</span>:tt)+]
			[$(<span class="macro-nonterminal">$reversed</span>:tt)<span class="kw-2">*</span>]
		]
	) =&gt; {
		<span class="macro">eager_internal!</span>{
			@reverse_tt[
				[$(<span class="macro-nonterminal">$to_reverse_rest</span>)+]
				[<span class="macro-nonterminal">$to_reverse_next </span>$(<span class="macro-nonterminal">$reversed</span>)<span class="kw-2">*</span>]
			]
		}
	};
	(
		<span class="comment">// Done reversing
		</span>@reverse_tt[
			[<span class="macro-nonterminal">$to_reverse_last</span>:tt]
			[$(<span class="macro-nonterminal">$reversed</span>:tt)<span class="kw-2">*</span>]
		]
	) =&gt; {
		<span class="macro-nonterminal">$to_reverse_last </span>$(<span class="macro-nonterminal">$reversed</span>)*
	};
}
