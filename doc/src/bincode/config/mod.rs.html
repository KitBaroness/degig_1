...
</pre></div><pre class="rust"><code><span class="doccomment">//! `bincode` uses a Builder-pattern to configure the Serializers and Deserializers in this
