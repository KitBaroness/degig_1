...
</span><span class="kw">mod </span>index_macro;
<span class="kw">use </span>core::default::Default;
<span class="kw">pub use </span>core::ops::IndexMut;
<span class="kw">pub use </span>core::ops::Index;
<span class="kw">pub use </span>core::ops::Range;
<span class="kw">pub trait </span>SliceWrapper&lt;T&gt; {
...
<span class="kw">pub trait </span>SliceWrapperMut&lt;T&gt; : SliceWrapper&lt;T&gt; {
  <span class="kw">fn </span>slice_mut (<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; &amp; <span class="kw-2">mut </span>[T];
}

<span class="kw">pub trait </span>AllocatedSlice&lt;T&gt;
    : SliceWrapperMut&lt;T&gt; + SliceWrapper&lt;T&gt; + Default {
}

<span class="kw">impl</span>&lt;T, U&gt; AllocatedSlice&lt;T&gt; <span class="kw">for </span>U <span class="kw">where </span>U : SliceWrapperMut&lt;T&gt; + SliceWrapper&lt;T&gt; + Default {
