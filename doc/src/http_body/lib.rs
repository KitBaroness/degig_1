...
</pre></div><pre class="rust"><code><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/http-body/0.4.6"</span>)]
#![deny(
...
</span><span class="kw">mod </span>collect;
...
<span class="kw">pub use </span><span class="self">self</span>::collect::Collected;
...
///
    ...
    <span class="doccomment">/// Turn this body into [`Collected`] body which will collect all the DATA frames
    /// and trailers.
    </span><span class="kw">fn </span>collect(<span class="self">self</span>) -&gt; <span class="kw">crate</span>::collect::Collect&lt;<span class="self">Self</span>&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
    {
        collect::Collect::new(<span class="self">self</span>)
    }
