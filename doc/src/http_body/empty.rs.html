...
</pre></div><pre class="rust"><code><span class="kw">use super</span>::{Body, SizeHint};
...
<span class="doccomment">/// A body that is always empty.
</span><span class="kw">pub struct </span>Empty&lt;D&gt; {
    _marker: PhantomData&lt;<span class="kw">fn</span>() -&gt; D&gt;,
}

<span class="kw">impl</span>&lt;D&gt; Empty&lt;D&gt; {
    <span class="doccomment">/// Create a new `Empty`.
    </span><span class="kw">pub fn </span>new() -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::default()
    }
}

<span class="kw">impl</span>&lt;D: Buf&gt; Body <span class="kw">for </span>Empty&lt;D&gt; {
    ...
    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; SizeHint {
        SizeHint::with_exact(<span class="number">0</span>)
    }
}

<span class="kw">impl</span>&lt;D&gt; fmt::Debug <span class="kw">for </span>Empty&lt;D&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Empty"</span>).finish()
    }
}

<span class="kw">impl</span>&lt;D&gt; Default <span class="kw">for </span>Empty&lt;D&gt; {
...
<span class="kw">impl</span>&lt;D&gt; Clone <span class="kw">for </span>Empty&lt;D&gt; {
...
<span class="kw">impl</span>&lt;D&gt; Copy <span class="kw">for </span>Empty&lt;D&gt; {}
