<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/byteorder-1.5.0/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="byteorder" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../byteorder/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="comment">// When testing under miri, we disable tests that take too long. But this
...
</span><span class="kw">pub use </span><span class="kw">crate</span>::io::{ReadBytesExt, WriteBytesExt};

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>io;

<span class="attr">#[inline]
</span><span class="kw">fn </span>extend_sign(val: u64, nbytes: usize) -&gt; i64 {
    <span class="kw">let </span>shift = (<span class="number">8 </span>- nbytes) * <span class="number">8</span>;
    (val &lt;&lt; shift) <span class="kw">as </span>i64 &gt;&gt; shift
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>extend_sign128(val: u128, nbytes: usize) -&gt; i128 {
    <span class="kw">let </span>shift = (<span class="number">16 </span>- nbytes) * <span class="number">8</span>;
    (val &lt;&lt; shift) <span class="kw">as </span>i128 &gt;&gt; shift
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>unextend_sign(val: i64, nbytes: usize) -&gt; u64 {
    <span class="kw">let </span>shift = (<span class="number">8 </span>- nbytes) * <span class="number">8</span>;
    (val &lt;&lt; shift) <span class="kw">as </span>u64 &gt;&gt; shift
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>unextend_sign128(val: i128, nbytes: usize) -&gt; u128 {
    <span class="kw">let </span>shift = (<span class="number">16 </span>- nbytes) * <span class="number">8</span>;
    (val &lt;&lt; shift) <span class="kw">as </span>u128 &gt;&gt; shift
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>pack_size(n: u64) -&gt; usize {
    <span class="kw">if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">8 </span>{
        <span class="number">1
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">16 </span>{
        <span class="number">2
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">24 </span>{
        <span class="number">3
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">32 </span>{
        <span class="number">4
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">40 </span>{
        <span class="number">5
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">48 </span>{
        <span class="number">6
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">56 </span>{
        <span class="number">7
...
<span class="attr">#[inline]
</span><span class="kw">fn </span>pack_size128(n: u128) -&gt; usize {
    <span class="kw">if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">8 </span>{
        <span class="number">1
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">16 </span>{
        <span class="number">2
        ...
        <span class="number">7
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">64 </span>{
        <span class="number">8
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">72 </span>{
        <span class="number">9
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">80 </span>{
        <span class="number">10
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">88 </span>{
        <span class="number">11
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">96 </span>{
        <span class="number">12
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">104 </span>{
        <span class="number">13
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">112 </span>{
        <span class="number">14
    </span>} <span class="kw">else if </span>n &lt; <span class="number">1 </span>&lt;&lt; <span class="number">120 </span>{
...
<span class="kw">mod </span>private {
    <span class="doccomment">/// Sealed stops crates other than byteorder from implementing any traits
    /// that use it.
    </span><span class="kw">pub trait </span>Sealed {}
    <span class="kw">impl </span>Sealed <span class="kw">for </span><span class="kw">super</span>::LittleEndian {}
    <span class="kw">impl </span>Sealed <span class="kw">for </span><span class="kw">super</span>::BigEndian {}
}

<span class="doccomment">/// `ByteOrder` describes types that can serialize integers as bytes.
///
...
/// [`BigEndian`]: enum.BigEndian.html
/// [`LittleEndian`]: enum.LittleEndian.html
</span><span class="kw">pub trait </span>ByteOrder:
    Clone
    + Copy
    + Debug
    + Default
    ...
    + private::Sealed
{
    <span class="doccomment">/// Reads an unsigned 16 bit integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 2`.
    </span><span class="kw">fn </span>read_u16(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u16;

    <span class="doccomment">/// Reads an unsigned 24 bit integer from `buf`, stored in u32.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_u24(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u32 {
        <span class="self">Self</span>::read_uint(buf, <span class="number">3</span>) <span class="kw">as </span>u32
    }

    <span class="doccomment">/// Reads an unsigned 32 bit integer from `buf`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_u32(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>read_u32(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u32;

    <span class="doccomment">/// Reads an unsigned 48 bit integer from `buf`, stored in u64.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_u48(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u64 {
        <span class="self">Self</span>::read_uint(buf, <span class="number">6</span>) <span class="kw">as </span>u64
    }

    <span class="doccomment">/// Reads an unsigned 64 bit integer from `buf`.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_u64(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u64;

    <span class="doccomment">/// Reads an unsigned 128 bit integer from `buf`.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_u128(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u128;

    <span class="doccomment">/// Reads an unsigned n-bytes integer from `buf`.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_uint(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; u64;
    ...
    /// ```
    </span><span class="kw">fn </span>read_uint128(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; u128;

    <span class="doccomment">/// Writes an unsigned 16 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 2`.
    ...
    /// ```
    </span><span class="kw">fn </span>write_u16(buf: <span class="kw-2">&amp;mut </span>[u8], n: u16);

    <span class="doccomment">/// Writes an unsigned 24 bit integer `n` to `buf`, stored in u32.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 3`.
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_u24(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>write_u24(buf: <span class="kw-2">&amp;mut </span>[u8], n: u32) {
        <span class="self">Self</span>::write_uint(buf, n <span class="kw">as </span>u64, <span class="number">3</span>)
    }

    <span class="doccomment">/// Writes an unsigned 32 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 4`.
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_u32(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>write_u32(buf: <span class="kw-2">&amp;mut </span>[u8], n: u32);

    <span class="doccomment">/// Writes an unsigned 48 bit integer `n` to `buf`, stored in u64.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 6`.
    ...
    /// assert_eq!(1_000_000_000_000, LittleEndian::read_u48(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>write_u48(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64) {
        <span class="self">Self</span>::write_uint(buf, n <span class="kw">as </span>u64, <span class="number">6</span>)
    }

    <span class="doccomment">/// Writes an unsigned 64 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 8`.
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_u64(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>write_u64(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64);

    <span class="doccomment">/// Writes an unsigned 128 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 16`.
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_u128(&amp;buf));
    /// ```
    </span><span class="kw">fn </span>write_u128(buf: <span class="kw-2">&amp;mut </span>[u8], n: u128);

    <span class="doccomment">/// Writes an unsigned integer `n` to `buf` using only `nbytes`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_uint(&amp;buf, 3));
    /// ```
    </span><span class="kw">fn </span>write_uint(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64, nbytes: usize);
    ...
    /// assert_eq!(1_000_000, LittleEndian::read_uint128(&amp;buf, 3));
    /// ```
    </span><span class="kw">fn </span>write_uint128(buf: <span class="kw-2">&amp;mut </span>[u8], n: u128, nbytes: usize);

    <span class="doccomment">/// Reads a signed 16 bit integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 2`.
    ...
    </span><span class="kw">fn </span>read_i16(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i16 {
        <span class="self">Self</span>::read_u16(buf) <span class="kw">as </span>i16
    }

    <span class="doccomment">/// Reads a signed 24 bit integer from `buf`, stored in i32.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 3`.
    ...
    </span><span class="kw">fn </span>read_i24(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i32 {
        <span class="self">Self</span>::read_int(buf, <span class="number">3</span>) <span class="kw">as </span>i32
    }

    <span class="doccomment">/// Reads a signed 32 bit integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 4`.
    ...
    </span><span class="kw">fn </span>read_i32(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i32 {
        <span class="self">Self</span>::read_u32(buf) <span class="kw">as </span>i32
    }

    <span class="doccomment">/// Reads a signed 48 bit integer from `buf`, stored in i64.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 6`.
    ...
    </span><span class="kw">fn </span>read_i48(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i64 {
        <span class="self">Self</span>::read_int(buf, <span class="number">6</span>) <span class="kw">as </span>i64
    }

    <span class="doccomment">/// Reads a signed 64 bit integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 8`.
    ...
    </span><span class="kw">fn </span>read_i64(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i64 {
        <span class="self">Self</span>::read_u64(buf) <span class="kw">as </span>i64
    }

    <span class="doccomment">/// Reads a signed 128 bit integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 16`.
    ...
    </span><span class="kw">fn </span>read_i128(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; i128 {
        <span class="self">Self</span>::read_u128(buf) <span class="kw">as </span>i128
    }

    <span class="doccomment">/// Reads a signed n-bytes integer from `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `nbytes &lt; 1` or `nbytes &gt; 8` or
    ...
    </span><span class="kw">fn </span>read_int(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; i64 {
        extend_sign(<span class="self">Self</span>::read_uint(buf, nbytes), nbytes)
    }
    ...
    </span><span class="kw">fn </span>read_int128(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; i128 {
        extend_sign128(<span class="self">Self</span>::read_uint128(buf, nbytes), nbytes)
    }

    <span class="doccomment">/// Reads a IEEE754 single-precision (4 bytes) floating point number.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 4`.
    ...
    </span><span class="kw">fn </span>read_f32(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; f32 {
        f32::from_bits(<span class="self">Self</span>::read_u32(buf))
    }

    <span class="doccomment">/// Reads a IEEE754 double-precision (8 bytes) floating point number.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 8`.
    ...
    </span><span class="kw">fn </span>read_f64(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; f64 {
        f64::from_bits(<span class="self">Self</span>::read_u64(buf))
    }

    <span class="doccomment">/// Writes a signed 16 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 2`.
    ...
    </span><span class="kw">fn </span>write_i16(buf: <span class="kw-2">&amp;mut </span>[u8], n: i16) {
        <span class="self">Self</span>::write_u16(buf, n <span class="kw">as </span>u16)
    }

    <span class="doccomment">/// Writes a signed 24 bit integer `n` to `buf`, stored in i32.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 3`.
    ...
    </span><span class="kw">fn </span>write_i24(buf: <span class="kw-2">&amp;mut </span>[u8], n: i32) {
        <span class="self">Self</span>::write_int(buf, n <span class="kw">as </span>i64, <span class="number">3</span>)
    }

    <span class="doccomment">/// Writes a signed 32 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 4`.
    ...
    </span><span class="kw">fn </span>write_i32(buf: <span class="kw-2">&amp;mut </span>[u8], n: i32) {
        <span class="self">Self</span>::write_u32(buf, n <span class="kw">as </span>u32)
    }

    <span class="doccomment">/// Writes a signed 48 bit integer `n` to `buf`, stored in i64.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 6`.
    ...
    </span><span class="kw">fn </span>write_i48(buf: <span class="kw-2">&amp;mut </span>[u8], n: i64) {
        <span class="self">Self</span>::write_int(buf, n <span class="kw">as </span>i64, <span class="number">6</span>)
    }

    <span class="doccomment">/// Writes a signed 64 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 8`.
    ...
    </span><span class="kw">fn </span>write_i64(buf: <span class="kw-2">&amp;mut </span>[u8], n: i64) {
        <span class="self">Self</span>::write_u64(buf, n <span class="kw">as </span>u64)
    }

    <span class="doccomment">/// Writes a signed 128 bit integer `n` to `buf`.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 16`.
    ...
    </span><span class="kw">fn </span>write_i128(buf: <span class="kw-2">&amp;mut </span>[u8], n: i128) {
        <span class="self">Self</span>::write_u128(buf, n <span class="kw">as </span>u128)
    }

    <span class="doccomment">/// Writes a signed integer `n` to `buf` using only `nbytes`.
    ///
    /// # Panics
    ///
    /// If `n` is not representable in `nbytes`, or if `nbytes` is `&gt; 8`, then
    ...
    </span><span class="kw">fn </span>write_int(buf: <span class="kw-2">&amp;mut </span>[u8], n: i64, nbytes: usize) {
        <span class="self">Self</span>::write_uint(buf, unextend_sign(n, nbytes), nbytes)
    }
    ...
    </span><span class="kw">fn </span>write_int128(buf: <span class="kw-2">&amp;mut </span>[u8], n: i128, nbytes: usize) {
        <span class="self">Self</span>::write_uint128(buf, unextend_sign128(n, nbytes), nbytes)
    }

    <span class="doccomment">/// Writes a IEEE754 single-precision (4 bytes) floating point number.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 4`.
    ...
    </span><span class="kw">fn </span>write_f32(buf: <span class="kw-2">&amp;mut </span>[u8], n: f32) {
        <span class="self">Self</span>::write_u32(buf, n.to_bits())
    }

    <span class="doccomment">/// Writes a IEEE754 double-precision (8 bytes) floating point number.
    ///
    /// # Panics
    ///
    /// Panics when `buf.len() &lt; 8`.
    ...
    </span><span class="kw">fn </span>write_f64(buf: <span class="kw-2">&amp;mut </span>[u8], n: f64) {
        <span class="self">Self</span>::write_u64(buf, n.to_bits())
    }

    <span class="doccomment">/// Reads unsigned 16 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>read_u16_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u16]);
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>read_u32_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u32]);
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>read_u64_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u64]);

    <span class="doccomment">/// Reads unsigned 128 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>read_u128_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u128]);

    <span class="doccomment">/// Reads signed 16 bit integers from `src` to `dst`.
    ///
    /// # Panics
    ///
    ...
    </span><span class="kw">fn </span>read_i16_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[i16]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u16, dst.len())
        };
        <span class="self">Self</span>::read_u16_into(src, dst)
    }

    <span class="doccomment">/// Reads signed 32 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `src.len() != 4*dst.len()`.
    ...
    </span><span class="kw">fn </span>read_i32_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[i32]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u32, dst.len())
        };
        <span class="self">Self</span>::read_u32_into(src, dst);
    }

    <span class="doccomment">/// Reads signed 64 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `src.len() != 8*dst.len()`.
    ...
    </span><span class="kw">fn </span>read_i64_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[i64]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u64, dst.len())
        };
        <span class="self">Self</span>::read_u64_into(src, dst);
    }

    <span class="doccomment">/// Reads signed 128 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `src.len() != 16*dst.len()`.
    ...
    </span><span class="kw">fn </span>read_i128_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[i128]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u128, dst.len())
        };
        <span class="self">Self</span>::read_u128_into(src, dst);
    }

    <span class="doccomment">/// Reads IEEE754 single-precision (4 bytes) floating point numbers from
    /// `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    </span><span class="kw">fn </span>read_f32_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[f32]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            <span class="kw">const _</span>: () = <span class="macro">assert!</span>(align_of::&lt;u32&gt;() &lt;= align_of::&lt;f32&gt;());
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u32, dst.len())
        };
        <span class="self">Self</span>::read_u32_into(src, dst);
    }
    ...
    #[deprecated(since = <span class="string">"1.3.0"</span>, note = <span class="string">"please use `read_f32_into` instead"</span>)]
    </span><span class="kw">fn </span>read_f32_into_unchecked(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[f32]) {
        <span class="self">Self</span>::read_f32_into(src, dst);
    }
    ...
    </span><span class="kw">fn </span>read_f64_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[f64]) {
        <span class="kw">let </span>dst = <span class="kw">unsafe </span>{
            <span class="kw">const _</span>: () = <span class="macro">assert!</span>(align_of::&lt;u64&gt;() &lt;= align_of::&lt;f64&gt;());
            slice::from_raw_parts_mut(dst.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u64, dst.len())
        };
        <span class="self">Self</span>::read_u64_into(src, dst);
    }
    ...
    #[deprecated(since = <span class="string">"1.3.0"</span>, note = <span class="string">"please use `read_f64_into` instead"</span>)]
    </span><span class="kw">fn </span>read_f64_into_unchecked(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[f64]) {
        <span class="self">Self</span>::read_f64_into(src, dst);
    }

    <span class="doccomment">/// Writes unsigned 16 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_u16_into(src: <span class="kw-2">&amp;</span>[u16], dst: <span class="kw-2">&amp;mut </span>[u8]);

    <span class="doccomment">/// Writes unsigned 32 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_u32_into(src: <span class="kw-2">&amp;</span>[u32], dst: <span class="kw-2">&amp;mut </span>[u8]);

    <span class="doccomment">/// Writes unsigned 64 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_u64_into(src: <span class="kw-2">&amp;</span>[u64], dst: <span class="kw-2">&amp;mut </span>[u8]);

    <span class="doccomment">/// Writes unsigned 128 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_u128_into(src: <span class="kw-2">&amp;</span>[u128], dst: <span class="kw-2">&amp;mut </span>[u8]);

    <span class="doccomment">/// Writes signed 8 bit integers from `src` into `dst`.
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_i8_into(src: <span class="kw-2">&amp;</span>[i8], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u8, src.len())
        };
        dst.copy_from_slice(src);
    }

    <span class="doccomment">/// Writes signed 16 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_i16_into(src: <span class="kw-2">&amp;</span>[i16], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u16, src.len())
        };
        <span class="self">Self</span>::write_u16_into(src, dst);
    }

    <span class="doccomment">/// Writes signed 32 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `dst.len() != 4*src.len()`.
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_i32_into(src: <span class="kw-2">&amp;</span>[i32], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u32, src.len())
        };
        <span class="self">Self</span>::write_u32_into(src, dst);
    }

    <span class="doccomment">/// Writes signed 64 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `dst.len() != 8*src.len()`.
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_i64_into(src: <span class="kw-2">&amp;</span>[i64], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u64, src.len())
        };
        <span class="self">Self</span>::write_u64_into(src, dst);
    }

    <span class="doccomment">/// Writes signed 128 bit integers from `src` into `dst`.
    ///
    /// # Panics
    ///
    /// Panics when `dst.len() != 16*src.len()`.
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_i128_into(src: <span class="kw-2">&amp;</span>[i128], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u128, src.len())
        };
        <span class="self">Self</span>::write_u128_into(src, dst);
    }

    <span class="doccomment">/// Writes IEEE754 single-precision (4 bytes) floating point numbers from
    /// `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_f32_into(src: <span class="kw-2">&amp;</span>[f32], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u32, src.len())
        };
        <span class="self">Self</span>::write_u32_into(src, dst);
    ...
    <span class="doccomment">/// Writes IEEE754 double-precision (8 bytes) floating point numbers from
    /// `src` into `dst`.
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(numbers_given, numbers_got);
    /// ```
    </span><span class="kw">fn </span>write_f64_into(src: <span class="kw-2">&amp;</span>[f64], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts(src.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>u64, src.len())
        };
        <span class="self">Self</span>::write_u64_into(src, dst);
    ...
    <span class="doccomment">/// Converts the given slice of unsigned 16 bit integers to a particular
    /// endianness.
    ///
    ...
    /// ```
    </span><span class="kw">fn </span>from_slice_u16(numbers: <span class="kw-2">&amp;mut </span>[u16]);

    <span class="doccomment">/// Converts the given slice of unsigned 32 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    /// ```
    </span><span class="kw">fn </span>from_slice_u32(numbers: <span class="kw-2">&amp;mut </span>[u32]);

    <span class="doccomment">/// Converts the given slice of unsigned 64 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    /// ```
    </span><span class="kw">fn </span>from_slice_u64(numbers: <span class="kw-2">&amp;mut </span>[u64]);

    <span class="doccomment">/// Converts the given slice of unsigned 128 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    /// ```
    </span><span class="kw">fn </span>from_slice_u128(numbers: <span class="kw-2">&amp;mut </span>[u128]);

    <span class="doccomment">/// Converts the given slice of signed 16 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    </span><span class="kw">fn </span>from_slice_i16(src: <span class="kw-2">&amp;mut </span>[i16]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(src.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u16, src.len())
        };
        <span class="self">Self</span>::from_slice_u16(src);
    }

    <span class="doccomment">/// Converts the given slice of signed 32 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    </span><span class="kw">fn </span>from_slice_i32(src: <span class="kw-2">&amp;mut </span>[i32]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(src.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u32, src.len())
        };
        <span class="self">Self</span>::from_slice_u32(src);
    }

    <span class="doccomment">/// Converts the given slice of signed 64 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    </span><span class="kw">fn </span>from_slice_i64(src: <span class="kw-2">&amp;mut </span>[i64]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(src.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u64, src.len())
        };
        <span class="self">Self</span>::from_slice_u64(src);
    }

    <span class="doccomment">/// Converts the given slice of signed 128 bit integers to a particular
    /// endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    ...
    </span><span class="kw">fn </span>from_slice_i128(src: <span class="kw-2">&amp;mut </span>[i128]) {
        <span class="kw">let </span>src = <span class="kw">unsafe </span>{
            slice::from_raw_parts_mut(src.as_mut_ptr() <span class="kw">as </span><span class="kw-2">*mut </span>u128, src.len())
        };
        <span class="self">Self</span>::from_slice_u128(src);
    }

    <span class="doccomment">/// Converts the given slice of IEEE754 single-precision (4 bytes) floating
    /// point numbers to a particular endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    </span><span class="kw">fn </span>from_slice_f32(numbers: <span class="kw-2">&amp;mut </span>[f32]);

    <span class="doccomment">/// Converts the given slice of IEEE754 double-precision (8 bytes) floating
    /// point numbers to a particular endianness.
    ///
    /// If the endianness matches the endianness of the host platform, then
    /// this is a no-op.
    </span><span class="kw">fn </span>from_slice_f64(numbers: <span class="kw-2">&amp;mut </span>[f64]);
}

<span class="doccomment">/// Defines big-endian serialization.
///
...
</span><span class="kw">pub enum </span>BigEndian {}

<span class="kw">impl </span>Default <span class="kw">for </span>BigEndian {
    <span class="kw">fn </span>default() -&gt; BigEndian {
        <span class="macro">panic!</span>(<span class="string">"BigEndian default"</span>)
    }
}

<span class="doccomment">/// A type alias for [`BigEndian`].
///
/// [`BigEndian`]: enum.BigEndian.html
</span><span class="kw">pub type </span>BE = BigEndian;

<span class="doccomment">/// Defines little-endian serialization.
///
/// Note that this type has no value constructor. It is used purely at the
/// type level.
///
...
</span><span class="kw">pub enum </span>LittleEndian {}

<span class="kw">impl </span>Default <span class="kw">for </span>LittleEndian {
    <span class="kw">fn </span>default() -&gt; LittleEndian {
        <span class="macro">panic!</span>(<span class="string">"LittleEndian default"</span>)
    }
}

<span class="doccomment">/// A type alias for [`LittleEndian`].
///
/// [`LittleEndian`]: enum.LittleEndian.html
</span><span class="kw">pub type </span>LE = LittleEndian;

<span class="doccomment">/// Defines network byte order serialization.
///
...
///
/// [`BigEndian`]: enum.BigEndian.html
</span><span class="kw">pub type </span>NetworkEndian = BigEndian;

<span class="doccomment">/// Defines system native-endian serialization.
///
/// Note that this type has no value constructor. It is used purely at the
/// type level.
///
...
</span><span class="kw">pub type </span>NativeEndian = LittleEndian;
...
</span><span class="kw">pub type </span>NativeEndian = BigEndian;

<span class="doccomment">/// Copies a &amp;[u8] $src into a &amp;mut [$ty] $dst for the endianness given by
/// $from_bytes (must be either from_be_bytes or from_le_bytes).
///
/// Panics if $src.len() != $dst.len() * size_of::&lt;$ty&gt;().
</span><span class="macro">macro_rules!</span> read_slice {
    (<span class="macro-nonterminal">$src</span>:expr, <span class="macro-nonterminal">$dst</span>:expr, <span class="macro-nonterminal">$ty</span>:ty, <span class="macro-nonterminal">$from_bytes</span>:ident) =&gt; {{
        <span class="kw">const </span>SIZE: usize = core::mem::size_of::&lt;<span class="macro-nonterminal">$ty</span>&gt;();
        <span class="comment">// Check types:
        </span><span class="kw">let </span>src: <span class="kw-2">&amp;</span>[u8] = <span class="macro-nonterminal">$src</span>;
        <span class="kw">let </span>dst: <span class="kw-2">&amp;mut </span>[<span class="macro-nonterminal">$ty</span>] = <span class="macro-nonterminal">$dst</span>;
        <span class="macro">assert_eq!</span>(src.len(), dst.len() * SIZE);
        <span class="kw">for </span>(src, dst) <span class="kw">in </span>src.chunks_exact(SIZE).zip(dst.iter_mut()) {
            <span class="kw-2">*</span>dst = &lt;<span class="macro-nonterminal">$ty</span>&gt;::<span class="macro-nonterminal">$from_bytes</span>(src.try_into().unwrap());
        }
    }};
}

<span class="doccomment">/// Copies a &amp;[$ty] $src into a &amp;mut [u8] $dst for the endianness given by
/// $from_bytes (must be either from_be_bytes or from_le_bytes).
///
/// Panics if $src.len() * size_of::&lt;$ty&gt;() != $dst.len().
</span><span class="macro">macro_rules!</span> write_slice {
    (<span class="macro-nonterminal">$src</span>:expr, <span class="macro-nonterminal">$dst</span>:expr, <span class="macro-nonterminal">$ty</span>:ty, <span class="macro-nonterminal">$to_bytes</span>:ident) =&gt; {{
        <span class="kw">const </span>SIZE: usize = core::mem::size_of::&lt;<span class="macro-nonterminal">$ty</span>&gt;();
        <span class="comment">// Check types:
        </span><span class="kw">let </span>src: <span class="kw-2">&amp;</span>[<span class="macro-nonterminal">$ty</span>] = <span class="macro-nonterminal">$src</span>;
        <span class="kw">let </span>dst: <span class="kw-2">&amp;mut </span>[u8] = <span class="macro-nonterminal">$dst</span>;
        <span class="macro">assert_eq!</span>(src.len() * SIZE, dst.len());
        <span class="kw">for </span>(src, dst) <span class="kw">in </span>src.iter().zip(dst.chunks_exact_mut(SIZE)) {
            dst.copy_from_slice(<span class="kw-2">&amp;</span>src.<span class="macro-nonterminal">$to_bytes</span>());
        }
    }};
}

<span class="kw">impl </span>ByteOrder <span class="kw">for </span>BigEndian {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u16(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u16 {
        u16::from_be_bytes(buf[..<span class="number">2</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u32(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u32 {
        u32::from_be_bytes(buf[..<span class="number">4</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u64(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u64 {
        u64::from_be_bytes(buf[..<span class="number">8</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u128(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u128 {
        u128::from_be_bytes(buf[..<span class="number">16</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_uint(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; u64 {
        <span class="kw">let </span><span class="kw-2">mut </span>out = [<span class="number">0</span>; <span class="number">8</span>];
        <span class="macro">assert!</span>(<span class="number">1 </span>&lt;= nbytes &amp;&amp; nbytes &lt;= out.len() &amp;&amp; nbytes &lt;= buf.len());
        <span class="kw">let </span>start = out.len() - nbytes;
        out[start..].copy_from_slice(<span class="kw-2">&amp;</span>buf[..nbytes]);
        u64::from_be_bytes(out)
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_uint128(buf: <span class="kw-2">&amp;</span>[u8], nbytes: usize) -&gt; u128 {
        <span class="kw">let </span><span class="kw-2">mut </span>out = [<span class="number">0</span>; <span class="number">16</span>];
        <span class="macro">assert!</span>(<span class="number">1 </span>&lt;= nbytes &amp;&amp; nbytes &lt;= out.len() &amp;&amp; nbytes &lt;= buf.len());
        <span class="kw">let </span>start = out.len() - nbytes;
        out[start..].copy_from_slice(<span class="kw-2">&amp;</span>buf[..nbytes]);
    ...
    <span class="attr">#[inline]
        ...
        buf[..<span class="number">2</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_be_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u32(buf: <span class="kw-2">&amp;mut </span>[u8], n: u32) {
        buf[..<span class="number">4</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_be_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u64(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64) {
        buf[..<span class="number">8</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_be_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u128(buf: <span class="kw-2">&amp;mut </span>[u8], n: u128) {
        buf[..<span class="number">16</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_be_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_uint(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64, nbytes: usize) {
        <span class="macro">assert!</span>(pack_size(n) &lt;= nbytes &amp;&amp; nbytes &lt;= <span class="number">8</span>);
        <span class="macro">assert!</span>(nbytes &lt;= buf.len());
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>bytes = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>n.to_be() <span class="kw">as </span><span class="kw-2">*const </span>u64 <span class="kw">as </span><span class="kw-2">*const </span>[u8; <span class="number">8</span>]);
            copy_nonoverlapping(
                bytes.as_ptr().offset((<span class="number">8 </span>- nbytes) <span class="kw">as </span>isize),
                buf.as_mut_ptr(),
                nbytes,
            );
        }
    ...
    <span class="attr">#[inline]
        ...
        <span class="macro">assert!</span>(pack_size128(n) &lt;= nbytes &amp;&amp; nbytes &lt;= <span class="number">16</span>);
        <span class="macro">assert!</span>(nbytes &lt;= buf.len());
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>bytes = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>n.to_be() <span class="kw">as </span><span class="kw-2">*const </span>u128 <span class="kw">as </span><span class="kw-2">*const </span>[u8; <span class="number">16</span>]);
            copy_nonoverlapping(
                bytes.as_ptr().offset((<span class="number">16 </span>- nbytes) <span class="kw">as </span>isize),
                buf.as_mut_ptr(),
                nbytes,
            );
        }
    ...
    <span class="attr">#[inline]
        ...
        <span class="macro">read_slice!</span>(src, dst, u16, from_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u32_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u32]) {
        <span class="macro">read_slice!</span>(src, dst, u32, from_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u64_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u64]) {
        <span class="macro">read_slice!</span>(src, dst, u64, from_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u128_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u128]) {
        <span class="macro">read_slice!</span>(src, dst, u128, from_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u16_into(src: <span class="kw-2">&amp;</span>[u16], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u16, to_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u32_into(src: <span class="kw-2">&amp;</span>[u32], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u32, to_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u64_into(src: <span class="kw-2">&amp;</span>[u64], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u64, to_be_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u128_into(src: <span class="kw-2">&amp;</span>[u128], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u128, to_be_bytes);
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"little"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw-2">*</span>n = n.to_be();
            }
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"little"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw">unsafe </span>{
                    <span class="kw">let </span>int = <span class="kw-2">*</span>(n <span class="kw">as </span><span class="kw-2">*const </span>f32 <span class="kw">as </span><span class="kw-2">*const </span>u32);
                    <span class="kw-2">*</span>n = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>int.to_be() <span class="kw">as </span><span class="kw-2">*const </span>u32 <span class="kw">as </span><span class="kw-2">*const </span>f32);
                }
            }
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"little"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw">unsafe </span>{
                    <span class="kw">let </span>int = <span class="kw-2">*</span>(n <span class="kw">as </span><span class="kw-2">*const </span>f64 <span class="kw">as </span><span class="kw-2">*const </span>u64);
                    <span class="kw-2">*</span>n = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>int.to_be() <span class="kw">as </span><span class="kw-2">*const </span>u64 <span class="kw">as </span><span class="kw-2">*const </span>f64);
                }
            }
        }
    }
...
<span class="kw">impl </span>ByteOrder <span class="kw">for </span>LittleEndian {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u16(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u16 {
        u16::from_le_bytes(buf[..<span class="number">2</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u32(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u32 {
        u32::from_le_bytes(buf[..<span class="number">4</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u64(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u64 {
        u64::from_le_bytes(buf[..<span class="number">8</span>].try_into().unwrap())
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u128(buf: <span class="kw-2">&amp;</span>[u8]) -&gt; u128 {
        u128::from_le_bytes(buf[..<span class="number">16</span>].try_into().unwrap())
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>out = [<span class="number">0</span>; <span class="number">8</span>];
        <span class="macro">assert!</span>(<span class="number">1 </span>&lt;= nbytes &amp;&amp; nbytes &lt;= out.len() &amp;&amp; nbytes &lt;= buf.len());
        out[..nbytes].copy_from_slice(<span class="kw-2">&amp;</span>buf[..nbytes]);
    ...
    <span class="attr">#[inline]
        ...
        buf[..<span class="number">2</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_le_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u32(buf: <span class="kw-2">&amp;mut </span>[u8], n: u32) {
        buf[..<span class="number">4</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_le_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u64(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64) {
        buf[..<span class="number">8</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_le_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u128(buf: <span class="kw-2">&amp;mut </span>[u8], n: u128) {
        buf[..<span class="number">16</span>].copy_from_slice(<span class="kw-2">&amp;</span>n.to_le_bytes());
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_uint(buf: <span class="kw-2">&amp;mut </span>[u8], n: u64, nbytes: usize) {
        <span class="macro">assert!</span>(pack_size(n <span class="kw">as </span>u64) &lt;= nbytes &amp;&amp; nbytes &lt;= <span class="number">8</span>);
        <span class="macro">assert!</span>(nbytes &lt;= buf.len());
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>bytes = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>n.to_le() <span class="kw">as </span><span class="kw-2">*const </span>u64 <span class="kw">as </span><span class="kw-2">*const </span>[u8; <span class="number">8</span>]);
    ...
    <span class="attr">#[inline]
        ...
        <span class="macro">assert!</span>(pack_size128(n <span class="kw">as </span>u128) &lt;= nbytes &amp;&amp; nbytes &lt;= <span class="number">16</span>);
        <span class="macro">assert!</span>(nbytes &lt;= buf.len());
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>bytes = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>n.to_le() <span class="kw">as </span><span class="kw-2">*const </span>u128 <span class="kw">as </span><span class="kw-2">*const </span>[u8; <span class="number">16</span>]);
            copy_nonoverlapping(bytes.as_ptr(), buf.as_mut_ptr(), nbytes);
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="macro">read_slice!</span>(src, dst, u16, from_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u32_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u32]) {
        <span class="macro">read_slice!</span>(src, dst, u32, from_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u64_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u64]) {
        <span class="macro">read_slice!</span>(src, dst, u64, from_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>read_u128_into(src: <span class="kw-2">&amp;</span>[u8], dst: <span class="kw-2">&amp;mut </span>[u128]) {
        <span class="macro">read_slice!</span>(src, dst, u128, from_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u16_into(src: <span class="kw-2">&amp;</span>[u16], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u16, to_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u32_into(src: <span class="kw-2">&amp;</span>[u32], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u32, to_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u64_into(src: <span class="kw-2">&amp;</span>[u64], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u64, to_le_bytes);
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>write_u128_into(src: <span class="kw-2">&amp;</span>[u128], dst: <span class="kw-2">&amp;mut </span>[u8]) {
        <span class="macro">write_slice!</span>(src, dst, u128, to_le_bytes);
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"big"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw-2">*</span>n = n.to_le();
            }
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"big"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw">unsafe </span>{
                    <span class="kw">let </span>int = <span class="kw-2">*</span>(n <span class="kw">as </span><span class="kw-2">*const </span>f32 <span class="kw">as </span><span class="kw-2">*const </span>u32);
                    <span class="kw-2">*</span>n = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>int.to_le() <span class="kw">as </span><span class="kw-2">*const </span>u32 <span class="kw">as </span><span class="kw-2">*const </span>f32);
                }
            }
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"big"</span>) {
            <span class="kw">for </span>n <span class="kw">in </span>numbers {
                <span class="kw">unsafe </span>{
                    <span class="kw">let </span>int = <span class="kw-2">*</span>(n <span class="kw">as </span><span class="kw-2">*const </span>f64 <span class="kw">as </span><span class="kw-2">*const </span>u64);
                    <span class="kw-2">*</span>n = <span class="kw-2">*</span>(<span class="kw-2">&amp;</span>int.to_le() <span class="kw">as </span><span class="kw-2">*const </span>u64 <span class="kw">as </span><span class="kw-2">*const </span>f64);
                }
            }
        }
    }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>quickcheck::{Arbitrary, Gen, QuickCheck, StdGen, Testable};
    <span class="kw">use </span>rand::{thread_rng, Rng};

    <span class="kw">pub const </span>U24_MAX: u32 = <span class="number">16_777_215</span>;
    <span class="kw">pub const </span>I24_MAX: i32 = <span class="number">8_388_607</span>;
    <span class="kw">pub const </span>U48_MAX: u64 = <span class="number">281_474_976_710_655</span>;
    <span class="kw">pub const </span>I48_MAX: i64 = <span class="number">140_737_488_355_327</span>;

    <span class="kw">pub const </span>U64_MAX: u64 = ::core::u64::MAX;
    <span class="kw">pub const </span>I64_MAX: u64 = ::core::i64::MAX <span class="kw">as </span>u64;

    <span class="macro">macro_rules!</span> calc_max {
        (<span class="macro-nonterminal">$max</span>:expr, <span class="macro-nonterminal">$bytes</span>:expr) =&gt; {
            <span class="macro">calc_max!</span>(<span class="macro-nonterminal">$max</span>, <span class="macro-nonterminal">$bytes</span>, <span class="number">8</span>)
        };
        (<span class="macro-nonterminal">$max</span>:expr, <span class="macro-nonterminal">$bytes</span>:expr, <span class="macro-nonterminal">$maxbytes</span>:expr) =&gt; {
            (<span class="macro-nonterminal">$max </span>- <span class="number">1</span>) &gt;&gt; (<span class="number">8 </span>* (<span class="macro-nonterminal">$maxbytes </span>- <span class="macro-nonterminal">$bytes</span>))
        };
    }

    <span class="attr">#[derive(Clone, Debug)]
    </span><span class="kw">pub struct </span>Wi128&lt;T&gt;(<span class="kw">pub </span>T);

    <span class="kw">impl</span>&lt;T: Clone&gt; Wi128&lt;T&gt; {
        <span class="kw">pub fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; T {
            <span class="self">self</span>.<span class="number">0</span>.clone()
        }
    }

    <span class="kw">impl</span>&lt;T: PartialEq&gt; PartialEq&lt;T&gt; <span class="kw">for </span>Wi128&lt;T&gt; {
        <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>T) -&gt; bool {
            <span class="self">self</span>.<span class="number">0</span>.eq(other)
        }
    }

    <span class="kw">impl </span>Arbitrary <span class="kw">for </span>Wi128&lt;u128&gt; {
        <span class="kw">fn </span>arbitrary&lt;G: Gen&gt;(gen: <span class="kw-2">&amp;mut </span>G) -&gt; Wi128&lt;u128&gt; {
            <span class="kw">let </span>max = <span class="macro">calc_max!</span>(::core::u128::MAX, gen.size(), <span class="number">16</span>);
            <span class="kw">let </span>output = (gen.gen::&lt;u64&gt;() <span class="kw">as </span>u128)
                | ((gen.gen::&lt;u64&gt;() <span class="kw">as </span>u128) &lt;&lt; <span class="number">64</span>);
            Wi128(output &amp; (max - <span class="number">1</span>))
        }
    }

    <span class="kw">impl </span>Arbitrary <span class="kw">for </span>Wi128&lt;i128&gt; {
        <span class="kw">fn </span>arbitrary&lt;G: Gen&gt;(gen: <span class="kw-2">&amp;mut </span>G) -&gt; Wi128&lt;i128&gt; {
            <span class="kw">let </span>max = <span class="macro">calc_max!</span>(::core::i128::MAX, gen.size(), <span class="number">16</span>);
            <span class="kw">let </span>output = (gen.gen::&lt;i64&gt;() <span class="kw">as </span>i128)
                | ((gen.gen::&lt;i64&gt;() <span class="kw">as </span>i128) &lt;&lt; <span class="number">64</span>);
            Wi128(output &amp; (max - <span class="number">1</span>))
        }
    }

    <span class="kw">pub fn </span>qc_sized&lt;A: Testable&gt;(f: A, size: u64) {
        QuickCheck::new()
            .gen(StdGen::new(thread_rng(), size <span class="kw">as </span>usize))
            .tests(<span class="number">1_00</span>)
            .max_tests(<span class="number">10_000</span>)
            .quickcheck(f);
    }

    <span class="macro">macro_rules!</span> qc_byte_order {
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$ty_int</span>:ty, <span class="macro-nonterminal">$max</span>:expr,
         <span class="macro-nonterminal">$bytes</span>:expr, <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident) =&gt; {
            <span class="attr">#[cfg(not(miri))]
                ...
                </span><span class="kw">use super</span>::{qc_sized, Wi128};
                <span class="kw">use crate</span>::{
                    BigEndian, ByteOrder, LittleEndian, NativeEndian,
                };

                <span class="attr">#[test]
                </span><span class="kw">fn </span>big_endian() {
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        BigEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, n.clone(), <span class="macro-nonterminal">$bytes</span>);
                        n == BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[..<span class="macro-nonterminal">$bytes</span>], <span class="macro-nonterminal">$bytes</span>)
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }

                <span class="attr">#[test]
                </span><span class="kw">fn </span>little_endian() {
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        LittleEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, n.clone(), <span class="macro-nonterminal">$bytes</span>);
                        n == LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[..<span class="macro-nonterminal">$bytes</span>], <span class="macro-nonterminal">$bytes</span>)
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }

                <span class="attr">#[test]
                </span><span class="kw">fn </span>native_endian() {
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        NativeEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, n.clone(), <span class="macro-nonterminal">$bytes</span>);
                        n == NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[..<span class="macro-nonterminal">$bytes</span>], <span class="macro-nonterminal">$bytes</span>)
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }
            }
        ...
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$ty_int</span>:ty, <span class="macro-nonterminal">$max</span>:expr,
         <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident) =&gt; {
            <span class="attr">#[cfg(not(miri))]
            </span><span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="attr">#[allow(unused_imports)]
                </span><span class="kw">use super</span>::{qc_sized, Wi128};
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span>bytes = size_of::&lt;<span class="macro-nonterminal">$ty_int</span>&gt;();
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        BigEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf[<span class="number">16 </span>- bytes..], n.clone());
                        n == BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[<span class="number">16 </span>- bytes..])
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span>bytes = size_of::&lt;<span class="macro-nonterminal">$ty_int</span>&gt;();
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        LittleEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf[..bytes], n.clone());
                        n == LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[..bytes])
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span>bytes = size_of::&lt;<span class="macro-nonterminal">$ty_int</span>&gt;();
                        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="number">16</span>];
                        NativeEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf[..bytes], n.clone());
                        n == NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf[..bytes])
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
            }
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_u16,
        u16,
        ::core::u16::MAX <span class="kw">as </span>u64,
        read_u16,
        write_u16
    );
    <span class="macro">qc_byte_order!</span>(
        prop_i16,
        i16,
        ::core::i16::MAX <span class="kw">as </span>u64,
        read_i16,
        write_i16
    );
    <span class="macro">qc_byte_order!</span>(
        prop_u24,
        u32,
        <span class="kw">crate</span>::test::U24_MAX <span class="kw">as </span>u64,
        read_u24,
        write_u24
    );
    <span class="macro">qc_byte_order!</span>(
        prop_i24,
        i32,
        <span class="kw">crate</span>::test::I24_MAX <span class="kw">as </span>u64,
        read_i24,
        write_i24
    );
    <span class="macro">qc_byte_order!</span>(
        prop_u32,
        u32,
        ::core::u32::MAX <span class="kw">as </span>u64,
        read_u32,
        write_u32
    );
    <span class="macro">qc_byte_order!</span>(
        prop_i32,
        i32,
        ::core::i32::MAX <span class="kw">as </span>u64,
        read_i32,
        write_i32
    );
    <span class="macro">qc_byte_order!</span>(
        prop_u48,
        u64,
        <span class="kw">crate</span>::test::U48_MAX <span class="kw">as </span>u64,
        read_u48,
        write_u48
    );
    <span class="macro">qc_byte_order!</span>(
        prop_i48,
        i64,
        <span class="kw">crate</span>::test::I48_MAX <span class="kw">as </span>u64,
        read_i48,
        write_i48
    );
    <span class="macro">qc_byte_order!</span>(
        prop_u64,
        u64,
        ::core::u64::MAX <span class="kw">as </span>u64,
        read_u64,
        write_u64
    );
    <span class="macro">qc_byte_order!</span>(
        prop_i64,
        i64,
        ::core::i64::MAX <span class="kw">as </span>u64,
        read_i64,
        write_i64
    );
    <span class="macro">qc_byte_order!</span>(
    ...
    <span class="macro">qc_byte_order!</span>(prop_u128, Wi128&lt;u128&gt;, <span class="number">16 </span>+ <span class="number">1</span>, read_u128, write_u128);
    <span class="macro">qc_byte_order!</span>(prop_i128, Wi128&lt;i128&gt;, <span class="number">16 </span>+ <span class="number">1</span>, read_i128, write_i128);

    <span class="macro">qc_byte_order!</span>(
        prop_uint_1,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">1</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_2,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">2</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_3,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">3</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_4,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">4</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_5,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">5</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_6,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">6</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_7,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">7</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_uint_8,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::U64_MAX, <span class="number">8</span>),
    ...
    <span class="macro">qc_byte_order!</span>(
        prop_int_1,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">1</span>),
        <span class="number">1</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_2,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">2</span>),
        <span class="number">2</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_3,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">3</span>),
        <span class="number">3</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_4,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">4</span>),
        <span class="number">4</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_5,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">5</span>),
        <span class="number">5</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_6,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">6</span>),
        <span class="number">6</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_7,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">7</span>),
        <span class="number">7</span>,
        read_int,
        write_int
    );
    <span class="macro">qc_byte_order!</span>(
        prop_int_8,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">super</span>::I64_MAX, <span class="number">8</span>),
        <span class="number">8</span>,
        read_int,
        write_int
    );
    ...
    <span class="comment">// Test that all of the byte conversion functions panic when given a
    // buffer that is too small.
    //
    // These tests are critical to ensure safety, otherwise we might end up
    // with a buffer overflow.
    </span><span class="macro">macro_rules!</span> too_small {
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$maximally_small</span>:expr, <span class="macro-nonterminal">$zero</span>:expr,
         <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident) =&gt; {
            <span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                ...
                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>read_big_endian() {
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>read_little_endian() {
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>read_native_endian() {
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>write_big_endian() {
                    <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    BigEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, <span class="macro-nonterminal">$zero</span>);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>write_little_endian() {
                    <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    LittleEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, <span class="macro-nonterminal">$zero</span>);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>write_native_endian() {
                    <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    NativeEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;mut </span>buf, <span class="macro-nonterminal">$zero</span>);
                }
            }
        };
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$maximally_small</span>:expr, <span class="macro-nonterminal">$read</span>:ident) =&gt; {
            <span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="kw">use crate</span>::{
                    BigEndian, ByteOrder, LittleEndian, NativeEndian,
                };
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf, <span class="macro-nonterminal">$maximally_small </span>+ <span class="number">1</span>);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf, <span class="macro-nonterminal">$maximally_small </span>+ <span class="number">1</span>);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>buf = [<span class="number">0</span>; <span class="macro-nonterminal">$maximally_small</span>];
                    NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>buf, <span class="macro-nonterminal">$maximally_small </span>+ <span class="number">1</span>);
                }
            }
        };
    }

    <span class="macro">too_small!</span>(small_u16, <span class="number">1</span>, <span class="number">0</span>, read_u16, write_u16);
    <span class="macro">too_small!</span>(small_i16, <span class="number">1</span>, <span class="number">0</span>, read_i16, write_i16);
    <span class="macro">too_small!</span>(small_u32, <span class="number">3</span>, <span class="number">0</span>, read_u32, write_u32);
    <span class="macro">too_small!</span>(small_i32, <span class="number">3</span>, <span class="number">0</span>, read_i32, write_i32);
    <span class="macro">too_small!</span>(small_u64, <span class="number">7</span>, <span class="number">0</span>, read_u64, write_u64);
    <span class="macro">too_small!</span>(small_i64, <span class="number">7</span>, <span class="number">0</span>, read_i64, write_i64);
    <span class="macro">too_small!</span>(small_f32, <span class="number">3</span>, <span class="number">0.0</span>, read_f32, write_f32);
    <span class="macro">too_small!</span>(small_f64, <span class="number">7</span>, <span class="number">0.0</span>, read_f64, write_f64);
    <span class="macro">too_small!</span>(small_u128, <span class="number">15</span>, <span class="number">0</span>, read_u128, write_u128);
    <span class="macro">too_small!</span>(small_i128, <span class="number">15</span>, <span class="number">0</span>, read_i128, write_i128);

    <span class="macro">too_small!</span>(small_uint_1, <span class="number">1</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_2, <span class="number">2</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_3, <span class="number">3</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_4, <span class="number">4</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_5, <span class="number">5</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_6, <span class="number">6</span>, read_uint);
    <span class="macro">too_small!</span>(small_uint_7, <span class="number">7</span>, read_uint);

    <span class="macro">too_small!</span>(small_uint128_1, <span class="number">1</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_2, <span class="number">2</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_3, <span class="number">3</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_4, <span class="number">4</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_5, <span class="number">5</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_6, <span class="number">6</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_7, <span class="number">7</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_8, <span class="number">8</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_9, <span class="number">9</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_10, <span class="number">10</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_11, <span class="number">11</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_12, <span class="number">12</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_13, <span class="number">13</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_14, <span class="number">14</span>, read_uint128);
    <span class="macro">too_small!</span>(small_uint128_15, <span class="number">15</span>, read_uint128);

    <span class="macro">too_small!</span>(small_int_1, <span class="number">1</span>, read_int);
    <span class="macro">too_small!</span>(small_int_2, <span class="number">2</span>, read_int);
    <span class="macro">too_small!</span>(small_int_3, <span class="number">3</span>, read_int);
    <span class="macro">too_small!</span>(small_int_4, <span class="number">4</span>, read_int);
    <span class="macro">too_small!</span>(small_int_5, <span class="number">5</span>, read_int);
    <span class="macro">too_small!</span>(small_int_6, <span class="number">6</span>, read_int);
    <span class="macro">too_small!</span>(small_int_7, <span class="number">7</span>, read_int);

    <span class="macro">too_small!</span>(small_int128_1, <span class="number">1</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_2, <span class="number">2</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_3, <span class="number">3</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_4, <span class="number">4</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_5, <span class="number">5</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_6, <span class="number">6</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_7, <span class="number">7</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_8, <span class="number">8</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_9, <span class="number">9</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_10, <span class="number">10</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_11, <span class="number">11</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_12, <span class="number">12</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_13, <span class="number">13</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_14, <span class="number">14</span>, read_int128);
    <span class="macro">too_small!</span>(small_int128_15, <span class="number">15</span>, read_int128);

    <span class="comment">// Test that reading/writing slices enforces the correct lengths.
    </span><span class="macro">macro_rules!</span> slice_lengths {
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident,
         <span class="macro-nonterminal">$num_bytes</span>:expr, <span class="macro-nonterminal">$numbers</span>:expr) =&gt; {
            <span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="kw">use crate</span>::{
                    BigEndian, ByteOrder, LittleEndian, NativeEndian,
                };
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span><span class="kw-2">mut </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>numbers);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span><span class="kw-2">mut </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>numbers);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span><span class="kw-2">mut </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>numbers);
                }

                <span class="attr">#[test]
                #[should_panic]
                </span><span class="kw">fn </span>write_big_endian() {
                    <span class="kw">let </span><span class="kw-2">mut </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    BigEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;</span>numbers, <span class="kw-2">&amp;mut </span>bytes);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span><span class="kw-2">mut </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    LittleEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;</span>numbers, <span class="kw-2">&amp;mut </span>bytes);
                }
                ...
                #[should_panic]
                    ...
                    <span class="kw">let </span><span class="kw-2">mut </span>bytes = [<span class="number">0</span>; <span class="macro-nonterminal">$num_bytes</span>];
                    <span class="kw">let </span>numbers = <span class="macro-nonterminal">$numbers</span>;
                    NativeEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;</span>numbers, <span class="kw-2">&amp;mut </span>bytes);
                }
            }
        };
    }

    <span class="macro">slice_lengths!</span>(
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>uint_bigger_buffer() {
        <span class="kw">use crate</span>::{ByteOrder, LittleEndian};
        <span class="kw">let </span>n = LittleEndian::read_uint(<span class="kw-2">&amp;</span>[<span class="number">1</span>, <span class="number">2</span>, <span class="number">3</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">7</span>, <span class="number">8</span>], <span class="number">5</span>);
        <span class="macro">assert_eq!</span>(n, <span class="number">0x05_0403_0201</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>regression173_array_impl() {
        <span class="kw">use crate</span>::{BigEndian, ByteOrder, LittleEndian};

        <span class="kw">let </span>xs = [<span class="number">0</span>; <span class="number">100</span>];

        <span class="kw">let </span>x = BigEndian::read_u16(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_u32(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_u64(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_u128(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_i16(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_i32(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_i64(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = BigEndian::read_i128(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);

        <span class="kw">let </span>x = LittleEndian::read_u16(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_u32(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_u64(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_u128(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_i16(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_i32(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_i64(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
        <span class="kw">let </span>x = LittleEndian::read_i128(<span class="kw-2">&amp;</span>xs);
        <span class="macro">assert_eq!</span>(x, <span class="number">0</span>);
    }
}
...
#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>stdtests {
    <span class="kw">extern crate </span>quickcheck;
    <span class="kw">extern crate </span>rand;

    <span class="kw">use </span><span class="self">self</span>::quickcheck::{QuickCheck, StdGen, Testable};
    <span class="kw">use </span><span class="self">self</span>::rand::thread_rng;

    <span class="kw">fn </span>qc_unsized&lt;A: Testable&gt;(f: A) {
        QuickCheck::new()
            .gen(StdGen::new(thread_rng(), <span class="number">16</span>))
            .tests(<span class="number">1_00</span>)
            .max_tests(<span class="number">10_000</span>)
            .quickcheck(f);
    }
    ...
    <span class="macro">macro_rules!</span> calc_max {
        (<span class="macro-nonterminal">$max</span>:expr, <span class="macro-nonterminal">$bytes</span>:expr) =&gt; {
            (<span class="macro-nonterminal">$max </span>- <span class="number">1</span>) &gt;&gt; (<span class="number">8 </span>* (<span class="number">8 </span>- <span class="macro-nonterminal">$bytes</span>))
        };
    }

    <span class="macro">macro_rules!</span> qc_bytes_ext {
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$ty_int</span>:ty, <span class="macro-nonterminal">$max</span>:expr,
         <span class="macro-nonterminal">$bytes</span>:expr, <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident) =&gt; {
            <span class="attr">#[cfg(not(miri))]
            </span><span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="attr">#[allow(unused_imports)]
                </span><span class="kw">use </span><span class="kw">crate</span>::test::{qc_sized, Wi128};
                <span class="kw">use crate</span>::{
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        ...
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;BigEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span>offset = wtr.len() - <span class="macro-nonterminal">$bytes</span>;
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(<span class="kw-2">&amp;mut </span>wtr[offset..]);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;BigEndian&gt;(<span class="macro-nonterminal">$bytes</span>).unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span><span class="kw-2">mut </span>wtr = <span class="macro">vec!</span>[];
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;LittleEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(wtr);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;LittleEndian&gt;(<span class="macro-nonterminal">$bytes</span>).unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        <span class="kw">let </span><span class="kw-2">mut </span>wtr = <span class="macro">vec!</span>[];
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;NativeEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span>offset = <span class="kw">if </span><span class="macro">cfg!</span>(target_endian = <span class="string">"big"</span>) {
                            wtr.len() - <span class="macro-nonterminal">$bytes
                        </span>} <span class="kw">else </span>{
                            <span class="number">0
                        </span>};
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(<span class="kw-2">&amp;mut </span>wtr[offset..]);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;NativeEndian&gt;(<span class="macro-nonterminal">$bytes</span>).unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max</span>);
                }
            }
        };
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$ty_int</span>:ty, <span class="macro-nonterminal">$max</span>:expr, <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident) =&gt; {
            <span class="attr">#[cfg(not(miri))]
            </span><span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="attr">#[allow(unused_imports)]
                </span><span class="kw">use </span><span class="kw">crate</span>::test::{qc_sized, Wi128};
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        ...
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;BigEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(wtr);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;BigEndian&gt;().unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        ...
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;LittleEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(wtr);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;LittleEndian&gt;().unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="kw">fn </span>prop(n: <span class="macro-nonterminal">$ty_int</span>) -&gt; bool {
                        ...
                        wtr.<span class="macro-nonterminal">$write</span>::&lt;NativeEndian&gt;(n.clone()).unwrap();
                        <span class="kw">let </span><span class="kw-2">mut </span>rdr = Cursor::new(wtr);
                        n == rdr.<span class="macro-nonterminal">$read</span>::&lt;NativeEndian&gt;().unwrap()
                    }
                    qc_sized(prop <span class="kw">as fn</span>(<span class="macro-nonterminal">$ty_int</span>) -&gt; bool, <span class="macro-nonterminal">$max </span>- <span class="number">1</span>);
                }
            }
    ...
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_u16,
        u16,
        ::std::u16::MAX <span class="kw">as </span>u64,
        read_u16,
        write_u16
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_i16,
        i16,
        ::std::i16::MAX <span class="kw">as </span>u64,
        read_i16,
        write_i16
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_u32,
        u32,
        ::std::u32::MAX <span class="kw">as </span>u64,
        read_u32,
        write_u32
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_i32,
        i32,
        ::std::i32::MAX <span class="kw">as </span>u64,
        read_i32,
        write_i32
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_u64,
        u64,
        ::std::u64::MAX <span class="kw">as </span>u64,
        read_u64,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_i64,
        i64,
        ::std::i64::MAX <span class="kw">as </span>u64,
        read_i64,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
    ...
    <span class="macro">qc_bytes_ext!</span>(prop_ext_u128, Wi128&lt;u128&gt;, <span class="number">16 </span>+ <span class="number">1</span>, read_u128, write_u128);
    <span class="macro">qc_bytes_ext!</span>(prop_ext_i128, Wi128&lt;i128&gt;, <span class="number">16 </span>+ <span class="number">1</span>, read_i128, write_i128);

    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_1,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">1</span>),
        <span class="number">1</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_2,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">2</span>),
        <span class="number">2</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_3,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">3</span>),
        <span class="number">3</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_4,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">4</span>),
        <span class="number">4</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_5,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">5</span>),
        <span class="number">5</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_6,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">6</span>),
        <span class="number">6</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_7,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">7</span>),
        <span class="number">7</span>,
        read_uint,
        write_u64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_uint_8,
        u64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::U64_MAX, <span class="number">8</span>),
        <span class="number">8</span>,
        read_uint,
        write_u64
    );
    ...
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_1,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">1</span>),
        <span class="number">1</span>,
        read_int,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_2,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">2</span>),
        <span class="number">2</span>,
        read_int,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_3,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">3</span>),
        <span class="number">3</span>,
        read_int,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_4,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">4</span>),
        <span class="number">4</span>,
        read_int,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_5,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">5</span>),
        <span class="number">5</span>,
        read_int,
        write_i64
    );
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_6,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">6</span>),
        <span class="number">6</span>,
        read_int,
        write_i64
    );
    ...
    <span class="macro">qc_bytes_ext!</span>(
        prop_ext_int_8,
        i64,
        <span class="macro">calc_max!</span>(<span class="kw">crate</span>::test::I64_MAX, <span class="number">8</span>),
        <span class="number">8</span>,
        read_int,
        write_i64
    );
    ...
    <span class="comment">// Test slice serialization/deserialization.
    </span><span class="macro">macro_rules!</span> qc_slice {
        (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$ty_int</span>:ty, <span class="macro-nonterminal">$read</span>:ident, <span class="macro-nonterminal">$write</span>:ident, <span class="macro-nonterminal">$zero</span>:expr) =&gt; {
            <span class="attr">#[cfg(not(miri))]
            </span><span class="kw">mod </span><span class="macro-nonterminal">$name </span>{
                <span class="kw">use </span><span class="kw">super</span>::qc_unsized;
                <span class="attr">#[allow(unused_imports)]
                </span><span class="kw">use </span><span class="kw">crate</span>::test::Wi128;
                <span class="kw">use crate</span>::{
                    BigEndian, ByteOrder, LittleEndian, NativeEndian,
                };
                <span class="kw">use </span>core::mem::size_of;
                ...
                <span class="attr">#[test]
                    ...
                    </span><span class="kw">fn </span>prop(numbers: Vec&lt;<span class="macro-nonterminal">$ty_int</span>&gt;) -&gt; bool {
                        <span class="kw">let </span>numbers: Vec&lt;<span class="kw">_</span>&gt; =
                            numbers.into_iter().map(|x| x.clone()).collect();
                        <span class="kw">let </span>num_bytes = size_of::&lt;<span class="macro-nonterminal">$ty_int</span>&gt;() * numbers.len();
                        <span class="kw">let </span><span class="kw-2">mut </span>bytes = <span class="macro">vec!</span>[<span class="number">0</span>; num_bytes];

                        BigEndian::<span class="macro-nonterminal">$write</span>(<span class="kw-2">&amp;</span>numbers, <span class="kw-2">&amp;mut </span>bytes);

                        <span class="kw">let </span><span class="kw-2">mut </span>got = <span class="macro">vec!</span>[<span class="macro-nonterminal">$zero</span>; numbers.len()];
                        <span class="kw">unsafe </span>{
                            BigEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>got);
                        }

                        numbers == got
                    }
                    qc_unsized(prop <span class="kw">as fn</span>(<span class="kw">_</span>) -&gt; bool);
                }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="attr">#[allow(unused_unsafe)]
                        ...
                        <span class="kw">let </span><span class="kw-2">mut </span>got = <span class="macro">vec!</span>[<span class="macro-nonterminal">$zero</span>; numbers.len()];
                        <span class="kw">unsafe </span>{
                            LittleEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>got);
                        }
                ...
                <span class="attr">#[test]
                    ...
                    <span class="attr">#[allow(unused_unsafe)]
                        ...
                        <span class="kw">let </span><span class="kw-2">mut </span>got = <span class="macro">vec!</span>[<span class="macro-nonterminal">$zero</span>; numbers.len()];
                        <span class="kw">unsafe </span>{
                            NativeEndian::<span class="macro-nonterminal">$read</span>(<span class="kw-2">&amp;</span>bytes, <span class="kw-2">&amp;mut </span>got);
                        }
    ...
    <span class="macro">qc_slice!</span>(prop_slice_u16, u16, read_u16_into, write_u16_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_i16, i16, read_i16_into, write_i16_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_u32, u32, read_u32_into, write_u32_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_i32, i32, read_i32_into, write_i32_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_u64, u64, read_u64_into, write_u64_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_i64, i64, read_i64_into, write_i64_into, <span class="number">0</span>);
    <span class="macro">qc_slice!</span>(
        prop_slice_u128,
        Wi128&lt;u128&gt;,
        read_u128_into,
        write_u128_into,
    ...
    <span class="macro">qc_slice!</span>(prop_slice_f32, f32, read_f32_into, write_f32_into, <span class="number">0.0</span>);
    <span class="macro">qc_slice!</span>(prop_slice_f64, f64, read_f64_into, write_f64_into, <span class="number">0.0</span>);
}
