...
</pre></div><pre class="rust"><code><span class="doccomment">//! The crunchy unroller - deterministically unroll constant loops. For number "crunching".
//!
...
</span><span class="macro">include!</span>(<span class="macro">concat!</span>(<span class="macro">env!</span>(<span class="string">"OUT_DIR"</span>), <span class="string">"/lib.rs"</span>));
