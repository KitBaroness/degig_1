...
</pre></div><pre class="rust"><code><span class="doccomment">//! [`Equivalent`] and [`Comparable`] are traits for key comparison in maps.
//!
...
<span class="doccomment">/// Key equivalence trait.
///
...
/// The implementor **must** hash like `K`, if it is hashable.
    ...
    <span class="doccomment">/// Compare self to `key` and return `true` if they are equal.
    </span><span class="kw">fn </span>equivalent(<span class="kw-2">&amp;</span><span class="self">self</span>, key: <span class="kw-2">&amp;</span>K) -&gt; bool;
}

<span class="kw">impl</span>&lt;Q: <span class="question-mark">?</span>Sized, K: <span class="question-mark">?</span>Sized&gt; Equivalent&lt;K&gt; <span class="kw">for </span>Q
<span class="kw">where
    </span>Q: Eq,
    K: Borrow&lt;Q&gt;,
{
    <span class="attr">#[inline]
        ...
        PartialEq::eq(<span class="self">self</span>, key.borrow())
    }
}

<span class="doccomment">/// Key ordering trait.
///
...
/// `String` keys and so on.
</span><span class="kw">pub trait </span>Comparable&lt;K: <span class="question-mark">?</span>Sized&gt;: Equivalent&lt;K&gt; {
    <span class="doccomment">/// Compare self to `key` and return their ordering.
    </span><span class="kw">fn </span>compare(<span class="kw-2">&amp;</span><span class="self">self</span>, key: <span class="kw-2">&amp;</span>K) -&gt; Ordering;
}

<span class="kw">impl</span>&lt;Q: <span class="question-mark">?</span>Sized, K: <span class="question-mark">?</span>Sized&gt; Comparable&lt;K&gt; <span class="kw">for </span>Q
<span class="kw">where
    </span>Q: Ord,
    K: Borrow&lt;Q&gt;,
{
    <span class="attr">#[inline]
        ...
        Ord::cmp(<span class="self">self</span>, key.borrow())
    }
}
