...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::cluster::HistogramPair;
<span class="kw">use </span><span class="kw">super</span>::command::Command;
<span class="kw">use </span><span class="kw">super</span>::histogram::{ContextType, HistogramCommand, HistogramDistance, HistogramLiteral};
<span class="kw">use </span><span class="kw">super</span>::interface::StaticCommand;
<span class="kw">use </span><span class="kw">super</span>::s16;
<span class="kw">use </span><span class="kw">super</span>::util::floatX;
<span class="kw">use </span><span class="kw">super</span>::v8;
<span class="kw">use </span><span class="kw">super</span>::PDF;
<span class="kw">pub use </span>alloc::Allocator;

<span class="kw">use </span><span class="kw">super</span>::entropy_encode::HuffmanTree;
<span class="kw">use </span><span class="kw">super</span>::hash_to_binary_tree::ZopfliNode;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">use </span>alloc_stdlib::StandardAlloc;
<span class="comment">/*
...
*/
...
</span><span class="kw">pub trait </span>BrotliAlloc:
    Allocator&lt;u8&gt;
    + Allocator&lt;u16&gt;
    + Allocator&lt;i32&gt;
    + Allocator&lt;u32&gt;
    + Allocator&lt;u64&gt;
    + Allocator&lt;Command&gt;
    + Allocator&lt;<span class="kw">super</span>::util::floatX&gt;
    + Allocator&lt;v8&gt;
    + Allocator&lt;s16&gt;
    + Allocator&lt;PDF&gt;
...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>BrotliAlloc <span class="kw">for </span>StandardAlloc {}

<span class="kw">pub struct </span>CombiningAllocator&lt;
...
<span class="kw">impl</span>&lt;
        ...
        AllocZopfliNode: Allocator&lt;ZopfliNode&gt;,
    &gt; BrotliAlloc
    <span class="kw">for </span>CombiningAllocator&lt;
        AllocU8,
        AllocU16,
        AllocI32,
        AllocU32,
    ...
    &gt;
{
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        CombiningAllocator {
            alloc_u8: <span class="self">self</span>.alloc_u8.clone(),
            alloc_u16: <span class="self">self</span>.alloc_u16.clone(),
            alloc_i32: <span class="self">self</span>.alloc_i32.clone(),
            alloc_u32: <span class="self">self</span>.alloc_u32.clone(),
            alloc_u64: <span class="self">self</span>.alloc_u64.clone(),
            alloc_c: <span class="self">self</span>.alloc_c.clone(),
            alloc_f: <span class="self">self</span>.alloc_f.clone(),
            alloc_f32x8: <span class="self">self</span>.alloc_f32x8.clone(),
            alloc_i16x16: <span class="self">self</span>.alloc_i16x16.clone(),
            alloc_pdf: <span class="self">self</span>.alloc_pdf.clone(),
            alloc_sc: <span class="self">self</span>.alloc_sc.clone(),
            alloc_hl: <span class="self">self</span>.alloc_hl.clone(),
            alloc_hc: <span class="self">self</span>.alloc_hc.clone(),
            alloc_hd: <span class="self">self</span>.alloc_hd.clone(),
            alloc_hp: <span class="self">self</span>.alloc_hp.clone(),
            alloc_ct: <span class="self">self</span>.alloc_ct.clone(),
            alloc_ht: <span class="self">self</span>.alloc_ht.clone(),
            alloc_zn: <span class="self">self</span>.alloc_zn.clone(),
        }
    }
}
...
<span class="macro">macro_rules!</span> implement_allocator {
    (<span class="macro-nonterminal">$bound_name</span>: ty,
   <span class="macro-nonterminal">$type_name</span>: ty,
   <span class="macro-nonterminal">$sub_type_name</span>: ty,
   <span class="macro-nonterminal">$local_name</span>: ident) =&gt; {
        <span class="kw">impl</span>&lt;
                AllocU8: Allocator&lt;u8&gt;,
                AllocU16: Allocator&lt;u16&gt;,
                AllocI32: Allocator&lt;i32&gt;,
                ...
                AllocHuffmanTree: Allocator&lt;HuffmanTree&gt;,
                AllocZopfliNode: Allocator&lt;ZopfliNode&gt;,
            &gt; Allocator&lt;<span class="macro-nonterminal">$type_name</span>&gt;
            <span class="kw">for </span>CombiningAllocator&lt;
                AllocU8,
                AllocU16,
                AllocI32,
            ...
            &gt;
        {
            <span class="kw">type </span>AllocatedMemory = <span class="macro-nonterminal">$sub_type_name</span>;
            <span class="kw">fn </span>alloc_cell(
                <span class="kw-2">&amp;mut </span><span class="self">self</span>,
                size: usize,
            ) -&gt; &lt;<span class="self">Self </span><span class="kw">as </span>Allocator&lt;<span class="macro-nonterminal">$type_name</span>&gt;&gt;::AllocatedMemory {
                <span class="self">self</span>.<span class="macro-nonterminal">$local_name</span>.alloc_cell(size)
            }
            <span class="kw">fn </span>free_cell(<span class="kw-2">&amp;mut </span><span class="self">self</span>, data: &lt;<span class="self">Self </span><span class="kw">as </span>Allocator&lt;<span class="macro-nonterminal">$type_name</span>&gt;&gt;::AllocatedMemory) {
                <span class="self">self</span>.<span class="macro-nonterminal">$local_name</span>.free_cell(data)
            }
        }
    };
}

<span class="macro">implement_allocator!</span>(AllocU8, u8, AllocU8::AllocatedMemory, alloc_u8);
<span class="macro">implement_allocator!</span>(AllocU16, u16, AllocU16::AllocatedMemory, alloc_u16);

<span class="macro">implement_allocator!</span>(AllocI32, i32, AllocI32::AllocatedMemory, alloc_i32);
<span class="macro">implement_allocator!</span>(AllocU32, u32, AllocU32::AllocatedMemory, alloc_u32);
<span class="macro">implement_allocator!</span>(AllocU64, u64, AllocU64::AllocatedMemory, alloc_u64);
<span class="macro">implement_allocator!</span>(
    AllocCommand,
    Command,
    AllocCommand::AllocatedMemory,
    alloc_c
);
<span class="macro">implement_allocator!</span>(AllocFloatX, floatX, AllocFloatX::AllocatedMemory, alloc_f);
<span class="macro">implement_allocator!</span>(AllocV8, v8, AllocV8::AllocatedMemory, alloc_f32x8);
<span class="macro">implement_allocator!</span>(AllocS16, s16, AllocS16::AllocatedMemory, alloc_i16x16);
<span class="macro">implement_allocator!</span>(AllocPDF, PDF, AllocPDF::AllocatedMemory, alloc_pdf);
<span class="macro">implement_allocator!</span>(
    AllocStaticCommand,
    StaticCommand,
