...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::backward_references::UnionHasher;
...
<span class="kw">pub struct </span>SingleThreadedJoinable&lt;T: Send + <span class="lifetime">'static</span>, U: Send + <span class="lifetime">'static</span>&gt; {
    result: <span class="prelude-ty">Result</span>&lt;T, U&gt;,
}
<span class="kw">impl</span>&lt;T: Send + <span class="lifetime">'static</span>, U: Send + <span class="lifetime">'static</span>&gt; Joinable&lt;T, U&gt; <span class="kw">for </span>SingleThreadedJoinable&lt;T, U&gt; {
...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">pub struct </span>SingleThreadedOwnedRetriever&lt;U: Send + <span class="lifetime">'static</span>&gt;(std::sync::RwLock&lt;U&gt;);
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl</span>&lt;U: Send + <span class="lifetime">'static</span>&gt; OwnedRetriever&lt;U&gt; <span class="kw">for </span>SingleThreadedOwnedRetriever&lt;U&gt; {
    <span class="kw">fn </span>view&lt;T, F: FnOnce(<span class="kw-2">&amp;</span>U) -&gt; T&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, f: F) -&gt; <span class="prelude-ty">Result</span>&lt;T, PoisonedThreadError&gt; {
        <span class="prelude-val">Ok</span>(f(<span class="kw-2">&amp;*</span><span class="self">self</span>.<span class="number">0</span>.read().unwrap()))
    }
    <span class="kw">fn </span>unwrap(<span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;U, PoisonedThreadError&gt; {
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.<span class="number">0</span>.into_inner().unwrap())
    }
}
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl</span>&lt;U: Send + <span class="lifetime">'static</span>&gt; SingleThreadedOwnedRetriever&lt;U&gt; {
    <span class="kw">fn </span>new(u: U) -&gt; <span class="self">Self </span>{
        SingleThreadedOwnedRetriever(std::sync::RwLock::new(u))
    }
}

<span class="attr">#[cfg(not(feature = <span class="string">"std"</span>))]
</span><span class="kw">pub struct </span>SingleThreadedOwnedRetriever&lt;U: Send + <span class="lifetime">'static</span>&gt;(U);
<span class="attr">#[cfg(not(feature = <span class="string">"std"</span>))]
</span><span class="kw">impl</span>&lt;U: Send + <span class="lifetime">'static</span>&gt; SingleThreadedOwnedRetriever&lt;U&gt; {
    <span class="kw">fn </span>new(u: U) -&gt; <span class="self">Self </span>{
...
<span class="attr">#[cfg(not(feature = <span class="string">"std"</span>))]
    ...
    <span class="kw">fn </span>view&lt;T, F: FnOnce(<span class="kw-2">&amp;</span>U) -&gt; T&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, f: F) -&gt; <span class="prelude-ty">Result</span>&lt;T, PoisonedThreadError&gt; {
        <span class="prelude-val">Ok</span>(f(<span class="kw-2">&amp;</span><span class="self">self</span>.<span class="number">0</span>))
    }
    <span class="kw">fn </span>unwrap(<span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;U, PoisonedThreadError&gt; {
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.<span class="number">0</span>)
    }
}

<span class="attr">#[derive(Default)]
</span><span class="kw">pub struct </span>SingleThreadedSpawner {}
...
<span class="kw">impl</span>&lt;
    ...
    &gt; BatchSpawnable&lt;ReturnValue, ExtraInput, Alloc, U&gt; <span class="kw">for </span>SingleThreadedSpawner
<span class="kw">where
    </span>&lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::AllocatedMemory: Send + <span class="lifetime">'static</span>,
{
    <span class="kw">type </span>JoinHandle = SingleThreadedJoinable&lt;ReturnValue, BrotliEncoderThreadError&gt;;
    <span class="kw">type </span>FinalJoinHandle = SingleThreadedOwnedRetriever&lt;U&gt;;
    ...
    <span class="kw">fn </span>spawn&lt;F: Fn(ExtraInput, usize, usize, <span class="kw-2">&amp;</span>U, Alloc) -&gt; ReturnValue + Send + <span class="lifetime">'static </span>+ Copy&gt;(
        ...
        <span class="kw">let </span>ret = handle.view(|sub_view| f(extra_input, index, num_threads, sub_view, alloc));
        <span class="kw-2">*</span>work = SendAlloc(InternalSendAlloc::Join(SingleThreadedJoinable {
            result: <span class="prelude-val">Ok</span>(ret.unwrap()),
        }));
    }
}
...
<span class="kw">impl</span>&lt;
        ...
        Alloc: BrotliAlloc + Send + <span class="lifetime">'static</span>,
        U: Send + <span class="lifetime">'static </span>+ Sync,
    &gt; BatchSpawnableLite&lt;ReturnValue, ExtraInput, Alloc, U&gt; <span class="kw">for </span>SingleThreadedSpawner
<span class="kw">where
    </span>&lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::AllocatedMemory: Send + <span class="lifetime">'static</span>,
{
    <span class="kw">type </span>JoinHandle =
        &lt;SingleThreadedSpawner <span class="kw">as </span>BatchSpawnable&lt;ReturnValue, ExtraInput, Alloc, U&gt;&gt;::JoinHandle;
    <span class="kw">type </span>FinalJoinHandle = &lt;SingleThreadedSpawner <span class="kw">as </span>BatchSpawnable&lt;
        ReturnValue,
        ExtraInput,
        Alloc,
        U,
...
&gt;(
    ...
    alloc_per_thread: <span class="kw-2">&amp;mut </span>[SendAlloc&lt;
        ...
        UnionHasher&lt;Alloc&gt;,
        Alloc,
        &lt;SingleThreadedSpawner <span class="kw">as </span>BatchSpawnable&lt;
            CompressionThreadResult&lt;Alloc&gt;,
            UnionHasher&lt;Alloc&gt;,
            Alloc,
            SliceW,
    ...
    &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::AllocatedMemory: Send,
{
    CompressMulti(
        ...
        output,
        alloc_per_thread,
        <span class="kw-2">&amp;mut </span>SingleThreadedSpawner::default(),
    )
}

<span class="kw">pub struct </span>WorkerPool&lt;A, B, C, D&gt; {
    a: PhantomData&lt;A&gt;,
    b: PhantomData&lt;B&gt;,
    c: PhantomData&lt;C&gt;,
    d: PhantomData&lt;D&gt;,
}
<span class="kw">pub fn </span>new_work_pool&lt;A, B, C, D&gt;(_num_threads: usize) -&gt; WorkerPool&lt;A, B, C, D&gt; {
    WorkerPool::&lt;A, B, C, D&gt; {
        a: PhantomData,
        b: PhantomData,
        c: PhantomData,
...
&gt;(
    ...
    alloc_per_thread: <span class="kw-2">&amp;mut </span>[SendAlloc&lt;
        ...
        &gt;&gt;::JoinHandle,
    &gt;],
    _worker_pool: <span class="kw-2">&amp;mut </span>WorkerPool&lt;
        CompressionThreadResult&lt;Alloc&gt;,
        UnionHasher&lt;Alloc&gt;,
        Alloc,
