...
</span><span class="kw">use </span><span class="kw">super</span>::backward_references::{
...
<span class="attr">#[allow(unused_imports)]
</span><span class="kw">use </span><span class="kw">super</span>::brotli_bit_stream::{
...
<span class="kw">use </span><span class="kw">super</span>::hash_to_binary_tree::InitializeH10;
...
<span class="kw">use </span><span class="kw">super</span>::command::{BrotliDistanceParams, Command, GetLengthCode};
...
<span class="attr">#[allow(unused_imports)]
</span><span class="kw">use </span><span class="kw">super</span>::entropy_encode::{
...
<span class="kw">use </span><span class="kw">super</span>::metablock::{
    BrotliBuildMetaBlock, BrotliBuildMetaBlockGreedy, BrotliInitDistanceParams,
    BrotliOptimizeHistograms,
};
<span class="kw">use </span><span class="kw">super</span>::static_dict::{kNumDistanceCacheEntries, BrotliGetDictionary};
...
</span><span class="kw">static </span>kCompressFragmentTwoPassBlockSize: usize = (<span class="number">1i32 </span>&lt;&lt; <span class="number">17</span>) <span class="kw">as </span>usize;
...
<span class="kw">fn </span>GetNextOutInternal&lt;<span class="lifetime">'a</span>&gt;(
    ...
    <span class="kw">match </span>next_out {
        <span class="kw-2">&amp;</span>NextOut::DynamicStorage(offset) =&gt; <span class="kw-2">&amp;mut </span>storage[offset <span class="kw">as </span>usize..],
        <span class="kw-2">&amp;</span>NextOut::TinyBuf(offset) =&gt; <span class="kw-2">&amp;mut </span>tiny_buf[offset <span class="kw">as </span>usize..],
...
<span class="macro">macro_rules!</span> GetNextOut {
    (<span class="macro-nonterminal">$s </span>: expr) =&gt; {
        GetNextOutInternal(<span class="kw-2">&amp;</span><span class="macro-nonterminal">$s</span>.next_out_, <span class="macro-nonterminal">$s</span>.storage_.slice_mut(), <span class="kw-2">&amp;mut </span><span class="macro-nonterminal">$s</span>.tiny_buf_)
    };
}
<span class="kw">fn </span>NextOutIncrement(next_out: <span class="kw-2">&amp;</span>NextOut, inc: i32) -&gt; NextOut {
    <span class="kw">match </span>next_out {
        <span class="kw-2">&amp;</span>NextOut::DynamicStorage(offset) =&gt; NextOut::DynamicStorage((offset <span class="kw">as </span>i32 + inc) <span class="kw">as </span>u32),
        <span class="kw-2">&amp;</span>NextOut::TinyBuf(offset) =&gt; NextOut::TinyBuf((offset <span class="kw">as </span>i32 + inc) <span class="kw">as </span>u32),
...
<span class="kw">fn </span>IsNextOutNull(next_out: <span class="kw-2">&amp;</span>NextOut) -&gt; bool {
    <span class="kw">match </span>next_out {
        <span class="kw-2">&amp;</span>NextOut::DynamicStorage(<span class="kw">_</span>) =&gt; <span class="bool-val">false</span>,
        <span class="kw-2">&amp;</span>NextOut::TinyBuf(<span class="kw">_</span>) =&gt; <span class="bool-val">false</span>,
...
<span class="kw">pub fn </span>set_parameter(
    ...
    <span class="kw">if </span>p <span class="kw">as </span>i32 == BrotliEncoderParameter::BROTLI_METABLOCK_CALLBACK <span class="kw">as </span>i32 {
        params.log_meta_block = value != <span class="number">0</span>;
        <span class="kw">return </span><span class="number">1i32</span>;
    }
...
<span class="kw">pub fn </span>BrotliEncoderSetParameter&lt;Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">if </span>state.is_initialized_ {
        <span class="kw">return </span><span class="number">0i32</span>;
    }
...
<span class="kw">pub fn </span>BROTLI_DISTANCE_ALPHABET_SIZE(NPOSTFIX: u32, NDIRECT: u32, MAXNBITS: u32) -&gt; u32 {
    BROTLI_NUM_DISTANCE_SHORT_CODES + (NDIRECT) + ((MAXNBITS) &lt;&lt; ((NPOSTFIX) + <span class="number">1</span>))
}
...
<span class="kw">fn </span>ExtendLastCommand&lt;Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">let </span>distance_code: u32 =
        <span class="kw">super</span>::command::CommandRestoreDistanceCode(last_command, <span class="kw-2">&amp;</span>s.params.dist);
        ...
        || distance_code <span class="kw">as </span>u64 - (BROTLI_NUM_DISTANCE_SHORT_CODES - <span class="number">1</span>) <span class="kw">as </span>u64 == cmd_dist)
    {
        <span class="kw">if </span>(cmd_dist &lt;= max_distance) {
            <span class="kw">while </span>(<span class="kw-2">*</span>bytes != <span class="number">0
                </span>&amp;&amp; s.ringbuffer_.data_mo.slice()[s.ringbuffer_.buffer_index
                    + (<span class="kw-2">*</span>wrapped_last_processed_pos <span class="kw">as </span>usize &amp; mask <span class="kw">as </span>usize)]
                    == s.ringbuffer_.data_mo.slice()[s.ringbuffer_.buffer_index
                        + (((<span class="kw-2">*</span>wrapped_last_processed_pos <span class="kw">as </span>usize)
                            .wrapping_sub(cmd_dist <span class="kw">as </span>usize))
        ...
        <span class="comment">/* The copy length is at most the metablock size, and thus expressible. */
            ...
            last_command.insert_len_ <span class="kw">as </span>usize,
            ((last_command.copy_len_ &amp; <span class="number">0x1FFFFFF</span>) <span class="kw">as </span>i32 + (last_command.copy_len_ &gt;&gt; <span class="number">25</span>) <span class="kw">as </span>i32)
...
<span class="kw">pub fn </span>BrotliEncoderCreateInstance&lt;Alloc: BrotliAlloc&gt;(
    ...
    BrotliEncoderStateStruct::&lt;Alloc&gt; {
        ...
        prev_byte_: <span class="number">0u8</span>,
        prev_byte2_: <span class="number">0u8</span>,
...
<span class="kw">fn </span>RingBufferFree&lt;AllocU8: alloc::Allocator&lt;u8&gt;&gt;(m: <span class="kw-2">&amp;mut </span>AllocU8, rb: <span class="kw-2">&amp;mut </span>RingBuffer&lt;AllocU8&gt;) {
    m.free_cell(core::mem::take(<span class="kw-2">&amp;mut </span>rb.data_mo));
}
...
</span><span class="kw">fn </span>BrotliEncoderCleanupState&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) {
    {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.storage_));
    }
    {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;Command&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.commands_));
    }
    RingBufferFree(<span class="kw-2">&amp;mut </span>s.m8, <span class="kw-2">&amp;mut </span>s.ringbuffer_);
    DestroyHasher(<span class="kw-2">&amp;mut </span>s.m8, <span class="kw-2">&amp;mut </span>s.hasher_);
    {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;i32&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.large_table_));
    }
    {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.command_buf_));
    }
    {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.literal_buf_));
    }
}

<span class="kw">pub fn </span>BrotliEncoderDestroyInstance&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) {
...
<span class="attr">#[cfg(not(feature = <span class="string">"disallow_large_window_size"</span>))]
...
<span class="kw">pub fn </span>SanitizeParams(params: <span class="kw-2">&amp;mut </span>BrotliEncoderParams) {
    params.quality = brotli_min_int(<span class="number">11i32</span>, brotli_max_int(<span class="number">0i32</span>, params.quality));
    <span class="kw">if </span>params.lgwin &lt; <span class="number">10i32 </span>{
        params.lgwin = <span class="number">10i32</span>;
    } <span class="kw">else if </span>params.lgwin &gt; <span class="number">24i32 </span>{
        <span class="kw">if </span>params.large_window &amp;&amp; check_large_window_ok() {
            <span class="kw">if </span>params.lgwin &gt; <span class="number">30i32 </span>{
                params.lgwin = <span class="number">30i32</span>;
            }
        } <span class="kw">else </span>{
            params.lgwin = <span class="number">24i32</span>;
        }
    }
...
<span class="kw">fn </span>ComputeLgBlock(params: <span class="kw-2">&amp;</span>BrotliEncoderParams) -&gt; i32 {
    <span class="kw">let </span><span class="kw-2">mut </span>lgblock: i32 = params.lgblock;
    <span class="kw">if </span>params.quality == <span class="number">0i32 </span>|| params.quality == <span class="number">1i32 </span>{
        lgblock = params.lgwin;
    } <span class="kw">else if </span>params.quality &lt; <span class="number">4i32 </span>{
        ...
        <span class="kw">if </span>params.quality &gt;= <span class="number">9i32 </span>&amp;&amp; (params.lgwin &gt; lgblock) {
            lgblock = brotli_min_int(<span class="number">18i32</span>, params.lgwin);
        }
    } <span class="kw">else </span>{
...
<span class="kw">fn </span>ComputeRbBits(params: <span class="kw-2">&amp;</span>BrotliEncoderParams) -&gt; i32 {
    <span class="number">1i32 </span>+ brotli_max_int(params.lgwin, params.lgblock)
}

<span class="kw">fn </span>RingBufferSetup&lt;AllocU8: alloc::Allocator&lt;u8&gt;&gt;(
    ...
    <span class="kw">let </span>tail_bits: i32 = params.lgblock;
    rb.size_ = <span class="number">1u32 </span>&lt;&lt; window_bits;
    rb.mask_ = (<span class="number">1u32 </span>&lt;&lt; window_bits).wrapping_sub(<span class="number">1</span>);
    rb.tail_size_ = <span class="number">1u32 </span>&lt;&lt; tail_bits;
    rb.total_size_ = rb.size_.wrapping_add(rb.tail_size_);
}

<span class="kw">fn </span>EncodeWindowBits(
    lgwin: i32,
    large_window: bool,
    last_bytes: <span class="kw-2">&amp;mut </span>u16,
    last_bytes_bits: <span class="kw-2">&amp;mut </span>u8,
) {
    ...
    } <span class="kw">else if </span>lgwin == <span class="number">16i32 </span>{
        <span class="kw-2">*</span>last_bytes = <span class="number">0u16</span>;
        <span class="kw-2">*</span>last_bytes_bits = <span class="number">1u8</span>;
    } <span class="kw">else if </span>lgwin == <span class="number">17i32 </span>{
        <span class="kw-2">*</span>last_bytes = <span class="number">1u16</span>;
        <span class="kw-2">*</span>last_bytes_bits = <span class="number">7u8</span>;
    } <span class="kw">else if </span>lgwin &gt; <span class="number">17i32 </span>{
        <span class="kw-2">*</span>last_bytes = ((lgwin - <span class="number">17i32</span>) &lt;&lt; <span class="number">1 </span>| <span class="number">1i32</span>) <span class="kw">as </span>u16;
        <span class="kw-2">*</span>last_bytes_bits = <span class="number">4u8</span>;
    } <span class="kw">else </span>{
        <span class="kw-2">*</span>last_bytes = ((lgwin - <span class="number">8i32</span>) &lt;&lt; <span class="number">4 </span>| <span class="number">1i32</span>) <span class="kw">as </span>u16;
        <span class="kw-2">*</span>last_bytes_bits = <span class="number">7u8</span>;
    }
}

<span class="kw">fn </span>InitCommandPrefixCodes(
    cmd_depths: <span class="kw-2">&amp;mut </span>[u8],
    ...
    <span class="kw">static </span>kDefaultCommandDepths: [u8; <span class="number">128</span>] = [
        <span class="number">0</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">8</span>, <span class="number">8</span>, <span class="number">8</span>, <span class="number">8</span>, <span class="number">8</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>,
        <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">0</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">7</span>, <span class="number">8</span>, <span class="number">8</span>, <span class="number">9</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>,
        <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">10</span>, <span class="number">5</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>,
        <span class="number">6</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">8</span>, <span class="number">10</span>, <span class="number">12</span>, <span class="number">12</span>,
        <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">12</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
    ];
    <span class="kw">static </span>kDefaultCommandBits: [u16; <span class="number">128</span>] = [
        ...
        <span class="number">29</span>, <span class="number">11</span>, <span class="number">43</span>, <span class="number">27</span>, <span class="number">59</span>, <span class="number">87</span>, <span class="number">55</span>, <span class="number">15</span>, <span class="number">79</span>, <span class="number">319</span>, <span class="number">831</span>, <span class="number">191</span>, <span class="number">703</span>, <span class="number">447</span>, <span class="number">959</span>, <span class="number">0</span>, <span class="number">14</span>, <span class="number">1</span>, <span class="number">25</span>, <span class="number">5</span>, <span class="number">21</span>, <span class="number">19</span>,
        <span class="number">51</span>, <span class="number">119</span>, <span class="number">159</span>, <span class="number">95</span>, <span class="number">223</span>, <span class="number">479</span>, <span class="number">991</span>, <span class="number">63</span>, <span class="number">575</span>, <span class="number">127</span>, <span class="number">639</span>, <span class="number">383</span>, <span class="number">895</span>, <span class="number">255</span>, <span class="number">767</span>, <span class="number">511</span>, <span class="number">1023</span>, <span class="number">14</span>, <span class="number">0</span>,
        <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">27</span>, <span class="number">59</span>, <span class="number">7</span>, <span class="number">39</span>, <span class="number">23</span>, <span class="number">55</span>, <span class="number">30</span>, <span class="number">1</span>, <span class="number">17</span>, <span class="number">9</span>, <span class="number">25</span>, <span class="number">5</span>, <span class="number">0</span>, <span class="number">8</span>,
        <span class="number">4</span>, <span class="number">12</span>, <span class="number">2</span>, <span class="number">10</span>, <span class="number">6</span>, <span class="number">21</span>, <span class="number">13</span>, <span class="number">29</span>, <span class="number">3</span>, <span class="number">19</span>, <span class="number">11</span>, <span class="number">15</span>, <span class="number">47</span>, <span class="number">31</span>, <span class="number">95</span>, <span class="number">63</span>, <span class="number">127</span>, <span class="number">255</span>, <span class="number">767</span>, <span class="number">2815</span>, <span class="number">1791</span>,
        <span class="number">3839</span>, <span class="number">511</span>, <span class="number">2559</span>, <span class="number">1535</span>, <span class="number">3583</span>, <span class="number">1023</span>, <span class="number">3071</span>, <span class="number">2047</span>, <span class="number">4095</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
    ];
    <span class="kw">static </span>kDefaultCommandCode: [u8; <span class="number">57</span>] = [
        <span class="number">0xff</span>, <span class="number">0x77</span>, <span class="number">0xd5</span>, <span class="number">0xbf</span>, <span class="number">0xe7</span>, <span class="number">0xde</span>, <span class="number">0xea</span>, <span class="number">0x9e</span>, <span class="number">0x51</span>, <span class="number">0x5d</span>, <span class="number">0xde</span>, <span class="number">0xc6</span>, <span class="number">0x70</span>, <span class="number">0x57</span>, <span class="number">0xbc</span>,
        <span class="number">0x58</span>, <span class="number">0x58</span>, <span class="number">0x58</span>, <span class="number">0xd8</span>, <span class="number">0xd8</span>, <span class="number">0x58</span>, <span class="number">0xd5</span>, <span class="number">0xcb</span>, <span class="number">0x8c</span>, <span class="number">0xea</span>, <span class="number">0xe0</span>, <span class="number">0xc3</span>, <span class="number">0x87</span>, <span class="number">0x1f</span>, <span class="number">0x83</span>,
        <span class="number">0xc1</span>, <span class="number">0x60</span>, <span class="number">0x1c</span>, <span class="number">0x67</span>, <span class="number">0xb2</span>, <span class="number">0xaa</span>, <span class="number">0x6</span>, <span class="number">0x83</span>, <span class="number">0xc1</span>, <span class="number">0x60</span>, <span class="number">0x30</span>, <span class="number">0x18</span>, <span class="number">0xcc</span>, <span class="number">0xa1</span>, <span class="number">0xce</span>,
        <span class="number">0x88</span>, <span class="number">0x54</span>, <span class="number">0x94</span>, <span class="number">0x46</span>, <span class="number">0xe1</span>, <span class="number">0xb0</span>, <span class="number">0xd0</span>, <span class="number">0x4e</span>, <span class="number">0xb2</span>, <span class="number">0xf7</span>, <span class="number">0x4</span>, <span class="number">0x0</span>,
    ];
...
<span class="kw">fn </span>EnsureInitialized&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; i32 {
    <span class="kw">if </span>s.is_initialized_ {
        <span class="kw">return </span><span class="number">1i32</span>;
    }
    SanitizeParams(<span class="kw-2">&amp;mut </span>s.params);
    s.params.lgblock = ComputeLgBlock(<span class="kw-2">&amp;mut </span>s.params);
    ChooseDistanceParams(<span class="kw-2">&amp;mut </span>s.params);
    s.remaining_metadata_bytes_ = !(<span class="number">0u32</span>);
    RingBufferSetup(<span class="kw-2">&amp;mut </span>s.params, <span class="kw-2">&amp;mut </span>s.ringbuffer_);
    {
        <span class="kw">let </span><span class="kw-2">mut </span>lgwin: i32 = s.params.lgwin;
        <span class="kw">if </span>s.params.quality == <span class="number">0i32 </span>|| s.params.quality == <span class="number">1i32 </span>{
            lgwin = brotli_max_int(lgwin, <span class="number">18i32</span>);
        }
        EncodeWindowBits(
            lgwin,
            s.params.large_window,
            <span class="kw-2">&amp;mut </span>s.last_bytes_,
            <span class="kw-2">&amp;mut </span>s.last_bytes_bits_,
        );
    }
    <span class="kw">if </span>s.params.quality == <span class="number">0i32 </span>{
        InitCommandPrefixCodes(
            <span class="kw-2">&amp;mut </span>s.cmd_depths_[..],
            <span class="kw-2">&amp;mut </span>s.cmd_bits_[..],
            <span class="kw-2">&amp;mut </span>s.cmd_code_[..],
            <span class="kw-2">&amp;mut </span>s.cmd_code_numbits_,
        );
    }
    ...
    s.is_initialized_ = <span class="bool-val">true</span>;
    <span class="number">1i32
</span>}

<span class="kw">fn </span>RingBufferInitBuffer&lt;AllocU8: alloc::Allocator&lt;u8&gt;&gt;(
    m: <span class="kw-2">&amp;mut </span>AllocU8,
    buflen: u32,
    rb: <span class="kw-2">&amp;mut </span>RingBuffer&lt;AllocU8&gt;,
) {
    <span class="kw">static </span>kSlackForEightByteHashingEverywhere: usize = <span class="number">7usize</span>;
    <span class="kw">let </span><span class="kw-2">mut </span>new_data = m.alloc_cell(
        ((<span class="number">2u32</span>).wrapping_add(buflen) <span class="kw">as </span>usize).wrapping_add(kSlackForEightByteHashingEverywhere),
    );
    <span class="kw">if </span>!rb.data_mo.slice().is_empty() {
        <span class="kw">let </span>lim: usize = ((<span class="number">2u32</span>).wrapping_add(rb.cur_size_) <span class="kw">as </span>usize)
            .wrapping_add(kSlackForEightByteHashingEverywhere);
        new_data.slice_mut()[..lim].clone_from_slice(<span class="kw-2">&amp;</span>rb.data_mo.slice()[..lim]);
        m.free_cell(core::mem::take(<span class="kw-2">&amp;mut </span>rb.data_mo));
    }
    <span class="kw">let _ </span>= core::mem::replace(<span class="kw-2">&amp;mut </span>rb.data_mo, new_data);
    rb.cur_size_ = buflen;
    rb.buffer_index = <span class="number">2usize</span>;
    rb.data_mo.slice_mut()[(rb.buffer_index.wrapping_sub(<span class="number">2</span>))] = <span class="number">0</span>;
    rb.data_mo.slice_mut()[(rb.buffer_index.wrapping_sub(<span class="number">1</span>))] = <span class="number">0</span>;
    <span class="kw">for </span>i <span class="kw">in </span><span class="number">0usize</span>..kSlackForEightByteHashingEverywhere {
        rb.data_mo.slice_mut()[rb
            .buffer_index
            .wrapping_add(rb.cur_size_ <span class="kw">as </span>usize)
            .wrapping_add(i)] = <span class="number">0</span>;
    }
}

<span class="kw">fn </span>RingBufferWriteTail&lt;AllocU8: alloc::Allocator&lt;u8&gt;&gt;(
    bytes: <span class="kw-2">&amp;</span>[u8],
    n: usize,
    rb: <span class="kw-2">&amp;mut </span>RingBuffer&lt;AllocU8&gt;,
) {
    <span class="kw">let </span>masked_pos: usize = (rb.pos_ &amp; rb.mask_) <span class="kw">as </span>usize;
    <span class="kw">if </span>masked_pos &lt; rb.tail_size_ <span class="kw">as </span>usize {
        <span class="kw">let </span>p: usize = (rb.size_ <span class="kw">as </span>usize).wrapping_add(masked_pos);
        <span class="kw">let </span>begin = rb.buffer_index.wrapping_add(p);
        <span class="kw">let </span>lim = brotli_min_size_t(n, (rb.tail_size_ <span class="kw">as </span>usize).wrapping_sub(masked_pos));
        rb.data_mo.slice_mut()[begin..(begin + lim)].clone_from_slice(<span class="kw-2">&amp;</span>bytes[..lim]);
    }
}

<span class="kw">fn </span>RingBufferWrite&lt;AllocU8: alloc::Allocator&lt;u8&gt;&gt;(
    m: <span class="kw-2">&amp;mut </span>AllocU8,
    bytes: <span class="kw-2">&amp;</span>[u8],
    n: usize,
    rb: <span class="kw-2">&amp;mut </span>RingBuffer&lt;AllocU8&gt;,
) {
    <span class="kw">if </span>rb.pos_ == <span class="number">0u32 </span>&amp;&amp; (n &lt; rb.tail_size_ <span class="kw">as </span>usize) {
        rb.pos_ = n <span class="kw">as </span>u32;
    ...
    <span class="kw">if </span>rb.cur_size_ &lt; rb.total_size_ {
        ...
        rb.data_mo.slice_mut()[rb
            .buffer_index
            .wrapping_add(rb.size_ <span class="kw">as </span>usize)
            .wrapping_sub(<span class="number">2</span>)] = <span class="number">0u8</span>;
        rb.data_mo.slice_mut()[rb
            .buffer_index
            .wrapping_add(rb.size_ <span class="kw">as </span>usize)
            .wrapping_sub(<span class="number">1</span>)] = <span class="number">0u8</span>;
    }
    {
        <span class="kw">let </span>masked_pos: usize = (rb.pos_ &amp; rb.mask_) <span class="kw">as </span>usize;
        RingBufferWriteTail(bytes, n, rb);
        <span class="kw">if </span>masked_pos.wrapping_add(n) &lt;= rb.size_ <span class="kw">as </span>usize {
            <span class="comment">// a single write fits
            </span><span class="kw">let </span>start = rb.buffer_index.wrapping_add(masked_pos);
            rb.data_mo.slice_mut()[start..(start + n)].clone_from_slice(<span class="kw-2">&amp;</span>bytes[..n]);
        } <span class="kw">else </span>{
            {
                <span class="kw">let </span>start = rb.buffer_index.wrapping_add(masked_pos);
                <span class="kw">let </span>mid = brotli_min_size_t(n, (rb.total_size_ <span class="kw">as </span>usize).wrapping_sub(masked_pos));
                rb.data_mo.slice_mut()[start..(start + mid)].clone_from_slice(<span class="kw-2">&amp;</span>bytes[..mid]);
            }
            <span class="kw">let </span>xstart = rb.buffer_index.wrapping_add(<span class="number">0</span>);
            <span class="kw">let </span>size = n.wrapping_sub((rb.size_ <span class="kw">as </span>usize).wrapping_sub(masked_pos));
            <span class="kw">let </span>bytes_start = (rb.size_ <span class="kw">as </span>usize).wrapping_sub(masked_pos);
            rb.data_mo.slice_mut()[xstart..(xstart + size)]
                .clone_from_slice(<span class="kw-2">&amp;</span>bytes[bytes_start..(bytes_start + size)]);
        }
    }
    <span class="kw">let </span>data_2 = rb.data_mo.slice()[rb
        .buffer_index
        .wrapping_add(rb.size_ <span class="kw">as </span>usize)
        .wrapping_sub(<span class="number">2</span>)];
    rb.data_mo.slice_mut()[rb.buffer_index.wrapping_sub(<span class="number">2</span>)] = data_2;
    <span class="kw">let </span>data_1 = rb.data_mo.slice()[rb
        .buffer_index
        .wrapping_add(rb.size_ <span class="kw">as </span>usize)
        .wrapping_sub(<span class="number">1</span>)];
    rb.data_mo.slice_mut()[rb.buffer_index.wrapping_sub(<span class="number">1</span>)] = data_1;
    rb.pos_ = rb.pos_.wrapping_add(n <span class="kw">as </span>u32);
    <span class="kw">if </span>rb.pos_ &gt; <span class="number">1u32 </span>&lt;&lt; <span class="number">30 </span>{
        rb.pos_ = rb.pos_ &amp; (<span class="number">1u32 </span>&lt;&lt; <span class="number">30</span>).wrapping_sub(<span class="number">1</span>) | <span class="number">1u32 </span>&lt;&lt; <span class="number">30</span>;
    }
}
...
<span class="kw">fn </span>CopyInputToRingBuffer&lt;Alloc: BrotliAlloc&gt;(
    ...
    s.input_pos_ = s.input_pos_.wrapping_add(input_size <span class="kw">as </span>u64);
    <span class="kw">if </span>(s.ringbuffer_).pos_ &lt;= (s.ringbuffer_).mask_ {
        <span class="kw">let </span>start = (s.ringbuffer_)
            .buffer_index
            .wrapping_add((s.ringbuffer_).pos_ <span class="kw">as </span>usize);
...
<span class="kw">fn </span>ChooseHasher(params: <span class="kw-2">&amp;mut </span>BrotliEncoderParams) {
    ...
    <span class="kw">if </span>params.quality &gt;= <span class="number">10 </span>&amp;&amp; !params.q9_5 {
        hparams.type_ = <span class="number">10</span>;
    } <span class="kw">else if </span>params.quality == <span class="number">10 </span>{
        <span class="comment">// we are using quality 10 as a proxy for "9.5"
        </span>hparams.type_ = <span class="number">9</span>;
        hparams.num_last_distances_to_check = H9_NUM_LAST_DISTANCES_TO_CHECK <span class="kw">as </span>i32;
        hparams.block_bits = H9_BLOCK_BITS <span class="kw">as </span>i32;
        hparams.bucket_bits = H9_BUCKET_BITS <span class="kw">as </span>i32;
        hparams.hash_len = <span class="number">4</span>;
    } <span class="kw">else if </span>params.quality == <span class="number">9 </span>{
        hparams.type_ = <span class="number">9</span>;
        hparams.num_last_distances_to_check = H9_NUM_LAST_DISTANCES_TO_CHECK <span class="kw">as </span>i32;
        hparams.block_bits = H9_BLOCK_BITS <span class="kw">as </span>i32;
        hparams.bucket_bits = H9_BUCKET_BITS <span class="kw">as </span>i32;
        hparams.hash_len = <span class="number">4</span>;
    } <span class="kw">else if </span>params.quality == <span class="number">4 </span>&amp;&amp; (params.size_hint &gt;= (<span class="number">1i32 </span>&lt;&lt; <span class="number">20</span>) <span class="kw">as </span>usize) {
        hparams.type_ = <span class="number">54i32</span>;
    } <span class="kw">else if </span>params.quality &lt; <span class="number">5 </span>{
        hparams.type_ = params.quality;
    } <span class="kw">else if </span>params.lgwin &lt;= <span class="number">16 </span>{
        hparams.type_ = <span class="kw">if </span>params.quality &lt; <span class="number">7 </span>{
            <span class="number">40i32
        </span>} <span class="kw">else if </span>params.quality &lt; <span class="number">9 </span>{
            <span class="number">41i32
        </span>} <span class="kw">else </span>{
            <span class="number">42i32
        </span>};
    } <span class="kw">else if </span>((params.q9_5 &amp;&amp; params.size_hint &gt; (<span class="number">1 </span>&lt;&lt; <span class="number">20</span>)) || params.size_hint &gt; (<span class="number">1 </span>&lt;&lt; <span class="number">22</span>))
        &amp;&amp; (params.lgwin &gt;= <span class="number">19i32</span>)
    {
        hparams.type_ = <span class="number">6i32</span>;
        hparams.block_bits = core::cmp::min(params.quality - <span class="number">1</span>, <span class="number">9</span>);
        hparams.bucket_bits = <span class="number">15i32</span>;
        hparams.hash_len = <span class="number">5i32</span>;
        hparams.num_last_distances_to_check = <span class="kw">if </span>params.quality &lt; <span class="number">7 </span>{
        ...
        hparams.type_ = <span class="number">5i32</span>;
        hparams.block_bits = core::cmp::min(params.quality - <span class="number">1</span>, <span class="number">9</span>);
        hparams.bucket_bits = <span class="kw">if </span>params.quality &lt; <span class="number">7 </span>&amp;&amp; params.size_hint &lt;= (<span class="number">1 </span>&lt;&lt; <span class="number">20</span>) {
...
<span class="kw">fn </span>InitializeH2&lt;AllocU32: alloc::Allocator&lt;u32&gt;&gt;(
    ...
    BasicHasher {
        ...
        buckets_: H2Sub {
            buckets_: m32.alloc_cell(<span class="number">65537 </span>+ <span class="number">8</span>),
        },
        h9_opts: <span class="kw">super</span>::backward_references::H9Opts::new(<span class="kw-2">&amp;</span>params.hasher),
    }
}
<span class="kw">fn </span>InitializeH3&lt;AllocU32: alloc::Allocator&lt;u32&gt;&gt;(
    m32: <span class="kw-2">&amp;mut </span>AllocU32,
    params: <span class="kw-2">&amp;</span>BrotliEncoderParams,
    ...
    BasicHasher {
        ...
        buckets_: H3Sub {
            buckets_: m32.alloc_cell(<span class="number">65538 </span>+ <span class="number">8</span>),
        },
        h9_opts: <span class="kw">super</span>::backward_references::H9Opts::new(<span class="kw-2">&amp;</span>params.hasher),
    }
}
<span class="kw">fn </span>InitializeH4&lt;AllocU32: alloc::Allocator&lt;u32&gt;&gt;(
    m32: <span class="kw-2">&amp;mut </span>AllocU32,
    params: <span class="kw-2">&amp;</span>BrotliEncoderParams,
    ...
    BasicHasher {
        ...
        buckets_: H4Sub {
            buckets_: m32.alloc_cell(<span class="number">131072 </span>+ <span class="number">8</span>),
        },
        h9_opts: <span class="kw">super</span>::backward_references::H9Opts::new(<span class="kw-2">&amp;</span>params.hasher),
    }
}
<span class="kw">fn </span>InitializeH54&lt;AllocU32: alloc::Allocator&lt;u32&gt;&gt;(
    m32: <span class="kw-2">&amp;mut </span>AllocU32,
    params: <span class="kw-2">&amp;</span>BrotliEncoderParams,
    ...
    BasicHasher {
        ...
        buckets_: H54Sub {
            buckets_: m32.alloc_cell(<span class="number">1048580 </span>+ <span class="number">8</span>),
        },
        h9_opts: <span class="kw">super</span>::backward_references::H9Opts::new(<span class="kw-2">&amp;</span>params.hasher),
    }
}

<span class="kw">fn </span>InitializeH9&lt;Alloc: alloc::Allocator&lt;u16&gt; + alloc::Allocator&lt;u32&gt;&gt;(
    m16: <span class="kw-2">&amp;mut </span>Alloc,
    params: <span class="kw-2">&amp;</span>BrotliEncoderParams,
) -&gt; H9&lt;Alloc&gt; {
    H9 {
...
<span class="kw">fn </span>InitializeH5&lt;Alloc: alloc::Allocator&lt;u16&gt; + alloc::Allocator&lt;u32&gt;&gt;(
    ...
    <span class="kw">let </span>buckets: &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::AllocatedMemory =
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::alloc_cell(m16, (bucket_size * block_size) <span class="kw">as </span>usize);
    <span class="kw">let </span>num: &lt;Alloc <span class="kw">as </span>Allocator&lt;u16&gt;&gt;::AllocatedMemory =
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u16&gt;&gt;::alloc_cell(m16, bucket_size <span class="kw">as </span>usize);

    <span class="kw">if </span>params.hasher.block_bits == (HQ5Sub {}).block_bits()
        &amp;&amp; (<span class="number">1 </span>&lt;&lt; params.hasher.bucket_bits) == (HQ5Sub {}).bucket_size()
    {
    ...
    <span class="kw">if </span>params.hasher.block_bits == (HQ7Sub {}).block_bits()
        &amp;&amp; (<span class="number">1 </span>&lt;&lt; params.hasher.bucket_bits) == (HQ7Sub {}).bucket_size()
    {
...
<span class="kw">pub fn </span>HasherSetup&lt;Alloc: alloc::Allocator&lt;u16&gt; + alloc::Allocator&lt;u32&gt;&gt;(
    m16: <span class="kw-2">&amp;mut </span>Alloc,
    handle: <span class="kw-2">&amp;mut </span>UnionHasher&lt;Alloc&gt;,
    params: <span class="kw-2">&amp;mut </span>BrotliEncoderParams,
        ...
        <span class="kw">match </span>handle.Prepare(one_shot != <span class="number">0</span>, input_size, data) {
            ...
            HowPrepared::NEWLY_PREPARED =&gt; {
                <span class="kw">if </span>position == <span class="number">0usize </span>{
                    <span class="kw">let </span>common = handle.GetHasherCommon();
                    common.dict_num_lookups = <span class="number">0usize</span>;
                    common.dict_num_matches = <span class="number">0usize</span>;
                }
            }
        }
    }
...
<span class="kw">pub fn </span>BrotliEncoderSetCustomDictionaryWithOptionalPrecomputedHasher&lt;Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">let </span>has_optional_hasher = <span class="kw">if let </span>UnionHasher::Uninit = opt_hasher {
        <span class="bool-val">false
    </span>} <span class="kw">else </span>{
        <span class="bool-val">true
    </span>};
    <span class="kw">let </span>max_dict_size: usize = (<span class="number">1usize </span>&lt;&lt; s.params.lgwin).wrapping_sub(<span class="number">16</span>);
    s.hasher_ = opt_hasher;
    <span class="kw">let </span><span class="kw-2">mut </span>dict_size: usize = size;
    <span class="kw">if </span>EnsureInitialized(s) == <span class="number">0 </span>{
        <span class="kw">return</span>;
    }
    <span class="kw">if </span>dict_size == <span class="number">0usize </span>|| s.params.quality == <span class="number">0i32 </span>|| s.params.quality == <span class="number">1i32 </span>|| size &lt;= <span class="number">1 </span>{
        s.params.catable = <span class="bool-val">true</span>; <span class="comment">// don't risk a too-short dictionary
        </span>s.params.appendable = <span class="bool-val">true</span>; <span class="comment">// don't risk a too-short dictionary
        </span><span class="kw">return</span>;
    }
    s.custom_dictionary = <span class="bool-val">true</span>;
    <span class="kw">if </span>size &gt; max_dict_size {
        dict = <span class="kw-2">&amp;</span>dict[size.wrapping_sub(max_dict_size)..];
        dict_size = max_dict_size;
    }
    CopyInputToRingBuffer(s, dict_size, dict);
    s.last_flush_pos_ = dict_size <span class="kw">as </span>u64;
    s.last_processed_pos_ = dict_size <span class="kw">as </span>u64;
    <span class="kw">if </span>dict_size &gt; <span class="number">0 </span>{
        s.prev_byte_ = dict[dict_size.wrapping_sub(<span class="number">1</span>)];
    }
    <span class="kw">if </span>dict_size &gt; <span class="number">1 </span>{
        s.prev_byte2_ = dict[dict_size.wrapping_sub(<span class="number">2</span>)];
    }
    ...
    <span class="kw">if </span><span class="macro">cfg!</span>(debug_assertions) || !has_optional_hasher {
        ...
        HasherPrependCustomDictionary(m16, <span class="kw-2">&amp;mut </span>s.hasher_, <span class="kw-2">&amp;mut </span>s.params, dict_size, dict);
        <span class="kw">if </span>has_optional_hasher {
...
<span class="kw">pub fn </span>BrotliEncoderMaxCompressedSize(input_size: usize) -&gt; usize {
    ...
    <span class="kw">let </span>num_large_blocks: usize = input_size &gt;&gt; <span class="number">14</span>;
    <span class="kw">let </span>tail: usize = input_size.wrapping_sub(num_large_blocks &lt;&lt; <span class="number">24</span>);
    <span class="kw">let </span>tail_overhead: usize = (<span class="kw">if </span>tail &gt; (<span class="number">1i32 </span>&lt;&lt; <span class="number">20</span>) <span class="kw">as </span>usize {
        <span class="number">4i32
    </span>} <span class="kw">else </span>{
    ...
    <span class="kw">if </span>input_size == <span class="number">0usize </span>{
        <span class="kw">return </span><span class="number">1 </span>+ magic_size;
    }
    <span class="kw">if </span>result &lt; input_size {
...
<span class="kw">fn </span>InitOrStitchToPreviousBlock&lt;Alloc: alloc::Allocator&lt;u16&gt; + alloc::Allocator&lt;u32&gt;&gt;(
    ...
    HasherSetup(
        ...
        position,
        input_size,
        is_last <span class="kw">as </span>i32,
    );
...
<span class="kw">pub fn </span>InitInsertCommand(xself: <span class="kw-2">&amp;mut </span>Command, insertlen: usize) {
    xself.insert_len_ = insertlen <span class="kw">as </span>u32;
    xself.copy_len_ = (<span class="number">4i32 </span>&lt;&lt; <span class="number">25</span>) <span class="kw">as </span>u32;
    xself.dist_extra_ = <span class="number">0u32</span>;
    xself.dist_prefix_ = (<span class="number">1u16 </span>&lt;&lt; <span class="number">10</span>) | BROTLI_NUM_DISTANCE_SHORT_CODES <span class="kw">as </span>u16;
    GetLengthCode(insertlen, <span class="number">4usize</span>, <span class="number">0i32</span>, <span class="kw-2">&amp;mut </span>xself.cmd_prefix_);
}

<span class="kw">fn </span>ShouldCompress(
    data: <span class="kw-2">&amp;</span>[u8],
    mask: usize,
    last_flush_pos: u64,
    bytes: usize,
    ...
    <span class="kw">if </span>num_commands &lt; (bytes &gt;&gt; <span class="number">8</span>).wrapping_add(<span class="number">2</span>)
        &amp;&amp; num_literals <span class="kw">as </span>(<span class="kw">super</span>::util::floatX)
            &gt; <span class="number">0.99 </span><span class="kw">as </span><span class="kw">super</span>::util::floatX * bytes <span class="kw">as </span>(<span class="kw">super</span>::util::floatX)
    {
        <span class="kw">let </span><span class="kw-2">mut </span>literal_histo = [<span class="number">0u32</span>; <span class="number">256</span>];
        ...
        <span class="kw">let </span>bit_cost_threshold: <span class="kw">super</span>::util::floatX =
            bytes <span class="kw">as </span>(<span class="kw">super</span>::util::floatX) * kMinEntropy / kSampleRate <span class="kw">as </span>(<span class="kw">super</span>::util::floatX);
        <span class="kw">let </span>t: usize = bytes
            .wrapping_add(kSampleRate <span class="kw">as </span>usize)
            .wrapping_sub(<span class="number">1</span>)
            ...
            {
                {
                    ...
                    <span class="kw">let </span>_lhs = <span class="kw-2">&amp;mut </span>literal_histo[data[(pos <span class="kw">as </span>usize &amp; mask)] <span class="kw">as </span>usize];
...
<span class="comment">/* Chooses the literal context mode for a metablock */
</span><span class="kw">fn </span>ChooseContextMode(
    params: <span class="kw-2">&amp;</span>BrotliEncoderParams,
    data: <span class="kw-2">&amp;</span>[u8],
    pos: usize,
    mask: usize,
    ...
    <span class="kw">if </span>(params.quality &gt;= <span class="number">10 </span>&amp;&amp; BrotliIsMostlyUTF8(data, pos, mask, length, kMinUTF8Ratio) == <span class="number">0</span>) {
...
<span class="kw">fn </span>MakeUncompressedStream(input: <span class="kw-2">&amp;</span>[u8], input_size: usize, output: <span class="kw-2">&amp;mut </span>[u8]) -&gt; usize {
    ...
    <span class="kw">if </span>input_size == <span class="number">0usize </span>{
        output[<span class="number">0</span>] = <span class="number">6u8</span>;
        <span class="kw">return </span><span class="number">1</span>;
    }
    output[result] = <span class="number">0x21u8</span>;
    result = result.wrapping_add(<span class="number">1</span>);
    output[result] = <span class="number">0x3u8</span>;
    result = result.wrapping_add(<span class="number">1</span>);
    <span class="kw">while </span>size &gt; <span class="number">0usize </span>{
        ...
        <span class="kw">let </span>chunk_size: u32 = <span class="kw">if </span>size &gt; (<span class="number">1u32 </span>&lt;&lt; <span class="number">24</span>) <span class="kw">as </span>usize {
            <span class="number">1u32 </span>&lt;&lt; <span class="number">24
        </span>} <span class="kw">else </span>{
            size <span class="kw">as </span>u32
        };
        <span class="kw">if </span>chunk_size &gt; <span class="number">1u32 </span>&lt;&lt; <span class="number">16 </span>{
            nibbles = <span class="kw">if </span>chunk_size &gt; <span class="number">1u32 </span>&lt;&lt; <span class="number">20 </span>{ <span class="number">2i32 </span>} <span class="kw">else </span>{ <span class="number">1i32 </span>} <span class="kw">as </span>u32;
        }
        <span class="kw">let </span>bits: u32 = nibbles &lt;&lt; <span class="number">1
            </span>| chunk_size.wrapping_sub(<span class="number">1</span>) &lt;&lt; <span class="number">3
            </span>| <span class="number">1u32 </span>&lt;&lt; (<span class="number">19u32</span>).wrapping_add((<span class="number">4u32</span>).wrapping_mul(nibbles));
        output[result] = bits <span class="kw">as </span>u8;
        result = result.wrapping_add(<span class="number">1</span>);
        output[result] = (bits &gt;&gt; <span class="number">8</span>) <span class="kw">as </span>u8;
        result = result.wrapping_add(<span class="number">1</span>);
        output[result] = (bits &gt;&gt; <span class="number">16</span>) <span class="kw">as </span>u8;
        result = result.wrapping_add(<span class="number">1</span>);
        <span class="kw">if </span>nibbles == <span class="number">2u32 </span>{
            output[result] = (bits &gt;&gt; <span class="number">24</span>) <span class="kw">as </span>u8;
            result = result.wrapping_add(<span class="number">1</span>);
        }
        output[result..(result + chunk_size <span class="kw">as </span>usize)]
            .clone_from_slice(<span class="kw-2">&amp;</span>input[offset..(offset + chunk_size <span class="kw">as </span>usize)]);
    ...
    output[result] = <span class="number">3u8</span>;
    result = result.wrapping_add(<span class="number">1</span>);
    result
}
<span class="kw">pub fn </span>BrotliEncoderCompress&lt;
    Alloc: BrotliAlloc,
...
&gt;(
    ...
    <span class="kw">if </span>is_fallback == <span class="number">0 </span>{
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>result: i32;
        {
            ...
            <span class="kw">let </span>next_in_array: <span class="kw-2">&amp;</span>[u8] = input_buffer;
            ...
            <span class="kw">let </span>next_out_array: <span class="kw-2">&amp;mut </span>[u8] = output_start;
            <span class="kw">let </span><span class="kw-2">mut </span>next_out_offset: usize = <span class="number">0</span>;
            <span class="kw">let </span><span class="kw-2">mut </span>total_out = <span class="prelude-val">Some</span>(<span class="number">0</span>);
            BrotliEncoderSetParameter(
                s,
                BrotliEncoderParameter::BROTLI_PARAM_QUALITY,
                quality <span class="kw">as </span>u32,
            );
            BrotliEncoderSetParameter(s, BrotliEncoderParameter::BROTLI_PARAM_LGWIN, lgwin <span class="kw">as </span>u32);
    ...
    <span class="macro">assert_ne!</span>(is_fallback, <span class="number">0</span>);
...
<span class="kw">fn </span>InjectBytePaddingBlock&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) {
    <span class="kw">let </span><span class="kw-2">mut </span>seal: u32 = s.last_bytes_ <span class="kw">as </span>u32;
    <span class="kw">let </span><span class="kw-2">mut </span>seal_bits: usize = s.last_bytes_bits_ <span class="kw">as </span>usize;
    <span class="kw">let </span>destination: <span class="kw-2">&amp;mut </span>[u8];
    s.last_bytes_ = <span class="number">0</span>;
    s.last_bytes_bits_ = <span class="number">0</span>;
    seal |= <span class="number">0x6u32 </span>&lt;&lt; seal_bits;

    seal_bits = seal_bits.wrapping_add(<span class="number">6</span>);
    <span class="kw">if </span>!IsNextOutNull(<span class="kw-2">&amp;</span>s.next_out_) {
        destination = <span class="kw-2">&amp;mut </span><span class="macro">GetNextOut!</span>(<span class="kw-2">*</span>s)[s.available_out_..];
    } <span class="kw">else </span>{
        destination = <span class="kw-2">&amp;mut </span>s.tiny_buf_[..];
        s.next_out_ = NextOut::TinyBuf(<span class="number">0</span>);
    }
    destination[<span class="number">0</span>] = seal <span class="kw">as </span>u8;
    <span class="kw">if </span>seal_bits &gt; <span class="number">8usize </span>{
        destination[<span class="number">1</span>] = (seal &gt;&gt; <span class="number">8</span>) <span class="kw">as </span>u8;
    }
    <span class="kw">if </span>seal_bits &gt; <span class="number">16usize </span>{
        destination[<span class="number">2</span>] = (seal &gt;&gt; <span class="number">16</span>) <span class="kw">as </span>u8;
    }
    s.available_out_ = s
        .available_out_
        .wrapping_add(seal_bits.wrapping_add(<span class="number">7</span>) &gt;&gt; <span class="number">3</span>);
}
<span class="kw">fn </span>InjectFlushOrPushOutput&lt;Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">if </span>s.stream_state_ <span class="kw">as </span>i32 == BrotliEncoderStreamState::BROTLI_STREAM_FLUSH_REQUESTED <span class="kw">as </span>i32
        &amp;&amp; (s.last_bytes_bits_ <span class="kw">as </span>i32 != <span class="number">0i32</span>)
    {
        InjectBytePaddingBlock(s);
        <span class="kw">return </span><span class="number">1i32</span>;
    }
    <span class="kw">if </span>s.available_out_ != <span class="number">0usize </span>&amp;&amp; (<span class="kw-2">*</span>available_out != <span class="number">0usize</span>) {
        <span class="kw">let </span>copy_output_size: usize = brotli_min_size_t(s.available_out_, <span class="kw-2">*</span>available_out);
        (<span class="kw-2">*</span>next_out_array)[(<span class="kw-2">*</span>next_out_offset)..(<span class="kw-2">*</span>next_out_offset + copy_output_size)]
            .clone_from_slice(<span class="kw-2">&amp;</span><span class="macro">GetNextOut!</span>(s)[..copy_output_size]);
        <span class="comment">//memcpy(*next_out, s.next_out_, copy_output_size);
        </span><span class="kw-2">*</span>next_out_offset = next_out_offset.wrapping_add(copy_output_size);
        <span class="kw-2">*</span>available_out = available_out.wrapping_sub(copy_output_size);
        s.next_out_ = NextOutIncrement(<span class="kw-2">&amp;</span>s.next_out_, (copy_output_size <span class="kw">as </span>i32));
        s.available_out_ = s.available_out_.wrapping_sub(copy_output_size);
        s.total_out_ = s.total_out_.wrapping_add(copy_output_size <span class="kw">as </span>u64);
        <span class="kw">if let </span><span class="kw-2">&amp;mut </span><span class="prelude-val">Some</span>(<span class="kw-2">ref mut </span>total_out_inner) = total_out {
            <span class="kw-2">*</span>total_out_inner = s.total_out_ <span class="kw">as </span>usize;
        }
        <span class="kw">return </span><span class="number">1i32</span>;
    }
    <span class="number">0i32
...
<span class="kw">fn </span>UnprocessedInputSize&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;</span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; u64 {
    s.input_pos_.wrapping_sub(s.last_processed_pos_)
}

<span class="kw">fn </span>UpdateSizeHint&lt;Alloc: BrotliAlloc&gt;(
    s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;,
    available_in: usize,
) {
    <span class="kw">if </span>s.params.size_hint == <span class="number">0usize </span>{
        ...
        <span class="kw">let </span>limit: u32 = <span class="number">1u32 </span>&lt;&lt; <span class="number">30</span>;
        <span class="kw">let </span>total: u32;
        <span class="kw">if </span>delta &gt;= u64::from(limit)
            || tail &gt;= u64::from(limit)
        ...
        s.params.size_hint = total <span class="kw">as </span>usize;
    }
}
...
<span class="kw">fn </span>WrapPosition(position: u64) -&gt; u32 {
    ...
    <span class="kw">let </span>gb: u64 = position &gt;&gt; <span class="number">30</span>;
    <span class="kw">if </span>gb &gt; <span class="number">2 </span>{
        result = result &amp; (<span class="number">1u32 </span>&lt;&lt; <span class="number">30</span>).wrapping_sub(<span class="number">1</span>)
            | ((gb.wrapping_sub(<span class="number">1</span>) &amp; <span class="number">1</span>) <span class="kw">as </span>u32).wrapping_add(<span class="number">1</span>) &lt;&lt; <span class="number">30</span>;
    }
    result
}
...
<span class="kw">fn </span>InputBlockSize&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; usize {
    ...
    <span class="number">1 </span>&lt;&lt; s.params.lgblock
}

<span class="kw">fn </span>GetBrotliStorage&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;, size: usize) {
    <span class="kw">if </span>s.storage_size_ &lt; size {
        &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::free_cell(<span class="kw-2">&amp;mut </span>s.m8, core::mem::take(<span class="kw-2">&amp;mut </span>s.storage_));
        s.storage_ = &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::alloc_cell(<span class="kw-2">&amp;mut </span>s.m8, size);
...
<span class="kw">fn </span>MaxHashTableSize(quality: i32) -&gt; usize {
    (<span class="kw">if </span>quality == <span class="number">0i32 </span>{
        <span class="number">1i32 </span>&lt;&lt; <span class="number">15
    </span>} <span class="kw">else </span>{
        <span class="number">1i32 </span>&lt;&lt; <span class="number">17
    </span>}) <span class="kw">as </span>usize
}
...
<span class="kw">fn </span>HashTableSize(max_table_size: usize, input_size: usize) -&gt; usize {
    ...
    <span class="kw">while </span>htsize &lt; max_table_size &amp;&amp; (htsize &lt; input_size) {
        htsize &lt;&lt;= <span class="number">1i32</span>;
    }
    htsize
}
...
<span class="macro">macro_rules!</span> GetHashTable {
    (<span class="macro-nonterminal">$s </span>: expr, <span class="macro-nonterminal">$quality</span>: expr, <span class="macro-nonterminal">$input_size </span>: expr, <span class="macro-nonterminal">$table_size </span>: expr) =&gt; {
        GetHashTableInternal(
            <span class="kw-2">&amp;mut </span><span class="macro-nonterminal">$s</span>.m8,
            <span class="kw-2">&amp;mut </span><span class="macro-nonterminal">$s</span>.small_table_,
            <span class="kw-2">&amp;mut </span><span class="macro-nonterminal">$s</span>.large_table_,
            <span class="macro-nonterminal">$quality</span>,
            <span class="macro-nonterminal">$input_size</span>,
            <span class="macro-nonterminal">$table_size</span>,
        )
    };
}
<span class="kw">fn </span>GetHashTableInternal&lt;<span class="lifetime">'a</span>, AllocI32: alloc::Allocator&lt;i32&gt;&gt;(
    mi32: <span class="kw-2">&amp;mut </span>AllocI32,
    ...
    <span class="kw">if </span>quality == <span class="number">0i32 </span>&amp;&amp; htsize &amp; <span class="number">0xaaaaausize </span>== <span class="number">0usize </span>{
        htsize &lt;&lt;= <span class="number">1i32</span>;
    }
...
<span class="kw">fn </span>UpdateLastProcessedPos&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; bool {
    <span class="kw">let </span>wrapped_last_processed_pos: u32 = WrapPosition(s.last_processed_pos_);
    <span class="kw">let </span>wrapped_input_pos: u32 = WrapPosition(s.input_pos_);
...
<span class="kw">fn </span>MaxMetablockSize(params: <span class="kw-2">&amp;</span>BrotliEncoderParams) -&gt; usize {
    ...
    <span class="number">1 </span>&lt;&lt; bits
}

<span class="kw">fn </span>ChooseContextMap(
    quality: i32,
    ...
    <span class="kw">static </span>kStaticContextMapContinuation: [u32; <span class="number">64</span>] = [
        <span class="number">1</span>, <span class="number">1</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
    ...
    <span class="kw">static </span>kStaticContextMapSimpleUTF8: [u32; <span class="number">64</span>] = [
        <span class="number">0</span>, <span class="number">0</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
        <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
        <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>,
    ];
    <span class="kw">let </span><span class="kw-2">mut </span>monogram_histo = [<span class="number">0u32</span>; <span class="number">3</span>];
    <span class="kw">let </span><span class="kw-2">mut </span>two_prefix_histo = [<span class="number">0u32</span>; <span class="number">6</span>];
    ...
    <span class="kw">while </span>i &lt; <span class="number">9usize </span>{
        {
            {
                <span class="kw">let </span>_rhs = bigram_histo[i];
                <span class="kw">let </span>_lhs = <span class="kw-2">&amp;mut </span>monogram_histo[i.wrapping_rem(<span class="number">3</span>)];
                <span class="kw-2">*</span>_lhs = (<span class="kw-2">*</span>_lhs).wrapping_add(_rhs);
            }
            {
                <span class="kw">let </span>_rhs = bigram_histo[i];
                <span class="kw">let </span>_lhs = <span class="kw-2">&amp;mut </span>two_prefix_histo[i.wrapping_rem(<span class="number">6</span>)];
                <span class="kw-2">*</span>_lhs = (<span class="kw-2">*</span>_lhs).wrapping_add(_rhs);
            }
        }
        i = i.wrapping_add(<span class="number">1</span>);
    }
    entropy[<span class="number">1</span>] = ShannonEntropy(<span class="kw-2">&amp;</span>monogram_histo[..], <span class="number">3usize</span>, <span class="kw-2">&amp;mut </span>dummy);
    entropy[<span class="number">2</span>] = ShannonEntropy(<span class="kw-2">&amp;</span>two_prefix_histo[..], <span class="number">3usize</span>, <span class="kw-2">&amp;mut </span>dummy)
        + ShannonEntropy(<span class="kw-2">&amp;</span>two_prefix_histo[<span class="number">3</span>..], <span class="number">3usize</span>, <span class="kw-2">&amp;mut </span>dummy);
    entropy[<span class="number">3</span>] = <span class="number">0i32 </span><span class="kw">as </span>(<span class="kw">super</span>::util::floatX);
    <span class="kw">for </span>i <span class="kw">in </span><span class="number">0usize</span>..<span class="number">3usize </span>{
        entropy[<span class="number">3</span>] += ShannonEntropy(
            <span class="kw-2">&amp;</span>bigram_histo[(<span class="number">3usize</span>).wrapping_mul(i)..],
            <span class="number">3usize</span>,
            <span class="kw-2">&amp;mut </span>dummy,
        );
    }
    <span class="kw">let </span>total: usize = monogram_histo[<span class="number">0</span>]
        .wrapping_add(monogram_histo[<span class="number">1</span>])
        .wrapping_add(monogram_histo[<span class="number">2</span>]) <span class="kw">as </span>usize;
    ...
    entropy[<span class="number">3</span>] <span class="kw-2">*</span>= entropy[<span class="number">0</span>];
    <span class="kw">if </span>quality &lt; <span class="number">7i32 </span>{
        entropy[<span class="number">3</span>] = entropy[<span class="number">1</span>] * <span class="number">10i32 </span><span class="kw">as </span>(<span class="kw">super</span>::util::floatX);
    }
    <span class="kw">if </span>entropy[<span class="number">1</span>] - entropy[<span class="number">2</span>] &lt; <span class="number">0.2 </span><span class="kw">as </span><span class="kw">super</span>::util::floatX
        &amp;&amp; (entropy[<span class="number">1</span>] - entropy[<span class="number">3</span>] &lt; <span class="number">0.2 </span><span class="kw">as </span><span class="kw">super</span>::util::floatX)
    {
        <span class="kw-2">*</span>num_literal_contexts = <span class="number">1</span>;
    } <span class="kw">else if </span>entropy[<span class="number">2</span>] - entropy[<span class="number">3</span>] &lt; <span class="number">0.02 </span><span class="kw">as </span><span class="kw">super</span>::util::floatX {
...
<span class="kw">static </span>kStaticContextMapComplexUTF8: [u32; <span class="number">64</span>] = [
    ...
    </span><span class="number">5</span>, <span class="number">5</span>, <span class="number">10</span>, <span class="number">5</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="number">6</span>, <span class="comment">/* [a-z] */
...
</span><span class="kw">fn </span>ShouldUseComplexStaticContextMap(
        ...
        <span class="kw">while </span>start_pos + <span class="number">64 </span>&lt;= end_pos {
            ...
            strides at every 4kB intervals. */
                ...
                <span class="kw">let </span>context = kStaticContextMapComplexUTF8
                    [BROTLI_CONTEXT(prev1, prev2, utf8_lut) <span class="kw">as </span>usize]
...
<span class="kw">fn </span>DecideOverLiteralContextModeling(
    input: <span class="kw-2">&amp;</span>[u8],
    <span class="kw-2">mut </span>start_pos: usize,
    length: usize,
    mask: usize,
    ...
    <span class="kw">if </span>quality &lt; <span class="number">5i32 </span>|| length &lt; <span class="number">64usize </span>{
    } <span class="kw">else if </span>ShouldUseComplexStaticContextMap(
        input,
        start_pos,
        length,
        mask,
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>bigram_prefix_histo = [<span class="number">0u32</span>; <span class="number">9</span>];
        <span class="kw">while </span>start_pos.wrapping_add(<span class="number">64</span>) &lt;= end_pos {
            {
                <span class="kw">static </span>lut: [i32; <span class="number">4</span>] = [<span class="number">0</span>, <span class="number">0</span>, <span class="number">1</span>, <span class="number">2</span>];
                <span class="kw">let </span>stride_end_pos: usize = start_pos.wrapping_add(<span class="number">64</span>);
                <span class="kw">let </span><span class="kw-2">mut </span>prev: i32 = lut[(input[(start_pos &amp; mask)] <span class="kw">as </span>i32 &gt;&gt; <span class="number">6</span>) <span class="kw">as </span>usize] * <span class="number">3i32</span>;
                <span class="kw">let </span><span class="kw-2">mut </span>pos: usize;
                pos = start_pos.wrapping_add(<span class="number">1</span>);
                <span class="kw">while </span>pos &lt; stride_end_pos {
                    {
                        <span class="kw">let </span>literal: u8 = input[(pos &amp; mask)];
                        {
                            <span class="kw">let </span>_rhs = <span class="number">1</span>;
                            <span class="kw">let </span>cur_ind = (prev + lut[(literal <span class="kw">as </span>i32 &gt;&gt; <span class="number">6</span>) <span class="kw">as </span>usize]);
                            <span class="kw">let </span>_lhs = <span class="kw-2">&amp;mut </span>bigram_prefix_histo[cur_ind <span class="kw">as </span>usize];
                            <span class="kw-2">*</span>_lhs = (<span class="kw-2">*</span>_lhs).wrapping_add(_rhs <span class="kw">as </span>u32);
                        }
                        prev = lut[(literal <span class="kw">as </span>i32 &gt;&gt; <span class="number">6</span>) <span class="kw">as </span>usize] * <span class="number">3i32</span>;
                    }
                    pos = pos.wrapping_add(<span class="number">1</span>);
                }
            }
            start_pos = start_pos.wrapping_add(<span class="number">4096</span>);
        }
        ChooseContextMap(
            quality,
...
<span class="kw">fn </span>WriteMetaBlockInternal&lt;Alloc: BrotliAlloc, Cb&gt;(
    alloc: <span class="kw-2">&amp;mut </span>Alloc,
    data: <span class="kw-2">&amp;</span>[u8],
    mask: usize,
    last_flush_pos: u64,
    bytes: usize,
    <span class="kw-2">mut </span>is_last: bool,
    ...
    ),
{
    ...
    <span class="kw">if </span>params.appendable {
        is_last = <span class="bool-val">false</span>;
    } <span class="kw">else </span>{
        <span class="macro">assert!</span>(!params.catable); <span class="comment">// Sanitize Params senforces this constraint
    </span>}
    ...
    <span class="kw">if </span>ShouldCompress(
        data,
        mask,
        last_flush_pos,
        bytes,
    ...
    <span class="kw">let </span>last_bytes: u16 =
        ((storage[saved_byte_location + <span class="number">1</span>] <span class="kw">as </span>u16) &lt;&lt; <span class="number">8</span>) | storage[saved_byte_location] <span class="kw">as </span>u16;
    <span class="kw">let </span>last_bytes_bits: u8 = <span class="kw-2">*</span>storage_ix <span class="kw">as </span>u8;
    ...
    // why was this removed??
    </span><span class="kw">if </span>params.quality &lt;= <span class="number">2i32 </span>{
        ...
        <span class="kw">if </span>params.quality &lt; <span class="number">10i32 </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>num_literal_contexts: usize = <span class="number">1</span>;
        ...
        <span class="kw">if </span>params.quality &gt;= <span class="number">4i32 </span>{
            ...
            BrotliOptimizeHistograms(num_effective_dist_codes <span class="kw">as </span>usize, <span class="kw-2">&amp;mut </span>mb);
        }
    ...
    <span class="kw">if </span>bytes + <span class="number">4 </span>+ saved_byte_location &lt; (<span class="kw-2">*</span>storage_ix &gt;&gt; <span class="number">3</span>) {
        dist_cache[..<span class="number">4</span>].clone_from_slice(<span class="kw-2">&amp;</span>saved_dist_cache[..<span class="number">4</span>]);
...
<span class="kw">fn </span>ChooseDistanceParams(params: <span class="kw-2">&amp;mut </span>BrotliEncoderParams) {
    ...
    <span class="kw">if </span>params.quality &gt;= <span class="number">4 </span>{
        ...
        <span class="kw">let </span>ndirect_msb = (num_direct_distance_codes &gt;&gt; distance_postfix_bits) &amp; <span class="number">0x0f</span>;
        <span class="kw">if </span>distance_postfix_bits &gt; BROTLI_MAX_NPOSTFIX <span class="kw">as </span>u32
            || num_direct_distance_codes &gt; BROTLI_MAX_NDIRECT <span class="kw">as </span>u32
...
<span class="kw">fn </span>EncodeData&lt;Alloc: BrotliAlloc, MetablockCallback&gt;(
    s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;,
    is_last: bool,
    force_flush: bool,
    ...
    ),
{
    ...
    <span class="kw">if </span>s.is_last_block_emitted_ {
        <span class="kw">return </span><span class="number">0i32</span>;
    }
    <span class="kw">if </span>is_last {
        s.is_last_block_emitted_ = <span class="bool-val">true</span>;
    }
    <span class="kw">if </span>delta &gt; InputBlockSize(s) <span class="kw">as </span>u64 {
        <span class="kw">return </span><span class="number">0i32</span>;
    }
    <span class="kw">let </span><span class="kw-2">mut </span>storage_ix: usize = usize::from(s.last_bytes_bits_);
    {
        <span class="kw">let </span>meta_size = core::cmp::max(
            bytes <span class="kw">as </span>usize,
            s.input_pos_.wrapping_sub(s.last_flush_pos_) <span class="kw">as </span>usize,
        );
        GetBrotliStorage(s, (<span class="number">2usize</span>).wrapping_mul(meta_size).wrapping_add(<span class="number">503 </span>+ <span class="number">24</span>));
    }
    {
        s.storage_.slice_mut()[<span class="number">0</span>] = s.last_bytes_ <span class="kw">as </span>u8;
        s.storage_.slice_mut()[<span class="number">1</span>] = (s.last_bytes_ &gt;&gt; <span class="number">8</span>) <span class="kw">as </span>u8;
    }
    ...
    <span class="kw">if let </span>IsFirst::NothingWritten = s.is_first_mb {
        <span class="kw">if </span>s.params.magic_number {
            BrotliWriteMetadataMetaBlock(<span class="kw-2">&amp;</span>s.params, <span class="kw-2">&amp;mut </span>storage_ix, s.storage_.slice_mut());
            s.last_bytes_ = s.storage_.slice()[(storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16
                | ((s.storage_.slice()[<span class="number">1 </span>+ (storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16) &lt;&lt; <span class="number">8</span>);
            s.last_bytes_bits_ = (storage_ix &amp; <span class="number">7u32 </span><span class="kw">as </span>usize) <span class="kw">as </span>u8;
            s.next_out_ = NextOut::DynamicStorage(<span class="number">0</span>);
    ...
    <span class="kw">if let </span>IsFirst::BothCatableBytesWritten = s.is_first_mb {
        ...
        {
            <span class="kw">let </span>data = <span class="kw-2">&amp;mut </span>s.ringbuffer_.data_mo.slice_mut()[s.ringbuffer_.buffer_index..];
            BrotliStoreUncompressedMetaBlock(
                <span class="kw-2">&amp;mut </span>s.m8,
                ...
                <span class="kw-2">&amp;mut </span>s.recoder_state,
                <span class="kw-2">&amp;mut </span>storage_ix,
                s.storage_.slice_mut(),
                <span class="bool-val">false</span>, <span class="comment">/* suppress meta-block logging */
                </span>callback,
            );
            s.last_bytes_ = s.storage_.slice()[(storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16
                | ((s.storage_.slice()[<span class="number">1 </span>+ (storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16) &lt;&lt; <span class="number">8</span>);
        ...
        s.last_processed_pos_ += num_bytes_to_write_uncompressed <span class="kw">as </span>u64;
        <span class="kw">if </span>num_bytes_to_write_uncompressed &gt;= <span class="number">2 </span>{
            s.is_first_mb = IsFirst::BothCatableBytesWritten;
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>wrapped_last_processed_pos: u32 = WrapPosition(s.last_processed_pos_);
    <span class="kw">if </span>s.params.quality == <span class="number">1i32 </span>&amp;&amp; s.command_buf_.slice().is_empty() {
        <span class="kw">let </span>new_buf =
            &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::alloc_cell(<span class="kw-2">&amp;mut </span>s.m8, kCompressFragmentTwoPassBlockSize);
        s.command_buf_ = new_buf;
        <span class="kw">let </span>new_buf8 =
            &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::alloc_cell(<span class="kw-2">&amp;mut </span>s.m8, kCompressFragmentTwoPassBlockSize);
        s.literal_buf_ = new_buf8;
    }
    <span class="kw">if </span>s.params.quality == <span class="number">0i32 </span>|| s.params.quality == <span class="number">1i32 </span>{
        <span class="kw">let </span><span class="kw-2">mut </span>table_size: usize = <span class="number">0</span>;
        {
            <span class="kw">if </span>delta == <span class="number">0 </span>&amp;&amp; !is_last {
                <span class="kw-2">*</span>out_size = catable_header_size;
                <span class="kw">return </span><span class="number">1i32</span>;
            }
            <span class="kw">let </span>data = <span class="kw-2">&amp;mut </span>s.ringbuffer_.data_mo.slice_mut()[s.ringbuffer_.buffer_index..];
            ...
            </span><span class="kw">let </span>table: <span class="kw-2">&amp;mut </span>[i32] =
                <span class="macro">GetHashTable!</span>(s, s.params.quality, bytes <span class="kw">as </span>usize, <span class="kw-2">&amp;mut </span>table_size);
            ...
            s.last_bytes_ = s.storage_.slice()[(storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16
                | ((s.storage_.slice()[(storage_ix &gt;&gt; <span class="number">3</span>) + <span class="number">1</span>] <span class="kw">as </span>u16) &lt;&lt; <span class="number">8</span>);
            s.last_bytes_bits_ = (storage_ix &amp; <span class="number">7u32 </span><span class="kw">as </span>usize) <span class="kw">as </span>u8;
        }
        UpdateLastProcessedPos(s);
        <span class="comment">// *output = &amp;mut s.storage_.slice_mut();
        </span>s.next_out_ = NextOut::DynamicStorage(<span class="number">0</span>); <span class="comment">// this always returns that
        </span><span class="kw-2">*</span>out_size = storage_ix &gt;&gt; <span class="number">3</span>;
        <span class="kw">return </span><span class="number">1i32</span>;
    }
    {
        <span class="kw">let </span><span class="kw-2">mut </span>newsize: usize = s
            .num_commands_
            .wrapping_add(bytes.wrapping_div(<span class="number">2</span>) <span class="kw">as </span>usize)
            .wrapping_add(<span class="number">1</span>);
        <span class="kw">if </span>newsize &gt; s.cmd_alloc_size_ {
            newsize = newsize.wrapping_add(bytes.wrapping_div(<span class="number">4</span>).wrapping_add(<span class="number">16</span>) <span class="kw">as </span>usize);
            ...
            <span class="kw">if </span>!s.commands_.slice().is_empty() {
                new_commands.slice_mut()[..s.num_commands_]
                    .clone_from_slice(<span class="kw-2">&amp;</span>s.commands_.slice()[..s.num_commands_]);
                &lt;Alloc <span class="kw">as </span>Allocator&lt;Command&gt;&gt;::free_cell(
                    <span class="kw-2">&amp;mut </span>s.m8,
                    core::mem::take(<span class="kw-2">&amp;mut </span>s.commands_),
                );
            }
    ...
    InitOrStitchToPreviousBlock(
        <span class="kw-2">&amp;mut </span>s.m8,
        <span class="kw-2">&amp;mut </span>s.hasher_,
        <span class="kw-2">&amp;mut </span>s.ringbuffer_.data_mo.slice_mut()[s.ringbuffer_.buffer_index..],
        mask <span class="kw">as </span>usize,
        <span class="kw-2">&amp;mut </span>s.params,
    ...
    <span class="kw">let </span>literal_context_mode = ChooseContextMode(
        ...
        WrapPosition(s.last_flush_pos_) <span class="kw">as </span>usize,
        mask <span class="kw">as </span>usize,
        (s.input_pos_.wrapping_sub(s.last_flush_pos_)) <span class="kw">as </span>usize,
    );
    ...
    <span class="kw">if </span><span class="bool-val">false </span>{
        <span class="comment">// we are remapping 10 as quality=9.5 since Zopfli doesn't seem to offer much benefits here
    ...
    BrotliCreateZopfliBackwardReferences(m,
    ...
    } <span class="kw">else if </span><span class="bool-val">false </span>&amp;&amp; s.params.quality == <span class="number">11i32 </span>{
        <span class="macro">panic!</span>(
            <span class="string">r####"BrotliCreateHqZopfliBackwardReferences(m,
                                           dictionary,
                                           bytes as usize,
                                           wrapped_last_processed_pos as usize,
                                           data,
        ...
        BrotliCreateBackwardReferences(
            ...
            <span class="kw-2">&amp;mut </span>s.params,
            <span class="kw-2">&amp;mut </span>s.hasher_,
            <span class="kw-2">&amp;mut </span>s.dist_cache_,
            <span class="kw-2">&amp;mut </span>s.last_insert_len_,
            <span class="kw-2">&amp;mut </span>s.commands_.slice_mut()[s.num_commands_..],
            <span class="kw-2">&amp;mut </span>s.num_commands_,
            <span class="kw-2">&amp;mut </span>s.num_literals_,
        );
    }
    {
        <span class="kw">let </span>max_length: usize = MaxMetablockSize(<span class="kw-2">&amp;mut </span>s.params);
        <span class="kw">let </span>max_literals: usize = max_length.wrapping_div(<span class="number">8</span>);
        <span class="kw">let </span>max_commands: usize = max_length.wrapping_div(<span class="number">8</span>);
        <span class="kw">let </span>processed_bytes: usize = s.input_pos_.wrapping_sub(s.last_flush_pos_) <span class="kw">as </span>usize;
        <span class="kw">let </span>next_input_fits_metablock =
            processed_bytes.wrapping_add(InputBlockSize(s)) &lt;= max_length;
        <span class="kw">let </span>should_flush =
            s.params.quality &lt; <span class="number">4 </span>&amp;&amp; s.num_literals_.wrapping_add(s.num_commands_) &gt;= <span class="number">0x2fff</span>;
        <span class="kw">if </span>!is_last
            &amp;&amp; !force_flush
            &amp;&amp; !should_flush
        ...
        {
            <span class="kw">if </span>UpdateLastProcessedPos(s) {
                HasherReset(<span class="kw-2">&amp;mut </span>s.hasher_);
            }
            <span class="kw-2">*</span>out_size = catable_header_size;
            <span class="kw">return </span><span class="number">1i32</span>;
        }
    }
    <span class="kw">if </span>s.last_insert_len_ &gt; <span class="number">0usize </span>{
        InitInsertCommand(
            <span class="kw-2">&amp;mut </span>s.commands_.slice_mut()[s.num_commands_],
            s.last_insert_len_,
        );
        s.num_commands_ = s.num_commands_.wrapping_add(<span class="number">1</span>);
        s.num_literals_ = s.num_literals_.wrapping_add(s.last_insert_len_);
        s.last_insert_len_ = <span class="number">0usize</span>;
    }
    <span class="kw">if </span>!is_last &amp;&amp; s.input_pos_ == s.last_flush_pos_ {
        <span class="kw-2">*</span>out_size = catable_header_size;
        <span class="kw">return </span><span class="number">1i32</span>;
    }
    {
        <span class="kw">let </span>metablock_size: u32 = s.input_pos_.wrapping_sub(s.last_flush_pos_) <span class="kw">as </span>u32;
        <span class="comment">//let mut storage_ix: usize = s.last_bytes_bits_ as usize;
        //s.storage_.slice_mut()[0] = (*s).last_bytes_ as u8;
        //s.storage_.slice_mut()[1] = ((*s).last_bytes_ &gt;&gt; 8) as u8;

        </span>WriteMetaBlockInternal(
            <span class="kw-2">&amp;mut </span>s.m8,
            <span class="kw-2">&amp;mut </span>s.ringbuffer_.data_mo.slice_mut()[s.ringbuffer_.buffer_index..],
            mask <span class="kw">as </span>usize,
            s.last_flush_pos_,
            ...
            literal_context_mode,
            <span class="kw-2">&amp;mut </span>s.params,
            <span class="kw-2">&amp;mut </span>s.literal_scratch_space,
            <span class="kw-2">&amp;mut </span>s.command_scratch_space,
            <span class="kw-2">&amp;mut </span>s.distance_scratch_space,
            s.prev_byte_,
            s.prev_byte2_,
            s.num_literals_,
            s.num_commands_,
            s.commands_.slice_mut(),
            <span class="kw-2">&amp;mut </span>s.saved_dist_cache_,
            <span class="kw-2">&amp;mut </span>s.dist_cache_,
            <span class="kw-2">&amp;mut </span>s.recoder_state,
            <span class="kw-2">&amp;mut </span>storage_ix,
            s.storage_.slice_mut(),
        ...
        <span class="kw">let </span>data = <span class="kw-2">&amp;</span>s.ringbuffer_.data_mo.slice()[s.ringbuffer_.buffer_index..];
        <span class="kw">if </span>s.last_flush_pos_ &gt; <span class="number">0 </span>{
            s.prev_byte_ = data[(((s.last_flush_pos_ <span class="kw">as </span>u32).wrapping_sub(<span class="number">1</span>) &amp; mask) <span class="kw">as </span>usize)];
        }
        <span class="kw">if </span>s.last_flush_pos_ &gt; <span class="number">1 </span>{
            s.prev_byte2_ = data[((s.last_flush_pos_.wrapping_sub(<span class="number">2</span>) <span class="kw">as </span>u32 &amp; mask) <span class="kw">as </span>usize)];
        }
        s.num_commands_ = <span class="number">0usize</span>;
        s.num_literals_ = <span class="number">0usize</span>;
        s.saved_dist_cache_
            .clone_from_slice(s.dist_cache_.split_at(<span class="number">4</span>).<span class="number">0</span>);
        s.next_out_ = NextOut::DynamicStorage(<span class="number">0</span>); <span class="comment">// this always returns that
        </span><span class="kw-2">*</span>out_size = storage_ix &gt;&gt; <span class="number">3</span>;
        <span class="number">1i32
    </span>}
}

<span class="kw">fn </span>WriteMetadataHeader&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; usize {
    <span class="kw">let </span>block_size = s.remaining_metadata_bytes_ <span class="kw">as </span>usize;
    ...
    storage_ix = s.last_bytes_bits_ <span class="kw">as </span>usize;
    header[<span class="number">0</span>] = s.last_bytes_ <span class="kw">as </span>u8;
    header[<span class="number">1</span>] = (s.last_bytes_ &gt;&gt; <span class="number">8</span>) <span class="kw">as </span>u8;
    s.last_bytes_ = <span class="number">0</span>;
    s.last_bytes_bits_ = <span class="number">0</span>;
    BrotliWriteBits(<span class="number">1</span>, <span class="number">0</span>, <span class="kw-2">&amp;mut </span>storage_ix, header);
    ...
    <span class="kw">if </span>block_size == <span class="number">0usize </span>{
        ...
        <span class="kw">let </span>nbits: u32 = <span class="kw">if </span>block_size == <span class="number">1 </span>{
            <span class="number">0u32
        </span>} <span class="kw">else </span>{
            Log2FloorNonZero((block_size <span class="kw">as </span>u32).wrapping_sub(<span class="number">1</span>) <span class="kw">as </span>(u64)).wrapping_add(<span class="number">1</span>)
        };
        <span class="kw">let </span>nbytes: u32 = nbits.wrapping_add(<span class="number">7</span>).wrapping_div(<span class="number">8</span>);
        ...
        BrotliWriteBits(
            (<span class="number">8u32</span>).wrapping_mul(nbytes) <span class="kw">as </span>usize,
            block_size.wrapping_sub(<span class="number">1</span>) <span class="kw">as </span>u64,
            <span class="kw-2">&amp;mut </span>storage_ix,
            header,
        );
    }
    storage_ix.wrapping_add(<span class="number">7u32 </span><span class="kw">as </span>usize) &gt;&gt; <span class="number">3
</span>}
...
<span class="kw">fn </span>ProcessMetadata&lt;
    Alloc: BrotliAlloc,
    MetaBlockCallback: FnMut(
        <span class="kw-2">&amp;mut </span>interface::PredictionModeContextMap&lt;InputReferenceMut&gt;,
        <span class="kw-2">&amp;mut </span>[interface::StaticCommand],
...
&gt;(
    ...
    <span class="kw">if </span><span class="kw-2">*</span>available_in &gt; (<span class="number">1u32 </span>&lt;&lt; <span class="number">24</span>) <span class="kw">as </span>usize {
        <span class="kw">return </span><span class="number">0i32</span>;
    }
    <span class="kw">if </span>s.stream_state_ <span class="kw">as </span>i32 == BrotliEncoderStreamState::BROTLI_STREAM_PROCESSING <span class="kw">as </span>i32 {
        s.remaining_metadata_bytes_ = <span class="kw-2">*</span>available_in <span class="kw">as </span>u32;
        s.stream_state_ = BrotliEncoderStreamState::BROTLI_STREAM_METADATA_HEAD;
    }
    <span class="kw">if </span>s.stream_state_ <span class="kw">as </span>i32 != BrotliEncoderStreamState::BROTLI_STREAM_METADATA_HEAD <span class="kw">as </span>i32
        &amp;&amp; (s.stream_state_ <span class="kw">as </span>i32 != BrotliEncoderStreamState::BROTLI_STREAM_METADATA_BODY <span class="kw">as </span>i32)
    {
        <span class="kw">return </span><span class="number">0i32</span>;
    }
    <span class="kw">loop </span>{
        <span class="kw">if </span>InjectFlushOrPushOutput(s, available_out, next_out_array, next_out_offset, total_out)
            != <span class="number">0
        </span>{
            <span class="kw">continue</span>;
        }
        <span class="kw">if </span>s.available_out_ != <span class="number">0usize </span>{
            <span class="kw">break</span>;
        }
        <span class="kw">if </span>s.input_pos_ != s.last_flush_pos_ {
            <span class="kw">let </span><span class="kw-2">mut </span>avail_out: usize = s.available_out_;
            <span class="kw">let </span>result: i32 = EncodeData(s, <span class="bool-val">false</span>, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>avail_out, metablock_callback);
        ...
        <span class="kw">if </span>s.stream_state_ <span class="kw">as </span>i32 == BrotliEncoderStreamState::BROTLI_STREAM_METADATA_HEAD <span class="kw">as </span>i32 {
            ...
            <span class="kw">if </span>s.remaining_metadata_bytes_ == <span class="number">0u32 </span>{
                s.remaining_metadata_bytes_ = !(<span class="number">0u32</span>);
            ...
            <span class="kw">if </span><span class="kw-2">*</span>available_out != <span class="number">0 </span>{
                <span class="kw">let </span>copy: u32 =
                    brotli_min_size_t(s.remaining_metadata_bytes_ <span class="kw">as </span>usize, <span class="kw-2">*</span>available_out) <span class="kw">as </span>u32;
                next_out_array[<span class="kw-2">*</span>next_out_offset..(<span class="kw-2">*</span>next_out_offset + copy <span class="kw">as </span>usize)]
                    .clone_from_slice(
                ...
                <span class="kw-2">*</span>available_in = available_in.wrapping_sub(copy <span class="kw">as </span>usize);
                ...
                </span><span class="kw-2">*</span>available_out = available_out.wrapping_sub(copy <span class="kw">as </span>usize);
            } <span class="kw">else </span>{
                <span class="kw">let </span>copy: u32 = brotli_min_uint32_t(s.remaining_metadata_bytes_, <span class="number">16u32</span>);
                s.next_out_ = NextOut::TinyBuf(<span class="number">0</span>);
                ...
                <span class="kw-2">*</span>available_in = available_in.wrapping_sub(copy <span class="kw">as </span>usize);
                s.remaining_metadata_bytes_ = s.remaining_metadata_bytes_.wrapping_sub(copy);
                s.available_out_ = copy <span class="kw">as </span>usize;
            }
            {
                <span class="kw">continue</span>;
            }
...
<span class="kw">fn </span>CheckFlushCompleteInner(
    stream_state: <span class="kw-2">&amp;mut </span>BrotliEncoderStreamState,
    available_out: usize,
    next_out: <span class="kw-2">&amp;mut </span>NextOut,
) {
    <span class="kw">if </span><span class="kw-2">*</span>stream_state == BrotliEncoderStreamState::BROTLI_STREAM_FLUSH_REQUESTED
...
<span class="kw">fn </span>CheckFlushComplete&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;) {
    CheckFlushCompleteInner(<span class="kw-2">&amp;mut </span>s.stream_state_, s.available_out_, <span class="kw-2">&amp;mut </span>s.next_out_);
}
...
<span class="kw">fn </span>BrotliEncoderCompressStreamFast&lt;Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">let </span>block_size_limit: usize = <span class="number">1 </span>&lt;&lt; s.params.lgwin;
    <span class="kw">let </span>buf_size: usize = brotli_min_size_t(
    ...
    <span class="kw">if </span>s.params.quality == <span class="number">1i32 </span>{
        <span class="kw">if </span>s.command_buf_.slice().is_empty() &amp;&amp; (buf_size == kCompressFragmentTwoPassBlockSize) {
            s.command_buf_ =
                &lt;Alloc <span class="kw">as </span>Allocator&lt;u32&gt;&gt;::alloc_cell(<span class="kw-2">&amp;mut </span>s.m8, kCompressFragmentTwoPassBlockSize);
            s.literal_buf_ =
                &lt;Alloc <span class="kw">as </span>Allocator&lt;u8&gt;&gt;::alloc_cell(<span class="kw-2">&amp;mut </span>s.m8, kCompressFragmentTwoPassBlockSize);
        }
        <span class="kw">if </span>!s.command_buf_.slice().is_empty() {
            command_buf = core::mem::take(<span class="kw-2">&amp;mut </span>s.command_buf_);
            literal_buf = core::mem::take(<span class="kw-2">&amp;mut </span>s.literal_buf_);
        } <span class="kw">else </span>{
    ...
    <span class="kw">loop </span>{
        ...
        <span class="kw">if </span>s.available_out_ == <span class="number">0usize
            </span>&amp;&amp; (s.stream_state_ <span class="kw">as </span>i32 == BrotliEncoderStreamState::BROTLI_STREAM_PROCESSING <span class="kw">as </span>i32)
            &amp;&amp; (<span class="kw-2">*</span>available_in != <span class="number">0usize
                </span>|| op <span class="kw">as </span>i32 != BrotliEncoderOperation::BROTLI_OPERATION_PROCESS <span class="kw">as </span>i32)
        {
            <span class="kw">let </span>block_size: usize = brotli_min_size_t(block_size_limit, <span class="kw-2">*</span>available_in);
            <span class="kw">let </span>is_last = <span class="kw-2">*</span>available_in == block_size
                &amp;&amp; op == BrotliEncoderOperation::BROTLI_OPERATION_FINISH;
            <span class="kw">let </span>force_flush =
                <span class="kw-2">*</span>available_in == block_size &amp;&amp; op == BrotliEncoderOperation::BROTLI_OPERATION_FLUSH;
            <span class="kw">let </span>max_out_size: usize = (<span class="number">2usize</span>).wrapping_mul(block_size).wrapping_add(<span class="number">503</span>);
            ...
            <span class="kw">let </span><span class="kw-2">mut </span>storage_ix: usize = s.last_bytes_bits_ <span class="kw">as </span>usize;
            <span class="kw">let </span><span class="kw-2">mut </span>table_size: usize = <span class="number">0</span>;

            <span class="kw">if </span>force_flush &amp;&amp; block_size == <span class="number">0 </span>{
            ...
            storage[<span class="number">0</span>] = s.last_bytes_ <span class="kw">as </span>u8;
            storage[<span class="number">1</span>] = (s.last_bytes_ &gt;&gt; <span class="number">8</span>) <span class="kw">as </span>u8;
            <span class="kw">let </span>table: <span class="kw-2">&amp;mut </span>[i32] = <span class="macro">GetHashTable!</span>(s, s.params.quality, block_size, <span class="kw-2">&amp;mut </span>table_size);
            <span class="kw">if </span>s.params.quality == <span class="number">0i32 </span>{
                BrotliCompressFragmentFast(
                    <span class="kw-2">&amp;mut </span>s.m8,
            ...
            <span class="kw-2">*</span>next_in_offset += block_size;
            <span class="kw-2">*</span>available_in = available_in.wrapping_sub(block_size);
            <span class="kw">if </span>inplace != <span class="number">0 </span>{
                <span class="kw">let </span>out_bytes: usize = storage_ix &gt;&gt; <span class="number">3</span>;
                <span class="number">0i32</span>;
                <span class="number">0i32</span>;
                <span class="kw-2">*</span>next_out_offset += out_bytes;
                <span class="kw-2">*</span>available_out = available_out.wrapping_sub(out_bytes);
                s.total_out_ = s.total_out_.wrapping_add(out_bytes <span class="kw">as </span>u64);
                <span class="kw">if let </span><span class="kw-2">&amp;mut </span><span class="prelude-val">Some</span>(<span class="kw-2">ref mut </span>total_out_inner) = total_out {
                    <span class="kw-2">*</span>total_out_inner = s.total_out_ <span class="kw">as </span>usize;
                }
            } <span class="kw">else </span>{
            ...
            s.last_bytes_ =
                storage[(storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16 | ((storage[<span class="number">1 </span>+ (storage_ix &gt;&gt; <span class="number">3</span>)] <span class="kw">as </span>u16) &lt;&lt; <span class="number">8</span>);
            s.last_bytes_bits_ = (storage_ix &amp; <span class="number">7u32 </span><span class="kw">as </span>usize) <span class="kw">as </span>u8;
            <span class="kw">if </span>force_flush {
                s.stream_state_ = BrotliEncoderStreamState::BROTLI_STREAM_FLUSH_REQUESTED;
            }
            <span class="kw">if </span>is_last {
    ...
    <span class="kw">if </span>command_buf.slice().len() == kCompressFragmentTwoPassBlockSize
        &amp;&amp; s.command_buf_.slice().is_empty()
    {
        <span class="comment">// undo temporary aliasing of command_buf and literal_buf
        </span>s.command_buf_ = core::mem::take(<span class="kw-2">&amp;mut </span>command_buf);
        s.literal_buf_ = core::mem::take(<span class="kw-2">&amp;mut </span>literal_buf);
    } <span class="kw">else </span>{
...
<span class="kw">pub fn </span>BrotliEncoderCompressStream&lt;
    Alloc: BrotliAlloc,
    MetablockCallback: FnMut(
        <span class="kw-2">&amp;mut </span>interface::PredictionModeContextMap&lt;InputReferenceMut&gt;,
        <span class="kw-2">&amp;mut </span>[interface::StaticCommand],
...
&gt;(
    ...
    <span class="kw">if </span>s.remaining_metadata_bytes_ != !(<span class="number">0u32</span>) {
        <span class="kw">if </span><span class="kw-2">*</span>available_in != s.remaining_metadata_bytes_ <span class="kw">as </span>usize {
            <span class="kw">return </span><span class="number">0i32</span>;
        }
    ...
    <span class="kw">if </span>op <span class="kw">as </span>i32 == BrotliEncoderOperation::BROTLI_OPERATION_EMIT_METADATA <span class="kw">as </span>i32 {
        ...
        <span class="kw">return </span>ProcessMetadata(
            s,
            available_in,
            next_in_array,
            next_in_offset,
    ...
    <span class="kw">if </span>(s.params.quality == <span class="number">0i32 </span>|| s.params.quality == <span class="number">1i32</span>) &amp;&amp; !s.params.catable {
        <span class="comment">// this part of the code does not support concatability
        </span><span class="kw">return </span>BrotliEncoderCompressStreamFast(
            s,
            op,
            available_in,
            next_in_array,
    ...
    <span class="kw">loop </span>{
        ...
        <span class="kw">if </span>remaining_block_size != <span class="number">0usize </span>&amp;&amp; (<span class="kw-2">*</span>available_in != <span class="number">0usize</span>) {
            ...
            <span class="kw-2">*</span>next_in_offset += copy_input_size;
            <span class="kw-2">*</span>available_in = available_in.wrapping_sub(copy_input_size);
            {
                <span class="kw">continue</span>;
            }
        }
        ...
        <span class="kw">if </span>s.available_out_ == <span class="number">0usize
            ...
            &amp;&amp; (remaining_block_size == <span class="number">0usize
                </span>|| op <span class="kw">as </span>i32 != BrotliEncoderOperation::BROTLI_OPERATION_PROCESS <span class="kw">as </span>i32)
        {
            <span class="kw">let </span>is_last =
                <span class="kw-2">*</span>available_in == <span class="number">0 </span>&amp;&amp; op == BrotliEncoderOperation::BROTLI_OPERATION_FINISH;
            <span class="kw">let </span>force_flush =
                <span class="kw-2">*</span>available_in == <span class="number">0 </span>&amp;&amp; op == BrotliEncoderOperation::BROTLI_OPERATION_FLUSH;

            UpdateSizeHint(s, <span class="kw-2">*</span>available_in);
            <span class="kw">let </span><span class="kw-2">mut </span>avail_out = s.available_out_;
            <span class="kw">let </span>result: i32 =
                EncodeData(s, is_last, force_flush, <span class="kw-2">&amp;mut </span>avail_out, metablock_callback);
            s.available_out_ = avail_out;
...
<span class="kw">pub fn </span>BrotliEncoderIsFinished&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;</span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; i32 {
    <span class="kw">if </span>s.stream_state_ == BrotliEncoderStreamState::BROTLI_STREAM_FINISHED
        &amp;&amp; BrotliEncoderHasMoreOutput(s) == <span class="number">0
    </span>{
        <span class="number">1i32
    </span>} <span class="kw">else </span>{
        <span class="number">0i32
...
<span class="kw">pub fn </span>BrotliEncoderHasMoreOutput&lt;Alloc: BrotliAlloc&gt;(s: <span class="kw-2">&amp;</span>BrotliEncoderStateStruct&lt;Alloc&gt;) -&gt; i32 {
    <span class="kw">if </span>s.available_out_ != <span class="number">0 </span>{
        <span class="number">1i32
    </span>} <span class="kw">else </span>{
        <span class="number">0i32
    </span>}
...
<span class="kw">pub fn </span>BrotliEncoderTakeOutput&lt;<span class="lifetime">'a</span>, Alloc: BrotliAlloc&gt;(
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>consumed_size: usize = s.available_out_;
    ...
    <span class="kw">if </span><span class="kw-2">*</span>size != <span class="number">0 </span>{
        consumed_size = brotli_min_size_t(<span class="kw-2">*</span>size, s.available_out_);
    }
    <span class="kw">if </span>consumed_size != <span class="number">0 </span>{
        s.next_out_ = NextOutIncrement(<span class="kw-2">&amp;</span>s.next_out_, consumed_size <span class="kw">as </span>i32);
        s.available_out_ = s.available_out_.wrapping_sub(consumed_size);
        s.total_out_ = s.total_out_.wrapping_add(consumed_size <span class="kw">as </span>u64);
        CheckFlushCompleteInner(<span class="kw-2">&amp;mut </span>s.stream_state_, s.available_out_, <span class="kw-2">&amp;mut </span>s.next_out_);
...
<span class="kw">pub fn </span>BrotliEncoderInputBlockSize&lt;Alloc: BrotliAlloc&gt;(
    s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;,
) -&gt; usize {
    InputBlockSize(s)
}

<span class="kw">pub fn </span>BrotliEncoderCopyInputToRingBuffer&lt;Alloc: BrotliAlloc&gt;(
    s: <span class="kw-2">&amp;mut </span>BrotliEncoderStateStruct&lt;Alloc&gt;,
    input_size: usize,
    input_buffer: <span class="kw-2">&amp;</span>[u8],
) {
...
<span class="kw">pub fn </span>BrotliEncoderWriteData&lt;
...
&gt;(
    ...
    <span class="kw">let </span>ret = EncodeData(
        s,
        is_last != <span class="number">0</span>,
        force_flush != <span class="number">0</span>,
        out_size,
        metablock_callback,
    );
    <span class="kw-2">*</span>output = s.storage_.slice_mut();
    ret
}
