<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/futures-sink-0.3.30/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="futures_sink" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../futures_sink/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</pre></div><pre class="rust"><code><span class="doccomment">//! Asynchronous sinks
//!
...
<span class="doccomment">/// A `Sink` is a value into which other values can be sent, asynchronously.
///
...
/// the simplest way to ultimately consume a stream.
...
</span><span class="kw">pub trait </span>Sink&lt;Item&gt; {
    <span class="doccomment">/// The type of value produced by the sink when an error occurs.
    </span><span class="kw">type </span>Error;

    <span class="doccomment">/// Attempts to prepare the `Sink` to receive a value.
    ///
    ...
    <span class="doccomment">/// Begin the process of sending a value to the sink.
    ...
    /// In most cases, if the sink encounters an error, the sink will
    /// permanently be unable to receive items.
    </span><span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: Item) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;;

    <span class="doccomment">/// Flush any remaining output from this sink.
    ///
    ...
    <span class="doccomment">/// Flush any remaining output and close this sink, if necessary.
    ///
    ...
    </span><span class="kw">fn </span>poll_close(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt;;
}

<span class="kw">impl</span>&lt;S: <span class="question-mark">?</span>Sized + Sink&lt;Item&gt; + Unpin, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span><span class="kw-2">&amp;mut </span>S {
    ...
    <span class="kw">fn </span>poll_ready(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).poll_ready(cx)
    }

    <span class="kw">fn </span>start_send(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: Item) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
        Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).start_send(item)
    }
...
<span class="kw">impl</span>&lt;P, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Pin&lt;P&gt;
<span class="kw">where
    </span>P: DerefMut + Unpin,
    P::Target: Sink&lt;Item&gt;,
{
    <span class="kw">type </span>Error = &lt;P::Target <span class="kw">as </span>Sink&lt;Item&gt;&gt;::Error;
    ...
    <span class="kw">fn </span>poll_ready(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        <span class="self">self</span>.get_mut().as_mut().poll_ready(cx)
    }
    ...
    <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: Item) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
        <span class="self">self</span>.get_mut().as_mut().start_send(item)
    }
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    ...
    <span class="kw">use </span>core::convert::Infallible <span class="kw">as </span>Never;

    <span class="kw">impl</span>&lt;T&gt; Sink&lt;T&gt; <span class="kw">for </span>alloc::vec::Vec&lt;T&gt; {
        <span class="kw">type </span>Error = Never;

        <span class="kw">fn </span>poll_ready(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        ...
        <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: T) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
            <span class="comment">// TODO: impl&lt;T&gt; Unpin for Vec&lt;T&gt; {}
            </span><span class="kw">unsafe </span>{ <span class="self">self</span>.get_unchecked_mut() }.push(item);
            <span class="prelude-val">Ok</span>(())
        }

        <span class="kw">fn </span>poll_flush(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
            Poll::Ready(<span class="prelude-val">Ok</span>(()))
        }

        <span class="kw">fn </span>poll_close(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
            Poll::Ready(<span class="prelude-val">Ok</span>(()))
        }
    }

    <span class="kw">impl</span>&lt;T&gt; Sink&lt;T&gt; <span class="kw">for </span>alloc::collections::VecDeque&lt;T&gt; {
        <span class="kw">type </span>Error = Never;
        ...
        <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: T) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
            <span class="comment">// TODO: impl&lt;T&gt; Unpin for Vec&lt;T&gt; {}
            </span><span class="kw">unsafe </span>{ <span class="self">self</span>.get_unchecked_mut() }.push_back(item);
            <span class="prelude-val">Ok</span>(())
        }
    ...
    <span class="kw">impl</span>&lt;S: <span class="question-mark">?</span>Sized + Sink&lt;Item&gt; + Unpin, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>alloc::boxed::Box&lt;S&gt; {
        <span class="kw">type </span>Error = S::Error;
