<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/num-integer-0.1.46/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="num_integer" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../num_integer/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
<span class="kw">use </span>num_traits::{Num, Signed, Zero};

<span class="kw">mod </span>roots;
<span class="kw">pub use </span><span class="kw">crate</span>::roots::Roots;
<span class="kw">pub use </span><span class="kw">crate</span>::roots::{cbrt, nth_root, sqrt};

<span class="kw">mod </span>average;
<span class="kw">pub use </span><span class="kw">crate</span>::average::Average;
<span class="kw">pub use </span><span class="kw">crate</span>::average::{average_ceil, average_floor};
...
<span class="kw">pub trait </span>Integer: Sized + Num + PartialOrd + Ord + Eq {
    ...
    </span><span class="attr">#[deprecated(note = <span class="string">"Please use is_multiple_of instead"</span>)]
    #[inline]
    ...
    <span class="doccomment">/// Decrements self by one.
    ///
    /// # Examples
    ///
    /// ~~~
    ...
    /// assert_eq!(x, 42);
    /// ~~~
    </span><span class="kw">fn </span>dec(<span class="kw-2">&amp;mut </span><span class="self">self</span>)
    <span class="kw">where
        </span><span class="self">Self</span>: Clone,
    {
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">self</span>.clone() - <span class="self">Self</span>::one()
    }

    <span class="doccomment">/// Increments self by one.
    ///
    /// # Examples
    ///
    /// ~~~
    ...
    /// assert_eq!(x, 42);
    /// ~~~
    </span><span class="kw">fn </span>inc(<span class="kw-2">&amp;mut </span><span class="self">self</span>)
    <span class="kw">where
        </span><span class="self">Self</span>: Clone,
    {
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">self</span>.clone() + <span class="self">Self</span>::one()
...
<span class="macro">macro_rules!</span> impl_integer_for_isize {
    (<span class="macro-nonterminal">$T</span>:ty, <span class="macro-nonterminal">$test_mod</span>:ident) =&gt; {
        ...
        <span class="attr">#[cfg(test)]
            ...
            <span class="kw">use </span><span class="kw">crate</span>::Integer;
            ...
            <span class="attr">#[test]
                ...
                <span class="kw">use </span><span class="kw">crate</span>::ExtendedGcd;
...
<span class="macro">impl_integer_for_isize!</span>(i128, test_integer_i128);
...
<span class="macro">impl_integer_for_usize!</span>(u128, test_integer_u128);
