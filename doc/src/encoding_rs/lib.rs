...
#![cfg_attr(feature = <span class="string">"simd-accel"</span>, feature(core_intrinsics, portable_simd))]
...
</span><span class="attr">#[derive(PartialEq, Debug, Copy, Clone)]
...
</span><span class="attr">#[cfg(all(test, feature = <span class="string">"serde"</span>))]
