...
</span><span class="attr">#![deny(missing_docs, missing_debug_implementations, rust_2018_idioms)]
...
</span><span class="attr">#![doc(test(attr(deny(warnings))))]
...
/// defining the modules.
    ...
    (
        ...
        $(
            $(<span class="attr">#[<span class="macro-nonterminal">$target</span>: meta]</span>)*
        ...
        <span class="kw">impl </span>std::fmt::Debug <span class="kw">for </span><span class="macro-nonterminal">$</span><span class="kw">type </span>{
            <span class="kw">fn </span><span class="macro-nonterminal">fmt</span>(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>std::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; std::fmt::Result {
                <span class="kw">let </span>string = <span class="kw">match </span><span class="self">self</span>.<span class="number">0 </span>{
                    $(
                        $(<span class="attr">#[<span class="macro-nonterminal">$target</span>]</span>)*
                    ...
                    n =&gt; <span class="kw">return </span><span class="macro">write!</span>(f, <span class="string">"{n}"</span>),
                };
                f.write_str(string)
            }
        }
    ...
    (<span class="macro-nonterminal">$from</span>: ty, <span class="macro-nonterminal">$</span><span class="kw">for</span>: <span class="macro-nonterminal">ty</span>) =&gt; {
        <span class="kw">impl </span>From&lt;<span class="macro-nonterminal">$from</span>&gt; <span class="kw">for </span><span class="macro-nonterminal">$</span><span class="kw">for </span>{
            <span class="kw">fn </span><span class="macro-nonterminal">from</span>(socket: <span class="macro-nonterminal">$from</span>) -&gt; <span class="macro-nonterminal">$</span><span class="kw">for </span>{
                <span class="attr">#[<span class="macro-nonterminal">cfg</span>(unix)]
...
<span class="doccomment">/// Link to online documentation for (almost) all supported OSs.
</span><span class="attr">#[rustfmt::skip]
</span><span class="macro">macro_rules!</span> man_links {
    <span class="comment">// Links to all OSs.
    </span>(<span class="macro-nonterminal">$syscall</span>: tt ( <span class="macro-nonterminal">$section</span>: tt ) ) =&gt; {
        <span class="macro">concat!</span>(
            <span class="macro">man_links!</span>(__ intro),
            <span class="macro">man_links!</span>(__ unix <span class="macro-nonterminal">$syscall</span>(<span class="macro-nonterminal">$section</span>)),
            <span class="macro">man_links!</span>(__ windows <span class="macro-nonterminal">$syscall</span>(<span class="macro-nonterminal">$section</span>)),
        )
    };
    <span class="comment">// Links to Unix-like OSs.
    </span>(unix: <span class="macro-nonterminal">$syscall</span>: tt ( <span class="macro-nonterminal">$section</span>: tt ) ) =&gt; {
        <span class="macro">concat!</span>(
            <span class="macro">man_links!</span>(__ intro),
            <span class="macro">man_links!</span>(__ unix <span class="macro-nonterminal">$syscall</span>(<span class="macro-nonterminal">$section</span>)),
        )
    };
    <span class="comment">// Links to Windows only.
    </span>(windows: <span class="macro-nonterminal">$syscall</span>: tt ( <span class="macro-nonterminal">$section</span>: tt ) ) =&gt; {
        <span class="macro">concat!</span>(
            <span class="macro">man_links!</span>(__ intro),
            <span class="macro">man_links!</span>(__ windows <span class="macro-nonterminal">$syscall</span>(<span class="macro-nonterminal">$section</span>)),
        )
    ...
    <span class="comment">// List for Unix-like OSs.
    </span>(__ unix <span class="macro-nonterminal">$syscall</span>: tt ( <span class="macro-nonterminal">$section</span>: tt ) ) =&gt; {
        <span class="macro">concat!</span>(
            <span class="string">" * DragonFly BSD: &lt;https://man.dragonflybsd.org/?command="</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"&amp;section="</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">"&gt;\n"</span>,
            <span class="string">" * FreeBSD: &lt;https://www.freebsd.org/cgi/man.cgi?query="</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"&amp;sektion="</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">"&gt;\n"</span>,
            <span class="string">" * Linux: &lt;https://man7.org/linux/man-pages/man"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">"/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"."</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">".html&gt;\n"</span>,
            <span class="string">" * macOS: &lt;https://developer.apple.com/library/archive/documentation/System/Conceptual/ManPages_iPhoneOS/man2/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"."</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">".html&gt; (archived, actually for iOS)\n"</span>,
            <span class="string">" * NetBSD: &lt;https://man.netbsd.org/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"."</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">"&gt;\n"</span>,
            <span class="string">" * OpenBSD: &lt;https://man.openbsd.org/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"."</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">"&gt;\n"</span>,
            <span class="string">" * iOS: &lt;https://developer.apple.com/library/archive/documentation/System/Conceptual/ManPages_iPhoneOS/man2/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"."</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$section</span>), <span class="string">".html&gt; (archived)\n"</span>,
            <span class="string">" * illumos: &lt;https://illumos.org/man/3SOCKET/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"&gt;\n"</span>,
        )
    };
    <span class="comment">// List for Window (so just Windows).
    </span>(__ windows <span class="macro-nonterminal">$syscall</span>: tt ( <span class="macro-nonterminal">$section</span>: tt ) ) =&gt; {
        <span class="macro">concat!</span>(
            <span class="string">" * Windows: &lt;https://docs.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$syscall</span>), <span class="string">"&gt;\n"</span>,
        )
    };
}
...
<span class="attr">#[cfg_attr(unix, path = <span class="string">"sys/unix.rs"</span>)]
...
<span class="kw">impl </span>Domain {
    ...
    <span class="doccomment">/// Domain for Unix socket communication, corresponding to `AF_UNIX`.
    </span><span class="kw">pub const </span>UNIX: Domain = Domain(sys::AF_UNIX);
...
<span class="kw">impl </span>Type {
    ...
    <span class="doccomment">/// Type corresponding to `SOCK_DCCP`.
    ///
    ...
    </span><span class="kw">pub const </span>DCCP: Type = Type(sys::SOCK_DCCP);

    <span class="doccomment">/// Type corresponding to `SOCK_SEQPACKET`.
    </span><span class="attr">#[cfg(all(feature = <span class="string">"all"</span>, not(target_os = <span class="string">"espidf"</span>)))]
    #[cfg_attr(docsrs, doc(cfg(all(feature = <span class="string">"all"</span>, not(target_os = <span class="string">"espidf"</span>)))))]
...
<span class="kw">impl </span>Protocol {
    ...
    </span><span class="doccomment">/// Protocol corresponding to `MPTCP`.
    </span><span class="kw">pub const </span>MPTCP: Protocol = Protocol(sys::IPPROTO_MPTCP);

    <span class="doccomment">/// Protocol corresponding to `DCCP`.
    </span><span class="attr">#[cfg(all(feature = <span class="string">"all"</span>, target_os = <span class="string">"linux"</span>))]
    #[cfg_attr(docsrs, doc(cfg(all(feature = <span class="string">"all"</span>, target_os = <span class="string">"linux"</span>))))]
    </span><span class="kw">pub const </span>DCCP: Protocol = Protocol(sys::IPPROTO_DCCP);

    <span class="doccomment">/// Protocol corresponding to `SCTP`.
    ...
    </span><span class="kw">pub const </span>SCTP: Protocol = Protocol(sys::IPPROTO_SCTP);

    <span class="doccomment">/// Protocol corresponding to `UDPLITE`.
    ...
    </span><span class="kw">pub const </span>UDPLITE: Protocol = Protocol(sys::IPPROTO_UDPLITE);

    <span class="doccomment">/// Protocol corresponding to `DIVERT`.
    ...
    </span><span class="kw">pub const </span>DIVERT: Protocol = Protocol(sys::IPPROTO_DIVERT);
}
...
/// See [`Socket::set_tcp_keepalive`].
    ...
    <span class="attr">#[cfg_attr(
        any(target_os = <span class="string">"openbsd"</span>, target_os = <span class="string">"haiku"</span>, target_os = <span class="string">"vita"</span>),
        allow(dead_code)
    )]
    </span>time: <span class="prelude-ty">Option</span>&lt;Duration&gt;,
    <span class="attr">#[cfg(not(any(
...
<span class="doccomment">/// Configuration of a `sendmsg(2)` system call.
///
/// This wraps `msghdr` on Unix and `WSAMSG` on Windows. Also see [`MsgHdrMut`]
/// for the variant used by `recvmsg(2)`.
</span><span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">pub struct </span>MsgHdr&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    inner: sys::msghdr,
    <span class="attr">#[allow(clippy::type_complexity)]
    </span>_lifetimes: PhantomData&lt;(<span class="kw-2">&amp;</span><span class="lifetime">'addr </span>SockAddr, <span class="kw-2">&amp;</span><span class="lifetime">'bufs </span>IoSlice&lt;<span class="lifetime">'bufs</span>&gt;, <span class="kw-2">&amp;</span><span class="lifetime">'control </span>[u8])&gt;,
}

<span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; MsgHdr&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    <span class="doccomment">/// Create a new `MsgHdr` with all empty/zero fields.
    </span><span class="attr">#[allow(clippy::new_without_default)]
    </span><span class="kw">pub fn </span>new() -&gt; MsgHdr&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
        <span class="comment">// SAFETY: all zero is valid for `msghdr` and `WSAMSG`.
        </span>MsgHdr {
            inner: <span class="kw">unsafe </span>{ mem::zeroed() },
            _lifetimes: PhantomData,
        }
    }

    <span class="doccomment">/// Set the address (name) of the message.
    ///
    /// Corresponds to setting `msg_name` and `msg_namelen` on Unix and `name`
    /// and `namelen` on Windows.
    </span><span class="kw">pub fn </span>with_addr(<span class="kw-2">mut </span><span class="self">self</span>, addr: <span class="kw-2">&amp;</span><span class="lifetime">'addr </span>SockAddr) -&gt; <span class="self">Self </span>{
        sys::set_msghdr_name(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, addr);
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the buffer(s) of the message.
    ///
    /// Corresponds to setting `msg_iov` and `msg_iovlen` on Unix and `lpBuffers`
    /// and `dwBufferCount` on Windows.
    </span><span class="kw">pub fn </span>with_buffers(<span class="kw-2">mut </span><span class="self">self</span>, bufs: <span class="kw-2">&amp;</span><span class="lifetime">'bufs </span>[IoSlice&lt;<span class="lifetime">'_</span>&gt;]) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>ptr = bufs.as_ptr() <span class="kw">as </span><span class="kw-2">*mut </span><span class="kw">_</span>;
        sys::set_msghdr_iov(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, ptr, bufs.len());
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the control buffer of the message.
    ///
    /// Corresponds to setting `msg_control` and `msg_controllen` on Unix and
    /// `Control` on Windows.
    </span><span class="kw">pub fn </span>with_control(<span class="kw-2">mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span><span class="lifetime">'control </span>[u8]) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>ptr = buf.as_ptr() <span class="kw">as </span><span class="kw-2">*mut </span><span class="kw">_</span>;
        sys::set_msghdr_control(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, ptr, buf.len());
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the flags of the message.
    ///
    /// Corresponds to setting `msg_flags` on Unix and `dwFlags` on Windows.
    </span><span class="kw">pub fn </span>with_flags(<span class="kw-2">mut </span><span class="self">self</span>, flags: sys::c_int) -&gt; <span class="self">Self </span>{
        sys::set_msghdr_flags(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, flags);
        <span class="self">self
    </span>}
}

<span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'name</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; fmt::Debug <span class="kw">for </span>MsgHdr&lt;<span class="lifetime">'name</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, fmt: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        <span class="string">"MsgHdr"</span>.fmt(fmt)
    }
}

<span class="doccomment">/// Configuration of a `recvmsg(2)` system call.
///
/// This wraps `msghdr` on Unix and `WSAMSG` on Windows. Also see [`MsgHdr`] for
/// the variant used by `sendmsg(2)`.
</span><span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">pub struct </span>MsgHdrMut&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    inner: sys::msghdr,
    <span class="attr">#[allow(clippy::type_complexity)]
    </span>_lifetimes: PhantomData&lt;(
        <span class="kw-2">&amp;</span><span class="lifetime">'addr </span><span class="kw-2">mut </span>SockAddr,
        <span class="kw-2">&amp;</span><span class="lifetime">'bufs </span><span class="kw-2">mut </span>MaybeUninitSlice&lt;<span class="lifetime">'bufs</span>&gt;,
        <span class="kw-2">&amp;</span><span class="lifetime">'control </span><span class="kw-2">mut </span>[u8],
    )&gt;,
}

<span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; MsgHdrMut&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    <span class="doccomment">/// Create a new `MsgHdrMut` with all empty/zero fields.
    </span><span class="attr">#[allow(clippy::new_without_default)]
    </span><span class="kw">pub fn </span>new() -&gt; MsgHdrMut&lt;<span class="lifetime">'addr</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
        <span class="comment">// SAFETY: all zero is valid for `msghdr` and `WSAMSG`.
        </span>MsgHdrMut {
            inner: <span class="kw">unsafe </span>{ mem::zeroed() },
            _lifetimes: PhantomData,
    ...
    <span class="doccomment">/// Set the mutable address (name) of the message.
    ///
    /// Corresponds to setting `msg_name` and `msg_namelen` on Unix and `name`
    /// and `namelen` on Windows.
    </span><span class="attr">#[allow(clippy::needless_pass_by_ref_mut)]
    </span><span class="kw">pub fn </span>with_addr(<span class="kw-2">mut </span><span class="self">self</span>, addr: <span class="kw-2">&amp;</span><span class="lifetime">'addr </span><span class="kw-2">mut </span>SockAddr) -&gt; <span class="self">Self </span>{
        sys::set_msghdr_name(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, addr);
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the mutable buffer(s) of the message.
    ///
    /// Corresponds to setting `msg_iov` and `msg_iovlen` on Unix and `lpBuffers`
    /// and `dwBufferCount` on Windows.
    </span><span class="kw">pub fn </span>with_buffers(<span class="kw-2">mut </span><span class="self">self</span>, bufs: <span class="kw-2">&amp;</span><span class="lifetime">'bufs </span><span class="kw-2">mut </span>[MaybeUninitSlice&lt;<span class="lifetime">'_</span>&gt;]) -&gt; <span class="self">Self </span>{
        sys::set_msghdr_iov(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, bufs.as_mut_ptr().cast(), bufs.len());
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the mutable control buffer of the message.
    ///
    /// Corresponds to setting `msg_control` and `msg_controllen` on Unix and
    /// `Control` on Windows.
    </span><span class="kw">pub fn </span>with_control(<span class="kw-2">mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span><span class="lifetime">'control </span><span class="kw-2">mut </span>[MaybeUninit&lt;u8&gt;]) -&gt; <span class="self">Self </span>{
        sys::set_msghdr_control(<span class="kw-2">&amp;mut </span><span class="self">self</span>.inner, buf.as_mut_ptr().cast(), buf.len());
        <span class="self">self
    </span>}

    <span class="doccomment">/// Returns the flags of the message.
    </span><span class="kw">pub fn </span>flags(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; RecvFlags {
        sys::msghdr_flags(<span class="kw-2">&amp;</span><span class="self">self</span>.inner)
    }
}

<span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'name</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; fmt::Debug <span class="kw">for </span>MsgHdrMut&lt;<span class="lifetime">'name</span>, <span class="lifetime">'bufs</span>, <span class="lifetime">'control</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, fmt: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        <span class="string">"MsgHdrMut"</span>.fmt(fmt)
    }
}
