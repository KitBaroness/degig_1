...
</pre></div><pre class="rust"><code><span class="comment">// Copyright 2016 lazy-static.rs Developers
//
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/lazy_static/1.4.0"</span>)]
#![no_std]
...
<span class="attr">#[cfg(feature = <span class="string">"spin_no_std"</span>)]
