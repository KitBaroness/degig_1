...
<span class="kw">pub type </span>CFFileDescriptorCallBack =
    <span class="kw">extern </span><span class="string">"C" </span><span class="kw">fn</span>(f: CFFileDescriptorRef, callBackTypes: CFOptionFlags, info: <span class="kw-2">*mut </span>c_void);
...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    </span><span class="kw">pub fn </span>CFFileDescriptorCreate(
        allocator: CFAllocatorRef,
        fd: CFFileDescriptorNativeDescriptor,
        closeOnInvalidate: Boolean,
        callout: CFFileDescriptorCallBack,
        context: <span class="kw-2">*const </span>CFFileDescriptorContext,
    ) -&gt; CFFileDescriptorRef;

    <span class="comment">/* Getting Information About a File Descriptor */
    </span><span class="kw">pub fn </span>CFFileDescriptorGetNativeDescriptor(
        f: CFFileDescriptorRef,
    ) -&gt; CFFileDescriptorNativeDescriptor;
    <span class="kw">pub fn </span>CFFileDescriptorIsValid(f: CFFileDescriptorRef) -&gt; Boolean;
    <span class="kw">pub fn </span>CFFileDescriptorGetContext(
        f: CFFileDescriptorRef,
        context: <span class="kw-2">*mut </span>CFFileDescriptorContext,
    );

    <span class="comment">/* Invalidating a File Descriptor */
    </span><span class="kw">pub fn </span>CFFileDescriptorInvalidate(f: CFFileDescriptorRef);

    <span class="comment">/* Managing Callbacks */
    </span><span class="kw">pub fn </span>CFFileDescriptorEnableCallBacks(f: CFFileDescriptorRef, callBackTypes: CFOptionFlags);
    <span class="kw">pub fn </span>CFFileDescriptorDisableCallBacks(f: CFFileDescriptorRef, callBackTypes: CFOptionFlags);

    <span class="comment">/* Creating a Run Loop Source */
    </span><span class="kw">pub fn </span>CFFileDescriptorCreateRunLoopSource(
        allocator: CFAllocatorRef,
        f: CFFileDescriptorRef,
        order: CFIndex,
    ) -&gt; CFRunLoopSourceRef;

    <span class="comment">/* Getting the CFFileDescriptor Type ID */
