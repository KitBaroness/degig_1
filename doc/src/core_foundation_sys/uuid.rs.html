...
<span class="kw">use </span><span class="kw">crate</span>::base::{CFAllocatorRef, CFTypeID};
...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    <span class="kw">pub fn </span>CFUUIDCreateFromString(alloc: CFAllocatorRef, uuidStr: CFStringRef) -&gt; CFUUIDRef;
    <span class="kw">pub fn </span>CFUUIDCreateFromUUIDBytes(allocator: CFAllocatorRef, bytes: CFUUIDBytes) -&gt; CFUUIDRef;
    <span class="kw">pub fn </span>CFUUIDCreateWithBytes(
    ...
    <span class="comment">/* Getting Information About CFUUID Objects */
    </span><span class="kw">pub fn </span>CFUUIDCreateString(allocator: CFAllocatorRef, uid: CFUUIDRef) -&gt; CFStringRef;
    <span class="kw">pub fn </span>CFUUIDGetConstantUUIDWithBytes(
        alloc: CFAllocatorRef,
        byte0: u8,
        byte1: u8,
        byte2: u8,
    ...
    <span class="comment">/* Getting the CFUUID Type Identifier */
    </span><span class="kw">pub fn </span>CFUUIDGetTypeID() -&gt; CFTypeID;
}
