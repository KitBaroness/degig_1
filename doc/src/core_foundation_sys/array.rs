...
<span class="kw">use </span><span class="kw">crate</span>::base::{Boolean, CFAllocatorRef, CFComparatorFunction, CFIndex, CFRange, CFTypeID};
<span class="kw">use </span><span class="kw">crate</span>::string::CFStringRef;

<span class="kw">pub type </span>CFArrayRetainCallBack =
...
<span class="kw">pub type </span>CFArrayEqualCallBack =
...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    <span class="comment">/* CFArray */
    /* Creating an Array */
    </span><span class="kw">pub fn </span>CFArrayCreate(
        allocator: CFAllocatorRef,
        values: <span class="kw-2">*const *const </span>c_void,
        numValues: CFIndex,
        callBacks: <span class="kw-2">*const </span>CFArrayCallBacks,
    ) -&gt; CFArrayRef;
    <span class="kw">pub fn </span>CFArrayCreateCopy(allocator: CFAllocatorRef, theArray: CFArrayRef) -&gt; CFArrayRef;

    <span class="comment">/* Examining an Array */
    </span><span class="kw">pub fn </span>CFArrayBSearchValues(
        theArray: CFArrayRef,
        range: CFRange,
    ...
    <span class="kw">pub fn </span>CFArrayContainsValue(
        theArray: CFArrayRef,
        range: CFRange,
        value: <span class="kw-2">*const </span>c_void,
    ) -&gt; Boolean;
    <span class="kw">pub fn </span>CFArrayGetCount(theArray: CFArrayRef) -&gt; CFIndex;
    <span class="kw">pub fn </span>CFArrayGetCountOfValue(
        theArray: CFArrayRef,
        range: CFRange,
        value: <span class="kw-2">*const </span>c_void,
    ) -&gt; CFIndex;
    <span class="kw">pub fn </span>CFArrayGetFirstIndexOfValue(
        theArray: CFArrayRef,
        range: CFRange,
        value: <span class="kw-2">*const </span>c_void,
    ) -&gt; CFIndex;
    <span class="kw">pub fn </span>CFArrayGetLastIndexOfValue(
        theArray: CFArrayRef,
        range: CFRange,
        value: <span class="kw-2">*const </span>c_void,
    ) -&gt; CFIndex;
    ...
    <span class="comment">/* Applying a Function to Elements */
    </span><span class="kw">pub fn </span>CFArrayApplyFunction(
        theArray: CFArrayRef,
        range: CFRange,
    ...
    <span class="comment">/* Getting the CFArray Type ID */
    </span><span class="kw">pub fn </span>CFArrayGetTypeID() -&gt; CFTypeID;

    <span class="comment">/* CFMutableArray */
    /* CFMutableArray Miscellaneous Functions */
    </span><span class="kw">pub fn </span>CFArrayAppendArray(
    ...
    <span class="kw">pub fn </span>CFArrayCreateMutable(
        allocator: CFAllocatorRef,
        capacity: CFIndex,
        callBacks: <span class="kw-2">*const </span>CFArrayCallBacks,
    ) -&gt; CFMutableArrayRef;
    <span class="kw">pub fn </span>CFArrayCreateMutableCopy(
        allocator: CFAllocatorRef,
        capacity: CFIndex,
        theArray: CFArrayRef,
    ) -&gt; CFMutableArrayRef;
    <span class="kw">pub fn </span>CFArrayExchangeValuesAtIndices(
        theArray: CFMutableArrayRef,
        idx1: CFIndex,
        idx2: CFIndex,
    );
    <span class="kw">pub fn </span>CFArrayInsertValueAtIndex(
        theArray: CFMutableArrayRef,
        idx: CFIndex,
        value: <span class="kw-2">*const </span>c_void,
    );
    ...
    <span class="kw">pub fn </span>CFArrayReplaceValues(
        theArray: CFMutableArrayRef,
        range: CFRange,
        newValues: <span class="kw-2">*mut *const </span>c_void,
        newCount: CFIndex,
    );
    ...
    <span class="kw">pub fn </span>CFArraySortValues(
        theArray: CFMutableArrayRef,
        range: CFRange,
        comparator: CFComparatorFunction,
        context: <span class="kw-2">*mut </span>c_void,
