...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    <span class="kw">pub static </span>kCFNumberPositiveInfinity: CFNumberRef;
    <span class="kw">pub static </span>kCFNumberNegativeInfinity: CFNumberRef;
    <span class="kw">pub static </span>kCFNumberNaN: CFNumberRef;

    <span class="comment">/* Creating a Number */
    </span><span class="kw">pub fn </span>CFNumberCreate(
        allocator: CFAllocatorRef,
        theType: CFNumberType,
        valuePtr: <span class="kw-2">*const </span>c_void,
    ) -&gt; CFNumberRef;

    <span class="comment">/* Getting Information About Numbers */
    </span><span class="kw">pub fn </span>CFNumberGetByteSize(number: CFNumberRef) -&gt; CFIndex;
    <span class="kw">pub fn </span>CFNumberGetType(number: CFNumberRef) -&gt; CFNumberType;
    <span class="kw">pub fn </span>CFNumberGetValue(
        number: CFNumberRef,
        theType: CFNumberType,
        valuePtr: <span class="kw-2">*mut </span>c_void,
    ) -&gt; bool;
    <span class="kw">pub fn </span>CFNumberIsFloatType(number: CFNumberRef) -&gt; Boolean;

    <span class="comment">/* Comparing Numbers */
    </span><span class="kw">pub fn </span>CFNumberCompare(
        date: CFNumberRef,
        other: CFNumberRef,
        context: <span class="kw-2">*mut </span>c_void,
    ) -&gt; CFComparisonResult;

    <span class="comment">/* Getting the CFNumber Type ID */
    </span><span class="kw">pub fn </span>CFNumberGetTypeID() -&gt; CFTypeID;
