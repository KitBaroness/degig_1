...
#![cfg_attr(
    all(feature = <span class="string">"mac_os_10_7_support"</span>, feature = <span class="string">"mac_os_10_8_features"</span>),
    feature(linkage)
)] </span><span class="comment">// back-compat requires weak linkage
...
// https://github.com/rust-lang/lang-team/issues/102
    ...
    all(
        ...
        feature = <span class="string">"link"
    </span>),
...
<span class="kw">pub mod </span>string_tokenizer;
<span class="kw">pub mod </span>timezone;
<span class="kw">pub mod </span>tree;
<span class="kw">pub mod </span>url;
<span class="kw">pub mod </span>url_enumerator;
<span class="attr">#[cfg(target_os = <span class="string">"macos"</span>)]
</span><span class="kw">pub mod </span>user_notification;
<span class="kw">pub mod </span>uuid;
<span class="attr">#[cfg(target_os = <span class="string">"macos"</span>)]
</span><span class="kw">pub mod </span>xml_node;
<span class="attr">#[cfg(target_os = <span class="string">"macos"</span>)]
</span><span class="kw">pub mod </span>xml_parser;
