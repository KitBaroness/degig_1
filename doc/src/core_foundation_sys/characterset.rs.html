...
</pre></div><pre class="rust"><code><span class="comment">// Copyright 2019 The Servo Project Developers. See the COPYRIGHT
...
</span><span class="kw">use </span><span class="kw">crate</span>::base::{Boolean, CFAllocatorRef, CFIndex, CFRange, CFTypeID, UTF32Char};
<span class="kw">use </span><span class="kw">crate</span>::data::CFDataRef;
<span class="kw">use </span><span class="kw">crate</span>::string::{CFStringRef, UniChar};
...
<span class="kw">pub type </span>CFMutableCharacterSetRef = <span class="kw-2">*mut </span>__CFCharacterSet;
...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    </span><span class="kw">pub fn </span>CFCharacterSetCreateCopy(
        alloc: CFAllocatorRef,
        theSet: CFCharacterSetRef,
    ) -&gt; CFCharacterSetRef;
    <span class="kw">pub fn </span>CFCharacterSetCreateInvertedSet(
        alloc: CFAllocatorRef,
        theSet: CFCharacterSetRef,
    ) -&gt; CFCharacterSetRef;
    <span class="kw">pub fn </span>CFCharacterSetCreateWithCharactersInRange(
        alloc: CFAllocatorRef,
        theRange: CFRange,
    ) -&gt; CFCharacterSetRef;
    <span class="kw">pub fn </span>CFCharacterSetCreateWithCharactersInString(
        alloc: CFAllocatorRef,
        theString: CFStringRef,
    ) -&gt; CFCharacterSetRef;
    <span class="kw">pub fn </span>CFCharacterSetCreateWithBitmapRepresentation(
        alloc: CFAllocatorRef,
        theData: CFDataRef,
    ) -&gt; CFCharacterSetRef;

    <span class="comment">/* Getting Predefined Character Sets */
    </span><span class="kw">pub fn </span>CFCharacterSetGetPredefined(
        theSetIdentifier: CFCharacterSetPredefinedSet,
    ) -&gt; CFCharacterSetRef;

    <span class="comment">/* Querying Character Sets */
    </span><span class="kw">pub fn </span>CFCharacterSetCreateBitmapRepresentation(
        alloc: CFAllocatorRef,
        theSet: CFCharacterSetRef,
    ) -&gt; CFDataRef;
    <span class="kw">pub fn </span>CFCharacterSetHasMemberInPlane(theSet: CFCharacterSetRef, thePlane: CFIndex) -&gt; Boolean;
    <span class="kw">pub fn </span>CFCharacterSetIsCharacterMember(theSet: CFCharacterSetRef, theChar: UniChar) -&gt; Boolean;
    <span class="kw">pub fn </span>CFCharacterSetIsLongCharacterMember(
        theSet: CFCharacterSetRef,
        theChar: UTF32Char,
    ) -&gt; Boolean;
    <span class="kw">pub fn </span>CFCharacterSetIsSupersetOfSet(
        theSet: CFCharacterSetRef,
        theOtherset: CFCharacterSetRef,
    ) -&gt; Boolean;

    <span class="comment">/* Getting the Character Set Type Identifier */
    </span><span class="kw">pub fn </span>CFCharacterSetGetTypeID() -&gt; CFTypeID;

    <span class="comment">/* CFMutableCharacterSet */
    /* Creating a Mutable Character Set */
    </span><span class="kw">pub fn </span>CFCharacterSetCreateMutable(alloc: CFAllocatorRef) -&gt; CFMutableCharacterSetRef;
    <span class="kw">pub fn </span>CFCharacterSetCreateMutableCopy(
        alloc: CFAllocatorRef,
        theSet: CFCharacterSetRef,
    ) -&gt; CFMutableCharacterSetRef;

    <span class="comment">/* Adding Characters */
    </span><span class="kw">pub fn </span>CFCharacterSetAddCharactersInRange(theSet: CFMutableCharacterSetRef, theRange: CFRange);
    <span class="kw">pub fn </span>CFCharacterSetAddCharactersInString(
        theSet: CFMutableCharacterSetRef,
        theString: CFStringRef,
    );

    <span class="comment">/* Removing Characters */
    </span><span class="kw">pub fn </span>CFCharacterSetRemoveCharactersInRange(
        theSet: CFMutableCharacterSetRef,
        theRange: CFRange,
    );
    <span class="kw">pub fn </span>CFCharacterSetRemoveCharactersInString(
        theSet: CFMutableCharacterSetRef,
        theString: CFStringRef,
    );

    <span class="comment">/* Logical Operations */
    </span><span class="kw">pub fn </span>CFCharacterSetIntersect(
        theSet: CFMutableCharacterSetRef,
        theOtherSet: CFCharacterSetRef,
    );
