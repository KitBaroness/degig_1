<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/util/prefilter/mod.rs`."><title>mod.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../../" data-static-root-path="../../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../../src-files.js"></script><script defer src="../../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="kw">mod </span>aho_corasick;
<span class="kw">mod </span>byteset;
<span class="kw">mod </span>memchr;
<span class="kw">mod </span>memmem;
...
</span><span class="kw">use </span>regex_syntax::hir::{literal, Hir};

<span class="kw">use </span><span class="kw">crate</span>::util::search::{MatchKind, Span};

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">use </span><span class="kw">crate</span>::util::prefilter::{
...
<span class="doccomment">/// A prefilter for accelerating regex searches.
///
...
/// ```
    ...
    <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    </span>pre: Arc&lt;<span class="kw">dyn </span>PrefilterI&gt;,
    <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    </span>is_fast: bool,
    <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    </span>max_needle_len: usize,
}

<span class="kw">impl </span>Prefilter {
    <span class="doccomment">/// Create a new prefilter from a sequence of needles and a corresponding
    /// match semantics.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>new&lt;B: AsRef&lt;[u8]&gt;&gt;(
        kind: MatchKind,
        needles: <span class="kw-2">&amp;</span>[B],
    ) -&gt; <span class="prelude-ty">Option</span>&lt;Prefilter&gt; {
        Choice::new(kind, needles).and_then(|choice| {
            <span class="kw">let </span>max_needle_len =
                needles.iter().map(|b| b.as_ref().len()).max().unwrap_or(<span class="number">0</span>);
            Prefilter::from_choice(choice, max_needle_len)
        })
    }

    <span class="doccomment">/// This turns a prefilter selection into a `Prefilter`. That is, in turns
    /// the enum given into a trait object.
    </span><span class="kw">fn </span>from_choice(
        choice: Choice,
        ...
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
            ...
            <span class="kw">let </span>pre: Arc&lt;<span class="kw">dyn </span>PrefilterI&gt; = <span class="kw">match </span>choice {
            ...
            <span class="kw">let </span>is_fast = pre.is_fast();
            <span class="prelude-val">Some</span>(Prefilter { pre, is_fast, max_needle_len })
        }
    }

    <span class="doccomment">/// This attempts to extract prefixes from the given `Hir` expression for
    ...
    </span><span class="kw">pub fn </span>from_hir_prefix(kind: MatchKind, hir: <span class="kw-2">&amp;</span>Hir) -&gt; <span class="prelude-ty">Option</span>&lt;Prefilter&gt; {
        Prefilter::from_hirs_prefix(kind, <span class="kw-2">&amp;</span>[hir])
    }

    <span class="doccomment">/// This attempts to extract prefixes from the given `Hir` expressions for
    /// the given match semantics, and if possible, builds a prefilter for
    /// them.
    ///
    ...
    </span><span class="kw">pub fn </span>from_hirs_prefix&lt;H: Borrow&lt;Hir&gt;&gt;(
        kind: MatchKind,
    ...
    <span class="doccomment">/// Run this prefilter on `haystack[span.start..end]` and return a matching
    /// span if one exists.
    ///
    ...
    /// ```
    ...
    </span><span class="kw">pub fn </span>find(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        <span class="attr">#[cfg(not(feature = <span class="string">"alloc"</span>))]
        </span>{
        ...
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
            ...
            <span class="self">self</span>.pre.find(haystack, span)
        }
    }

    <span class="doccomment">/// Returns the span of a prefix of `haystack[span.start..span.end]` if
    ...
    /// ```
    ...
    </span><span class="kw">pub fn </span>prefix(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        <span class="attr">#[cfg(not(feature = <span class="string">"alloc"</span>))]
        </span>{
            <span class="macro">unreachable!</span>()
        }
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
            ...
            <span class="self">self</span>.pre.prefix(haystack, span)
        }
    }

    <span class="doccomment">/// Returns the heap memory, in bytes, used by the underlying prefilter.
    </span><span class="attr">#[inline]
    ...
    <span class="doccomment">/// Return the length of the longest needle
    /// in this Prefilter
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>max_needle_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="attr">#[cfg(not(feature = <span class="string">"alloc"</span>))]
        </span>{
            <span class="macro">unreachable!</span>()
        }
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
            ...
            <span class="self">self</span>.max_needle_len
        }
    }

    <span class="doccomment">/// Implementations might return true here if they believe themselves to
    ...
    /// (Which of course we cannot afford to do.)
    ...
    </span><span class="kw">pub fn </span>is_fast(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="attr">#[cfg(not(feature = <span class="string">"alloc"</span>))]
        </span>{
            <span class="macro">unreachable!</span>()
        }
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
            ...
            <span class="self">self</span>.is_fast
        }
    }
}

<span class="doccomment">/// A trait for abstracting over prefilters. Basically, a prefilter is
...
/// and to an enum, then it's likely this trait could be removed.
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">trait </span>PrefilterI:
    ...
    /// or equal to the one given, and an end position less than or equal to
    /// the one given.
    </span><span class="kw">fn </span>find(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt;;
    ...
    /// The span returned is guaranteed to have a start position equivalent to
    /// the one given, and an end position less than or equal to the one given.
    </span><span class="kw">fn </span>prefix(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt;;
    ...
    </span><span class="kw">fn </span>is_fast(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool;
}

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;P: PrefilterI + <span class="question-mark">?</span>Sized&gt; PrefilterI <span class="kw">for </span>Arc&lt;P&gt; {
    <span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
    </span><span class="kw">fn </span>find(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        (<span class="kw-2">&amp;**</span><span class="self">self</span>).find(haystack, span)
    }

    <span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
    </span><span class="kw">fn </span>prefix(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8], span: Span) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        (<span class="kw-2">&amp;**</span><span class="self">self</span>).prefix(haystack, span)
    }
    ...
    <span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
        ...
        (<span class="kw-2">&amp;**</span><span class="self">self</span>).is_fast()
    }
}

<span class="doccomment">/// A type that encapsulates the selection of a prefilter algorithm from a
/// sequence of needles.
///
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">enum </span>Choice {
    Memchr(Memchr),
    Memchr2(Memchr2),
    Memchr3(Memchr3),
    Memmem(Memmem),
...
<span class="kw">impl </span>Choice {
    <span class="doccomment">/// Select what is believed to be the best prefilter algorithm for the
    ...
    /// crate can be returned.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new&lt;B: AsRef&lt;[u8]&gt;&gt;(
        kind: MatchKind,
        needles: <span class="kw-2">&amp;</span>[B],
    ) -&gt; <span class="prelude-ty">Option</span>&lt;Choice&gt; {
        <span class="comment">// An empty set means the regex matches nothing, so no sense in
        // building a prefilter.
        </span><span class="kw">if </span>needles.len() == <span class="number">0 </span>{
            <span class="macro">debug!</span>(<span class="string">"prefilter building failed: found empty set of literals"</span>);
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
        <span class="comment">// If the regex can match the empty string, then the prefilter
        // will by definition match at every position. This is obviously
        // completely ineffective.
        </span><span class="kw">if </span>needles.iter().any(|n| n.as_ref().is_empty()) {
            <span class="macro">debug!</span>(<span class="string">"prefilter building failed: literals match empty string"</span>);
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
        <span class="comment">// BREADCRUMBS: Perhaps the literal optimizer should special case
        ...
        </span><span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = Memchr::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: memchr"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::Memchr(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = Memchr2::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: memchr2"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::Memchr2(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = Memchr3::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: memchr3"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::Memchr3(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = Memmem::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: memmem"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::Memmem(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = Teddy::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: teddy"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::Teddy(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = ByteSet::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: byteset"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::ByteSet(pre));
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pre) = AhoCorasick::new(kind, needles) {
            <span class="macro">debug!</span>(<span class="string">"prefilter built: aho-corasick"</span>);
            <span class="kw">return </span><span class="prelude-val">Some</span>(Choice::AhoCorasick(pre));
        }
...
<span class="doccomment">/// Extracts all of the prefix literals from the given HIR expressions into a
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>prefixes&lt;H&gt;(kind: MatchKind, hirs: <span class="kw-2">&amp;</span>[H]) -&gt; literal::Seq
<span class="kw">where
    </span>H: core::borrow::Borrow&lt;Hir&gt;,
{
    <span class="kw">let </span><span class="kw-2">mut </span>extractor = literal::Extractor::new();
    extractor.kind(literal::ExtractKind::Prefix);

    <span class="kw">let </span><span class="kw-2">mut </span>prefixes = literal::Seq::empty();
    <span class="kw">for </span>hir <span class="kw">in </span>hirs {
        prefixes.union(<span class="kw-2">&amp;mut </span>extractor.extract(hir.borrow()));
    }
...
<span class="doccomment">/// Like `prefixes`, but for all suffixes of all matches for the given HIRs.
</span><span class="attr">#[cfg(feature = <span class="string">"syntax"</span>)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>suffixes&lt;H&gt;(kind: MatchKind, hirs: <span class="kw-2">&amp;</span>[H]) -&gt; literal::Seq
<span class="kw">where
    </span>H: core::borrow::Borrow&lt;Hir&gt;,
{
    <span class="kw">let </span><span class="kw-2">mut </span>extractor = literal::Extractor::new();
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>suffixes = literal::Seq::empty();
    <span class="kw">for </span>hir <span class="kw">in </span>hirs {
        suffixes.union(<span class="kw-2">&amp;mut </span>extractor.extract(hir.borrow()));
    }
    <span class="macro">debug!</span>(
