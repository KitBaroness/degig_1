<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/util/primitives.rs`."><title>primitives.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
<span class="doccomment">/// A `usize` that can never be `usize::MAX`.
///
...
</span><span class="attr">#[derive(Clone, Copy, Eq, Hash, PartialEq, PartialOrd, Ord)]
#[repr(transparent)]
</span><span class="kw">pub struct </span>NonMaxUsize(NonZeroUsize);

<span class="kw">impl </span>NonMaxUsize {
    <span class="doccomment">/// Create a new `NonMaxUsize` from the given value.
    ///
    /// This returns `None` only when the given value is equal to `usize::MAX`.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>new(value: usize) -&gt; <span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt; {
        NonZeroUsize::new(value.wrapping_add(<span class="number">1</span>)).map(NonMaxUsize)
    }

    <span class="doccomment">/// Return the underlying `usize` value. The returned value is guaranteed
    /// to not equal `usize::MAX`.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>get(<span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.<span class="number">0</span>.get().wrapping_sub(<span class="number">1</span>)
    }
}

<span class="comment">// We provide our own Debug impl because seeing the internal repr can be quite
// surprising if you aren't expecting it. e.g., 'NonMaxUsize(5)' vs just '5'.
</span><span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>NonMaxUsize {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="macro">write!</span>(f, <span class="string">"{:?}"</span>, <span class="self">self</span>.get())
    }
}
...
#[repr(transparent)]
</span><span class="kw">pub struct </span>SmallIndex(u32);
...
<span class="kw">impl </span>SmallIndex {
    ...
    /// for memory safety.
        ...
        </span>SmallIndex(index <span class="kw">as </span>u32)
    }
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;T&gt; core::ops::Index&lt;SmallIndex&gt; <span class="kw">for </span>Vec&lt;T&gt; {
    <span class="kw">type </span>Output = T;
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;T&gt; core::ops::IndexMut&lt;SmallIndex&gt; <span class="kw">for </span>Vec&lt;T&gt; {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>index_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>, index: SmallIndex) -&gt; <span class="kw-2">&amp;mut </span>T {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>[index.as_usize()]
    }
...
</span><span class="kw">impl </span>quickcheck::Arbitrary <span class="kw">for </span>SmallIndex {
    <span class="kw">fn </span>arbitrary(gen: <span class="kw-2">&amp;mut </span>quickcheck::Gen) -&gt; SmallIndex {
        <span class="kw">use </span>core::cmp::max;

        <span class="kw">let </span>id = max(i32::MIN + <span class="number">1</span>, i32::arbitrary(gen)).abs();
        <span class="kw">if </span>id &gt; SmallIndex::MAX.as_i32() {
            SmallIndex::MAX
...
<span class="macro">macro_rules!</span> index_type_impls {
    (<span class="macro-nonterminal">$name</span>:ident, <span class="macro-nonterminal">$err</span>:ident, <span class="macro-nonterminal">$iter</span>:ident, <span class="macro-nonterminal">$withiter</span>:ident) =&gt; {
        ...
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw">impl</span>&lt;T&gt; core::ops::Index&lt;<span class="macro-nonterminal">$name</span>&gt; <span class="kw">for </span>Vec&lt;T&gt; {
            <span class="kw">type </span>Output = T;
        ...
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw">impl</span>&lt;T&gt; core::ops::IndexMut&lt;<span class="macro-nonterminal">$name</span>&gt; <span class="kw">for </span>Vec&lt;T&gt; {
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>index_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>, index: <span class="macro-nonterminal">$name</span>) -&gt; <span class="kw-2">&amp;mut </span>T {
                <span class="kw-2">&amp;mut </span><span class="self">self</span>[index.as_usize()]
            }
        ...
        <span class="attr">#[cfg(test)]
        </span><span class="kw">impl </span>quickcheck::Arbitrary <span class="kw">for </span><span class="macro-nonterminal">$name </span>{
            <span class="kw">fn </span>arbitrary(gen: <span class="kw-2">&amp;mut </span>quickcheck::Gen) -&gt; <span class="macro-nonterminal">$name </span>{
                <span class="macro-nonterminal">$name</span>(SmallIndex::arbitrary(gen))
            }
        }

        <span class="doccomment">/// This error occurs when a value could not be constructed.
        ///
...
<span class="doccomment">/// The identifier of a regex pattern, represented by a [`SmallIndex`].
///
...
</span><span class="attr">#[derive(Clone, Copy, Default, Eq, Hash, PartialEq, PartialOrd, Ord)]
#[repr(transparent)]
</span><span class="kw">pub struct </span>PatternID(SmallIndex);

<span class="doccomment">/// The identifier of a finite automaton state, represented by a
/// [`SmallIndex`].
///
