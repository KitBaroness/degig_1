<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/util/captures.rs`."><title>captures.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="kw">use </span>alloc::{string::String, sync::Arc, vec, vec::Vec};
...
<span class="doccomment">/// The span offsets of capturing groups after a match has been found.
///
...
/// ```
...
</span><span class="kw">pub struct </span>Captures {
    <span class="doccomment">/// The group info that these capture groups are coupled to. This is what
    ...
    <span class="doccomment">/// The ID of the pattern that matched. Regex engines must set this to
    /// None when no match occurs.
    </span>pid: <span class="prelude-ty">Option</span>&lt;PatternID&gt;,
    <span class="doccomment">/// The slot values, i.e., submatch offsets.
    ///
    ...
    </span>slots: Vec&lt;<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;&gt;,
}

<span class="kw">impl </span>Captures {
    <span class="doccomment">/// Create new storage for the offsets of all matching capturing groups.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>all(group_info: GroupInfo) -&gt; Captures {
        <span class="kw">let </span>slots = group_info.slot_len();
        Captures { group_info, pid: <span class="prelude-val">None</span>, slots: <span class="macro">vec!</span>[<span class="prelude-val">None</span>; slots] }
    }

    <span class="doccomment">/// Create new storage for only the full match spans of a pattern. This
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>matches(group_info: GroupInfo) -&gt; Captures {
        <span class="comment">// This is OK because we know there are at least this many slots,
        // and GroupInfo construction guarantees that the number of slots fits
        // into a usize.
        </span><span class="kw">let </span>slots = group_info.pattern_len().checked_mul(<span class="number">2</span>).unwrap();
        Captures { group_info, pid: <span class="prelude-val">None</span>, slots: <span class="macro">vec!</span>[<span class="prelude-val">None</span>; slots] }
    }

    <span class="doccomment">/// Create new storage for only tracking which pattern matched. No offsets
    /// are stored at all.
    ///
    /// It is unspecified behavior to use the returned `Captures` value in a
    /// search with a `GroupInfo` other than the one that is provided to this
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>empty(group_info: GroupInfo) -&gt; Captures {
        Captures { group_info, pid: <span class="prelude-val">None</span>, slots: <span class="macro">vec!</span>[] }
    }

    <span class="doccomment">/// Returns true if and only if this capturing group represents a match.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.pid.is_some()
    }

    <span class="doccomment">/// Returns the identifier of the pattern that matched when this
    ...
    <span class="doccomment">/// Returns the pattern ID and the span of the match, if one occurred.
    ///
    ...
    /// ```
        ...
        <span class="prelude-val">Some</span>(Match::new(<span class="self">self</span>.pattern()<span class="question-mark">?</span>, <span class="self">self</span>.get_group(<span class="number">0</span>)<span class="question-mark">?</span>))
    }

    <span class="doccomment">/// Returns the span of a capturing group match corresponding to the group
    ...
    </span><span class="kw">pub fn </span>get_group(<span class="kw-2">&amp;</span><span class="self">self</span>, index: usize) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        <span class="kw">let </span>pid = <span class="self">self</span>.pattern()<span class="question-mark">?</span>;
        <span class="comment">// There's a little bit of work needed to map captures to slots in the
        // fully general case. But in the overwhelming common case of a single
        // pattern, we can just do some simple arithmetic.
        </span><span class="kw">let </span>(slot_start, slot_end) = <span class="kw">if </span><span class="self">self</span>.group_info().pattern_len() == <span class="number">1 </span>{
            (index.checked_mul(<span class="number">2</span>)<span class="question-mark">?</span>, index.checked_mul(<span class="number">2</span>)<span class="question-mark">?</span>.checked_add(<span class="number">1</span>)<span class="question-mark">?</span>)
        } <span class="kw">else </span>{
            <span class="self">self</span>.group_info().slots(pid, index)<span class="question-mark">?
        </span>};
        <span class="kw">let </span>start = <span class="self">self</span>.slots.get(slot_start).copied()<span class="question-mark">??</span>;
        <span class="kw">let </span>end = <span class="self">self</span>.slots.get(slot_end).copied()<span class="question-mark">??</span>;
        <span class="prelude-val">Some</span>(Span { start: start.get(), end: end.get() })
    }
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>get_group_by_name(<span class="kw-2">&amp;</span><span class="self">self</span>, name: <span class="kw-2">&amp;</span>str) -&gt; <span class="prelude-ty">Option</span>&lt;Span&gt; {
        <span class="kw">let </span>index = <span class="self">self</span>.group_info().to_index(<span class="self">self</span>.pattern()<span class="question-mark">?</span>, name)<span class="question-mark">?</span>;
        <span class="self">self</span>.get_group(index)
    }

    <span class="doccomment">/// Returns an iterator of possible spans for every capturing group in the
    /// matching pattern.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; CapturesPatternIter&lt;<span class="lifetime">'_</span>&gt; {
        <span class="kw">let </span>names = <span class="self">self
            </span>.pattern()
            .map_or(GroupInfoPatternNames::empty().enumerate(), |pid| {
                <span class="self">self</span>.group_info().pattern_names(pid).enumerate()
            });
        CapturesPatternIter { caps: <span class="self">self</span>, names }
    }

    <span class="doccomment">/// Return the total number of capturing groups for the matching pattern.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>group_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="kw">let </span>pid = <span class="kw">match </span><span class="self">self</span>.pattern() {
        ...
        <span class="self">self</span>.group_info().group_len(pid)
    }

    <span class="doccomment">/// Returns a reference to the underlying group info on which these
    /// captures are based.
    ///
    ...
    <span class="doccomment">/// Interpolates the capture references in `replacement` with the
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>interpolate_string(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span>str,
        replacement: <span class="kw-2">&amp;</span>str,
    ) -&gt; String {
        <span class="kw">let </span><span class="kw-2">mut </span>dst = String::new();
        <span class="self">self</span>.interpolate_string_into(haystack, replacement, <span class="kw-2">&amp;mut </span>dst);
        dst
    }
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>interpolate_string_into(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span>str,
        replacement: <span class="kw-2">&amp;</span>str,
        ...
        interpolate::string(
            replacement,
            |index, dst| {
                <span class="kw">let </span>span = <span class="kw">match </span><span class="self">self</span>.get_group(index) {
                    <span class="prelude-val">None </span>=&gt; <span class="kw">return</span>,
                    <span class="prelude-val">Some</span>(span) =&gt; span,
                };
                dst.push_str(<span class="kw-2">&amp;</span>haystack[span]);
            },
            |name| <span class="self">self</span>.group_info().to_index(<span class="self">self</span>.pattern()<span class="question-mark">?</span>, name),
            dst,
        );
    }
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>interpolate_bytes(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span>[u8],
        replacement: <span class="kw-2">&amp;</span>[u8],
    ) -&gt; Vec&lt;u8&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>dst = <span class="macro">vec!</span>[];
        <span class="self">self</span>.interpolate_bytes_into(haystack, replacement, <span class="kw-2">&amp;mut </span>dst);
        dst
    }
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>interpolate_bytes_into(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span>[u8],
        replacement: <span class="kw-2">&amp;</span>[u8],
        ...
        interpolate::bytes(
            ...
            |index, dst| {
                ...
                dst.extend_from_slice(<span class="kw-2">&amp;</span>haystack[span]);
            },
            |name| <span class="self">self</span>.group_info().to_index(<span class="self">self</span>.pattern()<span class="question-mark">?</span>, name),
            dst,
        );
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>extract&lt;<span class="lifetime">'h</span>, <span class="kw">const </span>N: usize&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>str,
    ) -&gt; (<span class="kw-2">&amp;</span><span class="lifetime">'h </span>str, [<span class="kw-2">&amp;</span><span class="lifetime">'h </span>str; N]) {
        <span class="kw">let </span><span class="kw-2">mut </span>matched = <span class="self">self</span>.iter().flatten();
        <span class="kw">let </span>whole_match = <span class="kw-2">&amp;</span>haystack[matched.next().expect(<span class="string">"a match"</span>)];
        <span class="kw">let </span>group_matches = [<span class="number">0</span>; N].map(|<span class="kw">_</span>| {
            <span class="kw">let </span>sp = matched.next().expect(<span class="string">"too few matching groups"</span>);
            <span class="kw-2">&amp;</span>haystack[sp]
        });
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>extract_bytes&lt;<span class="lifetime">'h</span>, <span class="kw">const </span>N: usize&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8],
    ) -&gt; (<span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8], [<span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]; N]) {
        <span class="kw">let </span><span class="kw-2">mut </span>matched = <span class="self">self</span>.iter().flatten();
        <span class="kw">let </span>whole_match = <span class="kw-2">&amp;</span>haystack[matched.next().expect(<span class="string">"a match"</span>)];
        <span class="kw">let </span>group_matches = [<span class="number">0</span>; N].map(|<span class="kw">_</span>| {
            <span class="kw">let </span>sp = matched.next().expect(<span class="string">"too few matching groups"</span>);
...
<span class="doccomment">/// Lower level "slot" oriented APIs. One does not typically need to use these
...
/// are writing their own regex engine while reusing this `Captures` type.
</span><span class="kw">impl </span>Captures {
    <span class="doccomment">/// Clear this `Captures` value.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.pid = <span class="prelude-val">None</span>;
        <span class="kw">for </span>slot <span class="kw">in </span><span class="self">self</span>.slots.iter_mut() {
            <span class="kw-2">*</span>slot = <span class="prelude-val">None</span>;
        }
    }

    <span class="doccomment">/// Set the pattern on this `Captures` value.
    ///
    ...
    </span><span class="kw">pub fn </span>set_pattern(<span class="kw-2">&amp;mut </span><span class="self">self</span>, pid: <span class="prelude-ty">Option</span>&lt;PatternID&gt;) {
        <span class="self">self</span>.pid = pid;
    }

    <span class="doccomment">/// Returns the underlying slots, where each slot stores a single offset.
    ///
    ...
    </span><span class="kw">pub fn </span>slots(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;] {
        <span class="kw-2">&amp;</span><span class="self">self</span>.slots
    }

    <span class="doccomment">/// Returns the underlying slots as a mutable slice, where each slot stores
    /// a single offset.
    ///
    ...
    </span><span class="kw">pub fn </span>slots_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;] {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>.slots
    }
}

<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Captures {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="kw">let </span><span class="kw-2">mut </span>dstruct = f.debug_struct(<span class="string">"Captures"</span>);
        dstruct.field(<span class="string">"pid"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.pid);
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pid) = <span class="self">self</span>.pid {
            dstruct.field(<span class="string">"spans"</span>, <span class="kw-2">&amp;</span>CapturesDebugMap { pid, caps: <span class="self">self </span>});
        }
        dstruct.finish()
    }
}

<span class="doccomment">/// A little helper type to provide a nice map-like debug representation for
/// our capturing group spans.
</span><span class="kw">struct </span>CapturesDebugMap&lt;<span class="lifetime">'a</span>&gt; {
    pid: PatternID,
    caps: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Captures,
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; core::fmt::Debug <span class="kw">for </span>CapturesDebugMap&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        ...
        <span class="kw">let </span>names = <span class="self">self</span>.caps.group_info().pattern_names(<span class="self">self</span>.pid);
        <span class="kw">for </span>(group_index, maybe_name) <span class="kw">in </span>names.enumerate() {
            ...
            <span class="kw">match </span><span class="self">self</span>.caps.get_group(group_index) {
                ...
                <span class="prelude-val">Some</span>(span) =&gt; map.entry(<span class="kw-2">&amp;</span>key, <span class="kw-2">&amp;</span>span),
            };
        }
        map.finish()
    }
...
<span class="doccomment">/// An iterator over all capturing groups in a `Captures` value.
///
...
</span><span class="kw">pub struct </span>CapturesPatternIter&lt;<span class="lifetime">'a</span>&gt; {
    caps: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Captures,
    names: core::iter::Enumerate&lt;GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt;&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>CapturesPatternIter&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">type </span>Item = <span class="prelude-ty">Option</span>&lt;Span&gt;;

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Option</span>&lt;Span&gt;&gt; {
        <span class="kw">let </span>(group_index, <span class="kw">_</span>) = <span class="self">self</span>.names.next()<span class="question-mark">?</span>;
        <span class="prelude-val">Some</span>(<span class="self">self</span>.caps.get_group(group_index))
    }

    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        <span class="self">self</span>.names.size_hint()
    }

    <span class="kw">fn </span>count(<span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.names.count()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; ExactSizeIterator <span class="kw">for </span>CapturesPatternIter&lt;<span class="lifetime">'a</span>&gt; {}
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; core::iter::FusedIterator <span class="kw">for </span>CapturesPatternIter&lt;<span class="lifetime">'a</span>&gt; {}

<span class="doccomment">/// Represents information about capturing groups in a compiled regex.
///
...
</span><span class="kw">pub struct </span>GroupInfo(Arc&lt;GroupInfoInner&gt;);

<span class="kw">impl </span>GroupInfo {
    <span class="doccomment">/// Creates a new group info from a sequence of patterns, where each
    ...
    /// overflow `PatternID`.
    </span><span class="kw">pub fn </span>new&lt;P, G, N&gt;(pattern_groups: P) -&gt; <span class="prelude-ty">Result</span>&lt;GroupInfo, GroupInfoError&gt;
    <span class="kw">where
        </span>P: IntoIterator&lt;Item = G&gt;,
        G: IntoIterator&lt;Item = <span class="prelude-ty">Option</span>&lt;N&gt;&gt;,
        N: AsRef&lt;str&gt;,
    {
        <span class="kw">let </span><span class="kw-2">mut </span>group_info = GroupInfoInner {
            slot_ranges: <span class="macro">vec!</span>[],
            name_to_index: <span class="macro">vec!</span>[],
            index_to_name: <span class="macro">vec!</span>[],
            memory_extra: <span class="number">0</span>,
        };
        <span class="kw">for </span>(pattern_index, groups) <span class="kw">in </span>pattern_groups.into_iter().enumerate() {
            <span class="comment">// If we can't convert the pattern index to an ID, then the caller
            // tried to build capture info for too many patterns.
            </span><span class="kw">let </span>pid = PatternID::new(pattern_index)
                .map_err(GroupInfoError::too_many_patterns)<span class="question-mark">?</span>;

            <span class="kw">let </span><span class="kw-2">mut </span>groups_iter = groups.into_iter().enumerate();
            <span class="kw">match </span>groups_iter.next() {
                <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(GroupInfoError::missing_groups(pid)),
                <span class="prelude-val">Some</span>((<span class="kw">_</span>, <span class="prelude-val">Some</span>(<span class="kw">_</span>))) =&gt; {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(GroupInfoError::first_must_be_unnamed(pid))
                }
                <span class="prelude-val">Some</span>((<span class="kw">_</span>, <span class="prelude-val">None</span>)) =&gt; {}
            }
            group_info.add_first_group(pid);
            <span class="comment">// Now iterate over the rest, which correspond to all of the
            // (conventionally) explicit capture groups in a regex pattern.
            </span><span class="kw">for </span>(group_index, maybe_name) <span class="kw">in </span>groups_iter {
                <span class="comment">// Just like for patterns, if the group index can't be
                // converted to a "small" index, then the caller has given too
                // many groups for a particular pattern.
                </span><span class="kw">let </span>group = SmallIndex::new(group_index).map_err(|<span class="kw">_</span>| {
                    GroupInfoError::too_many_groups(pid, group_index)
                })<span class="question-mark">?</span>;
                group_info.add_explicit_group(pid, group, maybe_name)<span class="question-mark">?</span>;
            }
        }
        group_info.fixup_slot_ranges()<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(GroupInfo(Arc::new(group_info)))
    }

    <span class="doccomment">/// This creates an empty `GroupInfo`.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>empty() -&gt; GroupInfo {
        GroupInfo::new(core::iter::empty::&lt;[<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>str&gt;; <span class="number">0</span>]&gt;())
            .expect(<span class="string">"empty group info is always valid"</span>)
    }

    <span class="doccomment">/// Return the capture group index corresponding to the given name in the
    ...
    </span><span class="kw">pub fn </span>to_index(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID, name: <span class="kw-2">&amp;</span>str) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="kw">let </span>indices = <span class="self">self</span>.<span class="number">0</span>.name_to_index.get(pid.as_usize())<span class="question-mark">?</span>;
        indices.get(name).cloned().map(|i| i.as_usize())
    }

    <span class="doccomment">/// Return the capture name for the given index and given pattern. If the
    ...
    </span><span class="kw">pub fn </span>to_name(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID, group_index: usize) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>str&gt; {
        <span class="kw">let </span>pattern_names = <span class="self">self</span>.<span class="number">0</span>.index_to_name.get(pid.as_usize())<span class="question-mark">?</span>;
        pattern_names.get(group_index)<span class="question-mark">?</span>.as_deref()
    }

    <span class="doccomment">/// Return an iterator of all capture groups and their names (if present)
    ...
    </span><span class="kw">pub fn </span>pattern_names(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID) -&gt; GroupInfoPatternNames&lt;<span class="lifetime">'_</span>&gt; {
        GroupInfoPatternNames {
            it: <span class="self">self
    ...
    <span class="doccomment">/// Return an iterator of all capture groups for all patterns supported by
    ...
    </span><span class="kw">pub fn </span>all_names(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; GroupInfoAllNames&lt;<span class="lifetime">'_</span>&gt; {
        GroupInfoAllNames {
            group_info: <span class="self">self</span>,
            pids: PatternID::iter(<span class="self">self</span>.pattern_len()),
            current_pid: <span class="prelude-val">None</span>,
            names: <span class="prelude-val">None</span>,
        }
    }

    <span class="doccomment">/// Returns the starting and ending slot corresponding to the given
    ...
    </span><span class="kw">pub fn </span>slots(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        pid: PatternID,
        group_index: usize,
    ) -&gt; <span class="prelude-ty">Option</span>&lt;(usize, usize)&gt; {
        <span class="comment">// Since 'slot' only even returns valid starting slots, we know that
        // there must also be an end slot and that end slot is always one more
        // than the start slot.
        </span><span class="self">self</span>.slot(pid, group_index).map(|start| (start, start + <span class="number">1</span>))
    }

    <span class="doccomment">/// Returns the starting slot corresponding to the given capturing group
    ...
    /// ```
    ...
    </span><span class="kw">pub fn </span>slot(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID, group_index: usize) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="kw">if </span>group_index &gt;= <span class="self">self</span>.group_len(pid) {
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
        <span class="comment">// At this point, we know that 'pid' refers to a real pattern and that
        ...
        </span><span class="kw">if </span>group_index == <span class="number">0 </span>{
            <span class="prelude-val">Some</span>(pid.as_usize() * <span class="number">2</span>)
        } <span class="kw">else </span>{
            <span class="comment">// As above, we don't need to check that our slot is less than the
            // end of our range since we already know the group index is a
            // valid index for the given pattern.
            </span><span class="kw">let </span>(start, <span class="kw">_</span>) = <span class="self">self</span>.<span class="number">0</span>.slot_ranges[pid];
            <span class="prelude-val">Some</span>(start.as_usize() + ((group_index - <span class="number">1</span>) * <span class="number">2</span>))
        }
    }

    <span class="doccomment">/// Returns the total number of patterns in this `GroupInfo`.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.<span class="number">0</span>.pattern_len()
    }

    <span class="doccomment">/// Return the number of capture groups in a pattern.
    ///
    ...
    </span><span class="kw">pub fn </span>group_len(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID) -&gt; usize {
        <span class="self">self</span>.<span class="number">0</span>.group_len(pid)
    }

    <span class="doccomment">/// Return the total number of capture groups across all patterns.
    ///
    ...
    </span><span class="kw">pub fn </span>all_group_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.slot_len() / <span class="number">2
    </span>}

    <span class="doccomment">/// Returns the total number of slots in this `GroupInfo` across all
    /// patterns.
    ///
    ...
    </span><span class="kw">pub fn </span>slot_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.<span class="number">0</span>.small_slot_len().as_usize()
    }

    <span class="doccomment">/// Returns the total number of slots for implicit capturing groups.
    ///
    ...
    </span><span class="kw">pub fn </span>implicit_slot_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.pattern_len() * <span class="number">2
    </span>}

    <span class="doccomment">/// Returns the total number of slots for explicit capturing groups.
    ///
    /// This is like [`GroupInfo::slot_len`], except it doesn't include the
    ...
    </span><span class="kw">pub fn </span>explicit_slot_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.slot_len().saturating_sub(<span class="self">self</span>.implicit_slot_len())
    }

    <span class="doccomment">/// Returns the memory usage, in bytes, of this `GroupInfo`.
    ///
    ...
    /// To compute that, use `std::mem::size_of::&lt;GroupInfo&gt;()`.
        ...
        <span class="kw">use </span>core::mem::size_of <span class="kw">as </span>s;

        s::&lt;GroupInfoInner&gt;()
            + <span class="self">self</span>.<span class="number">0</span>.slot_ranges.len() * s::&lt;(SmallIndex, SmallIndex)&gt;()
            + <span class="self">self</span>.<span class="number">0</span>.name_to_index.len() * s::&lt;CaptureNameMap&gt;()
            + <span class="self">self</span>.<span class="number">0</span>.index_to_name.len() * s::&lt;Vec&lt;<span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;&gt;()
            + <span class="self">self</span>.<span class="number">0</span>.memory_extra
    }
}

<span class="doccomment">/// A map from capture group name to its corresponding capture group index.
///
...
</span><span class="kw">type </span>CaptureNameMap = std::collections::HashMap&lt;Arc&lt;str&gt;, SmallIndex&gt;;
<span class="attr">#[cfg(not(feature = <span class="string">"std"</span>))]
</span><span class="kw">type </span>CaptureNameMap = alloc::collections::BTreeMap&lt;Arc&lt;str&gt;, SmallIndex&gt;;

<span class="doccomment">/// The inner guts of `GroupInfo`. This type only exists so that it can
/// be wrapped in an `Arc` to make `GroupInfo` reference counted.
</span><span class="attr">#[derive(Debug, Default)]
</span><span class="kw">struct </span>GroupInfoInner {
    slot_ranges: Vec&lt;(SmallIndex, SmallIndex)&gt;,
    name_to_index: Vec&lt;CaptureNameMap&gt;,
    index_to_name: Vec&lt;Vec&lt;<span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;&gt;,
    memory_extra: usize,
}

<span class="kw">impl </span>GroupInfoInner {
    <span class="doccomment">/// This adds the first unnamed group for the given pattern ID. The given
    ...
    /// given pattern and closing off the state for any previous pattern.
    </span><span class="kw">fn </span>add_first_group(<span class="kw-2">&amp;mut </span><span class="self">self</span>, pid: PatternID) {
        <span class="macro">assert_eq!</span>(pid.as_usize(), <span class="self">self</span>.slot_ranges.len());
        <span class="macro">assert_eq!</span>(pid.as_usize(), <span class="self">self</span>.name_to_index.len());
        <span class="macro">assert_eq!</span>(pid.as_usize(), <span class="self">self</span>.index_to_name.len());
        <span class="comment">// This is the start of our slots for the explicit capturing groups.
        ...
        </span><span class="kw">let </span>slot_start = <span class="self">self</span>.small_slot_len();
        <span class="self">self</span>.slot_ranges.push((slot_start, slot_start));
        <span class="self">self</span>.name_to_index.push(CaptureNameMap::new());
        <span class="self">self</span>.index_to_name.push(<span class="macro">vec!</span>[<span class="prelude-val">None</span>]);
        <span class="self">self</span>.memory_extra += core::mem::size_of::&lt;<span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;();
    }

    <span class="doccomment">/// Add an explicit capturing group for the given pattern with the given
    ...
    /// pattern has already been added.
    </span><span class="kw">fn </span>add_explicit_group&lt;N: AsRef&lt;str&gt;&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        pid: PatternID,
        group: SmallIndex,
        maybe_name: <span class="prelude-ty">Option</span>&lt;N&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;(), GroupInfoError&gt; {
        <span class="comment">// We also need to check that the slot index generated for
        ...
        // than isize::MAX.
        </span><span class="kw">let </span>end = <span class="kw-2">&amp;mut </span><span class="self">self</span>.slot_ranges[pid].<span class="number">1</span>;
        <span class="kw-2">*</span>end = SmallIndex::new(end.as_usize() + <span class="number">2</span>).map_err(|<span class="kw">_</span>| {
            GroupInfoError::too_many_groups(pid, group.as_usize())
        })<span class="question-mark">?</span>;
        <span class="kw">if let </span><span class="prelude-val">Some</span>(name) = maybe_name {
            <span class="kw">let </span>name = Arc::&lt;str&gt;::from(name.as_ref());
            <span class="kw">if </span><span class="self">self</span>.name_to_index[pid].contains_key(<span class="kw-2">&amp;*</span>name) {
                <span class="kw">return </span><span class="prelude-val">Err</span>(GroupInfoError::duplicate(pid, <span class="kw-2">&amp;</span>name));
            }
            <span class="kw">let </span>len = name.len();
            <span class="self">self</span>.name_to_index[pid].insert(Arc::clone(<span class="kw-2">&amp;</span>name), group);
            <span class="self">self</span>.index_to_name[pid].push(<span class="prelude-val">Some</span>(name));
            <span class="comment">// Adds the memory used by the Arc&lt;str&gt; in both maps.
            </span><span class="self">self</span>.memory_extra +=
                <span class="number">2 </span>* (len + core::mem::size_of::&lt;<span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;());
            <span class="comment">// And also the value entry for the 'name_to_index' map.
            ...
            </span><span class="self">self</span>.memory_extra += core::mem::size_of::&lt;SmallIndex&gt;();
        } <span class="kw">else </span>{
            <span class="self">self</span>.index_to_name[pid].push(<span class="prelude-val">None</span>);
            <span class="self">self</span>.memory_extra += core::mem::size_of::&lt;<span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;();
        }
        <span class="comment">// This is a sanity assert that checks that our group index
        // is in line with the number of groups added so far for this
        // pattern.
        </span><span class="macro">assert_eq!</span>(group.one_more(), <span class="self">self</span>.group_len(pid));
        <span class="comment">// And is also in line with the 'index_to_name' map.
        </span><span class="macro">assert_eq!</span>(group.one_more(), <span class="self">self</span>.index_to_name[pid].len());
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// This corrects the slot ranges to account for the slots corresponding
    ...
    </span><span class="kw">fn </span>fixup_slot_ranges(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;(), GroupInfoError&gt; {
        <span class="kw">use </span><span class="kw">crate</span>::util::primitives::IteratorIndexExt;
        <span class="comment">// Since we know number of patterns fits in PatternID and
        // PatternID::MAX &lt; isize::MAX, it follows that multiplying by 2 will
        // never overflow usize.
        </span><span class="kw">let </span>offset = <span class="self">self</span>.pattern_len().checked_mul(<span class="number">2</span>).unwrap();
        <span class="kw">for </span>(pid, <span class="kw-2">&amp;mut </span>(<span class="kw-2">ref mut </span>start, <span class="kw-2">ref mut </span>end)) <span class="kw">in
            </span><span class="self">self</span>.slot_ranges.iter_mut().with_pattern_ids()
        {
            <span class="kw">let </span>group_len = <span class="number">1 </span>+ ((end.as_usize() - start.as_usize()) / <span class="number">2</span>);
            <span class="kw">let </span>new_end = <span class="kw">match </span>end.as_usize().checked_add(offset) {
                <span class="prelude-val">Some</span>(new_end) =&gt; new_end,
                <span class="prelude-val">None </span>=&gt; {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(GroupInfoError::too_many_groups(
                        pid, group_len,
                    ))
                }
            };
            <span class="kw-2">*</span>end = SmallIndex::new(new_end).map_err(|<span class="kw">_</span>| {
                GroupInfoError::too_many_groups(pid, group_len)
            })<span class="question-mark">?</span>;
            <span class="comment">// Since start &lt;= end, if end is valid then start must be too.
            </span><span class="kw-2">*</span>start = SmallIndex::new(start.as_usize() + offset).unwrap();
        }
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Return the total number of patterns represented by this capture slot
    /// info.
    </span><span class="kw">fn </span>pattern_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.slot_ranges.len()
    }

    <span class="doccomment">/// Return the total number of capturing groups for the given pattern. If
    /// the given pattern isn't valid for this capture slot info, then 0 is
    /// returned.
    </span><span class="kw">fn </span>group_len(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID) -&gt; usize {
        <span class="kw">let </span>(start, end) = <span class="kw">match </span><span class="self">self</span>.slot_ranges.get(pid.as_usize()) {
            <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="number">0</span>,
            <span class="prelude-val">Some</span>(range) =&gt; range,
        };
        <span class="comment">// The difference between any two SmallIndex values always fits in a
        ...
        </span><span class="number">1 </span>+ ((end.as_usize() - start.as_usize()) / <span class="number">2</span>)
    }

    <span class="doccomment">/// Return the total number of slots in this capture slot info as a
    /// "small index."
    </span><span class="kw">fn </span>small_slot_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; SmallIndex {
        <span class="comment">// Since slots are allocated in order of pattern (starting at 0) and
        ...
        // range.
        </span><span class="self">self</span>.slot_ranges.last().map_or(SmallIndex::ZERO, |<span class="kw-2">&amp;</span>(<span class="kw">_</span>, end)| end)
    }
}

<span class="doccomment">/// An error that may occur when building a `GroupInfo`.
///
...
</span><span class="kw">pub struct </span>GroupInfoError {
    kind: GroupInfoErrorKind,
}

<span class="doccomment">/// The kind of error that occurs when building a `GroupInfo` fails.
///
/// We keep this un-exported because it's not clear how useful it is to
/// export it.
</span><span class="attr">#[derive(Clone, Debug)]
</span><span class="kw">enum </span>GroupInfoErrorKind {
    <span class="doccomment">/// This occurs when too many patterns have been added. i.e., It would
    /// otherwise overflow a `PatternID`.
    </span>TooManyPatterns { err: PatternIDError },
    <span class="doccomment">/// This occurs when too many capturing groups have been added for a
    /// particular pattern.
    </span>TooManyGroups {
        <span class="doccomment">/// The ID of the pattern that had too many groups.
        </span>pattern: PatternID,
        <span class="doccomment">/// The minimum number of groups that the caller has tried to add for
        /// a pattern.
        </span>minimum: usize,
    },
    <span class="doccomment">/// An error that occurs when a pattern has no capture groups. Either the
    ...
    /// (corresponding to the unnamed group for the entire pattern).
        ...
        <span class="doccomment">/// The ID of the pattern that had no capturing groups.
        </span>pattern: PatternID,
    },
    <span class="doccomment">/// An error that occurs when one tries to provide a name for the capture
    /// group at index 0. This capturing group must currently always be
    /// unnamed.
    </span>FirstMustBeUnnamed {
        <span class="doccomment">/// The ID of the pattern that was found to have a named first
        /// capturing group.
        </span>pattern: PatternID,
    },
    <span class="doccomment">/// An error that occurs when duplicate capture group names for the same
    /// pattern are added.
    ///
    ...
    /// builder is used to hand construct NFAs.
        ...
        <span class="doccomment">/// The pattern in which the duplicate capture group name was found.
        </span>pattern: PatternID,
        <span class="doccomment">/// The duplicate name.
        </span>name: String,
    },
}

<span class="kw">impl </span>GroupInfoError {
    <span class="kw">fn </span>too_many_patterns(err: PatternIDError) -&gt; GroupInfoError {
        GroupInfoError { kind: GroupInfoErrorKind::TooManyPatterns { err } }
    }

    <span class="kw">fn </span>too_many_groups(pattern: PatternID, minimum: usize) -&gt; GroupInfoError {
        GroupInfoError {
            kind: GroupInfoErrorKind::TooManyGroups { pattern, minimum },
        }
    }

    <span class="kw">fn </span>missing_groups(pattern: PatternID) -&gt; GroupInfoError {
        GroupInfoError { kind: GroupInfoErrorKind::MissingGroups { pattern } }
    }

    <span class="kw">fn </span>first_must_be_unnamed(pattern: PatternID) -&gt; GroupInfoError {
        GroupInfoError {
            kind: GroupInfoErrorKind::FirstMustBeUnnamed { pattern },
        }
    }

    <span class="kw">fn </span>duplicate(pattern: PatternID, name: <span class="kw-2">&amp;</span>str) -&gt; GroupInfoError {
        GroupInfoError {
...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>std::error::Error <span class="kw">for </span>GroupInfoError {
    <span class="kw">fn </span>source(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>(<span class="kw">dyn </span>std::error::Error + <span class="lifetime">'static</span>)&gt; {
        <span class="kw">match </span><span class="self">self</span>.kind {
            ...
            | GroupInfoErrorKind::Duplicate { .. } =&gt; <span class="prelude-val">None</span>,
        }
    }
}

<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>GroupInfoError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="kw">use </span><span class="self">self</span>::GroupInfoErrorKind::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="self">self</span>.kind {
            TooManyPatterns { <span class="kw-2">ref </span>err } =&gt; {
                <span class="macro">write!</span>(f, <span class="string">"too many patterns to build capture info: {}"</span>, err)
            }
            TooManyGroups { pattern, minimum } =&gt; {
                <span class="macro">write!</span>(
                    f,
                    <span class="string">"too many capture groups (at least {}) were \
                     found for pattern {}"</span>,
                    minimum,
                    pattern.as_usize()
                )
            }
            MissingGroups { pattern } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"no capturing groups found for pattern {} \
                 (either all patterns have zero groups or all patterns have \
                  at least one group)"</span>,
                pattern.as_usize(),
            ),
            FirstMustBeUnnamed { pattern } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"first capture group (at index 0) for pattern {} has a name \
                 (it must be unnamed)"</span>,
                pattern.as_usize(),
            ),
            Duplicate { pattern, <span class="kw-2">ref </span>name } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"duplicate capture group name '{}' found for pattern {}"</span>,
                name,
                pattern.as_usize(),
            ),
        }
...
<span class="doccomment">/// An iterator over capturing groups and their names for a specific pattern.
///
...
</span><span class="kw">pub struct </span>GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt; {
    it: core::slice::Iter&lt;<span class="lifetime">'a</span>, <span class="prelude-ty">Option</span>&lt;Arc&lt;str&gt;&gt;&gt;,
}

<span class="kw">impl </span>GroupInfoPatternNames&lt;<span class="lifetime">'static</span>&gt; {
    <span class="kw">fn </span>empty() -&gt; GroupInfoPatternNames&lt;<span class="lifetime">'static</span>&gt; {
        GroupInfoPatternNames { it: [].iter() }
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">type </span>Item = <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>str&gt;;

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>str&gt;&gt; {
        <span class="self">self</span>.it.next().map(|x| x.as_deref())
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; ExactSizeIterator <span class="kw">for </span>GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt; {}
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; core::iter::FusedIterator <span class="kw">for </span>GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt; {}

<span class="doccomment">/// An iterator over capturing groups and their names for a `GroupInfo`.
///
...
</span><span class="kw">pub struct </span>GroupInfoAllNames&lt;<span class="lifetime">'a</span>&gt; {
    group_info: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>GroupInfo,
    pids: PatternIDIter,
    current_pid: <span class="prelude-ty">Option</span>&lt;PatternID&gt;,
    names: <span class="prelude-ty">Option</span>&lt;core::iter::Enumerate&lt;GroupInfoPatternNames&lt;<span class="lifetime">'a</span>&gt;&gt;&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>GroupInfoAllNames&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">type </span>Item = (PatternID, usize, <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>str&gt;);

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;(PatternID, usize, <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>str&gt;)&gt; {
        <span class="comment">// If the group info has no captures, then we never have anything
        // to yield. We need to consider this case explicitly (at time of
        // writing) because 'pattern_capture_names' will panic if captures
        // aren't enabled.
        </span><span class="kw">if </span><span class="self">self</span>.group_info.<span class="number">0</span>.index_to_name.is_empty() {
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
        <span class="kw">if </span><span class="self">self</span>.current_pid.is_none() {
            <span class="self">self</span>.current_pid = <span class="prelude-val">Some</span>(<span class="self">self</span>.pids.next()<span class="question-mark">?</span>);
        }
        <span class="kw">let </span>pid = <span class="self">self</span>.current_pid.unwrap();
        <span class="kw">if </span><span class="self">self</span>.names.is_none() {
            <span class="self">self</span>.names = <span class="prelude-val">Some</span>(<span class="self">self</span>.group_info.pattern_names(pid).enumerate());
        }
        <span class="kw">let </span>(group_index, name) = <span class="kw">match </span><span class="self">self</span>.names.as_mut().unwrap().next() {
            <span class="prelude-val">Some</span>((group_index, name)) =&gt; (group_index, name),
            <span class="prelude-val">None </span>=&gt; {
                <span class="self">self</span>.current_pid = <span class="prelude-val">None</span>;
                <span class="self">self</span>.names = <span class="prelude-val">None</span>;
                <span class="kw">return </span><span class="self">self</span>.next();
            }
        };
        <span class="prelude-val">Some</span>((pid, group_index, name))
    }
}
