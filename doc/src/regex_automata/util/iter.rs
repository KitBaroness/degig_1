<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/util/iter.rs`."><title>iter.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="kw">use </span><span class="kw">crate</span>::util::captures::Captures;
<span class="kw">use </span><span class="kw">crate</span>::util::search::{HalfMatch, Input, Match, MatchError};

<span class="doccomment">/// A searcher for creating iterators and performing lower level iteration.
///
...
</span><span class="kw">pub struct </span>Searcher&lt;<span class="lifetime">'h</span>&gt; {
    <span class="doccomment">/// The input parameters to give to each regex engine call.
    ///
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; Searcher&lt;<span class="lifetime">'h</span>&gt; {
    <span class="doccomment">/// Create a new fallible non-overlapping matches iterator.
    ///
    ...
    </span><span class="kw">pub fn </span>new(input: Input&lt;<span class="lifetime">'h</span>&gt;) -&gt; Searcher&lt;<span class="lifetime">'h</span>&gt; {
        Searcher { input, last_match_end: <span class="prelude-val">None </span>}
    }

    <span class="doccomment">/// Returns the current `Input` used by this searcher.
    ///
    ...
    <span class="doccomment">/// Return the next half match for an infallible search if one exists, and
    ...
    </span><span class="kw">pub fn </span>advance_half&lt;F&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, finder: F) -&gt; <span class="prelude-ty">Option</span>&lt;HalfMatch&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
    {
        <span class="kw">match </span><span class="self">self</span>.try_advance_half(finder) {
            <span class="prelude-val">Ok</span>(m) =&gt; m,
            <span class="prelude-val">Err</span>(err) =&gt; <span class="macro">panic!</span>(
                <span class="string">"unexpected regex half find error: {}\n\
                 to handle find errors, use 'try' or 'search' methods"</span>,
                err,
            ),
        }
    }

    <span class="doccomment">/// Return the next match for an infallible search if one exists, and
    /// advance to the next position.
    ///
    ...
    </span><span class="kw">pub fn </span>advance&lt;F&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, finder: F) -&gt; <span class="prelude-ty">Option</span>&lt;Match&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;,
    {
        <span class="kw">match </span><span class="self">self</span>.try_advance(finder) {
            <span class="prelude-val">Ok</span>(m) =&gt; m,
            <span class="prelude-val">Err</span>(err) =&gt; <span class="macro">panic!</span>(
                <span class="string">"unexpected regex find error: {}\n\
                 to handle find errors, use 'try' or 'search' methods"</span>,
                err,
            ),
        }
    ...
    <span class="doccomment">/// Return the next half match for a fallible search if one exists, and
    /// advance to the next position.
    ///
    /// This is like `advance_half`, except it permits callers to handle errors
    /// during iteration.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>try_advance_half&lt;F&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        <span class="kw-2">mut </span>finder: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
    {
        <span class="kw">let </span><span class="kw-2">mut </span>m = <span class="kw">match </span>finder(<span class="kw-2">&amp;</span><span class="self">self</span>.input)<span class="question-mark">? </span>{
        ...
        <span class="kw">if </span><span class="prelude-val">Some</span>(m.offset()) == <span class="self">self</span>.last_match_end {
            m = <span class="kw">match </span><span class="self">self</span>.handle_overlapping_empty_half_match(m, finder)<span class="question-mark">? </span>{
                <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">None</span>),
                <span class="prelude-val">Some</span>(m) =&gt; m,
            };
        }
        <span class="self">self</span>.input.set_start(m.offset());
        <span class="self">self</span>.last_match_end = <span class="prelude-val">Some</span>(m.offset());
        <span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(m))
    }

    <span class="doccomment">/// Return the next match for a fallible search if one exists, and advance
    /// to the next position.
    ///
    /// This is like `advance`, except it permits callers to handle errors
    /// during iteration.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>try_advance&lt;F&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        <span class="kw-2">mut </span>finder: F,
        ...
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;,
    {
        ...
        <span class="kw">if </span>m.is_empty() &amp;&amp; <span class="prelude-val">Some</span>(m.end()) == <span class="self">self</span>.last_match_end {
            m = <span class="kw">match </span><span class="self">self</span>.handle_overlapping_empty_match(m, finder)<span class="question-mark">? </span>{
                <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">None</span>),
                <span class="prelude-val">Some</span>(m) =&gt; m,
            };
        }
    ...
    <span class="doccomment">/// Given a closure that executes a single search, return an iterator over
    ...
    </span><span class="kw">pub fn </span>into_half_matches_iter&lt;F&gt;(
        <span class="self">self</span>,
        finder: F,
    ) -&gt; TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
    {
        TryHalfMatchesIter { it: <span class="self">self</span>, finder }
    }
    ...
    </span><span class="kw">pub fn </span>into_matches_iter&lt;F&gt;(<span class="self">self</span>, finder: F) -&gt; TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;,
    {
        TryMatchesIter { it: <span class="self">self</span>, finder }
    }
    ...
    #[inline]
    </span><span class="kw">pub fn </span>into_captures_iter&lt;F&gt;(
        <span class="self">self</span>,
        caps: Captures,
        finder: F,
    ) -&gt; TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;, <span class="kw-2">&amp;mut </span>Captures) -&gt; <span class="prelude-ty">Result</span>&lt;(), MatchError&gt;,
    {
        TryCapturesIter { it: <span class="self">self</span>, caps, finder }
    }

    <span class="doccomment">/// Handles the special case of a match that begins where the previous
    ...
    #[inline(never)]
    </span><span class="kw">fn </span>handle_overlapping_empty_half_match&lt;F&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        <span class="kw">_</span>: HalfMatch,
        <span class="kw-2">mut </span>finder: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;
    <span class="kw">where
        </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
    {
        <span class="comment">// Since we are only here when 'm.offset()' matches the offset of the
        ...
        // UTF-8 mode.
        </span><span class="self">self</span>.input.set_start(<span class="self">self</span>.input.start().checked_add(<span class="number">1</span>).unwrap());
        finder(<span class="kw-2">&amp;</span><span class="self">self</span>.input)
    }
    ...
    #[inline(never)]
    </span><span class="kw">fn </span>handle_overlapping_empty_match&lt;F&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        m: Match,
        <span class="kw-2">mut </span>finder: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;
...
<span class="doccomment">/// An iterator over all non-overlapping half matches for a fallible search.
///
...
</span><span class="kw">pub struct </span>TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    it: Searcher&lt;<span class="lifetime">'h</span>&gt;,
    finder: F,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="doccomment">/// Return an infallible version of this iterator.
    ///
    ...
    </span><span class="kw">pub fn </span>infallible(<span class="self">self</span>) -&gt; HalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
        HalfMatchesIter(<span class="self">self</span>)
    }

    <span class="doccomment">/// Returns the current `Input` used by this iterator.
    ///
    ...
    </span><span class="kw">pub fn </span>input&lt;<span class="lifetime">'i</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'i </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'i </span>Input&lt;<span class="lifetime">'h</span>&gt; {
        <span class="self">self</span>.it.input()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
{
    <span class="kw">type </span>Item = <span class="prelude-ty">Result</span>&lt;HalfMatch, MatchError&gt;;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Result</span>&lt;HalfMatch, MatchError&gt;&gt; {
        <span class="self">self</span>.it.try_advance_half(<span class="kw-2">&amp;mut </span><span class="self">self</span>.finder).transpose()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; core::fmt::Debug <span class="kw">for </span>TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        f.debug_struct(<span class="string">"TryHalfMatchesIter"</span>)
            .field(<span class="string">"it"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.it)
            .field(<span class="string">"finder"</span>, <span class="kw-2">&amp;</span><span class="string">"&lt;closure&gt;"</span>)
            .finish()
    }
}

<span class="doccomment">/// An iterator over all non-overlapping half matches for an infallible search.
///
...
</span><span class="kw">pub struct </span>HalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;(TryHalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;);

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; HalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="doccomment">/// Returns the current `Input` used by this iterator.
    ///
    /// The `Input` returned is generally equivalent to the one used to
    /// construct this iterator, but its start position may be different to
    /// reflect the start of the next search to be executed.
        ...
        <span class="self">self</span>.<span class="number">0</span>.it.input()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>HalfMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt;,
{
    <span class="kw">type </span>Item = HalfMatch;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;HalfMatch&gt; {
        <span class="kw">match </span><span class="self">self</span>.<span class="number">0</span>.next()<span class="question-mark">? </span>{
            <span class="prelude-val">Ok</span>(m) =&gt; <span class="prelude-val">Some</span>(m),
            <span class="prelude-val">Err</span>(err) =&gt; <span class="macro">panic!</span>(
                <span class="string">"unexpected regex half find error: {}\n\
                 to handle find errors, use 'try' or 'search' methods"</span>,
                err,
...
</span><span class="kw">pub struct </span>TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    it: Searcher&lt;<span class="lifetime">'h</span>&gt;,
    finder: F,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="doccomment">/// Return an infallible version of this iterator.
    ///
    /// Any item yielded that corresponds to an error results in a panic. This
    /// is useful if your underlying regex engine is configured in a way that
    /// it is guaranteed to never return an error.
    </span><span class="kw">pub fn </span>infallible(<span class="self">self</span>) -&gt; MatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
        MatchesIter(<span class="self">self</span>)
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;,
{
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.it.try_advance(<span class="kw-2">&amp;mut </span><span class="self">self</span>.finder).transpose()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; core::fmt::Debug <span class="kw">for </span>TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        f.debug_struct(<span class="string">"TryMatchesIter"</span>)
            .field(<span class="string">"it"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.it)
            .field(<span class="string">"finder"</span>, <span class="kw-2">&amp;</span><span class="string">"&lt;closure&gt;"</span>)
            .finish()
    }
...
<span class="doccomment">/// An iterator over all non-overlapping matches for an infallible search.
///
...
</span><span class="kw">pub struct </span>MatchesIter&lt;<span class="lifetime">'h</span>, F&gt;(TryMatchesIter&lt;<span class="lifetime">'h</span>, F&gt;);

<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; MatchesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="doccomment">/// Returns the current `Input` used by this iterator.
    ///
    /// The `Input` returned is generally equivalent to the one used to
    /// construct this iterator, but its start position may be different to
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>MatchesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Match&gt;, MatchError&gt;,
{
...
<span class="doccomment">/// An iterator over all non-overlapping captures for a fallible search.
///
...
</span><span class="kw">pub struct </span>TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    it: Searcher&lt;<span class="lifetime">'h</span>&gt;,
    caps: Captures,
    finder: F,
}
...
</span><span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="doccomment">/// Return an infallible version of this iterator.
    ///
    /// Any item yielded that corresponds to an error results in a panic. This
    /// is useful if your underlying regex engine is configured in a way that
    /// it is guaranteed to never return an error.
    </span><span class="kw">pub fn </span>infallible(<span class="self">self</span>) -&gt; CapturesIter&lt;<span class="lifetime">'h</span>, F&gt; {
        CapturesIter(<span class="self">self</span>)
    }
}

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;, <span class="kw-2">&amp;mut </span>Captures) -&gt; <span class="prelude-ty">Result</span>&lt;(), MatchError&gt;,
{
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>TryCapturesIter { <span class="kw-2">ref mut </span>it, <span class="kw-2">ref mut </span>caps, <span class="kw-2">ref mut </span>finder } =
            <span class="kw-2">*</span><span class="self">self</span>;
        <span class="kw">let </span>result = it
            .try_advance(|input| {
                (finder)(input, caps)<span class="question-mark">?</span>;
                <span class="prelude-val">Ok</span>(caps.get_match())
            })
            .transpose()<span class="question-mark">?</span>;
        <span class="kw">match </span>result {
            <span class="prelude-val">Ok</span>(<span class="kw">_</span>) =&gt; <span class="prelude-val">Some</span>(<span class="prelude-val">Ok</span>(caps.clone())),
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; core::fmt::Debug <span class="kw">for </span>TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        f.debug_struct(<span class="string">"TryCapturesIter"</span>)
            .field(<span class="string">"it"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.it)
            .field(<span class="string">"caps"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.caps)
            .field(<span class="string">"finder"</span>, <span class="kw-2">&amp;</span><span class="string">"&lt;closure&gt;"</span>)
            .finish()
    }
}

<span class="doccomment">/// An iterator over all non-overlapping captures for an infallible search.
///
...
#[derive(Debug)]
</span><span class="kw">pub struct </span>CapturesIter&lt;<span class="lifetime">'h</span>, F&gt;(TryCapturesIter&lt;<span class="lifetime">'h</span>, F&gt;);

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl</span>&lt;<span class="lifetime">'h</span>, F&gt; Iterator <span class="kw">for </span>CapturesIter&lt;<span class="lifetime">'h</span>, F&gt;
<span class="kw">where
    </span>F: FnMut(<span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;, <span class="kw-2">&amp;mut </span>Captures) -&gt; <span class="prelude-ty">Result</span>&lt;(), MatchError&gt;,
{
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.<span class="number">0</span>.next()<span class="question-mark">? </span>{
            <span class="prelude-val">Ok</span>(m) =&gt; <span class="prelude-val">Some</span>(m),
            <span class="prelude-val">Err</span>(err) =&gt; <span class="macro">panic!</span>(
                <span class="string">"unexpected regex captures error: {}\n\
                 to handle find errors, use 'try' or 'search' methods"</span>,
                err,
            ),
        }
