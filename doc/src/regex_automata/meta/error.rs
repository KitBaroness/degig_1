<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/meta/error.rs`."><title>error.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</pre></div><pre class="rust"><code><span class="kw">use </span>regex_syntax::{ast, hir};

<span class="kw">use crate</span>::{nfa, util::search::MatchError, PatternID};

<span class="doccomment">/// An error that occurs when construction of a `Regex` fails.
///
...
<span class="kw">impl </span>BuildError {
    <span class="doccomment">/// If it is known which pattern ID caused this build error to occur, then
    ...
    /// ```
        ...
        <span class="kw">match </span><span class="self">self</span>.kind {
            BuildErrorKind::Syntax { pid, .. } =&gt; <span class="prelude-val">Some</span>(pid),
            <span class="kw">_ </span>=&gt; <span class="prelude-val">None</span>,
        }
    }

    <span class="doccomment">/// If this error occurred because the regex exceeded the configured size
    ...
    /// maximum amount of heap usage in bytes.
        ...
        <span class="kw">match </span><span class="self">self</span>.kind {
            BuildErrorKind::NFA(<span class="kw-2">ref </span>err) =&gt; err.size_limit(),
            <span class="kw">_ </span>=&gt; <span class="prelude-val">None</span>,
        }
    }

    <span class="doccomment">/// If this error corresponds to a syntax error, then a reference to it is
    /// returned by this method.
    </span><span class="kw">pub fn </span>syntax_error(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>regex_syntax::Error&gt; {
        <span class="kw">match </span><span class="self">self</span>.kind {
            BuildErrorKind::Syntax { <span class="kw-2">ref </span>err, .. } =&gt; <span class="prelude-val">Some</span>(err),
            <span class="kw">_ </span>=&gt; <span class="prelude-val">None</span>,
        }
    }

    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>ast(pid: PatternID, err: ast::Error) -&gt; BuildError {
        <span class="kw">let </span>err = regex_syntax::Error::from(err);
        BuildError { kind: BuildErrorKind::Syntax { pid, err } }
    }

    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>hir(pid: PatternID, err: hir::Error) -&gt; BuildError {
        <span class="kw">let </span>err = regex_syntax::Error::from(err);
        BuildError { kind: BuildErrorKind::Syntax { pid, err } }
    }
    ...
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="kw">match </span><span class="self">self</span>.kind {
            BuildErrorKind::Syntax { pid, .. } =&gt; {
                <span class="macro">write!</span>(f, <span class="string">"error parsing pattern {}"</span>, pid.as_usize())
            }
...
<span class="doccomment">/// An error that occurs when a search should be retried.
///
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">enum </span>RetryError {
    Quadratic(RetryQuadraticError),
    Fail(RetryFailError),
}

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>std::error::Error <span class="kw">for </span>RetryError {}

<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>RetryError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            RetryError::Quadratic(<span class="kw-2">ref </span>err) =&gt; err.fmt(f),
            RetryError::Fail(<span class="kw-2">ref </span>err) =&gt; err.fmt(f),
        }
    }
}

<span class="kw">impl </span>From&lt;MatchError&gt; <span class="kw">for </span>RetryError {
    <span class="kw">fn </span>from(merr: MatchError) -&gt; RetryError {
        RetryError::Fail(RetryFailError::from(merr))
    }
}

<span class="doccomment">/// An error that occurs when potential quadratic behavior has been detected
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>RetryQuadraticError(());

<span class="kw">impl </span>RetryQuadraticError {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new() -&gt; RetryQuadraticError {
        RetryQuadraticError(())
    }
}

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>std::error::Error <span class="kw">for </span>RetryQuadraticError {}

<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>RetryQuadraticError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="macro">write!</span>(f, <span class="string">"regex engine gave up to avoid quadratic behavior"</span>)
    }
}

<span class="kw">impl </span>From&lt;RetryQuadraticError&gt; <span class="kw">for </span>RetryError {
    <span class="kw">fn </span>from(err: RetryQuadraticError) -&gt; RetryError {
        RetryError::Quadratic(err)
    }
}

<span class="doccomment">/// An error that occurs when a regex engine "gives up" for some reason before
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>RetryFailError {
    offset: usize,
}

<span class="kw">impl </span>RetryFailError {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>from_offset(offset: usize) -&gt; RetryFailError {
        RetryFailError { offset }
    }
}

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">impl </span>std::error::Error <span class="kw">for </span>RetryFailError {}

<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>RetryFailError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="macro">write!</span>(f, <span class="string">"regex engine failed at offset {:?}"</span>, <span class="self">self</span>.offset)
    }
}

<span class="kw">impl </span>From&lt;RetryFailError&gt; <span class="kw">for </span>RetryError {
    <span class="kw">fn </span>from(err: RetryFailError) -&gt; RetryError {
        RetryError::Fail(err)
    }
}

<span class="kw">impl </span>From&lt;MatchError&gt; <span class="kw">for </span>RetryFailError {
    <span class="kw">fn </span>from(merr: MatchError) -&gt; RetryFailError {
        <span class="kw">use </span><span class="kw">crate</span>::util::search::MatchErrorKind::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="kw-2">*</span>merr.kind() {
            Quit { offset, .. } =&gt; RetryFailError::from_offset(offset),
            GaveUp { offset } =&gt; RetryFailError::from_offset(offset),
            <span class="comment">// These can never occur because we avoid them by construction
            ...
            </span>HaystackTooLong { .. } | UnsupportedAnchored { .. } =&gt; {
                <span class="macro">unreachable!</span>(<span class="string">"found impossible error in meta engine: {}"</span>, merr)
            }
        }
    }
}
