<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/hybrid/search.rs`."><title>search.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
<span class="attr">#[inline(never)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>find_fwd(
    ...
    <span class="kw">let </span>pre = <span class="kw">if </span>input.get_anchored().is_anchored() {
        <span class="prelude-val">None
    </span>} <span class="kw">else </span>{
        dfa.get_config().get_prefilter()
    };
    <span class="comment">// So what we do here is specialize four different versions of 'find_fwd':
    ...
    </span><span class="kw">if </span>pre.is_some() {
        <span class="kw">if </span>input.get_earliest() {
            find_fwd_imp(dfa, cache, input, pre, <span class="bool-val">true</span>)
        } <span class="kw">else </span>{
            find_fwd_imp(dfa, cache, input, pre, <span class="bool-val">false</span>)
        }
    } <span class="kw">else </span>{
        <span class="kw">if </span>input.get_earliest() {
            find_fwd_imp(dfa, cache, input, <span class="prelude-val">None</span>, <span class="bool-val">true</span>)
        } <span class="kw">else </span>{
            find_fwd_imp(dfa, cache, input, <span class="prelude-val">None</span>, <span class="bool-val">false</span>)
        }
    }
}

<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>find_fwd_imp(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    pre: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'_ </span>Prefilter&gt;,
    earliest: bool,
) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt; {
    <span class="comment">// See 'prefilter_restart' docs for explanation.
    </span><span class="kw">let </span>universal_start = dfa.get_nfa().look_set_prefix_any().is_empty();
    <span class="kw">let </span><span class="kw-2">mut </span>mat = <span class="prelude-val">None</span>;
    <span class="kw">let </span><span class="kw-2">mut </span>sid = init_fwd(dfa, cache, input)<span class="question-mark">?</span>;
    <span class="kw">let </span><span class="kw-2">mut </span>at = input.start();
    <span class="comment">// This could just be a closure, but then I think it would be unsound
    // because it would need to be safe to invoke. This way, the lack of safety
    // is clearer in the code below.
    </span><span class="macro">macro_rules!</span> next_unchecked {
        (<span class="macro-nonterminal">$sid</span>:expr, <span class="macro-nonterminal">$at</span>:expr) =&gt; {{
            <span class="kw">let </span>byte = <span class="kw-2">*</span>input.haystack().get_unchecked(<span class="macro-nonterminal">$at</span>);
            dfa.next_state_untagged_unchecked(cache, <span class="macro-nonterminal">$sid</span>, byte)
        }};
    }
    ...
    <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>pre) = pre {
        ...
        <span class="kw">match </span>pre.find(input.haystack(), span) {
            <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Ok</span>(mat),
            <span class="prelude-val">Some</span>(<span class="kw-2">ref </span>span) =&gt; {
                at = span.start;
                <span class="kw">if </span>!universal_start {
                    sid = prefilter_restart(dfa, cache, <span class="kw-2">&amp;</span>input, at)<span class="question-mark">?</span>;
                }
            }
        }
    }
    ...
    <span class="kw">while </span>at &lt; input.end() {
        <span class="kw">if </span>sid.is_tagged() {
            ...
            sid = dfa
                ...
                .map_err(|<span class="kw">_</span>| gave_up(at))<span class="question-mark">?</span>;
        } <span class="kw">else </span>{
            <span class="comment">// SAFETY: There are two safety invariants we need to uphold
            ...
            </span><span class="kw">let </span><span class="kw-2">mut </span>prev_sid = sid;
            <span class="kw">while </span>at &lt; input.end() {
                prev_sid = <span class="kw">unsafe </span>{ <span class="macro">next_unchecked!</span>(sid, at) };
                <span class="kw">if </span>prev_sid.is_tagged() || at + <span class="number">3 </span>&gt;= input.end() {
                    core::mem::swap(<span class="kw-2">&amp;mut </span>prev_sid, <span class="kw-2">&amp;mut </span>sid);
                    <span class="kw">break</span>;
                }
                at += <span class="number">1</span>;

                sid = <span class="kw">unsafe </span>{ <span class="macro">next_unchecked!</span>(prev_sid, at) };
                <span class="kw">if </span>sid.is_tagged() {
                    <span class="kw">break</span>;
                }
                at += <span class="number">1</span>;
                ...
                prev_sid = <span class="kw">unsafe </span>{ <span class="macro">next_unchecked!</span>(sid, at) };
                <span class="kw">if </span>prev_sid.is_tagged() {
                    core::mem::swap(<span class="kw-2">&amp;mut </span>prev_sid, <span class="kw-2">&amp;mut </span>sid);
                    <span class="kw">break</span>;
                }
                at += <span class="number">1</span>;
            ...
            <span class="comment">// If we quit out of the code above with an unknown state ID at
        ...
        <span class="kw">if </span>sid.is_tagged() {
            <span class="kw">if </span>sid.is_start() {
                <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>pre) = pre {
                    <span class="kw">let </span>span = Span::from(at..input.end());
                    <span class="kw">match </span>pre.find(input.haystack(), span) {
                        ...
                        <span class="prelude-val">Some</span>(<span class="kw-2">ref </span>span) =&gt; {
                            <span class="comment">// We want to skip any update to 'at' below
                            ...
                            </span><span class="kw">if </span>span.start &gt; at {
                                at = span.start;
                                <span class="kw">if </span>!universal_start {
                                    sid = prefilter_restart(
                                        dfa, cache, <span class="kw-2">&amp;</span>input, at,
            ...
            } <span class="kw">else if </span>sid.is_match() {
                <span class="kw">let </span>pattern = dfa.match_pattern(cache, sid, <span class="number">0</span>);
                <span class="comment">// Since slice ranges are inclusive at the beginning and
                ...
                // bound of the match.
                </span>mat = <span class="prelude-val">Some</span>(HalfMatch::new(pattern, at));
                ...
                cache.search_finish(at);
                <span class="kw">return </span><span class="prelude-val">Err</span>(MatchError::quit(input.haystack()[at], at));
            } <span class="kw">else </span>{
                <span class="macro">debug_assert!</span>(sid.is_unknown());
                <span class="macro">unreachable!</span>(<span class="string">"sid being unknown is a bug"</span>);
            }
        }
        at += <span class="number">1</span>;
    }
    eoi_fwd(dfa, cache, input, <span class="kw-2">&amp;mut </span>sid, <span class="kw-2">&amp;mut </span>mat)<span class="question-mark">?</span>;
    cache.search_finish(input.end());
    <span class="prelude-val">Ok</span>(mat)
}

<span class="attr">#[inline(never)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>find_rev(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;HalfMatch&gt;, MatchError&gt; {
    ...
    <span class="kw">if </span>input.get_earliest() {
        find_rev_imp(dfa, cache, input, <span class="bool-val">true</span>)
    } <span class="kw">else </span>{
        find_rev_imp(dfa, cache, input, <span class="bool-val">false</span>)
    }
}

<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>find_rev_imp(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    earliest: bool,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>mat = <span class="prelude-val">None</span>;
    <span class="kw">let </span><span class="kw-2">mut </span>sid = init_rev(dfa, cache, input)<span class="question-mark">?</span>;
    <span class="comment">// In reverse search, the loop below can't handle the case of searching an
    ...
    </span><span class="kw">if </span>input.start() == input.end() {
        eoi_rev(dfa, cache, input, <span class="kw-2">&amp;mut </span>sid, <span class="kw-2">&amp;mut </span>mat)<span class="question-mark">?</span>;
        <span class="kw">return </span><span class="prelude-val">Ok</span>(mat);
    }

    <span class="kw">let </span><span class="kw-2">mut </span>at = input.end() - <span class="number">1</span>;
    <span class="macro">macro_rules!</span> next_unchecked {
        (<span class="macro-nonterminal">$sid</span>:expr, <span class="macro-nonterminal">$at</span>:expr) =&gt; {{
            <span class="kw">let </span>byte = <span class="kw-2">*</span>input.haystack().get_unchecked(<span class="macro-nonterminal">$at</span>);
            dfa.next_state_untagged_unchecked(cache, <span class="macro-nonterminal">$sid</span>, byte)
        }};
    ...
    <span class="kw">loop </span>{
        <span class="kw">if </span>sid.is_tagged() {
            ...
            <span class="comment">// SAFETY: See comments in 'find_fwd' for a safety argument.
            //
            ...
            <span class="kw">while </span>at &gt;= input.start() {
                prev_sid = <span class="kw">unsafe </span>{ <span class="macro">next_unchecked!</span>(sid, at) };
                <span class="kw">if </span>prev_sid.is_tagged()
                    || at &lt;= input.start().saturating_add(<span class="number">3</span>)
                {
                    core::mem::swap(<span class="kw-2">&amp;mut </span>prev_sid, <span class="kw-2">&amp;mut </span>sid);
                    <span class="kw">break</span>;
                }
        ...
        <span class="kw">if </span>sid.is_tagged() {
            ...
            </span>} <span class="kw">else if </span>sid.is_match() {
                <span class="kw">let </span>pattern = dfa.match_pattern(cache, sid, <span class="number">0</span>);
                <span class="comment">// Since reverse searches report the beginning of a match
...
<span class="attr">#[inline(never)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>find_overlapping_fwd(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    ...
    <span class="kw">if </span>pre.is_some() {
        find_overlapping_fwd_imp(dfa, cache, input, pre, state)
    } <span class="kw">else </span>{
        find_overlapping_fwd_imp(dfa, cache, input, <span class="prelude-val">None</span>, state)
    }
}

<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>find_overlapping_fwd_imp(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    pre: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'_ </span>Prefilter&gt;,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>sid = <span class="kw">match </span>state.id {
        <span class="prelude-val">None </span>=&gt; {
            ...
            init_fwd(dfa, cache, input)<span class="question-mark">?
        </span>}
        <span class="prelude-val">Some</span>(sid) =&gt; {
            <span class="kw">if let </span><span class="prelude-val">Some</span>(match_index) = state.next_match_index {
                <span class="kw">let </span>match_len = dfa.match_len(cache, sid);
                <span class="kw">if </span>match_index &lt; match_len {
                    state.next_match_index = <span class="prelude-val">Some</span>(match_index + <span class="number">1</span>);
                    <span class="kw">let </span>pattern = dfa.match_pattern(cache, sid, match_index);
                    state.mat = <span class="prelude-val">Some</span>(HalfMatch::new(pattern, state.at));
                    <span class="kw">return </span><span class="prelude-val">Ok</span>(());
                }
            }
            <span class="comment">// Once we've reported all matches at a given position, we need to
            // advance the search to the next position.
            </span>state.at += <span class="number">1</span>;
            <span class="kw">if </span>state.at &gt; input.end() {
                <span class="kw">return </span><span class="prelude-val">Ok</span>(());
            }
            sid
        }
    ...
    <span class="comment">// NOTE: We don't optimize the crap out of this routine primarily because
    ...
    </span>cache.search_start(state.at);
    <span class="kw">while </span>state.at &lt; input.end() {
        sid = dfa
            .next_state(cache, sid, input.haystack()[state.at])
            .map_err(|<span class="kw">_</span>| gave_up(state.at))<span class="question-mark">?</span>;
        <span class="kw">if </span>sid.is_tagged() {
            ...
            <span class="kw">if </span>sid.is_start() {
                <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>pre) = pre {
                    ...
                    <span class="kw">match </span>pre.find(input.haystack(), span) {
                        ...
                        <span class="prelude-val">Some</span>(<span class="kw-2">ref </span>span) =&gt; {
                            <span class="kw">if </span>span.start &gt; state.at {
                                state.at = span.start;
                                <span class="kw">if </span>!universal_start {
                                    sid = prefilter_restart(
                                        dfa, cache, <span class="kw-2">&amp;</span>input, state.at,
                                    )<span class="question-mark">?</span>;
                                }
                                <span class="kw">continue</span>;
                            }
    ...
    <span class="kw">let </span>result = eoi_fwd(dfa, cache, input, <span class="kw-2">&amp;mut </span>sid, <span class="kw-2">&amp;mut </span>state.mat);
    state.id = <span class="prelude-val">Some</span>(sid);
    <span class="kw">if </span>state.mat.is_some() {
        <span class="comment">// '1' is always correct here since if we get to this point, this
        ...
        </span>state.next_match_index = <span class="prelude-val">Some</span>(<span class="number">1</span>);
    }
    cache.search_finish(input.end());
    result
}
...
<span class="attr">#[inline(never)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>find_overlapping_rev(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    state: <span class="kw-2">&amp;mut </span>OverlappingState,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>sid = <span class="kw">match </span>state.id {
        <span class="prelude-val">None </span>=&gt; {
            <span class="kw">let </span>sid = init_rev(dfa, cache, input)<span class="question-mark">?</span>;
            state.id = <span class="prelude-val">Some</span>(sid);
            <span class="kw">if </span>input.start() == input.end() {
                state.rev_eoi = <span class="bool-val">true</span>;
            } <span class="kw">else </span>{
                state.at = input.end() - <span class="number">1</span>;
            }
            sid
        }
        <span class="prelude-val">Some</span>(sid) =&gt; {
            ...
            </span><span class="kw">if </span>state.rev_eoi {
                <span class="kw">return </span><span class="prelude-val">Ok</span>(());
            } <span class="kw">else if </span>state.at == input.start() {
                <span class="comment">// At this point, we should follow the EOI transition. This
                // will cause us the skip the main loop below and fall through
                // to the final 'eoi_rev' transition.
                </span>state.rev_eoi = <span class="bool-val">true</span>;
            } <span class="kw">else </span>{
                <span class="comment">// We haven't hit the end of the search yet, so move on.
                </span>state.at -= <span class="number">1</span>;
            }
            sid
        }
    ...
    <span class="kw">while </span>!state.rev_eoi {
        sid = dfa
            .next_state(cache, sid, input.haystack()[state.at])
            .map_err(|<span class="kw">_</span>| gave_up(state.at))<span class="question-mark">?</span>;
        <span class="kw">if </span>sid.is_tagged() {
            ...
            <span class="kw">if </span>sid.is_start() {
                ...
                state.next_match_index = <span class="prelude-val">Some</span>(<span class="number">1</span>);
                <span class="kw">let </span>pattern = dfa.match_pattern(cache, sid, <span class="number">0</span>);
                state.mat = <span class="prelude-val">Some</span>(HalfMatch::new(pattern, state.at + <span class="number">1</span>));
                cache.search_finish(state.at);
                <span class="kw">return </span><span class="prelude-val">Ok</span>(());
            } <span class="kw">else if </span>sid.is_dead() {
                cache.search_finish(state.at);
        ...
        <span class="kw">if </span>state.at == input.start() {
            <span class="kw">break</span>;
        }
        state.at -= <span class="number">1</span>;
        cache.search_update(state.at);
    ...
    <span class="kw">let </span>result = eoi_rev(dfa, cache, input, <span class="kw-2">&amp;mut </span>sid, <span class="kw-2">&amp;mut </span>state.mat);
    state.rev_eoi = <span class="bool-val">true</span>;
    state.id = <span class="prelude-val">Some</span>(sid);
    <span class="kw">if </span>state.mat.is_some() {
        <span class="comment">// '1' is always correct here since if we get to this point, this
...
<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>init_fwd(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;LazyStateID, MatchError&gt; {
    <span class="kw">let </span>sid = dfa.start_state_forward(cache, input)<span class="question-mark">?</span>;
    <span class="comment">// Start states can never be match states, since all matches are delayed
    // by 1 byte.
    </span><span class="macro">debug_assert!</span>(!sid.is_match());
    <span class="prelude-val">Ok</span>(sid)
}

<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>init_rev(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;LazyStateID, MatchError&gt; {
    <span class="kw">let </span>sid = dfa.start_state_reverse(cache, input)<span class="question-mark">?</span>;
    <span class="comment">// Start states can never be match states, since all matches are delayed
    // by 1 byte.
    </span><span class="macro">debug_assert!</span>(!sid.is_match());
    <span class="prelude-val">Ok</span>(sid)
...
<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>eoi_fwd(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    sid: <span class="kw-2">&amp;mut </span>LazyStateID,
    ...
    <span class="kw">match </span>input.haystack().get(sp.end) {
        <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>b) =&gt; {
            <span class="kw-2">*</span>sid =
                dfa.next_state(cache, <span class="kw-2">*</span>sid, b).map_err(|<span class="kw">_</span>| gave_up(sp.end))<span class="question-mark">?</span>;
        ...
        <span class="prelude-val">None </span>=&gt; {
            <span class="kw-2">*</span>sid = dfa
                ...
                .map_err(|<span class="kw">_</span>| gave_up(input.haystack().len()))<span class="question-mark">?</span>;
            <span class="kw">if </span>sid.is_match() {
                <span class="kw">let </span>pattern = dfa.match_pattern(cache, <span class="kw-2">*</span>sid, <span class="number">0</span>);
...
<span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>eoi_rev(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    sid: <span class="kw-2">&amp;mut </span>LazyStateID,
    ...
    <span class="kw">if </span>sp.start &gt; <span class="number">0 </span>{
        ...
        <span class="kw-2">*</span>sid = dfa
            ...
            .map_err(|<span class="kw">_</span>| gave_up(sp.start))<span class="question-mark">?</span>;
        <span class="kw">if </span>sid.is_match() {
            <span class="kw">let </span>pattern = dfa.match_pattern(cache, <span class="kw-2">*</span>sid, <span class="number">0</span>);
        ...
        <span class="kw-2">*</span>sid =
            dfa.next_eoi_state(cache, <span class="kw-2">*</span>sid).map_err(|<span class="kw">_</span>| gave_up(sp.start))<span class="question-mark">?</span>;
        <span class="kw">if </span>sid.is_match() {
            <span class="kw">let </span>pattern = dfa.match_pattern(cache, <span class="kw-2">*</span>sid, <span class="number">0</span>);
...
<span class="doccomment">/// Re-compute the starting state that a DFA should be in after finding a
...
/// just state in the current state if you know it to be correct.
...
</span><span class="kw">fn </span>prefilter_restart(
    dfa: <span class="kw-2">&amp;</span>DFA,
    cache: <span class="kw-2">&amp;mut </span>Cache,
    input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
    at: usize,
    ...
    input.set_start(at);
    init_fwd(dfa, cache, <span class="kw-2">&amp;</span>input)
}

<span class="doccomment">/// A convenience routine for constructing a "gave up" match error.
</span><span class="attr">#[cfg_attr(feature = <span class="string">"perf-inline"</span>, inline(always))]
</span><span class="kw">fn </span>gave_up(offset: usize) -&gt; MatchError {
