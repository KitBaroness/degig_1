<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/hybrid/regex.rs`."><title>regex.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
*/
    ...
    hybrid::{
        dfa::{<span class="self">self</span>, DFA},
        error::BuildError,
    },
    nfa::thompson,
    util::{
...
<span class="doccomment">/// A regular expression that uses hybrid NFA/DFAs (also called "lazy DFAs")
/// for searching.
///
...
/// ```
    ...
    <span class="doccomment">/// The forward lazy DFA. This can only find the end of a match.
    </span>forward: DFA,
    <span class="doccomment">/// The reverse lazy DFA. This can only find the start of a match.
    ///
...
<span class="doccomment">/// Convenience routines for regex and cache construction.
    ...
    /// ```
        ...
        <span class="self">self</span>.forward().reset_cache(<span class="kw-2">&amp;mut </span>cache.forward);
        <span class="self">self</span>.reverse().reset_cache(<span class="kw-2">&amp;mut </span>cache.reverse);
    }
}

<span class="doccomment">/// Standard infallible search routines for finding and iterating over matches.
</span><span class="kw">impl </span>Regex {
    ...
    /// ```
        ...
        <span class="comment">// Not only can we do an "earliest" search, but we can avoid doing a
        // reverse scan too.
        </span><span class="self">self</span>.forward()
            .try_search_fwd(<span class="kw-2">&amp;mut </span>cache.forward, <span class="kw-2">&amp;</span>input.into().earliest(<span class="bool-val">true</span>))
            .unwrap()
            .is_some()
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.try_search(cache, <span class="kw-2">&amp;</span>input.into()).unwrap()
    }
...
<span class="doccomment">/// Lower level "search" primitives that accept a `&amp;Input` for cheap reuse
/// and return an error if one occurs instead of panicking.
    ...
    /// exists or not.
        ...
        <span class="kw">let </span>(fcache, rcache) = (<span class="kw-2">&amp;mut </span>cache.forward, <span class="kw-2">&amp;mut </span>cache.reverse);
        <span class="kw">let </span>end = <span class="kw">match </span><span class="self">self</span>.forward().try_search_fwd(fcache, input)<span class="question-mark">? </span>{
        ...
        <span class="comment">// This special cases an empty match at the beginning of the search. If
        ...
        </span><span class="kw">if </span>input.start() == end.offset() {
            <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(Match::new(
                end.pattern(),
                end.offset()..end.offset(),
            )));
        }
        <span class="comment">// We can also skip the reverse search if we know our search was
        ...
        // search.
        </span><span class="kw">if </span><span class="self">self</span>.is_anchored(input) {
            <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(Match::new(
                end.pattern(),
                input.start()..end.offset(),
            )));
        }
        <span class="comment">// N.B. I have tentatively convinced myself that it isn't necessary
        ...
        </span><span class="kw">let </span>revsearch = input
            .clone()
        ...
        <span class="kw">let </span>start = <span class="self">self
            ...
            .try_search_rev(rcache, <span class="kw-2">&amp;</span>revsearch)<span class="question-mark">?
            </span>.expect(<span class="string">"reverse search must match if forward search does"</span>);
        <span class="macro">debug_assert_eq!</span>(
            start.pattern(),
            end.pattern(),
            <span class="string">"forward and reverse search must match same pattern"</span>,
        );
        <span class="macro">debug_assert!</span>(start.offset() &lt;= end.offset());
        <span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(Match::new(end.pattern(), start.offset()..end.offset())))
    }

    <span class="doccomment">/// Returns true if either the given input specifies an anchored search
    /// or if the underlying NFA is always anchored.
    </span><span class="kw">fn </span>is_anchored(<span class="kw-2">&amp;</span><span class="self">self</span>, input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool {
        <span class="kw">match </span>input.get_anchored() {
            Anchored::No =&gt; {
                <span class="self">self</span>.forward().get_nfa().is_always_start_anchored()
            }
            Anchored::Yes | Anchored::Pattern(<span class="kw">_</span>) =&gt; <span class="bool-val">true</span>,
        }
    }
}

<span class="doccomment">/// Non-search APIs for querying information about the regex and setting a
/// prefilter.
</span><span class="kw">impl </span>Regex {
    <span class="doccomment">/// Return the underlying lazy DFA responsible for forward matching.
    ///
    /// This is useful for accessing the underlying lazy DFA and using it
    /// directly if the situation calls for it.
    </span><span class="kw">pub fn </span>forward(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>DFA {
        <span class="kw-2">&amp;</span><span class="self">self</span>.forward
    }

    <span class="doccomment">/// Return the underlying lazy DFA responsible for reverse matching.
    ///
    /// This is useful for accessing the underlying lazy DFA and using it
    /// directly if the situation calls for it.
    </span><span class="kw">pub fn </span>reverse(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>DFA {
        <span class="kw-2">&amp;</span><span class="self">self</span>.reverse
    }

    <span class="doccomment">/// Returns the total number of patterns matched by this regex.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="macro">assert_eq!</span>(<span class="self">self</span>.forward().pattern_len(), <span class="self">self</span>.reverse().pattern_len());
        <span class="self">self</span>.forward().pattern_len()
    }
}
...
<span class="doccomment">/// A cache represents a partially computed forward and reverse DFA.
///
...
<span class="kw">impl </span>Cache {
    <span class="doccomment">/// Create a new cache for the given `Regex`.
    ///
    ...
    /// must call [`Cache::reset`] with that `Regex`.
        ...
        <span class="kw">let </span>forward = dfa::Cache::new(re.forward());
        <span class="kw">let </span>reverse = dfa::Cache::new(re.reverse());
    ...
    /// ```
        ...
        <span class="self">self</span>.forward.reset(re.forward());
        <span class="self">self</span>.reverse.reset(re.reverse());
    }

    <span class="doccomment">/// Return a reference to the forward cache.
    </span><span class="kw">pub fn </span>forward(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>dfa::Cache {
        <span class="kw-2">&amp;</span><span class="self">self</span>.forward
    }

    <span class="doccomment">/// Return a reference to the reverse cache.
    </span><span class="kw">pub fn </span>reverse(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>dfa::Cache {
        <span class="kw-2">&amp;</span><span class="self">self</span>.reverse
    }

    <span class="doccomment">/// Return a mutable reference to the forward cache.
    ///
    /// If you need mutable references to both the forward and reverse caches,
    /// then use [`Cache::as_parts_mut`].
    </span><span class="kw">pub fn </span>forward_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>dfa::Cache {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>.forward
    }

    <span class="doccomment">/// Return a mutable reference to the reverse cache.
    ///
    /// If you need mutable references to both the forward and reverse caches,
    /// then use [`Cache::as_parts_mut`].
    </span><span class="kw">pub fn </span>reverse_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>dfa::Cache {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>.reverse
    }

    <span class="doccomment">/// Return references to the forward and reverse caches, respectively.
    </span><span class="kw">pub fn </span>as_parts(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (<span class="kw-2">&amp;</span>dfa::Cache, <span class="kw-2">&amp;</span>dfa::Cache) {
        (<span class="kw-2">&amp;</span><span class="self">self</span>.forward, <span class="kw-2">&amp;</span><span class="self">self</span>.reverse)
    }

    <span class="doccomment">/// Return mutable references to the forward and reverse caches,
    /// respectively.
    </span><span class="kw">pub fn </span>as_parts_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; (<span class="kw-2">&amp;mut </span>dfa::Cache, <span class="kw-2">&amp;mut </span>dfa::Cache) {
        (<span class="kw-2">&amp;mut </span><span class="self">self</span>.forward, <span class="kw-2">&amp;mut </span><span class="self">self</span>.reverse)
    }

    <span class="doccomment">/// Returns the heap memory usage, in bytes, as a sum of the forward and
    ...
    /// compute that, use `std::mem::size_of::&lt;Cache&gt;()`.
        ...
        <span class="self">self</span>.forward.memory_usage() + <span class="self">self</span>.reverse.memory_usage()
    }
}

<span class="doccomment">/// A builder for a regex based on a hybrid NFA/DFA.
///
...
<span class="kw">impl </span>Builder {
    <span class="doccomment">/// Create a new regex builder with the default configuration.
    </span><span class="kw">pub fn </span>new() -&gt; Builder {
        Builder { dfa: DFA::builder() }
    }

    <span class="doccomment">/// Build a regex from the given pattern.
    ///
    ...
    <span class="doccomment">/// Build a regex from the given patterns.
    </span><span class="attr">#[cfg(feature = <span class="string">"syntax"</span>)]
    </span><span class="kw">pub fn </span>build_many&lt;P: AsRef&lt;str&gt;&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        patterns: <span class="kw-2">&amp;</span>[P],
    ) -&gt; <span class="prelude-ty">Result</span>&lt;Regex, BuildError&gt; {
        <span class="kw">let </span>forward = <span class="self">self</span>.dfa.build_many(patterns)<span class="question-mark">?</span>;
        <span class="kw">let </span>reverse = <span class="self">self
            </span>.dfa
            .clone()
            .configure(
                DFA::config()
        ...
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.build_from_dfas(forward, reverse))
    }

    <span class="doccomment">/// Build a regex from its component forward and reverse hybrid NFA/DFAs.
    ///
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>build_from_dfas(<span class="kw-2">&amp;</span><span class="self">self</span>, forward: DFA, reverse: DFA) -&gt; Regex {
    ...
    /// line mode.
        ...
        <span class="self">self</span>.dfa.syntax(config);
    ...
    /// spent shrinking the size of the NFA.
        ...
        <span class="self">self</span>.dfa.thompson(config);
        <span class="self">self
    </span>}

    <span class="doccomment">/// Set the lazy DFA compilation configuration for this builder using
    /// [`dfa::Config`].
    ///
    ...
    </span><span class="kw">pub fn </span>dfa(<span class="kw-2">&amp;mut </span><span class="self">self</span>, config: dfa::Config) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.dfa.configure(config);
        <span class="self">self
    </span>}
}
