<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/dfa/remapper.rs`."><title>remapper.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
/// DFAs are partitioned.
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">trait </span>Remappable: core::fmt::Debug {
    ...
    <span class="doccomment">/// Return the power-of-2 exponent that yields the stride. The pertinent
...
/// will almost certainly result in a corrupt machine.
...
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">struct </span>Remapper {
    ...
    <span class="doccomment">/// A mapper from state index to state ID (and back).
    </span>idxmap: IndexMapper,
}
...
<span class="kw">impl </span>Remapper {
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(r: <span class="kw-2">&amp;</span><span class="kw">impl </span>Remappable) -&gt; Remapper {
        <span class="kw">let </span>idxmap = IndexMapper { stride2: r.stride2() };
        <span class="kw">let </span>map = (<span class="number">0</span>..r.state_len()).map(|i| idxmap.to_state_id(i)).collect();
        Remapper { map, idxmap }
    }
    ...
    /// value to be in a corrupt state.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>swap(
        ...
        <span class="self">self</span>.map.swap(<span class="self">self</span>.idxmap.to_index(id1), <span class="self">self</span>.idxmap.to_index(id2));
    }
    ...
    /// remappable value according to the swaps performed.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>remap(<span class="kw-2">mut </span><span class="self">self</span>, r: <span class="kw-2">&amp;mut </span><span class="kw">impl </span>Remappable) {
        ...
        <span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..r.state_len() {
            <span class="kw">let </span>cur_id = <span class="self">self</span>.idxmap.to_state_id(i);
            <span class="kw">let </span><span class="kw-2">mut </span>new_id = oldmap[i];
            <span class="kw">if </span>cur_id == new_id {
                <span class="kw">continue</span>;
            }
            <span class="kw">loop </span>{
                <span class="kw">let </span>id = oldmap[<span class="self">self</span>.idxmap.to_index(new_id)];
        ...
        r.remap(|next| <span class="self">self</span>.map[<span class="self">self</span>.idxmap.to_index(next)]);
    }
}
...
<span class="attr">#[cfg(feature = <span class="string">"dfa-build"</span>)]
    ...
    <span class="kw">use crate</span>::{dfa::dense::OwnedDFA, util::primitives::StateID};

    <span class="kw">use </span><span class="kw">super</span>::Remappable;

    <span class="kw">impl </span>Remappable <span class="kw">for </span>OwnedDFA {
        <span class="kw">fn </span>state_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
            OwnedDFA::state_len(<span class="self">self</span>)
        }

        <span class="kw">fn </span>stride2(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
            OwnedDFA::stride2(<span class="self">self</span>)
        }

        <span class="kw">fn </span>swap_states(<span class="kw-2">&amp;mut </span><span class="self">self</span>, id1: StateID, id2: StateID) {
            OwnedDFA::swap_states(<span class="self">self</span>, id1, id2)
        }
        ...
        <span class="kw">fn </span>remap(<span class="kw-2">&amp;mut </span><span class="self">self</span>, map: <span class="kw">impl </span>Fn(StateID) -&gt; StateID) {
            OwnedDFA::remap(<span class="self">self</span>, map)
        }
    }
}

<span class="attr">#[cfg(feature = <span class="string">"dfa-onepass"</span>)]
</span><span class="kw">mod </span>onepass {
    <span class="kw">use crate</span>::{dfa::onepass::DFA, util::primitives::StateID};

    <span class="kw">use </span><span class="kw">super</span>::Remappable;

    <span class="kw">impl </span>Remappable <span class="kw">for </span>DFA {
        <span class="kw">fn </span>state_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
            DFA::state_len(<span class="self">self</span>)
        }

        <span class="kw">fn </span>stride2(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
            <span class="comment">// We don't do pre-multiplication for the one-pass DFA, so
        ...
        <span class="kw">fn </span>swap_states(<span class="kw-2">&amp;mut </span><span class="self">self</span>, id1: StateID, id2: StateID) {
            DFA::swap_states(<span class="self">self</span>, id1, id2)
        }

        <span class="kw">fn </span>remap(<span class="kw-2">&amp;mut </span><span class="self">self</span>, map: <span class="kw">impl </span>Fn(StateID) -&gt; StateID) {
            DFA::remap(<span class="self">self</span>, map)
        }
    }
}
