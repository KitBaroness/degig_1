<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/regex-automata-0.4.6/src/dfa/onepass.rs`."><title>onepass.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../../" data-static-root-path="../../../static.files/" data-current-crate="regex_automata" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../../src-files.js"></script><script defer src="../../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../../regex_automata/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="comment">// A note on naming and credit:
//
...
<span class="kw">use crate</span>::{
    ...
    nfa::thompson::{<span class="self">self</span>, NFA},
    util::{
...
<span class="doccomment">/// The configuration used for building a [one-pass DFA](DFA).
///
...
/// perhaps more conveniently, with [`DFA::config`].
    ...
    match_kind: <span class="prelude-ty">Option</span>&lt;MatchKind&gt;,
    starts_for_each_pattern: <span class="prelude-ty">Option</span>&lt;bool&gt;,
    byte_classes: <span class="prelude-ty">Option</span>&lt;bool&gt;,
    size_limit: <span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Option</span>&lt;usize&gt;&gt;,
}

<span class="kw">impl </span>Config {
    <span class="doccomment">/// Return a new default one-pass DFA configuration.
    ...
    <span class="doccomment">/// Whether to attempt to shrink the size of the DFA's alphabet or not.
    ///
    ...
    <span class="doccomment">/// Set a size limit on the total heap used by a one-pass DFA.
    ///
    ...
    </span><span class="kw">pub fn </span>size_limit(<span class="kw-2">mut </span><span class="self">self</span>, limit: <span class="prelude-ty">Option</span>&lt;usize&gt;) -&gt; Config {
        <span class="self">self</span>.size_limit = <span class="prelude-val">Some</span>(limit);
        <span class="self">self
    </span>}
    ...
    <span class="doccomment">/// Returns the DFA size limit of this configuration if one was set.
    ...
    </span><span class="kw">pub fn </span>get_size_limit(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="self">self</span>.size_limit.unwrap_or(<span class="prelude-val">None</span>)
    }
    ...
    /// remains not set.
        ...
        Config {
            ...
            size_limit: o.size_limit.or(<span class="self">self</span>.size_limit),
        }
    }
}

<span class="doccomment">/// A builder for a [one-pass DFA](DFA).
///
...
<span class="kw">impl </span>Builder {
    <span class="doccomment">/// Create a new one-pass DFA builder with the default configuration.
    ...
    <span class="doccomment">/// Build a one-pass DFA from the given pattern.
    ///
    ...
    <span class="doccomment">/// Build a one-pass DFA from the given patterns.
    ///
    ...
    /// the pattern in the slice given.
        ...
        <span class="kw">let </span>nfa =
            <span class="self">self</span>.thompson.build_many(patterns).map_err(BuildError::nfa)<span class="question-mark">?</span>;
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>build_from_nfa(<span class="kw-2">&amp;</span><span class="self">self</span>, nfa: NFA) -&gt; <span class="prelude-ty">Result</span>&lt;DFA, BuildError&gt; {
        <span class="comment">// Why take ownership if we're just going to pass a reference to the
        ...
        </span>InternalBuilder::new(<span class="self">self</span>.config.clone(), <span class="kw-2">&amp;</span>nfa).build()
    }

    <span class="doccomment">/// Apply the given one-pass DFA configuration options to this builder.
...
<span class="doccomment">/// An internal builder for encapsulating the state necessary to build a
...
/// because the duplication is cheap.
...
</span><span class="kw">struct </span>InternalBuilder&lt;<span class="lifetime">'a</span>&gt; {
    <span class="doccomment">/// The DFA we're building.
    </span>dfa: DFA,
    <span class="doccomment">/// An unordered collection of NFA state IDs that we haven't yet tried to
    ...
    /// transitions.
    </span>uncompiled_nfa_ids: Vec&lt;StateID&gt;,
    <span class="doccomment">/// A map from NFA state ID to DFA state ID. This is useful for easily
    ...
    </span>nfa_to_dfa_id: Vec&lt;StateID&gt;,
    <span class="doccomment">/// A stack used to traverse the NFA states that make up a single DFA
    ...
    </span>stack: Vec&lt;(StateID, Epsilons)&gt;,
    <span class="doccomment">/// The set of NFA states that we've visited via 'stack'.
    </span>seen: SparseSet,
    <span class="doccomment">/// Whether a match NFA state has been observed while constructing a
    ...
    <span class="doccomment">/// The config passed to the builder.
    ///
    /// This is duplicated in dfa.config.
    </span>config: Config,
    <span class="doccomment">/// The NFA we're building a one-pass DFA from.
    ///
    /// This is duplicated in dfa.nfa.
    </span>nfa: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>NFA,
    <span class="doccomment">/// The equivalence classes that make up the alphabet for this DFA&gt;
    ///
    /// This is duplicated in dfa.classes.
    </span>classes: ByteClasses,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; InternalBuilder&lt;<span class="lifetime">'a</span>&gt; {
    <span class="doccomment">/// Create a new builder with an initial empty DFA.
    </span><span class="kw">fn </span>new(config: Config, nfa: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>NFA) -&gt; InternalBuilder {
        <span class="kw">let </span>classes = <span class="kw">if </span>!config.get_byte_classes() {
            <span class="comment">// A one-pass DFA will always use the equivalence class map, but
        ...
        <span class="comment">// Normally a DFA alphabet includes the EOI symbol, but we don't need
        ...
        </span><span class="kw">let </span>alphabet_len = classes.alphabet_len().checked_sub(<span class="number">1</span>).unwrap();
        <span class="kw">let </span>stride2 = classes.stride2();
        <span class="kw">let </span>dfa = DFA {
            config: config.clone(),
            nfa: nfa.clone(),
            table: <span class="macro">vec!</span>[],
            starts: <span class="macro">vec!</span>[],
            <span class="comment">// Since one-pass DFAs have a smaller state ID max than
            ...
            </span>min_match_id: StateID::MAX,
            classes: classes.clone(),
            alphabet_len,
            stride2,
            pateps_offset: alphabet_len,
            <span class="comment">// OK because PatternID::MAX*2 is guaranteed not to overflow.
            </span>explicit_slot_start: nfa.pattern_len().checked_mul(<span class="number">2</span>).unwrap(),
        };
        InternalBuilder {
            dfa,
            uncompiled_nfa_ids: <span class="macro">vec!</span>[],
            nfa_to_dfa_id: <span class="macro">vec!</span>[DEAD; nfa.states().len()],
            stack: <span class="macro">vec!</span>[],
            seen: SparseSet::new(nfa.states().len()),
            matched: <span class="bool-val">false</span>,
            config,
            nfa,
            classes,
        }
    ...
    <span class="doccomment">/// Build the DFA from the NFA given to this builder. If the NFA is not
    ...
    /// hard-coded based on representational limitations.)
    </span><span class="kw">fn </span>build(<span class="kw-2">mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;DFA, BuildError&gt; {
        <span class="self">self</span>.nfa.look_set_any().available().map_err(BuildError::word)<span class="question-mark">?</span>;
        <span class="kw">for </span>look <span class="kw">in </span><span class="self">self</span>.nfa.look_set_any().iter() {
            <span class="comment">// This is a future incompatibility check where if we add any
            ...
            // new assertions.
            </span><span class="kw">if </span>look.as_repr() &gt; Look::WordUnicodeNegate.as_repr() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::unsupported_look(look));
            }
        }
        <span class="kw">if </span><span class="self">self</span>.nfa.pattern_len().as_u64() &gt; PatternEpsilons::PATTERN_ID_LIMIT
        {
            <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::too_many_patterns(
                PatternEpsilons::PATTERN_ID_LIMIT,
            ));
        }
        <span class="kw">if </span><span class="self">self</span>.nfa.group_info().explicit_slot_len() &gt; Slots::LIMIT {
            <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::not_one_pass(
                <span class="string">"too many explicit capturing groups (max is 16)"</span>,
            ));
        }
        <span class="macro">assert_eq!</span>(DEAD, <span class="self">self</span>.add_empty_state()<span class="question-mark">?</span>);

        <span class="comment">// This is where the explicit slots start. We care about this because
        ...
        </span><span class="kw">let </span>explicit_slot_start = <span class="self">self</span>.nfa.pattern_len() * <span class="number">2</span>;
        <span class="self">self</span>.add_start_state(<span class="prelude-val">None</span>, <span class="self">self</span>.nfa.start_anchored())<span class="question-mark">?</span>;
        <span class="kw">if </span><span class="self">self</span>.config.get_starts_for_each_pattern() {
            <span class="kw">for </span>pid <span class="kw">in </span><span class="self">self</span>.nfa.patterns() {
                <span class="self">self</span>.add_start_state(
                    <span class="prelude-val">Some</span>(pid),
                    <span class="self">self</span>.nfa.start_pattern(pid).unwrap(),
                )<span class="question-mark">?</span>;
            }
        }
        <span class="comment">// NOTE: One wonders what the effects of treating 'uncompiled_nfa_ids'
        ...
        // the somewhat common case of a regex that isn't one-pass.
        </span><span class="kw">while let </span><span class="prelude-val">Some</span>(nfa_id) = <span class="self">self</span>.uncompiled_nfa_ids.pop() {
            <span class="kw">let </span>dfa_id = <span class="self">self</span>.nfa_to_dfa_id[nfa_id];
            <span class="comment">// Once we see a match, we keep going, but don't add any new
            // transitions. Normally we'd just stop, but we have to keep
            // going in order to verify that our regex is actually one-pass.
            </span><span class="self">self</span>.matched = <span class="bool-val">false</span>;
            <span class="comment">// The NFA states we've already explored for this DFA state.
            </span><span class="self">self</span>.seen.clear();
            <span class="comment">// The NFA states to explore via epsilon transitions. If we ever
            ...
            </span><span class="self">self</span>.stack_push(nfa_id, Epsilons::empty())<span class="question-mark">?</span>;
            <span class="kw">while let </span><span class="prelude-val">Some</span>((id, epsilons)) = <span class="self">self</span>.stack.pop() {
                <span class="kw">match </span><span class="kw-2">*</span><span class="self">self</span>.nfa.state(id) {
                    thompson::State::ByteRange { <span class="kw-2">ref </span>trans } =&gt; {
                        <span class="self">self</span>.compile_transition(dfa_id, trans, epsilons)<span class="question-mark">?</span>;
                    }
                    ...
                    thompson::State::Dense(<span class="kw-2">ref </span>dense) =&gt; {
                        <span class="kw">for </span>trans <span class="kw">in </span>dense.iter() {
                            <span class="self">self</span>.compile_transition(dfa_id, <span class="kw-2">&amp;</span>trans, epsilons)<span class="question-mark">?</span>;
                        }
                    }
                    thompson::State::Look { look, next } =&gt; {
                        <span class="kw">let </span>looks = epsilons.looks().insert(look);
                        <span class="self">self</span>.stack_push(next, epsilons.set_looks(looks))<span class="question-mark">?</span>;
                    }
                    thompson::State::Union { <span class="kw-2">ref </span>alternates } =&gt; {
                        <span class="kw">for </span><span class="kw-2">&amp;</span>sid <span class="kw">in </span>alternates.iter().rev() {
                            <span class="self">self</span>.stack_push(sid, epsilons)<span class="question-mark">?</span>;
                        }
                    }
                    thompson::State::BinaryUnion { alt1, alt2 } =&gt; {
                        <span class="self">self</span>.stack_push(alt2, epsilons)<span class="question-mark">?</span>;
                        <span class="self">self</span>.stack_push(alt1, epsilons)<span class="question-mark">?</span>;
                    }
                    thompson::State::Capture { next, slot, .. } =&gt; {
                        <span class="kw">let </span>slot = slot.as_usize();
                        <span class="kw">let </span>epsilons = <span class="kw">if </span>slot &lt; explicit_slot_start {
                            <span class="comment">// If this is an implicit slot, we don't care
                            ...
                            <span class="comment">// Offset our explicit slots so that they start
                            // at index 0.
                            </span><span class="kw">let </span>offset = slot - explicit_slot_start;
                            epsilons.set_slots(epsilons.slots().insert(offset))
                        };
                        <span class="self">self</span>.stack_push(next, epsilons)<span class="question-mark">?</span>;
                    }
                    thompson::State::Fail =&gt; {
                        <span class="kw">continue</span>;
                    }
                    thompson::State::Match { pattern_id } =&gt; {
                        <span class="comment">// If we found two different paths to a match state
                        // for the same DFA state, then we have ambiguity.
                        // Thus, it's not one-pass.
                        </span><span class="kw">if </span><span class="self">self</span>.matched {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::not_one_pass(
                                <span class="string">"multiple epsilon transitions to match state"</span>,
                            ));
                        }
                        <span class="self">self</span>.matched = <span class="bool-val">true</span>;
                        <span class="comment">// Shove the matching pattern ID and the 'epsilons'
                        ...
                        // report a match.
                        </span><span class="self">self</span>.dfa.set_pattern_epsilons(
                            dfa_id,
                            PatternEpsilons::empty()
                                .set_pattern_id(pattern_id)
                                .set_epsilons(epsilons),
                        );
                        <span class="comment">// N.B. It is tempting to just bail out here when
        ...
        <span class="self">self</span>.shuffle_states();
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.dfa)
    }

    <span class="doccomment">/// Shuffle all match states to the end of the transition table and set
    ...
    </span><span class="kw">fn </span>shuffle_states(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw">let </span><span class="kw-2">mut </span>remapper = Remapper::new(<span class="kw-2">&amp;</span><span class="self">self</span>.dfa);
        <span class="kw">let </span><span class="kw-2">mut </span>next_dest = <span class="self">self</span>.dfa.last_state_id();
        <span class="kw">for </span>i <span class="kw">in </span>(<span class="number">0</span>..<span class="self">self</span>.dfa.state_len()).rev() {
            <span class="kw">let </span>id = StateID::must(i);
            <span class="kw">let </span>is_match =
                <span class="self">self</span>.dfa.pattern_epsilons(id).pattern_id().is_some();
            <span class="kw">if </span>!is_match {
                <span class="kw">continue</span>;
            }
            remapper.swap(<span class="kw-2">&amp;mut </span><span class="self">self</span>.dfa, next_dest, id);
            <span class="self">self</span>.dfa.min_match_id = next_dest;
            next_dest = <span class="self">self</span>.dfa.prev_state_id(next_dest).expect(
                <span class="string">"match states should be a proper subset of all states"</span>,
            );
        }
        remapper.remap(<span class="kw-2">&amp;mut </span><span class="self">self</span>.dfa);
    }

    <span class="doccomment">/// Compile the given NFA transition into the DFA state given.
    ///
    ...
    /// different.)
    </span><span class="kw">fn </span>compile_transition(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        dfa_id: StateID,
        trans: <span class="kw-2">&amp;</span>thompson::Transition,
        epsilons: Epsilons,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;(), BuildError&gt; {
        <span class="kw">let </span>next_dfa_id = <span class="self">self</span>.add_dfa_state_for_nfa_state(trans.next)<span class="question-mark">?</span>;
        ...
        {
            <span class="kw">let </span>oldtrans = <span class="self">self</span>.dfa.transition(dfa_id, byte);
            <span class="kw">let </span>newtrans =
                Transition::new(<span class="self">self</span>.matched, next_dfa_id, epsilons);
            <span class="comment">// If the old transition points to the DEAD state, then we know
            ...
            </span><span class="kw">if </span>oldtrans.state_id() == DEAD {
                <span class="self">self</span>.dfa.set_transition(dfa_id, byte, newtrans);
            } <span class="kw">else if </span>oldtrans != newtrans {
                <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::not_one_pass(
                    <span class="string">"conflicting transition"</span>,
                ));
            }
        }
    ...
    <span class="doccomment">/// Add a start state to the DFA corresponding to the given NFA starting
    /// state ID.
    ///
    ...
    </span><span class="kw">fn </span>add_start_state(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        pid: <span class="prelude-ty">Option</span>&lt;PatternID&gt;,
        nfa_id: StateID,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;StateID, BuildError&gt; {
        <span class="kw">match </span>pid {
            <span class="comment">// With no pid, this should be the start state for all patterns
            // and thus be the first one.
            </span><span class="prelude-val">None </span>=&gt; <span class="macro">assert!</span>(<span class="self">self</span>.dfa.starts.is_empty()),
            <span class="comment">// With a pid, we want it to be at self.dfa.starts[pid+1].
            </span><span class="prelude-val">Some</span>(pid) =&gt; <span class="macro">assert!</span>(<span class="self">self</span>.dfa.starts.len() == pid.one_more()),
        }
        <span class="kw">let </span>dfa_id = <span class="self">self</span>.add_dfa_state_for_nfa_state(nfa_id)<span class="question-mark">?</span>;
        <span class="self">self</span>.dfa.starts.push(dfa_id);
        <span class="prelude-val">Ok</span>(dfa_id)
    }

    <span class="doccomment">/// Add a new DFA state corresponding to the given NFA state. If adding a
    ...
    /// sub-graph of NFA states is ultimately what produces a single DFA state.
    </span><span class="kw">fn </span>add_dfa_state_for_nfa_state(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        nfa_id: StateID,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;StateID, BuildError&gt; {
        <span class="comment">// If we've already built a DFA state for the given NFA state, then
        ...
        </span><span class="kw">let </span>existing_dfa_id = <span class="self">self</span>.nfa_to_dfa_id[nfa_id];
        <span class="kw">if </span>existing_dfa_id != DEAD {
            <span class="kw">return </span><span class="prelude-val">Ok</span>(existing_dfa_id);
        }
        <span class="comment">// If we don't have any DFA state yet, add it and then add the given
        // NFA state to the list of states to explore.
        </span><span class="kw">let </span>dfa_id = <span class="self">self</span>.add_empty_state()<span class="question-mark">?</span>;
        <span class="self">self</span>.nfa_to_dfa_id[nfa_id] = dfa_id;
        <span class="self">self</span>.uncompiled_nfa_ids.push(nfa_id);
        <span class="prelude-val">Ok</span>(dfa_id)
    }

    <span class="doccomment">/// Unconditionally add a new empty DFA state. If adding it would exceed
    ...
    /// The added state is *not* a match state.
    </span><span class="kw">fn </span>add_empty_state(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;StateID, BuildError&gt; {
        <span class="kw">let </span>state_limit = Transition::STATE_ID_LIMIT;
        <span class="comment">// Note that unlike dense and lazy DFAs, we specifically do NOT
        ...
        </span><span class="kw">let </span>next_id = <span class="self">self</span>.dfa.table.len() &gt;&gt; <span class="self">self</span>.dfa.stride2();
        <span class="kw">let </span>id = StateID::new(next_id)
            .map_err(|<span class="kw">_</span>| BuildError::too_many_states(state_limit))<span class="question-mark">?</span>;
        <span class="kw">if </span>id.as_u64() &gt; Transition::STATE_ID_LIMIT {
            <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::too_many_states(state_limit));
        }
        <span class="self">self</span>.dfa
            .table
            .extend(core::iter::repeat(Transition(<span class="number">0</span>)).take(<span class="self">self</span>.dfa.stride()));
        <span class="comment">// The default empty value for 'PatternEpsilons' is sadly not all
        ...
        </span><span class="self">self</span>.dfa.set_pattern_epsilons(id, PatternEpsilons::empty());
        <span class="kw">if let </span><span class="prelude-val">Some</span>(size_limit) = <span class="self">self</span>.config.get_size_limit() {
            <span class="kw">if </span><span class="self">self</span>.dfa.memory_usage() &gt; size_limit {
                <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::exceeded_size_limit(size_limit));
            }
        }
        <span class="prelude-val">Ok</span>(id)
    }

    <span class="doccomment">/// Push the given NFA state ID and its corresponding epsilons (slots and
    ...
    /// an error.
    </span><span class="kw">fn </span>stack_push(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        nfa_id: StateID,
        epsilons: Epsilons,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;(), BuildError&gt; {
        <span class="comment">// If we already have seen a match and we are compiling a leftmost
        ...
        // return Ok(());
        // }
        </span><span class="kw">if </span>!<span class="self">self</span>.seen.insert(nfa_id) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(BuildError::not_one_pass(
                <span class="string">"multiple epsilon transitions to same state"</span>,
            ));
        }
        <span class="self">self</span>.stack.push((nfa_id, epsilons));
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="doccomment">/// A one-pass DFA for executing a subset of anchored regex searches while
...
/// ```
    ...
    <span class="doccomment">/// The configuration provided by the caller.
    </span>config: Config,
    <span class="doccomment">/// The NFA used to build this DFA.
    ///
    /// NOTE: We probably don't need to store the NFA here, but we use enough
    /// bits from it that it's convenient to do so. And there really isn't much
    /// cost to doing so either, since an NFA is reference counted internally.
    </span>nfa: NFA,
    <span class="doccomment">/// The transition table. Given a state ID 's' and a byte of haystack 'b',
    ...
    </span>table: Vec&lt;Transition&gt;,
    <span class="doccomment">/// The DFA state IDs of the starting states.
    ///
    ...
    </span>starts: Vec&lt;StateID&gt;,
    <span class="doccomment">/// Every state ID &gt;= this value corresponds to a match state.
    ///
    /// This is what a search uses to detect whether a state is a match state
    /// or not. It requires only a simple comparison instead of bit-unpacking
    /// the PatternEpsilons from every state.
    </span>min_match_id: StateID,
    <span class="doccomment">/// The alphabet of this DFA, split into equivalence classes. Bytes in the
    /// same equivalence class can never discriminate between a match and a
    /// non-match.
    </span>classes: ByteClasses,
    <span class="doccomment">/// The number of elements in each state in the transition table. This may
    /// be less than the stride, since the stride is always a power of 2 and
    /// the alphabet length can be anything up to and including 256.
    </span>alphabet_len: usize,
    <span class="doccomment">/// The number of columns in the transition table, expressed as a power of
    /// 2.
    </span>stride2: usize,
    <span class="doccomment">/// The offset at which the PatternEpsilons for a match state is stored in
    ...
    /// experimenting.
    </span>pateps_offset: usize,
    <span class="doccomment">/// The first explicit slot index. This refers to the first slot appearing
    ...
    </span>explicit_slot_start: usize,
}
...
<span class="kw">impl </span>DFA {
    ...
    <span class="doccomment">/// Like `new`, but builds a one-pass DFA directly from an NFA. This is
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>new_from_nfa(nfa: NFA) -&gt; <span class="prelude-ty">Result</span>&lt;DFA, BuildError&gt; {
        DFA::builder().build_from_nfa(nfa)
    }

    <span class="doccomment">/// Create a new one-pass DFA that matches every input.
    ///
    /// # Example
    ///
    /// ```
    ...
    <span class="doccomment">/// Create a new one-pass DFA that never matches any input.
    ///
    /// # Example
    ///
    /// ```
    ...
    <span class="doccomment">/// Return a builder for configuring the construction of a DFA.
    ///
    ...
    /// thus might make it faster.
        ...
        Captures::all(<span class="self">self</span>.nfa.group_info().clone())
    }

    <span class="doccomment">/// Create a new cache for this DFA.
    ///
    ...
    <span class="doccomment">/// Return the config for this one-pass DFA.
    </span><span class="attr">#[inline]
    ...
    <span class="doccomment">/// Returns the total number of patterns compiled into this DFA.
    ///
    /// In the case of a DFA that contains no patterns, this returns `0`.
        ...
        <span class="self">self</span>.get_nfa().pattern_len()
    }

    <span class="doccomment">/// Returns the total number of states in this one-pass DFA.
    ///
    ...
    </span><span class="kw">pub fn </span>state_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.table.len() &gt;&gt; <span class="self">self</span>.stride2()
    }

    <span class="doccomment">/// Returns the total number of elements in the alphabet for this DFA.
    ///
    ...
    <span class="doccomment">/// Returns the total stride for every state in this DFA, expressed as the
    ...
    <span class="doccomment">/// Returns the total stride for every state in this DFA. This corresponds
    ...
    <span class="doccomment">/// Returns the memory usage, in bytes, of this DFA.
    ///
    ...
    /// compute that, use `std::mem::size_of::&lt;onepass::DFA&gt;()`.
        ...
        <span class="self">self</span>.table.len() * size_of::&lt;Transition&gt;()
            + <span class="self">self</span>.starts.len() * size_of::&lt;StateID&gt;()
    }
}

<span class="kw">impl </span>DFA {
    <span class="doccomment">/// Executes an anchored leftmost forward search, and returns true if and
    ...
    </span><span class="kw">pub fn </span>is_match&lt;<span class="lifetime">'h</span>, I: Into&lt;Input&lt;<span class="lifetime">'h</span>&gt;&gt;&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        cache: <span class="kw-2">&amp;mut </span>Cache,
        input: I,
    ) -&gt; bool {
        <span class="kw">let </span><span class="kw-2">mut </span>input = input.into().earliest(<span class="bool-val">true</span>);
        <span class="kw">if </span><span class="macro">matches!</span>(input.get_anchored(), Anchored::No) {
            input.set_anchored(Anchored::Yes);
        }
        <span class="self">self</span>.try_search_slots(cache, <span class="kw-2">&amp;</span>input, <span class="kw-2">&amp;mut </span>[]).unwrap().is_some()
    }

    <span class="doccomment">/// Executes an anchored leftmost forward search, and returns a `Match` if
    ...
    /// ```
    ...
    </span><span class="kw">pub fn </span>find&lt;<span class="lifetime">'h</span>, I: Into&lt;Input&lt;<span class="lifetime">'h</span>&gt;&gt;&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        cache: <span class="kw-2">&amp;mut </span>Cache,
        input: I,
    ) -&gt; <span class="prelude-ty">Option</span>&lt;Match&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>input = input.into();
        <span class="kw">if </span><span class="macro">matches!</span>(input.get_anchored(), Anchored::No) {
            input.set_anchored(Anchored::Yes);
        }
        <span class="kw">if </span><span class="self">self</span>.get_nfa().pattern_len() == <span class="number">1 </span>{
            ...
            <span class="kw">let </span>pid =
                <span class="self">self</span>.try_search_slots(cache, <span class="kw-2">&amp;</span>input, <span class="kw-2">&amp;mut </span>slots).unwrap()<span class="question-mark">?</span>;
            <span class="kw">let </span>start = slots[<span class="number">0</span>].unwrap().get();
            <span class="kw">let </span>end = slots[<span class="number">1</span>].unwrap().get();
            <span class="kw">return </span><span class="prelude-val">Some</span>(Match::new(pid, Span { start, end }));
        }
        ...
        <span class="kw">let </span>pid = <span class="self">self</span>.try_search_slots(cache, <span class="kw-2">&amp;</span>input, <span class="kw-2">&amp;mut </span>slots).unwrap()<span class="question-mark">?</span>;
        <span class="kw">let </span>start = slots[pid.as_usize() * <span class="number">2</span>].unwrap().get();
        <span class="kw">let </span>end = slots[pid.as_usize() * <span class="number">2 </span>+ <span class="number">1</span>].unwrap().get();
        <span class="prelude-val">Some</span>(Match::new(pid, Span { start, end }))
    }

    <span class="doccomment">/// Executes an anchored leftmost forward search and writes the spans
    ...
    /// ```
        ...
        <span class="self">self</span>.try_search(cache, <span class="kw-2">&amp;</span>input, caps).unwrap();
    }
    ...
    /// ```
        ...
        <span class="kw">if </span>!utf8empty {
            <span class="kw">return </span><span class="self">self</span>.try_search_slots_imp(cache, input, slots);
        }
        ...
        <span class="kw">if </span><span class="self">self</span>.get_nfa().pattern_len() == <span class="number">1 </span>{
            ...
            <span class="kw">return </span><span class="prelude-val">Ok</span>(got);
        }
        ...
        <span class="prelude-val">Ok</span>(got)
    }
    ...
    <span class="attr">#[inline(never)]
        ...
        <span class="kw">let </span>utf8empty = <span class="self">self</span>.get_nfa().has_empty() &amp;&amp; <span class="self">self</span>.get_nfa().is_utf8();
        <span class="kw">match </span><span class="self">self</span>.search_imp(cache, input, slots)<span class="question-mark">? </span>{
            ...
            <span class="prelude-val">Some</span>(pid) <span class="kw">if </span>!utf8empty =&gt; <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(pid)),
            <span class="prelude-val">Some</span>(pid) =&gt; {
                <span class="comment">// These slot indices are always correct because we know our
                // 'pid' is valid and thus we know that the slot indices for it
                // are valid.
                </span><span class="kw">let </span>slot_start = pid.as_usize().wrapping_mul(<span class="number">2</span>);
                <span class="kw">let </span>slot_end = slot_start.wrapping_add(<span class="number">1</span>);
                <span class="comment">// OK because we know we have a match and we know our caller
                ...
                // pattern.
                </span><span class="kw">let </span>start = slots[slot_start].unwrap().get();
                <span class="kw">let </span>end = slots[slot_end].unwrap().get();
                <span class="comment">// If our match splits a codepoint, then we cannot report is
                ...
                </span><span class="kw">if </span>start == end &amp;&amp; !input.is_char_boundary(start) {
                    <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">None</span>);
                }
                <span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(pid))
            }
        }
    }
}
...
<span class="kw">impl </span>DFA {
    <span class="kw">fn </span>search_imp(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        cache: <span class="kw-2">&amp;mut </span>Cache,
        input: <span class="kw-2">&amp;</span>Input&lt;<span class="lifetime">'_</span>&gt;,
        slots: <span class="kw-2">&amp;mut </span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;],
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;PatternID&gt;, MatchError&gt; {
        <span class="comment">// PERF: Some ideas. I ran out of steam after my initial impl to try
        // many of these.
        //
        ...
        </span><span class="kw">if </span>input.is_done() {
            <span class="kw">return </span><span class="prelude-val">Ok</span>(<span class="prelude-val">None</span>);
        }
        <span class="comment">// We unfortunately have a bit of book-keeping to do to set things
        ...
        </span><span class="kw">let </span>explicit_slots_len = core::cmp::min(
            Slots::LIMIT,
            slots.len().saturating_sub(<span class="self">self</span>.explicit_slot_start),
        );
        cache.setup_search(explicit_slots_len);
        <span class="kw">for </span>slot <span class="kw">in </span>cache.explicit_slots() {
        ...
        <span class="comment">// We set the starting slots for every pattern up front. This does
        ...
        </span><span class="kw">for </span>pid <span class="kw">in </span><span class="self">self</span>.nfa.patterns() {
            <span class="kw">let </span>i = pid.as_usize() * <span class="number">2</span>;
            <span class="kw">if </span>i &gt;= slots.len() {
                <span class="kw">break</span>;
            }
            slots[i] = NonMaxUsize::new(input.start());
        }
        <span class="kw">let </span><span class="kw-2">mut </span>pid = <span class="prelude-val">None</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>next_sid = <span class="kw">match </span>input.get_anchored() {
            Anchored::Yes =&gt; <span class="self">self</span>.start(),
            Anchored::Pattern(pid) =&gt; <span class="self">self</span>.start_pattern(pid)<span class="question-mark">?</span>,
            Anchored::No =&gt; {
                <span class="comment">// If the regex is itself always anchored, then we're fine,
                // even if the search is configured to be unanchored.
                </span><span class="kw">if </span>!<span class="self">self</span>.nfa.is_always_start_anchored() {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(MatchError::unsupported_anchored(
                        Anchored::No,
                    ));
                }
        ...
        <span class="kw">let </span>leftmost_first =
            <span class="macro">matches!</span>(<span class="self">self</span>.config.get_match_kind(), MatchKind::LeftmostFirst);
        <span class="kw">for </span>at <span class="kw">in </span>input.start()..input.end() {
            <span class="kw">let </span>sid = next_sid;
            <span class="kw">let </span>trans = <span class="self">self</span>.transition(sid, input.haystack()[at]);
            next_sid = trans.state_id();
            <span class="kw">let </span>epsilons = trans.epsilons();
            <span class="kw">if </span>sid &gt;= <span class="self">self</span>.min_match_id {
                <span class="kw">if </span><span class="self">self</span>.find_match(cache, input, at, sid, slots, <span class="kw-2">&amp;mut </span>pid) {
            ...
            <span class="kw">if </span>sid == DEAD
                || (!epsilons.looks().is_empty()
                    &amp;&amp; !<span class="self">self</span>.nfa.look_matcher().matches_set_inline(
                        epsilons.looks(),
                        input.haystack(),
                        at,
                    ))
        ...
        <span class="kw">if </span>next_sid &gt;= <span class="self">self</span>.min_match_id {
            <span class="self">self</span>.find_match(
                cache,
                input,
                input.end(),
                next_sid,
                slots,
                <span class="kw-2">&amp;mut </span>pid,
            );
        }
        <span class="prelude-val">Ok</span>(pid)
    }

    <span class="doccomment">/// Assumes 'sid' is a match state and looks for whether a match can
    ...
    /// the haystack.
        ...
        sid: StateID,
        slots: <span class="kw-2">&amp;mut </span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;],
        matched_pid: <span class="kw-2">&amp;mut </span><span class="prelude-ty">Option</span>&lt;PatternID&gt;,
    ) -&gt; bool {
        <span class="macro">debug_assert!</span>(sid &gt;= <span class="self">self</span>.min_match_id);
        <span class="kw">let </span>pateps = <span class="self">self</span>.pattern_epsilons(sid);
        <span class="kw">let </span>epsilons = pateps.epsilons();
        <span class="kw">if </span>!epsilons.looks().is_empty()
            &amp;&amp; !<span class="self">self</span>.nfa.look_matcher().matches_set_inline(
                epsilons.looks(),
                input.haystack(),
                at,
        ...
        <span class="kw">let </span>pid = pateps.pattern_id_unchecked();
        <span class="comment">// This calculation is always correct because we know our 'pid' is
        // valid and thus we know that the slot indices for it are valid.
        </span><span class="kw">let </span>slot_end = pid.as_usize().wrapping_mul(<span class="number">2</span>).wrapping_add(<span class="number">1</span>);
        <span class="comment">// Set the implicit 'end' slot for the matching pattern. (The 'start'
        // slot was set at the beginning of the search.)
        </span><span class="kw">if </span>slot_end &lt; slots.len() {
            slots[slot_end] = NonMaxUsize::new(at);
        }
        <span class="comment">// If the caller provided enough room, copy the previously recorded
        ...
        </span><span class="kw">if </span><span class="self">self</span>.explicit_slot_start &lt; slots.len() {
            <span class="comment">// NOTE: The 'cache.explicit_slots()' slice is setup at the
            // beginning of every search such that it is guaranteed to return a
            // slice of length equivalent to 'slots[explicit_slot_start..]'.
            </span>slots[<span class="self">self</span>.explicit_slot_start..]
                .copy_from_slice(cache.explicit_slots());
            epsilons.slots().apply(at, <span class="kw-2">&amp;mut </span>slots[<span class="self">self</span>.explicit_slot_start..]);
        }
        <span class="kw-2">*</span>matched_pid = <span class="prelude-val">Some</span>(pid);
        <span class="bool-val">true
    </span>}
}

<span class="kw">impl </span>DFA {
    <span class="doccomment">/// Returns the anchored start state for matching any pattern in this DFA.
    </span><span class="kw">fn </span>start(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; StateID {
        <span class="self">self</span>.starts[<span class="number">0</span>]
    }

    <span class="doccomment">/// Returns the anchored start state for matching the given pattern. If
    /// 'starts_for_each_pattern'
    /// was not enabled, then this returns an error. If the given pattern is
    /// not in this DFA, then `Ok(None)` is returned.
    </span><span class="kw">fn </span>start_pattern(<span class="kw-2">&amp;</span><span class="self">self</span>, pid: PatternID) -&gt; <span class="prelude-ty">Result</span>&lt;StateID, MatchError&gt; {
        <span class="kw">if </span>!<span class="self">self</span>.config.get_starts_for_each_pattern() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(MatchError::unsupported_anchored(Anchored::Pattern(
                pid,
            )));
        }
        <span class="comment">// 'starts' always has non-zero length. The first entry is always the
        ...
        // be zero.)
        </span><span class="prelude-val">Ok</span>(<span class="self">self</span>.starts.get(pid.one_more()).copied().unwrap_or(DEAD))
    }

    <span class="doccomment">/// Returns the transition from the given state ID and byte of input. The
    ...
    </span><span class="kw">fn </span>transition(<span class="kw-2">&amp;</span><span class="self">self</span>, sid: StateID, byte: u8) -&gt; Transition {
        <span class="kw">let </span>offset = sid.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="kw">let </span>class = <span class="self">self</span>.classes.get(byte).as_usize();
        <span class="self">self</span>.table[offset + class]
    }

    <span class="doccomment">/// Set the transition from the given state ID and byte of input to the
    /// transition given.
    </span><span class="kw">fn </span>set_transition(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sid: StateID, byte: u8, to: Transition) {
        <span class="kw">let </span>offset = sid.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="kw">let </span>class = <span class="self">self</span>.classes.get(byte).as_usize();
        <span class="self">self</span>.table[offset + class] = to;
    }

    <span class="doccomment">/// Return an iterator of "sparse" transitions for the given state ID.
    ...
    </span><span class="kw">fn </span>sparse_transitions(<span class="kw-2">&amp;</span><span class="self">self</span>, sid: StateID) -&gt; SparseTransitionIter&lt;<span class="lifetime">'_</span>&gt; {
        <span class="kw">let </span>start = sid.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="kw">let </span>end = start + <span class="self">self</span>.alphabet_len();
        SparseTransitionIter {
            it: <span class="self">self</span>.table[start..end].iter().enumerate(),
            cur: <span class="prelude-val">None</span>,
        }
    }

    <span class="doccomment">/// Return the pattern epsilons for the given state ID.
    ///
    /// If the given state ID does not correspond to a match state ID, then the
    /// pattern epsilons returned is empty.
    </span><span class="kw">fn </span>pattern_epsilons(<span class="kw-2">&amp;</span><span class="self">self</span>, sid: StateID) -&gt; PatternEpsilons {
        <span class="kw">let </span>offset = sid.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        PatternEpsilons(<span class="self">self</span>.table[offset + <span class="self">self</span>.pateps_offset].<span class="number">0</span>)
    }

    <span class="doccomment">/// Set the pattern epsilons for the given state ID.
    </span><span class="kw">fn </span>set_pattern_epsilons(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sid: StateID, pateps: PatternEpsilons) {
        <span class="kw">let </span>offset = sid.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="self">self</span>.table[offset + <span class="self">self</span>.pateps_offset] = Transition(pateps.<span class="number">0</span>);
    }

    <span class="doccomment">/// Returns the state ID prior to the one given. This returns None if the
    /// given ID is the first DFA state.
    </span><span class="kw">fn </span>prev_state_id(<span class="kw-2">&amp;</span><span class="self">self</span>, id: StateID) -&gt; <span class="prelude-ty">Option</span>&lt;StateID&gt; {
        <span class="kw">if </span>id == DEAD {
            <span class="prelude-val">None
        </span>} <span class="kw">else </span>{
            <span class="comment">// CORRECTNESS: Since 'id' is not the first state, subtracting 1
            // is always valid.
            </span><span class="prelude-val">Some</span>(StateID::new_unchecked(id.as_usize().checked_sub(<span class="number">1</span>).unwrap()))
        }
    }

    <span class="doccomment">/// Returns the state ID of the last state in this DFA's transition table.
    /// "last" in this context means the last state to appear in memory, i.e.,
    /// the one with the greatest ID.
    </span><span class="kw">fn </span>last_state_id(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; StateID {
        <span class="comment">// CORRECTNESS: A DFA table is always non-empty since it always at
        ...
        </span>StateID::new_unchecked(
            (<span class="self">self</span>.table.len() &gt;&gt; <span class="self">self</span>.stride2()).checked_sub(<span class="number">1</span>).unwrap(),
        )
    }

    <span class="doccomment">/// Move the transitions from 'id1' to 'id2' and vice versa.
    ///
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>swap_states(<span class="kw-2">&amp;mut </span><span class="self">self</span>, id1: StateID, id2: StateID) {
        <span class="kw">let </span>o1 = id1.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="kw">let </span>o2 = id2.as_usize() &lt;&lt; <span class="self">self</span>.stride2();
        <span class="kw">for </span>b <span class="kw">in </span><span class="number">0</span>..<span class="self">self</span>.stride() {
            <span class="self">self</span>.table.swap(o1 + b, o2 + b);
        }
    }

    <span class="doccomment">/// Map all state IDs in this DFA (transition table + start states)
    /// according to the closure given.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>remap(<span class="kw-2">&amp;mut </span><span class="self">self</span>, map: <span class="kw">impl </span>Fn(StateID) -&gt; StateID) {
        <span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..<span class="self">self</span>.state_len() {
            <span class="kw">let </span>offset = i &lt;&lt; <span class="self">self</span>.stride2();
            <span class="kw">for </span>b <span class="kw">in </span><span class="number">0</span>..<span class="self">self</span>.alphabet_len() {
                <span class="kw">let </span>next = <span class="self">self</span>.table[offset + b].state_id();
                <span class="self">self</span>.table[offset + b].set_state_id(map(next));
            }
        }
        <span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..<span class="self">self</span>.starts.len() {
            <span class="self">self</span>.starts[i] = map(<span class="self">self</span>.starts[i]);
        }
    }
}
...
<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>DFA {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="kw">fn </span>debug_state_transitions(
            f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter,
            dfa: <span class="kw-2">&amp;</span>DFA,
            sid: StateID,
        ) -&gt; core::fmt::Result {
            <span class="kw">for </span>(i, (start, end, trans)) <span class="kw">in
                </span>dfa.sparse_transitions(sid).enumerate()
            {
                <span class="kw">let </span>next = trans.state_id();
                ...
                <span class="kw">if </span>trans.match_wins() {
                    <span class="macro">write!</span>(f, <span class="string">" (MW)"</span>)<span class="question-mark">?</span>;
                }
                <span class="kw">if </span>!trans.epsilons().is_empty() {
                    <span class="macro">write!</span>(f, <span class="string">" ({:?})"</span>, trans.epsilons())<span class="question-mark">?</span>;
                }
            }
            <span class="prelude-val">Ok</span>(())
        }

        <span class="macro">writeln!</span>(f, <span class="string">"onepass::DFA("</span>)<span class="question-mark">?</span>;
        <span class="kw">for </span>index <span class="kw">in </span><span class="number">0</span>..<span class="self">self</span>.state_len() {
            <span class="kw">let </span>sid = StateID::must(index);
            <span class="kw">let </span>pateps = <span class="self">self</span>.pattern_epsilons(sid);
            <span class="kw">if </span>sid == DEAD {
                <span class="macro">write!</span>(f, <span class="string">"D "</span>)<span class="question-mark">?</span>;
            } <span class="kw">else if </span>pateps.pattern_id().is_some() {
                <span class="macro">write!</span>(f, <span class="string">"* "</span>)<span class="question-mark">?</span>;
            } <span class="kw">else </span>{
                <span class="macro">write!</span>(f, <span class="string">"  "</span>)<span class="question-mark">?</span>;
            }
            <span class="macro">write!</span>(f, <span class="string">"{:06?}"</span>, sid.as_usize())<span class="question-mark">?</span>;
            <span class="kw">if </span>!pateps.is_empty() {
                <span class="macro">write!</span>(f, <span class="string">" ({:?})"</span>, pateps)<span class="question-mark">?</span>;
            }
            <span class="macro">write!</span>(f, <span class="string">": "</span>)<span class="question-mark">?</span>;
            debug_state_transitions(f, <span class="self">self</span>, sid)<span class="question-mark">?</span>;
        ...
        <span class="kw">for </span>(i, <span class="kw-2">&amp;</span>sid) <span class="kw">in </span><span class="self">self</span>.starts.iter().enumerate() {
            <span class="kw">if </span>i == <span class="number">0 </span>{
                <span class="macro">writeln!</span>(f, <span class="string">"START(ALL): {:?}"</span>, sid.as_usize())<span class="question-mark">?</span>;
            } <span class="kw">else </span>{
                <span class="macro">writeln!</span>(
                    f,
                    <span class="string">"START(pattern: {:?}): {:?}"</span>,
        ...
        <span class="macro">writeln!</span>(f, <span class="string">"pattern length: {:?}"</span>, <span class="self">self</span>.pattern_len())<span class="question-mark">?</span>;
        <span class="macro">writeln!</span>(f, <span class="string">")"</span>)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="doccomment">/// An iterator over groups of consecutive equivalent transitions in a single
/// state.
</span><span class="attr">#[derive(Debug)]
</span><span class="kw">struct </span>SparseTransitionIter&lt;<span class="lifetime">'a</span>&gt; {
    it: core::iter::Enumerate&lt;core::slice::Iter&lt;<span class="lifetime">'a</span>, Transition&gt;&gt;,
    cur: <span class="prelude-ty">Option</span>&lt;(u8, u8, Transition)&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>SparseTransitionIter&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">type </span>Item = (u8, u8, Transition);

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;(u8, u8, Transition)&gt; {
        <span class="kw">while let </span><span class="prelude-val">Some</span>((b, <span class="kw-2">&amp;</span>trans)) = <span class="self">self</span>.it.next() {
            <span class="comment">// Fine because we'll never have more than u8::MAX transitions in
            // one state.
            </span><span class="kw">let </span>b = b.as_u8();
            <span class="kw">let </span>(prev_start, prev_end, prev_trans) = <span class="kw">match </span><span class="self">self</span>.cur {
                <span class="prelude-val">Some</span>(t) =&gt; t,
                <span class="prelude-val">None </span>=&gt; {
                    <span class="self">self</span>.cur = <span class="prelude-val">Some</span>((b, b, trans));
                    <span class="kw">continue</span>;
                }
            };
            <span class="kw">if </span>prev_trans == trans {
                <span class="self">self</span>.cur = <span class="prelude-val">Some</span>((prev_start, b, prev_trans));
            } <span class="kw">else </span>{
                <span class="self">self</span>.cur = <span class="prelude-val">Some</span>((b, b, trans));
                <span class="kw">if </span>prev_trans.state_id() != DEAD {
                    <span class="kw">return </span><span class="prelude-val">Some</span>((prev_start, prev_end, prev_trans));
                }
            }
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>((start, end, trans)) = <span class="self">self</span>.cur.take() {
            <span class="kw">if </span>trans.state_id() != DEAD {
                <span class="kw">return </span><span class="prelude-val">Some</span>((start, end, trans));
            }
        }
        <span class="prelude-val">None
    </span>}
...
<span class="doccomment">/// A cache represents mutable state that a one-pass [`DFA`] requires during a
/// search.
///
...
/// only be used with the new one-pass DFA (and not the old one).
    ...
    <span class="doccomment">/// Scratch space used to store slots during a search. Basically, we use
    ...
    </span>explicit_slots: Vec&lt;<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;&gt;,
    <span class="doccomment">/// The number of slots in the caller-provided 'Captures' value for the
    ...
    </span>explicit_slot_len: usize,
}

<span class="kw">impl </span>Cache {
    <span class="doccomment">/// Create a new [`onepass::DFA`](DFA) cache.
    ///
    ...
    </span><span class="kw">pub fn </span>new(re: <span class="kw-2">&amp;</span>DFA) -&gt; Cache {
        <span class="kw">let </span><span class="kw-2">mut </span>cache = Cache { explicit_slots: <span class="macro">vec!</span>[], explicit_slot_len: <span class="number">0 </span>};
        cache.reset(re);
        cache
    }

    <span class="doccomment">/// Reset this cache such that it can be used for searching with a
    ...
    /// # Ok::&lt;(), Box&lt;dyn std::error::Error&gt;&gt;(())
    /// ```
    </span><span class="kw">pub fn </span>reset(<span class="kw-2">&amp;mut </span><span class="self">self</span>, re: <span class="kw-2">&amp;</span>DFA) {
        <span class="kw">let </span>explicit_slot_len = re.get_nfa().group_info().explicit_slot_len();
        <span class="self">self</span>.explicit_slots.resize(explicit_slot_len, <span class="prelude-val">None</span>);
        <span class="self">self</span>.explicit_slot_len = explicit_slot_len;
    }
    ...
    /// compute that, use `std::mem::size_of::&lt;Cache&gt;()`.
        ...
        <span class="self">self</span>.explicit_slots.len() * core::mem::size_of::&lt;<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;&gt;()
    }

    <span class="kw">fn </span>explicit_slots(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;] {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>.explicit_slots[..<span class="self">self</span>.explicit_slot_len]
    }

    <span class="kw">fn </span>setup_search(<span class="kw-2">&amp;mut </span><span class="self">self</span>, explicit_slot_len: usize) {
        <span class="self">self</span>.explicit_slot_len = explicit_slot_len;
    }
}

<span class="doccomment">/// Represents a single transition in a one-pass DFA.
///
...
</span><span class="attr">#[derive(Clone, Copy, Eq, PartialEq)]
</span><span class="kw">struct </span>Transition(u64);

<span class="kw">impl </span>Transition {
    <span class="kw">const </span>STATE_ID_BITS: u64 = <span class="number">21</span>;
    <span class="kw">const </span>STATE_ID_SHIFT: u64 = <span class="number">64 </span>- Transition::STATE_ID_BITS;
    <span class="kw">const </span>STATE_ID_LIMIT: u64 = <span class="number">1 </span>&lt;&lt; Transition::STATE_ID_BITS;
    <span class="kw">const </span>MATCH_WINS_SHIFT: u64 = <span class="number">64 </span>- (Transition::STATE_ID_BITS + <span class="number">1</span>);
    <span class="kw">const </span>INFO_MASK: u64 = <span class="number">0x000003FF_FFFFFFFF</span>;

    <span class="doccomment">/// Return a new transition to the given state ID with the given epsilons.
    </span><span class="kw">fn </span>new(match_wins: bool, sid: StateID, epsilons: Epsilons) -&gt; Transition {
        <span class="kw">let </span>match_wins =
            <span class="kw">if </span>match_wins { <span class="number">1 </span>&lt;&lt; Transition::MATCH_WINS_SHIFT } <span class="kw">else </span>{ <span class="number">0 </span>};
        <span class="kw">let </span>sid = sid.as_u64() &lt;&lt; Transition::STATE_ID_SHIFT;
        Transition(sid | match_wins | epsilons.<span class="number">0</span>)
    }

    <span class="doccomment">/// Returns true if and only if this transition points to the DEAD state.
    </span><span class="kw">fn </span>is_dead(<span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.state_id() == DEAD
    }

    <span class="doccomment">/// Return whether this transition has a "match wins" property.
    ///
    ...
    </span><span class="kw">fn </span>match_wins(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        (<span class="self">self</span>.<span class="number">0 </span>&gt;&gt; Transition::MATCH_WINS_SHIFT &amp; <span class="number">1</span>) == <span class="number">1
    </span>}

    <span class="doccomment">/// Return the "next" state ID that this transition points to.
    </span><span class="kw">fn </span>state_id(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; StateID {
        <span class="comment">// OK because a Transition has a valid StateID in its upper bits by
        ...
        // which can never overflow usize on any supported target.
            ...
            (<span class="self">self</span>.<span class="number">0 </span>&gt;&gt; Transition::STATE_ID_SHIFT).as_usize(),
        )
    }

    <span class="doccomment">/// Set the "next" state ID in this transition.
    </span><span class="kw">fn </span>set_state_id(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sid: StateID) {
        <span class="kw-2">*</span><span class="self">self </span>= Transition::new(<span class="self">self</span>.match_wins(), sid, <span class="self">self</span>.epsilons());
    }

    <span class="doccomment">/// Return the epsilons embedded in this transition.
    </span><span class="kw">fn </span>epsilons(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Epsilons {
        Epsilons(<span class="self">self</span>.<span class="number">0 </span>&amp; Transition::INFO_MASK)
    }
}

<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Transition {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="kw">if </span><span class="self">self</span>.is_dead() {
            <span class="kw">return </span><span class="macro">write!</span>(f, <span class="string">"0"</span>);
        }
        <span class="macro">write!</span>(f, <span class="string">"{}"</span>, <span class="self">self</span>.state_id().as_usize())<span class="question-mark">?</span>;
        <span class="kw">if </span><span class="self">self</span>.match_wins() {
            <span class="macro">write!</span>(f, <span class="string">"-MW"</span>)<span class="question-mark">?</span>;
        }
        <span class="kw">if </span>!<span class="self">self</span>.epsilons().is_empty() {
            <span class="macro">write!</span>(f, <span class="string">"-{:?}"</span>, <span class="self">self</span>.epsilons())<span class="question-mark">?</span>;
        }
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="doccomment">/// A representation of a match state's pattern ID along with the epsilons for
/// when a match occurs.
///
...
</span><span class="kw">struct </span>PatternEpsilons(u64);

<span class="kw">impl </span>PatternEpsilons {
    <span class="kw">const </span>PATTERN_ID_BITS: u64 = <span class="number">22</span>;
    <span class="kw">const </span>PATTERN_ID_SHIFT: u64 = <span class="number">64 </span>- PatternEpsilons::PATTERN_ID_BITS;
    <span class="comment">// A sentinel value indicating that this is not a match state. We don't
    // use 0 since 0 is a valid pattern ID.
    </span><span class="kw">const </span>PATTERN_ID_NONE: u64 = <span class="number">0x00000000_003FFFFF</span>;
    <span class="kw">const </span>PATTERN_ID_LIMIT: u64 = PatternEpsilons::PATTERN_ID_NONE;
    <span class="kw">const </span>PATTERN_ID_MASK: u64 = <span class="number">0xFFFFFC00_00000000</span>;
    <span class="kw">const </span>EPSILONS_MASK: u64 = <span class="number">0x000003FF_FFFFFFFF</span>;

    <span class="doccomment">/// Return a new empty pattern epsilons that has no pattern ID and has no
    /// epsilons. This is suitable for non-match states.
    </span><span class="kw">fn </span>empty() -&gt; PatternEpsilons {
        PatternEpsilons(
    ...
    <span class="doccomment">/// Whether this pattern epsilons is empty or not. It's empty when it has
    /// no pattern ID and an empty epsilons.
    </span><span class="kw">fn </span>is_empty(<span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.pattern_id().is_none() &amp;&amp; <span class="self">self</span>.epsilons().is_empty()
    }

    <span class="doccomment">/// Return the pattern ID in this pattern epsilons if one exists.
    </span><span class="kw">fn </span>pattern_id(<span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;PatternID&gt; {
        <span class="kw">let </span>pid = <span class="self">self</span>.<span class="number">0 </span>&gt;&gt; PatternEpsilons::PATTERN_ID_SHIFT;
        <span class="kw">if </span>pid == PatternEpsilons::PATTERN_ID_LIMIT {
            <span class="prelude-val">None
        </span>} <span class="kw">else </span>{
            <span class="prelude-val">Some</span>(PatternID::new_unchecked(pid.as_usize()))
        }
    }

    <span class="doccomment">/// Returns the pattern ID without checking whether it's valid. If this is
    ...
    </span><span class="kw">fn </span>pattern_id_unchecked(<span class="self">self</span>) -&gt; PatternID {
        <span class="kw">let </span>pid = <span class="self">self</span>.<span class="number">0 </span>&gt;&gt; PatternEpsilons::PATTERN_ID_SHIFT;
        PatternID::new_unchecked(pid.as_usize())
    }

    <span class="doccomment">/// Return a new pattern epsilons with the given pattern ID, but the same
    /// epsilons.
    </span><span class="kw">fn </span>set_pattern_id(<span class="self">self</span>, pid: PatternID) -&gt; PatternEpsilons {
        PatternEpsilons(
            (pid.as_u64() &lt;&lt; PatternEpsilons::PATTERN_ID_SHIFT)
                | (<span class="self">self</span>.<span class="number">0 </span>&amp; PatternEpsilons::EPSILONS_MASK),
        )
    }

    <span class="doccomment">/// Return the epsilons part of this pattern epsilons.
    </span><span class="kw">fn </span>epsilons(<span class="self">self</span>) -&gt; Epsilons {
        Epsilons(<span class="self">self</span>.<span class="number">0 </span>&amp; PatternEpsilons::EPSILONS_MASK)
    }

    <span class="doccomment">/// Return a new pattern epsilons with the given epsilons, but the same
    /// pattern ID.
    </span><span class="kw">fn </span>set_epsilons(<span class="self">self</span>, epsilons: Epsilons) -&gt; PatternEpsilons {
        PatternEpsilons(
            (<span class="self">self</span>.<span class="number">0 </span>&amp; PatternEpsilons::PATTERN_ID_MASK)
                | (u64::from(epsilons.<span class="number">0</span>) &amp; PatternEpsilons::EPSILONS_MASK),
        )
    }
}

<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>PatternEpsilons {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="kw">if </span><span class="self">self</span>.is_empty() {
            <span class="kw">return </span><span class="macro">write!</span>(f, <span class="string">"N/A"</span>);
        }
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pid) = <span class="self">self</span>.pattern_id() {
            <span class="macro">write!</span>(f, <span class="string">"{}"</span>, pid.as_usize())<span class="question-mark">?</span>;
        }
        <span class="kw">if </span>!<span class="self">self</span>.epsilons().is_empty() {
            <span class="kw">if </span><span class="self">self</span>.pattern_id().is_some() {
                <span class="macro">write!</span>(f, <span class="string">"/"</span>)<span class="question-mark">?</span>;
            }
            <span class="macro">write!</span>(f, <span class="string">"{:?}"</span>, <span class="self">self</span>.epsilons())<span class="question-mark">?</span>;
        }
...
<span class="doccomment">/// Epsilons represents all of the NFA epsilons transitions that went into a
...
</span><span class="kw">struct </span>Epsilons(u64);

<span class="kw">impl </span>Epsilons {
    <span class="kw">const </span>SLOT_MASK: u64 = <span class="number">0x000003FF_FFFFFC00</span>;
    <span class="kw">const </span>SLOT_SHIFT: u64 = <span class="number">10</span>;
    <span class="kw">const </span>LOOK_MASK: u64 = <span class="number">0x00000000_000003FF</span>;

    <span class="doccomment">/// Create a new empty epsilons. It has no slots and no assertions that
    /// need to be satisfied.
    </span><span class="kw">fn </span>empty() -&gt; Epsilons {
        Epsilons(<span class="number">0</span>)
    }

    <span class="doccomment">/// Returns true if this epsilons contains no slots and no assertions.
    </span><span class="kw">fn </span>is_empty(<span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.<span class="number">0 </span>== <span class="number">0
    </span>}

    <span class="doccomment">/// Returns the slot epsilon transitions.
    </span><span class="kw">fn </span>slots(<span class="self">self</span>) -&gt; Slots {
        Slots((<span class="self">self</span>.<span class="number">0 </span>&gt;&gt; Epsilons::SLOT_SHIFT).low_u32())
    }

    <span class="doccomment">/// Set the slot epsilon transitions.
    </span><span class="kw">fn </span>set_slots(<span class="self">self</span>, slots: Slots) -&gt; Epsilons {
        Epsilons(
            (u64::from(slots.<span class="number">0</span>) &lt;&lt; Epsilons::SLOT_SHIFT)
                | (<span class="self">self</span>.<span class="number">0 </span>&amp; Epsilons::LOOK_MASK),
        )
    }

    <span class="doccomment">/// Return the set of look-around assertions in these epsilon transitions.
    </span><span class="kw">fn </span>looks(<span class="self">self</span>) -&gt; LookSet {
        LookSet { bits: (<span class="self">self</span>.<span class="number">0 </span>&amp; Epsilons::LOOK_MASK).low_u32() }
    }

    <span class="doccomment">/// Set the look-around assertions on these epsilon transitions.
    </span><span class="kw">fn </span>set_looks(<span class="self">self</span>, look_set: LookSet) -&gt; Epsilons {
        Epsilons(
            (<span class="self">self</span>.<span class="number">0 </span>&amp; Epsilons::SLOT_MASK)
                | (u64::from(look_set.bits) &amp; Epsilons::LOOK_MASK),
        )
    }
}

<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Epsilons {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="kw">let </span><span class="kw-2">mut </span>wrote = <span class="bool-val">false</span>;
        <span class="kw">if </span>!<span class="self">self</span>.slots().is_empty() {
            <span class="macro">write!</span>(f, <span class="string">"{:?}"</span>, <span class="self">self</span>.slots())<span class="question-mark">?</span>;
            wrote = <span class="bool-val">true</span>;
        }
        <span class="kw">if </span>!<span class="self">self</span>.looks().is_empty() {
            <span class="kw">if </span>wrote {
                <span class="macro">write!</span>(f, <span class="string">"/"</span>)<span class="question-mark">?</span>;
            }
            <span class="macro">write!</span>(f, <span class="string">"{:?}"</span>, <span class="self">self</span>.looks())<span class="question-mark">?</span>;
            wrote = <span class="bool-val">true</span>;
        }
        <span class="kw">if </span>!wrote {
            <span class="macro">write!</span>(f, <span class="string">"N/A"</span>)<span class="question-mark">?</span>;
        }
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="doccomment">/// The set of epsilon transitions indicating that the current position in a
...
</span><span class="kw">struct </span>Slots(u32);

<span class="kw">impl </span>Slots {
    <span class="kw">const </span>LIMIT: usize = <span class="number">32</span>;

    <span class="doccomment">/// Insert the slot at the given bit index.
    </span><span class="kw">fn </span>insert(<span class="self">self</span>, slot: usize) -&gt; Slots {
        <span class="macro">debug_assert!</span>(slot &lt; Slots::LIMIT);
        Slots(<span class="self">self</span>.<span class="number">0 </span>| (<span class="number">1 </span>&lt;&lt; slot.as_u32()))
    }

    <span class="doccomment">/// Remove the slot at the given bit index.
    </span><span class="kw">fn </span>remove(<span class="self">self</span>, slot: usize) -&gt; Slots {
        <span class="macro">debug_assert!</span>(slot &lt; Slots::LIMIT);
        Slots(<span class="self">self</span>.<span class="number">0 </span>&amp; !(<span class="number">1 </span>&lt;&lt; slot.as_u32()))
    }

    <span class="doccomment">/// Returns true if and only if this set contains no slots.
    </span><span class="kw">fn </span>is_empty(<span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.<span class="number">0 </span>== <span class="number">0
    </span>}

    <span class="doccomment">/// Returns an iterator over all of the set bits in this set.
    </span><span class="kw">fn </span>iter(<span class="self">self</span>) -&gt; SlotsIter {
        SlotsIter { slots: <span class="self">self </span>}
    }

    <span class="doccomment">/// For the position `at` in the current haystack, copy it to
    ...
    </span><span class="kw">fn </span>apply(
        <span class="self">self</span>,
        at: usize,
        caller_explicit_slots: <span class="kw-2">&amp;mut </span>[<span class="prelude-ty">Option</span>&lt;NonMaxUsize&gt;],
    ) {
        <span class="kw">if </span><span class="self">self</span>.is_empty() {
            <span class="kw">return</span>;
        }
        <span class="kw">let </span>at = NonMaxUsize::new(at);
        <span class="kw">for </span>slot <span class="kw">in </span><span class="self">self</span>.iter() {
            <span class="kw">if </span>slot &gt;= caller_explicit_slots.len() {
                <span class="kw">break</span>;
            }
...
<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Slots {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        <span class="macro">write!</span>(f, <span class="string">"S"</span>)<span class="question-mark">?</span>;
        <span class="kw">for </span>slot <span class="kw">in </span><span class="self">self</span>.iter() {
            <span class="macro">write!</span>(f, <span class="string">"-{:?}"</span>, slot)<span class="question-mark">?</span>;
        }
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="doccomment">/// An iterator over all of the bits set in a slot set.
///
/// This returns the bit index that is set, so callers may need to offset it
/// to get the actual NFA slot index.
</span><span class="attr">#[derive(Debug)]
</span><span class="kw">struct </span>SlotsIter {
    slots: Slots,
}

<span class="kw">impl </span>Iterator <span class="kw">for </span>SlotsIter {
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="comment">// Number of zeroes here is always &lt;= u8::MAX, and so fits in a usize.
        </span><span class="kw">let </span>slot = <span class="self">self</span>.slots.<span class="number">0</span>.trailing_zeros().as_usize();
        <span class="kw">if </span>slot &gt;= Slots::LIMIT {
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
        <span class="self">self</span>.slots = <span class="self">self</span>.slots.remove(slot);
        <span class="prelude-val">Some</span>(slot)
    }
}

<span class="doccomment">/// An error that occurred during the construction of a one-pass DFA.
///
...
<span class="doccomment">/// The kind of error that occurred during the construction of a one-pass DFA.
</span><span class="attr">#[derive(Clone, Debug)]
</span><span class="kw">enum </span>BuildErrorKind {
    NFA(<span class="kw">crate</span>::nfa::thompson::BuildError),
    ...
    NotOnePass { msg: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str },
}

<span class="kw">impl </span>BuildError {
    <span class="kw">fn </span>nfa(err: <span class="kw">crate</span>::nfa::thompson::BuildError) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::NFA(err) }
    }

    <span class="kw">fn </span>word(err: UnicodeWordBoundaryError) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::Word(err) }
    }

    <span class="kw">fn </span>too_many_states(limit: u64) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::TooManyStates { limit } }
    }

    <span class="kw">fn </span>too_many_patterns(limit: u64) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::TooManyPatterns { limit } }
    }

    <span class="kw">fn </span>unsupported_look(look: Look) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::UnsupportedLook { look } }
    }

    <span class="kw">fn </span>exceeded_size_limit(limit: usize) -&gt; BuildError {
        BuildError { kind: BuildErrorKind::ExceededSizeLimit { limit } }
    }

    <span class="kw">fn </span>not_one_pass(msg: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str) -&gt; BuildError {
...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
    ...
    <span class="kw">fn </span>source(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>(<span class="kw">dyn </span>std::error::Error + <span class="lifetime">'static</span>)&gt; {
        <span class="kw">use </span><span class="self">self</span>::BuildErrorKind::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="self">self</span>.kind {
            NFA(<span class="kw-2">ref </span>err) =&gt; <span class="prelude-val">Some</span>(err),
            Word(<span class="kw-2">ref </span>err) =&gt; <span class="prelude-val">Some</span>(err),
...
<span class="kw">impl </span>core::fmt::Display <span class="kw">for </span>BuildError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        ...
        <span class="kw">match </span><span class="self">self</span>.kind {
            NFA(<span class="kw">_</span>) =&gt; <span class="macro">write!</span>(f, <span class="string">"error building NFA"</span>),
            Word(<span class="kw">_</span>) =&gt; <span class="macro">write!</span>(f, <span class="string">"NFA contains Unicode word boundary"</span>),
            TooManyStates { limit } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"one-pass DFA exceeded a limit of {:?} for number of states"</span>,
                limit,
            ),
            TooManyPatterns { limit } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"one-pass DFA exceeded a limit of {:?} for number of patterns"</span>,
                limit,
            ),
            UnsupportedLook { look } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"one-pass DFA does not support the {:?} assertion"</span>,
                look,
            ),
            ExceededSizeLimit { limit } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"one-pass DFA exceeded size limit of {:?} during building"</span>,
                limit,
            ),
            NotOnePass { msg } =&gt; <span class="macro">write!</span>(
                f,
                <span class="string">"one-pass DFA could not be built because \
                 pattern is not one-pass: {}"</span>,
                msg,
            ),
        }
    }
...
<span class="attr">#[cfg(all(test, feature = <span class="string">"syntax"</span>))]
    ...
    </span><span class="kw">fn </span>fail_conflicting_transition() {
        <span class="kw">let </span>predicate = |err: <span class="kw-2">&amp;</span>str| err.contains(<span class="string">"conflicting transition"</span>);

        <span class="kw">let </span>err = DFA::new(<span class="string">r"a*[ab]"</span>).unwrap_err().to_string();
        <span class="macro">assert!</span>(predicate(<span class="kw-2">&amp;</span>err), <span class="string">"{}"</span>, err);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>fail_multiple_epsilon() {
        <span class="kw">let </span>predicate = |err: <span class="kw-2">&amp;</span>str| {
            err.contains(<span class="string">"multiple epsilon transitions to same state"</span>)
        };

        <span class="kw">let </span>err = DFA::new(<span class="string">r"(^|$)a"</span>).unwrap_err().to_string();
        <span class="macro">assert!</span>(predicate(<span class="kw-2">&amp;</span>err), <span class="string">"{}"</span>, err);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>fail_multiple_match() {
        <span class="kw">let </span>predicate = |err: <span class="kw-2">&amp;</span>str| {
            err.contains(<span class="string">"multiple epsilon transitions to match state"</span>)
        };

        <span class="kw">let </span>err = DFA::new_many(<span class="kw-2">&amp;</span>[<span class="string">r"^"</span>, <span class="string">r"$"</span>]).unwrap_err().to_string();
        <span class="macro">assert!</span>(predicate(<span class="kw-2">&amp;</span>err), <span class="string">"{}"</span>, err);
    }

    <span class="comment">// This test is meant to build a one-pass regex with the maximum number of
    // possible slots.
    //
    ...
    </span><span class="kw">fn </span>max_slots() {
        <span class="comment">// One too many...
        </span><span class="kw">let </span>pat = <span class="string">r"(a)(b)(c)(d)(e)(f)(g)(h)(i)(j)(k)(l)(m)(n)(o)(p)(q)"</span>;
        <span class="macro">assert!</span>(DFA::new(pat).is_err());
        <span class="comment">// Just right.
        </span><span class="kw">let </span>pat = <span class="string">r"(a)(b)(c)(d)(e)(f)(g)(h)(i)(j)(k)(l)(m)(n)(o)(p)"</span>;
        <span class="macro">assert!</span>(DFA::new(pat).is_ok());
    }

    <span class="comment">// This test ensures that the one-pass DFA works with all look-around
    ...
    // expect them to work with.
        ...
        <span class="comment">// haystack anchors
        </span><span class="macro">assert!</span>(DFA::new(<span class="string">r"^"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"$"</span>).is_ok());

        <span class="comment">// line anchors
        </span><span class="macro">assert!</span>(DFA::new(<span class="string">r"(?m)^"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?m)$"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?Rm)^"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?Rm)$"</span>).is_ok());

        <span class="comment">// word boundaries
        </span><span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"unicode-word-boundary"</span>) {
            <span class="macro">assert!</span>(DFA::new(<span class="string">r"\b"</span>).is_ok());
            <span class="macro">assert!</span>(DFA::new(<span class="string">r"\B"</span>).is_ok());
        }
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?-u)\b"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?-u)\B"</span>).is_ok());
    }

    <span class="attr">#[cfg(not(miri))] </span><span class="comment">// takes too long on miri
    </span><span class="attr">#[test]
    </span><span class="kw">fn </span>is_one_pass() {
        <span class="kw">use </span><span class="kw">crate</span>::util::syntax;

        <span class="macro">assert!</span>(DFA::new(<span class="string">r"a*b"</span>).is_ok());
        <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"unicode-perl"</span>) {
            <span class="macro">assert!</span>(DFA::new(<span class="string">r"\w"</span>).is_ok());
        }
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?-u)\w*\s"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?s:.)*?"</span>).is_ok());
        <span class="macro">assert!</span>(DFA::builder()
            .syntax(syntax::Config::new().utf8(<span class="bool-val">false</span>))
            .build(<span class="string">r"(?s-u:.)*?"</span>)
            .is_ok());
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>is_not_one_pass() {
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"a*a"</span>).is_err());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?s-u:.)*?"</span>).is_err());
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"(?s:.)*?a"</span>).is_err());
    }

    <span class="attr">#[cfg(not(miri))]
    #[test]
    </span><span class="kw">fn </span>is_not_one_pass_bigger() {
        <span class="macro">assert!</span>(DFA::new(<span class="string">r"\w*\s"</span>).is_err());
    }
}
