...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::slice;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Bytes&lt;<span class="lifetime">'a</span>&gt; {
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.peek_ahead(<span class="number">0</span>)
    }

    <span class="attr">#[inline]
    </span><span class="kw">pub fn </span>peek_ahead(<span class="kw-2">&amp;</span><span class="self">self</span>, n: usize) -&gt; <span class="prelude-ty">Option</span>&lt;u8&gt; {
        <span class="self">self</span>.slice.get(<span class="self">self</span>.pos + n).copied()
    }

    <span class="attr">#[inline]
    </span><span class="kw">pub fn </span>peek_n&lt;U: TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a</span>[u8]&gt;&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, n: usize) -&gt; <span class="prelude-ty">Option</span>&lt;U&gt; {
        <span class="self">self</span>.slice.get(<span class="self">self</span>.pos..<span class="self">self</span>.pos + n)<span class="question-mark">?</span>.try_into().ok()
    }
    ...
    <span class="attr">#[inline]
    </span><span class="kw">pub unsafe fn </span>advance_and_commit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, n: usize) {
        <span class="macro">debug_assert!</span>(<span class="self">self</span>.pos + n &lt;= <span class="self">self</span>.slice.len(), <span class="string">"overflow"</span>);
        <span class="self">self</span>.pos += n;
        <span class="kw">let </span>ptr = <span class="self">self</span>.slice.as_ptr();
        <span class="kw">let </span>tail = slice::from_raw_parts(ptr.add(n), <span class="self">self</span>.slice.len() - n);
        <span class="self">self</span>.pos = <span class="number">0</span>;
        <span class="self">self</span>.slice = tail;
    }
}
