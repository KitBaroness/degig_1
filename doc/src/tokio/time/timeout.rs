...
</pre></div><pre class="rust"><code><span class="doccomment">//! Allows a future to execute for a maximum amount of time.
//!
...
</span><span class="kw">pub fn </span>timeout&lt;F&gt;(duration: Duration, future: F) -&gt; Timeout&lt;F&gt;
<span class="kw">where
    </span>F: Future,
{
...
/// # }
/// ```
</span><span class="kw">pub fn </span>timeout_at&lt;F&gt;(deadline: Instant, future: F) -&gt; Timeout&lt;F&gt;
<span class="kw">where
    </span>F: Future,
{
