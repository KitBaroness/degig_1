...
</pre></div><pre class="rust"><code><span class="attr">#![allow(clippy::trivially_copy_pass_by_ref)]
...
</span><span class="attr">#[derive(Clone, Copy, Eq, PartialEq, PartialOrd, Ord, Hash)]
...
<span class="kw">impl </span>ops::Sub&lt;Duration&gt; <span class="kw">for </span>Instant {
    ...
    <span class="kw">fn </span>sub(<span class="self">self</span>, rhs: Duration) -&gt; Instant {
        Instant::from_std(std::time::Instant::sub(<span class="self">self</span>.std, rhs))
    }
}
...
<span class="attr">#[cfg(not(feature = <span class="string">"test-util"</span>))]
