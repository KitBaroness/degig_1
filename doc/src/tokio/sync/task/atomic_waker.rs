...
</pre></div><pre class="rust"><code><span class="attr">#![cfg_attr(any(loom, not(feature = <span class="string">"sync"</span>)), allow(dead_code, unreachable_pub))]
