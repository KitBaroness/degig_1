...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::batch_semaphore <span class="kw">as </span>ll; <span class="comment">// low level implementation
</span><span class="kw">use super</span>::{AcquireError, TryAcquireError};
...
<span class="doccomment">/// Counting semaphore performing asynchronous permit acquisition.
///
...
</span><span class="kw">pub struct </span>Semaphore {
    <span class="doccomment">/// The low level semaphore
    </span>ll_sem: ll::Semaphore,
    <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
    </span>resource_span: tracing::Span,
}

<span class="doccomment">/// A permit from the semaphore.
///
...
#[derive(Debug)]
</span><span class="kw">pub struct </span>SemaphorePermit&lt;<span class="lifetime">'a</span>&gt; {
    sem: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Semaphore,
    permits: u32,
}

<span class="doccomment">/// An owned permit from the semaphore.
///
...
#[clippy::has_significant_drop]
#[derive(Debug)]
</span><span class="kw">pub struct </span>OwnedSemaphorePermit {
    sem: Arc&lt;Semaphore&gt;,
    permits: u32,
}
...
#[cfg(not(loom))]
    ...
    check_unpin::&lt;SemaphorePermit&lt;<span class="lifetime">'_</span>&gt;&gt;();
...
<span class="kw">impl </span>Semaphore {
    <span class="doccomment">/// The maximum number of permits which a semaphore can hold. It is `usize::MAX &gt;&gt; 3`.
    ///
    /// Exceeding this limit typically results in a panic.
    </span><span class="kw">pub const </span>MAX_PERMITS: usize = <span class="kw">super</span>::batch_semaphore::Semaphore::MAX_PERMITS;
    ...
    </span><span class="kw">pub fn </span>new(permits: usize) -&gt; <span class="self">Self </span>{
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
            ...
            <span class="macro">tracing::trace_span!</span>(
                ...
                inherits_child_attrs = <span class="bool-val">true</span>,
            )
        };

        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
        </span><span class="kw">let </span>ll_sem = resource_span.in_scope(|| ll::Semaphore::new(permits));

        <span class="attr">#[cfg(any(not(tokio_unstable), not(feature = <span class="string">"tracing"</span>)))]
        </span><span class="kw">let </span>ll_sem = ll::Semaphore::new(permits);
    ...
    </span><span class="kw">pub const fn </span>const_new(permits: usize) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
    ...
    <span class="doccomment">/// Creates a new closed semaphore with 0 permits.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new_closed() -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const fn </span>const_new_closed() -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
    ...
    <span class="doccomment">/// Returns the current number of available permits.
        ...
        <span class="self">self</span>.ll_sem.available_permits()
    }
    ...
    /// The maximum number of permits is [`Semaphore::MAX_PERMITS`], and this function will panic if the limit is exceeded.
        ...
        <span class="self">self</span>.ll_sem.release(n);
    }

    <span class="doccomment">/// Decrease a semaphore's permits by a maximum of `n`.
    ///
    ...
    </span><span class="kw">pub fn </span>forget_permits(<span class="kw-2">&amp;</span><span class="self">self</span>, n: usize) -&gt; usize {
        <span class="self">self</span>.ll_sem.forget_permits(n)
    }

    <span class="doccomment">/// Acquires a permit from the semaphore.
    ///
    ...
    </span><span class="kw">pub async fn </span>acquire(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;SemaphorePermit&lt;<span class="lifetime">'_</span>&gt;, AcquireError&gt; {
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
        </span><span class="kw">let </span>inner = trace::async_op(
            || <span class="self">self</span>.ll_sem.acquire(<span class="number">1</span>),
            <span class="self">self</span>.resource_span.clone(),
            <span class="string">"Semaphore::acquire"</span>,
            <span class="string">"poll"</span>,
            <span class="bool-val">true</span>,
        );
        <span class="attr">#[cfg(not(all(tokio_unstable, feature = <span class="string">"tracing"</span>)))]
        </span><span class="kw">let </span>inner = <span class="self">self</span>.ll_sem.acquire(<span class="number">1</span>);

        inner.<span class="kw">await</span><span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(SemaphorePermit {
            sem: <span class="self">self</span>,
            permits: <span class="number">1</span>,
        })
    }

    <span class="doccomment">/// Acquires `n` permits from the semaphore.
    ///
    /// If the semaphore has been closed, this returns an [`AcquireError`].
    /// Otherwise, this returns a [`SemaphorePermit`] representing the
    /// acquired permits.
    ...
    /// [`AcquireError`]: crate::sync::AcquireError
    /// [`SemaphorePermit`]: crate::sync::SemaphorePermit
    </span><span class="kw">pub async fn </span>acquire_many(<span class="kw-2">&amp;</span><span class="self">self</span>, n: u32) -&gt; <span class="prelude-ty">Result</span>&lt;SemaphorePermit&lt;<span class="lifetime">'_</span>&gt;, AcquireError&gt; {
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
        </span>trace::async_op(
            || <span class="self">self</span>.ll_sem.acquire(n <span class="kw">as </span>usize),
            <span class="self">self</span>.resource_span.clone(),
            <span class="string">"Semaphore::acquire_many"</span>,
            <span class="string">"poll"</span>,
            <span class="bool-val">true</span>,
        )
        ...
        <span class="attr">#[cfg(not(all(tokio_unstable, feature = <span class="string">"tracing"</span>)))]
        </span><span class="self">self</span>.ll_sem.acquire(n <span class="kw">as </span>usize).<span class="kw">await</span><span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Tries to acquire a permit from the semaphore.
    ///
    ...
    /// [`SemaphorePermit`]: crate::sync::SemaphorePermit
    </span><span class="kw">pub fn </span>try_acquire(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;SemaphorePermit&lt;<span class="lifetime">'_</span>&gt;, TryAcquireError&gt; {
        <span class="kw">match </span><span class="self">self</span>.ll_sem.try_acquire(<span class="number">1</span>) {
            <span class="prelude-val">Ok</span>(()) =&gt; <span class="prelude-val">Ok</span>(SemaphorePermit {
                sem: <span class="self">self</span>,
                permits: <span class="number">1</span>,
            }),
    ...
    <span class="doccomment">/// Tries to acquire `n` permits from the semaphore.
    ///
    /// If the semaphore has been closed, this returns a [`TryAcquireError::Closed`]
    ...
    /// [`TryAcquireError::NoPermits`]: crate::sync::TryAcquireError::NoPermits
    /// [`SemaphorePermit`]: crate::sync::SemaphorePermit
    </span><span class="kw">pub fn </span>try_acquire_many(<span class="kw-2">&amp;</span><span class="self">self</span>, n: u32) -&gt; <span class="prelude-ty">Result</span>&lt;SemaphorePermit&lt;<span class="lifetime">'_</span>&gt;, TryAcquireError&gt; {
        <span class="kw">match </span><span class="self">self</span>.ll_sem.try_acquire(n <span class="kw">as </span>usize) {
            <span class="prelude-val">Ok</span>(()) =&gt; <span class="prelude-val">Ok</span>(SemaphorePermit {
                sem: <span class="self">self</span>,
                permits: n,
            }),
    ...
    /// [`OwnedSemaphorePermit`]: crate::sync::OwnedSemaphorePermit
    </span><span class="kw">pub async fn </span>acquire_owned(<span class="self">self</span>: Arc&lt;<span class="self">Self</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedSemaphorePermit, AcquireError&gt; {
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
        </span><span class="kw">let </span>inner = trace::async_op(
            || <span class="self">self</span>.ll_sem.acquire(<span class="number">1</span>),
            <span class="self">self</span>.resource_span.clone(),
            <span class="string">"Semaphore::acquire_owned"</span>,
            <span class="string">"poll"</span>,
            <span class="bool-val">true</span>,
        );
        <span class="attr">#[cfg(not(all(tokio_unstable, feature = <span class="string">"tracing"</span>)))]
        ...
        inner.<span class="kw">await</span><span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(OwnedSemaphorePermit {
            sem: <span class="self">self</span>,
            permits: <span class="number">1</span>,
        })
    }
    ...
    /// [`AcquireError`]: crate::sync::AcquireError
    /// [`OwnedSemaphorePermit`]: crate::sync::OwnedSemaphorePermit
    </span><span class="kw">pub async fn </span>acquire_many_owned(
        <span class="self">self</span>: Arc&lt;<span class="self">Self</span>&gt;,
        n: u32,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedSemaphorePermit, AcquireError&gt; {
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))]
        </span><span class="kw">let </span>inner = trace::async_op(
            || <span class="self">self</span>.ll_sem.acquire(n <span class="kw">as </span>usize),
            <span class="self">self</span>.resource_span.clone(),
            <span class="string">"Semaphore::acquire_many_owned"</span>,
            <span class="string">"poll"</span>,
            <span class="bool-val">true</span>,
        );
        <span class="attr">#[cfg(not(all(tokio_unstable, feature = <span class="string">"tracing"</span>)))]
        </span><span class="kw">let </span>inner = <span class="self">self</span>.ll_sem.acquire(n <span class="kw">as </span>usize);
    ...
    /// [`TryAcquireError::NoPermits`]: crate::sync::TryAcquireError::NoPermits
    /// [`OwnedSemaphorePermit`]: crate::sync::OwnedSemaphorePermit
    </span><span class="kw">pub fn </span>try_acquire_owned(<span class="self">self</span>: Arc&lt;<span class="self">Self</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedSemaphorePermit, TryAcquireError&gt; {
        <span class="kw">match </span><span class="self">self</span>.ll_sem.try_acquire(<span class="number">1</span>) {
            <span class="prelude-val">Ok</span>(()) =&gt; <span class="prelude-val">Ok</span>(OwnedSemaphorePermit {
                sem: <span class="self">self</span>,
                permits: <span class="number">1</span>,
            }),
            <span class="prelude-val">Err</span>(e) =&gt; <span class="prelude-val">Err</span>(e),
    ...
    /// [`TryAcquireError::NoPermits`]: crate::sync::TryAcquireError::NoPermits
    /// [`OwnedSemaphorePermit`]: crate::sync::OwnedSemaphorePermit
    </span><span class="kw">pub fn </span>try_acquire_many_owned(
        <span class="self">self</span>: Arc&lt;<span class="self">Self</span>&gt;,
        n: u32,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedSemaphorePermit, TryAcquireError&gt; {
        <span class="kw">match </span><span class="self">self</span>.ll_sem.try_acquire(n <span class="kw">as </span>usize) {
            <span class="prelude-val">Ok</span>(()) =&gt; <span class="prelude-val">Ok</span>(OwnedSemaphorePermit {
                sem: <span class="self">self</span>,
                permits: n,
    ...
    /// ```
        ...
        <span class="self">self</span>.ll_sem.close();
    }
    ...
    <span class="doccomment">/// Returns true if the semaphore is closed
        ...
        <span class="self">self</span>.ll_sem.is_closed()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; SemaphorePermit&lt;<span class="lifetime">'a</span>&gt; {
    <span class="doccomment">/// Forgets the permit **without** releasing it back to the semaphore.
    /// This can be used to reduce the amount of permits available from a
    /// semaphore.
    </span><span class="kw">pub fn </span>forget(<span class="kw-2">mut </span><span class="self">self</span>) {
        <span class="self">self</span>.permits = <span class="number">0</span>;
    }

    <span class="doccomment">/// Merge two [`SemaphorePermit`] instances together, consuming `other`
    ...
    </span><span class="kw">pub fn </span>merge(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>other: <span class="self">Self</span>) {
        <span class="macro">assert!</span>(
            std::ptr::eq(<span class="self">self</span>.sem, other.sem),
            <span class="string">"merging permits from different semaphore instances"
        </span>);
        <span class="self">self</span>.permits += other.permits;
        other.permits = <span class="number">0</span>;
    }
}

<span class="kw">impl </span>OwnedSemaphorePermit {
    <span class="doccomment">/// Forgets the permit **without** releasing it back to the semaphore.
    /// This can be used to reduce the amount of permits available from a
    /// semaphore.
    </span><span class="kw">pub fn </span>forget(<span class="kw-2">mut </span><span class="self">self</span>) {
    ...
    <span class="doccomment">/// Merge two [`OwnedSemaphorePermit`] instances together, consuming `other`
    /// without releasing the permits it holds.
    ///
    /// Permits held by both `self` and `other` are released when `self` drops.
    ///
    ...
    /// are merged.
        ...
        <span class="macro">assert!</span>(
            Arc::ptr_eq(<span class="kw-2">&amp;</span><span class="self">self</span>.sem, <span class="kw-2">&amp;</span>other.sem),
            <span class="string">"merging permits from different semaphore instances"
        </span>);
        <span class="self">self</span>.permits += other.permits;
        other.permits = <span class="number">0</span>;
    ...
    <span class="doccomment">/// Returns the [`Semaphore`] from which this permit was acquired.
    </span><span class="kw">pub fn </span>semaphore(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>Arc&lt;Semaphore&gt; {
        <span class="kw-2">&amp;</span><span class="self">self</span>.sem
    }
}

<span class="kw">impl </span>Drop <span class="kw">for </span>SemaphorePermit&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="self">self</span>.sem.add_permits(<span class="self">self</span>.permits <span class="kw">as </span>usize);
    }
}

<span class="kw">impl </span>Drop <span class="kw">for </span>OwnedSemaphorePermit {
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="self">self</span>.sem.add_permits(<span class="self">self</span>.permits <span class="kw">as </span>usize);
    }
}
