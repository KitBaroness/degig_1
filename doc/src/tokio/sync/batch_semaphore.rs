...
<span class="kw">impl </span>Semaphore {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const fn </span>const_new(permits: usize) -&gt; <span class="self">Self </span>{
        <span class="macro">assert!</span>(permits &lt;= <span class="self">Self</span>::MAX_PERMITS);
    ...
    <span class="doccomment">/// Creates a new closed semaphore with 0 permits.
        ...
        <span class="self">Self </span>{
            permits: AtomicUsize::new(<span class="self">Self</span>::CLOSED),
            waiters: Mutex::new(Waitlist {
                queue: LinkedList::new(),
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>try_acquire(<span class="kw-2">&amp;</span><span class="self">self</span>, num_permits: usize) -&gt; <span class="prelude-ty">Result</span>&lt;(), TryAcquireError&gt; {
        <span class="macro">assert!</span>(
            num_permits &lt;= <span class="self">Self</span>::MAX_PERMITS,
            <span class="string">"a semaphore may not have more than MAX_PERMITS permits ({})"</span>,
            <span class="self">Self</span>::MAX_PERMITS
        );
        <span class="kw">let </span>num_permits = num_permits &lt;&lt; <span class="self">Self</span>::PERMIT_SHIFT;
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>acquire(<span class="kw-2">&amp;</span><span class="self">self</span>, num_permits: usize) -&gt; Acquire&lt;<span class="lifetime">'_</span>&gt; {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>forget_permits(<span class="kw-2">&amp;</span><span class="self">self</span>, n: usize) -&gt; usize {
        <span class="kw">if </span>n == <span class="number">0 </span>{
            <span class="kw">return </span><span class="number">0</span>;
        }

        <span class="kw">let </span><span class="kw-2">mut </span>curr_bits = <span class="self">self</span>.permits.load(Acquire);
        <span class="kw">loop </span>{
            <span class="kw">let </span>curr = curr_bits &gt;&gt; <span class="self">Self</span>::PERMIT_SHIFT;
            <span class="kw">let </span>new = curr.saturating_sub(n);
            <span class="kw">match </span><span class="self">self</span>.permits.compare_exchange_weak(
                curr_bits,
                new &lt;&lt; <span class="self">Self</span>::PERMIT_SHIFT,
                AcqRel,
                Acquire,
            ) {
                <span class="prelude-val">Ok</span>(<span class="kw">_</span>) =&gt; <span class="kw">return </span>std::cmp::min(curr, n),
                <span class="prelude-val">Err</span>(actual) =&gt; curr_bits = actual,
            };
        }
    }
    ...
    <span class="kw">fn </span>poll_acquire(
        ...
        <span class="kw">let </span>needed = <span class="kw">if </span>queued {
            ...
            num_permits &lt;&lt; <span class="self">Self</span>::PERMIT_SHIFT
        };
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>waiters = <span class="kw">loop </span>{
            <span class="comment">// Has the semaphore closed?
                ...
                <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Err</span>(AcquireError::closed()));
            }
        ...
        <span class="comment">// Otherwise, register the waker &amp; enqueue the node.
            ...
            <span class="comment">// Do we need to register the new waker?
                ...
                .as_ref()
                .map_or(<span class="bool-val">true</span>, |waker| !waker.will_wake(cx.waker()))
            {
                old_waker = std::mem::replace(waker, <span class="prelude-val">Some</span>(cx.waker().clone()));
            }
        });
...
<span class="kw">impl </span>Waiter {
    <span class="kw">fn </span>new(
        num_permits: usize,
        <span class="attr">#[cfg(all(tokio_unstable, feature = <span class="string">"tracing"</span>))] </span>ctx: trace::AsyncOpTracingCtx,
    ) -&gt; <span class="self">Self </span>{
        Waiter {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Acquire&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">fn </span>new(semaphore: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Semaphore, num_permits: usize) -&gt; <span class="self">Self </span>{
    ...
    <span class="kw">fn </span>project(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;) -&gt; (Pin&lt;<span class="kw-2">&amp;mut </span>Waiter&gt;, <span class="kw-2">&amp;</span>Semaphore, usize, <span class="kw-2">&amp;mut </span>bool) {
...
<span class="kw">impl </span>Drop <span class="kw">for </span>Acquire&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        ...
        <span class="kw">let </span>acquired_permits = <span class="self">self</span>.num_permits - <span class="self">self</span>.node.state.load(Acquire);
...
<span class="comment">// ===== impl TryAcquireError =====
    ...
    </span><span class="attr">#[allow(dead_code)] </span><span class="comment">// may be used later!
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_closed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
