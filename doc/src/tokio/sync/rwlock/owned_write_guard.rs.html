...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::sync::rwlock::owned_read_guard::OwnedRwLockReadGuard;
<span class="kw">use </span><span class="kw">crate</span>::sync::rwlock::owned_write_guard_mapped::OwnedRwLockMappedWriteGuard;
<span class="kw">use </span><span class="kw">crate</span>::sync::rwlock::RwLock;
<span class="kw">use </span>std::marker::PhantomData;
<span class="kw">use </span>std::sync::Arc;
<span class="kw">use </span>std::{fmt, mem, ops, ptr};
...
/// [`RwLock`]: struct@crate::sync::RwLock
...
</span><span class="kw">pub struct </span>OwnedRwLockWriteGuard&lt;T: <span class="question-mark">?</span>Sized&gt; {
    ...
    <span class="kw">pub</span>(<span class="kw">super</span>) lock: Arc&lt;RwLock&lt;T&gt;&gt;,
...
</span><span class="kw">struct </span>Inner&lt;T: <span class="question-mark">?</span>Sized&gt; {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; OwnedRwLockWriteGuard&lt;T&gt; {
    <span class="kw">fn </span>skip_drop(<span class="self">self</span>) -&gt; Inner&lt;T&gt; {
    ...
    </span><span class="kw">pub fn </span>map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(<span class="kw-2">mut </span>this: <span class="self">Self</span>, f: F) -&gt; OwnedRwLockMappedWriteGuard&lt;T, U&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Makes a new [`OwnedRwLockReadGuard`] for a component of the locked data.
    ///
    ...
    </span><span class="kw">pub fn </span>downgrade_map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(this: <span class="self">Self</span>, f: F) -&gt; OwnedRwLockReadGuard&lt;T, U&gt;
    <span class="kw">where
    ...
    /// ```
        ...
        f: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedRwLockMappedWriteGuard&lt;T, U&gt;, <span class="self">Self</span>&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Attempts to make a new [`OwnedRwLockReadGuard`] for a component of
    ...
    </span><span class="kw">pub fn </span>try_downgrade_map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(
        this: <span class="self">Self</span>,
        f: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;OwnedRwLockReadGuard&lt;T, U&gt;, <span class="self">Self</span>&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Converts this `OwnedRwLockWriteGuard` into an
    ...
    </span><span class="kw">pub fn </span>into_mapped(this: <span class="self">Self</span>) -&gt; OwnedRwLockMappedWriteGuard&lt;T&gt; {
        <span class="self">Self</span>::map(this, |me| me)
    }
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>downgrade(<span class="self">self</span>) -&gt; OwnedRwLockReadGuard&lt;T&gt; {
    ...
    <span class="doccomment">/// Returns a reference to the original `Arc&lt;RwLock&gt;`.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>rwlock(this: <span class="kw-2">&amp;</span><span class="self">Self</span>) -&gt; <span class="kw-2">&amp;</span>Arc&lt;RwLock&lt;T&gt;&gt; {
        <span class="kw-2">&amp;</span>this.lock
    }
}

<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::Deref <span class="kw">for </span>OwnedRwLockWriteGuard&lt;T&gt; {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::DerefMut <span class="kw">for </span>OwnedRwLockWriteGuard&lt;T&gt; {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; fmt::Debug <span class="kw">for </span>OwnedRwLockWriteGuard&lt;T&gt;
<span class="kw">where
    </span>T: fmt::Debug,
{
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; fmt::Display <span class="kw">for </span>OwnedRwLockWriteGuard&lt;T&gt;
<span class="kw">where
    </span>T: fmt::Display,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; Drop <span class="kw">for </span>OwnedRwLockWriteGuard&lt;T&gt; {
