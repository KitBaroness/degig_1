...
<span class="kw">use </span><span class="kw">crate</span>::sync::rwlock::read_guard::RwLockReadGuard;
<span class="kw">use </span><span class="kw">crate</span>::sync::rwlock::write_guard_mapped::RwLockMappedWriteGuard;
<span class="kw">use </span>std::marker::PhantomData;
<span class="kw">use </span>std::{fmt, mem, ops};

<span class="doccomment">/// RAII structure used to release the exclusive write access of a lock when
/// dropped.
///
...
#[must_use = <span class="string">"if unused the RwLock will immediately unlock"</span>]
</span><span class="kw">pub struct </span>RwLockWriteGuard&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; {
    ...
    <span class="kw">pub</span>(<span class="kw">super</span>) data: <span class="kw-2">*mut </span>T,
    <span class="kw">pub</span>(<span class="kw">super</span>) marker: PhantomData&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>T&gt;,
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; RwLockWriteGuard&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    <span class="doccomment">/// Makes a new [`RwLockMappedWriteGuard`] for a component of the locked data.
    ///
    ...
    </span><span class="kw">pub fn </span>map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(<span class="kw-2">mut </span>this: <span class="self">Self</span>, f: F) -&gt; RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, U&gt;
    <span class="kw">where
    ...
    </span><span class="kw">pub fn </span>downgrade_map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(this: <span class="self">Self</span>, f: F) -&gt; RwLockReadGuard&lt;<span class="lifetime">'a</span>, U&gt;
    <span class="kw">where
        </span>F: FnOnce(<span class="kw-2">&amp;</span>T) -&gt; <span class="kw-2">&amp;</span>U,
    {
        ...
        <span class="comment">// Release all but one of the permits held by the write guard
        </span><span class="kw">let </span>to_release = (this.permits_acquired - <span class="number">1</span>) <span class="kw">as </span>usize;
    ...
    <span class="doccomment">/// Attempts to make a new [`RwLockMappedWriteGuard`] for a component of
    ...
    </span><span class="kw">pub fn </span>try_map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(
        <span class="kw-2">mut </span>this: <span class="self">Self</span>,
        f: F,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, U&gt;, <span class="self">Self</span>&gt;
    <span class="kw">where
        </span>F: FnOnce(<span class="kw-2">&amp;mut </span>T) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;mut </span>U&gt;,
    {
        ...
        <span class="prelude-val">Ok</span>(RwLockMappedWriteGuard {
            permits_acquired: this.permits_acquired,
            s: this.s,
            data,
            marker: PhantomData,
    ...
    <span class="doccomment">/// Attempts to make a new [`RwLockReadGuard`] for a component of
    /// the locked data. The original guard is returned if the closure returns
    /// `None`.
    ///
    /// This operation cannot fail as the `RwLockWriteGuard` passed in already
    ...
    </span><span class="kw">pub fn </span>try_downgrade_map&lt;F, U: <span class="question-mark">?</span>Sized&gt;(this: <span class="self">Self</span>, f: F) -&gt; <span class="prelude-ty">Result</span>&lt;RwLockReadGuard&lt;<span class="lifetime">'a</span>, U&gt;, <span class="self">Self</span>&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Converts this `RwLockWriteGuard` into an `RwLockMappedWriteGuard`. This
    ...
    </span><span class="kw">pub fn </span>into_mapped(this: <span class="self">Self</span>) -&gt; RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T&gt; {
        RwLockWriteGuard::map(this, |me| me)
    }

    <span class="doccomment">/// Atomically downgrades a write lock into a read lock without allowing
    ...
    ///
    /// [`RwLock`]: struct@crate::sync::RwLock
    </span><span class="kw">pub fn </span>downgrade(<span class="self">self</span>) -&gt; RwLockReadGuard&lt;<span class="lifetime">'a</span>, T&gt; {
        <span class="kw">let </span>this = <span class="self">self</span>.skip_drop();
        <span class="kw">let </span>guard = RwLockReadGuard {
            s: this.s,
            data: this.data,
            marker: PhantomData,
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::Deref <span class="kw">for </span>RwLockWriteGuard&lt;<span class="lifetime">'_</span>, T&gt; {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::DerefMut <span class="kw">for </span>RwLockWriteGuard&lt;<span class="lifetime">'_</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; fmt::Debug <span class="kw">for </span>RwLockWriteGuard&lt;<span class="lifetime">'a</span>, T&gt;
<span class="kw">where
    </span>T: fmt::Debug,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; fmt::Display <span class="kw">for </span>RwLockWriteGuard&lt;<span class="lifetime">'a</span>, T&gt;
<span class="kw">where
    </span>T: fmt::Display,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; Drop <span class="kw">for </span>RwLockWriteGuard&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="self">self</span>.s.release(<span class="self">self</span>.permits_acquired <span class="kw">as </span>usize);
