...
</span><span class="kw">pub struct </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    <span class="comment">// Note: No `downgrade`, `downgrade_map` nor `try_downgrade_map` because they would be unsound, as we're already
    //       potentially been mapped with internal mutability.
</span>}

<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::Deref <span class="kw">for </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'_</span>, T&gt; {
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; ops::DerefMut <span class="kw">for </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'_</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; fmt::Debug <span class="kw">for </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T&gt;
<span class="kw">where
    </span>T: fmt::Debug,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; fmt::Display <span class="kw">for </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T&gt;
<span class="kw">where
    </span>T: fmt::Display,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized&gt; Drop <span class="kw">for </span>RwLockMappedWriteGuard&lt;<span class="lifetime">'a</span>, T&gt; {
