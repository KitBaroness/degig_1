...
</pre></div><pre class="rust"><code><span class="doccomment">//! A shutdown channel.
//!
...
<span class="kw">impl </span>Receiver {
    ...
    /// If the timeout has elapsed, it returns `false`, otherwise it returns `true`.
        ...
        <span class="kw">use </span><span class="kw">crate</span>::runtime::context::try_enter_blocking_region;

        <span class="kw">if </span>timeout == <span class="prelude-val">Some</span>(Duration::from_nanos(<span class="number">0</span>)) {
            <span class="kw">return </span><span class="bool-val">false</span>;
        }

        <span class="kw">let </span><span class="kw-2">mut </span>e = <span class="kw">match </span>try_enter_blocking_region() {
