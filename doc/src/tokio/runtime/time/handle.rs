...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::runtime::time::TimeSource;
...
<span class="doccomment">/// Handle to time driver instance.
    ...
    <span class="kw">pub</span>(<span class="kw">super</span>) time_source: TimeSource,
    <span class="kw">pub</span>(<span class="kw">super</span>) inner: <span class="kw">super</span>::Inner,
}

<span class="kw">impl </span>Handle {
    <span class="doccomment">/// Returns the time source associated with this handle.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>time_source(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>TimeSource {
    ...
    <span class="doccomment">/// Track that the driver is being unparked
        ...
        </span><span class="self">self</span>.inner
            .did_wake
            .store(<span class="bool-val">true</span>, std::sync::atomic::Ordering::SeqCst);
    }
}
