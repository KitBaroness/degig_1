...
</pre></div><pre class="rust"><code><span class="doccomment">//! Timer state structures.
//!
...
<span class="doccomment">/// The largest safe integer to use for ticks.
///
/// This value should be updated if any other signal values are added above.
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">const </span>MAX_SAFE_MILLIS_DURATION: u64 = u64::MAX - <span class="number">2</span>;
...
<span class="kw">impl </span>StateCell {
    ...
    /// returns None and registers the waker.
        ...
        // the state, or both.
        </span><span class="self">self</span>.waker.register_by_ref(waker);
    ...
    /// SAFETY: The driver lock must be held.
        ...
        <span class="self">self</span>.waker.take_waker()
    }
...
/// before polling.
    ...
    <span class="doccomment">/// Deadline for the timer. This is used to register on the first
    /// poll, as we can't register prior to being pinned.
    </span>deadline: Instant,
    <span class="doccomment">/// Whether the deadline has been registered.
    </span>registered: bool,
...
<span class="kw">impl </span>std::fmt::Debug <span class="kw">for </span>TimerShared {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>std::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; std::fmt::Result {
        f.debug_struct(<span class="string">"TimerShared"</span>)
...
<span class="kw">impl </span>TimerShared {
    ...
    <span class="doccomment">/// Gets the cached time-of-expiration value.
        ...
        </span><span class="self">self</span>.cached_when.load(Ordering::Relaxed)
    }
    ...
    /// not in any timer wheel lists.
        ...
        <span class="self">self</span>.cached_when.store(true_when, Ordering::Relaxed);
    ...
    /// not in any timer wheel lists.
        ...
        <span class="self">self</span>.cached_when.store(when, Ordering::Relaxed);
    }
    ...
    /// in the timer wheel.
        ...
        <span class="self">self</span>.cached_when.store(t, Ordering::Relaxed);
    }
...
<span class="comment">// ===== impl Entry =====
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>deadline(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Instant {
        <span class="self">self</span>.deadline
    }
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_elapsed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        !<span class="self">self</span>.inner().state.might_be_registered() &amp;&amp; <span class="self">self</span>.registered
    }
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>reset(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, new_time: Instant, reregister: bool) {
        <span class="kw">unsafe </span>{ <span class="self">self</span>.as_mut().get_unchecked_mut() }.deadline = new_time;
        <span class="kw">unsafe </span>{ <span class="self">self</span>.as_mut().get_unchecked_mut() }.registered = reregister;
        ...
        <span class="kw">if </span>reregister {
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>poll_elapsed(
        ...
        <span class="macro">assert!</span>(
            !<span class="self">self</span>.driver().is_shutdown(),
            <span class="string">"{}"</span>,
            <span class="kw">crate</span>::util::error::RUNTIME_SHUTTING_DOWN_ERROR
        );

        <span class="kw">if </span>!<span class="self">self</span>.registered {
            <span class="kw">let </span>deadline = <span class="self">self</span>.deadline;
            <span class="self">self</span>.as_mut().reset(deadline, <span class="bool-val">true</span>);
        }
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>clock(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="kw">super</span>::Clock {
        <span class="self">self</span>.driver.driver().clock()
    }
}
