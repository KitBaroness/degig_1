...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::runtime::time::{EntryList, TimerHandle, TimerShared};

<span class="kw">use </span>std::{fmt, ptr::NonNull};
...
<span class="kw">impl </span>Level {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(level: usize) -&gt; Level {
        <span class="comment">// A value has to be Copy in order to use syntax like:
        ...
        </span><span class="kw">let </span>ctor = EntryList::default;
    ...
    /// `Instant` at which this slot must be processed.
        ...
        </span><span class="kw">let </span>slot = <span class="kw">match </span><span class="self">self</span>.next_occupied_slot(now) {
    ...
    <span class="kw">fn </span>next_occupied_slot(<span class="kw-2">&amp;</span><span class="self">self</span>, now: u64) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        ...
        <span class="kw">let </span>slot = (zeros + now_slot) % <span class="number">64</span>;
