...
<span class="kw">impl</span>&lt;T&gt; OnceCell&lt;T&gt; {
    ...
    <span class="doccomment">/// Get the value inside this cell, initializing it using the provided
    /// function if necessary.
    ///
    /// If the `init` closure panics, then the `OnceCell` is poisoned and all
    /// future calls to `get` will panic.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>get(<span class="kw-2">&amp;</span><span class="self">self</span>, init: <span class="kw">impl </span>FnOnce() -&gt; T) -&gt; <span class="kw-2">&amp;</span>T {
    ...
    </span><span class="kw">fn </span>do_init(<span class="kw-2">&amp;</span><span class="self">self</span>, init: <span class="kw">impl </span>FnOnce() -&gt; T) {
