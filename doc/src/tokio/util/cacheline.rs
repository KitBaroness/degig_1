...
</span><span class="comment">// arm, mips and mips64 have 32-byte cache line size.
//
// Sources:
...
// - https://github.com/golang/go/blob/3dd58676054223962cd915bb0934d1f9f489d4d2/src/internal/cpu/cpu_mips64x.go#L9
    ...
    any(target_arch = <span class="string">"arm"</span>, target_arch = <span class="string">"mips"</span>, target_arch = <span class="string">"mips64"</span>,),
...
</span><span class="comment">// x86, riscv and wasm have 64-byte cache line size.
//
// Sources:
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>CachePadded&lt;T&gt; {
    value: T,
}

<span class="kw">impl</span>&lt;T&gt; CachePadded&lt;T&gt; {
    <span class="doccomment">/// Pads and aligns a value to the length of a cache line.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(value: T) -&gt; CachePadded&lt;T&gt; {
        CachePadded::&lt;T&gt; { value }
    }
}
