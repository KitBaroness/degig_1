...
</pre></div><pre class="rust"><code><span class="doccomment">/// Pins a value on the stack.
///
...
/// ```
    ...
    ($(<span class="macro-nonterminal">$x</span>:ident),<span class="kw-2">*</span>) =&gt; { $(
        <span class="comment">// Move the value to ensure that it is owned
        </span><span class="kw">let </span><span class="kw-2">mut </span><span class="macro-nonterminal">$x </span>= <span class="macro-nonterminal">$x</span>;
        <span class="comment">// Shadow the original binding so that it can't be directly accessed
        // ever again.
            ...
            <span class="macro-nonterminal">$crate::macros::support::Pin::new_unchecked</span>(<span class="kw-2">&amp;mut </span><span class="macro-nonterminal">$x</span>)
        };
    )* };
    ($(
        ...
        $(
            <span class="kw">let </span><span class="macro-nonterminal">$x </span>= <span class="macro-nonterminal">$init</span>;
            <span class="macro-nonterminal">$</span><span class="macro">crate::pin!</span>(<span class="macro-nonterminal">$x</span>);
        )*
    };
}
