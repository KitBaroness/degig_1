...
<span class="attr">#[cfg(unix)]
    ...
    <span class="kw">impl </span>AsFd <span class="kw">for </span>UdpSocket {
...
<span class="macro">cfg_windows!</span> {
    ...
    <span class="kw">use </span><span class="kw">crate</span>::os::windows::io::{AsSocket, BorrowedSocket};
    ...
    <span class="kw">impl </span>AsSocket <span class="kw">for </span>UdpSocket {
