...
<span class="kw">impl </span>UnixStream {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">async fn </span>connect_mio(sys: mio::net::UnixStream) -&gt; io::Result&lt;UnixStream&gt; {
        <span class="kw">let </span>stream = UnixStream::new(sys)<span class="question-mark">?</span>;
...
<span class="kw">impl </span>AsFd <span class="kw">for </span>UnixStream {
