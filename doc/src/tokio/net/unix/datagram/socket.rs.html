...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::{Interest, PollEvented, ReadBuf, Ready};
...
<span class="macro">cfg_net_unix!</span> {
    <span class="doccomment">/// An I/O object representing a Unix datagram socket.
    ///
...
<span class="kw">impl </span>UnixDatagram {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>from_mio(sys: mio::net::UnixDatagram) -&gt; io::Result&lt;UnixDatagram&gt; {
        <span class="kw">let </span>datagram = UnixDatagram::new(sys)<span class="question-mark">?</span>;

        <span class="kw">if let </span><span class="prelude-val">Some</span>(e) = datagram.io.take_error()<span class="question-mark">? </span>{
    ...
    <span class="doccomment">/// Creates a new `UnixDatagram` bound to the specified path.
    ///
    /// # Examples
    /// ```
    /// # use std::error::Error;
    ...
    /// # }
    /// ```
    </span><span class="kw">pub fn </span>bind&lt;P&gt;(path: P) -&gt; io::Result&lt;UnixDatagram&gt;
    <span class="kw">where
        </span>P: AsRef&lt;Path&gt;,
    {
        <span class="kw">let </span>socket = mio::net::UnixDatagram::bind(path)<span class="question-mark">?</span>;
    ...
    /// ```
        ...
        <span class="kw">let </span>(a, b) = mio::net::UnixDatagram::pair()<span class="question-mark">?</span>;
        <span class="kw">let </span>a = UnixDatagram::new(a)<span class="question-mark">?</span>;
        <span class="kw">let </span>b = UnixDatagram::new(b)<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>((a, b))
    }

    <span class="doccomment">/// Creates new [`UnixDatagram`] from a [`std::os::unix::net::UnixDatagram`].
    ///
    ...
    </span><span class="kw">pub fn </span>from_std(datagram: net::UnixDatagram) -&gt; io::Result&lt;UnixDatagram&gt; {
        <span class="kw">let </span>socket = mio::net::UnixDatagram::from_std(datagram);
        <span class="kw">let </span>io = PollEvented::new(socket)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(UnixDatagram { io })
    }

    <span class="doccomment">/// Turns a [`tokio::net::UnixDatagram`] into a [`std::os::unix::net::UnixDatagram`].
    ///
    ...
    </span><span class="kw">pub fn </span>into_std(<span class="self">self</span>) -&gt; io::Result&lt;std::os::unix::net::UnixDatagram&gt; {
        <span class="self">self</span>.io
            .into_inner()
            .map(IntoRawFd::into_raw_fd)
            .map(|raw_fd| <span class="kw">unsafe </span>{ std::os::unix::net::UnixDatagram::from_raw_fd(raw_fd) })
    }

    <span class="kw">fn </span>new(socket: mio::net::UnixDatagram) -&gt; io::Result&lt;UnixDatagram&gt; {
        <span class="kw">let </span>io = PollEvented::new(socket)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(UnixDatagram { io })
    }

    <span class="doccomment">/// Creates a new `UnixDatagram` which is not bound to any address.
    ///
    /// # Examples
    /// ```
    /// # use std::error::Error;
    ...
    /// ```
        ...
        <span class="kw">let </span>socket = mio::net::UnixDatagram::unbound()<span class="question-mark">?</span>;
        UnixDatagram::new(socket)
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.io.connect(path)
    }
    ...
    <span class="doccomment">/// Tries to send a datagram to the peer without waiting.
    ///
    /// # Examples
    ///
    /// ```no_run
    ...
    /// }
    /// ```
    </span><span class="kw">pub fn </span>try_send_to&lt;P&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8], target: P) -&gt; io::Result&lt;usize&gt;
    <span class="kw">where
        </span>P: AsRef&lt;Path&gt;,
    {
        <span class="self">self</span>.io
    ...
    <span class="doccomment">/// Tries to receive a datagram from the peer without waiting.
    ///
    /// # Examples
    ///
    /// ```no_run
    ...
    <span class="macro">cfg_io_util!</span> {
        <span class="doccomment">/// Tries to receive data from the socket without waiting.
        ///
        ...
        /// ```
            ...
            <span class="kw">let </span>(n, addr) = <span class="self">self</span>.io.registration().try_io(Interest::READABLE, || {
                ...
                <span class="comment">// Safety: We trust `UnixDatagram::recv_from` to have filled up `n` bytes in the
                // buffer.
                </span><span class="kw">let </span>(n, addr) = (<span class="kw-2">*</span><span class="self">self</span>.io).recv_from(dst)<span class="question-mark">?</span>;
            ...
            <span class="prelude-val">Ok</span>((n, SocketAddr(addr)))
        }

        <span class="doccomment">/// Receives from the socket, advances the
        ...
        /// ```
            ...
            <span class="self">self</span>.io.registration().try_io(Interest::READABLE, || {
                ...
                <span class="comment">// Safety: We trust `UnixDatagram::recv` to have filled up `n` bytes in the
                // buffer.
                </span><span class="kw">let </span>n = (<span class="kw-2">*</span><span class="self">self</span>.io).recv(dst)<span class="question-mark">?</span>;
        ...
        <span class="doccomment">/// Receives data from the socket from the address to which it is connected,
    ...
    /// # }
    /// ```
    </span><span class="kw">pub async fn </span>send_to&lt;P&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8], target: P) -&gt; io::Result&lt;usize&gt;
    <span class="kw">where
        </span>P: AsRef&lt;Path&gt;,
    {
        <span class="self">self</span>.io
            .registration()
            .async_io(Interest::WRITABLE, || <span class="self">self</span>.io.send_to(buf, target.as_ref()))
            .<span class="kw">await
    </span>}
    ...
    /// ```
        ...
        <span class="kw">let </span>(n, addr) = <span class="self">self
            </span>.io
            .registration()
    ...
    <span class="doccomment">/// Attempts to receive a single datagram on the specified address.
    ///
    ...
    /// This function may encounter any standard I/O error except `WouldBlock`.
        ...
        <span class="attr">#[allow(clippy::blocks_in_conditions)]
        </span><span class="kw">let </span>(n, addr) = <span class="macro">ready!</span>(<span class="self">self</span>.io.registration().poll_read_io(cx, || {
        ...
        buf.advance(n);
        Poll::Ready(<span class="prelude-val">Ok</span>(SocketAddr(addr)))
    }

    <span class="doccomment">/// Attempts to send data to the specified address.
    ///
    ...
    ///
    /// This function may encounter any standard I/O error except `WouldBlock`.
    </span><span class="kw">pub fn </span>poll_send_to&lt;P&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
        ...
        </span>P: AsRef&lt;Path&gt;,
    {
        <span class="self">self</span>.io
            .registration()
            .poll_write_io(cx, || <span class="self">self</span>.io.send_to(buf, target.as_ref()))
    }
    ...
    /// [`connect`]: method@Self::connect
        ...
        <span class="attr">#[allow(clippy::blocks_in_conditions)]
        </span><span class="kw">let </span>n = <span class="macro">ready!</span>(<span class="self">self</span>.io.registration().poll_read_io(cx, || {
            <span class="comment">// Safety: will not read the maybe uninitialized bytes.
            </span><span class="kw">let </span>b = <span class="kw">unsafe </span>{
                <span class="kw-2">&amp;mut *</span>(buf.unfilled_mut() <span class="kw">as </span><span class="kw-2">*mut </span>[std::mem::MaybeUninit&lt;u8&gt;] <span class="kw">as </span><span class="kw-2">*mut </span>[u8])
            };
    ...
    /// ```
        ...
        <span class="kw">let </span>(n, addr) = <span class="self">self
            ...
            .registration()
            .try_io(Interest::READABLE, || <span class="self">self</span>.io.recv_from(buf))<span class="question-mark">?</span>;
...
<span class="kw">impl </span>TryFrom&lt;std::os::unix::net::UnixDatagram&gt; <span class="kw">for </span>UnixDatagram {
    ...
    </span><span class="kw">fn </span>try_from(stream: std::os::unix::net::UnixDatagram) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
