...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::{Interest, PollEvented};
...
<span class="attr">#[cfg(unix)]
    ...
    <span class="kw">impl </span>AsFd <span class="kw">for </span>TcpListener {
...
<span class="macro">cfg_windows!</span> {
    ...
    <span class="kw">impl </span>AsSocket <span class="kw">for </span>TcpListener {
