...
</pre></div><pre class="rust"><code><span class="macro">cfg_not_wasi!</span> {
...
<span class="kw">use </span><span class="kw">crate</span>::net::tcp::split::{split, ReadHalf, WriteHalf};
<span class="kw">use </span><span class="kw">crate</span>::net::tcp::split_owned::{split_owned, OwnedReadHalf, OwnedWriteHalf};
...
<span class="macro">cfg_net!</span> {
    <span class="doccomment">/// A TCP stream between a local and a remote socket.
    ///
...
<span class="kw">impl </span>TcpStream {
    <span class="macro">cfg_not_wasi!</span> {
        <span class="doccomment">/// Opens a TCP connection to a remote host.
        ///
        ...
        /// [`write_all`]: fn@crate::io::AsyncWriteExt::write_all
        /// [`AsyncWriteExt`]: trait@crate::io::AsyncWriteExt
        </span><span class="kw">pub async fn </span>connect&lt;A: ToSocketAddrs&gt;(addr: A) -&gt; io::Result&lt;TcpStream&gt; {
            ...
            <span class="kw">for </span>addr <span class="kw">in </span>addrs {
                <span class="kw">match </span>TcpStream::connect_addr(addr).<span class="kw">await </span>{
                    <span class="prelude-val">Ok</span>(stream) =&gt; <span class="kw">return </span><span class="prelude-val">Ok</span>(stream),
        ...
        <span class="doccomment">/// Establishes a connection to the specified `addr`.
        </span><span class="kw">async fn </span>connect_addr(addr: SocketAddr) -&gt; io::Result&lt;TcpStream&gt; {
            <span class="kw">let </span>sys = mio::net::TcpStream::connect(addr)<span class="question-mark">?</span>;
            TcpStream::connect_mio(sys).<span class="kw">await
        </span>}

        <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">async fn </span>connect_mio(sys: mio::net::TcpStream) -&gt; io::Result&lt;TcpStream&gt; {
            <span class="kw">let </span>stream = TcpStream::new(sys)<span class="question-mark">?</span>;

            <span class="comment">// Once we've connected, wait for the stream to be writable as
            // that's when the actual connection has been initiated. Once we're
            // writable we check for `take_socket_error` to see if the connect
            // actually hit an error or not.
            //
            // If all that succeeded then we ship everything on up.
            </span>poll_fn(|cx| stream.io.registration().poll_write_ready(cx)).<span class="kw">await</span><span class="question-mark">?</span>;
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(connected: mio::net::TcpStream) -&gt; io::Result&lt;TcpStream&gt; {
        <span class="kw">let </span>io = PollEvented::new(connected)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(TcpStream { io })
    }

    <span class="doccomment">/// Creates new `TcpStream` from a `std::net::TcpStream`.
    ///
    ...
    </span><span class="kw">pub fn </span>from_std(stream: std::net::TcpStream) -&gt; io::Result&lt;TcpStream&gt; {
        <span class="kw">let </span>io = mio::net::TcpStream::from_std(stream);
        <span class="kw">let </span>io = PollEvented::new(io)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(TcpStream { io })
    }

    <span class="doccomment">/// Turns a [`tokio::net::TcpStream`] into a [`std::net::TcpStream`].
    ///
    ...
    /// [`set_nonblocking`]: fn@std::net::TcpStream::set_nonblocking
    </span><span class="kw">pub fn </span>into_std(<span class="self">self</span>) -&gt; io::Result&lt;std::net::TcpStream&gt; {
        <span class="attr">#[cfg(unix)]
            ...
            <span class="self">self</span>.io
                ...
                .map(|raw_fd| <span class="kw">unsafe </span>{ std::net::TcpStream::from_raw_fd(raw_fd) })
        }
        ...
        <span class="attr">#[cfg(windows)]
            ...
            <span class="self">self</span>.io
                ...
                .map(|raw_socket| <span class="kw">unsafe </span>{ std::net::TcpStream::from_raw_socket(raw_socket) })
        }

        <span class="attr">#[cfg(target_os = <span class="string">"wasi"</span>)]
        </span>{
            <span class="kw">use </span>std::os::wasi::io::{FromRawFd, IntoRawFd};
            <span class="self">self</span>.io
                .into_inner()
    ...
    /// ```
        ...
        <span class="kw">loop </span>{
            ...
            <span class="kw">let </span>b = <span class="kw">unsafe </span>{
            ...
            <span class="kw">match </span><span class="self">self</span>.io.peek(b) {
                <span class="prelude-val">Ok</span>(ret) =&gt; {
                    <span class="kw">unsafe </span>{ buf.assume_init(ret) };
                    buf.advance(ret);
    ...
    <span class="doccomment">/// Try to write a buffer to the stream, returning how many bytes were
    /// written.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.io
            .registration()
            .try_io(Interest::WRITABLE, || (<span class="kw-2">&amp;*</span><span class="self">self</span>.io).write_vectored(bufs))
    }
    ...
    /// [`AsyncReadExt`]: trait@crate::io::AsyncReadExt
    </span><span class="kw">pub async fn </span>peek(<span class="kw-2">&amp;</span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.io
            .registration()
            .async_io(Interest::READABLE, || <span class="self">self</span>.io.peek(buf))
            .<span class="kw">await
    </span>}
    ...
    /// ```
        ...
        <span class="self">self</span>.io.nodelay()
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.io.set_nodelay(nodelay)
    }
    ...
    <span class="macro">cfg_not_wasi!</span> {
        ...
        /// ```
            ...
            socket2::SockRef::from(<span class="self">self</span>).linger()
        }
        ...
        /// ```
            ...
            socket2::SockRef::from(<span class="self">self</span>).set_linger(dur)
        }
    }
    ...
    </span><span class="doccomment">/// Splits a `TcpStream` into a read half and a write half, which can be used
    ...
    <span class="doccomment">/// Splits a `TcpStream` into a read half and a write half, which can be used
    /// to read and write the stream concurrently.
    ///
    ...
    // `try_write` methods.
        ...
        <span class="comment">// Safety: `TcpStream::read` correctly handles reads into uninitialized memory
        </span><span class="kw">unsafe </span>{ <span class="self">self</span>.io.poll_read(cx, buf) }
    }

    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>poll_write_priv(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
...
<span class="kw">impl </span>TryFrom&lt;std::net::TcpStream&gt; <span class="kw">for </span>TcpStream {
    ...
    </span><span class="kw">fn </span>try_from(stream: std::net::TcpStream) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        <span class="self">Self</span>::from_std(stream)
    }
}

<span class="comment">// ===== impl Read / Write =====

</span><span class="kw">impl </span>AsyncRead <span class="kw">for </span>TcpStream {
...
<span class="kw">impl </span>AsyncWrite <span class="kw">for </span>TcpStream {
...
<span class="attr">#[cfg(unix)]
    ...
    <span class="kw">use </span><span class="kw">super</span>::TcpStream;
    <span class="kw">use </span>std::os::unix::prelude::<span class="kw-2">*</span>;

    <span class="kw">impl </span>AsRawFd <span class="kw">for </span>TcpStream {
    ...
    <span class="kw">impl </span>AsFd <span class="kw">for </span>TcpStream {
...
<span class="macro">cfg_windows!</span> {
    <span class="kw">use </span><span class="kw">crate</span>::os::windows::io::{AsRawSocket, RawSocket, AsSocket, BorrowedSocket};

    <span class="kw">impl </span>AsRawSocket <span class="kw">for </span>TcpStream {
    ...
    <span class="kw">impl </span>AsSocket <span class="kw">for </span>TcpStream {
...
<span class="attr">#[cfg(all(tokio_unstable, target_os = <span class="string">"wasi"</span>))]
</span><span class="kw">mod </span>sys {
    <span class="kw">use </span><span class="kw">super</span>::TcpStream;
    <span class="kw">use </span>std::os::wasi::prelude::<span class="kw-2">*</span>;
