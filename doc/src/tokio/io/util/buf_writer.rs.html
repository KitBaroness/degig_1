...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::util::DEFAULT_BUF_SIZE;
<span class="kw">use </span><span class="kw">crate</span>::io::{AsyncBufRead, AsyncRead, AsyncSeek, AsyncWrite, ReadBuf};

<span class="kw">use </span>pin_project_lite::pin_project;
<span class="kw">use </span>std::fmt;
<span class="kw">use </span>std::io::{<span class="self">self</span>, IoSlice, SeekFrom, Write};
...
<span class="macro">pin_project!</span> {
    ...
    ///
        ...
        <span class="attr">#[pin]
        </span><span class="kw">pub</span>(<span class="kw">super</span>) inner: W,
        <span class="kw">pub</span>(<span class="kw">super</span>) buf: Vec&lt;u8&gt;,
        <span class="kw">pub</span>(<span class="kw">super</span>) written: usize,
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; BufWriter&lt;W&gt; {
    ...
    <span class="kw">fn </span>flush_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>me = <span class="self">self</span>.project();

        <span class="kw">let </span>len = me.buf.len();
        <span class="kw">let </span><span class="kw-2">mut </span>ret = <span class="prelude-val">Ok</span>(());
        <span class="kw">while </span><span class="kw-2">*</span>me.written &lt; len {
            <span class="kw">match </span><span class="macro">ready!</span>(me.inner.as_mut().poll_write(cx, <span class="kw-2">&amp;</span>me.buf[<span class="kw-2">*</span>me.written..])) {
                ...
                <span class="prelude-val">Ok</span>(n) =&gt; <span class="kw-2">*</span>me.written += n,
        ...
        <span class="kw">if </span><span class="kw-2">*</span>me.written &gt; <span class="number">0 </span>{
            me.buf.drain(..<span class="kw-2">*</span>me.written);
        }
        <span class="kw-2">*</span>me.written = <span class="number">0</span>;
        Poll::Ready(ret)
    }
    ...
    <span class="doccomment">/// Gets a mutable reference to the underlying writer.
    ///
    ...
    <span class="doccomment">/// Gets a pinned mutable reference to the underlying writer.
    ///
    /// It is inadvisable to directly write to the underlying writer.
    </span><span class="kw">pub fn </span>get_pin_mut(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;) -&gt; Pin&lt;<span class="kw-2">&amp;mut </span>W&gt; {
        <span class="self">self</span>.project().inner
    }

    <span class="doccomment">/// Consumes this `BufWriter`, returning the underlying writer.
    ///
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; AsyncWrite <span class="kw">for </span>BufWriter&lt;W&gt; {
    <span class="kw">fn </span>poll_write(
        ...
        <span class="kw">if </span>buf.len() &gt;= me.buf.capacity() {
    ...
    <span class="kw">fn </span>poll_write_vectored(
        <span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
        <span class="kw-2">mut </span>bufs: <span class="kw-2">&amp;</span>[IoSlice&lt;<span class="lifetime">'_</span>&gt;],
    ) -&gt; Poll&lt;io::Result&lt;usize&gt;&gt; {
        <span class="kw">if </span><span class="self">self</span>.inner.is_write_vectored() {
            <span class="kw">let </span>total_len = bufs
                .iter()
                .fold(<span class="number">0usize</span>, |acc, b| acc.saturating_add(b.len()));
            <span class="kw">if </span>total_len &gt; <span class="self">self</span>.buf.capacity() - <span class="self">self</span>.buf.len() {
                <span class="macro">ready!</span>(<span class="self">self</span>.as_mut().flush_buf(cx))<span class="question-mark">?</span>;
            }
            <span class="kw">let </span>me = <span class="self">self</span>.as_mut().project();
            <span class="kw">if </span>total_len &gt;= me.buf.capacity() {
                <span class="comment">// It's more efficient to pass the slices directly to the
                // underlying writer than to buffer them.
                // The case when the total_len calculation saturates at
                // usize::MAX is also handled here.
                </span>me.inner.poll_write_vectored(cx, bufs)
            } <span class="kw">else </span>{
                bufs.iter().for_each(|b| me.buf.extend_from_slice(b));
                Poll::Ready(<span class="prelude-val">Ok</span>(total_len))
            }
        } <span class="kw">else </span>{
            <span class="comment">// Remove empty buffers at the beginning of bufs.
            </span><span class="kw">while </span>bufs.first().map(|buf| buf.len()) == <span class="prelude-val">Some</span>(<span class="number">0</span>) {
                bufs = <span class="kw-2">&amp;</span>bufs[<span class="number">1</span>..];
            }
            <span class="kw">if </span>bufs.is_empty() {
                <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Ok</span>(<span class="number">0</span>));
            }
            <span class="comment">// Flush if the first buffer doesn't fit.
            </span><span class="kw">let </span>first_len = bufs[<span class="number">0</span>].len();
            <span class="kw">if </span>first_len &gt; <span class="self">self</span>.buf.capacity() - <span class="self">self</span>.buf.len() {
                <span class="macro">ready!</span>(<span class="self">self</span>.as_mut().flush_buf(cx))<span class="question-mark">?</span>;
                <span class="macro">debug_assert!</span>(<span class="self">self</span>.buf.is_empty());
            }
            <span class="kw">let </span>me = <span class="self">self</span>.as_mut().project();
            <span class="kw">if </span>first_len &gt;= me.buf.capacity() {
                <span class="comment">// The slice is at least as large as the buffering capacity,
                // so it's better to write it directly, bypassing the buffer.
                </span><span class="macro">debug_assert!</span>(me.buf.is_empty());
                <span class="kw">return </span>me.inner.poll_write(cx, <span class="kw-2">&amp;</span>bufs[<span class="number">0</span>]);
            } <span class="kw">else </span>{
                me.buf.extend_from_slice(<span class="kw-2">&amp;</span>bufs[<span class="number">0</span>]);
                bufs = <span class="kw-2">&amp;</span>bufs[<span class="number">1</span>..];
            }
            <span class="kw">let </span><span class="kw-2">mut </span>total_written = first_len;
            <span class="macro">debug_assert!</span>(total_written != <span class="number">0</span>);
            <span class="comment">// Append the buffers that fit in the internal buffer.
            </span><span class="kw">for </span>buf <span class="kw">in </span>bufs {
                <span class="kw">if </span>buf.len() &gt; me.buf.capacity() - me.buf.len() {
                    <span class="kw">break</span>;
                } <span class="kw">else </span>{
            ...
            Poll::Ready(<span class="prelude-val">Ok</span>(total_written))
        }
    }
...
/// Seeking always writes out the internal buffer before seeking.
</span><span class="kw">impl</span>&lt;W: AsyncWrite + AsyncSeek&gt; AsyncSeek <span class="kw">for </span>BufWriter&lt;W&gt; {
    <span class="kw">fn </span>start_seek(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, pos: SeekFrom) -&gt; io::Result&lt;()&gt; {
        <span class="comment">// We need to flush the internal buffer before seeking.
    ...
    <span class="kw">fn </span>poll_complete(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;u64&gt;&gt; {
        <span class="kw">let </span>pos = <span class="kw">match </span><span class="self">self</span>.seek_state {
            SeekState::Init =&gt; {
                <span class="kw">return </span><span class="self">self</span>.project().inner.poll_complete(cx);
            }
            SeekState::Start(pos) =&gt; <span class="prelude-val">Some</span>(pos),
            SeekState::Pending =&gt; <span class="prelude-val">None</span>,
        };

        <span class="comment">// Flush the internal buffer before seeking.
        </span><span class="macro">ready!</span>(<span class="self">self</span>.as_mut().flush_buf(cx))<span class="question-mark">?</span>;

        <span class="kw">let </span><span class="kw-2">mut </span>me = <span class="self">self</span>.project();
        <span class="kw">if let </span><span class="prelude-val">Some</span>(pos) = pos {
            <span class="comment">// Ensure previous seeks have finished before starting a new one
            </span><span class="macro">ready!</span>(me.inner.as_mut().poll_complete(cx))<span class="question-mark">?</span>;
            <span class="kw">if let </span><span class="prelude-val">Err</span>(e) = me.inner.as_mut().start_seek(pos) {
                <span class="kw-2">*</span>me.seek_state = SeekState::Init;
                <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Err</span>(e));
            }
        }
        <span class="kw">match </span>me.inner.poll_complete(cx) {
            Poll::Ready(res) =&gt; {
                <span class="kw-2">*</span>me.seek_state = SeekState::Init;
                Poll::Ready(res)
            }
            Poll::Pending =&gt; {
                <span class="kw-2">*</span>me.seek_state = SeekState::Pending;
                Poll::Pending
            }
        }
    }
...
<span class="kw">impl</span>&lt;W: AsyncWrite + AsyncRead&gt; AsyncRead <span class="kw">for </span>BufWriter&lt;W&gt; {
    <span class="kw">fn </span>poll_read(
        ...
        <span class="self">self</span>.get_pin_mut().poll_read(cx, buf)
    }
}

<span class="kw">impl</span>&lt;W: AsyncWrite + AsyncBufRead&gt; AsyncBufRead <span class="kw">for </span>BufWriter&lt;W&gt; {
    ...
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"BufWriter"</span>)
            ...
            .field(
                ...
                <span class="kw-2">&amp;</span><span class="macro">format_args!</span>(<span class="string">"{}/{}"</span>, <span class="self">self</span>.buf.len(), <span class="self">self</span>.buf.capacity()),
            )
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">crate</span>::is_unpin::&lt;BufWriter&lt;()&gt;&gt;();
    }
}
