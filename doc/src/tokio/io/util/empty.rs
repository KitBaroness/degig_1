...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::util::poll_proceed_and_make_progress;
<span class="kw">use </span><span class="kw">crate</span>::io::{AsyncBufRead, AsyncRead, AsyncWrite, ReadBuf};
...
<span class="macro">cfg_io_util!</span> {
    <span class="doccomment">/// `Empty` ignores any data written via [`AsyncWrite`], and will always be empty
    ...
    <span class="doccomment">/// Creates a value that is always at EOF for reads, and ignores all data written.
    ///
    ...
    /// }
    /// ```
    </span><span class="kw">pub fn </span>empty() -&gt; Empty {
        Empty { _p: () }
    }
}

<span class="kw">impl </span>AsyncRead <span class="kw">for </span>Empty {
    <span class="attr">#[inline]
        ...
        <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>ReadBuf&lt;<span class="lifetime">'_</span>&gt;,
    ) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        <span class="macro">ready!</span>(<span class="kw">crate</span>::trace::trace_leaf(cx));
        <span class="macro">ready!</span>(poll_proceed_and_make_progress(cx));
        Poll::Ready(<span class="prelude-val">Ok</span>(()))
    }
}

<span class="kw">impl </span>AsyncBufRead <span class="kw">for </span>Empty {
    <span class="attr">#[inline]
        ...
        <span class="macro">ready!</span>(<span class="kw">crate</span>::trace::trace_leaf(cx));
        <span class="macro">ready!</span>(poll_proceed_and_make_progress(cx));
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="kw-2">&amp;</span>[]))
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>consume(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: usize) {}
}

<span class="kw">impl </span>AsyncWrite <span class="kw">for </span>Empty {
    <span class="attr">#[inline]
    ...
    <span class="attr">#[inline]
        ...
        <span class="macro">ready!</span>(<span class="kw">crate</span>::trace::trace_leaf(cx));
        <span class="macro">ready!</span>(poll_proceed_and_make_progress(cx));
        <span class="kw">let </span>num_bytes = bufs.iter().map(|b| b.len()).sum();
        Poll::Ready(<span class="prelude-val">Ok</span>(num_bytes))
    }
}

<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Empty {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"Empty { .. }"</span>)
    }
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">crate</span>::is_unpin::&lt;Empty&gt;();
    }
}
