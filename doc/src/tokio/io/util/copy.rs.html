...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::{AsyncRead, AsyncWrite, ReadBuf};
...
<span class="kw">impl </span>CopyBuffer {
    ...
    <span class="kw">fn </span>poll_fill_buf&lt;R&gt;(
        ...
        </span>R: AsyncRead + <span class="question-mark">?</span>Sized,
    {
        ...
        <span class="kw">let </span>res = reader.poll_read(cx, <span class="kw-2">&amp;mut </span>buf);
        <span class="kw">if let </span>Poll::Ready(<span class="prelude-val">Ok</span>(())) = res {
            <span class="kw">let </span>filled_len = buf.filled().len();
    ...
    <span class="kw">fn </span>poll_write_buf&lt;R, W&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
    ...
    {
        <span class="kw">let </span>me = <span class="kw-2">&amp;mut *</span><span class="self">self</span>;
        <span class="kw">match </span>writer.as_mut().poll_write(cx, <span class="kw-2">&amp;</span>me.buf[me.pos..me.cap]) {
            Poll::Pending =&gt; {
                <span class="comment">// Top up the buffer towards full if we can read a bit more
                // data - this should improve the chances of a large write
                </span><span class="kw">if </span>!me.read_done &amp;&amp; me.cap &lt; me.buf.len() {
                    <span class="macro">ready!</span>(me.poll_fill_buf(cx, reader.as_mut()))<span class="question-mark">?</span>;
                }
                Poll::Pending
            }
            res =&gt; res,
        ...
        W: AsyncWrite + <span class="question-mark">?</span>Sized,
    {
        ...
        </span><span class="comment">// Keep track of task budget
        ...
        <span class="kw">loop </span>{
            ...
            // continue.
                ...
                <span class="kw">match </span><span class="self">self</span>.poll_fill_buf(cx, reader.as_mut()) {
            ...
            <span class="comment">// If our buffer has some data, let's write it out!
                ...
                <span class="kw">let </span>i = <span class="macro">ready!</span>(<span class="self">self</span>.poll_write_buf(cx, reader.as_mut(), writer.as_mut()))<span class="question-mark">?</span>;
                <span class="attr">#[cfg(any(
                    feature = <span class="string">"fs"</span>,
                    feature = <span class="string">"io-std"</span>,
                    feature = <span class="string">"net"</span>,
