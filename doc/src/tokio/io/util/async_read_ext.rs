...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::util::chain::{chain, Chain};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read::{read, Read};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_buf::{read_buf, ReadBuf};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_exact::{read_exact, ReadExact};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_int::{ReadF32, ReadF32Le, ReadF64, ReadF64Le};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_int::{
...
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_to_end::{read_to_end, ReadToEnd};
<span class="kw">use </span><span class="kw">crate</span>::io::util::read_to_string::{read_to_string, ReadToString};
<span class="kw">use </span><span class="kw">crate</span>::io::util::take::{take, Take};
...
<span class="macro">cfg_io_util!</span> {
    <span class="doccomment">/// Defines numeric reader
    </span><span class="macro">macro_rules!</span> read_impl {
        (
            $(
                $(<span class="attr">#[<span class="macro-nonterminal">$outer</span>:meta]</span>)*
                <span class="kw">fn </span><span class="macro-nonterminal">$name</span>:ident(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; $(<span class="macro-nonterminal">$fut</span>:ident)<span class="kw-2">*</span>;
            )*
        ) =&gt; {
            $(
                $(<span class="attr">#[<span class="macro-nonterminal">$outer</span>]</span>)*
                <span class="kw">fn </span><span class="macro-nonterminal">$name</span>(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; $(<span class="macro-nonterminal">$fut</span>)<span class="kw-2">*</span>&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt; <span class="kw">where </span><span class="self">Self</span>: Unpin {
                    $(<span class="macro-nonterminal">$fut</span>)<span class="kw-2">*</span>::new(<span class="self">self</span>)
                }
            )*
        }
    }
    ...
    /// [`AsyncRead`]: AsyncRead
        ...
        <span class="doccomment">/// Creates a new `AsyncRead` instance that chains this stream with
        /// `next`.
        ///
        ...
        <span class="kw">where
            ...
            R: AsyncRead,
        {
            chain(<span class="self">self</span>, next)
        }

        <span class="doccomment">/// Pulls some bytes from this source into the specified buffer,
        ...
        {
            read(<span class="self">self</span>, buf)
        }
        ...
        /// }
        /// ```
        </span><span class="kw">fn </span>read_buf&lt;<span class="lifetime">'a</span>, B&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>B) -&gt; ReadBuf&lt;<span class="lifetime">'a</span>, <span class="self">Self</span>, B&gt;
        <span class="kw">where
            </span><span class="self">Self</span>: Unpin,
            B: BufMut + <span class="question-mark">?</span>Sized,
        {
            read_buf(<span class="self">self</span>, buf)
        }

        <span class="doccomment">/// Reads the exact number of bytes required to fill `buf`.
        ///
        /// Equivalent to:
        ///
        /// ```ignore
        ...
        {
            read_exact(<span class="self">self</span>, buf)
        }

        <span class="macro">read_impl!</span> {
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u8(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU8;
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i8(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI8;

            <span class="doccomment">/// Reads an unsigned 16-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u16(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU16;

            <span class="doccomment">/// Reads a signed 16-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i16(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI16;

            <span class="doccomment">/// Reads an unsigned 32-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU32;

            <span class="doccomment">/// Reads a signed 32-bit integer in big-endian order from the
            /// underlying reader.
            ///
            ///
            /// Equivalent to:
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI32;

            <span class="doccomment">/// Reads an unsigned 64-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u64(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU64;

            <span class="doccomment">/// Reads an signed 64-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i64(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI64;

            <span class="doccomment">/// Reads an unsigned 128-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u128(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU128;

            <span class="doccomment">/// Reads an signed 128-bit integer in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i128(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI128;

            <span class="doccomment">/// Reads an 32-bit floating point type in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_f32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadF32;

            <span class="doccomment">/// Reads an 64-bit floating point type in big-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_f64(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadF64;

            <span class="doccomment">/// Reads an unsigned 16-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u16_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU16Le;

            <span class="doccomment">/// Reads a signed 16-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i16_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI16Le;

            <span class="doccomment">/// Reads an unsigned 32-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u32_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU32Le;

            <span class="doccomment">/// Reads a signed 32-bit integer in little-endian order from the
            /// underlying reader.
            ///
            ///
            /// Equivalent to:
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i32_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI32Le;

            <span class="doccomment">/// Reads an unsigned 64-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u64_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU64Le;

            <span class="doccomment">/// Reads an signed 64-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i64_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI64Le;

            <span class="doccomment">/// Reads an unsigned 128-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_u128_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadU128Le;

            <span class="doccomment">/// Reads an signed 128-bit integer in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_i128_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadI128Le;

            <span class="doccomment">/// Reads an 32-bit floating point type in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_f32_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadF32Le;

            <span class="doccomment">/// Reads an 64-bit floating point type in little-endian order from the
            /// underlying reader.
            ///
            /// Equivalent to:
            ///
            ...
            /// }
            /// ```
            </span><span class="kw">fn </span>read_f64_le(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; ReadF64Le;
        }

        <span class="doccomment">/// Reads all bytes until EOF in this source, placing them into `buf`.
        ///
        /// Equivalent to:
        ///
        /// ```ignore
        ...
        {
            read_to_end(<span class="self">self</span>, buf)
        }

        <span class="doccomment">/// Reads all bytes until EOF in this source, appending them to `buf`.
        ///
        /// Equivalent to:
        ///
        /// ```ignore
        ...
        </span><span class="kw">fn </span>read_to_string&lt;<span class="lifetime">'a</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span><span class="self">self</span>, dst: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>String) -&gt; ReadToString&lt;<span class="lifetime">'a</span>, <span class="self">Self</span>&gt;
        <span class="kw">where
            </span><span class="self">Self</span>: Unpin,
        {
            read_to_string(<span class="self">self</span>, dst)
        }

        <span class="doccomment">/// Creates an adaptor which reads at most `limit` bytes from it.
        ///
        ...
        {
            take(<span class="self">self</span>, limit)
        }
    }
}
