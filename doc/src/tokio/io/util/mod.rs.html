...
<a href="#111" id="111">111</a>
</pre></div><pre class="rust"><code><span class="attr">#![allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
    ...
    <span class="kw">pub use </span>copy_bidirectional::copy_bidirectional;
    ...
    <span class="kw">pub use </span>mem::{duplex, DuplexStream};
