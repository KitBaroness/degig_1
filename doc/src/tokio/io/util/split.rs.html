...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::util::read_until::read_until_internal;
...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Splitter for the [`split`](crate::io::AsyncBufReadExt::split) method.
    ///
    ...
    </span><span class="kw">pub struct </span>Split&lt;R&gt; {
        <span class="attr">#[pin]
        </span>reader: R,
        buf: Vec&lt;u8&gt;,
        delim: u8,
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>split&lt;R&gt;(reader: R, delim: u8) -&gt; Split&lt;R&gt;
<span class="kw">where
    </span>R: AsyncBufRead,
{
    Split {
...
<span class="kw">impl</span>&lt;R&gt; Split&lt;R&gt;
<span class="kw">where
    </span>R: AsyncBufRead + Unpin,
{
    <span class="doccomment">/// Returns the next segment in the stream.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # }
    /// ```
    </span><span class="kw">pub async fn </span>next_segment(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; io::Result&lt;<span class="prelude-ty">Option</span>&lt;Vec&lt;u8&gt;&gt;&gt; {
        <span class="kw">use </span><span class="kw">crate</span>::future::poll_fn;

        poll_fn(|cx| Pin::new(<span class="kw-2">&amp;mut *</span><span class="self">self</span>).poll_next_segment(cx)).<span class="kw">await
    </span>}
}
...
{
    <span class="doccomment">/// Polls for the next segment in the stream.
    ///
    /// This method returns:
    ///
    ...
    /// receive a wakeup.
    </span><span class="kw">pub fn </span>poll_next_segment(
        <span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
    ) -&gt; Poll&lt;io::Result&lt;<span class="prelude-ty">Option</span>&lt;Vec&lt;u8&gt;&gt;&gt;&gt; {
        <span class="kw">let </span>me = <span class="self">self</span>.project();

        <span class="kw">let </span>n = <span class="macro">ready!</span>(read_until_internal(
            me.reader, cx, <span class="kw-2">*</span>me.delim, me.buf, me.read,
        ))<span class="question-mark">?</span>;
        <span class="comment">// read_until_internal resets me.read to zero once it finds the delimiter
        </span><span class="macro">debug_assert_eq!</span>(<span class="kw-2">*</span>me.read, <span class="number">0</span>);
        ...
        <span class="kw">if </span>me.buf.last() == <span class="prelude-val">Some</span>(me.delim) {
            me.buf.pop();
        }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">crate</span>::is_unpin::&lt;Split&lt;()&gt;&gt;();
    }
}
