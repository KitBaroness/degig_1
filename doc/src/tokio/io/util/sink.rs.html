...
<span class="macro">cfg_io_util!</span> {
    <span class="doccomment">/// An async writer which will move data into the void.
    ///
    ...
    <span class="doccomment">/// Creates an instance of an async writer which will successfully consume all
    /// data.
    ///
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">crate</span>::is_unpin::&lt;Sink&gt;();
    }
}
