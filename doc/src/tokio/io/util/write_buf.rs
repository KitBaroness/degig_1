...
<span class="macro">pin_project!</span> {
    ...
    </span><span class="kw">pub struct </span>WriteBuf&lt;<span class="lifetime">'a</span>, W, B&gt; {
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>write_buf&lt;<span class="lifetime">'a</span>, W, B&gt;(writer: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>W, buf: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>B) -&gt; WriteBuf&lt;<span class="lifetime">'a</span>, W, B&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;W, B&gt; Future <span class="kw">for </span>WriteBuf&lt;<span class="lifetime">'_</span>, W, B&gt;
<span class="kw">where
    </span>W: AsyncWrite + Unpin,
    B: Buf,
{
    ...
    <span class="kw">fn </span>poll(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;usize&gt;&gt; {
        ...
        <span class="kw">if </span>!me.buf.has_remaining() {
            <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Ok</span>(<span class="number">0</span>));
        }

        <span class="kw">let </span>n = <span class="macro">ready!</span>(Pin::new(me.writer).poll_write(cx, me.buf.chunk()))<span class="question-mark">?</span>;
        me.buf.advance(n);
