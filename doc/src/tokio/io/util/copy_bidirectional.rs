...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::copy::CopyBuffer;
...
<span class="kw">where
    ...
    B: AsyncRead + AsyncWrite + Unpin + <span class="question-mark">?</span>Sized,
{
    <span class="kw">let </span><span class="kw-2">mut </span>a_to_b = TransferState::Running(CopyBuffer::new());
    <span class="kw">let </span><span class="kw-2">mut </span>b_to_a = TransferState::Running(CopyBuffer::new());
    poll_fn(|cx| {
        <span class="kw">let </span>a_to_b = transfer_one_direction(cx, <span class="kw-2">&amp;mut </span>a_to_b, a, b)<span class="question-mark">?</span>;
        <span class="kw">let </span>b_to_a = transfer_one_direction(cx, <span class="kw-2">&amp;mut </span>b_to_a, b, a)<span class="question-mark">?</span>;
