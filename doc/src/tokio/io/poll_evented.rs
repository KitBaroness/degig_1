...
<span class="kw">use </span><span class="kw">crate</span>::runtime::io::Registration;
...
<span class="comment">// ===== impl PollEvented =====
    ...
    #[cfg_attr(feature = <span class="string">"signal"</span>, allow(unused))]
    ...
    #[cfg_attr(feature = <span class="string">"signal"</span>, allow(unused))]
        ...
        <span class="self">Self</span>::new_with_interest_and_handle(io, interest, scheduler::Handle::current())
    }
    ...
    </span><span class="attr">#[cfg(any(feature = <span class="string">"net"</span>, feature = <span class="string">"process"</span>))]
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>poll_read_ready(<span class="kw-2">&amp;</span><span class="self">self</span>, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        <span class="self">self</span>.registration
            .poll_read_ready(cx)
            .map_err(io::Error::from)
            .map_ok(|<span class="kw">_</span>| ())
    }

    <span class="doccomment">/// Re-register under new runtime with `interest`.
    </span><span class="attr">#[cfg(all(feature = <span class="string">"process"</span>, target_os = <span class="string">"linux"</span>))]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>reregister(<span class="kw-2">&amp;mut </span><span class="self">self</span>, interest: Interest) -&gt; io::Result&lt;()&gt; {
        <span class="kw">let </span>io = <span class="self">self</span>.io.as_mut().unwrap(); <span class="comment">// As io shouldn't ever be None, just unwrap here.
        </span><span class="kw">let _ </span>= <span class="self">self</span>.registration.deregister(io);
        <span class="self">self</span>.registration =
            Registration::new_with_interest_and_handle(io, interest, scheduler::Handle::current())<span class="question-mark">?</span>;
...
<span class="macro">feature!</span> {
    <span class="attr">#![any(feature = <span class="string">"net"</span>, all(unix, feature = <span class="string">"process"</span>))]
    ...
    <span class="kw">impl</span>&lt;E: Source&gt; PollEvented&lt;E&gt; {
            ...
            </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>E: io::Read + <span class="lifetime">'a</span>,
        {
            ...
            <span class="kw">loop </span>{
                <span class="kw">let </span>evt = <span class="macro">ready!</span>(<span class="self">self</span>.registration.poll_read_ready(cx))<span class="question-mark">?</span>;
                ...
                <span class="kw">match </span><span class="self">self</span>.io.as_ref().unwrap().read(b) {
                    <span class="prelude-val">Ok</span>(n) =&gt; {
                        <span class="comment">// if we read a partially full buffer, this is sufficient on unix to show
                        ...
                        </span><span class="kw">if </span>n &gt; <span class="number">0 </span>&amp;&amp; (!<span class="macro">cfg!</span>(windows) &amp;&amp; !<span class="macro">cfg!</span>(mio_unsupported_force_poll_poll) &amp;&amp; n &lt; len) {
                            <span class="self">self</span>.registration.clear_readiness(evt);
                        }
            ...
            </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>E: io::Write + <span class="lifetime">'a</span>,
        {
            ...
            <span class="kw">loop </span>{
                <span class="kw">let </span>evt = <span class="macro">ready!</span>(<span class="self">self</span>.registration.poll_write_ready(cx))<span class="question-mark">?</span>;

                <span class="kw">match </span><span class="self">self</span>.io.as_ref().unwrap().write(buf) {
                    <span class="prelude-val">Ok</span>(n) =&gt; {
                        <span class="comment">// if we write only part of our buffer, this is sufficient on unix to show
                        // that the socket buffer is full.  Unfortunately this assumption
                        // fails for level-triggered selectors (like on Windows or poll even for
                        // UNIX): https://github.com/tokio-rs/tokio/issues/5866
                        </span><span class="kw">if </span>n &gt; <span class="number">0 </span>&amp;&amp; (!<span class="macro">cfg!</span>(windows) &amp;&amp; !<span class="macro">cfg!</span>(mio_unsupported_force_poll_poll) &amp;&amp; n &lt; buf.len()) {
                            <span class="self">self</span>.registration.clear_readiness(evt);
                        }
