...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io::{Interest, Ready};
...
/// [`AsyncWrite`]: trait@crate::io::AsyncWrite
    ...
    <span class="comment">// The inner value is always present. the Option is required for `drop` and `into_inner`.
    // In all other methods `unwrap` is valid, and will never panic.
    </span>inner: <span class="prelude-ty">Option</span>&lt;T&gt;,
}
...
</span><span class="attr">#[must_use = <span class="string">"You must explicitly choose whether to clear the readiness state by calling a method on ReadyGuard"</span>]
...
<span class="kw">impl</span>&lt;T: AsRawFd&gt; AsyncFd&lt;T&gt; {
    ...
    {
        <span class="self">Self</span>::with_interest(inner, Interest::READABLE | Interest::WRITABLE)
    }
    ...
    <span class="attr">#[track_caller]
        ...
        <span class="self">Self</span>::try_new_with_handle_and_interest(inner, handle, interest).map_err(Into::into)
    }
    ...
    #[track_caller]
    </span><span class="kw">pub fn </span>try_new(inner: T) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, AsyncFdTryNewError&lt;T&gt;&gt;
    <span class="kw">where
        </span>T: AsRawFd,
    {
        <span class="self">Self</span>::try_with_interest(inner, Interest::READABLE | Interest::WRITABLE)
    }
    ...
    #[track_caller]
    </span><span class="kw">pub fn </span>try_with_interest(inner: T, interest: Interest) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, AsyncFdTryNewError&lt;T&gt;&gt;
    <span class="kw">where
        </span>T: AsRawFd,
    {
        <span class="self">Self</span>::try_new_with_handle_and_interest(inner, scheduler::Handle::current(), interest)
    }

    <span class="attr">#[track_caller]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>try_new_with_handle_and_interest(
        inner: T,
        handle: scheduler::Handle,
        interest: Interest,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, AsyncFdTryNewError&lt;T&gt;&gt; {
        <span class="kw">let </span>fd = inner.as_raw_fd();

        <span class="kw">match </span>Registration::new_with_interest_and_handle(<span class="kw-2">&amp;mut </span>SourceFd(<span class="kw-2">&amp;</span>fd), interest, handle) {
            <span class="prelude-val">Ok</span>(registration) =&gt; <span class="prelude-val">Ok</span>(AsyncFd {
                registration,
                inner: <span class="prelude-val">Some</span>(inner),
            }),
            <span class="prelude-val">Err</span>(cause) =&gt; <span class="prelude-val">Err</span>(AsyncFdTryNewError { inner, cause }),
        }
    }
    ...
    <span class="kw">fn </span>take_inner(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;T&gt; {
        <span class="kw">let </span>inner = <span class="self">self</span>.inner.take()<span class="question-mark">?</span>;
        <span class="kw">let </span>fd = inner.as_raw_fd();
        ...
        <span class="prelude-val">Some</span>(inner)
    }
    ...
    /// [`Waker::wake`]: method@std::task::Waker::wake
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(AsyncFdReadyGuard {
    ...
    /// [`Waker::wake`]: method@std::task::Waker::wake
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(AsyncFdReadyMutGuard {
            async_fd: <span class="self">self</span>,
            event: <span class="prelude-val">Some</span>(event),
        }))
    }
    ...
    <span class="doccomment">/// Waits for any of the requested ready states, returning a
    ...
    /// }
    /// ```
    </span><span class="kw">pub async fn </span>ready(<span class="kw-2">&amp;</span><span class="self">self</span>, interest: Interest) -&gt; io::Result&lt;AsyncFdReadyGuard&lt;<span class="lifetime">'_</span>, T&gt;&gt; {
    ...
    /// }
    /// ```
    </span><span class="kw">pub async fn </span>ready_mut(
    ...
    /// provides shared access to the inner IO resource when handling the
    /// [`AsyncFdReadyGuard`].
    </span><span class="attr">#[allow(clippy::needless_lifetimes)] </span><span class="comment">// The lifetime improves rustdoc rendering.
        ...
        <span class="self">self</span>.ready(Interest::READABLE).<span class="kw">await
    </span>}
    ...
    /// resource mutably when handling the [`AsyncFdReadyMutGuard`].
        ...
        <span class="self">self</span>.ready_mut(Interest::READABLE).<span class="kw">await
    </span>}
    ...
    /// [`AsyncFdReadyGuard`].
        ...
        <span class="self">self</span>.ready(Interest::WRITABLE).<span class="kw">await
    </span>}
    ...
    /// resource mutably when handling the [`AsyncFdReadyMutGuard`].
        ...
        <span class="self">self</span>.ready_mut(Interest::WRITABLE).<span class="kw">await
    </span>}
...
<span class="kw">impl</span>&lt;T: AsRawFd&gt; std::os::unix::io::AsFd <span class="kw">for </span>AsyncFd&lt;T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, Inner: AsRawFd&gt; AsyncFdReadyGuard&lt;<span class="lifetime">'a</span>, Inner&gt; {
    <span class="doccomment">/// Indicates to tokio that the file descriptor is no longer ready. All
    ...
    <span class="doccomment">/// Indicates to tokio that the file descriptor no longer has a specific readiness.
    ...
    /// }
    /// ```
    </span><span class="kw">pub fn </span>clear_ready_matching(<span class="kw-2">&amp;mut </span><span class="self">self</span>, ready: Ready) {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">mut </span>event) = <span class="self">self</span>.event.take() {
            <span class="self">self</span>.async_fd
                .registration
                .clear_readiness(event.with_ready(ready));

            <span class="comment">// the event is no longer ready for the readiness that was just cleared
            </span>event.ready = event.ready - ready;

            <span class="kw">if </span>!event.ready.is_empty() {
                <span class="self">self</span>.event = <span class="prelude-val">Some</span>(event);
            }
        }
    }
    ...
    <span class="doccomment">/// Get the [`Ready`] value associated with this guard.
    ///
    ...
    </span><span class="kw">pub fn </span>ready(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Ready {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.event {
            <span class="prelude-val">Some</span>(event) =&gt; event.ready,
            <span class="prelude-val">None </span>=&gt; Ready::EMPTY,
        }
    }
    ...
    /// [`WouldBlock`]: std::io::ErrorKind::WouldBlock
    ...
    </span><span class="attr">#[cfg_attr(docsrs, doc(alias = <span class="string">"with_io"</span>))]
        ...
        <span class="kw">match </span>result {
            <span class="prelude-val">Err</span>(err) <span class="kw">if </span>err.kind() == io::ErrorKind::WouldBlock =&gt; {
                ...
                <span class="prelude-val">Err</span>(TryIoError(()))
            }
...
<span class="doccomment">/// Error returned by [`try_new`] or [`try_with_interest`].
///
/// [`try_new`]: AsyncFd::try_new
/// [`try_with_interest`]: AsyncFd::try_with_interest
</span><span class="kw">pub struct </span>AsyncFdTryNewError&lt;T&gt; {
    inner: T,
    cause: io::Error,
}

<span class="kw">impl</span>&lt;T&gt; AsyncFdTryNewError&lt;T&gt; {
    <span class="doccomment">/// Returns the original object passed to [`try_new`] or [`try_with_interest`]
    /// alongside the error that caused these functions to fail.
    ///
    /// [`try_new`]: AsyncFd::try_new
    /// [`try_with_interest`]: AsyncFd::try_with_interest
    </span><span class="kw">pub fn </span>into_parts(<span class="self">self</span>) -&gt; (T, io::Error) {
        (<span class="self">self</span>.inner, <span class="self">self</span>.cause)
    }
}

<span class="kw">impl</span>&lt;T&gt; fmt::Display <span class="kw">for </span>AsyncFdTryNewError&lt;T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        fmt::Display::fmt(<span class="kw-2">&amp;</span><span class="self">self</span>.cause, f)
    }
}

<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>AsyncFdTryNewError&lt;T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        fmt::Debug::fmt(<span class="kw-2">&amp;</span><span class="self">self</span>.cause, f)
    }
}

<span class="kw">impl</span>&lt;T&gt; Error <span class="kw">for </span>AsyncFdTryNewError&lt;T&gt; {
    <span class="kw">fn </span>source(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>(<span class="kw">dyn </span>Error + <span class="lifetime">'static</span>)&gt; {
        <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span><span class="self">self</span>.cause)
    }
}

<span class="kw">impl</span>&lt;T&gt; From&lt;AsyncFdTryNewError&lt;T&gt;&gt; <span class="kw">for </span>io::Error {
    <span class="kw">fn </span>from(value: AsyncFdTryNewError&lt;T&gt;) -&gt; <span class="self">Self </span>{
        value.cause
    }
}
