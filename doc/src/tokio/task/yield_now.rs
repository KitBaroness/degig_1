...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::runtime::context;

<span class="kw">use </span>std::future::Future;
<span class="kw">use </span>std::pin::Pin;
<span class="kw">use </span>std::task::{Context, Poll};

<span class="doccomment">/// Yields execution back to the Tokio runtime.
///
...
/// [`tokio::select!`]: macro@crate::select
...
</span><span class="kw">pub async fn </span>yield_now() {
    <span class="doccomment">/// Yield implementation
    </span><span class="kw">struct </span>YieldNow {
        yielded: bool,
    }

    <span class="kw">impl </span>Future <span class="kw">for </span>YieldNow {
        ...
        <span class="kw">fn </span>poll(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;()&gt; {
            ...
            <span class="kw">if </span><span class="self">self</span>.yielded {
                <span class="kw">return </span>Poll::Ready(());
            }

            <span class="self">self</span>.yielded = <span class="bool-val">true</span>;
    ...
    YieldNow { yielded: <span class="bool-val">false </span>}.<span class="kw">await</span>;
}
