...
<span class="kw">impl </span>Processor {
    <span class="kw">fn </span>_process_initialize_mint(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>mint.is_initialized {
        ...
        mint.is_initialized = <span class="bool-val">true</span>;
        mint.freeze_authority = freeze_authority;

        Mint::pack(mint, <span class="kw-2">&amp;mut </span>mint_info.data.borrow_mut())<span class="question-mark">?</span>;
    ...
    <span class="kw">fn </span>_process_initialize_account(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>new_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>account.is_initialized() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AlreadyInUse.into());
        }
        ...
        <span class="kw">let </span>is_native_mint = <span class="self">Self</span>::cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span><span class="kw">crate</span>::native_mint::id());
        <span class="kw">if </span>!is_native_mint {
            <span class="self">Self</span>::check_account_owner(program_id, mint_info)<span class="question-mark">?</span>;
            <span class="kw">let _ </span>= Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow_mut())
                .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        }

        account.mint = <span class="kw-2">*</span>mint_info.key;
        account.owner = <span class="kw-2">*</span>owner;
        account.close_authority = COption::None;
        account.delegate = COption::None;
        account.delegated_amount = <span class="number">0</span>;
        ...
        <span class="kw">if </span>is_native_mint {
            ...
            account.amount = <span class="number">0</span>;
        };

        Account::pack(account, <span class="kw-2">&amp;mut </span>new_account_info.data.borrow_mut())<span class="question-mark">?</span>;
    ...
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
    ) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(program_id, accounts, <span class="prelude-val">None</span>, <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes an [InitializeAccount2](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account2(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        owner: Pubkey,
    ) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(program_id, accounts, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner), <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes an [InitializeAccount3](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account3(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        owner: Pubkey,
    ) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(program_id, accounts, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner), <span class="bool-val">false</span>)
    }
    ...
    <span class="kw">fn </span>_process_initialize_multisig(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>multisig = Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>multisig_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>multisig.is_initialized {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AlreadyInUse.into());
        }
        ...
        Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>multisig_info.data.borrow_mut())<span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Processes a [Transfer](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>source_account = Account::unpack(<span class="kw-2">&amp;</span>source_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>destination_account = Account::unpack(<span class="kw-2">&amp;</span>destination_account_info.data.borrow())<span class="question-mark">?</span>;

        <span class="kw">if </span>source_account.is_frozen() || destination_account.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }
        <span class="kw">if </span>source_account.amount &lt; amount {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
        }
        <span class="kw">if </span>!<span class="self">Self</span>::cmp_pubkeys(<span class="kw-2">&amp;</span>source_account.mint, <span class="kw-2">&amp;</span>destination_account.mint) {
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>((mint_info, expected_decimals)) = expected_mint_info {
            <span class="kw">if </span>!<span class="self">Self</span>::cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span>source_account.mint) {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
            }

            <span class="kw">let </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow_mut())<span class="question-mark">?</span>;
            <span class="kw">if </span>expected_decimals != mint.decimals {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into());
            }
        }

        <span class="kw">let </span>self_transfer =
            <span class="self">Self</span>::cmp_pubkeys(source_account_info.key, destination_account_info.key);

        <span class="kw">match </span>source_account.delegate {
            COption::Some(<span class="kw-2">ref </span>delegate) <span class="kw">if </span><span class="self">Self</span>::cmp_pubkeys(authority_info.key, delegate) =&gt; {
                ...
                <span class="kw">if </span>source_account.delegated_amount &lt; amount {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
                }
                <span class="kw">if </span>!self_transfer {
                    source_account.delegated_amount = source_account
                        ...
                        .checked_sub(amount)
                        .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
                    <span class="kw">if </span>source_account.delegated_amount == <span class="number">0 </span>{
                        source_account.delegate = COption::None;
                    }
                }
            }
            <span class="kw">_ </span>=&gt; <span class="self">Self</span>::validate_owner(
                program_id,
                <span class="kw-2">&amp;</span>source_account.owner,
                authority_info,
                account_info_iter.as_slice(),
            )<span class="question-mark">?</span>,
        };

        <span class="kw">if </span>self_transfer || amount == <span class="number">0 </span>{
            <span class="self">Self</span>::check_account_owner(program_id, source_account_info)<span class="question-mark">?</span>;
            <span class="self">Self</span>::check_account_owner(program_id, destination_account_info)<span class="question-mark">?</span>;
        }
        ...
        <span class="kw">if </span>source_account.is_native() {
        ...
        Account::pack(source_account, <span class="kw-2">&amp;mut </span>source_account_info.data.borrow_mut())<span class="question-mark">?</span>;
        Account::pack(
            destination_account,
            <span class="kw-2">&amp;mut </span>destination_account_info.data.borrow_mut(),
        )<span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Processes an [Approve](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">if </span>source_account.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }
        ...
        source_account.delegate = COption::Some(<span class="kw-2">*</span>delegate_info.key);
    ...
    <span class="doccomment">/// Processes an [Revoke](enum.TokenInstruction.html) instruction.
        ...
        source_account.delegate = COption::None;
        source_account.delegated_amount = <span class="number">0</span>;
    ...
    <span class="doccomment">/// Processes a [SetAuthority](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">if </span>account_info.data_len() == Account::get_packed_len() {
            <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack(<span class="kw-2">&amp;</span>account_info.data.borrow())<span class="question-mark">?</span>;

            <span class="kw">if </span>account.is_frozen() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
            }
            ...
            <span class="kw">match </span>authority_type {
                AuthorityType::AccountOwner =&gt; {
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>account.owner,
                        authority_info,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;

                    <span class="kw">if let </span>COption::Some(authority) = new_authority {
                    ...
                    <span class="kw">if </span>account.is_native() {
                        account.close_authority = COption::None;
                    }
                }
                AuthorityType::CloseAccount =&gt; {
                    <span class="kw">let </span>authority = account.close_authority.unwrap_or(account.owner);
                    <span class="self">Self</span>::validate_owner(
                        program_id,
            ...
            Account::pack(account, <span class="kw-2">&amp;mut </span>account_info.data.borrow_mut())<span class="question-mark">?</span>;
        } <span class="kw">else if </span>account_info.data_len() == Mint::get_packed_len() {
            <span class="kw">let </span><span class="kw-2">mut </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>account_info.data.borrow())<span class="question-mark">?</span>;
            <span class="kw">match </span>authority_type {
            ...
            Mint::pack(mint, <span class="kw-2">&amp;mut </span>account_info.data.borrow_mut())<span class="question-mark">?</span>;
        } <span class="kw">else </span>{
    ...
    <span class="doccomment">/// Processes a [MintTo](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>destination_account = Account::unpack(<span class="kw-2">&amp;</span>destination_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>destination_account.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }

        <span class="kw">if </span>destination_account.is_native() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NativeNotSupported.into());
        }
        <span class="kw">if </span>!<span class="self">Self</span>::cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span>destination_account.mint) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
        }

        <span class="kw">let </span><span class="kw-2">mut </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow())<span class="question-mark">?</span>;
        ...
        <span class="kw">match </span>mint.mint_authority {
            COption::Some(mint_authority) =&gt; <span class="self">Self</span>::validate_owner(
                program_id,
                <span class="kw-2">&amp;</span>mint_authority,
                owner_info,
                account_info_iter.as_slice(),
            )<span class="question-mark">?</span>,
            COption::None =&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::FixedSupply.into()),
        }
    ...
    <span class="doccomment">/// Processes a [Burn](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">if </span>!source_account.is_owned_by_system_program_or_incinerator() {
            <span class="kw">match </span>source_account.delegate {
                COption::Some(<span class="kw-2">ref </span>delegate) <span class="kw">if </span><span class="self">Self</span>::cmp_pubkeys(authority_info.key, delegate) =&gt; {
                    <span class="self">Self</span>::validate_owner(
                        program_id,
    ...
    <span class="doccomment">/// Processes a [CloseAccount](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">if </span><span class="self">Self</span>::cmp_pubkeys(source_account_info.key, destination_account_info.key) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::InvalidAccountData);
        }

        <span class="kw">let </span>source_account = Account::unpack(<span class="kw-2">&amp;</span>source_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>!source_account.is_native() &amp;&amp; source_account.amount != <span class="number">0 </span>{
    ...
    /// [ThawAccount](enum.TokenInstruction.html) instruction.
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>source_account = Account::unpack(<span class="kw-2">&amp;</span>source_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>freeze &amp;&amp; source_account.is_frozen() || !freeze &amp;&amp; !source_account.is_frozen() {
        ...
        <span class="kw">let </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow_mut())<span class="question-mark">?</span>;
        <span class="kw">match </span>mint.freeze_authority {
            COption::Some(authority) =&gt; <span class="self">Self</span>::validate_owner(
                program_id,
                <span class="kw-2">&amp;</span>authority,
                authority_info,
                account_info_iter.as_slice(),
            ),
            COption::None =&gt; <span class="prelude-val">Err</span>(TokenError::MintCannotFreeze.into()),
        }<span class="question-mark">?</span>;

        source_account.state = <span class="kw">if </span>freeze {
            AccountState::Frozen
        } <span class="kw">else </span>{
    ...
    </span><span class="kw">pub fn </span>process_sync_native(program_id: <span class="kw-2">&amp;</span>Pubkey, accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>native_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="self">Self</span>::check_account_owner(program_id, native_account_info)<span class="question-mark">?</span>;

        <span class="kw">let </span><span class="kw-2">mut </span>native_account = Account::unpack(<span class="kw-2">&amp;</span>native_account_info.data.borrow())<span class="question-mark">?</span>;

        <span class="kw">if let </span>COption::Some(rent_exempt_reserve) = native_account.is_native {
            <span class="kw">let </span>new_amount = native_account_info
                .lamports()
                .checked_sub(rent_exempt_reserve)
                .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
            <span class="kw">if </span>new_amount &lt; native_account.amount {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidState.into());
            }
            native_account.amount = new_amount;
        } <span class="kw">else </span>{
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NonNativeNotSupported.into());
        }

        Account::pack(native_account, <span class="kw-2">&amp;mut </span>native_account_info.data.borrow_mut())<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }
    ...
    <span class="doccomment">/// Processes a [GetAccountDataSize](enum.TokenInstruction.html) instruction
        ...
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="comment">// make sure the mint is valid
        </span><span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="self">Self</span>::check_account_owner(program_id, mint_info)<span class="question-mark">?</span>;
        <span class="kw">let _ </span>= Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow())
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        set_return_data(<span class="kw-2">&amp;</span>Account::LEN.to_le_bytes());
        <span class="prelude-val">Ok</span>(())
    }
    ...
    /// instruction
        ...
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>token_account_info.data.borrow())<span class="question-mark">?</span>;
        <span class="kw">if </span>account.is_initialized() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AlreadyInUse.into());
        }
        <span class="macro">msg!</span>(<span class="string">"Please upgrade to SPL Token 2022 for immutable owner support"</span>);
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [AmountToUiAmount](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_amount_to_ui_amount(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        amount: u64,
    ) -&gt; ProgramResult {
        ...
        <span class="kw">let </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow_mut())
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="kw">let </span>ui_amount = amount_to_ui_amount_string_trimmed(amount, mint.decimals);
    ...
    <span class="doccomment">/// Processes an [AmountToUiAmount](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_ui_amount_to_amount(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        ui_amount: <span class="kw-2">&amp;</span>str,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="self">Self</span>::check_account_owner(program_id, mint_info)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>mint = Mint::unpack(<span class="kw-2">&amp;</span>mint_info.data.borrow_mut())
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="kw">let </span>amount = try_ui_amount_into_amount(ui_amount.to_string(), mint.decimals)<span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Processes an [Instruction](enum.Instruction.html).
        ...
        <span class="kw">let </span>instruction = TokenInstruction::unpack(input)<span class="question-mark">?</span>;
        ...
        <span class="kw">match </span>instruction {
            TokenInstruction::InitializeMint {
                ...
                <span class="self">Self</span>::process_initialize_mint(accounts, decimals, mint_authority, freeze_authority)
            }
            TokenInstruction::InitializeMint2 {
                ...
                <span class="self">Self</span>::process_initialize_mint2(accounts, decimals, mint_authority, freeze_authority)
            }
            TokenInstruction::InitializeAccount =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount"</span>);
                <span class="self">Self</span>::process_initialize_account(program_id, accounts)
            }
            TokenInstruction::InitializeAccount2 { owner } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount2"</span>);
                <span class="self">Self</span>::process_initialize_account2(program_id, accounts, owner)
            }
            TokenInstruction::InitializeAccount3 { owner } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount3"</span>);
                <span class="self">Self</span>::process_initialize_account3(program_id, accounts, owner)
            }
            TokenInstruction::InitializeMultisig { m } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMultisig"</span>);
                <span class="self">Self</span>::process_initialize_multisig(accounts, m)
            }
            TokenInstruction::InitializeMultisig2 { m } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMultisig2"</span>);
                <span class="self">Self</span>::process_initialize_multisig2(accounts, m)
            }
            TokenInstruction::Transfer { amount } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: Transfer"</span>);
                <span class="self">Self</span>::process_transfer(program_id, accounts, amount, <span class="prelude-val">None</span>)
            }
            TokenInstruction::Approve { amount } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: Approve"</span>);
                <span class="self">Self</span>::process_approve(program_id, accounts, amount, <span class="prelude-val">None</span>)
            }
            ...
            TokenInstruction::SetAuthority {
                ...
                <span class="self">Self</span>::process_set_authority(program_id, accounts, authority_type, new_authority)
            }
            TokenInstruction::MintTo { amount } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: MintTo"</span>);
                <span class="self">Self</span>::process_mint_to(program_id, accounts, amount, <span class="prelude-val">None</span>)
            }
            TokenInstruction::Burn { amount } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: Burn"</span>);
                <span class="self">Self</span>::process_burn(program_id, accounts, amount, <span class="prelude-val">None</span>)
            }
            ...
            TokenInstruction::TransferChecked { amount, decimals } =&gt; {
                ...
                <span class="self">Self</span>::process_transfer(program_id, accounts, amount, <span class="prelude-val">Some</span>(decimals))
            }
            TokenInstruction::ApproveChecked { amount, decimals } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: ApproveChecked"</span>);
                <span class="self">Self</span>::process_approve(program_id, accounts, amount, <span class="prelude-val">Some</span>(decimals))
            }
            TokenInstruction::MintToChecked { amount, decimals } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: MintToChecked"</span>);
                <span class="self">Self</span>::process_mint_to(program_id, accounts, amount, <span class="prelude-val">Some</span>(decimals))
            }
            TokenInstruction::BurnChecked { amount, decimals } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: BurnChecked"</span>);
                <span class="self">Self</span>::process_burn(program_id, accounts, amount, <span class="prelude-val">Some</span>(decimals))
            }
            TokenInstruction::SyncNative =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: SyncNative"</span>);
                <span class="self">Self</span>::process_sync_native(program_id, accounts)
            }
            TokenInstruction::GetAccountDataSize =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: GetAccountDataSize"</span>);
                <span class="self">Self</span>::process_get_account_data_size(program_id, accounts)
            }
            ...
            TokenInstruction::AmountToUiAmount { amount } =&gt; {
                ...
                <span class="self">Self</span>::process_amount_to_ui_amount(program_id, accounts, amount)
            }
            TokenInstruction::UiAmountToAmount { ui_amount } =&gt; {
                <span class="macro">msg!</span>(<span class="string">"Instruction: UiAmountToAmount"</span>);
                <span class="self">Self</span>::process_ui_amount_to_amount(program_id, accounts, ui_amount)
            }
        }
    }

    <span class="doccomment">/// Checks that the account is owned by the expected program
    </span><span class="kw">pub fn </span>check_account_owner(program_id: <span class="kw-2">&amp;</span>Pubkey, account_info: <span class="kw-2">&amp;</span>AccountInfo) -&gt; ProgramResult {
        <span class="kw">if </span>!<span class="self">Self</span>::cmp_pubkeys(program_id, account_info.owner) {
    ...
    <span class="doccomment">/// Checks two pubkeys for equality in a computationally cheap way using
    /// `sol_memcmp`
    </span><span class="kw">pub fn </span>cmp_pubkeys(a: <span class="kw-2">&amp;</span>Pubkey, b: <span class="kw-2">&amp;</span>Pubkey) -&gt; bool {
        sol_memcmp(a.as_ref(), b.as_ref(), PUBKEY_BYTES) == <span class="number">0
    </span>}

    <span class="doccomment">/// Validates owner(s) are present
        ...
        <span class="kw">if </span>!<span class="self">Self</span>::cmp_pubkeys(expected_owner, owner_account_info.key) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into());
        }
        <span class="kw">if </span><span class="self">Self</span>::cmp_pubkeys(program_id, owner_account_info.owner)
            &amp;&amp; owner_account_info.data_len() == Multisig::get_packed_len()
        {
            <span class="kw">let </span>multisig = Multisig::unpack(<span class="kw-2">&amp;</span>owner_account_info.data.borrow())<span class="question-mark">?</span>;
            ...
            <span class="kw">for </span>signer <span class="kw">in </span>signers.iter() {
                <span class="kw">for </span>(position, key) <span class="kw">in </span>multisig.signers[<span class="number">0</span>..multisig.n <span class="kw">as </span>usize].iter().enumerate() {
                    <span class="kw">if </span><span class="self">Self</span>::cmp_pubkeys(key, signer.key) &amp;&amp; !matched[position] {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>{
        ...
        <span class="kw">crate</span>::instruction::<span class="kw-2">*</span>,
        serial_test::serial,
        solana_program::{
    ...
    <span class="kw">impl </span>solana_sdk::program_stubs::SyscallStubs <span class="kw">for </span>SyscallStubs {
        ...
        <span class="kw">fn </span>sol_get_clock_sysvar(<span class="kw-2">&amp;</span><span class="self">self</span>, _var_addr: <span class="kw-2">*mut </span>u8) -&gt; u64 {
        ...
        <span class="kw">fn </span>sol_set_return_data(<span class="kw-2">&amp;</span><span class="self">self</span>, data: <span class="kw-2">&amp;</span>[u8]) {
            <span class="macro">assert_eq!</span>(<span class="kw-2">&amp;*</span>EXPECTED_DATA.write().unwrap(), data)
        }
    }
    ...
    <span class="attr">#[test]
        ...
        <span class="comment">// Mint
        </span><span class="kw">let </span>check = Mint {
            mint_authority: COption::Some(Pubkey::new_from_array([<span class="number">1</span>; <span class="number">32</span>])),
            supply: <span class="number">42</span>,
            decimals: <span class="number">7</span>,
            is_initialized: <span class="bool-val">true</span>,
            freeze_authority: COption::Some(Pubkey::new_from_array([<span class="number">2</span>; <span class="number">32</span>])),
        };
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Mint::get_packed_len() + <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
            Mint::pack(check, <span class="kw-2">&amp;mut </span>packed)
        );
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Mint::get_packed_len() - <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Mint::get_packed_len()];
        Mint::pack(check, <span class="kw-2">&amp;mut </span>packed).unwrap();
        <span class="kw">let </span>expect = <span class="macro">vec!</span>[
            <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>,
            <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">42</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">7</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>,
            <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>,
        ];
        <span class="macro">assert_eq!</span>(packed, expect);
        <span class="kw">let </span>unpacked = Mint::unpack(<span class="kw-2">&amp;</span>packed).unwrap();
        <span class="macro">assert_eq!</span>(unpacked, check);

        <span class="comment">// Account
        </span><span class="kw">let </span>check = Account {
            mint: Pubkey::new_from_array([<span class="number">1</span>; <span class="number">32</span>]),
            owner: Pubkey::new_from_array([<span class="number">2</span>; <span class="number">32</span>]),
            amount: <span class="number">3</span>,
            delegate: COption::Some(Pubkey::new_from_array([<span class="number">4</span>; <span class="number">32</span>])),
            state: AccountState::Frozen,
            is_native: COption::Some(<span class="number">5</span>),
            delegated_amount: <span class="number">6</span>,
            close_authority: COption::Some(Pubkey::new_from_array([<span class="number">7</span>; <span class="number">32</span>])),
        };
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Account::get_packed_len() + <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
            Account::pack(check, <span class="kw-2">&amp;mut </span>packed)
        );
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Account::get_packed_len() - <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Account::get_packed_len()];
        Account::pack(check, <span class="kw-2">&amp;mut </span>packed).unwrap();
        <span class="kw">let </span>expect = <span class="macro">vec!</span>[
            <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>,
            <span class="number">1</span>, <span class="number">1</span>, <span class="number">1</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>,
            <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">2</span>, <span class="number">3</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>,
            <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">4</span>, <span class="number">2</span>, <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">5</span>, <span class="number">0</span>, <span class="number">0</span>,
            <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">6</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>,
            <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>, <span class="number">7</span>,
        ];
        <span class="macro">assert_eq!</span>(packed, expect);
        <span class="kw">let </span>unpacked = Account::unpack(<span class="kw-2">&amp;</span>packed).unwrap();
        <span class="macro">assert_eq!</span>(unpacked, check);

        <span class="comment">// Multisig
        </span><span class="kw">let </span>check = Multisig {
            m: <span class="number">1</span>,
            n: <span class="number">2</span>,
            is_initialized: <span class="bool-val">true</span>,
            signers: [Pubkey::new_from_array([<span class="number">3</span>; <span class="number">32</span>]); MAX_SIGNERS],
        };
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Multisig::get_packed_len() + <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
            Multisig::pack(check, <span class="kw-2">&amp;mut </span>packed)
        );
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Multisig::get_packed_len() - <span class="number">1</span>];
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>packed = <span class="macro">vec!</span>[<span class="number">0</span>; Multisig::get_packed_len()];
        Multisig::pack(check, <span class="kw-2">&amp;mut </span>packed).unwrap();
        <span class="kw">let </span>expect = <span class="macro">vec!</span>[
            <span class="number">1</span>, <span class="number">2</span>, <span class="number">1</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            ...
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
            <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>, <span class="number">3</span>,
        ];
        <span class="macro">assert_eq!</span>(packed, expect);
        <span class="kw">let </span>unpacked = Multisig::unpack(<span class="kw-2">&amp;</span>packed).unwrap();
        <span class="macro">assert_eq!</span>(unpacked, check);
    }
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId),
            do_process_instruction(
                transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">0</span>,).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner2_account,
        ...
        <span class="comment">// insufficient funds
            ...
            do_process_instruction(
                transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
        ...
        <span class="comment">// insufficient funds
            ...
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            account_info.key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_burn_and_close_system_and_incinerator_tokens() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>incinerator_account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>incinerator_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>system_account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>system_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>recipient_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>recipient_account = SolanaAccount::default();
        <span class="kw">let </span><span class="kw-2">mut </span>mock_incinerator_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        ...
        <span class="comment">// create account
            ...
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        <span class="comment">// create incinerator- and system-owned accounts
        </span>do_process_instruction(
            initialize_account3(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>incinerator_account_key,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>solana_program::incinerator::id(),
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>incinerator_account, <span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        do_process_instruction(
            initialize_account3(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>system_account_key,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>solana_program::system_program::id(),
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>system_account, <span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        ...
        <span class="comment">// transfer half to incinerator, half to system program
        </span>do_process_instruction(
            transfer(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
            ...
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>incinerator_account,
                <span class="kw-2">&amp;mut </span>owner_account,
            ],
        )
        .unwrap();
        do_process_instruction(
            ...
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>system_account,
                <span class="kw-2">&amp;mut </span>owner_account,
            ],
        )
        .unwrap();

        <span class="comment">// close with balance fails
        </span><span class="macro">assert_eq!</span>(
            ...
            do_process_instruction(
                ...
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>incinerator_account,
                    <span class="kw-2">&amp;mut </span>mock_incinerator_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                ],
            )
        );
        ...
        <span class="comment">// anyone can burn
        </span>do_process_instruction(
            burn(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>incinerator_account_key,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>recipient_key,
                <span class="kw-2">&amp;</span>[],
                <span class="number">500</span>,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>incinerator_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>recipient_account,
            ],
        )
        .unwrap();
        do_process_instruction(
        ...
        <span class="comment">// closing fails if destination is not the incinerator
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
            do_process_instruction(
                close_account(
        ...
        <span class="comment">// closing succeeds with incinerator recipient
        </span>do_process_instruction(
            close_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>incinerator_account_key,
    ...
    <span class="attr">#[test]
        ...
        </span>Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>signers).unwrap();
        ...
        Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>signers).unwrap();
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>signers)
        );
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>[])
        );
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>signers[<span class="number">0</span>..<span class="number">1</span>])
        );
        ...
        Processor::validate_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>owner_account_info, <span class="kw-2">&amp;</span>signers[<span class="number">5</span>..<span class="number">7</span>])
            .unwrap();
    ...
    #[serial]
        ...
        <span class="comment">// fail if an invalid mint is passed in
            ...
            <span class="prelude-val">Err</span>(TokenError::InvalidMint.into()),
            do_process_instruction(
                get_account_data_size(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_initialize_immutable_owner() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// success initialize immutable
        </span>do_process_instruction(
        ...
        <span class="comment">// fail post-init
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AlreadyInUse.into()),
            do_process_instruction(
                initialize_immutable_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key).unwrap(),
