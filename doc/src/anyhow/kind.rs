...
</pre></div><pre class="rust"><code><span class="comment">// Tagged dispatch mechanism for resolving the behavior of `anyhow!($expr)`.
//
...
</span><span class="kw">pub trait </span>AdhocKind: Sized {
...
<span class="kw">impl </span>Adhoc {
    ...
    </span><span class="kw">pub fn </span>new&lt;M&gt;(<span class="self">self</span>, message: M) -&gt; Error
    <span class="kw">where
...
<span class="attr">#[doc(hidden)]
</span><span class="kw">pub trait </span>TraitKind: Sized {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Trait {
    <span class="attr">#[cold]
    </span><span class="kw">pub fn </span>new&lt;E&gt;(<span class="self">self</span>, error: E) -&gt; Error
    <span class="kw">where
        </span>E: Into&lt;Error&gt;,
    {
        error.into()
...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
    ...
    <span class="attr">#[cold]
    </span><span class="kw">pub fn </span>new(<span class="self">self</span>, error: Box&lt;<span class="kw">dyn </span>StdError + Send + Sync&gt;) -&gt; Error {
