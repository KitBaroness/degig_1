...
</pre></div><pre class="rust"><code><span class="attr">#[cfg(std_backtrace)]
...
<span class="attr">#[cfg(error_generic_member_access)]
    ...
    (<span class="macro-nonterminal">$err</span>:expr) =&gt; {
        <span class="kw">match </span>std::error::request_ref::&lt;std::backtrace::Backtrace&gt;(<span class="macro-nonterminal">$err </span><span class="kw">as </span><span class="kw-2">&amp;</span><span class="kw">dyn </span>std::error::Error) {
...
<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, not(std_backtrace), not(feature = <span class="string">"backtrace"</span>)))]
</span><span class="macro">macro_rules!</span> backtrace_if_absent {
    (<span class="macro-nonterminal">$err</span>:expr) =&gt; {
        <span class="prelude-val">None
    </span>};
