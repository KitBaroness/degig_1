...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::error::ContextError;
...
<span class="kw">mod </span>ext {
        ...
        </span>E: std::error::Error + Send + Sync + <span class="lifetime">'static</span>,
    {
        ...
        {
            <span class="kw">let </span>backtrace = <span class="macro">backtrace_if_absent!</span>(<span class="kw-2">&amp;</span><span class="self">self</span>);
    ...
    </span>E: ext::StdError + Send + Sync + <span class="lifetime">'static</span>,
{
    ...
    {
        <span class="comment">// Not using map_err to save 2 useless frames off the captured backtrace
        // in ext_context.
            ...
            <span class="prelude-val">Err</span>(error) =&gt; <span class="prelude-val">Err</span>(error.ext_context(context)),
        }
    }
...
/// ```
    ...
    {
        <span class="comment">// Not using ok_or_else to save 2 useless frames off the captured
        // backtrace.
        </span><span class="kw">match </span><span class="self">self </span>{
            <span class="prelude-val">Some</span>(ok) =&gt; <span class="prelude-val">Ok</span>(ok),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">Err</span>(Error::from_display(context, <span class="macro">backtrace!</span>())),
        }
    }
    ...
    E: StdError + <span class="lifetime">'static</span>,
{
    ...
    <span class="attr">#[cfg(error_generic_member_access)]
        ...
        StdError::provide(<span class="kw-2">&amp;</span><span class="self">self</span>.error, request);
    }
}
    ...
    </span>C: Display,
{
    ...
    <span class="attr">#[cfg(error_generic_member_access)]
        ...
        Error::provide(<span class="kw-2">&amp;</span><span class="self">self</span>.error, request);
    }
}
