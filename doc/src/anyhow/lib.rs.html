...
</pre></div><pre class="rust"><code><span class="doccomment">//! [![github]](https://github.com/dtolnay/anyhow)&amp;ensp;[![crates-io]](https://crates.io/crates/anyhow)&amp;ensp;[![docs-rs]](https://docs.rs/anyhow)
//!
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/anyhow/1.0.82"</span>)]
...
<span class="comment">// Not public API. Referenced by macro-generated code.
    ...
    </span><span class="kw">pub use </span><span class="kw">crate</span>::ensure::{BothDebug, NotBothDebug};
    <span class="attr">#[doc(hidden)]
    </span><span class="kw">pub use </span>alloc::format;
    <span class="attr">#[doc(hidden)]
    </span><span class="kw">pub use </span>core::result::Result::Err;
    <span class="attr">#[doc(hidden)]
    </span><span class="kw">pub use </span>core::{concat, format_args, stringify};

    <span class="attr">#[doc(hidden)]
    </span><span class="kw">pub mod </span>kind {
        <span class="attr">#[doc(hidden)]
        </span><span class="kw">pub use </span><span class="kw">crate</span>::kind::{AdhocKind, TraitKind};
