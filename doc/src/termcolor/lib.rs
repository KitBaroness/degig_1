<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/termcolor-1.4.1/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="termcolor" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../termcolor/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="attr">#![deny(missing_debug_implementations, missing_docs)]
...
<span class="doccomment">/// This trait describes the behavior of writers that support colored output.
    ...
    <span class="doccomment">/// Set the current hyperlink of the writer.
    ///
    ...
    </span><span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, _link: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Returns true if and only if the underlying writer supports hyperlinks.
    ///
    /// This can be used to avoid generating hyperlink URIs unnecessarily.
    ///
    /// This defaults to `false`.
    </span><span class="kw">fn </span>supports_hyperlinks(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="bool-val">false
    </span>}
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized + WriteColor&gt; WriteColor <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>T {
    ...
    <span class="kw">fn </span>supports_hyperlinks(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        (<span class="kw-2">&amp;**</span><span class="self">self</span>).supports_hyperlinks()
    }
    ...
    <span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, link: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        (<span class="kw-2">&amp;mut **</span><span class="self">self</span>).set_hyperlink(link)
    }
...
<span class="kw">impl </span>WriteColor <span class="kw">for </span>StandardStream {
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.wtr.supports_hyperlinks()
    }
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, link: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="self">self</span>.wtr.set_hyperlink(link)
    }
...
<span class="kw">impl</span>&lt;W: io::Write&gt; WriteColor <span class="kw">for </span>WriterInner&lt;W&gt; {
    ...
    <span class="kw">fn </span>supports_hyperlinks(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            WriterInner::Ansi(<span class="kw">_</span>) =&gt; <span class="bool-val">true</span>,
            <span class="attr">#[cfg(windows)]
            </span>WriterInner::Windows { .. } =&gt; <span class="bool-val">false</span>,
        }
    }
    ...
    <span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, link: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            WriterInner::NoColor(<span class="kw-2">ref mut </span>wtr) =&gt; wtr.set_hyperlink(link),
            WriterInner::Ansi(<span class="kw-2">ref mut </span>wtr) =&gt; wtr.set_hyperlink(link),
            <span class="attr">#[cfg(windows)]
            </span>WriterInner::Windows { .. } =&gt; <span class="prelude-val">Ok</span>(()),
        }
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, W: io::Write&gt; WriteColor <span class="kw">for </span>WriterInnerLock&lt;<span class="lifetime">'a</span>, W&gt; {
    ...
    <span class="kw">fn </span>supports_hyperlinks(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            WriterInnerLock::Ansi(<span class="kw">_</span>) =&gt; <span class="bool-val">true</span>,
            <span class="attr">#[cfg(windows)]
            </span>WriterInnerLock::Windows { .. } =&gt; <span class="bool-val">false</span>,
        }
    }
    ...
    <span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, link: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            WriterInnerLock::Unreachable(<span class="kw">_</span>) =&gt; <span class="macro">unreachable!</span>(),
            WriterInnerLock::NoColor(<span class="kw-2">ref mut </span>wtr) =&gt; wtr.set_hyperlink(link),
            WriterInnerLock::Ansi(<span class="kw-2">ref mut </span>wtr) =&gt; wtr.set_hyperlink(link),
            <span class="attr">#[cfg(windows)]
            </span>WriterInnerLock::Windows { .. } =&gt; <span class="prelude-val">Ok</span>(()),
        }
    }
...
<span class="kw">impl </span>BufferWriter {
    ...
    /// occur.
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>sep) = <span class="self">self</span>.separator {
            <span class="kw">if </span><span class="self">self</span>.printed.load(Ordering::Relaxed) {
        ...
        <span class="self">self</span>.printed.store(<span class="bool-val">true</span>, Ordering::Relaxed);
        <span class="prelude-val">Ok</span>(())
    }
}
...
<span class="kw">impl </span>WriteColor <span class="kw">for </span>Buffer {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.<span class="number">0 </span>{
            ...
            BufferInner::Ansi(<span class="kw">_</span>) =&gt; <span class="bool-val">true</span>,
            <span class="attr">#[cfg(windows)]
            </span>BufferInner::Windows(<span class="kw">_</span>) =&gt; <span class="bool-val">false</span>,
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.<span class="number">0 </span>{
            BufferInner::NoColor(<span class="kw-2">ref mut </span>w) =&gt; w.set_hyperlink(link),
            BufferInner::Ansi(<span class="kw-2">ref mut </span>w) =&gt; w.set_hyperlink(link),
            <span class="attr">#[cfg(windows)]
            </span>BufferInner::Windows(<span class="kw-2">ref mut </span>w) =&gt; w.set_hyperlink(link),
        }
    }
...
<span class="kw">impl</span>&lt;W: io::Write&gt; WriteColor <span class="kw">for </span>NoColor&lt;W&gt; {
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw">_</span>: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="prelude-val">Ok</span>(())
    }
...
<span class="kw">impl</span>&lt;W: io::Write&gt; WriteColor <span class="kw">for </span>Ansi&lt;W&gt; {
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.write_str(<span class="string">"\x1B]8;;"</span>)<span class="question-mark">?</span>;
        <span class="kw">if let </span><span class="prelude-val">Some</span>(uri) = link.uri() {
            <span class="self">self</span>.write_all(uri)<span class="question-mark">?</span>;
        }
        <span class="self">self</span>.write_str(<span class="string">"\x1B\\"</span>)
    }
...
<span class="kw">impl </span>WriteColor <span class="kw">for </span>io::Sink {
    ...
    <span class="kw">fn </span>set_hyperlink(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw">_</span>: <span class="kw-2">&amp;</span>HyperlinkSpec) -&gt; io::Result&lt;()&gt; {
        <span class="prelude-val">Ok</span>(())
    }
...
<span class="doccomment">/// A hyperlink specification.
</span><span class="attr">#[derive(Clone, Debug)]
</span><span class="kw">pub struct </span>HyperlinkSpec&lt;<span class="lifetime">'a</span>&gt; {
    uri: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; HyperlinkSpec&lt;<span class="lifetime">'a</span>&gt; {
    <span class="doccomment">/// Creates a new hyperlink specification.
    </span><span class="kw">pub fn </span>open(uri: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]) -&gt; HyperlinkSpec&lt;<span class="lifetime">'a</span>&gt; {
        HyperlinkSpec { uri: <span class="prelude-val">Some</span>(uri) }
    }

    <span class="doccomment">/// Creates a hyperlink specification representing no hyperlink.
    </span><span class="kw">pub fn </span>close() -&gt; HyperlinkSpec&lt;<span class="lifetime">'a</span>&gt; {
        HyperlinkSpec { uri: <span class="prelude-val">None </span>}
    }

    <span class="doccomment">/// Returns the URI of the hyperlink if one is attached to this spec.
    </span><span class="kw">pub fn </span>uri(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]&gt; {
        <span class="self">self</span>.uri
    }
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_ansi_hyperlink() {
        <span class="kw">let </span><span class="kw-2">mut </span>buf = Ansi::new(<span class="macro">vec!</span>[]);
        buf.set_hyperlink(<span class="kw-2">&amp;</span>HyperlinkSpec::open(<span class="string">b"https://example.com"</span>))
            .unwrap();
        buf.write_str(<span class="string">"label"</span>).unwrap();
        buf.set_hyperlink(<span class="kw-2">&amp;</span>HyperlinkSpec::close()).unwrap();

        <span class="macro">assert_eq!</span>(
            buf.<span class="number">0</span>,
            <span class="string">b"\x1B]8;;https://example.com\x1B\\label\x1B]8;;\x1B\\"</span>.to_vec()
        );
    }
}
