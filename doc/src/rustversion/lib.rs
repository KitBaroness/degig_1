...
</pre></div><pre class="rust"><code><span class="doccomment">//! [![github]](https://github.com/dtolnay/rustversion)&amp;ensp;[![crates-io]](https://crates.io/crates/rustversion)&amp;ensp;[![docs-rs]](https://docs.rs/rustversion)
//!
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/rustversion/1.0.15"</span>)]
#![allow(
    ...
    <span class="comment">// https://github.com/rust-lang/rust-clippy/issues/8539
    </span>clippy::iter_with_drain,
...
<span class="kw">const </span>RUSTVERSION: Version = <span class="macro">include!</span>(<span class="macro">concat!</span>(<span class="macro">env!</span>(<span class="string">"OUT_DIR"</span>), <span class="string">"/version.expr"</span>));
...
<span class="attr">#[cfg(not(cfg_macro_not_allowed))]
#[proc_macro]
