...
</pre></div><pre class="rust"><code><span class="doccomment">//! Buffer wrappers implementing default so we can allocate the buffers with `Box::default()`
