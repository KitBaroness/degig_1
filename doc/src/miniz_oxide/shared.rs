...
</pre></div><pre class="rust"><code><span class="attr">#[doc(hidden)]
</span><span class="kw">pub const </span>MZ_ADLER32_INIT: u32 = <span class="number">1</span>;

<span class="attr">#[doc(hidden)]
</span><span class="kw">pub const </span>MZ_DEFAULT_WINDOW_BITS: i32 = <span class="number">15</span>;

<span class="kw">pub const </span>HUFFMAN_LENGTH_ORDER: [u8; <span class="number">19</span>] = [
...
<span class="attr">#[doc(hidden)]
#[cfg(not(feature = <span class="string">"simd"</span>))]
</span><span class="kw">pub fn </span>update_adler32(adler: u32, data: <span class="kw-2">&amp;</span>[u8]) -&gt; u32 {
    <span class="kw">let </span><span class="kw-2">mut </span>hash = adler::Adler32::from_checksum(adler);
...
#[cfg(feature = <span class="string">"simd"</span>)]
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>hash = simd_adler32::Adler32::from_checksum(adler);
    hash.write(data);
    hash.finish()
}
