...
///
</span><span class="attr">#[cfg_attr(feature = <span class="string">"derive"</span>, doc = <span class="string">"```"</span>)]
#[cfg_attr(
...
///
</span><span class="attr">#[cfg_attr(feature = <span class="string">"derive"</span>, doc = <span class="string">"```compile_fail"</span>)]
#[cfg_attr(
  not(feature = <span class="string">"derive"</span>),
  doc = <span class="string">"```ignore
// This example requires the `derive` feature."
