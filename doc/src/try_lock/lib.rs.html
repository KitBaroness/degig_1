...
<span class="kw">impl</span>&lt;T&gt; TryLock&lt;T&gt; {
    ...
    </span><span class="kw">pub const fn </span>new(val: T) -&gt; TryLock&lt;T&gt; {
        TryLock {
...
/// This type derefs to the underlying value.
</span><span class="attr">#[must_use = <span class="string">"TryLock will immediately unlock if not used"</span>]
    ...
    order: Ordering,
    <span class="doccomment">/// Suppresses Send and Sync autotraits for `struct Locked`.
    </span>_p: PhantomData&lt;<span class="kw-2">*mut </span>T&gt;,
}
