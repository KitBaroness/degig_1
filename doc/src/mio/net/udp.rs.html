...
</pre></div><pre class="rust"><code><span class="doccomment">//! Primitives for working with UDP.
//!
...
<span class="kw">impl </span>UdpSocket {
    ...
    </span><span class="attr">#[cfg_attr(all(feature = <span class="string">"os-poll"</span>, not(target_os = <span class="string">"freebsd"</span>)), doc = <span class="string">"```"</span>)]
    #[cfg_attr(
