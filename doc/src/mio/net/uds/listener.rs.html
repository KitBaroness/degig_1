...
<span class="kw">impl </span>UnixListener {
    <span class="doccomment">/// Creates a new `UnixListener` bound to the specified socket `path`.
    ...
    </span><span class="kw">pub fn </span>bind_addr(address: <span class="kw-2">&amp;</span>SocketAddr) -&gt; io::Result&lt;UnixListener&gt; {
