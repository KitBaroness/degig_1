...
<span class="kw">use </span><span class="kw">crate</span>::net::SocketAddr;
...
<span class="kw">impl </span>UnixStream {
    ...
    <span class="doccomment">/// Connects to the socket named by `address`.
    ///
    /// This may return a `WouldBlock` in which case the socket connection
    /// cannot be completed immediately. Usually it means the backlog is full.
    </span><span class="kw">pub fn </span>connect_addr(address: <span class="kw-2">&amp;</span>SocketAddr) -&gt; io::Result&lt;UnixStream&gt; {
