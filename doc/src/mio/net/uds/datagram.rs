...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::io_source::IoSource;
...
<span class="kw">impl </span>UnixDatagram {
    ...
    <span class="doccomment">/// Returns the address of this socket.
        ...
        sys::uds::datagram::local_addr(<span class="kw-2">&amp;</span><span class="self">self</span>.inner)
    }
    ...
    /// The `connect` method will connect the socket to a peer.
        ...
        sys::uds::datagram::peer_addr(<span class="kw-2">&amp;</span><span class="self">self</span>.inner)
    }
    ...
    </span><span class="kw">pub fn </span>recv_from(<span class="kw-2">&amp;</span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;(usize, sys::SocketAddr)&gt; {
