...
</pre></div><pre class="rust"><code><span class="kw">use </span>std::num::NonZeroU8;
...
</span><span class="attr">#[derive(Copy, PartialEq, Eq, Clone, PartialOrd, Ord)]
...
<span class="kw">const </span>LIO: u8 = <span class="number">0b1000</span>;
<span class="kw">const </span>PRIORITY: u8 = <span class="number">0b10000</span>;
...
<span class="kw">impl </span>Interest {
    ...
    </span><span class="kw">pub const </span>PRIORITY: Interest = Interest(<span class="kw">unsafe </span>{ NonZeroU8::new_unchecked(PRIORITY) });
    ...
    #[must_use = <span class="string">"this returns the result of the operation, without modifying the original"</span>]
    ...
    <span class="doccomment">/// Returns true if `Interest` contains priority readiness.
    </span><span class="attr">#[must_use]
    </span><span class="kw">pub const fn </span>is_priority(<span class="self">self</span>) -&gt; bool {
        (<span class="self">self</span>.<span class="number">0</span>.get() &amp; PRIORITY) != <span class="number">0
    </span>}
}
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Interest {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, fmt: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        ...
        <span class="attr">#[cfg(any(target_os = <span class="string">"linux"</span>, target_os = <span class="string">"android"</span>))]
            ...
            <span class="kw">if </span><span class="self">self</span>.is_priority() {
                <span class="kw">if </span>one {
                    <span class="macro">write!</span>(fmt, <span class="string">" | "</span>)<span class="question-mark">?
                </span>}
