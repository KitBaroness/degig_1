...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::event::Event;
<span class="kw">use </span><span class="kw">crate</span>::sys;

<span class="kw">use </span>std::fmt;

<span class="doccomment">/// A collection of readiness events.
///
...
<span class="doccomment">/// [`Events`] iterator.
///
...
/// ```
    ...
    inner: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Events,
    pos: usize,
}

<span class="kw">impl </span>Events {
    <span class="doccomment">/// Return a new `Events` capable of holding up to `capacity` events.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    </span><span class="kw">pub fn </span>with_capacity(capacity: usize) -&gt; Events {
        Events {
            inner: sys::Events::with_capacity(capacity),
        }
    }

    <span class="doccomment">/// Returns the number of `Event` values that `self` can hold.
    ///
    /// ```
    /// use mio::Events;
    ///
    ...
    <span class="doccomment">/// Returns `true` if `self` contains no `Event` values.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns an iterator over the `Event` values.
    ///
    /// # Examples
    ///
    </span><span class="attr">#[cfg_attr(feature = <span class="string">"os-poll"</span>, doc = <span class="string">"```"</span>)]
    ...
    <span class="doccomment">/// Clearing all `Event` values from container explicitly.
    ///
    /// # Notes
    ///
    ...
    <span class="doccomment">/// Returns the inner `sys::Events`.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>sys(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>sys::Events {
        <span class="kw-2">&amp;mut </span><span class="self">self</span>.inner
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>Events {
    <span class="kw">type </span>Item = <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Event;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'a</span>&gt; {
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="kw">let </span>ret = <span class="self">self
            ...
            .inner
            .get(<span class="self">self</span>.pos)
    ...
    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        <span class="kw">let </span>size = <span class="self">self</span>.inner.inner.len();
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Events {
