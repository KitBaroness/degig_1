...
</pre></div><pre class="rust"><code><span class="doccomment">//! Module with system specific types.
//!
//! Required types:
//!
...
//! * `Waker`: see [`crate::Waker`].
    ...
    <span class="macro">macro_rules!</span> debug_detail {
        (
            ...
            $($(<span class="attr">#[<span class="macro-nonterminal">$target</span>: meta]</span>)* <span class="macro-nonterminal">$libc</span>: ident :: <span class="macro-nonterminal">$flag</span>: ident),+ $(,)*
        ) =&gt; {
            ...
            <span class="kw">impl </span>fmt::Debug <span class="kw">for </span><span class="macro-nonterminal">$</span><span class="kw">type </span>{
                <span class="kw">fn </span><span class="macro-nonterminal">fmt</span>(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
                    ...
                    $(
                        ...
                        <span class="attr">#[allow(clippy::bad_bit_mask)] </span><span class="comment">// Apparently some flags are zero.
                        </span>{
...
<span class="macro">cfg_not_os_poll!</span> {
    ...
    <span class="attr">#[cfg(unix)]
        ...
        </span><span class="kw">pub use </span><span class="self">self</span>::unix::SourceFd;
    }
