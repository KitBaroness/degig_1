...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>connect(path: <span class="kw-2">&amp;</span>Path) -&gt; io::Result&lt;net::UnixStream&gt; {
    ...
    connect_addr(<span class="kw-2">&amp;</span>socket_address)
}
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>connect_addr(address: <span class="kw-2">&amp;</span>SocketAddr) -&gt; io::Result&lt;net::UnixStream&gt; {
    ...
    <span class="kw">match </span><span class="macro">syscall!</span>(connect(fd, sockaddr, <span class="kw-2">*</span>address.raw_socklen())) {
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>local_addr(socket: <span class="kw-2">&amp;</span>net::UnixStream) -&gt; io::Result&lt;SocketAddr&gt; {
    <span class="kw">super</span>::local_addr(socket.as_raw_fd())
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>peer_addr(socket: <span class="kw-2">&amp;</span>net::UnixStream) -&gt; io::Result&lt;SocketAddr&gt; {
