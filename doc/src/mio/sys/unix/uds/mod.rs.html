...
</pre></div><pre class="rust"><code><span class="kw">mod </span>socketaddr;
...
<span class="macro">cfg_os_poll!</span> {
    ...
    <span class="kw">pub</span>(<span class="kw">in </span><span class="kw">crate</span>::sys) <span class="kw">fn </span>socket_addr(bytes: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;(libc::sockaddr_un, libc::socklen_t)&gt; {
        ...
        <span class="kw">match </span>(bytes.first(), bytes.len().cmp(<span class="kw-2">&amp;</span>sockaddr.sun_path.len())) {
    ...
    <span class="attr">#[cfg(test)]
        ...
        <span class="attr">#[test]
            ...
            <span class="kw">let </span>(sockaddr, actual) = socket_addr(path.as_os_str().as_bytes()).unwrap();
            <span class="kw">let </span>offset = path_offset(<span class="kw-2">&amp;</span>sockaddr);
        ...
        <span class="attr">#[test]
            ...
            </span><span class="kw">let </span>(sockaddr, actual) = socket_addr(PATH).unwrap();
            <span class="kw">let </span>offset = path_offset(<span class="kw-2">&amp;</span>sockaddr);
