...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::path_offset;
...
<span class="macro">cfg_os_poll!</span> {
    ...
    <span class="kw">impl </span>SocketAddr {
        ...
        <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>raw_sockaddr(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>libc::sockaddr_un {
            <span class="kw-2">&amp;</span><span class="self">self</span>.sockaddr
        }

        <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>raw_socklen(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>libc::socklen_t {
            <span class="kw-2">&amp;</span><span class="self">self</span>.socklen
        }
