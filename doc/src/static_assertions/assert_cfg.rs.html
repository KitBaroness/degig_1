...
</pre></div><pre class="rust"><code><span class="doccomment">/// Asserts that a given configuration is set.
///
/// # Examples
///
...
</span><span class="macro">macro_rules!</span> assert_cfg {
    () =&gt; {};
    ($(<span class="macro-nonterminal">$cfg</span>:meta)+, <span class="macro-nonterminal">$msg</span>:expr $(,)<span class="question-mark">?</span>) =&gt; {
        <span class="attr">#[cfg(not($(<span class="macro-nonterminal">$cfg</span>)+))]
        </span><span class="macro">compile_error!</span>(<span class="macro-nonterminal">$msg</span>);
    };
    ($(<span class="macro-nonterminal">$cfg</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="attr">#[cfg(not($(<span class="macro-nonterminal">$cfg</span>)<span class="kw-2">*</span>))]
        </span><span class="macro">compile_error!</span>(<span class="macro">concat!</span>(<span class="string">"Cfg does not pass: "</span>, <span class="macro">stringify!</span>($(<span class="macro-nonterminal">$cfg</span>)<span class="kw-2">*</span>)));
    };
}
