...
<span class="kw">impl </span>Weekday {
    ...
    /// ```
        ...
        <span class="kw">if </span>lhs &lt; rhs {
            <span class="number">7 </span>+ lhs - rhs
