...
<span class="attr">#[cfg(all(
    feature = <span class="string">"now"</span>,
    not(all(
...
<span class="kw">use super</span>::{FixedOffset, MappedLocalTime, Offset, TimeZone};
<span class="kw">use </span><span class="kw">crate</span>::naive::{NaiveDate, NaiveDateTime};
<span class="attr">#[cfg(feature = <span class="string">"now"</span>)]
#[allow(deprecated)]
...
<span class="attr">#[cfg(feature = <span class="string">"now"</span>)]
    ...
    <span class="doccomment">/// Returns a `Date` which corresponds to the current date.
        ...
        note = <span class="string">"use `Utc::now()` instead, potentially with `.date_naive()`"
    </span>)]
    #[allow(deprecated)]
    #[must_use]
    ...
    <span class="doccomment">/// Returns a `DateTime&lt;Utc&gt;` which corresponds to the current date and time in UTC.
    ///
    ...
    #[must_use]
        ...
        DateTime::from_timestamp(now.as_secs() <span class="kw">as </span>i64, now.subsec_nanos()).unwrap()
    }

    <span class="doccomment">/// Returns a `DateTime` which corresponds to the current date and time.
...
<span class="kw">impl </span>TimeZone <span class="kw">for </span>Utc {
    ...
    <span class="kw">fn </span>offset_from_local_date(<span class="kw-2">&amp;</span><span class="self">self</span>, _local: <span class="kw-2">&amp;</span>NaiveDate) -&gt; MappedLocalTime&lt;Utc&gt; {
        MappedLocalTime::Single(Utc)
    }
    <span class="kw">fn </span>offset_from_local_datetime(<span class="kw-2">&amp;</span><span class="self">self</span>, _local: <span class="kw-2">&amp;</span>NaiveDateTime) -&gt; MappedLocalTime&lt;Utc&gt; {
        MappedLocalTime::Single(Utc)
    }
