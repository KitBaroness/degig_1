...
</span><span class="doccomment">//! Functionality for rounding or truncating a `DateTime` by a `TimeDelta`.

</span><span class="kw">use crate</span>::{DateTime, NaiveDateTime, TimeDelta, TimeZone, Timelike};
...
<span class="kw">where
    </span>T: Timelike + Add&lt;TimeDelta, Output = T&gt; + Sub&lt;TimeDelta, Output = T&gt;,
{
    <span class="kw">fn </span>round_subsecs(<span class="self">self</span>, digits: u16) -&gt; T {
        ...
        <span class="kw">if </span>delta_down &gt; <span class="number">0 </span>{
            ...
            <span class="kw">if </span>delta_up &lt;= delta_down {
                <span class="self">self </span>+ TimeDelta::nanoseconds(delta_up.into())
            } <span class="kw">else </span>{
                <span class="self">self </span>- TimeDelta::nanoseconds(delta_down.into())
            }
        } <span class="kw">else </span>{
...
</span><span class="kw">const fn </span>span_for_digits(digits: u16) -&gt; u32 {
...
<span class="doccomment">/// Extension trait for rounding or truncating a DateTime by a TimeDelta.
///
/// # Limitations
...
/// will also fail if the `TimeDelta` is bigger than the timestamp, negative or zero.
    ...
    <span class="doccomment">/// Return a copy rounded by TimeDelta.
    ///
    /// # Example
    /// ``` rust
    ...
    /// );
    /// ```
    </span><span class="kw">fn </span>duration_round(<span class="self">self</span>, duration: TimeDelta) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Err&gt;;

    <span class="doccomment">/// Return a copy truncated by TimeDelta.
    ///
    /// # Example
    /// ``` rust
    /// # use chrono::{DurationRound, TimeDelta, NaiveDate};
    ...
    /// );
    /// ```
    </span><span class="kw">fn </span>duration_trunc(<span class="self">self</span>, duration: TimeDelta) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Err&gt;;
}
...
<span class="kw">impl</span>&lt;Tz: TimeZone&gt; DurationRound <span class="kw">for </span>DateTime&lt;Tz&gt; {
    ...
    <span class="kw">fn </span>duration_round(<span class="self">self</span>, duration: TimeDelta) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Err&gt; {
        duration_round(<span class="self">self</span>.naive_local(), <span class="self">self</span>, duration)
    }

    <span class="kw">fn </span>duration_trunc(<span class="self">self</span>, duration: TimeDelta) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Err&gt; {
    ...
    </span>T: Timelike + Add&lt;TimeDelta, Output = T&gt; + Sub&lt;TimeDelta, Output = T&gt;,
{
    <span class="kw">if let </span><span class="prelude-val">Some</span>(span) = duration.num_nanoseconds() {
        <span class="kw">if </span>span &lt;= <span class="number">0 </span>{
            <span class="kw">return </span><span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit);
        }
        <span class="kw">let </span>stamp =
            naive.and_utc().timestamp_nanos_opt().ok_or(RoundingError::TimestampExceedsLimit)<span class="question-mark">?</span>;
        ...
        <span class="kw">if </span>delta_down == <span class="number">0 </span>{
            ...
            <span class="kw">if </span>delta_up &lt;= delta_down {
                <span class="prelude-val">Ok</span>(original + TimeDelta::nanoseconds(delta_up))
            } <span class="kw">else </span>{
                <span class="prelude-val">Ok</span>(original - TimeDelta::nanoseconds(delta_down))
            }
        }
    } <span class="kw">else </span>{
    ...
    </span>T: Timelike + Add&lt;TimeDelta, Output = T&gt; + Sub&lt;TimeDelta, Output = T&gt;,
{
    <span class="kw">if let </span><span class="prelude-val">Some</span>(span) = duration.num_nanoseconds() {
        ...
        <span class="kw">match </span>delta_down.cmp(<span class="kw-2">&amp;</span><span class="number">0</span>) {
            ...
            Ordering::Greater =&gt; <span class="prelude-val">Ok</span>(original - TimeDelta::nanoseconds(delta_down)),
            Ordering::Less =&gt; <span class="prelude-val">Ok</span>(original - TimeDelta::nanoseconds(span - delta_down.abs())),
        }
    } <span class="kw">else </span>{
        <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit)
    }
...
<span class="doccomment">/// An error from rounding by `TimeDelta`
///
/// See: [`DurationRound`]
</span><span class="attr">#[derive(Debug, Clone, PartialEq, Eq, Copy)]
</span><span class="kw">pub enum </span>RoundingError {
    <span class="doccomment">/// Error when the TimeDelta exceeds the TimeDelta from or until the Unix epoch.
    ///
    /// Note: this error is not produced anymore.
    </span>DurationExceedsTimestamp,

    <span class="doccomment">/// Error when `TimeDelta.num_nanoseconds` exceeds the limit.
    ///
    /// ``` rust
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use super</span>::{DurationRound, RoundingError, SubsecRound, TimeDelta};
    ...
    <span class="kw">use crate</span>::{DateTime, NaiveDate};
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::new(-<span class="number">1</span>, <span class="number">0</span>).unwrap()),
            <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit)
        );
        <span class="macro">assert_eq!</span>(dt.duration_round(TimeDelta::zero()), <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit));

        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_milliseconds(<span class="number">10</span>).unwrap()).unwrap().to_string(),
        ...
        <span class="comment">// round up
            ...
            .unwrap();
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_minutes(<span class="number">5</span>).unwrap()).unwrap().to_string(),
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_minutes(<span class="number">10</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:20:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_minutes(<span class="number">30</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:30:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_hours(<span class="number">1</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:00:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_days(<span class="number">1</span>).unwrap()).unwrap().to_string(),
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_round(TimeDelta::try_weeks(<span class="number">1</span>).unwrap()).unwrap().to_string(),
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::new(-<span class="number">1</span>, <span class="number">0</span>).unwrap()),
            <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit)
        );
        <span class="macro">assert_eq!</span>(dt.duration_trunc(TimeDelta::zero()), <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit));

        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_milliseconds(<span class="number">10</span>).unwrap()).unwrap().to_string(),
        ...
        <span class="comment">// would round up
            ...
            .unwrap();
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_minutes(<span class="number">5</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:20:00 UTC"
        </span>);
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_minutes(<span class="number">10</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:20:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_minutes(<span class="number">30</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:00:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_hours(<span class="number">1</span>).unwrap()).unwrap().to_string(),
            <span class="string">"2012-12-12 18:00:00 UTC"
        </span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_days(<span class="number">1</span>).unwrap()).unwrap().to_string(),
        ...
        <span class="macro">assert_eq!</span>(
            dt.duration_trunc(TimeDelta::try_weeks(<span class="number">1</span>).unwrap()).unwrap().to_string(),
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>issue1010() {
        <span class="kw">let </span>dt = DateTime::from_timestamp(-<span class="number">4_227_854_320</span>, <span class="number">678_774_288</span>).unwrap();
        <span class="kw">let </span>span = TimeDelta::microseconds(-<span class="number">7_019_067_213_869_040</span>);
        <span class="macro">assert_eq!</span>(dt.duration_trunc(span), <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit));

        <span class="kw">let </span>dt = DateTime::from_timestamp(<span class="number">320_041_586</span>, <span class="number">920_103_021</span>).unwrap();
        <span class="kw">let </span>span = TimeDelta::nanoseconds(-<span class="number">8_923_838_508_697_114_584</span>);
        <span class="macro">assert_eq!</span>(dt.duration_round(span), <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit));

        <span class="kw">let </span>dt = DateTime::from_timestamp(-<span class="number">2_621_440</span>, <span class="number">0</span>).unwrap();
        <span class="kw">let </span>span = TimeDelta::nanoseconds(-<span class="number">9_223_372_036_854_771_421</span>);
        <span class="macro">assert_eq!</span>(dt.duration_round(span), <span class="prelude-val">Err</span>(RoundingError::DurationExceedsLimit));
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_duration_trunc_close_to_epoch() {
        <span class="kw">let </span>span = TimeDelta::try_minutes(<span class="number">15</span>).unwrap();

        <span class="kw">let </span>dt = NaiveDate::from_ymd_opt(<span class="number">1970</span>, <span class="number">1</span>, <span class="number">1</span>).unwrap().and_hms_opt(<span class="number">0</span>, <span class="number">0</span>, <span class="number">15</span>).unwrap();
        <span class="macro">assert_eq!</span>(dt.duration_trunc(span).unwrap().to_string(), <span class="string">"1970-01-01 00:00:00"</span>);

        <span class="kw">let </span>dt = NaiveDate::from_ymd_opt(<span class="number">1969</span>, <span class="number">12</span>, <span class="number">31</span>).unwrap().and_hms_opt(<span class="number">23</span>, <span class="number">59</span>, <span class="number">45</span>).unwrap();
        <span class="macro">assert_eq!</span>(dt.duration_trunc(span).unwrap().to_string(), <span class="string">"1969-12-31 23:45:00"</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_duration_round_close_to_epoch() {
        <span class="kw">let </span>span = TimeDelta::try_minutes(<span class="number">15</span>).unwrap();

        <span class="kw">let </span>dt = NaiveDate::from_ymd_opt(<span class="number">1970</span>, <span class="number">1</span>, <span class="number">1</span>).unwrap().and_hms_opt(<span class="number">0</span>, <span class="number">0</span>, <span class="number">15</span>).unwrap();
        <span class="macro">assert_eq!</span>(dt.duration_round(span).unwrap().to_string(), <span class="string">"1970-01-01 00:00:00"</span>);
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_duration_round_close_to_min_max() {
        <span class="kw">let </span>span = TimeDelta::nanoseconds(i64::MAX);

        <span class="kw">let </span>dt = DateTime::from_timestamp_nanos(i64::MIN / <span class="number">2 </span>- <span class="number">1</span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_round(span).unwrap().to_string(),
            <span class="string">"1677-09-21 00:12:43.145224193 UTC"
        </span>);

        <span class="kw">let </span>dt = DateTime::from_timestamp_nanos(i64::MIN / <span class="number">2 </span>+ <span class="number">1</span>);
        <span class="macro">assert_eq!</span>(dt.duration_round(span).unwrap().to_string(), <span class="string">"1970-01-01 00:00:00 UTC"</span>);

        <span class="kw">let </span>dt = DateTime::from_timestamp_nanos(i64::MAX / <span class="number">2 </span>+ <span class="number">1</span>);
        <span class="macro">assert_eq!</span>(
            dt.duration_round(span).unwrap().to_string(),
            <span class="string">"2262-04-11 23:47:16.854775807 UTC"
        </span>);
