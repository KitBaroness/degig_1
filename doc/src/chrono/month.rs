...
</span><span class="attr">#[derive(PartialEq, Eq, Copy, Clone, Debug, Hash, PartialOrd, Ord)]
#[cfg_attr(
...
<span class="kw">impl </span>Months {
    ...
    <span class="doccomment">/// Returns the total number of months in the `Months` instance.
    </span><span class="attr">#[inline]
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span><span class="kw">super</span>::Month;
    <span class="kw">use crate</span>::{Datelike, Months, OutOfRange, TimeZone, Utc};
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_months_as_u32() {
        <span class="macro">assert_eq!</span>(Months::new(<span class="number">0</span>).as_u32(), <span class="number">0</span>);
        <span class="macro">assert_eq!</span>(Months::new(<span class="number">1</span>).as_u32(), <span class="number">1</span>);
        <span class="macro">assert_eq!</span>(Months::new(u32::MAX).as_u32(), u32::MAX);
    }
    ...
    #[cfg(feature = <span class="string">"rkyv-validation"</span>)]
        ...
        <span class="kw">let </span>month = Month::January;
        <span class="kw">let </span>bytes = rkyv::to_bytes::&lt;<span class="kw">_</span>, <span class="number">1</span>&gt;(<span class="kw-2">&amp;</span>month).unwrap();
        <span class="macro">assert_eq!</span>(rkyv::from_bytes::&lt;Month&gt;(<span class="kw-2">&amp;</span>bytes).unwrap(), month);
    }
}
