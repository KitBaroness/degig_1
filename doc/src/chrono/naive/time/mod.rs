...
<span class="kw">use crate</span>::{FixedOffset, TimeDelta, Timelike};
...
<span class="kw">impl </span>NaiveTime {
    ...
    #[must_use]
        ...
        expect(NaiveTime::from_hms_opt(hour, min, sec), <span class="string">"invalid time"</span>)
    }
    ...
    #[must_use]
        ...
        expect(NaiveTime::from_hms_milli_opt(hour, min, sec, milli), <span class="string">"invalid time"</span>)
    }
    ...
    #[must_use]
        ...
        expect(NaiveTime::from_hms_micro_opt(hour, min, sec, micro), <span class="string">"invalid time"</span>)
    }
    ...
    #[must_use]
        ...
        expect(NaiveTime::from_hms_nano_opt(hour, min, sec, nano), <span class="string">"invalid time"</span>)
    }
    ...
    #[must_use]
        ...
        expect(NaiveTime::from_num_seconds_from_midnight_opt(secs, nano), <span class="string">"invalid time"</span>)
    }
    ...
    <span class="doccomment">/// Adds given `TimeDelta` to the current time, and also returns the number of *seconds*
    ...
    /// ```
    ...
    </span><span class="kw">pub const fn </span>overflowing_add_signed(<span class="kw-2">&amp;</span><span class="self">self</span>, rhs: TimeDelta) -&gt; (NaiveTime, i64) {
        <span class="kw">let </span><span class="kw-2">mut </span>secs = <span class="self">self</span>.secs <span class="kw">as </span>i64;
        <span class="kw">let </span><span class="kw-2">mut </span>frac = <span class="self">self</span>.frac <span class="kw">as </span>i32;
        <span class="kw">let </span>secs_to_add = rhs.num_seconds();
        <span class="kw">let </span>frac_to_add = rhs.subsec_nanos();
        ...
        // second, just do that and return (this way the rest of the code can ignore leap seconds).
            ...
            <span class="comment">// check below is adjusted to not overflow an i32: `frac + frac_to_add &gt;= 2_000_000_000`
            </span><span class="kw">if </span>secs_to_add &gt; <span class="number">0 </span>|| (frac_to_add &gt; <span class="number">0 </span>&amp;&amp; frac &gt;= <span class="number">2_000_000_000 </span>- frac_to_add) {
                frac -= <span class="number">1_000_000_000</span>;
            } <span class="kw">else if </span>secs_to_add &lt; <span class="number">0 </span>{
                frac -= <span class="number">1_000_000_000</span>;
                secs += <span class="number">1</span>;
            } <span class="kw">else </span>{
                <span class="kw">return </span>(NaiveTime { secs: <span class="self">self</span>.secs, frac: (frac + frac_to_add) <span class="kw">as </span>u32 }, <span class="number">0</span>);
            }
        }

        <span class="kw">let </span><span class="kw-2">mut </span>secs = secs + secs_to_add;
        frac += frac_to_add;
        ...
        <span class="kw">let </span>secs_in_day = secs.rem_euclid(<span class="number">86_400</span>);
        <span class="kw">let </span>remaining = secs - secs_in_day;
        (NaiveTime { secs: secs_in_day <span class="kw">as </span>u32, frac: frac <span class="kw">as </span>u32 }, remaining)
    }

    <span class="doccomment">/// Subtracts given `TimeDelta` from the current time, and also returns the number of *seconds*
    ...
    #[must_use]
    </span><span class="kw">pub const fn </span>overflowing_sub_signed(<span class="kw-2">&amp;</span><span class="self">self</span>, rhs: TimeDelta) -&gt; (NaiveTime, i64) {
        <span class="kw">let </span>(time, rhs) = <span class="self">self</span>.overflowing_add_signed(rhs.neg());
    ...
    /// ```
    ...
    </span><span class="kw">pub const fn </span>signed_duration_since(<span class="self">self</span>, rhs: NaiveTime) -&gt; TimeDelta {
        ...
        </span><span class="kw">let </span><span class="kw-2">mut </span>secs = <span class="self">self</span>.secs <span class="kw">as </span>i64 - rhs.secs <span class="kw">as </span>i64;
        <span class="kw">let </span>frac = <span class="self">self</span>.frac <span class="kw">as </span>i64 - rhs.frac <span class="kw">as </span>i64;

        <span class="comment">// `secs` may contain a leap second yet to be counted
        </span><span class="kw">if </span><span class="self">self</span>.secs &gt; rhs.secs &amp;&amp; rhs.frac &gt;= <span class="number">1_000_000_000 </span>{
            secs += <span class="number">1</span>;
        } <span class="kw">else if </span><span class="self">self</span>.secs &lt; rhs.secs &amp;&amp; <span class="self">self</span>.frac &gt;= <span class="number">1_000_000_000 </span>{
            secs -= <span class="number">1</span>;
        }

        <span class="kw">let </span>secs_from_frac = frac.div_euclid(<span class="number">1_000_000_000</span>);
        <span class="kw">let </span>frac = frac.rem_euclid(<span class="number">1_000_000_000</span>) <span class="kw">as </span>u32;

        expect(TimeDelta::new(secs + secs_from_frac, frac), <span class="string">"must be in range"</span>)
    }

    <span class="doccomment">/// Adds given `FixedOffset` to the current time, and returns the number of days that should be
    ...
    /// preserves leap seconds.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">const fn </span>overflowing_add_offset(<span class="kw-2">&amp;</span><span class="self">self</span>, offset: FixedOffset) -&gt; (NaiveTime, i32) {
        <span class="kw">let </span>secs = <span class="self">self</span>.secs <span class="kw">as </span>i32 + offset.local_minus_utc();
        ...
        (NaiveTime { secs: secs <span class="kw">as </span>u32, frac: <span class="self">self</span>.frac }, days)
    }

    <span class="doccomment">/// Subtracts given `FixedOffset` from the current time, and returns the number of days that
    ...
    /// preserves leap seconds.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">const fn </span>overflowing_sub_offset(<span class="kw-2">&amp;</span><span class="self">self</span>, offset: FixedOffset) -&gt; (NaiveTime, i32) {
        <span class="kw">let </span>secs = <span class="self">self</span>.secs <span class="kw">as </span>i32 - offset.local_minus_utc();
        <span class="kw">let </span>days = secs.div_euclid(<span class="number">86_400</span>);
        <span class="kw">let </span>secs = secs.rem_euclid(<span class="number">86_400</span>);
        (NaiveTime { secs: secs <span class="kw">as </span>u32, frac: <span class="self">self</span>.frac }, days)
    ...
    </span><span class="comment">// This duplicates `Timelike::num_seconds_from_midnight()`, because trait methods can't be const
    // yet.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const fn </span>num_seconds_from_midnight(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u32 {
        <span class="self">self</span>.secs
    }

    <span class="doccomment">/// Returns the number of nanoseconds since the whole non-leap second.
    </span><span class="comment">// This duplicates `Timelike::nanosecond()`, because trait methods can't be const yet.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const fn </span>nanosecond(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u32 {
...
<span class="doccomment">/// Add `TimeDelta` to `NaiveTime`.
///
...
</span><span class="kw">impl </span>Add&lt;TimeDelta&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>add(<span class="self">self</span>, rhs: TimeDelta) -&gt; NaiveTime {
        <span class="self">self</span>.overflowing_add_signed(rhs).<span class="number">0
    </span>}
}

<span class="doccomment">/// Add-assign `TimeDelta` to `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the addition ignores integral number of days.
</span><span class="kw">impl </span>AddAssign&lt;TimeDelta&gt; <span class="kw">for </span>NaiveTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Add `std::time::Duration` to `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the addition ignores integral number of days.
</span><span class="kw">impl </span>Add&lt;Duration&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>add(<span class="self">self</span>, rhs: Duration) -&gt; NaiveTime {
        <span class="comment">// We don't care about values beyond `24 * 60 * 60`, so we can take a modulus and avoid
        // overflow during the conversion to `TimeDelta`.
        // But we limit to double that just in case `self` is a leap-second.
        </span><span class="kw">let </span>secs = rhs.as_secs() % (<span class="number">2 </span>* <span class="number">24 </span>* <span class="number">60 </span>* <span class="number">60</span>);
        <span class="kw">let </span>d = TimeDelta::new(secs <span class="kw">as </span>i64, rhs.subsec_nanos()).unwrap();
        <span class="self">self</span>.overflowing_add_signed(d).<span class="number">0
    </span>}
}

<span class="doccomment">/// Add-assign `std::time::Duration` to `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the addition ignores integral number of days.
</span><span class="kw">impl </span>AddAssign&lt;Duration&gt; <span class="kw">for </span>NaiveTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Add `FixedOffset` to `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the addition ignores integral number of days.
</span><span class="kw">impl </span>Add&lt;FixedOffset&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>add(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveTime {
        <span class="self">self</span>.overflowing_add_offset(rhs).<span class="number">0
    </span>}
}

<span class="doccomment">/// Subtract `TimeDelta` from `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
...
///
/// [leap second handling]: crate::NaiveTime#leap-second-handling
</span><span class="kw">impl </span>Sub&lt;TimeDelta&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: TimeDelta) -&gt; NaiveTime {
        <span class="self">self</span>.overflowing_sub_signed(rhs).<span class="number">0
    </span>}
}

<span class="doccomment">/// Subtract-assign `TimeDelta` from `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the subtraction ignores integral number of days.
</span><span class="kw">impl </span>SubAssign&lt;TimeDelta&gt; <span class="kw">for </span>NaiveTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Subtract `std::time::Duration` from `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the subtraction ignores integral number of days.
</span><span class="kw">impl </span>Sub&lt;Duration&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>d = TimeDelta::new(secs <span class="kw">as </span>i64, rhs.subsec_nanos()).unwrap();
        <span class="self">self</span>.overflowing_sub_signed(d).<span class="number">0
    </span>}
}

<span class="doccomment">/// Subtract-assign `std::time::Duration` from `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the subtraction ignores integral number of days.
</span><span class="kw">impl </span>SubAssign&lt;Duration&gt; <span class="kw">for </span>NaiveTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Subtract `FixedOffset` from `NaiveTime`.
///
/// This wraps around and never overflows or underflows.
/// In particular the subtraction ignores integral number of days.
</span><span class="kw">impl </span>Sub&lt;FixedOffset&gt; <span class="kw">for </span>NaiveTime {
    <span class="kw">type </span>Output = NaiveTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveTime {
        <span class="self">self</span>.overflowing_sub_offset(rhs).<span class="number">0
    </span>}
}
...
/// ```
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: NaiveTime) -&gt; TimeDelta {
