...
<span class="kw">use </span><span class="kw">crate</span>::time_delta::NANOS_PER_SEC;
...
<span class="kw">impl </span>NaiveDateTime {
    ...
    /// more).
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.23"</span>, note = <span class="string">"use `DateTime::from_timestamp` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>from_timestamp(secs: i64, nsecs: u32) -&gt; NaiveDateTime {
        <span class="kw">let </span>datetime =
            expect(DateTime::from_timestamp(secs, nsecs), <span class="string">"invalid or out-of-range datetime"</span>);
        datetime.naive_utc()
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `DateTime::from_timestamp_millis` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>from_timestamp_millis(millis: i64) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="prelude-val">Some</span>(<span class="macro">try_opt!</span>(DateTime::from_timestamp_millis(millis)).naive_utc())
    }
    ...
    /// (more than ca. 262,000 years away from common era)
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `DateTime::from_timestamp_micros` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>from_timestamp_micros(micros: i64) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        ...
        <span class="prelude-val">Some</span>(<span class="macro">try_opt!</span>(DateTime::&lt;Utc&gt;::from_timestamp(secs, nsecs)).naive_utc())
    }

    <span class="doccomment">/// Creates a new [NaiveDateTime] from nanoseconds since the UNIX epoch.
    ///
    /// The UNIX epoch starts on midnight, January 1, 1970, UTC.
    ///
    /// # Errors
    ...
    /// (more than ca. 262,000 years away from common era)
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `DateTime::from_timestamp_nanos` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>from_timestamp_nanos(nanos: i64) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="kw">let </span>secs = nanos.div_euclid(NANOS_PER_SEC <span class="kw">as </span>i64);
        <span class="kw">let </span>nsecs = nanos.rem_euclid(NANOS_PER_SEC <span class="kw">as </span>i64) <span class="kw">as </span>u32;
        <span class="prelude-val">Some</span>(<span class="macro">try_opt!</span>(DateTime::from_timestamp(secs, nsecs)).naive_utc())
    }
    ...
    /// (2 seconds or more).
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `DateTime::from_timestamp` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>from_timestamp_opt(secs: i64, nsecs: u32) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="prelude-val">Some</span>(<span class="macro">try_opt!</span>(DateTime::from_timestamp(secs, nsecs)).naive_utc())
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp()` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>timestamp(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; i64 {
        <span class="self">self</span>.and_utc().timestamp()
    }
    ...
    /// Note that this does *not* account for the timezone!
    /// The true "UNIX timestamp" would count seconds since the midnight *UTC* on the epoch.
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp_millis()` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>timestamp_millis(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; i64 {
        <span class="self">self</span>.and_utc().timestamp_millis()
    }
    ...
    /// Note that this does *not* account for the timezone!
    /// The true "UNIX timestamp" would count seconds since the midnight *UTC* on the epoch.
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp_micros()` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>timestamp_micros(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; i64 {
        <span class="self">self</span>.and_utc().timestamp_micros()
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.31"</span>, note = <span class="string">"use `.and_utc().timestamp_nanos_opt()` instead"</span>)]
    #[inline]
    #[must_use]
    #[allow(deprecated)]
    </span><span class="kw">pub const fn </span>timestamp_nanos(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; i64 {
        <span class="self">self</span>.and_utc().timestamp_nanos()
    }
    ...
    /// The dates that can be represented as nanoseconds are between 1677-09-21T00:12:43.145224192
    /// and 2262-04-11T23:47:16.854775807.
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp_nanos_opt()` instead"</span>)]
    #[inline]
    #[must_use]
        ...
        <span class="self">self</span>.and_utc().timestamp_nanos_opt()
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp_subsec_millis()` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>timestamp_subsec_millis(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u32 {
        <span class="self">self</span>.and_utc().timestamp_subsec_millis()
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.35"</span>, note = <span class="string">"use `.and_utc().timestamp_subsec_micros()` instead"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub const fn </span>timestamp_subsec_micros(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u32 {
        <span class="self">self</span>.and_utc().timestamp_subsec_micros()
    }
    ...
    </span><span class="attr">#[deprecated(since = <span class="string">"0.4.36"</span>, note = <span class="string">"use `.and_utc().timestamp_subsec_nanos()` instead"</span>)]
    </span><span class="kw">pub const fn </span>timestamp_subsec_nanos(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u32 {
        <span class="self">self</span>.and_utc().timestamp_subsec_nanos()
    }
    ...
    </span><span class="kw">pub const fn </span>checked_add_signed(<span class="self">self</span>, rhs: TimeDelta) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="kw">let </span>(time, remainder) = <span class="self">self</span>.time.overflowing_add_signed(rhs);
        <span class="kw">let </span>remainder = <span class="macro">try_opt!</span>(TimeDelta::try_seconds(remainder));
        <span class="kw">let </span>date = <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_add_signed(remainder));
    ...
    </span><span class="kw">pub const fn </span>checked_add_months(<span class="self">self</span>, rhs: Months) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="prelude-val">Some</span>(<span class="self">Self </span>{ date: <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_add_months(rhs)), time: <span class="self">self</span>.time })
    }

    <span class="doccomment">/// Adds given `FixedOffset` to the current datetime.
    ...
    </span><span class="kw">pub const fn </span>checked_add_offset(<span class="self">self</span>, rhs: FixedOffset) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="kw">let </span>(time, days) = <span class="self">self</span>.time.overflowing_add_offset(rhs);
        <span class="kw">let </span>date = <span class="kw">match </span>days {
            -<span class="number">1 </span>=&gt; <span class="macro">try_opt!</span>(<span class="self">self</span>.date.pred_opt()),
            <span class="number">1 </span>=&gt; <span class="macro">try_opt!</span>(<span class="self">self</span>.date.succ_opt()),
            <span class="kw">_ </span>=&gt; <span class="self">self</span>.date,
        };
        <span class="prelude-val">Some</span>(NaiveDateTime { date, time })
    }

    <span class="doccomment">/// Subtracts given `FixedOffset` from the current datetime.
    /// Returns `None` if the result would be outside the valid range for [`NaiveDateTime`].
    ///
    /// This method is similar to [`checked_sub_signed`](#method.checked_sub_signed), but preserves
    /// leap seconds.
    </span><span class="kw">pub const fn </span>checked_sub_offset(<span class="self">self</span>, rhs: FixedOffset) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="kw">let </span>(time, days) = <span class="self">self</span>.time.overflowing_sub_offset(rhs);
        <span class="kw">let </span>date = <span class="kw">match </span>days {
            -<span class="number">1 </span>=&gt; <span class="macro">try_opt!</span>(<span class="self">self</span>.date.pred_opt()),
            <span class="number">1 </span>=&gt; <span class="macro">try_opt!</span>(<span class="self">self</span>.date.succ_opt()),
            <span class="kw">_ </span>=&gt; <span class="self">self</span>.date,
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>overflowing_add_offset(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveDateTime {
        <span class="kw">let </span>(time, days) = <span class="self">self</span>.time.overflowing_add_offset(rhs);
        <span class="kw">let </span>date = <span class="kw">match </span>days {
            -<span class="number">1 </span>=&gt; <span class="self">self</span>.date.pred_opt().unwrap_or(NaiveDate::BEFORE_MIN),
            <span class="number">1 </span>=&gt; <span class="self">self</span>.date.succ_opt().unwrap_or(NaiveDate::AFTER_MAX),
            <span class="kw">_ </span>=&gt; <span class="self">self</span>.date,
        };
        NaiveDateTime { date, time }
    }
    ...
    #[allow(unused)] </span><span class="comment">// currently only used in `Local` but not on all platforms
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>overflowing_sub_offset(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveDateTime {
        <span class="kw">let </span>(time, days) = <span class="self">self</span>.time.overflowing_sub_offset(rhs);
        <span class="kw">let </span>date = <span class="kw">match </span>days {
            -<span class="number">1 </span>=&gt; <span class="self">self</span>.date.pred_opt().unwrap_or(NaiveDate::BEFORE_MIN),
            <span class="number">1 </span>=&gt; <span class="self">self</span>.date.succ_opt().unwrap_or(NaiveDate::AFTER_MAX),
    ...
    </span><span class="kw">pub const fn </span>checked_sub_signed(<span class="self">self</span>, rhs: TimeDelta) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="kw">let </span>(time, remainder) = <span class="self">self</span>.time.overflowing_sub_signed(rhs);
        <span class="kw">let </span>remainder = <span class="macro">try_opt!</span>(TimeDelta::try_seconds(remainder));
        <span class="kw">let </span>date = <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_sub_signed(remainder));
        <span class="prelude-val">Some</span>(NaiveDateTime { date, time })
    }
    ...
    </span><span class="kw">pub const fn </span>checked_sub_months(<span class="self">self</span>, rhs: Months) -&gt; <span class="prelude-ty">Option</span>&lt;NaiveDateTime&gt; {
        <span class="prelude-val">Some</span>(<span class="self">Self </span>{ date: <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_sub_months(rhs)), time: <span class="self">self</span>.time })
    }
    ...
    /// Returns `None` if the resulting date would be out of range.
        ...
        <span class="prelude-val">Some</span>(<span class="self">Self </span>{ date: <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_add_days(days)), ..<span class="self">self </span>})
    }
    ...
    /// Returns `None` if the resulting date would be out of range.
        ...
        <span class="prelude-val">Some</span>(<span class="self">Self </span>{ date: <span class="macro">try_opt!</span>(<span class="self">self</span>.date.checked_sub_days(days)), ..<span class="self">self </span>})
    }
    ...
    </span><span class="kw">pub const fn </span>signed_duration_since(<span class="self">self</span>, rhs: NaiveDateTime) -&gt; TimeDelta {
        expect(
            <span class="self">self</span>.date
                .signed_duration_since(rhs.date)
                .checked_add(<span class="kw-2">&amp;</span><span class="self">self</span>.time.signed_duration_since(rhs.time)),
            <span class="string">"always in range"</span>,
        )
    }
    ...
    <span class="doccomment">/// Converts the `NaiveDateTime` into a timezone-aware `DateTime&lt;Tz&gt;` with the provided
    /// time zone.
    ///
    /// # Example
    ///
    ...
    </span><span class="kw">pub fn </span>and_local_timezone&lt;Tz: TimeZone&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, tz: Tz) -&gt; MappedLocalTime&lt;DateTime&lt;Tz&gt;&gt; {
    ...
    </span><span class="kw">pub const fn </span>and_utc(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; DateTime&lt;Utc&gt; {
        DateTime::from_naive_utc_and_offset(<span class="kw-2">*</span><span class="self">self</span>, Utc)
    }
    ...
    <span class="doccomment">/// The Unix Epoch, 1970-01-01 00:00:00.
        ...
        expect(NaiveDate::from_ymd_opt(<span class="number">1970</span>, <span class="number">1</span>, <span class="number">1</span>), <span class="string">""</span>).and_time(NaiveTime::MIN);
}

<span class="kw">impl </span>From&lt;NaiveDate&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="doccomment">/// Converts a `NaiveDate` to a `NaiveDateTime` of the same date but at midnight.
    ///
    /// # Example
    ///
    /// ```
    ...
    </span><span class="kw">fn </span>from(date: NaiveDate) -&gt; <span class="self">Self </span>{
        date.and_hms_opt(<span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>).unwrap()
    }
}
...
<span class="doccomment">/// Add `TimeDelta` to `NaiveDateTime`.
///
...
</span><span class="kw">impl </span>Add&lt;TimeDelta&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>add(<span class="self">self</span>, rhs: TimeDelta) -&gt; NaiveDateTime {
        <span class="self">self</span>.checked_add_signed(rhs).expect(<span class="string">"`NaiveDateTime + TimeDelta` overflowed"</span>)
    }
}

<span class="doccomment">/// Add `std::time::Duration` to `NaiveDateTime`.
///
/// As a part of Chrono's [leap second handling], the addition assumes that **there is no leap
/// second ever**, except when the `NaiveDateTime` itself represents a leap  second in which case
/// the assumption becomes that **there is exactly a single leap second ever**.
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_add_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>Add&lt;Duration&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;
...
<span class="doccomment">/// Add-assign `TimeDelta` to `NaiveDateTime`.
///
/// As a part of Chrono's [leap second handling], the addition assumes that **there is no leap
/// second ever**, except when the `NaiveDateTime` itself represents a leap  second in which case
/// the assumption becomes that **there is exactly a single leap second ever**.
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_add_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>AddAssign&lt;TimeDelta&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Add-assign `std::time::Duration` to `NaiveDateTime`.
///
/// As a part of Chrono's [leap second handling], the addition assumes that **there is no leap
/// second ever**, except when the `NaiveDateTime` itself represents a leap  second in which case
/// the assumption becomes that **there is exactly a single leap second ever**.
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_add_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>AddAssign&lt;Duration&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Add `FixedOffset` to `NaiveDateTime`.
///
/// # Panics
///
/// Panics if the resulting date would be out of range.
/// Consider using `checked_add_offset` to get an `Option` instead.
</span><span class="kw">impl </span>Add&lt;FixedOffset&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>add(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveDateTime {
        <span class="self">self</span>.checked_add_offset(rhs).expect(<span class="string">"`NaiveDateTime + FixedOffset` out of range"</span>)
    }
}

<span class="doccomment">/// Add `Months` to `NaiveDateTime`.
///
...
/// );
/// ```
</span><span class="kw">impl </span>Add&lt;Months&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="kw">fn </span>add(<span class="self">self</span>, rhs: Months) -&gt; <span class="self">Self</span>::Output {
        <span class="self">self</span>.checked_add_months(rhs).expect(<span class="string">"`NaiveDateTime + Months` out of range"</span>)
    }
}

<span class="doccomment">/// Subtract `TimeDelta` from `NaiveDateTime`.
///
...
///
/// [leap second handling]: crate::NaiveTime#leap-second-handling
</span><span class="kw">impl </span>Sub&lt;TimeDelta&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: TimeDelta) -&gt; NaiveDateTime {
        <span class="self">self</span>.checked_sub_signed(rhs).expect(<span class="string">"`NaiveDateTime - TimeDelta` overflowed"</span>)
    }
}

<span class="doccomment">/// Subtract `std::time::Duration` from `NaiveDateTime`.
///
/// As a part of Chrono's [leap second handling] the subtraction assumes that **there is no leap
/// second ever**, except when the `NaiveDateTime` itself represents a leap second in which case
/// the assumption becomes that **there is exactly a single leap second ever**.
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_sub_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>Sub&lt;Duration&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;
...
<span class="doccomment">/// Subtract-assign `TimeDelta` from `NaiveDateTime`.
///
/// This is the same as the addition with a negated `TimeDelta`.
///
/// As a part of Chrono's [leap second handling], the addition assumes that **there is no leap
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_sub_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>SubAssign&lt;TimeDelta&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Subtract-assign `std::time::Duration` from `NaiveDateTime`.
///
/// As a part of Chrono's [leap second handling], the addition assumes that **there is no leap
/// second ever**, except when the `NaiveDateTime` itself represents a leap  second in which case
/// the assumption becomes that **there is exactly a single leap second ever**.
...
/// Panics if the resulting date would be out of range.
/// Consider using [`NaiveDateTime::checked_sub_signed`] to get an `Option` instead.
</span><span class="kw">impl </span>SubAssign&lt;Duration&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="attr">#[inline]
...
<span class="doccomment">/// Subtract `FixedOffset` from `NaiveDateTime`.
///
/// # Panics
///
/// Panics if the resulting date would be out of range.
/// Consider using `checked_sub_offset` to get an `Option` instead.
</span><span class="kw">impl </span>Sub&lt;FixedOffset&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: FixedOffset) -&gt; NaiveDateTime {
        <span class="self">self</span>.checked_sub_offset(rhs).expect(<span class="string">"`NaiveDateTime - FixedOffset` out of range"</span>)
    }
}

<span class="doccomment">/// Subtract `Months` from `NaiveDateTime`.
///
...
/// ```
    ...
    <span class="kw">fn </span>sub(<span class="self">self</span>, rhs: Months) -&gt; <span class="self">Self</span>::Output {
        <span class="self">self</span>.checked_sub_months(rhs).expect(<span class="string">"`NaiveDateTime - Months` out of range"</span>)
    }
}
...
/// ```
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>sub(<span class="self">self</span>, rhs: NaiveDateTime) -&gt; TimeDelta {
...
</span><span class="kw">impl </span>Add&lt;Days&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="kw">fn </span>add(<span class="self">self</span>, days: Days) -&gt; <span class="self">Self</span>::Output {
        <span class="self">self</span>.checked_add_days(days).expect(<span class="string">"`NaiveDateTime + Days` out of range"</span>)
    }
}

<span class="doccomment">/// Subtract `Days` from `NaiveDateTime`.
///
/// # Panics
///
/// Panics if the resulting date would be out of range.
/// Consider using `checked_sub_days` to get an `Option` instead.
</span><span class="kw">impl </span>Sub&lt;Days&gt; <span class="kw">for </span>NaiveDateTime {
    <span class="kw">type </span>Output = NaiveDateTime;

    <span class="kw">fn </span>sub(<span class="self">self</span>, days: Days) -&gt; <span class="self">Self</span>::Output {
        <span class="self">self</span>.checked_sub_days(days).expect(<span class="string">"`NaiveDateTime - Days` out of range"</span>)
    }
}
...
/// ```
    ...
    <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::UNIX_EPOCH
    }
}
