...
</pre></div><pre class="rust"><code><span class="doccomment">//! Channel that never delivers messages.
//!
...
<span class="doccomment">/// This flavor doesn't need a token.
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">type </span>NeverToken = ();

<span class="doccomment">/// Channel that never delivers messages.
...
<span class="kw">impl</span>&lt;T&gt; Channel&lt;T&gt; {
    <span class="doccomment">/// Creates a channel that never delivers messages.
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">unsafe fn </span>read(<span class="kw-2">&amp;</span><span class="self">self</span>, _token: <span class="kw-2">&amp;mut </span>Token) -&gt; <span class="prelude-ty">Result</span>&lt;T, ()&gt; {
...
<span class="kw">impl</span>&lt;T&gt; SelectHandle <span class="kw">for </span>Channel&lt;T&gt; {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>try_select(<span class="kw-2">&amp;</span><span class="self">self</span>, _token: <span class="kw-2">&amp;mut </span>Token) -&gt; bool {
