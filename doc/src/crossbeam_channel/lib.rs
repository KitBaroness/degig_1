...
</pre></div><pre class="rust"><code><span class="doccomment">//! Multi-producer multi-consumer channels for message passing.
//!
...
</span><span class="kw">mod </span>channel;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>context;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>counter;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>err;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>flavors;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>select;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>select_macro;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>utils;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>waker;

<span class="doccomment">/// Crate internals used by the `select!` macro.
</span><span class="attr">#[doc(hidden)]
#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">pub mod </span>internal {
    <span class="kw">pub use </span><span class="kw">crate</span>::select::{select, select_timeout, try_select, SelectHandle};
}
