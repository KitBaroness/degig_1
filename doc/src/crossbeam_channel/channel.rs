...
</pre></div><pre class="rust"><code><span class="doccomment">//! The channel interface.
...
<span class="kw">use </span><span class="kw">crate</span>::counter;
<span class="kw">use </span><span class="kw">crate</span>::err::{
...
<span class="kw">use </span><span class="kw">crate</span>::select::{Operation, SelectHandle, Token};

<span class="doccomment">/// Creates a channel of unbounded capacity.
///
...
/// ```
</span><span class="kw">pub fn </span>unbounded&lt;T&gt;() -&gt; (Sender&lt;T&gt;, Receiver&lt;T&gt;) {
    <span class="kw">let </span>(s, r) = counter::new(flavors::list::Channel::new());
    <span class="kw">let </span>s = Sender {
        flavor: SenderFlavor::List(s),
    };
    <span class="kw">let </span>r = Receiver {
        flavor: ReceiverFlavor::List(r),
    };
    (s, r)
}

<span class="doccomment">/// Creates a channel of bounded capacity.
///
...
/// assert_eq!(r.recv(), Ok(1));
/// ```
</span><span class="kw">pub fn </span>bounded&lt;T&gt;(cap: usize) -&gt; (Sender&lt;T&gt;, Receiver&lt;T&gt;) {
    <span class="kw">if </span>cap == <span class="number">0 </span>{
        <span class="kw">let </span>(s, r) = counter::new(flavors::zero::Channel::new());
        <span class="kw">let </span>s = Sender {
        ...
        <span class="kw">let </span>(s, r) = counter::new(flavors::array::Channel::with_capacity(cap));
        <span class="kw">let </span>s = Sender {
...
<span class="doccomment">/// Creates a receiver that delivers a message after a certain duration of time.
///
...
/// ```
</span><span class="kw">pub fn </span>after(duration: Duration) -&gt; Receiver&lt;Instant&gt; {
    <span class="kw">match </span>Instant::now().checked_add(duration) {
        <span class="prelude-val">Some</span>(deadline) =&gt; Receiver {
            flavor: ReceiverFlavor::At(Arc::new(flavors::at::Channel::new_deadline(deadline))),
        },
        <span class="prelude-val">None </span>=&gt; never(),
    }
}

<span class="doccomment">/// Creates a receiver that delivers a message at a certain instant in time.
///
/// The channel is bounded with capacity of 1 and never gets disconnected. Exactly one message will
...
/// ```
</span><span class="kw">pub fn </span>at(when: Instant) -&gt; Receiver&lt;Instant&gt; {
    Receiver {
        flavor: ReceiverFlavor::At(Arc::new(flavors::at::Channel::new_deadline(when))),
    }
}

<span class="doccomment">/// Creates a receiver that never delivers messages.
///
...
/// }
/// ```
</span><span class="kw">pub fn </span>never&lt;T&gt;() -&gt; Receiver&lt;T&gt; {
    Receiver {
        flavor: ReceiverFlavor::Never(flavors::never::Channel::new()),
    }
}

<span class="doccomment">/// Creates a receiver that delivers messages periodically.
///
...
/// ```
</span><span class="kw">pub fn </span>tick(duration: Duration) -&gt; Receiver&lt;Instant&gt; {
    <span class="kw">match </span>Instant::now().checked_add(duration) {
        <span class="prelude-val">Some</span>(delivery_time) =&gt; Receiver {
...
<span class="doccomment">/// The sending side of a channel.
///
/// # Examples
///
/// ```
...
<span class="doccomment">/// Sender flavors.
</span><span class="kw">enum </span>SenderFlavor&lt;T&gt; {
    <span class="doccomment">/// Bounded channel based on a preallocated array.
    </span>Array(counter::Sender&lt;flavors::array::Channel&lt;T&gt;&gt;),

    <span class="doccomment">/// Unbounded channel implemented as a linked list.
    </span>List(counter::Sender&lt;flavors::list::Channel&lt;T&gt;&gt;),

    <span class="doccomment">/// Zero-capacity channel.
    </span>Zero(counter::Sender&lt;flavors::zero::Channel&lt;T&gt;&gt;),
}
...
<span class="kw">impl</span>&lt;T&gt; UnwindSafe <span class="kw">for </span>Sender&lt;T&gt; {}
<span class="kw">impl</span>&lt;T&gt; RefUnwindSafe <span class="kw">for </span>Sender&lt;T&gt; {}

<span class="kw">impl</span>&lt;T&gt; Sender&lt;T&gt; {
    <span class="doccomment">/// Attempts to send a message into the channel without blocking.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>try_send(<span class="kw-2">&amp;</span><span class="self">self</span>, msg: T) -&gt; <span class="prelude-ty">Result</span>&lt;(), TrySendError&lt;T&gt;&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
    ...
    <span class="doccomment">/// Blocks the current thread until a message is sent or the channel is disconnected.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>send(<span class="kw-2">&amp;</span><span class="self">self</span>, msg: T) -&gt; <span class="prelude-ty">Result</span>&lt;(), SendError&lt;T&gt;&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            SenderFlavor::Array(chan) =&gt; chan.send(msg, <span class="prelude-val">None</span>),
            SenderFlavor::List(chan) =&gt; chan.send(msg, <span class="prelude-val">None</span>),
            SenderFlavor::Zero(chan) =&gt; chan.send(msg, <span class="prelude-val">None</span>),
        }
    ...
    <span class="doccomment">/// Waits for a message to be sent into the channel, but only for a limited time.
    ///
    /// If the channel is full and not disconnected, this call will block until the send operation
    ...
    /// );
    /// ```
    </span><span class="kw">pub fn </span>send_timeout(<span class="kw-2">&amp;</span><span class="self">self</span>, msg: T, timeout: Duration) -&gt; <span class="prelude-ty">Result</span>&lt;(), SendTimeoutError&lt;T&gt;&gt; {
        <span class="kw">match </span>Instant::now().checked_add(timeout) {
            <span class="prelude-val">Some</span>(deadline) =&gt; <span class="self">self</span>.send_deadline(msg, deadline),
            <span class="prelude-val">None </span>=&gt; <span class="self">self</span>.send(msg).map_err(SendTimeoutError::from),
        }
    }

    <span class="doccomment">/// Waits for a message to be sent into the channel, but only until a given deadline.
    ///
    /// If the channel is full and not disconnected, this call will block until the send operation
    /// can proceed or the operation times out. If the channel becomes disconnected, this call will
    /// wake up and return an error. The returned error contains the original message.
    ...
    /// );
    /// ```
    </span><span class="kw">pub fn </span>send_deadline(<span class="kw-2">&amp;</span><span class="self">self</span>, msg: T, deadline: Instant) -&gt; <span class="prelude-ty">Result</span>&lt;(), SendTimeoutError&lt;T&gt;&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            SenderFlavor::Array(chan) =&gt; chan.send(msg, <span class="prelude-val">Some</span>(deadline)),
            SenderFlavor::List(chan) =&gt; chan.send(msg, <span class="prelude-val">Some</span>(deadline)),
            SenderFlavor::Zero(chan) =&gt; chan.send(msg, <span class="prelude-val">Some</span>(deadline)),
        }
    }
    ...
    <span class="doccomment">/// If the channel is bounded, returns its capacity.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    </span><span class="kw">pub fn </span>capacity(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
    ...
    /// ```
    </span><span class="kw">pub fn </span>same_channel(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Sender&lt;T&gt;) -&gt; bool {
        <span class="kw">match </span>(<span class="kw-2">&amp;</span><span class="self">self</span>.flavor, <span class="kw-2">&amp;</span>other.flavor) {
            (SenderFlavor::Array(<span class="kw-2">ref </span>a), SenderFlavor::Array(<span class="kw-2">ref </span>b)) =&gt; a == b,
            (SenderFlavor::List(<span class="kw-2">ref </span>a), SenderFlavor::List(<span class="kw-2">ref </span>b)) =&gt; a == b,
            (SenderFlavor::Zero(<span class="kw-2">ref </span>a), SenderFlavor::Zero(<span class="kw-2">ref </span>b)) =&gt; a == b,
...
<span class="kw">impl</span>&lt;T&gt; Clone <span class="kw">for </span>Sender&lt;T&gt; {
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>flavor = <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
...
<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>Sender&lt;T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"Sender { .. }"</span>)
    }
}

<span class="doccomment">/// The receiving side of a channel.
///
/// # Examples
///
/// ```
...
<span class="doccomment">/// Receiver flavors.
</span><span class="kw">enum </span>ReceiverFlavor&lt;T&gt; {
    <span class="doccomment">/// Bounded channel based on a preallocated array.
    </span>Array(counter::Receiver&lt;flavors::array::Channel&lt;T&gt;&gt;),

    <span class="doccomment">/// Unbounded channel implemented as a linked list.
    </span>List(counter::Receiver&lt;flavors::list::Channel&lt;T&gt;&gt;),

    <span class="doccomment">/// Zero-capacity channel.
    </span>Zero(counter::Receiver&lt;flavors::zero::Channel&lt;T&gt;&gt;),

    <span class="doccomment">/// The after flavor.
    </span>At(Arc&lt;flavors::at::Channel&gt;),

    <span class="doccomment">/// The tick flavor.
    </span>Tick(Arc&lt;flavors::tick::Channel&gt;),

    <span class="doccomment">/// The never flavor.
    </span>Never(flavors::never::Channel&lt;T&gt;),
}
...
<span class="kw">impl</span>&lt;T&gt; UnwindSafe <span class="kw">for </span>Receiver&lt;T&gt; {}
<span class="kw">impl</span>&lt;T&gt; RefUnwindSafe <span class="kw">for </span>Receiver&lt;T&gt; {}

<span class="kw">impl</span>&lt;T&gt; Receiver&lt;T&gt; {
    <span class="doccomment">/// Attempts to receive a message from the channel without blocking.
    ///
    ...
    /// ```
        ...
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            ...
            ReceiverFlavor::At(chan) =&gt; {
                <span class="kw">let </span>msg = chan.try_recv();
                <span class="kw">unsafe </span>{
                    mem::transmute_copy::&lt;<span class="prelude-ty">Result</span>&lt;Instant, TryRecvError&gt;, <span class="prelude-ty">Result</span>&lt;T, TryRecvError&gt;&gt;(
    ...
    <span class="doccomment">/// Blocks the current thread until a message is received or the channel is empty and
    /// disconnected.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>recv(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;T, RecvError&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            ReceiverFlavor::Array(chan) =&gt; chan.recv(<span class="prelude-val">None</span>),
            ReceiverFlavor::List(chan) =&gt; chan.recv(<span class="prelude-val">None</span>),
            ReceiverFlavor::Zero(chan) =&gt; chan.recv(<span class="prelude-val">None</span>),
            ReceiverFlavor::At(chan) =&gt; {
                <span class="kw">let </span>msg = chan.recv(<span class="prelude-val">None</span>);
                <span class="kw">unsafe </span>{
                    mem::transmute_copy::&lt;
                        <span class="prelude-ty">Result</span>&lt;Instant, RecvTimeoutError&gt;,
                        <span class="prelude-ty">Result</span>&lt;T, RecvTimeoutError&gt;,
                    &gt;(<span class="kw-2">&amp;</span>msg)
                }
            }
            ReceiverFlavor::Tick(chan) =&gt; {
            ...
            ReceiverFlavor::Never(chan) =&gt; chan.recv(<span class="prelude-val">None</span>),
        }
        .map_err(|<span class="kw">_</span>| RecvError)
    }

    <span class="doccomment">/// Waits for a message to be received from the channel, but only for a limited time.
    ///
    /// If the channel is empty and not disconnected, this call will block until the receive
    ...
    /// ```
        ...
        <span class="kw">match </span>Instant::now().checked_add(timeout) {
            ...
            <span class="prelude-val">None </span>=&gt; <span class="self">self</span>.recv().map_err(RecvTimeoutError::from),
        }
    }

    <span class="doccomment">/// Waits for a message to be received from the channel, but only before a given deadline.
    ///
    /// If the channel is empty and not disconnected, this call will block until the receive
    /// operation can proceed or the operation times out. If the channel is empty and becomes
    /// disconnected, this call will wake up and return an error.
    ...
    /// ```
        ...
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            ReceiverFlavor::Array(chan) =&gt; chan.recv(<span class="prelude-val">Some</span>(deadline)),
            ReceiverFlavor::List(chan) =&gt; chan.recv(<span class="prelude-val">Some</span>(deadline)),
            ReceiverFlavor::Zero(chan) =&gt; chan.recv(<span class="prelude-val">Some</span>(deadline)),
            ReceiverFlavor::At(chan) =&gt; {
                <span class="kw">let </span>msg = chan.recv(<span class="prelude-val">Some</span>(deadline));
                <span class="kw">unsafe </span>{
                    mem::transmute_copy::&lt;
                        <span class="prelude-ty">Result</span>&lt;Instant, RecvTimeoutError&gt;,
                        <span class="prelude-ty">Result</span>&lt;T, RecvTimeoutError&gt;,
            ...
            ReceiverFlavor::Never(chan) =&gt; chan.recv(<span class="prelude-val">Some</span>(deadline)),
        }
    }
    ...
    <span class="doccomment">/// A blocking iterator over messages in the channel.
    ///
    ...
    /// ```
        ...
        Iter { receiver: <span class="self">self </span>}
    }

    <span class="doccomment">/// A non-blocking iterator over messages in the channel.
    ///
    ...
    /// assert_eq!(v, [1, 2]);
    /// ```
    </span><span class="kw">pub fn </span>try_iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; TryIter&lt;<span class="lifetime">'_</span>, T&gt; {
        TryIter { receiver: <span class="self">self </span>}
    }
    ...
    /// ```
    </span><span class="kw">pub fn </span>same_channel(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Receiver&lt;T&gt;) -&gt; bool {
        <span class="kw">match </span>(<span class="kw-2">&amp;</span><span class="self">self</span>.flavor, <span class="kw-2">&amp;</span>other.flavor) {
            ...
            (ReceiverFlavor::Never(<span class="kw">_</span>), ReceiverFlavor::Never(<span class="kw">_</span>)) =&gt; <span class="bool-val">true</span>,
            <span class="kw">_ </span>=&gt; <span class="bool-val">false</span>,
        }
    }
}
    ...
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw">unsafe </span>{
            <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
                ...
                ReceiverFlavor::At(<span class="kw">_</span>) =&gt; {}
                ReceiverFlavor::Tick(<span class="kw">_</span>) =&gt; {}
                ReceiverFlavor::Never(<span class="kw">_</span>) =&gt; {}
            }
        }
    }
}
...
<span class="kw">impl</span>&lt;T&gt; Clone <span class="kw">for </span>Receiver&lt;T&gt; {
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>flavor = <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            ...
            ReceiverFlavor::Never(<span class="kw">_</span>) =&gt; ReceiverFlavor::Never(flavors::never::Channel::new()),
        };
...
<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>Receiver&lt;T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"Receiver { .. }"</span>)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>Receiver&lt;T&gt; {
...
<span class="kw">impl</span>&lt;T&gt; IntoIterator <span class="kw">for </span>Receiver&lt;T&gt; {
    <span class="kw">type </span>Item = T;
    <span class="kw">type </span>IntoIter = IntoIter&lt;T&gt;;

    <span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::IntoIter {
        IntoIter { receiver: <span class="self">self </span>}
    }
}

<span class="doccomment">/// A blocking iterator over messages in a channel.
///
...
/// ```
    ...
    receiver: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Receiver&lt;T&gt;,
}

<span class="kw">impl</span>&lt;T&gt; FusedIterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'_</span>, T&gt; {}

<span class="kw">impl</span>&lt;T&gt; Iterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'_</span>, T&gt; {
    <span class="kw">type </span>Item = T;

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="self">self</span>.receiver.recv().ok()
    }
}

<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>Iter&lt;<span class="lifetime">'_</span>, T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"Iter { .. }"</span>)
    }
}

<span class="doccomment">/// A non-blocking iterator over messages in a channel.
///
/// Each call to [`next`] returns a message if there is one ready to be received. The iterator
/// never blocks waiting for the next message.
///
...
/// assert_eq!(v, [1, 2]);
/// ```
</span><span class="kw">pub struct </span>TryIter&lt;<span class="lifetime">'a</span>, T&gt; {
    receiver: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Receiver&lt;T&gt;,
}

<span class="kw">impl</span>&lt;T&gt; Iterator <span class="kw">for </span>TryIter&lt;<span class="lifetime">'_</span>, T&gt; {
    <span class="kw">type </span>Item = T;

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="self">self</span>.receiver.try_recv().ok()
    }
}

<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>TryIter&lt;<span class="lifetime">'_</span>, T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"TryIter { .. }"</span>)
    }
}
...
<span class="kw">impl</span>&lt;T&gt; fmt::Debug <span class="kw">for </span>IntoIter&lt;T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.pad(<span class="string">"IntoIter { .. }"</span>)
    }
}

<span class="kw">impl</span>&lt;T&gt; SelectHandle <span class="kw">for </span>Sender&lt;T&gt; {
...
<span class="kw">impl</span>&lt;T&gt; SelectHandle <span class="kw">for </span>Receiver&lt;T&gt; {
    <span class="kw">fn </span>try_select(<span class="kw-2">&amp;</span><span class="self">self</span>, token: <span class="kw-2">&amp;mut </span>Token) -&gt; bool {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
    ...
    <span class="kw">fn </span>deadline(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;Instant&gt; {
        <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.flavor {
            ReceiverFlavor::Array(<span class="kw">_</span>) =&gt; <span class="prelude-val">None</span>,
            ReceiverFlavor::List(<span class="kw">_</span>) =&gt; <span class="prelude-val">None</span>,
            ReceiverFlavor::Zero(<span class="kw">_</span>) =&gt; <span class="prelude-val">None</span>,
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">unsafe fn </span>write&lt;T&gt;(s: <span class="kw-2">&amp;</span>Sender&lt;T&gt;, token: <span class="kw-2">&amp;mut </span>Token, msg: T) -&gt; <span class="prelude-ty">Result</span>&lt;(), T&gt; {
    <span class="kw">match </span><span class="kw-2">&amp;</span>s.flavor {
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">unsafe fn </span>read&lt;T&gt;(r: <span class="kw-2">&amp;</span>Receiver&lt;T&gt;, token: <span class="kw-2">&amp;mut </span>Token) -&gt; <span class="prelude-ty">Result</span>&lt;T, ()&gt; {
    <span class="kw">match </span><span class="kw-2">&amp;</span>r.flavor {
        ...
        ReceiverFlavor::At(chan) =&gt; {
            mem::transmute_copy::&lt;<span class="prelude-ty">Result</span>&lt;Instant, ()&gt;, <span class="prelude-ty">Result</span>&lt;T, ()&gt;&gt;(<span class="kw-2">&amp;</span>chan.read(token))
        }
        ReceiverFlavor::Tick(chan) =&gt; {
            mem::transmute_copy::&lt;<span class="prelude-ty">Result</span>&lt;Instant, ()&gt;, <span class="prelude-ty">Result</span>&lt;T, ()&gt;&gt;(<span class="kw-2">&amp;</span>chan.read(token))
        }
