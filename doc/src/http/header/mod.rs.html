...
</pre></div><pre class="rust"><code><span class="doccomment">//! HTTP header types
//!
...
<span class="kw">pub use </span><span class="self">self</span>::map::{
...
<span class="kw">pub use </span><span class="self">self</span>::name::{HeaderName, InvalidHeaderName};
<span class="kw">pub use </span><span class="self">self</span>::value::{HeaderValue, InvalidHeaderValue, ToStrError};

<span class="comment">// Use header name constants
</span><span class="kw">pub use </span><span class="self">self</span>::name::{
    ACCEPT,
    ACCEPT_CHARSET,
    ACCEPT_ENCODING,
    ACCEPT_LANGUAGE,
...
<span class="doccomment">/// Maximum length of a header name
///
...
</span><span class="kw">const </span>MAX_HEADER_NAME_LEN: usize = (<span class="number">1 </span>&lt;&lt; <span class="number">16</span>) - <span class="number">1</span>;
