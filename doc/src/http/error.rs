...
<span class="kw">use </span><span class="kw">crate</span>::header::MaxSizeReached;
...
<span class="kw">impl </span>Error {
    ...
    <span class="doccomment">/// Return a reference to the lower level, inner error.
        ...
        <span class="kw">match </span><span class="self">self</span>.inner {
            ...
            MaxSizeReached(<span class="kw-2">ref </span>e) =&gt; e,
        }
    }
}
...
<span class="kw">impl </span>From&lt;MaxSizeReached&gt; <span class="kw">for </span>Error {
    <span class="kw">fn </span>from(err: MaxSizeReached) -&gt; Error {
        Error {
