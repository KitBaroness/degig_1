...
<span class="kw">fn </span>public_values_eq(a: untrusted::Input&lt;<span class="lifetime">'_</span>&gt;, b: untrusted::Input&lt;<span class="lifetime">'_</span>&gt;) -&gt; bool {
