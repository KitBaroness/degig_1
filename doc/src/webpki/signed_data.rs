...
</span><span class="kw">use </span><span class="kw">crate</span>::verify_cert::Budget;
...
</span><span class="attr">#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"alloc"</span>)))]
#[cfg(feature = <span class="string">"alloc"</span>)]
#[derive(Clone, Debug)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>OwnedSignedData {
    ...
    /// TLS 1.2 signed data.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) data: Vec&lt;u8&gt;,
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) algorithm: Vec&lt;u8&gt;,
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) signature: Vec&lt;u8&gt;,
}

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">impl </span>OwnedSignedData {
    <span class="doccomment">/// Return a borrowed [`SignedData`] from the owned representation.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>borrow(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; SignedData&lt;<span class="lifetime">'_</span>&gt; {
        SignedData {
            data: untrusted::Input::from(<span class="kw-2">&amp;</span><span class="self">self</span>.data),
            algorithm: untrusted::Input::from(<span class="kw-2">&amp;</span><span class="self">self</span>.algorithm),
            signature: untrusted::Input::from(<span class="kw-2">&amp;</span><span class="self">self</span>.signature),
        }
    }
}
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>SignedData&lt;<span class="lifetime">'a</span>&gt; {
    <span class="doccomment">/// The signed data. This would be `tbsCertificate` in the case of an X.509
    /// certificate, `tbsResponseData` in the case of an OCSP response, `tbsCertList`
    /// in the case of a CRL, and the data nested in the `digitally-signed` construct for
    /// TLS 1.2 signed data.
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; SignedData&lt;<span class="lifetime">'a</span>&gt; {
    ...
    /// function will read.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>from_der(
        der: <span class="kw-2">&amp;mut </span>untrusted::Reader&lt;<span class="lifetime">'a</span>&gt;,
        size_limit: usize,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;(untrusted::Input&lt;<span class="lifetime">'a</span>&gt;, <span class="self">Self</span>), Error&gt; {
        <span class="kw">let </span>(data, tbs) = der.read_partial(|input| {
    ...
    <span class="doccomment">/// Convert the borrowed signed data to an [`OwnedSignedData`].
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>to_owned(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; OwnedSignedData {
        OwnedSignedData {
            data: <span class="self">self</span>.data.as_slice_less_safe().to_vec(),
            algorithm: <span class="self">self</span>.algorithm.as_slice_less_safe().to_vec(),
            signature: <span class="self">self</span>.signature.as_slice_less_safe().to_vec(),
        }
    }
}
...
/// linearly for matches.
    ...
    supported_algorithms: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>SignatureAlgorithm],
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>verify_signature(
    ...
    <span class="kw">let </span>spki = SubjectPublicKeyInfo::from_der(spki_value)<span class="question-mark">?</span>;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; SubjectPublicKeyInfo&lt;<span class="lifetime">'a</span>&gt; {
    ...
    </span><span class="kw">fn </span>from_der(input: untrusted::Input&lt;<span class="lifetime">'a</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, Error&gt; {
...
<span class="kw">impl </span>AlgorithmIdentifier {
    <span class="kw">fn </span>matches_algorithm_id_value(<span class="kw-2">&amp;</span><span class="self">self</span>, encoded: untrusted::Input) -&gt; bool {
        public_values_eq(encoded, <span class="self">self</span>.asn1_id_value)
    }
}
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_ENCRYPTION: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PKCS1_SHA256: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PKCS1_SHA384: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PKCS1_SHA512: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PSS_SHA256: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PSS_SHA384: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">const </span>RSA_PSS_SHA512: AlgorithmIdentifier = AlgorithmIdentifier {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="macro">macro_rules!</span> test_file_bytes {
        ( <span class="macro-nonterminal">$file_name</span>:expr ) =&gt; {
            <span class="macro">include_bytes!</span>(<span class="macro">concat!</span>(
                <span class="string">"../third-party/chromium/data/verify_signed_data/"</span>,
                <span class="macro-nonterminal">$file_name
            </span>))
        };
    }
    ...
    <span class="comment">// TODO: The expected results need to be modified for SHA-1 deprecation.
        ...
        (<span class="macro-nonterminal">$fn_name</span>:ident, <span class="macro-nonterminal">$file_name</span>:expr, <span class="macro-nonterminal">$expected_result</span>:expr) =&gt; {
            ...
            </span><span class="kw">fn </span><span class="macro-nonterminal">$fn_name</span>() {
                test_verify_signed_data(<span class="macro">test_file_bytes!</span>(<span class="macro-nonterminal">$file_name</span>), <span class="macro-nonterminal">$expected_result</span>);
            }
        };
    }

    <span class="kw">fn </span>test_verify_signed_data(file_contents: <span class="kw-2">&amp;</span>[u8], expected_result: <span class="prelude-ty">Result</span>&lt;(), Error&gt;) {
        <span class="kw">let </span>tsd = parse_test_signed_data(file_contents);
        ...
        (<span class="macro-nonterminal">$fn_name</span>:ident, <span class="macro-nonterminal">$file_name</span>:expr, <span class="macro-nonterminal">$expected_result</span>:expr) =&gt; {
            <span class="attr">#[test]
                ...
                test_verify_signed_data_signature_outer(
                    <span class="macro">test_file_bytes!</span>(<span class="macro-nonterminal">$file_name</span>),
                    <span class="macro-nonterminal">$expected_result</span>,
                );
            }
        };
    }

    <span class="kw">fn </span>test_verify_signed_data_signature_outer(file_contents: <span class="kw-2">&amp;</span>[u8], expected_error: Error) {
        <span class="kw">let </span>tsd = parse_test_signed_data(file_contents);
        <span class="kw">let </span>signature = untrusted::Input::from(<span class="kw-2">&amp;</span>tsd.signature);
        <span class="macro">assert_eq!</span>(
            signature
    ...
    <span class="comment">// XXX: This is testing code that is not even in this module.
        ...
        (<span class="macro-nonterminal">$fn_name</span>:ident, <span class="macro-nonterminal">$file_name</span>:expr, <span class="macro-nonterminal">$error</span>:expr) =&gt; {
            <span class="attr">#[test]
                ...
                test_parse_spki_bad_outer(<span class="macro">test_file_bytes!</span>(<span class="macro-nonterminal">$file_name</span>), <span class="macro-nonterminal">$error</span>)
            }
        };
    }

    <span class="kw">fn </span>test_parse_spki_bad_outer(file_contents: <span class="kw-2">&amp;</span>[u8], expected_error: Error) {
        <span class="kw">let </span>tsd = parse_test_signed_data(file_contents);
    ...
    <span class="kw">const </span>UNSUPPORTED_SIGNATURE_ALGORITHM_FOR_RSA_KEY: Error = <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"alloc"</span>) {
        Error::UnsupportedSignatureAlgorithmForPublicKey
    } <span class="kw">else </span>{
        Error::UnsupportedSignatureAlgorithm
    };

    <span class="kw">const </span>INVALID_SIGNATURE_FOR_RSA_KEY: Error = <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"alloc"</span>) {
        Error::InvalidSignatureForPublicKey
    } <span class="kw">else </span>{
        Error::UnsupportedSignatureAlgorithm
    };

    <span class="kw">const </span>OK_IF_RSA_AVAILABLE: <span class="prelude-ty">Result</span>&lt;(), Error&gt; = <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"alloc"</span>) {
        <span class="prelude-val">Ok</span>(())
    } <span class="kw">else </span>{
        <span class="prelude-val">Err</span>(Error::UnsupportedSignatureAlgorithm)
    };
    ...
    <span class="macro">test_verify_signed_data!</span>(
        ...
        <span class="prelude-val">Err</span>(UNSUPPORTED_SIGNATURE_ALGORITHM_FOR_RSA_KEY)
    );
    <span class="comment">// XXX: We should have a variant of this test with a SHA-256 digest that gives
    // `Error::InvalidSignatureForPublicKey`.
    </span><span class="macro">test_verify_signed_data!</span>(
    ...
    <span class="macro">test_verify_signed_data!</span>(
        ...
        <span class="prelude-val">Err</span>(INVALID_SIGNATURE_FOR_RSA_KEY)
    );
    <span class="macro">test_verify_signed_data!</span>(
        test_rsa_pkcs1_sha1,
    ...
    <span class="kw">fn </span>parse_test_signed_data(file_contents: <span class="kw-2">&amp;</span>[u8]) -&gt; TestSignedData {
        <span class="kw">let </span><span class="kw-2">mut </span>lines = core::str::from_utf8(file_contents).unwrap().lines();
    ...
    <span class="kw">use </span>alloc::str::Lines;

    <span class="kw">fn </span>read_pem_section(lines: <span class="kw-2">&amp;mut </span>Lines, section_name: <span class="kw-2">&amp;</span>str) -&gt; Vec&lt;u8&gt; {
        ...
        <span class="kw">loop </span>{
            <span class="kw">let </span>line = lines.next().unwrap();
        ...
        general_purpose::STANDARD.decode(<span class="kw-2">&amp;</span>base64).unwrap()
    }
    ...
    <span class="kw">static </span>SUPPORTED_ALGORITHMS_IN_TESTS: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>signed_data::SignatureAlgorithm] = <span class="kw-2">&amp;</span>[
        ...
        </span><span class="kw-2">&amp;</span>signed_data::ECDSA_P256_SHA256,
        ...
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PKCS1_2048_8192_SHA384,
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PKCS1_2048_8192_SHA512,
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PKCS1_3072_8192_SHA384,
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PSS_2048_8192_SHA256_LEGACY_KEY,
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PSS_2048_8192_SHA384_LEGACY_KEY,
        <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
        </span><span class="kw-2">&amp;</span>signed_data::RSA_PSS_2048_8192_SHA512_LEGACY_KEY,
