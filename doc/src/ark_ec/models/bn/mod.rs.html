...
<span class="kw">pub trait </span>BnConfig: <span class="lifetime">'static </span>+ Sized {
    <span class="doccomment">/// The absolute value of the BN curve parameter `X`
    ...
    <span class="doccomment">/// Whether or not `X` is negative.
    </span><span class="kw">const </span>X_IS_NEGATIVE: bool;

    <span class="doccomment">/// The absolute value of `6X + 2`.
    </span><span class="kw">const </span>ATE_LOOP_COUNT: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>[i8];

    <span class="kw">const </span>TWIST_TYPE: TwistType;
    <span class="kw">const </span>TWIST_MUL_BY_Q_X: Fp2&lt;<span class="self">Self</span>::Fp2Config&gt;;
    <span class="kw">const </span>TWIST_MUL_BY_Q_Y: Fp2&lt;<span class="self">Self</span>::Fp2Config&gt;;
    ...
    <span class="kw">fn </span>multi_miller_loop(
    ...
    ) -&gt; MillerLoopOutput&lt;Bn&lt;<span class="self">Self</span>&gt;&gt; {
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>f = <span class="macro">cfg_chunks_mut!</span>(pairs, <span class="number">4</span>)
            .map(|pairs| {
                <span class="kw">let </span><span class="kw-2">mut </span>f = &lt;Bn&lt;<span class="self">Self</span>&gt; <span class="kw">as </span>Pairing&gt;::TargetField::one();
                <span class="kw">for </span>i <span class="kw">in </span>(<span class="number">1</span>..<span class="self">Self</span>::ATE_LOOP_COUNT.len()).rev() {
                    <span class="kw">if </span>i != <span class="self">Self</span>::ATE_LOOP_COUNT.len() - <span class="number">1 </span>{
                        f.square_in_place();
                    }

                    <span class="kw">for </span>(p, coeffs) <span class="kw">in </span>pairs.iter_mut() {
                        Bn::&lt;<span class="self">Self</span>&gt;::ell(<span class="kw-2">&amp;mut </span>f, <span class="kw-2">&amp;</span>coeffs.next().unwrap(), <span class="kw-2">&amp;</span>p.<span class="number">0</span>);
                    }

                    <span class="kw">let </span>bit = <span class="self">Self</span>::ATE_LOOP_COUNT[i - <span class="number">1</span>];
            ...
            .product::&lt;&lt;Bn&lt;<span class="self">Self</span>&gt; <span class="kw">as </span>Pairing&gt;::TargetField&gt;();

        <span class="kw">if </span><span class="self">Self</span>::X_IS_NEGATIVE {
            f.cyclotomic_inverse_in_place();
        }

        <span class="kw">for </span>(p, coeffs) <span class="kw">in </span><span class="kw-2">&amp;mut </span>pairs {
            Bn::&lt;<span class="self">Self</span>&gt;::ell(<span class="kw-2">&amp;mut </span>f, <span class="kw-2">&amp;</span>coeffs.next().unwrap(), <span class="kw-2">&amp;</span>p.<span class="number">0</span>);
        }
    ...
    <span class="attr">#[allow(clippy::let_and_return)]
    </span><span class="kw">fn </span>final_exponentiation(f: MillerLoopOutput&lt;Bn&lt;<span class="self">Self</span>&gt;&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;PairingOutput&lt;Bn&lt;<span class="self">Self</span>&gt;&gt;&gt; {
        <span class="comment">// Easy part: result = elt^((q^6-1)*(q^2+1)).
        // Follows, e.g., Beuchat et al page 9, by computing result as follows:
        //   elt^((q^6-1)*(q^2+1)) = (conj(elt) * elt^(-1))^(q^2+1)
        </span><span class="kw">let </span>f = f.<span class="number">0</span>;

        <span class="comment">// f1 = r.cyclotomic_inverse_in_place() = f^(p^6)
        </span><span class="kw">let </span><span class="kw-2">mut </span>f1 = f;
        ...
        f.inverse().map(|<span class="kw-2">mut </span>f2| {
            ...
            <span class="comment">// Hard part follows Laura Fuentes-Castaneda et al. "Faster hashing to G2"
            // by computing:
            //
            ...
            </span><span class="kw">let </span>y0 = Bn::&lt;<span class="self">Self</span>&gt;::exp_by_neg_x(r);
            <span class="kw">let </span>y1 = y0.cyclotomic_square();
            <span class="kw">let </span>y2 = y1.cyclotomic_square();
            <span class="kw">let </span><span class="kw-2">mut </span>y3 = y2 * <span class="kw-2">&amp;</span>y1;
            <span class="kw">let </span>y4 = Bn::&lt;<span class="self">Self</span>&gt;::exp_by_neg_x(y3);
            <span class="kw">let </span>y5 = y4.cyclotomic_square();
            <span class="kw">let </span><span class="kw-2">mut </span>y6 = Bn::&lt;<span class="self">Self</span>&gt;::exp_by_neg_x(y5);
            y3.cyclotomic_inverse_in_place();
            y6.cyclotomic_inverse_in_place();
            <span class="kw">let </span>y7 = y6 * <span class="kw-2">&amp;</span>y4;
            <span class="kw">let </span><span class="kw-2">mut </span>y8 = y7 * <span class="kw-2">&amp;</span>y3;
            <span class="kw">let </span>y9 = y8 * <span class="kw-2">&amp;</span>y1;
            <span class="kw">let </span>y10 = y8 * <span class="kw-2">&amp;</span>y4;
            <span class="kw">let </span>y11 = y10 * <span class="kw-2">&amp;</span>r;
            <span class="kw">let </span><span class="kw-2">mut </span>y12 = y9;
            y12.frobenius_map_in_place(<span class="number">1</span>);
            <span class="kw">let </span>y13 = y12 * <span class="kw-2">&amp;</span>y11;
            y8.frobenius_map_in_place(<span class="number">2</span>);
            <span class="kw">let </span>y14 = y8 * <span class="kw-2">&amp;</span>y13;
            r.cyclotomic_inverse_in_place();
            <span class="kw">let </span><span class="kw-2">mut </span>y15 = r * <span class="kw-2">&amp;</span>y9;
            y15.frobenius_map_in_place(<span class="number">3</span>);
            <span class="kw">let </span>y16 = y15 * <span class="kw-2">&amp;</span>y14;
...
</span><span class="kw">pub struct </span>Bn&lt;P: BnConfig&gt;(PhantomData&lt;<span class="kw">fn</span>() -&gt; P&gt;);

<span class="kw">impl</span>&lt;P: BnConfig&gt; Bn&lt;P&gt; {
    <span class="doccomment">/// Evaluates the line function at point p.
        ...
        <span class="kw">match </span>P::TWIST_TYPE {
            TwistType::M =&gt; {
                c2.mul_assign_by_fp(<span class="kw-2">&amp;</span>p.y);
                c1.mul_assign_by_fp(<span class="kw-2">&amp;</span>p.x);
                f.mul_by_014(<span class="kw-2">&amp;</span>c0, <span class="kw-2">&amp;</span>c1, <span class="kw-2">&amp;</span>c2);
            },
            TwistType::D =&gt; {
                c0.mul_assign_by_fp(<span class="kw-2">&amp;</span>p.y);
                c1.mul_assign_by_fp(<span class="kw-2">&amp;</span>p.x);
    ...
    <span class="kw">fn </span>exp_by_neg_x(<span class="kw-2">mut </span>f: Fp12&lt;P::Fp12Config&gt;) -&gt; Fp12&lt;P::Fp12Config&gt; {
...
<span class="kw">impl</span>&lt;P: BnConfig&gt; Pairing <span class="kw">for </span>Bn&lt;P&gt; {
