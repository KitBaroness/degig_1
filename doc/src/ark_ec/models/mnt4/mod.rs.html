...
<span class="kw">pub type </span>GT&lt;P&gt; = Fp4&lt;P&gt;;

<span class="kw">pub trait </span>MNT4Config: <span class="lifetime">'static </span>+ Sized {
    <span class="kw">const </span>TWIST: Fp2&lt;<span class="self">Self</span>::Fp2Config&gt;;
    <span class="kw">const </span>TWIST_COEFF_A: Fp2&lt;<span class="self">Self</span>::Fp2Config&gt;;
    ...
    <span class="kw">type </span>Fp4Config: Fp4Config&lt;Fp2Config = <span class="self">Self</span>::Fp2Config&gt;;
    ...
    <span class="kw">fn </span>multi_miller_loop(
    ...
    ) -&gt; MillerLoopOutput&lt;MNT4&lt;<span class="self">Self</span>&gt;&gt; {
        ...
        <span class="kw">let </span>result = <span class="macro">cfg_into_iter!</span>(pairs)
            .map(|(a, b)| MNT4::&lt;<span class="self">Self</span>&gt;::ate_miller_loop(<span class="kw-2">&amp;</span>a, <span class="kw-2">&amp;</span>b))
            .product();
        MillerLoopOutput(result)
    }

    <span class="kw">fn </span>final_exponentiation(f: MillerLoopOutput&lt;MNT4&lt;<span class="self">Self</span>&gt;&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;PairingOutput&lt;MNT4&lt;<span class="self">Self</span>&gt;&gt;&gt; {
        ...
        <span class="kw">let </span>value_to_first_chunk =
            MNT4::&lt;<span class="self">Self</span>&gt;::final_exponentiation_first_chunk(<span class="kw-2">&amp;</span>value, <span class="kw-2">&amp;</span>value_inv);
        <span class="kw">let </span>value_inv_to_first_chunk =
            MNT4::&lt;<span class="self">Self</span>&gt;::final_exponentiation_first_chunk(<span class="kw-2">&amp;</span>value_inv, <span class="kw-2">&amp;</span>value);
        <span class="kw">let </span>result = MNT4::&lt;<span class="self">Self</span>&gt;::final_exponentiation_last_chunk(
...
</span><span class="kw">pub struct </span>MNT4&lt;P: MNT4Config&gt;(PhantomData&lt;<span class="kw">fn</span>() -&gt; P&gt;);

<span class="kw">impl</span>&lt;P: MNT4Config&gt; MNT4&lt;P&gt; {
    <span class="kw">fn </span>doubling_for_flipped_miller_loop(
        ...
        <span class="kw">let </span>x = -(e + <span class="kw-2">&amp;</span>e + <span class="kw-2">&amp;</span>e + <span class="kw-2">&amp;</span>e) + <span class="kw-2">&amp;</span>g;
        <span class="kw">let </span>y = -d_eight + <span class="kw-2">&amp;</span>(f * <span class="kw-2">&amp;</span>(e + <span class="kw-2">&amp;</span>e - <span class="kw-2">&amp;</span>x));
    ...
    <span class="kw">fn </span>mixed_addition_for_flipped_miller_loop(
        x: <span class="kw-2">&amp;</span>Fp2&lt;P::Fp2Config&gt;,
        y: <span class="kw-2">&amp;</span>Fp2&lt;P::Fp2Config&gt;,
        r: <span class="kw-2">&amp;</span>G2ProjectiveExtended&lt;P&gt;,
        ...
        <span class="kw">let </span>l1 = d - <span class="kw-2">&amp;</span>(r.y + <span class="kw-2">&amp;</span>r.y);

        <span class="kw">let </span>x = l1.square() - <span class="kw-2">&amp;</span>j - <span class="kw-2">&amp;</span>(v + <span class="kw-2">&amp;</span>v);
        <span class="kw">let </span>y = l1 * <span class="kw-2">&amp;</span>(v - <span class="kw-2">&amp;</span>x) - <span class="kw-2">&amp;</span>(j * <span class="kw-2">&amp;</span>(r.y + <span class="kw-2">&amp;</span>r.y));
    ...
    <span class="kw">pub fn </span>ate_miller_loop(p: <span class="kw-2">&amp;</span>G1Prepared&lt;P&gt;, q: <span class="kw-2">&amp;</span>G2Prepared&lt;P&gt;) -&gt; Fp4&lt;P::Fp4Config&gt; {
        <span class="kw">let </span>l1_coeff = Fp2::new(p.x, P::Fp::zero()) - <span class="kw-2">&amp;</span>q.x_over_twist;

        <span class="kw">let </span><span class="kw-2">mut </span>f = &lt;Fp4&lt;P::Fp4Config&gt;&gt;::one();
        ...
        <span class="kw">for </span>(bit, dc) <span class="kw">in </span>P::ATE_LOOP_COUNT.iter().skip(<span class="number">1</span>).zip(<span class="kw-2">&amp;</span>q.double_coefficients) {
            <span class="kw">let </span>g_rr_at_p = Fp4::new(
                -dc.c_4c - <span class="kw-2">&amp;</span>(dc.c_j * <span class="kw-2">&amp;</span>p.x_twist) + <span class="kw-2">&amp;</span>dc.c_l,
        ...
        <span class="kw">if </span>P::ATE_IS_LOOP_COUNT_NEG {
            ...
            <span class="kw">let </span>g_rnegr_at_p = Fp4::new(
                ac.c_rz * <span class="kw-2">&amp;</span>p.y_twist,
                -(q.y_over_twist * <span class="kw-2">&amp;</span>ac.c_rz + <span class="kw-2">&amp;</span>(l1_coeff * <span class="kw-2">&amp;</span>ac.c_l1)),
            );
    ...
    <span class="kw">fn </span>final_exponentiation_first_chunk(
        elt: <span class="kw-2">&amp;</span>Fp4&lt;P::Fp4Config&gt;,
        elt_inv: <span class="kw-2">&amp;</span>Fp4&lt;P::Fp4Config&gt;,
    ) -&gt; Fp4&lt;P::Fp4Config&gt; {
        <span class="comment">// (q^2-1)

        // elt_q2 = elt^(q^2)
        </span><span class="kw">let </span><span class="kw-2">mut </span>elt_q2 = <span class="kw-2">*</span>elt;
...
<span class="kw">impl</span>&lt;P: MNT4Config&gt; Pairing <span class="kw">for </span>MNT4&lt;P&gt; {
    ...
    <span class="kw">type </span>TargetField = Fp4&lt;P::Fp4Config&gt;;
