...
</span><span class="doccomment">//! This crate provides the [`Bitmap`][Bitmap] type as a convenient and
...
</span><span class="kw">mod </span>bitmap;
<span class="kw">mod </span>types;

<span class="attr">#[doc(inline)]
</span><span class="kw">pub use </span><span class="kw">crate</span>::bitmap::{Bitmap, Iter};
<span class="attr">#[doc(inline)]
</span><span class="kw">pub use </span><span class="kw">crate</span>::types::{BitOps, Bits};
