...
<span class="kw">impl </span>AhoCorasickBuilder {
    ...
    /// that first.
        ...
        // noncontiguous NFA in the first place.
            ...
            <span class="attr">#[allow(unused_variables)] </span><span class="comment">// unused when 'logging' is disabled
    ...
    /// number increases.
        ...
        <span class="self">self</span>.nfa_noncontiguous.dense_depth(depth);
