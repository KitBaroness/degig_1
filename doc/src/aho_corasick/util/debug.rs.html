...
</pre></div><pre class="rust"><code><span class="doccomment">/// A type that wraps a single byte with a convenient fmt::Debug impl that
/// escapes the byte.
