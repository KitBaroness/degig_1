...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::util::int::Usize;
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>ByteClasses([u8; <span class="number">256</span>]);
...
<span class="kw">impl </span>ByteClasses {
    ...
    /// the same class.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>empty() -&gt; ByteClasses {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>singletons() -&gt; ByteClasses {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>set(<span class="kw-2">&amp;mut </span><span class="self">self</span>, byte: u8, class: u8) {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>get(<span class="kw-2">&amp;</span><span class="self">self</span>, byte: u8) -&gt; u8 {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>alphabet_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="comment">// Add one since the number of equivalence classes is one bigger than
        // the last one.
        </span>usize::from(<span class="self">self</span>.<span class="number">0</span>[<span class="number">255</span>]) + <span class="number">1
    </span>}
    ...
    /// `2^stride2 = stride`.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>stride2(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
    ...
    <span class="doccomment">/// Returns the stride for these equivalence classes, which corresponds
    /// to the smallest power of 2 greater than or equal to the number of
    /// equivalence classes.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>stride(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_singleton(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; ByteClassIter {
        ByteClassIter { it: <span class="number">0</span>..<span class="self">self</span>.alphabet_len() }
    }

    <span class="doccomment">/// Returns an iterator of the bytes in the given equivalence class.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>elements(<span class="kw-2">&amp;</span><span class="self">self</span>, class: u8) -&gt; ByteClassElements {
        ByteClassElements { classes: <span class="self">self</span>, class, bytes: <span class="number">0</span>..=<span class="number">255 </span>}
    }
    ...
    </span><span class="kw">fn </span>element_ranges(<span class="kw-2">&amp;</span><span class="self">self</span>, class: u8) -&gt; ByteClassElementRanges {
...
<span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>ByteClasses {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="kw">if </span><span class="self">self</span>.is_singleton() {
            <span class="macro">write!</span>(f, <span class="string">"ByteClasses(&lt;one-class-per-byte&gt;)"</span>)
            ...
            <span class="kw">for </span>(i, class) <span class="kw">in </span><span class="self">self</span>.iter().enumerate() {
                ...
                <span class="macro">write!</span>(f, <span class="string">"{:?} =&gt; ["</span>, class)<span class="question-mark">?</span>;
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>ByteClassIter {
    it: core::ops::Range&lt;usize&gt;,
}

<span class="kw">impl </span>Iterator <span class="kw">for </span>ByteClassIter {
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;u8&gt; {
        <span class="self">self</span>.it.next().map(|class| class.as_u8())
    }
}

<span class="doccomment">/// An iterator over all elements in a specific equivalence class.
</span><span class="attr">#[derive(Debug)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>ByteClassElements&lt;<span class="lifetime">'a</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Iterator <span class="kw">for </span>ByteClassElements&lt;<span class="lifetime">'a</span>&gt; {
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;u8&gt; {
        <span class="kw">while let </span><span class="prelude-val">Some</span>(byte) = <span class="self">self</span>.bytes.next() {
            <span class="kw">if </span><span class="self">self</span>.class == <span class="self">self</span>.classes.get(byte) {
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>ByteClassElementRanges&lt;<span class="lifetime">'a</span>&gt; {
    elements: ByteClassElements&lt;<span class="lifetime">'a</span>&gt;,
    range: <span class="prelude-ty">Option</span>&lt;(u8, u8)&gt;,
}
        ...
        <span class="kw">loop </span>{
            ...
            <span class="kw">match </span><span class="self">self</span>.range.take() {
                ...
                <span class="prelude-val">Some</span>((start, end)) =&gt; {
                    <span class="kw">if </span>usize::from(end) + <span class="number">1 </span>!= usize::from(element) {
                        <span class="self">self</span>.range = <span class="prelude-val">Some</span>((element, element));
...
<span class="kw">impl </span>Default <span class="kw">for </span>ByteClassSet {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        // class 5: z-z
        // class 6: \x7B-\xFF
        </span><span class="macro">assert_eq!</span>(classes.alphabet_len(), <span class="number">7</span>);

        <span class="kw">let </span>elements = classes.elements(<span class="number">0</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements.len(), <span class="number">98</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">0</span>], <span class="string">b'\x00'</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">97</span>], <span class="string">b'a'</span>);

        <span class="kw">let </span>elements = classes.elements(<span class="number">1</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements, <span class="macro">vec!</span>[<span class="string">b'b'</span>, <span class="string">b'c'</span>, <span class="string">b'd'</span>],);

        <span class="kw">let </span>elements = classes.elements(<span class="number">2</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements, <span class="macro">vec!</span>[<span class="string">b'e'</span>, <span class="string">b'f'</span>],);

        <span class="kw">let </span>elements = classes.elements(<span class="number">3</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements, <span class="macro">vec!</span>[<span class="string">b'g'</span>, <span class="string">b'h'</span>, <span class="string">b'i'</span>, <span class="string">b'j'</span>, <span class="string">b'k'</span>, <span class="string">b'l'</span>, <span class="string">b'm'</span>,],);

        <span class="kw">let </span>elements = classes.elements(<span class="number">4</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements.len(), <span class="number">12</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">0</span>], <span class="string">b'n'</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">11</span>], <span class="string">b'y'</span>);

        <span class="kw">let </span>elements = classes.elements(<span class="number">5</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements, <span class="macro">vec!</span>[<span class="string">b'z'</span>]);

        <span class="kw">let </span>elements = classes.elements(<span class="number">6</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements.len(), <span class="number">133</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">0</span>], <span class="string">b'\x7B'</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">132</span>], <span class="string">b'\xFF'</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>elements_singletons() {
        <span class="kw">let </span>classes = ByteClasses::singletons();
        <span class="macro">assert_eq!</span>(classes.alphabet_len(), <span class="number">256</span>);

        <span class="kw">let </span>elements = classes.elements(<span class="string">b'a'</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements, <span class="macro">vec!</span>[<span class="string">b'a'</span>]);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>elements_empty() {
        <span class="kw">let </span>classes = ByteClasses::empty();
        <span class="macro">assert_eq!</span>(classes.alphabet_len(), <span class="number">1</span>);

        <span class="kw">let </span>elements = classes.elements(<span class="number">0</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(elements.len(), <span class="number">256</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">0</span>], <span class="string">b'\x00'</span>);
        <span class="macro">assert_eq!</span>(elements[<span class="number">255</span>], <span class="string">b'\xFF'</span>);
    }
}
