...
</span><span class="comment">// We define a little more than what we need, but I'd rather just have
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">trait </span>I8 {
    <span class="kw">fn </span>as_usize(<span class="self">self</span>) -&gt; usize;
    <span class="kw">fn </span>to_bits(<span class="self">self</span>) -&gt; u8;
    <span class="kw">fn </span>from_bits(n: u8) -&gt; i8;
}

<span class="kw">impl </span>I8 <span class="kw">for </span>i8 {
    <span class="kw">fn </span>as_usize(<span class="self">self</span>) -&gt; usize {
        <span class="attr">#[cfg(debug_assertions)]
        </span>{
            usize::try_from(<span class="self">self</span>).expect(<span class="string">"i8 overflowed usize"</span>)
        }
        <span class="attr">#[cfg(not(debug_assertions))]
        </span>{
            <span class="self">self </span><span class="kw">as </span>usize
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">trait </span>I64 {
    <span class="kw">fn </span>as_usize(<span class="self">self</span>) -&gt; usize;
    <span class="kw">fn </span>to_bits(<span class="self">self</span>) -&gt; u64;
    <span class="kw">fn </span>from_bits(n: u64) -&gt; i64;
}

<span class="kw">impl </span>I64 <span class="kw">for </span>i64 {
    <span class="kw">fn </span>as_usize(<span class="self">self</span>) -&gt; usize {
        <span class="attr">#[cfg(debug_assertions)]
        </span>{
            usize::try_from(<span class="self">self</span>).expect(<span class="string">"i64 overflowed usize"</span>)
        }
        <span class="attr">#[cfg(not(debug_assertions))]
        </span>{
            <span class="self">self </span><span class="kw">as </span>usize
