...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::{cmp, fmt, mem, u16, usize};
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>Patterns {
...
<span class="comment">// BREADCRUMBS: I think we want to experiment with a different bucket
...
// know that that is the issue, but I suspect it is.
...
</span><span class="kw">impl </span>Patterns {
    ...
    /// panics.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new() -&gt; Patterns {
        Patterns {
    ...
    /// This panics if the pattern given is empty.
        ...
        <span class="kw">let </span>id = PatternID::new(<span class="self">self</span>.by_id.len()).unwrap();
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>set_match_kind(<span class="kw-2">&amp;mut </span><span class="self">self</span>, kind: MatchKind) {
        ...
        <span class="kw">match </span><span class="self">self</span>.kind {
            ...
            MatchKind::LeftmostLongest =&gt; {
                ...
                order.sort_by(|<span class="kw-2">&amp;</span>id1, <span class="kw-2">&amp;</span>id2| {
                    by_id[id1].len().cmp(<span class="kw-2">&amp;</span>by_id[id2].len()).reverse()
                });
            }
        }
    }
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>reset(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>match_kind(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>MatchKind {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>get(<span class="kw-2">&amp;</span><span class="self">self</span>, id: PatternID) -&gt; Pattern&lt;<span class="lifetime">'_</span>&gt; {
        Pattern(<span class="kw-2">&amp;</span><span class="self">self</span>.by_id[id])
    }
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">unsafe fn </span>get_unchecked(<span class="kw-2">&amp;</span><span class="self">self</span>, id: PatternID) -&gt; Pattern&lt;<span class="lifetime">'_</span>&gt; {
        Pattern(<span class="self">self</span>.by_id.get_unchecked(id.as_usize()))
    }
    ...
    /// leftmost-longest.)
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; PatternIter&lt;<span class="lifetime">'_</span>&gt; {
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>PatternIter&lt;<span class="lifetime">'p</span>&gt; {
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>Pattern&lt;<span class="lifetime">'a</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]);
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>&gt; Pattern&lt;<span class="lifetime">'p</span>&gt; {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>bytes(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[u8] {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>low_nybbles(<span class="kw-2">&amp;</span><span class="self">self</span>, len: usize) -&gt; Box&lt;[u8]&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>nybs = <span class="macro">vec!</span>[<span class="number">0</span>; len].into_boxed_slice();
        <span class="kw">for </span>(i, byte) <span class="kw">in </span><span class="self">self</span>.bytes().iter().take(len).enumerate() {
            nybs[i] = byte &amp; <span class="number">0xF</span>;
        }
        nybs
    }
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_prefix(<span class="kw-2">&amp;</span><span class="self">self</span>, bytes: <span class="kw-2">&amp;</span>[u8]) -&gt; bool {
        is_prefix(bytes, <span class="self">self</span>.bytes())
    }

    <span class="doccomment">/// Returns true if this pattern is a prefix of the haystack given by the
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">unsafe fn </span>is_prefix_raw(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        start: <span class="kw-2">*const </span>u8,
        end: <span class="kw-2">*const </span>u8,
    ) -&gt; bool {
        <span class="kw">let </span>patlen = <span class="self">self</span>.bytes().len();
        <span class="kw">let </span>haylen = end.distance(start);
        <span class="kw">if </span>patlen &gt; haylen {
            <span class="kw">return </span><span class="bool-val">false</span>;
        }
        <span class="comment">// SAFETY: We've checked that the haystack has length at least equal
        // to this pattern. All other safety concerns are the responsibility
        // of the caller.
        </span>is_equal_raw(start, <span class="self">self</span>.bytes().as_ptr(), patlen)
    }
}
...
/// another function that is marked as `inline(never)` or just `inline`.
    ...
    </span><span class="kw">unsafe </span>{ is_equal_raw(haystack.as_ptr(), needle.as_ptr(), needle.len()) }
}
...
#[inline(always)]
</span><span class="kw">fn </span>is_equal(x: <span class="kw-2">&amp;</span>[u8], y: <span class="kw-2">&amp;</span>[u8]) -&gt; bool {
...
</span><span class="kw">unsafe fn </span>is_equal_raw(<span class="kw-2">mut </span>x: <span class="kw-2">*const </span>u8, <span class="kw-2">mut </span>y: <span class="kw-2">*const </span>u8, n: usize) -&gt; bool {
