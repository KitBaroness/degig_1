...
</pre></div><pre class="rust"><code><span class="comment">// Necessary for implementing atomic methods for `AtomicUnit`
</span><span class="attr">#![allow(clippy::unit_arg)]

</span><span class="kw">use </span><span class="kw">crate</span>::primitive::sync::atomic::{<span class="self">self</span>, Ordering};
...
<span class="kw">impl</span>&lt;T&gt; UnwindSafe <span class="kw">for </span>AtomicCell&lt;T&gt; {}
<span class="kw">impl</span>&lt;T&gt; RefUnwindSafe <span class="kw">for </span>AtomicCell&lt;T&gt; {}
...
<span class="kw">impl</span>&lt;T: Copy + Eq&gt; AtomicCell&lt;T&gt; {
    ...
    </span><span class="attr">#[deprecated(note = <span class="string">"Use `compare_exchange` instead"</span>)]
...
<span class="macro">macro_rules!</span> impl_arithmetic {
    (<span class="macro-nonterminal">$t</span>:ty, fallback, <span class="macro-nonterminal">$example</span>:tt) =&gt; {
        <span class="kw">impl </span>AtomicCell&lt;<span class="macro-nonterminal">$t</span>&gt; {
            ...
            /// use crossbeam_utils::atomic::AtomicCell;
            ///
            </span><span class="attr">#[doc = <span class="macro-nonterminal">$example</span>]
    ...
    (<span class="macro-nonterminal">$t</span>:ty, <span class="macro-nonterminal">$atomic</span>:ident, <span class="macro-nonterminal">$example</span>:tt) =&gt; {
        <span class="kw">impl </span>AtomicCell&lt;<span class="macro-nonterminal">$t</span>&gt; {
            <span class="doccomment">/// Increments the current value by `val` and returns the previous value.
            ///
            /// The addition wraps on overflow.
            ...
            /// ```
                ...
                <span class="macro">atomic!</span> {
                    <span class="macro-nonterminal">$t</span>, _a,
                    {
                        <span class="kw">let </span>a = <span class="kw">unsafe </span>{ <span class="kw-2">&amp;*</span>(<span class="self">self</span>.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>atomic::<span class="macro-nonterminal">$atomic</span>) };
...
<span class="macro">impl_arithmetic!</span>(u8, AtomicU8, <span class="string">"let a = AtomicCell::new(7u8);"</span>);
<span class="macro">impl_arithmetic!</span>(i8, AtomicI8, <span class="string">"let a = AtomicCell::new(7i8);"</span>);
<span class="macro">impl_arithmetic!</span>(u16, AtomicU16, <span class="string">"let a = AtomicCell::new(7u16);"</span>);
<span class="macro">impl_arithmetic!</span>(i16, AtomicI16, <span class="string">"let a = AtomicCell::new(7i16);"</span>);

<span class="macro">impl_arithmetic!</span>(u32, AtomicU32, <span class="string">"let a = AtomicCell::new(7u32);"</span>);
<span class="macro">impl_arithmetic!</span>(i32, AtomicI32, <span class="string">"let a = AtomicCell::new(7i32);"</span>);

<span class="attr">#[cfg(target_has_atomic = <span class="string">"64"</span>)]
</span><span class="macro">impl_arithmetic!</span>(u64, AtomicU64, <span class="string">"let a = AtomicCell::new(7u64);"</span>);
<span class="attr">#[cfg(target_has_atomic = <span class="string">"64"</span>)]
</span><span class="macro">impl_arithmetic!</span>(i64, AtomicI64, <span class="string">"let a = AtomicCell::new(7i64);"</span>);
...
<span class="macro">impl_arithmetic!</span>(usize, AtomicUsize, <span class="string">"let a = AtomicCell::new(7usize);"</span>);
<span class="macro">impl_arithmetic!</span>(isize, AtomicIsize, <span class="string">"let a = AtomicCell::new(7isize);"</span>);
...
<span class="kw">impl </span>AtomicCell&lt;bool&gt; {
    ...
    /// ```
        ...
        <span class="macro">atomic!</span> {
            bool, _a,
            {
                <span class="kw">let </span>a = <span class="kw">unsafe </span>{ <span class="kw-2">&amp;*</span>(<span class="self">self</span>.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>atomic::AtomicBool) };
                a.fetch_and(val, Ordering::AcqRel)
            },
            {
                <span class="kw">let </span>_guard = lock(<span class="self">self</span>.as_ptr() <span class="kw">as </span>usize).write();
...
#[must_use]
    ...
    </span><span class="kw">const </span>LEN: usize = <span class="number">67</span>;
    <span class="attr">#[allow(clippy::declare_interior_mutable_const)]
    </span><span class="kw">const </span>L: CachePadded&lt;SeqLock&gt; = CachePadded::new(SeqLock::new());
    <span class="kw">static </span>LOCKS: [CachePadded&lt;SeqLock&gt;; LEN] = [L; LEN];
...
<span class="doccomment">/// Returns `true` if operations on `AtomicCell&lt;T&gt;` are lock-free.
    ...
    <span class="macro">atomic!</span> { T, _a, <span class="bool-val">true</span>, <span class="bool-val">false </span>}
}
