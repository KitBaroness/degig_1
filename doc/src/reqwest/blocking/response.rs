...
<span class="kw">impl </span>Response {
    ...
    /// ```
        ...
        <span class="self">self</span>.text_with_charset(<span class="string">"utf-8"</span>)
    }
    ...
    <span class="comment">// private
        ...
        <span class="kw">if </span><span class="self">self</span>.body.is_none() {
            ...
            <span class="kw">let </span>body = body.map_err(<span class="kw">crate</span>::error::into_io).into_async_read();
