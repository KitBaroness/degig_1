...
</pre></div><pre class="rust"><code><span class="kw">use </span>std::pin::Pin;
<span class="kw">use </span>std::task::{<span class="self">self</span>, Poll};
<span class="kw">use </span>std::{fmt, io};

<span class="kw">use </span>futures_util::TryFutureExt;
...
<span class="kw">impl </span>From&lt;hyper::upgrade::Upgraded&gt; <span class="kw">for </span>Upgraded {
    <span class="kw">fn </span>from(inner: hyper::upgrade::Upgraded) -&gt; <span class="self">Self </span>{
        Upgraded { inner }
    }
}

<span class="kw">impl </span><span class="kw">super</span>::response::Response {
    <span class="doccomment">/// Consumes the response and returns a future for a possible HTTP upgrade.
    </span><span class="kw">pub async fn </span>upgrade(<span class="self">self</span>) -&gt; <span class="kw">crate</span>::Result&lt;Upgraded&gt; {
