...
<span class="kw">impl </span>Body {
    ...
    <span class="kw">where
        </span>S: futures_core::stream::TryStream + Send + <span class="lifetime">'static</span>,
    ...
    E: Into&lt;Box&lt;<span class="kw">dyn </span>std::error::Error + Send + Sync&gt;&gt;,
{
    ...
    <span class="kw">fn </span>poll_data(
        ...
        <span class="kw">let </span>item = <span class="macro">futures_core::ready!</span>(<span class="self">self</span>.project().inner.get_pin_mut().poll_next(cx)<span class="question-mark">?</span>);
