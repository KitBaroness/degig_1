...
</span><span class="attr">#[cfg(all(feature = <span class="string">"http3"</span>, not(reqwest_unstable)))]
...
<span class="macro">macro_rules!</span> if_wasm {
...
<span class="macro">if_hyper!</span> {
    ...
    <span class="kw">pub use </span><span class="self">self</span>::proxy::{Proxy,NoProxy};
