...
<span class="macro">cfg_if!</span> {
    ...
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"linux"</span>, target_os = <span class="string">"emscripten"</span>, target_os = <span class="string">"hurd"</span>, target_os = <span class="string">"redox"</span>))] </span>{
