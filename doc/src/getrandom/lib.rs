...
</pre></div><pre class="rust"><code><span class="doccomment">//! Interface to the operating system's random number generator.
//!
//! # Supported targets
//!
...
//! [platform-support]: https://doc.rust-lang.org/stable/rustc/platform-support.html
    ...
    html_root_url = <span class="string">"https://docs.rs/getrandom/0.2.14"
</span>)]
#![no_std]
...
</span><span class="attr">#[cfg(feature = <span class="string">"custom"</span>)]
...
// regardless of what value it returns.
    ...
    <span class="kw">if </span><span class="attr">#[cfg(any(target_os = <span class="string">"haiku"</span>, target_os = <span class="string">"redox"</span>, target_os = <span class="string">"nto"</span>, target_os = <span class="string">"aix"</span>))] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"use_file.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(
        not(feature = <span class="string">"linux_disable_fallback"</span>),
        any(
            <span class="comment">// Rust supports Android API level 19 (KitKat) [0] and the next upgrade targets
            ...
            <span class="comment">// Only on these `target_arch`es Rust supports Linux kernel versions (3.2+)
            ...
            // https://doc.rust-lang.org/stable/rustc/platform-support.html
                ...
                any(
                    ...
                    target_arch = <span class="string">"x86"</span>,
                    target_arch = <span class="string">"x86_64"</span>,
                    <span class="comment">// Minimum supported Linux kernel version for MUSL targets
                    // is not specified explicitly (as of Rust 1.77) and they
                    // are used in practice to target pre-3.17 kernels.
                    </span>target_env = <span class="string">"musl"</span>,
                ),
            )
        ),
    ))] </span>{
        ...
        <span class="attr">#[path = <span class="string">"linux_android_with_fallback.rs"</span>] </span><span class="kw">mod </span>imp;
        ...
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"linux_android.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"illumos"</span>, target_os = <span class="string">"solaris"</span>))] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="kw">mod </span>use_file;
        <span class="attr">#[path = <span class="string">"solaris_illumos.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"freebsd"</span>, target_os = <span class="string">"netbsd"</span>))] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"bsd_arandom.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"dragonfly"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="kw">mod </span>use_file;
        <span class="attr">#[path = <span class="string">"dragonfly.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"fuchsia"</span>)] </span>{
        <span class="attr">#[path = <span class="string">"fuchsia.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"ios"</span>, target_os = <span class="string">"watchos"</span>, target_os = <span class="string">"tvos"</span>))] </span>{
        <span class="attr">#[path = <span class="string">"apple-other.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"macos"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"macos.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"openbsd"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"openbsd.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(target_arch = <span class="string">"wasm32"</span>, target_os = <span class="string">"wasi"</span>))] </span>{
        <span class="attr">#[path = <span class="string">"wasi.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"hermit"</span>)] </span>{
        <span class="attr">#[path = <span class="string">"hermit.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"vxworks"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"vxworks.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"solid_asp3"</span>)] </span>{
        <span class="attr">#[path = <span class="string">"solid.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"espidf"</span>)] </span>{
        <span class="attr">#[path = <span class="string">"espidf.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(windows)] </span>{
        <span class="attr">#[path = <span class="string">"windows.rs"</span>] </span><span class="kw">mod </span>imp;
        ...
        <span class="attr">#[path = <span class="string">"3ds.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"vita"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"vita.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"emscripten"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"emscripten.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(target_arch = <span class="string">"x86_64"</span>, target_env = <span class="string">"sgx"</span>))] </span>{
        <span class="kw">mod </span>lazy;
        <span class="attr">#[path = <span class="string">"rdrand.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(feature = <span class="string">"rdrand"</span>,
                        any(target_arch = <span class="string">"x86_64"</span>, target_arch = <span class="string">"x86"</span>)))] </span>{
        <span class="kw">mod </span>lazy;
        <span class="attr">#[path = <span class="string">"rdrand.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(feature = <span class="string">"js"</span>,
        ...
        <span class="attr">#[path = <span class="string">"js.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"hurd"</span>)] </span>{
        <span class="kw">mod </span>util_libc;
        <span class="attr">#[path = <span class="string">"hurd.rs"</span>] </span><span class="kw">mod </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(feature = <span class="string">"custom"</span>)] </span>{
        <span class="kw">use </span>custom <span class="kw">as </span>imp;
    } <span class="kw">else if </span><span class="attr">#[cfg(all(any(target_arch = <span class="string">"wasm32"</span>, target_arch = <span class="string">"wasm64"</span>),
                        target_os = <span class="string">"unknown"</span>))] </span>{
