...
</pre></div><pre class="rust"><code><span class="attr">#![doc(test(attr(
    <span class="comment">// Problematic handling for foreign From&lt;T&gt; impls in tests
    // https://github.com/rust-lang/rust/issues/121621
    </span>allow(unknown_lints, non_local_definitions),
    deny(
...
</span><span class="comment">// Not needed for 2018 edition and conflicts with `rust_2018_idioms`
</span><span class="attr">#![doc(test(no_crate_inject))]
#![doc(html_root_url = <span class="string">"https://docs.rs/serde_with/3.8.0/"</span>)]
#![cfg_attr(docsrs, feature(doc_cfg))]
#![no_std]

</span><span class="doccomment">//! [![crates.io badge](https://img.shields.io/crates/v/serde_with.svg)](https://crates.io/crates/serde_with/)
...
</span><span class="kw">pub extern crate </span>core;
<span class="attr">#[doc(hidden)]
</span><span class="kw">pub extern crate </span>serde;
<span class="attr">#[doc(hidden)]
</span><span class="kw">pub extern crate </span>serde_derive;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">extern crate </span>std;

<span class="attr">#[cfg(feature = <span class="string">"base64"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"base64"</span>)))]
</span><span class="kw">pub mod </span>base64;
<span class="attr">#[cfg(feature = <span class="string">"chrono_0_4"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"chrono_0_4"</span>)))]
</span><span class="kw">pub mod </span>chrono_0_4;
<span class="doccomment">/// Legacy export of the [`chrono_0_4`] module.
...
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"chrono"</span>)))]
    ...
    <span class="kw">pub use </span>chrono_0_4::<span class="kw-2">*</span>;
}
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">mod </span>content;
<span class="kw">pub mod </span>de;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">mod </span>duplicate_key_impls;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">mod </span>enum_map;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>flatten_maybe;
<span class="kw">pub mod </span>formats;
<span class="attr">#[cfg(feature = <span class="string">"hex"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"hex"</span>)))]
</span><span class="kw">pub mod </span>hex;
<span class="attr">#[cfg(feature = <span class="string">"json"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"json"</span>)))]
</span><span class="kw">pub mod </span>json;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">mod </span>key_value_map;
<span class="kw">pub mod </span>rust;
<span class="attr">#[cfg(feature = <span class="string">"schemars_0_8"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"schemars_0_8"</span>)))]
</span><span class="kw">pub mod </span>schemars_0_8;
<span class="kw">pub mod </span>ser;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>serde_conv;
<span class="attr">#[cfg(feature = <span class="string">"time_0_3"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"time_0_3"</span>)))]
</span><span class="kw">pub mod </span>time_0_3;
<span class="kw">mod </span>utils;
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
#[doc(hidden)]
</span><span class="kw">pub mod </span>with_prefix;

<span class="comment">// Taken from shepmaster/snafu
...
</span><span class="attr">#[cfg(feature = <span class="string">"guide"</span>)]
#[allow(unused_macro_rules)]
</span><span class="macro">macro_rules!</span> generate_guide {
    (<span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>:ident; $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="macro">generate_guide!</span>(@gen <span class="string">"."</span>, <span class="kw">pub mod </span><span class="macro-nonterminal">$name </span>{ } $(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>);
    };
    (<span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>:ident { $(<span class="macro-nonterminal">$children</span>:tt)* } $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="macro">generate_guide!</span>(@gen <span class="string">"."</span>, <span class="kw">pub mod </span><span class="macro-nonterminal">$name </span>{ $(<span class="macro-nonterminal">$children</span>)* } $(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>);
    };
    (@gen <span class="macro-nonterminal">$prefix</span>:expr, ) =&gt; {};
    (@gen <span class="macro-nonterminal">$prefix</span>:expr, <span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>:ident; $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="macro">generate_guide!</span>(@gen <span class="macro-nonterminal">$prefix</span>, <span class="kw">pub mod </span><span class="macro-nonterminal">$name </span>{ } $(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>);
    };
    (@gen <span class="macro-nonterminal">$prefix</span>:expr, @code <span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>:ident; $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>;
        <span class="macro">generate_guide!</span>(@gen <span class="macro-nonterminal">$prefix</span>, $(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>);
    };
    (@gen <span class="macro-nonterminal">$prefix</span>:expr, <span class="kw">pub mod </span><span class="macro-nonterminal">$name</span>:ident { $(<span class="macro-nonterminal">$children</span>:tt)* } $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        <span class="macro">doc_comment::doc_comment!</span> {
            <span class="macro">include_str!</span>(<span class="macro">concat!</span>(<span class="macro-nonterminal">$prefix</span>, <span class="string">"/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$name</span>), <span class="string">".md"</span>)),
            <span class="kw">pub mod </span><span class="macro-nonterminal">$name </span>{
                <span class="macro">generate_guide!</span>(@gen <span class="macro">concat!</span>(<span class="macro-nonterminal">$prefix</span>, <span class="string">"/"</span>, <span class="macro">stringify!</span>(<span class="macro-nonterminal">$name</span>)), $(<span class="macro-nonterminal">$children</span>)<span class="kw-2">*</span>);
            }
        }
        <span class="macro">generate_guide!</span>(@gen <span class="macro-nonterminal">$prefix</span>, $(<span class="macro-nonterminal">$rest</span>)<span class="kw-2">*</span>);
    };
...
<span class="attr">#[cfg(feature = <span class="string">"guide"</span>)]
</span><span class="macro">generate_guide!</span> {
    <span class="kw">pub mod </span>guide {
        @code <span class="kw">pub mod </span>feature_flags;
        <span class="kw">pub mod </span>serde_as;
        <span class="kw">pub mod </span>serde_as_transformations;
    }
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>prelude {
    <span class="attr">#![allow(unused_imports)]

    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">use </span><span class="kw">crate</span>::utils::duration::{DurationSigned, Sign};
    <span class="kw">pub use crate</span>::{de::<span class="kw-2">*</span>, ser::<span class="kw-2">*</span>, <span class="kw-2">*</span>};
    ...
    <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    </span><span class="kw">pub use </span>alloc::{
        borrow::{Cow, ToOwned},
        boxed::Box,
        collections::{BTreeMap, BTreeSet, BinaryHeap, LinkedList, VecDeque},
        rc::{Rc, Weak <span class="kw">as </span>RcWeak},
    ...
    <span class="kw">pub use </span>serde::{
        de::{
            Deserialize, DeserializeOwned, DeserializeSeed, Deserializer, EnumAccess,
            Error <span class="kw">as </span>DeError, Expected, IgnoredAny, IntoDeserializer, MapAccess, SeqAccess,
            Unexpected, VariantAccess, Visitor,
        },
        forward_to_deserialize_any,
        ser::{
            Error <span class="kw">as </span>SerError, Impossible, Serialize, SerializeMap, SerializeSeq, SerializeStruct,
...
<span class="doccomment">/// This module is not part of the public API
///
/// Do not rely on any exports.
</span><span class="attr">#[doc(hidden)]
</span><span class="kw">pub mod </span>__private__ {
    <span class="kw">pub use </span><span class="kw">crate</span>::prelude::<span class="kw-2">*</span>;
}

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
#[doc(inline)]
</span><span class="kw">pub use </span><span class="kw">crate</span>::enum_map::EnumMap;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
#[doc(inline)]
</span><span class="kw">pub use </span><span class="kw">crate</span>::key_value_map::KeyValueMap;
<span class="attr">#[doc(inline)]
</span><span class="kw">pub use crate</span>::{de::DeserializeAs, ser::SerializeAs};
<span class="kw">use </span>core::marker::PhantomData;
<span class="comment">// Re-Export all proc_macros, as these should be seen as part of the serde_with crate
</span><span class="attr">#[cfg(feature = <span class="string">"macros"</span>)]
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"macros"</span>)))]
#[doc(inline)]
</span><span class="kw">pub use </span>serde_with_macros::<span class="kw-2">*</span>;

<span class="doccomment">/// Adapter to convert from `serde_as` to the serde traits.
///
...
</span><span class="kw">pub struct </span>As&lt;T: <span class="question-mark">?</span>Sized&gt;(PhantomData&lt;T&gt;);
...
</span><span class="kw">pub struct </span>Same;

<span class="doccomment">/// De/Serialize using [`Display`] and [`FromStr`] implementation
///
...
</span><span class="kw">pub struct </span>DisplayFromStr;

<span class="doccomment">/// Use the first format if [`De/Serializer::is_human_readable`], otherwise use the second
///
...
</span><span class="kw">pub struct </span>IfIsHumanReadable&lt;H, F = Same&gt;(PhantomData&lt;H&gt;, PhantomData&lt;F&gt;);

<span class="doccomment">/// De/Serialize a [`Option&lt;String&gt;`] type while transforming the empty string to [`None`]
///
...
///
/// [`FromStr`]: std::str::FromStr
</span><span class="kw">pub struct </span>NoneAsEmptyString;

<span class="doccomment">/// Deserialize value and return [`Default`] on error
///
...
</span><span class="kw">pub struct </span>DefaultOnError&lt;T = Same&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Deserialize [`Default`] from `null` values
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>DefaultOnNull&lt;T = Same&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Deserialize from bytes or string
///
...
</span><span class="kw">pub struct </span>BytesOrString;

<span class="doccomment">/// De/Serialize Durations as number of seconds.
///
...
</span><span class="kw">pub struct </span>DurationSeconds&lt;
...
/// [`chrono::Duration`]: ::chrono_0_4::Duration
/// [feature flag]: https://docs.rs/serde_with/3.8.0/serde_with/guide/feature_flags/index.html
</span><span class="kw">pub struct </span>DurationSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSeconds`] with milli-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationMilliSeconds&lt;
    FORMAT: formats::Format = u64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSecondsWithFrac`] with milli-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationMilliSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSeconds`] with micro-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationMicroSeconds&lt;
    FORMAT: formats::Format = u64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSecondsWithFrac`] with micro-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationMicroSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSeconds`] with nano-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationNanoSeconds&lt;
    FORMAT: formats::Format = u64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`DurationSecondsWithFrac`] with nano-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>DurationNanoSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// De/Serialize timestamps as seconds since the UNIX epoch
///
...
/// [feature flag]: https://docs.rs/serde_with/3.8.0/serde_with/guide/feature_flags/index.html
</span><span class="kw">pub struct </span>TimestampSeconds&lt;
...
/// [feature flag]: https://docs.rs/serde_with/3.8.0/serde_with/guide/feature_flags/index.html
</span><span class="kw">pub struct </span>TimestampSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSeconds`] with milli-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampMilliSeconds&lt;
    FORMAT: formats::Format = i64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSecondsWithFrac`] with milli-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampMilliSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSeconds`] with micro-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampMicroSeconds&lt;
    FORMAT: formats::Format = i64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSecondsWithFrac`] with micro-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampMicroSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSeconds`] with nano-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampNanoSeconds&lt;
    FORMAT: formats::Format = i64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Equivalent to [`TimestampSecondsWithFrac`] with nano-seconds as base unit.
///
...
</span><span class="kw">pub struct </span>TimestampNanoSecondsWithFrac&lt;
    FORMAT: formats::Format = f64,
    STRICTNESS: formats::Strictness = formats::Strict,
&gt;(PhantomData&lt;(FORMAT, STRICTNESS)&gt;);

<span class="doccomment">/// Optimized handling of owned and borrowed byte representations.
///
...
<span class="doccomment">/// Deserialize one or many elements
///
...
</span><span class="kw">pub struct </span>OneOrMany&lt;T, FORMAT: formats::Format = formats::PreferOne&gt;(PhantomData&lt;(T, FORMAT)&gt;);

<span class="doccomment">/// Try multiple deserialization options until one succeeds.
///
...
</span><span class="kw">pub struct </span>PickFirst&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Serialize value by converting to/from a proxy type with serde support.
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>FromInto&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Serialize a reference value by converting to/from a proxy type with serde support.
///
/// This adapter serializes a type `O` by converting it into a second type `T` and serializing `T`.
/// Deserializing works analogue, by deserializing a `T` and then converting into `O`.
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>FromIntoRef&lt;T&gt;(PhantomData&lt;T&gt;);
...
/// # }
/// ```
</span><span class="kw">pub struct </span>TryFromInto&lt;T&gt;(PhantomData&lt;T&gt;);
...
/// # }
/// ```
</span><span class="kw">pub struct </span>TryFromIntoRef&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Borrow `Cow` data during deserialization when possible.
///
...
</span><span class="kw">pub struct </span>BorrowCow;

<span class="doccomment">/// Deserialize a sequence into `Vec&lt;T&gt;`, skipping elements which fail to deserialize.
///
...
</span><span class="kw">pub struct </span>VecSkipError&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Deserialize a boolean from a number
///
...
</span><span class="doccomment">/// #[serde_as]
/// # #[derive(Debug, PartialEq)]
/// #[derive(Deserialize, Serialize)]
...
/// # }
/// ```
</span><span class="kw">pub struct </span>BoolFromInt&lt;S: formats::Strictness = formats::Strict&gt;(PhantomData&lt;S&gt;);

<span class="doccomment">/// De/Serialize a delimited collection using [`Display`] and [`FromStr`] implementation
///
...
</span><span class="kw">pub struct </span>StringWithSeparator&lt;Sep, T&gt;(PhantomData&lt;(Sep, T)&gt;);

<span class="doccomment">/// This serializes a list of tuples into a map
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>Map&lt;K, V&gt;(PhantomData&lt;(K, V)&gt;);

<span class="doccomment">/// De/Serialize a Map into a list of tuples
///
...
/// # }
/// ```
</span><span class="kw">pub struct </span>Seq&lt;V&gt;(PhantomData&lt;V&gt;);

<span class="doccomment">/// Ensure no duplicate keys exist in a map.
///
...
</span><span class="kw">pub struct </span>MapPreventDuplicates&lt;K, V&gt;(PhantomData&lt;(K, V)&gt;);

<span class="doccomment">/// Ensure that the first key is taken, if duplicate keys exist
///
...
</span><span class="kw">pub struct </span>MapFirstKeyWins&lt;K, V&gt;(PhantomData&lt;(K, V)&gt;);

<span class="doccomment">/// Ensure no duplicate values exist in a set.
///
...
</span><span class="kw">pub struct </span>SetPreventDuplicates&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Ensure that the last value is taken, if duplicate values exist
///
...
</span><span class="kw">pub struct </span>SetLastValueWins&lt;T&gt;(PhantomData&lt;T&gt;);

<span class="doccomment">/// Helper for implementing [`JsonSchema`] on serializers whose output depends
...
</span><span class="attr">#[cfg(feature = <span class="string">"schemars_0_8"</span>)]
</span><span class="kw">pub struct </span>Schema&lt;T: <span class="question-mark">?</span>Sized, TA&gt;(PhantomData&lt;T&gt;, PhantomData&lt;TA&gt;);
