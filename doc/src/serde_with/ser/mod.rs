...
</pre></div><pre class="rust"><code><span class="doccomment">//! Module for [`SerializeAs`][] implementations
//!
...
</span><span class="kw">mod </span>duplicates;
<span class="kw">mod </span>impls;

<span class="kw">use </span><span class="kw">crate</span>::prelude::<span class="kw-2">*</span>;

<span class="doccomment">/// A **data structure** that can be serialized into any data format supported by Serde, analogue to [`Serialize`].
///
...
</span><span class="kw">pub trait </span>SerializeAs&lt;T: <span class="question-mark">?</span>Sized&gt; {
    <span class="doccomment">/// Serialize this value into the given Serde serializer.
    </span><span class="kw">fn </span>serialize_as&lt;S&gt;(source: <span class="kw-2">&amp;</span>T, serializer: S) -&gt; <span class="prelude-ty">Result</span>&lt;S::Ok, S::Error&gt;
    <span class="kw">where
        </span>S: Serializer;
}

<span class="doccomment">/// Helper type to implement [`SerializeAs`] for container-like types.
</span><span class="kw">pub struct </span>SerializeAsWrap&lt;<span class="lifetime">'a</span>, T: <span class="question-mark">?</span>Sized, U: <span class="question-mark">?</span>Sized&gt; {
    value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T,
    marker: PhantomData&lt;U&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, U&gt; SerializeAsWrap&lt;<span class="lifetime">'a</span>, T, U&gt;
<span class="kw">where
    </span>T: <span class="question-mark">?</span>Sized,
    U: <span class="question-mark">?</span>Sized,
{
    <span class="doccomment">/// Create new instance with provided value.
    </span><span class="kw">pub fn </span>new(value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T) -&gt; <span class="self">Self </span>{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, U&gt; Serialize <span class="kw">for </span>SerializeAsWrap&lt;<span class="lifetime">'a</span>, T, U&gt;
<span class="kw">where
    </span>T: <span class="question-mark">?</span>Sized,
    U: <span class="question-mark">?</span>Sized,
    U: SerializeAs&lt;T&gt;,
{
    ...
    {
        U::serialize_as(<span class="self">self</span>.value, serializer)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, U&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt; <span class="kw">for </span>SerializeAsWrap&lt;<span class="lifetime">'a</span>, T, U&gt;
<span class="kw">where
    </span>T: <span class="question-mark">?</span>Sized,
    U: <span class="question-mark">?</span>Sized,
    U: SerializeAs&lt;T&gt;,
{
    <span class="kw">fn </span>from(value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::new(value)
    }
}

<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; As&lt;T&gt; {
    <span class="doccomment">/// Serialize type `T` using [`SerializeAs`][]
    ///
