...
</pre></div><pre class="rust"><code><span class="doccomment">//! Module for [`DeserializeAs`][] implementations
//!
...
<span class="doccomment">/// A **data structure** that can be deserialized from any data format supported by Serde, analogue to [`Deserialize`].
///
...
</span><span class="kw">pub trait </span>DeserializeAs&lt;<span class="lifetime">'de</span>, T&gt;: Sized {
    <span class="doccomment">/// Deserialize this value from the given Serde deserializer.
    </span><span class="kw">fn </span>deserialize_as&lt;D&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt;
    <span class="kw">where
        </span>D: Deserializer&lt;<span class="lifetime">'de</span>&gt;;
}

<span class="doccomment">/// Helper type to implement [`DeserializeAs`] for container-like types.
</span><span class="kw">pub struct </span>DeserializeAsWrap&lt;T, U&gt; {
    value: T,
    marker: PhantomData&lt;U&gt;,
}

<span class="kw">impl</span>&lt;T, U&gt; DeserializeAsWrap&lt;T, U&gt; {
    <span class="doccomment">/// Return the inner value of type `T`.
    </span><span class="kw">pub fn </span>into_inner(<span class="self">self</span>) -&gt; T {
        <span class="self">self</span>.value
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, T, U&gt; Deserialize&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span>DeserializeAsWrap&lt;T, U&gt;
<span class="kw">where
    </span>U: DeserializeAs&lt;<span class="lifetime">'de</span>, T&gt;,
{
    ...
    {
        U::deserialize_as(deserializer).map(|value| <span class="self">Self </span>{
            value,
            marker: PhantomData,
        })
    }
...
<span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized&gt; As&lt;T&gt; {
    <span class="doccomment">/// Deserialize type `T` using [`DeserializeAs`][]
    ///
