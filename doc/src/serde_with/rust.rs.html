...
</pre></div><pre class="rust"><code><span class="doccomment">//! De/Serialization for Rust's builtin and std types

</span><span class="kw">use </span><span class="kw">crate</span>::prelude::<span class="kw-2">*</span>;

<span class="doccomment">/// Makes a distinction between a missing, unset, or existing value
///
...
/// ```
</span><span class="attr">#[allow(clippy::option_option)]
</span><span class="kw">pub mod </span>double_option {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;

    <span class="doccomment">/// Deserialize potentially non-existing optional value
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, T, D&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Option</span>&lt;T&gt;&gt;, D::Error&gt;
    <span class="kw">where
        </span>T: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        Deserialize::deserialize(deserializer).map(<span class="prelude-val">Some</span>)
    }

    <span class="doccomment">/// Serialize optional value
    </span><span class="kw">pub fn </span>serialize&lt;S, T&gt;(values: <span class="kw-2">&amp;</span><span class="prelude-ty">Option</span>&lt;<span class="prelude-ty">Option</span>&lt;T&gt;&gt;, serializer: S) -&gt; <span class="prelude-ty">Result</span>&lt;S::Ok, S::Error&gt;
    <span class="kw">where
        </span>S: Serializer,
        T: Serialize,
    {
        <span class="kw">match </span>values {
            <span class="prelude-val">None </span>=&gt; serializer.serialize_unit(),
            <span class="prelude-val">Some</span>(<span class="prelude-val">None</span>) =&gt; serializer.serialize_none(),
            <span class="prelude-val">Some</span>(<span class="prelude-val">Some</span>(v)) =&gt; serializer.serialize_some(<span class="kw-2">&amp;</span>v),
        }
    }
}

<span class="doccomment">/// Serialize inner value if [`Some`]`(T)`. If [`None`], serialize the unit struct `()`.
///
...
/// assert_eq!(s, ron::ser::to_string_pretty(&amp;v, pretty_config).unwrap());
/// ```
</span><span class="kw">pub mod </span>unwrap_or_skip {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;

    <span class="doccomment">/// Deserialize value wrapped in Some(T)
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, D, T&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;T&gt;, D::Error&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Serialize value if Some(T), unit struct if None
    </span><span class="kw">pub fn </span>serialize&lt;T, S&gt;(option: <span class="kw-2">&amp;</span><span class="prelude-ty">Option</span>&lt;T&gt;, serializer: S) -&gt; <span class="prelude-ty">Result</span>&lt;S::Ok, S::Error&gt;
    <span class="kw">where
        </span>T: Serialize,
        S: Serializer,
    {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(value) = option {
...
/// ```
...
</span><span class="kw">pub mod </span>sets_duplicate_value_is_error {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;
    <span class="kw">use </span><span class="kw">crate</span>::duplicate_key_impls::PreventDuplicateInsertsSet;

    <span class="doccomment">/// Deserialize a set and return an error on duplicate values
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, D, T, V&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt;
    <span class="kw">where
        </span>T: PreventDuplicateInsertsSet&lt;V&gt;,
        V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        <span class="kw">struct </span>SeqVisitor&lt;T, V&gt; {
            marker: PhantomData&lt;T&gt;,
            set_item_type: PhantomData&lt;V&gt;,
        }

        <span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, T, V&gt; Visitor&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span>SeqVisitor&lt;T, V&gt;
        <span class="kw">where
            </span>T: PreventDuplicateInsertsSet&lt;V&gt;,
            V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        {
                ...
                </span>A: SeqAccess&lt;<span class="lifetime">'de</span>&gt;,
            {
                ...
                <span class="kw">while let </span><span class="prelude-val">Some</span>(value) = access.next_element()<span class="question-mark">? </span>{
                    <span class="kw">if </span>!values.insert(value) {
        ...
        <span class="kw">let </span>visitor = SeqVisitor {
            marker: PhantomData,
    ...
    <span class="doccomment">/// Serialize the set with the default serializer
    </span><span class="kw">pub fn </span>serialize&lt;T, S&gt;(value: <span class="kw-2">&amp;</span>T, serializer: S) -&gt; <span class="prelude-ty">Result</span>&lt;S::Ok, S::Error&gt;
    <span class="kw">where
        </span>T: Serialize,
        S: Serializer,
    {
...
/// ```
...
</span><span class="kw">pub mod </span>maps_duplicate_key_is_error {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;
    <span class="kw">use </span><span class="kw">crate</span>::duplicate_key_impls::PreventDuplicateInsertsMap;

    <span class="doccomment">/// Deserialize a map and return an error on duplicate keys
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, D, T, K, V&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt;
    <span class="kw">where
        </span>T: PreventDuplicateInsertsMap&lt;K, V&gt;,
        K: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        <span class="kw">struct </span>MapVisitor&lt;T, K, V&gt; {
            marker: PhantomData&lt;T&gt;,
            map_key_type: PhantomData&lt;K&gt;,
            map_value_type: PhantomData&lt;V&gt;,
        }

        <span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, T, K, V&gt; Visitor&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span>MapVisitor&lt;T, K, V&gt;
        <span class="kw">where
            </span>T: PreventDuplicateInsertsMap&lt;K, V&gt;,
            K: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
            V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        {
                ...
                </span>A: MapAccess&lt;<span class="lifetime">'de</span>&gt;,
            {
                ...
                <span class="kw">while let </span><span class="prelude-val">Some</span>((key, value)) = access.next_entry()<span class="question-mark">? </span>{
                    <span class="kw">if </span>!values.insert(key, value) {
        ...
        <span class="kw">let </span>visitor = MapVisitor {
            marker: PhantomData,
    ...
    <span class="doccomment">/// Serialize the map with the default serializer
    </span><span class="kw">pub fn </span>serialize&lt;T, S&gt;(value: <span class="kw-2">&amp;</span>T, serializer: S) -&gt; <span class="prelude-ty">Result</span>&lt;S::Ok, S::Error&gt;
    <span class="kw">where
        </span>T: Serialize,
        S: Serializer,
...
</span><span class="kw">pub mod </span>sets_last_value_wins {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;
    <span class="kw">use </span><span class="kw">crate</span>::duplicate_key_impls::DuplicateInsertsLastWinsSet;

    <span class="doccomment">/// Deserialize a set and keep the last of equal values
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, D, T, V&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt;
    <span class="kw">where
        </span>T: DuplicateInsertsLastWinsSet&lt;V&gt;,
        V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        <span class="kw">struct </span>SeqVisitor&lt;T, V&gt; {
...
</span><span class="kw">pub mod </span>maps_first_key_wins {
    <span class="kw">use super</span>::<span class="kw-2">*</span>;
    <span class="kw">use </span><span class="kw">crate</span>::duplicate_key_impls::DuplicateInsertsFirstWinsMap;

    <span class="doccomment">/// Deserialize a map and return an error on duplicate keys
    </span><span class="kw">pub fn </span>deserialize&lt;<span class="lifetime">'de</span>, D, T, K, V&gt;(deserializer: D) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt;
    <span class="kw">where
        </span>T: DuplicateInsertsFirstWinsMap&lt;K, V&gt;,
        K: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        V: Deserialize&lt;<span class="lifetime">'de</span>&gt;,
        D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
...
<span class="doccomment">/// Deserialize any value, ignore it, and return the default value for the type being deserialized.
///
...
</span><span class="kw">pub fn </span>deserialize_ignore_any&lt;<span class="lifetime">'de</span>, D: Deserializer&lt;<span class="lifetime">'de</span>&gt;, T: Default&gt;(
    deserializer: D,
) -&gt; <span class="prelude-ty">Result</span>&lt;T, D::Error&gt; {
    IgnoredAny::deserialize(deserializer).map(|<span class="kw">_</span>| T::default())
}
