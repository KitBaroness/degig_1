...
</span><span class="kw">mod </span>input;
...
/// called with `None`.
    ...
    input: <span class="prelude-ty">Option</span>&lt;Input&lt;<span class="lifetime">'a</span>&gt;&gt;,
    incomplete_read: E,
    read: F,
