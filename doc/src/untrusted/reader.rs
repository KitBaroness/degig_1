...
</span><span class="kw">use crate</span>::{no_panic, Input};
...
<span class="doccomment">/// Avoids writing the value or position to avoid creating a side channel,
/// though `Reader` can't avoid leaking the position via timing.
</span><span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Reader&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        f.debug_struct(<span class="string">"Reader"</span>).finish()
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Reader&lt;<span class="lifetime">'a</span>&gt; {
    ...
    </span><span class="kw">pub fn </span>at_end(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.i == <span class="self">self</span>.input.len()
    }
        ...
        </span>F: FnOnce(<span class="kw-2">&amp;mut </span>Reader&lt;<span class="lifetime">'a</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;R, E&gt;,
    {
        ...
        <span class="kw">let </span>bytes_read = <span class="self">self</span>.input.subslice(start..<span class="self">self</span>.i).unwrap().into();
    ...
    </span><span class="kw">pub fn </span>skip_to_end(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw">let _ </span>= <span class="self">self</span>.read_bytes_to_end();
    }
}
