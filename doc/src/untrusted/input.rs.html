...
</span><span class="kw">use crate</span>::{no_panic, Reader};

<span class="doccomment">/// A wrapper around `&amp;'a [u8]` that helps in writing panic-free code.
///
...
<span class="doccomment">/// The value is intentionally omitted from the output to avoid leaking
/// secrets.
</span><span class="kw">impl </span>core::fmt::Debug <span class="kw">for </span>Input&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        f.debug_struct(<span class="string">"Input"</span>).finish()
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Input&lt;<span class="lifetime">'a</span>&gt; {
    ...
    <span class="doccomment">/// Returns `true` if the input is empty and false otherwise.
        ...
        <span class="self">self</span>.value.is_empty()
    }

    <span class="doccomment">/// Returns the length of the `Input`.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.value.len()
    }
    ...
    </span><span class="kw">pub fn </span>as_slice_less_safe(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8] {
        <span class="self">self</span>.value.as_slice_less_safe()
    }

    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>into_value(<span class="self">self</span>) -&gt; no_panic::Slice&lt;<span class="lifetime">'a</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]&gt; <span class="kw">for </span>Input&lt;<span class="lifetime">'a</span>&gt; {
    ...
    </span><span class="kw">fn </span>from(value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]) -&gt; <span class="self">Self </span>{
        no_panic::Slice::new(value).into()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; From&lt;no_panic::Slice&lt;<span class="lifetime">'a</span>&gt;&gt; <span class="kw">for </span>Input&lt;<span class="lifetime">'a</span>&gt; {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>from(value: no_panic::Slice&lt;<span class="lifetime">'a</span>&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ value }
    }
}
