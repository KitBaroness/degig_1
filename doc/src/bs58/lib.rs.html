...
</span><span class="doccomment">//! Another [Base58][] codec implementation.
//!
...
</span><span class="kw">pub use </span>alphabet::Alphabet;
...
</span><span class="kw">const </span>CHECKSUM_LEN: usize = <span class="number">4</span>;

<span class="doccomment">/// Possible check variants.
</span><span class="kw">enum </span>Check {
    Disabled,
    <span class="attr">#[cfg(feature = <span class="string">"check"</span>)]
    </span>Enabled(<span class="prelude-ty">Option</span>&lt;u8&gt;),
}

<span class="doccomment">/// Setup decoder for the given string using the [default alphabet][Alphabet::DEFAULT].
///
/// # Examples
///
/// ## Basic example
...
/// ```
</span><span class="kw">pub fn </span>decode&lt;I: AsRef&lt;[u8]&gt;&gt;(input: I) -&gt; decode::DecodeBuilder&lt;<span class="lifetime">'static</span>, I&gt; {
    decode::DecodeBuilder::from_input(input)
}

<span class="doccomment">/// Setup encoder for the given bytes using the [default alphabet][Alphabet::DEFAULT].
///
/// # Examples
///
/// ## Basic example
...
/// ```
</span><span class="kw">pub fn </span>encode&lt;I: AsRef&lt;[u8]&gt;&gt;(input: I) -&gt; encode::EncodeBuilder&lt;<span class="lifetime">'static</span>, I&gt; {
