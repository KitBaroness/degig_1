...
</pre></div><pre class="rust"><code><span class="doccomment">//! WARNING: this is not part of the crate's public API and is subject to change at any time
...
<span class="kw">pub use </span>std::{file, format_args, line, module_path, stringify};
...
<span class="comment">// Log implementation.
    ...
    args: Arguments,
    level: Level,
    <span class="kw-2">&amp;</span>(target, module_path, file): <span class="kw-2">&amp;</span>(<span class="kw-2">&amp;</span>str, <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str, <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str),
    line: u32,
    ...
    builder
        ...
        .file_static(<span class="prelude-val">Some</span>(file))
        .line(<span class="prelude-val">Some</span>(line));
...
<span class="kw">pub fn </span>log&lt;<span class="lifetime">'a</span>, K&gt;(
    args: Arguments,
    level: Level,
    target_module_path_and_file: <span class="kw-2">&amp;</span>(<span class="kw-2">&amp;</span>str, <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str, <span class="kw-2">&amp;</span><span class="lifetime">'static </span>str),
    line: u32,
    kvs: K,
) <span class="kw">where
