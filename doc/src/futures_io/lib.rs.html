<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/futures-io-0.3.30/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="futures_io" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../futures_io/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="attr">#![cfg_attr(test, warn(single_use_lifetimes))]
#![doc(test(
    no_crate_inject,
    attr(
...
#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">mod </span>if_std {
    ...
    </span><span class="attr">#[allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
    </span><span class="attr">#[doc(no_inline)]
    </span><span class="kw">pub use </span>io::{Error, ErrorKind, IoSlice, IoSliceMut, <span class="prelude-ty">Result</span>, SeekFrom};

    <span class="doccomment">/// Read bytes asynchronously.
    ///
    ...
    /// the calling thread.
        ...
        <span class="doccomment">/// Attempt to read from the `AsyncRead` into `buf`.
        ///
        ...
        ) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;usize&gt;&gt;;

        <span class="doccomment">/// Attempt to read from the `AsyncRead` into `bufs` using vectored
        /// IO operations.
        ///
        ...
        /// `Interrupted` into another error kind.
            ...
            <span class="kw">for </span>b <span class="kw">in </span>bufs {
                <span class="kw">if </span>!b.is_empty() {
                    <span class="kw">return </span><span class="self">self</span>.poll_read(cx, b);
                }
            }

            <span class="self">self</span>.poll_read(cx, <span class="kw-2">&amp;mut </span>[])
        }
    }

    <span class="doccomment">/// Write bytes asynchronously.
    ///
    ...
    /// the calling thread.
        ...
        <span class="doccomment">/// Attempt to write bytes from `bufs` into the object using vectored
        /// IO operations.
        ///
        ...
        /// `Interrupted` into another error kind.
            ...
            <span class="kw">for </span>b <span class="kw">in </span>bufs {
                <span class="kw">if </span>!b.is_empty() {
                    <span class="kw">return </span><span class="self">self</span>.poll_write(cx, b);
                }
            }

            <span class="self">self</span>.poll_write(cx, <span class="kw-2">&amp;</span>[])
        }

        <span class="doccomment">/// Attempt to flush the object, ensuring that any buffered data reach
        /// their destination.
        ///
        ...
        </span><span class="kw">fn </span>poll_flush(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt;;

        <span class="doccomment">/// Attempt to close the object.
        ///
        /// On success, returns `Poll::Ready(Ok(()))`.
        ///
        ...
        /// `Poll::Pending` and either internally retry or convert
        /// `Interrupted` into another error kind.
        </span><span class="kw">fn </span>poll_close(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt;;
    }

    <span class="doccomment">/// Seek bytes asynchronously.
    ///
    ...
    /// for wakeup and return if data is not yet available, rather than blocking
    /// the calling thread.
    </span><span class="kw">pub trait </span>AsyncSeek {
        <span class="doccomment">/// Attempt to seek to an offset, in bytes, in a stream.
        ///
    ...
    /// the calling thread.
        ...
        <span class="doccomment">/// Attempt to return the contents of the internal buffer, filling it with more data
        ...
        /// `Poll::Pending` and either internally retry or convert
        /// `Interrupted` into another error kind.
        </span><span class="kw">fn </span>poll_fill_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>[u8]&gt;&gt;;
    ...
    <span class="macro">macro_rules!</span> deref_async_read {
        () =&gt; {
            ...
            <span class="kw">fn </span>poll_read_vectored(
                ...
                Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).poll_read_vectored(cx, bufs)
            }
        };
    }
        ...
        P::Target: AsyncRead,
    {
        ...
        <span class="kw">fn </span>poll_read_vectored(
            ...
            <span class="self">self</span>.get_mut().as_mut().poll_read_vectored(cx, bufs)
        }
    }

    <span class="macro">macro_rules!</span> delegate_async_read_to_stdio {
        () =&gt; {
            <span class="kw">fn </span>poll_read(
                <span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
                ...
                Poll::Ready(io::Read::read(<span class="kw-2">&amp;mut *</span><span class="self">self</span>, buf))
            }
            ...
            <span class="kw">fn </span>poll_read_vectored(
                ...
                Poll::Ready(io::Read::read_vectored(<span class="kw-2">&amp;mut *</span><span class="self">self</span>, bufs))
            }
        };
    }

    <span class="kw">impl </span>AsyncRead <span class="kw">for </span><span class="kw-2">&amp;</span>[u8] {
        <span class="macro">delegate_async_read_to_stdio!</span>();
    }
    ...
    <span class="macro">macro_rules!</span> deref_async_write {
        () =&gt; {
            ...
            <span class="kw">fn </span>poll_flush(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt; {
                Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).poll_flush(cx)
            }

            <span class="kw">fn </span>poll_close(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt; {
                Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).poll_close(cx)
            }
        };
    }
        ...
        P::Target: AsyncWrite,
    {
        ...
        <span class="kw">fn </span>poll_flush(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt; {
            <span class="self">self</span>.get_mut().as_mut().poll_flush(cx)
        }

        <span class="kw">fn </span>poll_close(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt; {
            <span class="self">self</span>.get_mut().as_mut().poll_close(cx)
        }
    }

    <span class="macro">macro_rules!</span> delegate_async_write_to_stdio {
        () =&gt; {
            <span class="kw">fn </span>poll_write(
                <span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
                <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
            ...
            <span class="kw">fn </span>poll_flush(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;()&gt;&gt; {
    ...
    <span class="kw">impl </span>AsyncWrite <span class="kw">for </span>Vec&lt;u8&gt; {
        <span class="macro">delegate_async_write_to_stdio!</span>();
    }

    <span class="macro">macro_rules!</span> deref_async_seek {
        () =&gt; {
            <span class="kw">fn </span>poll_seek(
                <span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
                cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
                pos: SeekFrom,
            ) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;u64&gt;&gt; {
                Pin::new(<span class="kw-2">&amp;mut **</span><span class="self">self</span>).poll_seek(cx, pos)
            }
        };
    }

    <span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized + AsyncSeek + Unpin&gt; AsyncSeek <span class="kw">for </span>Box&lt;T&gt; {
        <span class="macro">deref_async_seek!</span>();
    }

    <span class="kw">impl</span>&lt;T: <span class="question-mark">?</span>Sized + AsyncSeek + Unpin&gt; AsyncSeek <span class="kw">for </span><span class="kw-2">&amp;mut </span>T {
        <span class="macro">deref_async_seek!</span>();
    }

    <span class="kw">impl</span>&lt;P&gt; AsyncSeek <span class="kw">for </span>Pin&lt;P&gt;
    <span class="kw">where
        </span>P: DerefMut + Unpin,
        P::Target: AsyncSeek,
    {
        <span class="kw">fn </span>poll_seek(
            ...
            <span class="self">self</span>.get_mut().as_mut().poll_seek(cx, pos)
        }
    }
    ...
    <span class="macro">macro_rules!</span> delegate_async_buf_read_to_stdio {
        () =&gt; {
            <span class="kw">fn </span>poll_fill_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>[u8]&gt;&gt; {
    ...
    <span class="kw">impl </span>AsyncBufRead <span class="kw">for </span><span class="kw-2">&amp;</span>[u8] {
        <span class="macro">delegate_async_buf_read_to_stdio!</span>();
    }
}

<span class="attr">#[cfg(feature = <span class="string">"std"</span>)]
</span><span class="kw">pub use </span><span class="self">self</span>::if_std::<span class="kw-2">*</span>;
