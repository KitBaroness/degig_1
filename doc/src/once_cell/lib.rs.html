...
</pre></div><pre class="rust"><code><span class="doccomment">//! # Overview
//!
...
<span class="attr">#[cfg(all(feature = <span class="string">"critical-section"</span>, not(feature = <span class="string">"std"</span>)))]
#[path = <span class="string">"imp_cs.rs"</span>]
</span><span class="kw">mod </span>imp;

<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"parking_lot"</span>))]
#[path = <span class="string">"imp_pl.rs"</span>]
</span><span class="kw">mod </span>imp;

<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, not(feature = <span class="string">"parking_lot"</span>)))]
#[path = <span class="string">"imp_std.rs"</span>]
</span><span class="kw">mod </span>imp;

<span class="doccomment">/// Single-threaded version of `OnceCell`.
</span><span class="kw">pub mod </span>unsync {
    ...
    <span class="doccomment">/// A cell which can be written to only once. It is not thread safe.
    ///
    ...
    <span class="comment">// Similarly to a `Sync` bound on `sync::OnceCell`, we can use
    // `&amp;unsync::OnceCell` to sneak a `T` through `catch_unwind`,
    // by initializing the cell in closure and extracting the value in the
    // `Drop`.
    </span><span class="kw">impl</span>&lt;T: RefUnwindSafe + UnwindSafe&gt; RefUnwindSafe <span class="kw">for </span>OnceCell&lt;T&gt; {}
    ...
    <span class="kw">impl</span>&lt;T: Clone&gt; Clone <span class="kw">for </span>OnceCell&lt;T&gt; {
        <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; OnceCell&lt;T&gt; {
            <span class="kw">match </span><span class="self">self</span>.get() {
                <span class="prelude-val">Some</span>(value) =&gt; OnceCell::with_value(value.clone()),
                <span class="prelude-val">None </span>=&gt; OnceCell::new(),
            }
        }
        ...
        <span class="kw">fn </span>clone_from(<span class="kw-2">&amp;mut </span><span class="self">self</span>, source: <span class="kw-2">&amp;</span><span class="self">Self</span>) {
            <span class="kw">match </span>(<span class="self">self</span>.get_mut(), source.get()) {
                (<span class="prelude-val">Some</span>(this), <span class="prelude-val">Some</span>(source)) =&gt; this.clone_from(source),
                <span class="kw">_ </span>=&gt; <span class="kw-2">*</span><span class="self">self </span>= source.clone(),
            }
        }
    }
    ...
    <span class="kw">impl</span>&lt;T&gt; From&lt;T&gt; <span class="kw">for </span>OnceCell&lt;T&gt; {
    ...
    <span class="kw">impl</span>&lt;T&gt; OnceCell&lt;T&gt; {
        ...
        <span class="doccomment">/// Creates a new initialized cell.
        </span><span class="kw">pub const fn </span>with_value(value: T) -&gt; OnceCell&lt;T&gt; {
        ...
        /// Returns `None` if the cell is empty.
            ...
            <span class="comment">// Safe due to `inner`'s invariant of being written to at most once.
        ...
        <span class="doccomment">/// Gets a mutable reference to the underlying value.
        ///
        /// Returns `None` if the cell is empty.
        ///
        ...
        /// ```
            ...
            <span class="comment">// Safe because we have unique access
            </span><span class="kw">unsafe </span>{ <span class="kw-2">&amp;mut *</span><span class="self">self</span>.inner.get() }.as_mut()
        }
        ...
        /// ```
            ...
            <span class="kw">match </span><span class="self">self</span>.try_insert(value) {
                <span class="prelude-val">Ok</span>(<span class="kw">_</span>) =&gt; <span class="prelude-val">Ok</span>(()),
                <span class="prelude-val">Err</span>((<span class="kw">_</span>, value)) =&gt; <span class="prelude-val">Err</span>(value),
            }
        }

        <span class="doccomment">/// Like [`set`](Self::set), but also returns a reference to the final cell value.
        ///
        /// # Example
        /// ```
        /// use once_cell::unsync::OnceCell;
        ...
        /// assert!(cell.get().is_some());
        /// ```
        </span><span class="kw">pub fn </span>try_insert(<span class="kw-2">&amp;</span><span class="self">self</span>, value: T) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>T, (<span class="kw-2">&amp;</span>T, T)&gt; {
            <span class="kw">if let </span><span class="prelude-val">Some</span>(old) = <span class="self">self</span>.get() {
                <span class="kw">return </span><span class="prelude-val">Err</span>((old, value));
            }

            <span class="kw">let </span>slot = <span class="kw">unsafe </span>{ <span class="kw-2">&amp;mut *</span><span class="self">self</span>.inner.get() };
            <span class="comment">// This is the only place where we set the slot, no races
            // due to reentrancy/concurrency are possible, and we've
            // checked that slot is currently `None`, so this write
            // maintains the `inner`'s invariant.
            </span><span class="kw-2">*</span>slot = <span class="prelude-val">Some</span>(value);
            <span class="prelude-val">Ok</span>(<span class="kw">unsafe </span>{ slot.as_ref().unwrap_unchecked() })
        }
            ...
            </span>F: FnOnce() -&gt; T,
        {
            ...
            <span class="kw">match </span><span class="self">self</span>.get_or_try_init(|| <span class="prelude-val">Ok</span>::&lt;T, Void&gt;(f())) {
            ...
            </span>F: FnOnce() -&gt; <span class="prelude-ty">Result</span>&lt;T, E&gt;,
        {
            ...
            <span class="prelude-val">Ok</span>(<span class="kw">unsafe </span>{ <span class="self">self</span>.get().unwrap_unchecked() })
        }
        ...
        <span class="doccomment">/// Consumes the `OnceCell`, returning the wrapped value.
        ///
    ...
    /// //   92
    /// ```
    </span><span class="kw">pub struct </span>Lazy&lt;T, F = <span class="kw">fn</span>() -&gt; T&gt; {
        cell: OnceCell&lt;T&gt;,
        init: Cell&lt;<span class="prelude-ty">Option</span>&lt;F&gt;&gt;,
    }

    <span class="kw">impl</span>&lt;T, F: RefUnwindSafe&gt; RefUnwindSafe <span class="kw">for </span>Lazy&lt;T, F&gt; <span class="kw">where </span>OnceCell&lt;T&gt;: RefUnwindSafe {}
    ...
    <span class="kw">impl</span>&lt;T, F&gt; Lazy&lt;T, F&gt; {
        ...
        /// # }
        /// ```
        </span><span class="kw">pub const fn </span>new(init: F) -&gt; Lazy&lt;T, F&gt; {
            Lazy { cell: OnceCell::new(), init: Cell::new(<span class="prelude-val">Some</span>(init)) }
        }

        <span class="doccomment">/// Consumes this `Lazy` returning the stored value.
        ///
        /// Returns `Ok(value)` if `Lazy` is initialized and `Err(f)` otherwise.
        </span><span class="kw">pub fn </span>into_value(this: Lazy&lt;T, F&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;T, F&gt; {
            <span class="kw">let </span>cell = this.cell;
            <span class="kw">let </span>init = this.init;
            cell.into_inner().ok_or_else(|| {
                init.take().unwrap_or_else(|| <span class="macro">panic!</span>(<span class="string">"Lazy instance has previously been poisoned"</span>))
            })
        }
    }
    ...
    <span class="kw">impl</span>&lt;T, F: FnOnce() -&gt; T&gt; Lazy&lt;T, F&gt; {
        ...
        /// assert_eq!(&amp;*lazy, &amp;92);
        /// ```
        </span><span class="kw">pub fn </span>force(this: <span class="kw-2">&amp;</span>Lazy&lt;T, F&gt;) -&gt; <span class="kw-2">&amp;</span>T {
        ...
        /// assert_eq!(*lazy, 92);
        /// ```
        </span><span class="kw">pub fn </span>force_mut(this: <span class="kw-2">&amp;mut </span>Lazy&lt;T, F&gt;) -&gt; <span class="kw-2">&amp;mut </span>T {
            <span class="kw">if </span>this.cell.get_mut().is_none() {
                <span class="kw">let </span>value = <span class="kw">match </span>this.init.get_mut().take() {
                    <span class="prelude-val">Some</span>(f) =&gt; f(),
                    <span class="prelude-val">None </span>=&gt; <span class="macro">panic!</span>(<span class="string">"Lazy instance has previously been poisoned"</span>),
                };
                this.cell = OnceCell::with_value(value);
            }
            this.cell.get_mut().unwrap_or_else(|| <span class="macro">unreachable!</span>())
        }

        <span class="doccomment">/// Gets the reference to the result of this lazy value if
        ...
        /// ```
        </span><span class="kw">pub fn </span>get(this: <span class="kw-2">&amp;</span>Lazy&lt;T, F&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>T&gt; {
            this.cell.get()
        }

        <span class="doccomment">/// Gets the mutable reference to the result of this lazy value if
        /// it was initialized, otherwise returns `None`.
        ///
        /// # Example
        /// ```
        ...
        /// ```
        </span><span class="kw">pub fn </span>get_mut(this: <span class="kw-2">&amp;mut </span>Lazy&lt;T, F&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;mut </span>T&gt; {
            this.cell.get_mut()
        }
    }
    ...
    <span class="kw">impl</span>&lt;T, F: FnOnce() -&gt; T&gt; DerefMut <span class="kw">for </span>Lazy&lt;T, F&gt; {
        <span class="kw">fn </span>deref_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>T {
            Lazy::force_mut(<span class="self">self</span>)
        }
    }
...
<span class="doccomment">/// Thread-safe, blocking version of `OnceCell`.
</span><span class="attr">#[cfg(any(feature = <span class="string">"std"</span>, feature = <span class="string">"critical-section"</span>))]
    ...
    <span class="kw">use </span><span class="kw">super</span>::imp::OnceCell <span class="kw">as </span>Imp;
    ...
    /// ```
    </span><span class="kw">pub struct </span>OnceCell&lt;T&gt;(Imp&lt;T&gt;);
    ...
    <span class="kw">impl</span>&lt;T: Clone&gt; Clone <span class="kw">for </span>OnceCell&lt;T&gt; {
        <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; OnceCell&lt;T&gt; {
            <span class="kw">match </span><span class="self">self</span>.get() {
                <span class="prelude-val">Some</span>(value) =&gt; <span class="self">Self</span>::with_value(value.clone()),
                <span class="prelude-val">None </span>=&gt; <span class="self">Self</span>::new(),
            }
        }
    ...
    <span class="kw">impl</span>&lt;T&gt; From&lt;T&gt; <span class="kw">for </span>OnceCell&lt;T&gt; {
        <span class="kw">fn </span>from(value: T) -&gt; <span class="self">Self </span>{
            <span class="self">Self</span>::with_value(value)
        }
    }
    ...
    <span class="kw">impl</span>&lt;T&gt; OnceCell&lt;T&gt; {
        ...
        /// method never blocks.
            ...
            <span class="kw">if </span><span class="self">self</span>.<span class="number">0</span>.is_initialized() {
                <span class="comment">// Safe b/c value is initialized.
                </span><span class="prelude-val">Some</span>(<span class="kw">unsafe </span>{ <span class="self">self</span>.get_unchecked() })
            } <span class="kw">else </span>{
                <span class="prelude-val">None
            </span>}
        }

        <span class="doccomment">/// Gets the reference to the underlying value, blocking the current
        ...
        /// ```
            ...
            <span class="kw">if </span>!<span class="self">self</span>.<span class="number">0</span>.is_initialized() {
                <span class="self">self</span>.<span class="number">0</span>.wait()
            }
            <span class="macro">debug_assert!</span>(<span class="self">self</span>.<span class="number">0</span>.is_initialized());
            <span class="comment">// Safe b/c of the wait call above and the fact that we didn't
        ...
        <span class="doccomment">/// Get the reference to the underlying value, without checking if the
        /// cell is initialized.
        ///
        /// # Safety
        ///
        ...
        /// the contents are acquired by (synchronized to) this thread.
            ...
            <span class="self">self</span>.<span class="number">0</span>.get_unchecked()
        }
        ...
        /// ```
            ...
            <span class="kw">let </span>res = <span class="self">self</span>.get_or_init(|| <span class="kw">unsafe </span>{ value.take().unwrap_unchecked() });
            <span class="kw">match </span>value {
                <span class="prelude-val">None </span>=&gt; <span class="prelude-val">Ok</span>(res),
                <span class="prelude-val">Some</span>(value) =&gt; <span class="prelude-val">Err</span>((res, value)),
            }
        }
            ...
            </span>F: FnOnce() -&gt; <span class="prelude-ty">Result</span>&lt;T, E&gt;,
        {
            ...
            </span><span class="kw">if let </span><span class="prelude-val">Some</span>(value) = <span class="self">self</span>.get() {
                <span class="kw">return </span><span class="prelude-val">Ok</span>(value);
            }

            <span class="self">self</span>.<span class="number">0</span>.initialize(f)<span class="question-mark">?</span>;

            <span class="comment">// Safe b/c value is initialized.
            </span><span class="macro">debug_assert!</span>(<span class="self">self</span>.<span class="number">0</span>.is_initialized());
            <span class="prelude-val">Ok</span>(<span class="kw">unsafe </span>{ <span class="self">self</span>.get_unchecked() })
        }
        ...
        <span class="doccomment">/// Consumes the `OnceCell`, returning the wrapped value. Returns
    ...
    </span><span class="kw">unsafe impl</span>&lt;T, F: Send&gt; Sync <span class="kw">for </span>Lazy&lt;T, F&gt; <span class="kw">where </span>OnceCell&lt;T&gt;: Sync {}
    <span class="comment">// auto-derived `Send` impl is OK.

    </span><span class="kw">impl</span>&lt;T, F: RefUnwindSafe&gt; RefUnwindSafe <span class="kw">for </span>Lazy&lt;T, F&gt; <span class="kw">where </span>OnceCell&lt;T&gt;: RefUnwindSafe {}

    <span class="kw">impl</span>&lt;T, F&gt; Lazy&lt;T, F&gt; {
        <span class="doccomment">/// Creates a new lazy value with the given initializing
        /// function.
        </span><span class="kw">pub const fn </span>new(f: F) -&gt; Lazy&lt;T, F&gt; {
            Lazy { cell: OnceCell::new(), init: Cell::new(<span class="prelude-val">Some</span>(f)) }
        }
...
<span class="attr">#[cfg(feature = <span class="string">"race"</span>)]
</span><span class="kw">pub mod </span>race;
