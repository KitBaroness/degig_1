...
</pre></div><pre class="rust"><code><span class="doccomment">//! Thread-safe, non-blocking, "first one wins" flavor of `OnceCell`.
//!
...
</span><span class="attr">#[cfg(feature = <span class="string">"critical-section"</span>)]
</span><span class="kw">use </span>portable_atomic <span class="kw">as </span>atomic;
<span class="attr">#[cfg(not(feature = <span class="string">"critical-section"</span>))]
</span><span class="kw">use </span>core::sync::atomic;

<span class="kw">use </span>atomic::{AtomicPtr, AtomicUsize, Ordering};
...
<span class="doccomment">/// A thread-safe cell which can be written to only once.
</span><span class="kw">pub struct </span>OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {
    inner: AtomicPtr&lt;T&gt;,
    ghost: PhantomData&lt;UnsafeCell&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt;&gt;,
}

<span class="comment">// TODO: Replace UnsafeCell with SyncUnsafeCell once stabilized
</span><span class="kw">unsafe impl</span>&lt;<span class="lifetime">'a</span>, T: Sync&gt; Sync <span class="kw">for </span>OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; core::fmt::Debug <span class="kw">for </span>OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        <span class="macro">write!</span>(f, <span class="string">"OnceRef({:?})"</span>, <span class="self">self</span>.inner)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Default <span class="kw">for </span>OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::new()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="doccomment">/// Creates a new empty cell.
    </span><span class="kw">pub const fn </span>new() -&gt; OnceRef&lt;<span class="lifetime">'a</span>, T&gt; {
        OnceRef { inner: AtomicPtr::new(ptr::null_mut()), ghost: PhantomData }
    }

    <span class="doccomment">/// Gets a reference to the underlying value.
    </span><span class="kw">pub fn </span>get(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt; {
        <span class="kw">let </span>ptr = <span class="self">self</span>.inner.load(Ordering::Acquire);
        <span class="kw">unsafe </span>{ ptr.as_ref() }
    }
    ...
    /// full.
    </span><span class="kw">pub fn </span>set(<span class="kw-2">&amp;</span><span class="self">self</span>, value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T) -&gt; <span class="prelude-ty">Result</span>&lt;(), ()&gt; {
        <span class="kw">let </span>ptr = value <span class="kw">as </span><span class="kw-2">*const </span>T <span class="kw">as </span><span class="kw-2">*mut </span>T;
        <span class="kw">let </span>exchange =
            <span class="self">self</span>.inner.compare_exchange(ptr::null_mut(), ptr, Ordering::AcqRel, Ordering::Acquire);
        <span class="kw">match </span>exchange {
            <span class="prelude-val">Ok</span>(<span class="kw">_</span>) =&gt; <span class="prelude-val">Ok</span>(()),
            <span class="prelude-val">Err</span>(<span class="kw">_</span>) =&gt; <span class="prelude-val">Err</span>(()),
        }
    ...
    /// be called. However, all threads will return the same value, produced by
    /// some `f`.
    </span><span class="kw">pub fn </span>get_or_init&lt;F&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, f: F) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T
    <span class="kw">where
        </span>F: FnOnce() -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T,
    {
        <span class="kw">enum </span>Void {}
        <span class="kw">match </span><span class="self">self</span>.get_or_try_init(|| <span class="prelude-val">Ok</span>::&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T, Void&gt;(f())) {
            <span class="prelude-val">Ok</span>(val) =&gt; val,
            <span class="prelude-val">Err</span>(void) =&gt; <span class="kw">match </span>void {},
        }
    }
    ...
    /// be called. However, all threads will return the same value, produced by
    /// some `f`.
    </span><span class="kw">pub fn </span>get_or_try_init&lt;F, E&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, f: F) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T, E&gt;
    <span class="kw">where
        </span>F: FnOnce() -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T, E&gt;,
    {
        ...
        <span class="kw">if </span>ptr.is_null() {
            <span class="comment">// TODO replace with `cast_mut` when MSRV reaches 1.65.0 (also in `set`)
            </span>ptr = f()<span class="question-mark">? </span><span class="kw">as </span><span class="kw-2">*const </span>T <span class="kw">as </span><span class="kw-2">*mut </span>T;
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
    ...
    <span class="kw">impl</span>&lt;T&gt; OnceBox&lt;T&gt; {
        ...
        /// full.
            ...
            <span class="kw">if </span>exchange.is_err() {
