...
</span><span class="kw">pub struct </span>ChunkedEncoder&lt;<span class="lifetime">'e</span>, E: Engine + <span class="question-mark">?</span>Sized&gt; {
    engine: <span class="kw-2">&amp;</span><span class="lifetime">'e </span>E,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'e</span>, E: Engine + <span class="question-mark">?</span>Sized&gt; ChunkedEncoder&lt;<span class="lifetime">'e</span>, E&gt; {
    <span class="kw">pub fn </span>new(engine: <span class="kw-2">&amp;</span><span class="lifetime">'e </span>E) -&gt; ChunkedEncoder&lt;<span class="lifetime">'e</span>, E&gt; {
    ...
    <span class="kw">pub fn </span>encode&lt;S: Sink&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, bytes: <span class="kw-2">&amp;</span>[u8], sink: <span class="kw-2">&amp;mut </span>S) -&gt; <span class="prelude-ty">Result</span>&lt;(), S::Error&gt; {
        ...
        <span class="kw">const </span>CHUNK_SIZE: usize = BUF_SIZE / <span class="number">4 </span>* <span class="number">3</span>;

        <span class="kw">let </span><span class="kw-2">mut </span>buf = [<span class="number">0</span>; BUF_SIZE];
        <span class="kw">for </span>chunk <span class="kw">in </span>bytes.chunks(CHUNK_SIZE) {
            <span class="kw">let </span><span class="kw-2">mut </span>len = <span class="self">self</span>.engine.internal_encode(chunk, <span class="kw-2">&amp;mut </span>buf);
            <span class="kw">if </span>chunk.len() != CHUNK_SIZE &amp;&amp; <span class="self">self</span>.engine.config().encode_padding() {
                <span class="comment">// Final, potentially partial, chunk.
                ...
                </span>len += add_padding(len, <span class="kw-2">&amp;mut </span>buf[len..]);
            }
            sink.write_encoded_bytes(<span class="kw-2">&amp;</span>buf[..len])<span class="question-mark">?</span>;
        }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(<span class="string">""</span>, chunked_encode_str(<span class="kw-2">&amp;</span>[], PAD));
    }
    ...
    <span class="attr">#[test]
        ...
        </span><span class="macro">assert_eq!</span>(<span class="string">"Zm9vYmFyYmF6cXV4"</span>, chunked_encode_str(<span class="string">b"foobarbazqux"</span>, PAD));
    }
    ...
    <span class="attr">#[test]
        ...
        <span class="comment">// &gt; 32 bytes input, will enter the uber fast loop
            ...
            chunked_encode_str(<span class="string">b"foobarbazquxquuxcorgegraultgarplyz"</span>, PAD)
        );
    }
    ...
    <span class="attr">#[test]
        ...
        </span><span class="macro">assert_eq!</span>(<span class="string">"Zm9vYmFy"</span>, chunked_encode_str(<span class="string">b"foobar"</span>, PAD));
    }
    ...
    <span class="kw">pub fn </span>chunked_encode_matches_normal_encode_random&lt;S: SinkTestHelper&gt;(sink_test_helper: <span class="kw-2">&amp;</span>S) {
        ...
        <span class="kw">for _ in </span><span class="number">0</span>..<span class="number">20_000 </span>{
            input_buf.clear();
            output_buf.clear();
            ...
            <span class="kw">let </span>chunk_encoded_string = sink_test_helper.encode_to_string(<span class="kw-2">&amp;</span>engine, <span class="kw-2">&amp;</span>input_buf);
            engine.encode_string(<span class="kw-2">&amp;</span>input_buf, <span class="kw-2">&amp;mut </span>output_buf);

            <span class="macro">assert_eq!</span>(output_buf, chunk_encoded_string, <span class="string">"input len={}"</span>, buf_len);
        }
    }

    <span class="kw">fn </span>chunked_encode_str(bytes: <span class="kw-2">&amp;</span>[u8], config: GeneralPurposeConfig) -&gt; String {
        <span class="kw">let </span><span class="kw-2">mut </span>s = String::new();

        <span class="kw">let </span><span class="kw-2">mut </span>sink = StringSink::new(<span class="kw-2">&amp;mut </span>s);
        <span class="kw">let </span>engine = GeneralPurpose::new(<span class="kw-2">&amp;</span>STANDARD, config);
        <span class="kw">let </span>encoder = ChunkedEncoder::new(<span class="kw-2">&amp;</span>engine);
    ...
    <span class="comment">// An abstraction around sinks so that we can have tests that easily to any sink implementation
        ...
        <span class="kw">fn </span>encode_to_string&lt;E: Engine&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, engine: <span class="kw-2">&amp;</span>E, bytes: <span class="kw-2">&amp;</span>[u8]) -&gt; String;
    }
    ...
    <span class="kw">impl </span>SinkTestHelper <span class="kw">for </span>StringSinkTestHelper {
        <span class="kw">fn </span>encode_to_string&lt;E: Engine&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, engine: <span class="kw-2">&amp;</span>E, bytes: <span class="kw-2">&amp;</span>[u8]) -&gt; String {
            <span class="kw">let </span>encoder = ChunkedEncoder::new(engine);
            <span class="kw">let </span><span class="kw-2">mut </span>s = String::new();
            <span class="kw">let </span><span class="kw-2">mut </span>sink = StringSink::new(<span class="kw-2">&amp;mut </span>s);
            encoder.encode(bytes, <span class="kw-2">&amp;mut </span>sink).unwrap();
