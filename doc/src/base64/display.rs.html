...
</pre></div><pre class="rust"><code><span class="doccomment">//! Enables base64'd output anywhere you might use a `Display` implementation, like a format string.
//!
//! ```
...
</span><span class="kw">pub struct </span>Base64Display&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E: Engine&gt; {
    bytes: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8],
    chunked_encoder: ChunkedEncoder&lt;<span class="lifetime">'e</span>, E&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E: Engine&gt; Base64Display&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E&gt; {
    <span class="doccomment">/// Create a `Base64Display` with the provided engine.
    </span><span class="kw">pub fn </span>new(bytes: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8], engine: <span class="kw-2">&amp;</span><span class="lifetime">'e </span>E) -&gt; Base64Display&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E&gt; {
        Base64Display {
            bytes,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E: Engine&gt; Display <span class="kw">for </span>Base64Display&lt;<span class="lifetime">'a</span>, <span class="lifetime">'e</span>, E&gt; {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(
            ...
            <span class="macro">format!</span>(<span class="string">"~${}#*"</span>, Base64Display::new(<span class="string">b"foobar"</span>, <span class="kw-2">&amp;</span>STANDARD))
        );
        <span class="macro">assert_eq!</span>(
            <span class="string">"~$Zm9vYmFyZg==#*"</span>,
            <span class="macro">format!</span>(<span class="string">"~${}#*"</span>, Base64Display::new(<span class="string">b"foobarf"</span>, <span class="kw-2">&amp;</span>STANDARD))
        );
    }
    ...
    <span class="kw">impl </span>SinkTestHelper <span class="kw">for </span>DisplaySinkTestHelper {
        <span class="kw">fn </span>encode_to_string&lt;E: Engine&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, engine: <span class="kw-2">&amp;</span>E, bytes: <span class="kw-2">&amp;</span>[u8]) -&gt; String {
            <span class="macro">format!</span>(<span class="string">"{}"</span>, Base64Display::new(bytes, engine))
        }
    }
}
