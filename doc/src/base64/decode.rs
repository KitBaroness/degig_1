...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::engine::{general_purpose::STANDARD, DecodeEstimate, Engine};
...
<span class="doccomment">/// Errors that can occur while decoding into a slice.
    ...
    <span class="doccomment">/// The provided slice _may_ be too small.
    ///
