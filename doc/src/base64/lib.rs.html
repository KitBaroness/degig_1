...
</pre></div><pre class="rust"><code><span class="doccomment">//! Correct, fast, and configurable [base64][] decoding and encoding. Base64
...
</span><span class="doccomment">//! use base64::prelude::*;
//!
...
#![cfg_attr(not(feature = <span class="string">"alloc"</span>), doc = <span class="string">"```ignore"</span>)]
</span><span class="doccomment">//! use base64::{engine::general_purpose::URL_SAFE, Engine as _};
//!
//! # fn main() -&gt; Result&lt;(), base64::DecodeError&gt; {
...
#![cfg_attr(not(feature = <span class="string">"alloc"</span>), doc = <span class="string">"```ignore"</span>)]
</span><span class="doccomment">//! use base64::{engine::general_purpose::STANDARD, Engine as _};
//!
...
#![cfg_attr(not(feature = <span class="string">"alloc"</span>), doc = <span class="string">"```ignore"</span>)]
</span><span class="doccomment">//! use base64::{engine::general_purpose::STANDARD_NO_PAD, Engine as _};
//!
...
#![cfg_attr(not(feature = <span class="string">"alloc"</span>), doc = <span class="string">"```ignore"</span>)]
</span><span class="doccomment">//! use base64::{engine, alphabet, Engine as _};
//!
