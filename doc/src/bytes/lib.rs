...
</pre></div><pre class="rust"><code><span class="attr">#![warn(missing_docs, missing_debug_implementations, rust_2018_idioms)]
#![doc(test(
    no_crate_inject,
