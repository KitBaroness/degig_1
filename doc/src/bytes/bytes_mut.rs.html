...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::iter::FromIterator;
 ...
 */
    ...
    /// ```
    </span><span class="attr">#[must_use = <span class="string">"consider BytesMut::advance(len()) if you don't need the other half"</span>]
    ...
    </span><span class="kw">unsafe fn </span>advance_unchecked(<span class="kw-2">&amp;mut </span><span class="self">self</span>, count: usize) {
