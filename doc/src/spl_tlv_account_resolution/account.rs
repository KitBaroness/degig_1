...
</pre></div><pre class="rust"><code><span class="doccomment">//! Struct for managing extra required account configs, ie. defining accounts
...
//! collection of seeds
    ...
    <span class="kw">crate</span>::{error::AccountResolutionError, seeds::Seed},
