...
/// ```
</span><span class="kw">pub trait </span>TitleCase: ToOwned {
...
<span class="kw">impl </span>TitleCase <span class="kw">for </span>str {
    <span class="kw">fn </span>to_title_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; String {
        transform(<span class="self">self</span>, capitalize, |s| s.push(<span class="string">' '</span>))
    }
}

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>tests {
    <span class="kw">use </span><span class="kw">super</span>::TitleCase;
