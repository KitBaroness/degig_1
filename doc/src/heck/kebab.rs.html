...
<span class="doccomment">/// This trait defines a kebab case conversion.
///
...
/// ```
</span><span class="kw">pub trait </span>KebabCase: ToOwned {
    <span class="doccomment">/// Convert this type to kebab case.
    </span><span class="kw">fn </span>to_kebab_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self</span>::Owned;
}

<span class="kw">impl </span>KebabCase <span class="kw">for </span>str {
    <span class="kw">fn </span>to_kebab_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self</span>::Owned {
        transform(<span class="self">self</span>, lowercase, |s| s.push(<span class="string">'-'</span>))
    }
}

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>tests {
    <span class="kw">use </span><span class="kw">super</span>::KebabCase;
    ...
    <span class="macro">macro_rules!</span> t {
        (<span class="macro-nonterminal">$t</span>:ident : <span class="macro-nonterminal">$s1</span>:expr =&gt; <span class="macro-nonterminal">$s2</span>:expr) =&gt; {
            <span class="attr">#[test]
                ...
                <span class="macro">assert_eq!</span>(<span class="macro-nonterminal">$s1</span>.to_kebab_case(), <span class="macro-nonterminal">$s2</span>)
            }
        };
    }
    ...
    <span class="macro">t!</span>(test9: <span class="string">"XΣXΣ baﬄe" </span>=&gt; <span class="string">"xσxς-baﬄe"</span>);
