...
</pre></div><pre class="rust"><code><span class="kw">use crate</span>::{capitalize, transform};

<span class="doccomment">/// This trait defines a camel case conversion.
///
...
/// ```
</span><span class="kw">pub trait </span>CamelCase: ToOwned {
    <span class="doccomment">/// Convert this type to camel case.
    </span><span class="kw">fn </span>to_camel_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self</span>::Owned;
}

<span class="kw">impl </span>CamelCase <span class="kw">for </span>str {
    <span class="kw">fn </span>to_camel_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; String {
        transform(<span class="self">self</span>, capitalize, |<span class="kw">_</span>| {})
    }
}

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>tests {
    <span class="kw">use </span><span class="kw">super</span>::CamelCase;
    ...
    <span class="macro">macro_rules!</span> t {
        (<span class="macro-nonterminal">$t</span>:ident : <span class="macro-nonterminal">$s1</span>:expr =&gt; <span class="macro-nonterminal">$s2</span>:expr) =&gt; {
            <span class="attr">#[test]
                ...
                <span class="macro">assert_eq!</span>(<span class="macro-nonterminal">$s1</span>.to_camel_case(), <span class="macro-nonterminal">$s2</span>)
            }
        };
    }
    ...
    <span class="macro">t!</span>(test3: <span class="string">"MixedUP_CamelCase, with some Spaces" </span>=&gt; <span class="string">"MixedUpCamelCaseWithSomeSpaces"</span>);
