...
/// ```
</span><span class="kw">pub trait </span>ShoutyKebabCase: ToOwned {
...
<span class="kw">impl </span>ShoutyKebabCase <span class="kw">for </span>str {
    <span class="kw">fn </span>to_shouty_kebab_case(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self</span>::Owned {
        transform(<span class="self">self</span>, uppercase, |s| s.push(<span class="string">'-'</span>))
    }
}

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>tests {
    <span class="kw">use </span><span class="kw">super</span>::ShoutyKebabCase;
    ...
    <span class="macro">t!</span>(test9: <span class="string">"XΣXΣ baﬄe" </span>=&gt; <span class="string">"XΣXΣ-BAFFLE"</span>);
