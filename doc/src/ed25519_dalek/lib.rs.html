...
</span><span class="doccomment">//! A Rust implementation of ed25519 key generation, signing, and verification.
//!
//! # Example
//!
...
#![deny(missing_docs)] </span><span class="comment">// refuse to compile if documentation is missing
...
<span class="kw">pub extern crate </span>ed25519;

<span class="attr">#[cfg(all(feature = <span class="string">"alloc"</span>, not(feature = <span class="string">"std"</span>)))]
</span><span class="kw">extern crate </span>alloc;
<span class="kw">extern crate </span>curve25519_dalek;
<span class="attr">#[cfg(all(any(feature = <span class="string">"batch"</span>, feature = <span class="string">"batch_deterministic"</span>), any(feature = <span class="string">"std"</span>, feature = <span class="string">"alloc"</span>)))]
</span><span class="kw">extern crate </span>merlin;
<span class="attr">#[cfg(any(feature = <span class="string">"batch"</span>, feature = <span class="string">"std"</span>, feature = <span class="string">"alloc"</span>, test))]
</span><span class="kw">extern crate </span>rand;
<span class="attr">#[cfg(feature = <span class="string">"serde"</span>)]
</span><span class="kw">extern crate </span>serde_crate <span class="kw">as </span>serde;
<span class="kw">extern crate </span>sha2;
...
<span class="kw">mod </span>secret;
<span class="kw">mod </span>signature;

<span class="kw">pub use </span>curve25519_dalek::digest::Digest;

<span class="attr">#[cfg(all(any(feature = <span class="string">"batch"</span>, feature = <span class="string">"batch_deterministic"</span>), any(feature = <span class="string">"std"</span>, feature = <span class="string">"alloc"</span>)))]
</span><span class="kw">pub use </span><span class="kw">crate</span>::batch::<span class="kw-2">*</span>;
<span class="kw">pub use </span><span class="kw">crate</span>::constants::<span class="kw-2">*</span>;
<span class="kw">pub use </span><span class="kw">crate</span>::errors::<span class="kw-2">*</span>;
<span class="kw">pub use </span><span class="kw">crate</span>::keypair::<span class="kw-2">*</span>;
<span class="kw">pub use </span><span class="kw">crate</span>::public::<span class="kw-2">*</span>;
<span class="kw">pub use </span><span class="kw">crate</span>::secret::<span class="kw-2">*</span>;

<span class="comment">// Re-export the `Signer` and `Verifier` traits from the `signature` crate
</span><span class="kw">pub use </span>ed25519::signature::{Signer, Verifier};
<span class="kw">pub use </span>ed25519::Signature;
