...
<span class="kw">impl </span>Signature {
    <span class="attr">#[deprecated(
        since = <span class="string">"1.16.4"</span>,
        note = <span class="string">"Please use 'Signature::from' or 'Signature::try_from' instead"
    </span>)]
    </span><span class="kw">pub fn </span>new(signature_slice: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="self">Self </span>{
    ...
    <span class="kw">pub fn </span>new_unique() -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::from(std::array::from_fn(|<span class="kw">_</span>| rand::random()))
    }
...
<span class="kw">impl </span>From&lt;[u8; SIGNATURE_BYTES]&gt; <span class="kw">for </span>Signature {
    <span class="attr">#[inline]
        ...
        <span class="self">Self</span>(GenericArray::from(signature))
    }
}
...
<span class="kw">impl </span>TryFrom&lt;Vec&lt;u8&gt;&gt; <span class="kw">for </span>Signature {
...
<span class="kw">impl </span>FromStr <span class="kw">for </span>Signature {
    ...
    <span class="kw">fn </span>from_str(s: <span class="kw-2">&amp;</span>str) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Err&gt; {
        ...
        Signature::try_from(bytes).map_err(|<span class="kw">_</span>| ParseSignatureError::WrongSize)
    }
}
