...
</span><span class="kw">pub use </span>solana_program::entrypoint::<span class="kw-2">*</span>;

<span class="attr">#[macro_export]
#[deprecated(
    since = <span class="string">"1.4.3"</span>,
    note = <span class="string">"use solana_program::entrypoint::entrypoint instead"
</span>)]
</span><span class="macro">macro_rules!</span> entrypoint {
    (<span class="macro-nonterminal">$process_instruction</span>:ident) =&gt; {
        <span class="attr">#[cfg(all(not(feature = <span class="string">"custom-heap"</span>), not(test)))]
        #[global_allocator]
            ...
            start: <span class="macro-nonterminal">$crate::entrypoint::HEAP_START_ADDRESS</span>,
