...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// A helper that wraps a [`Sink`]`&lt;`[`Bytes`]`&gt;` and converts it into a
    ...
    </span><span class="kw">pub struct </span>CopyToBytes&lt;S&gt; {
        <span class="attr">#[pin]
        </span>inner: S,
    }
}

<span class="kw">impl</span>&lt;S&gt; CopyToBytes&lt;S&gt; {
    <span class="doccomment">/// Creates a new [`CopyToBytes`].
    </span><span class="kw">pub fn </span>new(inner: S) -&gt; <span class="self">Self </span>{
    ...
    <span class="doccomment">/// Consumes this [`CopyToBytes`], returning the underlying sink.
    </span><span class="kw">pub fn </span>into_inner(<span class="self">self</span>) -&gt; S {
        <span class="self">self</span>.inner
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, S&gt; Sink&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]&gt; <span class="kw">for </span>CopyToBytes&lt;S&gt;
<span class="kw">where
    </span>S: Sink&lt;Bytes&gt;,
{
    ...
    <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
...
<span class="kw">impl</span>&lt;S: Stream&gt; Stream <span class="kw">for </span>CopyToBytes&lt;S&gt; {
