...
</pre></div><pre class="rust"><code><span class="kw">use </span>bytes::BufMut;
...
<span class="doccomment">/// Read data from an `AsyncRead` into an implementer of the [`BufMut`] trait.
///
/// [`BufMut`]: bytes::BufMut
///
/// # Example
...
/// # }
/// ```
</span><span class="kw">pub async fn </span>read_buf&lt;R, B&gt;(read: <span class="kw-2">&amp;mut </span>R, buf: <span class="kw-2">&amp;mut </span>B) -&gt; io::Result&lt;usize&gt;
<span class="kw">where
    </span>R: AsyncRead + Unpin,
    B: BufMut,
{
    <span class="kw">return </span>ReadBufFn(read, buf).<span class="kw">await</span>;

    <span class="kw">struct </span>ReadBufFn&lt;<span class="lifetime">'a</span>, R, B&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>R, <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>B);

    <span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, R, B&gt; Future <span class="kw">for </span>ReadBufFn&lt;<span class="lifetime">'a</span>, R, B&gt;
    <span class="kw">where
        </span>R: AsyncRead + Unpin,
        B: BufMut,
    {
        ...
        <span class="kw">fn </span>poll(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="self">Self</span>::Output&gt; {
            ...
            <span class="kw">crate</span>::util::poll_read_buf(Pin::new(this.<span class="number">0</span>), cx, this.<span class="number">1</span>)
        }
    }
}
