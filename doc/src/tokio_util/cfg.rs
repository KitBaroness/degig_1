...
</pre></div><pre class="rust"><code><span class="macro">macro_rules!</span> cfg_codec {
    ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
        $(
            <span class="attr">#[cfg(feature = <span class="string">"codec"</span>)]
            #[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"codec"</span>)))]
            </span><span class="macro-nonterminal">$item
        </span>)*
    }
}

<span class="macro">macro_rules!</span> cfg_compat {
    ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
        $(
...
<span class="macro">macro_rules!</span> cfg_net {
    ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
        $(
            <span class="attr">#[cfg(all(feature = <span class="string">"net"</span>, feature = <span class="string">"codec"</span>))]
            #[cfg_attr(docsrs, doc(cfg(all(feature = <span class="string">"net"</span>, feature = <span class="string">"codec"</span>))))]
            </span><span class="macro-nonterminal">$item
        </span>)*
    }
}

<span class="macro">macro_rules!</span> cfg_io {
    ($(<span class="macro-nonterminal">$item</span>:item)<span class="kw-2">*</span>) =&gt; {
        $(
