...
</pre></div><pre class="rust"><code><span class="doccomment">//! Module defining an Either type.
...
/// }
/// ```
</span><span class="attr">#[allow(missing_docs)] </span><span class="comment">// Doc-comments for variants in this particular case don't make much sense.
