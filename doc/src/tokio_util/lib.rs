...
</pre></div><pre class="rust"><code><span class="attr">#![allow(clippy::needless_doctest_main)]
#![warn(
...
</span><span class="doccomment">//! Utilities for working with Tokio.
//!
...
<span class="macro">cfg_codec!</span> {
...
<span class="macro">cfg_compat!</span> {
    <span class="kw">pub mod </span>compat;
}
...
<span class="kw">pub use </span>bytes;
