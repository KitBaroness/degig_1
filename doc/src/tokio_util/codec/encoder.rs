...
</pre></div><pre class="rust"><code><span class="kw">use </span>bytes::BytesMut;
<span class="kw">use </span>std::io;

<span class="doccomment">/// Trait of helper objects to write out messages as bytes, for use with
/// [`FramedWrite`].
///
/// [`FramedWrite`]: crate::codec::FramedWrite
</span><span class="kw">pub trait </span>Encoder&lt;Item&gt; {
    ...
    <span class="doccomment">/// Encodes a frame into the buffer provided.
    ///
    ...
    ///
    /// [`FramedWrite`]: crate::codec::FramedWrite
    </span><span class="kw">fn </span>encode(<span class="kw-2">&amp;mut </span><span class="self">self</span>, item: Item, dst: <span class="kw-2">&amp;mut </span>BytesMut) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;;
}
