...
</pre></div><pre class="rust"><code><span class="doccomment">//! Synchronization primitives

</span><span class="kw">mod </span>cancellation_token;
<span class="kw">pub use </span>cancellation_token::{
    guard::DropGuard, CancellationToken, WaitForCancellationFuture, WaitForCancellationFutureOwned,
};

<span class="kw">mod </span>mpsc;
<span class="kw">pub use </span>mpsc::{PollSendError, PollSender};

<span class="kw">mod </span>poll_semaphore;
<span class="kw">pub use </span>poll_semaphore::PollSemaphore;

<span class="kw">mod </span>reusable_box;
<span class="kw">pub use </span>reusable_box::ReusableBoxFuture;
