...
</pre></div><pre class="rust"><code><span class="doccomment">//! This mod provides the logic for the inner tree structure of the CancellationToken.
//!
