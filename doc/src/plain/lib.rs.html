...
</pre></div><pre class="rust"><code><span class="doccomment">//! A small Rust library that allows users to interpret arrays of bytes
...
<span class="kw">mod </span>plain;
<span class="kw">pub use </span>plain::Plain;

<span class="kw">mod </span>methods;
<span class="kw">pub use </span>methods::{as_bytes, as_mut_bytes, copy_from_bytes, from_bytes, from_mut_bytes, is_aligned,
