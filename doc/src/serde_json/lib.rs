...
</pre></div><pre class="rust"><code><span class="doccomment">//! # Serde JSON
//!
...
//! [`serde-json-core`]: https://github.com/rust-embedded-community/serde-json-core
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/serde_json/1.0.116"</span>)]
    ...
    clippy::unconditional_recursion, <span class="comment">// https://github.com/rust-lang/rust-clippy/issues/12133
    </span>clippy::unnecessary_wraps
)]
...
#[cfg(not(any(feature = <span class="string">"std"</span>, feature = <span class="string">"alloc"</span>)))]
</span><span class="macro">compile_error!</span> {
    <span class="string">"serde_json requires that either `std` (default) or `alloc` feature is enabled"
</span>}
