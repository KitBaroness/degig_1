...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::Value;
...
</span><span class="macro">from_integer!</span> {
    i128 u128
}

<span class="kw">impl </span>From&lt;f32&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert 32-bit floating point number to `Value::Number`, or
...
<span class="kw">impl </span>From&lt;f64&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert 64-bit floating point number to `Value::Number`, or
    /// `Value::Null` if infinite or NaN.
    ///
    /// # Examples
    ///
...
<span class="kw">impl </span>From&lt;bool&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert boolean to `Value::Bool`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>From&lt;String&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert `String` to `Value::String`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>From&lt;<span class="kw-2">&amp;</span>str&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert string slice to `Value::String`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; From&lt;Cow&lt;<span class="lifetime">'a</span>, str&gt;&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert copy-on-write string to `Value::String`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>From&lt;Number&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert `Number` to `Value::Number`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>From&lt;Map&lt;String, Value&gt;&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert map (with string keys) to `Value::Object`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl</span>&lt;T: Into&lt;Value&gt;&gt; From&lt;Vec&lt;T&gt;&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert a `Vec` to `Value::Array`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl</span>&lt;T: Clone + Into&lt;Value&gt;&gt; From&lt;<span class="kw-2">&amp;</span>[T]&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert a slice to `Value::Array`.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let x: Value = v.into();
    /// ```
    </span><span class="kw">fn </span>from(f: <span class="kw-2">&amp;</span>[T]) -&gt; <span class="self">Self </span>{
        Value::Array(f.iter().cloned().map(Into::into).collect())
    }
}

<span class="kw">impl</span>&lt;T: Into&lt;Value&gt;&gt; FromIterator&lt;T&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Create a `Value::Array` by collecting an iterator of array elements.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl</span>&lt;K: Into&lt;String&gt;, V: Into&lt;Value&gt;&gt; FromIterator&lt;(K, V)&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Create a `Value::Object` by collecting an iterator of key-value pairs.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>From&lt;()&gt; <span class="kw">for </span>Value {
    <span class="doccomment">/// Convert `()` to `Value::Null`.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl</span>&lt;T&gt; From&lt;<span class="prelude-ty">Option</span>&lt;T&gt;&gt; <span class="kw">for </span>Value
<span class="kw">where
    </span>T: Into&lt;Value&gt;,
{
    <span class="kw">fn </span>from(opt: <span class="prelude-ty">Option</span>&lt;T&gt;) -&gt; <span class="self">Self </span>{
        <span class="kw">match </span>opt {
            <span class="prelude-val">None </span>=&gt; Value::Null,
            <span class="prelude-val">Some</span>(value) =&gt; Into::into(value),
        }
    }
}
