...
<span class="kw">fn </span>eq_f32(value: <span class="kw-2">&amp;</span>Value, other: f32) -&gt; bool {
    <span class="kw">match </span>value {
        Value::Number(n) =&gt; n.as_f32().map_or(<span class="bool-val">false</span>, |i| i == other),
