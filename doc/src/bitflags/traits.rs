...
<span class="kw">impl</span>&lt;B&gt; Flag&lt;B&gt; {
    ...
    */
    </span><span class="kw">pub const fn </span>is_named(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        !<span class="self">self</span>.name.is_empty()
    }
    ...
    */
    </span><span class="kw">pub const fn </span>is_unnamed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.name.is_empty()
    }
}
...
*/
    ...
    <span class="doccomment">/// Convert from a bits value, unsetting any unknown bits.
        ...
        <span class="self">Self</span>::from_bits_retain(bits &amp; <span class="self">Self</span>::all().bits())
    }
    ...
    /// correspond to any named flag.
        ...
        <span class="comment">// Don't parse empty names as empty flags
    ...
    {
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">Self</span>::from_bits_retain(<span class="self">self</span>.bits()).union(other);
    }
    ...
    {
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">Self</span>::from_bits_retain(<span class="self">self</span>.bits()).difference(other);
    }
    ...
    {
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">Self</span>::from_bits_retain(<span class="self">self</span>.bits()).symmetric_difference(other);
    }

    <span class="doccomment">/// Call [`Flags::insert`] when `value` is `true` or [`Flags::remove`] when `value` is `false`.
...
*/
    ...
    <span class="doccomment">/// A value with all bits unset.
    </span><span class="kw">const </span>EMPTY: <span class="self">Self</span>;

    <span class="doccomment">/// A value with all bits set.
...
#[deprecated(note = <span class="string">"use the `Flags` trait instead"</span>)]
