...
</pre></div><pre class="rust"><code><span class="doccomment">//! Trace verbosity level filtering.
//!
...
</span><span class="kw">pub const </span>STATIC_MAX_LEVEL: LevelFilter = get_max_level_inner();

<span class="kw">const fn </span>get_max_level_inner() -&gt; LevelFilter {
    <span class="kw">if </span><span class="macro">cfg!</span>(not(debug_assertions)) {
        <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"release_max_level_off"</span>) {
            ...
            <span class="comment">// Same as branch cfg!(feature = "release_max_level_trace")
            </span>LevelFilter::TRACE
        }
        ...
        <span class="comment">// Same as branch cfg!(feature = "max_level_trace")
        </span>LevelFilter::TRACE
    }
}
