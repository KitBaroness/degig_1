...
</pre></div><pre class="rust"><code><span class="doccomment">//! Spans represent periods of time in which a program was executing in a
//! particular context.
//!
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        Span::current().record(<span class="string">"some-key"</span>, <span class="string">"some text"</span>);
        Span::current().record(<span class="string">"some-key"</span>, <span class="bool-val">false</span>);
    }
}
