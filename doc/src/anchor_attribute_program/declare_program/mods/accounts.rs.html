...
</pre></div><pre class="rust"><code><span class="kw">use </span>anchor_lang_idl::types::{Idl, IdlSerialization};
                        ...
                        <span class="macro">matches!</span>(ty_def.serialization, IdlSerialization::BytemuckUnsafe)
                            .then(|| {
                                <span class="macro">quote!</span> {
                                    <span class="kw">unsafe impl </span>anchor_lang::__private::Pod <span class="kw">for </span>#name {}
                                    <span class="kw">unsafe impl </span>anchor_lang::__private::Zeroable <span class="kw">for </span>#name {}
                                }
                            })
                            .unwrap_or_default();
