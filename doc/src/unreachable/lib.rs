<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/unreachable-1.0.0/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="unreachable" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../unreachable/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="doccomment">//! # unreachable
//!
...
</span><span class="kw">extern crate </span>void;

<span class="kw">use </span>core::mem;

<span class="doccomment">/// Hint to the optimizer that any code path which calls this function is
...
</span><span class="kw">pub unsafe fn </span>unreachable() -&gt; ! {
    <span class="kw">let </span>x: <span class="kw-2">&amp;</span>void::Void = mem::transmute(<span class="number">1usize</span>);
    void::unreachable(<span class="kw-2">*</span>x)
}
...
<span class="kw">impl</span>&lt;T&gt; UncheckedOptionExt&lt;T&gt; <span class="kw">for </span><span class="prelude-ty">Option</span>&lt;T&gt; {
    <span class="kw">unsafe fn </span>unchecked_unwrap(<span class="self">self</span>) -&gt; T {
        <span class="kw">match </span><span class="self">self </span>{
            ...
            <span class="prelude-val">None </span>=&gt; unreachable()
        }
    }

    <span class="kw">unsafe fn </span>unchecked_unwrap_none(<span class="self">self</span>) {
        <span class="kw">match </span><span class="self">self </span>{
            <span class="prelude-val">Some</span>(<span class="kw">_</span>) =&gt; unreachable(),
...
<span class="kw">impl</span>&lt;T, E&gt; UncheckedResultExt&lt;T, E&gt; <span class="kw">for </span><span class="prelude-ty">Result</span>&lt;T, E&gt; {
    <span class="kw">unsafe fn </span>unchecked_unwrap_ok(<span class="self">self</span>) -&gt; T {
        <span class="kw">match </span><span class="self">self </span>{
            ...
            <span class="prelude-val">Err</span>(<span class="kw">_</span>) =&gt; unreachable()
        }
    }

    <span class="kw">unsafe fn </span>unchecked_unwrap_err(<span class="self">self</span>) -&gt; E {
        <span class="kw">match </span><span class="self">self </span>{
            <span class="prelude-val">Ok</span>(<span class="kw">_</span>) =&gt; unreachable(),
