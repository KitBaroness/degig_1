...
</pre></div><pre class="rust"><code><span class="kw">use </span>proc_macro2::<span class="kw-2">*</span>;
...
<span class="kw">impl </span>Diagnostic {
    ...
    </span><span class="attr">#[allow(unconditional_recursion)]
