...
</pre></div><pre class="rust"><code><span class="doccomment">//! A common backend for bindgen crates.
//!
...
#![cfg_attr(feature = <span class="string">"extra-traits"</span>, deny(missing_debug_implementations))]
#![deny(missing_docs)]
#![doc(html_root_url = <span class="string">"https://docs.rs/wasm-bindgen-backend/0.2"</span>)]

</span><span class="kw">pub use </span><span class="kw">crate</span>::codegen::TryToTokens;
<span class="kw">pub use </span><span class="kw">crate</span>::error::Diagnostic;
