...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)] </span><span class="kw">extern crate </span>std;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">extern crate </span>alloc;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">use </span>alloc::boxed::Box;

<span class="kw">pub use </span>error::Error;
<span class="attr">#[cfg(feature = <span class="string">"getrandom"</span>)] </span><span class="kw">pub use </span>os::OsRng;
...
<span class="attr">#[cfg(feature = <span class="string">"getrandom"</span>)] </span><span class="kw">mod </span>os;
...
/// [`rand`]: https://docs.rs/rand
    ...
    </span><span class="attr">#[cfg(feature = <span class="string">"getrandom"</span>)]
