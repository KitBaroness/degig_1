...
<span class="attr">#[cfg(feature = <span class="string">"std"</span>)] </span><span class="kw">use </span>std::boxed::Box;
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Error {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        ...
        <span class="attr">#[cfg(all(feature = <span class="string">"getrandom"</span>, not(feature = <span class="string">"std"</span>)))]
        </span>{
            getrandom::Error::from(<span class="self">self</span>.code).fmt(f)
        }
        <span class="attr">#[cfg(not(feature = <span class="string">"getrandom"</span>))]
        </span>{
