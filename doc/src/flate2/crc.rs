...
</pre></div><pre class="rust"><code><span class="doccomment">//! Simple CRC bindings backed by miniz.c
...
<span class="kw">impl </span>Crc {
    ...
    <span class="doccomment">/// Combine the CRC with the CRC for the subsequent block of bytes.
        ...
        <span class="self">self</span>.amt = <span class="self">self</span>.amt.wrapping_add(additional_crc.amt);
