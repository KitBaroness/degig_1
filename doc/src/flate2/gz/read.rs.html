...
<span class="kw">pub fn </span>gz_encoder&lt;R: Read&gt;(inner: bufread::GzEncoder&lt;BufReader&lt;R&gt;&gt;) -&gt; GzEncoder&lt;R&gt; {
    GzEncoder { inner }
}

<span class="kw">impl</span>&lt;R: Read&gt; GzEncoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;R: Read&gt; Read <span class="kw">for </span>GzEncoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;R: Read + Write&gt; Write <span class="kw">for </span>GzEncoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;R: Read&gt; GzDecoder&lt;R&gt; {
    <span class="doccomment">/// Creates a new decoder from the given reader, immediately parsing the
    /// gzip header.
    </span><span class="kw">pub fn </span>new(r: R) -&gt; GzDecoder&lt;R&gt; {
        GzDecoder {
...
<span class="kw">impl</span>&lt;R: Read&gt; Read <span class="kw">for </span>GzDecoder&lt;R&gt; {
    <span class="kw">fn </span>read(<span class="kw-2">&amp;mut </span><span class="self">self</span>, into: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.read(into)
    }
}

<span class="kw">impl</span>&lt;R: Read + Write&gt; Write <span class="kw">for </span>GzDecoder&lt;R&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.get_mut().write(buf)
    }
...
</span><span class="kw">pub struct </span>MultiGzDecoder&lt;R&gt; {
    inner: bufread::MultiGzDecoder&lt;BufReader&lt;R&gt;&gt;,
}

<span class="kw">impl</span>&lt;R: Read&gt; MultiGzDecoder&lt;R&gt; {
    <span class="doccomment">/// Creates a new decoder from the given reader, immediately parsing the
...
<span class="kw">impl</span>&lt;R: Read&gt; Read <span class="kw">for </span>MultiGzDecoder&lt;R&gt; {
    <span class="kw">fn </span>read(<span class="kw-2">&amp;mut </span><span class="self">self</span>, into: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.read(into)
    }
}

<span class="kw">impl</span>&lt;R: Read + Write&gt; Write <span class="kw">for </span>MultiGzDecoder&lt;R&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.get_mut().write(buf)
    }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>std::io::{Cursor, ErrorKind, Read, <span class="prelude-ty">Result</span>, Write};

    <span class="kw">use </span><span class="kw">super</span>::GzDecoder;

    <span class="comment">//a cursor turning EOF into blocking errors
    </span><span class="attr">#[derive(Debug)]
    </span><span class="kw">pub struct </span>BlockingCursor {
        <span class="kw">pub </span>cursor: Cursor&lt;Vec&lt;u8&gt;&gt;,
    }

    <span class="kw">impl </span>BlockingCursor {
        <span class="kw">pub fn </span>new() -&gt; BlockingCursor {
            BlockingCursor {
                cursor: Cursor::new(Vec::new()),
            }
        }

        <span class="kw">pub fn </span>set_position(<span class="kw-2">&amp;mut </span><span class="self">self</span>, pos: u64) {
            <span class="kw">return </span><span class="self">self</span>.cursor.set_position(pos);
        }
    }

    <span class="kw">impl </span>Write <span class="kw">for </span>BlockingCursor {
        <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;usize&gt; {
            <span class="kw">return </span><span class="self">self</span>.cursor.write(buf);
        }
        <span class="kw">fn </span>flush(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
            <span class="kw">return </span><span class="self">self</span>.cursor.flush();
        }
    }

    <span class="kw">impl </span>Read <span class="kw">for </span>BlockingCursor {
        <span class="kw">fn </span>read(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;usize&gt; {
            <span class="comment">//use the cursor, except it turns eof into blocking error
            </span><span class="kw">let </span>r = <span class="self">self</span>.cursor.read(buf);
            <span class="kw">match </span>r {
                <span class="prelude-val">Err</span>(<span class="kw-2">ref </span>err) =&gt; {
                    <span class="kw">if </span>err.kind() == ErrorKind::UnexpectedEof {
                        <span class="kw">return </span><span class="prelude-val">Err</span>(ErrorKind::WouldBlock.into());
                    }
                }
                <span class="prelude-val">Ok</span>(<span class="number">0</span>) =&gt; {
                    <span class="comment">//regular EOF turned into blocking error
                    </span><span class="kw">return </span><span class="prelude-val">Err</span>(ErrorKind::WouldBlock.into());
                }
                <span class="prelude-val">Ok</span>(_n) =&gt; {}
            }
    ...
    <span class="attr">#[test]
        ...
        </span><span class="kw">let </span><span class="kw-2">mut </span>decoder = GzDecoder::new(r);
        ...
        <span class="kw">match </span>decoder.read(<span class="kw-2">&amp;mut </span>out) {
            <span class="prelude-val">Err</span>(e) =&gt; {
                <span class="macro">assert_eq!</span>(e.kind(), ErrorKind::WouldBlock);
            }
            <span class="kw">_ </span>=&gt; {
