...
</span><span class="kw">pub struct </span>DeflateEncoder&lt;W: Write&gt; {
    inner: zio::Writer&lt;W, Compress&gt;,
}

<span class="kw">impl</span>&lt;W: Write&gt; DeflateEncoder&lt;W&gt; {
    ...
    /// be flushed.
    </span><span class="kw">pub fn </span>new(w: W, level: <span class="kw">crate</span>::Compression) -&gt; DeflateEncoder&lt;W&gt; {
        DeflateEncoder {
            inner: zio::Writer::new(w, Compress::new(level, <span class="bool-val">false</span>)),
        }
    }
...
<span class="kw">impl</span>&lt;W: Write&gt; Write <span class="kw">for </span>DeflateEncoder&lt;W&gt; {
...
<span class="kw">impl</span>&lt;W: Read + Write&gt; Read <span class="kw">for </span>DeflateEncoder&lt;W&gt; {
...
</span><span class="kw">pub struct </span>DeflateDecoder&lt;W: Write&gt; {
    inner: zio::Writer&lt;W, Decompress&gt;,
}

<span class="kw">impl</span>&lt;W: Write&gt; DeflateDecoder&lt;W&gt; {
    <span class="doccomment">/// Creates a new decoder which will write uncompressed data to the stream.
    ///
    /// When this encoder is dropped or unwrapped the final pieces of data will
    /// be flushed.
    </span><span class="kw">pub fn </span>new(w: W) -&gt; DeflateDecoder&lt;W&gt; {
        DeflateDecoder {
            inner: zio::Writer::new(w, Decompress::new(<span class="bool-val">false</span>)),
        }
    }
    ...
    /// returns an error then that will be returned from this function.
        ...
        <span class="self">self</span>.inner.finish()<span class="question-mark">?</span>;
        <span class="self">self</span>.inner.data = Decompress::new(<span class="bool-val">false</span>);
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.inner.replace(w))
    }
...
<span class="kw">impl</span>&lt;W: Write&gt; Write <span class="kw">for </span>DeflateDecoder&lt;W&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.write(buf)
    }
...
<span class="kw">impl</span>&lt;W: Read + Write&gt; Read <span class="kw">for </span>DeflateDecoder&lt;W&gt; {
    <span class="kw">fn </span>read(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.get_mut().read(buf)
    }
}
