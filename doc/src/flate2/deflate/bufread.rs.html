...
<span class="kw">impl</span>&lt;R: BufRead&gt; DeflateEncoder&lt;R&gt; {
    ...
    /// stream and emit the compressed stream.
        ...
        DeflateEncoder {
            obj: r,
            data: Compress::new(level, <span class="bool-val">false</span>),
        }
    }
}

<span class="kw">pub fn </span>reset_encoder_data&lt;R&gt;(zlib: <span class="kw-2">&amp;mut </span>DeflateEncoder&lt;R&gt;) {
    zlib.data.reset();
}
...
<span class="kw">impl</span>&lt;R: BufRead&gt; Read <span class="kw">for </span>DeflateEncoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;W: BufRead + Write&gt; Write <span class="kw">for </span>DeflateEncoder&lt;W&gt; {
...
<span class="kw">pub fn </span>reset_decoder_data&lt;R&gt;(zlib: <span class="kw-2">&amp;mut </span>DeflateDecoder&lt;R&gt;) {
    zlib.data = Decompress::new(<span class="bool-val">false</span>);
}

<span class="kw">impl</span>&lt;R: BufRead&gt; DeflateDecoder&lt;R&gt; {
    ...
    /// stream.
        ...
        DeflateDecoder {
            obj: r,
            data: Decompress::new(<span class="bool-val">false</span>),
        }
    }
}
...
<span class="kw">impl</span>&lt;R&gt; DeflateDecoder&lt;R&gt; {
    ...
    <span class="doccomment">/// Resets the state of this decoder's data
    ///
...
<span class="kw">impl</span>&lt;R: BufRead&gt; Read <span class="kw">for </span>DeflateDecoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;W: BufRead + Write&gt; Write <span class="kw">for </span>DeflateDecoder&lt;W&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.get_mut().write(buf)
    }
