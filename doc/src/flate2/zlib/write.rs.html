...
</span><span class="kw">pub struct </span>ZlibEncoder&lt;W: Write&gt; {
    inner: zio::Writer&lt;W, Compress&gt;,
}

<span class="kw">impl</span>&lt;W: Write&gt; ZlibEncoder&lt;W&gt; {
    <span class="doccomment">/// Creates a new encoder which will write compressed data to the stream
    /// given at the given compression level.
    ///
    /// When this encoder is dropped or unwrapped the final pieces of data will
    /// be flushed.
    </span><span class="kw">pub fn </span>new(w: W, level: <span class="kw">crate</span>::Compression) -&gt; ZlibEncoder&lt;W&gt; {
        ZlibEncoder {
            inner: zio::Writer::new(w, Compress::new(level, <span class="bool-val">true</span>)),
        }
    }

    <span class="doccomment">/// Creates a new encoder which will write compressed data to the stream
    /// `w` with the given `compression` settings.
    </span><span class="kw">pub fn </span>new_with_compress(w: W, compression: Compress) -&gt; ZlibEncoder&lt;W&gt; {
        ZlibEncoder {
    ...
    <span class="doccomment">/// Resets the state of this encoder entirely, swapping out the output
    /// stream for another.
    ///
    ...
    </span><span class="kw">pub fn </span>reset(<span class="kw-2">&amp;mut </span><span class="self">self</span>, w: W) -&gt; io::Result&lt;W&gt; {
        <span class="self">self</span>.inner.finish()<span class="question-mark">?</span>;
        <span class="self">self</span>.inner.data.reset();
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.inner.replace(w))
    }
    ...
    <span class="doccomment">/// Consumes this encoder, flushing the output stream.
    ///
    ...
    /// This function will perform I/O to complete this stream, and any I/O
    /// errors which occur will be returned from this function.
    </span><span class="kw">pub fn </span>flush_finish(<span class="kw-2">mut </span><span class="self">self</span>) -&gt; io::Result&lt;W&gt; {
        <span class="self">self</span>.inner.flush()<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.inner.take_inner())
    }

    <span class="doccomment">/// Returns the number of bytes that have been written to this compressor.
    ///
    ...
    /// there may still be some active buffering.
        ...
        <span class="self">self</span>.inner.data.total_in()
    }
    ...
    /// buffered.
        ...
        <span class="self">self</span>.inner.data.total_out()
    }
}

<span class="kw">impl</span>&lt;W: Write&gt; Write <span class="kw">for </span>ZlibEncoder&lt;W&gt; {
...
<span class="kw">impl</span>&lt;W: Read + Write&gt; Read <span class="kw">for </span>ZlibEncoder&lt;W&gt; {
...
</span><span class="kw">pub struct </span>ZlibDecoder&lt;W: Write&gt; {
    inner: zio::Writer&lt;W, Decompress&gt;,
}

<span class="kw">impl</span>&lt;W: Write&gt; ZlibDecoder&lt;W&gt; {
    ...
    /// be flushed.
    </span><span class="kw">pub fn </span>new(w: W) -&gt; ZlibDecoder&lt;W&gt; {
        ZlibDecoder {
            inner: zio::Writer::new(w, Decompress::new(<span class="bool-val">true</span>)),
        }
    }

    <span class="doccomment">/// Creates a new decoder which will write uncompressed data to the stream `w`
    /// using the given `decompression` settings.
    ///
    /// When this decoder is dropped or unwrapped the final pieces of data will
    /// be flushed.
    </span><span class="kw">pub fn </span>new_with_decompress(w: W, decompression: Decompress) -&gt; ZlibDecoder&lt;W&gt; {
        ZlibDecoder {
    ...
    <span class="doccomment">/// Resets the state of this decoder entirely, swapping out the output
    /// stream for another.
    ///
    ...
    /// errors which occur will be returned from this function.
        ...
        <span class="self">self</span>.inner.finish()<span class="question-mark">?</span>;
        <span class="self">self</span>.inner.data = Decompress::new(<span class="bool-val">true</span>);
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.inner.replace(w))
    }
    ...
    <span class="doccomment">/// Returns the number of bytes that the decompressor has consumed for
    /// decompression.
    ///
    ...
    <span class="doccomment">/// Returns the number of bytes that the decompressor has written to its
    /// output stream.
    </span><span class="kw">pub fn </span>total_out(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; u64 {
        <span class="self">self</span>.inner.data.total_out()
    }
...
<span class="kw">impl</span>&lt;W: Write&gt; Write <span class="kw">for </span>ZlibDecoder&lt;W&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.write(buf)
    }
...
<span class="kw">impl</span>&lt;W: Read + Write&gt; Read <span class="kw">for </span>ZlibDecoder&lt;W&gt; {
    <span class="kw">fn </span>read(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.inner.get_mut().read(buf)
    }
}
