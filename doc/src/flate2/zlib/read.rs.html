...
<span class="kw">use </span><span class="kw">crate</span>::Decompress;
...
<span class="kw">impl</span>&lt;R: Read&gt; ZlibEncoder&lt;R&gt; {
    ...
    <span class="doccomment">/// Creates a new encoder with the given `compression` settings which will
    /// read uncompressed data from the given stream `r` and emit the compressed stream.
    </span><span class="kw">pub fn </span>new_with_compress(r: R, compression: <span class="kw">crate</span>::Compress) -&gt; ZlibEncoder&lt;R&gt; {
        ZlibEncoder {
...
<span class="kw">impl</span>&lt;R: Read&gt; Read <span class="kw">for </span>ZlibEncoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;W: Read + Write&gt; Write <span class="kw">for </span>ZlibEncoder&lt;W&gt; {
...
<span class="kw">impl</span>&lt;R: Read&gt; ZlibDecoder&lt;R&gt; {
    ...
    /// stream.
        ...
        ZlibDecoder::new_with_buf(r, <span class="macro">vec!</span>[<span class="number">0</span>; <span class="number">32 </span>* <span class="number">1024</span>])
    }
    ...
    </span><span class="kw">pub fn </span>new_with_buf(r: R, buf: Vec&lt;u8&gt;) -&gt; ZlibDecoder&lt;R&gt; {
        ZlibDecoder {
    ...
    </span><span class="kw">pub fn </span>new_with_decompress(r: R, decompression: Decompress) -&gt; ZlibDecoder&lt;R&gt; {
        ZlibDecoder::new_with_decompress_and_buf(r, <span class="macro">vec!</span>[<span class="number">0</span>; <span class="number">32 </span>* <span class="number">1024</span>], decompression)
    }
    ...
    /// Note that the specified buffer will only be used up to its current
    /// length. The buffer's capacity will also not grow over time.
    </span><span class="kw">pub fn </span>new_with_decompress_and_buf(
        r: R,
        buf: Vec&lt;u8&gt;,
...
<span class="kw">impl</span>&lt;R: Read&gt; Read <span class="kw">for </span>ZlibDecoder&lt;R&gt; {
...
<span class="kw">impl</span>&lt;R: Read + Write&gt; Write <span class="kw">for </span>ZlibDecoder&lt;R&gt; {
    <span class="kw">fn </span>write(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;</span>[u8]) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.get_mut().write(buf)
    }
