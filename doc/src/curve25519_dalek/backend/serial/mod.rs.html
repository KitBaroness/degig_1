...
</span><span class="doccomment">//! Serial implementations of field, scalar, point arithmetic.
//!
...
//! together.
    ...
    feature = <span class="string">"u32_backend"</span>,
    feature = <span class="string">"u64_backend"</span>,
    feature = <span class="string">"fiat_u32_backend"</span>,
    feature = <span class="string">"fiat_u64_backend"
</span>)))]
...
</span><span class="kw">pub mod </span>fiat_u32;

<span class="attr">#[cfg(feature = <span class="string">"fiat_u64_backend"</span>)]
</span><span class="kw">pub mod </span>fiat_u64;

<span class="kw">pub mod </span>curve_models;
...
</span><span class="kw">pub mod </span>scalar_mul;
