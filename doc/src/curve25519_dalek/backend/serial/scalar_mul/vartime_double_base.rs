...
</span><span class="kw">use </span>constants;
<span class="kw">use </span>traits::Identity;
<span class="kw">use </span>scalar::Scalar;
<span class="kw">use </span>edwards::EdwardsPoint;
<span class="kw">use </span>backend::serial::curve_models::{ProjectiveNielsPoint, ProjectivePoint};
...
<span class="doccomment">/// Compute \\(aA + bB\\) in variable time, where \\(B\\) is the Ed25519 basepoint.
    ...
    <span class="kw">let </span>b_naf = b.non_adjacent_form(<span class="number">8</span>);
    ...
    <span class="kw">let </span>table_B = <span class="kw-2">&amp;</span>constants::AFFINE_ODD_MULTIPLES_OF_BASEPOINT;
    ...
    <span class="kw">loop </span>{
        ...
        <span class="kw">if </span>a_naf[i] &gt; <span class="number">0 </span>{
            t = <span class="kw-2">&amp;</span>t.to_extended() + <span class="kw-2">&amp;</span>table_A.select(a_naf[i] <span class="kw">as </span>usize);
        } <span class="kw">else if </span>a_naf[i] &lt; <span class="number">0 </span>{
            t = <span class="kw-2">&amp;</span>t.to_extended() - <span class="kw-2">&amp;</span>table_A.select(-a_naf[i] <span class="kw">as </span>usize);
        }

        <span class="kw">if </span>b_naf[i] &gt; <span class="number">0 </span>{
            t = <span class="kw-2">&amp;</span>t.to_extended() + <span class="kw-2">&amp;</span>table_B.select(b_naf[i] <span class="kw">as </span>usize);
        } <span class="kw">else if </span>b_naf[i] &lt; <span class="number">0 </span>{
            t = <span class="kw-2">&amp;</span>t.to_extended() - <span class="kw-2">&amp;</span>table_B.select(-b_naf[i] <span class="kw">as </span>usize);
        }
