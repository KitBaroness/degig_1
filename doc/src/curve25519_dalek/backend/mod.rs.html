...
</span><span class="doccomment">//! Pluggable implementations for different architectures.
//!
...
//! feature; it uses the [`serial`] backend for non-vectorized operations.
    ...
    feature = <span class="string">"fiat_u64_backend"</span>,
...
<span class="kw">pub mod </span>serial;
...
<span class="attr">#[cfg(any(
    ...
    all(feature = <span class="string">"nightly"</span>, rustdoc)
))]
#[cfg_attr(
