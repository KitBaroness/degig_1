...
<span class="kw">where
    </span>T: subtle::ConstantTimeEq + Identity,
{
    <span class="kw">fn </span>is_identity(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.ct_eq(<span class="kw-2">&amp;</span>T::identity()).unwrap_u8() == <span class="number">1u8
    </span>}
}
...
<span class="doccomment">/// A precomputed table of basepoints, for optimising scalar multiplications.
    ...
    </span><span class="kw">fn </span>basepoint_mul(<span class="kw-2">&amp;</span><span class="self">self</span>, scalar: <span class="kw-2">&amp;</span>Scalar) -&gt; <span class="self">Self</span>::Point;
}
