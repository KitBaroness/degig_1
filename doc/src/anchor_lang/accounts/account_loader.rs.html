...
</pre></div><pre class="rust"><code><span class="doccomment">//! Type facilitating on demand zero copy deserialization.
...
<span class="kw">use </span>arrayref::array_ref;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: ZeroCopy + Owner + fmt::Debug&gt; fmt::Debug <span class="kw">for </span>AccountLoader&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: ZeroCopy + Owner&gt; AccountLoader&lt;<span class="lifetime">'info</span>, T&gt; {
    ...
    <span class="doccomment">/// Constructs a new `Loader` from a previously initialized account.
        ...
        <span class="kw">let </span>data: <span class="kw-2">&amp;</span>[u8] = <span class="kw-2">&amp;</span>acc_info.try_borrow_data()<span class="question-mark">?</span>;
        <span class="kw">if </span>data.len() &lt; T::discriminator().len() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ErrorCode::AccountDiscriminatorNotFound.into());
        }
        <span class="comment">// Discriminator must match.
        </span><span class="kw">let </span>disc_bytes = <span class="macro">array_ref!</span>[data, <span class="number">0</span>, <span class="number">8</span>];
        <span class="kw">if </span>disc_bytes != <span class="kw-2">&amp;</span>T::discriminator() {
    ...
    <span class="doccomment">/// Returns a Ref to the account data structure for reading.
        ...
        <span class="kw">let </span>disc_bytes = <span class="macro">array_ref!</span>[data, <span class="number">0</span>, <span class="number">8</span>];
        <span class="kw">if </span>disc_bytes != <span class="kw-2">&amp;</span>T::discriminator() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ErrorCode::AccountDiscriminatorMismatch.into());
        }

        <span class="prelude-val">Ok</span>(Ref::map(data, |data| {
            bytemuck::from_bytes(<span class="kw-2">&amp;</span>data[<span class="number">8</span>..mem::size_of::&lt;T&gt;() + <span class="number">8</span>])
        }))
    }
    ...
    <span class="doccomment">/// Returns a `RefMut` to the account data structure for reading or writing.
        ...
        <span class="prelude-val">Ok</span>(RefMut::map(data, |data| {
            bytemuck::from_bytes_mut(<span class="kw-2">&amp;mut </span>data.deref_mut()[<span class="number">8</span>..mem::size_of::&lt;T&gt;() + <span class="number">8</span>])
        }))
    }
    ...
    /// Should only be called once, when the account is being initialized.
        ...
        </span><span class="kw">let </span><span class="kw-2">mut </span>disc_bytes = [<span class="number">0u8</span>; <span class="number">8</span>];
        disc_bytes.copy_from_slice(<span class="kw-2">&amp;</span>data[..<span class="number">8</span>]);
        <span class="kw">let </span>discriminator = u64::from_le_bytes(disc_bytes);
        <span class="kw">if </span>discriminator != <span class="number">0 </span>{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: ZeroCopy + Owner&gt; AccountsExit&lt;<span class="lifetime">'info</span>&gt; <span class="kw">for </span>AccountLoader&lt;<span class="lifetime">'info</span>, T&gt; {
    <span class="comment">// The account *cannot* be loaded when this is called.
        ...
        <span class="comment">// Only persist if the owner is the current program and the account is not closed.
            ...
            writer.write_all(<span class="kw-2">&amp;</span>T::discriminator()).unwrap();
        }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: ZeroCopy + Owner&gt; ToAccountMetas <span class="kw">for </span>AccountLoader&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: ZeroCopy + Owner&gt; Key <span class="kw">for </span>AccountLoader&lt;<span class="lifetime">'info</span>, T&gt; {
