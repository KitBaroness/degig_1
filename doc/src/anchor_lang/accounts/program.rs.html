...
</pre></div><pre class="rust"><code><span class="doccomment">//! Type validating that the account is the given Program

</span><span class="kw">use </span><span class="kw">crate</span>::error::{Error, ErrorCode};
<span class="kw">use crate</span>::{
    AccountDeserialize, Accounts, AccountsExit, Id, Key, <span class="prelude-ty">Result</span>, ToAccountInfos, ToAccountMetas,
};
<span class="kw">use </span>solana_program::account_info::AccountInfo;
<span class="kw">use </span>solana_program::bpf_loader_upgradeable::{<span class="self">self</span>, UpgradeableLoaderState};
...
<span class="doccomment">/// Type validating that the account is the given Program
///
...
</span><span class="kw">pub struct </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
    info: <span class="kw-2">&amp;</span><span class="lifetime">'info </span>AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
    _phantom: PhantomData&lt;T&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: fmt::Debug&gt; fmt::Debug <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Program"</span>).field(<span class="string">"info"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.info).finish()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Program&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(info: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>AccountInfo&lt;<span class="lifetime">'a</span>&gt;) -&gt; Program&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    <span class="kw">pub fn </span>programdata_address(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;Pubkey&gt;&gt; {
        <span class="kw">if </span><span class="kw-2">*</span><span class="self">self</span>.info.owner == bpf_loader_upgradeable::ID {
            ...
            <span class="kw">let </span>upgradable_loader_state =
                UpgradeableLoaderState::try_deserialize_unchecked(<span class="kw-2">&amp;mut </span>data)<span class="question-mark">?</span>;

            <span class="kw">match </span>upgradable_loader_state {
                UpgradeableLoaderState::Uninitialized
                | UpgradeableLoaderState::Buffer {
                    authority_address: <span class="kw">_</span>,
                }
                | UpgradeableLoaderState::ProgramData {
                    slot: <span class="kw">_</span>,
                    upgrade_authority_address: <span class="kw">_</span>,
                } =&gt; {
                    <span class="comment">// Unreachable because check in try_from
                ...
                UpgradeableLoaderState::Program {
                    programdata_address,
                } =&gt; <span class="prelude-val">Ok</span>(<span class="prelude-val">Some</span>(programdata_address)),
            }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: Id&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>AccountInfo&lt;<span class="lifetime">'a</span>&gt;&gt; <span class="kw">for </span>Program&lt;<span class="lifetime">'a</span>, T&gt; {
    ...
    <span class="doccomment">/// Deserializes the given `info` into a `Program`.
        ...
        <span class="kw">if </span>info.key != <span class="kw-2">&amp;</span>T::id() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(Error::from(ErrorCode::InvalidProgramId).with_pubkeys((<span class="kw-2">*</span>info.key, T::id())));
        }
        ...
        <span class="prelude-val">Ok</span>(Program::new(info))
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, B, T: Id&gt; Accounts&lt;<span class="lifetime">'info</span>, B&gt; <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T&gt; ToAccountMetas <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T&gt; ToAccountInfos&lt;<span class="lifetime">'info</span>&gt; <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T&gt; AsRef&lt;AccountInfo&lt;<span class="lifetime">'info</span>&gt;&gt; <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T&gt; Deref <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: AccountDeserialize&gt; AccountsExit&lt;<span class="lifetime">'info</span>&gt; <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: AccountDeserialize&gt; Key <span class="kw">for </span>Program&lt;<span class="lifetime">'info</span>, T&gt; {
