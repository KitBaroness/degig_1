...
</pre></div><pre class="rust"><code><span class="doccomment">//! Type validating that the account signed the transaction
...
<span class="doccomment">/// Type validating that the account signed the transaction. No other ownership
...
</span><span class="kw">pub struct </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
    info: <span class="kw-2">&amp;</span><span class="lifetime">'info </span>AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; Signer&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">fn </span>new(info: <span class="kw-2">&amp;</span><span class="lifetime">'info </span>AccountInfo&lt;<span class="lifetime">'info</span>&gt;) -&gt; Signer&lt;<span class="lifetime">'info</span>&gt; {
        <span class="self">Self </span>{ info }
    }

    <span class="doccomment">/// Deserializes the given `info` into a `Signer`.
    </span><span class="attr">#[inline(never)]
    </span><span class="kw">pub fn </span>try_from(info: <span class="kw-2">&amp;</span><span class="lifetime">'info </span>AccountInfo&lt;<span class="lifetime">'info</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;Signer&lt;<span class="lifetime">'info</span>&gt;&gt; {
        <span class="kw">if </span>!info.is_signer {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ErrorCode::AccountNotSigner.into());
        }
        <span class="prelude-val">Ok</span>(Signer::new(info))
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, B&gt; Accounts&lt;<span class="lifetime">'info</span>, B&gt; <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AccountsExit&lt;<span class="lifetime">'info</span>&gt; <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; ToAccountMetas <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; ToAccountInfos&lt;<span class="lifetime">'info</span>&gt; <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AsRef&lt;AccountInfo&lt;<span class="lifetime">'info</span>&gt;&gt; <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; Deref <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; Key <span class="kw">for </span>Signer&lt;<span class="lifetime">'info</span>&gt; {
