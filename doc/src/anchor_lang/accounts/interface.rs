...
</pre></div><pre class="rust"><code><span class="doccomment">//! Type validating that the account is one of a set of given Programs
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T&gt; ToAccountMetas <span class="kw">for </span>Interface&lt;<span class="lifetime">'info</span>, T&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>, T: AccountDeserialize&gt; Key <span class="kw">for </span>Interface&lt;<span class="lifetime">'info</span>, T&gt; {
