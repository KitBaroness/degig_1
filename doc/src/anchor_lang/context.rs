...
</pre></div><pre class="rust"><code><span class="doccomment">//! Data structures that are used to provide non-argument inputs to program endpoints
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'b</span>, <span class="lifetime">'c</span>, <span class="lifetime">'info</span>, T&gt; fmt::Debug <span class="kw">for </span>Context&lt;<span class="lifetime">'a</span>, <span class="lifetime">'b</span>, <span class="lifetime">'c</span>, <span class="lifetime">'info</span>, T&gt;
<span class="kw">where
