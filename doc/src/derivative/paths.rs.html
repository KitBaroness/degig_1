...
</pre></div><pre class="rust"><code><span class="doccomment">//! Contains some standard paths.

/// Return the path of the `discriminant` function, that is `::std::mem::discriminant`.
</span><span class="kw">pub fn </span>discriminant_path() -&gt; syn::Path {
    <span class="kw">if </span><span class="macro">cfg!</span>(feature = <span class="string">"use_core"</span>) {
        <span class="macro">parse_quote!</span>(::core::mem::discriminant)
    } <span class="kw">else </span>{
        <span class="macro">parse_quote!</span>(::std::mem::discriminant)
    }
