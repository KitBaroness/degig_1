<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/num-rational-0.2.4/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="num_rational" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../num_rational/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/num-rational/0.2"</span>)]
#![no_std]

#[cfg(feature = <span class="string">"bigint"</span>)]
</span><span class="kw">extern crate </span>num_bigint <span class="kw">as </span>bigint;
...
</span><span class="kw">use </span>bigint::{BigInt, BigUint, Sign};

<span class="kw">use </span>integer::Integer;
<span class="kw">use </span>traits::float::FloatCore;
...
<span class="macro">macro_rules!</span> maybe_const {
    ($( $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub fn </span><span class="macro-nonterminal">$name</span>:ident <span class="macro-nonterminal">$args</span>:tt -&gt; <span class="macro-nonterminal">$ret</span>:ty <span class="macro-nonterminal">$body</span>:block )<span class="kw-2">*</span>) =&gt; {$(
        <span class="attr">#[cfg(has_const_fn)]
        </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)* <span class="kw">pub const fn </span><span class="macro-nonterminal">$name $args </span>-&gt; <span class="macro-nonterminal">$ret $body

        </span><span class="attr">#[cfg(not(has_const_fn))]
        </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)* <span class="kw">pub fn </span><span class="macro-nonterminal">$name $args </span>-&gt; <span class="macro-nonterminal">$ret $body
...
<span class="doccomment">/// These method are `const` for Rust 1.31 and later.
    ...
    <span class="macro">maybe_const!</span> {
        <span class="doccomment">/// Creates a `Ratio` without checking for `denom == 0` or reducing.
        </span><span class="attr">#[inline]
        </span><span class="kw">pub fn </span>new_raw(numer: T, denom: T) -&gt; Ratio&lt;T&gt; {
            Ratio {
                numer: numer,
                denom: denom,
            }
        ...
        </span><span class="kw">pub fn </span>numer(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>T {
            <span class="kw-2">&amp;</span><span class="self">self</span>.numer
        }

        <span class="doccomment">/// Gets an immutable reference to the denominator.
        </span><span class="attr">#[inline]
        </span><span class="kw">pub fn </span>denom(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>T {
...
<span class="kw">impl</span>&lt;T: Clone + Integer&gt; Ratio&lt;T&gt; {
    <span class="doccomment">/// Creates a new `Ratio`. Fails if `denom` is zero.
    </span><span class="attr">#[inline]
    ...
    /// Fails if the `Ratio` is zero.
        ...
        <span class="kw">match </span><span class="self">self</span>.numer.cmp(<span class="kw-2">&amp;</span>T::zero()) {
            cmp::Ordering::Equal =&gt; <span class="macro">panic!</span>(<span class="string">"numerator == 0"</span>),
            cmp::Ordering::Greater =&gt; Ratio::new_raw(<span class="self">self</span>.denom.clone(), <span class="self">self</span>.numer.clone()),
            cmp::Ordering::Less =&gt; Ratio::new_raw(
                T::zero() - <span class="self">self</span>.denom.clone(),
                T::zero() - <span class="self">self</span>.numer.clone(),
            ),
        }
    }
    ...
    <span class="doccomment">/// Rounds to the nearest integer. Rounds half-way cases away from zero.
        ...
        // a &gt;= (b/2)+1. This avoids overflow issues.
            ...
            <span class="kw-2">*</span>fractional.numer() &gt;= fractional.denom().clone() / two.clone()
        } <span class="kw">else </span>{
            <span class="kw-2">*</span>fractional.numer() &gt;= (fractional.denom().clone() / two.clone()) + one.clone()
        };
...
<span class="kw">impl</span>&lt;T: Clone + Integer + Pow&lt;u32, Output = T&gt;&gt; Ratio&lt;T&gt; {
...
<span class="macro">macro_rules!</span> pow_impl {
    (<span class="macro-nonterminal">$exp</span>:ty) =&gt; {
        <span class="macro">pow_impl!</span>(<span class="macro-nonterminal">$exp</span>, <span class="macro-nonterminal">$exp</span>);
    };
    (<span class="macro-nonterminal">$exp</span>:ty, <span class="macro-nonterminal">$unsigned</span>:ty) =&gt; {
        <span class="kw">impl</span>&lt;T: Clone + Integer + Pow&lt;<span class="macro-nonterminal">$unsigned</span>, Output = T&gt;&gt; Pow&lt;<span class="macro-nonterminal">$exp</span>&gt; <span class="kw">for </span>Ratio&lt;T&gt; {
            <span class="kw">type </span>Output = Ratio&lt;T&gt;;
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>pow(<span class="self">self</span>, expon: <span class="macro-nonterminal">$exp</span>) -&gt; Ratio&lt;T&gt; {
                <span class="kw">match </span>expon.cmp(<span class="kw-2">&amp;</span><span class="number">0</span>) {
                    cmp::Ordering::Equal =&gt; One::one(),
                    cmp::Ordering::Less =&gt; {
                        <span class="kw">let </span>expon = expon.wrapping_abs() <span class="kw">as </span><span class="macro-nonterminal">$unsigned</span>;
                        Ratio::new_raw(Pow::pow(<span class="self">self</span>.denom, expon), Pow::pow(<span class="self">self</span>.numer, expon))
                    }
                    cmp::Ordering::Greater =&gt; Ratio::new_raw(
                        Pow::pow(<span class="self">self</span>.numer, expon <span class="kw">as </span><span class="macro-nonterminal">$unsigned</span>),
                        Pow::pow(<span class="self">self</span>.denom, expon <span class="kw">as </span><span class="macro-nonterminal">$unsigned</span>),
                    ),
                }
            }
        }
        <span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: Clone + Integer + Pow&lt;<span class="macro-nonterminal">$unsigned</span>, Output = T&gt;&gt; Pow&lt;<span class="macro-nonterminal">$exp</span>&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>Ratio&lt;T&gt; {
            <span class="kw">type </span>Output = Ratio&lt;T&gt;;
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>pow(<span class="self">self</span>, expon: <span class="macro-nonterminal">$exp</span>) -&gt; Ratio&lt;T&gt; {
                Pow::pow(<span class="self">self</span>.clone(), expon)
            }
        }
        <span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: Clone + Integer + Pow&lt;<span class="macro-nonterminal">$unsigned</span>, Output = T&gt;&gt; Pow&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="macro-nonterminal">$exp</span>&gt; <span class="kw">for </span>Ratio&lt;T&gt; {
            <span class="kw">type </span>Output = Ratio&lt;T&gt;;
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>pow(<span class="self">self</span>, expon: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="macro-nonterminal">$exp</span>) -&gt; Ratio&lt;T&gt; {
                Pow::pow(<span class="self">self</span>, <span class="kw-2">*</span>expon)
            }
        }
        <span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'b</span>, T: Clone + Integer + Pow&lt;<span class="macro-nonterminal">$unsigned</span>, Output = T&gt;&gt; Pow&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="macro-nonterminal">$exp</span>&gt;
            <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'b </span>Ratio&lt;T&gt;
        {
            <span class="kw">type </span>Output = Ratio&lt;T&gt;;
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>pow(<span class="self">self</span>, expon: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="macro-nonterminal">$exp</span>) -&gt; Ratio&lt;T&gt; {
                Pow::pow(<span class="self">self</span>.clone(), <span class="kw-2">*</span>expon)
            }
        }
    };
}

<span class="comment">// this is solely to make `pow_impl!` work
</span><span class="kw">trait </span>WrappingAbs: Sized {
    <span class="kw">fn </span>wrapping_abs(<span class="self">self</span>) -&gt; <span class="self">Self </span>{
        <span class="self">self
    </span>}
}
<span class="kw">impl </span>WrappingAbs <span class="kw">for </span>u8 {}
<span class="kw">impl </span>WrappingAbs <span class="kw">for </span>u16 {}
<span class="kw">impl </span>WrappingAbs <span class="kw">for </span>u32 {}
<span class="kw">impl </span>WrappingAbs <span class="kw">for </span>u64 {}
<span class="kw">impl </span>WrappingAbs <span class="kw">for </span>usize {}

<span class="macro">pow_impl!</span>(i8, u8);
<span class="macro">pow_impl!</span>(i16, u16);
<span class="macro">pow_impl!</span>(i32, u32);
<span class="macro">pow_impl!</span>(i64, u64);
...
<span class="comment">// TODO: pow_impl!(BigUint) and pow_impl!(BigInt, BigUint)

</span><span class="attr">#[cfg(feature = <span class="string">"bigint"</span>)]
    ...
    <span class="doccomment">/// Converts a float into a rational number.
        ...
        <span class="kw">if </span>exponent &lt; <span class="number">0 </span>{
            ...
            numer = numer &lt;&lt; (exponent <span class="kw">as </span>usize);
...
<span class="comment">// Like `std::try!` for Option&lt;T&gt;, unwrap the value or early-return None.
// Since Rust 1.22 this can be replaced by the `?` operator.
</span><span class="macro">macro_rules!</span> otry {
    ...
    </span>T: Clone + Integer + CheckedMul,
{
    <span class="attr">#[inline]
        ...
        <span class="prelude-val">Some</span>(Ratio::new(
            <span class="macro">otry!</span>((<span class="self">self</span>.numer.clone() / gcd_ad.clone())
                .checked_mul(<span class="kw-2">&amp;</span>(rhs.numer.clone() / gcd_bc.clone()))),
            <span class="macro">otry!</span>((<span class="self">self</span>.denom.clone() / gcd_bc).checked_mul(<span class="kw-2">&amp;</span>(rhs.denom.clone() / gcd_ad))),
        ))
    }
}
    ...
    </span>T: Clone + Integer + CheckedMul,
{
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>(numer, denom) = <span class="kw">if </span><span class="self">self</span>.denom == rhs.denom {
            ...
            <span class="kw">let </span>gcd_ac = <span class="self">self</span>.numer.gcd(<span class="kw-2">&amp;</span>rhs.numer);
            <span class="kw">let </span>gcd_bd = <span class="self">self</span>.denom.gcd(<span class="kw-2">&amp;</span>rhs.denom);
            <span class="kw">let </span>denom = <span class="macro">otry!</span>((<span class="self">self</span>.denom.clone() / gcd_bd.clone())
                .checked_mul(<span class="kw-2">&amp;</span>(rhs.numer.clone() / gcd_ac.clone())));
            (
                <span class="macro">otry!</span>((<span class="self">self</span>.numer.clone() / gcd_ac).checked_mul(<span class="kw-2">&amp;</span>(rhs.denom.clone() / gcd_bd))),
                denom,
            )
        };
        <span class="comment">// Manual `reduce()`, avoiding sharp edges
            ...
            <span class="kw">let </span>raw = <span class="kw">if </span>denom &lt; T::zero() {
                ...
                Ratio::new_raw(<span class="macro">otry!</span>(numer.checked_mul(<span class="kw-2">&amp;</span>n1)), <span class="macro">otry!</span>(denom.checked_mul(<span class="kw-2">&amp;</span>n1)))
            } <span class="kw">else </span>{
    ...
    (<span class="kw">impl </span><span class="macro-nonterminal">$imp</span>:ident, <span class="macro-nonterminal">$method</span>:ident) =&gt; {
        <span class="kw">impl</span>&lt;T: Clone + Integer + CheckedMul + <span class="macro-nonterminal">$imp</span>&gt; <span class="macro-nonterminal">$imp </span><span class="kw">for </span>Ratio&lt;T&gt; {
            <span class="attr">#[inline]
                ...
                <span class="kw">let </span>lcm = <span class="macro">otry!</span>((<span class="self">self</span>.denom.clone() / gcd.clone()).checked_mul(<span class="kw-2">&amp;</span>rhs.denom));
                <span class="kw">let </span>lhs_numer = <span class="macro">otry!</span>((lcm.clone() / <span class="self">self</span>.denom.clone()).checked_mul(<span class="kw-2">&amp;</span><span class="self">self</span>.numer));
                <span class="kw">let </span>rhs_numer = <span class="macro">otry!</span>((lcm.clone() / rhs.denom.clone()).checked_mul(<span class="kw-2">&amp;</span>rhs.numer));
                <span class="prelude-val">Some</span>(Ratio::new(<span class="macro">otry!</span>(lhs_numer.<span class="macro-nonterminal">$method</span>(<span class="kw-2">&amp;</span>rhs_numer)), lcm))
            }
        }
    };
}
...
</span><span class="kw">impl</span>&lt;T&gt; fmt::Display <span class="kw">for </span>Ratio&lt;T&gt;
<span class="kw">where
    </span>T: fmt::Display + Eq + One,
{
    <span class="doccomment">/// Renders as `numer/denom`. If denom=1, renders as numer.
        ...
        <span class="kw">if </span><span class="self">self</span>.denom.is_one() {
            <span class="macro">write!</span>(f, <span class="string">"{}"</span>, <span class="self">self</span>.numer)
        } <span class="kw">else </span>{
    ...
    </span>T: serde::Deserialize&lt;<span class="lifetime">'de</span>&gt; + Clone + Integer + PartialOrd,
{
        ...
        </span>D: serde::Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        ...
        <span class="kw">let </span>(numer, denom): (T, T) = <span class="macro">try!</span>(serde::Deserialize::deserialize(deserializer));
        <span class="kw">if </span>denom.is_zero() {
...
<span class="attr">#[cfg(has_i128)]
</span><span class="macro">from_primitive_integer!</span>(i128, approximate_float);
...
<span class="attr">#[cfg(has_i128)]
</span><span class="macro">from_primitive_integer!</span>(u128, approximate_float_unsigned);
    ...
    F: FloatCore + NumCast,
{
    ...
    <span class="kw">let </span>r = approximate_float_unsigned(abs_val, max_error, max_iterations);

    <span class="comment">// Make negative again if needed
    </span><span class="kw">if </span>negative {
        r.map(|r| r.neg())
    } <span class="kw">else </span>{
        r
    }
    ...
    F: FloatCore + NumCast,
{
    ...
    <span class="kw">let </span>t_max_f = <span class="kw">match </span>&lt;F <span class="kw">as </span>NumCast&gt;::from(t_max.clone()) {
        <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">None</span>,
        <span class="prelude-val">Some</span>(t_max_f) =&gt; t_max_f,
    };
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>core::str::FromStr;
    <span class="kw">use </span>integer::Integer;
    <span class="kw">use </span>traits::{FromPrimitive, One, Pow, Signed, Zero};
    ...
    <span class="attr">#[cfg(not(feature = <span class="string">"bigint"</span>))]
    ...
    #[cfg(feature = <span class="string">"std"</span>)]
        ...
        <span class="macro">assert_eq!</span>(<span class="macro">format!</span>(<span class="string">"{}"</span>, _2), <span class="string">"2"</span>.to_string());
        <span class="macro">assert_eq!</span>(<span class="macro">format!</span>(<span class="string">"{}"</span>, _1_2), <span class="string">"1/2"</span>.to_string());
        <span class="macro">assert_eq!</span>(<span class="macro">format!</span>(<span class="string">"{}"</span>, _0), <span class="string">"0"</span>.to_string());
        <span class="macro">assert_eq!</span>(<span class="macro">format!</span>(<span class="string">"{}"</span>, Ratio::from_integer(-<span class="number">2</span>)), <span class="string">"-2"</span>.to_string());
    }
    ...
    <span class="kw">mod </span>arith {
        ...
        <span class="kw">use </span>integer::Integer;
        <span class="kw">use </span>traits::{Bounded, CheckedAdd, CheckedDiv, CheckedMul, CheckedSub, NumAssign};
        ...
        <span class="attr">#[test]
            ...
            <span class="attr">#[cfg(has_u128)]
            </span>test_add_typed_overflow::&lt;u128&gt;();
            ...
            <span class="attr">#[cfg(has_i128)]
            </span>test_add_typed_overflow::&lt;i128&gt;();
        }
        ...
        <span class="attr">#[test]
            ...
            <span class="attr">#[cfg(has_u128)]
            </span>test_sub_typed_overflow::&lt;u128&gt;();
            ...
            <span class="attr">#[cfg(has_i128)]
            </span>test_sub_typed_overflow::&lt;i128&gt;();
        }
        ...
        <span class="attr">#[test]
                ...
                </span>T: Integer + Bounded + Clone + Debug + NumAssign + CheckedMul,
            {
                ...
                <span class="macro">assert_eq!</span>(expected, {
                    <span class="kw">let </span><span class="kw-2">mut </span>tmp = _1_big.clone();
                ...
                </span><span class="kw">let </span>big = T::max_value() / two.clone() / _3.clone() * _3.clone() + T::one();
                <span class="macro">assert_eq!</span>(<span class="prelude-val">None</span>, big.clone().checked_mul(<span class="kw-2">&amp;</span>_3.clone()));
                <span class="kw">let </span>big_3 = Ratio::new(big.clone(), _3.clone());
                <span class="kw">let </span>expected = Ratio::new(big.clone(), T::one());
                <span class="macro">assert_eq!</span>(expected, big_3.clone() * _3.clone());
                <span class="macro">assert_eq!</span>(expected, {
                    <span class="kw">let </span><span class="kw-2">mut </span>tmp = big_3.clone();
                    tmp <span class="kw-2">*</span>= _3.clone();
                    tmp
                });
            }
            ...
            <span class="attr">#[cfg(has_u128)]
            </span>test_mul_typed_overflow::&lt;u128&gt;();
            ...
            <span class="attr">#[cfg(has_i128)]
            </span>test_mul_typed_overflow::&lt;i128&gt;();
        }
        ...
        <span class="attr">#[test]
                ...
                </span>T: Integer + Bounded + Clone + Debug + NumAssign + CheckedMul,
            {
                ...
                <span class="kw">let </span>expected = Ratio::new(T::one(), big.clone() / two.clone() * _3.clone());
                ...
                <span class="kw">let </span>expected = Ratio::new(T::one(), big.clone());
                <span class="macro">assert_eq!</span>(expected, _3_big.clone() / _3.clone());
                <span class="macro">assert_eq!</span>(expected, {
                    <span class="kw">let </span><span class="kw-2">mut </span>tmp = _3_big.clone();
                    tmp /= _3.clone();
                    tmp
                });
            }
            ...
            <span class="attr">#[cfg(has_u128)]
            </span>test_div_typed_overflow::&lt;u128&gt;();
            ...
            <span class="attr">#[cfg(has_i128)]
            </span>test_div_typed_overflow::&lt;i128&gt;();
        }
        ...
        <span class="attr">#[test]
                ...
                </span>T: Integer + Bounded + Clone + Debug + NumAssign,
            {
                ...
                <span class="kw">let </span>_1_max: Ratio&lt;T&gt; = Ratio::new(T::one(), max_div2.clone());
                ...
                {
                    <span class="kw">let </span><span class="kw-2">mut </span>tmp: Ratio&lt;T&gt; = _1_two.clone();
                    tmp %= _1_max.clone();
                    <span class="macro">assert!</span>(T::is_zero(<span class="kw-2">&amp;</span>tmp.numer));
                }
            }
            ...
            <span class="attr">#[cfg(has_u128)]
            </span>test_rem_typed_overflow::&lt;u128&gt;();
            ...
            <span class="attr">#[cfg(has_i128)]
            </span>test_rem_typed_overflow::&lt;i128&gt;();
        }
    ...
    <span class="attr">#[test]
    #[should_panic(expected = <span class="string">"== 0"</span>)]
    ...
    #[test]
        ...
        </span>test(<span class="number">3.14159265359f32</span>, (<span class="string">"13176795"</span>, <span class="string">"4194304"</span>));
        ...
        </span>test(<span class="number">3.14159265359f64</span>, (<span class="string">"3537118876014453"</span>, <span class="string">"1125899906842624"</span>));
    ...
    #[cfg(feature = <span class="string">"std"</span>)]
        ...
        <span class="macro">assert!</span>(::hash(<span class="kw-2">&amp;</span>_0) != ::hash(<span class="kw-2">&amp;</span>_1));
        <span class="macro">assert!</span>(::hash(<span class="kw-2">&amp;</span>_0) != ::hash(<span class="kw-2">&amp;</span>_3_2));
        ...
        <span class="macro">assert_eq!</span>(a, b);
        <span class="macro">assert_eq!</span>(::hash(<span class="kw-2">&amp;</span>a), ::hash(<span class="kw-2">&amp;</span>b));
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(<span class="kw-2">&amp;</span>r + <span class="kw-2">&amp;</span>zero, r);
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(<span class="kw-2">&amp;</span>r * <span class="kw-2">&amp;</span>one, r);
