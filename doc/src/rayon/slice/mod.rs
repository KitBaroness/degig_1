...
</pre></div><pre class="rust"><code><span class="doccomment">//! Parallel iterator types for [slices][std::slice]
//!
...
</span><span class="kw">mod </span>chunk_by;
...
<span class="kw">pub use </span><span class="self">self</span>::chunk_by::{ChunkBy, ChunkByMut};
...
<span class="doccomment">/// Parallel extensions for slices.
    ...
    /// ```
    </span><span class="kw">fn </span>par_split_inclusive&lt;P&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, separator: P) -&gt; SplitInclusive&lt;<span class="lifetime">'_</span>, T, P&gt;
    <span class="kw">where
        </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool + Sync + Send,
    {
        SplitInclusive {
    ...
    <span class="doccomment">/// Returns a parallel iterator over the slice producing non-overlapping runs
    ...
    /// ```
    </span><span class="kw">fn </span>par_chunk_by&lt;F&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, pred: F) -&gt; ChunkBy&lt;<span class="lifetime">'_</span>, T, F&gt;
    <span class="kw">where
        </span>F: Fn(<span class="kw-2">&amp;</span>T, <span class="kw-2">&amp;</span>T) -&gt; bool + Send + Sync,
    {
        ChunkBy::new(<span class="self">self</span>.as_parallel_slice(), pred)
    }
}
...
<span class="doccomment">/// Parallel extensions for mutable slices.
    ...
    <span class="doccomment">/// Returns a parallel iterator over mutable subslices separated by elements
    ...
    /// ```
    </span><span class="kw">fn </span>par_split_inclusive_mut&lt;P&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, separator: P) -&gt; SplitInclusiveMut&lt;<span class="lifetime">'_</span>, T, P&gt;
    <span class="kw">where
        </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool + Sync + Send,
    {
        SplitInclusiveMut {
    ...
    <span class="doccomment">/// Returns a parallel iterator over the slice producing non-overlapping mutable
    ...
    /// ```
    </span><span class="kw">fn </span>par_chunk_by_mut&lt;F&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, pred: F) -&gt; ChunkByMut&lt;<span class="lifetime">'_</span>, T, F&gt;
    <span class="kw">where
        </span>F: Fn(<span class="kw-2">&amp;</span>T, <span class="kw-2">&amp;</span>T) -&gt; bool + Send + Sync,
    {
        ChunkByMut::new(<span class="self">self</span>.as_parallel_slice_mut(), pred)
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T: <span class="lifetime">'data </span>+ Sync&gt; Producer <span class="kw">for </span>WindowsProducer&lt;<span class="lifetime">'data</span>, T&gt; {
    ...
    <span class="kw">fn </span>split_at(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>) {
        <span class="kw">let </span>left_index = Ord::min(<span class="self">self</span>.slice.len(), index + (<span class="self">self</span>.window_size - <span class="number">1</span>));
...
</span><span class="kw">pub struct </span>SplitInclusive&lt;<span class="lifetime">'data</span>, T, P&gt; {
    slice: <span class="kw-2">&amp;</span><span class="lifetime">'data </span>[T],
    separator: P,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T, P: Clone&gt; Clone <span class="kw">for </span>SplitInclusive&lt;<span class="lifetime">'data</span>, T, P&gt; {
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        SplitInclusive {
            separator: <span class="self">self</span>.separator.clone(),
            ..<span class="kw-2">*</span><span class="self">self
...
<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T: Debug, P&gt; Debug <span class="kw">for </span>SplitInclusive&lt;<span class="lifetime">'data</span>, T, P&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"SplitInclusive"</span>)
            .field(<span class="string">"slice"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.slice)
            .finish()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T, P&gt; ParallelIterator <span class="kw">for </span>SplitInclusive&lt;<span class="lifetime">'data</span>, T, P&gt;
<span class="kw">where
    </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool + Sync + Send,
    T: Sync,
{
    ...
    {
        <span class="kw">let </span>producer = SplitInclusiveProducer::new_incl(<span class="self">self</span>.slice, <span class="kw-2">&amp;</span><span class="self">self</span>.separator);
        bridge_unindexed(producer, consumer)
    }
}
    ...
    </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool,
{
    ...
    <span class="kw">fn </span>split_once&lt;<span class="kw">const </span>INCL: bool&gt;(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>) {
        <span class="kw">if </span>INCL {
            ...
            </span><span class="self">self</span>.split_at(index + <span class="number">1</span>)
        ...
        <span class="self">Self</span>: Send,
    {
        <span class="kw">if </span>INCL {
            ...
            folder.consume_iter(<span class="self">self</span>.split_inclusive(separator))
        } <span class="kw">else </span>{
...
<span class="doccomment">/// Parallel iterator over mutable slices separated by a predicate,
/// including the matched part as a terminator.
</span><span class="kw">pub struct </span>SplitInclusiveMut&lt;<span class="lifetime">'data</span>, T, P&gt; {
    slice: <span class="kw-2">&amp;</span><span class="lifetime">'data </span><span class="kw-2">mut </span>[T],
    separator: P,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T: Debug, P&gt; Debug <span class="kw">for </span>SplitInclusiveMut&lt;<span class="lifetime">'data</span>, T, P&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"SplitInclusiveMut"</span>)
            .field(<span class="string">"slice"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.slice)
            .finish()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'data</span>, T, P&gt; ParallelIterator <span class="kw">for </span>SplitInclusiveMut&lt;<span class="lifetime">'data</span>, T, P&gt;
<span class="kw">where
    </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool + Sync + Send,
    T: Send,
{
    ...
    </span>P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool,
{
    ...
    <span class="kw">fn </span>split_once&lt;<span class="kw">const </span>INCL: bool&gt;(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>) {
        <span class="kw">if </span>INCL {
            <span class="comment">// include the separator in the left side
            </span><span class="self">self</span>.split_at_mut(index + <span class="number">1</span>)
        } <span class="kw">else </span>{
        ...
        <span class="self">Self</span>: Send,
    {
        <span class="kw">if </span>INCL {
            <span class="macro">debug_assert!</span>(!skip_last);
            folder.consume_iter(<span class="self">self</span>.split_inclusive_mut(separator))
        } <span class="kw">else </span>{
