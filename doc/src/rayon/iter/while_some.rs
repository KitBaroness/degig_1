...
<span class="kw">impl</span>&lt;I&gt; WhileSome&lt;I&gt;
<span class="kw">where
    </span>I: ParallelIterator,
{
    <span class="doccomment">/// Creates a new `WhileSome` iterator.
...
<span class="kw">where
    </span>I: ParallelIterator&lt;Item = <span class="prelude-ty">Option</span>&lt;T&gt;&gt;,
    T: Send,
{
    ...
    </span>C: Folder&lt;T&gt;,
{
    ...
    <span class="kw">fn </span>consume_iter&lt;I&gt;(<span class="kw-2">mut </span><span class="self">self</span>, iter: I) -&gt; <span class="self">Self
        ...
        </span>I: IntoIterator&lt;Item = <span class="prelude-ty">Option</span>&lt;T&gt;&gt;,
    {
        <span class="kw">fn </span>some&lt;T&gt;(full: <span class="kw-2">&amp;</span>AtomicBool) -&gt; <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span><span class="prelude-ty">Option</span>&lt;T&gt;) -&gt; bool + <span class="lifetime">'_ </span>{
            <span class="kw">move </span>|x| <span class="kw">match </span><span class="kw-2">*</span>x {
                <span class="prelude-val">Some</span>(<span class="kw">_</span>) =&gt; !full.load(Ordering::Relaxed),
                <span class="prelude-val">None </span>=&gt; {
                    full.store(<span class="bool-val">true</span>, Ordering::Relaxed);
        ...
        <span class="self">self</span>.base = <span class="self">self</span>.base.consume_iter(
            iter.into_iter()
                .take_while(some(<span class="self">self</span>.full))
                .map(Option::unwrap),
        );
        <span class="self">self
    </span>}
