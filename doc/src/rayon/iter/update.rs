...
<span class="kw">impl</span>&lt;I: ParallelIterator + Debug, F&gt; Debug <span class="kw">for </span>Update&lt;I, F&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Update"</span>).field(<span class="string">"base"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.base).finish()
    }
}

<span class="kw">impl</span>&lt;I, F&gt; Update&lt;I, F&gt;
<span class="kw">where
    </span>I: ParallelIterator,
{
    <span class="doccomment">/// Creates a new `Update` iterator.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(base: I, update_op: F) -&gt; <span class="self">Self </span>{
...
</span><span class="kw">struct </span>UpdateProducer&lt;<span class="lifetime">'f</span>, P, F&gt; {
    base: P,
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>P::Item) + Send + Sync,
{
    ...
    {
        <span class="kw">let </span>folder1 = UpdateFolder {
            base: folder,
            update_op: <span class="self">self</span>.update_op,
        };
...
</span><span class="kw">struct </span>UpdateConsumer&lt;<span class="lifetime">'f</span>, C, F&gt; {
    base: C,
    update_op: <span class="kw-2">&amp;</span><span class="lifetime">'f </span>F,
}
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>T) + Send + Sync,
{
    ...
    <span class="kw">fn </span>split_at(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>, <span class="self">Self</span>::Reducer) {
        ...
        (
            UpdateConsumer::new(left, <span class="self">self</span>.update_op),
            UpdateConsumer::new(right, <span class="self">self</span>.update_op),
            reducer,
        )
    }
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>T) + Send + Sync,
{
    <span class="kw">fn </span>split_off_left(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        UpdateConsumer::new(<span class="self">self</span>.base.split_off_left(), <span class="self">self</span>.update_op)
    }
...
<span class="kw">struct </span>UpdateFolder&lt;<span class="lifetime">'f</span>, C, F&gt; {
    base: C,
    update_op: <span class="kw-2">&amp;</span><span class="lifetime">'f </span>F,
}

<span class="kw">fn </span>apply&lt;T&gt;(update_op: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;mut </span>T)) -&gt; <span class="kw">impl </span>Fn(T) -&gt; T {
    <span class="kw">move </span>|<span class="kw-2">mut </span>item| {
        update_op(<span class="kw-2">&amp;mut </span>item);
        item
    }
}
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>T),
{
    ...
    {
        <span class="kw">let </span>update_op = <span class="self">self</span>.update_op;
...
<span class="kw">where
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>I::Item),
{
    <span class="kw">type </span>Item = I::Item;

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>v = <span class="self">self</span>.base.next()<span class="question-mark">?</span>;
    ...
    <span class="kw">fn </span>fold&lt;Acc, G&gt;(<span class="self">self</span>, init: Acc, g: G) -&gt; Acc
    <span class="kw">where
        </span>G: FnMut(Acc, <span class="self">Self</span>::Item) -&gt; Acc,
    {
        <span class="self">self</span>.base.map(apply(<span class="self">self</span>.update_op)).fold(init, g)
    }
    ...
    <span class="kw">where
        </span>C: ::std::iter::FromIterator&lt;<span class="self">Self</span>::Item&gt;,
    {
        <span class="self">self</span>.base.map(apply(<span class="self">self</span>.update_op)).collect()
    }
}
    ...
    F: Fn(<span class="kw-2">&amp;mut </span>I::Item),
{
    <span class="kw">fn </span>next_back(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>v = <span class="self">self</span>.base.next_back()<span class="question-mark">?</span>;
        (<span class="self">self</span>.update_op)(<span class="kw-2">&amp;mut </span>v);
        <span class="prelude-val">Some</span>(v)
    }
}
