...
<span class="doccomment">/// `Copied` is an iterator that copies the elements of an underlying iterator.
///
...
#[derive(Debug, Clone)]
</span><span class="kw">pub struct </span>Copied&lt;I: ParallelIterator&gt; {
    base: I,
}
...
{
    <span class="doccomment">/// Creates a new `Copied` iterator.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(base: I) -&gt; <span class="self">Self </span>{
        Copied { base }
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, I&gt; ParallelIterator <span class="kw">for </span>Copied&lt;I&gt;
<span class="kw">where
    </span>I: ParallelIterator&lt;Item = <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt;,
    T: <span class="lifetime">'a </span>+ Copy + Send + Sync,
{
    ...
    {
        <span class="kw">let </span>consumer1 = CopiedConsumer::new(consumer);
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, I&gt; IndexedParallelIterator <span class="kw">for </span>Copied&lt;I&gt;
<span class="kw">where
    ...
    T: <span class="lifetime">'a </span>+ Copy + Send + Sync,
{
        ...
        </span>CB: ProducerCallback&lt;<span class="self">Self</span>::Item&gt;,
    {
        ...
        <span class="kw">where
            ...
            T: <span class="lifetime">'a </span>+ Copy + Send,
        {
            ...
            {
                <span class="kw">let </span>producer = CopiedProducer { base };
...
</span><span class="kw">struct </span>CopiedProducer&lt;P&gt; {
    base: P,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, P&gt; Producer <span class="kw">for </span>CopiedProducer&lt;P&gt;
<span class="kw">where
    </span>P: Producer&lt;Item = <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt;,
    T: <span class="lifetime">'a </span>+ Copy,
{
    <span class="kw">type </span>Item = T;
    <span class="kw">type </span>IntoIter = iter::Copied&lt;P::IntoIter&gt;;

    <span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::IntoIter {
        <span class="self">self</span>.base.into_iter().copied()
    }
    ...
    {
        <span class="self">self</span>.base.fold_with(CopiedFolder { base: folder }).base
    }
}
...
</span><span class="kw">struct </span>CopiedConsumer&lt;C&gt; {
    base: C,
}

<span class="kw">impl</span>&lt;C&gt; CopiedConsumer&lt;C&gt; {
    <span class="kw">fn </span>new(base: C) -&gt; <span class="self">Self </span>{
        CopiedConsumer { base }
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, C&gt; Consumer&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt; <span class="kw">for </span>CopiedConsumer&lt;C&gt;
<span class="kw">where
    </span>C: Consumer&lt;T&gt;,
    T: <span class="lifetime">'a </span>+ Copy,
{
    <span class="kw">type </span>Folder = CopiedFolder&lt;C::Folder&gt;;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, C&gt; UnindexedConsumer&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt; <span class="kw">for </span>CopiedConsumer&lt;C&gt;
<span class="kw">where
    ...
    T: <span class="lifetime">'a </span>+ Copy,
{
    <span class="kw">fn </span>split_off_left(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        CopiedConsumer::new(<span class="self">self</span>.base.split_off_left())
    }
...
<span class="kw">struct </span>CopiedFolder&lt;F&gt; {
    base: F,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, F&gt; Folder&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>T&gt; <span class="kw">for </span>CopiedFolder&lt;F&gt;
<span class="kw">where
    </span>F: Folder&lt;T&gt;,
    T: <span class="lifetime">'a </span>+ Copy,
{
    ...
    <span class="kw">fn </span>consume(<span class="self">self</span>, <span class="kw-2">&amp;</span>item: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>T) -&gt; <span class="self">Self </span>{
        CopiedFolder {
    ...
    {
        <span class="self">self</span>.base = <span class="self">self</span>.base.consume_iter(iter.into_iter().copied());
