...
<span class="kw">impl</span>&lt;I: ParallelIterator + Debug, P&gt; Debug <span class="kw">for </span>Filter&lt;I, P&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Filter"</span>).field(<span class="string">"base"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.base).finish()
    }
}

<span class="kw">impl</span>&lt;I, P&gt; Filter&lt;I, P&gt;
<span class="kw">where
    </span>I: ParallelIterator,
{
    <span class="doccomment">/// Creates a new `Filter` iterator.
...
</span><span class="kw">struct </span>FilterConsumer&lt;<span class="lifetime">'p</span>, C, P&gt; {
    base: C,
    ...
    P: Fn(<span class="kw-2">&amp;</span>T) -&gt; bool + Sync,
{
    <span class="kw">fn </span>split_off_left(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        FilterConsumer::new(<span class="self">self</span>.base.split_off_left(), <span class="self">self</span>.filter_op)
    }
...
<span class="kw">struct </span>FilterFolder&lt;<span class="lifetime">'p</span>, C, P&gt; {
    base: C,
    filter_op: <span class="kw-2">&amp;</span><span class="lifetime">'p </span>P,
}
