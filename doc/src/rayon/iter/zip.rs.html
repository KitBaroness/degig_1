...
<span class="kw">impl</span>&lt;A, B&gt; Zip&lt;A, B&gt;
<span class="kw">where
    </span>A: IndexedParallelIterator,
    B: IndexedParallelIterator,
{
    <span class="doccomment">/// Creates a new `Zip` iterator.
    ...
    B: IndexedParallelIterator,
{
    ...
    <span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        Ord::min(<span class="self">self</span>.a.len(), <span class="self">self</span>.b.len())
    }
