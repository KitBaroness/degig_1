...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::noop::<span class="kw-2">*</span>;
...
<span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>for_each&lt;I, F, T&gt;(pi: I, op: <span class="kw-2">&amp;</span>F)
<span class="kw">where
    </span>I: ParallelIterator&lt;Item = T&gt;,
    F: Fn(T) + Sync,
    T: Send,
{
    <span class="kw">let </span>consumer = ForEachConsumer { op };
    pi.drive_unindexed(consumer)
}

<span class="kw">struct </span>ForEachConsumer&lt;<span class="lifetime">'f</span>, F&gt; {
    ...
    </span>F: Fn(T) + Sync,
{
    ...
    {
        iter.into_iter().for_each(<span class="self">self</span>.op);
        <span class="self">self
    </span>}
