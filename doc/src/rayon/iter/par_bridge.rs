...
</pre></div><pre class="rust"><code><span class="attr">#[cfg(not(feature = <span class="string">"web_spin_lock"</span>))]
</span><span class="kw">use </span>std::sync::Mutex;

<span class="attr">#[cfg(feature = <span class="string">"web_spin_lock"</span>)]
</span><span class="kw">use </span>wasm_sync::Mutex;
...
<span class="kw">impl</span>&lt;Iter: Iterator + Send&gt; UnindexedProducer <span class="kw">for </span><span class="kw-2">&amp;</span>IterParallelProducer&lt;<span class="lifetime">'_</span>, Iter&gt; {
    ...
    <span class="kw">fn </span>split(<span class="self">self</span>) -&gt; (<span class="self">Self</span>, <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>&gt;) {
        ...
        </span><span class="kw">let </span>update = <span class="self">self
            </span>.split_count
            .fetch_update(Ordering::Relaxed, Ordering::Relaxed, |c| c.checked_sub(<span class="number">1</span>));
        (<span class="self">self</span>, update.is_ok().then_some(<span class="self">self</span>))
    }
