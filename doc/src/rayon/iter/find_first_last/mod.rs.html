...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, P: <span class="lifetime">'p </span>+ Fn(<span class="kw-2">&amp;</span>T) -&gt; bool, T&gt; Folder&lt;T&gt; <span class="kw">for </span>FindFolder&lt;<span class="lifetime">'p</span>, T, P&gt; {
    ...
    <span class="kw">fn </span>consume(<span class="kw-2">mut </span><span class="self">self</span>, item: T) -&gt; <span class="self">Self </span>{
        ...
        <span class="kw">if </span>!found_best_in_range &amp;&amp; (<span class="self">self</span>.find_op)(<span class="kw-2">&amp;</span>item) {
            <span class="comment">// Update the best found index if ours is better.
            </span><span class="kw">let </span>update =
                <span class="self">self</span>.best_found
                    .fetch_update(Ordering::Relaxed, Ordering::Relaxed, |current| {
                        better_position(<span class="self">self</span>.boundary, current, <span class="self">self</span>.match_position)
                            .then_some(<span class="self">self</span>.boundary)
                    });

            <span class="comment">// Save this item if our index was better or equal.
            </span><span class="kw">if </span>update.is_ok() || update == <span class="prelude-val">Err</span>(<span class="self">self</span>.boundary) {
