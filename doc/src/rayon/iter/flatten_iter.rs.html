...
<span class="doccomment">/// `FlattenIter` turns each element to a serial iterator, then flattens these iterators
...
#[derive(Debug, Clone)]
</span><span class="kw">pub struct </span>FlattenIter&lt;I: ParallelIterator&gt; {
    base: I,
}

<span class="kw">impl</span>&lt;I&gt; FlattenIter&lt;I&gt;
<span class="kw">where
    </span>I: ParallelIterator,
    I::Item: IntoIterator,
    &lt;I::Item <span class="kw">as </span>IntoIterator&gt;::Item: Send,
{
    <span class="doccomment">/// Creates a new `FlattenIter` iterator.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(base: I) -&gt; <span class="self">Self </span>{
        FlattenIter { base }
    }
}

<span class="kw">impl</span>&lt;I&gt; ParallelIterator <span class="kw">for </span>FlattenIter&lt;I&gt;
<span class="kw">where
    </span>I: ParallelIterator,
    I::Item: IntoIterator,
    &lt;I::Item <span class="kw">as </span>IntoIterator&gt;::Item: Send,
{
    <span class="kw">type </span>Item = &lt;I::Item <span class="kw">as </span>IntoIterator&gt;::Item;
    ...
    {
        <span class="kw">let </span>consumer = FlattenIterConsumer::new(consumer);
...
</span><span class="kw">struct </span>FlattenIterConsumer&lt;C&gt; {
    base: C,
}

<span class="kw">impl</span>&lt;C&gt; FlattenIterConsumer&lt;C&gt; {
    <span class="kw">fn </span>new(base: C) -&gt; <span class="self">Self </span>{
        FlattenIterConsumer { base }
    }
}

<span class="kw">impl</span>&lt;T, C&gt; Consumer&lt;T&gt; <span class="kw">for </span>FlattenIterConsumer&lt;C&gt;
<span class="kw">where
    </span>C: UnindexedConsumer&lt;T::Item&gt;,
    T: IntoIterator,
{
    <span class="kw">type </span>Folder = FlattenIterFolder&lt;C::Folder&gt;;
...
<span class="kw">impl</span>&lt;T, C&gt; UnindexedConsumer&lt;T&gt; <span class="kw">for </span>FlattenIterConsumer&lt;C&gt;
<span class="kw">where
    </span>C: UnindexedConsumer&lt;T::Item&gt;,
    T: IntoIterator,
{
    <span class="kw">fn </span>split_off_left(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
        FlattenIterConsumer::new(<span class="self">self</span>.base.split_off_left())
    }
...
<span class="kw">struct </span>FlattenIterFolder&lt;C&gt; {
    base: C,
}

<span class="kw">impl</span>&lt;T, C&gt; Folder&lt;T&gt; <span class="kw">for </span>FlattenIterFolder&lt;C&gt;
<span class="kw">where
    </span>C: Folder&lt;T::Item&gt;,
    T: IntoIterator,
{
    <span class="kw">type </span><span class="prelude-ty">Result </span>= C::Result;

    <span class="kw">fn </span>consume(<span class="self">self</span>, item: T) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>base = <span class="self">self</span>.base.consume_iter(item);
    ...
    {
        <span class="kw">let </span>iter = iter.into_iter().flatten();
