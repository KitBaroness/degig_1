...
<span class="kw">where
    ...
    B: ParallelIterator&lt;Item = A::Item&gt;,
{
    <span class="doccomment">/// Creates a new `Chain` iterator.
    ...
    B: ParallelIterator&lt;Item = A::Item&gt;,
{
    ...
    <span class="kw">fn </span>opt_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="self">self</span>.a.opt_len()<span class="question-mark">?</span>.checked_add(<span class="self">self</span>.b.opt_len()<span class="question-mark">?</span>)
    }
}
    ...
    B: IndexedParallelIterator&lt;Item = A::Item&gt;,
{
    ...
    <span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.a.len().checked_add(<span class="self">self</span>.b.len()).expect(<span class="string">"overflow"</span>)
    }
        ...
        </span>CB: ProducerCallback&lt;<span class="self">Self</span>::Item&gt;,
    {
        ...
        <span class="kw">where
            </span>B: IndexedParallelIterator,
            CB: ProducerCallback&lt;B::Item&gt;,
        {
            ...
            <span class="kw">where
                </span>A: Producer&lt;Item = B::Item&gt;,
            {
                <span class="self">self</span>.b.with_producer(CallbackB {
    ...
    B: Producer&lt;Item = A::Item&gt;,
{
    ...
    <span class="kw">fn </span>min_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        Ord::max(<span class="self">self</span>.a.min_len(), <span class="self">self</span>.b.min_len())
    }

    <span class="kw">fn </span>max_len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        Ord::min(<span class="self">self</span>.a.max_len(), <span class="self">self</span>.b.max_len())
    }
