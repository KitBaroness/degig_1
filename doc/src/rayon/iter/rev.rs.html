...
<span class="doccomment">/// `Rev` is an iterator that produces elements in reverse order. This struct
...
#[derive(Debug, Clone)]
</span><span class="kw">pub struct </span>Rev&lt;I: IndexedParallelIterator&gt; {
    base: I,
}

<span class="kw">impl</span>&lt;I&gt; Rev&lt;I&gt;
<span class="kw">where
    </span>I: IndexedParallelIterator,
{
    <span class="doccomment">/// Creates a new `Rev` iterator.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(base: I) -&gt; <span class="self">Self </span>{
        Rev { base }
    }
}

<span class="kw">impl</span>&lt;I&gt; ParallelIterator <span class="kw">for </span>Rev&lt;I&gt;
<span class="kw">where
    </span>I: IndexedParallelIterator,
{
...
<span class="kw">impl</span>&lt;I&gt; IndexedParallelIterator <span class="kw">for </span>Rev&lt;I&gt;
<span class="kw">where
    </span>I: IndexedParallelIterator,
{
        ...
        </span>CB: ProducerCallback&lt;<span class="self">Self</span>::Item&gt;,
    {
        ...
        <span class="kw">return </span><span class="self">self</span>.base.with_producer(Callback { callback, len });
            ...
            </span>CB: ProducerCallback&lt;T&gt;,
        {
            ...
            {
                <span class="kw">let </span>producer = RevProducer {
                    base,
...
<span class="kw">struct </span>RevProducer&lt;P&gt; {
    base: P,
    len: usize,
}

<span class="kw">impl</span>&lt;P&gt; Producer <span class="kw">for </span>RevProducer&lt;P&gt;
<span class="kw">where
    </span>P: Producer,
{
    <span class="kw">type </span>Item = P::Item;
    <span class="kw">type </span>IntoIter = iter::Rev&lt;P::IntoIter&gt;;

    <span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::IntoIter {
        <span class="self">self</span>.base.into_iter().rev()
    }
    ...
    <span class="kw">fn </span>split_at(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>) {
        <span class="kw">let </span>(left, right) = <span class="self">self</span>.base.split_at(<span class="self">self</span>.len - index);
        (
            RevProducer {
                base: right,
                len: index,
