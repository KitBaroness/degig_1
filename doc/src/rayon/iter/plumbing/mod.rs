...
</pre></div><pre class="rust"><code><span class="doccomment">//! Traits and functions used to implement parallel iteration.  These are
...
<span class="kw">impl </span>Splitter {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span>stolen {
            ...
            </span><span class="self">self</span>.splits = Ord::max(<span class="kw">crate</span>::current_num_threads(), <span class="self">self</span>.splits / <span class="number">2</span>);
...
<span class="kw">impl </span>LengthSplitter {
    ...
    /// smaller than the `min`.
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>splitter = LengthSplitter {
            inner: Splitter::new(),
            min: Ord::max(min, <span class="number">1</span>),
        };
        ...
        </span><span class="kw">let </span>min_splits = len / Ord::max(max, <span class="number">1</span>);
