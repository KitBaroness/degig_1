...
<span class="doccomment">/// `Enumerate` is an iterator that returns the current count along with the element.
...
#[derive(Debug, Clone)]
</span><span class="kw">pub struct </span>Enumerate&lt;I: IndexedParallelIterator&gt; {
    base: I,
}
...
{
    <span class="doccomment">/// Creates a new `Enumerate` iterator.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(base: I) -&gt; <span class="self">Self </span>{
        Enumerate { base }
    }
}

<span class="kw">impl</span>&lt;I&gt; ParallelIterator <span class="kw">for </span>Enumerate&lt;I&gt;
<span class="kw">where
    </span>I: IndexedParallelIterator,
{
    <span class="kw">type </span>Item = (usize, I::Item);
...
<span class="kw">impl</span>&lt;I&gt; IndexedParallelIterator <span class="kw">for </span>Enumerate&lt;I&gt;
<span class="kw">where
    </span>I: IndexedParallelIterator,
{
        ...
        </span>CB: ProducerCallback&lt;<span class="self">Self</span>::Item&gt;,
    {
        ...
        <span class="kw">impl</span>&lt;I, CB&gt; ProducerCallback&lt;I&gt; <span class="kw">for </span>Callback&lt;CB&gt;
        <span class="kw">where
            </span>CB: ProducerCallback&lt;(usize, I)&gt;,
        {
            ...
            {
                <span class="kw">let </span>producer = EnumerateProducer { base, offset: <span class="number">0 </span>};
...
</span><span class="kw">struct </span>EnumerateProducer&lt;P&gt; {
    base: P,
    offset: usize,
}

<span class="kw">impl</span>&lt;P&gt; Producer <span class="kw">for </span>EnumerateProducer&lt;P&gt;
<span class="kw">where
    </span>P: Producer,
{
    <span class="kw">type </span>Item = (usize, P::Item);
    <span class="kw">type </span>IntoIter = iter::Zip&lt;Range&lt;usize&gt;, P::IntoIter&gt;;

    <span class="kw">fn </span>into_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::IntoIter {
        <span class="comment">// Enumerate only works for IndexedParallelIterators. Since those
        ...
        </span><span class="kw">let </span>base = <span class="self">self</span>.base.into_iter();
        <span class="kw">let </span>end = <span class="self">self</span>.offset + base.len();
        (<span class="self">self</span>.offset..end).zip(base)
    }
    ...
    <span class="kw">fn </span>split_at(<span class="self">self</span>, index: usize) -&gt; (<span class="self">Self</span>, <span class="self">Self</span>) {
        ...
        (
            ...
            EnumerateProducer {
                base: right,
                offset: <span class="self">self</span>.offset + index,
            },
        )
    }
}
