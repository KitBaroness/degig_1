...
</pre></div><pre class="rust"><code><span class="doccomment">//! Parallel iterator types for [results][std::result]
//!
...
<span class="kw">use </span><span class="kw">crate</span>::option;
...
<span class="kw">impl</span>&lt;T: Send, E&gt; IntoParallelIterator <span class="kw">for </span><span class="prelude-ty">Result</span>&lt;T, E&gt; {
    ...
    <span class="kw">fn </span>into_par_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::Iter {
        IntoIter {
            inner: <span class="self">self</span>.ok().into_par_iter(),
        }
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: Sync, E&gt; IntoParallelIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="prelude-ty">Result</span>&lt;T, E&gt; {
    ...
    <span class="kw">fn </span>into_par_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::Iter {
        Iter {
            inner: <span class="self">self</span>.as_ref().ok().into_par_iter(),
        }
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T: Send, E&gt; IntoParallelIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span><span class="prelude-ty">Result</span>&lt;T, E&gt; {
    ...
    <span class="kw">fn </span>into_par_iter(<span class="self">self</span>) -&gt; <span class="self">Self</span>::Iter {
        IterMut {
            inner: <span class="self">self</span>.as_mut().ok().into_par_iter(),
        }
    }
}
...
</span><span class="kw">impl</span>&lt;C, T, E&gt; FromParallelIterator&lt;<span class="prelude-ty">Result</span>&lt;T, E&gt;&gt; <span class="kw">for </span><span class="prelude-ty">Result</span>&lt;C, E&gt;
<span class="kw">where
    ...
    E: Send,
{
    <span class="kw">fn </span>from_par_iter&lt;I&gt;(par_iter: I) -&gt; <span class="self">Self
        ...
        </span>I: IntoParallelIterator&lt;Item = <span class="prelude-ty">Result</span>&lt;T, E&gt;&gt;,
    {
        <span class="kw">fn </span>ok&lt;T, E&gt;(saved: <span class="kw-2">&amp;</span>Mutex&lt;<span class="prelude-ty">Option</span>&lt;E&gt;&gt;) -&gt; <span class="kw">impl </span>Fn(<span class="prelude-ty">Result</span>&lt;T, E&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;T&gt; + <span class="lifetime">'_ </span>{
            <span class="kw">move </span>|item| <span class="kw">match </span>item {
                ...
                <span class="prelude-val">Err</span>(error) =&gt; {
                    ...
                    </span><span class="kw">if let </span><span class="prelude-val">Ok</span>(<span class="kw-2">mut </span>guard) = saved.try_lock() {
        ...
        <span class="kw">let </span>collection = par_iter
            .into_par_iter()
            .map(ok(<span class="kw-2">&amp;</span>saved_error))
            .while_some()
            .collect();
