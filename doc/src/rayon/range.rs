...
</pre></div><pre class="rust"><code><span class="doccomment">//! Parallel iterator types for [ranges][std::range],
...
<span class="doccomment">/// Parallel iterator over a range, implemented for all integer types and `char`.
///
...
</span><span class="kw">impl</span>&lt;T&gt; IntoParallelIterator <span class="kw">for </span>Range&lt;T&gt;
<span class="kw">where
    ...
    ( <span class="macro-nonterminal">$t</span>:ty ) =&gt; {
        <span class="kw">impl </span>RangeInteger <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            ...
            <span class="kw">fn </span>opt_len(iter: <span class="kw-2">&amp;</span>Iter&lt;<span class="macro-nonterminal">$t</span>&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
                <span class="prelude-val">Some</span>(iter.range.len())
            }
        }
...
<span class="macro">macro_rules!</span> unindexed_range_impl {
    ( <span class="macro-nonterminal">$t</span>:ty, <span class="macro-nonterminal">$len_t</span>:ty ) =&gt; {
        ...
        <span class="kw">impl </span>RangeInteger <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            ...
            {
                <span class="attr">#[inline]
                </span><span class="kw">fn </span>offset(start: <span class="macro-nonterminal">$t</span>) -&gt; <span class="kw">impl </span>Fn(usize) -&gt; <span class="macro-nonterminal">$t </span>{
                    <span class="kw">move </span>|i| start.wrapping_add(i <span class="kw">as </span><span class="macro-nonterminal">$t</span>)
                }

                <span class="kw">if let </span><span class="prelude-val">Some</span>(len) = iter.opt_len() {
                    <span class="comment">// Drive this in indexed mode for better `collect`.
                    </span>(<span class="number">0</span>..len)
                        .into_par_iter()
...
<span class="macro">unindexed_range_impl!</span> {u128, u128}
<span class="macro">unindexed_range_impl!</span> {i128, u128}

<span class="comment">// char is special because of the surrogate range hole
    ...
    ( <span class="macro-nonterminal">$self</span>:ident . <span class="macro-nonterminal">$method</span>:ident ( $( <span class="macro-nonterminal">$arg</span>:expr ),* ) ) =&gt; {{
        <span class="kw">let </span>start = <span class="macro-nonterminal">$self</span>.range.start <span class="kw">as </span>u32;
        <span class="kw">let </span>end = <span class="macro-nonterminal">$self</span>.range.end <span class="kw">as </span>u32;
        <span class="kw">if </span>start &lt; <span class="number">0xD800 </span>&amp;&amp; <span class="number">0xE000 </span>&lt; end {
            <span class="comment">// chain the before and after surrogate range fragments
                ...
                .into_par_iter()
                .chain(<span class="number">0xE000</span>..end)
...
<span class="kw">impl </span>IndexedParallelIterator <span class="kw">for </span>Iter&lt;char&gt; {
    ...
    <span class="kw">fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        ...
        </span><span class="kw">let </span>start = <span class="self">self</span>.range.start <span class="kw">as </span>u32;
        <span class="kw">let </span>end = <span class="self">self</span>.range.end <span class="kw">as </span>u32;
...
<span class="attr">#[test]
    ...
    <span class="kw">let </span>r1: i32 = left.range.map(i32::from).sum();
    <span class="kw">let </span>r2: i32 = right.range.map(i32::from).sum();
...
<span class="attr">#[test]
    ...
    <span class="kw">let </span>producer = IterProducer {
        range: <span class="number">0</span>..octillion,
    };
...
<span class="attr">#[test]
    ...
    <span class="macro">assert_eq!</span>(
        ...
        (<span class="number">0</span>..usize::MAX <span class="kw">as </span>u64).into_par_iter().opt_len()
    );
    <span class="kw">if </span>(usize::MAX <span class="kw">as </span>u64) &lt; u64::MAX {
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">None</span>,
            (<span class="number">0</span>..(usize::MAX <span class="kw">as </span>u64).wrapping_add(<span class="number">1</span>))
                .into_par_iter()
                .opt_len()
        );
...
<span class="attr">#[test]
    ...
    <span class="macro">assert_eq!</span>(
        <span class="prelude-val">Some</span>(usize::MAX),
        (<span class="number">0</span>..usize::MAX <span class="kw">as </span>u128).into_par_iter().opt_len()
    );
