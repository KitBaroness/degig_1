...
</pre></div><pre class="rust"><code><span class="doccomment">//! Common splitter for strings and slices
//!
...
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">struct </span>SplitProducer&lt;<span class="lifetime">'p</span>, P, V, <span class="kw">const </span>INCL: bool = <span class="bool-val">false</span>&gt; {
    data: V,
...
<span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">type </span>SplitInclusiveProducer&lt;<span class="lifetime">'p</span>, P, V&gt; = SplitProducer&lt;<span class="lifetime">'p</span>, P, V, <span class="bool-val">true</span>&gt;;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, P, V&gt; SplitInclusiveProducer&lt;<span class="lifetime">'p</span>, P, V&gt;
<span class="kw">where
    </span>V: Fissile&lt;P&gt; + Send,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new_incl(data: V, separator: <span class="kw-2">&amp;</span><span class="lifetime">'p </span>P) -&gt; <span class="self">Self </span>{
        SplitProducer {
            tail: data.length(),
            data,
            separator,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, P, V, <span class="kw">const </span>INCL: bool&gt; SplitProducer&lt;<span class="lifetime">'p</span>, P, V, INCL&gt;
<span class="kw">where
    </span>V: Fissile&lt;P&gt; + Send,
{
        ...
        </span>F: Folder&lt;V&gt;,
    {
        ...
        <span class="kw">if </span>tail == data.length() {
            ...
            </span>data.fold_splits::&lt;F, INCL&gt;(separator, folder, skip_last)
            ...
            </span><span class="kw">let </span>(left, right) = data.split_once::&lt;INCL&gt;(index);
            <span class="kw">let </span>folder = left.fold_splits::&lt;F, INCL&gt;(separator, folder, <span class="bool-val">false</span>);
...
<span class="kw">impl</span>&lt;<span class="lifetime">'p</span>, P, V, <span class="kw">const </span>INCL: bool&gt; UnindexedProducer <span class="kw">for </span>SplitProducer&lt;<span class="lifetime">'p</span>, P, V, INCL&gt;
<span class="kw">where
    </span>V: Fissile&lt;P&gt; + Send,
    P: Sync,
{
    ...
    <span class="kw">fn </span>split(<span class="self">self</span>) -&gt; (<span class="self">Self</span>, <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>&gt;) {
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(index) = index {
            ...
            <span class="kw">let </span>(left, right) = <span class="self">self</span>.data.split_once::&lt;INCL&gt;(index);
