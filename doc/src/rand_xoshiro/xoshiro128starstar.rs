...
</span><span class="kw">pub struct </span>Xoshiro128StarStar {
    s: [u32; <span class="number">4</span>],
}

<span class="kw">impl </span>Xoshiro128StarStar {
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro128StarStar {
    <span class="kw">type </span>Seed = [u8; <span class="number">16</span>];

    <span class="doccomment">/// Create a new `Xoshiro128StarStar`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">16</span>]) -&gt; Xoshiro128StarStar {
    ...
    <span class="doccomment">/// Seed a `Xoshiro128StarStar` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro128StarStar {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro128StarStar {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro128StarStar::from_seed(
        ...
        <span class="comment">// These values were produced with the reference implementation (v1.1):
        // http://xoshiro.di.unimi.it/xoshiro128starstar.c
        </span><span class="kw">let </span>expected = [
            <span class="number">11520</span>, <span class="number">0</span>, <span class="number">5927040</span>, <span class="number">70819200</span>, <span class="number">2031721883</span>, <span class="number">1637235492</span>, <span class="number">1287239034</span>,
            <span class="number">3734860849</span>, <span class="number">3729100597</span>, <span class="number">4258142804</span>,
        ];
