...
</span><span class="kw">pub struct </span>Xoshiro512StarStar {
    s: [u64; <span class="number">8</span>],
}

<span class="kw">impl </span>Xoshiro512StarStar {
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro512StarStar {
    <span class="kw">type </span>Seed = Seed512;

    <span class="doccomment">/// Create a new `Xoshiro512StarStar`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: Seed512) -&gt; Xoshiro512StarStar {
    ...
    <span class="doccomment">/// Seed a `Xoshiro512StarStar` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro512StarStar {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro512StarStar {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>result_starstar = <span class="macro">starstar_u64!</span>(<span class="self">self</span>.s[<span class="number">1</span>]);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro512StarStar::from_seed(Seed512(
