...
</span><span class="doccomment">//! This crate implements the [xoshiro] family of pseudorandom number generators
...
</span><span class="attr">#![doc(html_logo_url = <span class="string">"https://www.rust-lang.org/logos/rust-logo-128x128-blk.png"</span>,
       html_favicon_url = <span class="string">"https://www.rust-lang.org/favicon.ico"</span>,
       html_root_url = <span class="string">"https://docs.rs/rand_xoshiro/0.6.0"</span>)]
...
#[macro_use]
</span><span class="kw">mod </span>common;
<span class="kw">mod </span>splitmix64;
<span class="kw">mod </span>xoshiro128starstar;
<span class="kw">mod </span>xoshiro128plusplus;
<span class="kw">mod </span>xoshiro128plus;
<span class="kw">mod </span>xoshiro256starstar;
<span class="kw">mod </span>xoshiro256plusplus;
<span class="kw">mod </span>xoshiro256plus;
<span class="kw">mod </span>xoshiro512starstar;
<span class="kw">mod </span>xoshiro512plusplus;
<span class="kw">mod </span>xoshiro512plus;
<span class="kw">mod </span>xoroshiro128plus;
<span class="kw">mod </span>xoroshiro128plusplus;
<span class="kw">mod </span>xoroshiro128starstar;
<span class="kw">mod </span>xoroshiro64starstar;
<span class="kw">mod </span>xoroshiro64star;

<span class="kw">pub use </span>rand_core;
<span class="kw">pub use </span>splitmix64::SplitMix64;
<span class="kw">pub use </span>xoshiro128starstar::Xoshiro128StarStar;
<span class="kw">pub use </span>xoshiro128plusplus::Xoshiro128PlusPlus;
<span class="kw">pub use </span>xoshiro128plus::Xoshiro128Plus;
<span class="kw">pub use </span>xoshiro256starstar::Xoshiro256StarStar;
<span class="kw">pub use </span>xoshiro256plusplus::Xoshiro256PlusPlus;
<span class="kw">pub use </span>xoshiro256plus::Xoshiro256Plus;
<span class="kw">pub use </span>common::Seed512;
<span class="kw">pub use </span>xoshiro512starstar::Xoshiro512StarStar;
<span class="kw">pub use </span>xoshiro512plusplus::Xoshiro512PlusPlus;
<span class="kw">pub use </span>xoshiro512plus::Xoshiro512Plus;
<span class="kw">pub use </span>xoroshiro128plus::Xoroshiro128Plus;
<span class="kw">pub use </span>xoroshiro128starstar::Xoroshiro128StarStar;
<span class="kw">pub use </span>xoroshiro128plusplus::Xoroshiro128PlusPlus;
<span class="kw">pub use </span>xoroshiro64starstar::Xoroshiro64StarStar;
<span class="kw">pub use </span>xoroshiro64star::Xoroshiro64Star;
