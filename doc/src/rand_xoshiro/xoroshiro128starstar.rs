...
</span><span class="kw">pub struct </span>Xoroshiro128StarStar {
    s0: u64,
    s1: u64,
}

<span class="kw">impl </span>Xoroshiro128StarStar {
    ...
    /// ```
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [<span class="number">0xdf900294d8f554a5</span>, <span class="number">0x170865df4b3201fc</span>]);
    }
    ...
    /// distributed computations.
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [<span class="number">0xd2a98b26625eee7b</span>, <span class="number">0xdddf9b1090aa7ac1</span>]);
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoroshiro128StarStar {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>r = <span class="macro">starstar_u64!</span>(<span class="self">self</span>.s0);
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoroshiro128StarStar {
    <span class="kw">type </span>Seed = [u8; <span class="number">16</span>];

    <span class="doccomment">/// Create a new `Xoroshiro128StarStar`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">16</span>]) -&gt; Xoroshiro128StarStar {
    ...
    <span class="doccomment">/// Seed a `Xoroshiro128StarStar` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoroshiro128StarStar {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro128StarStar::from_seed(
        ...
        // http://xoshiro.di.unimi.it/xoshiro128starstar.c
            ...
            <span class="number">5760</span>, <span class="number">97769243520</span>, <span class="number">9706862127477703552</span>, <span class="number">9223447511460779954</span>,
            <span class="number">8358291023205304566</span>, <span class="number">15695619998649302768</span>, <span class="number">8517900938696309774</span>,
            <span class="number">16586480348202605369</span>, <span class="number">6959129367028440372</span>, <span class="number">16822147227405758281</span>,
        ];
