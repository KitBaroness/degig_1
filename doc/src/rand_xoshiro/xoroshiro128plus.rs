...
</span><span class="kw">pub struct </span>Xoroshiro128Plus {
    s0: u64,
    s1: u64,
}

<span class="kw">impl </span>Xoroshiro128Plus {
...
<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoroshiro128Plus {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next_u32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; u32 {
        <span class="comment">// The two lowest bits have some linear dependencies, so we use the
        // upper bits instead.
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>r = <span class="self">self</span>.s0.wrapping_add(<span class="self">self</span>.s1);
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoroshiro128Plus {
    <span class="kw">type </span>Seed = [u8; <span class="number">16</span>];

    <span class="doccomment">/// Create a new `Xoroshiro128Plus`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">16</span>]) -&gt; Xoroshiro128Plus {
    ...
    <span class="doccomment">/// Seed a `Xoroshiro128Plus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoroshiro128Plus {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro128Plus::from_seed(
