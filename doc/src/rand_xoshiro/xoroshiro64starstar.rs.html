...
<span class="kw">use </span>rand_core::impls::{fill_bytes_via_next, next_u64_via_u32};
<span class="kw">use </span>rand_core::{RngCore, SeedableRng};

<span class="doccomment">/// A xoroshiro64** random number generator.
///
...
</span><span class="kw">pub struct </span>Xoroshiro64StarStar {
    s0: u32,
    s1: u32,
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoroshiro64StarStar {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next_u32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; u32 {
        <span class="kw">let </span>r = <span class="macro">starstar_u32!</span>(<span class="self">self</span>.s0);
        <span class="macro">impl_xoroshiro_u32!</span>(<span class="self">self</span>);
        r
    }
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoroshiro64StarStar {
    <span class="kw">type </span>Seed = [u8; <span class="number">8</span>];

    <span class="doccomment">/// Create a new `Xoroshiro64StarStar`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">8</span>]) -&gt; Xoroshiro64StarStar {
        ...
        read_u32_into(<span class="kw-2">&amp;</span>seed, <span class="kw-2">&amp;mut </span>s);
    ...
    <span class="doccomment">/// Seed a `Xoroshiro64StarStar` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoroshiro64StarStar {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro64StarStar::from_seed([<span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">2</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>]);
        ...
        // http://xoshiro.di.unimi.it/xoshiro64starstar.c
            ...
            <span class="number">3802928447</span>, <span class="number">813792938</span>, <span class="number">1618621494</span>, <span class="number">2955957307</span>, <span class="number">3252880261</span>,
            <span class="number">1129983909</span>, <span class="number">2539651700</span>, <span class="number">1327610908</span>, <span class="number">1757650787</span>, <span class="number">2763843748</span>,
        ];
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>zero_seed() {
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro64StarStar::seed_from_u64(<span class="number">0</span>);
        <span class="macro">assert_ne!</span>(rng.next_u64(), <span class="number">0</span>);
    }
}
