...
<span class="kw">impl </span>Xoshiro256PlusPlus {
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro256PlusPlus {
    ...
    <span class="doccomment">/// Seed a `Xoshiro256PlusPlus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro256PlusPlus {
...
<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro256PlusPlus {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>result_plusplus = <span class="macro">plusplus_u64!</span>(<span class="self">self</span>.s[<span class="number">0</span>], <span class="self">self</span>.s[<span class="number">3</span>], <span class="number">23</span>);
