...
</span><span class="kw">pub struct </span>Xoshiro128PlusPlus {
    s: [u32; <span class="number">4</span>],
}

<span class="kw">impl </span>Xoshiro128PlusPlus {
    ...
    <span class="doccomment">/// Jump forward, equivalently to 2^96 calls to `next_u32()`.
    ///
    ...
    /// distributed computations.
        ...
        <span class="macro">impl_jump!</span>(u32, <span class="self">self</span>, [<span class="number">0xb523952e</span>, <span class="number">0x0b6f099f</span>, <span class="number">0xccf5a0ef</span>, <span class="number">0x1c580662</span>]);
    }
}

<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro128PlusPlus {
    <span class="kw">type </span>Seed = [u8; <span class="number">16</span>];

    <span class="doccomment">/// Create a new `Xoshiro128PlusPlus`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">16</span>]) -&gt; Xoshiro128PlusPlus {
    ...
    <span class="doccomment">/// Seed a `Xoshiro128PlusPlus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro128PlusPlus {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro128PlusPlus {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next_u32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; u32 {
        <span class="kw">let </span>result_starstar = <span class="macro">plusplus_u32!</span>(<span class="self">self</span>.s[<span class="number">0</span>], <span class="self">self</span>.s[<span class="number">3</span>]);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro128PlusPlus::from_seed(
        ...
        // http://xoshiro.di.unimi.it/xoshiro128plusplus.c
            ...
            <span class="number">641</span>, <span class="number">1573767</span>, <span class="number">3222811527</span>, <span class="number">3517856514</span>, <span class="number">836907274</span>, <span class="number">4247214768</span>,
            <span class="number">3867114732</span>, <span class="number">1355841295</span>, <span class="number">495546011</span>, <span class="number">621204420</span>,
        ];
