...
</span><span class="kw">pub struct </span>Xoshiro256StarStar {
    s: [u64; <span class="number">4</span>],
}

<span class="kw">impl </span>Xoshiro256StarStar {
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro256StarStar {
    <span class="kw">type </span>Seed = [u8; <span class="number">32</span>];

    <span class="doccomment">/// Create a new `Xoshiro256StarStar`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">32</span>]) -&gt; Xoshiro256StarStar {
    ...
    <span class="doccomment">/// Seed a `Xoshiro256StarStar` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro256StarStar {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro256StarStar {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro256StarStar::from_seed(
        ...
        // http://xoshiro.di.unimi.it/xoshiro128starstar.c
            ...
            <span class="number">11520</span>, <span class="number">0</span>, <span class="number">1509978240</span>, <span class="number">1215971899390074240</span>, <span class="number">1216172134540287360</span>,
            <span class="number">607988272756665600</span>, <span class="number">16172922978634559625</span>, <span class="number">8476171486693032832</span>,
            <span class="number">10595114339597558777</span>, <span class="number">2904607092377533576</span>,
        ];
