...
<span class="kw">use </span><span class="kw">crate</span>::Seed512;

<span class="doccomment">/// A xoshiro512++ random number generator.
///
...
</span><span class="kw">pub struct </span>Xoshiro512PlusPlus {
    s: [u64; <span class="number">8</span>],
}

<span class="kw">impl </span>Xoshiro512PlusPlus {
    <span class="doccomment">/// Jump forward, equivalently to 2^256 calls to `next_u64()`.
    ///
    ...
    /// ```
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [
            ...
            <span class="number">0x53851efdb6df0aaf</span>, <span class="number">0x1ebbc8b23eaf25db
        </span>]);
    }

    <span class="doccomment">/// Jump forward, equivalently to 2^384 calls to `next_u64()`.
    ///
    ...
    /// distributed computations.
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [
            ...
            <span class="number">0x915e38fd4eda93bc</span>, <span class="number">0x5b3ccdfa5d7daca5
        </span>]);
    }
}


<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro512PlusPlus {
    <span class="kw">type </span>Seed = Seed512;

    <span class="doccomment">/// Create a new `Xoshiro512PlusPlus`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: Seed512) -&gt; Xoshiro512PlusPlus {
        <span class="macro">deal_with_zero_seed!</span>(seed, <span class="self">Self</span>);
        <span class="kw">let </span><span class="kw-2">mut </span>state = [<span class="number">0</span>; <span class="number">8</span>];
        read_u64_into(<span class="kw-2">&amp;</span>seed.<span class="number">0</span>, <span class="kw-2">&amp;mut </span>state);
        Xoshiro512PlusPlus { s: state }
    }

    <span class="doccomment">/// Seed a `Xoshiro512PlusPlus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro512PlusPlus {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro512PlusPlus {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>result_plusplus = <span class="macro">plusplus_u64!</span>(<span class="self">self</span>.s[<span class="number">2</span>], <span class="self">self</span>.s[<span class="number">0</span>], <span class="number">17</span>);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro512PlusPlus::from_seed(Seed512(
        ...
        // http://xoshiro.di.unimi.it/xoshiro512plusplus.c
            ...
            <span class="number">524291</span>, <span class="number">1048578</span>, <span class="number">539099140</span>, <span class="number">3299073855497</span>, <span class="number">6917532603230064654</span>,
            <span class="number">7494048333530275843</span>, <span class="number">14418333309547923463</span>, <span class="number">10960079161595355914</span>,
            <span class="number">18279570946505382726</span>, <span class="number">10209173166699159237</span>,
        ];
