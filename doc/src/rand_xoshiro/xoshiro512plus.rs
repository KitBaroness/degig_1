...
</span><span class="kw">pub struct </span>Xoshiro512Plus {
    s: [u64; <span class="number">8</span>],
}

<span class="kw">impl </span>Xoshiro512Plus {
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoshiro512Plus {
    <span class="kw">type </span>Seed = Seed512;

    <span class="doccomment">/// Create a new `Xoshiro512Plus`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>from_seed(seed: Seed512) -&gt; Xoshiro512Plus {
    ...
    <span class="doccomment">/// Seed a `Xoshiro512Plus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoshiro512Plus {
        <span class="macro">from_splitmix!</span>(seed)
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoshiro512Plus {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>result_plus = <span class="self">self</span>.s[<span class="number">0</span>].wrapping_add(<span class="self">self</span>.s[<span class="number">2</span>]);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoshiro512Plus::from_seed(Seed512(
        ...
        // http://xoshiro.di.unimi.it/xoshiro512plus.c
            ...
            <span class="number">4</span>, <span class="number">8</span>, <span class="number">4113</span>, <span class="number">25169936</span>, <span class="number">52776585412635</span>, <span class="number">57174648719367</span>,
            <span class="number">9223482039571869716</span>, <span class="number">9331471677901559830</span>, <span class="number">9340533895746033672</span>,
            <span class="number">14078399799840753678</span>,
        ];
