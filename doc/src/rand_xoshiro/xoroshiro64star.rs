...
</span><span class="kw">pub struct </span>Xoroshiro64Star {
    s0: u32,
    s1: u32,
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoroshiro64Star {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next_u32(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; u32 {
        <span class="kw">let </span>r = <span class="self">self</span>.s0.wrapping_mul(<span class="number">0x9E3779BB</span>);
...
<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoroshiro64Star {
    <span class="kw">type </span>Seed = [u8; <span class="number">8</span>];

    <span class="doccomment">/// Create a new `Xoroshiro64Star`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">8</span>]) -&gt; Xoroshiro64Star {
    ...
    <span class="doccomment">/// Seed a `Xoroshiro64Star` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoroshiro64Star {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro64Star::from_seed([<span class="number">1</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">2</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>]);
        ...
        // http://xoshiro.di.unimi.it/xoshiro64star.c
            ...
            <span class="number">2654435771</span>, <span class="number">327208753</span>, <span class="number">4063491769</span>, <span class="number">4259754937</span>, <span class="number">261922412</span>, <span class="number">168123673</span>,
            <span class="number">552743735</span>, <span class="number">1672597395</span>, <span class="number">1031040050</span>, <span class="number">2755315674</span>,
        ];
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro64Star::seed_from_u64(<span class="number">0</span>);
