...
<span class="doccomment">/// A xoroshiro128++ random number generator.
///
...
</span><span class="kw">pub struct </span>Xoroshiro128PlusPlus {
    s0: u64,
    s1: u64,
}

<span class="kw">impl </span>Xoroshiro128PlusPlus {
    <span class="doccomment">/// Jump forward, equivalently to 2^64 calls to `next_u64()`.
    ///
    ...
    /// ```
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [<span class="number">0x2bd7a6a6e99c2ddc</span>, <span class="number">0x0992ccaf6a6fca05</span>]);
    }

    <span class="doccomment">/// Jump forward, equivalently to 2^96 calls to `next_u64()`.
    ///
    ...
    /// distributed computations.
        ...
        <span class="macro">impl_jump!</span>(u64, <span class="self">self</span>, [<span class="number">0x360fd5f2cf8d5d99</span>, <span class="number">0x9c6e6877736c46e3</span>]);
    }
}

<span class="kw">impl </span>RngCore <span class="kw">for </span>Xoroshiro128PlusPlus {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>r = <span class="macro">plusplus_u64!</span>(<span class="self">self</span>.s0, <span class="self">self</span>.s1, <span class="number">17</span>);
        <span class="macro">impl_xoroshiro_u64_plusplus!</span>(<span class="self">self</span>);
        r
    }
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>try_fill_bytes(<span class="kw-2">&amp;mut </span><span class="self">self</span>, dest: <span class="kw-2">&amp;mut </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;(), rand_core::Error&gt; {
        <span class="self">self</span>.fill_bytes(dest);
        <span class="prelude-val">Ok</span>(())
    }
}

<span class="kw">impl </span>SeedableRng <span class="kw">for </span>Xoroshiro128PlusPlus {
    <span class="kw">type </span>Seed = [u8; <span class="number">16</span>];

    <span class="doccomment">/// Create a new `Xoroshiro128PlusPlus`.  If `seed` is entirely 0, it will be
    /// mapped to a different seed.
    </span><span class="kw">fn </span>from_seed(seed: [u8; <span class="number">16</span>]) -&gt; Xoroshiro128PlusPlus {
        <span class="macro">deal_with_zero_seed!</span>(seed, <span class="self">Self</span>);
        <span class="kw">let </span><span class="kw-2">mut </span>s = [<span class="number">0</span>; <span class="number">2</span>];
        read_u64_into(<span class="kw-2">&amp;</span>seed, <span class="kw-2">&amp;mut </span>s);

        Xoroshiro128PlusPlus {
            s0: s[<span class="number">0</span>],
            s1: s[<span class="number">1</span>],
        }
    }

    <span class="doccomment">/// Seed a `Xoroshiro128PlusPlus` from a `u64` using `SplitMix64`.
    </span><span class="kw">fn </span>seed_from_u64(seed: u64) -&gt; Xoroshiro128PlusPlus {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>rng = Xoroshiro128PlusPlus::from_seed(
        ...
        // http://xoshiro.di.unimi.it/xoshiro128plusplus.c
            ...
            <span class="number">393217</span>, <span class="number">669327710093319</span>, <span class="number">1732421326133921491</span>, <span class="number">11394790081659126983</span>,
            <span class="number">9555452776773192676</span>, <span class="number">3586421180005889563</span>, <span class="number">1691397964866707553</span>,
            <span class="number">10735626796753111697</span>, <span class="number">15216282715349408991</span>, <span class="number">14247243556711267923</span>,
        ];
