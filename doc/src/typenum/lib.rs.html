...
</pre></div><pre class="rust"><code><span class="doccomment">//! This crate provides type-level numbers evaluated at compile time. It depends only on libcore.
//!
...
#![cfg_attr(feature = <span class="string">"cargo-clippy"</span>, deny(clippy::missing_inline_in_public_items))]
#![doc(html_root_url = <span class="string">"https://docs.rs/typenum/1.17.0"</span>)]
...
<span class="kw">mod </span>generated {
    ...
    </span><span class="macro">include!</span>(<span class="macro">concat!</span>(<span class="macro">env!</span>(<span class="string">"OUT_DIR"</span>), <span class="string">"/generic_const_mappings.rs"</span>));
}
...
#[rustfmt::skip]
</span><span class="kw">pub use </span>consts::{
    False, True, B0, B1,
    U0, U1, U2, <span class="kw-2">*</span>,
    N1, N2, Z0, P1, P2, <span class="kw-2">*</span>,
};

<span class="attr">#[cfg(feature = <span class="string">"const-generics"</span>)]
</span><span class="kw">pub use </span><span class="kw">crate</span>::generated::generic_const_mappings;
