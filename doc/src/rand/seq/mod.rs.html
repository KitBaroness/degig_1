...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">use </span>core::ops::Index;

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">use </span>alloc::vec::Vec;

<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">use </span><span class="kw">crate</span>::distributions::uniform::{SampleBorrow, SampleUniform};
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">use </span><span class="kw">crate</span>::distributions::WeightedError;
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)] </span><span class="kw">use </span><span class="kw">crate</span>::Rng;
    <span class="attr">#[cfg(all(feature = <span class="string">"alloc"</span>, not(feature = <span class="string">"std"</span>)))] </span><span class="kw">use </span>alloc::vec::Vec;
