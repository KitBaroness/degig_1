...
</span><span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"std_rng"</span>))]
</span><span class="kw">pub use </span><span class="kw">crate</span>::rngs::thread::thread_rng;
<span class="kw">pub use </span>rng::{Fill, Rng};

<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"std_rng"</span>))]
