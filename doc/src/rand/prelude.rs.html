...
</span><span class="attr">#[doc(no_inline)] </span><span class="kw">pub use </span><span class="kw">crate</span>::distributions::Distribution;
...
<span class="attr">#[doc(no_inline)] </span><span class="kw">pub use </span><span class="kw">crate</span>::seq::{IteratorRandom, SliceRandom};
<span class="attr">#[doc(no_inline)]
#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"std_rng"</span>))]
</span><span class="kw">pub use crate</span>::{random, thread_rng};
<span class="attr">#[doc(no_inline)] </span><span class="kw">pub use crate</span>::{CryptoRng, Rng, RngCore, SeedableRng};
