    ...
    Rsdr: RngCore,
{
    ...
    <span class="attr">#[inline(never)]
        ...
        <span class="attr">#![allow(clippy::if_same_then_else)] </span><span class="comment">// false positive
...
<span class="attr">#[cfg(all(unix, not(target_os = <span class="string">"emscripten"</span>)))]
...
<span class="attr">#[cfg(not(all(unix, not(target_os = <span class="string">"emscripten"</span>))))]
</span><span class="kw">mod </span>fork {
    <span class="kw">pub fn </span>get_fork_counter() -&gt; usize {
        <span class="number">0
    </span>}
