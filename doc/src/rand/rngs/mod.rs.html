...
</span><span class="attr">#[cfg_attr(doc_cfg, doc(cfg(feature = <span class="string">"std"</span>)))]
...
</span><span class="attr">#[cfg(all(feature = <span class="string">"small_rng"</span>, target_pointer_width = <span class="string">"64"</span>))]
</span><span class="kw">mod </span>xoshiro256plusplus;
<span class="attr">#[cfg(all(feature = <span class="string">"small_rng"</span>, not(target_pointer_width = <span class="string">"64"</span>)))]
</span><span class="kw">mod </span>xoshiro128plusplus;
<span class="attr">#[cfg(feature = <span class="string">"small_rng"</span>)] </span><span class="kw">mod </span>small;

<span class="attr">#[cfg(feature = <span class="string">"std_rng"</span>)] </span><span class="kw">mod </span>std;
<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"std_rng"</span>))] </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>thread;

<span class="attr">#[cfg(feature = <span class="string">"small_rng"</span>)] </span><span class="kw">pub use </span><span class="self">self</span>::small::SmallRng;
<span class="attr">#[cfg(feature = <span class="string">"std_rng"</span>)] </span><span class="kw">pub use </span><span class="self">self</span>::std::StdRng;
<span class="attr">#[cfg(all(feature = <span class="string">"std"</span>, feature = <span class="string">"std_rng"</span>))] </span><span class="kw">pub use </span><span class="self">self</span>::thread::ThreadRng;

<span class="attr">#[cfg_attr(doc_cfg, doc(cfg(feature = <span class="string">"getrandom"</span>)))]
