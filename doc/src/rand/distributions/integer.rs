...
<span class="attr">#[cfg(all(target_arch = <span class="string">"x86"</span>, feature = <span class="string">"simd_support"</span>))]
</span><span class="kw">use </span>core::arch::x86::{__m128i, __m256i};
<span class="attr">#[cfg(all(target_arch = <span class="string">"x86_64"</span>, feature = <span class="string">"simd_support"</span>))]
...
<span class="kw">use </span>core::num::{NonZeroU16, NonZeroU32, NonZeroU64, NonZeroU8, NonZeroUsize,
    NonZeroU128};
<span class="attr">#[cfg(feature = <span class="string">"simd_support"</span>)] </span><span class="kw">use </span>packed_simd::<span class="kw-2">*</span>;
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="attr">#[cfg(any(target_pointer_width = <span class="string">"32"</span>, target_pointer_width = <span class="string">"16"</span>))]
        ...
        </span><span class="attr">#[cfg(feature = <span class="string">"simd_support"</span>)]
        </span>{
