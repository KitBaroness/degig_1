...
</pre></div><pre class="rust"><code><span class="doccomment">//! Interface state types
...
#[discriminator_hash_input(<span class="string">"spl_token_group_interface:group"</span>)]
    ...
    </span><span class="kw">pub </span>size: PodU32,
...
<span class="kw">impl </span>TokenGroup {
    ...
    </span><span class="kw">pub fn </span>new(mint: <span class="kw-2">&amp;</span>Pubkey, update_authority: OptionalNonZeroPubkey, max_size: u32) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            mint: <span class="kw-2">*</span>mint,
            update_authority,
            size: PodU32::default(), <span class="comment">// [0, 0, 0, 0]
            </span>max_size: max_size.into(),
        }
    }

    <span class="doccomment">/// Updates the max size for a group
    </span><span class="kw">pub fn </span>update_max_size(<span class="kw-2">&amp;mut </span><span class="self">self</span>, new_max_size: u32) -&gt; <span class="prelude-ty">Result</span>&lt;(), ProgramError&gt; {
        <span class="comment">// The new max size cannot be less than the current size
        </span><span class="kw">if </span>new_max_size &lt; u32::from(<span class="self">self</span>.size) {
    ...
    <span class="doccomment">/// Increment the size for a group, returning the new size
    </span><span class="kw">pub fn </span>increment_size(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;u32, ProgramError&gt; {
        <span class="comment">// The new size cannot be greater than the max size
        </span><span class="kw">let </span>new_size = u32::from(<span class="self">self</span>.size)
        ...
        <span class="kw">if </span>new_size &gt; u32::from(<span class="self">self</span>.max_size) {
...
#[discriminator_hash_input(<span class="string">"spl_token_group_interface:member"</span>)]
    ...
    </span><span class="kw">pub </span>member_number: PodU32,
}
<span class="kw">impl </span>TokenGroupMember {
    <span class="doccomment">/// Creates a new `TokenGroupMember` state
    </span><span class="kw">pub fn </span>new(mint: <span class="kw-2">&amp;</span>Pubkey, group: <span class="kw-2">&amp;</span>Pubkey, member_number: u32) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            mint: <span class="kw-2">*</span>mint,
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>preimage = hash::hashv(<span class="kw-2">&amp;</span>[<span class="macro">format!</span>(<span class="string">"{NAMESPACE}:group"</span>).as_bytes()]);
        ...
        <span class="kw">let </span>preimage = hash::hashv(<span class="kw-2">&amp;</span>[<span class="macro">format!</span>(<span class="string">"{NAMESPACE}:member"</span>).as_bytes()]);
        <span class="kw">let </span>discriminator =
            ArrayDiscriminator::try_from(<span class="kw-2">&amp;</span>preimage.as_ref()[..ArrayDiscriminator::LENGTH]).unwrap();
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(u32::from(group.max_size), new_max_size);
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(u32::from(group.size), <span class="number">1</span>);
