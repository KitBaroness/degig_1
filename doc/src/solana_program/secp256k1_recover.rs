...
</pre></div><pre class="rust"><code><span class="doccomment">//! Public key recovery from [secp256k1] ECDSA signatures.
//!
...
/// ```
    ...
    <span class="attr">#[cfg(target_os = <span class="string">"solana"</span>)]
        ...
        <span class="kw">let </span>result = <span class="kw">unsafe </span>{
            <span class="kw">crate</span>::syscalls::sol_secp256k1_recover(
                hash.as_ptr(),
