...
</pre></div><pre class="rust"><code><span class="doccomment">//! Hashing with the [blake3] hash function.
//!
//! [blake3]: https://github.com/BLAKE3-team/BLAKE3

</span><span class="kw">use </span>{
    <span class="kw">crate</span>::sanitize::Sanitize,
...
<span class="doccomment">/// A blake3 hash.
...
<span class="kw">impl </span>Hasher {
    ...
    <span class="kw">pub fn </span>result(<span class="self">self</span>) -&gt; Hash {
        Hash(<span class="kw-2">*</span><span class="self">self</span>.hasher.finalize().as_bytes())
    }
}
...
<span class="kw">impl </span>Hash {
    ...
    <span class="doccomment">/// unique Hash for tests and benchmarks.
        ...
        <span class="self">Self</span>::new(<span class="kw-2">&amp;</span>b)
    }
...
<span class="doccomment">/// Return a Blake3 hash for the given data.
    ...
    <span class="comment">// Call via a system call to perform the calculation
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">crate</span>::syscalls::sol_blake3(
...
<span class="doccomment">/// Return the hash of the given hash extended with the given value.
</span><span class="kw">pub fn </span>extend_and_hash(id: <span class="kw-2">&amp;</span>Hash, val: <span class="kw-2">&amp;</span>[u8]) -&gt; Hash {
    <span class="kw">let </span><span class="kw-2">mut </span>hash_data = id.as_ref().to_vec();
    hash_data.extend_from_slice(val);
    hash(<span class="kw-2">&amp;</span>hash_data)
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>hash = hash(<span class="kw-2">&amp;</span>[<span class="number">1u8</span>]);
        ...
        hash_base58_str.push_str(<span class="kw-2">&amp;</span>bs58::encode(hash.<span class="number">0</span>).into_string());
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>hash_base58_str = bs58::encode(hash.<span class="number">0</span>).into_string();
        <span class="macro">assert_eq!</span>(hash_base58_str.parse::&lt;Hash&gt;(), <span class="prelude-val">Ok</span>(hash));
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_extend_and_hash() {
        <span class="kw">let </span>val = <span class="string">"gHiljKpq"</span>;
        <span class="kw">let </span>val_hash = hash(val.as_bytes());
        <span class="kw">let </span>ext = <span class="string">"lM890t"</span>;
        <span class="kw">let </span>hash_ext = [<span class="kw-2">&amp;</span>val_hash.<span class="number">0</span>, ext.as_bytes()].concat();
        <span class="kw">let </span>ext_hash = extend_and_hash(<span class="kw-2">&amp;</span>val_hash, ext.as_bytes());
        <span class="macro">assert!</span>(ext_hash == hash(<span class="kw-2">&amp;</span>hash_ext));
    }
}
