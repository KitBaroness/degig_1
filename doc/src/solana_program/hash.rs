...
</pre></div><pre class="rust"><code><span class="doccomment">//! Hashing with the [SHA-256] hash function, and a general [`Hash`] type.
//!
//! [SHA-256]: https://en.wikipedia.org/wiki/SHA-2
//! [`Hash`]: struct@Hash

</span><span class="kw">use </span>{
    <span class="kw">crate</span>::{sanitize::Sanitize, wasm_bindgen},
...
<span class="kw">impl </span>Hasher {
    ...
    <span class="kw">pub fn </span>result(<span class="self">self</span>) -&gt; Hash {
        Hash(<span class="self">self</span>.hasher.finalize().into())
    }
}
...
<span class="doccomment">/// Return a Sha256 hash for the given data.
    ...
    <span class="comment">// Call via a system call to perform the calculation
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">crate</span>::syscalls::sol_sha256(
