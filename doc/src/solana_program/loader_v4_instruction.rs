...
</pre></div><pre class="rust"><code><span class="doccomment">//! Instructions for the v4 built-in loader program.

</span><span class="attr">#[repr(u8)]
#[derive(Serialize, Deserialize, Debug, PartialEq, Eq, Clone)]
</span><span class="kw">pub enum </span>LoaderV4Instruction {
    <span class="doccomment">/// Write ELF data into an undeployed program account.
    ///
    /// # Account references
    ...
    <span class="doccomment">/// Changes the size of an undeployed program account.
    ///
    ...
    ///   2. `[writable]` Optional, the recipient account.
        ...
        <span class="doccomment">/// The new size after the operation.
        </span>new_size: u32,
    },

    <span class="doccomment">/// Verify the data of a program account to be a valid ELF.
    ///
    ...
    <span class="doccomment">/// Undo the deployment of a program account.
    ///
    ...
    <span class="doccomment">/// Transfers the authority over a program account.
    ///
