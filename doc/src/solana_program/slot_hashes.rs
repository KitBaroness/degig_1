...
</pre></div><pre class="rust"><code><span class="doccomment">//! A type to hold data for the [`SlotHashes` sysvar][sv].
//!
...
<span class="kw">use </span>{
    <span class="kw">crate</span>::hash::Hash,
    std::{
        iter::FromIterator,
        ops::Deref,
...
<span class="kw">pub type </span>SlotHash = (Slot, Hash);
...
<span class="kw">impl </span>SlotHashes {
    <span class="kw">pub fn </span>add(<span class="kw-2">&amp;mut </span><span class="self">self</span>, slot: Slot, hash: Hash) {
    ...
    <span class="kw">pub fn </span>position(<span class="kw-2">&amp;</span><span class="self">self</span>, slot: <span class="kw-2">&amp;</span>Slot) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
    ...
    </span><span class="kw">pub fn </span>get(<span class="kw-2">&amp;</span><span class="self">self</span>, slot: <span class="kw-2">&amp;</span>Slot) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Hash&gt; {
...
<span class="kw">impl </span>FromIterator&lt;(Slot, Hash)&gt; <span class="kw">for </span>SlotHashes {
    <span class="kw">fn </span>from_iter&lt;I: IntoIterator&lt;Item = (Slot, Hash)&gt;&gt;(iter: I) -&gt; <span class="self">Self </span>{
