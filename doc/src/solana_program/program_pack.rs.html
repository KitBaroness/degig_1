...
</pre></div><pre class="rust"><code><span class="doccomment">//! The [`Pack`] serialization trait.

</span><span class="kw">use </span><span class="kw">crate</span>::program_error::ProgramError;
