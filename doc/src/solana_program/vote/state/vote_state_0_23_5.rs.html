...
<span class="kw">const </span>MAX_ITEMS: usize = <span class="number">32</span>;

<span class="attr">#[derive(Debug, Default, Serialize, Deserialize, PartialEq, Eq, Clone)]
</span><span class="kw">pub struct </span>VoteState0_23_5 {
    ...
    </span><span class="kw">pub </span>authorized_voter: Pubkey,
    <span class="doccomment">/// when the authorized voter was set/initialized
    </span><span class="kw">pub </span>authorized_voter_epoch: Epoch,

    <span class="doccomment">/// history of prior authorized voters and the epoch ranges for which
    ///  they were set
    </span><span class="kw">pub </span>prior_voters: CircBuf&lt;(Pubkey, Epoch, Epoch, Slot)&gt;,
    ...
    <span class="kw">pub </span>root_slot: <span class="prelude-ty">Option</span>&lt;u64&gt;,
...
<span class="attr">#[derive(Debug, Serialize, Deserialize, PartialEq, Eq, Clone)]
    ...
    <span class="kw">pub </span>buf: [I; MAX_ITEMS],
    <span class="doccomment">/// next pointer
    </span><span class="kw">pub </span>idx: usize,
}
...
<span class="kw">impl</span>&lt;I: Default + Copy&gt; Default <span class="kw">for </span>CircBuf&lt;I&gt; {
    <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            ...
            idx: MAX_ITEMS - <span class="number">1</span>,
        }
    }
}
...
<span class="kw">impl</span>&lt;I&gt; CircBuf&lt;I&gt; {
    <span class="kw">pub fn </span>append(<span class="kw-2">&amp;mut </span><span class="self">self</span>, item: I) {
        ...
        <span class="self">self</span>.idx %= MAX_ITEMS;
