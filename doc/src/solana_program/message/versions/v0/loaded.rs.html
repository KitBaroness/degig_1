...
</span><span class="attr">#[derive(Clone, Default, Debug, PartialEq, Eq, Serialize, Deserialize)]
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; LoadedMessage&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">pub fn </span>new(message: v0::Message, loaded_addresses: LoadedAddresses) -&gt; <span class="self">Self </span>{
    ...
    <span class="kw">pub fn </span>new_borrowed(message: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>v0::Message, loaded_addresses: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>LoadedAddresses) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span><span class="kw-2">mut </span>loaded_message = <span class="self">Self </span>{
    ...
    <span class="kw">fn </span>set_is_writable_account_cache(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw">let </span>is_writable_account_cache = <span class="self">self
            </span>.account_keys()
            .iter()
            .enumerate()
            .map(|(i, _key)| <span class="self">self</span>.is_writable_internal(i))
    ...
    <span class="doccomment">/// Returns true if the account at the specified index was loaded as writable
    </span><span class="kw">fn </span>is_writable_internal(<span class="kw-2">&amp;</span><span class="self">self</span>, key_index: usize) -&gt; bool {
        <span class="kw">if </span><span class="self">self</span>.is_writable_index(key_index) {
            <span class="kw">if let </span><span class="prelude-val">Some</span>(key) = <span class="self">self</span>.account_keys().get(key_index) {
                <span class="kw">return </span>!(is_builtin_key_or_sysvar(key) || <span class="self">self</span>.demote_program_id(key_index));
            }
        }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>{
        ...
        <span class="kw">crate</span>::{instruction::CompiledInstruction, message::MessageHeader, system_program, sysvar},
        itertools::Itertools,
    };
