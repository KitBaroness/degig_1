...
</pre></div><pre class="rust"><code><span class="doccomment">//! Sequences of [`Instruction`]s executed within a single transaction.
//!
...
</span><span class="kw">mod </span>compiled_keys;
...
</span><span class="attr">#[derive(Serialize, Deserialize, Default, Debug, PartialEq, Eq, Clone, Copy, AbiExample)]
