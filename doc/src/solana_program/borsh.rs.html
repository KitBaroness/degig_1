...
</pre></div><pre class="rust"><code><span class="doccomment">//! Utilities for the [borsh] serialization format.
//!
...
</span><span class="kw">use </span>borsh0_10::{maybestd::io::Error, BorshDeserialize, BorshSchema, BorshSerialize};
...
/// be used on-chain in the Solana SBF execution environment.
    ...
    note = <span class="string">"Please use `borsh0_10::get_packed_len` instead"
</span>)]
</span><span class="kw">pub fn </span>get_packed_len&lt;S: BorshSchema&gt;() -&gt; usize {
    <span class="attr">#[allow(deprecated)]
    </span><span class="kw">crate</span>::borsh0_10::get_packed_len::&lt;S&gt;()
}
...
/// as easily.
    ...
    since = <span class="string">"1.17.0"</span>,
    note = <span class="string">"Please use `borsh0_10::try_from_slice_unchecked` instead"
</span>)]
</span><span class="kw">pub fn </span>try_from_slice_unchecked&lt;T: BorshDeserialize&gt;(data: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;T, Error&gt; {
    <span class="attr">#[allow(deprecated)]
    </span><span class="kw">crate</span>::borsh0_10::try_from_slice_unchecked::&lt;T&gt;(data)
}
...
/// exists, to figure out how much space to allocate in an account.
    ...
    since = <span class="string">"1.17.0"</span>,
    note = <span class="string">"Please use `borsh0_10::get_instance_packed_len` instead"
</span>)]
</span><span class="kw">pub fn </span>get_instance_packed_len&lt;T: BorshSerialize&gt;(instance: <span class="kw-2">&amp;</span>T) -&gt; <span class="prelude-ty">Result</span>&lt;usize, Error&gt; {
    <span class="attr">#[allow(deprecated)]
    </span><span class="kw">crate</span>::borsh0_10::get_instance_packed_len(instance)
}

<span class="macro">macro_rules!</span> impl_get_packed_len_v0 {
