...
</pre></div><pre class="rust"><code><span class="doccomment">//! Information about epoch duration.
//!
...
//! # Ok::&lt;(), anyhow::Error&gt;(())
//! ```
</span><span class="kw">pub use </span><span class="kw">crate</span>::epoch_schedule::EpochSchedule;
<span class="kw">use crate</span>::{impl_sysvar_get, program_error::ProgramError, sysvar::Sysvar};

<span class="macro">crate::declare_sysvar_id!</span>(<span class="string">"SysvarEpochSchedu1e111111111111111111111111"</span>, EpochSchedule);

<span class="kw">impl </span>Sysvar <span class="kw">for </span>EpochSchedule {
    <span class="macro">impl_sysvar_get!</span>(sol_get_epoch_schedule_sysvar);
}
