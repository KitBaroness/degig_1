...
</pre></div><pre class="rust"><code><span class="doccomment">//! Information about recent blocks and their fee calculators.
//!
...
<span class="macro">declare_deprecated_sysvar_id!</span>(
    <span class="string">"SysvarRecentB1ockHashes11111111111111111111"</span>,
    RecentBlockhashes
);
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Eq <span class="kw">for </span>IterItem&lt;<span class="lifetime">'a</span>&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; PartialEq <span class="kw">for </span>IterItem&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span><span class="self">Self</span>) -&gt; bool {
        <span class="self">self</span>.<span class="number">0 </span>== other.<span class="number">0
    </span>}
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; Ord <span class="kw">for </span>IterItem&lt;<span class="lifetime">'a</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; PartialOrd <span class="kw">for </span>IterItem&lt;<span class="lifetime">'a</span>&gt; {
...
<span class="kw">impl </span>Sysvar <span class="kw">for </span>RecentBlockhashes {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>{<span class="kw">super</span>::<span class="kw-2">*</span>, <span class="kw">crate</span>::clock::MAX_PROCESSING_AGE};
