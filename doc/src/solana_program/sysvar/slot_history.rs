...
</pre></div><pre class="rust"><code><span class="doccomment">//! A bitvector of slots present over the last epoch.
//!
...
<span class="macro">crate::declare_sysvar_id!</span>(<span class="string">"SysvarS1otHistory11111111111111111111111111"</span>, SlotHistory);

<span class="kw">impl </span>Sysvar <span class="kw">for </span>SlotHistory {
    <span class="comment">// override
        ...
        </span><span class="number">131_097 </span><span class="comment">// golden, update if MAX_ENTRIES changes
    </span>}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">assert_eq!</span>(
            SlotHistory::size_of(),
            bincode::serialized_size(<span class="kw-2">&amp;</span>SlotHistory::default()).unwrap() <span class="kw">as </span>usize
        );
    }
}
