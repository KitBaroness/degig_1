...
</pre></div><pre class="rust"><code><span class="doccomment">//! Current cluster fees.
//!
...
<span class="macro">crate::declare_deprecated_sysvar_id!</span>(<span class="string">"SysvarFees111111111111111111111111111111111"</span>, Fees);

<span class="doccomment">/// Transaction fees.
...
</span><span class="kw">pub struct </span>Fees {
    <span class="kw">pub </span>fee_calculator: FeeCalculator,
}

<span class="kw">impl </span>Fees {
    <span class="kw">pub fn </span>new(fee_calculator: <span class="kw-2">&amp;</span>FeeCalculator) -&gt; <span class="self">Self </span>{
        <span class="attr">#[allow(deprecated)]
        </span><span class="self">Self </span>{
            fee_calculator: <span class="kw-2">*</span>fee_calculator,
        }
    }
}

<span class="kw">impl </span>Sysvar <span class="kw">for </span>Fees {
    <span class="macro">impl_sysvar_get!</span>(sol_get_fees_sysvar);
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>fees = Fees {
            fee_calculator: FeeCalculator {
                lamports_per_signature: <span class="number">1</span>,
            },
        };
        <span class="kw">let </span>cloned_fees = fees.clone();
        <span class="macro">assert_eq!</span>(cloned_fees, fees);
    }
}
