...
//! # Ok::&lt;(), anyhow::Error&gt;(())
//! ```
</span><span class="kw">pub use </span><span class="kw">crate</span>::rent::Rent;
<span class="kw">use crate</span>::{impl_sysvar_get, program_error::ProgramError, sysvar::Sysvar};

<span class="macro">crate::declare_sysvar_id!</span>(<span class="string">"SysvarRent111111111111111111111111111111111"</span>, Rent);

<span class="kw">impl </span>Sysvar <span class="kw">for </span>Rent {
    <span class="macro">impl_sysvar_get!</span>(sol_get_rent_sysvar);
}
