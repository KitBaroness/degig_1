...
</pre></div><pre class="rust"><code><span class="doccomment">//! History of stake activations and de-activations.
//!
...
</span><span class="kw">pub use </span><span class="kw">crate</span>::stake_history::StakeHistory;
<span class="kw">use </span><span class="kw">crate</span>::sysvar::Sysvar;

<span class="macro">crate::declare_sysvar_id!</span>(<span class="string">"SysvarStakeHistory1111111111111111111111111"</span>, StakeHistory);

<span class="kw">impl </span>Sysvar <span class="kw">for </span>StakeHistory {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>{<span class="kw">super</span>::<span class="kw-2">*</span>, <span class="kw">crate</span>::stake_history::<span class="kw-2">*</span>};
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_create_account() {
        <span class="kw">let </span><span class="kw-2">mut </span>stake_history = StakeHistory::default();
