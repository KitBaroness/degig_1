...
</pre></div><pre class="rust"><code><span class="doccomment">//! Epoch rewards for current epoch
//!
...
</span><span class="kw">pub use </span><span class="kw">crate</span>::epoch_rewards::EpochRewards;
<span class="kw">use crate</span>::{impl_sysvar_get, program_error::ProgramError, sysvar::Sysvar};

<span class="macro">crate::declare_sysvar_id!</span>(<span class="string">"SysvarEpochRewards1111111111111111111111111"</span>, EpochRewards);

<span class="kw">impl </span>Sysvar <span class="kw">for </span>EpochRewards {
    <span class="macro">impl_sysvar_get!</span>(sol_get_epoch_rewards_sysvar);
}
