...
</pre></div><pre class="rust"><code><span class="doccomment">//! Hashing with the [keccak] (SHA-3) hash function.
//!
...
<span class="kw">impl </span>Hasher {
    ...
    <span class="kw">pub fn </span>result(<span class="self">self</span>) -&gt; Hash {
        <span class="comment">// At the time of this writing, the sha3 library is stuck on an old version
...
<span class="doccomment">/// Return a Keccak256 hash for the given data.
    ...
    <span class="comment">// Call via a system call to perform the calculation
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">crate</span>::syscalls::sol_keccak256(
