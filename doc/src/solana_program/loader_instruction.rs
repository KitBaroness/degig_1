...
</pre></div><pre class="rust"><code><span class="doccomment">//! Instructions for the [non-upgradable BPF loader][nubpfl].
//!
...
<span class="kw">pub fn </span>write(
...
<span class="kw">pub fn </span>finalize(account_pubkey: <span class="kw-2">&amp;</span>Pubkey, program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; Instruction {
