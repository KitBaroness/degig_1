...
</pre></div><pre class="rust"><code><span class="doccomment">//! The latest BPF loader native program.
//!
...
</span><span class="macro">crate::declare_id!</span>(<span class="string">"BPFLoader2111111111111111111111111111111111"</span>);
