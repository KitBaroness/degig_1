...
/// ```
    ...
    <span class="doccomment">/// Sets `self` to the additive identity element of `Self`, `0`.
    </span><span class="kw">fn </span>set_zero(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw-2">*</span><span class="self">self </span>= Zero::zero();
    }
...
<span class="doccomment">/// Defines an associated constant representing the additive identity element
/// for `Self`.
</span><span class="kw">pub trait </span>ConstZero: Zero {
    <span class="doccomment">/// The additive identity element of `Self`, `0`.
...
<span class="macro">macro_rules!</span> zero_impl {
    (<span class="macro-nonterminal">$t</span>:ty, <span class="macro-nonterminal">$v</span>:expr) =&gt; {
        ...
        <span class="kw">impl </span>ConstZero <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            <span class="kw">const </span>ZERO: <span class="self">Self </span>= <span class="macro-nonterminal">$v</span>;
        }
    };
}
...
<span class="macro">zero_impl!</span>(u128, <span class="number">0</span>);
...
<span class="macro">zero_impl!</span>(i128, <span class="number">0</span>);
    ...
    </span>Wrapping&lt;T&gt;: Add&lt;Output = Wrapping&lt;T&gt;&gt;,
{
    ...
    <span class="kw">fn </span>set_zero(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="self">self</span>.<span class="number">0</span>.set_zero();
    }
...
<span class="kw">impl</span>&lt;T: ConstZero&gt; ConstZero <span class="kw">for </span>Wrapping&lt;T&gt;
<span class="kw">where
    </span>Wrapping&lt;T&gt;: Add&lt;Output = Wrapping&lt;T&gt;&gt;,
{
    <span class="kw">const </span>ZERO: <span class="self">Self </span>= Wrapping(T::ZERO);
}
...
/// ```
    ...
    <span class="doccomment">/// Sets `self` to the multiplicative identity element of `Self`, `1`.
    </span><span class="kw">fn </span>set_one(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="kw-2">*</span><span class="self">self </span>= One::one();
    }
...
<span class="doccomment">/// Defines an associated constant representing the multiplicative identity
/// element for `Self`.
</span><span class="kw">pub trait </span>ConstOne: One {
    <span class="doccomment">/// The multiplicative identity element of `Self`, `1`.
...
<span class="macro">macro_rules!</span> one_impl {
    (<span class="macro-nonterminal">$t</span>:ty, <span class="macro-nonterminal">$v</span>:expr) =&gt; {
        ...
        <span class="kw">impl </span>ConstOne <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            <span class="kw">const </span>ONE: <span class="self">Self </span>= <span class="macro-nonterminal">$v</span>;
        }
    };
}
...
<span class="macro">one_impl!</span>(u128, <span class="number">1</span>);
...
<span class="macro">one_impl!</span>(i128, <span class="number">1</span>);
...
{
    <span class="kw">fn </span>set_one(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        <span class="self">self</span>.<span class="number">0</span>.set_one();
    }
...
<span class="kw">impl</span>&lt;T: ConstOne&gt; ConstOne <span class="kw">for </span>Wrapping&lt;T&gt;
<span class="kw">where
    </span>Wrapping&lt;T&gt;: Mul&lt;Output = Wrapping&lt;T&gt;&gt;,
{
    <span class="kw">const </span>ONE: <span class="self">Self </span>= Wrapping(T::ONE);
}
