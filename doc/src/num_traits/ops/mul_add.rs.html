...
</pre></div><pre class="rust"><code><span class="doccomment">/// Fused multiply-add. Computes `(self * a) + b` with only one rounding
...
/// ```
    ...
    <span class="doccomment">/// Performs the fused multiply-add operation `(self * a) + b`
    </span><span class="kw">fn </span>mul_add(<span class="self">self</span>, a: A, b: B) -&gt; <span class="self">Self</span>::Output;
}

<span class="doccomment">/// The fused multiply-add assignment operation `*self = (*self * a) + b`
</span><span class="kw">pub trait </span>MulAddAssign&lt;A = <span class="self">Self</span>, B = <span class="self">Self</span>&gt; {
    <span class="doccomment">/// Performs the fused multiply-add assignment operation `*self = (*self * a) + b`
...
<span class="attr">#[cfg(any(feature = <span class="string">"std"</span>, feature = <span class="string">"libm"</span>))]
    ...
    <span class="attr">#[inline]
        ...
        &lt;<span class="self">Self </span><span class="kw">as </span><span class="kw">crate</span>::Float&gt;::mul_add(<span class="self">self</span>, a, b)
    }
}
...
<span class="macro">mul_add_impl!</span>(MulAdd <span class="kw">for </span>isize i8 i16 i32 i64 i128);
<span class="macro">mul_add_impl!</span>(MulAdd <span class="kw">for </span>usize u8 u16 u32 u64 u128);
...
<span class="attr">#[cfg(any(feature = <span class="string">"std"</span>, feature = <span class="string">"libm"</span>))]
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw-2">*</span><span class="self">self </span>= &lt;<span class="self">Self </span><span class="kw">as </span><span class="kw">crate</span>::Float&gt;::mul_add(<span class="kw-2">*</span><span class="self">self</span>, a, b)
    }
}
...
<span class="macro">mul_add_assign_impl!</span>(MulAddAssign <span class="kw">for </span>isize i8 i16 i32 i64 i128);
<span class="macro">mul_add_assign_impl!</span>(MulAddAssign <span class="kw">for </span>usize u8 u16 u32 u64 u128);
                ...
                $(
                    {
                        ...
                        <span class="macro">assert!</span>(abs_difference &lt;= <span class="number">46.4 </span>* <span class="macro-nonterminal">$t::EPSILON</span>);
                    }
                )+
            };
        }
