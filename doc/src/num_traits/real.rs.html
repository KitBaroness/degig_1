...
</pre></div><pre class="rust"><code><span class="attr">#![cfg(any(feature = <span class="string">"std"</span>, feature = <span class="string">"libm"</span>))]

</span><span class="kw">use </span>core::ops::Neg;

<span class="kw">use crate</span>::{Float, Num, NumCast};
