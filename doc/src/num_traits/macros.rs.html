...
<a href="#44" id="44">44</a>
</pre></div><pre class="rust"><code><span class="comment">// not all are used in all features configurations
    ...
    ($( <span class="macro-nonterminal">$imp</span>:path <span class="kw">as </span><span class="macro-nonterminal">$method</span>:ident ( <span class="self">self </span>$( , <span class="macro-nonterminal">$arg</span>:ident : <span class="macro-nonterminal">$ty</span>:ty )* ) -&gt; <span class="macro-nonterminal">$ret</span>:ty ; )<span class="kw-2">*</span>)
        =&gt; {$(
            <span class="attr">#[inline]
            </span><span class="kw">fn </span><span class="macro-nonterminal">$method</span>(<span class="self">self </span>$( , <span class="macro-nonterminal">$arg </span>: <span class="macro-nonterminal">$ty </span>)* ) -&gt; <span class="macro-nonterminal">$ret </span>{
                <span class="macro-nonterminal">$imp</span>(<span class="self">self </span>$( , <span class="macro-nonterminal">$arg </span>)* )
            }
        )<span class="kw-2">*</span>};
}
