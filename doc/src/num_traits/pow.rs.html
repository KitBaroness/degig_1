...
</pre></div><pre class="rust"><code><span class="kw">use crate</span>::{CheckedMul, One};
...
<span class="macro">pow_impl!</span>(u128, u8, u32, u128::pow);
<span class="macro">pow_impl!</span>(u128, u16, u32, u128::pow);
<span class="macro">pow_impl!</span>(u128, u32, u32, u128::pow);
<span class="macro">pow_impl!</span>(u128, usize);

<span class="macro">pow_impl!</span>(i128, u8, u32, i128::pow);
<span class="macro">pow_impl!</span>(i128, u16, u32, i128::pow);
<span class="macro">pow_impl!</span>(i128, u32, u32, i128::pow);
<span class="macro">pow_impl!</span>(i128, usize);
...
<span class="macro">pow_impl!</span>(Wrapping&lt;u128&gt;);
<span class="macro">pow_impl!</span>(Wrapping&lt;i128&gt;);
...
// pow_impl!(isize, u64);
    ...
    <span class="macro">pow_impl!</span>(f32, i8, i32, &lt;f32 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f32, u8, i32, &lt;f32 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f32, i16, i32, &lt;f32 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f32, u16, i32, &lt;f32 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f32, i32, i32, &lt;f32 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f64, i8, i32, &lt;f64 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f64, u8, i32, &lt;f64 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f64, i16, i32, &lt;f64 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f64, u16, i32, &lt;f64 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f64, i32, i32, &lt;f64 <span class="kw">as </span>Float&gt;::powi);
    <span class="macro">pow_impl!</span>(f32, f32, f32, &lt;f32 <span class="kw">as </span>Float&gt;::powf);
    <span class="macro">pow_impl!</span>(f64, f32, f64, &lt;f64 <span class="kw">as </span>Float&gt;::powf);
    <span class="macro">pow_impl!</span>(f64, f64, f64, &lt;f64 <span class="kw">as </span>Float&gt;::powf);
}
...
/// ```
    ...
    <span class="kw">while </span>exp &amp; <span class="number">1 </span>== <span class="number">0 </span>{
        base = base.checked_mul(<span class="kw-2">&amp;</span>base)<span class="question-mark">?</span>;
        exp &gt;&gt;= <span class="number">1</span>;
    }
    <span class="kw">if </span>exp == <span class="number">1 </span>{
    ...
    <span class="kw">while </span>exp &gt; <span class="number">1 </span>{
        ...
        base = base.checked_mul(<span class="kw-2">&amp;</span>base)<span class="question-mark">?</span>;
        <span class="kw">if </span>exp &amp; <span class="number">1 </span>== <span class="number">1 </span>{
            acc = acc.checked_mul(<span class="kw-2">&amp;</span>base)<span class="question-mark">?</span>;
        }
    }
