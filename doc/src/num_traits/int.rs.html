...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::ops::{BitAnd, BitOr, BitXor, Not, Shl, Shr};

<span class="kw">use </span><span class="kw">crate</span>::bounds::Bounded;
<span class="kw">use </span><span class="kw">crate</span>::ops::checked::<span class="kw-2">*</span>;
<span class="kw">use </span><span class="kw">crate</span>::ops::saturating::Saturating;
<span class="kw">use crate</span>::{Num, NumCast};
...
<span class="macro">macro_rules!</span> prim_int_impl {
    (<span class="macro-nonterminal">$T</span>:ty, <span class="macro-nonterminal">$S</span>:ty, <span class="macro-nonterminal">$U</span>:ty) =&gt; {
        <span class="kw">impl </span>PrimInt <span class="kw">for </span><span class="macro-nonterminal">$T </span>{
            ...
            <span class="attr">#[cfg(has_leading_trailing_ones)]
            #[inline]
            </span><span class="kw">fn </span>leading_ones(<span class="self">self</span>) -&gt; u32 {
            ...
            <span class="attr">#[cfg(has_reverse_bits)]
            #[inline]
            </span><span class="kw">fn </span>reverse_bits(<span class="self">self</span>) -&gt; <span class="self">Self </span>{
...
<span class="macro">prim_int_impl!</span>(u128, i128, u128);
...
<span class="macro">prim_int_impl!</span>(i128, i128, u128);
<span class="macro">prim_int_impl!</span>(isize, isize, usize);

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>tests {
    <span class="kw">use </span><span class="kw">crate</span>::int::PrimInt;
