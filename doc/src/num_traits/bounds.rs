...
<span class="doccomment">/// Numbers which have lower bounds
</span><span class="kw">pub trait </span>LowerBounded {
    <span class="doccomment">/// Returns the smallest finite number this type can represent
    </span><span class="kw">fn </span>min_value() -&gt; <span class="self">Self</span>;
}

<span class="comment">// FIXME: With a major version bump, this should be a supertrait instead
</span><span class="kw">impl</span>&lt;T: Bounded&gt; LowerBounded <span class="kw">for </span>T {
    <span class="kw">fn </span>min_value() -&gt; T {
        Bounded::min_value()
    }
}

<span class="doccomment">/// Numbers which have upper bounds
</span><span class="kw">pub trait </span>UpperBounded {
    <span class="doccomment">/// Returns the largest finite number this type can represent
    </span><span class="kw">fn </span>max_value() -&gt; <span class="self">Self</span>;
}

<span class="comment">// FIXME: With a major version bump, this should be a supertrait instead
</span><span class="kw">impl</span>&lt;T: Bounded&gt; UpperBounded <span class="kw">for </span>T {
    <span class="kw">fn </span>max_value() -&gt; T {
        Bounded::max_value()
    }
}
...
<span class="macro">bounded_impl!</span>(u128, u128::MIN, u128::MAX);
...
<span class="macro">bounded_impl!</span>(i128, i128::MIN, i128::MAX);
