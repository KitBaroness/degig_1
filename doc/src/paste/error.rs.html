...
<span class="kw">impl </span>Error {
    <span class="kw">pub fn </span>new(span: Span, msg: <span class="kw-2">&amp;</span>str) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::new2(span, span, msg)
    }

    <span class="kw">pub fn </span>new2(begin: Span, end: Span, msg: <span class="kw-2">&amp;</span>str) -&gt; <span class="self">Self </span>{
        Error {
            begin,
            end,
            msg: msg.to_owned(),
    ...
    <span class="kw">pub fn </span>to_compile_error(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; TokenStream {
