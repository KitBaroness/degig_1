...
<span class="attr">#[cfg(feature = <span class="string">"portable-atomic"</span>)]
</span><span class="kw">use </span>portable_atomic <span class="kw">as </span>atomic;

<span class="attr">#[cfg(not(feature = <span class="string">"portable-atomic"</span>))]
