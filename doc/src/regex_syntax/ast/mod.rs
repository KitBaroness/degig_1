...
#[cfg_attr(feature = <span class="string">"arbitrary"</span>, derive(arbitrary::Arbitrary))]
    ...
    <span class="doccomment">/// The special word boundary syntax, `\b{something}`, was used, but
    /// either EOF without `}` was seen, or an invalid character in the
    /// braces was seen.
    </span>SpecialWordBoundaryUnclosed,
    <span class="doccomment">/// The special word boundary syntax, `\b{something}`, was used, but
    /// `something` was not recognized as a valid word boundary kind.
    </span>SpecialWordBoundaryUnrecognized,
    <span class="doccomment">/// The syntax `\b{` was observed, but afterwards the end of the pattern
    ...
    /// boundary assertion.
    </span>SpecialWordOrRepetitionUnexpectedEof,
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            SpecialWordBoundaryUnclosed =&gt; {
                <span class="macro">write!</span>(
                    f,
                    <span class="string">"special word boundary assertion is either \
                     unclosed or contains an invalid character"</span>,
                )
            }
            SpecialWordBoundaryUnrecognized =&gt; {
                <span class="macro">write!</span>(
                    f,
                    <span class="string">"unrecognized special word boundary assertion, \
            ...
            SpecialWordOrRepetitionUnexpectedEof =&gt; {
                <span class="macro">write!</span>(
                    f,
                    <span class="string">"found either the beginning of a special word \
                     boundary or a bounded repetition on a \\b with \
                     an opening brace, but no closing brace"</span>,
                )
            }
            UnicodeClassInvalid =&gt; {
...
#[cfg_attr(feature = <span class="string">"arbitrary"</span>, derive(arbitrary::Arbitrary))]
    ...
    </span>Flags(Box&lt;SetFlags&gt;),
    <span class="doccomment">/// A single character literal, which includes escape sequences.
    </span>Literal(Box&lt;Literal&gt;),
    <span class="doccomment">/// The "any character" class.
    </span>Dot(Box&lt;Span&gt;),
    <span class="doccomment">/// A single zero-width assertion.
    </span>Assertion(Box&lt;Assertion&gt;),
    <span class="doccomment">/// A single Unicode character class, e.g., `\pL` or `\p{Greek}`.
    </span>ClassUnicode(Box&lt;ClassUnicode&gt;),
    <span class="doccomment">/// A single perl character class, e.g., `\d` or `\W`.
    </span>ClassPerl(Box&lt;ClassPerl&gt;),
    <span class="doccomment">/// A single bracketed character class set, which may contain zero or more
    /// character ranges and/or zero or more nested classes. e.g.,
    /// `[a-zA-Z\pL]`.
    </span>ClassBracketed(Box&lt;ClassBracketed&gt;),
    <span class="doccomment">/// A repetition operator applied to an arbitrary regular expression.
    </span>Repetition(Box&lt;Repetition&gt;),
    <span class="doccomment">/// A grouped regular expression.
    </span>Group(Box&lt;Group&gt;),
    <span class="doccomment">/// An alternation of regular expressions.
    </span>Alternation(Box&lt;Alternation&gt;),
    <span class="doccomment">/// A concatenation of regular expressions.
    </span>Concat(Box&lt;Concat&gt;),
}

<span class="kw">impl </span>Ast {
    <span class="doccomment">/// Create an "empty" AST item.
    </span><span class="kw">pub fn </span>empty(span: Span) -&gt; Ast {
        Ast::Empty(Box::new(span))
    }

    <span class="doccomment">/// Create a "flags" AST item.
    </span><span class="kw">pub fn </span>flags(e: SetFlags) -&gt; Ast {
        Ast::Flags(Box::new(e))
    }

    <span class="doccomment">/// Create a "literal" AST item.
    </span><span class="kw">pub fn </span>literal(e: Literal) -&gt; Ast {
        Ast::Literal(Box::new(e))
    }

    <span class="doccomment">/// Create a "dot" AST item.
    </span><span class="kw">pub fn </span>dot(span: Span) -&gt; Ast {
        Ast::Dot(Box::new(span))
    }

    <span class="doccomment">/// Create a "assertion" AST item.
    </span><span class="kw">pub fn </span>assertion(e: Assertion) -&gt; Ast {
        Ast::Assertion(Box::new(e))
    }

    <span class="doccomment">/// Create a "Unicode class" AST item.
    </span><span class="kw">pub fn </span>class_unicode(e: ClassUnicode) -&gt; Ast {
        Ast::ClassUnicode(Box::new(e))
    }

    <span class="doccomment">/// Create a "Perl class" AST item.
    </span><span class="kw">pub fn </span>class_perl(e: ClassPerl) -&gt; Ast {
        Ast::ClassPerl(Box::new(e))
    }

    <span class="doccomment">/// Create a "bracketed class" AST item.
    </span><span class="kw">pub fn </span>class_bracketed(e: ClassBracketed) -&gt; Ast {
        Ast::ClassBracketed(Box::new(e))
    }

    <span class="doccomment">/// Create a "repetition" AST item.
    </span><span class="kw">pub fn </span>repetition(e: Repetition) -&gt; Ast {
        Ast::Repetition(Box::new(e))
    }

    <span class="doccomment">/// Create a "group" AST item.
    </span><span class="kw">pub fn </span>group(e: Group) -&gt; Ast {
        Ast::Group(Box::new(e))
    }

    <span class="doccomment">/// Create a "alternation" AST item.
    </span><span class="kw">pub fn </span>alternation(e: Alternation) -&gt; Ast {
        Ast::Alternation(Box::new(e))
    }

    <span class="doccomment">/// Create a "concat" AST item.
    </span><span class="kw">pub fn </span>concat(e: Concat) -&gt; Ast {
    ...
    <span class="doccomment">/// Return the span of this abstract syntax tree.
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            Ast::ClassUnicode(<span class="kw-2">ref </span>x) =&gt; <span class="kw-2">&amp;</span>x.span,
            Ast::ClassPerl(<span class="kw-2">ref </span>x) =&gt; <span class="kw-2">&amp;</span>x.span,
    ...
    /// subexpressions.
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            | Ast::ClassPerl(<span class="kw">_</span>) =&gt; <span class="bool-val">false</span>,
...
<span class="attr">#[cfg(feature = <span class="string">"arbitrary"</span>)]
</span><span class="kw">impl </span>arbitrary::Arbitrary&lt;<span class="lifetime">'_</span>&gt; <span class="kw">for </span>ClassUnicodeKind {
    <span class="kw">fn </span>arbitrary(
        u: <span class="kw-2">&amp;mut </span>arbitrary::Unstructured,
        ...
        <span class="attr">#[cfg(any(
            ...
            <span class="kw">use </span><span class="kw">super</span>::unicode_tables::{
                property_names::PROPERTY_NAMES,
                property_values::PROPERTY_VALUES,
            };

            <span class="kw">match </span>u.choose_index(<span class="number">3</span>)<span class="question-mark">? </span>{
                <span class="number">0 </span>=&gt; {
                    <span class="kw">let </span>all = PROPERTY_VALUES
                        .iter()
                        .flat_map(|e| e.<span class="number">1</span>.iter())
                        .filter(|(name, <span class="kw">_</span>)| name.len() == <span class="number">1</span>)
                        .count();
                    <span class="kw">let </span>idx = u.choose_index(all)<span class="question-mark">?</span>;
                    <span class="kw">let </span>value = PROPERTY_VALUES
                        .iter()
                        .flat_map(|e| e.<span class="number">1</span>.iter())
                        .take(idx + <span class="number">1</span>)
                        .last()
                        .unwrap()
                        .<span class="number">0
                        </span>.chars()
                        .next()
                        .unwrap();
                    <span class="prelude-val">Ok</span>(ClassUnicodeKind::OneLetter(value))
                }
                <span class="number">1 </span>=&gt; {
                    <span class="kw">let </span>all = PROPERTY_VALUES
                        .iter()
                        .map(|e| e.<span class="number">1</span>.len())
                        .sum::&lt;usize&gt;()
                        + PROPERTY_NAMES.len();
                    <span class="kw">let </span>idx = u.choose_index(all)<span class="question-mark">?</span>;
                    <span class="kw">let </span>name = PROPERTY_VALUES
                        .iter()
                        .flat_map(|e| e.<span class="number">1</span>.iter())
                        ...
                        .last()
                        .unwrap();
                    <span class="prelude-val">Ok</span>(ClassUnicodeKind::Named(name.to_string()))
                }
                <span class="number">2 </span>=&gt; {
                    <span class="kw">let </span>all = PROPERTY_VALUES
                        ...
                        .sum::&lt;usize&gt;();
                    <span class="kw">let </span>idx = u.choose_index(all)<span class="question-mark">?</span>;
                    <span class="kw">let </span>(prop, value) = PROPERTY_VALUES
                        .iter()
                        .flat_map(|e| {
                            e.<span class="number">1</span>.iter().map(|(<span class="kw">_</span>, value)| (e.<span class="number">0</span>, value))
                        })
                        .take(idx + <span class="number">1</span>)
                        .last()
                        .unwrap();
                    <span class="prelude-val">Ok</span>(ClassUnicodeKind::NamedValue {
                        op: u.arbitrary()<span class="question-mark">?</span>,
                        name: prop.to_string(),
                        value: value.to_string(),
                    })
                }
                <span class="kw">_ </span>=&gt; <span class="macro">unreachable!</span>(<span class="string">"index chosen is impossible"</span>),
            }
        }
        <span class="attr">#[cfg(not(any(
            ...
            <span class="kw">match </span>u.choose_index(<span class="number">3</span>)<span class="question-mark">? </span>{
                <span class="number">0 </span>=&gt; <span class="prelude-val">Ok</span>(ClassUnicodeKind::OneLetter(u.arbitrary()<span class="question-mark">?</span>)),
                <span class="number">1 </span>=&gt; <span class="prelude-val">Ok</span>(ClassUnicodeKind::Named(u.arbitrary()<span class="question-mark">?</span>)),
                <span class="number">2 </span>=&gt; <span class="prelude-val">Ok</span>(ClassUnicodeKind::NamedValue {
                    op: u.arbitrary()<span class="question-mark">?</span>,
                    name: u.arbitrary()<span class="question-mark">?</span>,
                    value: u.arbitrary()<span class="question-mark">?</span>,
                }),
                <span class="kw">_ </span>=&gt; <span class="macro">unreachable!</span>(<span class="string">"index chosen is impossible"</span>),
            }
        }
    ...
    <span class="kw">fn </span>size_hint(depth: usize) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        <span class="attr">#[cfg(any(
            ...
            arbitrary::size_hint::and_all(<span class="kw-2">&amp;</span>[
        ...
        <span class="attr">#[cfg(not(any(
            ...
            arbitrary::size_hint::and(
                usize::size_hint(depth),
                arbitrary::size_hint::or_all(<span class="kw-2">&amp;</span>[
...
#[cfg_attr(feature = <span class="string">"arbitrary"</span>, derive(arbitrary::Arbitrary))]
    ...
    <span class="doccomment">/// `\b{start}`
    </span>WordBoundaryStart,
    <span class="doccomment">/// `\b{end}`
    </span>WordBoundaryEnd,
    <span class="doccomment">/// `\&lt;` (alias for `\b{start}`)
    </span>WordBoundaryStartAngle,
    <span class="doccomment">/// `\&gt;` (alias for `\b{end}`)
    </span>WordBoundaryEndAngle,
    <span class="doccomment">/// `\b{start-half}`
    </span>WordBoundaryStartHalf,
    <span class="doccomment">/// `\b{end-half}`
    </span>WordBoundaryEndHalf,
}
...
<span class="attr">#[cfg(feature = <span class="string">"arbitrary"</span>)]
</span><span class="kw">impl </span>arbitrary::Arbitrary&lt;<span class="lifetime">'_</span>&gt; <span class="kw">for </span>CaptureName {
    <span class="kw">fn </span>arbitrary(
        u: <span class="kw-2">&amp;mut </span>arbitrary::Unstructured,
    ) -&gt; arbitrary::Result&lt;CaptureName&gt; {
        <span class="kw">let </span>len = u.arbitrary_len::&lt;char&gt;()<span class="question-mark">?</span>;
        <span class="kw">if </span>len == <span class="number">0 </span>{
            <span class="kw">return </span><span class="prelude-val">Err</span>(arbitrary::Error::NotEnoughData);
        }
        ...
        <span class="kw">for _ in </span><span class="number">0</span>..len {
            <span class="kw">let </span>ch: char = u.arbitrary()<span class="question-mark">?</span>;
            <span class="kw">let </span>cp = u32::from(ch);
            <span class="kw">let </span>ascii_letter_offset = u8::try_from(cp % <span class="number">26</span>).unwrap();
            <span class="kw">let </span>ascii_letter = <span class="string">b'a' </span>+ ascii_letter_offset;
            name.push(char::from(ascii_letter));
        }
        <span class="prelude-val">Ok</span>(CaptureName { span: u.arbitrary()<span class="question-mark">?</span>, name, index: u.arbitrary()<span class="question-mark">? </span>})
    }
...
/// space but heap space proportional to the depth of the `Ast`.
    ...
    <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            <span class="comment">// Bracketed classes are recursive, they get their own Drop impl.
            </span>| Ast::ClassBracketed(<span class="kw">_</span>) =&gt; <span class="kw">return</span>,
        ...
        <span class="kw">while let </span><span class="prelude-val">Some</span>(<span class="kw-2">mut </span>ast) = stack.pop() {
            <span class="kw">match </span>ast {
                ...
                | Ast::ClassUnicode(<span class="kw">_</span>)
                | Ast::ClassPerl(<span class="kw">_</span>)
                <span class="comment">// Bracketed classes are recursive, so they get their own Drop
                // impl.
                </span>| Ast::ClassBracketed(<span class="kw">_</span>) =&gt; {}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="comment">// This tests that our `Ast` has a reasonable size. This isn't a hard rule
    ...
    </span><span class="kw">fn </span>ast_size() {
        <span class="kw">let </span>max = <span class="number">2 </span>* core::mem::size_of::&lt;usize&gt;();
        <span class="kw">let </span>size = core::mem::size_of::&lt;Ast&gt;();
        <span class="macro">assert!</span>(
            size &lt;= max,
            <span class="string">"Ast size of {} bytes is bigger than suggested max {}"</span>,
            size,
            max
        );
    }
