...
/// in the range.
</span><span class="attr">#[derive(Clone, Copy, Default, Eq, PartialEq, PartialOrd, Ord)]
...
<span class="doccomment">/// A set of characters represented by arbitrary bytes.
///
