...
<span class="kw">impl</span>&lt;W: fmt::Write&gt; Visitor <span class="kw">for </span>Writer&lt;W&gt; {
    ...
    <span class="kw">fn </span>visit_pre(<span class="kw-2">&amp;mut </span><span class="self">self</span>, hir: <span class="kw-2">&amp;</span>Hir) -&gt; fmt::Result {
        <span class="kw">match </span><span class="kw-2">*</span>hir.kind() {
            HirKind::Empty =&gt; {
                <span class="comment">// Technically an empty sub-expression could be "printed" by
                ...
                </span><span class="self">self</span>.wtr.write_str(<span class="string">r"(?:)"</span>)<span class="question-mark">?</span>;
            }
            <span class="comment">// Repetition operators are strictly suffix oriented.
            </span>HirKind::Repetition(<span class="kw">_</span>) =&gt; {}
            HirKind::Literal(hir::Literal(<span class="kw-2">ref </span>bytes)) =&gt; {
                <span class="comment">// See the comment on the 'Concat' and 'Alternation' case below
                ...
                </span><span class="kw">let </span>result = core::str::from_utf8(bytes);
                <span class="kw">let </span>len = result.map_or(bytes.len(), |s| s.chars().count());
                <span class="kw">if </span>len &gt; <span class="number">1 </span>{
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"(?:"</span>)<span class="question-mark">?</span>;
                }
            ...
            HirKind::Class(hir::Class::Unicode(<span class="kw-2">ref </span>cls)) =&gt; {
                <span class="kw">if </span>cls.ranges().is_empty() {
                    <span class="kw">return </span><span class="self">self</span>.wtr.write_str(<span class="string">"[a&amp;&amp;b]"</span>);
                }
                ...
                <span class="kw">for </span>range <span class="kw">in </span>cls.iter() {
                    ...
                    } <span class="kw">else if </span>u32::from(range.start()) + <span class="number">1
                        </span>== u32::from(range.end())
                    {
                        <span class="self">self</span>.write_literal_char(range.start())<span class="question-mark">?</span>;
            ...
            HirKind::Class(hir::Class::Bytes(<span class="kw-2">ref </span>cls)) =&gt; {
                ...
                <span class="kw">for </span>range <span class="kw">in </span>cls.iter() {
                    ...
                    } <span class="kw">else if </span>range.start() + <span class="number">1 </span>== range.end() {
                        <span class="self">self</span>.write_literal_class_byte(range.start())<span class="question-mark">?</span>;
            ...
            HirKind::Look(<span class="kw-2">ref </span>look) =&gt; <span class="kw">match </span><span class="kw-2">*</span>look {
                hir::Look::Start =&gt; {
                ...
                hir::Look::StartCRLF =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">"(?mR:^)"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::EndCRLF =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">"(?mR:$)"</span>)<span class="question-mark">?</span>;
                }
                ...
                hir::Look::WordStartAscii =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"(?-u:\b{start})"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordEndAscii =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"(?-u:\b{end})"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordStartUnicode =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"\b{start}"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordEndUnicode =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"\b{end}"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordStartHalfAscii =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"(?-u:\b{start-half})"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordEndHalfAscii =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"(?-u:\b{end-half})"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordStartHalfUnicode =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"\b{start-half}"</span>)<span class="question-mark">?</span>;
                }
                hir::Look::WordEndHalfUnicode =&gt; {
                    <span class="self">self</span>.wtr.write_str(<span class="string">r"\b{end-half}"</span>)<span class="question-mark">?</span>;
                }
            },
            HirKind::Capture(hir::Capture { <span class="kw-2">ref </span>name, .. }) =&gt; {
                <span class="self">self</span>.wtr.write_str(<span class="string">"("</span>)<span class="question-mark">?</span>;
                <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>name) = <span class="kw-2">*</span>name {
                    <span class="macro">write!</span>(<span class="self">self</span>.wtr, <span class="string">"?P&lt;{}&gt;"</span>, name)<span class="question-mark">?</span>;
                }
            }
            <span class="comment">// Why do this? Wrapping concats and alts in non-capturing groups
            ...
            </span>HirKind::Concat(<span class="kw">_</span>) | HirKind::Alternation(<span class="kw">_</span>) =&gt; {
                <span class="self">self</span>.wtr.write_str(<span class="string">r"(?:"</span>)<span class="question-mark">?</span>;
            }
        }
        <span class="prelude-val">Ok</span>(())
    ...
    <span class="kw">fn </span>visit_post(<span class="kw-2">&amp;mut </span><span class="self">self</span>, hir: <span class="kw-2">&amp;</span>Hir) -&gt; fmt::Result {
        <span class="kw">match </span><span class="kw-2">*</span>hir.kind() {
            ...
            HirKind::Repetition(<span class="kw-2">ref </span>x) =&gt; {
                <span class="kw">match </span>(x.min, x.max) {
                    (<span class="number">0</span>, <span class="prelude-val">Some</span>(<span class="number">1</span>)) =&gt; {
                        <span class="self">self</span>.wtr.write_str(<span class="string">"?"</span>)<span class="question-mark">?</span>;
                    }
                    ...
                    (<span class="number">1</span>, <span class="prelude-val">Some</span>(<span class="number">1</span>)) =&gt; {
                        <span class="comment">// 'a{1}' and 'a{1}?' are exactly equivalent to 'a'.
                    ...
                    (m, <span class="prelude-val">Some</span>(n)) <span class="kw">if </span>m == n =&gt; {
                        <span class="macro">write!</span>(<span class="self">self</span>.wtr, <span class="string">"{{{}}}"</span>, m)<span class="question-mark">?</span>;
                        <span class="comment">// a{m} and a{m}? are always exactly equivalent.
                        </span><span class="kw">return </span><span class="prelude-val">Ok</span>(());
                    }
            ...
            HirKind::Capture(<span class="kw">_</span>)
...
<span class="kw">impl</span>&lt;W: fmt::Write&gt; Writer&lt;W&gt; {
    ...
    <span class="kw">fn </span>write_literal_byte(<span class="kw-2">&amp;mut </span><span class="self">self</span>, b: u8) -&gt; fmt::Result {
        <span class="kw">if </span>b &lt;= <span class="number">0x7F </span>&amp;&amp; !b.is_ascii_control() &amp;&amp; !b.is_ascii_whitespace() {
            <span class="self">self</span>.write_literal_char(char::try_from(b).unwrap())
        } <span class="kw">else </span>{
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">fn </span>roundtrip_bytes(given: <span class="kw-2">&amp;</span>str, expected: <span class="kw-2">&amp;</span>str) {
        roundtrip_with(|b| b.utf8(<span class="bool-val">false</span>), given, expected);
    }
    ...
    <span class="attr">#[test]
        ...
        roundtrip(<span class="string">r"[ab]"</span>, <span class="string">r"[ab]"</span>);
        ...
        roundtrip(<span class="string">r"(?-u)[a]"</span>, <span class="string">r"a"</span>);
        roundtrip(<span class="string">r"(?-u)[ab]"</span>, <span class="string">r"(?-u:[ab])"</span>);
        ...
        </span>roundtrip_bytes(<span class="string">r"(?-u)[\[]"</span>, <span class="string">r"\["</span>);
        ...
        <span class="comment">// This tests that an empty character class is correctly roundtripped.
        </span><span class="attr">#[cfg(feature = <span class="string">"unicode-gencat"</span>)]
        </span>roundtrip(<span class="string">r"\P{any}"</span>, <span class="string">r"[a&amp;&amp;b]"</span>);
        roundtrip_bytes(<span class="string">r"(?-u)[^\x00-\xFF]"</span>, <span class="string">r"[a&amp;&amp;b]"</span>);
    }
    ...
    <span class="attr">#[test]
        ...
        roundtrip(<span class="string">"a{1}"</span>, <span class="string">"a"</span>);
        roundtrip(<span class="string">"a{2}"</span>, <span class="string">"a{2}"</span>);
        roundtrip(<span class="string">"a{1,}"</span>, <span class="string">"a+"</span>);
        ...
        roundtrip(<span class="string">"a{1,}?"</span>, <span class="string">"a+?"</span>);
        roundtrip(<span class="string">"a{1,5}?"</span>, <span class="string">"a{1,5}?"</span>);
        roundtrip(<span class="string">"(?U)a{1}"</span>, <span class="string">"a"</span>);
        roundtrip(<span class="string">"(?U)a{2}"</span>, <span class="string">"a{2}"</span>);
        roundtrip(<span class="string">"(?U)a{1,}"</span>, <span class="string">"a+?"</span>);
        roundtrip(<span class="string">"(?U)a{1,5}"</span>, <span class="string">"a{1,5}?"</span>);

        <span class="comment">// Test that various zero-length repetitions always translate to an
        // empty regex. This is more a property of HIR's smart constructors
        // than the printer though.
        </span>roundtrip(<span class="string">"a{0}"</span>, <span class="string">"(?:)"</span>);
        roundtrip(<span class="string">"(?:ab){0}"</span>, <span class="string">"(?:)"</span>);
        <span class="attr">#[cfg(feature = <span class="string">"unicode-gencat"</span>)]
        </span>{
            roundtrip(<span class="string">r"\p{any}{0}"</span>, <span class="string">"(?:)"</span>);
            roundtrip(<span class="string">r"\P{any}{0}"</span>, <span class="string">"(?:)"</span>);
        }
    }
    ...
    <span class="attr">#[test]
        ...
        roundtrip(<span class="string">"a|b"</span>, <span class="string">"[ab]"</span>);
        roundtrip(<span class="string">"ab|cd"</span>, <span class="string">"(?:(?:ab)|(?:cd))"</span>);
        roundtrip(<span class="string">"a|b|c"</span>, <span class="string">"[a-c]"</span>);
        roundtrip(<span class="string">"ab|cd|ef"</span>, <span class="string">"(?:(?:ab)|(?:cd)|(?:ef))"</span>);
        roundtrip(<span class="string">"foo|bar|quux"</span>, <span class="string">"(?:(?:foo)|(?:bar)|(?:quux))"</span>);
    }

    <span class="comment">// This is a regression test that stresses a peculiarity of how the HIR
    ...
    // See: https://github.com/rust-lang/regex/issues/731
    ...
    </span><span class="kw">fn </span>regression_repetition_concat() {
        <span class="kw">let </span>expr = Hir::concat(<span class="macro">alloc::vec!</span>[
            Hir::literal(<span class="string">"x"</span>.as_bytes()),
            Hir::repetition(hir::Repetition {
                min: <span class="number">1</span>,
                max: <span class="prelude-val">None</span>,
                greedy: <span class="bool-val">true</span>,
                sub: Box::new(Hir::literal(<span class="string">"ab"</span>.as_bytes())),
            }),
            Hir::literal(<span class="string">"y"</span>.as_bytes()),
        ]);
        <span class="macro">assert_eq!</span>(<span class="string">r"(?:x(?:ab)+y)"</span>, expr.to_string());
        ...
        <span class="kw">let </span>expr = Hir::concat(<span class="macro">alloc::vec!</span>[
            ...
            Hir::repetition(hir::Repetition {
                ...
                max: <span class="prelude-val">None</span>,
                greedy: <span class="bool-val">true</span>,
                sub: Box::new(Hir::concat(<span class="macro">alloc::vec!</span>[
                    Hir::look(hir::Look::Start),
        ...
        <span class="macro">assert_eq!</span>(<span class="string">r"(?:\A\A\z\z)"</span>, expr.to_string());
    }

    <span class="comment">// Just like regression_repetition_concat, but with the repetition using
    // an alternation as a child expression instead.
    //
    // See: https://github.com/rust-lang/regex/issues/731
    </span><span class="attr">#[test]
    </span><span class="kw">fn </span>regression_repetition_alternation() {
        <span class="kw">let </span>expr = Hir::concat(<span class="macro">alloc::vec!</span>[
            Hir::literal(<span class="string">"ab"</span>.as_bytes()),
            Hir::repetition(hir::Repetition {
                min: <span class="number">1</span>,
                max: <span class="prelude-val">None</span>,
                greedy: <span class="bool-val">true</span>,
                sub: Box::new(Hir::alternation(<span class="macro">alloc::vec!</span>[
                    Hir::literal(<span class="string">"cd"</span>.as_bytes()),
                    Hir::literal(<span class="string">"ef"</span>.as_bytes()),
                ])),
            }),
            Hir::literal(<span class="string">"gh"</span>.as_bytes()),
        ]);
        <span class="macro">assert_eq!</span>(<span class="string">r"(?:(?:ab)(?:(?:cd)|(?:ef))+(?:gh))"</span>, expr.to_string());
    ...
    <span class="comment">// This regression test is very similar in flavor to
    ...
    // See: https://github.com/rust-lang/regex/issues/516
    ...
    </span><span class="kw">fn </span>regression_alternation_concat() {
        <span class="kw">let </span>expr = Hir::concat(<span class="macro">alloc::vec!</span>[
            Hir::literal(<span class="string">"ab"</span>.as_bytes()),
            Hir::alternation(<span class="macro">alloc::vec!</span>[
                Hir::literal(<span class="string">"mn"</span>.as_bytes()),
                Hir::literal(<span class="string">"xy"</span>.as_bytes()),
            ]),
        ]);
        <span class="macro">assert_eq!</span>(<span class="string">r"(?:(?:ab)(?:(?:mn)|(?:xy)))"</span>, expr.to_string());
        ...
        <span class="macro">assert_eq!</span>(<span class="string">r"(?:\A(?:\A|\z))"</span>, expr.to_string());
    }
}
