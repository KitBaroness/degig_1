...
</span><span class="kw">use </span>core::{char, fmt, iter::FusedIterator, slice};
...
<span class="kw">impl </span>Utf8Sequence {
    ...
    <span class="doccomment">/// Reverses the ranges in this sequence.
    ///
    ...
    /// character classes in reverse.
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            Utf8Sequence::One(<span class="kw">_</span>) =&gt; {}
            Utf8Sequence::Two(<span class="kw-2">ref mut </span>x) =&gt; x.reverse(),
            Utf8Sequence::Three(<span class="kw-2">ref mut </span>x) =&gt; x.reverse(),
            Utf8Sequence::Four(<span class="kw-2">ref mut </span>x) =&gt; x.reverse(),
        }
    }
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>Utf8Sequence {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            Four(<span class="kw-2">ref </span>r) =&gt; {
                <span class="macro">write!</span>(f, <span class="string">"{:?}{:?}{:?}{:?}"</span>, r[<span class="number">0</span>], r[<span class="number">1</span>], r[<span class="number">2</span>], r[<span class="number">3</span>])
            }
        }
    }
}
...
<span class="kw">impl </span>Utf8Sequences {
    ...
    /// N.B. Benchmarks say that this method is dubious.
        ...
        <span class="self">self</span>.push(u32::from(start), u32::from(end));
    }

    <span class="kw">fn </span>push(<span class="kw-2">&amp;mut </span><span class="self">self</span>, start: u32, end: u32) {
        <span class="self">self</span>.range_stack.push(ScalarRange { start, end });
    }
}
...
<span class="kw">impl </span>Iterator <span class="kw">for </span>Utf8Sequences {
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="lifetime">'TOP</span>: <span class="kw">while let </span><span class="prelude-val">Some</span>(<span class="kw-2">mut </span>r) = <span class="self">self</span>.range_stack.pop() {
            <span class="lifetime">'INNER</span>: <span class="kw">loop </span>{
                ...
                <span class="kw">return </span><span class="prelude-val">Some</span>(Utf8Sequence::from_encoded_range(
                    <span class="kw-2">&amp;</span>start[<span class="number">0</span>..n],
                    <span class="kw-2">&amp;</span>end[<span class="number">0</span>..n],
                ));
            }
        }
...
<span class="kw">impl </span>FusedIterator <span class="kw">for </span>Utf8Sequences {}
...
<span class="kw">impl </span>ScalarRange {
    ...
    /// Either or both ranges may be invalid.
        ...
        <span class="kw">if </span><span class="self">self</span>.start &lt; <span class="number">0xE000 </span>&amp;&amp; <span class="self">self</span>.end &gt; <span class="number">0xD7FF </span>{
            <span class="prelude-val">Some</span>((
                ScalarRange { start: <span class="self">self</span>.start, end: <span class="number">0xD7FF </span>},
                ScalarRange { start: <span class="number">0xE000</span>, end: <span class="self">self</span>.end },
            ))
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>}
    ...
    /// values in this range can be encoded as a single byte.
        ...
        <span class="kw">if </span><span class="self">self</span>.is_ascii() {
            <span class="kw">let </span>start = u8::try_from(<span class="self">self</span>.start).unwrap();
            <span class="kw">let </span>end = u8::try_from(<span class="self">self</span>.end).unwrap();
            <span class="prelude-val">Some</span>(Utf8Range::new(start, end))
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>}
    }
    ...
    /// The slices should have room for at least `MAX_UTF8_BYTES`.
        ...
        <span class="kw">let </span>ss = cs.encode_utf8(start);
        <span class="kw">let </span>se = ce.encode_utf8(end);
        <span class="macro">assert_eq!</span>(ss.len(), se.len());
        ss.len()
    }
}
...
<span class="kw">fn </span>max_scalar_value(nbytes: usize) -&gt; u32 {
    <span class="kw">match </span>nbytes {
        ...
        <span class="number">4 </span>=&gt; <span class="number">0x0010_FFFF</span>,
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span><span class="kw">crate</span>::utf8::{Utf8Range, Utf8Sequences};
    ...
    <span class="attr">#[test]
        ...
        </span><span class="kw">for </span>i <span class="kw">in </span><span class="number">0x0</span>..=<span class="number">0x0010_FFFF </span>{
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">use </span><span class="kw">crate</span>::utf8::Utf8Sequence::<span class="kw-2">*</span>;

        <span class="kw">let </span>seqs = Utf8Sequences::new(<span class="string">'\u{0}'</span>, <span class="string">'\u{FFFF}'</span>).collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();
        <span class="macro">assert_eq!</span>(
            ...
            <span class="macro">vec!</span>[
                ...
                Three([
                    rutf8(<span class="number">0xE0</span>, <span class="number">0xE0</span>),
                    rutf8(<span class="number">0xA0</span>, <span class="number">0xBF</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>)
                ]),
                Three([
                    rutf8(<span class="number">0xE1</span>, <span class="number">0xEC</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>)
                ]),
                Three([
                    rutf8(<span class="number">0xED</span>, <span class="number">0xED</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0x9F</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>)
                ]),
                Three([
                    rutf8(<span class="number">0xEE</span>, <span class="number">0xEF</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>),
                    rutf8(<span class="number">0x80</span>, <span class="number">0xBF</span>)
                ]),
            ]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>s = One(rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>));
        s.reverse();
        <span class="macro">assert_eq!</span>(s.as_slice(), <span class="kw-2">&amp;</span>[rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>)]);

        <span class="kw">let </span><span class="kw-2">mut </span>s = Two([rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>), rutf8(<span class="number">0xB</span>, <span class="number">0xC</span>)]);
        s.reverse();
        <span class="macro">assert_eq!</span>(s.as_slice(), <span class="kw-2">&amp;</span>[rutf8(<span class="number">0xB</span>, <span class="number">0xC</span>), rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>)]);

        <span class="kw">let </span><span class="kw-2">mut </span>s = Three([rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>), rutf8(<span class="number">0xB</span>, <span class="number">0xC</span>), rutf8(<span class="number">0xC</span>, <span class="number">0xD</span>)]);
        s.reverse();
        <span class="macro">assert_eq!</span>(
            s.as_slice(),
            <span class="kw-2">&amp;</span>[rutf8(<span class="number">0xC</span>, <span class="number">0xD</span>), rutf8(<span class="number">0xB</span>, <span class="number">0xC</span>), rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>)]
        );

        <span class="kw">let </span><span class="kw-2">mut </span>s = Four([
            rutf8(<span class="number">0xA</span>, <span class="number">0xB</span>),
            rutf8(<span class="number">0xB</span>, <span class="number">0xC</span>),
            rutf8(<span class="number">0xC</span>, <span class="number">0xD</span>),
            rutf8(<span class="number">0xD</span>, <span class="number">0xE</span>),
        ]);
        s.reverse();
        <span class="macro">assert_eq!</span>(
            s.as_slice(),
    ...
    <span class="kw">fn </span>encode_surrogate(cp: u32) -&gt; [u8; <span class="number">3</span>] {
        ...
        dst[<span class="number">0</span>] = u8::try_from(cp &gt;&gt; <span class="number">12 </span>&amp; <span class="number">0x0F</span>).unwrap() | TAG_THREE_B;
        dst[<span class="number">1</span>] = u8::try_from(cp &gt;&gt; <span class="number">6 </span>&amp; <span class="number">0x3F</span>).unwrap() | TAG_CONT;
        dst[<span class="number">2</span>] = u8::try_from(cp &amp; <span class="number">0x3F</span>).unwrap() | TAG_CONT;
        dst
    }
}
