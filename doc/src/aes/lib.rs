...
</pre></div><pre class="rust"><code><span class="doccomment">//! Pure Rust implementation of the Advanced Encryption Standard
//! (a.k.a. Rijndael)
//!
//! # Supported backends
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(all(target_arch = <span class="string">"aarch64"</span>, feature = <span class="string">"armv8"</span>, not(feature = <span class="string">"force-soft"</span>)))] </span>{
        <span class="kw">mod </span>armv8;
        <span class="kw">mod </span>autodetect;
        <span class="kw">pub use </span>autodetect::{Aes128, Aes192, Aes256};

        <span class="attr">#[cfg(feature = <span class="string">"ctr"</span>)]
        </span><span class="kw">pub use </span>autodetect::ctr::{Aes128Ctr, Aes192Ctr, Aes256Ctr};
        ...
        not(feature = <span class="string">"force-soft"</span>)
    ))] </span>{
        <span class="kw">mod </span>autodetect;
        ...
        <span class="kw">pub use </span>soft::{Aes128, Aes192, Aes256};

        <span class="attr">#[cfg(feature = <span class="string">"ctr"</span>)]
        </span><span class="kw">pub use </span>soft::{Aes128Ctr, Aes192Ctr, Aes256Ctr};
    }
}

<span class="kw">pub use </span>cipher::{<span class="self">self</span>, BlockCipher, BlockDecrypt, BlockEncrypt, NewBlockCipher};

<span class="doccomment">/// 128-bit AES block
</span><span class="kw">pub type </span>Block = cipher::generic_array::GenericArray&lt;u8, cipher::consts::U16&gt;;

<span class="doccomment">/// 8 x 128-bit AES blocks to be processed in parallel
</span><span class="kw">pub type </span>ParBlocks = cipher::generic_array::GenericArray&lt;Block, cipher::consts::U8&gt;;

<span class="doccomment">/// Size of an AES block (128-bits; 16-bytes)
