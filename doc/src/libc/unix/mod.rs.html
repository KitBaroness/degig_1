...
</pre></div><pre class="rust"><code><span class="doccomment">//! Definitions found commonly among almost all Unix derivatives
//!
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(any(target_os = <span class="string">"espidf"</span>, target_os = <span class="string">"horizon"</span>, target_os = <span class="string">"vita"</span>))] </span>{
        ...
        <span class="kw">pub type </span>uid_t = i32;
        <span class="kw">pub type </span>gid_t = i32;
...
<span class="macro">s!</span> {
    ...
    // See https://sourceware.org/bugzilla/show_bug.cgi?id=16437
        ...
        <span class="kw">pub </span>tv_sec: time_t,
        <span class="attr">#[cfg(all(target_arch = <span class="string">"x86_64"</span>, target_pointer_width = <span class="string">"32"</span>))]
    ...
    <span class="kw">pub struct </span>rusage {
        ...
        <span class="attr">#[cfg(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>, target_os = <span class="string">"emscripten"</span>))]
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"nto"</span>))] </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))] </span>{
        <span class="kw">pub const </span>FD_CLOEXEC: ::c_int = <span class="number">0x1</span>;
    }
}

<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"nto"</span>))]
    </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(any(target_os = <span class="string">"haiku"</span>, target_os = <span class="string">"illumos"</span>,
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"haiku"</span>))] </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(any(target_os = <span class="string">"l4re"</span>, target_os = <span class="string">"espidf"</span>))] </span>{
        <span class="comment">// required libraries for L4Re and the ESP-IDF framework are linked externally, ATM
    </span>} <span class="kw">else if </span><span class="attr">#[cfg(feature = <span class="string">"std"</span>)] </span>{
        <span class="comment">// cargo build, don't pull in anything extra as the std dep
        // already pulls in all libs.
    </span>} <span class="kw">else if </span><span class="attr">#[cfg(all(target_os = <span class="string">"linux"</span>,
        ...
        <span class="attr">#[link(name = <span class="string">"util"</span>, kind = <span class="string">"static"</span>, modifiers = <span class="string">"-bundle"</span>,
    ...
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>))] </span>{
        <span class="attr">#[cfg_attr(feature = <span class="string">"rustc-dep-of-std"</span>,
                   link(name = <span class="string">"c"</span>, kind = <span class="string">"static"</span>, modifiers = <span class="string">"-bundle"</span>,
                        cfg(target_feature = <span class="string">"crt-static"</span>)))]
        #[cfg_attr(feature = <span class="string">"rustc-dep-of-std"</span>,
                   link(name = <span class="string">"c"</span>, cfg(not(target_feature = <span class="string">"crt-static"</span>))))]
        </span><span class="kw">extern </span>{}
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"emscripten"</span>)] </span>{
        <span class="attr">#[link(name = <span class="string">"c"</span>)]
        </span><span class="kw">extern </span>{}
    } <span class="kw">else if </span><span class="attr">#[cfg(all(target_os = <span class="string">"android"</span>, feature = <span class="string">"rustc-dep-of-std"</span>))] </span>{
        <span class="attr">#[link(name = <span class="string">"c"</span>, kind = <span class="string">"static"</span>, modifiers = <span class="string">"-bundle"</span>,
            cfg(target_feature = <span class="string">"crt-static"</span>))]
        #[link(name = <span class="string">"m"</span>, kind = <span class="string">"static"</span>, modifiers = <span class="string">"-bundle"</span>,
            cfg(target_feature = <span class="string">"crt-static"</span>))]
        #[link(name = <span class="string">"m"</span>, cfg(not(target_feature = <span class="string">"crt-static"</span>)))]
    ...
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"macos"</span>,
        ...
        <span class="attr">#[link(name = <span class="string">"root"</span>)]
        #[link(name = <span class="string">"network"</span>)]
        </span><span class="kw">extern </span>{}
    } <span class="kw">else if </span><span class="attr">#[cfg(target_env = <span class="string">"newlib"</span>)] </span>{
        <span class="attr">#[link(name = <span class="string">"c"</span>)]
        #[link(name = <span class="string">"m"</span>)]
        </span><span class="kw">extern </span>{}
    } <span class="kw">else if </span><span class="attr">#[cfg(target_env = <span class="string">"illumos"</span>)] </span>{
        <span class="attr">#[link(name = <span class="string">"c"</span>)]
        #[link(name = <span class="string">"m"</span>)]
        </span><span class="kw">extern </span>{}
    ...
    } <span class="kw">else if </span><span class="attr">#[cfg(target_env = <span class="string">"aix"</span>)] </span>{
        <span class="attr">#[link(name = <span class="string">"c"</span>)]
        #[link(name = <span class="string">"m"</span>)]
        #[link(name = <span class="string">"bsd"</span>)]
...
<span class="kw">extern </span><span class="string">"C" </span>{
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__fgetpos50"</span>)]
    </span><span class="kw">pub fn </span>fgetpos(stream: <span class="kw-2">*mut </span>FILE, ptr: <span class="kw-2">*mut </span>fpos_t) -&gt; c_int;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__fsetpos50"</span>)]
    ...
    <span class="kw">pub fn </span>atol(s: <span class="kw-2">*const </span>c_char) -&gt; c_long;
    <span class="kw">pub fn </span>atoll(s: <span class="kw-2">*const </span>c_char) -&gt; c_longlong;
    <span class="attr">#[cfg_attr(
        all(target_os = <span class="string">"macos"</span>, target_arch = <span class="string">"x86"</span>),
    ...
    <span class="kw">pub fn </span>strtoll(s: <span class="kw-2">*const </span>c_char, endp: <span class="kw-2">*mut *mut </span>c_char, base: c_int) -&gt; c_longlong;
    ...
    <span class="kw">pub fn </span>strtoull(s: <span class="kw-2">*const </span>c_char, endp: <span class="kw-2">*mut *mut </span>c_char, base: c_int) -&gt; c_ulonglong;
...
<span class="kw">extern </span><span class="string">"C" </span>{
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__getpwnam50"</span>)]
    </span><span class="kw">pub fn </span>getpwnam(name: <span class="kw-2">*const </span>::c_char) -&gt; <span class="kw-2">*mut </span>passwd;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__getpwuid50"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"espidf"</span>, link_name = <span class="string">"lwip_setsockopt"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"espidf"</span>, link_name = <span class="string">"lwip_shutdown"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"illumos"</span>, link_name = <span class="string">"getloginx"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__utime50"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__getrusage50"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__times13"</span>)]
    ...
    <span class="kw">pub fn </span>pthread_attr_getstacksize(
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__libc_thr_yield"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"illumos"</span>, link_name = <span class="string">"__xnet_getsockopt"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__utimes50"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__gmtime_r50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__localtime_r50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__time50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    </span><span class="kw">pub fn </span>time(time: <span class="kw-2">*mut </span>time_t) -&gt; time_t;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__gmtime50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    </span><span class="kw">pub fn </span>gmtime(time_p: <span class="kw-2">*const </span>time_t) -&gt; <span class="kw-2">*mut </span>tm;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__locatime50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    </span><span class="kw">pub fn </span>localtime(time_p: <span class="kw-2">*const </span>time_t) -&gt; <span class="kw-2">*mut </span>tm;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__difftime50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    </span><span class="kw">pub fn </span>difftime(time1: time_t, time0: time_t) -&gt; ::c_double;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__timegm50"</span>)]
    #[cfg_attr(any(target_env = <span class="string">"musl"</span>, target_env = <span class="string">"ohos"</span>), allow(deprecated))]
    </span><span class="comment">// FIXME: for `time_t`
    </span><span class="kw">pub fn </span>timegm(tm: <span class="kw-2">*mut </span>::tm) -&gt; time_t;

    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__mknod50"</span>)]
    #[cfg_attr(
        all(target_os = <span class="string">"freebsd"</span>, any(freebsd11, freebsd10)),
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__setlocale50"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigemptyset14"</span>)]
    </span><span class="kw">pub fn </span>sigemptyset(set: <span class="kw-2">*mut </span>sigset_t) -&gt; ::c_int;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigaddset14"</span>)]
    </span><span class="kw">pub fn </span>sigaddset(set: <span class="kw-2">*mut </span>sigset_t, signum: ::c_int) -&gt; ::c_int;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigfillset14"</span>)]
    </span><span class="kw">pub fn </span>sigfillset(set: <span class="kw-2">*mut </span>sigset_t) -&gt; ::c_int;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigdelset14"</span>)]
    </span><span class="kw">pub fn </span>sigdelset(set: <span class="kw-2">*mut </span>sigset_t, signum: ::c_int) -&gt; ::c_int;
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigismember14"</span>)]
    </span><span class="kw">pub fn </span>sigismember(set: <span class="kw-2">*const </span>sigset_t, signum: ::c_int) -&gt; ::c_int;

    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigprocmask14"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigpending14"</span>)]
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"macos"</span>, link_name = <span class="string">"syslog$DARWIN_EXTSN"</span>)]
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(any(target_os = <span class="string">"emscripten"</span>,
                     target_os = <span class="string">"android"</span>,
                     target_os = <span class="string">"haiku"</span>,
                     target_os = <span class="string">"nto"</span>)))] </span>{
        <span class="kw">extern </span><span class="string">"C" </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"aix"</span>))] </span>{
        <span class="kw">extern </span><span class="string">"C" </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(any(target_env = <span class="string">"uclibc"</span>, target_os = <span class="string">"nto"</span>)))] </span>{
        <span class="kw">extern </span><span class="string">"C" </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(not(target_os = <span class="string">"redox"</span>))] </span>{
        <span class="kw">extern </span>{
            ...
            <span class="attr">#[cfg_attr(all(target_os = <span class="string">"macos"</span>, target_arch = <span class="string">"x86"</span>),
            ...
            <span class="attr">#[cfg_attr(all(target_os = <span class="string">"macos"</span>, target_arch = <span class="string">"x86_64"</span>),
            ...
            <span class="attr">#[cfg_attr(all(target_os = <span class="string">"macos"</span>, not(target_arch = <span class="string">"aarch64"</span>)),
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(target_os = <span class="string">"nto"</span>)] </span>{
        <span class="kw">extern </span>{
            <span class="kw">pub fn </span>readlinkat(dirfd: ::c_int,
                pathname: <span class="kw-2">*const </span>::c_char,
                buf: <span class="kw-2">*mut </span>::c_char,
                bufsiz: ::size_t) -&gt; ::c_int;
            <span class="kw">pub fn </span>readlink(path: <span class="kw-2">*const </span>c_char, buf: <span class="kw-2">*mut </span>c_char, bufsz: ::size_t) -&gt; ::c_int;
            <span class="kw">pub fn </span>pselect(
                nfds: ::c_int,
                readfds: <span class="kw-2">*mut </span>fd_set,
                writefds: <span class="kw-2">*mut </span>fd_set,
                errorfds: <span class="kw-2">*mut </span>fd_set,
            ...
            <span class="kw">pub fn </span>sigaction(
                signum: ::c_int,
                act: <span class="kw-2">*const </span>sigaction,
                oldact: <span class="kw-2">*mut </span>sigaction
            ) -&gt; ::c_int;
        }
    } <span class="kw">else </span>{
        <span class="kw">extern </span>{
            ...
            <span class="attr">#[cfg_attr(target_os = <span class="string">"netbsd"</span>, link_name = <span class="string">"__sigaction14"</span>)]
            </span><span class="kw">pub fn </span>sigaction(
                signum: ::c_int,
                act: <span class="kw-2">*const </span>sigaction,
                oldact: <span class="kw-2">*mut </span>sigaction
            ) -&gt; ::c_int;
...
<span class="macro">cfg_if!</span> {
   <span class="kw">if </span><span class="attr">#[cfg(not(any(target_os = <span class="string">"solaris"</span>,
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(target_env = <span class="string">"newlib"</span>)] </span>{
        <span class="kw">mod </span>newlib;
        <span class="kw">pub use </span><span class="self">self</span>::newlib::<span class="kw-2">*</span>;
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"linux"</span>,
    ...
    } <span class="kw">else if </span><span class="attr">#[cfg(any(target_os = <span class="string">"solaris"</span>,
        ...
        <span class="kw">mod </span>nto;
        <span class="kw">pub use </span><span class="self">self</span>::nto::<span class="kw-2">*</span>;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"aix"</span>)] </span>{
        <span class="kw">mod </span>aix;
        <span class="kw">pub use </span><span class="self">self</span>::aix::<span class="kw-2">*</span>;
    } <span class="kw">else if </span><span class="attr">#[cfg(target_os = <span class="string">"hurd"</span>)] </span>{
        <span class="kw">mod </span>hurd;
        <span class="kw">pub use </span><span class="self">self</span>::hurd::<span class="kw-2">*</span>;
    } <span class="kw">else </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(libc_core_cvoid)] </span>{
...
<span class="macro">cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(libc_align)] </span>{
