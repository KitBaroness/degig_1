...
</pre></div><pre class="rust"><code><span class="doccomment">/// A macro for defining #[cfg] if-else statements.
///
...
<span class="macro">macro_rules!</span> s {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub </span><span class="macro-nonterminal">$t</span>:ident <span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* })<span class="kw-2">*</span>) =&gt; ($(
        <span class="macro">s!</span>(it: $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)* <span class="kw">pub </span><span class="macro-nonterminal">$t $i </span>{ $(<span class="macro-nonterminal">$field</span>)* });
    )<span class="kw-2">*</span>);
    (it: $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub </span>union <span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* }) =&gt; (
    ...
    (it: $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub struct </span><span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* }) =&gt; (
...
<span class="macro">macro_rules!</span> s_no_extra_traits {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub </span><span class="macro-nonterminal">$t</span>:ident <span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* })<span class="kw-2">*</span>) =&gt; ($(
        <span class="macro">s_no_extra_traits!</span>(it: $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)* <span class="kw">pub </span><span class="macro-nonterminal">$t $i </span>{ $(<span class="macro-nonterminal">$field</span>)* });
    )<span class="kw-2">*</span>);
    (it: $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub </span>union <span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* }) =&gt; (
        <span class="macro">cfg_if!</span> {
...
<span class="macro">macro_rules!</span> missing {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub enum </span><span class="macro-nonterminal">$i</span>:ident {})<span class="kw-2">*</span>) =&gt; ($(
        $(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)* <span class="attr">#[allow(missing_copy_implementations)] </span><span class="kw">pub enum </span><span class="macro-nonterminal">$i </span>{ }
    )<span class="kw-2">*</span>);
}

<span class="macro">macro_rules!</span> e {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub enum </span><span class="macro-nonterminal">$i</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* })<span class="kw-2">*</span>) =&gt; ($(
        <span class="macro">__item!</span> {
            <span class="attr">#[cfg_attr(feature = <span class="string">"extra_traits"</span>, derive(Debug, Eq, Hash, PartialEq))]
            </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)*
...
<span class="macro">macro_rules!</span> s_paren {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub struct </span><span class="macro-nonterminal">$i</span>:ident ( $(<span class="macro-nonterminal">$field</span>:tt)* ); )* ) =&gt; ($(
        <span class="macro">__item!</span> {
            <span class="attr">#[cfg_attr(feature = <span class="string">"extra_traits"</span>, derive(Debug, Eq, Hash, PartialEq))]
            </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)*
            <span class="kw">pub struct </span><span class="macro-nonterminal">$i </span>( $(<span class="macro-nonterminal">$field</span>)* );
...
// 'f!' block
    ...
    <span class="kw">if </span><span class="attr">#[cfg(libc_const_extern_fn)] </span>{
        <span class="macro">macro_rules!</span> f {
            ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="kw">pub </span>$({<span class="macro-nonterminal">$constness</span>:ident})* <span class="kw">fn </span><span class="macro-nonterminal">$i</span>:ident(
        ...
        <span class="macro">macro_rules!</span> const_fn {
            ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* $({<span class="macro-nonterminal">$constness</span>:ident})* <span class="kw">fn </span><span class="macro-nonterminal">$i</span>:ident(
                        $(<span class="macro-nonterminal">$arg</span>:ident: <span class="macro-nonterminal">$argty</span>:ty),*
            ) -&gt; <span class="macro-nonterminal">$ret</span>:ty {
                $(<span class="macro-nonterminal">$body</span>:stmt);*
            })<span class="kw-2">*</span>) =&gt; ($(
...
<span class="macro">macro_rules!</span> align_const {
    ($($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)*
       ...
       = <span class="macro-nonterminal">$t2</span>:ident { $(<span class="macro-nonterminal">$field</span>:tt)* };)<span class="kw-2">*</span>) =&gt; ($(
        <span class="attr">#[cfg(libc_align)]
        </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)*
        ...
        <span class="attr">#[cfg(not(libc_align))]
        </span>$(<span class="attr">#[<span class="macro-nonterminal">$attr</span>]</span>)*
        <span class="kw">pub const </span><span class="macro-nonterminal">$name </span>: <span class="macro-nonterminal">$t1 </span>= <span class="macro-nonterminal">$t2 </span>{
            $(<span class="macro-nonterminal">$field</span>)*
            __align: [],
...
<span class="attr">#[cfg(not(libc_ptr_addr_of))]
...
<span class="attr">#[cfg(libc_ptr_addr_of)]
</span><span class="macro">macro_rules!</span> ptr_addr_of {
    (<span class="macro-nonterminal">$place</span>:expr) =&gt; {
