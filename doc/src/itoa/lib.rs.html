<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/itoa-1.0.11/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="itoa" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../itoa/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
</pre></div><pre class="rust"><code><span class="doccomment">//! [![github]](https://github.com/dtolnay/itoa)&amp;ensp;[![crates-io]](https://crates.io/crates/itoa)&amp;ensp;[![docs-rs]](https://docs.rs/itoa)
//!
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/itoa/1.0.11"</span>)]
#![no_std]
#![allow(
...
<span class="kw">impl </span>Buffer {
    ...
    #[cfg_attr(feature = <span class="string">"no-panic"</span>, no_panic)]
        ...
        <span class="kw">let </span>bytes = [MaybeUninit::&lt;u8&gt;::uninit(); I128_MAX_LEN];
        Buffer { bytes }
    }
    ...
    /// representation within the buffer.
        ...
        i.write(<span class="kw">unsafe </span>{
            <span class="kw-2">&amp;mut *</span>(<span class="kw-2">&amp;mut </span><span class="self">self</span>.bytes <span class="kw">as </span><span class="kw-2">*mut </span>[MaybeUninit&lt;u8&gt;; I128_MAX_LEN]
...
<span class="comment">// Seal to prevent downstream implementations of the Integer trait.
    ...
    <span class="kw">pub trait </span>Sealed: Copy {
        <span class="kw">type </span>Buffer: <span class="lifetime">'static</span>;
...
<span class="kw">const </span>DEC_DIGITS_LUT: <span class="kw-2">&amp;</span>[u8] = <span class="string">b"\
    ...
    ($(<span class="macro-nonterminal">$max_len</span>:expr =&gt; <span class="macro-nonterminal">$t</span>:ident),* <span class="kw">as </span><span class="macro-nonterminal">$conv_fn</span>:ident) =&gt; {$(
        ...
        <span class="kw">impl </span>private::Sealed <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            ...
            #[cfg_attr(feature = <span class="string">"no-panic"</span>, no_panic)]
                ...
                <span class="comment">// Need at least 16 bits for the 4-digits-at-a-time to work.
                </span><span class="kw">if </span>mem::size_of::&lt;<span class="macro-nonterminal">$t</span>&gt;() &gt;= <span class="number">2 </span>{
                    <span class="comment">// Eagerly decode 4 digits at a time.
                ...
                <span class="comment">// If we reach here, numbers are &lt;=9999 so at most 4 digits long.
                </span><span class="kw">let </span><span class="kw-2">mut </span>n = n <span class="kw">as </span>isize; <span class="comment">// Possibly reduce 64-bit math.
                ...
                <span class="comment">// Decode last 1 or 2 digits.
                ...
                <span class="kw">let </span>bytes = <span class="kw">unsafe </span>{ slice::from_raw_parts(buf_ptr.offset(curr), len) };
    ...
    ($(<span class="macro-nonterminal">$max_len</span>:expr =&gt; <span class="macro-nonterminal">$t</span>:ident),<span class="kw-2">*</span>) =&gt; {$(
        ...
        <span class="kw">impl </span>private::Sealed <span class="kw">for </span><span class="macro-nonterminal">$t </span>{
            ...
            #[cfg_attr(feature = <span class="string">"no-panic"</span>, no_panic)]
                ...
                <span class="kw">let </span>buf1 = <span class="kw">unsafe </span>{ buf_ptr.offset(curr - U64_MAX_LEN <span class="kw">as </span>isize) <span class="kw">as </span><span class="kw-2">*mut </span>[MaybeUninit&lt;u8&gt;; U64_MAX_LEN] };
                curr -= rem.write(<span class="kw">unsafe </span>{ <span class="kw-2">&amp;mut *</span>buf1 }).len() <span class="kw">as </span>isize;
                ...
                <span class="kw">if </span>n != <span class="number">0 </span>{
                    ...
                    <span class="kw">let </span>buf2 = <span class="kw">unsafe </span>{ buf_ptr.offset(curr - U64_MAX_LEN <span class="kw">as </span>isize) <span class="kw">as </span><span class="kw-2">*mut </span>[MaybeUninit&lt;u8&gt;; U64_MAX_LEN] };
                    curr -= rem.write(<span class="kw">unsafe </span>{ <span class="kw-2">&amp;mut *</span>buf2 }).len() <span class="kw">as </span>isize;
...
<span class="kw">const </span>U128_MAX_LEN: usize = <span class="number">39</span>;
<span class="kw">const </span>I128_MAX_LEN: usize = <span class="number">40</span>;

<span class="macro">impl_Integer128!</span>(I128_MAX_LEN =&gt; i128, U128_MAX_LEN =&gt; u128);
