...
</span><span class="comment">// This module defines an internal builder that encapsulates all interaction
...
<span class="doccomment">/// A builder for constructing a `Regex`, `bytes::Regex`, `RegexSet` or a
/// `bytes::RegexSet`.
///
...
</span><span class="kw">struct </span>Builder {
    pats: Vec&lt;String&gt;,
    metac: meta::Config,
...
<span class="kw">impl </span>Default <span class="kw">for </span>Builder {
    <span class="kw">fn </span>default() -&gt; Builder {
        <span class="kw">let </span>metac = meta::Config::new()
            .nfa_size_limit(<span class="prelude-val">Some</span>(<span class="number">10 </span>* (<span class="number">1 </span>&lt;&lt; <span class="number">20</span>)))
            .hybrid_cache_capacity(<span class="number">2 </span>* (<span class="number">1 </span>&lt;&lt; <span class="number">20</span>));
        Builder { pats: <span class="macro">vec!</span>[], metac, syntaxc: syntax::Config::default() }
    }
}

<span class="kw">impl </span>Builder {
    <span class="kw">fn </span>new&lt;I, S&gt;(patterns: I) -&gt; Builder
    <span class="kw">where
        </span>S: AsRef&lt;str&gt;,
        I: IntoIterator&lt;Item = S&gt;,
    {
        <span class="kw">let </span><span class="kw-2">mut </span>b = Builder::default();
        b.pats.extend(patterns.into_iter().map(|p| p.as_ref().to_string()));
        b
    }

    <span class="kw">fn </span>build_one_string(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw">crate</span>::Regex, Error&gt; {
        <span class="macro">assert_eq!</span>(<span class="number">1</span>, <span class="self">self</span>.pats.len());
        <span class="kw">let </span>metac = <span class="self">self
            </span>.metac
            .clone()
            .match_kind(MatchKind::LeftmostFirst)
            .utf8_empty(<span class="bool-val">true</span>);
        <span class="kw">let </span>syntaxc = <span class="self">self</span>.syntaxc.clone().utf8(<span class="bool-val">true</span>);
        <span class="kw">let </span>pattern = Arc::from(<span class="self">self</span>.pats[<span class="number">0</span>].as_str());
        meta::Builder::new()
            .configure(metac)
            .syntax(syntaxc)
            .build(<span class="kw-2">&amp;</span>pattern)
            .map(|meta| <span class="kw">crate</span>::Regex { meta, pattern })
            .map_err(Error::from_meta_build_error)
    }

    <span class="kw">fn </span>build_one_bytes(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw">crate</span>::bytes::Regex, Error&gt; {
        <span class="macro">assert_eq!</span>(<span class="number">1</span>, <span class="self">self</span>.pats.len());
        <span class="kw">let </span>metac = <span class="self">self
            </span>.metac
            .clone()
        ...
        <span class="kw">let </span>syntaxc = <span class="self">self</span>.syntaxc.clone().utf8(<span class="bool-val">false</span>);
        <span class="kw">let </span>pattern = Arc::from(<span class="self">self</span>.pats[<span class="number">0</span>].as_str());
        meta::Builder::new()
            .configure(metac)
            .syntax(syntaxc)
            .build(<span class="kw-2">&amp;</span>pattern)
            .map(|meta| <span class="kw">crate</span>::bytes::Regex { meta, pattern })
            .map_err(Error::from_meta_build_error)
    }

    <span class="kw">fn </span>build_many_string(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw">crate</span>::RegexSet, Error&gt; {
        <span class="kw">let </span>metac = <span class="self">self
            </span>.metac
            .clone()
        ...
        <span class="kw">let </span>syntaxc = <span class="self">self</span>.syntaxc.clone().utf8(<span class="bool-val">true</span>);
        <span class="kw">let </span>patterns = Arc::from(<span class="self">self</span>.pats.as_slice());
        meta::Builder::new()
            .configure(metac)
            .syntax(syntaxc)
            .build_many(<span class="kw-2">&amp;</span>patterns)
            .map(|meta| <span class="kw">crate</span>::RegexSet { meta, patterns })
            .map_err(Error::from_meta_build_error)
    }

    <span class="kw">fn </span>build_many_bytes(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw">crate</span>::bytes::RegexSet, Error&gt; {
        <span class="kw">let </span>metac = <span class="self">self
            </span>.metac
            .clone()
            .match_kind(MatchKind::All)
        ...
        meta::Builder::new()
            ...
            .syntax(syntaxc)
            .build_many(<span class="kw-2">&amp;</span>patterns)
            .map(|meta| <span class="kw">crate</span>::bytes::RegexSet { meta, patterns })
            .map_err(Error::from_meta_build_error)
    }

    <span class="kw">fn </span>case_insensitive(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.case_insensitive(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>multi_line(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.multi_line(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>dot_matches_new_line(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.dot_matches_new_line(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>crlf(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.crlf(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>line_terminator(<span class="kw-2">&amp;mut </span><span class="self">self</span>, byte: u8) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.metac = <span class="self">self</span>.metac.clone().line_terminator(byte);
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.line_terminator(byte);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>swap_greed(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.swap_greed(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>ignore_whitespace(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.ignore_whitespace(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>unicode(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.unicode(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>octal(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.octal(yes);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>size_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, limit: usize) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.metac = <span class="self">self</span>.metac.clone().nfa_size_limit(<span class="prelude-val">Some</span>(limit));
        <span class="self">self
    </span>}

    <span class="kw">fn </span>dfa_size_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, limit: usize) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.metac = <span class="self">self</span>.metac.clone().hybrid_cache_capacity(limit);
        <span class="self">self
    </span>}

    <span class="kw">fn </span>nest_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, limit: u32) -&gt; <span class="kw-2">&amp;mut </span>Builder {
        <span class="self">self</span>.syntaxc = <span class="self">self</span>.syntaxc.nest_limit(limit);
        <span class="self">self
    </span>}
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>string {
    <span class="kw">use crate</span>::{error::Error, Regex, RegexSet};

    <span class="kw">use </span><span class="kw">super</span>::Builder;

    <span class="doccomment">/// A configurable builder for a [`Regex`].
    ///
    ...
    </span><span class="kw">pub struct </span>RegexBuilder {
        builder: Builder,
    }

    <span class="kw">impl </span>RegexBuilder {
        <span class="doccomment">/// Create a new builder with a default configuration for the given
        /// pattern.
        ///
        ...
        <span class="doccomment">/// Compiles the pattern given to `RegexBuilder::new` with the
        ...
        /// was exceeded, then an error is returned.
            ...
            <span class="self">self</span>.builder.build_one_string()
        }

        <span class="doccomment">/// This configures Unicode mode for the entire pattern.
        ///
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.unicode(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures whether to enable case insensitive matching for the
        /// entire pattern.
        ///
        ...
        /// assert!(!re.is_match("fooBARquux"));
        /// ```
        </span><span class="kw">pub fn </span>case_insensitive(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.case_insensitive(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures multi-line mode for the entire pattern.
        ///
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.multi_line(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures dot-matches-new-line mode for the entire pattern.
        ///
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.dot_matches_new_line(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures CRLF mode for the entire pattern.
        ///
        ...
        /// ```
        </span><span class="kw">pub fn </span>crlf(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.crlf(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// Configures the line terminator to be used by the regex.
        ///
        ...
        /// ```
        </span><span class="kw">pub fn </span>line_terminator(<span class="kw-2">&amp;mut </span><span class="self">self</span>, byte: u8) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.line_terminator(byte);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures swap-greed mode for the entire pattern.
        ///
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.swap_greed(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures verbose mode for the entire pattern.
        ///
        ...
        /// assert_eq!("Potter", &amp;caps["last"]);
        /// ```
        </span><span class="kw">pub fn </span>ignore_whitespace(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.ignore_whitespace(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures octal mode for the entire pattern.
        ///
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.octal(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// Sets the approximate size limit, in bytes, of the compiled regex.
        ///
        ...
        /// ```
        </span><span class="kw">pub fn </span>size_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, bytes: usize) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.size_limit(bytes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// Set the approximate capacity, in bytes, of the cache of transitions
        ...
        </span><span class="kw">pub fn </span>dfa_size_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, bytes: usize) -&gt; <span class="kw-2">&amp;mut </span>RegexBuilder {
            <span class="self">self</span>.builder.dfa_size_limit(bytes);
            <span class="self">self
        </span>}
        ...
        /// ```
            ...
            <span class="self">self</span>.builder.nest_limit(limit);
            <span class="self">self
        </span>}
    }

    <span class="doccomment">/// A configurable builder for a [`RegexSet`].
    ///
    ...
    </span><span class="kw">pub struct </span>RegexSetBuilder {
        builder: Builder,
    }
    ...
    <span class="kw">impl </span>RegexSetBuilder {
        ...
        <span class="doccomment">/// Compiles the patterns given to `RegexSetBuilder::new` with the
        /// configuration set on this builder.
        ///
        ...
        /// was exceeded, then an error is returned.
            ...
            <span class="self">self</span>.builder.build_many_string()
        }

        <span class="doccomment">/// This configures Unicode mode for the all of the patterns.
        ///
        /// Enabling Unicode mode does a number of things:
        ///
        /// * Most fundamentally, it causes the fundamental atom of matching
        ...
        <span class="doccomment">/// This configures whether to enable case insensitive matching for all
        /// of the patterns.
        ///
        /// This setting can also be configured using the inline flag `i`
        /// in the pattern. For example, `(?i:foo)` matches `foo` case
        ...
        /// assert!(!re.is_match("fooBARquux"));
        /// ```
        </span><span class="kw">pub fn </span>case_insensitive(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.case_insensitive(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures multi-line mode for all of the patterns.
        ///
        /// Enabling multi-line mode changes the behavior of the `^` and `$`
        /// anchor assertions. Instead of only matching at the beginning and
        /// end of a haystack, respectively, multi-line mode causes them to
        ...
        /// assert!(re.is_match("\nfoo\n"));
        /// ```
        </span><span class="kw">pub fn </span>multi_line(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.multi_line(yes);
            <span class="self">self
        </span>}
        ...
        <span class="doccomment">/// This configures CRLF mode for all of the patterns.
        ///
        /// When CRLF mode is enabled, both `\r` ("carriage return" or CR for
        /// short) and `\n` ("line feed" or LF for short) are treated as line
        /// terminators. This results in the following:
        ...
        /// assert!(!re.is_match("\r\n"));
        /// ```
        </span><span class="kw">pub fn </span>crlf(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.crlf(yes);
            <span class="self">self
        </span>}
        ...
        /// );
        /// ```
        </span><span class="kw">pub fn </span>line_terminator(<span class="kw-2">&amp;mut </span><span class="self">self</span>, byte: u8) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.line_terminator(byte);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures swap-greed mode for all of the patterns.
        ///
        /// When swap-greed mode is enabled, patterns like `a+` will become
        /// non-greedy and patterns like `a+?` will become greedy. In other
        /// words, the meanings of `a+` and `a+?` are switched.
        ...
        ///
        /// The default for this is `false`.
        </span><span class="kw">pub fn </span>swap_greed(<span class="kw-2">&amp;mut </span><span class="self">self</span>, yes: bool) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.swap_greed(yes);
            <span class="self">self
        </span>}

        <span class="doccomment">/// This configures verbose mode for all of the patterns.
        ///
        /// When enabled, whitespace will treated as insignifcant in the
        /// pattern and `#` can be used to start a comment until the next new
        /// line.
        ...
        <span class="doccomment">/// This configures octal mode for all of the patterns.
        ///
        /// Octal syntax is a little-known way of uttering Unicode codepoints
        /// in a pattern. For example, `a`, `\x61`, `\u0061` and `\141` are all
        /// equivalent patterns, where the last example shows octal syntax.
        ...
        /// );
        /// ```
        </span><span class="kw">pub fn </span>size_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, bytes: usize) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.size_limit(bytes);
            <span class="self">self
        </span>}
        ...
        /// ```
        </span><span class="kw">pub fn </span>nest_limit(<span class="kw-2">&amp;mut </span><span class="self">self</span>, limit: u32) -&gt; <span class="kw-2">&amp;mut </span>RegexSetBuilder {
            <span class="self">self</span>.builder.nest_limit(limit);
            <span class="self">self
        </span>}
    }
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>bytes {
    ...
    <span class="kw">impl </span>RegexBuilder {
        ...
        /// was exceeded, then an error is returned.
            ...
            <span class="self">self</span>.builder.build_one_bytes()
        }
    ...
    <span class="kw">impl </span>RegexSetBuilder {
        ...
        /// was exceeded, then an error is returned.
            ...
            <span class="self">self</span>.builder.build_many_bytes()
        }
