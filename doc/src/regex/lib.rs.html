...
#![deny(missing_docs)]
#![cfg_attr(feature = <span class="string">"pattern"</span>, feature(pattern))]
...
<span class="kw">pub use crate</span>::{builders::string::<span class="kw-2">*</span>, regex::string::<span class="kw-2">*</span>, regexset::string::<span class="kw-2">*</span>};

<span class="kw">mod </span>builders;
<span class="kw">pub mod </span>bytes;
<span class="kw">mod </span>error;
<span class="kw">mod </span>find_byte;
<span class="attr">#[cfg(feature = <span class="string">"pattern"</span>)]
</span><span class="kw">mod </span>pattern;
<span class="kw">mod </span>regex;
<span class="kw">mod </span>regexset;

<span class="doccomment">/// Escapes all regular expression meta characters in `pattern`.
///
/// The string returned may be safely used as a literal in a regular
/// expression.
</span><span class="kw">pub fn </span>escape(pattern: <span class="kw-2">&amp;</span>str) -&gt; alloc::string::String {
