...
</pre></div><pre class="rust"><code><span class="kw">use </span>alloc::{borrow::Cow, string::String, sync::Arc, vec::Vec};

<span class="kw">use </span>regex_automata::{meta, util::captures, Input, PatternID};

<span class="kw">use crate</span>::{bytes::RegexBuilder, error::Error};
...
<span class="doccomment">/// Core regular expression methods.
    ...
    </span><span class="kw">pub fn </span>find&lt;<span class="lifetime">'h</span>&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]) -&gt; <span class="prelude-ty">Option</span>&lt;Match&lt;<span class="lifetime">'h</span>&gt;&gt; {
    ...
    </span><span class="kw">pub fn </span>find_iter&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'r </span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]) -&gt; Matches&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt; {
    ...
    </span><span class="kw">pub fn </span>captures&lt;<span class="lifetime">'h</span>&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]) -&gt; <span class="prelude-ty">Option</span>&lt;Captures&lt;<span class="lifetime">'h</span>&gt;&gt; {
    ...
    </span><span class="kw">pub fn </span>split&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'r </span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]) -&gt; Split&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt; {
    ...
    /// need to be parsed for the `$` syntax.
        ...
        haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8],
        rep: R,
    ) -&gt; Cow&lt;<span class="lifetime">'h</span>, [u8]&gt; {
...
/// matches for capture groups.
    ...
    </span><span class="kw">pub fn </span>shortest_match(<span class="kw-2">&amp;</span><span class="self">self</span>, haystack: <span class="kw-2">&amp;</span>[u8]) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt; {
        <span class="self">self</span>.shortest_match_at(haystack, <span class="number">0</span>)
    }

    <span class="doccomment">/// Returns the same as `shortest_match`, but starts the search at the
    /// given offset.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.meta.find(input).map(|m| Match::new(haystack, m.start(), m.end()))
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.meta.captures(input, <span class="kw-2">&amp;mut </span>caps);
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; Match&lt;<span class="lifetime">'h</span>&gt; {
    ...
    </span><span class="kw">pub fn </span>as_bytes(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8] {
    ...
    </span><span class="kw">fn </span>new(haystack: <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8], start: usize, end: usize) -&gt; Match&lt;<span class="lifetime">'h</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; core::fmt::Debug <span class="kw">for </span>Match&lt;<span class="lifetime">'h</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
        ...
        <span class="kw">if let </span><span class="prelude-val">Ok</span>(s) = core::str::from_utf8(<span class="self">self</span>.as_bytes()) {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; From&lt;Match&lt;<span class="lifetime">'h</span>&gt;&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8] {
    <span class="kw">fn </span>from(m: Match&lt;<span class="lifetime">'h</span>&gt;) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8] {
        m.as_bytes()
    }
}
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; Captures&lt;<span class="lifetime">'h</span>&gt; {
    ...
    /// ```
    </span><span class="kw">pub fn </span>extract&lt;<span class="kw">const </span>N: usize&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (<span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8], [<span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]; N]) {
        ...
        </span><span class="self">self</span>.caps.extract_bytes(<span class="self">self</span>.haystack)
    }
    ...
    /// ```
        ...
        <span class="self">self</span>.caps.interpolate_bytes_into(<span class="self">self</span>.haystack, replacement, dst);
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'h</span>&gt; core::fmt::Debug <span class="kw">for </span>Captures&lt;<span class="lifetime">'h</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; core::fmt::Result {
        ...
        <span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; core::fmt::Debug <span class="kw">for </span>Value&lt;<span class="lifetime">'a</span>&gt; {
            <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; core::fmt::Result {
                <span class="kw">use </span>regex_automata::util::escape::DebugHaystack;
                ...
                <span class="macro">write!</span>(
                    ...
                    DebugHaystack(<span class="self">self</span>.<span class="number">0</span>.as_bytes())
                )
            }
        }
...
/// If there is no matching group at the given index.
    ...
    </span><span class="kw">fn </span>index&lt;<span class="lifetime">'a</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="self">self</span>, i: usize) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8] {
...
/// If there is no matching group at the given name.
    ...
    <span class="kw">fn </span>index&lt;<span class="lifetime">'a</span>&gt;(<span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="self">self</span>, name: <span class="kw-2">&amp;</span><span class="lifetime">'n </span>str) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8] {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt; Iterator <span class="kw">for </span>Split&lt;<span class="lifetime">'r</span>, <span class="lifetime">'h</span>&gt; {
    <span class="kw">type </span>Item = <span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8];

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span><span class="lifetime">'h </span>[u8]&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="kw">const </span>N: usize&gt; Replacer <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8; N] {
...
<span class="kw">impl</span>&lt;<span class="kw">const </span>N: usize&gt; Replacer <span class="kw">for </span>[u8; N] {
    <span class="kw">fn </span>replace_append(<span class="kw-2">&amp;mut </span><span class="self">self</span>, caps: <span class="kw-2">&amp;</span>Captures&lt;<span class="lifetime">'_</span>&gt;, dst: <span class="kw-2">&amp;mut </span>Vec&lt;u8&gt;) {
        caps.expand(<span class="kw-2">&amp;*</span><span class="self">self</span>, dst);
    }
...
</span><span class="kw">pub struct </span>NoExpand&lt;<span class="lifetime">'s</span>&gt;(<span class="kw">pub </span><span class="kw-2">&amp;</span><span class="lifetime">'s </span>[u8]);
...
</span><span class="kw">fn </span>no_expansion&lt;T: AsRef&lt;[u8]&gt;&gt;(replacement: <span class="kw-2">&amp;</span>T) -&gt; <span class="prelude-ty">Option</span>&lt;Cow&lt;<span class="lifetime">'_</span>, [u8]&gt;&gt; {
    <span class="kw">let </span>replacement = replacement.as_ref();
    <span class="kw">match </span><span class="kw">crate</span>::find_byte::find_byte(<span class="string">b'$'</span>, replacement) {
