...
</pre></div><pre class="rust"><code><span class="kw">use </span>std::env::args;
...
<span class="kw">use </span>mpl_token_metadata::{
    instructions::{Create, CreateBuilder, Verify, VerifyInstructionArgs}, types::Creator, types::CreateArgs, ID <span class="kw">as </span>MPL_ID
};
...
<span class="doccomment">/// This is the function which used to create instruction for initalize pass token
</span><span class="kw">pub fn </span>init_pass_token(
    ...
    {
        <span class="comment">//NOTE: setup and validation
        </span><span class="kw">let </span>main_state = <span class="kw-2">&amp;mut </span>ctx.accounts.main_state;
        ...
        <span class="kw">let </span>profile_metadata = ctx.accounts.profile_metadata.to_account_info();

        profile_state.activation_token = <span class="prelude-val">Some</span>(ctx.accounts.activation_token.key());
        activation_token_state.parent_profile = ctx.accounts.profile.key();
        activation_token_state.creator = ctx.accounts.user.key();
        <span class="comment">//TODO: update some main state if fiels are avaible (may be in future)
    </span>}
    {
        <span class="comment">//NOTE: minting
        </span>ctx.accounts.init_token(name, symbol, uri)<span class="question-mark">?</span>;
    }
    {
        ctx.accounts.verify_collection_item(ctx.program_id)<span class="question-mark">?</span>;
    }
    <span class="prelude-val">Ok</span>(())
}

<span class="doccomment">/// Struct used to create context while preparing instruction for initialize pass token
</span><span class="attr">#[derive(Accounts)]
</span><span class="kw">pub struct </span>AInitPassToken&lt;<span class="lifetime">'info</span>&gt; {
    ...
    <span class="doccomment">/// signer token assoicated account public key
        ...
        constraint = user_profile_ata.amount == <span class="number">1 </span>@ MyError::OnlyProfileHolderAllow,
    )]
    ...
    </span><span class="kw">pub </span>user_activation_token_ata: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,

    <span class="doccomment">/// project public key
    ///CHECK:
    </span><span class="kw">pub </span>project: Box&lt;Account&lt;<span class="lifetime">'info</span>, Mint&gt;&gt;,

    <span class="doccomment">/// load project mainstate account public key
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
        seeds = [SEED_MAIN_STATE, project.key().as_ref()]</span>,
        bump,
    )]
    <span class="kw">pub </span>main_state: Box&lt;Account&lt;<span class="lifetime">'info</span>, MainState&gt;&gt;,

    <span class="doccomment">/// load mainstate account public key
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
        seeds = [SEED_MAIN_STATE]</span>,
        bump,
    )]
    <span class="kw">pub </span>parent_main_state: Box&lt;Account&lt;<span class="lifetime">'info</span>, MainState&gt;&gt;,

    <span class="doccomment">/// activation token public key
    ///CHECK:
    </span><span class="attr">#[account(<span class="kw-2">mut</span>, signer)]
    </span><span class="kw">pub </span>activation_token: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
    ...
    <span class="doccomment">/// load activiation state account public key 
        ...
        bump,
        space = <span class="number">8 </span>+ ActivationTokenState::MAX_SIZE,
    )]
    <span class="kw">pub </span>activation_token_state: Box&lt;Account&lt;<span class="lifetime">'info</span>, ActivationTokenState&gt;&gt;,

    <span class="doccomment">/// load activiation metadata account public key 
    ///CHECK:
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
        seeds=[
    ...
    <span class="kw">pub </span>activation_token_metadata: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
    ...
    <span class="doccomment">/// load profile collection authority public key 
    ///CHECK:
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
        seeds = [
            ...
            MPL_ID.as_ref(),
            profile.key().as_ref(),
            <span class="string">"collection_authority"</span>.as_bytes(),
            main_state.key().as_ref(),
        ]</span>,
        bump,
        seeds::program = MPL_ID
    )]
    <span class="kw">pub </span>profile_collection_authority_record: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,

    <span class="doccomment">/// collection nft to make nft as verified nft
    ///CHECK:
    </span><span class="attr">#[account(<span class="kw-2">mut</span>)]
    </span><span class="kw">pub </span>parent_collection: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
    ...
    <span class="kw">pub </span>parent_collection_metadata: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,

    <span class="doccomment">/// load parent collection edition account public key 
    ///CHECK:
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
        seeds=[
    ...
    <span class="kw">pub </span>parent_collection_edition: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AInitPassToken&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>init_token(
        ...
        <span class="kw">let </span>metadata = <span class="self">self</span>.activation_token_metadata.to_account_info();
        <span class="kw">let </span>mpl_program = <span class="self">self</span>.mpl_program.to_account_info();
        <span class="kw">let </span>ata_program = <span class="self">self</span>.associated_token_program.to_account_info();
        ...
        <span class="kw">let </span>asset_data = CreateArgs::V1 {
            ...
            collection: <span class="prelude-val">Some</span>(mpl_token_metadata::types::Collection {
                ...
                key: <span class="self">self</span>.parent_collection.key(),
            }),
            uses: <span class="prelude-val">None</span>,
            creators: <span class="prelude-val">Some</span>(<span class="macro">vec!</span>[
                Creator {
                ...
                Creator {
                    address: <span class="self">self</span>.profile.key(),
                    verified: <span class="bool-val">false</span>,
                    share: <span class="number">0</span>,
                },
                Creator {
            ...
            primary_sale_happened: <span class="bool-val">false</span>,
            seller_fee_basis_points: <span class="number">100</span>,
            decimals: <span class="prelude-val">Some</span>(<span class="number">0</span>),
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[SEED_MAIN_STATE, <span class="self">self</span>.project.key().as_ref(), <span class="kw-2">&amp;</span>[main_state._bump]]],
    ...
    <span class="kw">pub fn </span>verify_collection_item(<span class="kw-2">&amp;mut </span><span class="self">self</span>, program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        ...
        <span class="kw">let </span>mpl_program = <span class="self">self</span>.mpl_program.to_account_info();
        <span class="kw">let </span>metadata = <span class="self">self</span>.activation_token_metadata.to_account_info();
        <span class="kw">let </span>main_state = <span class="kw-2">&amp;mut </span><span class="self">self</span>.parent_main_state;
        <span class="kw">let </span>collection = <span class="self">self</span>.parent_collection.to_account_info();
        <span class="kw">let </span>collection_metadata = <span class="self">self</span>.parent_collection_metadata.to_account_info();
        <span class="kw">let </span>collection_edition = <span class="self">self</span>.parent_collection_edition.to_account_info();
        ...
        <span class="kw">let </span>ix = Verify {
            collection_metadata: <span class="prelude-val">Some</span>(collection_metadata.key()),
            metadata: metadata.key(),
            authority: main_state.key(),
            collection_mint: <span class="prelude-val">Some</span>(collection.key()),
            collection_master_edition: <span class="prelude-val">Some</span>(collection_edition.key()),
            system_program: system_program.key(),
            sysvar_instructions: sysvar_instructions.key(),
            <span class="comment">// delegate_record: Some(collection_authority_record.key()),
            </span>delegate_record: <span class="prelude-val">None</span>,
        }
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[
                ...
                mpl_program,
                system_program,
                <span class="comment">// collection_authority_record,
                </span>sysvar_instructions,
            ],
