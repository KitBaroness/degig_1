...
<span class="doccomment">/// This is the function which used to create instruction for initalize activation token
</span><span class="kw">pub fn </span>init_activation_token(
...
<span class="doccomment">/// Struct used to create context while preparing instruction for initialize activation token
</span><span class="attr">#[derive(Accounts)]
</span><span class="kw">pub struct </span>AInitActivationToken&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AInitActivationToken&lt;<span class="lifetime">'info</span>&gt; {
