...
<span class="doccomment">/// This is the function which used to create instruction for mint gensis pass nft
</span><span class="kw">pub fn </span>mint_genesis_pass(
...
<span class="doccomment">/// Struct used to create context while preparing instruction for create new gensis pass nft
...
#[instruction(
...
</span><span class="kw">pub struct </span>AMintPassByAdmin&lt;<span class="lifetime">'info</span>&gt; {
    ...
    <span class="doccomment">/// load project mainstate account with seed for update purpose
    </span><span class="attr">#[account(
        init,
        payer = user,
        seeds = [SEED_MAIN_STATE, profile.key().as_ref()]</span>,
        bump,
        space = <span class="number">8 </span>+ MainState::MAX_SIZE, 
    )]
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AMintPassByAdmin&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>mint(<span class="kw-2">&amp;mut </span><span class="self">self</span>, name: String, symbol: String, uri_hash: String) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        ...
        // Creators Setup for royalty
            ...
            creators: <span class="prelude-val">Some</span>(<span class="macro">vec!</span>[Creator {
                ...
                address: <span class="self">self</span>.user.key(),
            }]),
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[
                <span class="kw-2">&amp;</span>[SEED_MAIN_STATE, mint.key().as_ref(), <span class="kw-2">&amp;</span>[<span class="self">self</span>.main_state._bump]],
            ],
    ...
    <span class="kw">pub fn </span>verify_collection_item(<span class="kw-2">&amp;mut </span><span class="self">self</span>, program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        ...
        <span class="kw">let </span>mpl_program = <span class="self">self</span>.mpl_program.to_account_info();
        <span class="kw">let </span>metadata = <span class="self">self</span>.profile_metadata.to_account_info();
        <span class="kw">let </span>parent_main_state = <span class="kw-2">&amp;mut </span><span class="self">self</span>.parent_main_state;
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[SEED_MAIN_STATE, <span class="kw-2">&amp;</span>[parent_main_state._bump]]],
        )<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }
