...
</span><span class="kw">pub struct </span>MintPassByAtInput {
    <span class="kw">pub </span>name: String,
    <span class="kw">pub </span>symbol: String,
    <span class="comment">// pub uri: String,
    </span><span class="kw">pub </span>uri_hash: String,
}

<span class="doccomment">/// This is the function which used to create instruction for mint new pass nft
...
<span class="doccomment">/// Struct used to create context while preparing instruction for create new pass nft
...
#[instruction(
...
</span><span class="kw">pub struct </span>AMintPassByAt&lt;<span class="lifetime">'info</span>&gt; {
    ...
    ///CHECK:
    </span><span class="kw">pub </span>project: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
    ...
    </span><span class="comment">// #[account(address = ADDRESS_LOOKUP_TABLE_PROGRAM)]
    // pub address_lookup_table_program: AccountInfo&lt;'info&gt;,

    </span><span class="doccomment">/// system var instruction public key
    ///CHECK:
    </span><span class="attr">#[account()]
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AMintPassByAt&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>mint(<span class="kw-2">&amp;mut </span><span class="self">self</span>, name: String, symbol: String, uri_hash: String) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        ...
        </span><span class="kw">let </span>seller_fee_basis_points = TOTAL_SELLER_BASIS_POINTS;
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[
                <span class="kw-2">&amp;</span>[SEED_MAIN_STATE, <span class="self">self</span>.project.key().as_ref(), <span class="kw-2">&amp;</span>[<span class="self">self</span>.main_state._bump]],
            ],
...
</span><span class="kw">pub struct </span>TransferModel&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub </span>account_opos_ata: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
