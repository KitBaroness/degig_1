...
<span class="doccomment">/// This is the function which used to create instruction for mint guest pass nft
    ...
    <span class="kw">let </span>uri_hash = <span class="kw-2">*</span>uri_hash;
    {
        ...
        <span class="kw">if </span>main_state.invitation_minting_cost &gt; <span class="number">0 </span>{
            <span class="kw">return </span><span class="prelude-val">Err</span>(<span class="macro">error!</span>(MyError::NOTEligibleForGuestPass));
        }
...
<span class="doccomment">/// Struct used to create context while preparing instruction for create new guest pass nft
</span><span class="attr">#[derive(Accounts)]
#[instruction(
    name: Box&lt;String&gt;,
    symbol: Box&lt;String&gt;,
    uri: Box&lt;String&gt;,
)]</span><span class="kw">pub struct </span>AMintGuestPass&lt;<span class="lifetime">'info</span>&gt; {
    ...
    <span class="doccomment">/// profile public key
    ///CHECK:
    </span><span class="attr">#[account(
        <span class="kw-2">mut</span>,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; AMintGuestPass&lt;<span class="lifetime">'info</span>&gt; {
