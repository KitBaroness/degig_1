...
<span class="kw">use </span>anchor_spl::{associated_token::AssociatedToken, token::{Mint, Token, TokenAccount}};
...
<span class="kw">use </span>solana_program::program::invoke_signed;

<span class="kw">use crate</span>::{constants::SEED_LAUNCH_PASS, launchpass::LaunchPassState, other_states::MintingCostDistribution};
...
<span class="kw">pub fn </span>init_launch_pass(
    ...
    {
        <span class="kw">let </span>launch_pass = <span class="kw-2">&amp;mut </span>ctx.accounts.launch_pass;
...
<span class="attr">#[derive(Accounts)]
</span><span class="kw">pub struct </span>InitLaunchPass&lt;<span class="lifetime">'info</span>&gt; {
    <span class="attr">#[account(
        <span class="kw-2">mut</span>,
    )]
    </span><span class="kw">pub </span>owner: Signer&lt;<span class="lifetime">'info</span>&gt;,
    ...
    <span class="attr">#[account(
        ...
        bump,
        payer = owner,
        space= <span class="number">8 </span>+ LaunchPassState::MAX_SIZE
    )]
    <span class="kw">pub </span>launch_pass: Box&lt;Account&lt;<span class="lifetime">'info</span>, LaunchPassState&gt;&gt;,
    ...
    <span class="kw">pub </span>mint_metadata: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; InitLaunchPass&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>init_launch(<span class="kw-2">&amp;</span><span class="self">self</span>, name: String, symbol: String, uri: String) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        <span class="kw">let </span>mint = <span class="self">self</span>.mint.to_account_info();
        <span class="kw">let </span>user = <span class="self">self</span>.owner.to_account_info();
        ...
        <span class="kw">let </span>metadata = <span class="self">self</span>.mint_metadata.to_account_info();
        <span class="kw">let </span>mpl_program = <span class="self">self</span>.mpl_program.to_account_info();
        ...
        <span class="kw">let </span>main_state = <span class="self">self</span>.launch_pass.clone();
        ...
        invoke_signed(
            ...
            <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[SEED_LAUNCH_PASS, user.key().as_ref(), <span class="self">self</span>.mint.key().as_ref(), <span class="kw-2">&amp;</span>[main_state._bump]]],
