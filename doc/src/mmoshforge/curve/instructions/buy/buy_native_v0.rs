...
</span><span class="kw">pub struct </span>BuyNativeV0&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">pub fn </span>handler(ctx: Context&lt;BuyNativeV0&gt;, args: BuyV0Args) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
  ...
  //   target_royalties
  // );
  </span><span class="kw">let </span>source = <span class="kw-2">&amp;</span>ctx.accounts.source;
  <span class="kw">let </span>base_storage_account = <span class="kw-2">&amp;</span>ctx.accounts.common.base_storage;
  ...
  <span class="kw">if </span>base_royalties &gt; <span class="number">0 </span>{
    <span class="comment">// msg!("Paying out {} base royalties", base_royalties);
    </span>invoke(
      <span class="kw-2">&amp;</span>system_instruction::transfer(<span class="kw-2">&amp;</span>source.key(), <span class="kw-2">&amp;</span>base_royalties_account.key(), base_royalties),
  ...
  <span class="comment">// msg!("Paying out {} to base storage", price);
  </span>buy_wrapped_sol(
    <span class="kw-2">&amp;</span>BuyWrappedSolV0 {
    ...
    <span class="kw-2">&amp;</span>BuyWrappedSolV0Args { amount: price },
  )<span class="question-mark">?</span>;
