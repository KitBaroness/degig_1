...
<span class="attr">#[derive(Accounts)]
</span><span class="kw">pub struct </span>BuyCommonV0&lt;<span class="lifetime">'info</span>&gt; {
  ...
  <span class="attr">#[account(<span class="kw-2">mut</span>)]
  </span><span class="doccomment">/// CHECK: Token account could have been closed. This is fine if royalties are 0
  </span><span class="kw">pub </span>buy_base_royalties: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
  <span class="attr">#[account(<span class="kw-2">mut</span>)]
  </span><span class="kw">pub </span>destination: Box&lt;Account&lt;<span class="lifetime">'info</span>, TokenAccount&gt;&gt;,
  <span class="attr">#[account(<span class="kw-2">mut</span>)]
  </span><span class="doccomment">/// CHECK: Token account could have been closed. This is fine if royalties are 0
  </span><span class="kw">pub </span>buy_target_royalties: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
