...
</span><span class="kw">pub struct </span>UpdateCurveV0Args {
...
</span><span class="kw">pub struct </span>UpdateCurveV0&lt;<span class="lifetime">'info</span>&gt; {
  <span class="attr">#[account(
    <span class="kw-2">mut</span>,
    constraint = token_bonding.curve_authority.ok_or(<span class="macro">error!</span>(ErrorCode::NoAuthority))<span class="question-mark">? </span>== curve_authority.key()
  )]
  </span><span class="kw">pub </span>token_bonding: Box&lt;Account&lt;<span class="lifetime">'info</span>, TokenBondingV0&gt;&gt;,
  <span class="kw">pub </span>curve_authority: Signer&lt;<span class="lifetime">'info</span>&gt;,
  <span class="kw">pub </span>curve: Box&lt;Account&lt;<span class="lifetime">'info</span>, CurveV0&gt;&gt;,
}

<span class="kw">pub fn </span>handler(ctx: Context&lt;UpdateCurveV0&gt;, args: UpdateCurveV0Args) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
