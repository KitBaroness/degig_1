...
<a href="#110" id="110">110</a>
  ...
  sell_account_common::<span class="kw-2">*</span>,
  sell_arg_common::SellV0Args,
  sell_wrapped_sol_v0::{sell_wrapped_sol, SellWrappedSolV0, SellWrappedSolV0Args},
};
<span class="kw">use </span><span class="kw">crate</span>::curve::state::<span class="kw-2">*</span>;
...
</span><span class="kw">pub struct </span>SellNativeV0&lt;<span class="lifetime">'info</span>&gt; {
  <span class="kw">pub </span>common: SellCommonV0&lt;<span class="lifetime">'info</span>&gt;,
  <span class="doccomment">/// CHECK: Checked by cpi to spl token
  </span><span class="attr">#[account(<span class="kw-2">mut</span>)]
  </span><span class="kw">pub </span>destination: AccountInfo&lt;<span class="lifetime">'info</span>&gt;,
...
<span class="kw">pub fn </span>handler(ctx: Context&lt;SellNativeV0&gt;, args: SellV0Args) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
  <span class="kw">let </span>amount = args.target_amount;

  <span class="kw">let </span>SellAmount {
    reclaimed,
    base_royalties,
    target_royalties,
  } = sell_shared_logic(<span class="kw-2">&amp;mut </span>ctx.accounts.common, <span class="kw-2">&amp;</span>args)<span class="question-mark">?</span>;
  ...
  </span>burn_and_pay_sell_royalties(amount, target_royalties, <span class="kw-2">&amp;</span>ctx.accounts.common)<span class="question-mark">?</span>;

  <span class="kw">let </span>base_storage_account = <span class="kw-2">&amp;</span>ctx.accounts.common.base_storage.clone();
  <span class="kw">let </span>destination = <span class="kw-2">&amp;</span>ctx.accounts.destination;
  <span class="kw">let </span>token_bonding = <span class="kw-2">&amp;mut </span>ctx.accounts.common.token_bonding;
  <span class="kw">let </span>target_mint = <span class="kw-2">&amp;mut </span>ctx.accounts.common.target_mint;
  ...
  // );
  </span><span class="kw">let </span>bonding_seeds: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[u8]]] = <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[
  ...
  sell_wrapped_sol(
    <span class="kw-2">&amp;</span>SellWrappedSolV0 {
    ...
    <span class="kw-2">&amp;</span>SellWrappedSolV0Args {
      amount: reclaimed,
      all: <span class="bool-val">false</span>,
    },
    <span class="prelude-val">Some</span>(bonding_seeds),
  )<span class="question-mark">?</span>;

  <span class="kw">if </span>base_royalties &gt; <span class="number">0 </span>&amp;&amp; ctx.accounts.common.sell_base_royalties.lamports() &gt; <span class="number">0 </span>{
    <span class="macro">msg!</span>(
      <span class="string">"Paying out {} from base storage to base royalties"</span>,
      base_royalties
    );
    sell_wrapped_sol(
      <span class="kw-2">&amp;</span>SellWrappedSolV0 {
