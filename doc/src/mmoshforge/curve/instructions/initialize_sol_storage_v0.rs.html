...
<span class="kw">use </span>anchor_spl::token::{Mint, Token};

<span class="attr">#[derive(AnchorSerialize, AnchorDeserialize, Clone, Default)]
</span><span class="kw">pub struct </span>InitializeSolStorageV0Args {
...
#[instruction(args: InitializeSolStorageV0Args)]
</span><span class="kw">pub struct </span>InitializeSolStorageV0&lt;<span class="lifetime">'info</span>&gt; {
  ...
  <span class="attr">#[account(
    init,
    space = <span class="number">212</span>,
    seeds = [<span class="string">"state"</span>.as_bytes()]</span>,
    bump,
    payer = payer
  )]
  <span class="kw">pub </span>state: Account&lt;<span class="lifetime">'info</span>, ProgramStateV0&gt;,
  <span class="attr">#[account(
    seeds = [<span class="string">"sol-storage"</span>.as_bytes()]</span>,
    bump = args.sol_storage_bump_seed,
  )]
  <span class="kw">pub </span>sol_storage: SystemAccount&lt;<span class="lifetime">'info</span>&gt;,
  <span class="attr">#[account(
    constraint = wrapped_sol_mint.mint_authority.unwrap() == mint_authority.key() &amp;&amp;
                 ...
                 wrapped_sol_mint.supply == <span class="number">0
  </span>)]
  </span><span class="kw">pub </span>wrapped_sol_mint: Account&lt;<span class="lifetime">'info</span>, Mint&gt;,
  <span class="attr">#[account(
    seeds = [<span class="string">"wrapped-sol-authority"</span>.as_bytes()]</span>,
    bump = args.mint_authority_bump_seed
  )]
  <span class="doccomment">/// CHECK: Authority, used in CPIs
...
<span class="kw">pub fn </span>handler(
  ...
  <span class="kw">let </span>state = <span class="kw-2">&amp;mut </span>ctx.accounts.state;
