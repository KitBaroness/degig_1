...
<span class="kw">pub fn </span>stake_vault(
    ctx: Context&lt;StakeVault&gt;,
    value: u64
) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
    {
        ctx.accounts.init_stake_vault(value)<span class="question-mark">?</span>;
    }
    <span class="prelude-val">Ok</span>(())
}

<span class="attr">#[derive(Accounts)]
</span><span class="kw">pub struct </span>StakeVault&lt;<span class="lifetime">'info</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; StakeVault&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>init_stake_vault(<span class="kw-2">&amp;</span><span class="self">self</span>, value: u64) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        <span class="comment">// transfer_tokens(
