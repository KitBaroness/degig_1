...
<span class="kw">use </span>anchor_spl::{associated_token::AssociatedToken, token::{<span class="self">self</span>, Mint, Token, TokenAccount, Transfer}};

<span class="kw">use crate</span>::{constants::SEED_VAULT, error::MyError, vault::VaultState};

<span class="kw">pub fn </span>unstake_vault(
    ctx: Context&lt;UnstakeVault&gt;,
    value: u64
) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
    {
        ctx.accounts.init_unstake_vault(value)<span class="question-mark">?</span>;
    }
...
<span class="attr">#[derive(Accounts)]
...
</span><span class="kw">pub struct </span>UnstakeVault&lt;<span class="lifetime">'info</span>&gt; {
    ...
    <span class="attr">#[account(
        ...
        </span>constraint = vault.authority.key() == receiver.key() @ MyError::OnlyOwnerCanCall,
    )]
...
<span class="kw">impl</span>&lt;<span class="lifetime">'info</span>&gt; UnstakeVault&lt;<span class="lifetime">'info</span>&gt; {
    <span class="kw">pub fn </span>init_unstake_vault(<span class="kw-2">&amp;</span><span class="self">self</span>, value: u64) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
        <span class="kw">if </span><span class="self">self</span>.vault.lock_date <span class="kw">as </span>i64 &gt; <span class="self">self</span>.clock.unix_timestamp {
        ...
        token::transfer(CpiContext::new(<span class="self">self</span>.token_program.to_account_info(), cpi_accounts).with_signer(<span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[SEED_VAULT, <span class="self">self</span>.stake_key.key().as_ref() ,<span class="self">self</span>.mint.key().as_ref(), <span class="kw-2">&amp;</span>[<span class="self">self</span>.vault._bump]]]), value)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }
