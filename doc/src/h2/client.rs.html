...
</pre></div><pre class="rust"><code><span class="doccomment">//! Client implementation of the HTTP/2 protocol.
//!
//! # Getting started
//!
    ...
    </span>B: Buf,
{
    ...
    /// [`SendStream::send_trailers`]: ../struct.SendStream.html#method.send_trailers
        ...
        <span class="self">self</span>.inner
            ...
            .map_err(Into::into)
            .map(|(stream, is_full)| {
                <span class="kw">if </span>stream.is_pending_open() &amp;&amp; is_full {
                    <span class="comment">// Only prevent sending another request when the request queue
                    // is not full.
                    </span><span class="self">self</span>.pending = <span class="prelude-val">Some</span>(stream.clone_to_opaque());
                }
...
<span class="comment">// ===== impl Builder =====
    ...
    <span class="doccomment">/// Sets the header table size.
    ///
    ...
    /// # pub fn main() {}
    /// ```
    </span><span class="kw">pub fn </span>header_table_size(<span class="kw-2">&amp;mut </span><span class="self">self</span>, size: u32) -&gt; <span class="kw-2">&amp;mut </span><span class="self">Self </span>{
        <span class="self">self</span>.settings.set_header_table_size(<span class="prelude-val">Some</span>(size));
        <span class="self">self
    </span>}
...
<span class="kw">impl </span>proto::Peer <span class="kw">for </span>Peer {
    ...
    */
    ...
    </span><span class="kw">fn </span>convert_poll_message(
        pseudo: Pseudo,
        fields: HeaderMap,
        stream_id: StreamId,
