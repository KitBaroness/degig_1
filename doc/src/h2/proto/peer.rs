...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::error::Reason;
...
<span class="doccomment">/// Either a Client or a Server
    ...
    <span class="comment">//fn is_server() -&gt; bool;
