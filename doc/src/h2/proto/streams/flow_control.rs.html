...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::frame::Reason;
...
<span class="kw">impl </span>FlowControl {
    ...
    <span class="kw">pub fn </span>claim_capacity(<span class="kw-2">&amp;mut </span><span class="self">self</span>, capacity: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="self">self</span>.available.decrease_by(capacity)
    }

    <span class="kw">pub fn </span>assign_capacity(<span class="kw-2">&amp;mut </span><span class="self">self</span>, capacity: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="self">self</span>.available.increase_by(capacity)
    }
    ...
    /// INITIAL_WINDOW_SIZE value.
    </span><span class="kw">pub fn </span>dec_send_window(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sz: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="macro">tracing::trace!</span>(
        ...
        <span class="comment">// ~~This should not be able to overflow `window_size` from the bottom.~~ wrong. it can.
        </span><span class="self">self</span>.window_size.decrease_by(sz)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }
    ...
    /// INITIAL_WINDOW_SIZE value.
    </span><span class="kw">pub fn </span>dec_recv_window(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sz: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="macro">tracing::trace!</span>(
        ...
        <span class="self">self</span>.available.decrease_by(sz)<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Decrements the window reflecting data has actually been sent. The caller
    /// must ensure that the window has capacity.
    </span><span class="kw">pub fn </span>send_data(<span class="kw-2">&amp;mut </span><span class="self">self</span>, sz: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="macro">tracing::trace!</span>(
        ...
        <span class="comment">// If send size is zero it's meaningless to update flow control window
        </span><span class="kw">if </span>sz &gt; <span class="number">0 </span>{
            <span class="comment">// Ensure that the argument is correct
            </span><span class="macro">assert!</span>(<span class="self">self</span>.window_size.<span class="number">0 </span>&gt;= sz <span class="kw">as </span>i32);
...
<span class="kw">impl </span>Window {
    ...
    <span class="kw">pub fn </span>decrease_by(<span class="kw-2">&amp;mut </span><span class="self">self</span>, other: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(v) = <span class="self">self</span>.<span class="number">0</span>.checked_sub(other <span class="kw">as </span>i32) {
            <span class="self">self</span>.<span class="number">0 </span>= v;
            <span class="prelude-val">Ok</span>(())
        } <span class="kw">else </span>{
            <span class="prelude-val">Err</span>(Reason::FLOW_CONTROL_ERROR)
        }
    }

    <span class="kw">pub fn </span>increase_by(<span class="kw-2">&amp;mut </span><span class="self">self</span>, other: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;(), Reason&gt; {
        <span class="kw">let </span>other = <span class="self">self</span>.add(other)<span class="question-mark">?</span>;
        <span class="self">self</span>.<span class="number">0 </span>= other.<span class="number">0</span>;
        <span class="prelude-val">Ok</span>(())
    }

    <span class="kw">pub fn </span>add(<span class="kw-2">&amp;</span><span class="self">self</span>, other: WindowSize) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, Reason&gt; {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(v) = <span class="self">self</span>.<span class="number">0</span>.checked_add(other <span class="kw">as </span>i32) {
            <span class="prelude-val">Ok</span>(<span class="self">Self</span>(v))
        } <span class="kw">else </span>{
            <span class="prelude-val">Err</span>(Reason::FLOW_CONTROL_ERROR)
        }
    }
