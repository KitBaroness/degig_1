...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::codec::SendError;
...
<span class="kw">impl </span>Error {
    ...
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>library_go_away_data(reason: Reason, debug_data: <span class="kw">impl </span>Into&lt;Bytes&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::GoAway(debug_data.into(), reason, Initiator::Library)
    }
...
<span class="kw">impl </span>From&lt;io::ErrorKind&gt; <span class="kw">for </span>Error {
    <span class="kw">fn </span>from(src: io::ErrorKind) -&gt; <span class="self">Self </span>{
        Error::Io(src, <span class="prelude-val">None</span>)
    }
}
