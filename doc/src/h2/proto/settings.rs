        ...
        <span class="kw">if </span>frame.is_ack() {
            <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.local {
                Local::WaitingAck(local) =&gt; {
                    ...
                    <span class="kw">if let </span><span class="prelude-val">Some</span>(val) = local.header_table_size() {
                        codec.set_recv_header_table_size(val <span class="kw">as </span>usize);
                    }
