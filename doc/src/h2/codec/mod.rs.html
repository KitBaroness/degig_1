...
<span class="kw">impl</span>&lt;T, B&gt; Codec&lt;T, B&gt; {
    ...
    <span class="doccomment">/// Set the decoder header table size size.
    </span><span class="kw">pub fn </span>set_recv_header_table_size(<span class="kw-2">&amp;mut </span><span class="self">self</span>, val: usize) {
        <span class="self">self</span>.inner.set_header_table_size(val)
    }
