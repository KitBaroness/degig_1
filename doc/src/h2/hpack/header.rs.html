...
</pre></div><pre class="rust"><code><span class="kw">use super</span>::{DecoderError, NeedMore};
...
<span class="kw">impl </span>Header {
    ...
    <span class="kw">pub fn </span>skip_value_index(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            Header::Field { <span class="kw-2">ref </span>name, .. } =&gt; <span class="macro">matches!</span>(
