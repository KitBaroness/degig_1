...
<span class="attr">#[cfg(feature = <span class="string">"bilock"</span>)]
...
<span class="kw">impl</span>&lt;T&gt; BiLock&lt;T&gt; {
    ...
    </span><span class="attr">#[cfg(feature = <span class="string">"bilock"</span>)]
    #[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"bilock"</span>)))]
    ...
    <span class="doccomment">/// Returns `true` only if the other `BiLock&lt;T&gt;` originated from the same call to `BiLock::new`.
    </span><span class="kw">pub fn </span>is_pair_of(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span><span class="self">Self</span>) -&gt; bool {
        Arc::ptr_eq(<span class="kw-2">&amp;</span><span class="self">self</span>.arc, <span class="kw-2">&amp;</span>other.arc)
    }
    ...
    {
        <span class="kw">if </span><span class="self">self</span>.is_pair_of(<span class="kw-2">&amp;</span>other) {
            drop(other);
...
</span><span class="attr">#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"bilock"</span>)))]
...
</span><span class="attr">#[allow(clippy::useless_transmute)]
#[inline]
