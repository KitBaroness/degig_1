...
</pre></div><pre class="rust"><code><span class="doccomment">//! This module contains the `Never` type.
//!
...
</span><span class="kw">pub type </span>Never = core::convert::Infallible;
