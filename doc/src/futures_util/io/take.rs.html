...
<span class="kw">use </span>futures_io::{AsyncBufRead, AsyncRead};
<span class="kw">use </span>pin_project_lite::pin_project;
<span class="kw">use </span>std::pin::Pin;
<span class="kw">use </span>std::{cmp, io};

<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Reader for the [`take`](super::AsyncReadExt::take) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"readers do nothing unless you `.await` or poll them"</span>]
...
<span class="kw">impl</span>&lt;R: AsyncRead&gt; Take&lt;R&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(inner: R, limit: u64) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ inner, limit }
    }
...
<span class="kw">impl</span>&lt;R: AsyncRead&gt; AsyncRead <span class="kw">for </span>Take&lt;R&gt; {
    <span class="kw">fn </span>poll_read(
        ...
        <span class="kw">if </span><span class="kw-2">*</span>this.limit == <span class="number">0 </span>{
            <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Ok</span>(<span class="number">0</span>));
        }

        <span class="kw">let </span>max = cmp::min(buf.len() <span class="kw">as </span>u64, <span class="kw-2">*</span>this.limit) <span class="kw">as </span>usize;
        <span class="kw">let </span>n = <span class="macro">ready!</span>(this.inner.poll_read(cx, <span class="kw-2">&amp;mut </span>buf[..max]))<span class="question-mark">?</span>;
        <span class="kw-2">*</span>this.limit -= n <span class="kw">as </span>u64;
...
<span class="kw">impl</span>&lt;R: AsyncBufRead&gt; AsyncBufRead <span class="kw">for </span>Take&lt;R&gt; {
    <span class="kw">fn </span>poll_fill_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;<span class="kw-2">&amp;</span>[u8]&gt;&gt; {
        ...
        </span><span class="kw">if </span><span class="kw-2">*</span>this.limit == <span class="number">0 </span>{
            <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Ok</span>(<span class="kw-2">&amp;</span>[]));
        }

        <span class="kw">let </span>buf = <span class="macro">ready!</span>(this.inner.poll_fill_buf(cx)<span class="question-mark">?</span>);
        <span class="kw">let </span>cap = cmp::min(buf.len() <span class="kw">as </span>u64, <span class="kw-2">*</span>this.limit) <span class="kw">as </span>usize;
    ...
    <span class="kw">fn </span>consume(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, amt: usize) {
        ...
        </span><span class="kw">let </span>amt = cmp::min(amt <span class="kw">as </span>u64, <span class="kw-2">*</span>this.limit) <span class="kw">as </span>usize;
        <span class="kw-2">*</span>this.limit -= amt <span class="kw">as </span>u64;
