...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::buf_writer::BufWriter;
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; LineWriter&lt;W&gt; {
    ...
    </span><span class="kw">pub fn </span>new(inner: W) -&gt; LineWriter&lt;W&gt; {
        LineWriter::with_capacity(<span class="number">1024</span>, inner)
    }

    <span class="doccomment">/// Creates a new `LineWriter` with the specified buffer capacity.
    </span><span class="kw">pub fn </span>with_capacity(capacity: usize, inner: W) -&gt; LineWriter&lt;W&gt; {
