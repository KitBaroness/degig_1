...
</pre></div><pre class="rust"><code><span class="kw">use </span>futures_core::task::{Context, Poll};
<span class="kw">use </span>futures_io::{AsyncBufRead, AsyncRead, AsyncSeek, AsyncWrite, IoSlice, IoSliceMut, SeekFrom};
<span class="kw">use </span>std::pin::Pin;
<span class="kw">use </span>std::{fmt, io};

<span class="doccomment">/// A simple wrapper type which allows types which implement only
...
</span><span class="kw">pub struct </span>AllowStdIo&lt;T&gt;(T);

<span class="kw">impl</span>&lt;T&gt; Unpin <span class="kw">for </span>AllowStdIo&lt;T&gt; {}

<span class="macro">macro_rules!</span> try_with_interrupt {
        ...
        <span class="kw">loop </span>{
            <span class="kw">match </span><span class="macro-nonterminal">$e </span>{
                <span class="prelude-val">Ok</span>(e) =&gt; {
                    <span class="kw">break </span>e;
                }
                <span class="prelude-val">Err</span>(<span class="kw-2">ref </span>e) <span class="kw">if </span>e.kind() == ::std::io::ErrorKind::Interrupted =&gt; {
...
<span class="kw">impl</span>&lt;T&gt; AllowStdIo&lt;T&gt; {
    <span class="doccomment">/// Creates a new `AllowStdIo` from an existing IO object.
    </span><span class="kw">pub fn </span>new(io: T) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>(io)
    }

    <span class="doccomment">/// Returns a reference to the contained IO object.
    ...
    <span class="doccomment">/// Returns a mutable reference to the contained IO object.
    ...
    <span class="doccomment">/// Consumes self and returns the contained IO object.
    </span><span class="kw">pub fn </span>into_inner(<span class="self">self</span>) -&gt; T {
        <span class="self">self</span>.<span class="number">0
    </span>}
}

<span class="kw">impl</span>&lt;T&gt; io::Write <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Write,
{
    ...
    <span class="kw">fn </span>write_fmt(<span class="kw-2">&amp;mut </span><span class="self">self</span>, fmt: fmt::Arguments&lt;<span class="lifetime">'_</span>&gt;) -&gt; io::Result&lt;()&gt; {
        <span class="self">self</span>.<span class="number">0</span>.write_fmt(fmt)
    }
}

<span class="kw">impl</span>&lt;T&gt; AsyncWrite <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Write,
{
    <span class="kw">fn </span>poll_write(
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.write(buf))))
    }
    ...
    <span class="kw">fn </span>poll_write_vectored(
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.write_vectored(bufs))))
    }
    ...
    <span class="kw">fn </span>poll_flush(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        <span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.flush());
...
<span class="kw">impl</span>&lt;T&gt; io::Read <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Read,
{
    ...
    <span class="kw">fn </span>read_to_string(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>String) -&gt; io::Result&lt;usize&gt; {
        <span class="self">self</span>.<span class="number">0</span>.read_to_string(buf)
    }
    <span class="kw">fn </span>read_exact(<span class="kw-2">&amp;mut </span><span class="self">self</span>, buf: <span class="kw-2">&amp;mut </span>[u8]) -&gt; io::Result&lt;()&gt; {
        <span class="self">self</span>.<span class="number">0</span>.read_exact(buf)
    }
}

<span class="kw">impl</span>&lt;T&gt; AsyncRead <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Read,
{
    <span class="kw">fn </span>poll_read(
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.read(buf))))
    }
    ...
    <span class="kw">fn </span>poll_read_vectored(
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.read_vectored(bufs))))
    }
}

<span class="kw">impl</span>&lt;T&gt; io::Seek <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Seek,
{
    <span class="kw">fn </span>seek(<span class="kw-2">&amp;mut </span><span class="self">self</span>, pos: SeekFrom) -&gt; io::Result&lt;u64&gt; {
        <span class="self">self</span>.<span class="number">0</span>.seek(pos)
    }
}

<span class="kw">impl</span>&lt;T&gt; AsyncSeek <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::Seek,
{
    <span class="kw">fn </span>poll_seek(
        ...
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="self">self</span>.<span class="number">0</span>.seek(pos))))
    }
}

<span class="kw">impl</span>&lt;T&gt; io::BufRead <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::BufRead,
{
    <span class="kw">fn </span>fill_buf(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; io::Result&lt;<span class="kw-2">&amp;</span>[u8]&gt; {
        <span class="self">self</span>.<span class="number">0</span>.fill_buf()
    }
    <span class="kw">fn </span>consume(<span class="kw-2">&amp;mut </span><span class="self">self</span>, amt: usize) {
        <span class="self">self</span>.<span class="number">0</span>.consume(amt)
    }
}

<span class="kw">impl</span>&lt;T&gt; AsyncBufRead <span class="kw">for </span>AllowStdIo&lt;T&gt;
<span class="kw">where
    </span>T: io::BufRead,
{
    <span class="kw">fn </span>poll_fill_buf(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, <span class="kw">_</span>: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;<span class="kw-2">&amp;</span>[u8]&gt;&gt; {
        <span class="kw">let </span>this: <span class="kw-2">*mut </span><span class="self">Self </span>= <span class="kw-2">&amp;mut *</span><span class="self">self </span><span class="kw">as </span><span class="kw-2">*mut </span><span class="kw">_</span>;
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="macro">try_with_interrupt!</span>(<span class="kw">unsafe </span>{ <span class="kw-2">&amp;mut *</span>this }.<span class="number">0</span>.fill_buf())))
    }
