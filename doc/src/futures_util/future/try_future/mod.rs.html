...
</pre></div><pre class="rust"><code><span class="doccomment">//! Futures
//!
//! This module contains a number of functions for working with `Future`s,
//! including the `FutureExt` trait which adds methods to `Future` types.

</span><span class="attr">#[cfg(feature = <span class="string">"compat"</span>)]
...
<span class="kw">use </span><span class="kw">crate</span>::future::{assert_future, Inspect, Map};
<span class="kw">use </span><span class="kw">crate</span>::stream::assert_stream;

<span class="comment">// Combinators
</span><span class="kw">mod </span>into_future;
<span class="kw">mod </span>try_flatten;
<span class="kw">mod </span>try_flatten_err;

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`try_flatten`](TryFutureExt::try_flatten) method.
    </span>TryFlatten&lt;Fut1, Fut2&gt;(
        try_flatten::TryFlatten&lt;Fut1, Fut2&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut1| try_flatten::TryFlatten::new(x)]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`try_flatten_err`](TryFutureExt::try_flatten_err) method.
    </span>TryFlattenErr&lt;Fut1, Fut2&gt;(
        try_flatten_err::TryFlattenErr&lt;Fut1, Fut2&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut1| try_flatten_err::TryFlattenErr::new(x)]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`try_flatten_stream`](TryFutureExt::try_flatten_stream) method.
    </span>TryFlattenStream&lt;Fut&gt;(
        try_flatten::TryFlatten&lt;Fut, Fut::Ok&gt;
    ): Debug + Sink + Stream + FusedStream + New[|x: Fut| try_flatten::TryFlatten::new(x)]
    <span class="kw">where </span>Fut: TryFuture
);

<span class="attr">#[cfg(feature = <span class="string">"sink"</span>)]
</span><span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Sink for the [`flatten_sink`](TryFutureExt::flatten_sink) method.
    </span><span class="attr">#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"sink"</span>)))]
    </span>FlattenSink&lt;Fut, Si&gt;(
        try_flatten::TryFlatten&lt;Fut, Si&gt;
    ): Debug + Sink + Stream + FusedStream + New[|x: Fut| try_flatten::TryFlatten::new(x)]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`and_then`](TryFutureExt::and_then) method.
    </span>AndThen&lt;Fut1, Fut2, F&gt;(
        TryFlatten&lt;MapOk&lt;Fut1, F&gt;, Fut2&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut1, f: F| TryFlatten::new(MapOk::new(x, f))]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`or_else`](TryFutureExt::or_else) method.
    </span>OrElse&lt;Fut1, Fut2, F&gt;(
        TryFlattenErr&lt;MapErr&lt;Fut1, F&gt;, Fut2&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut1, f: F| TryFlattenErr::new(MapErr::new(x, f))]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`err_into`](TryFutureExt::err_into) method.
    </span>ErrInto&lt;Fut, E&gt;(
        MapErr&lt;Fut, IntoFn&lt;E&gt;&gt;
...
<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`ok_into`](TryFutureExt::ok_into) method.
    </span>OkInto&lt;Fut, E&gt;(
        MapOk&lt;Fut, IntoFn&lt;E&gt;&gt;
...
<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`inspect_ok`](super::TryFutureExt::inspect_ok) method.
    </span>InspectOk&lt;Fut, F&gt;(
        Inspect&lt;IntoFuture&lt;Fut&gt;, InspectOkFn&lt;F&gt;&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut, f: F| Inspect::new(IntoFuture::new(x), inspect_ok_fn(f))]
);

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`inspect_err`](super::TryFutureExt::inspect_err) method.
    </span>InspectErr&lt;Fut, F&gt;(
...
<span class="attr">#[allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
</span><span class="kw">pub use </span><span class="self">self</span>::into_future::IntoFuture;

<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`map_ok`](TryFutureExt::map_ok) method.
    </span>MapOk&lt;Fut, F&gt;(
...
<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`map_err`](TryFutureExt::map_err) method.
    </span>MapErr&lt;Fut, F&gt;(
...
<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`map_ok_or_else`](TryFutureExt::map_ok_or_else) method.
    </span>MapOkOrElse&lt;Fut, F, G&gt;(
...
<span class="macro">delegate_all!</span>(
    <span class="doccomment">/// Future for the [`unwrap_or_else`](TryFutureExt::unwrap_or_else) method.
    </span>UnwrapOrElse&lt;Fut, F&gt;(
        Map&lt;IntoFuture&lt;Fut&gt;, UnwrapOrElseFn&lt;F&gt;&gt;
    ): Debug + Future + FusedFuture + New[|x: Fut, f: F| Map::new(IntoFuture::new(x), unwrap_or_else_fn(f))]
);

<span class="kw">impl</span>&lt;Fut: <span class="question-mark">?</span>Sized + TryFuture&gt; TryFutureExt <span class="kw">for </span>Fut {}

<span class="doccomment">/// Adapters specific to [`Result`]-returning futures
</span><span class="kw">pub trait </span>TryFutureExt: TryFuture {
    <span class="doccomment">/// Flattens the execution of this future when the successful result of this
    /// future is a [`Sink`].
    ///
    ...
    </span><span class="kw">fn </span>flatten_sink&lt;Item&gt;(<span class="self">self</span>) -&gt; FlattenSink&lt;<span class="self">Self</span>, <span class="self">Self</span>::Ok&gt;
    <span class="kw">where
        </span><span class="self">Self</span>::Ok: Sink&lt;Item, Error = <span class="self">Self</span>::Error&gt;,
        <span class="self">Self</span>: Sized,
    {
        <span class="kw">crate</span>::sink::assert_sink::&lt;Item, <span class="self">Self</span>::Error, <span class="kw">_</span>&gt;(FlattenSink::new(<span class="self">self</span>))
    }

    <span class="doccomment">/// Maps this future's success value to a different value.
    ///
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="self">Self</span>::Ok) -&gt; T,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;T, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(MapOk::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Maps this future's success value to a different value, and permits for error handling resulting in the same type.
    ///
    ...
    /// ```
    ///
    </span><span class="kw">fn </span>map_ok_or_else&lt;T, E, F&gt;(<span class="self">self</span>, e: E, f: F) -&gt; MapOkOrElse&lt;<span class="self">Self</span>, F, E&gt;
    <span class="kw">where
        </span>F: FnOnce(<span class="self">Self</span>::Ok) -&gt; T,
        E: FnOnce(<span class="self">Self</span>::Error) -&gt; T,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;T, <span class="kw">_</span>&gt;(MapOkOrElse::new(<span class="self">self</span>, f, e))
    }

    <span class="doccomment">/// Maps this future's error value to a different value.
    ///
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="self">Self</span>::Error) -&gt; E,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, E&gt;, <span class="kw">_</span>&gt;(MapErr::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Maps this future's [`Error`](TryFuture::Error) to a new error type
    ...
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, E&gt;, <span class="kw">_</span>&gt;(ErrInto::new(<span class="self">self</span>))
    }

    <span class="doccomment">/// Maps this future's [`Ok`](TryFuture::Ok) to a new type
    /// using the [`Into`](std::convert::Into) trait.
    </span><span class="kw">fn </span>ok_into&lt;U&gt;(<span class="self">self</span>) -&gt; OkInto&lt;<span class="self">Self</span>, U&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
        <span class="self">Self</span>::Ok: Into&lt;U&gt;,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;U, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(OkInto::new(<span class="self">self</span>))
    }

    <span class="doccomment">/// Executes another future after this one resolves successfully. The
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="self">Self</span>::Ok) -&gt; Fut,
        Fut: TryFuture&lt;Error = <span class="self">Self</span>::Error&gt;,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;Fut::Ok, Fut::Error&gt;, <span class="kw">_</span>&gt;(AndThen::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Executes another future if this one resolves to an error. The
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="self">Self</span>::Error) -&gt; Fut,
        Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= <span class="self">Self</span>::Ok&gt;,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;Fut::Ok, Fut::Error&gt;, <span class="kw">_</span>&gt;(OrElse::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Do something with the success value of a future before passing it on.
    ///
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="kw-2">&amp;</span><span class="self">Self</span>::Ok),
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(InspectOk::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Do something with the error value of a future before passing it on.
    ///
    /// When using futures, you'll often chain several of them together.  While
    /// working on such code, you might want to check out what's happening at
    /// various parts in the pipeline, without consuming the intermediate
    ...
    <span class="kw">where
        </span>F: FnOnce(<span class="kw-2">&amp;</span><span class="self">Self</span>::Error),
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(InspectErr::new(<span class="self">self</span>, f))
    }
    ...
    </span><span class="kw">fn </span>try_flatten(<span class="self">self</span>) -&gt; TryFlatten&lt;<span class="self">Self</span>, <span class="self">Self</span>::Ok&gt;
    <span class="kw">where
        </span><span class="self">Self</span>::Ok: TryFuture&lt;Error = <span class="self">Self</span>::Error&gt;,
        <span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;&lt;<span class="self">Self</span>::Ok <span class="kw">as </span>TryFuture&gt;::Ok, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(TryFlatten::new(<span class="self">self</span>))
    }
    ...
    /// # });
    /// ```
    </span><span class="kw">fn </span>try_flatten_stream(<span class="self">self</span>) -&gt; TryFlattenStream&lt;<span class="self">Self</span>&gt;
    <span class="kw">where
        </span><span class="self">Self</span>::Ok: TryStream&lt;Error = <span class="self">Self</span>::Error&gt;,
        <span class="self">Self</span>: Sized,
    {
        assert_stream::&lt;<span class="prelude-ty">Result</span>&lt;&lt;<span class="self">Self</span>::Ok <span class="kw">as </span>TryStream&gt;::Ok, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(TryFlattenStream::new(
            <span class="self">self</span>,
        ))
    }

    <span class="doccomment">/// Unwraps this future's output, producing a future with this future's
    ...
    /// # });
    /// ```
    </span><span class="kw">fn </span>unwrap_or_else&lt;F&gt;(<span class="self">self</span>, f: F) -&gt; UnwrapOrElse&lt;<span class="self">Self</span>, F&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
        F: FnOnce(<span class="self">Self</span>::Error) -&gt; <span class="self">Self</span>::Ok,
    {
        assert_future::&lt;<span class="self">Self</span>::Ok, <span class="kw">_</span>&gt;(UnwrapOrElse::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Wraps a [`TryFuture`] into a future compatible with libraries using
    ...
    <span class="doccomment">/// Wraps a [`TryFuture`] into a type that implements
    ...
    /// ```
    </span><span class="kw">fn </span>into_future(<span class="self">self</span>) -&gt; IntoFuture&lt;<span class="self">Self</span>&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(IntoFuture::new(<span class="self">self</span>))
    }

    <span class="doccomment">/// A convenience method for calling [`TryFuture::try_poll`] on [`Unpin`]
    /// future types.
    </span><span class="kw">fn </span>try_poll_unpin(<span class="kw-2">&amp;mut </span><span class="self">self</span>, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>::Ok, <span class="self">Self</span>::Error&gt;&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Unpin,
    {
        Pin::new(<span class="self">self</span>).try_poll(cx)
    }
}
