...
<span class="macro">pin_project!</span> {
    <span class="attr">#[project = TryFlattenProj]
    #[derive(Debug)]
    </span><span class="kw">pub enum </span>TryFlatten&lt;Fut1, Fut2&gt; {
...
<span class="kw">impl</span>&lt;Fut1, Fut2&gt; TryFlatten&lt;Fut1, Fut2&gt; {
...
<span class="kw">impl</span>&lt;Fut&gt; FusedFuture <span class="kw">for </span>TryFlatten&lt;Fut, Fut::Ok&gt;
<span class="kw">where
    </span>Fut: TryFuture,
...
<span class="kw">impl</span>&lt;Fut&gt; Future <span class="kw">for </span>TryFlatten&lt;Fut, Fut::Ok&gt;
<span class="kw">where
    </span>Fut: TryFuture,
    Fut::Ok: TryFuture&lt;Error = Fut::Error&gt;,
{
    <span class="kw">type </span>Output = <span class="prelude-ty">Result</span>&lt;&lt;Fut::Ok <span class="kw">as </span>TryFuture&gt;::Ok, Fut::Error&gt;;
    ...
    <span class="kw">fn </span>poll(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="self">Self</span>::Output&gt; {
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                TryFlattenProj::First { f } =&gt; <span class="kw">match </span><span class="macro">ready!</span>(f.try_poll(cx)) {
                    <span class="prelude-val">Ok</span>(f) =&gt; <span class="self">self</span>.set(<span class="self">Self</span>::Second { f }),
                    <span class="prelude-val">Err</span>(e) =&gt; {
                        <span class="self">self</span>.set(<span class="self">Self</span>::Empty);
                        <span class="kw">break </span><span class="prelude-val">Err</span>(e);
                    }
                },
                ...
                TryFlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"TryFlatten polled after completion"</span>),
            }
        })
    }
}

<span class="kw">impl</span>&lt;Fut&gt; FusedStream <span class="kw">for </span>TryFlatten&lt;Fut, Fut::Ok&gt;
<span class="kw">where
    </span>Fut: TryFuture,
...
<span class="kw">impl</span>&lt;Fut&gt; Stream <span class="kw">for </span>TryFlatten&lt;Fut, Fut::Ok&gt;
<span class="kw">where
    </span>Fut: TryFuture,
    Fut::Ok: TryStream&lt;Error = Fut::Error&gt;,
{
    <span class="kw">type </span>Item = <span class="prelude-ty">Result</span>&lt;&lt;Fut::Ok <span class="kw">as </span>TryStream&gt;::Ok, Fut::Error&gt;;
        ...
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                TryFlattenProj::First { f } =&gt; <span class="kw">match </span><span class="macro">ready!</span>(f.try_poll(cx)) {
                    ...
                    <span class="prelude-val">Err</span>(e) =&gt; {
                        <span class="self">self</span>.set(<span class="self">Self</span>::Empty);
                        <span class="kw">break </span><span class="prelude-val">Some</span>(<span class="prelude-val">Err</span>(e));
                    }
                },
                TryFlattenProj::Second { f } =&gt; {
                    <span class="kw">let </span>output = <span class="macro">ready!</span>(f.try_poll_next(cx));
                    <span class="kw">if </span>output.is_none() {
                        <span class="self">self</span>.set(<span class="self">Self</span>::Empty);
                    }
                    <span class="kw">break </span>output;
                }
                TryFlattenProj::Empty =&gt; <span class="kw">break </span><span class="prelude-val">None</span>,
            }
        })
    }
}
...
<span class="attr">#[cfg(feature = <span class="string">"sink"</span>)]
</span><span class="kw">impl</span>&lt;Fut, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>TryFlatten&lt;Fut, Fut::Ok&gt;
<span class="kw">where
    </span>Fut: TryFuture,
    Fut::Ok: Sink&lt;Item, Error = Fut::Error&gt;,
{
    <span class="kw">type </span>Error = Fut::Error;
    ...
    <span class="kw">fn </span>poll_ready(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                ...
                TryFlattenProj::Second { f } =&gt; {
                    <span class="kw">break </span><span class="macro">ready!</span>(f.poll_ready(cx));
                }
                TryFlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"poll_ready called after eof"</span>),
            }
        })
    }
    ...
    <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: Item) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
        <span class="kw">match </span><span class="self">self</span>.project() {
            TryFlattenProj::First { .. } =&gt; <span class="macro">panic!</span>(<span class="string">"poll_ready not called first"</span>),
            TryFlattenProj::Second { f } =&gt; f.start_send(item),
            TryFlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"start_send called after eof"</span>),
        }
    }
    ...
    <span class="kw">fn </span>poll_flush(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        <span class="kw">match </span><span class="self">self</span>.project() {
            TryFlattenProj::First { .. } =&gt; Poll::Ready(<span class="prelude-val">Ok</span>(())),
            TryFlattenProj::Second { f } =&gt; f.poll_flush(cx),
            TryFlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"poll_flush called after eof"</span>),
        }
    }
    ...
    <span class="kw">fn </span>poll_close(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        <span class="kw">let </span>res = <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
