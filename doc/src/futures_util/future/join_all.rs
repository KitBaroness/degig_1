...
</pre></div><pre class="rust"><code><span class="doccomment">//! Definition of the `JoinAll` combinator, waiting for all of a list of futures
//! to finish.
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>iter_pin_mut&lt;T&gt;(slice: Pin&lt;<span class="kw-2">&amp;mut </span>[T]&gt;) -&gt; <span class="kw">impl </span>Iterator&lt;Item = Pin&lt;<span class="kw-2">&amp;mut </span>T&gt;&gt; {
...
<span class="attr">#[cfg_attr(target_os = <span class="string">"none"</span>, cfg(target_has_atomic = <span class="string">"ptr"</span>))]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const </span>SMALL: usize = <span class="number">30</span>;

<span class="kw">enum </span>JoinAllKind&lt;F&gt;
<span class="kw">where
    </span>F: Future,
{
    Small {
    ...
    I::Item: Future,
{
    ...
    #[cfg_attr(target_os = <span class="string">"none"</span>, cfg(not(target_has_atomic = <span class="string">"ptr"</span>)))]
        ...
        <span class="kw">let </span>kind =
            JoinAllKind::Small { elems: iter.map(MaybeDone::Future).collect::&lt;Box&lt;[<span class="kw">_</span>]&gt;&gt;().into() };
    ...
    <span class="attr">#[cfg_attr(target_os = <span class="string">"none"</span>, cfg(target_has_atomic = <span class="string">"ptr"</span>))]
        ...
        <span class="kw">let </span>kind = <span class="kw">match </span>iter.size_hint().<span class="number">1 </span>{
            <span class="prelude-val">Some</span>(max) <span class="kw">if </span>max &lt;= SMALL =&gt; JoinAllKind::Small {
                elems: iter.map(MaybeDone::Future).collect::&lt;Box&lt;[<span class="kw">_</span>]&gt;&gt;().into(),
            },
            <span class="kw">_ </span>=&gt; JoinAllKind::Big { fut: iter.collect::&lt;FuturesOrdered&lt;<span class="kw">_</span>&gt;&gt;().collect() },
        };
