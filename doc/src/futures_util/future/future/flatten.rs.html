...
<span class="macro">pin_project!</span> {
    <span class="attr">#[project = FlattenProj]
    #[derive(Debug)]
    </span><span class="kw">pub enum </span>Flatten&lt;Fut1, Fut2&gt; {
...
<span class="kw">impl</span>&lt;Fut1, Fut2&gt; Flatten&lt;Fut1, Fut2&gt; {
...
<span class="kw">impl</span>&lt;Fut&gt; FusedFuture <span class="kw">for </span>Flatten&lt;Fut, Fut::Output&gt;
<span class="kw">where
    </span>Fut: Future,
    Fut::Output: Future,
{
...
<span class="kw">impl</span>&lt;Fut&gt; Future <span class="kw">for </span>Flatten&lt;Fut, Fut::Output&gt;
<span class="kw">where
    </span>Fut: Future,
    Fut::Output: Future,
{
    <span class="kw">type </span>Output = &lt;Fut::Output <span class="kw">as </span>Future&gt;::Output;
    ...
    <span class="kw">fn </span>poll(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="self">Self</span>::Output&gt; {
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                FlattenProj::First { f } =&gt; {
                    <span class="kw">let </span>f = <span class="macro">ready!</span>(f.poll(cx));
                    <span class="self">self</span>.set(<span class="self">Self</span>::Second { f });
                }
                FlattenProj::Second { f } =&gt; {
                    <span class="kw">let </span>output = <span class="macro">ready!</span>(f.poll(cx));
                    <span class="self">self</span>.set(<span class="self">Self</span>::Empty);
                    <span class="kw">break </span>output;
                }
                FlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"Flatten polled after completion"</span>),
            }
        })
    }
}

<span class="kw">impl</span>&lt;Fut&gt; FusedStream <span class="kw">for </span>Flatten&lt;Fut, Fut::Output&gt;
<span class="kw">where
    </span>Fut: Future,
    Fut::Output: Stream,
{
...
<span class="kw">impl</span>&lt;Fut&gt; Stream <span class="kw">for </span>Flatten&lt;Fut, Fut::Output&gt;
<span class="kw">where
    </span>Fut: Future,
    Fut::Output: Stream,
{
    <span class="kw">type </span>Item = &lt;Fut::Output <span class="kw">as </span>Stream&gt;::Item;
    ...
    <span class="kw">fn </span>poll_next(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                ...
                FlattenProj::Second { f } =&gt; {
                    <span class="kw">let </span>output = <span class="macro">ready!</span>(f.poll_next(cx));
                    <span class="kw">if </span>output.is_none() {
                        <span class="self">self</span>.set(<span class="self">Self</span>::Empty);
                    }
                    <span class="kw">break </span>output;
                }
                FlattenProj::Empty =&gt; <span class="kw">break </span><span class="prelude-val">None</span>,
            }
        })
    }
}
...
<span class="attr">#[cfg(feature = <span class="string">"sink"</span>)]
</span><span class="kw">impl</span>&lt;Fut, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Flatten&lt;Fut, Fut::Output&gt;
<span class="kw">where
    </span>Fut: Future,
    Fut::Output: Sink&lt;Item&gt;,
{
    <span class="kw">type </span>Error = &lt;Fut::Output <span class="kw">as </span>Sink&lt;Item&gt;&gt;::Error;
    ...
    <span class="kw">fn </span>poll_ready(<span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">match </span><span class="self">self</span>.as_mut().project() {
                ...
                FlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"poll_ready called after eof"</span>),
            }
        })
    }
    ...
    <span class="kw">fn </span>start_send(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, item: Item) -&gt; <span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt; {
        <span class="kw">match </span><span class="self">self</span>.project() {
            FlattenProj::First { .. } =&gt; <span class="macro">panic!</span>(<span class="string">"poll_ready not called first"</span>),
            FlattenProj::Second { f } =&gt; f.start_send(item),
            FlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"start_send called after eof"</span>),
        }
    }
    ...
    <span class="kw">fn </span>poll_flush(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Result</span>&lt;(), <span class="self">Self</span>::Error&gt;&gt; {
        <span class="kw">match </span><span class="self">self</span>.project() {
            FlattenProj::First { .. } =&gt; Poll::Ready(<span class="prelude-val">Ok</span>(())),
            FlattenProj::Second { f } =&gt; f.poll_flush(cx),
            FlattenProj::Empty =&gt; <span class="macro">panic!</span>(<span class="string">"poll_flush called after eof"</span>),
        }
    }
