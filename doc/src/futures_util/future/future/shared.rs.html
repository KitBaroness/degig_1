...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::task::{waker_ref, ArcWake};
...
<span class="kw">const </span>NULL_WAKER_KEY: usize = usize::max_value();
    ...
    </span>Fut: Future,
{
    ...
    /// is `COMPLETE`
        ...
        <span class="kw">match </span><span class="kw-2">&amp;*</span><span class="self">self</span>.future_or_output.get() {
            FutureOrOutput::Output(<span class="kw-2">ref </span>item) =&gt; item,
    ...
    Fut::Output: Clone,
{
    ...
    /// is `COMPLETE`
        ...
        <span class="kw">match </span>Arc::try_unwrap(<span class="self">self</span>) {
            ...
            <span class="prelude-val">Err</span>(inner) =&gt; inner.output().clone(),
        }
    }
}
