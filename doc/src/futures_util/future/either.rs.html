...
/// ```
    ...
    <span class="doccomment">/// First branch of the type
    </span>Left(<span class="comment">/* #[pin] */ </span>A),
    <span class="doccomment">/// Second branch of the type
    </span>Right(<span class="comment">/* #[pin] */ </span>B),
}

<span class="kw">impl</span>&lt;A, B&gt; Either&lt;A, B&gt; {
    <span class="doccomment">/// Convert `Pin&lt;&amp;Either&lt;A, B&gt;&gt;` to `Either&lt;Pin&lt;&amp;A&gt;, Pin&lt;&amp;B&gt;&gt;`,
    /// pinned projections of the inner variants.
    </span><span class="kw">pub fn </span>as_pin_ref(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;</span><span class="self">Self</span>&gt;) -&gt; Either&lt;Pin&lt;<span class="kw-2">&amp;</span>A&gt;, Pin&lt;<span class="kw-2">&amp;</span>B&gt;&gt; {
        ...
        // guaranteed to be pinned, as they come from `self` which is pinned.
            ...
            <span class="kw">match </span><span class="kw-2">*</span>Pin::get_ref(<span class="self">self</span>) {
                Either::Left(<span class="kw-2">ref </span>inner) =&gt; Either::Left(Pin::new_unchecked(inner)),
                Either::Right(<span class="kw-2">ref </span>inner) =&gt; Either::Right(Pin::new_unchecked(inner)),
            }
        }
    }

    <span class="doccomment">/// Convert `Pin&lt;&amp;mut Either&lt;A, B&gt;&gt;` to `Either&lt;Pin&lt;&amp;mut A&gt;, Pin&lt;&amp;mut B&gt;&gt;`,
    /// pinned projections of the inner variants.
    </span><span class="kw">pub fn </span>as_pin_mut(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;) -&gt; Either&lt;Pin&lt;<span class="kw-2">&amp;mut </span>A&gt;, Pin&lt;<span class="kw-2">&amp;mut </span>B&gt;&gt; {
        ...
        // also don't have an implementation of `Drop`, nor manual `Unpin`.
            ...
            <span class="kw">match </span><span class="kw-2">*</span>Pin::get_unchecked_mut(<span class="self">self</span>) {
                Either::Left(<span class="kw-2">ref mut </span>inner) =&gt; Either::Left(Pin::new_unchecked(inner)),
                Either::Right(<span class="kw-2">ref mut </span>inner) =&gt; Either::Right(Pin::new_unchecked(inner)),
            }
        }
    }
}

<span class="kw">impl</span>&lt;A, B, T&gt; Either&lt;(T, A), (T, B)&gt; {
    <span class="doccomment">/// Factor out a homogeneous type from an either of pairs.
    ///
    /// Here, the homogeneous type is the first element of the pairs.
    </span><span class="kw">pub fn </span>factor_first(<span class="self">self</span>) -&gt; (T, Either&lt;A, B&gt;) {
...
<span class="kw">impl</span>&lt;A, B, T&gt; Either&lt;(A, T), (B, T)&gt; {
    <span class="doccomment">/// Factor out a homogeneous type from an either of pairs.
    ///
    /// Here, the homogeneous type is the second element of the pairs.
    </span><span class="kw">pub fn </span>factor_second(<span class="self">self</span>) -&gt; (Either&lt;A, B&gt;, T) {
        <span class="kw">match </span><span class="self">self </span>{
...
<span class="kw">impl</span>&lt;A, B&gt; Future <span class="kw">for </span>Either&lt;A, B&gt;
<span class="kw">where
    </span>A: Future,
    B: Future&lt;Output = A::Output&gt;,
{
    <span class="kw">type </span>Output = A::Output;
...
<span class="kw">impl</span>&lt;A, B&gt; FusedFuture <span class="kw">for </span>Either&lt;A, B&gt;
<span class="kw">where
    </span>A: FusedFuture,
...
<span class="kw">impl</span>&lt;A, B&gt; Stream <span class="kw">for </span>Either&lt;A, B&gt;
<span class="kw">where
    </span>A: Stream,
...
<span class="kw">impl</span>&lt;A, B&gt; FusedStream <span class="kw">for </span>Either&lt;A, B&gt;
<span class="kw">where
    </span>A: FusedStream,
...
<span class="attr">#[cfg(feature = <span class="string">"sink"</span>)]
</span><span class="kw">impl</span>&lt;A, B, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Either&lt;A, B&gt;
<span class="kw">where
    </span>A: Sink&lt;Item&gt;,
...
#[cfg(feature = <span class="string">"std"</span>)]
    ...
    <span class="kw">use </span>core::task::{Context, Poll};
    <span class="kw">use </span>futures_io::{
        AsyncBufRead, AsyncRead, AsyncSeek, AsyncWrite, IoSlice, IoSliceMut, <span class="prelude-ty">Result</span>, SeekFrom,
    };

    <span class="kw">impl</span>&lt;A, B&gt; AsyncRead <span class="kw">for </span>Either&lt;A, B&gt;
    <span class="kw">where
        </span>A: AsyncRead,
        B: AsyncRead,
    {
    ...
    <span class="kw">impl</span>&lt;A, B&gt; AsyncWrite <span class="kw">for </span>Either&lt;A, B&gt;
    <span class="kw">where
        </span>A: AsyncWrite,
        B: AsyncWrite,
    {
    ...
    <span class="kw">impl</span>&lt;A, B&gt; AsyncSeek <span class="kw">for </span>Either&lt;A, B&gt;
    <span class="kw">where
        </span>A: AsyncSeek,
        B: AsyncSeek,
    {
    ...
    <span class="kw">impl</span>&lt;A, B&gt; AsyncBufRead <span class="kw">for </span>Either&lt;A, B&gt;
    <span class="kw">where
        </span>A: AsyncBufRead,
        B: AsyncBufRead,
    {
