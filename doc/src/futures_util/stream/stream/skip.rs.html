...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`skip`](super::StreamExt::skip) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Skip&lt;St&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        remaining: usize,
    }
...
<span class="kw">impl</span>&lt;St: Stream&gt; Skip&lt;St&gt; {
...
<span class="kw">impl</span>&lt;St: FusedStream&gt; FusedStream <span class="kw">for </span>Skip&lt;St&gt; {
...
<span class="kw">impl</span>&lt;St: Stream&gt; Stream <span class="kw">for </span>Skip&lt;St&gt; {
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;St::Item&gt;&gt; {
        ...
        <span class="kw">while </span><span class="kw-2">*</span>this.remaining &gt; <span class="number">0 </span>{
            <span class="kw">if </span><span class="macro">ready!</span>(this.stream.as_mut().poll_next(cx)).is_some() {
    ...
    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        ...
        <span class="kw">let </span>lower = lower.saturating_sub(<span class="self">self</span>.remaining);
        <span class="kw">let </span>upper = upper.map(|x| x.saturating_sub(<span class="self">self</span>.remaining));
...
</span><span class="kw">impl</span>&lt;S, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Skip&lt;S&gt;
<span class="kw">where
