...
<span class="macro">pin_project!</span> {
    ...
    </span><span class="kw">pub struct </span>Any&lt;St, Fut, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        f: F,
        done: bool,
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; fmt::Debug <span class="kw">for </span>Any&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
    Fut: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Any"</span>)
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; Any&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut(St::Item) -&gt; Fut,
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; FusedFuture <span class="kw">for </span>Any&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut(St::Item) -&gt; Fut,
    Fut: Future&lt;Output = bool&gt;,
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; Future <span class="kw">for </span>Any&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut(St::Item) -&gt; Fut,
    Fut: Future&lt;Output = bool&gt;,
    ...
    <span class="kw">fn </span>poll(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;bool&gt; {
        ...
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">if let </span><span class="prelude-val">Some</span>(fut) = this.future.as_mut().as_pin_mut() {
                ...
                </span><span class="kw">let </span>res = <span class="macro">ready!</span>(fut.poll(cx));
                ...
                <span class="macro">panic!</span>(<span class="string">"Any polled after completion"</span>)
            }
        })
    }
}
