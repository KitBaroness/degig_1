...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`fuse`](super::StreamExt::fuse) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Fuse&lt;St&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        done: bool,
    }
...
<span class="kw">impl</span>&lt;St&gt; Fuse&lt;St&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(stream: St) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ stream, done: <span class="bool-val">false </span>}
    }

    <span class="doccomment">/// Returns whether the underlying stream has finished or not.
    ///
    ...
    /// underlying stream is still in use.
        ...
        <span class="self">self</span>.done
    }

    <span class="macro">delegate_access_inner!</span>(stream, St, ());
}

<span class="kw">impl</span>&lt;S: Stream&gt; FusedStream <span class="kw">for </span>Fuse&lt;S&gt; {
    <span class="kw">fn </span>is_terminated(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.done
    }
}

<span class="kw">impl</span>&lt;S: Stream&gt; Stream <span class="kw">for </span>Fuse&lt;S&gt; {
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;S::Item&gt;&gt; {
        ...
        <span class="kw">if </span><span class="kw-2">*</span>this.done {
            <span class="kw">return </span>Poll::Ready(<span class="prelude-val">None</span>);
        }

        <span class="kw">let </span>item = <span class="macro">ready!</span>(this.stream.poll_next(cx));
...
</span><span class="kw">impl</span>&lt;S: Stream + Sink&lt;Item&gt;, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Fuse&lt;S&gt; {
