...
<span class="kw">impl</span>&lt;St: Stream&gt; ReadyChunks&lt;St&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(stream: St, capacity: usize) -&gt; <span class="self">Self </span>{
        ...
        <span class="self">Self </span>{ stream: stream.fuse(), cap: capacity }
    }
...
<span class="kw">impl</span>&lt;St: Stream&gt; Stream <span class="kw">for </span>ReadyChunks&lt;St&gt; {
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>items: Vec&lt;St::Item&gt; = Vec::new();
        ...
        <span class="kw">loop </span>{
            <span class="kw">match </span>this.stream.as_mut().poll_next(cx) {
                ...
                // more ready values
                    ...
                    <span class="kw">return if </span>items.is_empty() { Poll::Pending } <span class="kw">else </span>{ Poll::Ready(<span class="prelude-val">Some</span>(items)) }
                }
                ...
                // the full one.
                    ...
                    <span class="kw">if </span>items.is_empty() {
                        items.reserve(<span class="kw-2">*</span>this.cap);
                    }
                    items.push(item);
                    <span class="kw">if </span>items.len() &gt;= <span class="kw-2">*</span>this.cap {
                        <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Some</span>(items));
                    }
                }
                ...
                // have buffered, if we have anything.
                    ...
                    <span class="kw">let </span>last = <span class="kw">if </span>items.is_empty() { <span class="prelude-val">None </span>} <span class="kw">else </span>{ <span class="prelude-val">Some</span>(items) };
...
<span class="kw">impl</span>&lt;St: Stream&gt; FusedStream <span class="kw">for </span>ReadyChunks&lt;St&gt; {
