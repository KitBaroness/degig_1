...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`then`](super::StreamExt::then) method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Then&lt;St, Fut, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        <span class="attr">#[pin]
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; fmt::Debug <span class="kw">for </span>Then&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
    Fut: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Then"</span>).field(<span class="string">"stream"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.stream).field(<span class="string">"future"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.future).finish()
    }
}

<span class="kw">impl</span>&lt;St, Fut, F&gt; Then&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut(St::Item) -&gt; Fut,
{
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; FusedStream <span class="kw">for </span>Then&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: FusedStream,
    F: FnMut(St::Item) -&gt; Fut,
    Fut: Future,
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; Stream <span class="kw">for </span>Then&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut(St::Item) -&gt; Fut,
    Fut: Future,
...
</span><span class="kw">impl</span>&lt;S, Fut, F, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Then&lt;S, Fut, F&gt;
<span class="kw">where
    </span>S: Sink&lt;Item&gt;,
{
