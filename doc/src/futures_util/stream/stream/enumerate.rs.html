...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`enumerate`](super::StreamExt::enumerate) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Enumerate&lt;St&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        count: usize,
    }
...
<span class="kw">impl</span>&lt;St: Stream&gt; Enumerate&lt;St&gt; {
...
<span class="kw">impl</span>&lt;St: Stream + FusedStream&gt; FusedStream <span class="kw">for </span>Enumerate&lt;St&gt; {
...
<span class="kw">impl</span>&lt;St: Stream&gt; Stream <span class="kw">for </span>Enumerate&lt;St&gt; {
    <span class="kw">type </span>Item = (usize, St::Item);
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        <span class="kw">match </span><span class="macro">ready!</span>(this.stream.poll_next(cx)) {
            <span class="prelude-val">Some</span>(item) =&gt; {
                <span class="kw">let </span>prev_count = <span class="kw-2">*</span>this.count;
                <span class="kw-2">*</span>this.count += <span class="number">1</span>;
                Poll::Ready(<span class="prelude-val">Some</span>((prev_count, item)))
            }
...
</span><span class="kw">impl</span>&lt;S, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Enumerate&lt;S&gt;
<span class="kw">where
