...
<span class="kw">use </span><span class="kw">crate</span>::fns::FnMut1;

<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`map`](super::StreamExt::map) method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Map&lt;St, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        f: F,
    }
...
<span class="kw">impl</span>&lt;St, F&gt; fmt::Debug <span class="kw">for </span>Map&lt;St, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Map"</span>).field(<span class="string">"stream"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.stream).finish()
    }
}

<span class="kw">impl</span>&lt;St, F&gt; Map&lt;St, F&gt; {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(stream: St, f: F) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ stream, f }
    }

    <span class="macro">delegate_access_inner!</span>(stream, St, ());
}

<span class="kw">impl</span>&lt;St, F&gt; FusedStream <span class="kw">for </span>Map&lt;St, F&gt;
<span class="kw">where
    </span>St: FusedStream,
    F: FnMut1&lt;St::Item&gt;,
{
...
<span class="kw">impl</span>&lt;St, F&gt; Stream <span class="kw">for </span>Map&lt;St, F&gt;
<span class="kw">where
    </span>St: Stream,
    F: FnMut1&lt;St::Item&gt;,
{
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        <span class="kw">let </span>res = <span class="macro">ready!</span>(this.stream.as_mut().poll_next(cx));
...
</span><span class="kw">impl</span>&lt;St, F, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Map&lt;St, F&gt;
<span class="kw">where
