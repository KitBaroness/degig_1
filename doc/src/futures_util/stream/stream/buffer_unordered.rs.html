...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::stream::{Fuse, FuturesUnordered, StreamExt};
...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`buffer_unordered`](super::StreamExt::buffer_unordered)
    /// method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>BufferUnordered&lt;St&gt;
    <span class="kw">where
        </span>St: Stream,
    {
        <span class="attr">#[pin]
...
<span class="kw">impl</span>&lt;St&gt; fmt::Debug <span class="kw">for </span>BufferUnordered&lt;St&gt;
<span class="kw">where
    </span>St: Stream + fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"BufferUnordered"</span>)
...
<span class="kw">impl</span>&lt;St&gt; BufferUnordered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
...
<span class="kw">impl</span>&lt;St&gt; Stream <span class="kw">for </span>BufferUnordered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        // our queue of futures.
            ...
            <span class="kw">match </span>this.stream.as_mut().poll_next(cx) {
                Poll::Ready(<span class="prelude-val">Some</span>(fut)) =&gt; this.in_progress_queue.push(fut),
...
<span class="kw">impl</span>&lt;St&gt; FusedStream <span class="kw">for </span>BufferUnordered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
    <span class="kw">fn </span>is_terminated(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.in_progress_queue.is_terminated() &amp;&amp; <span class="self">self</span>.stream.is_terminated()
    }
}
...
</span><span class="kw">impl</span>&lt;S, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>BufferUnordered&lt;S&gt;
<span class="kw">where
