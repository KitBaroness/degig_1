...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::stream::{Fuse, FusedStream, FuturesOrdered, StreamExt};
...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`buffered`](super::StreamExt::buffered) method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Buffered&lt;St&gt;
    <span class="kw">where
        </span>St: Stream,
        St::Item: Future,
    {
...
<span class="kw">impl</span>&lt;St&gt; fmt::Debug <span class="kw">for </span>Buffered&lt;St&gt;
<span class="kw">where
    ...
    St::Item: Future,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"Buffered"</span>)
            ...
            .field(<span class="string">"in_progress_queue"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.in_progress_queue)
            .field(<span class="string">"max"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.max)
            .finish()
    }
}

<span class="kw">impl</span>&lt;St&gt; Buffered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(stream: St, n: usize) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ stream: <span class="kw">super</span>::Fuse::new(stream), in_progress_queue: FuturesOrdered::new(), max: n }
    }

    <span class="macro">delegate_access_inner!</span>(stream, St, (.));
}

<span class="kw">impl</span>&lt;St&gt; Stream <span class="kw">for </span>Buffered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
    <span class="kw">type </span>Item = &lt;St::Item <span class="kw">as </span>Future&gt;::Output;
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        // our queue of futures.
            ...
            <span class="kw">match </span>this.stream.as_mut().poll_next(cx) {
                Poll::Ready(<span class="prelude-val">Some</span>(fut)) =&gt; this.in_progress_queue.push_back(fut),
        ...
        </span><span class="kw">let </span>res = this.in_progress_queue.poll_next_unpin(cx);
        <span class="kw">if let </span><span class="prelude-val">Some</span>(val) = <span class="macro">ready!</span>(res) {
            <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Some</span>(val));
        }
    ...
    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        <span class="kw">let </span>queue_len = <span class="self">self</span>.in_progress_queue.len();
        <span class="kw">let </span>(lower, upper) = <span class="self">self</span>.stream.size_hint();
        <span class="kw">let </span>lower = lower.saturating_add(queue_len);
        <span class="kw">let </span>upper = <span class="kw">match </span>upper {
            <span class="prelude-val">Some</span>(x) =&gt; x.checked_add(queue_len),
...
<span class="kw">impl</span>&lt;St&gt; FusedStream <span class="kw">for </span>Buffered&lt;St&gt;
<span class="kw">where
    </span>St: Stream,
    St::Item: Future,
{
    <span class="kw">fn </span>is_terminated(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.stream.is_done() &amp;&amp; <span class="self">self</span>.in_progress_queue.is_terminated()
    }
}
...
</span><span class="kw">impl</span>&lt;S, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Buffered&lt;S&gt;
<span class="kw">where
