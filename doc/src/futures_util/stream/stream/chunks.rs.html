...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::stream::Fuse;
...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`chunks`](super::StreamExt::chunks) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>Chunks&lt;St: Stream&gt; {
        <span class="attr">#[pin]
        </span>stream: Fuse&lt;St&gt;,
        items: Vec&lt;St::Item&gt;,
...
<span class="kw">impl</span>&lt;St: Stream&gt; Chunks&lt;St&gt; {
    ...
    <span class="kw">fn </span>take(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;) -&gt; Vec&lt;St::Item&gt; {
...
<span class="kw">impl</span>&lt;St: Stream&gt; Stream <span class="kw">for </span>Chunks&lt;St&gt; {
            ...
            <span class="kw">match </span><span class="macro">ready!</span>(this.stream.as_mut().poll_next(cx)) {
                ...
                // the full one.
                    ...
                    <span class="kw">if </span>this.items.len() &gt;= <span class="kw-2">*</span>this.cap {
                        <span class="kw">return </span>Poll::Ready(<span class="prelude-val">Some</span>(<span class="self">self</span>.take()));
                    }
                }
...
<span class="kw">impl</span>&lt;St: FusedStream&gt; FusedStream <span class="kw">for </span>Chunks&lt;St&gt; {
...
</span><span class="kw">impl</span>&lt;S, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>Chunks&lt;S&gt;
<span class="kw">where
