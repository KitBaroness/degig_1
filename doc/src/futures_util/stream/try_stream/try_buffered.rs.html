...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::future::{IntoFuture, TryFutureExt};
<span class="kw">use </span><span class="kw">crate</span>::stream::{Fuse, FuturesOrdered, IntoStream, StreamExt};
...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`try_buffered`](super::TryStreamExt::try_buffered) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>TryBuffered&lt;St&gt;
    <span class="kw">where
        </span>St: TryStream,
        St::Ok: TryFuture,
    {
...
<span class="kw">impl</span>&lt;St&gt; TryBuffered&lt;St&gt;
<span class="kw">where
    </span>St: TryStream,
    St::Ok: TryFuture,
{
...
<span class="kw">impl</span>&lt;St&gt; Stream <span class="kw">for </span>TryBuffered&lt;St&gt;
<span class="kw">where
    </span>St: TryStream,
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        // our queue of futures. Propagate errors from the stream immediately.
            ...
            <span class="kw">match </span>this.stream.as_mut().poll_next(cx)<span class="question-mark">? </span>{
                Poll::Ready(<span class="prelude-val">Some</span>(fut)) =&gt; this.in_progress_queue.push_back(fut.into_future()),
...
</span><span class="kw">impl</span>&lt;S, Item, E&gt; Sink&lt;Item&gt; <span class="kw">for </span>TryBuffered&lt;S&gt;
<span class="kw">where
