...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Future for the [`try_fold`](super::TryStreamExt::try_fold) method.
    </span><span class="attr">#[must_use = <span class="string">"futures do nothing unless you `.await` or poll them"</span>]
    </span><span class="kw">pub struct </span>TryFold&lt;St, Fut, T, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        f: F,
...
<span class="kw">impl</span>&lt;St, Fut, T, F&gt; fmt::Debug <span class="kw">for </span>TryFold&lt;St, Fut, T, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
    Fut: fmt::Debug,
    T: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"TryFold"</span>)
...
<span class="kw">impl</span>&lt;St, Fut, T, F&gt; TryFold&lt;St, Fut, T, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(T, St::Ok) -&gt; Fut,
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= T, Error = St::Error&gt;,
{
...
<span class="kw">impl</span>&lt;St, Fut, T, F&gt; FusedFuture <span class="kw">for </span>TryFold&lt;St, Fut, T, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(T, St::Ok) -&gt; Fut,
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= T, Error = St::Error&gt;,
...
<span class="kw">impl</span>&lt;St, Fut, T, F&gt; Future <span class="kw">for </span>TryFold&lt;St, Fut, T, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(T, St::Ok) -&gt; Fut,
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= T, Error = St::Error&gt;,
{
    <span class="kw">type </span>Output = <span class="prelude-ty">Result</span>&lt;T, St::Error&gt;;
    ...
    <span class="kw">fn </span>poll(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="self">Self</span>::Output&gt; {
        ...
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">if let </span><span class="prelude-val">Some</span>(fut) = this.future.as_mut().as_pin_mut() {
                ...
                </span><span class="kw">let </span>res = <span class="macro">ready!</span>(fut.try_poll(cx));
                this.future.set(<span class="prelude-val">None</span>);
                <span class="kw">match </span>res {
                    <span class="prelude-val">Ok</span>(a) =&gt; <span class="kw-2">*</span>this.accum = <span class="prelude-val">Some</span>(a),
                    <span class="prelude-val">Err</span>(e) =&gt; <span class="kw">break </span><span class="prelude-val">Err</span>(e),
                }
            } <span class="kw">else if </span>this.accum.is_some() {
                <span class="comment">// we're waiting on a new item from the stream
                </span><span class="kw">let </span>res = <span class="macro">ready!</span>(this.stream.as_mut().try_poll_next(cx));
                <span class="kw">let </span>a = this.accum.take().unwrap();
                <span class="kw">match </span>res {
                    <span class="prelude-val">Some</span>(<span class="prelude-val">Ok</span>(item)) =&gt; this.future.set(<span class="prelude-val">Some</span>((this.f)(a, item))),
                    <span class="prelude-val">Some</span>(<span class="prelude-val">Err</span>(e)) =&gt; <span class="kw">break </span><span class="prelude-val">Err</span>(e),
                    <span class="prelude-val">None </span>=&gt; <span class="kw">break </span><span class="prelude-val">Ok</span>(a),
                }
