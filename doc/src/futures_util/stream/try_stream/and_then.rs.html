...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`and_then`](super::TryStreamExt::and_then) method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>AndThen&lt;St, Fut, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        <span class="attr">#[pin]
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; fmt::Debug <span class="kw">for </span>AndThen&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
    Fut: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"AndThen"</span>)
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; AndThen&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(St::Ok) -&gt; Fut,
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; Stream <span class="kw">for </span>AndThen&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(St::Ok) -&gt; Fut,
    Fut: TryFuture&lt;Error = St::Error&gt;,
{
    <span class="kw">type </span>Item = <span class="prelude-ty">Result</span>&lt;Fut::Ok, St::Error&gt;;
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; FusedStream <span class="kw">for </span>AndThen&lt;St, Fut, F&gt;
<span class="kw">where
...
</span><span class="kw">impl</span>&lt;S, Fut, F, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>AndThen&lt;S, Fut, F&gt;
<span class="kw">where
    </span>S: Sink&lt;Item&gt;,
{
