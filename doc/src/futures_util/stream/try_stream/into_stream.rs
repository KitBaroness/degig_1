...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`into_stream`](super::TryStreamExt::into_stream) method.
    </span><span class="attr">#[derive(Debug)]
    #[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>IntoStream&lt;St&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
    }
}

<span class="kw">impl</span>&lt;St&gt; IntoStream&lt;St&gt; {
    <span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(stream: St) -&gt; <span class="self">Self </span>{
...
<span class="kw">impl</span>&lt;St: TryStream + FusedStream&gt; FusedStream <span class="kw">for </span>IntoStream&lt;St&gt; {
...
<span class="kw">impl</span>&lt;St: TryStream&gt; Stream <span class="kw">for </span>IntoStream&lt;St&gt; {
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.project().stream.try_poll_next(cx)
    }
...
</span><span class="kw">impl</span>&lt;S: Sink&lt;Item&gt;, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>IntoStream&lt;S&gt; {
