...
</pre></div><pre class="rust"><code><span class="doccomment">//! Streams
//!
...
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
</span><span class="kw">mod </span>try_ready_chunks;
<span class="attr">#[cfg(feature = <span class="string">"alloc"</span>)]
#[allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
</span><span class="kw">pub use </span><span class="self">self</span>::try_ready_chunks::{TryReadyChunks, TryReadyChunksError};
...
<span class="kw">mod </span>try_all;
<span class="attr">#[allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
</span><span class="kw">pub use </span><span class="self">self</span>::try_all::TryAll;

<span class="kw">mod </span>try_any;
<span class="attr">#[allow(unreachable_pub)] </span><span class="comment">// https://github.com/rust-lang/rust/issues/57411
</span><span class="kw">pub use </span><span class="self">self</span>::try_any::TryAny;
...
<span class="doccomment">/// Adapters specific to `Result`-returning streams
    ...
    /// # })
    /// ```
    </span><span class="attr">#[cfg_attr(target_os = <span class="string">"none"</span>, cfg(target_has_atomic = <span class="string">"ptr"</span>))]
    #[cfg(feature = <span class="string">"alloc"</span>)]
    ...
    <span class="doccomment">/// An adaptor for chunking up successful, ready items of the stream inside a vector.
    ///
    /// This combinator will attempt to pull successful items from this stream and buffer
    /// them into a local vector. At most `capacity` items will get buffered
    ...
    </span><span class="kw">fn </span>try_ready_chunks(<span class="self">self</span>, capacity: usize) -&gt; TryReadyChunks&lt;<span class="self">Self</span>&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
    {
        assert_stream::&lt;<span class="prelude-ty">Result</span>&lt;Vec&lt;<span class="self">Self</span>::Ok&gt;, TryReadyChunksError&lt;<span class="self">Self</span>::Ok, <span class="self">Self</span>::Error&gt;&gt;, <span class="kw">_</span>&gt;(
            TryReadyChunks::new(<span class="self">self</span>, capacity),
        )
    }
    ...
    /// # })
    /// ```
    </span><span class="attr">#[cfg(feature = <span class="string">"io"</span>)]
    #[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"io"</span>)))]
    #[cfg(feature = <span class="string">"std"</span>)]
    ...
    <span class="doccomment">/// Attempt to execute a predicate over an asynchronous stream and evaluate if all items
    ...
    /// # });
    /// ```
    </span><span class="kw">fn </span>try_all&lt;Fut, F&gt;(<span class="self">self</span>, f: F) -&gt; TryAll&lt;<span class="self">Self</span>, Fut, F&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
        F: FnMut(<span class="self">Self</span>::Ok) -&gt; Fut,
        Fut: Future&lt;Output = bool&gt;,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;bool, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(TryAll::new(<span class="self">self</span>, f))
    }

    <span class="doccomment">/// Attempt to execute a predicate over an asynchronous stream and evaluate if any items
    /// satisfy the predicate. Exits early if an `Err` is encountered or if an `Ok` item is found
    ...
    /// # });
    /// ```
    </span><span class="kw">fn </span>try_any&lt;Fut, F&gt;(<span class="self">self</span>, f: F) -&gt; TryAny&lt;<span class="self">Self</span>, Fut, F&gt;
    <span class="kw">where
        </span><span class="self">Self</span>: Sized,
        F: FnMut(<span class="self">Self</span>::Ok) -&gt; Fut,
        Fut: Future&lt;Output = bool&gt;,
    {
        assert_future::&lt;<span class="prelude-ty">Result</span>&lt;bool, <span class="self">Self</span>::Error&gt;, <span class="kw">_</span>&gt;(TryAny::new(<span class="self">self</span>, f))
    }
}
