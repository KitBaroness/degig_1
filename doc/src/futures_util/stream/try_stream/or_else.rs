...
<span class="macro">pin_project!</span> {
    <span class="doccomment">/// Stream for the [`or_else`](super::TryStreamExt::or_else) method.
    </span><span class="attr">#[must_use = <span class="string">"streams do nothing unless polled"</span>]
    </span><span class="kw">pub struct </span>OrElse&lt;St, Fut, F&gt; {
        <span class="attr">#[pin]
        </span>stream: St,
        <span class="attr">#[pin]
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; fmt::Debug <span class="kw">for </span>OrElse&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: fmt::Debug,
    Fut: fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"OrElse"</span>)
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; OrElse&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(St::Error) -&gt; Fut,
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= St::Ok&gt;,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(stream: St, f: F) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ stream, future: <span class="prelude-val">None</span>, f }
    }

    <span class="macro">delegate_access_inner!</span>(stream, St, ());
}

<span class="kw">impl</span>&lt;St, Fut, F&gt; Stream <span class="kw">for </span>OrElse&lt;St, Fut, F&gt;
<span class="kw">where
    </span>St: TryStream,
    F: FnMut(St::Error) -&gt; Fut,
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= St::Ok&gt;,
{
    <span class="kw">type </span>Item = <span class="prelude-ty">Result</span>&lt;St::Ok, Fut::Error&gt;;
    ...
    <span class="kw">fn </span>poll_next(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;<span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt;&gt; {
        ...
        Poll::Ready(<span class="kw">loop </span>{
            <span class="kw">if let </span><span class="prelude-val">Some</span>(fut) = this.future.as_mut().as_pin_mut() {
                <span class="kw">let </span>item = <span class="macro">ready!</span>(fut.try_poll(cx));
                this.future.set(<span class="prelude-val">None</span>);
                <span class="kw">break </span><span class="prelude-val">Some</span>(item);
            } <span class="kw">else </span>{
                <span class="kw">match </span><span class="macro">ready!</span>(this.stream.as_mut().try_poll_next(cx)) {
                    <span class="prelude-val">Some</span>(<span class="prelude-val">Ok</span>(item)) =&gt; <span class="kw">break </span><span class="prelude-val">Some</span>(<span class="prelude-val">Ok</span>(item)),
                    <span class="prelude-val">Some</span>(<span class="prelude-val">Err</span>(e)) =&gt; {
                        this.future.set(<span class="prelude-val">Some</span>((this.f)(e)));
                    }
    ...
    <span class="kw">fn </span>size_hint(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (usize, <span class="prelude-ty">Option</span>&lt;usize&gt;) {
        <span class="kw">let </span>future_len = usize::from(<span class="self">self</span>.future.is_some());
        <span class="kw">let </span>(lower, upper) = <span class="self">self</span>.stream.size_hint();
        <span class="kw">let </span>lower = lower.saturating_add(future_len);
        <span class="kw">let </span>upper = <span class="kw">match </span>upper {
            <span class="prelude-val">Some</span>(x) =&gt; x.checked_add(future_len),
...
<span class="kw">impl</span>&lt;St, Fut, F&gt; FusedStream <span class="kw">for </span>OrElse&lt;St, Fut, F&gt;
<span class="kw">where
    ...
    Fut: TryFuture&lt;<span class="prelude-val">Ok </span>= St::Ok&gt;,
{
    <span class="kw">fn </span>is_terminated(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.future.is_none() &amp;&amp; <span class="self">self</span>.stream.is_terminated()
    }
}
...
</span><span class="kw">impl</span>&lt;S, Fut, F, Item&gt; Sink&lt;Item&gt; <span class="kw">for </span>OrElse&lt;S, Fut, F&gt;
<span class="kw">where
    </span>S: Sink&lt;Item&gt;,
{
