...
</pre></div><pre class="rust"><code><span class="doccomment">//! Arithmetic on `Iterator.size_hint()` values.
//!
...
<span class="doccomment">/// Subtract `x` correctly from a `SizeHint`.
</span><span class="attr">#[inline]
#[allow(dead_code)]
