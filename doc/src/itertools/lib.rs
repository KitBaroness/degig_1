...
</span><span class="attr">#![doc(html_root_url=<span class="string">"https://docs.rs/itertools/0.8/"</span>)]
...
/// method in the list.
    ...
    </span><span class="attr">#[deprecated(note=<span class="string">"Use .map_ok() instead"</span>, since=<span class="string">"0.10.0"</span>)]
    ...
    /// ```
    </span><span class="attr">#[deprecated(note=<span class="string">"Use .for_each() instead"</span>, since=<span class="string">"0.8.0"</span>)]
    ...
    </span><span class="attr">#[deprecated(note=<span class="string">"Use .fold_ok() instead"</span>, since=<span class="string">"0.10.0"</span>)]
    ...
    /// ```
    </span><span class="attr">#[deprecated(since = <span class="string">"0.10.2"</span>, note = <span class="string">"Use `Iterator::reduce` instead"</span>)]
              ...
              F: FnMut(B, <span class="self">Self</span>::Item) -&gt; FoldWhile&lt;B&gt;
    {
        ...
        <span class="kw">let </span>result = <span class="self">self</span>.try_fold(init, <span class="attr">#[inline(always)] </span>|acc, v|
