...
/// See [`.format_with()`](crate::Itertools::format_with) for more information.
    ...
    </span>inner: RefCell&lt;<span class="prelude-ty">Option</span>&lt;(I, F)&gt;&gt;,
}
          ...
          F: FnMut(I::Item, <span class="kw-2">&amp;mut </span><span class="kw">dyn </span>FnMut(<span class="kw-2">&amp;</span><span class="kw">dyn </span>fmt::Display) -&gt; fmt::Result) -&gt; fmt::Result
{
    FormatWith {
        sep: separator,
        inner: RefCell::new(<span class="prelude-val">Some</span>((iter, f))),
    }
}
    ...
    <span class="kw">where </span>I: Iterator,
{
    Format {
        sep: separator,
        inner: RefCell::new(<span class="prelude-val">Some</span>(iter)),
    }
}
          ...
          F: FnMut(I::Item, <span class="kw-2">&amp;mut </span><span class="kw">dyn  </span>FnMut(<span class="kw-2">&amp;</span><span class="kw">dyn </span>fmt::Display) -&gt; fmt::Result) -&gt; fmt::Result
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        <span class="kw">let </span>(<span class="kw-2">mut </span>iter, <span class="kw-2">mut </span>format) = <span class="kw">match </span><span class="self">self</span>.inner.borrow_mut().take() {
    ...
    <span class="kw">where </span>I: Iterator,
{
    <span class="kw">fn </span>format&lt;F&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter, <span class="kw-2">mut </span>cb: F) -&gt; fmt::Result
        <span class="kw">where </span>F: FnMut(<span class="kw-2">&amp;</span>I::Item, <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result,
    {
...
<span class="macro">impl_format!</span>{Display Debug
