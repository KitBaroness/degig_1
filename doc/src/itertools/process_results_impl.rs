...
/// ```
    ...
    <span class="kw">where </span>I: IntoIterator&lt;Item = <span class="prelude-ty">Result</span>&lt;T, E&gt;&gt;,
          F: FnOnce(ProcessResults&lt;I::IntoIter, E&gt;) -&gt; R
{
    ...
    <span class="kw">let </span>result = processor(ProcessResults { error: <span class="kw-2">&amp;mut </span>error, iter });
