...
<span class="doccomment">/// `MinMaxResult` is an enum returned by `minmax`.
///
...
<span class="kw">impl</span>&lt;T: Clone&gt; MinMaxResult&lt;T&gt; {
    ...
    /// ```
        ...
        <span class="kw">match </span><span class="self">self </span>{
            MinMaxResult::NoElements =&gt; <span class="prelude-val">None</span>,
            MinMaxResult::OneElement(x) =&gt; <span class="prelude-val">Some</span>((x.clone(), x)),
            MinMaxResult::MinMax(x, y) =&gt; <span class="prelude-val">Some</span>((x, y))
        }
    }
}

<span class="doccomment">/// Implementation guts for `minmax` and `minmax_by_key`.
</span><span class="kw">pub fn </span>minmax_impl&lt;I, K, F, L&gt;(<span class="kw-2">mut </span>it: I, <span class="kw-2">mut </span>key_for: F,
                               <span class="kw-2">mut </span>lt: L) -&gt; MinMaxResult&lt;I::Item&gt;
        ...
        <span class="prelude-val">Some</span>(x) =&gt; {
            <span class="kw">match </span>it.next() {
                ...
                <span class="prelude-val">Some</span>(y) =&gt; {
                    ...
                    <span class="kw">if </span>!lt(<span class="kw-2">&amp;</span>y, <span class="kw-2">&amp;</span>x, <span class="kw-2">&amp;</span>yk, <span class="kw-2">&amp;</span>xk) {(x, y, xk, yk)} <span class="kw">else </span>{(y, x, yk, xk)}
                }
            }
        }
    };
