...
</pre></div><pre class="rust"><code><span class="doccomment">//! Iterators that are sources (produce elements from parameters,
...
/// );
/// ```
</span><span class="attr">#[deprecated(note=<span class="string">"Use std repeat_with() instead"</span>, since=<span class="string">"0.8.0"</span>)]
