...
</pre></div><pre class="rust"><code><span class="doccomment">//! Fragment Component
//!
...
<span class="doccomment">/// A map of byte characters that determines if a character is a valid fragment character.
</span><span class="attr">#[rustfmt::skip]
</span><span class="kw">const </span>FRAGMENT_CHAR_MAP: [u8; <span class="number">256</span>] = [
...
<span class="doccomment">/// The fragment component as defined in
...
</span><span class="kw">pub struct </span>Fragment&lt;<span class="lifetime">'fragment</span>&gt; {
    <span class="doccomment">/// The internal fragment source that is either owned or borrowed.
    </span>fragment: Cow&lt;<span class="lifetime">'fragment</span>, str&gt;,

    <span class="doccomment">/// Whether the fragment is normalized.
    </span>normalized: bool,
}

<span class="kw">impl </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="doccomment">/// Returns a new fragment which is identical but has a lifetime tied to this fragment.
    </span><span class="kw">pub fn </span>as_borrowed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; Fragment {
        <span class="kw">use </span><span class="self">self</span>::Cow::<span class="kw-2">*</span>;

        <span class="kw">let </span>fragment = <span class="kw">match </span><span class="kw-2">&amp;</span><span class="self">self</span>.fragment {
    ...
    <span class="doccomment">/// Returns a `str` representation of the fragment.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="kw-2">&amp;</span><span class="self">self</span>.fragment
    }

    <span class="doccomment">/// Converts the [`Fragment`] into an owned copy.
    ///
    ...
    </span><span class="kw">pub fn </span>into_owned(<span class="self">self</span>) -&gt; Fragment&lt;<span class="lifetime">'static</span>&gt; {
        Fragment {
            fragment: Cow::from(<span class="self">self</span>.fragment.into_owned()),
            normalized: <span class="self">self</span>.normalized,
        }
    }

    <span class="doccomment">/// Returns whether the fragment is normalized.
    ///
    ...
    <span class="doccomment">/// Normalizes the fragment such that it will have no bytes that are in the unreserved character
    ...
    /// ```
        ...
        <span class="kw">if </span>!<span class="self">self</span>.normalized {
            <span class="comment">// Unsafe: Fragments must be valid ASCII-US, so this is safe.
            </span><span class="kw">unsafe </span>{ normalize_string(<span class="kw-2">&amp;mut </span><span class="self">self</span>.fragment.to_mut(), <span class="bool-val">true</span>) };
            <span class="self">self</span>.normalized = <span class="bool-val">true</span>;
        }
    }
}

<span class="kw">impl </span>AsRef&lt;[u8]&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>as_ref(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[u8] {
        <span class="self">self</span>.fragment.as_bytes()
    }
}

<span class="kw">impl </span>AsRef&lt;str&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>as_ref(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>str {
        <span class="kw-2">&amp;</span><span class="self">self</span>.fragment
    }
}

<span class="kw">impl </span>Deref <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
...
<span class="kw">impl </span>Display <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>Formatter) -&gt; fmt::Result {
        formatter.write_str(<span class="kw-2">&amp;</span><span class="self">self</span>.fragment)
    }
}

<span class="kw">impl </span>Eq <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'fragment</span>&gt; From&lt;Fragment&lt;<span class="lifetime">'fragment</span>&gt;&gt; <span class="kw">for </span>String {
    <span class="kw">fn </span>from(value: Fragment&lt;<span class="lifetime">'fragment</span>&gt;) -&gt; <span class="self">Self </span>{
        value.to_string()
    }
}

<span class="kw">impl </span>Hash <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>hash&lt;H&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, state: <span class="kw-2">&amp;mut </span>H)
    <span class="kw">where
        </span>H: Hasher,
    {
        percent_encoded_hash(<span class="self">self</span>.fragment.as_bytes(), state, <span class="bool-val">true</span>);
    }
}

<span class="kw">impl </span>PartialEq <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Fragment) -&gt; bool {
        <span class="kw-2">*</span><span class="self">self </span>== <span class="kw-2">*</span>other.as_bytes()
    }
}

<span class="kw">impl </span>PartialEq&lt;[u8]&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>[u8]) -&gt; bool {
        percent_encoded_equality(<span class="self">self</span>.fragment.as_bytes(), other, <span class="bool-val">true</span>)
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'fragment</span>&gt; PartialEq&lt;Fragment&lt;<span class="lifetime">'fragment</span>&gt;&gt; <span class="kw">for </span>[u8] {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'fragment</span>&gt;) -&gt; bool {
        other == <span class="self">self
    </span>}
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; PartialEq&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8]&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'fragment</span>&gt; PartialEq&lt;Fragment&lt;<span class="lifetime">'fragment</span>&gt;&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8] {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'fragment</span>&gt;) -&gt; bool {
        other == <span class="kw-2">*</span><span class="self">self
    </span>}
}

<span class="kw">impl </span>PartialEq&lt;str&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'fragment</span>&gt; PartialEq&lt;Fragment&lt;<span class="lifetime">'fragment</span>&gt;&gt; <span class="kw">for </span>str {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'fragment</span>&gt;) -&gt; bool {
        other == <span class="self">self</span>.as_bytes()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; PartialEq&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>str&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: &amp;&amp;<span class="lifetime">'a </span>str) -&gt; bool {
        <span class="self">self </span>== other.as_bytes()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, <span class="lifetime">'fragment</span>&gt; PartialEq&lt;Fragment&lt;<span class="lifetime">'fragment</span>&gt;&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>str {
    <span class="kw">fn </span>eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'fragment</span>&gt;) -&gt; bool {
        other == <span class="self">self</span>.as_bytes()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'fragment</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'fragment </span>[u8]&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'fragment</span>&gt; {
    <span class="kw">type </span>Error = FragmentError;

    <span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span><span class="lifetime">'fragment </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        ...
        <span class="kw">while let </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>byte) = bytes.next() {
            <span class="kw">match </span>FRAGMENT_CHAR_MAP[byte <span class="kw">as </span>usize] {
                <span class="number">0 </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(FragmentError::InvalidCharacter),
                <span class="string">b'%' </span>=&gt; {
                    <span class="kw">match </span>get_percent_encoded_value(bytes.next().cloned(), bytes.next().cloned()) {
                        ...
                        <span class="prelude-val">Err</span>(<span class="kw">_</span>) =&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(FragmentError::InvalidPercentEncoding),
                    }
                }
        ...
        </span><span class="prelude-val">Ok</span>(Fragment {
            fragment: Cow::from(<span class="kw">unsafe </span>{ str::from_utf8_unchecked(value) }),
            normalized,
        })
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'fragment</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'fragment </span>str&gt; <span class="kw">for </span>Fragment&lt;<span class="lifetime">'fragment</span>&gt; {
    <span class="kw">type </span>Error = FragmentError;

    <span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span><span class="lifetime">'fragment </span>str) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        Fragment::try_from(value.as_bytes())
    }
}

<span class="doccomment">/// An error representing an invalid fragment.
</span><span class="attr">#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
#[non_exhaustive]
</span><span class="kw">pub enum </span>FragmentError {
...
<span class="kw">impl </span>Display <span class="kw">for </span>FragmentError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>Formatter) -&gt; fmt::Result {
        <span class="kw">use </span><span class="self">self</span>::FragmentError::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="self">self </span>{
            InvalidCharacter =&gt; <span class="macro">write!</span>(formatter, <span class="string">"invalid fragment character"</span>),
            InvalidPercentEncoding =&gt; <span class="macro">write!</span>(formatter, <span class="string">"invalid fragment percent encoding"</span>),
        }
    }
}

<span class="kw">impl </span>Error <span class="kw">for </span>FragmentError {}

<span class="kw">impl </span>From&lt;Infallible&gt; <span class="kw">for </span>FragmentError {
...
<span class="attr">#[cfg(test)]
    ...
    </span><span class="kw">fn </span>test_fragment_normalize() {
        <span class="kw">fn </span>test_case(value: <span class="kw-2">&amp;</span>str, expected: <span class="kw-2">&amp;</span>str) {
            <span class="kw">let </span><span class="kw-2">mut </span>fragment = Fragment::try_from(value).unwrap();
            fragment.normalize();
            <span class="macro">assert_eq!</span>(fragment, expected);
        }
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_fragment_parse() {
        <span class="kw">use </span><span class="self">self</span>::FragmentError::<span class="kw-2">*</span>;

        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">""</span>).unwrap(), <span class="string">""</span>);
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"fragment"</span>).unwrap(), <span class="string">"fragment"</span>);
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"fRaGmEnT"</span>).unwrap(), <span class="string">"fRaGmEnT"</span>);
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"%ff%ff%ff%41"</span>).unwrap(), <span class="string">"%ff%ff%ff%41"</span>);

        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">" "</span>), <span class="prelude-val">Err</span>(InvalidCharacter));
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"%"</span>), <span class="prelude-val">Err</span>(InvalidPercentEncoding));
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"%f"</span>), <span class="prelude-val">Err</span>(InvalidPercentEncoding));
        <span class="macro">assert_eq!</span>(Fragment::try_from(<span class="string">"%zz"</span>), <span class="prelude-val">Err</span>(InvalidPercentEncoding));
    }
}
