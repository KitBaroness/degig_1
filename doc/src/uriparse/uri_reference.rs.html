...
</pre></div><pre class="rust"><code><span class="kw">use </span>std::convert::{Infallible, TryFrom};
<span class="kw">use </span>std::error::Error;
<span class="kw">use </span>std::fmt::{<span class="self">self</span>, Display, Formatter, Write};
<span class="kw">use </span>std::mem;

<span class="kw">use </span><span class="kw">crate</span>::authority::{parse_authority, Authority, AuthorityError, Host, Password, Username};
<span class="kw">use </span><span class="kw">crate</span>::fragment::{Fragment, FragmentError};
<span class="kw">use </span><span class="kw">crate</span>::path::{parse_path, Path, PathError};
<span class="kw">use </span><span class="kw">crate</span>::query::{parse_query, Query, QueryError};
<span class="kw">use </span><span class="kw">crate</span>::scheme::{parse_scheme, Scheme, SchemeError};

<span class="doccomment">/// A URI reference as defined in
...
</span><span class="kw">pub struct </span>URIReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// The authority component of the URI reference as defined in
    /// [[RFC3986, Section 3.2]](https://tools.ietf.org/html/rfc3986#section-3.2).
    </span>authority: <span class="prelude-ty">Option</span>&lt;Authority&lt;<span class="lifetime">'uri</span>&gt;&gt;,

    <span class="doccomment">/// The fragment component of the URI reference as defined in
    /// [[RFC3986, Section 3.5]](https://tools.ietf.org/html/rfc3986#section-3.5).
    </span>fragment: <span class="prelude-ty">Option</span>&lt;Fragment&lt;<span class="lifetime">'uri</span>&gt;&gt;,

    <span class="doccomment">/// The path component of the URI reference as defined in
    /// [[RFC3986, Section 3.3]](https://tools.ietf.org/html/rfc3986#section-3.3).
    </span>path: Path&lt;<span class="lifetime">'uri</span>&gt;,

    <span class="doccomment">/// The query component of the URI reference as defined in
    /// [[RFC3986, Section 3.4]](https://tools.ietf.org/html/rfc3986#section-3.4).
    </span>query: <span class="prelude-ty">Option</span>&lt;Query&lt;<span class="lifetime">'uri</span>&gt;&gt;,

    <span class="doccomment">/// The scheme component of the URI reference as defined in
    /// [[RFC3986, Section 3.1](https://tools.ietf.org/html/rfc3986#section-3.1).
    </span>scheme: <span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; URIReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// Returns the authority, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.authority.as_ref()
    }

    <span class="doccomment">/// Constructs a default builder for a URI reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>builder&lt;<span class="lifetime">'new_uri</span>&gt;() -&gt; URIReferenceBuilder&lt;<span class="lifetime">'new_uri</span>&gt; {
        URIReferenceBuilder::default()
    }

    <span class="doccomment">/// Returns whether the URI reference can act as a base URI.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.has_scheme() &amp;&amp; !<span class="self">self</span>.has_fragment()
    }

    <span class="doccomment">/// Constructs a new [`URIReference`] from the individual parts: scheme, authority, path, query,
    /// and fragment.
    ///
    ...
    /// ```
        ...
        TFragmentError,
    &gt;(
        scheme: <span class="prelude-ty">Option</span>&lt;TScheme&gt;,
    ...
    ) -&gt; <span class="prelude-ty">Result</span>&lt;URIReference&lt;<span class="lifetime">'new_uri</span>&gt;, URIReferenceError&gt;
    <span class="kw">where
        ...
        URIReferenceError: From&lt;TSchemeError&gt;
            ...
            + From&lt;TFragmentError&gt;,
    {
        <span class="kw">let </span>scheme = <span class="kw">match </span>scheme {
            <span class="prelude-val">Some</span>(scheme) =&gt; <span class="prelude-val">Some</span>(Scheme::try_from(scheme)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };

        <span class="kw">let </span>authority = <span class="kw">match </span>authority {
            <span class="prelude-val">Some</span>(authority) =&gt; <span class="prelude-val">Some</span>(Authority::try_from(authority)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };

        <span class="kw">let </span><span class="kw-2">mut </span>path = Path::try_from(path)<span class="question-mark">?</span>;

        <span class="kw">if </span>authority.is_some() {
            path.set_absolute(<span class="bool-val">true</span>);
        }

        validate_absolute_path(authority.as_ref(), <span class="kw-2">&amp;</span>path)<span class="question-mark">?</span>;
        validate_schemeless_path(scheme.as_ref(), authority.as_ref(), <span class="kw-2">&amp;</span>path)<span class="question-mark">?</span>;

        <span class="kw">let </span>query = <span class="kw">match </span>query {
            <span class="prelude-val">Some</span>(query) =&gt; <span class="prelude-val">Some</span>(Query::try_from(query)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };

        <span class="kw">let </span>fragment = <span class="kw">match </span>fragment {
            <span class="prelude-val">Some</span>(fragment) =&gt; <span class="prelude-val">Some</span>(Fragment::try_from(fragment)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };

        <span class="prelude-val">Ok</span>(URIReference {
            authority,
            fragment,
            path,
            query,
    ...
    <span class="doccomment">/// Returns the fragment, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.fragment.as_ref()
    }

    <span class="doccomment">/// Returns whether the URI reference has an authority component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.authority.is_some()
    }

    <span class="doccomment">/// Returns whether the URI reference has a fragment component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.fragment.is_some()
    }

    <span class="doccomment">/// Returns whether the URI reference has a password component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>authority) = <span class="self">self</span>.authority {
    ...
    <span class="doccomment">/// Returns whether the URI reference has a port.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the URI reference has a query component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.query.is_some()
    }

    <span class="doccomment">/// Returns whether the URI reference has a scheme component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// assert!(!reference.has_scheme());
    /// ```
    </span><span class="kw">pub fn </span>has_scheme(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_some()
    }

    <span class="doccomment">/// Returns whether the URI reference has a username component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the host, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>authority) = <span class="self">self</span>.authority {
            <span class="prelude-val">Some</span>(authority.host())
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>}
    }

    <span class="doccomment">/// Consumes the URI reference and converts it into a builder with the same values.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    </span><span class="kw">pub fn </span>into_builder(<span class="self">self</span>) -&gt; URIReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
        <span class="kw">let </span><span class="kw-2">mut </span>builder = URIReferenceBuilder::new();
        builder
            .scheme(<span class="self">self</span>.scheme)
            .authority(<span class="self">self</span>.authority)
            .path(<span class="self">self</span>.path)
            .query(<span class="self">self</span>.query)
            .fragment(<span class="self">self</span>.fragment);
        builder
    }

    <span class="doccomment">/// Converts the [`URIReference`] into an owned copy.
    ///
    ...
    </span><span class="kw">pub fn </span>into_owned(<span class="self">self</span>) -&gt; URIReference&lt;<span class="lifetime">'static</span>&gt; {
        <span class="kw">let </span>scheme = <span class="self">self</span>.scheme.map(Scheme::into_owned);
        <span class="kw">let </span>authority = <span class="self">self</span>.authority.map(Authority::into_owned);
        <span class="kw">let </span>path = <span class="self">self</span>.path.into_owned();
        <span class="kw">let </span>query = <span class="self">self</span>.query.map(Query::into_owned);
        <span class="kw">let </span>fragment = <span class="self">self</span>.fragment.map(Fragment::into_owned);
    ...
    <span class="doccomment">/// Consumes the [`URIReference`] and returns its parts: scheme, authority, path, query, and
    /// fragment.
    ///
    /// # Examples
    ///
    ...
    /// ```
        ...
        <span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;,
        ...
        (
            ...
            <span class="self">self</span>.query,
            <span class="self">self</span>.fragment,
        )
    }

    <span class="doccomment">/// Returns whether the URI reference is an absolute path reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>is_absolute_path_reference(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_none() &amp;&amp; <span class="self">self</span>.authority.is_none() &amp;&amp; <span class="self">self</span>.path.is_absolute()
    }

    <span class="doccomment">/// Returns whether the URI reference is a network path reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>is_network_path_reference(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_none() &amp;&amp; <span class="self">self</span>.authority.is_some()
    }

    <span class="doccomment">/// Returns whether the URI reference is normalized.
    ///
    ...
    /// ```
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(scheme) = <span class="self">self</span>.scheme.as_ref() {
            <span class="kw">if </span>!scheme.is_normalized() {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(authority) = <span class="self">self</span>.authority.as_ref() {
            <span class="kw">if </span>!authority.is_normalized() {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
        }

        <span class="kw">if </span>!<span class="self">self</span>.path.is_normalized(<span class="self">self</span>.scheme.is_none()) {
            <span class="kw">return </span><span class="bool-val">false</span>;
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(query) = <span class="self">self</span>.query.as_ref() {
            <span class="kw">if </span>!query.is_normalized() {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(fragment) = <span class="self">self</span>.fragment.as_ref() {
            <span class="kw">if </span>!fragment.is_normalized() {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
        }
    ...
    <span class="doccomment">/// Returns whether the URI reference is a relative path reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>is_relative_path_reference(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_none() &amp;&amp; <span class="self">self</span>.authority.is_none() &amp;&amp; !<span class="self">self</span>.path.is_absolute()
    }

    <span class="doccomment">/// Returns whether the URI reference is a relative reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>is_relative_reference(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_none()
    }

    <span class="doccomment">/// Returns whether the URI reference is a URI.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>is_uri(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; bool {
        <span class="self">self</span>.scheme.is_some()
    }
    ...
    {
        <span class="kw">let </span>authority = mapper(<span class="self">self</span>.authority.take());
        <span class="self">self</span>.set_authority(authority)
            .expect(<span class="string">"mapped authority resulted in invalid state"</span>)
    }
    ...
    {
        <span class="kw">let </span>fragment = mapper(<span class="self">self</span>.fragment.take());
        <span class="self">self</span>.set_fragment(fragment)
            .expect(<span class="string">"mapped fragment resulted in invalid state"</span>)
    }
    ...
    {
        <span class="comment">// Unsafe: We're creating an invalid path just as a temporary sentinel value, but it is
        // replaced shortly after.
        </span><span class="kw">let </span>temp_path = <span class="kw">unsafe </span>{ Path::new_with_no_segments(<span class="bool-val">true</span>) };
        <span class="kw">let </span>path = mapper(mem::replace(<span class="kw-2">&amp;mut </span><span class="self">self</span>.path, temp_path));
        <span class="self">self</span>.set_path(path)
            .expect(<span class="string">"mapped path resulted in invalid state"</span>)
    }
    ...
    {
        <span class="kw">let </span>query = mapper(<span class="self">self</span>.query.take());
        <span class="self">self</span>.set_query(query)
            .expect(<span class="string">"mapped query resulted in invalid state"</span>)
    }
    ...
    <span class="kw">where
        </span>TMapper: FnOnce(<span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;) -&gt; <span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;,
    {
        <span class="kw">let </span>scheme = mapper(<span class="self">self</span>.scheme.take());
        <span class="self">self</span>.set_scheme(scheme)
            .expect(<span class="string">"mapped scheme resulted in invalid state"</span>)
    }

    <span class="doccomment">/// Normalizes the URI reference.
    ///
    /// A normalized URI reference will have all of its components normalized.
    ///
    /// # Examples
    ...
    /// ```
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(scheme) = <span class="self">self</span>.scheme.as_mut() {
            scheme.normalize();
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(authority) = <span class="self">self</span>.authority.as_mut() {
            authority.normalize();
        }

        <span class="self">self</span>.path.normalize(<span class="self">self</span>.scheme.is_none());

        <span class="kw">if let </span><span class="prelude-val">Some</span>(query) = <span class="self">self</span>.query.as_mut() {
            query.normalize();
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(fragment) = <span class="self">self</span>.fragment.as_mut() {
            fragment.normalize();
        }
    }

    <span class="doccomment">/// Returns the path of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the password, if present, of the URI reference.
    ///
    ...
    <span class="doccomment">/// Returns the port, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the query, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
        ...
        <span class="self">self</span>.query.as_ref()
    }

    <span class="doccomment">/// Returns the scheme, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    </span><span class="kw">pub fn </span>scheme(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt; {
        <span class="self">self</span>.scheme.as_ref()
    }

    <span class="doccomment">/// Sets the authority of the URI reference.
    ///
    ...
    /// ```
        ...
        authority: <span class="prelude-ty">Option</span>&lt;TAuthority&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Authority&lt;<span class="lifetime">'uri</span>&gt;&gt;, URIReferenceError&gt;
    <span class="kw">where
    ...
    {
        <span class="self">self</span>.authority = <span class="kw">match </span>authority {
            <span class="prelude-val">Some</span>(authority) =&gt; {
                <span class="self">self</span>.path.set_absolute(<span class="bool-val">true</span>);
                <span class="prelude-val">Some</span>(Authority::try_from(authority)<span class="question-mark">?</span>)
            }
            <span class="prelude-val">None </span>=&gt; {
                validate_absolute_path(<span class="prelude-val">None</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.path)<span class="question-mark">?</span>;
                <span class="prelude-val">None
            </span>}
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.authority())
    }

    <span class="doccomment">/// Sets the fragment of the URI reference.
    ///
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        fragment: <span class="prelude-ty">Option</span>&lt;TFragment&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'uri</span>&gt;&gt;, URIReferenceError&gt;
    <span class="kw">where
        </span>Fragment&lt;<span class="lifetime">'uri</span>&gt;: TryFrom&lt;TFragment, Error = TFragmentError&gt;,
        URIReferenceError: From&lt;TFragmentError&gt;,
    {
        <span class="self">self</span>.fragment = <span class="kw">match </span>fragment {
            <span class="prelude-val">Some</span>(fragment) =&gt; <span class="prelude-val">Some</span>(Fragment::try_from(fragment)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.fragment())
    }

    <span class="doccomment">/// Sets the path of the URI reference.
    ///
    ...
    /// assert_eq!(reference.to_string(), "http://example.com/my/path");
    /// ```
    </span><span class="kw">pub fn </span>set_path&lt;TPath, TPathError&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        path: TPath,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>Path&lt;<span class="lifetime">'uri</span>&gt;, URIReferenceError&gt;
    <span class="kw">where
        </span>Path&lt;<span class="lifetime">'uri</span>&gt;: TryFrom&lt;TPath, Error = TPathError&gt;,
        URIReferenceError: From&lt;TPathError&gt;,
    {
        <span class="kw">let </span><span class="kw-2">mut </span>path = Path::try_from(path)<span class="question-mark">?</span>;
        validate_absolute_path(<span class="self">self</span>.authority.as_ref(), <span class="kw-2">&amp;</span>path)<span class="question-mark">?</span>;
        validate_schemeless_path(<span class="self">self</span>.scheme.as_ref(), <span class="self">self</span>.authority.as_ref(), <span class="kw-2">&amp;</span>path)<span class="question-mark">?</span>;

        <span class="kw">if </span><span class="self">self</span>.authority.is_some() {
            path.set_absolute(<span class="bool-val">true</span>);
        }

        <span class="self">self</span>.path = path;
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.path())
    }

    <span class="doccomment">/// Sets the query of the URI reference.
    ///
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        query: <span class="prelude-ty">Option</span>&lt;TQuery&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Query&lt;<span class="lifetime">'uri</span>&gt;&gt;, URIReferenceError&gt;
    <span class="kw">where
        </span>Query&lt;<span class="lifetime">'uri</span>&gt;: TryFrom&lt;TQuery, Error = TQueryError&gt;,
        URIReferenceError: From&lt;TQueryError&gt;,
    {
        <span class="self">self</span>.query = <span class="kw">match </span>query {
            <span class="prelude-val">Some</span>(query) =&gt; <span class="prelude-val">Some</span>(Query::try_from(query)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>.query())
    }

    <span class="doccomment">/// Sets the scheme of the URI reference.
    ///
    /// An error will be returned in one of two cases:
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        scheme: <span class="prelude-ty">Option</span>&lt;TScheme&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;, URIReferenceError&gt;
    <span class="kw">where
        </span>Scheme&lt;<span class="lifetime">'uri</span>&gt;: TryFrom&lt;TScheme, Error = TSchemeError&gt;,
        URIReferenceError: From&lt;TSchemeError&gt;,
    {
        <span class="self">self</span>.scheme = <span class="kw">match </span>scheme {
            <span class="prelude-val">Some</span>(scheme) =&gt; <span class="prelude-val">Some</span>(Scheme::try_from(scheme)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; {
                validate_schemeless_path(<span class="prelude-val">None</span>, <span class="self">self</span>.authority.as_ref(), <span class="kw-2">&amp;</span><span class="self">self</span>.path)<span class="question-mark">?</span>;
                <span class="prelude-val">None
            </span>}
        };
    ...
    <span class="doccomment">/// Returns a new URI reference which is identical but has a lifetime tied to this URI
    /// reference.
    ///
    /// This function will perform a memory allocation.
    </span><span class="kw">pub fn </span>to_borrowed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; URIReference {
        <span class="kw">let </span>scheme = <span class="self">self</span>.scheme.as_ref().map(Scheme::as_borrowed);
        <span class="kw">let </span>authority = <span class="self">self</span>.authority.as_ref().map(Authority::as_borrowed);
        <span class="kw">let </span>path = <span class="self">self</span>.path.to_borrowed();
        <span class="kw">let </span>query = <span class="self">self</span>.query.as_ref().map(Query::as_borrowed);
        <span class="kw">let </span>fragment = <span class="self">self</span>.fragment.as_ref().map(Fragment::as_borrowed);
    ...
    <span class="doccomment">/// Returns the username, if present, of the URI reference.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>Display <span class="kw">for </span>URIReference&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>Formatter) -&gt; fmt::Result {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>scheme) = <span class="self">self</span>.scheme {
            formatter.write_str(scheme.as_str())<span class="question-mark">?</span>;
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>authority) = <span class="self">self</span>.authority {
            ...
            formatter.write_str(<span class="kw-2">&amp;</span>authority.to_string())<span class="question-mark">?</span>;
        }

        formatter.write_str(<span class="kw-2">&amp;</span><span class="self">self</span>.path.to_string())<span class="question-mark">?</span>;

        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>query) = <span class="self">self</span>.query {
            formatter.write_char(<span class="string">'?'</span>)<span class="question-mark">?</span>;
            formatter.write_str(query.as_str())<span class="question-mark">?</span>;
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">ref </span>fragment) = <span class="self">self</span>.fragment {
            formatter.write_char(<span class="string">'#'</span>)<span class="question-mark">?</span>;
            formatter.write_str(fragment.as_str())<span class="question-mark">?</span>;
        }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; From&lt;URIReference&lt;<span class="lifetime">'uri</span>&gt;&gt; <span class="kw">for </span>String {
    <span class="kw">fn </span>from(value: URIReference&lt;<span class="lifetime">'uri</span>&gt;) -&gt; <span class="self">Self </span>{
        value.to_string()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'uri </span>[u8]&gt; <span class="kw">for </span>URIReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">type </span>Error = URIReferenceError;
    ...
    <span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span><span class="lifetime">'uri </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        <span class="kw">let </span>(scheme, value) = <span class="kw">match </span>parse_scheme(value) {
            <span class="prelude-val">Ok</span>((scheme, rest)) =&gt; {
                <span class="kw">if </span>rest.starts_with(<span class="string">b":"</span>) {
                    (<span class="prelude-val">Some</span>(scheme), <span class="kw-2">&amp;</span>rest[<span class="number">1</span>..])
                } <span class="kw">else </span>{
                    (<span class="prelude-val">None</span>, value)
                }
            }
            <span class="kw">_ </span>=&gt; (<span class="prelude-val">None</span>, value),
        };

        <span class="kw">let </span>(authority, value) = <span class="kw">match </span>value.get(<span class="number">0</span>..<span class="number">2</span>) {
            <span class="prelude-val">Some</span>(<span class="string">b"//"</span>) =&gt; {
                <span class="kw">let </span>(authority, value) = parse_authority(<span class="kw-2">&amp;</span>value[<span class="number">2</span>..])<span class="question-mark">?</span>;
                (<span class="prelude-val">Some</span>(authority), value)
            }
            <span class="kw">_ </span>=&gt; (<span class="prelude-val">None</span>, value),
        };

        <span class="kw">let </span>(<span class="kw-2">mut </span>path, value) = parse_path(value)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>(query, value) = <span class="kw">if </span>value.starts_with(<span class="string">b"?"</span>) {
            <span class="kw">let </span>(query, value) = parse_query(<span class="kw-2">&amp;</span>value[<span class="number">1</span>..])<span class="question-mark">?</span>;
            (<span class="prelude-val">Some</span>(query), value)
        } <span class="kw">else </span>{
            (<span class="prelude-val">None</span>, value)
        };

        <span class="kw">let </span>fragment = <span class="kw">if </span>value.starts_with(<span class="string">b"#"</span>) {
            <span class="prelude-val">Some</span>(Fragment::try_from(<span class="kw-2">&amp;</span>value[<span class="number">1</span>..])<span class="question-mark">?</span>)
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>};
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'uri </span>str&gt; <span class="kw">for </span>URIReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">type </span>Error = URIReferenceError;
...
<span class="doccomment">/// A builder type for [`URIReference]`.
///
...
/// have a path. Everything else is optional.
...
</span><span class="kw">pub struct </span>URIReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// The authority component of the URI reference as defined in
    /// [[RFC3986, Section 3.2]](https://tools.ietf.org/html/rfc3986#section-3.2).
    </span>authority: <span class="prelude-ty">Option</span>&lt;Authority&lt;<span class="lifetime">'uri</span>&gt;&gt;,
    ...
    <span class="doccomment">/// The path component of the URI reference as defined in
    /// [[RFC3986, Section 3.3]](https://tools.ietf.org/html/rfc3986#section-3.3).
    </span>path: <span class="prelude-ty">Option</span>&lt;Path&lt;<span class="lifetime">'uri</span>&gt;&gt;,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; URIReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// Sets the authority part of the URI reference.
    ///
    ...
    <span class="doccomment">/// Consumes the builder and tries to build a [`URIReference`].
    ///
    ...
    /// assert!(result.is_err());
    /// ```
    </span><span class="kw">pub fn </span>build(<span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;URIReference&lt;<span class="lifetime">'uri</span>&gt;, URIReferenceError&gt; {
        <span class="kw">let </span>path = <span class="kw">match </span><span class="self">self</span>.path {
            <span class="prelude-val">Some</span>(path) =&gt; path,
            <span class="prelude-val">None </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(URIReferenceError::MissingPath),
        };

        URIReference::from_parts(<span class="self">self</span>.scheme, <span class="self">self</span>.authority, path, <span class="self">self</span>.query, <span class="self">self</span>.fragment)
    }

    <span class="doccomment">/// Sets the fragment part of the URI reference.
    ///
    ...
    <span class="doccomment">/// Sets the path part of the URI reference.
    ///
    ...
    /// assert_eq!(reference.to_string(), "http://example.com/my/path");
    /// ```
    </span><span class="kw">pub fn </span>scheme(<span class="kw-2">&amp;mut </span><span class="self">self</span>, scheme: <span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;) -&gt; <span class="kw-2">&amp;mut </span><span class="self">Self </span>{
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        authority: <span class="prelude-ty">Option</span>&lt;TAuthority&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>, TAuthorityError&gt;
    <span class="kw">where
        </span>Authority&lt;<span class="lifetime">'uri</span>&gt;: TryFrom&lt;TAuthority, Error = TAuthorityError&gt;,
        AuthorityError: From&lt;TAuthorityError&gt;,
    {
        <span class="self">self</span>.authority = <span class="kw">match </span>authority {
            <span class="prelude-val">Some</span>(authority) =&gt; <span class="prelude-val">Some</span>(Authority::try_from(authority).map_err(|error| error)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
    ...
    {
        <span class="self">self</span>.fragment = <span class="kw">match </span>fragment {
            <span class="prelude-val">Some</span>(fragment) =&gt; <span class="prelude-val">Some</span>(Fragment::try_from(fragment).map_err(|error| error)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>)
    }
    ...
    {
        <span class="self">self</span>.path = <span class="prelude-val">Some</span>(Path::try_from(path).map_err(|error| error)<span class="question-mark">?</span>);
        <span class="prelude-val">Ok</span>(<span class="self">self</span>)
    }
    ...
    {
        <span class="self">self</span>.query = <span class="kw">match </span>query {
            <span class="prelude-val">Some</span>(query) =&gt; <span class="prelude-val">Some</span>(Query::try_from(query).map_err(|error| error)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>)
    }
    ...
    {
        <span class="self">self</span>.scheme = <span class="kw">match </span>scheme {
            <span class="prelude-val">Some</span>(scheme) =&gt; <span class="prelude-val">Some</span>(Scheme::try_from(scheme).map_err(|error| error)<span class="question-mark">?</span>),
            <span class="prelude-val">None </span>=&gt; <span class="prelude-val">None</span>,
        };
        <span class="prelude-val">Ok</span>(<span class="self">self</span>)
    }

    <span class="doccomment">/// Consumes the builder and sets the authority part of the URI reference.
    ///
    /// It is optional to specify an authority.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Consumes the builder and sets the fragment part of the URI reference.
    ///
    /// It is optional to specify a fragment.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Consumes the builder and sets the path part of the URI reference.
    ///
    /// It is required to specify a path. Not doing so will result in an error during the
    /// [`URIReferenceBuilder::build`] function.
    ///
    ...
    <span class="doccomment">/// Consumes the builder and sets the query part of the URI reference.
    ///
    /// It is optional to specify a query.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Consumes the builder and sets the scheme part of the URI reference.
    ///
    /// It is optional to specify a scheme.
    ///
    /// # Examples
    ...
    /// ```
    </span><span class="kw">pub fn </span>with_scheme(<span class="kw-2">mut </span><span class="self">self</span>, scheme: <span class="prelude-ty">Option</span>&lt;Scheme&lt;<span class="lifetime">'uri</span>&gt;&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">self</span>.scheme(scheme);
        <span class="self">self
    </span>}
}

<span class="doccomment">/// An error representing an invalid URI reference.
</span><span class="attr">#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
#[non_exhaustive]
</span><span class="kw">pub enum </span>URIReferenceError {
    ...
    /// This can only occur when using creation functions that act on individual parts (e.g.
    /// [`URIReference::from_parts`]).
    </span>SchemelessPathStartsWithColonSegment,
}

<span class="kw">impl </span>Display <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>Formatter) -&gt; fmt::Result {
        <span class="kw">use </span><span class="self">self</span>::URIReferenceError::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="self">self </span>{
            AbsolutePathStartsWithTwoSlashes =&gt; <span class="macro">write!</span>(
                formatter,
                <span class="string">"absolute path URI reference starts with two slashes"
            </span>),
            ...
            MissingPath =&gt; <span class="macro">write!</span>(formatter, <span class="string">"URI reference missing path"</span>),
            SchemelessPathStartsWithColonSegment =&gt; <span class="macro">write!</span>(
                formatter,
                <span class="string">"schemeless path URI reference starts with colon segment"
            </span>),
        }
    }
}

<span class="kw">impl </span>Error <span class="kw">for </span>URIReferenceError {}

<span class="kw">impl </span>From&lt;Infallible&gt; <span class="kw">for </span>URIReferenceError {
...
<span class="kw">impl </span>From&lt;AuthorityError&gt; <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>from(value: AuthorityError) -&gt; <span class="self">Self </span>{
        URIReferenceError::Authority(value)
    }
}

<span class="kw">impl </span>From&lt;FragmentError&gt; <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>from(value: FragmentError) -&gt; <span class="self">Self </span>{
        URIReferenceError::Fragment(value)
    }
}

<span class="kw">impl </span>From&lt;PathError&gt; <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>from(value: PathError) -&gt; <span class="self">Self </span>{
        URIReferenceError::Path(value)
    }
}

<span class="kw">impl </span>From&lt;QueryError&gt; <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>from(value: QueryError) -&gt; <span class="self">Self </span>{
        URIReferenceError::Query(value)
    }
}

<span class="kw">impl </span>From&lt;SchemeError&gt; <span class="kw">for </span>URIReferenceError {
    <span class="kw">fn </span>from(value: SchemeError) -&gt; <span class="self">Self </span>{
        URIReferenceError::Scheme(value)
    }
}

<span class="kw">fn </span>validate_absolute_path(
    authority: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Authority&gt;,
    path: <span class="kw-2">&amp;</span>Path,
) -&gt; <span class="prelude-ty">Result</span>&lt;(), URIReferenceError&gt; {
    <span class="kw">if </span>authority.is_some()
        || path.is_relative()
        || path.segments().len() == <span class="number">1
        </span>|| !path.segments().first().unwrap().is_empty()
    {
        <span class="prelude-val">Ok</span>(())
    } <span class="kw">else </span>{
        <span class="prelude-val">Err</span>(URIReferenceError::AbsolutePathStartsWithTwoSlashes)
    }
}

<span class="kw">fn </span>validate_schemeless_path(
    scheme: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Scheme&gt;,
    authority: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Authority&gt;,
    path: <span class="kw-2">&amp;</span>Path,
) -&gt; <span class="prelude-ty">Result</span>&lt;(), URIReferenceError&gt; {
    <span class="kw">if </span>scheme.is_some()
        ...
        || !path
            ...
            .unwrap()
            .bytes()
            .any(|byte| byte == <span class="string">b':'</span>)
    {
        <span class="prelude-val">Ok</span>(())
    } <span class="kw">else </span>{
        <span class="prelude-val">Err</span>(URIReferenceError::SchemelessPathStartsWithColonSegment)
    }
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_parse_uri_reference() {
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">"http://example.com"</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
            <span class="prelude-val">Some</span>(Scheme::HTTP),
            <span class="prelude-val">Some</span>(<span class="string">"example.com"</span>),
            <span class="string">"/"</span>,
            <span class="prelude-val">None</span>::&lt;Query&gt;,
            <span class="prelude-val">None</span>::&lt;Fragment&gt;,
        )
        .unwrap();
        ...
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">"http:"</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
            <span class="prelude-val">Some</span>(Scheme::HTTP),
            <span class="prelude-val">None</span>::&lt;Authority&gt;,
            <span class="string">""</span>,
            <span class="prelude-val">None</span>::&lt;Query&gt;,
            <span class="prelude-val">None</span>::&lt;Fragment&gt;,
        )
        ...
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">"http:/path"</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
            <span class="prelude-val">Some</span>(Scheme::HTTP),
            <span class="prelude-val">None</span>::&lt;Authority&gt;,
        ...
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">"//example.com/"</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
        ...
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">""</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
            <span class="prelude-val">None</span>::&lt;Scheme&gt;,
            <span class="prelude-val">None</span>::&lt;Authority&gt;,
            <span class="string">""</span>,
        ...
        <span class="kw">let </span>actual = URIReference::try_from(<span class="string">"test/path"</span>).unwrap();
        <span class="kw">let </span>expected = URIReference::from_parts(
            <span class="prelude-val">None</span>::&lt;Scheme&gt;,
            <span class="prelude-val">None</span>::&lt;Authority&gt;,
            <span class="string">"test/path"</span>,
            <span class="prelude-val">None</span>::&lt;Query&gt;,
            <span class="prelude-val">None</span>::&lt;Fragment&gt;,
        )
        .unwrap();
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_parse_uri_reference_error() {
        <span class="macro">assert_eq!</span>(
            URIReference::try_from(<span class="string">"://www.example.com/"</span>),
            <span class="prelude-val">Err</span>(URIReferenceError::SchemelessPathStartsWithColonSegment)
        );
    }
}
