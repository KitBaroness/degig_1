...
<span class="kw">use </span><span class="kw">crate</span>::scheme::Scheme;
<span class="kw">use </span><span class="kw">crate</span>::uri_reference::{URIReference, URIReferenceBuilder, URIReferenceError};

<span class="doccomment">/// A relative reference as defined in
...
</span><span class="kw">pub struct </span>RelativeReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// All relative references are also URI references, so we just maintain a [`URIReference`]
    /// underneath.
    </span>uri_reference: URIReference&lt;<span class="lifetime">'uri</span>&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; RelativeReference&lt;<span class="lifetime">'uri</span>&gt; {
    ...
    <span class="doccomment">/// Returns the authority, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Constructs a default builder for a relative reference.
    ///
    ...
    /// ```
    </span><span class="kw">pub fn </span>builder&lt;<span class="lifetime">'new_uri</span>&gt;() -&gt; RelativeReferenceBuilder&lt;<span class="lifetime">'new_uri</span>&gt; {
        RelativeReferenceBuilder::new()
    }

    <span class="doccomment">/// Constructs a new [`RelativeReference`] from the individual parts: authority, path, query,
    /// and fragment.
    ///
    ...
    ) -&gt; <span class="prelude-ty">Result</span>&lt;RelativeReference&lt;<span class="lifetime">'new_uri</span>&gt;, RelativeReferenceError&gt;
    <span class="kw">where
        </span>Authority&lt;<span class="lifetime">'new_uri</span>&gt;: TryFrom&lt;TAuthority, Error = TAuthorityError&gt;,
            ...
            From&lt;TAuthorityError&gt; + From&lt;TPathError&gt; + From&lt;TQueryError&gt; + From&lt;TFragmentError&gt;,
    {
        <span class="kw">let </span>uri_reference =
            URIReference::from_parts(<span class="prelude-val">None</span>::&lt;Scheme&gt;, authority, path, query, fragment)
                .map_err(|error| RelativeReferenceError::try_from(error).unwrap())<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(RelativeReference { uri_reference })
    }

    <span class="doccomment">/// Returns the fragment, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has an authority component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has a fragment component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has a password component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has a port.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has a query component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns whether the relative reference has a username component.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the host, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Consumes the relative reference and converts it into a builder with the same values.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    </span><span class="kw">pub fn </span>into_builder(<span class="self">self</span>) -&gt; RelativeReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
        <span class="kw">let </span>(<span class="kw">_</span>, authority, path, query, fragment) = <span class="self">self</span>.uri_reference.into_parts();
        <span class="kw">let </span><span class="kw-2">mut </span>builder = RelativeReferenceBuilder::new();
    ...
    <span class="doccomment">/// Converts the [`RelativeReference`] into an owned copy.
    ///
    ...
    </span><span class="kw">pub fn </span>into_owned(<span class="self">self</span>) -&gt; RelativeReference&lt;<span class="lifetime">'static</span>&gt; {
        RelativeReference {
            uri_reference: <span class="self">self</span>.uri_reference.into_owned(),
        }
    }

    <span class="doccomment">/// Consumes the [`RelativeReference`] and returns its parts: authority, path, query, and
    /// fragment.
    ///
    /// # Examples
    ///
    ...
    <span class="doccomment">/// Returns whether the relative reference is an absolute path reference.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.uri_reference.is_absolute_path_reference()
    }

    <span class="doccomment">/// Returns whether the relative reference is a network path reference.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.uri_reference.is_network_path_reference()
    }

    <span class="doccomment">/// Returns whether the relative reference is normalized.
    ///
    ...
    <span class="doccomment">/// Returns whether the relative reference is a relative path reference.
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.uri_reference.is_relative_path_reference()
    }
    ...
    <span class="doccomment">/// Normalizes the relative reference.
    ///
    /// A normalized relative reference will have all of its components normalized.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Returns the path of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the password, if present, of the relative reference.
    ///
    ...
    <span class="doccomment">/// Returns the port, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Returns the query, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
    ...
    <span class="doccomment">/// Sets the authority of the relative reference.
    ///
    ...
    /// ```
        ...
        authority: <span class="prelude-ty">Option</span>&lt;TAuthority&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Authority&lt;<span class="lifetime">'uri</span>&gt;&gt;, RelativeReferenceError&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Sets the fragment of the relative reference.
    ///
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        fragment: <span class="prelude-ty">Option</span>&lt;TFragment&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Fragment&lt;<span class="lifetime">'uri</span>&gt;&gt;, RelativeReferenceError&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Sets the path of the relative reference.
    ///
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        path: TPath,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw-2">&amp;</span>Path&lt;<span class="lifetime">'uri</span>&gt;, RelativeReferenceError&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Sets the query of the relative reference.
    ///
    ...
    /// ```
        ...
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        query: <span class="prelude-ty">Option</span>&lt;TQuery&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Query&lt;<span class="lifetime">'uri</span>&gt;&gt;, RelativeReferenceError&gt;
    <span class="kw">where
    ...
    <span class="doccomment">/// Returns a new relative reference which is identical but has a lifetime tied to this relative
    /// reference.
    ///
    /// This function will perform a memory allocation.
    </span><span class="kw">pub fn </span>to_borrowed(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; RelativeReference {
        RelativeReference {
            uri_reference: <span class="self">self</span>.uri_reference.to_borrowed(),
        }
    }

    <span class="doccomment">/// Returns the username, if present, of the relative reference.
    ///
    /// # Examples
    ///
    /// ```
...
<span class="kw">impl </span>Display <span class="kw">for </span>RelativeReference&lt;<span class="lifetime">'_</span>&gt; {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; From&lt;RelativeReference&lt;<span class="lifetime">'uri</span>&gt;&gt; <span class="kw">for </span>String {
    <span class="kw">fn </span>from(value: RelativeReference&lt;<span class="lifetime">'uri</span>&gt;) -&gt; <span class="self">Self </span>{
        value.to_string()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; From&lt;RelativeReference&lt;<span class="lifetime">'uri</span>&gt;&gt; <span class="kw">for </span>URIReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">fn </span>from(value: RelativeReference&lt;<span class="lifetime">'uri</span>&gt;) -&gt; <span class="self">Self </span>{
        value.uri_reference
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'uri </span>[u8]&gt; <span class="kw">for </span>RelativeReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">type </span>Error = RelativeReferenceError;
    ...
    <span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span><span class="lifetime">'uri </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        <span class="kw">let </span>uri_reference = URIReference::try_from(value)
            .map_err(|error| RelativeReferenceError::try_from(error).unwrap())<span class="question-mark">?</span>;

        <span class="kw">if </span>uri_reference.is_uri() {
            <span class="prelude-val">Err</span>(RelativeReferenceError::NotRelativeReference)
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; TryFrom&lt;<span class="kw-2">&amp;</span><span class="lifetime">'uri </span>str&gt; <span class="kw">for </span>RelativeReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">type </span>Error = RelativeReferenceError;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; TryFrom&lt;URIReference&lt;<span class="lifetime">'uri</span>&gt;&gt; <span class="kw">for </span>RelativeReference&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="kw">type </span>Error = RelativeReferenceError;
    ...
    <span class="kw">fn </span>try_from(value: URIReference&lt;<span class="lifetime">'uri</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        <span class="kw">if </span>value.is_relative_reference() {
            <span class="prelude-val">Ok</span>(RelativeReference {
                uri_reference: value,
            })
        } <span class="kw">else </span>{
            <span class="prelude-val">Err</span>(RelativeReferenceError::NotRelativeReference)
...
<span class="doccomment">/// A builder type for [`RelativeReference]`.
///
...
</span><span class="kw">pub struct </span>RelativeReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// All relative references are also URI references, so we just maintain a
    /// [`URIReferenceBuilder`] underneath.
    </span>uri_reference_builder: URIReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'uri</span>&gt; RelativeReferenceBuilder&lt;<span class="lifetime">'uri</span>&gt; {
    <span class="doccomment">/// Sets the authority part of the relative reference.
    ///
    ...
    <span class="doccomment">/// Consumes the builder and tries to build a [`RelativeReference`].
    ///
    ...
    /// assert!(result.is_err());
    /// ```
    </span><span class="kw">pub fn </span>build(<span class="self">self</span>) -&gt; <span class="prelude-ty">Result</span>&lt;RelativeReference&lt;<span class="lifetime">'uri</span>&gt;, RelativeReferenceError&gt; {
        <span class="prelude-val">Ok</span>(RelativeReference {
            uri_reference: <span class="self">self
    ...
    <span class="doccomment">/// Sets the fragment part of the relative reference.
    ///
    ...
    <span class="doccomment">/// Sets the path part of the relative reference.
    ///
    ...
    <span class="doccomment">/// Sets the query part of the relative reference.
    ///
    ...
    <span class="doccomment">/// Consumes the builder and sets the authority part of the relative reference.
    ///
    /// It is optional to specify an authority.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Consumes the builder and sets the fragment part of the relative reference.
    ///
    /// It is optional to specify a fragment.
    ///
    /// # Examples
    ...
    <span class="doccomment">/// Consumes the builder and sets the path part of the relative reference.
    ///
    /// It is required to specify a path. Not doing so will result in an error during the
    /// [`RelativeReferenceBuilder::build`] function.
    ///
    ...
    <span class="doccomment">/// Consumes the builder and sets the query part of the relative reference.
    ///
    /// It is optional to specify a query.
    ///
    /// # Examples
...
<span class="doccomment">/// An error representing an invalid relative reference.
</span><span class="attr">#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
#[non_exhaustive]
</span><span class="kw">pub enum </span>RelativeReferenceError {
    <span class="doccomment">/// Represents the case where there is no authority, but the first path segment starts with
    ...
    <span class="doccomment">/// When parsing from some byte string source, if the source ends up being a URI, then it is
    /// obviously not a relative reference.
    ///
    /// This can only occur when parsing from a byte string source.
    </span>NotRelativeReference,

    <span class="doccomment">/// Represents the case where the first path segment contains a `':'`. This is not allowed
...
<span class="kw">impl </span>Display <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>Formatter) -&gt; fmt::Result {
        <span class="kw">use </span><span class="self">self</span>::RelativeReferenceError::<span class="kw-2">*</span>;

        <span class="kw">match </span><span class="self">self </span>{
            AbsolutePathStartsWithTwoSlashes =&gt; {
                <span class="macro">write!</span>(formatter, <span class="string">"absolute path starts with two slashes"</span>)
            }
            Authority(error) =&gt; error.fmt(formatter),
            Fragment(error) =&gt; error.fmt(formatter),
            NotRelativeReference =&gt; <span class="macro">write!</span>(formatter, <span class="string">"not relative reference"</span>),
            ...
            SchemelessPathStartsWithColonSegment =&gt; <span class="macro">write!</span>(
                formatter,
                <span class="string">"relative reference schemeless path starts with colon segment"
            </span>),
        }
    }
}

<span class="kw">impl </span>Error <span class="kw">for </span>RelativeReferenceError {}

<span class="kw">impl </span>From&lt;Infallible&gt; <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>from(<span class="kw">_</span>: Infallible) -&gt; <span class="self">Self </span>{
        RelativeReferenceError::MissingPath
    }
}

<span class="kw">impl </span>From&lt;AuthorityError&gt; <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>from(value: AuthorityError) -&gt; <span class="self">Self </span>{
        RelativeReferenceError::Authority(value)
    }
}

<span class="kw">impl </span>From&lt;FragmentError&gt; <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>from(value: FragmentError) -&gt; <span class="self">Self </span>{
        RelativeReferenceError::Fragment(value)
    }
}

<span class="kw">impl </span>From&lt;PathError&gt; <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>from(value: PathError) -&gt; <span class="self">Self </span>{
        RelativeReferenceError::Path(value)
    }
}

<span class="kw">impl </span>From&lt;QueryError&gt; <span class="kw">for </span>RelativeReferenceError {
    <span class="kw">fn </span>from(value: QueryError) -&gt; <span class="self">Self </span>{
        RelativeReferenceError::Query(value)
    }
}

<span class="kw">impl </span>TryFrom&lt;URIReferenceError&gt; <span class="kw">for </span>RelativeReferenceError {
    ...
    <span class="kw">fn </span>try_from(value: URIReferenceError) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="self">Self</span>, <span class="self">Self</span>::Error&gt; {
        ...
        <span class="kw">match </span>value {
            ...
            URIReferenceError::SchemelessPathStartsWithColonSegment =&gt; {
                <span class="prelude-val">Ok</span>(SchemelessPathStartsWithColonSegment)
            }
            URIReferenceError::Scheme(<span class="kw">_</span>) =&gt; <span class="prelude-val">Err</span>(()),
        }
    }
}
