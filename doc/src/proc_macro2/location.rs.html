...
<span class="doccomment">/// A line-column pair representing the start or end of a `Span`.
///
/// This type is semver exempt and not exposed by default.
</span><span class="attr">#[cfg_attr(doc_cfg, doc(cfg(feature = <span class="string">"span-locations"</span>)))]
#[derive(Copy, Clone, Debug, PartialEq, Eq, Hash)]
</span><span class="kw">pub struct </span>LineColumn {
    <span class="doccomment">/// The 1-indexed line in the source file on which the span starts or ends
    /// (inclusive).
    </span><span class="kw">pub </span>line: usize,
    <span class="doccomment">/// The 0-indexed column (in UTF-8 characters) in the source file on which
    /// the span starts or ends (inclusive).
    </span><span class="kw">pub </span>column: usize,
}

<span class="kw">impl </span>Ord <span class="kw">for </span>LineColumn {
    <span class="kw">fn </span>cmp(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span><span class="self">Self</span>) -&gt; Ordering {
        <span class="self">self</span>.line
            .cmp(<span class="kw-2">&amp;</span>other.line)
            .then(<span class="self">self</span>.column.cmp(<span class="kw-2">&amp;</span>other.column))
    }
}

<span class="kw">impl </span>PartialOrd <span class="kw">for </span>LineColumn {
