...
<span class="kw">impl</span>&lt;T&gt; RcVec&lt;T&gt; {
    ...
    <span class="kw">pub fn </span>iter(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; slice::Iter&lt;T&gt; {
        <span class="self">self</span>.inner.iter()
    }

    <span class="kw">pub fn </span>make_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; RcVecMut&lt;T&gt;
    <span class="kw">where
        </span>T: Clone,
    {
        RcVecMut {
    ...
    <span class="kw">pub fn </span>get_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;RcVecMut&lt;T&gt;&gt; {
    ...
    <span class="kw">pub fn </span>make_owned(<span class="kw-2">mut </span><span class="self">self</span>) -&gt; RcVecBuilder&lt;T&gt;
    <span class="kw">where
        </span>T: Clone,
    {
...
<span class="kw">impl</span>&lt;T&gt; RcVecBuilder&lt;T&gt; {
    ...
    <span class="kw">pub fn </span>push(<span class="kw-2">&amp;mut </span><span class="self">self</span>, element: T) {
        <span class="self">self</span>.inner.push(element);
    }

    <span class="kw">pub fn </span>extend(<span class="kw-2">&amp;mut </span><span class="self">self</span>, iter: <span class="kw">impl </span>IntoIterator&lt;Item = T&gt;) {
        <span class="self">self</span>.inner.extend(iter);
    }

    <span class="kw">pub fn </span>as_mut(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; RcVecMut&lt;T&gt; {
        RcVecMut {
            inner: <span class="kw-2">&amp;mut </span><span class="self">self</span>.inner,
        }
    }

    <span class="kw">pub fn </span>build(<span class="self">self</span>) -&gt; RcVec&lt;T&gt; {
        RcVec {
