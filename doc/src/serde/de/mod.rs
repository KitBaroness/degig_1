...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>size_hint;
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>&gt; fmt::Display <span class="kw">for </span>Unexpected&lt;<span class="lifetime">'a</span>&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        ...
        <span class="kw">match </span><span class="kw-2">*</span><span class="self">self </span>{
            ...
            Float(f) =&gt; <span class="macro">write!</span>(formatter, <span class="string">"floating point `{}`"</span>, WithDecimalPoint(f)),
            ...
            Bytes(<span class="kw">_</span>) =&gt; formatter.write_str(<span class="string">"byte array"</span>),
            Unit =&gt; formatter.write_str(<span class="string">"unit value"</span>),
            <span class="prelude-ty">Option </span>=&gt; formatter.write_str(<span class="string">"Option value"</span>),
            NewtypeStruct =&gt; formatter.write_str(<span class="string">"newtype struct"</span>),
            Seq =&gt; formatter.write_str(<span class="string">"sequence"</span>),
            Map =&gt; formatter.write_str(<span class="string">"map"</span>),
            Enum =&gt; formatter.write_str(<span class="string">"enum"</span>),
            UnitVariant =&gt; formatter.write_str(<span class="string">"unit variant"</span>),
            NewtypeVariant =&gt; formatter.write_str(<span class="string">"newtype variant"</span>),
            TupleVariant =&gt; formatter.write_str(<span class="string">"tuple variant"</span>),
            StructVariant =&gt; formatter.write_str(<span class="string">"struct variant"</span>),
...
/// [Understanding deserializer lifetimes]: https://serde.rs/lifetimes.html
        ...
        </span>D: Deserializer&lt;<span class="lifetime">'de</span>&gt;,
    {
        ...
        </span><span class="kw-2">*</span>place = <span class="macro">tri!</span>(Deserialize::deserialize(deserializer));
...
/// [example data format]: https://serde.rs/data-format.html
    ...
    #[doc(hidden)]
        ...
        <span class="self">self</span>,
        <span class="kw">_</span>: <span class="kw">crate</span>::actually_private::T,
        visitor: V,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="kw">crate</span>::__private::de::Content&lt;<span class="lifetime">'de</span>&gt;, <span class="self">Self</span>::Error&gt;
    <span class="kw">where
        </span>V: Visitor&lt;<span class="lifetime">'de</span>, Value = <span class="kw">crate</span>::__private::de::Content&lt;<span class="lifetime">'de</span>&gt;&gt;,
    {
...
/// ```
        ...
        </span>E: Error,
    {
        ...
        <span class="prelude-val">Err</span>(Error::invalid_type(
    ...
    {
        <span class="self">self</span>.visit_str(v.encode_utf8(<span class="kw-2">&amp;mut </span>[<span class="number">0u8</span>; <span class="number">4</span>]))
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, <span class="lifetime">'a</span>, A&gt; SeqAccess&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>A
<span class="kw">where
    </span>A: <span class="question-mark">?</span>Sized + SeqAccess&lt;<span class="lifetime">'de</span>&gt;,
{
...
/// [example data format]: https://serde.rs/data-format.html
    ...
    {
        <span class="kw">match </span><span class="macro">tri!</span>(<span class="self">self</span>.next_key_seed(kseed)) {
            <span class="prelude-val">Some</span>(key) =&gt; {
                <span class="kw">let </span>value = <span class="macro">tri!</span>(<span class="self">self</span>.next_value_seed(vseed));
...
<span class="kw">impl</span>&lt;<span class="lifetime">'de</span>, <span class="lifetime">'a</span>, A&gt; MapAccess&lt;<span class="lifetime">'de</span>&gt; <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>A
<span class="kw">where
    </span>A: <span class="question-mark">?</span>Sized + MapAccess&lt;<span class="lifetime">'de</span>&gt;,
{
    <span class="kw">type </span>Error = A::Error;
    ...
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        <span class="kw">match </span><span class="self">self</span>.names.len() {
            ...
            <span class="kw">_ </span>=&gt; {
                <span class="macro">tri!</span>(formatter.write_str(<span class="string">"one of "</span>));
                <span class="kw">for </span>(i, alt) <span class="kw">in </span><span class="self">self</span>.names.iter().enumerate() {
                    <span class="kw">if </span>i &gt; <span class="number">0 </span>{
                        <span class="macro">tri!</span>(formatter.write_str(<span class="string">", "</span>));
                    }
                    <span class="macro">tri!</span>(<span class="macro">write!</span>(formatter, <span class="string">"`{}`"</span>, alt));
                }
                <span class="prelude-val">Ok</span>(())
            }
        }
...
<span class="kw">struct </span>WithDecimalPoint(f64);

<span class="kw">impl </span>Display <span class="kw">for </span>WithDecimalPoint {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, formatter: <span class="kw-2">&amp;mut </span>fmt::Formatter) -&gt; fmt::Result {
        <span class="kw">struct </span>LookForDecimalPoint&lt;<span class="lifetime">'f</span>, <span class="lifetime">'a</span>&gt; {
            formatter: <span class="kw-2">&amp;</span><span class="lifetime">'f </span><span class="kw-2">mut </span>fmt::Formatter&lt;<span class="lifetime">'a</span>&gt;,
            has_decimal_point: bool,
        }

        <span class="kw">impl</span>&lt;<span class="lifetime">'f</span>, <span class="lifetime">'a</span>&gt; fmt::Write <span class="kw">for </span>LookForDecimalPoint&lt;<span class="lifetime">'f</span>, <span class="lifetime">'a</span>&gt; {
            <span class="kw">fn </span>write_str(<span class="kw-2">&amp;mut </span><span class="self">self</span>, fragment: <span class="kw-2">&amp;</span>str) -&gt; fmt::Result {
                <span class="self">self</span>.has_decimal_point |= fragment.contains(<span class="string">'.'</span>);
                <span class="self">self</span>.formatter.write_str(fragment)
            }

            <span class="kw">fn </span>write_char(<span class="kw-2">&amp;mut </span><span class="self">self</span>, ch: char) -&gt; fmt::Result {
                <span class="self">self</span>.has_decimal_point |= ch == <span class="string">'.'</span>;
                <span class="self">self</span>.formatter.write_char(ch)
            }
        }

        <span class="kw">let </span><span class="kw-2">mut </span>writer = LookForDecimalPoint {
            formatter,
            has_decimal_point: <span class="bool-val">false</span>,
        };
        <span class="macro">tri!</span>(<span class="macro">write!</span>(writer, <span class="string">"{}"</span>, <span class="self">self</span>.<span class="number">0</span>));
        <span class="kw">if </span>!writer.has_decimal_point {
            <span class="macro">tri!</span>(formatter.write_str(<span class="string">".0"</span>));
        }
        <span class="prelude-val">Ok</span>(())
    }
}
