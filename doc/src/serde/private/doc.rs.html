...
</pre></div><pre class="rust"><code><span class="comment">// Used only by Serde doc tests. Not public API.
...
#[macro_export]
    ...
    (<span class="macro-nonterminal">$func</span>:ident $(&lt;<span class="macro-nonterminal">$t</span>:ident&gt;)* ($(<span class="macro-nonterminal">$arg</span>:ty),<span class="kw-2">*</span>) -&gt; <span class="macro-nonterminal">$ret</span>:ident) =&gt; {
        <span class="kw">fn </span><span class="macro-nonterminal">$func </span>$(&lt;<span class="macro-nonterminal">$t</span>&gt;)* (<span class="self">self </span>$(, <span class="kw">_</span>: <span class="macro-nonterminal">$arg</span>)<span class="kw-2">*</span>) -&gt; <span class="macro-nonterminal">$crate::__private::Result</span>&lt;<span class="self">Self</span>::<span class="macro-nonterminal">$ret</span>, <span class="self">Self</span>::Error&gt;
        <span class="kw">where
            </span>$(<span class="macro-nonterminal">$t</span>: <span class="question-mark">?</span>Sized + <span class="macro-nonterminal">$crate::Serialize</span>,)*
        {
            <span class="macro">unimplemented!</span>()
        }
    };
