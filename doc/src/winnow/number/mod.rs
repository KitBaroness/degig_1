...
</pre></div><pre class="rust"><code><span class="doccomment">//! Parsers recognizing numbers

</span><span class="attr">#![allow(clippy::match_same_arms)]

#[cfg(test)]
</span><span class="kw">mod </span>tests;

<span class="kw">use </span><span class="kw">crate</span>::bytes::take;
<span class="kw">use </span><span class="kw">crate</span>::error::ErrMode;
<span class="kw">use </span><span class="kw">crate</span>::error::ErrorKind;
<span class="kw">use </span><span class="kw">crate</span>::error::Needed;
...
<span class="kw">use </span><span class="kw">crate</span>::stream::{AsBytes, Stream, StreamIsPartial};
...
<span class="doccomment">/// Configurable endianness
    ...
    <span class="doccomment">/// Will match the host's endianness
    </span>Native,
}

<span class="doccomment">/// Recognizes an unsigned 1 byte integer.
///
...
</span><span class="kw">pub fn </span>be_u8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u8, E&gt;
<span class="kw">where
...
<span class="doccomment">/// Recognizes a big endian unsigned 2 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_u16&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_u16"</span>, <span class="kw">move </span>|input: I| be_uint(input, <span class="number">2</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian unsigned 3 byte integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_u24&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_u23"</span>, <span class="kw">move </span>|input: I| be_uint(input, <span class="number">3</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian unsigned 4 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_u32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_u32"</span>, <span class="kw">move </span>|input: I| be_uint(input, <span class="number">4</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian unsigned 8 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_u64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_u64"</span>, <span class="kw">move </span>|input: I| be_uint(input, <span class="number">8</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian unsigned 16 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_u128&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_u128"</span>, <span class="kw">move </span>|input: I| be_uint(input, <span class="number">16</span>)).parse_next(input)
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>be_uint&lt;I, Uint, E: ParseError&lt;I&gt;&gt;(input: I, bound: usize) -&gt; IResult&lt;I, Uint, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
...
{
    <span class="macro">debug_assert_ne!</span>(bound, <span class="number">1</span>, <span class="string">"to_be_uint needs extra work to avoid overflow"</span>);
    take(bound)
        .map(|n: &lt;I <span class="kw">as </span>Stream&gt;::Slice| to_be_uint(n.as_bytes()))
        .parse_next(input)
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>to_be_uint&lt;Uint&gt;(number: <span class="kw-2">&amp;</span>[u8]) -&gt; Uint
<span class="kw">where
    </span>Uint: Default + Shl&lt;u8, Output = Uint&gt; + Add&lt;Uint, Output = Uint&gt; + From&lt;u8&gt;,
{
    <span class="kw">let </span><span class="kw-2">mut </span>res = Uint::default();
    <span class="kw">for </span>byte <span class="kw">in </span>number.iter().copied() {
        res = (res &lt;&lt; <span class="number">8</span>) + byte.into();
    }

    res
}

<span class="doccomment">/// Recognizes a signed 1 byte integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i8, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
{
...
<span class="doccomment">/// Recognizes a big endian signed 2 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i16&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_i16"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u16, <span class="kw">_</span>&gt;(input, <span class="number">2</span>).map(|(i, n)| (i, n <span class="kw">as </span>i16))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian signed 3 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i24&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_i24"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">3</span>).map(|(i, n)| {
            <span class="comment">// Same as the unsigned version but we need to sign-extend manually here
            </span><span class="kw">let </span>n = <span class="kw">if </span>n &amp; <span class="number">0x80_00_00 </span>!= <span class="number">0 </span>{
                (n | <span class="number">0xff_00_00_00</span>) <span class="kw">as </span>i32
...
<span class="doccomment">/// Recognizes a big endian signed 4 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_i32"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">4</span>).map(|(i, n)| (i, n <span class="kw">as </span>i32))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian signed 8 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_i64"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u64, <span class="kw">_</span>&gt;(input, <span class="number">8</span>).map(|(i, n)| (i, n <span class="kw">as </span>i64))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian signed 16 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_i128&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_i128"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u128, <span class="kw">_</span>&gt;(input, <span class="number">16</span>).map(|(i, n)| (i, n <span class="kw">as </span>i128))
    })
    .parse_next(input)
}
...
</span><span class="kw">pub fn </span>le_u8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u8, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
{
...
<span class="doccomment">/// Recognizes a little endian unsigned 2 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_u16&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_u16"</span>, <span class="kw">move </span>|input: I| le_uint(input, <span class="number">2</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian unsigned 3 byte integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_u24&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_u24"</span>, <span class="kw">move </span>|input: I| le_uint(input, <span class="number">3</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian unsigned 4 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_u32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_u32"</span>, <span class="kw">move </span>|input: I| le_uint(input, <span class="number">4</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian unsigned 8 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_u64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_u64"</span>, <span class="kw">move </span>|input: I| le_uint(input, <span class="number">8</span>)).parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian unsigned 16 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_u128&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_u128"</span>, <span class="kw">move </span>|input: I| le_uint(input, <span class="number">16</span>)).parse_next(input)
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>le_uint&lt;I, Uint, E: ParseError&lt;I&gt;&gt;(input: I, bound: usize) -&gt; IResult&lt;I, Uint, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
...
{
    take(bound)
        .map(|n: &lt;I <span class="kw">as </span>Stream&gt;::Slice| to_le_uint(n.as_bytes()))
        .parse_next(input)
}

<span class="attr">#[inline]
</span><span class="kw">fn </span>to_le_uint&lt;Uint&gt;(number: <span class="kw-2">&amp;</span>[u8]) -&gt; Uint
<span class="kw">where
    </span>Uint: Default + Shl&lt;u8, Output = Uint&gt; + Add&lt;Uint, Output = Uint&gt; + From&lt;u8&gt;,
{
    <span class="kw">let </span><span class="kw-2">mut </span>res = Uint::default();
    <span class="kw">for </span>(index, byte) <span class="kw">in </span>number.iter_offsets() {
        res = res + (Uint::from(byte) &lt;&lt; (<span class="number">8 </span>* index <span class="kw">as </span>u8));
    }
...
</span><span class="kw">pub fn </span>le_i8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i8, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
{
...
<span class="doccomment">/// Recognizes a little endian signed 2 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_i16&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_i16"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u16, <span class="kw">_</span>&gt;(input, <span class="number">2</span>).map(|(i, n)| (i, n <span class="kw">as </span>i16))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian signed 3 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_i24&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_i24"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">3</span>).map(|(i, n)| {
            <span class="comment">// Same as the unsigned version but we need to sign-extend manually here
            </span><span class="kw">let </span>n = <span class="kw">if </span>n &amp; <span class="number">0x80_00_00 </span>!= <span class="number">0 </span>{
                (n | <span class="number">0xff_00_00_00</span>) <span class="kw">as </span>i32
            } <span class="kw">else </span>{
...
<span class="doccomment">/// Recognizes a little endian signed 4 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_i32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_i32"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">4</span>).map(|(i, n)| (i, n <span class="kw">as </span>i32))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian signed 8 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_i64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_i64"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u64, <span class="kw">_</span>&gt;(input, <span class="number">8</span>).map(|(i, n)| (i, n <span class="kw">as </span>i64))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian signed 16 bytes integer.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_i128&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_i128"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u128, <span class="kw">_</span>&gt;(input, <span class="number">16</span>).map(|(i, n)| (i, n <span class="kw">as </span>i128))
    })
    .parse_next(input)
}
...
</span><span class="kw">pub fn </span>u8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u8, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
{
    trace(<span class="string">"u8"</span>, <span class="kw">move </span>|input: I| {
...
<span class="attr">#[inline]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>streaming_u8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u8, E&gt;
<span class="kw">where
    </span>I: Stream&lt;Token = u8&gt;,
{
    input
        .next_token()
        .ok_or_else(|| ErrMode::Incomplete(Needed::new(<span class="number">1</span>)))
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>complete_u8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, u8, E&gt;
<span class="kw">where
    </span>I: Stream&lt;Token = u8&gt;,
{
    input
...
<span class="doccomment">/// Recognizes an unsigned 2 bytes integer
///
...
</span><span class="kw">pub fn </span>u16&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, u16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_u16,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_u16,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_u16,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_u16,
        }
    }(input)
}

<span class="doccomment">/// Recognizes an unsigned 3 byte integer
///
...
</span><span class="kw">pub fn </span>u24&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_u24,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_u24,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_u24,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_u24,
        }
    }(input)
}

<span class="doccomment">/// Recognizes an unsigned 4 byte integer
///
...
</span><span class="kw">pub fn </span>u32&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, u32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_u32,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_u32,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_u32,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_u32,
        }
    }(input)
}

<span class="doccomment">/// Recognizes an unsigned 8 byte integer
///
...
</span><span class="kw">pub fn </span>u64&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, u64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_u64,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_u64,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_u64,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_u64,
        }
    }(input)
}

<span class="doccomment">/// Recognizes an unsigned 16 byte integer
///
...
</span><span class="kw">pub fn </span>u128&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, u128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_u128,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_u128,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_u128,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_u128,
        }
    }(input)
}
...
</span><span class="kw">pub fn </span>i8&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, i8, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
{
    trace(<span class="string">"i8"</span>, <span class="kw">move </span>|input: I| {
        <span class="kw">if </span>input.is_partial() {
            streaming_u8(input)
        } <span class="kw">else </span>{
            complete_u8(input)
        }
        .map(|(i, n)| (i, n <span class="kw">as </span>i8))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a signed 2 byte integer
///
...
</span><span class="kw">pub fn </span>i16&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, i16, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_i16,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_i16,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_i16,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_i16,
        }
    }(input)
}

<span class="doccomment">/// Recognizes a signed 3 byte integer
///
...
</span><span class="kw">pub fn </span>i24&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_i24,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_i24,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_i24,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_i24,
        }
    }(input)
}

<span class="doccomment">/// Recognizes a signed 4 byte integer
///
...
</span><span class="kw">pub fn </span>i32&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, i32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_i32,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_i32,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_i32,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_i32,
        }
    }(input)
}

<span class="doccomment">/// Recognizes a signed 8 byte integer
///
...
</span><span class="kw">pub fn </span>i64&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, i64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_i64,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_i64,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_i64,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_i64,
        }
    }(input)
}

<span class="doccomment">/// Recognizes a signed 16 byte integer
///
...
</span><span class="kw">pub fn </span>i128&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, i128, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_i128,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_i128,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_i128,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_i128,
        }
    }(input)
}

<span class="doccomment">/// Recognizes a big endian 4 bytes floating point number.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_f32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, f32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_f32"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">4</span>).map(|(i, n)| (i, f32::from_bits(n)))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a big endian 8 bytes floating point number.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>be_f64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, f64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_f64"</span>, <span class="kw">move </span>|input: I| {
        be_uint::&lt;<span class="kw">_</span>, u64, <span class="kw">_</span>&gt;(input, <span class="number">8</span>).map(|(i, n)| (i, f64::from_bits(n)))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian 4 bytes floating point number.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_f32&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, f32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"le_f32"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u32, <span class="kw">_</span>&gt;(input, <span class="number">4</span>).map(|(i, n)| (i, f32::from_bits(n)))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a little endian 8 bytes floating point number.
///
/// *Complete version*: Returns an error if there is not enough input data.
///
/// *Partial version*: Will return `Err(winnow::error::ErrMode::Incomplete(_))` if there is not enough data.
...
</span><span class="kw">pub fn </span>le_f64&lt;I, E: ParseError&lt;I&gt;&gt;(input: I) -&gt; IResult&lt;I, f64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    trace(<span class="string">"be_f64"</span>, <span class="kw">move </span>|input: I| {
        le_uint::&lt;<span class="kw">_</span>, u64, <span class="kw">_</span>&gt;(input, <span class="number">8</span>).map(|(i, n)| (i, f64::from_bits(n)))
    })
    .parse_next(input)
}

<span class="doccomment">/// Recognizes a 4 byte floating point number
///
...
</span><span class="kw">pub fn </span>f32&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, f32, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_f32,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_f32,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_f32,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_f32,
        }
    }(input)
}

<span class="doccomment">/// Recognizes an 8 byte floating point number
///
...
</span><span class="kw">pub fn </span>f64&lt;I, E: ParseError&lt;I&gt;&gt;(endian: <span class="kw">crate</span>::number::Endianness) -&gt; <span class="kw">impl </span>Parser&lt;I, f64, E&gt;
<span class="kw">where
    </span>I: StreamIsPartial,
    I: Stream&lt;Token = u8&gt;,
    &lt;I <span class="kw">as </span>Stream&gt;::Slice: AsBytes,
{
    <span class="kw">move </span>|input: I| {
        <span class="kw">match </span>endian {
            <span class="kw">crate</span>::number::Endianness::Big =&gt; be_f64,
            <span class="kw">crate</span>::number::Endianness::Little =&gt; le_f64,
            <span class="attr">#[cfg(target_endian = <span class="string">"big"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; be_f64,
            <span class="attr">#[cfg(target_endian = <span class="string">"little"</span>)]
            </span><span class="kw">crate</span>::number::Endianness::Native =&gt; le_f64,
        }
    }(input)
}
