...
</pre></div><pre class="rust"><code><span class="doccomment">//! &gt; winnow, making parsing a breeze
//!
...
//! ```rust
//! # #[cfg(feature = "alloc")] {
</span><span class="attr">#![doc = <span class="macro">include_str!</span>(<span class="string">"../examples/css/parser.rs"</span>)]
...
#![deny(missing_docs)]
</span><span class="comment">// BEGIN - Embark standard lints v6 for Rust 1.55+
// do not change or add/remove here, but one can add exceptions after this section
// for more info see: &lt;https://github.com/EmbarkStudios/rust-ecosystem/issues/59&gt;
// "-Dunsafe_code",
</span><span class="attr">#![warn(clippy::all)]
...
</span><span class="comment">// END - Embark standard lints v6 for Rust 1.55+
</span><span class="attr">#![allow(clippy::branches_sharing_code)]
...
/// it, albeit there it is not public.
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>lib {
    ...
    /// as well as `core` or `std`
        ...
        #[doc(hidden)]
        </span><span class="kw">pub use </span>alloc::{borrow, boxed, collections, string, vec};

        <span class="attr">#[doc(hidden)]
        </span><span class="kw">pub use </span>core::{cmp, convert, fmt, hash, iter, mem, ops, option, result, slice, str};
...
<span class="kw">pub mod </span>branch;
...
<span class="kw">pub mod </span>trace;

<span class="attr">#[cfg(feature = <span class="string">"unstable-doc"</span>)]
</span><span class="kw">pub mod </span>_topic;
<span class="attr">#[cfg(feature = <span class="string">"unstable-doc"</span>)]
</span><span class="kw">pub mod </span>_tutorial;

<span class="doccomment">/// Core concepts available for glob import
///
/// Including
/// - [`FinishIResult`]
/// - [`Parser`]
...
/// ```
    ...
    <span class="kw">pub use </span><span class="kw">crate</span>::stream::StreamIsPartial <span class="kw">as _</span>;
    <span class="attr">#[allow(deprecated)]
    </span><span class="kw">pub use </span><span class="kw">crate</span>::FinishIResult <span class="kw">as _</span>;
    <span class="kw">pub use </span><span class="kw">crate</span>::IResult;
    <span class="kw">pub use </span><span class="kw">crate</span>::Parser;
}

<span class="attr">#[allow(deprecated)]
</span><span class="kw">pub use </span>error::FinishIResult;
<span class="kw">pub use </span>error::IResult;
<span class="kw">pub use </span>parser::<span class="kw-2">*</span>;
<span class="kw">pub use </span>stream::BStr;
<span class="kw">pub use </span>stream::Bytes;
<span class="kw">pub use </span>stream::Located;
<span class="kw">pub use </span>stream::Partial;
<span class="kw">pub use </span>stream::Stateful;
<span class="kw">pub use </span>stream::Str;
