...
</pre></div><pre class="rust"><code><span class="doccomment">//! Choice combinators
...
</span><span class="kw">pub use </span><span class="kw">crate</span>::dispatch;
...
<span class="doccomment">/// Pick the first successful parser
///
...
/// # }
/// ```
</span><span class="attr">#[doc(alias = <span class="string">"choice"</span>)]
</span><span class="kw">pub fn </span>alt&lt;I: Stream, O, E: ParseError&lt;I&gt;, List: Alt&lt;I, O, E&gt;&gt;(
    <span class="kw-2">mut </span>l: List,
) -&gt; <span class="kw">impl </span>Parser&lt;I, O, E&gt; {
    trace(<span class="string">"alt"</span>, <span class="kw">move </span>|i: I| l.choice(i))
}
...
/// ```
///
</span><span class="kw">pub fn </span>permutation&lt;I: Stream, O, E: ParseError&lt;I&gt;, List: Permutation&lt;I, O, E&gt;&gt;(
    <span class="kw-2">mut </span>l: List,
) -&gt; <span class="kw">impl </span>Parser&lt;I, O, E&gt; {
    trace(<span class="string">"permutation"</span>, <span class="kw">move </span>|i: I| l.permutation(i))
}
...
<span class="macro">macro_rules!</span> alt_trait_impl(
  ($(<span class="macro-nonterminal">$id</span>:ident)+) =&gt; (
    <span class="kw">impl</span>&lt;
      ...
      $(<span class="macro-nonterminal">$id</span>: Parser&lt;I, Output, Error&gt;),+
    &gt; Alt&lt;I, Output, Error&gt; <span class="kw">for </span>( $(<span class="macro-nonterminal">$id</span>),+ ) {

      <span class="kw">fn </span>choice(<span class="kw-2">&amp;mut </span><span class="self">self</span>, input: I) -&gt; IResult&lt;I, Output, Error&gt; {
        <span class="kw">match </span><span class="self">self</span>.<span class="number">0</span>.parse_next(input.clone()) {
          <span class="prelude-val">Err</span>(ErrMode::Backtrack(e)) =&gt; <span class="macro">alt_trait_inner!</span>(<span class="number">1</span>, <span class="self">self</span>, input, e, $(<span class="macro-nonterminal">$id</span>)+),
          res =&gt; res,
        }
      }
    }
...
<span class="macro">macro_rules!</span> alt_trait_inner(
  (<span class="macro-nonterminal">$it</span>:tt, <span class="macro-nonterminal">$self</span>:expr, <span class="macro-nonterminal">$input</span>:expr, <span class="macro-nonterminal">$err</span>:expr, <span class="macro-nonterminal">$head</span>:ident $(<span class="macro-nonterminal">$id</span>:ident)+) =&gt; (
    <span class="kw">match </span><span class="macro-nonterminal">$self</span>.<span class="macro-nonterminal">$it</span>.parse_next(<span class="macro-nonterminal">$input</span>.clone()) {
  ...
  (<span class="macro-nonterminal">$it</span>:tt, <span class="macro-nonterminal">$self</span>:expr, <span class="macro-nonterminal">$input</span>:expr, <span class="macro-nonterminal">$err</span>:expr, <span class="macro-nonterminal">$head</span>:ident) =&gt; (
    <span class="prelude-val">Err</span>(ErrMode::Backtrack(<span class="macro-nonterminal">$err</span>.append(<span class="macro-nonterminal">$input</span>, ErrorKind::Alt)))
  );
);

<span class="macro">alt_trait!</span>(Alt2 Alt3 Alt4 Alt5 Alt6 Alt7 Alt8 Alt9 Alt10 Alt11 Alt12 Alt13 Alt14 Alt15 Alt16 Alt17 Alt18 Alt19 Alt20 Alt21 Alt22);

<span class="comment">// Manually implement Alt for (A,), the 1-tuple type
</span><span class="kw">impl</span>&lt;I, O, E: ParseError&lt;I&gt;, A: Parser&lt;I, O, E&gt;&gt; Alt&lt;I, O, E&gt; <span class="kw">for </span>(A,) {
    <span class="kw">fn </span>choice(<span class="kw-2">&amp;mut </span><span class="self">self</span>, input: I) -&gt; IResult&lt;I, O, E&gt; {
        <span class="self">self</span>.<span class="number">0</span>.parse_next(input)
    }
}
...
<span class="macro">macro_rules!</span> permutation_trait_impl(
  ($(<span class="macro-nonterminal">$name</span>:ident <span class="macro-nonterminal">$ty</span>:ident <span class="macro-nonterminal">$item</span>:ident),+) =&gt; (
    <span class="kw">impl</span>&lt;
      I: Clone, $(<span class="macro-nonterminal">$ty</span>),+ , Error: ParseError&lt;I&gt;,
      $(<span class="macro-nonterminal">$name</span>: Parser&lt;I, <span class="macro-nonterminal">$ty</span>, Error&gt;),+
    &gt; Permutation&lt;I, ( $(<span class="macro-nonterminal">$ty</span>),+ ), Error&gt; <span class="kw">for </span>( $(<span class="macro-nonterminal">$name</span>),+ ) {

      <span class="kw">fn </span>permutation(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>input: I) -&gt; IResult&lt;I, ( $(<span class="macro-nonterminal">$ty</span>),+ ), Error&gt; {
        ...
        <span class="kw">loop </span>{
          ...
          // or errored on the remaining input
            ...
            </span><span class="kw">return </span><span class="prelude-val">Err</span>(ErrMode::Backtrack(err.append(input, ErrorKind::Alt)));
          }
