...
</pre></div><pre class="rust"><code><span class="comment">// We *mostly* avoid unsafe code, but `map::core::raw` allows it to use `RawTable` buckets.
