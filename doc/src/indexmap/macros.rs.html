...
#[macro_export]
</span><span class="doccomment">/// Create an [`IndexMap`][crate::IndexMap] from a list of key-value pairs
///
/// ## Example
///
/// ```
...
/// ```
    ...
    ($(<span class="macro-nonterminal">$key</span>:expr =&gt; <span class="macro-nonterminal">$value</span>:expr),<span class="kw-2">*</span>) =&gt; {
        {
            <span class="comment">// Note: `stringify!($key)` is just here to consume the repetition,
            // but we throw away that string literal during constant evaluation.
            </span><span class="kw">const </span>CAP: usize = &lt;[()]&gt;::len(<span class="kw-2">&amp;</span>[$({ <span class="macro">stringify!</span>(<span class="macro-nonterminal">$key</span>); }),<span class="kw-2">*</span>]);
            <span class="kw">let </span><span class="kw-2">mut </span>map = <span class="macro-nonterminal">$crate::IndexMap::with_capacity</span>(CAP);
            $(
...
#[cfg_attr(docsrs, doc(cfg(feature = <span class="string">"std"</span>)))]
#[macro_export]
</span><span class="doccomment">/// Create an [`IndexSet`][crate::IndexSet] from a list of values
///
/// ## Example
///
/// ```
...
/// ```
    ...
    ($(<span class="macro-nonterminal">$value</span>:expr),<span class="kw-2">*</span>) =&gt; {
        {
            <span class="comment">// Note: `stringify!($value)` is just here to consume the repetition,
            // but we throw away that string literal during constant evaluation.
            </span><span class="kw">const </span>CAP: usize = &lt;[()]&gt;::len(<span class="kw-2">&amp;</span>[$({ <span class="macro">stringify!</span>(<span class="macro-nonterminal">$value</span>); }),<span class="kw-2">*</span>]);
            <span class="kw">let </span><span class="kw-2">mut </span>set = <span class="macro-nonterminal">$crate::IndexSet::with_capacity</span>(CAP);
            $(
                set.insert(<span class="macro-nonterminal">$value</span>);
            )*
            set
        }
    };
...
</span><span class="attr">#[cfg(any(feature = <span class="string">"rayon"</span>, feature = <span class="string">"rustc-rayon"</span>))]
