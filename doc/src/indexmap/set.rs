...
</pre></div><pre class="rust"><code><span class="doccomment">//! A hash set implemented using [`IndexMap`]
...
<span class="kw">pub use </span><span class="self">self</span>::mutable::MutableValues;
...
<span class="kw">impl</span>&lt;T, S&gt; IndexSet&lt;T, S&gt; {
    ...
    <span class="doccomment">/// Return the number of elements the set can hold without reallocating.
    ///
    ...
    {
        Drain::new(<span class="self">self</span>.map.core.drain(range))
    }
    ...
    <span class="doccomment">/// Reserve capacity for `additional` more values, without over-allocating.
    ///
    ...
    /// Computes in **O(n)** time.
        ...
        <span class="self">self</span>.map.reserve_exact(additional);
    }

    <span class="doccomment">/// Try to reserve capacity for `additional` more values.
    ///
    /// Computes in **O(n)** time.
    ...
    <span class="doccomment">/// Try to reserve capacity for `additional` more values, without over-allocating.
    ///
    ...
    /// Computes in **O(n)** time.
        ...
        <span class="self">self</span>.map.try_reserve_exact(additional)
    }
    ...
    S: BuildHasher,
{
    ...
    /// Computes in **O(1)** time (amortized average).
        ...
        <span class="kw">let </span>(index, existing) = <span class="self">self</span>.map.insert_full(value, ());
        (index, existing.is_none())
    }

    <span class="doccomment">/// Insert the value into the set at its ordered position among sorted values.
    ///
    ...
    </span><span class="kw">pub fn </span>insert_sorted(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: T) -&gt; (usize, bool)
    <span class="kw">where
        </span>T: Ord,
    {
        <span class="kw">let </span>(index, existing) = <span class="self">self</span>.map.insert_sorted(value, ());
        (index, existing.is_none())
    }

    <span class="doccomment">/// Insert the value into the set at the given index.
    ///
    /// If an equivalent item already exists in the set, it returns
    ...
    </span><span class="kw">pub fn </span>shift_insert(<span class="kw-2">&amp;mut </span><span class="self">self</span>, index: usize, value: T) -&gt; bool {
        <span class="self">self</span>.map.shift_insert(index, value, ()).is_none()
    }
    ...
    /// Computes in **O(1)** time (average).
        ...
        <span class="kw">let </span>hash = <span class="self">self</span>.map.hash(<span class="kw-2">&amp;</span>value);
        <span class="kw">match </span><span class="self">self</span>.map.core.replace_full(hash, value, ()) {
            (i, <span class="prelude-val">Some</span>((replaced, ()))) =&gt; (i, <span class="prelude-val">Some</span>(replaced)),
            (i, <span class="prelude-val">None</span>) =&gt; (i, <span class="prelude-val">None</span>),
        }
    }
    ...
    {
        Difference::new(<span class="self">self</span>, other)
    }
    ...
    {
        SymmetricDifference::new(<span class="self">self</span>, other)
    }
    ...
    {
        Intersection::new(<span class="self">self</span>, other)
    }
    ...
    {
        Union::new(<span class="self">self</span>, other)
    }

    <span class="doccomment">/// Creates a splicing iterator that replaces the specified range in the set
    ...
    /// ```
    </span><span class="kw">pub fn </span>splice&lt;R, I&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, range: R, replace_with: I) -&gt; Splice&lt;<span class="lifetime">'_</span>, I::IntoIter, T, S&gt;
    <span class="kw">where
        </span>R: RangeBounds&lt;usize&gt;,
    ...
    </span>S: BuildHasher,
{
    ...
    ///
    /// Computes in **O(1)** time (average).
    </span><span class="kw">pub fn </span>contains&lt;Q&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; bool
    <span class="kw">where
    ...
    ///
    /// Computes in **O(1)** time (average).
    </span><span class="kw">pub fn </span>get&lt;Q&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>T&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    </span><span class="kw">pub fn </span>get_full&lt;Q&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;(usize, <span class="kw-2">&amp;</span>T)&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Computes in **O(1)** time (average).
    </span><span class="kw">pub fn </span>get_index_of&lt;Q&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;usize&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    </span><span class="attr">#[deprecated(note = <span class="string">"`remove` disrupts the set order -- \
        use `swap_remove` or `shift_remove` for explicit behavior."</span>)]
    </span><span class="kw">pub fn </span>remove&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; bool
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Computes in **O(1)** time (average).
    </span><span class="kw">pub fn </span>swap_remove&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; bool
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Computes in **O(n)** time (average).
    </span><span class="kw">pub fn </span>shift_remove&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; bool
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    </span><span class="attr">#[deprecated(note = <span class="string">"`take` disrupts the set order -- \
        use `swap_take` or `shift_take` for explicit behavior."</span>)]
    </span><span class="kw">pub fn </span>take&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;T&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Computes in **O(1)** time (average).
    </span><span class="kw">pub fn </span>swap_take&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;T&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Computes in **O(n)** time (average).
    </span><span class="kw">pub fn </span>shift_take&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;T&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Return `None` if `value` was not in the set.
    </span><span class="kw">pub fn </span>swap_remove_full&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;(usize, T)&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
    ...
    ///
    /// Return `None` if `value` was not in the set.
    </span><span class="kw">pub fn </span>shift_remove_full&lt;Q&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, value: <span class="kw-2">&amp;</span>Q) -&gt; <span class="prelude-ty">Option</span>&lt;(usize, T)&gt;
    <span class="kw">where
        </span>Q: <span class="question-mark">?</span>Sized + Hash + Equivalent&lt;T&gt;,
    {
...
<span class="kw">impl</span>&lt;T, S&gt; IndexSet&lt;T, S&gt; {
    ...
    <span class="doccomment">/// Sort the set’s values in place using a key extraction function.
    ///
    ...
    </span><span class="kw">pub fn </span>sort_by_cached_key&lt;K, F&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, <span class="kw-2">mut </span>sort_key: F)
    <span class="kw">where
        </span>K: Ord,
        F: FnMut(<span class="kw-2">&amp;</span>T) -&gt; K,
    {
        <span class="self">self</span>.with_entries(<span class="kw">move </span>|entries| {
            entries.sort_by_cached_key(<span class="kw">move </span>|a| sort_key(<span class="kw-2">&amp;</span>a.key));
        });
    }
    ...
    {
        <span class="self">self</span>.as_slice().binary_search(x)
    }
    ...
    <span class="doccomment">/// Returns a slice of all the values in the set.
    ///
    /// Computes in **O(1)** time.
    </span><span class="kw">pub fn </span>as_slice(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>Slice&lt;T&gt; {
        Slice::from_slice(<span class="self">self</span>.as_entries())
    }

    <span class="doccomment">/// Converts into a boxed slice of all the values in the set.
    ///
    /// Note that this will drop the inner hash table and any excess capacity.
    </span><span class="kw">pub fn </span>into_boxed_slice(<span class="self">self</span>) -&gt; Box&lt;Slice&lt;T&gt;&gt; {
    ...
    ///
    /// Computes in **O(1)** time.
    </span><span class="kw">pub fn </span>get_range&lt;R: RangeBounds&lt;usize&gt;&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, range: R) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Slice&lt;T&gt;&gt; {
