...
</pre></div><pre class="rust"><code><span class="kw">use super</span>::{Bucket, Entries, IndexSet, Slice};
...
<span class="kw">use </span>core::slice::Iter <span class="kw">as </span>SliceIter;
...
<span class="doccomment">/// An iterator over the items of an [`IndexSet`].
///
...
/// See its documentation for more.
    ...
    iter: SliceIter&lt;<span class="lifetime">'a</span>, Bucket&lt;T&gt;&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Iter&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(entries: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[Bucket&lt;T&gt;]) -&gt; <span class="self">Self </span>{
    ...
    </span><span class="kw">pub fn </span>as_slice(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Slice&lt;T&gt; {
...
<span class="kw">impl</span>&lt;T&gt; Default <span class="kw">for </span>Iter&lt;<span class="lifetime">'_</span>, T&gt; {
    <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ iter: [].iter() }
    }
}

<span class="doccomment">/// An owning iterator over the items of an [`IndexSet`].
///
...
<span class="kw">impl</span>&lt;T&gt; IntoIter&lt;T&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(entries: Vec&lt;Bucket&lt;T&gt;&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
...
<span class="kw">impl</span>&lt;T&gt; Default <span class="kw">for </span>IntoIter&lt;T&gt; {
    <span class="kw">fn </span>default() -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
...
<span class="doccomment">/// A draining iterator over the items of an [`IndexSet`].
///
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T&gt; Drain&lt;<span class="lifetime">'a</span>, T&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(iter: vec::Drain&lt;<span class="lifetime">'a</span>, Bucket&lt;T&gt;&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{ iter }
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S&gt; Difference&lt;<span class="lifetime">'a</span>, T, S&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new&lt;S1&gt;(set: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S1&gt;, other: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            iter: set.iter(),
            other,
        }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S&gt; Intersection&lt;<span class="lifetime">'a</span>, T, S&gt; {
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new&lt;S1&gt;(set: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S1&gt;, other: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            iter: set.iter(),
            other,
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S1, S2&gt; SymmetricDifference&lt;<span class="lifetime">'a</span>, T, S1, S2&gt;
<span class="kw">where
    </span>T: Eq + Hash,
    S1: BuildHasher,
    S2: BuildHasher,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new(set1: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S1&gt;, set2: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S2&gt;) -&gt; <span class="self">Self </span>{
        <span class="kw">let </span>diff1 = set1.difference(set2);
        <span class="kw">let </span>diff2 = set2.difference(set1);
        <span class="self">Self </span>{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, T, S&gt; Union&lt;<span class="lifetime">'a</span>, T, S&gt;
<span class="kw">where
    </span>T: Eq + Hash,
    S: BuildHasher,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new&lt;S2&gt;(set1: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S&gt;, set2: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>IndexSet&lt;T, S2&gt;) -&gt; <span class="self">Self
...
<span class="doccomment">/// A splicing iterator for `IndexSet`.
///
/// This `struct` is created by [`IndexSet::splice()`].
/// See its documentation for more.
</span><span class="kw">pub struct </span>Splice&lt;<span class="lifetime">'a</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
{
    iter: <span class="kw">crate</span>::map::Splice&lt;<span class="lifetime">'a</span>, UnitValue&lt;I&gt;, T, (), S&gt;,
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, I, T, S&gt; Splice&lt;<span class="lifetime">'a</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
{
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>new&lt;R&gt;(set: <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>IndexSet&lt;T, S&gt;, range: R, replace_with: I) -&gt; <span class="self">Self
    </span><span class="kw">where
...
<span class="kw">impl</span>&lt;I, T, S&gt; Iterator <span class="kw">for </span>Splice&lt;<span class="lifetime">'_</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
{
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="prelude-val">Some</span>(<span class="self">self</span>.iter.next()<span class="question-mark">?</span>.<span class="number">0</span>)
    }
...
<span class="kw">impl</span>&lt;I, T, S&gt; DoubleEndedIterator <span class="kw">for </span>Splice&lt;<span class="lifetime">'_</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
{
    <span class="kw">fn </span>next_back(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="prelude-val">Some</span>(<span class="self">self</span>.iter.next_back()<span class="question-mark">?</span>.<span class="number">0</span>)
    }
}

<span class="kw">impl</span>&lt;I, T, S&gt; ExactSizeIterator <span class="kw">for </span>Splice&lt;<span class="lifetime">'_</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
...
<span class="kw">impl</span>&lt;I, T, S&gt; FusedIterator <span class="kw">for </span>Splice&lt;<span class="lifetime">'_</span>, I, T, S&gt;
<span class="kw">where
    </span>I: Iterator&lt;Item = T&gt;,
    T: Hash + Eq,
    S: BuildHasher,
...
<span class="kw">struct </span>UnitValue&lt;I&gt;(I);

<span class="kw">impl</span>&lt;I: Iterator&gt; Iterator <span class="kw">for </span>UnitValue&lt;I&gt; {
    <span class="kw">type </span>Item = (I::Item, ());

    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="self">self</span>.<span class="number">0</span>.next().map(|x| (x, ()))
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, I, T, S&gt; fmt::Debug <span class="kw">for </span>Splice&lt;<span class="lifetime">'a</span>, I, T, S&gt;
<span class="kw">where
    </span>I: fmt::Debug + Iterator&lt;Item = T&gt;,
    T: fmt::Debug + Hash + Eq,
    S: BuildHasher,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        fmt::Debug::fmt(<span class="kw-2">&amp;</span><span class="self">self</span>.iter, f)
    }
}

<span class="kw">impl</span>&lt;I: fmt::Debug&gt; fmt::Debug <span class="kw">for </span>UnitValue&lt;I&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
