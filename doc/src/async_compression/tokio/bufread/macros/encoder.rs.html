    ...
    ($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="macro-nonterminal">$name</span>:ident&lt;<span class="macro-nonterminal">$inner</span>:ident&gt; $({ $(<span class="macro-nonterminal">$inherent_methods</span>:tt)* })<span class="kw-2">*</span>) =&gt; {
        <span class="macro">pin_project_lite::pin_project!</span> {
            ...
            /// read uncompressed data from an underlying stream and emit a stream of compressed data.
                ...
                <span class="attr">#[pin]
                </span>inner: <span class="kw">crate</span>::tokio::bufread::Encoder&lt;<span class="macro-nonterminal">$inner</span>, <span class="kw">crate</span>::codec::<span class="macro-nonterminal">$name</span>&gt;,
            }
        }
        ...
        <span class="kw">impl</span>&lt;<span class="macro-nonterminal">$inner</span>: tokio::io::AsyncBufRead&gt; <span class="macro-nonterminal">$name</span>&lt;<span class="macro-nonterminal">$inner</span>&gt; {
            $(
                <span class="doccomment">/// Creates a new encoder which will read uncompressed data from the given stream
                /// and emit a compressed stream.
                ///
                </span>$(<span class="macro-nonterminal">$inherent_methods</span>)*
            )*

            <span class="doccomment">/// Acquires a reference to the underlying reader that this encoder is wrapping.
            ...
            <span class="doccomment">/// Acquires a mutable reference to the underlying reader that this encoder is
            /// wrapping.
            ///
            ...
            <span class="doccomment">/// Acquires a pinned mutable reference to the underlying reader that this encoder is
            /// wrapping.
            ///
            /// Note that care must be taken to avoid tampering with the state of the reader which
            /// may otherwise confuse this encoder.
