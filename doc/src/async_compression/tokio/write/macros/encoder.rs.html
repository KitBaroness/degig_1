...
</pre></div><pre class="rust"><code><span class="macro">macro_rules!</span> encoder {
    ($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="macro-nonterminal">$name</span>:ident&lt;<span class="macro-nonterminal">$inner</span>:ident&gt; $({ $(<span class="macro-nonterminal">$inherent_methods</span>:tt)* })<span class="kw-2">*</span>) =&gt; {
        <span class="macro">pin_project_lite::pin_project!</span> {
            ...
            /// take in uncompressed data and write it compressed to an underlying stream.
                ...
                <span class="attr">#[pin]
                </span>inner: <span class="kw">crate</span>::tokio::write::Encoder&lt;<span class="macro-nonterminal">$inner</span>, <span class="kw">crate</span>::codec::<span class="macro-nonterminal">$name</span>&gt;,
            }
        }

        <span class="kw">impl</span>&lt;<span class="macro-nonterminal">$inner</span>: tokio::io::AsyncWrite&gt; <span class="macro-nonterminal">$name</span>&lt;<span class="macro-nonterminal">$inner</span>&gt; {
            $(
                <span class="doccomment">/// Creates a new encoder which will take in uncompressed data and write it
                /// compressed to the given stream.
                ///
                </span>$(<span class="macro-nonterminal">$inherent_methods</span>)*
            )*

            <span class="doccomment">/// Acquires a reference to the underlying writer that this encoder is wrapping.
            ...
            <span class="doccomment">/// Acquires a mutable reference to the underlying writer that this encoder is
            /// wrapping.
            ///
            ...
            <span class="doccomment">/// Acquires a pinned mutable reference to the underlying writer that this encoder is
            /// wrapping.
            ///
            /// Note that care must be taken to avoid tampering with the state of the writer which
            /// may otherwise confuse this encoder.
            ...
            <span class="doccomment">/// Consumes this encoder returning the underlying writer.
            ///
        ...
        <span class="kw">impl</span>&lt;<span class="macro-nonterminal">$inner</span>: tokio::io::AsyncWrite&gt; tokio::io::AsyncWrite <span class="kw">for </span><span class="macro-nonterminal">$name</span>&lt;<span class="macro-nonterminal">$inner</span>&gt; {
        ...
        <span class="kw">const _</span>: () = {
            <span class="kw">fn </span>_assert() {
                ...
                _assert_send::&lt;<span class="macro-nonterminal">$name</span>&lt;Pin&lt;Box&lt;<span class="kw">dyn </span>AsyncWrite + Send&gt;&gt;&gt;&gt;();
                _assert_sync::&lt;<span class="macro-nonterminal">$name</span>&lt;Pin&lt;Box&lt;<span class="kw">dyn </span>AsyncWrite + Sync&gt;&gt;&gt;&gt;();
            }
        };
    }
}
