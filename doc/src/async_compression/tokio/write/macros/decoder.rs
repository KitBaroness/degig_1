    ...
    ($(<span class="attr">#[<span class="macro-nonterminal">$attr</span>:meta]</span>)* <span class="macro-nonterminal">$name</span>:ident&lt;<span class="macro-nonterminal">$inner</span>:ident&gt; $({ $(<span class="macro-nonterminal">$inherent_methods</span>:tt)* })<span class="kw-2">*</span>) =&gt; {
        <span class="macro">pin_project_lite::pin_project!</span> {
            ...
            /// take in compressed data and write it uncompressed to an underlying stream.
                ...
                <span class="attr">#[pin]
                </span>inner: <span class="kw">crate</span>::tokio::write::Decoder&lt;<span class="macro-nonterminal">$inner</span>, <span class="kw">crate</span>::codec::<span class="macro-nonterminal">$name</span>&gt;,
            }
        }
        ...
        <span class="kw">impl</span>&lt;<span class="macro-nonterminal">$inner</span>: tokio::io::AsyncWrite&gt; <span class="macro-nonterminal">$name</span>&lt;<span class="macro-nonterminal">$inner</span>&gt; {
            <span class="doccomment">/// Creates a new decoder which will take in compressed data and write it uncompressed
            /// to the given stream.
                ...
                <span class="macro-nonterminal">$name </span>{
                    inner: <span class="kw">crate</span>::tokio::write::Decoder::new(read, <span class="kw">crate</span>::codec::<span class="macro-nonterminal">$name::new</span>()),
                }
            }
