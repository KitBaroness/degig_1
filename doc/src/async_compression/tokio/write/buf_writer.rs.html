...
</pre></div><pre class="rust"><code><span class="comment">// Originally sourced from `futures_util::io::buf_writer`, needs to be redefined locally so that
// the `AsyncBufWrite` impl can access its internals, and changed a bit to make it more efficient
// with those methods.

</span><span class="kw">use </span><span class="kw">super</span>::AsyncBufWrite;
...
<span class="kw">const </span>DEFAULT_BUF_SIZE: usize = <span class="number">8192</span>;

<span class="macro">pin_project!</span> {
    <span class="kw">pub struct </span>BufWriter&lt;W&gt; {
        <span class="attr">#[pin]
        </span>inner: W,
        buf: Box&lt;[u8]&gt;,
        written: usize,
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; BufWriter&lt;W&gt; {
    ...
    <span class="doccomment">/// Creates a new `BufWriter` with the specified buffer capacity.
        ...
        <span class="self">Self </span>{
            inner,
            buf: <span class="macro">vec!</span>[<span class="number">0</span>; cap].into(),
            written: <span class="number">0</span>,
            buffered: <span class="number">0</span>,
        }
    }

    <span class="kw">fn </span>partial_flush_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        ...
        <span class="kw">while </span><span class="kw-2">*</span>this.written &lt; <span class="kw-2">*</span>this.buffered {
            <span class="kw">match </span>this
                .inner
                .as_mut()
                .poll_write(cx, <span class="kw-2">&amp;</span>this.buf[<span class="kw-2">*</span>this.written..<span class="kw-2">*</span>this.buffered])
            {
                Poll::Pending =&gt; {
                ...
                Poll::Ready(<span class="prelude-val">Ok</span>(n)) =&gt; <span class="kw-2">*</span>this.written += n,
        ...
        <span class="kw">if </span><span class="kw-2">*</span>this.written &gt; <span class="number">0 </span>{
            this.buf.copy_within(<span class="kw-2">*</span>this.written..<span class="kw-2">*</span>this.buffered, <span class="number">0</span>);
            <span class="kw-2">*</span>this.buffered -= <span class="kw-2">*</span>this.written;
            <span class="kw-2">*</span>this.written = <span class="number">0</span>;

            Poll::Ready(ret)
        } <span class="kw">else if </span><span class="kw-2">*</span>this.buffered == <span class="number">0 </span>{
            Poll::Ready(ret)
    ...
    <span class="kw">fn </span>flush_buf(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;) -&gt; Poll&lt;io::Result&lt;()&gt;&gt; {
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>ret = <span class="prelude-val">Ok</span>(());
        <span class="kw">while </span><span class="kw-2">*</span>this.written &lt; <span class="kw-2">*</span>this.buffered {
            <span class="kw">match </span><span class="macro">ready!</span>(this
                .inner
                .as_mut()
                .poll_write(cx, <span class="kw-2">&amp;</span>this.buf[<span class="kw-2">*</span>this.written..<span class="kw-2">*</span>this.buffered]))
            {
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; AsyncWrite <span class="kw">for </span>BufWriter&lt;W&gt; {
    <span class="kw">fn </span>poll_write(
        ...
        <span class="kw">if </span><span class="kw-2">*</span>this.buffered + buf.len() &gt; this.buf.len() {
            <span class="macro">ready!</span>(<span class="self">self</span>.as_mut().partial_flush_buf(cx))<span class="question-mark">?</span>;
        }

        <span class="kw">let </span>this = <span class="self">self</span>.as_mut().project();
        <span class="kw">if </span>buf.len() &gt;= this.buf.len() {
            <span class="kw">if </span><span class="kw-2">*</span>this.buffered == <span class="number">0 </span>{
                this.inner.poll_write(cx, buf)
            } <span class="kw">else </span>{
                <span class="comment">// The only way that `partial_flush_buf` would have returned with
                // `this.buffered != 0` is if it were Pending, so our waker was already queued
                </span>Poll::Pending
            }
        } <span class="kw">else </span>{
            <span class="kw">let </span>len = min(this.buf.len() - <span class="kw-2">*</span>this.buffered, buf.len());
            this.buf[<span class="kw-2">*</span>this.buffered..<span class="kw-2">*</span>this.buffered + len].copy_from_slice(<span class="kw-2">&amp;</span>buf[..len]);
            <span class="kw-2">*</span>this.buffered += len;
...
<span class="kw">impl</span>&lt;W: AsyncWrite&gt; AsyncBufWrite <span class="kw">for </span>BufWriter&lt;W&gt; {
    <span class="kw">fn </span>poll_partial_flush_buf(
        <span class="kw-2">mut </span><span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;,
        cx: <span class="kw-2">&amp;mut </span>Context&lt;<span class="lifetime">'_</span>&gt;,
    ) -&gt; Poll&lt;io::Result&lt;<span class="kw-2">&amp;mut </span>[u8]&gt;&gt; {
        <span class="macro">ready!</span>(<span class="self">self</span>.as_mut().partial_flush_buf(cx))<span class="question-mark">?</span>;
        <span class="kw">let </span>this = <span class="self">self</span>.project();
        Poll::Ready(<span class="prelude-val">Ok</span>(<span class="kw-2">&amp;mut </span>this.buf[<span class="kw-2">*</span>this.buffered..]))
    }

    <span class="kw">fn </span>produce(<span class="self">self</span>: Pin&lt;<span class="kw-2">&amp;mut </span><span class="self">Self</span>&gt;, amt: usize) {
        <span class="kw-2">*</span><span class="self">self</span>.project().buffered += amt;
    }
}
    ...
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; fmt::Result {
        f.debug_struct(<span class="string">"BufWriter"</span>)
            ...
            .field(
                ...
                <span class="kw-2">&amp;</span><span class="macro">format_args!</span>(<span class="string">"{}/{}"</span>, <span class="self">self</span>.buffered, <span class="self">self</span>.buf.len()),
            )
