...
</pre></div><pre class="rust"><code><span class="kw">use </span>digest::{generic_array::GenericArray, typenum::U64};
...
<span class="macro">cfg_if::cfg_if!</span> {
    <span class="kw">if </span><span class="attr">#[cfg(feature = <span class="string">"force-soft"</span>)] </span>{
        ...
        <span class="attr">#[cfg(feature = <span class="string">"asm"</span>)]
            ...
            <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">use </span>sha2_asm::compress256 <span class="kw">as </span>compress;
        }
...
<span class="doccomment">/// Raw SHA-256 compression function.
///
...
</span><span class="kw">pub fn </span>compress256(state: <span class="kw-2">&amp;mut </span>[u32; <span class="number">8</span>], blocks: <span class="kw-2">&amp;</span>[GenericArray&lt;u8, U64&gt;]) {
    <span class="comment">// SAFETY: GenericArray&lt;u8, U64&gt; and [u8; 64] have
    // exactly the same memory layout
    </span><span class="kw">let </span>p = blocks.as_ptr() <span class="kw">as </span><span class="kw-2">*const </span>[u8; <span class="number">64</span>];
