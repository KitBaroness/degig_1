...
</pre></div><pre class="rust"><code><span class="doccomment">//! This crate provides Serde's two derive macros.
//!
//! ```edition2021
...
</span><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/serde_derive/1.0.198"</span>)]
