...
<span class="kw">pub fn </span>wrap_in_const(serde_path: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>syn::Path&gt;, code: TokenStream) -&gt; TokenStream {
    <span class="kw">let </span>use_serde = <span class="kw">match </span>serde_path {
        ...
        <span class="prelude-val">None </span>=&gt; <span class="macro">quote!</span> {
            <span class="attr">#[allow(unused_extern_crates, clippy::useless_attribute)]
