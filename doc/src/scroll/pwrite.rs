...
<span class="kw">use </span><span class="kw">crate</span>::ctx::TryIntoCtx;
<span class="kw">use </span><span class="kw">crate</span>::error;

<span class="doccomment">/// A very generic, contextual pwrite interface in Rust.
///
...
///
</span><span class="kw">pub trait </span>Pwrite&lt;Ctx: Copy, E&gt; {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>pwrite&lt;N: TryIntoCtx&lt;Ctx, <span class="self">Self</span>, Error = E&gt;&gt;(
    ...
    {
        <span class="self">self</span>.pwrite_with(n, offset, Ctx::default())
    }

    <span class="doccomment">/// Write `N` at offset `I` with context `Ctx`
    /// # Example
    /// ```
    ...
    </span><span class="kw">fn </span>pwrite_with&lt;N: TryIntoCtx&lt;Ctx, <span class="self">Self</span>, Error = E&gt;&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        n: N,
        offset: usize,
        ctx: Ctx,
    ...
    <span class="doccomment">/// Write `n` into `self` at `offset`, with a default `Ctx`. Updates the offset.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>gwrite&lt;N: TryIntoCtx&lt;Ctx, <span class="self">Self</span>, Error = E&gt;&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        n: N,
        ...
        </span>Ctx: Default,
    {
        ...
        <span class="self">self</span>.gwrite_with(n, offset, ctx)
    }

    <span class="doccomment">/// Write `n` into `self` at `offset`, with the `ctx`. Updates the offset.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>gwrite_with&lt;N: TryIntoCtx&lt;Ctx, <span class="self">Self</span>, Error = E&gt;&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        n: N,
        offset: <span class="kw-2">&amp;mut </span>usize,
        ctx: Ctx,
    ) -&gt; result::Result&lt;usize, E&gt; {
        <span class="kw">let </span>o = <span class="kw-2">*</span>offset;
        <span class="self">self</span>.pwrite_with(n, o, ctx).map(|size| {
...
<span class="kw">impl</span>&lt;Ctx: Copy, E: From&lt;error::Error&gt;&gt; Pwrite&lt;Ctx, E&gt; <span class="kw">for </span>[u8] {
    <span class="kw">fn </span>pwrite_with&lt;N: TryIntoCtx&lt;Ctx, <span class="self">Self</span>, Error = E&gt;&gt;(
        <span class="kw-2">&amp;mut </span><span class="self">self</span>,
        n: N,
        offset: usize,
        ctx: Ctx,
    ) -&gt; result::Result&lt;usize, E&gt; {
        <span class="kw">if </span>offset &gt;= <span class="self">self</span>.len() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(error::Error::BadOffset(offset).into());
        }
        <span class="kw">let </span>dst = <span class="kw-2">&amp;mut </span><span class="self">self</span>[offset..];
