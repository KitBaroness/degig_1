...
</pre></div><pre class="rust"><code><span class="kw">use </span>core::ops::{Index, IndexMut, RangeFrom};

<span class="kw">use </span><span class="kw">crate</span>::ctx::{FromCtx, IntoCtx};

<span class="doccomment">/// Core-read - core, no_std friendly trait for reading basic traits from byte buffers. Cannot fail
...
/// ```
</span><span class="kw">pub trait </span>Cread&lt;Ctx, I = usize&gt;: Index&lt;I&gt; + Index&lt;RangeFrom&lt;I&gt;&gt;
<span class="kw">where
    </span>Ctx: Copy,
{
    <span class="doccomment">/// Reads a value from `Self` at `offset` with `ctx`. Cannot fail.
    ...
    </span><span class="kw">fn </span>cread_with&lt;N: FromCtx&lt;Ctx, &lt;<span class="self">Self </span><span class="kw">as </span>Index&lt;RangeFrom&lt;I&gt;&gt;&gt;::Output&gt;&gt;(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        offset: I,
        ctx: Ctx,
    ) -&gt; N {
        N::from_ctx(<span class="kw-2">&amp;</span><span class="self">self</span>[offset..], ctx)
    }
    <span class="doccomment">/// Reads a value implementing `FromCtx` from `Self` at `offset`,
    ...
    </span><span class="kw">fn </span>cread&lt;N: FromCtx&lt;Ctx, &lt;<span class="self">Self </span><span class="kw">as </span>Index&lt;RangeFrom&lt;I&gt;&gt;&gt;::Output&gt;&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, offset: I) -&gt; N
    <span class="kw">where
        </span>Ctx: Default,
    {
...
<span class="kw">impl</span>&lt;Ctx: Copy, I, R: <span class="question-mark">?</span>Sized + Index&lt;I&gt; + Index&lt;RangeFrom&lt;I&gt;&gt;&gt; Cread&lt;Ctx, I&gt; <span class="kw">for </span>R {}

<span class="doccomment">/// Core-write - core, no_std friendly trait for writing basic types into byte buffers. Cannot fail
/// unless the buffer is too small, in which case an assert fires and the program panics.
...
/// ```
</span><span class="kw">pub trait </span>Cwrite&lt;Ctx: Copy, I = usize&gt;: Index&lt;I&gt; + IndexMut&lt;RangeFrom&lt;I&gt;&gt; {
    <span class="doccomment">/// Writes `n` into `Self` at `offset`; uses default context.
    /// For the primitive types, this will be the **target machine**'s endianness.
    ///
    /// # Example
    ///
    ...
    </span><span class="kw">fn </span>cwrite&lt;N: IntoCtx&lt;Ctx, &lt;<span class="self">Self </span><span class="kw">as </span>Index&lt;RangeFrom&lt;I&gt;&gt;&gt;::Output&gt;&gt;(<span class="kw-2">&amp;mut </span><span class="self">self</span>, n: N, offset: I)
    <span class="kw">where
        </span>Ctx: Default,
    {
        <span class="kw">let </span>ctx = Ctx::default();
        n.into_ctx(<span class="self">self</span>.index_mut(offset..), ctx)
    }
    <span class="doccomment">/// Writes `n` into `Self` at `offset` with `ctx`
    ///
    /// # Example
    ///
    /// ```
    ...
    </span><span class="kw">fn </span>cwrite_with&lt;N: IntoCtx&lt;Ctx, &lt;<span class="self">Self </span><span class="kw">as </span>Index&lt;RangeFrom&lt;I&gt;&gt;&gt;::Output&gt;&gt;(
...
<span class="kw">impl</span>&lt;Ctx: Copy, I, W: <span class="question-mark">?</span>Sized + Index&lt;I&gt; + IndexMut&lt;RangeFrom&lt;I&gt;&gt;&gt; Cwrite&lt;Ctx, I&gt; <span class="kw">for </span>W {}
