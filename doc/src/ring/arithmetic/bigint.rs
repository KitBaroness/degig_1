...
</span><span class="kw">use </span><span class="self">self</span>::boxed_limbs::BoxedLimbs;
...
<span class="kw">use </span>core::{marker::PhantomData, num::NonZeroU64};

<span class="kw">mod </span>boxed_limbs;
<span class="kw">mod </span>modulus;
<span class="kw">mod </span>private_exponent;

<span class="kw">pub trait </span>PublicModulus {}
...
<span class="doccomment">/// Does a Montgomery reduction on `limbs` assuming they are Montgomery-encoded ('R') and assuming
/// they are the same size as `m`, but perhaps not reduced mod `m`. The result will be
/// fully reduced mod `m`.
</span><span class="kw">fn </span>from_montgomery_amm&lt;M&gt;(limbs: BoxedLimbs&lt;M&gt;, m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;) -&gt; Elem&lt;M, Unencoded&gt; {
    <span class="macro">debug_assert_eq!</span>(limbs.len(), m.limbs().len());

    <span class="kw">let </span><span class="kw-2">mut </span>limbs = limbs;
    ...
    <span class="kw">let </span>one = <span class="kw-2">&amp;</span>one[..m.limbs().len()];
    limbs_mont_mul(<span class="kw-2">&amp;mut </span>limbs, one, m.limbs(), m.n0(), m.cpu_features());
    Elem {
        limbs,
...
<span class="attr">#[cfg(any(test, not(target_arch = <span class="string">"x86_64"</span>)))]
</span><span class="kw">impl</span>&lt;M&gt; Elem&lt;M, R&gt; {
    <span class="attr">#[inline]
        ...
        from_montgomery_amm(<span class="self">self</span>.limbs, m)
    }
}
...
{
    limbs_mont_mul(<span class="kw-2">&amp;mut </span>b.limbs, <span class="kw-2">&amp;</span>a.limbs, m.limbs(), m.n0(), m.cpu_features());
    Elem {
        limbs: b.limbs,
        encoding: PhantomData,
    }
...
<span class="comment">// r *= 2.
</span><span class="kw">fn </span>elem_double&lt;M, AF&gt;(r: <span class="kw-2">&amp;mut </span>Elem&lt;M, AF&gt;, m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;) {
    limb::limbs_double_mod(<span class="kw-2">&amp;mut </span>r.limbs, m.limbs())
}

<span class="comment">// TODO: This is currently unused, but we intend to eventually use this to
...
// the old usage.
</span><span class="kw">pub fn </span>elem_reduced_once&lt;A, M&gt;(
    a: <span class="kw-2">&amp;</span>Elem&lt;A, Unencoded&gt;,
    m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;,
    other_modulus_len_bits: BitLength,
) -&gt; Elem&lt;M, Unencoded&gt; {
    <span class="macro">assert_eq!</span>(m.len_bits(), other_modulus_len_bits);

    <span class="kw">let </span><span class="kw-2">mut </span>r = a.limbs.clone();
    limb::limbs_reduce_once_constant_time(<span class="kw-2">&amp;mut </span>r, m.limbs());
    Elem {
...
<span class="attr">#[inline]
</span><span class="kw">pub fn </span>elem_reduced&lt;Larger, Smaller&gt;(
    a: <span class="kw-2">&amp;</span>Elem&lt;Larger, Unencoded&gt;,
    m: <span class="kw-2">&amp;</span>Modulus&lt;Smaller&gt;,
    other_prime_len_bits: BitLength,
) -&gt; Elem&lt;Smaller, RInverse&gt; {
    <span class="comment">// This is stricter than required mathematically but this is what we
    // guarantee and this is easier to check. The real requirement is that
    // that `a &lt; m*R` where `R` is the Montgomery `R` for `m`.
    </span><span class="macro">assert_eq!</span>(other_prime_len_bits, m.len_bits());

    <span class="comment">// `limbs_from_mont_in_place` requires this.
    </span><span class="macro">assert_eq!</span>(a.limbs.len(), m.limbs().len() * <span class="number">2</span>);
    ...
    limbs_from_mont_in_place(<span class="kw-2">&amp;mut </span>r.limbs, tmp, m.limbs(), m.n0());
    r
}
...
{
    limbs_mont_square(<span class="kw-2">&amp;mut </span>a.limbs, m.limbs(), m.n0(), m.cpu_features());
    Elem {
        limbs: a.limbs,
        encoding: PhantomData,
    }
...
<span class="kw">pub fn </span>elem_widen&lt;Larger, Smaller&gt;(
    a: Elem&lt;Smaller, Unencoded&gt;,
    m: <span class="kw-2">&amp;</span>Modulus&lt;Larger&gt;,
    smaller_modulus_bits: BitLength,
) -&gt; <span class="prelude-ty">Result</span>&lt;Elem&lt;Larger, Unencoded&gt;, error::Unspecified&gt; {
    <span class="kw">if </span>smaller_modulus_bits &gt;= m.len_bits() {
...
<span class="comment">// TODO: Document why this works for all Montgomery factors.
    ...
    limb::limbs_add_assign_mod(<span class="kw-2">&amp;mut </span>a.limbs, <span class="kw-2">&amp;</span>b.limbs, m.limbs());
    a
}
...
<span class="kw">impl</span>&lt;M&gt; One&lt;M, RR&gt; {
    ...
    // `N0::LIMBS_USED` is either one or two.
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>newRR(m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;) -&gt; <span class="self">Self </span>{
        <span class="comment">// The number of limbs in the numbers involved.
        </span><span class="kw">let </span>w = m.limbs().len();

        <span class="comment">// The length of the numbers involved, in bits. R = 2**r.
        </span><span class="kw">let </span>r = w * LIMB_BITS;

        <span class="kw">let </span><span class="kw-2">mut </span>acc: Elem&lt;M, R&gt; = m.zero();
        m.oneR(<span class="kw-2">&amp;mut </span>acc.limbs);

        <span class="comment">// 2**t * R can be calculated by t doublings starting with R.
        //
        ...
        </span><span class="kw">let </span>t = w;
        <span class="kw">let </span>z = w.trailing_zeros();
        <span class="kw">let </span>d = w &gt;&gt; z;
        <span class="macro">debug_assert_eq!</span>(w, d * (<span class="number">1 </span>&lt;&lt; z));
        <span class="macro">debug_assert!</span>(d &lt;= t);
        <span class="macro">debug_assert!</span>(t &lt; r);
        <span class="kw">for _ in </span><span class="number">0</span>..t {
            elem_double(<span class="kw-2">&amp;mut </span>acc, m);
        }

        <span class="comment">// Because t | r:
        //
        //     MontExp(2**t * R, r / t)
        ...
        </span><span class="kw">const </span>B: u32 = <span class="kw">if </span><span class="macro">cfg!</span>(target_pointer_width = <span class="string">"64"</span>) {
            <span class="number">6
        </span>} <span class="kw">else if </span><span class="macro">cfg!</span>(target_pointer_width = <span class="string">"32"</span>) {
            <span class="number">5
        ...
        </span><span class="kw">const </span>_LIMB_BITS_IS_2_POW_B: () = <span class="macro">assert!</span>(LIMB_BITS == <span class="number">1 </span>&lt;&lt; B);
        <span class="macro">debug_assert_eq!</span>(r, t * (<span class="number">1 </span>&lt;&lt; B));
        <span class="kw">for _ in </span><span class="number">0</span>..B {
...
<span class="kw">impl</span>&lt;M&gt; One&lt;M, RRR&gt; {
    <span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>newRRR(One(oneRR): One&lt;M, RR&gt;, m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>(elem_squared(oneRR, m))
    }
}
...
<span class="kw">impl</span>&lt;M: PublicModulus, E&gt; Clone <span class="kw">for </span>One&lt;M, E&gt; {
    <span class="kw">fn </span>clone(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="self">Self </span>{
...
// accepted exponent and with the most common values of 65537 and 3.
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>elem_exp_vartime&lt;M&gt;(
    base: Elem&lt;M, R&gt;,
    exponent: NonZeroU64,
    m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;,
) -&gt; Elem&lt;M, R&gt; {
    ...
    </span><span class="kw">let </span>exponent = exponent.get();
    ...
    <span class="kw">while </span>bit &gt; <span class="number">1 </span>{
        ...
        <span class="kw">if </span>(exponent &amp; bit) != <span class="number">0 </span>{
            acc = elem_mul(<span class="kw-2">&amp;</span>base, acc, m);
        }
    }
    acc
}
...
<span class="attr">#[cfg(not(target_arch = <span class="string">"x86_64"</span>))]
    ...
    base: Elem&lt;M, R&gt;,
    exponent: <span class="kw-2">&amp;</span>PrivateExponent,
    m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;Elem&lt;M, Unencoded&gt;, error::Unspecified&gt; {
    <span class="kw">use crate</span>::{bssl, limb::Window};
    ...
    <span class="kw">fn </span>gather&lt;M&gt;(table: <span class="kw-2">&amp;</span>[Limb], acc: <span class="kw-2">&amp;mut </span>Elem&lt;M, R&gt;, i: Window) {
        <span class="macro">prefixed_extern!</span> {
    ...
    <span class="kw">fn </span>power&lt;M&gt;(
        ...
        gather(table, <span class="kw-2">&amp;mut </span>tmp, i);
    ...
    <span class="comment">// table[0] = base**0 (i.e. 1).
    </span>m.oneR(entry_mut(<span class="kw-2">&amp;mut </span>table, <span class="number">0</span>, num_limbs));
    ...
    <span class="kw">let </span>tmp = m.zero();
    <span class="kw">let </span><span class="kw-2">mut </span>acc = Elem {
        limbs: base.limbs,
        encoding: PhantomData,
    };
    <span class="kw">let </span>(acc, <span class="kw">_</span>) = limb::fold_5_bit_windows(
        exponent.limbs(),
        |initial_window| {
            gather(<span class="kw-2">&amp;</span>table, <span class="kw-2">&amp;mut </span>acc, initial_window);
            (acc, tmp)
        },
        |(acc, tmp), window| power(<span class="kw-2">&amp;</span>table, acc, m, window, tmp),
    );

    <span class="prelude-val">Ok</span>(acc.into_unencoded(m))
}
...
<span class="attr">#[cfg(target_arch = <span class="string">"x86_64"</span>)]
    ...
    <span class="kw">use crate</span>::{cpu, limb::LIMB_BYTES};

    <span class="comment">// Pretty much all the math here requires CPU feature detection to have
    ...
    </span><span class="kw">let </span>cpu_features = m.cpu_features();
    ...
    <span class="kw">fn </span>scatter(table: <span class="kw-2">&amp;mut </span>[Limb], acc: <span class="kw-2">&amp;</span>[Limb], i: Window, num_limbs: usize) {
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>bn_scatter5(a: <span class="kw-2">*const </span>Limb, a_len: c::size_t, table: <span class="kw-2">*mut </span>Limb, i: Window);
        }
        <span class="kw">unsafe </span>{ bn_scatter5(acc.as_ptr(), num_limbs, table.as_mut_ptr(), i) }
    }

    <span class="kw">fn </span>gather(table: <span class="kw-2">&amp;</span>[Limb], acc: <span class="kw-2">&amp;mut </span>[Limb], i: Window, num_limbs: usize) {
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>bn_gather5(r: <span class="kw-2">*mut </span>Limb, a_len: c::size_t, table: <span class="kw-2">*const </span>Limb, i: Window);
        }
        <span class="kw">unsafe </span>{ bn_gather5(acc.as_mut_ptr(), num_limbs, table.as_ptr(), i) }
    }

    <span class="kw">fn </span>limbs_mul_mont_gather5_amm(
        table: <span class="kw-2">&amp;</span>[Limb],
        acc: <span class="kw-2">&amp;mut </span>[Limb],
        base: <span class="kw-2">&amp;</span>[Limb],
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>bn_mul_mont_gather5(
    ...
    <span class="kw">fn </span>power_amm(
        table: <span class="kw-2">&amp;</span>[Limb],
        acc: <span class="kw-2">&amp;mut </span>[Limb],
        m_cached: <span class="kw-2">&amp;</span>[Limb],
        n0: <span class="kw-2">&amp;</span>N0,
        i: Window,
        num_limbs: usize,
    ) {
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>bn_power5(
                r: <span class="kw-2">*mut </span>Limb,
                a: <span class="kw-2">*const </span>Limb,
                table: <span class="kw-2">*const </span>Limb,
    ...
    <span class="comment">// These are named `(tmp, am, np)` in BoringSSL.
    </span><span class="kw">let </span>(acc, base_cached, m_cached): (<span class="kw-2">&amp;mut </span>[Limb], <span class="kw-2">&amp;</span>[Limb], <span class="kw-2">&amp;</span>[Limb]) = {
        <span class="kw">let </span>(acc, rest) = state.split_at_mut(num_limbs);
        <span class="kw">let </span>(base_cached, rest) = rest.split_at_mut(num_limbs);

        <span class="comment">// Upstream, the input `base` is not Montgomery-encoded, so they compute a
        // Montgomery-encoded copy and store it here.
        </span>base_cached.copy_from_slice(<span class="kw-2">&amp;</span>base.limbs);

        <span class="kw">let </span>m_cached = <span class="kw-2">&amp;mut </span>rest[..num_limbs];
        <span class="comment">// "To improve cache locality" according to upstream.
        </span>m_cached.copy_from_slice(m.limbs());

        (acc, base_cached, m_cached)
    };

    <span class="kw">let </span>n0 = m.n0();

    <span class="comment">// Fill in all the powers of 2 of `acc` into the table using only squaring and without any
    // gathering, storing the last calculated power into `acc`.
    </span><span class="kw">fn </span>scatter_powers_of_2(
        table: <span class="kw-2">&amp;mut </span>[Limb],
        acc: <span class="kw-2">&amp;mut </span>[Limb],
        m_cached: <span class="kw-2">&amp;</span>[Limb],
        n0: <span class="kw-2">&amp;</span>N0,
        <span class="kw-2">mut </span>i: Window,
        num_limbs: usize,
        ...
        <span class="kw">loop </span>{
            ...
            <span class="kw">if </span>i &gt;= (TABLE_ENTRIES <span class="kw">as </span>Window) {
    ...
    <span class="comment">// All entries in `table` will be Montgomery encoded.

    // acc = table[0] = base**0 (i.e. 1).
    </span>m.oneR(acc);
    scatter(table, acc, <span class="number">0</span>, num_limbs);

    <span class="comment">// acc = base**1 (i.e. base).
    </span>acc.copy_from_slice(base_cached);

    <span class="comment">// Fill in entries 1, 2, 4, 8, 16.
    </span>scatter_powers_of_2(table, acc, m_cached, n0, <span class="number">1</span>, num_limbs, cpu_features);
    <span class="comment">// Fill in entries 3, 6, 12, 24; 5, 10, 20, 30; 7, 14, 28; 9, 18; 11, 22; 13, 26; 15, 30;
    // 17; 19; 21; 23; 25; 27; 29; 31.
    </span><span class="kw">for </span>i <span class="kw">in </span>(<span class="number">3</span>..(TABLE_ENTRIES <span class="kw">as </span>Window)).step_by(<span class="number">2</span>) {
        limbs_mul_mont_gather5_amm(table, acc, base_cached, m_cached, n0, i - <span class="number">1</span>, num_limbs);
        scatter_powers_of_2(table, acc, m_cached, n0, i, num_limbs, cpu_features);
    }

    <span class="kw">let </span>acc = limb::fold_5_bit_windows(
        exponent.limbs(),
        |initial_window| {
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>r_amm = base.limbs;
    r_amm.copy_from_slice(acc);

    <span class="prelude-val">Ok</span>(from_montgomery_amm(r_amm, m))
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        test::run(
            ...
            |section, test_case| {
                ...
                <span class="kw">let </span>m = m.modulus(cpu_features);
                ...
                <span class="kw">let </span>e = {
                    ...
                    PrivateExponent::from_be_bytes_for_test_only(untrusted::Input::from(<span class="kw-2">&amp;</span>bytes), <span class="kw-2">&amp;</span>m)
    ...
    // verification and signing tests.
        ...
        <span class="kw">let </span>cpu_features = cpu::features();
        test::run(
            <span class="macro">test_file!</span>(<span class="string">"../../crypto/fipsmodule/bn/test/mod_mul_tests.txt"</span>),
            |section, test_case| {
                <span class="macro">assert_eq!</span>(section, <span class="string">""</span>);
    ...
    <span class="attr">#[test]
        ...
        test::run(
            ...
            |section, test_case| {
                ...
                <span class="kw">let </span>a = into_encoded(a, <span class="kw-2">&amp;</span>m);
                <span class="kw">let </span>actual_result = elem_squared(a, <span class="kw-2">&amp;</span>m);
                <span class="kw">let </span>actual_result = actual_result.into_unencoded(<span class="kw-2">&amp;</span>m);
                assert_elem_eq(<span class="kw-2">&amp;</span>actual_result, <span class="kw-2">&amp;</span>expected_result);
    ...
    <span class="attr">#[test]
        ...
        test::run(
            ...
            |section, test_case| {
                ...
                <span class="kw">struct </span>M {}

                <span class="kw">let </span>m_ = consume_modulus::&lt;M&gt;(test_case, <span class="string">"M"</span>);
                <span class="kw">let </span>m = m_.modulus(cpu_features);
                ...
                <span class="kw">let </span>a =
                    consume_elem_unchecked::&lt;M&gt;(test_case, <span class="string">"A"</span>, expected_result.limbs.len() * <span class="number">2</span>);
                <span class="kw">let </span>other_modulus_len_bits = m_.len_bits();

                <span class="kw">let </span>actual_result = elem_reduced(<span class="kw-2">&amp;</span>a, <span class="kw-2">&amp;</span>m, other_modulus_len_bits);
                <span class="kw">let </span>oneRR = One::newRR(<span class="kw-2">&amp;</span>m);
    ...
    <span class="attr">#[test]
        ...
        test::run(
            ...
            |section, test_case| {
                ...
                <span class="kw">struct </span>M {}
                <span class="kw">struct </span>O {}
                <span class="kw">let </span>m = consume_modulus::&lt;M&gt;(test_case, <span class="string">"m"</span>);
                <span class="kw">let </span>m = m.modulus(cpu_features);
                <span class="kw">let </span>a = consume_elem_unchecked::&lt;O&gt;(test_case, <span class="string">"a"</span>, m.limbs().len());
                <span class="kw">let </span>expected_result = consume_elem::&lt;M&gt;(test_case, <span class="string">"r"</span>, <span class="kw-2">&amp;</span>m);
                <span class="kw">let </span>other_modulus_len_bits = m.len_bits();

                <span class="kw">let </span>actual_result = elem_reduced_once(<span class="kw-2">&amp;</span>a, <span class="kw-2">&amp;</span>m, other_modulus_len_bits);
                assert_elem_eq(<span class="kw-2">&amp;</span>actual_result, <span class="kw-2">&amp;</span>expected_result);
    ...
    <span class="kw">fn </span>consume_elem_unchecked&lt;M&gt;(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>limbs = BoxedLimbs::zero(num_limbs);
        limb::parse_big_endian_and_pad_consttime(untrusted::Input::from(<span class="kw-2">&amp;</span>bytes), <span class="kw-2">&amp;mut </span>limbs)
            .unwrap();
        Elem {
            limbs,
            encoding: PhantomData,
    ...
    <span class="kw">fn </span>consume_modulus&lt;M&gt;(test_case: <span class="kw-2">&amp;mut </span>test::TestCase, name: <span class="kw-2">&amp;</span>str) -&gt; OwnedModulus&lt;M&gt; {
        <span class="kw">let </span>value = test_case.consume_bytes(name);
        OwnedModulus::from_be_bytes(untrusted::Input::from(<span class="kw-2">&amp;</span>value)).unwrap()
    }

    <span class="kw">fn </span>assert_elem_eq&lt;M, E&gt;(a: <span class="kw-2">&amp;</span>Elem&lt;M, E&gt;, b: <span class="kw-2">&amp;</span>Elem&lt;M, E&gt;) {
        <span class="kw">if </span>elem_verify_equal_consttime(a, b).is_err() {
    ...
    <span class="kw">fn </span>into_encoded&lt;M&gt;(a: Elem&lt;M, Unencoded&gt;, m: <span class="kw-2">&amp;</span>Modulus&lt;M&gt;) -&gt; Elem&lt;M, R&gt; {
        <span class="kw">let </span>oneRR = One::newRR(m);
