...
<span class="attr">#[inline(always)]
    ...
    </span><span class="kw">use </span>arm::init_global_shared_with_assembly;

    <span class="attr">#[cfg(any(target_arch = <span class="string">"x86"</span>, target_arch = <span class="string">"x86_64"</span>))]
    </span><span class="kw">use </span>intel::init_global_shared_with_assembly;
    ...
    <span class="attr">#[cfg(any(
        ...
        <span class="kw">let </span>() = INIT.call_once(|| <span class="kw">unsafe </span>{ init_global_shared_with_assembly() });
    }
...
<span class="attr">#[cfg(any(target_arch = <span class="string">"x86"</span>, target_arch = <span class="string">"x86_64"</span>))]
</span><span class="kw">pub mod </span>intel;
