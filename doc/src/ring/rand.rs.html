...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">mod </span>sealed {
    ...
    <span class="kw">impl</span>&lt;<span class="kw">const </span>N: usize&gt; RandomlyConstructable <span class="kw">for </span>[u8; N] {
        ...
        <span class="attr">#[inline]
        </span><span class="kw">fn </span>as_mut_bytes(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;mut </span>[u8] {
...
<span class="comment">// Use the `getrandom` crate whenever it is using the environment's (operating
// system's) CSPRNG. Avoid using it on targets where it uses the `rdrand`
// implementation.
</span><span class="attr">#[cfg(any(
    all(feature = <span class="string">"less-safe-getrandom-custom-or-rdrand"</span>, target_os = <span class="string">"none"</span>),
    ...
    all(
        ...
        any(
            ...
            all(target_os = <span class="string">"unknown"</span>, feature = <span class="string">"wasm32_unknown_unknown_js"</span>)
        )
    ),
))]
</span><span class="kw">impl </span>sealed::SecureRandom <span class="kw">for </span>SystemRandom {
    <span class="attr">#[inline(always)]
    </span><span class="kw">fn </span>fill_impl(<span class="kw-2">&amp;</span><span class="self">self</span>, dest: <span class="kw-2">&amp;mut </span>[u8]) -&gt; <span class="prelude-ty">Result</span>&lt;(), error::Unspecified&gt; {
        getrandom::getrandom(dest).map_err(|<span class="kw">_</span>| error::Unspecified)
    }
}
