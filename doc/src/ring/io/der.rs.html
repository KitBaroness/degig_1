...
#[repr(u8)]
    ...
    ContextSpecific1 = CONTEXT_SPECIFIC | <span class="number">1</span>,
...
</span><span class="kw">pub fn </span>bit_string_with_no_unused_bits&lt;<span class="lifetime">'a</span>&gt;(
    input: <span class="kw-2">&amp;mut </span>untrusted::Reader&lt;<span class="lifetime">'a</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;untrusted::Input&lt;<span class="lifetime">'a</span>&gt;, error::Unspecified&gt; {
    bit_string_tagged_with_no_unused_bits(Tag::BitString, input)
}

<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>bit_string_tagged_with_no_unused_bits&lt;<span class="lifetime">'a</span>&gt;(
    tag: Tag,
    input: <span class="kw-2">&amp;mut </span>untrusted::Reader&lt;<span class="lifetime">'a</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;untrusted::Input&lt;<span class="lifetime">'a</span>&gt;, error::Unspecified&gt; {
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>nonnegative_integer&lt;<span class="lifetime">'a</span>&gt;(
    input: <span class="kw-2">&amp;mut </span>untrusted::Reader&lt;<span class="lifetime">'a</span>&gt;,
) -&gt; <span class="prelude-ty">Result</span>&lt;untrusted::Input&lt;<span class="lifetime">'a</span>&gt;, error::Unspecified&gt; {
    ...
    <span class="kw">match </span>value
        ...
        <span class="comment">// Zero or leading zero.
        </span>(<span class="number">0</span>, rest) =&gt; {
            <span class="kw">match </span>rest.first() {
                <span class="comment">// Zero.
                </span><span class="prelude-val">None </span>=&gt; <span class="prelude-val">Ok</span>(value),
                <span class="comment">// Necessary leading zero.
                </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>second) <span class="kw">if </span>second &amp; <span class="number">0x80 </span>== <span class="number">0x80 </span>=&gt; <span class="prelude-val">Ok</span>(untrusted::Input::from(rest)),
                <span class="comment">// Unnecessary leading zero.
                </span><span class="kw">_ </span>=&gt; <span class="prelude-val">Err</span>(error::Unspecified),
            }
        }
        <span class="comment">// Positive value with no leading zero.
        </span>(first, <span class="kw">_</span>) <span class="kw">if </span>first &amp; <span class="number">0x80 </span>== <span class="number">0 </span>=&gt; <span class="prelude-val">Ok</span>(value),
        <span class="comment">// Negative value.
        </span>(<span class="kw">_</span>, <span class="kw">_</span>) =&gt; <span class="prelude-val">Err</span>(error::Unspecified),
    }
}
...
/// numeric value. This is typically used for parsing version numbers.
    ...
    <span class="kw">let </span>value = nonnegative_integer(input)<span class="question-mark">?</span>;
    <span class="kw">match </span><span class="kw-2">*</span>value.as_slice_less_safe() {
        [b] =&gt; <span class="prelude-val">Ok</span>(b),
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">fn </span>with_i&lt;<span class="lifetime">'a</span>, F, R&gt;(value: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[u8], f: F) -&gt; <span class="prelude-ty">Result</span>&lt;R, error::Unspecified&gt;
    <span class="kw">where
        </span>F: FnOnce(<span class="kw-2">&amp;mut </span>untrusted::Reader&lt;<span class="lifetime">'a</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;R, error::Unspecified&gt;,
    {
    ...
    <span class="kw">static </span>GOOD_POSITIVE_INTEGERS_SMALL: <span class="kw-2">&amp;</span>[(<span class="kw-2">&amp;</span>[u8], u8)] = <span class="kw-2">&amp;</span>[
    ...
    <span class="kw">static </span>GOOD_POSITIVE_INTEGERS_LARGE: <span class="kw-2">&amp;</span>[(<span class="kw-2">&amp;</span>[u8], <span class="kw-2">&amp;</span>[u8])] = <span class="kw-2">&amp;</span>[
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x02</span>, <span class="number">0x01</span>, <span class="number">0x00</span>], <span class="kw-2">&amp;</span>[<span class="number">0x01</span>, <span class="number">0x00</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x02</span>, <span class="number">0x02</span>, <span class="number">0x01</span>], <span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x01</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x02</span>, <span class="number">0x7e</span>, <span class="number">0xfe</span>], <span class="kw-2">&amp;</span>[<span class="number">0x7e</span>, <span class="number">0xfe</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x02</span>, <span class="number">0x7f</span>, <span class="number">0xff</span>], <span class="kw-2">&amp;</span>[<span class="number">0x7f</span>, <span class="number">0xff</span>]),
        <span class="comment">// Values that need to have an 0x00 prefix to disambiguate them from
        // them from negative values.
        </span>(<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x03</span>, <span class="number">0x00</span>, <span class="number">0x80</span>, <span class="number">0x00</span>], <span class="kw-2">&amp;</span>[<span class="number">0x80</span>, <span class="number">0x00</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x03</span>, <span class="number">0x00</span>, <span class="number">0x81</span>, <span class="number">0x01</span>], <span class="kw-2">&amp;</span>[<span class="number">0x81</span>, <span class="number">0x01</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x03</span>, <span class="number">0x00</span>, <span class="number">0xfe</span>, <span class="number">0xfe</span>], <span class="kw-2">&amp;</span>[<span class="number">0xfe</span>, <span class="number">0xfe</span>]),
        (<span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x03</span>, <span class="number">0x00</span>, <span class="number">0xff</span>, <span class="number">0xff</span>], <span class="kw-2">&amp;</span>[<span class="number">0xff</span>, <span class="number">0xff</span>]),
    ];
    ...
    <span class="kw">static </span>BAD_NONNEGATIVE_INTEGERS: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[u8]] = <span class="kw-2">&amp;</span>[
        ...
        <span class="comment">// Would be valid if leading zero is ignored when comparing length.
        </span><span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x01</span>, <span class="number">0x00</span>, <span class="number">0x01</span>],
        ...
        <span class="comment">// Values that are missing a necessary leading 0x00
        </span><span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x01</span>, <span class="number">0x80</span>],
        <span class="kw-2">&amp;</span>[<span class="number">0x02</span>, <span class="number">0x01</span>, <span class="number">0x81</span>],
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>zero = (ZERO_INTEGER, <span class="number">0x00</span>);
        <span class="kw">for </span><span class="kw-2">&amp;</span>(test_in, test_out) <span class="kw">in
            </span>core::iter::once(<span class="kw-2">&amp;</span>zero).chain(GOOD_POSITIVE_INTEGERS_SMALL.iter())
        {
            <span class="kw">let </span>result = with_i(test_in, |input| {
                <span class="macro">assert_eq!</span>(small_nonnegative_integer(input)<span class="question-mark">?</span>, test_out);
                <span class="prelude-val">Ok</span>(())
            });
            <span class="macro">assert_eq!</span>(result, <span class="prelude-val">Ok</span>(()));
        }
        <span class="kw">for </span><span class="kw-2">&amp;</span>test_in <span class="kw">in </span>BAD_NONNEGATIVE_INTEGERS
            .iter()
            .chain(GOOD_POSITIVE_INTEGERS_LARGE.iter().map(|(input, <span class="kw">_</span>)| input))
        {
            <span class="kw">let </span>result = with_i(test_in, small_nonnegative_integer);
            <span class="macro">assert_eq!</span>(result, <span class="prelude-val">Err</span>(error::Unspecified));
        }
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_positive_integer() {
        <span class="kw">for </span>(test_in, test_out) <span class="kw">in </span>GOOD_POSITIVE_INTEGERS_SMALL
            .iter()
            .map(|(test_in, test_out)| (<span class="kw-2">*</span>test_in, core::slice::from_ref(test_out)))
            .chain(GOOD_POSITIVE_INTEGERS_LARGE.iter().copied())
        {
            <span class="kw">let </span>result = with_i(test_in, |input| {
                <span class="macro">assert_eq!</span>(
                    positive_integer(input)<span class="question-mark">?</span>.big_endian_without_leading_zero(),
                    test_out
                );
                <span class="prelude-val">Ok</span>(())
            });
        ...
        <span class="kw">for </span><span class="kw-2">&amp;</span>test_in <span class="kw">in </span>core::iter::once(<span class="kw-2">&amp;</span>ZERO_INTEGER).chain(BAD_NONNEGATIVE_INTEGERS.iter()) {
            <span class="kw">let </span>result = with_i(test_in, positive_integer);
            <span class="macro">assert!</span>(<span class="macro">matches!</span>(result, <span class="prelude-val">Err</span>(error::Unspecified)));
        }
    }
}
