...
</span><span class="kw">use super</span>::{Aad, Algorithm, BoundKey, LessSafeKey, NonceSequence, Tag, UnboundKey};
<span class="kw">use </span><span class="kw">crate</span>::error;

<span class="doccomment">/// An AEAD key for encrypting and signing ("sealing"), bound to a nonce
/// sequence.
///
/// Intentionally not `Clone` or `Copy` since cloning would allow duplication
/// of the nonce sequence.
</span><span class="kw">pub struct </span>SealingKey&lt;N: NonceSequence&gt; {
    key: LessSafeKey,
    nonce_sequence: N,
}

<span class="kw">impl</span>&lt;N: NonceSequence&gt; BoundKey&lt;N&gt; <span class="kw">for </span>SealingKey&lt;N&gt; {
...
<span class="kw">impl</span>&lt;N: NonceSequence&gt; core::fmt::Debug <span class="kw">for </span>SealingKey&lt;N&gt; {
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter) -&gt; <span class="prelude-ty">Result</span>&lt;(), core::fmt::Error&gt; {
        <span class="self">self</span>.key.fmt_debug(<span class="string">"SealingKey"</span>, f)
    }
}

<span class="kw">impl</span>&lt;N: NonceSequence&gt; SealingKey&lt;N&gt; {
    <span class="doccomment">/// Encrypts and signs (“seals”) data in place, appending the tag to the
        ...
        InOut: AsMut&lt;[u8]&gt; + <span class="kw">for</span>&lt;<span class="lifetime">'in_out</span>&gt; Extend&lt;<span class="kw-2">&amp;</span><span class="lifetime">'in_out </span>u8&gt;,
    {
        <span class="self">self</span>.key
            .seal_in_place_append_tag(<span class="self">self</span>.nonce_sequence.advance()<span class="question-mark">?</span>, aad, in_out)
    }

    <span class="doccomment">/// Encrypts and signs (“seals”) data in place.
    ///
    ...
    {
        <span class="self">self</span>.key
            .seal_in_place_separate_tag(<span class="self">self</span>.nonce_sequence.advance()<span class="question-mark">?</span>, aad, in_out)
    }
}
