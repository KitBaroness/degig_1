...
<span class="kw">fn </span>chacha20_init(key: <span class="kw-2">&amp;</span>[u8], _cpu_features: cpu::Features) -&gt; <span class="prelude-ty">Result</span>&lt;KeyInner, error::Unspecified&gt; {
    <span class="kw">let </span>chacha20_key: [u8; chacha::KEY_LEN] = key.try_into()<span class="question-mark">?</span>;
    <span class="prelude-val">Ok</span>(KeyInner::ChaCha20(chacha::Key::new(chacha20_key)))
}
