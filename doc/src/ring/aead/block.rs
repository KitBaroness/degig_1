...
</span><span class="kw">use </span><span class="kw">crate</span>::polyfill::ArrayFlatten;
<span class="kw">use </span>core::ops::{BitXor, BitXorAssign};

<span class="attr">#[repr(transparent)]
#[derive(Copy, Clone)]
</span><span class="kw">pub struct </span>Block([u8; <span class="number">16</span>]);
...
<span class="kw">impl </span>Block {
    <span class="attr">#[inline]
        ...
        <span class="self">Self</span>([<span class="number">0</span>; <span class="number">16</span>])
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>tmp: [u8; BLOCK_LEN] = <span class="kw-2">*</span><span class="self">self</span>.as_ref();
        tmp[index..].fill(<span class="number">0</span>);
        <span class="kw-2">*</span><span class="self">self </span>= <span class="self">Self</span>::from(<span class="kw-2">&amp;</span>tmp)
    }
}

<span class="kw">impl </span>BitXorAssign <span class="kw">for </span>Block {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>bitxor_assign(<span class="kw-2">&amp;mut </span><span class="self">self</span>, a: <span class="self">Self</span>) {
        <span class="comment">// Relies heavily on optimizer to optimize this into word- or vector-
        // level XOR.
        </span><span class="kw">for </span>(r, a) <span class="kw">in </span><span class="self">self</span>.<span class="number">0</span>.iter_mut().zip(a.<span class="number">0</span>.iter()) {
            <span class="kw-2">*</span>r ^= <span class="kw-2">*</span>a;
        }
    }
}

<span class="kw">impl </span>BitXor <span class="kw">for </span>Block {
    <span class="kw">type </span>Output = <span class="self">Self</span>;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>bitxor(<span class="self">self</span>, a: <span class="self">Self</span>) -&gt; <span class="self">Self </span>{
...
<span class="kw">impl</span>&lt;T&gt; From&lt;T&gt; <span class="kw">for </span>Block
<span class="kw">where
    </span>T: ArrayFlatten&lt;Output = [u8; <span class="number">16</span>]&gt;,
{
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>from(bytes: T) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>(bytes.array_flatten())
    }
}
