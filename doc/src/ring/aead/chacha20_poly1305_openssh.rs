...
<span class="kw">use crate</span>::{constant_time, error};
...
<span class="kw">impl </span>SealingKey {
    ...
    </span><span class="kw">pub fn </span>new(key_material: <span class="kw-2">&amp;</span>[u8; KEY_LEN]) -&gt; <span class="self">Self </span>{
    ...
    /// is encrypted with `K_1` and `ciphertext` is encrypted by `K_2`.
        ...
        <span class="kw">let </span>poly_key = derive_poly1305_key(<span class="kw-2">&amp;</span><span class="self">self</span>.key.k_2, counter.increment());
        ...
        <span class="kw">let </span>Tag(tag) = poly1305::sign(poly_key, plaintext_in_ciphertext_out, cpu_features);
...
<span class="kw">impl </span>OpeningKey {
    ...
    /// and must not be used.
        ...
        </span><span class="kw">let </span>poly_key = derive_poly1305_key(<span class="kw-2">&amp;</span><span class="self">self</span>.key.k_2, counter.increment());
...
<span class="kw">impl </span>Key {
    <span class="kw">fn </span>new(key_material: <span class="kw-2">&amp;</span>[u8; KEY_LEN]) -&gt; <span class="self">Self </span>{
...
<span class="kw">fn </span>make_counter(sequence_number: u32) -&gt; Counter {
    <span class="kw">let </span>[s0, s1, s2, s3] = sequence_number.to_be_bytes();
    <span class="kw">let </span>nonce = [<span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, <span class="number">0</span>, s0, s1, s2, s3];
...
</span><span class="kw">pub const </span>TAG_LEN: usize = <span class="kw">super</span>::TAG_LEN;
...
<span class="kw">fn </span>verify(key: poly1305::Key, msg: <span class="kw-2">&amp;</span>[u8], tag: <span class="kw-2">&amp;</span>[u8; TAG_LEN]) -&gt; <span class="prelude-ty">Result</span>&lt;(), error::Unspecified&gt; {
    <span class="kw">let </span>Tag(calculated_tag) = poly1305::sign(key, msg, cpu::features());
