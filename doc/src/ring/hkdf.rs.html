...
<span class="kw">impl </span>Salt {
    ...
    /// `Salt` object instead of re-constructing `Salt`s with the same value.
        ...
        <span class="self">Self</span>(hmac::Key::new(algorithm.<span class="number">0</span>, value))
    }
