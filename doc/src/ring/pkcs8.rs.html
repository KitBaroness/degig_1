...
<span class="kw">fn </span>unwrap_key__&lt;<span class="lifetime">'a</span>&gt;(
    ...
    <span class="kw">let </span>public_key = <span class="kw">if let </span><span class="prelude-val">Some</span>(options) = public_key_options {
        ...
        <span class="kw">let </span>result =
            <span class="kw">if </span>options.accept_legacy_ed25519_public_key_tag &amp;&amp; input.peek(INCORRECT_LEGACY <span class="kw">as </span>u8) {
                der::nested(
                    input,
                    INCORRECT_LEGACY,
                    error::Unspecified,
