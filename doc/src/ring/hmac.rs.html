...
<span class="kw">impl </span>Key {
    ...
    /// removed in a future version of *ring*.
        ...
        <span class="kw">let </span>block_len = digest_alg.block_len();

        <span class="kw">let </span>key_hash;
        <span class="kw">let </span>key_value = <span class="kw">if </span>key_value.len() &lt;= block_len {
            key_value
        ...
        <span class="kw">let </span>padded_key = <span class="kw-2">&amp;mut </span>padded_key[..block_len];
...
<span class="kw">impl </span>From&lt;hkdf::Okm&lt;<span class="lifetime">'_</span>, Algorithm&gt;&gt; <span class="kw">for </span>Key {
    <span class="kw">fn </span>from(okm: hkdf::Okm&lt;Algorithm&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::construct(<span class="kw-2">*</span>okm.len(), |buf| okm.fill(buf)).unwrap()
    }
}
