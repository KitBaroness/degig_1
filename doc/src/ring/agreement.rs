...
<span class="kw">impl </span>EphemeralPrivateKey {
    <span class="doccomment">/// Generate a new ephemeral private key for the given algorithm.
        ...
        </span><span class="kw">let </span>private_key = ec::Seed::generate(alg.curve, rng, cpu_features)<span class="question-mark">?</span>;
...
</span><span class="kw">pub fn </span>agree_ephemeral&lt;B: AsRef&lt;[u8]&gt;, R&gt;(
    my_private_key: EphemeralPrivateKey,
    peer_public_key: <span class="kw-2">&amp;</span>UnparsedPublicKey&lt;B&gt;,
    kdf: <span class="kw">impl </span>FnOnce(<span class="kw-2">&amp;</span>[u8]) -&gt; R,
) -&gt; <span class="prelude-ty">Result</span>&lt;R, error::Unspecified&gt; {
...
<span class="kw">fn </span>agree_ephemeral_&lt;R&gt;(
    my_private_key: EphemeralPrivateKey,
    ...
    </span><span class="prelude-val">Ok</span>(kdf(shared_key))
}
