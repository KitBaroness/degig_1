...
</pre></div><pre class="rust"><code><span class="comment">// Copyright 2017 Brian Smith.
//
...
/// with respect to *m*; i.e. the 0 &lt;= x &lt; m for every value x.
    ...
    </span><span class="kw">pub</span>(<span class="kw">super</span>) limbs: [Limb; MAX_LIMBS],

    <span class="doccomment">/// The modulus *m* for the ring ℤ/mℤ for which this element is a value.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) m: PhantomData&lt;M&gt;,

    <span class="doccomment">/// The number of Montgomery factors that need to be canceled out from
    /// `value` to get the actual value.
    </span><span class="kw">pub</span>(<span class="kw">super</span>) encoding: PhantomData&lt;E&gt;,
}
...
<span class="kw">impl</span>&lt;M, E: Encoding&gt; Elem&lt;M, E&gt; {
    ...
    <span class="kw">pub const fn </span>from_hex(hex: <span class="kw-2">&amp;</span>str) -&gt; <span class="self">Self </span>{
        Elem {
