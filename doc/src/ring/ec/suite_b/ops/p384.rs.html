...
<span class="kw">pub static </span>COMMON_OPS: CommonOps = CommonOps {
    ...
    q: Modulus {
        ...
        rr: limbs_from_hex(<span class="string">"10000000200000000fffffffe000000000000000200000000fffffffe00000001"</span>),
    },
    n: Elem::from_hex(<span class="string">"ffffffffffffffffffffffffffffffffffffffffffffffffc7634d81f4372ddf581a0db248b0a77aecec196accc52973"</span>),

    a: Elem::from_hex(<span class="string">"fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffbfffffffc0000000000000003fffffffc"</span>),
    b: Elem::from_hex(<span class="string">"cd08114b604fbff9b62b21f41f022094e3374bee94938ae277f2209b1920022ef729add87a4c32ec081188719d412dcc"</span>),
...
<span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">static </span>GENERATOR: (Elem&lt;R&gt;, Elem&lt;R&gt;) = (
    Elem::from_hex(<span class="string">"4d3aadc2299e1513812ff723614ede2b6454868459a30eff879c3afc541b4d6e20e378e2a0d6ce383dd0756649c0b528"</span>),
    Elem::from_hex(<span class="string">"2b78abc25a15c5e9dd8002263969a840c6c3521968f4ffd98bade7562e83b050a1bfa8bf7bb4a9ac23043dad4b03a4fe"</span>),
);
...
<span class="kw">fn </span>p384_point_mul_base_impl(a: <span class="kw-2">&amp;</span>Scalar) -&gt; Point {
    ...
    </span>PRIVATE_KEY_OPS.point_mul(a, <span class="kw-2">&amp;</span>GENERATOR)
}
...
<span class="kw">pub static </span>PUBLIC_SCALAR_OPS: PublicScalarOps = PublicScalarOps {
    ...
    q_minus_n: Elem::from_hex(<span class="string">"389cb27e0bc8d21fa7e5f24cb74f58851313e696333ad68c"</span>),
...
<span class="kw">pub static </span>PRIVATE_SCALAR_OPS: PrivateScalarOps = PrivateScalarOps {
    ...
    oneRR_mod_n: Scalar::from_hex(<span class="string">"c84ee012b39bf213fb05b7a28266895d40d49174aab1cc5bc3e483afcb82947ff3d81e5df1aa4192d319b2419b409a9"</span>),
    scalar_inv_to_mont: p384_scalar_inv_to_mont,
};

<span class="kw">fn </span>p384_scalar_inv_to_mont(a: Scalar&lt;R&gt;) -&gt; Scalar&lt;R&gt; {
