...
</pre></div><pre class="rust"><code><span class="comment">// Copyright 2016 Brian Smith.
//
...
</span><span class="kw">use crate</span>::{arithmetic::limbs_from_hex, arithmetic::montgomery::<span class="kw-2">*</span>, error, limb::<span class="kw-2">*</span>};
...
<span class="kw">impl </span>Point {
    <span class="kw">pub fn </span>new_at_infinity() -&gt; <span class="self">Self </span>{
...
<span class="doccomment">/// Operations and values needed by all curve operations.
    ...
    </span>elem_mul_mont: <span class="kw">unsafe extern </span><span class="string">"C" </span><span class="kw">fn</span>(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb, b: <span class="kw-2">*const </span>Limb),
...
<span class="kw">impl </span>CommonOps {
    <span class="comment">// The length of a field element, which is the same as the length of a
    // scalar, in bytes.
    </span><span class="kw">pub fn </span>len(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; usize {
        <span class="self">self</span>.num_limbs * LIMB_BYTES
    }

    <span class="attr">#[cfg(test)]
    </span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>n_limbs(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>[Limb] {
        <span class="kw-2">&amp;</span><span class="self">self</span>.n.limbs[..<span class="self">self</span>.num_limbs]
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>num_limbs = <span class="self">self</span>.num_limbs;
        limbs_add_assign_mod(
            <span class="kw-2">&amp;mut </span>a.limbs[..num_limbs],
            <span class="kw-2">&amp;</span>b.limbs[..num_limbs],
            <span class="kw-2">&amp;</span><span class="self">self</span>.q.p[..num_limbs],
        );
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">const </span>ONE: Elem&lt;Unencoded&gt; = Elem::from_hex(<span class="string">"1"</span>);
...
<span class="kw">impl </span>PrivateKeyOps {
    <span class="kw">pub fn </span>leak_limbs&lt;<span class="lifetime">'a</span>&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, a: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Elem&lt;Unencoded&gt;) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'a </span>[Limb] {
        <span class="kw-2">&amp;</span>a.limbs[..<span class="self">self</span>.common.num_limbs]
    }
...
<span class="kw">impl </span>PublicKeyOps {
    ...
    // in the interval [0, p-1] in the case that q is an odd prime p[.]"
        ...
        <span class="kw">let </span>encoded_value = input.read_bytes(<span class="self">self</span>.common.len())<span class="question-mark">?</span>;
...
<span class="kw">impl </span>ScalarOps {
    <span class="comment">// The (maximum) length of a scalar, not including any padding.
        ...
        <span class="self">self</span>.common.len()
    }

    <span class="kw">pub fn </span>leak_limbs&lt;<span class="lifetime">'s</span>&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>, s: <span class="kw-2">&amp;</span><span class="lifetime">'s </span>Scalar) -&gt; <span class="kw-2">&amp;</span><span class="lifetime">'s </span>[Limb] {
        <span class="kw-2">&amp;</span>s.limbs[..<span class="self">self</span>.common.num_limbs]
    }
...
<span class="doccomment">/// Operations on public scalars needed by ECDSA signature verification.
    ...
    <span class="kw">pub </span>twin_mul: <span class="kw">fn</span>(g_scalar: <span class="kw-2">&amp;</span>Scalar, p_scalar: <span class="kw-2">&amp;</span>Scalar, p_xy: <span class="kw-2">&amp;</span>(Elem&lt;R&gt;, Elem&lt;R&gt;)) -&gt; Point,
    <span class="kw">pub </span>scalar_inv_to_mont_vartime: <span class="kw">fn</span>(s: <span class="kw-2">&amp;</span>Scalar&lt;Unencoded&gt;) -&gt; Scalar&lt;R&gt;,
    <span class="kw">pub </span>q_minus_n: Elem&lt;Unencoded&gt;,
}

<span class="kw">impl </span>PublicScalarOps {
    <span class="kw">pub fn </span>n(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>Elem&lt;Unencoded&gt; {
        <span class="kw-2">&amp;</span><span class="self">self</span>.scalar_ops.common.n
    }
    ...
    <span class="kw">pub fn </span>elem_equals_vartime(<span class="kw-2">&amp;</span><span class="self">self</span>, a: <span class="kw-2">&amp;</span>Elem&lt;Unencoded&gt;, b: <span class="kw-2">&amp;</span>Elem&lt;Unencoded&gt;) -&gt; bool {
        a.limbs[..<span class="self">self</span>.public_key_ops.common.num_limbs]
            == b.limbs[..<span class="self">self</span>.public_key_ops.common.num_limbs]
    }
    ...
    <span class="kw">pub fn </span>scalar_inv_to_mont_vartime(<span class="kw-2">&amp;</span><span class="self">self</span>, s: <span class="kw-2">&amp;</span>Scalar&lt;Unencoded&gt;) -&gt; Scalar&lt;R&gt; {
        (<span class="self">self</span>.scalar_inv_to_mont_vartime)(s)
    }
}
...
<span class="attr">#[allow(non_snake_case)]
    ...
    oneRR_mod_n: Scalar&lt;RR&gt;, <span class="comment">// 1 * R**2 (mod n). TOOD: Use One&lt;RR&gt;.
    </span>scalar_inv_to_mont: <span class="kw">fn</span>(a: Scalar&lt;R&gt;) -&gt; Scalar&lt;R&gt;,
}

<span class="kw">impl </span>PrivateScalarOps {
    <span class="kw">pub fn </span>to_mont(<span class="kw-2">&amp;</span><span class="self">self</span>, s: <span class="kw-2">&amp;</span>Scalar&lt;Unencoded&gt;) -&gt; Scalar&lt;R&gt; {
        <span class="self">self</span>.scalar_ops.scalar_product(s, <span class="kw-2">&amp;</span><span class="self">self</span>.oneRR_mod_n)
    }

    <span class="doccomment">/// Returns the modular inverse of `a` (mod `n`). Panics if `a` is zero.
        ...
        <span class="macro">assert!</span>(!<span class="self">self</span>.scalar_ops.common.is_zero(a));
        <span class="kw">let </span>a = <span class="self">self</span>.to_mont(a);
        (<span class="self">self</span>.scalar_inv_to_mont)(a)
    }
}

<span class="comment">// XXX: Inefficient and unnecessarily depends on `PrivateKeyOps`. TODO: implement interleaved wNAF
// multiplication.
</span><span class="kw">fn </span>twin_mul_inefficient(
    ...
    <span class="kw">let </span>scaled_g = ops.point_mul_base(g_scalar);
...
<span class="kw">pub fn </span>scalar_sum(ops: <span class="kw-2">&amp;</span>CommonOps, a: <span class="kw-2">&amp;</span>Scalar, <span class="kw-2">mut </span>b: Scalar) -&gt; Scalar {
    limbs_add_assign_mod(
        <span class="kw-2">&amp;mut </span>b.limbs[..ops.num_limbs],
        <span class="kw-2">&amp;</span>a.limbs[..ops.num_limbs],
...
<span class="kw">pub fn </span>scalar_parse_big_endian_partially_reduced_variable_consttime(
    ...
    {
        <span class="kw">let </span>r = <span class="kw-2">&amp;mut </span>r.limbs[..ops.num_limbs];
        parse_big_endian_and_pad_consttime(bytes, r)<span class="question-mark">?</span>;
        limbs_reduce_once_constant_time(r, <span class="kw-2">&amp;</span>ops.n.limbs[..ops.num_limbs]);
    }
...
<span class="kw">fn </span>parse_big_endian_fixed_consttime&lt;M&gt;(
    ...
    <span class="kw">if </span>bytes.len() != ops.len() {
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">trait </span>Convert&lt;E: Encoding&gt; {
        <span class="kw">fn </span>convert(<span class="self">self</span>, cops: <span class="kw-2">&amp;</span>CommonOps) -&gt; Elem&lt;E&gt;;
    }

    <span class="kw">impl </span>Convert&lt;R&gt; <span class="kw">for </span>Elem&lt;R&gt; {
        <span class="kw">fn </span>convert(<span class="self">self</span>, _cops: <span class="kw-2">&amp;</span>CommonOps) -&gt; Elem&lt;R&gt; {
            <span class="self">self
        </span>}
    }

    <span class="kw">impl </span>Convert&lt;Unencoded&gt; <span class="kw">for </span>Elem&lt;R&gt; {
        <span class="kw">fn </span>convert(<span class="self">self</span>, cops: <span class="kw-2">&amp;</span>CommonOps) -&gt; Elem&lt;Unencoded&gt; {
            cops.elem_unencoded(<span class="kw-2">&amp;</span><span class="self">self</span>)
        }
    }
    ...
    <span class="comment">// XXX: There's no `p256_sub` in *ring*; it's logic is inlined into
    // the point arithmetic functions. Thus, we can't test it.
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p384_elem_sub(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb, b: <span class="kw-2">*const </span>Limb);
        }
        elem_sub_test(
    ...
    <span class="comment">// XXX: There's no `p256_div_by_2` in *ring*; it's logic is inlined
    // into the point arithmetic functions. Thus, we can't test it.

    </span><span class="attr">#[test]
    </span><span class="kw">fn </span>p384_elem_div_by_2_test() {
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p384_elem_div_by_2(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb);
        }
        elem_div_by_2_test(
            <span class="kw-2">&amp;</span>p384::COMMON_OPS,
            p384_elem_div_by_2,
    ...
    <span class="comment">// There is no `ecp_nistz256_neg` on other targets.
    </span><span class="attr">#[cfg(target_arch = <span class="string">"x86_64"</span>)]
    #[test]
    </span><span class="kw">fn </span>p256_elem_neg_test() {
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>ecp_nistz256_neg(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb);
        }
        elem_neg_test(
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p384_elem_neg(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb);
        }
        elem_neg_test(
            <span class="kw-2">&amp;</span>p384::COMMON_OPS,
            p384_elem_neg,
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p256_scalar_sqr_rep_mont(r: <span class="kw-2">*mut </span>Limb, a: <span class="kw-2">*const </span>Limb, rep: Limb);
        }
        scalar_square_test(
            <span class="kw-2">&amp;</span>p256::SCALAR_OPS,
    ...
    <span class="attr">#[test]
    #[should_panic(expected = <span class="string">"!self.scalar_ops.common.is_zero(a)"</span>)]
    </span><span class="kw">fn </span>p256_scalar_inv_to_mont_zero_panic_test() {
        <span class="kw">let _ </span>= p256::PRIVATE_SCALAR_OPS.scalar_inv_to_mont(<span class="kw-2">&amp;</span>ZERO_SCALAR);
    }

    <span class="attr">#[test]
    #[should_panic(expected = <span class="string">"!self.scalar_ops.common.is_zero(a)"</span>)]
    </span><span class="kw">fn </span>p384_scalar_inv_to_mont_zero_panic_test() {
        <span class="kw">let _ </span>= p384::PRIVATE_SCALAR_OPS.scalar_inv_to_mont(<span class="kw-2">&amp;</span>ZERO_SCALAR);
    }
    ...
    <span class="kw">fn </span>point_sum_test(ops: <span class="kw-2">&amp;</span>PrivateKeyOps, test_file: test::File) {
        test::run(test_file, |section, test_case| {
            ...
            <span class="kw">let </span>r_expected: TestPoint&lt;R&gt; = consume_point(ops, test_case, <span class="string">"r"</span>);
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p256_point_add_affine(
    ...
    <span class="comment">// XXX: There is no `nistz384_point_add_affine()`.
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p256_point_double(
                r: <span class="kw-2">*mut </span>Limb,   <span class="comment">// [p256::COMMON_OPS.num_limbs*3]
                </span>a: <span class="kw-2">*const </span>Limb, <span class="comment">// [p256::COMMON_OPS.num_limbs*3]
            </span>);
        }
    ...
    <span class="attr">#[test]
        ...
        <span class="macro">prefixed_extern!</span> {
            <span class="kw">fn </span>p384_point_double(
    ...
    <span class="doccomment">/// TODO: We should be testing `point_mul` with points other than the generator.
    </span><span class="attr">#[test]
    </span><span class="kw">fn </span>p256_point_mul_test() {
        point_mul_base_tests(
            <span class="kw-2">&amp;</span>p256::PRIVATE_KEY_OPS,
            |s| p256::PRIVATE_KEY_OPS.point_mul(s, <span class="kw-2">&amp;</span>p256::GENERATOR),
    ...
    <span class="doccomment">/// TODO: We should be testing `point_mul` with points other than the generator.
        ...
        point_mul_base_tests(
            <span class="kw-2">&amp;</span>p384::PRIVATE_KEY_OPS,
            |s| p384::PRIVATE_KEY_OPS.point_mul(s, <span class="kw-2">&amp;</span>p384::GENERATOR),
    ...
    <span class="kw">fn </span>point_mul_serialized_test(
        ...
        test::run(test_file, |section, test_case| {
            ...
            <span class="kw">let </span><span class="kw-2">mut </span>actual_result = <span class="macro">vec!</span>[<span class="number">4u8</span>; <span class="number">1 </span>+ (<span class="number">2 </span>* cops.len())];
            {
                <span class="kw">let </span>(x, y) = actual_result[<span class="number">1</span>..].split_at_mut(cops.len());
    ...
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>point_mul_base_tests(
        ops: <span class="kw-2">&amp;</span>PrivateKeyOps,
        f: <span class="kw">impl </span>Fn(<span class="kw-2">&amp;</span>Scalar) -&gt; Point,
        test_file: test::File,
    ) {
        test::run(test_file, |section, test_case| {
            <span class="macro">assert_eq!</span>(section, <span class="string">""</span>);
            <span class="kw">let </span>g_scalar = consume_scalar(ops.common, test_case, <span class="string">"g_scalar"</span>);
            <span class="kw">let </span>expected_result: TestPoint&lt;Unencoded&gt; = consume_point(ops, test_case, <span class="string">"r"</span>);
            <span class="kw">let </span>actual_result = f(<span class="kw-2">&amp;</span>g_scalar);
            assert_point_actual_equals_expected(ops, <span class="kw-2">&amp;</span>actual_result, <span class="kw-2">&amp;</span>expected_result);
            <span class="prelude-val">Ok</span>(())
        })
    }

    <span class="kw">fn </span>assert_point_actual_equals_expected&lt;E: Encoding&gt;(
        ops: <span class="kw-2">&amp;</span>PrivateKeyOps,
        actual_point: <span class="kw-2">&amp;</span>Point,
        expected_point: <span class="kw-2">&amp;</span>TestPoint&lt;E&gt;,
    ) <span class="kw">where
        </span>Elem&lt;R&gt;: Convert&lt;E&gt;,
    {
        <span class="kw">let </span>cops = ops.common;
        <span class="kw">let </span>actual_x = <span class="kw-2">&amp;</span>cops.point_x(actual_point);
        <span class="kw">let </span>actual_y = <span class="kw-2">&amp;</span>cops.point_y(actual_point);
        <span class="kw">let </span>actual_z = <span class="kw-2">&amp;</span>cops.point_z(actual_point);
        <span class="kw">match </span>expected_point {
            TestPoint::Infinity =&gt; {
                <span class="kw">let </span>zero = Elem::zero();
                assert_elems_are_equal(cops, actual_z, <span class="kw-2">&amp;</span>zero);
            }
            TestPoint::Affine(expected_x, expected_y) =&gt; {
                <span class="kw">let </span>zz_inv = ops.elem_inverse_squared(actual_z);
                <span class="kw">let </span>x_aff = cops.elem_product(actual_x, <span class="kw-2">&amp;</span>zz_inv);
                <span class="kw">let </span>y_aff = {
                    <span class="kw">let </span>zzzz_inv = cops.elem_squared(<span class="kw-2">&amp;</span>zz_inv);
                    <span class="kw">let </span>zzz_inv = cops.elem_product(actual_z, <span class="kw-2">&amp;</span>zzzz_inv);
                    cops.elem_product(actual_y, <span class="kw-2">&amp;</span>zzz_inv)
                };

                <span class="kw">let </span>x_aff = x_aff.convert(cops);
                <span class="kw">let </span>y_aff = y_aff.convert(cops);

                assert_elems_are_equal(cops, <span class="kw-2">&amp;</span>x_aff, expected_x);
                assert_elems_are_equal(cops, <span class="kw-2">&amp;</span>y_aff, expected_y);
            }
        }
    }
    ...
    <span class="kw">struct </span>AffinePoint {
        xy: [Limb; <span class="number">2 </span>* MAX_LIMBS],
    }

    <span class="kw">fn </span>consume_affine_point(
        ops: <span class="kw-2">&amp;</span>PrivateKeyOps,
        test_case: <span class="kw-2">&amp;mut </span>test::TestCase,
        name: <span class="kw-2">&amp;</span>str,
    ) -&gt; AffinePoint {
    ...
    <span class="kw">enum </span>TestPoint&lt;E: Encoding&gt; {
        Infinity,
        Affine(Elem&lt;E&gt;, Elem&lt;E&gt;),
    }

    <span class="kw">fn </span>consume_point&lt;E: Encoding&gt;(
        ops: <span class="kw-2">&amp;</span>PrivateKeyOps,
        test_case: <span class="kw-2">&amp;mut </span>test::TestCase,
        name: <span class="kw-2">&amp;</span>str,
    ) -&gt; TestPoint&lt;E&gt; {
        <span class="kw">fn </span>consume_point_elem&lt;E: Encoding&gt;(ops: <span class="kw-2">&amp;</span>CommonOps, elems: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>str], i: usize) -&gt; Elem&lt;E&gt; {
            <span class="kw">let </span>bytes = test::from_hex(elems[i]).unwrap();
            <span class="kw">let </span>bytes = untrusted::Input::from(<span class="kw-2">&amp;</span>bytes);
    ...
    <span class="kw">fn </span>assert_elems_are_equal&lt;E: Encoding&gt;(ops: <span class="kw-2">&amp;</span>CommonOps, a: <span class="kw-2">&amp;</span>Elem&lt;E&gt;, b: <span class="kw-2">&amp;</span>Elem&lt;E&gt;) {
    ...
    <span class="kw">fn </span>assert_limbs_are_equal(
        ...
        <span class="kw">if </span>actual[..ops.num_limbs] != expected[..ops.num_limbs] {
            <span class="kw">let </span><span class="kw-2">mut </span>actual_s = alloc::string::String::new();
            <span class="kw">let </span><span class="kw-2">mut </span>expected_s = alloc::string::String::new();
            <span class="kw">for </span>j <span class="kw">in </span><span class="number">0</span>..ops.num_limbs {
                <span class="kw">let </span>width = LIMB_BITS / <span class="number">4</span>;
                <span class="kw">let </span>formatted = <span class="macro">format!</span>(<span class="string">"{:0width$x}"</span>, actual[ops.num_limbs - j - <span class="number">1</span>]);
                actual_s.push_str(<span class="kw-2">&amp;</span>formatted);
                <span class="kw">let </span>formatted = <span class="macro">format!</span>(<span class="string">"{:0width$x}"</span>, expected[ops.num_limbs - j - <span class="number">1</span>]);
                expected_s.push_str(<span class="kw-2">&amp;</span>formatted);
            }
            <span class="macro">panic!</span>(
                <span class="string">"Actual != Expected,\nActual = {}, Expected = {}"</span>,
                actual_s, expected_s
            );
        }
    }
    ...
    <span class="kw">fn </span>consume_padded_bytes(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>bytes = <span class="macro">vec!</span>[<span class="number">0</span>; ops.len() - unpadded_bytes.len()];
