...
// values like all-zero values and values larger than `n`.
    ...
    <span class="kw">let </span>len = ops.scalar_bytes_len();
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use crate</span>::{digest, ec::suite_b::ops::<span class="kw-2">*</span>, limb, test};
