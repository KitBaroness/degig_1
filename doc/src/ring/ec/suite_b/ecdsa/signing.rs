...
</span><span class="attr">#![allow(clippy::cast_possible_truncation)] </span><span class="comment">// XXX
...
<span class="kw">impl </span>EcdsaKeyPair {
    ...
    /// algorithm identifier in the PKCS#8 header.
        ...
        <span class="self">Self</span>::new(alg, key_pair, rng)
    }
    ...
    <span class="kw">fn </span>new(
        ...
        <span class="kw">let </span>d = alg.private_scalar_ops.to_mont(<span class="kw-2">&amp;</span>d);
    ...
    <span class="doccomment">/// Returns the signature of the `message` using a random nonce generated by `rng`.
    ...
    /// generated by `rng`.
        ...
        <span class="kw">for _ in </span><span class="number">0</span>..<span class="number">100 </span>{
            ...
            <span class="kw">let </span>k_inv = ops.scalar_inv_to_mont(<span class="kw-2">&amp;</span>k);
            ...
            <span class="comment">// Step 6.
                ...
                <span class="kw">let </span>e_plus_dr = scalar_sum(cops, <span class="kw-2">&amp;</span>e, dr);
...
<span class="kw">impl </span>NonceRandomKey {
    <span class="kw">fn </span>new(
        ...
        <span class="prelude-val">Ok</span>(<span class="self">Self</span>(ctx.finish()))
    }
}
...
<span class="kw">fn </span>format_rs_asn1(ops: <span class="kw-2">&amp;</span><span class="lifetime">'static </span>ScalarOps, r: <span class="kw-2">&amp;</span>Scalar, s: <span class="kw-2">&amp;</span>Scalar, out: <span class="kw-2">&amp;mut </span>[u8]) -&gt; usize {
    ...
    // zero.
        ...
        limb::big_endian_from_limbs(ops.leak_limbs(a), <span class="kw-2">&amp;mut </span>fixed[<span class="number">1</span>..]);
        ...
        out[<span class="number">2</span>..][..value.len()].copy_from_slice(value);
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use crate</span>::{rand, signature, test};
        ...
        test::run(
            ...
            |section, test_case| {
                ...
                <span class="kw">let </span>private_key =
                    signature::EcdsaKeyPair::from_private_key_and_public_key(alg, <span class="kw-2">&amp;</span>d, <span class="kw-2">&amp;</span>q, <span class="kw-2">&amp;</span>rng)
                        .unwrap();
