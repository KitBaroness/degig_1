...
<span class="kw">impl </span>signature::VerificationAlgorithm <span class="kw">for </span>EdDSAParameters {
    <span class="kw">fn </span>verify(
        ...
        <span class="kw">unsafe </span>{ x25519_ge_double_scalarmult_vartime(<span class="kw-2">&amp;mut </span>r, <span class="kw-2">&amp;</span>h, <span class="kw-2">&amp;</span>a, <span class="kw-2">&amp;</span>signature_s) };
...
<span class="macro">prefixed_extern!</span> {
    <span class="kw">fn </span>x25519_ge_double_scalarmult_vartime(
