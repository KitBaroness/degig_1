...
impl core::fmt::Debug for PublicModulus {
    ...
    <span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>from_be_bytes(
        ...
        </span><span class="kw">const </span>MIN_BITS: bits::BitLength = bits::BitLength::from_usize_bits(<span class="number">1024</span>);

        <span class="comment">// Step 3 / Step c for `n` (out of order).
        </span><span class="kw">let </span>value = bigint::OwnedModulus::from_be_bytes(n)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>bits_rounded_up =
            bits::BitLength::from_usize_bytes(bits.as_usize_bytes_rounded_up()).unwrap(); <span class="comment">// TODO: safe?
        ...
        <span class="kw">let </span>oneRR = bigint::One::newRR(<span class="kw-2">&amp;</span>value.modulus(cpu_features));
