...
</span><span class="kw">use </span><span class="kw">super</span>::PublicKey;
<span class="kw">use </span>core::iter::FromIterator;

<span class="doccomment">/// RSA public key components.
///
/// `B` must implement `AsRef&lt;[u8]&gt;` like `&amp;[u8]` or `Vec&lt;u8&gt;`.
</span><span class="attr">#[derive(Clone, Copy)]
</span><span class="kw">pub struct </span>PublicKeyComponents&lt;B&gt; {
...
<span class="kw">impl</span>&lt;B&gt; core::fmt::Debug <span class="kw">for </span>PublicKeyComponents&lt;B&gt;
<span class="kw">where
    </span>B: core::fmt::Debug,
{
    <span class="kw">fn </span>fmt(<span class="kw-2">&amp;</span><span class="self">self</span>, f: <span class="kw-2">&amp;mut </span>core::fmt::Formatter&lt;<span class="lifetime">'_</span>&gt;) -&gt; <span class="prelude-ty">Result</span>&lt;(), core::fmt::Error&gt; {
        f.debug_struct(<span class="string">"PublicKeyComponents"</span>)
            .field(<span class="string">"n"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.n)
            .field(<span class="string">"e"</span>, <span class="kw-2">&amp;</span><span class="self">self</span>.e)
            .finish()
    }
}

<span class="kw">impl</span>&lt;B&gt; From&lt;<span class="kw-2">&amp;</span>PublicKey&gt; <span class="kw">for </span>PublicKeyComponents&lt;B&gt;
<span class="kw">where
    </span>B: FromIterator&lt;u8&gt;,
{
    <span class="kw">fn </span>from(public_key: <span class="kw-2">&amp;</span>PublicKey) -&gt; <span class="self">Self </span>{
