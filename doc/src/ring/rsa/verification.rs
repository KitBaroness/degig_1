...
<span class="kw">use crate</span>::{
    bits::{<span class="self">self</span>, FromUsizeBytes <span class="kw">as _</span>},
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">1024</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PKCS1_SHA256,
    <span class="string">"Verification of signatures using RSA keys of 1024-8192 bits,
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">2048</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PKCS1_SHA384,
    <span class="string">"Verification of signatures using RSA keys of 2048-8192 bits,
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">2048</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PKCS1_SHA512,
    <span class="string">"Verification of signatures using RSA keys of 2048-8192 bits,
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">2048</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PSS_SHA256,
    <span class="string">"Verification of signatures using RSA keys of 2048-8192 bits,
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">2048</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PSS_SHA384,
    <span class="string">"Verification of signatures using RSA keys of 2048-8192 bits,
...
<span class="macro">rsa_params!</span>(
    ...
    <span class="number">2048</span>,
    <span class="kw-2">&amp;</span><span class="kw">super</span>::padding::RSA_PSS_SHA512,
    <span class="string">"Verification of signatures using RSA keys of 2048-8192 bits,
             PSS padding, and SHA-512.\n\nSee \"`RSA_PSS_*` Details\" in
             `ring::signature`'s module-level documentation for more details."
</span>);

<span class="kw">pub use </span><span class="kw">super</span>::PublicKeyComponents <span class="kw">as </span>RsaPublicKeyComponents;

<span class="kw">impl</span>&lt;B&gt; <span class="kw">super</span>::PublicKeyComponents&lt;B&gt;
<span class="kw">where
    </span>B: AsRef&lt;[u8]&gt;,
{
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>verify_rsa_(
    ...
    <span class="kw">let </span>max_bits: bits::BitLength =
        bits::BitLength::from_usize_bytes(PUBLIC_KEY_PUBLIC_MODULUS_MAX_LEN)<span class="question-mark">?</span>;
    ...
    </span><span class="kw">let </span>key = public_key::Inner::from_modulus_and_exponent(
        n,
        e,
        params.min_bits,
        max_bits,
    ...
    <span class="kw">let </span>decoded = key.exponentiate(signature, <span class="kw-2">&amp;mut </span>decoded, cpu_features)<span class="question-mark">?</span>;
