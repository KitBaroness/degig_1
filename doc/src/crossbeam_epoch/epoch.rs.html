...
</pre></div><pre class="rust"><code><span class="doccomment">//! The global epoch
//!
...
</span><span class="kw">use </span><span class="kw">crate</span>::primitive::sync::atomic::{AtomicUsize, Ordering};
...
</span><span class="attr">#[derive(Copy, Clone, Default, Debug, Eq, PartialEq)]
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>Epoch {
...
<span class="kw">impl </span>Epoch {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>starting() -&gt; <span class="self">Self </span>{
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>wrapping_sub(<span class="self">self</span>, rhs: <span class="self">Self</span>) -&gt; isize {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>is_pinned(<span class="self">self</span>) -&gt; bool {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>pinned(<span class="self">self</span>) -&gt; Epoch {
        Epoch {
            data: <span class="self">self</span>.data | <span class="number">1</span>,
        }
    }

    <span class="doccomment">/// Returns the same epoch, but marked as unpinned.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>unpinned(<span class="self">self</span>) -&gt; Epoch {
        Epoch {
            data: <span class="self">self</span>.data &amp; !<span class="number">1</span>,
        }
    }
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>successor(<span class="self">self</span>) -&gt; Epoch {
        Epoch {
            data: <span class="self">self</span>.data.wrapping_add(<span class="number">2</span>),
        }
    }
}
...
</span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>AtomicEpoch {
...
<span class="kw">impl </span>AtomicEpoch {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>new(epoch: Epoch) -&gt; <span class="self">Self </span>{
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>load(<span class="kw-2">&amp;</span><span class="self">self</span>, ord: Ordering) -&gt; Epoch {
        Epoch {
            data: <span class="self">self</span>.data.load(ord),
        }
    }

    <span class="doccomment">/// Stores a value into the atomic epoch.
    </span><span class="attr">#[inline]
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>store(<span class="kw-2">&amp;</span><span class="self">self</span>, epoch: Epoch, ord: Ordering) {
    ...
    </span><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">fn </span>compare_exchange(
        <span class="kw-2">&amp;</span><span class="self">self</span>,
        current: Epoch,
        new: Epoch,
        success: Ordering,
        failure: Ordering,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;Epoch, Epoch&gt; {
        <span class="kw">match </span><span class="self">self
            </span>.data
            .compare_exchange(current.data, new.data, success, failure)
        {
            <span class="prelude-val">Ok</span>(data) =&gt; <span class="prelude-val">Ok</span>(Epoch { data }),
            <span class="prelude-val">Err</span>(data) =&gt; <span class="prelude-val">Err</span>(Epoch { data }),
        }
    }
}
