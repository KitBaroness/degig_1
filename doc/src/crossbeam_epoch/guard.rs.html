...
<span class="kw">impl </span>Guard {
        ...
        </span>F: FnOnce() -&gt; R,
    {
        ...
        </span><span class="kw">struct </span>ScopeGuard(<span class="kw-2">*const </span>Local);
        <span class="kw">impl </span>Drop <span class="kw">for </span>ScopeGuard {
            <span class="kw">fn </span>drop(<span class="kw-2">&amp;mut </span><span class="self">self</span>) {
                <span class="kw">if let </span><span class="prelude-val">Some</span>(local) = <span class="kw">unsafe </span>{ <span class="self">self</span>.<span class="number">0</span>.as_ref() } {
        ...
        <span class="kw">let </span>_guard = ScopeGuard(<span class="self">self</span>.local);
