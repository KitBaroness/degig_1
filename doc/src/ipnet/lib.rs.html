...
</pre></div><pre class="rust"><code><span class="attr">#![doc(html_root_url = <span class="string">"https://docs.rs/ipnet/2.9.0"</span>)]
...
#![cfg_attr(not(feature = <span class="string">"std"</span>), feature(error_in_core))]
#![cfg_attr(not(feature = <span class="string">"std"</span>), feature(ip_in_core))]
...
<span class="kw">pub use </span><span class="self">self</span>::mask::{ip_mask_to_prefix, ipv4_mask_to_prefix, ipv6_mask_to_prefix};
