...
<span class="kw">use </span>core::cmp::{min, max};
<span class="kw">use </span>core::cmp::Ordering::{Less, Equal};
<span class="kw">use </span>core::convert::From;
<span class="kw">use </span>core::fmt;
<span class="kw">use </span>core::iter::FusedIterator;
<span class="kw">use </span>core::option::Option::{<span class="prelude-val">Some</span>, <span class="prelude-val">None</span>};
...
/// ```
</span><span class="attr">#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash)]
...
<span class="kw">impl </span>Ipv4Net {
    ...
    /// ]);
        ...
        <span class="kw">for </span>(start, <span class="kw-2">mut </span>end) <span class="kw">in </span>intervals {
            <span class="kw">if </span>end != core::u32::MAX {
                end = end.saturating_sub(<span class="number">1</span>)
            }
...
<span class="kw">impl </span>Ipv6Net {    
    ...
    /// ```
        ...
        <span class="kw">for </span>(start, <span class="kw-2">mut </span>end) <span class="kw">in </span>intervals {
            <span class="kw">if </span>end != core::u128::MAX {
                end = end.saturating_sub(<span class="number">1</span>)
            }
...
<span class="kw">fn </span>next_ipv4_subnet(start: Ipv4Addr, end: Ipv4Addr, min_prefix_len: u8) -&gt; Ipv4Net {
    ...
    <span class="kw">if </span>range == core::u32::MAX &amp;&amp; min_prefix_len == <span class="number">0 </span>{
...
<span class="kw">fn </span>next_ipv6_subnet(start: Ipv6Addr, end: Ipv6Addr, min_prefix_len: u8) -&gt; Ipv6Net {
    <span class="kw">let </span>range = end.saturating_sub(start).saturating_add(<span class="number">1</span>);
    <span class="kw">if </span>range == core::u128::MAX &amp;&amp; min_prefix_len == <span class="number">0 </span>{
