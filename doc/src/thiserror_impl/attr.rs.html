...
</pre></div><pre class="rust"><code><span class="kw">use </span>proc_macro2::{Delimiter, Group, Span, TokenStream, TokenTree};
...
<span class="kw">use </span>syn::parse::discouraged::Speculative;
...
<span class="attr">#[derive(Clone)]
    ...
    <span class="kw">pub </span>requires_fmt_machinery: bool,
...
<span class="attr">#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Debug)]
...
<span class="kw">pub fn </span>get(input: <span class="kw-2">&amp;</span>[Attribute]) -&gt; <span class="prelude-ty">Result</span>&lt;Attrs&gt; {
    ...
    <span class="kw">for </span>attr <span class="kw">in </span>input {
        <span class="kw">if </span>attr.path().is_ident(<span class="string">"error"</span>) {
            ...
            <span class="kw">match </span>attr.meta {
                Meta::Path(<span class="kw">_</span>) =&gt; {}
                Meta::List(<span class="kw">_</span>) | Meta::NameValue(<span class="kw">_</span>) =&gt; {
...
<span class="kw">fn </span>parse_error_attribute&lt;<span class="lifetime">'a</span>&gt;(attrs: <span class="kw-2">&amp;mut </span>Attrs&lt;<span class="lifetime">'a</span>&gt;, attr: <span class="kw-2">&amp;</span><span class="lifetime">'a </span>Attribute) -&gt; <span class="prelude-ty">Result</span>&lt;()&gt; {
    ...
    attr.parse_args_with(|input: ParseStream| {
        ...
        <span class="kw">let </span>fmt: LitStr = input.parse()<span class="question-mark">?</span>;

        <span class="kw">let </span>ahead = input.fork();
        ahead.parse::&lt;<span class="prelude-ty">Option</span>&lt;<span class="macro">Token!</span>[,]&gt;&gt;()<span class="question-mark">?</span>;
        <span class="kw">let </span>args = <span class="kw">if </span>ahead.is_empty() {
            input.advance_to(<span class="kw-2">&amp;</span>ahead);
            TokenStream::new()
        } <span class="kw">else </span>{
            parse_token_expr(input, <span class="bool-val">false</span>)<span class="question-mark">?
        </span>};

        <span class="kw">let </span>requires_fmt_machinery = !args.is_empty();
...
<span class="kw">impl </span>ToTokens <span class="kw">for </span>Display&lt;<span class="lifetime">'_</span>&gt; {
    <span class="kw">fn </span>to_tokens(<span class="kw-2">&amp;</span><span class="self">self</span>, tokens: <span class="kw-2">&amp;mut </span>TokenStream) {
        ...
        <span class="comment">// Currently `write!(f, "text")` produces less efficient code than
        ...
        </span>tokens.extend(<span class="kw">if </span><span class="self">self</span>.requires_fmt_machinery {
            <span class="macro">quote!</span> {
                <span class="macro">::core::write!</span>(__formatter, #fmt #args)
            }
        } <span class="kw">else </span>{
            <span class="macro">quote!</span> {
...
<span class="kw">impl </span>ToTokens <span class="kw">for </span>Trait {
    <span class="kw">fn </span>to_tokens(<span class="kw-2">&amp;</span><span class="self">self</span>, tokens: <span class="kw-2">&amp;mut </span>TokenStream) {
        <span class="kw">let </span>trait_name = <span class="kw">match </span><span class="self">self </span>{
            Trait::Debug =&gt; <span class="string">"Debug"</span>,
            Trait::Display =&gt; <span class="string">"Display"</span>,
            Trait::Octal =&gt; <span class="string">"Octal"</span>,
            Trait::LowerHex =&gt; <span class="string">"LowerHex"</span>,
            Trait::UpperHex =&gt; <span class="string">"UpperHex"</span>,
            Trait::Pointer =&gt; <span class="string">"Pointer"</span>,
            Trait::Binary =&gt; <span class="string">"Binary"</span>,
            Trait::LowerExp =&gt; <span class="string">"LowerExp"</span>,
            Trait::UpperExp =&gt; <span class="string">"UpperExp"</span>,
        };
        <span class="kw">let </span>ident = Ident::new(trait_name, Span::call_site());
        tokens.extend(<span class="macro">quote!</span>(::core::fmt::#ident));
    }
}
