...
<span class="kw">impl </span>InferredBounds {
    ...
    <span class="attr">#[allow(clippy::type_repetition_in_bounds, clippy::trait_duplication_in_bounds)] </span><span class="comment">// clippy bug: https://github.com/rust-lang/rust-clippy/issues/8771
    </span><span class="kw">pub fn </span>insert(<span class="kw-2">&amp;mut </span><span class="self">self</span>, ty: <span class="kw">impl </span>ToTokens, bound: <span class="kw">impl </span>ToTokens) {
