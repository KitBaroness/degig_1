...
#[repr(transparent)]
</span><span class="kw">pub struct </span>NonTransferable;

<span class="doccomment">/// Indicates that the tokens from this account belong to a non-transferable
/// mint
</span><span class="attr">#[cfg_attr(feature = <span class="string">"serde-traits"</span>, derive(Serialize, Deserialize))]
#[cfg_attr(feature = <span class="string">"serde-traits"</span>, serde(rename_all = <span class="string">"camelCase"</span>))]
#[derive(Clone, Copy, Debug, Default, PartialEq, Pod, Zeroable)]
#[repr(transparent)]
</span><span class="kw">pub struct </span>NonTransferableAccount;

<span class="kw">impl </span>Extension <span class="kw">for </span>NonTransferable {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::NonTransferable;
}

<span class="kw">impl </span>Extension <span class="kw">for </span>NonTransferableAccount {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::NonTransferableAccount;
}
