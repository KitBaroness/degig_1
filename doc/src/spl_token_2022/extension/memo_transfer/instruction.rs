...
<span class="doccomment">/// Required Memo Transfers extension instructions
...
#[repr(u8)]
</span><span class="kw">pub enum </span>RequiredMemoTransfersInstruction {
    <span class="doccomment">/// Require memos for transfers into this Account. Adds the MemoTransfer
    ...
    <span class="doccomment">/// Stop requiring memos for transfers into this Account.
    ///
...
<span class="doccomment">/// Create an `Enable` instruction
</span><span class="kw">pub fn </span>enable_required_transfer_memos(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    account: <span class="kw-2">&amp;</span>Pubkey,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>accounts = <span class="macro">vec!</span>[
        AccountMeta::new(<span class="kw-2">*</span>account, <span class="bool-val">false</span>),
        AccountMeta::new_readonly(<span class="kw-2">*</span>owner, signers.is_empty()),
    ];
...
<span class="doccomment">/// Create a `Disable` instruction
</span><span class="kw">pub fn </span>disable_required_transfer_memos(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    account: <span class="kw-2">&amp;</span>Pubkey,
    owner: <span class="kw-2">&amp;</span>Pubkey,
    signers: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>Pubkey],
