...
#[repr(transparent)]
</span><span class="kw">pub struct </span>ImmutableOwner;

<span class="kw">impl </span>Extension <span class="kw">for </span>ImmutableOwner {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::ImmutableOwner;
}
