...
<span class="doccomment">/// Close authority extension data for mints.
...
</span><span class="kw">pub struct </span>MintCloseAuthority {
    <span class="doccomment">/// Optional authority to close the mint
    </span><span class="kw">pub </span>close_authority: OptionalNonZeroPubkey,
}
<span class="kw">impl </span>Extension <span class="kw">for </span>MintCloseAuthority {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::MintCloseAuthority;
}
