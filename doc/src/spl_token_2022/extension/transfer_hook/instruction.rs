...
<span class="doccomment">/// Transfer hook extension instructions
...
#[repr(u8)]
    ...
    <span class="doccomment">/// Initialize a new mint with a transfer hook program.
    ///
    ...
    <span class="doccomment">/// Update the transfer hook program id. Only supported for mints that
...
#[repr(C)]
    ...
    <span class="doccomment">/// The public key for the account that can update the program id
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// The program id that performs logic during transfers
...
<span class="doccomment">/// Create an `Initialize` instruction
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>InitializeInstructionData {
            ...
            program_id: transfer_hook_program_id.try_into()<span class="question-mark">?</span>,
        },
    ))
}
