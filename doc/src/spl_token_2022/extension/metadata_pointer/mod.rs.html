...
<span class="doccomment">/// Instructions for the MetadataPointer extension
</span><span class="kw">pub mod </span>instruction;
<span class="doccomment">/// Instruction processor for the MetadataPointer extension
</span><span class="kw">pub mod </span>processor;

<span class="doccomment">/// Metadata pointer extension data for mints.
...
</span><span class="kw">pub struct </span>MetadataPointer {
    <span class="doccomment">/// Authority that can set the metadata address
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// Account address that holds the metadata
    </span><span class="kw">pub </span>metadata_address: OptionalNonZeroPubkey,
}

<span class="kw">impl </span>Extension <span class="kw">for </span>MetadataPointer {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::MetadataPointer;
}
