...
<span class="doccomment">/// Metadata pointer extension instructions
...
#[repr(u8)]
</span><span class="kw">pub enum </span>MetadataPointerInstruction {
    <span class="doccomment">/// Initialize a new mint with a metadata pointer
    ///
    ...
    <span class="doccomment">/// Update the metadata pointer address. Only supported for mints that
...
#[repr(C)]
    ...
    <span class="doccomment">/// The public key for the account that can update the metadata address
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// The account address that holds the metadata
    </span><span class="kw">pub </span>metadata_address: OptionalNonZeroPubkey,
}
...
#[repr(C)]
    ...
    <span class="doccomment">/// The new account address that holds the metadata
    </span><span class="kw">pub </span>metadata_address: OptionalNonZeroPubkey,
}
...
<span class="doccomment">/// Create an `Initialize` instruction
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>InitializeInstructionData {
            ...
            metadata_address: metadata_address.try_into()<span class="question-mark">?</span>,
        },
    ))
}
