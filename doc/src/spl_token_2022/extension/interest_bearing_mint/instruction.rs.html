...
<span class="doccomment">/// Interesting-bearing mint extension instructions
...
#[repr(u8)]
</span><span class="kw">pub enum </span>InterestBearingMintInstruction {
    <span class="doccomment">/// Initialize a new mint with interest accrual.
    ///
    ...
    <span class="doccomment">/// Update the interest rate. Only supported for mints that include the
...
<span class="doccomment">/// Data expected by `InterestBearing::Initialize`
</span><span class="attr">#[cfg_attr(feature = <span class="string">"serde-traits"</span>, derive(Serialize, Deserialize))]
#[cfg_attr(feature = <span class="string">"serde-traits"</span>, serde(rename_all = <span class="string">"camelCase"</span>))]
#[derive(Clone, Copy, Pod, Zeroable)]
#[repr(C)]
</span><span class="kw">pub struct </span>InitializeInstructionData {
    <span class="doccomment">/// The public key for the account that can update the rate
    </span><span class="kw">pub </span>rate_authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// The initial interest rate
    </span><span class="kw">pub </span>rate: BasisPoints,
}
...
<span class="doccomment">/// Create an `Initialize` instruction
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>InitializeInstructionData {
            rate_authority: rate_authority.try_into()<span class="question-mark">?</span>,
            rate: rate.into(),
        },
    ))
}

<span class="doccomment">/// Create an `UpdateRate` instruction
</span><span class="kw">pub fn </span>update_rate(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    rate_authority: <span class="kw-2">&amp;</span>Pubkey,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>accounts = <span class="macro">vec!</span>[
        ...
        AccountMeta::new_readonly(<span class="kw-2">*</span>rate_authority, signers.is_empty()),
    ];
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>BasisPoints::from(rate),
    ))
}
