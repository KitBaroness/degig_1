...
<span class="doccomment">/// Instructions for the GroupPointer extension
</span><span class="kw">pub mod </span>instruction;
<span class="doccomment">/// Instruction processor for the GroupPointer extension
</span><span class="kw">pub mod </span>processor;

<span class="doccomment">/// Group pointer extension data for mints.
...
</span><span class="kw">pub struct </span>GroupPointer {
    <span class="doccomment">/// Authority that can set the group address
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// Account address that holds the group
    </span><span class="kw">pub </span>group_address: OptionalNonZeroPubkey,
}

<span class="kw">impl </span>Extension <span class="kw">for </span>GroupPointer {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::GroupPointer;
}
