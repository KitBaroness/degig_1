...
#[repr(u8)]
</span><span class="kw">pub enum </span>CpiGuardInstruction {
    <span class="doccomment">/// Lock certain token operations from taking place within CPI for this
    /// Account, namely:
    ...
    <span class="doccomment">/// Allow all token operations to happen via CPI as normal.
    ///
...
</span><span class="kw">pub fn </span>enable_cpi_guard(
...
</span><span class="kw">pub fn </span>disable_cpi_guard(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    account: <span class="kw-2">&amp;</span>Pubkey,
    owner: <span class="kw-2">&amp;</span>Pubkey,
    signers: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>Pubkey],
