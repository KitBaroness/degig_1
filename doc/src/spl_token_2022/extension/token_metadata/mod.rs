...
<span class="doccomment">/// Instruction processor for the TokenMetadata extension
</span><span class="kw">pub mod </span>processor;

<span class="kw">impl </span>Extension <span class="kw">for </span>TokenMetadata {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::TokenMetadata;
}
