...
<a href="#547" id="547">547</a>
    ...
    <span class="kw">crate</span>::serialization::{aeciphertext_fromstr, elgamalpubkey_fromstr},
...
#[repr(u8)]
</span><span class="kw">pub enum </span>ConfidentialTransferFeeInstruction {
    <span class="doccomment">/// Initializes confidential transfer fees for a mint.
    ///
    ...
    </span>InitializeConfidentialTransferFeeConfig,

    <span class="doccomment">/// Transfer all withheld confidential tokens in the mint to an account.
    ...
    <span class="doccomment">/// Permissionless instruction to transfer all withheld confidential tokens
    /// to the mint.
    ///
    ...
    <span class="doccomment">/// Configure a confidential transfer fee mint to accept harvested
    /// confidential fees.
    ///
    /// Accounts expected by this instruction:
    ///
    ...
    /// Data expected by this instruction:
    ///   None
    </span>EnableHarvestToMint,

    <span class="doccomment">/// Configure a confidential transfer fee mint to reject any harvested
    /// confidential fees.
    ///
    /// Accounts expected by this instruction:
    ///
    ...
    /// Data expected by this instruction:
    ///   None
    </span>DisableHarvestToMint,
}

<span class="doccomment">/// Data expected by `InitializeConfidentialTransferFeeConfig`
</span><span class="attr">#[cfg_attr(feature = <span class="string">"serde-traits"</span>, derive(Serialize, Deserialize))]
#[cfg_attr(feature = <span class="string">"serde-traits"</span>, serde(rename_all = <span class="string">"camelCase"</span>))]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable)]
#[repr(C)]
</span><span class="kw">pub struct </span>InitializeConfidentialTransferFeeConfigData {
    <span class="doccomment">/// confidential transfer fee authority
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,

    <span class="doccomment">/// ElGamal public key used to encrypt withheld fees.
    </span><span class="attr">#[cfg_attr(feature = <span class="string">"serde-traits"</span>, serde(with = <span class="string">"elgamalpubkey_fromstr"</span>))]
    </span><span class="kw">pub </span>withdraw_withheld_authority_elgamal_pubkey: ElGamalPubkey,
}

<span class="doccomment">/// Data expected by
/// `ConfidentialTransferFeeInstruction::WithdrawWithheldTokensFromMint`
</span><span class="attr">#[cfg_attr(feature = <span class="string">"serde-traits"</span>, derive(Serialize, Deserialize))]
#[cfg_attr(feature = <span class="string">"serde-traits"</span>, serde(rename_all = <span class="string">"camelCase"</span>))]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable)]
#[repr(C)]
</span><span class="kw">pub struct </span>WithdrawWithheldTokensFromMintData {
    <span class="doccomment">/// Relative location of the `ProofInstruction::VerifyWithdrawWithheld`
    ...
    <span class="doccomment">/// The new decryptable balance in the destination token account.
...
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable)]
#[repr(C)]
</span><span class="kw">pub struct </span>WithdrawWithheldTokensFromAccountsData {
    <span class="doccomment">/// Number of token accounts harvested
    </span><span class="kw">pub </span>num_token_accounts: u8,
    <span class="doccomment">/// Relative location of the `ProofInstruction::VerifyWithdrawWithheld`
...
<span class="doccomment">/// Create a `InitializeConfidentialTransferFeeConfig` instruction
</span><span class="kw">pub fn </span>initialize_confidential_transfer_fee_config(
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>InitializeConfidentialTransferFeeConfigData {
...
<span class="doccomment">/// Create an inner `WithdrawWithheldTokensFromMint` instruction
///
/// This instruction is suitable for use with a cross-program `invoke`
</span><span class="kw">pub fn </span>inner_withdraw_withheld_tokens_from_mint(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>accounts = <span class="macro">vec!</span>[
        ...
        AccountMeta::new(<span class="kw-2">*</span>destination, <span class="bool-val">false</span>),
    ];
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        TokenInstruction::ConfidentialTransferFeeExtension,
        ConfidentialTransferFeeInstruction::WithdrawWithheldTokensFromMint,
        <span class="kw-2">&amp;</span>WithdrawWithheldTokensFromMintData {
            proof_instruction_offset,
            new_decryptable_available_balance: <span class="kw-2">*</span>new_decryptable_available_balance,
        },
    ))
}

<span class="doccomment">/// Create an `WithdrawWithheldTokensFromMint` instruction
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>instructions = <span class="macro">vec!</span>[inner_withdraw_withheld_tokens_from_mint(
        token_program_id,
        mint,
        destination,
        ...
        proof_data_location
    {
        ...
        instructions.push(verify_ciphertext_ciphertext_equality(<span class="prelude-val">None</span>, proof_data));
    };
...
/// This instruction is suitable for use with a cross-program `invoke`
...
</span><span class="kw">pub fn </span>inner_withdraw_withheld_tokens_from_accounts(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    destination: <span class="kw-2">&amp;</span>Pubkey,
    new_decryptable_available_balance: <span class="kw-2">&amp;</span>DecryptableBalance,
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        TokenInstruction::ConfidentialTransferFeeExtension,
        ConfidentialTransferFeeInstruction::WithdrawWithheldTokensFromAccounts,
        <span class="kw-2">&amp;</span>WithdrawWithheldTokensFromAccountsData {
            proof_instruction_offset,
            num_token_accounts,
            new_decryptable_available_balance: <span class="kw-2">*</span>new_decryptable_available_balance,
        },
...
<span class="doccomment">/// Create a `WithdrawWithheldTokensFromAccounts` instruction
</span><span class="attr">#[allow(clippy::too_many_arguments)]
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>instructions = <span class="macro">vec!</span>[inner_withdraw_withheld_tokens_from_accounts(
        token_program_id,
        mint,
        destination,
        new_decryptable_available_balance,
...
<span class="doccomment">/// Creates a `HarvestWithheldTokensToMint` instruction
    ...
    check_program_account(token_program_id)<span class="question-mark">?</span>;
    <span class="kw">let </span><span class="kw-2">mut </span>accounts = <span class="macro">vec!</span>[AccountMeta::new(<span class="kw-2">*</span>mint, <span class="bool-val">false</span>)];
...
<span class="doccomment">/// Create an `EnableHarvestToMint` instruction
</span><span class="kw">pub fn </span>enable_harvest_to_mint(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    authority: <span class="kw-2">&amp;</span>Pubkey,
    multisig_signers: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>Pubkey],
...
<span class="doccomment">/// Create a `DisableHarvestToMint` instruction
</span><span class="kw">pub fn </span>disable_harvest_to_mint(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    authority: <span class="kw-2">&amp;</span>Pubkey,
    multisig_signers: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>Pubkey],
