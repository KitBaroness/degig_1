...
<span class="doccomment">/// Default Account state extension processor
</span><span class="kw">pub mod </span>processor;

<span class="doccomment">/// Default Account::state extension data for mints.
...
</span><span class="kw">pub struct </span>DefaultAccountState {
    <span class="doccomment">/// Default Account::state in which new Accounts should be initialized
    </span><span class="kw">pub </span>state: PodAccountState,
}
<span class="kw">impl </span>Extension <span class="kw">for </span>DefaultAccountState {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::DefaultAccountState;
}

<span class="kw">type </span>PodAccountState = u8;
