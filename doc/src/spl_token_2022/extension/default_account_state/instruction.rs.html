...
<span class="doccomment">/// Default Account State extension instructions
...
#[repr(u8)]
</span><span class="kw">pub enum </span>DefaultAccountStateInstruction {
    <span class="doccomment">/// Initialize a new mint with the default state for new Accounts.
    ///
    ...
    <span class="doccomment">/// Update the default state for new Accounts. Only supported for mints that
...
<span class="doccomment">/// Utility function for decoding a DefaultAccountState instruction and its data
</span><span class="kw">pub fn </span>decode_instruction(
    input: <span class="kw-2">&amp;</span>[u8],
) -&gt; <span class="prelude-ty">Result</span>&lt;(DefaultAccountStateInstruction, AccountState), ProgramError&gt; {
    ...
    <span class="prelude-val">Ok</span>((
        DefaultAccountStateInstruction::try_from(input[<span class="number">0</span>])
            .or(<span class="prelude-val">Err</span>(TokenError::InvalidInstruction))<span class="question-mark">?</span>,
        AccountState::try_from(input[<span class="number">1</span>]).or(<span class="prelude-val">Err</span>(TokenError::InvalidInstruction))<span class="question-mark">?</span>,
    ))
}

<span class="kw">fn </span>encode_instruction(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    accounts: Vec&lt;AccountMeta&gt;,
    instruction_type: DefaultAccountStateInstruction,
    state: <span class="kw-2">&amp;</span>AccountState,
) -&gt; Instruction {
    <span class="kw">let </span><span class="kw-2">mut </span>data = TokenInstruction::DefaultAccountStateExtension.pack();
    data.push(instruction_type.into());
    data.push((<span class="kw-2">*</span>state).into());
    Instruction {
...
</span><span class="kw">pub fn </span>initialize_default_account_state(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
...
<span class="doccomment">/// Create an `Initialize` instruction
</span><span class="kw">pub fn </span>update_default_account_state(
    token_program_id: <span class="kw-2">&amp;</span>Pubkey,
    mint: <span class="kw-2">&amp;</span>Pubkey,
    freeze_authority: <span class="kw-2">&amp;</span>Pubkey,
    ...
    <span class="kw">let </span><span class="kw-2">mut </span>accounts = <span class="macro">vec!</span>[
        ...
        AccountMeta::new_readonly(<span class="kw-2">*</span>freeze_authority, signers.is_empty()),
    ];
