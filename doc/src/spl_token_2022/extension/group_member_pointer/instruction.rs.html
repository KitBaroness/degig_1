...
<span class="doccomment">/// Group member pointer extension instructions
...
#[repr(u8)]
</span><span class="kw">pub enum </span>GroupMemberPointerInstruction {
    <span class="doccomment">/// Initialize a new mint with a group member pointer
    ///
    ...
    <span class="doccomment">/// Update the group member pointer address. Only supported for mints that
...
#[repr(C)]
    ...
    <span class="doccomment">/// The account address that holds the member
...
#[repr(C)]
    ...
    <span class="doccomment">/// The new account address that holds the group
    </span><span class="kw">pub </span>member_address: OptionalNonZeroPubkey,
}
...
<span class="doccomment">/// Create an `Initialize` instruction
    ...
    <span class="prelude-val">Ok</span>(encode_instruction(
        ...
        <span class="kw-2">&amp;</span>InitializeInstructionData {
            ...
            member_address: member_address.try_into()<span class="question-mark">?</span>,
        },
    ))
}
