...
<span class="doccomment">/// Instructions for the GroupMemberPointer extension
</span><span class="kw">pub mod </span>instruction;
<span class="doccomment">/// Instruction processor for the GroupMemberPointer extension
</span><span class="kw">pub mod </span>processor;

<span class="doccomment">/// Group member pointer extension data for mints.
...
</span><span class="kw">pub struct </span>GroupMemberPointer {
    <span class="doccomment">/// Authority that can set the member address
    </span><span class="kw">pub </span>authority: OptionalNonZeroPubkey,
    <span class="doccomment">/// Account address that holds the member
    </span><span class="kw">pub </span>member_address: OptionalNonZeroPubkey,
}

<span class="kw">impl </span>Extension <span class="kw">for </span>GroupMemberPointer {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::GroupMemberPointer;
}
