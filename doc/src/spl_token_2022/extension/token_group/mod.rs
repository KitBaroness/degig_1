...
<span class="doccomment">/// Instruction processor for the TokenGroup extensions
</span><span class="kw">pub mod </span>processor;

<span class="kw">impl </span>Extension <span class="kw">for </span>TokenGroup {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::TokenGroup;
}

<span class="kw">impl </span>Extension <span class="kw">for </span>TokenGroupMember {
    <span class="kw">const </span>TYPE: ExtensionType = ExtensionType::TokenGroupMember;
}
