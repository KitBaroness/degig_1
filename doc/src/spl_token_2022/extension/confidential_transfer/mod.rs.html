...
<span class="doccomment">/// Helper functions to generate split zero-knowledge proofs for confidential
...
</span><span class="kw">pub mod </span>split_proof_generation;
...
<span class="doccomment">/// Ciphertext extraction and proof related helper logic
///
/// This submodule should be removed with the next upgrade to the Solana program
</span><span class="kw">pub mod </span>ciphertext_extraction;

<span class="doccomment">/// ElGamal ciphertext containing an account balance
</span><span class="kw">pub type </span>EncryptedBalance = ElGamalCiphertext;
<span class="doccomment">/// Authenticated encryption containing an account balance
</span><span class="kw">pub type </span>DecryptableBalance = AeCiphertext;
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Pod, Zeroable)]
    ...
    </span><span class="kw">pub </span>elgamal_pubkey: ElGamalPubkey,
