...
<span class="kw">pub mod </span>generic_token_account;
...
<span class="kw">pub mod </span>pod_instruction;
...
</span><span class="kw">pub mod </span>serialization;
...
// version
</span><span class="kw">use </span>solana_program::{
...
<span class="kw">pub use </span>{solana_program, solana_zk_token_sdk};
...
/// the given decimals field
    ...
    <span class="comment">// splitting a string, even an empty one, will always yield an iterator of at
    // least length == 1
...
<span class="macro">solana_program::declare_id!</span>(<span class="string">"TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb"</span>);

<span class="doccomment">/// Checks that the supplied program ID is correct for spl-token-2022
...
<span class="doccomment">/// Checks that the supplied program ID is corect for spl-token or
/// spl-token-2022
</span><span class="kw">pub fn </span>check_spl_token_program_account(spl_token_program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; ProgramResult {
    <span class="kw">if </span>spl_token_program_id != <span class="kw-2">&amp;</span>id() &amp;&amp; spl_token_program_id != <span class="kw-2">&amp;</span>spl_token::id() {
        <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId);
    }
    <span class="prelude-val">Ok</span>(())
}

<span class="doccomment">/// Checks that the supplied program ID is correct for the ZK Token proof
/// program
</span><span class="kw">pub fn </span>check_zk_token_proof_program_account(zk_token_proof_program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; ProgramResult {
    <span class="kw">if </span>zk_token_proof_program_id != <span class="kw-2">&amp;</span>solana_zk_token_sdk::zk_token_proof_program::id() {
        <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId);
    }
    <span class="prelude-val">Ok</span>(())
}

<span class="doccomment">/// Checks if the spplied program ID is that of the system program
</span><span class="kw">pub fn </span>check_system_program_account(system_program_id: <span class="kw-2">&amp;</span>Pubkey) -&gt; ProgramResult {
    <span class="kw">if </span>system_program_id != <span class="kw-2">&amp;</span>system_program::id() {
        <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId);
    }
    <span class="prelude-val">Ok</span>(())
}
