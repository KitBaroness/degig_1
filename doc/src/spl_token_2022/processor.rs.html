...
<a href="#8189" id="8189">8189</a>
</pre></div><pre class="rust"><code><span class="doccomment">//! Program state processor
    ...
    <span class="kw">crate</span>::{
        ...
        error::TokenError,
        extension::{
            confidential_transfer::{<span class="self">self</span>, ConfidentialTransferAccount, ConfidentialTransferMint},
            confidential_transfer_fee::{
                <span class="self">self</span>, ConfidentialTransferFeeAmount, ConfidentialTransferFeeConfig,
            },
            cpi_guard::{<span class="self">self</span>, in_cpi, CpiGuard},
            default_account_state::{<span class="self">self</span>, DefaultAccountState},
            group_member_pointer::{<span class="self">self</span>, GroupMemberPointer},
            group_pointer::{<span class="self">self</span>, GroupPointer},
            immutable_owner::ImmutableOwner,
            interest_bearing_mint::{<span class="self">self</span>, InterestBearingConfig},
            memo_transfer::{<span class="self">self</span>, check_previous_sibling_instruction_is_memo, memo_required},
            metadata_pointer::{<span class="self">self</span>, MetadataPointer},
            mint_close_authority::MintCloseAuthority,
            non_transferable::{NonTransferable, NonTransferableAccount},
            permanent_delegate::{get_permanent_delegate, PermanentDelegate},
            reallocate, token_group, token_metadata,
            transfer_fee::{<span class="self">self</span>, TransferFeeAmount, TransferFeeConfig},
            transfer_hook::{<span class="self">self</span>, TransferHook, TransferHookAccount},
...
<span class="doccomment">/// Program state handler.
</span><span class="kw">pub struct </span>Processor {}
<span class="kw">impl </span>Processor {
    <span class="kw">fn </span>_process_initialize_mint(
        ...
        <span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>mint_data_len = mint_info.data_len();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_data = mint_info.data.borrow_mut();
        <span class="kw">let </span>rent = <span class="kw">if </span>rent_sysvar_account {
            Rent::from_account_info(next_account_info(account_info_iter)<span class="question-mark">?</span>)<span class="question-mark">?
        </span>} <span class="kw">else </span>{
            Rent::get()<span class="question-mark">?
        </span>};

        <span class="kw">if </span>!rent.is_exempt(mint_info.lamports(), mint_data_len) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NotRentExempt.into());
        }

        <span class="kw">let </span><span class="kw-2">mut </span>mint = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack_uninitialized(<span class="kw-2">&amp;mut </span>mint_data)<span class="question-mark">?</span>;
        <span class="kw">let </span>extension_types = mint.get_extension_types()<span class="question-mark">?</span>;
        <span class="kw">if </span>ExtensionType::try_calculate_account_len::&lt;Mint&gt;(<span class="kw-2">&amp;</span>extension_types)<span class="question-mark">? </span>!= mint_data_len {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::InvalidAccountData);
        }
        ExtensionType::check_for_invalid_mint_extension_combinations(<span class="kw-2">&amp;</span>extension_types)<span class="question-mark">?</span>;

        <span class="kw">if let </span><span class="prelude-val">Ok</span>(default_account_state) = mint.get_extension_mut::&lt;DefaultAccountState&gt;() {
            <span class="kw">let </span>default_account_state = AccountState::try_from(default_account_state.state)
                .or(<span class="prelude-val">Err</span>(ProgramError::InvalidAccountData))<span class="question-mark">?</span>;
            <span class="kw">if </span>default_account_state == AccountState::Frozen &amp;&amp; freeze_authority.is_none() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintCannotFreeze.into());
            }
        }

        mint.base.mint_authority = PodCOption::some(<span class="kw-2">*</span>mint_authority);
        mint.base.decimals = decimals;
        mint.base.is_initialized = PodBool::from_bool(<span class="bool-val">true</span>);
        mint.base.freeze_authority = freeze_authority;
        mint.init_account_type()<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [InitializeMint](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_initialize_mint(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        decimals: u8,
        mint_authority: <span class="kw-2">&amp;</span>Pubkey,
        freeze_authority: PodCOption&lt;Pubkey&gt;,
    ) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_mint(accounts, decimals, mint_authority, freeze_authority, <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes an [InitializeMint2](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_initialize_mint2(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        decimals: u8,
        mint_authority: <span class="kw-2">&amp;</span>Pubkey,
        freeze_authority: PodCOption&lt;Pubkey&gt;,
    ) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_mint(accounts, decimals, mint_authority, freeze_authority, <span class="bool-val">false</span>)
    }

    <span class="kw">fn </span>_process_initialize_account(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        owner: <span class="prelude-ty">Option</span>&lt;<span class="kw-2">&amp;</span>Pubkey&gt;,
        rent_sysvar_account: bool,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>new_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>owner = <span class="kw">if let </span><span class="prelude-val">Some</span>(owner) = owner {
            owner
        } <span class="kw">else </span>{
            next_account_info(account_info_iter)<span class="question-mark">?</span>.key
        };
        <span class="kw">let </span>new_account_info_data_len = new_account_info.data_len();
        <span class="kw">let </span>rent = <span class="kw">if </span>rent_sysvar_account {
            Rent::from_account_info(next_account_info(account_info_iter)<span class="question-mark">?</span>)<span class="question-mark">?
        </span>} <span class="kw">else </span>{
            Rent::get()<span class="question-mark">?
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>account_data = new_account_info.data.borrow_mut();
        <span class="comment">// unpack_uninitialized checks account.base.is_initialized() under the hood
        </span><span class="kw">let </span><span class="kw-2">mut </span>account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack_uninitialized(<span class="kw-2">&amp;mut </span>account_data)<span class="question-mark">?</span>;

        <span class="kw">if </span>!rent.is_exempt(new_account_info.lamports(), new_account_info_data_len) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NotRentExempt.into());
        }

        <span class="comment">// get_required_account_extensions checks mint validity
        </span><span class="kw">let </span>mint_data = mint_info.data.borrow();
        <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="kw">if </span>mint
            .get_extension::&lt;PermanentDelegate&gt;()
            .map(|e| <span class="prelude-ty">Option</span>::&lt;Pubkey&gt;::from(e.delegate).is_some())
            .unwrap_or(<span class="bool-val">false</span>)
        {
            <span class="macro">msg!</span>(<span class="string">"Warning: Mint has a permanent delegate, so tokens in this account may be seized at any time"</span>);
        }
        <span class="kw">let </span>required_extensions =
            <span class="self">Self</span>::get_required_account_extensions_from_unpacked_mint(mint_info.owner, <span class="kw-2">&amp;</span>mint)<span class="question-mark">?</span>;
        <span class="kw">if </span>ExtensionType::try_calculate_account_len::&lt;Account&gt;(<span class="kw-2">&amp;</span>required_extensions)<span class="question-mark">?
            </span>&gt; new_account_info_data_len
        {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::InvalidAccountData);
        }
        <span class="kw">for </span>extension <span class="kw">in </span>required_extensions {
            account.init_account_extension_from_type(extension)<span class="question-mark">?</span>;
        }

        <span class="kw">let </span>starting_state =
            <span class="kw">if let </span><span class="prelude-val">Ok</span>(default_account_state) = mint.get_extension::&lt;DefaultAccountState&gt;() {
                AccountState::try_from(default_account_state.state)
                    .or(<span class="prelude-val">Err</span>(ProgramError::InvalidAccountData))<span class="question-mark">?
            </span>} <span class="kw">else </span>{
                AccountState::Initialized
            };

        account.base.mint = <span class="kw-2">*</span>mint_info.key;
        account.base.owner = <span class="kw-2">*</span>owner;
        account.base.close_authority = PodCOption::none();
        account.base.delegate = PodCOption::none();
        account.base.delegated_amount = <span class="number">0</span>.into();
        account.base.state = starting_state.into();
        <span class="kw">if </span>cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span>native_mint::id()) {
            <span class="kw">let </span>rent_exempt_reserve = rent.minimum_balance(new_account_info_data_len);
            account.base.is_native = PodCOption::some(rent_exempt_reserve.into());
            account.base.amount = new_account_info
                .lamports()
                .checked_sub(rent_exempt_reserve)
                .ok_or(TokenError::Overflow)<span class="question-mark">?
                </span>.into();
        } <span class="kw">else </span>{
            account.base.is_native = PodCOption::none();
            account.base.amount = <span class="number">0</span>.into();
        };

        account.init_account_type()<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [InitializeAccount](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account(accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(accounts, <span class="prelude-val">None</span>, <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes an [InitializeAccount2](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account2(accounts: <span class="kw-2">&amp;</span>[AccountInfo], owner: <span class="kw-2">&amp;</span>Pubkey) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(accounts, <span class="prelude-val">Some</span>(owner), <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes an [InitializeAccount3](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_account3(accounts: <span class="kw-2">&amp;</span>[AccountInfo], owner: <span class="kw-2">&amp;</span>Pubkey) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_account(accounts, <span class="prelude-val">Some</span>(owner), <span class="bool-val">false</span>)
    }

    <span class="kw">fn </span>_process_initialize_multisig(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        m: u8,
        rent_sysvar_account: bool,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>multisig_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>multisig_info_data_len = multisig_info.data_len();
        <span class="kw">let </span>rent = <span class="kw">if </span>rent_sysvar_account {
            Rent::from_account_info(next_account_info(account_info_iter)<span class="question-mark">?</span>)<span class="question-mark">?
        </span>} <span class="kw">else </span>{
            Rent::get()<span class="question-mark">?
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_data = multisig_info.data.borrow_mut();
        <span class="kw">let </span>multisig = pod_from_bytes_mut::&lt;PodMultisig&gt;(<span class="kw-2">&amp;mut </span>multisig_data)<span class="question-mark">?</span>;
        <span class="kw">if </span>bool::from(multisig.is_initialized) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AlreadyInUse.into());
        }

        <span class="kw">if </span>!rent.is_exempt(multisig_info.lamports(), multisig_info_data_len) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NotRentExempt.into());
        }

        <span class="kw">let </span>signer_infos = account_info_iter.as_slice();
        multisig.m = m;
        multisig.n = signer_infos.len() <span class="kw">as </span>u8;
        <span class="kw">if </span>!is_valid_signer_index(multisig.n <span class="kw">as </span>usize) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidNumberOfProvidedSigners.into());
        }
        <span class="kw">if </span>!is_valid_signer_index(multisig.m <span class="kw">as </span>usize) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidNumberOfRequiredSigners.into());
        }
        <span class="kw">for </span>(i, signer_info) <span class="kw">in </span>signer_infos.iter().enumerate() {
            multisig.signers[i] = <span class="kw-2">*</span>signer_info.key;
        }
        multisig.is_initialized = <span class="bool-val">true</span>.into();

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes a [InitializeMultisig](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_multisig(accounts: <span class="kw-2">&amp;</span>[AccountInfo], m: u8) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_multisig(accounts, m, <span class="bool-val">true</span>)
    }

    <span class="doccomment">/// Processes a [InitializeMultisig2](enum.TokenInstruction.html)
    /// instruction.
    </span><span class="kw">pub fn </span>process_initialize_multisig2(accounts: <span class="kw-2">&amp;</span>[AccountInfo], m: u8) -&gt; ProgramResult {
        <span class="self">Self</span>::_process_initialize_multisig(accounts, m, <span class="bool-val">false</span>)
    }

    <span class="doccomment">/// Processes a [Transfer](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_transfer(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        amount: u64,
        expected_decimals: <span class="prelude-ty">Option</span>&lt;u8&gt;,
        expected_fee: <span class="prelude-ty">Option</span>&lt;u64&gt;,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();

        <span class="kw">let </span>source_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        <span class="kw">let </span>expected_mint_info = <span class="kw">if let </span><span class="prelude-val">Some</span>(expected_decimals) = expected_decimals {
            <span class="prelude-val">Some</span>((next_account_info(account_info_iter)<span class="question-mark">?</span>, expected_decimals))
        } <span class="kw">else </span>{
            <span class="prelude-val">None
        </span>};

        <span class="kw">let </span>destination_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info_data_len = authority_info.data_len();

        <span class="kw">let </span><span class="kw-2">mut </span>source_account_data = source_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>source_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>source_account_data)<span class="question-mark">?</span>;
        <span class="kw">if </span>source_account.base.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }
        <span class="kw">let </span>source_amount = u64::from(source_account.base.amount);
        <span class="kw">if </span>source_amount &lt; amount {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
        }
        <span class="kw">if </span>source_account
            .get_extension::&lt;NonTransferableAccount&gt;()
            .is_ok()
        {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NonTransferable.into());
        }
        <span class="kw">let </span>(fee, maybe_permanent_delegate, maybe_transfer_hook_program_id) =
            <span class="kw">if let </span><span class="prelude-val">Some</span>((mint_info, expected_decimals)) = expected_mint_info {
                <span class="kw">if </span>!cmp_pubkeys(<span class="kw-2">&amp;</span>source_account.base.mint, mint_info.key) {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
                }

                <span class="kw">let </span>mint_data = mint_info.try_borrow_data()<span class="question-mark">?</span>;
                <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)<span class="question-mark">?</span>;

                <span class="kw">if </span>expected_decimals != mint.base.decimals {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into());
                }

                <span class="kw">let </span>fee = <span class="kw">if let </span><span class="prelude-val">Ok</span>(transfer_fee_config) = mint.get_extension::&lt;TransferFeeConfig&gt;()
                {
                    transfer_fee_config
                        .calculate_epoch_fee(Clock::get()<span class="question-mark">?</span>.epoch, amount)
                        .ok_or(TokenError::Overflow)<span class="question-mark">?
                </span>} <span class="kw">else </span>{
                    <span class="number">0
                </span>};

                <span class="kw">let </span>maybe_permanent_delegate = get_permanent_delegate(<span class="kw-2">&amp;</span>mint);
                <span class="kw">let </span>maybe_transfer_hook_program_id = transfer_hook::get_program_id(<span class="kw-2">&amp;</span>mint);
                ...
                <span class="comment">// Transfer hook extension exists on the account, but no mint
                // was provided to figure out required accounts, abort
                </span><span class="kw">if </span>source_account
                    .get_extension::&lt;TransferHookAccount&gt;()
                    .is_ok()
                {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintRequiredForTransfer.into());
                }

                <span class="comment">// Transfer fee amount extension exists on the account, but no mint
                    ...
                    .is_ok()
                {
                    ...
                    (<span class="number">0</span>, <span class="prelude-val">None</span>, <span class="prelude-val">None</span>)
                }
            };
        <span class="kw">if let </span><span class="prelude-val">Some</span>(expected_fee) = expected_fee {
            <span class="kw">if </span>expected_fee != fee {
                <span class="macro">msg!</span>(<span class="string">"Calculated fee {}, received {}"</span>, fee, expected_fee);
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::FeeMismatch.into());
            }
        }

        <span class="kw">let </span>self_transfer = cmp_pubkeys(source_account_info.key, destination_account_info.key);
        <span class="kw">match </span>(source_account.base.delegate, maybe_permanent_delegate) {
            (<span class="kw">_</span>, <span class="prelude-val">Some</span>(<span class="kw-2">ref </span>delegate)) <span class="kw">if </span>cmp_pubkeys(authority_info.key, delegate) =&gt; {
                <span class="self">Self</span>::validate_owner(
                    program_id,
                    delegate,
                    authority_info,
            ...
            ) <span class="kw">if </span>cmp_pubkeys(authority_info.key, <span class="kw-2">&amp;</span>delegate) =&gt; {
                <span class="self">Self</span>::validate_owner(
                    program_id,
                    <span class="kw-2">&amp;</span>delegate,
                    authority_info,
                    authority_info_data_len,
                    account_info_iter.as_slice(),
                )<span class="question-mark">?</span>;
                <span class="kw">let </span>delegated_amount = u64::from(source_account.base.delegated_amount);
                <span class="kw">if </span>delegated_amount &lt; amount {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
                }
                <span class="kw">if </span>!self_transfer {
                    source_account.base.delegated_amount = delegated_amount
                        .checked_sub(amount)
                        .ok_or(TokenError::Overflow)<span class="question-mark">?
                        </span>.into();
                    <span class="kw">if </span>u64::from(source_account.base.delegated_amount) == <span class="number">0 </span>{
            ...
            <span class="kw">_ </span>=&gt; {
                <span class="self">Self</span>::validate_owner(
                    program_id,
                    <span class="kw-2">&amp;</span>source_account.base.owner,
                    authority_info,
                    authority_info_data_len,
                    account_info_iter.as_slice(),
                )<span class="question-mark">?</span>;

                <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = source_account.get_extension::&lt;CpiGuard&gt;() {
                    <span class="kw">if </span>cpi_guard.lock_cpi.into() &amp;&amp; in_cpi() {
                        <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardTransferBlocked.into());
                    }
                }
            }
        }

        <span class="comment">// Revisit this later to see if it's worth adding a check to reduce
        // compute costs, ie:
        // if self_transfer || amount == 0
        </span>check_program_account(source_account_info.owner)<span class="question-mark">?</span>;
        check_program_account(destination_account_info.owner)<span class="question-mark">?</span>;

        <span class="comment">// This check MUST occur just before the amounts are manipulated
        // to ensure self-transfers are fully validated
        </span><span class="kw">if </span>self_transfer {
            <span class="kw">return </span><span class="prelude-val">Ok</span>(());
        }

        <span class="comment">// self-transfer was dealt with earlier, so this *should* be safe
        </span><span class="kw">let </span><span class="kw-2">mut </span>destination_account_data = destination_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>destination_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>destination_account_data)<span class="question-mark">?</span>;

        <span class="kw">if </span>destination_account.base.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }
        <span class="kw">if </span>!cmp_pubkeys(<span class="kw-2">&amp;</span>source_account.base.mint, <span class="kw-2">&amp;</span>destination_account.base.mint) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
        }

        <span class="kw">if </span>memo_required(<span class="kw-2">&amp;</span>destination_account) {
            check_previous_sibling_instruction_is_memo()<span class="question-mark">?</span>;
        }

        <span class="kw">if let </span><span class="prelude-val">Ok</span>(confidential_transfer_state) =
            destination_account.get_extension::&lt;ConfidentialTransferAccount&gt;()
        {
            confidential_transfer_state.non_confidential_transfer_allowed()<span class="question-mark">?
        </span>}
        ...
        <span class="kw">let </span>credited_amount = amount.checked_sub(fee).ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
        destination_account.base.amount = u64::from(destination_account.base.amount)
            .checked_add(credited_amount)
            .ok_or(TokenError::Overflow)<span class="question-mark">?
            </span>.into();
        <span class="kw">if </span>fee &gt; <span class="number">0 </span>{
            <span class="kw">if let </span><span class="prelude-val">Ok</span>(extension) = destination_account.get_extension_mut::&lt;TransferFeeAmount&gt;() {
                <span class="kw">let </span>new_withheld_amount = u64::from(extension.withheld_amount)
                    .checked_add(fee)
                    .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
                extension.withheld_amount = new_withheld_amount.into();
            } <span class="kw">else </span>{
                <span class="comment">// Use the generic error since this should never happen. If there's
                // a fee, then the mint has a fee configured, which means all accounts
                // must have the withholding.
                </span><span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidState.into());
            }
        }

        <span class="kw">if </span>source_account.base.is_native() {
            <span class="kw">let </span>source_starting_lamports = source_account_info.lamports();
            <span class="kw-2">**</span>source_account_info.lamports.borrow_mut() = source_starting_lamports
                .checked_sub(amount)
                .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;

            <span class="kw">let </span>destination_starting_lamports = destination_account_info.lamports();
            <span class="kw-2">**</span>destination_account_info.lamports.borrow_mut() = destination_starting_lamports
                .checked_add(amount)
                .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(program_id) = maybe_transfer_hook_program_id {
            <span class="kw">if let </span><span class="prelude-val">Some</span>((mint_info, <span class="kw">_</span>)) = expected_mint_info {
                <span class="comment">// set transferring flags
                </span>transfer_hook::set_transferring(<span class="kw-2">&amp;mut </span>source_account)<span class="question-mark">?</span>;
                transfer_hook::set_transferring(<span class="kw-2">&amp;mut </span>destination_account)<span class="question-mark">?</span>;

                <span class="comment">// must drop these to avoid the double-borrow during CPI
                </span>drop(source_account_data);
                ...
                <span class="comment">// unset transferring flag
                </span>transfer_hook::unset_transferring(source_account_info)<span class="question-mark">?</span>;
                transfer_hook::unset_transferring(destination_account_info)<span class="question-mark">?</span>;
            } <span class="kw">else </span>{
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintRequiredForTransfer.into());
            }
        }
    ...
    <span class="doccomment">/// Processes an [Approve](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_approve(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        amount: u64,
        expected_decimals: <span class="prelude-ty">Option</span>&lt;u8&gt;,
        ...
        <span class="kw">let </span>delegate_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>owner_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>owner_info_data_len = owner_info.data_len();

        <span class="kw">let </span><span class="kw-2">mut </span>source_account_data = source_account_info.data.borrow_mut();
        <span class="kw">let </span>source_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>source_account_data)<span class="question-mark">?</span>;
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>((mint_info, expected_decimals)) = expected_mint_info {
            ...
            <span class="kw">let </span>mint_data = mint_info.data.borrow();
            <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)<span class="question-mark">?</span>;
            <span class="kw">if </span>expected_decimals != mint.base.decimals {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into());
            }
        ...
        <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = source_account.get_extension::&lt;CpiGuard&gt;() {
            <span class="kw">if </span>cpi_guard.lock_cpi.into() &amp;&amp; in_cpi() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardApproveBlocked.into());
            }
        }

        source_account.base.delegate = PodCOption::some(<span class="kw-2">*</span>delegate_info.key);
        source_account.base.delegated_amount = amount.into();

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [Revoke](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_revoke(program_id: <span class="kw-2">&amp;</span>Pubkey, accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>source_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info_data_len = authority_info.data_len();
        ...
        <span class="self">Self</span>::validate_owner(
            program_id,
            <span class="kw">match </span><span class="kw-2">&amp;</span>source_account.base.delegate {
                PodCOption {
                    option: PodCOption::&lt;Pubkey&gt;::SOME,
                    value: delegate,
                } <span class="kw">if </span>cmp_pubkeys(authority_info.key, delegate) =&gt; delegate,
                <span class="kw">_ </span>=&gt; <span class="kw-2">&amp;</span>source_account.base.owner,
            },
            authority_info,
            authority_info_data_len,
            account_info_iter.as_slice(),
        ...
        source_account.base.delegate = PodCOption::none();
        source_account.base.delegated_amount = <span class="number">0</span>.into();

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes a [SetAuthority](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_set_authority(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        ...
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info_data_len = authority_info.data_len();

        <span class="kw">let </span><span class="kw-2">mut </span>account_data = account_info.data.borrow_mut();
        <span class="kw">if let </span><span class="prelude-val">Ok</span>(<span class="kw-2">mut </span>account) = PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>account_data)
        {
            <span class="kw">if </span>account.base.is_frozen() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
            }

            <span class="kw">match </span>authority_type {
                AuthorityType::AccountOwner =&gt; {
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>account.base.owner,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;

                    <span class="kw">if </span>account.get_extension_mut::&lt;ImmutableOwner&gt;().is_ok() {
                        <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::ImmutableOwner.into());
                    }

                    <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = account.get_extension::&lt;CpiGuard&gt;() {
                        <span class="kw">if </span>cpi_guard.lock_cpi.into() &amp;&amp; in_cpi() {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardSetAuthorityBlocked.into());
                        } <span class="kw">else if </span>cpi_guard.lock_cpi.into() {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardOwnerChangeBlocked.into());
                        }
                    }

                    <span class="kw">if let </span>PodCOption {
                        option: PodCOption::&lt;Pubkey&gt;::SOME,
                        value: authority,
                    } = new_authority
                    {
                        ...
                        <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidInstruction.into());
                    }

                    account.base.delegate = PodCOption::none();
                    account.base.delegated_amount = <span class="number">0</span>.into();

                    <span class="kw">if </span>account.base.is_native() {
                        account.base.close_authority = PodCOption::none();
                    }
                }
                AuthorityType::CloseAccount =&gt; {
                    <span class="kw">let </span>authority = account.base.close_authority.unwrap_or(account.base.owner);
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                    ...
                    <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = account.get_extension::&lt;CpiGuard&gt;() {
                        <span class="kw">if </span>cpi_guard.lock_cpi.into() &amp;&amp; in_cpi() &amp;&amp; new_authority.is_some() {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardSetAuthorityBlocked.into());
                        }
                    }
                ...
                <span class="kw">_ </span>=&gt; {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AuthorityTypeNotSupported.into());
                }
            }
        } <span class="kw">else if let </span><span class="prelude-val">Ok</span>(<span class="kw-2">mut </span>mint) = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;mut </span>account_data)
        {
            <span class="kw">match </span>authority_type {
                AuthorityType::MintTokens =&gt; {
                    <span class="comment">// Once a mint's supply is fixed, it cannot be undone by setting a new
                    // mint_authority
                    </span><span class="kw">let </span>mint_authority = mint
                        .base
                        .mint_authority
                        .ok_or(Into::&lt;ProgramError&gt;::into(TokenError::FixedSupply))<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>mint_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                ...
                AuthorityType::FreezeAccount =&gt; {
                    <span class="comment">// Once a mint's freeze authority is disabled, it cannot be re-enabled by
                    // setting a new freeze_authority
                    </span><span class="kw">let </span>freeze_authority = mint
                        .base
                        .freeze_authority
                        .ok_or(Into::&lt;ProgramError&gt;::into(TokenError::MintCannotFreeze))<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>freeze_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                ...
                AuthorityType::CloseMint =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;MintCloseAuthority&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_close_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.close_authority.into();
                    <span class="kw">let </span>close_authority =
                        maybe_close_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>close_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                    extension.close_authority = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::TransferFeeConfig =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;TransferFeeConfig&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_transfer_fee_config_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; =
                        extension.transfer_fee_config_authority.into();
                    <span class="kw">let </span>transfer_fee_config_authority = maybe_transfer_fee_config_authority
                        .ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>transfer_fee_config_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                    extension.transfer_fee_config_authority = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::WithheldWithdraw =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;TransferFeeConfig&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_withdraw_withheld_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; =
                        extension.withdraw_withheld_authority.into();
                    <span class="kw">let </span>withdraw_withheld_authority = maybe_withdraw_withheld_authority
                        .ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>withdraw_withheld_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                    extension.withdraw_withheld_authority = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::InterestRate =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;InterestBearingConfig&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_rate_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.rate_authority.into();
                    <span class="kw">let </span>rate_authority =
                        maybe_rate_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>rate_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                    extension.rate_authority = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::PermanentDelegate =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;PermanentDelegate&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_delegate: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.delegate.into();
                    <span class="kw">let </span>delegate = maybe_delegate.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>delegate,
                        authority_info,
                    ...
                    extension.delegate = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::ConfidentialTransferMint =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;ConfidentialTransferMint&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_confidential_transfer_mint_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; =
                        extension.authority.into();
                    <span class="kw">let </span>confidential_transfer_mint_authority =
                        maybe_confidential_transfer_mint_authority
                            .ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>confidential_transfer_mint_authority,
                        authority_info,
                        authority_info_data_len,
                        account_info_iter.as_slice(),
                    )<span class="question-mark">?</span>;
                    extension.authority = new_authority.try_into()<span class="question-mark">?</span>;
                }
                AuthorityType::TransferHookProgramId =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;TransferHook&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.authority.into();
                    <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        <span class="kw-2">&amp;</span>authority,
                        authority_info,
                ...
                AuthorityType::ConfidentialTransferFeeConfig =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;ConfidentialTransferFeeConfig&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.authority.into();
                    <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                ...
                AuthorityType::MetadataPointer =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;MetadataPointer&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.authority.into();
                    <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                ...
                AuthorityType::GroupPointer =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;GroupPointer&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.authority.into();
                    <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                ...
                AuthorityType::GroupMemberPointer =&gt; {
                    <span class="kw">let </span>extension = mint.get_extension_mut::&lt;GroupMemberPointer&gt;()<span class="question-mark">?</span>;
                    <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.authority.into();
                    <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::validate_owner(
                        program_id,
    ...
    <span class="doccomment">/// Processes a [MintTo](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_mint_to(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        amount: u64,
        expected_decimals: <span class="prelude-ty">Option</span>&lt;u8&gt;,
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>destination_account_data = destination_account_info.data.borrow_mut();
        <span class="kw">let </span>destination_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>destination_account_data)<span class="question-mark">?</span>;
        <span class="kw">if </span>destination_account.base.is_frozen() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AccountFrozen.into());
        }

        <span class="kw">if </span>destination_account.base.is_native() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NativeNotSupported.into());
        }
        <span class="kw">if </span>!cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span>destination_account.base.mint) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
        }

        <span class="kw">let </span><span class="kw-2">mut </span>mint_data = mint_info.data.borrow_mut();
        <span class="kw">let </span>mint = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;mut </span>mint_data)<span class="question-mark">?</span>;

        <span class="comment">// If the mint if non-transferable, only allow minting to accounts
        // with immutable ownership.
        </span><span class="kw">if </span>mint.get_extension::&lt;NonTransferable&gt;().is_ok()
            &amp;&amp; destination_account
                .get_extension::&lt;ImmutableOwner&gt;()
                .is_err()
        {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NonTransferableNeedsImmutableOwnership.into());
        }

        <span class="kw">if let </span><span class="prelude-val">Some</span>(expected_decimals) = expected_decimals {
            <span class="kw">if </span>expected_decimals != mint.base.decimals {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into());
            }
        }

        <span class="kw">match </span><span class="kw-2">&amp;</span>mint.base.mint_authority {
            PodCOption {
                option: PodCOption::&lt;Pubkey&gt;::SOME,
            ...
            <span class="kw">_ </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::FixedSupply.into()),
        }

        <span class="comment">// Revisit this later to see if it's worth adding a check to reduce
        // compute costs, ie:
        // if amount == 0
        </span>check_program_account(mint_info.owner)<span class="question-mark">?</span>;
        check_program_account(destination_account_info.owner)<span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Processes a [Burn](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_burn(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        amount: u64,
        expected_decimals: <span class="prelude-ty">Option</span>&lt;u8&gt;,
        ...
        <span class="kw">if </span>u64::from(source_account.base.amount) &lt; amount {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
        }
        <span class="kw">if </span>mint_info.key != <span class="kw-2">&amp;</span>source_account.base.mint {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
        }
        ...
        {
            <span class="kw">match </span>(<span class="kw-2">&amp;</span>source_account.base.delegate, maybe_permanent_delegate) {
                (<span class="kw">_</span>, <span class="prelude-val">Some</span>(<span class="kw-2">ref </span>delegate)) <span class="kw">if </span>cmp_pubkeys(authority_info.key, delegate) =&gt; {
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        delegate,
                ...
                (
                    ...
                    <span class="kw">_</span>,
                ) <span class="kw">if </span>cmp_pubkeys(authority_info.key, delegate) =&gt; {
                    <span class="self">Self</span>::validate_owner(
                        program_id,
                        delegate,
                        authority_info,
                    ...
                    <span class="kw">if </span>u64::from(source_account.base.delegated_amount) &lt; amount {
                        <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into());
                    }
                ...
                <span class="kw">_ </span>=&gt; {
                    ...
                    <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = source_account.get_extension::&lt;CpiGuard&gt;() {
                        <span class="kw">if </span>cpi_guard.lock_cpi.into() &amp;&amp; in_cpi() {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardBurnBlocked.into());
                        }
                    }
                }
            }
        ...
        check_program_account(mint_info.owner)<span class="question-mark">?</span>;
    ...
    <span class="doccomment">/// Processes a [CloseAccount](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_close_account(program_id: <span class="kw-2">&amp;</span>Pubkey, accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>source_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>destination_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        ...
        <span class="kw">if </span>cmp_pubkeys(source_account_info.key, destination_account_info.key) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::InvalidAccountData);
        }

        <span class="kw">let </span>source_account_data = source_account_info.data.borrow();
        <span class="kw">if let </span><span class="prelude-val">Ok</span>(source_account) =
            PodStateWithExtensions::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;</span>source_account_data)
        {
            <span class="kw">if </span>!source_account.base.is_native() &amp;&amp; u64::from(source_account.base.amount) != <span class="number">0 </span>{
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NonNativeHasBalance.into());
            }

            <span class="kw">let </span>authority = source_account
                .base
                .close_authority
            ...
            {
                <span class="kw">if let </span><span class="prelude-val">Ok</span>(cpi_guard) = source_account.get_extension::&lt;CpiGuard&gt;() {
                    <span class="kw">if </span>cpi_guard.lock_cpi.into()
                        &amp;&amp; in_cpi()
                        &amp;&amp; !cmp_pubkeys(destination_account_info.key, <span class="kw-2">&amp;</span>source_account.base.owner)
                    {
                        <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::CpiGuardCloseAccountBlocked.into());
                    }
                }
            ...
            } <span class="kw">else if </span>!solana_program::incinerator::check_id(destination_account_info.key) {
                <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::InvalidAccountData);
            }
            ...
            {
                confidential_transfer_state.closable()<span class="question-mark">?
            </span>}

            <span class="kw">if let </span><span class="prelude-val">Ok</span>(confidential_transfer_fee_state) =
                source_account.get_extension::&lt;ConfidentialTransferFeeAmount&gt;()
            {
                confidential_transfer_fee_state.closable()<span class="question-mark">?
            </span>}

            <span class="kw">if let </span><span class="prelude-val">Ok</span>(transfer_fee_state) = source_account.get_extension::&lt;TransferFeeAmount&gt;() {
                transfer_fee_state.closable()<span class="question-mark">?
            </span>}
        } <span class="kw">else if let </span><span class="prelude-val">Ok</span>(mint) = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>source_account_data) {
            <span class="kw">let </span>extension = mint.get_extension::&lt;MintCloseAuthority&gt;()<span class="question-mark">?</span>;
            <span class="kw">let </span>maybe_authority: <span class="prelude-ty">Option</span>&lt;Pubkey&gt; = extension.close_authority.into();
            <span class="kw">let </span>authority = maybe_authority.ok_or(TokenError::AuthorityTypeNotSupported)<span class="question-mark">?</span>;
            <span class="self">Self</span>::validate_owner(
                program_id,
                <span class="kw-2">&amp;</span>authority,
            ...
            <span class="kw">if </span>u64::from(mint.base.supply) != <span class="number">0 </span>{
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintHasSupply.into());
            }
        } <span class="kw">else </span>{
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::UninitializedAccount);
        }
        ...
        <span class="kw-2">**</span>source_account_info.lamports.borrow_mut() = <span class="number">0</span>;
        drop(source_account_data);
        delete_account(source_account_info)<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes a [FreezeAccount](enum.TokenInstruction.html) or a
    /// [ThawAccount](enum.TokenInstruction.html) instruction.
    </span><span class="kw">pub fn </span>process_toggle_freeze_account(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        freeze: bool,
    ) -&gt; ProgramResult {
        ...
        <span class="kw">let </span>source_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>source_account_data)<span class="question-mark">?</span>;
        <span class="kw">if </span>freeze &amp;&amp; source_account.base.is_frozen() || !freeze &amp;&amp; !source_account.base.is_frozen()
        {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidState.into());
        }
        <span class="kw">if </span>source_account.base.is_native() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NativeNotSupported.into());
        }
        <span class="kw">if </span>!cmp_pubkeys(mint_info.key, <span class="kw-2">&amp;</span>source_account.base.mint) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::MintMismatch.into());
        }

        <span class="kw">let </span>mint_data = mint_info.data.borrow();
        <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)<span class="question-mark">?</span>;
        <span class="kw">match </span><span class="kw-2">&amp;</span>mint.base.freeze_authority {
            PodCOption {
                option: PodCOption::&lt;Pubkey&gt;::SOME,
                value: authority,
            } =&gt; <span class="self">Self</span>::validate_owner(
            ...
            <span class="kw">_ </span>=&gt; <span class="prelude-val">Err</span>(TokenError::MintCannotFreeze.into()),
        }<span class="question-mark">?</span>;

        source_account.base.state = <span class="kw">if </span>freeze {
    ...
    <span class="doccomment">/// Processes a [SyncNative](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_sync_native(accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>native_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        check_program_account(native_account_info.owner)<span class="question-mark">?</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>native_account_data = native_account_info.data.borrow_mut();
        <span class="kw">let </span>native_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;mut </span>native_account_data)<span class="question-mark">?</span>;

        <span class="kw">match </span>native_account.base.is_native {
            PodCOption {
                option: PodCOption::&lt;PodU64&gt;::SOME,
                value: amount,
            } =&gt; {
                <span class="kw">let </span>new_amount = native_account_info
                    .lamports()
                    .checked_sub(u64::from(amount))
                    .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;
                <span class="kw">if </span>new_amount &lt; u64::from(native_account.base.amount) {
                    <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidState.into());
                }
                native_account.base.amount = new_amount.into();
            }
            <span class="kw">_ </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NonNativeNotSupported.into()),
        }

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [InitializeMintCloseAuthority](enum.TokenInstruction.html)
    /// instruction
    </span><span class="kw">pub fn </span>process_initialize_mint_close_authority(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        close_authority: PodCOption&lt;Pubkey&gt;,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        <span class="kw">let </span><span class="kw-2">mut </span>mint_data = mint_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>mint = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack_uninitialized(<span class="kw-2">&amp;mut </span>mint_data)<span class="question-mark">?</span>;
        <span class="kw">let </span>extension = mint.init_extension::&lt;MintCloseAuthority&gt;(<span class="bool-val">true</span>)<span class="question-mark">?</span>;
        extension.close_authority = close_authority.try_into()<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes a [GetAccountDataSize](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_get_account_data_size(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        new_extension_types: <span class="kw-2">&amp;</span>[ExtensionType],
    ) -&gt; ProgramResult {
        <span class="kw">if </span>new_extension_types
            .iter()
            .any(|<span class="kw-2">&amp;</span>t| t.get_account_type() != AccountType::Account)
        {
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>account_extensions = <span class="self">Self</span>::get_required_account_extensions(mint_account_info)<span class="question-mark">?</span>;
        <span class="comment">// ExtensionType::try_calculate_account_len() dedupes types, so just a dumb
        // concatenation is fine here
        </span>account_extensions.extend_from_slice(new_extension_types);

        <span class="kw">let </span>account_len = ExtensionType::try_calculate_account_len::&lt;Account&gt;(<span class="kw-2">&amp;</span>account_extensions)<span class="question-mark">?</span>;
        set_return_data(<span class="kw-2">&amp;</span>account_len.to_le_bytes());

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [InitializeImmutableOwner](enum.TokenInstruction.html)
    /// instruction
    </span><span class="kw">pub fn </span>process_initialize_immutable_owner(accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>token_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>token_account_data = <span class="kw-2">&amp;mut </span>token_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>token_account =
            PodStateWithExtensionsMut::&lt;PodAccount&gt;::unpack_uninitialized(token_account_data)<span class="question-mark">?</span>;
        token_account
            .init_extension::&lt;ImmutableOwner&gt;(<span class="bool-val">true</span>)
            .map(|<span class="kw">_</span>| ())
    }

    <span class="doccomment">/// Processes an [AmountToUiAmount](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_amount_to_ui_amount(accounts: <span class="kw-2">&amp;</span>[AccountInfo], amount: u64) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        check_program_account(mint_info.owner)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="kw">let </span>ui_amount = <span class="kw">if let </span><span class="prelude-val">Ok</span>(extension) = mint.get_extension::&lt;InterestBearingConfig&gt;() {
            <span class="kw">let </span>unix_timestamp = Clock::get()<span class="question-mark">?</span>.unix_timestamp;
            extension
                .amount_to_ui_amount(amount, mint.base.decimals, unix_timestamp)
                .ok_or(ProgramError::InvalidArgument)<span class="question-mark">?
        </span>} <span class="kw">else </span>{
            <span class="kw">crate</span>::amount_to_ui_amount_string_trimmed(amount, mint.base.decimals)
        };

        set_return_data(<span class="kw-2">&amp;</span>ui_amount.into_bytes());
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [AmountToUiAmount](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_ui_amount_to_amount(accounts: <span class="kw-2">&amp;</span>[AccountInfo], ui_amount: <span class="kw-2">&amp;</span>str) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        check_program_account(mint_info.owner)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span>mint = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="kw">let </span>amount = <span class="kw">if let </span><span class="prelude-val">Ok</span>(extension) = mint.get_extension::&lt;InterestBearingConfig&gt;() {
            <span class="kw">let </span>unix_timestamp = Clock::get()<span class="question-mark">?</span>.unix_timestamp;
            extension.try_ui_amount_into_amount(ui_amount, mint.base.decimals, unix_timestamp)<span class="question-mark">?
        </span>} <span class="kw">else </span>{
            <span class="kw">crate</span>::try_ui_amount_into_amount(ui_amount.to_string(), mint.base.decimals)<span class="question-mark">?
        </span>};

        set_return_data(<span class="kw-2">&amp;</span>amount.to_le_bytes());
        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes a [CreateNativeMint](enum.TokenInstruction.html) instruction
    </span><span class="kw">pub fn </span>process_create_native_mint(accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>payer_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>native_mint_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>system_program_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        <span class="kw">if </span><span class="kw-2">*</span>native_mint_info.key != native_mint::id() {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::InvalidMint.into());
        }

        <span class="kw">let </span>rent = Rent::get()<span class="question-mark">?</span>;
        <span class="kw">let </span>new_minimum_balance = rent.minimum_balance(Mint::get_packed_len());
        <span class="kw">let </span>lamports_diff = new_minimum_balance.saturating_sub(native_mint_info.lamports());
        invoke(
            <span class="kw-2">&amp;</span>system_instruction::transfer(payer_info.key, native_mint_info.key, lamports_diff),
        ...
        invoke_signed(
            <span class="kw-2">&amp;</span>system_instruction::allocate(native_mint_info.key, Mint::get_packed_len() <span class="kw">as </span>u64),
            <span class="kw-2">&amp;</span>[native_mint_info.clone(), system_program_info.clone()],
            <span class="kw-2">&amp;</span>[native_mint::PROGRAM_ADDRESS_SEEDS],
        )<span class="question-mark">?</span>;

        invoke_signed(
            <span class="kw-2">&amp;</span>system_instruction::assign(native_mint_info.key, <span class="kw-2">&amp;</span><span class="kw">crate</span>::id()),
            <span class="kw-2">&amp;</span>[native_mint_info.clone(), system_program_info.clone()],
            <span class="kw-2">&amp;</span>[native_mint::PROGRAM_ADDRESS_SEEDS],
        )<span class="question-mark">?</span>;
        ...
        Mint::pack(
            Mint {
                ...
                is_initialized: <span class="bool-val">true</span>,
                ..Mint::default()
            },
            <span class="kw-2">&amp;mut </span>native_mint_info.data.borrow_mut(),
        )
    }

    <span class="doccomment">/// Processes an [InitializeNonTransferableMint](enum.TokenInstruction.html)
    /// instruction
    </span><span class="kw">pub fn </span>process_initialize_non_transferable_mint(accounts: <span class="kw-2">&amp;</span>[AccountInfo]) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        <span class="kw">let </span><span class="kw-2">mut </span>mint_data = mint_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>mint = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack_uninitialized(<span class="kw-2">&amp;mut </span>mint_data)<span class="question-mark">?</span>;
        mint.init_extension::&lt;NonTransferable&gt;(<span class="bool-val">true</span>)<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Processes an [InitializePermanentDelegate](enum.TokenInstruction.html)
    /// instruction
    </span><span class="kw">pub fn </span>process_initialize_permanent_delegate(
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
        delegate: <span class="kw-2">&amp;</span>Pubkey,
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();
        <span class="kw">let </span>mint_account_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>mint_data = mint_account_info.data.borrow_mut();
        <span class="kw">let </span><span class="kw-2">mut </span>mint = PodStateWithExtensionsMut::&lt;PodMint&gt;::unpack_uninitialized(<span class="kw-2">&amp;mut </span>mint_data)<span class="question-mark">?</span>;
        <span class="kw">let </span>extension = mint.init_extension::&lt;PermanentDelegate&gt;(<span class="bool-val">true</span>)<span class="question-mark">?</span>;
        extension.delegate = <span class="prelude-val">Some</span>(<span class="kw-2">*</span>delegate).try_into()<span class="question-mark">?</span>;

        <span class="prelude-val">Ok</span>(())
    }

    <span class="doccomment">/// Withdraw Excess Lamports is used to recover Lamports transferred to any
    /// TokenProgram owned account by moving them to another account
    /// of the source account.
    </span><span class="kw">pub fn </span>process_withdraw_excess_lamports(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        accounts: <span class="kw-2">&amp;</span>[AccountInfo],
    ) -&gt; ProgramResult {
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>accounts.iter();

        <span class="kw">let </span>source_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>destination_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;
        <span class="kw">let </span>authority_info = next_account_info(account_info_iter)<span class="question-mark">?</span>;

        <span class="kw">let </span>source_data = source_info.data.borrow();

        <span class="kw">if let </span><span class="prelude-val">Ok</span>(account) = PodStateWithExtensions::&lt;PodAccount&gt;::unpack(<span class="kw-2">&amp;</span>source_data) {
            <span class="kw">if </span>account.base.is_native() {
                <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::NativeNotSupported.into());
            }
            <span class="self">Self</span>::validate_owner(
        ...
        } <span class="kw">else if let </span><span class="prelude-val">Ok</span>(mint) = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>source_data) {
            <span class="kw">match </span><span class="kw-2">&amp;</span>mint.base.mint_authority {
                PodCOption {
                    option: PodCOption::&lt;Pubkey&gt;::SOME,
                    value: mint_authority,
                ...
                <span class="kw">_ </span>=&gt; <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::AuthorityTypeNotSupported.into()),
            }
        } <span class="kw">else if </span>source_data.len() == PodMultisig::SIZE_OF {
            <span class="self">Self</span>::validate_owner(
                program_id,
                source_info.key,
                authority_info,
        ...
        <span class="kw">let </span>source_rent_exempt_reserve = Rent::get()<span class="question-mark">?</span>.minimum_balance(source_info.data_len());

        <span class="kw">let </span>transfer_amount = source_info
            .lamports()
            .checked_sub(source_rent_exempt_reserve)
            .ok_or(TokenError::NotRentExempt)<span class="question-mark">?</span>;

        <span class="kw">let </span>source_starting_lamports = source_info.lamports();
        <span class="kw-2">**</span>source_info.lamports.borrow_mut() = source_starting_lamports
            .checked_sub(transfer_amount)
            .ok_or(TokenError::Overflow)<span class="question-mark">?</span>;

        <span class="kw">let </span>destination_starting_lamports = destination_info.lamports();
        <span class="kw-2">**</span>destination_info.lamports.borrow_mut() = destination_starting_lamports
    ...
    <span class="doccomment">/// Processes an [Instruction](enum.Instruction.html).
    </span><span class="kw">pub fn </span>process(program_id: <span class="kw-2">&amp;</span>Pubkey, accounts: <span class="kw-2">&amp;</span>[AccountInfo], input: <span class="kw-2">&amp;</span>[u8]) -&gt; ProgramResult {
        <span class="kw">if let </span><span class="prelude-val">Ok</span>(instruction_type) = decode_instruction_type(input) {
            <span class="kw">match </span>instruction_type {
                PodTokenInstruction::InitializeMint =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMint"</span>);
                    <span class="kw">let </span>(data, freeze_authority) =
                        decode_instruction_data_with_coption_pubkey::&lt;InitializeMintData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_mint(
                        accounts,
                        data.decimals,
                        <span class="kw-2">&amp;</span>data.mint_authority,
                        freeze_authority,
                    )
                }
                PodTokenInstruction::InitializeMint2 =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMint2"</span>);
                    <span class="kw">let </span>(data, freeze_authority) =
                        decode_instruction_data_with_coption_pubkey::&lt;InitializeMintData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_mint2(
                        accounts,
                        data.decimals,
                        <span class="kw-2">&amp;</span>data.mint_authority,
                        freeze_authority,
                ...
                PodTokenInstruction::InitializeAccount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount"</span>);
                    <span class="self">Self</span>::process_initialize_account(accounts)
                }
                PodTokenInstruction::InitializeAccount2 =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount2"</span>);
                    <span class="kw">let </span>owner = decode_instruction_data::&lt;Pubkey&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_account2(accounts, owner)
                }
                PodTokenInstruction::InitializeAccount3 =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeAccount3"</span>);
                    <span class="kw">let </span>owner = decode_instruction_data::&lt;Pubkey&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_account3(accounts, owner)
                }
                PodTokenInstruction::InitializeMultisig =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMultisig"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;InitializeMultisigData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_multisig(accounts, data.m)
                }
                PodTokenInstruction::InitializeMultisig2 =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMultisig2"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;InitializeMultisigData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_multisig2(accounts, data.m)
                }
                <span class="attr">#[allow(deprecated)]
                </span>PodTokenInstruction::Transfer =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: Transfer"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_transfer(program_id, accounts, data.amount.into(), <span class="prelude-val">None</span>, <span class="prelude-val">None</span>)
                }
                PodTokenInstruction::Approve =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: Approve"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_approve(program_id, accounts, data.amount.into(), <span class="prelude-val">None</span>)
                }
                PodTokenInstruction::Revoke =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: Revoke"</span>);
                    <span class="self">Self</span>::process_revoke(program_id, accounts)
                }
                PodTokenInstruction::SetAuthority =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: SetAuthority"</span>);
                    <span class="kw">let </span>(data, new_authority) =
                        decode_instruction_data_with_coption_pubkey::&lt;SetAuthorityData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_set_authority(
                        program_id,
                        accounts,
                        AuthorityType::from(data.authority_type)<span class="question-mark">?</span>,
                        new_authority,
                    )
                }
                PodTokenInstruction::MintTo =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: MintTo"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_mint_to(program_id, accounts, data.amount.into(), <span class="prelude-val">None</span>)
                }
                PodTokenInstruction::Burn =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: Burn"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_burn(program_id, accounts, data.amount.into(), <span class="prelude-val">None</span>)
                }
                PodTokenInstruction::CloseAccount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: CloseAccount"</span>);
                    <span class="self">Self</span>::process_close_account(program_id, accounts)
                }
                PodTokenInstruction::FreezeAccount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: FreezeAccount"</span>);
                    <span class="self">Self</span>::process_toggle_freeze_account(program_id, accounts, <span class="bool-val">true</span>)
                }
                PodTokenInstruction::ThawAccount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: ThawAccount"</span>);
                    <span class="self">Self</span>::process_toggle_freeze_account(program_id, accounts, <span class="bool-val">false</span>)
                }
                PodTokenInstruction::TransferChecked =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: TransferChecked"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountCheckedData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_transfer(
                        program_id,
                        accounts,
                        data.amount.into(),
                        <span class="prelude-val">Some</span>(data.decimals),
                        <span class="prelude-val">None</span>,
                    )
                }
                PodTokenInstruction::ApproveChecked =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: ApproveChecked"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountCheckedData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_approve(
                        program_id,
                        accounts,
                        data.amount.into(),
                        <span class="prelude-val">Some</span>(data.decimals),
                ...
                PodTokenInstruction::MintToChecked =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: MintToChecked"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountCheckedData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_mint_to(
                        program_id,
                        accounts,
                        data.amount.into(),
                        <span class="prelude-val">Some</span>(data.decimals),
                ...
                PodTokenInstruction::BurnChecked =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: BurnChecked"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountCheckedData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_burn(
                        program_id,
                        accounts,
                        data.amount.into(),
                        <span class="prelude-val">Some</span>(data.decimals),
                ...
                PodTokenInstruction::SyncNative =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: SyncNative"</span>);
                    <span class="self">Self</span>::process_sync_native(accounts)
                }
                PodTokenInstruction::GetAccountDataSize =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: GetAccountDataSize"</span>);
                    <span class="kw">let </span>extension_types = input[<span class="number">1</span>..]
                    ...
                    <span class="self">Self</span>::process_get_account_data_size(accounts, <span class="kw-2">&amp;</span>extension_types)
                }
                PodTokenInstruction::InitializeMintCloseAuthority =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeMintCloseAuthority"</span>);
                    <span class="kw">let </span>(<span class="kw">_</span>, close_authority) =
                        decode_instruction_data_with_coption_pubkey::&lt;()&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_mint_close_authority(accounts, close_authority)
                }
                PodTokenInstruction::TransferFeeExtension =&gt; {
                    transfer_fee::processor::process_instruction(program_id, accounts, <span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                }
                PodTokenInstruction::ConfidentialTransferExtension =&gt; {
                    confidential_transfer::processor::process_instruction(
                        program_id,
                        accounts,
                        <span class="kw-2">&amp;</span>input[<span class="number">1</span>..],
                    )
                }
                ...
                PodTokenInstruction::InitializeImmutableOwner =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeImmutableOwner"</span>);
                    <span class="self">Self</span>::process_initialize_immutable_owner(accounts)
                }
                PodTokenInstruction::AmountToUiAmount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: AmountToUiAmount"</span>);
                    <span class="kw">let </span>data = decode_instruction_data::&lt;AmountData&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_amount_to_ui_amount(accounts, data.amount.into())
                }
                PodTokenInstruction::UiAmountToAmount =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: UiAmountToAmount"</span>);
                    <span class="kw">let </span>ui_amount = std::str::from_utf8(<span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                        .map_err(|<span class="kw">_</span>| TokenError::InvalidInstruction)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_ui_amount_to_amount(accounts, ui_amount)
                }
                PodTokenInstruction::Reallocate =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: Reallocate"</span>);
                    <span class="kw">let </span>extension_types = input[<span class="number">1</span>..]
                        .chunks(std::mem::size_of::&lt;ExtensionType&gt;())
                        .map(ExtensionType::try_from)
                        .collect::&lt;<span class="prelude-ty">Result</span>&lt;Vec&lt;<span class="kw">_</span>&gt;, <span class="kw">_</span>&gt;&gt;()<span class="question-mark">?</span>;
                ...
                PodTokenInstruction::MemoTransferExtension =&gt; {
                    memo_transfer::processor::process_instruction(program_id, accounts, <span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                }
                PodTokenInstruction::CreateNativeMint =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: CreateNativeMint"</span>);
                    <span class="self">Self</span>::process_create_native_mint(accounts)
                }
                PodTokenInstruction::InitializeNonTransferableMint =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializeNonTransferableMint"</span>);
                    <span class="self">Self</span>::process_initialize_non_transferable_mint(accounts)
                }
                ...
                PodTokenInstruction::CpiGuardExtension =&gt; {
                    cpi_guard::processor::process_instruction(program_id, accounts, <span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                }
                PodTokenInstruction::InitializePermanentDelegate =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: InitializePermanentDelegate"</span>);
                    <span class="kw">let </span>delegate = decode_instruction_data::&lt;Pubkey&gt;(input)<span class="question-mark">?</span>;
                    <span class="self">Self</span>::process_initialize_permanent_delegate(accounts, delegate)
                }
                PodTokenInstruction::TransferHookExtension =&gt; {
                    transfer_hook::processor::process_instruction(program_id, accounts, <span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                }
                ...
                PodTokenInstruction::WithdrawExcessLamports =&gt; {
                    <span class="macro">msg!</span>(<span class="string">"Instruction: WithdrawExcessLamports"</span>);
                    <span class="self">Self</span>::process_withdraw_excess_lamports(program_id, accounts)
                }
                ...
                PodTokenInstruction::GroupPointerExtension =&gt; {
                    group_pointer::processor::process_instruction(program_id, accounts, <span class="kw-2">&amp;</span>input[<span class="number">1</span>..])
                }
        ...
        } <span class="kw">else if let </span><span class="prelude-val">Ok</span>(instruction) = TokenMetadataInstruction::unpack(input) {
            token_metadata::processor::process_instruction(program_id, accounts, instruction)
        } <span class="kw">else if let </span><span class="prelude-val">Ok</span>(instruction) = TokenGroupInstruction::unpack(input) {
            token_group::processor::process_instruction(program_id, accounts, instruction)
        } <span class="kw">else </span>{
            <span class="prelude-val">Err</span>(TokenError::InvalidInstruction.into())
        }
    }

    <span class="doccomment">/// Validates owner(s) are present. Used for Mints and Accounts only.
    </span><span class="kw">pub fn </span>validate_owner(
        program_id: <span class="kw-2">&amp;</span>Pubkey,
        expected_owner: <span class="kw-2">&amp;</span>Pubkey,
        owner_account_info: <span class="kw-2">&amp;</span>AccountInfo,
        owner_account_data_len: usize,
        signers: <span class="kw-2">&amp;</span>[AccountInfo],
    ) -&gt; ProgramResult {
        <span class="kw">if </span>!cmp_pubkeys(expected_owner, owner_account_info.key) {
            <span class="kw">return </span><span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into());
        }

        <span class="kw">if </span>cmp_pubkeys(program_id, owner_account_info.owner)
            &amp;&amp; owner_account_data_len == PodMultisig::SIZE_OF
        {
            <span class="kw">let </span>multisig_data = <span class="kw-2">&amp;</span>owner_account_info.data.borrow();
            <span class="kw">let </span>multisig = pod_from_bytes::&lt;PodMultisig&gt;(multisig_data)<span class="question-mark">?</span>;
            <span class="kw">let </span><span class="kw-2">mut </span>num_signers = <span class="number">0</span>;
            <span class="kw">let </span><span class="kw-2">mut </span>matched = [<span class="bool-val">false</span>; MAX_SIGNERS];
            <span class="kw">for </span>signer <span class="kw">in </span>signers.iter() {
                <span class="kw">for </span>(position, key) <span class="kw">in </span>multisig.signers[<span class="number">0</span>..multisig.n <span class="kw">as </span>usize].iter().enumerate() {
                    <span class="kw">if </span>cmp_pubkeys(key, signer.key) &amp;&amp; !matched[position] {
                        <span class="kw">if </span>!signer.is_signer {
                            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature);
                        }
                        matched[position] = <span class="bool-val">true</span>;
                        num_signers += <span class="number">1</span>;
                    }
                }
            }
            <span class="kw">if </span>num_signers &lt; multisig.m {
                <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature);
            }
            <span class="kw">return </span><span class="prelude-val">Ok</span>(());
        } <span class="kw">else if </span>!owner_account_info.is_signer {
            <span class="kw">return </span><span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature);
        }
        <span class="prelude-val">Ok</span>(())
    }

    <span class="kw">fn </span>get_required_account_extensions(
        mint_account_info: <span class="kw-2">&amp;</span>AccountInfo,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;ExtensionType&gt;, ProgramError&gt; {
        <span class="kw">let </span>mint_data = mint_account_info.data.borrow();
        <span class="kw">let </span>state = PodStateWithExtensions::&lt;PodMint&gt;::unpack(<span class="kw-2">&amp;</span>mint_data)
            .map_err(|<span class="kw">_</span>| Into::&lt;ProgramError&gt;::into(TokenError::InvalidMint))<span class="question-mark">?</span>;
        <span class="self">Self</span>::get_required_account_extensions_from_unpacked_mint(mint_account_info.owner, <span class="kw-2">&amp;</span>state)
    }

    <span class="kw">fn </span>get_required_account_extensions_from_unpacked_mint(
        token_program_id: <span class="kw-2">&amp;</span>Pubkey,
        state: <span class="kw-2">&amp;</span>PodStateWithExtensions&lt;PodMint&gt;,
    ) -&gt; <span class="prelude-ty">Result</span>&lt;Vec&lt;ExtensionType&gt;, ProgramError&gt; {
        check_program_account(token_program_id)<span class="question-mark">?</span>;
        <span class="kw">let </span>mint_extensions = state.get_extension_types()<span class="question-mark">?</span>;
        <span class="prelude-val">Ok</span>(ExtensionType::get_required_init_account_extensions(
            <span class="kw-2">&amp;</span>mint_extensions,
        ))
    }
}

<span class="doccomment">/// Helper function to mostly delete an account in a test environment.  We could
...
</span><span class="kw">fn </span>delete_account(account_info: <span class="kw-2">&amp;</span>AccountInfo) -&gt; <span class="prelude-ty">Result</span>&lt;(), ProgramError&gt; {
    account_info.assign(<span class="kw-2">&amp;</span>system_program::id());
    <span class="kw">let </span><span class="kw-2">mut </span>account_data = account_info.data.borrow_mut();
    <span class="kw">let </span>data_len = account_data.len();
    solana_program::program_memory::sol_memset(<span class="kw-2">*</span>account_data, <span class="number">0</span>, data_len);
    <span class="prelude-val">Ok</span>(())
}

<span class="doccomment">/// Helper function to totally delete an account on-chain
</span><span class="attr">#[cfg(target_os = <span class="string">"solana"</span>)]
</span><span class="kw">fn </span>delete_account(account_info: <span class="kw-2">&amp;</span>AccountInfo) -&gt; <span class="prelude-ty">Result</span>&lt;(), ProgramError&gt; {
    account_info.assign(<span class="kw-2">&amp;</span>system_program::id());
    account_info.realloc(<span class="number">0</span>, <span class="bool-val">false</span>)
}
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span>{
        ...
        <span class="kw">crate</span>::{
            extension::transfer_fee::instruction::initialize_transfer_fee_config, instruction::<span class="kw-2">*</span>,
            state::Multisig,
        },
        serial_test::serial,
        solana_program::{
            ...
            program_error::{<span class="self">self</span>, PrintProgramError},
            program_option::COption,
            sysvar::{clock::Clock, rent},
        },
        solana_sdk::account::{
            create_account_for_test, create_is_signer_account_infos, Account <span class="kw">as </span>SolanaAccount,
        },
        std::sync::{Arc, RwLock},
    };

    <span class="macro">lazy_static::lazy_static!</span> {
        <span class="kw">static </span><span class="kw-2">ref </span>EXPECTED_DATA: Arc&lt;RwLock&lt;Vec&lt;u8&gt;&gt;&gt; = Arc::new(RwLock::new(Vec::new()));
    }

    <span class="kw">fn </span>set_expected_data(expected_data: Vec&lt;u8&gt;) {
        <span class="kw-2">*</span>EXPECTED_DATA.write().unwrap() = expected_data;
    }

    <span class="kw">struct </span>SyscallStubs {}
    <span class="kw">impl </span>solana_sdk::program_stubs::SyscallStubs <span class="kw">for </span>SyscallStubs {
        <span class="kw">fn </span>sol_log(<span class="kw-2">&amp;</span><span class="self">self</span>, _message: <span class="kw-2">&amp;</span>str) {}

        <span class="kw">fn </span>sol_invoke_signed(
            <span class="kw-2">&amp;</span><span class="self">self</span>,
            _instruction: <span class="kw-2">&amp;</span>Instruction,
            _account_infos: <span class="kw-2">&amp;</span>[AccountInfo],
            _signers_seeds: <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>[u8]]],
        ) -&gt; ProgramResult {
            <span class="prelude-val">Err</span>(ProgramError::Custom(<span class="number">42</span>)) <span class="comment">// Not supported
        </span>}

        <span class="kw">fn </span>sol_get_clock_sysvar(<span class="kw-2">&amp;</span><span class="self">self</span>, var_addr: <span class="kw-2">*mut </span>u8) -&gt; u64 {
            <span class="kw">unsafe </span>{
                <span class="kw-2">*</span>(var_addr <span class="kw">as </span><span class="kw-2">*mut </span><span class="kw">_ as </span><span class="kw-2">*mut </span>Clock) = Clock::default();
            }
            solana_program::entrypoint::SUCCESS
        }

        <span class="kw">fn </span>sol_get_epoch_schedule_sysvar(<span class="kw-2">&amp;</span><span class="self">self</span>, _var_addr: <span class="kw-2">*mut </span>u8) -&gt; u64 {
            program_error::UNSUPPORTED_SYSVAR
        }

        <span class="attr">#[allow(deprecated)]
        </span><span class="kw">fn </span>sol_get_fees_sysvar(<span class="kw-2">&amp;</span><span class="self">self</span>, _var_addr: <span class="kw-2">*mut </span>u8) -&gt; u64 {
            program_error::UNSUPPORTED_SYSVAR
        }

        <span class="kw">fn </span>sol_get_rent_sysvar(<span class="kw-2">&amp;</span><span class="self">self</span>, var_addr: <span class="kw-2">*mut </span>u8) -&gt; u64 {
            <span class="kw">unsafe </span>{
                <span class="kw-2">*</span>(var_addr <span class="kw">as </span><span class="kw-2">*mut </span><span class="kw">_ as </span><span class="kw-2">*mut </span>Rent) = Rent::default();
            }
            solana_program::entrypoint::SUCCESS
        }

        <span class="kw">fn </span>sol_set_return_data(<span class="kw-2">&amp;</span><span class="self">self</span>, data: <span class="kw-2">&amp;</span>[u8]) {
            <span class="macro">assert_eq!</span>(<span class="kw-2">&amp;*</span>EXPECTED_DATA.read().unwrap(), data)
        }
    }

    <span class="kw">fn </span>do_process_instruction(
        instruction: Instruction,
        accounts: Vec&lt;<span class="kw-2">&amp;mut </span>SolanaAccount&gt;,
    ) -&gt; ProgramResult {
        {
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>meta = instruction
            .accounts
            .iter()
            .zip(accounts)
            .map(|(account_meta, account)| (<span class="kw-2">&amp;</span>account_meta.pubkey, account_meta.is_signer, account))
            .collect::&lt;Vec&lt;<span class="kw">_</span>&gt;&gt;();

        <span class="kw">let </span>account_infos = create_is_signer_account_infos(<span class="kw-2">&amp;mut </span>meta);
        Processor::process(<span class="kw-2">&amp;</span>instruction.program_id, <span class="kw-2">&amp;</span>account_infos, <span class="kw-2">&amp;</span>instruction.data)
    }

    <span class="kw">fn </span>do_process_instruction_dups(
        instruction: Instruction,
    ...
    <span class="kw">fn </span>return_token_error_as_program_error() -&gt; ProgramError {
        TokenError::MintMismatch.into()
    }

    <span class="kw">fn </span>rent_sysvar() -&gt; SolanaAccount {
        create_account_for_test(<span class="kw-2">&amp;</span>Rent::default())
    }

    <span class="kw">fn </span>mint_minimum_balance() -&gt; u64 {
        Rent::default().minimum_balance(Mint::get_packed_len())
    }

    <span class="kw">fn </span>account_minimum_balance() -&gt; u64 {
        Rent::default().minimum_balance(Account::get_packed_len())
    }

    <span class="kw">fn </span>multisig_minimum_balance() -&gt; u64 {
        Rent::default().minimum_balance(Multisig::get_packed_len())
    }

    <span class="kw">fn </span>native_mint() -&gt; SolanaAccount {
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span><span class="kw">crate</span>::id());
        do_process_instruction(
            initialize_mint(
                <span class="kw-2">&amp;</span><span class="kw">crate</span>::id(),
                <span class="kw-2">&amp;</span><span class="kw">crate</span>::native_mint::id(),
                <span class="kw-2">&amp;</span>Pubkey::default(),
                <span class="prelude-val">None</span>,
                <span class="kw">crate</span>::native_mint::DECIMALS,
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        mint_account
    }
    ...
    </span><span class="kw">fn </span>test_print_error() {
        <span class="kw">let </span>error = return_token_error_as_program_error();
        error.print::&lt;TokenError&gt;();
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_error_as_custom() {
        <span class="macro">assert_eq!</span>(
            return_token_error_as_program_error(),
            ProgramError::Custom(<span class="number">3</span>)
        );
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_unique_account_sizes() {
        <span class="macro">assert_ne!</span>(Mint::get_packed_len(), <span class="number">0</span>);
        <span class="macro">assert_ne!</span>(Mint::get_packed_len(), Account::get_packed_len());
        <span class="macro">assert_ne!</span>(Mint::get_packed_len(), Multisig::get_packed_len());
        <span class="macro">assert_ne!</span>(Account::get_packed_len(), <span class="number">0</span>);
        <span class="macro">assert_ne!</span>(Account::get_packed_len(), Multisig::get_packed_len());
        <span class="macro">assert_ne!</span>(Multisig::get_packed_len(), <span class="number">0</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_initialize_mint() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account = SolanaAccount::new(<span class="number">42</span>, Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint2_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();

        <span class="comment">// mint is not rent exempt
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NotRentExempt.into()),
            do_process_instruction(
                initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar]
            )
        );
        ...
        <span class="comment">// create new mint
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();

        <span class="comment">// create twice
        </span><span class="macro">assert_eq!</span>(
        ...
        <span class="comment">// create another mint that can freeze
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint2_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner_key), <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint2_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.freeze_authority, COption::Some(owner_key));
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_initialize_mint2() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account = SolanaAccount::new(<span class="number">42</span>, Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        ...
        <span class="comment">// mint is not rent exempt
            ...
            <span class="prelude-val">Err</span>(TokenError::NotRentExempt.into()),
            do_process_instruction(
                initialize_mint2(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account]
            )
        );
        ...
        <span class="comment">// create another mint that can freeze
            ...
            initialize_mint2(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint2_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner_key), <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account],
        )
        .unwrap();
        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint2_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.freeze_authority, COption::Some(owner_key));
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_initialize_mint_account() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(<span class="number">42</span>, Account::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();

        <span class="comment">// account is not rent exempt
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NotRentExempt.into()),
            do_process_instruction(
                initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                    <span class="kw-2">&amp;mut </span>rent_sysvar
                ],
            )
        );
        ...
        <span class="comment">// mint is not valid (not initialized)
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidMint.into()),
            do_process_instruction(
                initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
        ...
        <span class="comment">// create mint
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// mint not owned by program
        </span><span class="kw">let </span>not_program_id = Pubkey::new_unique();
        mint_account.owner = not_program_id;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId),
            do_process_instruction(
                initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
        ...
        <span class="comment">// create account
        </span>do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_transfer_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span><span class="kw-2">mut </span>account1_info: AccountInfo = (<span class="kw-2">&amp;</span>account1_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account1_account).into();
        <span class="kw">let </span>account2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account2_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span><span class="kw-2">mut </span>account2_info: AccountInfo = (<span class="kw-2">&amp;</span>account2_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>account2_account).into();
        <span class="kw">let </span>account3_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account3_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>account3_info: AccountInfo = (<span class="kw-2">&amp;</span>account3_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>account3_account).into();
        <span class="kw">let </span>account4_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account4_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>account4_info: AccountInfo = (<span class="kw-2">&amp;</span>account4_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account4_account).into();
        <span class="kw">let </span>multisig_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_account = SolanaAccount::new(
            multisig_minimum_balance(),
            Multisig::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>multisig_info: AccountInfo = (<span class="kw-2">&amp;</span>multisig_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>multisig_account).into();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>owner_info: AccountInfo = (<span class="kw-2">&amp;</span>owner_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>owner_account).into();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint_info: AccountInfo = (<span class="kw-2">&amp;</span>mint_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>mint_account).into();
        <span class="kw">let </span>rent_key = rent::id();
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();
        <span class="kw">let </span>rent_info: AccountInfo = (<span class="kw-2">&amp;</span>rent_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>rent_sysvar).into();

        <span class="comment">// create mint
        </span>do_process_instruction_dups(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), rent_info.clone()],
        )
        .unwrap();

        <span class="comment">// create account
        </span>do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key).unwrap(),
            <span class="macro">vec!</span>[
                account1_info.clone(),
                mint_info.clone(),
                account1_info.clone(),
        ...
        <span class="comment">// create another account
        </span>do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                account2_info.clone(),
                mint_info.clone(),
                owner_info.clone(),
        ...
        <span class="comment">// mint to account
        </span>do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), owner_info.clone()],
        )
        .unwrap();

        <span class="comment">// source-owner transfer
        </span>do_process_instruction_dups(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>account1_key,
                <span class="kw-2">&amp;</span>[],
        ...
        <span class="comment">// source-owner TransferChecked
        </span>do_process_instruction_dups(
            transfer_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>account1_key,
                <span class="kw-2">&amp;</span>[],
                <span class="number">500</span>,
        ...
        <span class="comment">// source-delegate transfer
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account1_info.data.borrow()).unwrap();
        account.amount = <span class="number">1000</span>;
        account.delegated_amount = <span class="number">1000</span>;
        account.delegate = COption::Some(account1_key);
        account.owner = owner_key;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account1_info.data.borrow_mut()).unwrap();
        ...
        <span class="comment">// source-delegate TransferChecked
        </span>do_process_instruction_dups(
            transfer_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// test destination-owner transfer
        </span>do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account2_key).unwrap(),
            <span class="macro">vec!</span>[
                account3_info.clone(),
                mint_info.clone(),
                account2_info.clone(),
        ...
        .unwrap();
        do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account3_info.clone(), owner_info.clone()],
        )
        .unwrap();

        account1_info.is_signer = <span class="bool-val">false</span>;
        account2_info.is_signer = <span class="bool-val">true</span>;
        do_process_instruction_dups(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account3_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>[],
                <span class="number">500</span>,
        ...
        <span class="comment">// destination-owner TransferChecked
        </span>do_process_instruction_dups(
            transfer_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account3_key,
        ...
        <span class="comment">// test source-multisig signer
        </span>do_process_instruction_dups(
            initialize_multisig(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>account4_key], <span class="number">1</span>).unwrap(),
            <span class="macro">vec!</span>[
                multisig_info.clone(),
                rent_info.clone(),
                account4_info.clone(),
        ...
        do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account4_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>multisig_key).unwrap(),
            <span class="macro">vec!</span>[
                account4_info.clone(),
                mint_info.clone(),
                multisig_info.clone(),
        ...
        do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account4_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account4_info.clone(), owner_info.clone()],
        )
        .unwrap();

        <span class="comment">// source-multisig-signer transfer
        </span>do_process_instruction_dups(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account4_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>multisig_key,
                <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>account4_key],
                <span class="number">500</span>,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// source-multisig-signer TransferChecked
        </span>do_process_instruction_dups(
            transfer_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account4_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_transfer() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        ...
        <span class="kw">let </span>delegate_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>delegate_account = SolanaAccount::default();
        <span class="kw">let </span>mismatch_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mismatch_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint2_key = Pubkey::new_unique();
        ...
        <span class="comment">// create another account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account2_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        <span class="comment">// create another account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account3_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        <span class="comment">// create mismatch account
        </span>do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mismatch_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>mismatch_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>mismatch_account.data).unwrap();
        account.mint = mint2_key;
        Account::pack(account, <span class="kw-2">&amp;mut </span>mismatch_account.data).unwrap();

        <span class="comment">// mint to account
        </span>do_process_instruction(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="comment">// missing signer
        </span><span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            <span class="kw-2">&amp;</span>account_key,
            <span class="kw-2">&amp;</span>account2_key,
            <span class="kw-2">&amp;</span>owner_key,
            <span class="kw-2">&amp;</span>[],
            <span class="number">1000</span>,
        )
        .unwrap();
        instruction.accounts[<span class="number">2</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            do_process_instruction(
                instruction,
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
        ...
        <span class="comment">// mismatch mint
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintMismatch.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>mismatch_key,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[],
        ...
        <span class="comment">// missing owner
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>account2_key,
                    <span class="kw-2">&amp;</span>owner2_key,
                    <span class="kw-2">&amp;</span>[],
                    <span class="number">1000
                </span>)
                .unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner2_account,
                ],
            )
        );

        <span class="comment">// account not owned by program
        </span><span class="kw">let </span>not_program_id = Pubkey::new_unique();
        ...
        <span class="macro">assert_eq!</span>(
            ...
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">0</span>,).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner2_account,
        ...
        <span class="comment">// account 2 not owned by program
        </span><span class="kw">let </span>not_program_id = Pubkey::new_unique();
        ...
        <span class="comment">// insufficient funds
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
        ...
        <span class="comment">// transfer half back
        </span>do_process_instruction(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="comment">// incorrect decimals
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into()),
            do_process_instruction(
                transfer_checked(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account2_key,
                    ...
                    <span class="number">10 </span><span class="comment">// &lt;-- incorrect decimals
                </span>)
                .unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account2_account,
        ...
        <span class="comment">// incorrect mint
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintMismatch.into()),
            do_process_instruction(
                transfer_checked(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account2_key,
                    <span class="kw-2">&amp;</span>account3_key, <span class="comment">// &lt;-- incorrect mint
                    </span><span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[],
                    <span class="number">1</span>,
                    <span class="number">2
                ...
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>account3_account, <span class="comment">// &lt;-- incorrect mint
                    </span><span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                ],
            )
        );
        <span class="comment">// transfer rest with explicit decimals
        </span>do_process_instruction(
            transfer_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account2_key,
        ...
        <span class="comment">// insufficient funds
            ...
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
        ...
        <span class="comment">// approve delegate
        </span>do_process_instruction(
            approve(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
                <span class="kw-2">&amp;</span>delegate_key,
                <span class="kw-2">&amp;</span>owner_key,
                <span class="kw-2">&amp;</span>[],
            ...
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>delegate_account,
                <span class="kw-2">&amp;mut </span>owner_account,
            ],
        )
        .unwrap();

        <span class="comment">// not a delegate of source account
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                    ...
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>account2_key,
                    <span class="kw-2">&amp;</span>owner2_key, <span class="comment">// &lt;-- incorrect owner or delegate
        ...
        <span class="comment">// insufficient funds approved via delegate
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
        ...
        <span class="comment">// transfer via delegate
        </span>do_process_instruction(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="comment">// transfer rest
        </span>do_process_instruction(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="comment">// insufficient funds in source account via delegate
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_self_transfer() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>account_info = (<span class="kw-2">&amp;</span>account_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>account_account).into_account_info();
        <span class="kw">let </span>account3_info = (<span class="kw-2">&amp;</span>account3_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>account3_account).into_account_info();
        <span class="kw">let </span>delegate_info = (<span class="kw-2">&amp;</span>delegate_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>delegate_account).into_account_info();
        <span class="kw">let </span>owner_info = (<span class="kw-2">&amp;</span>owner_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>owner_account).into_account_info();
        <span class="kw">let </span>owner2_info = (<span class="kw-2">&amp;</span>owner2_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>owner2_account).into_account_info();
        <span class="kw">let </span>mint_info = (<span class="kw-2">&amp;</span>mint_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>mint_account).into_account_info();

        <span class="comment">// transfer
        </span><span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            account_info.key,
            owner_info.key,
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Ok</span>(()),
            Processor::process(
                <span class="kw-2">&amp;</span>instruction.program_id,
                <span class="kw-2">&amp;</span>[
                    account_info.clone(),
                    account_info.clone(),
                    owner_info.clone(),
                ],
                <span class="kw-2">&amp;</span>instruction.data,
            )
        );
        <span class="comment">// no balance change...
        </span><span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_info.try_borrow_data().unwrap()).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">1000</span>);

        <span class="comment">// transfer checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
            account_info.key,
        ...
        <span class="comment">// missing signer
        </span><span class="kw">let </span><span class="kw-2">mut </span>owner_no_sign_info = owner_info.clone();
        <span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
        ...
        .unwrap();
        instruction.accounts[<span class="number">2</span>].is_signer = <span class="bool-val">false</span>;
        owner_no_sign_info.is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::process(
                <span class="kw-2">&amp;</span>instruction.program_id,
        ...
        <span class="comment">// missing signer checked
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
            account_info.key,
        ...
        .unwrap();
        instruction.accounts[<span class="number">3</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::process(
                <span class="kw-2">&amp;</span>instruction.program_id,
        ...
        <span class="comment">// missing owner checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
        ...
        <span class="comment">// insufficient funds checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
        ...
        <span class="comment">// incorrect mint
            ...
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            account3_info.key, <span class="comment">// &lt;-- incorrect mint
            </span>account_info.key,
            owner_info.key,
            <span class="kw-2">&amp;</span>[],
            <span class="number">1</span>,
            <span class="number">2</span>,
        ...
        <span class="macro">assert_eq!</span>(
            ...
            Processor::process(
                ...
                <span class="kw-2">&amp;</span>[
                    account_info.clone(),
                    account3_info.clone(), <span class="comment">// &lt;-- incorrect mint
                    </span>account_info.clone(),
                    owner_info.clone(),
                ],
                <span class="kw-2">&amp;</span>instruction.data,
            )
        ...
        <span class="comment">// approve delegate
        </span><span class="kw">let </span>instruction = approve(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            delegate_info.key,
            owner_info.key,
        ...
        <span class="comment">// delegate transfer
        </span><span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
        ...
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">1000</span>);
        <span class="macro">assert_eq!</span>(account.delegated_amount, <span class="number">100</span>);

        <span class="comment">// delegate transfer checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
        ...
        <span class="comment">// delegate insufficient funds
        </span><span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
        ...
        <span class="comment">// delegate insufficient funds checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
        ...
        <span class="comment">// owner transfer with delegate assigned
        </span><span class="attr">#[allow(deprecated)]
        </span><span class="kw">let </span>instruction = transfer(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
        ...
        <span class="comment">// owner transfer with delegate assigned checked
        </span><span class="kw">let </span>instruction = transfer_checked(
            <span class="kw-2">&amp;</span>program_id,
            account_info.key,
            mint_info.key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_mintable_token_with_zero_supply() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// create mint-able token with zero supply
        </span><span class="kw">let </span>decimals = <span class="number">2</span>;
        do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, decimals).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(
            mint,
            Mint {
        ...
        <span class="comment">// mint to
        </span>do_process_instruction(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        <span class="kw">let _ </span>= Mint::unpack(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">42</span>);

        <span class="comment">// mint to 2, with incorrect decimals
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into()),
            do_process_instruction(
                mint_to_checked(
        ...
        <span class="kw">let _ </span>= Mint::unpack(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">84</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_approve_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>account1_info: AccountInfo = (<span class="kw-2">&amp;</span>account1_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account1_account).into();
        <span class="kw">let </span>account2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account2_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
        ...
        <span class="kw">let </span>account2_info: AccountInfo = (<span class="kw-2">&amp;</span>account2_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>account2_account).into();
        <span class="kw">let </span>account3_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account3_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
        ...
        <span class="kw">let </span>account3_info: AccountInfo = (<span class="kw-2">&amp;</span>account3_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account3_account).into();
        <span class="kw">let </span>multisig_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_account = SolanaAccount::new(
            multisig_minimum_balance(),
            Multisig::get_packed_len(),
        ...
        <span class="comment">// source-owner approve
        </span>do_process_instruction_dups(
            approve(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// source-owner approve_checked
        </span>do_process_instruction_dups(
            approve_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// source-owner revoke
        </span>do_process_instruction_dups(
            revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[account1_info.clone(), account1_info.clone()],
        )
        .unwrap();

        <span class="comment">// test source-multisig signer
        </span>do_process_instruction_dups(
            initialize_multisig(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>account3_key], <span class="number">1</span>).unwrap(),
            <span class="macro">vec!</span>[
                multisig_info.clone(),
                rent_info.clone(),
                account3_info.clone(),
        ...
        do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>multisig_key).unwrap(),
            <span class="macro">vec!</span>[
                account3_info.clone(),
                mint_info.clone(),
                multisig_info.clone(),
        ...
        <span class="comment">// source-multisig-signer approve
        </span>do_process_instruction_dups(
            approve(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account3_key,
                <span class="kw-2">&amp;</span>account2_key,
                <span class="kw-2">&amp;</span>multisig_key,
                <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>account3_key],
                <span class="number">500</span>,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// source-multisig-signer approve_checked
        </span>do_process_instruction_dups(
            approve_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account3_key,
        ...
        <span class="comment">// source-owner multisig-signer
        </span>do_process_instruction_dups(
            revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>account3_key]).unwrap(),
            <span class="macro">vec!</span>[
                account3_info.clone(),
                multisig_info.clone(),
                account3_info.clone(),
        ...
        <span class="comment">// approve to source
        </span>do_process_instruction_dups(
            approve_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account2_key,
        ...
        <span class="comment">// source-delegate revoke, force account2 to be a signer
        </span><span class="kw">let </span>account2_info: AccountInfo = (<span class="kw-2">&amp;</span>account2_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account2_account).into();
        do_process_instruction_dups(
            revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[account2_info.clone(), account2_info.clone()],
        )
        .unwrap();
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_approve() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// missing signer
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction = approve(
            <span class="kw-2">&amp;</span>program_id,
            <span class="kw-2">&amp;</span>account_key,
            <span class="kw-2">&amp;</span>delegate_key,
            <span class="kw-2">&amp;</span>owner_key,
        ...
        <span class="comment">// approve delegate 2, with incorrect decimals
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into()),
            do_process_instruction(
                approve_checked(
                    ...
                    <span class="kw-2">&amp;</span>[],
                    <span class="number">100</span>,
                    <span class="number">0 </span><span class="comment">// &lt;-- incorrect decimals
                </span>)
                .unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
        ...
        <span class="comment">// approve delegate 2, with incorrect mint
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintMismatch.into()),
            do_process_instruction(
                approve_checked(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>account2_key, <span class="comment">// &lt;-- bad mint
                    </span><span class="kw-2">&amp;</span>delegate_key,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[],
                    <span class="number">100</span>,
                    <span class="number">0
                ...
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account2_account, <span class="comment">// &lt;-- bad mint
                    </span><span class="kw-2">&amp;mut </span>delegate_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                ],
            )
        );

        <span class="comment">// approve delegate 2
        </span>do_process_instruction(
            approve_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// revoke delegate
        </span>do_process_instruction(
            revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="comment">// approve delegate 3
        </span>do_process_instruction(
            approve_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// revoke by delegate
        </span>do_process_instruction(
            revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>delegate_account],
        )
        .unwrap();

        <span class="comment">// fails the second time
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                revoke(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[]).unwrap(),
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_set_authority_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint_info: AccountInfo = (<span class="kw-2">&amp;</span>mint_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>mint_account).into();
        <span class="kw">let </span>rent_key = rent::id();
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();
        <span class="kw">let </span>rent_info: AccountInfo = (<span class="kw-2">&amp;</span>rent_key, <span class="bool-val">false</span>, <span class="kw-2">&amp;mut </span>rent_sysvar).into();
        ...
        <span class="comment">// create mint
            ...
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mint_key, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>mint_key), <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), rent_info.clone()],
        )
        .unwrap();
        ...
        <span class="comment">// set mint_authority when currently self
        </span>do_process_instruction_dups(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner_key),
                AuthorityType::MintTokens,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>[],
            )
            .unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), mint_info.clone()],
        )
        .unwrap();

        <span class="comment">// set freeze_authority when currently self
        </span>do_process_instruction_dups(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
        ...
        <span class="comment">// set account owner when currently self
        </span>do_process_instruction_dups(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// set close_authority when currently self
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account1_info.data.borrow()).unwrap();
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_set_authority() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::default();
        <span class="kw">let </span>owner3_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner3_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint2_key = Pubkey::new_unique();
        ...
        <span class="comment">// create new mint with owner
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// create mint with owner and freeze_authority
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint2_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner_key), <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// invalid account
        </span><span class="macro">assert_eq!</span>(
            ...
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner2_key),
                    AuthorityType::AccountOwner,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[]
                )
        ...
        <span class="comment">// create another account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>mint2_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account2_account,
                <span class="kw-2">&amp;mut </span>mint2_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        )
        ...
        <span class="comment">// missing owner
            ...
            do_process_instruction(
                ...
                .unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner2_account],
            )
        );

        <span class="comment">// owner did not sign
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction = set_authority(
            <span class="kw-2">&amp;</span>program_id,
            <span class="kw-2">&amp;</span>account_key,
            <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner2_key),
            AuthorityType::AccountOwner,
        ...
        .unwrap();
        instruction.accounts[<span class="number">1</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            do_process_instruction(instruction, <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account,],)
        );

        <span class="comment">// wrong authority type
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AuthorityTypeNotSupported.into()),
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// account owner may not be set to None
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidInstruction.into()),
            do_process_instruction(
                set_authority(
        ...
        <span class="comment">// set delegate
        </span>do_process_instruction(
            approve(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.delegate, COption::Some(owner2_key));
        <span class="macro">assert_eq!</span>(account.delegated_amount, u64::MAX);

        <span class="comment">// set owner
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
                <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner3_key),
                AuthorityType::AccountOwner,
                <span class="kw-2">&amp;</span>owner_key,
                <span class="kw-2">&amp;</span>[],
            )
        ...
        <span class="comment">// check delegate cleared
        </span><span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.delegate, COption::None);
        <span class="macro">assert_eq!</span>(account.delegated_amount, <span class="number">0</span>);

        <span class="comment">// set owner without existing delegate
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
                <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner2_key),
                AuthorityType::AccountOwner,
                <span class="kw-2">&amp;</span>owner3_key,
                <span class="kw-2">&amp;</span>[],
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner3_account],
        )
        .unwrap();

        <span class="comment">// set close_authority
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// close_authority may be set to None
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// wrong owner
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                set_authority(
                ...
                .unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner2_account],
            )
        );
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            do_process_instruction(instruction, <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],)
        );

        <span class="comment">// cannot freeze
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintCannotFreeze.into()),
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>mint_key,
                ...
                .unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );
        ...
        <span class="comment">// set owner to None
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
        ...
        <span class="comment">// test unsetting mint_authority is one-way operation
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::FixedSupply.into()),
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>mint2_key,
                    <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>owner2_key),
                    AuthorityType::MintTokens,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[]
        ...
        <span class="comment">// set freeze_authority
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint2_key,
            ...
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="comment">// test unsetting freeze_authority is one-way operation
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint2_key,
            ...
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account, <span class="kw-2">&amp;mut </span>owner2_account],
        )
        .unwrap();
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_set_authority_with_immutable_owner_extension() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();

        <span class="kw">let </span>account_len =
            ExtensionType::try_calculate_account_len::&lt;Account&gt;(<span class="kw-2">&amp;</span>[ExtensionType::ImmutableOwner])
                .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
        ...
        <span class="comment">// create account
            ...
            <span class="prelude-val">Ok</span>(()),
            do_process_instruction(
                initialize_immutable_owner(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account],
            )
        );
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Ok</span>(()),
        ...
        <span class="comment">// Immutable Owner extension blocks account owner authority changes
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::ImmutableOwner.into()),
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_mint_to_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// create mint
            ...
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mint_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), rent_info.clone()],
        )
        .unwrap();
        ...
        <span class="comment">// create account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                account1_info.clone(),
                mint_info.clone(),
                owner_info.clone(),
        ...
        <span class="comment">// mint_to when mint_authority is self
        </span>do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), mint_info.clone()],
        )
        .unwrap();

        <span class="comment">// mint_to_checked when mint_authority is self
        </span>do_process_instruction_dups(
            mint_to_checked(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), mint_info.clone()],
        )
        .unwrap();

        <span class="comment">// mint_to when mint_authority is account owner
        </span><span class="kw">let </span><span class="kw-2">mut </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_info.data.borrow()).unwrap();
        mint.mint_authority = COption::Some(account1_key);
        Mint::pack(mint, <span class="kw-2">&amp;mut </span>mint_info.data.borrow_mut()).unwrap();
        do_process_instruction_dups(
            mint_to(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
        ...
        <span class="comment">// mint_to_checked when mint_authority is account owner
        </span>do_process_instruction_dups(
            mint_to(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_mint_to() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint2_key = Pubkey::new_unique();
        <span class="kw">let </span>uninitialized_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>uninitialized_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        ...
        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.supply, <span class="number">42</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">42</span>);

        <span class="comment">// mint to another account to test supply accumulation
        </span>do_process_instruction(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account2_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.supply, <span class="number">84</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">42</span>);

        <span class="comment">// missing signer
        </span><span class="kw">let </span><span class="kw-2">mut </span>instruction =
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap();
        instruction.accounts[<span class="number">2</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
        ...
        <span class="comment">// mismatch account
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintMismatch.into()),
            do_process_instruction(
                mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mismatch_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>mismatch_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );
        ...
        <span class="comment">// missing owner
            ...
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>account2_account,
                    <span class="kw-2">&amp;mut </span>owner2_account,
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId),
            do_process_instruction(
                mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">0</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );
        mint_account.owner = program_id;
        ...
        <span class="comment">// uninitialized destination account
        </span><span class="macro">assert_eq!</span>(
            ...
            do_process_instruction(
                mint_to(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>mint_key,
                    <span class="kw-2">&amp;</span>uninitialized_key,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[],
                ...
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>uninitialized_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                ],
            )
        );

        <span class="comment">// unset mint_authority and test minting fails
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_burn_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// source-owner burn
        </span>do_process_instruction_dups(
            burn(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
        ...
        <span class="comment">// source-owner burn_checked
        </span>do_process_instruction_dups(
            burn_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// mint-owner burn
        </span>do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), owner_info.clone()],
        )
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account1_info.data.borrow()).unwrap();
        account.owner = mint_key;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account1_info.data.borrow_mut()).unwrap();
        do_process_instruction_dups(
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[], <span class="number">500</span>).unwrap(),
            <span class="macro">vec!</span>[account1_info.clone(), mint_info.clone(), mint_info.clone()],
        )
        .unwrap();

        <span class="comment">// mint-owner burn_checked
        </span>do_process_instruction_dups(
            burn_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// source-delegate burn
        </span>do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), owner_info.clone()],
        )
        ...
        <span class="comment">// source-delegate burn_checked
        </span>do_process_instruction_dups(
            burn_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
        ...
        <span class="comment">// mint-delegate burn
        </span>do_process_instruction_dups(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), account1_info.clone(), owner_info.clone()],
        )
        ...
        <span class="comment">// mint-delegate burn_checked
        </span>do_process_instruction_dups(
            burn_checked(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account1_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_burn() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// mint to mismatch account and change mint key
        </span>do_process_instruction(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mismatch_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>mismatch_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>mismatch_account.data).unwrap();
        ...
        <span class="comment">// missing signer
            ...
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap();
        instruction.accounts[<span class="number">1</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
        ...
        <span class="comment">// missing owner
            ...
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner2_account],
            )
        );
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::IncorrectProgramId),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">0</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );
        account_account.owner = program_id;
        ...
        <span class="comment">// mint mismatch
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintMismatch.into()),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mismatch_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mismatch_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );

        <span class="comment">// burn
        </span>do_process_instruction(
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">21</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="comment">// burn_checked, with incorrect decimals
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintDecimalsMismatch.into()),
            do_process_instruction(
                burn_checked(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">21</span>, <span class="number">3</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );

        <span class="comment">// burn_checked
        </span>do_process_instruction(
            burn_checked(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">21</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();

        <span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.supply, <span class="number">2000 </span>- <span class="number">42</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">1000 </span>- <span class="number">42</span>);
        ...
        <span class="comment">// insufficient funds approved via delegate
            ...
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[], <span class="number">85</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>delegate_account
        ...
        <span class="comment">// burn via delegate
        </span>do_process_instruction(
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[], <span class="number">84</span>).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>delegate_account,
        ...
        </span><span class="kw">let </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(mint.supply, <span class="number">2000 </span>- <span class="number">42 </span>- <span class="number">84</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">1000 </span>- <span class="number">42 </span>- <span class="number">84</span>);

        <span class="comment">// insufficient funds approved via delegate
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>delegate_key, <span class="kw-2">&amp;</span>[], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>delegate_account
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_multisig() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>multisig_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_account = SolanaAccount::new(<span class="number">42</span>, Multisig::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>multisig_delegate_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_delegate_account = SolanaAccount::new(
            multisig_minimum_balance(),
            Multisig::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>signer_keys = <span class="macro">vec!</span>[Pubkey::new_unique(); MAX_SIGNERS];
        <span class="kw">let </span>signer_key_refs: Vec&lt;<span class="kw-2">&amp;</span>Pubkey&gt; = signer_keys.iter().collect();
        <span class="kw">let </span><span class="kw-2">mut </span>signer_accounts = <span class="macro">vec!</span>[SolanaAccount::new(<span class="number">0</span>, <span class="number">0</span>, <span class="kw-2">&amp;</span>program_id); MAX_SIGNERS];
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();

        <span class="comment">// multisig is not rent exempt
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NotRentExempt.into()),
            do_process_instruction(
                initialize_multisig(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>signer_keys[<span class="number">0</span>]], <span class="number">1</span>).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>multisig_account,
                    <span class="kw-2">&amp;mut </span>rent_sysvar,
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_account2 = multisig_account.clone();

        <span class="comment">// single signer
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            initialize_multisig(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>signer_keys[<span class="number">0</span>]], <span class="number">1</span>).unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// single signer using `initialize_multisig2`
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            initialize_multisig2(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>multisig_key, <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>signer_keys[<span class="number">0</span>]], <span class="number">1</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>multisig_account2, account_info_iter.next().unwrap()],
        )
        .unwrap();

        <span class="comment">// multiple signer
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            initialize_multisig(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>multisig_delegate_key,
                <span class="kw-2">&amp;</span>signer_key_refs,
                MAX_SIGNERS <span class="kw">as </span>u8,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>multisig_delegate_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
                account_info_iter.next().unwrap(),
                account_info_iter.next().unwrap(),
                account_info_iter.next().unwrap(),
        ...
        <span class="comment">// create new mint with multisig owner
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>multisig_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();

        <span class="comment">// create account with multisig owner
        </span>do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>multisig_key).unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// create another account with multisig owner
        </span>do_process_instruction(
            initialize_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account2_key,
        ...
        do_process_instruction(
            mint_to(
                ...
                <span class="kw-2">&amp;</span>account_key,
                <span class="kw-2">&amp;</span>multisig_key,
                <span class="kw-2">&amp;</span>[<span class="kw-2">&amp;</span>signer_keys[<span class="number">0</span>]],
                <span class="number">1000</span>,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// freeze account
        </span><span class="kw">let </span>account3_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account3_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        ...
        do_process_instruction(
            initialize_mint(
                ...
                <span class="kw-2">&amp;</span>mint2_key,
                <span class="kw-2">&amp;</span>multisig_key,
                <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>multisig_key),
                <span class="number">2</span>,
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint2_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        ...
        .unwrap();
        do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>mint2_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account3_account,
                <span class="kw-2">&amp;mut </span>mint2_account,
                <span class="kw-2">&amp;mut </span>owner_account,
        ...
        .unwrap();
        <span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            mint_to(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint2_key,
        ...
        <span class="comment">// do SetAuthority on mint
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="comment">// do SetAuthority on account
        </span><span class="kw">let </span>account_info_iter = <span class="kw-2">&amp;mut </span>signer_accounts.iter_mut();
        do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_validate_owner() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>account_to_validate = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>signer_keys = [Pubkey::default(); MAX_SIGNERS];
        <span class="kw">for </span>signer_key <span class="kw">in </span>signer_keys.iter_mut().take(MAX_SIGNERS) {
            <span class="kw-2">*</span>signer_key = Pubkey::new_unique();
        }
        <span class="kw">let </span><span class="kw-2">mut </span>signer_lamports = <span class="number">0</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>signer_data = <span class="macro">vec!</span>[];
        <span class="kw">let </span><span class="kw-2">mut </span>signers = <span class="macro">vec!</span>[
            AccountInfo::new(
                <span class="kw-2">&amp;</span>owner_key,
                <span class="bool-val">true</span>,
                <span class="bool-val">false</span>,
                <span class="kw-2">&amp;mut </span>signer_lamports,
                <span class="kw-2">&amp;mut </span>signer_data,
                <span class="kw-2">&amp;</span>program_id,
                <span class="bool-val">false</span>,
                Epoch::default(),
            );
            MAX_SIGNERS + <span class="number">1
        </span>];
        <span class="kw">for </span>(signer, key) <span class="kw">in </span>signers.iter_mut().zip(<span class="kw-2">&amp;</span>signer_keys) {
            signer.key = key;
        }
        <span class="kw">let </span><span class="kw-2">mut </span>lamports = <span class="number">0</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>data = <span class="macro">vec!</span>[<span class="number">0</span>; Multisig::get_packed_len()];
        <span class="kw">let </span><span class="kw-2">mut </span>multisig = Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>data).unwrap();
        multisig.m = MAX_SIGNERS <span class="kw">as </span>u8;
        multisig.n = MAX_SIGNERS <span class="kw">as </span>u8;
        multisig.signers = signer_keys;
        multisig.is_initialized = <span class="bool-val">true</span>;
        Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>data).unwrap();
        <span class="kw">let </span>owner_account_info = AccountInfo::new(
            <span class="kw-2">&amp;</span>owner_key,
            <span class="bool-val">false</span>,
            <span class="bool-val">false</span>,
        ...
        <span class="comment">// no multisig, but the account is its own authority, and data is mutably
        // borrowed
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>lamports = <span class="number">0</span>;
            <span class="kw">let </span><span class="kw-2">mut </span>data = <span class="macro">vec!</span>[<span class="number">0</span>; Account::get_packed_len()];
            <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>data).unwrap();
            account.owner = account_to_validate;
            Account::pack(account, <span class="kw-2">&amp;mut </span>data).unwrap();
            <span class="kw">let </span>account_info = AccountInfo::new(
                <span class="kw-2">&amp;</span>account_to_validate,
                <span class="bool-val">true</span>,
                <span class="bool-val">false</span>,
                <span class="kw-2">&amp;mut </span>lamports,
                <span class="kw-2">&amp;mut </span>data,
            ...
            <span class="kw">let </span>account_info_data_len = account_info.data_len();
            <span class="kw">let </span><span class="kw-2">mut </span>borrowed_data = account_info.try_borrow_mut_data().unwrap();
            ...
            .unwrap();
            <span class="comment">// modify the data to be sure that it wasn't silently dropped by the compiler
            </span>borrowed_data[<span class="number">0</span>] = <span class="number">1</span>;
        }

        <span class="comment">// full 11 of 11
        </span>Processor::validate_owner(
            <span class="kw-2">&amp;</span>program_id,
            <span class="kw-2">&amp;</span>owner_key,
            <span class="kw-2">&amp;</span>owner_account_info,
            owner_account_info.data_len(),
            <span class="kw-2">&amp;</span>signers,
        )
        .unwrap();

        <span class="comment">// 1 of 11
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">1</span>;
            Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>owner_account_info.data.borrow_mut()).unwrap();
        }
        Processor::validate_owner(
            <span class="kw-2">&amp;</span>program_id,
            <span class="kw-2">&amp;</span>owner_key,
        ...
        <span class="comment">// 2:1
            ...
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">2</span>;
            multisig.n = <span class="number">1</span>;
            Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>owner_account_info.data.borrow_mut()).unwrap();
        }
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
        ...
        <span class="comment">// 0:11
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">0</span>;
            multisig.n = <span class="number">11</span>;
            Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>owner_account_info.data.borrow_mut()).unwrap();
        }
        Processor::validate_owner(
            <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="comment">// 2:11 but 0 provided
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">2</span>;
        ...
        <span class="comment">// 2:11 but 1 provided
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">2</span>;
        ...
        <span class="macro">assert_eq!</span>(
            ...
            Processor::validate_owner(
                ...
                <span class="kw-2">&amp;</span>owner_account_info,
                owner_account_info.data_len(),
                <span class="kw-2">&amp;</span>signers[<span class="number">0</span>..<span class="number">1</span>]
            )
        );

        <span class="comment">// 2:11, 2 from middle provided
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">2</span>;
        ...
        Processor::validate_owner(
            ...
            <span class="kw-2">&amp;</span>owner_account_info,
            owner_account_info.data_len(),
            <span class="kw-2">&amp;</span>signers[<span class="number">5</span>..<span class="number">7</span>],
        )
        .unwrap();

        <span class="comment">// 11:11, one is not a signer
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>multisig =
                Multisig::unpack_unchecked(<span class="kw-2">&amp;</span>owner_account_info.data.borrow()).unwrap();
            multisig.m = <span class="number">11</span>;
            multisig.n = <span class="number">11</span>;
            Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>owner_account_info.data.borrow_mut()).unwrap();
        }
        signers[<span class="number">5</span>].is_signer = <span class="bool-val">false</span>;
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::MissingRequiredSignature),
            Processor::validate_owner(
                <span class="kw-2">&amp;</span>program_id,
        ...
        signers[<span class="number">5</span>].is_signer = <span class="bool-val">true</span>;

        <span class="comment">// 11:11, single signer signs multiple times
        </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>signer_lamports = <span class="number">0</span>;
            <span class="kw">let </span><span class="kw-2">mut </span>signer_data = <span class="macro">vec!</span>[];
            <span class="kw">let </span>signers = <span class="macro">vec!</span>[
                AccountInfo::new(
                    <span class="kw-2">&amp;</span>signer_keys[<span class="number">5</span>],
                    <span class="bool-val">true</span>,
                    <span class="bool-val">false</span>,
                    <span class="kw-2">&amp;mut </span>signer_lamports,
                    <span class="kw-2">&amp;mut </span>signer_data,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_owner_close_account_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
        ...
        <span class="kw">let </span>to_close_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>to_close_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>to_close_account_info: AccountInfo =
            (<span class="kw-2">&amp;</span>to_close_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>to_close_account).into();
        <span class="kw">let </span>destination_account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>destination_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>destination_account_info: AccountInfo =
            (<span class="kw-2">&amp;</span>destination_account_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>destination_account).into();
        <span class="comment">// create account
        </span>do_process_instruction_dups(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>to_close_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>to_close_key).unwrap(),
            <span class="macro">vec!</span>[
        ...
        <span class="comment">// source-owner close
        </span>do_process_instruction_dups(
            close_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>to_close_key,
                <span class="kw-2">&amp;</span>destination_account_key,
                <span class="kw-2">&amp;</span>to_close_key,
                <span class="kw-2">&amp;</span>[],
            )
            .unwrap(),
        ...
        .unwrap();
        <span class="macro">assert_eq!</span>(<span class="kw-2">*</span>to_close_account_info.data.borrow(), <span class="kw-2">&amp;</span>[<span class="number">0u8</span>; Account::LEN]);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_close_authority_close_account_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
        ...
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>to_close_account_info.data.borrow()).unwrap();
        account.close_authority = COption::Some(to_close_key);
        account.owner = owner_key;
        Account::pack(account, <span class="kw-2">&amp;mut </span>to_close_account_info.data.borrow_mut()).unwrap();
        do_process_instruction_dups(
            close_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>to_close_key,
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_close_account() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        ...
        <span class="kw">let </span>account2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account2_account = SolanaAccount::new(
            account_minimum_balance() + <span class="number">42</span>,
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>account3_key = Pubkey::new_unique();
        ...
        <span class="comment">// uninitialized
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::UninitializedAccount),
            do_process_instruction(
                close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account3_account,
                    <span class="kw-2">&amp;mut </span>owner2_account,
        ...
        <span class="comment">// initialize and mint to non-native account
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// initialize native account
        </span>do_process_instruction(
            initialize_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account2_key,
        ...
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        <span class="macro">assert!</span>(account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">42</span>);

        <span class="comment">// close non-native account with balance
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NonNativeHasBalance.into()),
            do_process_instruction(
                close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>account3_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
        ...
        <span class="macro">assert_eq!</span>(account_account.lamports, account_minimum_balance());

        <span class="comment">// empty account
        </span>do_process_instruction(
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">42</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        ...
        <span class="comment">// close account
        </span>do_process_instruction(
            close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
        ...
        .unwrap();
        <span class="macro">assert_eq!</span>(account_account.lamports, <span class="number">0</span>);
        <span class="macro">assert_eq!</span>(account3_account.lamports, <span class="number">2 </span>* account_minimum_balance());
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">0</span>);

        <span class="comment">// fund and initialize new non-native account to test close authority
        </span><span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        ...
        .unwrap();
        account_account.lamports = <span class="number">2</span>;
        ...
        <span class="comment">// account owner cannot authorize close if close_authority is set
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
        ...
        <span class="comment">// close non-native account with close_authority
        </span>do_process_instruction(
            close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
        ...
        .unwrap();
        <span class="macro">assert_eq!</span>(account_account.lamports, <span class="number">0</span>);
        <span class="macro">assert_eq!</span>(account3_account.lamports, <span class="number">2 </span>* account_minimum_balance() + <span class="number">2</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">0</span>);

        <span class="comment">// close native account
        </span>do_process_instruction(
            close_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>account3_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account2_account,
                <span class="kw-2">&amp;mut </span>account3_account,
                <span class="kw-2">&amp;mut </span>owner_account,
        ...
        .unwrap();
        <span class="macro">assert_eq!</span>(account2_account.data, [<span class="number">0u8</span>; Account::LEN]);
        <span class="macro">assert_eq!</span>(
            account3_account.lamports,
            <span class="number">3 </span>* account_minimum_balance() + <span class="number">2 </span>+ <span class="number">42
        </span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_native_token() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account = native_mint();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance() + <span class="number">40</span>,
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>account2_key = Pubkey::new_unique();
        ...
        <span class="kw">let </span>account3_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account3_account = SolanaAccount::new(account_minimum_balance(), <span class="number">0</span>, <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::default();
        ...
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert!</span>(account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">40</span>);
        ...
        <span class="comment">// mint_to unsupported
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NativeNotSupported.into()),
            do_process_instruction(
                mint_to(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span><span class="kw">crate</span>::native_mint::id(),
        ...
        <span class="comment">// burn unsupported
        </span><span class="kw">let </span>bogus_mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>bogus_mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>bogus_mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>bogus_mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        ...
        <span class="macro">assert_eq!</span>(
            ...
            do_process_instruction(
                burn(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="kw-2">&amp;</span>bogus_mint_key,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[],
                    <span class="number">42
                </span>)
                ...
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_account,
                    <span class="kw-2">&amp;mut </span>bogus_mint_account,
                    <span class="kw-2">&amp;mut </span>owner_account
                ],
            )
        );

        <span class="comment">// ensure can't transfer below rent-exempt reserve
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InsufficientFunds.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
        ...
        <span class="comment">// transfer between native accounts
        </span>do_process_instruction(
            <span class="attr">#[allow(deprecated)]
            </span>transfer(
                <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="macro">assert!</span>(account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">0</span>);
        <span class="macro">assert_eq!</span>(account2_account.lamports, account_minimum_balance() + <span class="number">40</span>);
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        <span class="macro">assert!</span>(account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">40</span>);

        <span class="comment">// set close authority
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.close_authority, COption::Some(owner3_key));

        <span class="comment">// set new account owner
        </span>do_process_instruction(
            set_authority(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>account_key,
        ...
        <span class="comment">// close authority cleared
        </span><span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.close_authority, COption::None);
        ...
        <span class="macro">assert_eq!</span>(account_account.lamports, <span class="number">0</span>);
        <span class="macro">assert_eq!</span>(account3_account.lamports, <span class="number">2 </span>* account_minimum_balance());
        <span class="macro">assert_eq!</span>(account_account.data, [<span class="number">0u8</span>; Account::LEN]);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_overflow() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::default();
        <span class="kw">let </span>mint_owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_owner_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();
        ...
        <span class="comment">// create new mint with owner
            ...
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>mint_owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();

        <span class="comment">// create an account
        </span>do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
        ...
        <span class="comment">// create another account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner2_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account2_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner2_account,
        ...
        <span class="comment">// mint the max to an account
        </span>do_process_instruction(
            mint_to(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="kw-2">&amp;</span>account_key,
                <span class="kw-2">&amp;</span>mint_owner_key,
                <span class="kw-2">&amp;</span>[],
                u64::MAX,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>mint_owner_account,
            ],
        )
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, u64::MAX);

        <span class="comment">// attempt to mint one more to account
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::Overflow.into()),
            do_process_instruction(
                mint_to(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>mint_key,
        ...
        <span class="comment">// attempt to mint one more to the other account
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::Overflow.into()),
            do_process_instruction(
                mint_to(
        ...
        <span class="comment">// burn some of the supply
        </span>do_process_instruction(
            burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">100</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, u64::MAX - <span class="number">100</span>);
        ...
        <span class="comment">// manipulate account balance to attempt overflow transfer
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        account.amount = <span class="number">1</span>;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account2_account.data).unwrap();
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_frozen() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// create new mint and fund first account
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// fund first account
        </span>do_process_instruction(
            mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">1000</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        ...
        <span class="comment">// no transfer if either account is frozen
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        account.state = AccountState::Frozen;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account2_account.data).unwrap();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
            do_process_instruction(
                <span class="attr">#[allow(deprecated)]
                </span>transfer(
                    <span class="kw-2">&amp;</span>program_id,
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        account.state = AccountState::Initialized;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account_account.data).unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account2_account.data).unwrap();
        account.state = AccountState::Frozen;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account2_account.data).unwrap();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
        ...
        <span class="comment">// no approve if account is frozen
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        account.state = AccountState::Frozen;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account_account.data).unwrap();
        <span class="kw">let </span>delegate_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>delegate_account = SolanaAccount::default();
        ...
        <span class="comment">// no revoke if account is frozen
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        account.delegate = COption::Some(delegate_key);
        account.delegated_amount = <span class="number">100</span>;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
            do_process_instruction(
        ...
        <span class="comment">// no set authority if account is frozen
        </span><span class="kw">let </span>new_owner_key = Pubkey::new_unique();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
            do_process_instruction(
                set_authority(
                    <span class="kw-2">&amp;</span>program_id,
                    <span class="kw-2">&amp;</span>account_key,
                    <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>new_owner_key),
                    AuthorityType::AccountOwner,
                    <span class="kw-2">&amp;</span>owner_key,
                    <span class="kw-2">&amp;</span>[]
                )
        ...
        <span class="comment">// no mint_to if destination account is frozen
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
            do_process_instruction(
                mint_to(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">100</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>owner_account,],
            )
        );

        <span class="comment">// no burn if account is frozen
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::AccountFrozen.into()),
            do_process_instruction(
                burn(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[], <span class="number">100</span>).unwrap(),
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_freeze_thaw_dups() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account1_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account1_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="comment">// create mint
            ...
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span>account1_key), <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[mint_info.clone(), rent_info.clone()],
        )
        .unwrap();
        ...
        <span class="comment">// freeze where mint freeze_authority is account
        </span>do_process_instruction_dups(
            freeze_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[
                account1_info.clone(),
                mint_info.clone(),
                account1_info.clone(),
        ...
        <span class="comment">// thaw where mint freeze_authority is account
        </span><span class="kw">let </span><span class="kw-2">mut </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account1_info.data.borrow()).unwrap();
        account.state = AccountState::Frozen;
        Account::pack(account, <span class="kw-2">&amp;mut </span>account1_info.data.borrow_mut()).unwrap();
        do_process_instruction_dups(
            thaw_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account1_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[
                account1_info.clone(),
                mint_info.clone(),
                account1_info.clone(),
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_freeze_account() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        <span class="kw">let </span>account_owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_owner_account = SolanaAccount::default();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>owner2_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner2_account = SolanaAccount::default();
        ...
        <span class="comment">// create new mint with owner different from account owner
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// create account
            ...
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>account_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>account_owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        )
        .unwrap();
        ...
        <span class="comment">// mint cannot freeze
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::MintCannotFreeze.into()),
            do_process_instruction(
                freeze_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
            )
        );

        <span class="comment">// missing freeze_authority
        </span><span class="kw">let </span><span class="kw-2">mut </span>mint = Mint::unpack_unchecked(<span class="kw-2">&amp;</span>mint_account.data).unwrap();
        mint.freeze_authority = COption::Some(owner_key);
        Mint::pack(mint, <span class="kw-2">&amp;mut </span>mint_account.data).unwrap();
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                freeze_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner2_account],
            )
        );

        <span class="comment">// check explicit thaw
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidState.into()),
            do_process_instruction(
                thaw_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner2_account],
            )
        );

        <span class="comment">// freeze
        </span>do_process_instruction(
            freeze_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.state, AccountState::Frozen);

        <span class="comment">// check explicit freeze
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidState.into()),
            do_process_instruction(
                freeze_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
        ...
        <span class="comment">// check thaw authority
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::OwnerMismatch.into()),
            do_process_instruction(
                thaw_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner2_key, <span class="kw-2">&amp;</span>[]).unwrap(),
        ...
        <span class="comment">// thaw
        </span>do_process_instruction(
            thaw_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>owner_account],
        )
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>account_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.state, AccountState::Initialized);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_initialize_account2_and_3() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>account_account = SolanaAccount::new(
            account_minimum_balance(),
        ...
        do_process_instruction(
            initialize_account2(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account2_account, <span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();

        <span class="macro">assert_eq!</span>(account_account, account2_account);

        do_process_instruction(
            initialize_account3(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>account3_account, <span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        <span class="macro">assert_eq!</span>(account_account, account3_account);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>initialize_account_on_non_transferable_mint() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>account = Pubkey::new_unique();
        <span class="kw">let </span>account_len = ExtensionType::try_calculate_account_len::&lt;Mint&gt;(<span class="kw-2">&amp;</span>[
            ExtensionType::NonTransferableAccount,
        ])
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account_without_enough_length = SolanaAccount::new(
            Rent::default().minimum_balance(account_len),
            account_len,
            <span class="kw-2">&amp;</span>program_id,
        );

        <span class="kw">let </span>account2 = Pubkey::new_unique();
        <span class="kw">let </span>account2_len = ExtensionType::try_calculate_account_len::&lt;Mint&gt;(<span class="kw-2">&amp;</span>[
            ExtensionType::NonTransferableAccount,
            ExtensionType::ImmutableOwner,
        ])
        .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>account_with_enough_length = SolanaAccount::new(
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_len =
            ExtensionType::try_calculate_account_len::&lt;Mint&gt;(<span class="kw-2">&amp;</span>[ExtensionType::NonTransferable])
                .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account = SolanaAccount::new(
        ...
        <span class="comment">// create a non-transferable mint
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Ok</span>(()),
            do_process_instruction(
                initialize_non_transferable_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
        <span class="macro">assert_eq!</span>(
        ...
        <span class="comment">//fail when account space is not enough for adding the immutable ownership
        // extension
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidAccountData),
            do_process_instruction(
                initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_without_enough_length,
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                    <span class="kw-2">&amp;mut </span>rent_sysvar,
                ]
        ...
        <span class="comment">//success to initialize an account with enough data space
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Ok</span>(()),
            do_process_instruction(
                initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account2, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
                <span class="macro">vec!</span>[
                    <span class="kw-2">&amp;mut </span>account_with_enough_length,
                    <span class="kw-2">&amp;mut </span>mint_account,
                    <span class="kw-2">&amp;mut </span>owner_account,
                    <span class="kw-2">&amp;mut </span>rent_sysvar,
                ]
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>test_sync_native() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>native_account_key = Pubkey::new_unique();
        <span class="kw">let </span>lamports = <span class="number">40</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>native_account = SolanaAccount::new(
            account_minimum_balance() + lamports,
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>non_native_account_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>non_native_account = SolanaAccount::new(
            account_minimum_balance() + <span class="number">50</span>,
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        ...
        <span class="comment">// initialize non-native mint
        </span>do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        ...
        <span class="comment">// initialize non-native account
        </span>do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>non_native_account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key)
                .unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>non_native_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>non_native_account.data).unwrap();
        <span class="macro">assert!</span>(!account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, <span class="number">0</span>);

        <span class="comment">// fail sync non-native
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::NonNativeNotSupported.into()),
            do_process_instruction(
                sync_native(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>non_native_account_key,).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>non_native_account],
            )
        );

        <span class="comment">// fail sync uninitialized
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::UninitializedAccount),
            do_process_instruction(
                sync_native(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>native_account_key,).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>native_account],
            )
        );

        <span class="comment">// wrap native account
        </span>do_process_instruction(
            initialize_account(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>native_account_key,
                <span class="kw-2">&amp;</span><span class="kw">crate</span>::native_mint::id(),
                <span class="kw-2">&amp;</span>owner_key,
            )
            .unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>native_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        <span class="comment">// fail sync, not owned by program
        </span><span class="kw">let </span>not_program_id = Pubkey::new_unique();
        ...
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>native_account.data).unwrap();
        <span class="macro">assert!</span>(account.is_native());
        <span class="macro">assert_eq!</span>(account.amount, lamports);

        <span class="comment">// sync, no change
        </span>do_process_instruction(
            sync_native(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>native_account_key).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>native_account],
        )
        ...
        <span class="comment">// transfer sol
        </span><span class="kw">let </span>new_lamports = lamports + <span class="number">50</span>;
        native_account.lamports = account_minimum_balance() + new_lamports;

        <span class="comment">// success sync
        </span>do_process_instruction(
            sync_native(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>native_account_key).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>native_account],
        )
        .unwrap();
        <span class="kw">let </span>account = Account::unpack_unchecked(<span class="kw-2">&amp;</span>native_account.data).unwrap();
        <span class="macro">assert_eq!</span>(account.amount, new_lamports);

        <span class="comment">// reduce sol
        </span>native_account.lamports -= <span class="number">1</span>;

        <span class="comment">// fail sync
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidState.into()),
            do_process_instruction(
                sync_native(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>native_account_key,).unwrap(),
    ...
    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_get_account_data_size() {
        <span class="comment">// see integration tests for return-data validity
        </span><span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>owner_account = SolanaAccount::default();
        <span class="kw">let </span><span class="kw-2">mut </span>rent_sysvar = rent_sysvar();

        <span class="comment">// Base mint
        </span><span class="kw">let </span><span class="kw-2">mut </span>mint_account =
            SolanaAccount::new(mint_minimum_balance(), Mint::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
        ...
        set_expected_data(
            ExtensionType::try_calculate_account_len::&lt;Account&gt;(<span class="kw-2">&amp;</span>[])
                .unwrap()
                .to_le_bytes()
                .to_vec(),
        );
        do_process_instruction(
            get_account_data_size(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[]).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        ...
        do_process_instruction(
            get_account_data_size(
                ...
                <span class="kw-2">&amp;</span>[
                    ExtensionType::TransferFeeAmount,
                    ExtensionType::TransferFeeAmount, <span class="comment">// Duplicate user input ignored...
                </span>],
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        ...
        <span class="comment">// Native mint
        </span><span class="kw">let </span><span class="kw-2">mut </span>mint_account = native_mint();
        set_expected_data(
            ExtensionType::try_calculate_account_len::&lt;Account&gt;(<span class="kw-2">&amp;</span>[])
                .unwrap()
                .to_le_bytes()
        ...
        <span class="comment">// Extended mint
        </span><span class="kw">let </span>mint_len =
            ExtensionType::try_calculate_account_len::&lt;Mint&gt;(<span class="kw-2">&amp;</span>[ExtensionType::TransferFeeConfig])
                .unwrap();
        <span class="kw">let </span><span class="kw-2">mut </span>extended_mint_account = SolanaAccount::new(
            Rent::default().minimum_balance(mint_len),
            mint_len,
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>extended_mint_key = Pubkey::new_unique();
        do_process_instruction(
            initialize_transfer_fee_config(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>extended_mint_key, <span class="prelude-val">None</span>, <span class="prelude-val">None</span>, <span class="number">10</span>, <span class="number">4242</span>)
                .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>extended_mint_account],
        )
        .unwrap();
        do_process_instruction(
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>extended_mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>extended_mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        ...
        do_process_instruction(
            get_account_data_size(
                <span class="kw-2">&amp;</span>program_id,
                <span class="kw-2">&amp;</span>mint_key,
                <span class="comment">// User extension that's also added by the mint ignored...
                </span><span class="kw-2">&amp;</span>[ExtensionType::TransferFeeAmount],
            )
            .unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>extended_mint_account],
        )
        ...
        <span class="comment">// Invalid mint
        </span><span class="kw">let </span><span class="kw-2">mut </span>invalid_mint_account = SolanaAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            <span class="kw-2">&amp;</span>program_id,
        );
        <span class="kw">let </span>invalid_mint_key = Pubkey::new_unique();
        do_process_instruction(
            initialize_account(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>invalid_mint_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>owner_key).unwrap(),
            <span class="macro">vec!</span>[
                <span class="kw-2">&amp;mut </span>invalid_mint_account,
                <span class="kw-2">&amp;mut </span>mint_account,
                <span class="kw-2">&amp;mut </span>owner_account,
                <span class="kw-2">&amp;mut </span>rent_sysvar,
            ],
        ...
        <span class="macro">assert_eq!</span>(
            do_process_instruction(
                get_account_data_size(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>invalid_mint_key, <span class="kw-2">&amp;</span>[]).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>invalid_mint_account],
            ),
            <span class="prelude-val">Err</span>(TokenError::InvalidMint.into())
        );

        <span class="comment">// Invalid mint owner
        </span><span class="kw">let </span>invalid_program_id = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>invalid_mint_account = SolanaAccount::new(
            mint_minimum_balance(),
            Mint::get_packed_len(),
            <span class="kw-2">&amp;</span>invalid_program_id,
        );
        <span class="kw">let </span>invalid_mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>instruction =
            initialize_mint(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>invalid_mint_key, <span class="kw-2">&amp;</span>owner_key, <span class="prelude-val">None</span>, <span class="number">2</span>).unwrap();
        instruction.program_id = invalid_program_id;
        do_process_instruction(
            instruction,
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>invalid_mint_account, <span class="kw-2">&amp;mut </span>rent_sysvar],
        )
        .unwrap();
        ...
        <span class="comment">// Invalid Extension Type for mint and uninitialized account
        </span><span class="macro">assert_eq!</span>(
            do_process_instruction(
                get_account_data_size(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[ExtensionType::Uninitialized])
                    .unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            ),
            <span class="prelude-val">Err</span>(TokenError::ExtensionTypeMismatch.into())
        );
        <span class="macro">assert_eq!</span>(
            do_process_instruction(
                get_account_data_size(
    ...
    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_amount_to_ui_amount() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
        ...
        <span class="comment">// fail if an invalid mint is passed in
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(TokenError::InvalidMint.into()),
            do_process_instruction(
                amount_to_ui_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="number">110</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
        ...
        set_expected_data(<span class="string">"0.23"</span>.as_bytes().to_vec());
        do_process_instruction(
            amount_to_ui_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="number">23</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        set_expected_data(<span class="string">"1.1"</span>.as_bytes().to_vec());
        do_process_instruction(
            amount_to_ui_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="number">110</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        ...
        set_expected_data(<span class="string">"42"</span>.as_bytes().to_vec());
        do_process_instruction(
            amount_to_ui_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="number">4200</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        set_expected_data(<span class="string">"0"</span>.as_bytes().to_vec());
        do_process_instruction(
            amount_to_ui_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="number">0</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
    }
    ...
    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_ui_amount_to_amount() {
        <span class="kw">let </span>program_id = <span class="kw">crate</span>::id();
        <span class="kw">let </span>owner_key = Pubkey::new_unique();
        <span class="kw">let </span>mint_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>mint_account =
        ...
        <span class="comment">// fail if an invalid mint is passed in
            ...
            <span class="prelude-val">Err</span>(TokenError::InvalidMint.into()),
            do_process_instruction(
                ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"1.1"</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
        ...
        set_expected_data(<span class="number">23u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0.23"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        set_expected_data(<span class="number">20u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0.20"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        ...
        set_expected_data(<span class="number">20u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0.2000"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        ...
        set_expected_data(<span class="number">20u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">".20"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        set_expected_data(<span class="number">110u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"1.1"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        ...
        set_expected_data(<span class="number">110u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"1.10"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        set_expected_data(<span class="number">4200u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"42"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();
        ...
        set_expected_data(<span class="number">0u64</span>.to_le_bytes().to_vec());
        do_process_instruction(
            ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0"</span>).unwrap(),
            <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
        )
        .unwrap();

        <span class="comment">// fail if invalid ui_amount passed in
        </span><span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidArgument),
            do_process_instruction(
                ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">""</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
        <span class="macro">assert_eq!</span>(
        ...
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidArgument),
            do_process_instruction(
                ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0.111"</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
        <span class="macro">assert_eq!</span>(
            <span class="prelude-val">Err</span>(ProgramError::InvalidArgument),
            do_process_instruction(
                ui_amount_to_amount(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="string">"0.t"</span>).unwrap(),
                <span class="macro">vec!</span>[<span class="kw-2">&amp;mut </span>mint_account],
            )
        );
    }
    ...
    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_withdraw_excess_lamports_from_multisig() {
        {
            <span class="kw">use </span>std::sync::Once;
            <span class="kw">static </span>ONCE: Once = Once::new();
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>lamports = <span class="number">0</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>destination_data = <span class="macro">vec!</span>[];
        <span class="kw">let </span>system_program_id = system_program::id();
        <span class="kw">let </span>destination_key = Pubkey::new_unique();
        <span class="kw">let </span>destination_info = AccountInfo::new(
            <span class="kw-2">&amp;</span>destination_key,
            <span class="bool-val">true</span>,
            <span class="bool-val">false</span>,
            <span class="kw-2">&amp;mut </span>lamports,
            <span class="kw-2">&amp;mut </span>destination_data,
            <span class="kw-2">&amp;</span>system_program_id,
            <span class="bool-val">false</span>,
            Epoch::default(),
        );

        <span class="kw">let </span>multisig_key = Pubkey::new_unique();
        <span class="kw">let </span><span class="kw-2">mut </span>multisig_account = SolanaAccount::new(<span class="number">0</span>, Multisig::get_packed_len(), <span class="kw-2">&amp;</span>program_id);
        <span class="kw">let </span>excess_lamports = <span class="number">4_000_000_000_000</span>;
        ...
        <span class="kw">let </span>signer_refs: Vec&lt;<span class="kw-2">&amp;</span>Pubkey&gt; = signer_keys.iter().collect();
        <span class="kw">let </span><span class="kw-2">mut </span>signer_lamports = <span class="number">0</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>signer_data = <span class="macro">vec!</span>[];
        <span class="kw">let </span><span class="kw-2">mut </span>signers: Vec&lt;AccountInfo&lt;<span class="lifetime">'_</span>&gt;&gt; = <span class="macro">vec!</span>[
            AccountInfo::new(
                <span class="kw-2">&amp;</span>destination_key,
                <span class="bool-val">true</span>,
                <span class="bool-val">false</span>,
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>multisig =
            Multisig::unpack_unchecked(<span class="kw-2">&amp;</span><span class="macro">vec!</span>[<span class="number">0</span>; Multisig::get_packed_len()]).unwrap();
        multisig.m = MAX_SIGNERS <span class="kw">as </span>u8;
        multisig.n = MAX_SIGNERS <span class="kw">as </span>u8;
        multisig.signers = signer_keys;
        multisig.is_initialized = <span class="bool-val">true</span>;
        Multisig::pack(multisig, <span class="kw-2">&amp;mut </span>multisig_account.data).unwrap();

        <span class="kw">let </span>multisig_info: AccountInfo = (<span class="kw-2">&amp;</span>multisig_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>multisig_account).into();

        <span class="kw">let </span><span class="kw-2">mut </span>signers_infos = <span class="macro">vec!</span>[
            multisig_info.clone(),
        ...
        do_process_instruction_dups(
            withdraw_excess_lamports(
                ...
                <span class="kw-2">&amp;</span>destination_key,
                <span class="kw-2">&amp;</span>multisig_key,
                <span class="kw-2">&amp;</span>signer_refs,
            )
            .unwrap(),
            signers_infos,
        )
        ...
        <span class="macro">assert_eq!</span>(destination_info.lamports(), excess_lamports);
    }

    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_withdraw_excess_lamports_from_account() {
        <span class="kw">let </span>excess_lamports = <span class="number">4_000_000_000_000</span>;
        ...
        <span class="kw">let </span><span class="kw-2">mut </span>destination_lamports = <span class="number">0</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>destination_data = <span class="macro">vec!</span>[];
        <span class="kw">let </span>destination_key = Pubkey::new_unique();
        <span class="kw">let </span>destination_info = AccountInfo::new(
            <span class="kw-2">&amp;</span>destination_key,
            <span class="bool-val">true</span>,
            <span class="bool-val">false</span>,
            <span class="kw-2">&amp;mut </span>destination_lamports,
            <span class="kw-2">&amp;mut </span>destination_data,
            <span class="kw-2">&amp;</span>system_program_id,
            <span class="bool-val">false</span>,
            Epoch::default(),
        ...
        <span class="kw">let </span>mint_info = AccountInfo::new(
            <span class="kw-2">&amp;</span>mint_key,
            <span class="bool-val">true</span>,
            <span class="bool-val">false</span>,
            <span class="kw-2">&amp;mut </span>mint_account.lamports,
            <span class="kw-2">&amp;mut </span>mint_account.data,
            <span class="kw-2">&amp;</span>program_id,
            <span class="bool-val">false</span>,
            Epoch::default(),
        );

        <span class="kw">let </span>account_info: AccountInfo = (<span class="kw-2">&amp;</span>account_key, <span class="bool-val">true</span>, <span class="kw-2">&amp;mut </span>account_account).into();

        do_process_instruction_dups(
            initialize_account3(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>account_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>account_key).unwrap(),
            <span class="macro">vec!</span>[account_info.clone(), mint_info.clone()],
        )
        .unwrap();
    ...
    <span class="attr">#[test]
    #[serial]
    </span><span class="kw">fn </span>test_withdraw_excess_lamports_from_mint() {
        <span class="kw">let </span>excess_lamports = <span class="number">4_000_000_000_000</span>;
        ...
        do_process_instruction_dups(
            withdraw_excess_lamports(<span class="kw-2">&amp;</span>program_id, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>destination_key, <span class="kw-2">&amp;</span>mint_key, <span class="kw-2">&amp;</span>[])
                .unwrap(),
            <span class="macro">vec!</span>[
                mint_info.clone(),
                destination_info.clone(),
