...
/// address space.
    ...
    </span><span class="kw">while </span>n &gt;= <span class="number">4 </span>{
    ...
    </span><span class="kw">if </span>n &gt;= <span class="number">2 </span>{
        <span class="kw">let </span>vx = x.cast::&lt;u16&gt;().read_unaligned();
        <span class="kw">let </span>vy = y.cast::&lt;u16&gt;().read_unaligned();
        <span class="kw">if </span>vx != vy {
            <span class="kw">return </span><span class="bool-val">false</span>;
        }
        x = x.add(<span class="number">2</span>);
        y = y.add(<span class="number">2</span>);
        n -= <span class="number">2</span>;
    }
    <span class="kw">if </span>n &gt; <span class="number">0 </span>{
        <span class="kw">if </span>x.read() != y.read() {
            <span class="kw">return </span><span class="bool-val">false</span>;
        }
    }
