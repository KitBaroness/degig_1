...
</pre></div><pre class="rust"><code><span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">const </span>RANK: [u8; <span class="number">256</span>] = [
