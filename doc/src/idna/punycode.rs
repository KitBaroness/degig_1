...
</pre></div><pre class="rust"><code><span class="comment">// Copyright 2013 The rust-url developers.
//
...
<span class="kw">pub</span>(<span class="kw">crate</span>) <span class="kw">struct </span>Decode&lt;<span class="lifetime">'a</span>&gt; {
    base: core::str::Chars&lt;<span class="lifetime">'a</span>&gt;,
...
/// This is a convenience wrapper around `encode`.
    ...
    <span class="kw">if </span>input.len() &gt; u32::MAX <span class="kw">as </span>usize {
        <span class="kw">return </span><span class="prelude-val">None</span>;
    }
    ...
    </span>I: Iterator&lt;Item = char&gt; + Clone,
{
    ...
    </span><span class="kw">let </span>(<span class="kw-2">mut </span>input_length, <span class="kw-2">mut </span>basic_length) = (<span class="number">0u32</span>, <span class="number">0</span>);
    <span class="kw">for </span>c <span class="kw">in </span>input.clone() {
        input_length = input_length.checked_add(<span class="number">1</span>).ok_or(())<span class="question-mark">?</span>;
    ...
    <span class="kw">while </span>processed &lt; input_length {
        ...
        <span class="kw">for </span>c <span class="kw">in </span>input.clone() {
            ...
            <span class="kw">if </span>c &lt; code_point {
                delta = delta.checked_add(<span class="number">1</span>).ok_or(())<span class="question-mark">?</span>;
            }
            <span class="kw">if </span>c == code_point {
...
#[ignore = <span class="string">"slow"</span>]
#[cfg(target_pointer_width = <span class="string">"64"</span>)]
</span><span class="kw">fn </span>huge_encode() {
    <span class="kw">let </span><span class="kw-2">mut </span>buf = String::new();
    <span class="macro">assert!</span>(encode_into(std::iter::repeat(<span class="string">'ß'</span>).take(u32::MAX <span class="kw">as </span>usize + <span class="number">1</span>), <span class="kw-2">&amp;mut </span>buf).is_err());
