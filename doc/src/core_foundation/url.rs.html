...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>CFURL {
    <span class="attr">#[inline]
        ...
        <span class="kw">unsafe </span>{
            ...
            <span class="macro">write!</span>(f, <span class="string">"{}"</span>, string)
        }
    }
}
...
<span class="kw">impl </span>CFURL {
    <span class="kw">pub fn </span>from_path&lt;P: AsRef&lt;Path&gt;&gt;(path: P, isDirectory: bool) -&gt; <span class="prelude-ty">Option</span>&lt;CFURL&gt; {
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>url_ref = CFURLCreateFromFileSystemRepresentation(
                ptr::null_mut(),
                path_bytes.as_ptr(),
                path_bytes.len() <span class="kw">as </span>CFIndex,
                isDirectory <span class="kw">as </span>u8,
            );
    ...
    <span class="kw">pub fn </span>from_file_system_path(
        filePath: CFString,
        pathStyle: CFURLPathStyle,
        isDirectory: bool,
    ) -&gt; CFURL {
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>url_ref = CFURLCreateWithFileSystemPath(
                kCFAllocatorDefault,
    ...
    <span class="attr">#[cfg(unix)]
        ...
        <span class="comment">// implementing this on Windows is more complicated because of the different OsStr representation
            ...
            <span class="kw">let </span>result = CFURLGetFileSystemRepresentation(
                <span class="self">self</span>.<span class="number">0</span>,
                <span class="bool-val">true </span><span class="kw">as </span>Boolean,
                buf.as_mut_ptr(),
                buf.len() <span class="kw">as </span>CFIndex,
            );
    ...
    <span class="kw">pub fn </span>get_string(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; CFString {
        <span class="kw">unsafe </span>{ TCFType::wrap_under_get_rule(CFURLGetString(<span class="self">self</span>.<span class="number">0</span>)) }
    }
    ...
    <span class="kw">pub fn </span>absolute(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; CFURL {
        <span class="kw">unsafe </span>{ TCFType::wrap_under_create_rule(CFURLCopyAbsoluteURL(<span class="self">self</span>.as_concrete_TypeRef())) }
    }
}
...
<span class="attr">#[test]
    ...
    <span class="kw">let </span>cfurl_relative: CFURL = <span class="kw">unsafe </span>{
        <span class="kw">let </span>url_ref = CFURLCreateWithFileSystemPathRelativeToBase(
            kCFAllocatorDefault,
