...
</span><span class="kw">use </span>core_foundation_sys::base::CFIndex;
<span class="kw">use </span>core_foundation_sys::base::{kCFAllocatorDefault, CFOptionFlags};
<span class="kw">pub use </span>core_foundation_sys::runloop::<span class="kw-2">*</span>;
...
<span class="kw">use </span><span class="kw">crate</span>::filedescriptor::CFFileDescriptor;
...
<span class="comment">// https://github.com/servo/core-foundation-rs/issues/550
</span><span class="kw">unsafe impl </span>Send <span class="kw">for </span>CFRunLoop {}
<span class="kw">unsafe impl </span>Sync <span class="kw">for </span>CFRunLoop {}
...
<span class="kw">impl </span>CFRunLoop {
    ...
    <span class="kw">pub fn </span>contains_timer(<span class="kw-2">&amp;</span><span class="self">self</span>, timer: <span class="kw-2">&amp;</span>CFRunLoopTimer, mode: CFRunLoopMode) -&gt; bool {
        <span class="kw">unsafe </span>{ CFRunLoopContainsTimer(<span class="self">self</span>.<span class="number">0</span>, timer.<span class="number">0</span>, mode) != <span class="number">0 </span>}
    }
    ...
    <span class="kw">pub fn </span>contains_source(<span class="kw-2">&amp;</span><span class="self">self</span>, source: <span class="kw-2">&amp;</span>CFRunLoopSource, mode: CFRunLoopMode) -&gt; bool {
        <span class="kw">unsafe </span>{ CFRunLoopContainsSource(<span class="self">self</span>.<span class="number">0</span>, source.<span class="number">0</span>, mode) != <span class="number">0 </span>}
    }
    ...
    <span class="kw">pub fn </span>contains_observer(<span class="kw-2">&amp;</span><span class="self">self</span>, observer: <span class="kw-2">&amp;</span>CFRunLoopObserver, mode: CFRunLoopMode) -&gt; bool {
        <span class="kw">unsafe </span>{ CFRunLoopContainsObserver(<span class="self">self</span>.<span class="number">0</span>, observer.<span class="number">0</span>, mode) != <span class="number">0 </span>}
    }
...
<span class="kw">impl </span>CFRunLoopTimer {
    <span class="kw">pub fn </span>new(
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>timer_ref = CFRunLoopTimerCreate(
                kCFAllocatorDefault,
                fireDate,
                interval,
                flags,
...
<span class="attr">#[cfg(test)]
    ...
    <span class="kw">use </span><span class="kw">crate</span>::base::Boolean;
    <span class="kw">use </span><span class="kw">crate</span>::date::{CFAbsoluteTime, CFDate};
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>run_loop_timer =
            CFRunLoopTimer::new(now + <span class="number">0.20f64</span>, <span class="number">0f64</span>, <span class="number">0</span>, <span class="number">0</span>, timer_popped, <span class="kw-2">&amp;mut </span>context);
        <span class="kw">unsafe </span>{
    ...
    <span class="kw">extern </span><span class="string">"C" </span><span class="kw">fn </span>observe(<span class="kw">_</span>: CFRunLoopObserverRef, <span class="kw">_</span>: CFRunLoopActivity, context: <span class="kw-2">*mut </span>c_void) {
        <span class="kw">let </span>tx: <span class="kw-2">&amp;</span>mpsc::Sender&lt;CFRunLoop&gt; = <span class="kw">unsafe </span>{ <span class="kw-2">&amp;*</span>(context <span class="kw">as </span><span class="kw-2">*const </span><span class="kw">_</span>) };
        <span class="kw">let _ </span>= tx.send(CFRunLoop::get_current());
    }

    <span class="kw">extern </span><span class="string">"C" </span><span class="kw">fn </span>observe_timer_popped(<span class="kw">_</span>: CFRunLoopTimerRef, <span class="kw">_</span>: <span class="kw-2">*mut </span>c_void) {
        <span class="macro">panic!</span>(<span class="string">"timer popped unexpectedly"</span>);
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>observe_runloop() {
        ...
        spawn(<span class="kw">move </span>|| {
            <span class="kw">let </span><span class="kw-2">mut </span>context = CFRunLoopObserverContext {
                version: <span class="number">0</span>,
                info: <span class="kw-2">&amp;</span>tx <span class="kw">as </span><span class="kw-2">*const </span><span class="kw">_ as </span><span class="kw-2">*mut </span>c_void,
                retain: <span class="prelude-val">None</span>,
                release: <span class="prelude-val">None</span>,
                copyDescription: <span class="prelude-val">None</span>,
            };
            ...
            <span class="kw">let </span>runloop = CFRunLoop::get_current();
            runloop.add_observer(<span class="kw-2">&amp;</span>observer, <span class="kw">unsafe </span>{ kCFRunLoopDefaultMode });

            <span class="kw">let </span>timer = CFRunLoopTimer::new(
                CFDate::now().abs_time() + <span class="number">1f64</span>,
                <span class="number">0f64</span>,
                <span class="number">0</span>,
                <span class="number">0</span>,
                observe_timer_popped,
                null_mut(),
            );
            runloop.add_timer(<span class="kw-2">&amp;</span>timer, <span class="kw">unsafe </span>{ kCFRunLoopDefaultMode });

            <span class="kw">let </span>result = <span class="kw">unsafe </span>{
                CFRunLoop::run_in_mode(kCFRunLoopDefaultMode, Duration::from_secs(<span class="number">10</span>), <span class="bool-val">false</span>)
            };

            <span class="macro">assert_eq!</span>(result, CFRunLoopRunResult::Stopped);

            drop(tx);
        });

        <span class="kw">let </span>runloop: CFRunLoop = rx.recv().unwrap();
        runloop.stop();
    }
}
