...
<span class="kw">pub use </span>core_foundation_sys::timezone::<span class="kw-2">*</span>;

<span class="kw">use </span><span class="kw">crate</span>::base::TCFType;
<span class="kw">use </span><span class="kw">crate</span>::date::{CFDate, CFTimeInterval};
...
<span class="kw">impl </span>CFTimeZone {
    ...
    <span class="kw">pub fn </span>seconds_from_gmt(<span class="kw-2">&amp;</span><span class="self">self</span>, date: CFDate) -&gt; CFTimeInterval {
        <span class="kw">unsafe </span>{ CFTimeZoneGetSecondsFromGMT(<span class="self">self</span>.<span class="number">0</span>, date.abs_time()) }
    }
    ...
    /// `"Europe/Paris"`.
        ...
        <span class="kw">unsafe </span>{ CFString::wrap_under_get_rule(CFTimeZoneGetName(<span class="self">self</span>.<span class="number">0</span>)) }
    }
}
