...
<span class="kw">pub use </span>core_foundation_sys::data::<span class="kw-2">*</span>;
...
<span class="kw">impl </span>CFData {
    <span class="doccomment">/// Creates a [`CFData`] around a copy `buffer`
        ...
        <span class="kw">unsafe </span>{
            <span class="kw">let </span>data_ref = CFDataCreate(
                kCFAllocatorDefault,
                buffer.as_ptr(),
    ...
    <span class="doccomment">/// Creates a [`CFData`] referencing `buffer` without creating a copy
        ...
        <span class="kw">unsafe </span>{
            ...
            <span class="kw">let </span>data_ref = CFDataCreateWithBytesNoCopy(
                kCFAllocatorDefault,
                ptr,
                len,
    ...
    /// read-only.
        ...
        <span class="kw">unsafe </span>{ slice::from_raw_parts(CFDataGetBytePtr(<span class="self">self</span>.<span class="number">0</span>), <span class="self">self</span>.len() <span class="kw">as </span>usize) }
    }
    ...
    <span class="doccomment">/// Returns the length of this byte buffer.
        ...
        <span class="kw">unsafe </span>{ CFDataGetLength(<span class="self">self</span>.<span class="number">0</span>) }
    }

    <span class="doccomment">/// Returns `true` if this byte buffer is empty.
    </span><span class="attr">#[inline]
...
<span class="attr">#[cfg(test)]
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>l = Arc::new(VecWrapper {
            inner: <span class="macro">vec!</span>[<span class="number">5</span>],
