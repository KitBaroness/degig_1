...
</pre></div><pre class="rust"><code><span class="doccomment">//! **POLYVAL** is a GHASH-like universal hash over GF(2^128) useful for
...
#![cfg_attr(
    all(feature = <span class="string">"armv8"</span>, target_arch = <span class="string">"aarch64"</span>),
...
#![doc(
    ...
    html_root_url = <span class="string">"https://docs.rs/polyval/0.5.3"
</span>)]
#![warn(missing_docs, rust_2018_idioms)]

</span><span class="kw">mod </span>backend;
<span class="kw">mod </span>mulx;

<span class="kw">pub use crate</span>::{backend::Polyval, mulx::mulx};
<span class="kw">pub use </span>universal_hash;

<span class="macro">opaque_debug::implement!</span>(Polyval);

<span class="doccomment">/// Size of a POLYVAL block in bytes
</span><span class="kw">pub const </span>BLOCK_SIZE: usize = <span class="number">16</span>;

<span class="doccomment">/// Size of a POLYVAL key in bytes
</span><span class="kw">pub const </span>KEY_SIZE: usize = <span class="number">16</span>;

<span class="doccomment">/// POLYVAL keys (16-bytes)
</span><span class="kw">pub type </span>Key = universal_hash::Key&lt;Polyval&gt;;

<span class="doccomment">/// POLYVAL blocks (16-bytes)
</span><span class="kw">pub type </span>Block = universal_hash::Block&lt;Polyval&gt;;

<span class="doccomment">/// POLYVAL tags (16-bytes)
</span><span class="kw">pub type </span>Tag = universal_hash::Output&lt;Polyval&gt;;
