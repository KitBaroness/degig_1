...
</pre></div><pre class="rust"><code><span class="comment">// `Add`/`Sub` ops may flip from `BigInt` to its `BigUint` magnitude
</span><span class="attr">#![allow(clippy::suspicious_arithmetic_impl)]

</span><span class="kw">use </span><span class="kw">crate</span>::std_alloc::{String, Vec};
<span class="kw">use </span>core::cmp::Ordering::{<span class="self">self</span>, Equal};
<span class="kw">use </span>core::default::Default;
<span class="kw">use </span>core::fmt;
<span class="kw">use </span>core::hash;
<span class="kw">use </span>core::ops::{Neg, Not};
<span class="kw">use </span>core::str;
<span class="kw">use </span>core::{i128, u128};
<span class="kw">use </span>core::{i64, u64};

<span class="kw">use </span>num_integer::{Integer, Roots};
<span class="kw">use </span>num_traits::{Num, One, Pow, Signed, Zero};

<span class="kw">use </span><span class="self">self</span>::Sign::{Minus, NoSign, Plus};

<span class="kw">use </span><span class="kw">crate</span>::big_digit::BigDigit;
<span class="kw">use </span><span class="kw">crate</span>::biguint::to_str_radix_reversed;
<span class="kw">use </span><span class="kw">crate</span>::biguint::{BigUint, IntDigits, U32Digits, U64Digits};
...
</span><span class="attr">#[derive(PartialEq, PartialOrd, Eq, Ord, Copy, Clone, Debug, Hash)]
...
// but we want to keep the allocation in `data`.
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self</span>.sign = other.sign;
        <span class="self">self</span>.data.clone_from(<span class="kw-2">&amp;</span>other.data);
    }
}

<span class="kw">impl </span>hash::Hash <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="macro">debug_assert!</span>((<span class="self">self</span>.sign != NoSign) ^ <span class="self">self</span>.data.is_zero());
        <span class="self">self</span>.sign.hash(state);
        <span class="kw">if </span><span class="self">self</span>.sign != NoSign {
...
<span class="kw">impl </span>PartialEq <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="macro">debug_assert!</span>((<span class="self">self</span>.sign != NoSign) ^ <span class="self">self</span>.data.is_zero());
        <span class="macro">debug_assert!</span>((other.sign != NoSign) ^ other.data.is_zero());
        <span class="self">self</span>.sign == other.sign &amp;&amp; (<span class="self">self</span>.sign == NoSign || <span class="self">self</span>.data == other.data)
    }
}
...
<span class="kw">impl </span>fmt::Debug <span class="kw">for </span>BigInt {
...
<span class="kw">impl </span>Not <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;

    <span class="kw">fn </span>not(<span class="self">self</span>) -&gt; BigInt {
        <span class="kw">match </span><span class="self">self</span>.sign {
            NoSign =&gt; -BigInt::one(),
            Plus =&gt; -BigInt::from(<span class="kw-2">&amp;</span><span class="self">self</span>.data + <span class="number">1u32</span>),
            Minus =&gt; BigInt::from(<span class="kw-2">&amp;</span><span class="self">self</span>.data - <span class="number">1u32</span>),
        }
    }
}
...
<span class="kw">impl </span>Signed <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            ...
            Minus =&gt; BigInt::from(<span class="self">self</span>.data.clone()),
        }
    }
...
<span class="kw">trait </span>UnsignedAbs {
    <span class="kw">type </span>Unsigned;

    <span class="doccomment">/// A convenience method for getting the absolute value of a signed primitive as unsigned
    /// See also `unsigned_abs`: &lt;https://github.com/rust-lang/rust/issues/74913&gt;
    </span><span class="kw">fn </span>uabs(<span class="self">self</span>) -&gt; <span class="self">Self</span>::Unsigned;

    <span class="kw">fn </span>checked_uabs(<span class="self">self</span>) -&gt; CheckedUnsignedAbs&lt;<span class="self">Self</span>::Unsigned&gt;;
}

<span class="kw">enum </span>CheckedUnsignedAbs&lt;T&gt; {
    Positive(T),
    Negative(T),
}
<span class="kw">use </span><span class="self">self</span>::CheckedUnsignedAbs::{Negative, Positive};

<span class="macro">macro_rules!</span> impl_unsigned_abs {
    (<span class="macro-nonterminal">$Signed</span>:ty, <span class="macro-nonterminal">$Unsigned</span>:ty) =&gt; {
        <span class="kw">impl </span>UnsignedAbs <span class="kw">for </span><span class="macro-nonterminal">$Signed </span>{
            <span class="kw">type </span>Unsigned = <span class="macro-nonterminal">$Unsigned</span>;

            <span class="attr">#[inline]
            </span><span class="kw">fn </span>uabs(<span class="self">self</span>) -&gt; <span class="macro-nonterminal">$Unsigned </span>{
                <span class="self">self</span>.wrapping_abs() <span class="kw">as </span><span class="macro-nonterminal">$Unsigned
            </span>}

            <span class="attr">#[inline]
            </span><span class="kw">fn </span>checked_uabs(<span class="self">self</span>) -&gt; CheckedUnsignedAbs&lt;<span class="self">Self</span>::Unsigned&gt; {
                <span class="kw">if </span><span class="self">self </span>&gt;= <span class="number">0 </span>{
                    Positive(<span class="self">self </span><span class="kw">as </span><span class="macro-nonterminal">$Unsigned</span>)
                } <span class="kw">else </span>{
                    Negative(<span class="self">self</span>.wrapping_neg() <span class="kw">as </span><span class="macro-nonterminal">$Unsigned</span>)
                }
            }
        }
    };
}
<span class="macro">impl_unsigned_abs!</span>(i8, u8);
<span class="macro">impl_unsigned_abs!</span>(i16, u16);
<span class="macro">impl_unsigned_abs!</span>(i32, u32);
<span class="macro">impl_unsigned_abs!</span>(i64, u64);
<span class="macro">impl_unsigned_abs!</span>(i128, u128);
<span class="macro">impl_unsigned_abs!</span>(isize, usize);
...
<span class="kw">impl </span>Neg <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>Integer <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        </span><span class="kw">let </span>(d_ui, r_ui) = <span class="self">self</span>.data.div_rem(<span class="kw-2">&amp;</span>other.data);
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>(d_ui, m) = <span class="self">self</span>.data.div_mod_floor(<span class="kw-2">&amp;</span>other.data);
        <span class="kw">let </span>d = BigInt::from(d_ui);
        <span class="kw">match </span>(<span class="self">self</span>.sign, other.sign) {
            ...
            (<span class="kw">_</span>, NoSign) =&gt; <span class="macro">unreachable!</span>(),
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        </span><span class="kw">let </span>m_ui = <span class="self">self</span>.data.mod_floor(<span class="kw-2">&amp;</span>other.data);
        <span class="kw">let </span>m = BigInt::from_biguint(other.sign, m_ui);
        <span class="kw">match </span>(<span class="self">self</span>.sign, other.sign) {
    ...
    <span class="kw">fn </span>div_mod_floor(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>BigInt) -&gt; (BigInt, BigInt) {
        <span class="comment">// m.sign == other.sign
        </span><span class="kw">let </span>(d_ui, m_ui) = <span class="self">self</span>.data.div_mod_floor(<span class="kw-2">&amp;</span>other.data);
        <span class="kw">let </span>d = BigInt::from(d_ui);
        <span class="kw">let </span>m = BigInt::from_biguint(other.sign, m_ui);
        <span class="kw">match </span>(<span class="self">self</span>.sign, other.sign) {
            ...
            (Plus, Minus) | (NoSign, Minus) | (Minus, Plus) =&gt; {
                <span class="kw">if </span>m.is_zero() {
                    ...
                    (-d - <span class="number">1u32</span>, other - m)
                }
            }
            (<span class="kw">_</span>, NoSign) =&gt; <span class="macro">unreachable!</span>(),
        }
    ...
    /// The result is always positive.
        ...
        BigInt::from(<span class="self">self</span>.data.gcd(<span class="kw-2">&amp;</span>other.data))
    }
    ...
    <span class="doccomment">/// Calculates the Lowest Common Multiple (LCM) of the number and `other`.
        ...
        BigInt::from(<span class="self">self</span>.data.lcm(<span class="kw-2">&amp;</span>other.data))
    }

    <span class="doccomment">/// Calculates the Greatest Common Divisor (GCD) and
    /// Lowest Common Multiple (LCM) together.
    </span><span class="attr">#[inline]
    </span><span class="kw">fn </span>gcd_lcm(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>BigInt) -&gt; (BigInt, BigInt) {
        <span class="kw">let </span>(gcd, lcm) = <span class="self">self</span>.data.gcd_lcm(<span class="kw-2">&amp;</span>other.data);
    ...
    </span><span class="kw">fn </span>extended_gcd_lcm(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span>BigInt) -&gt; (num_integer::ExtendedGcd&lt;BigInt&gt;, BigInt) {
        <span class="kw">let </span>egcd = <span class="self">self</span>.extended_gcd(other);
        <span class="kw">let </span>lcm = <span class="kw">if </span>egcd.gcd.is_zero() {
            BigInt::zero()
        } <span class="kw">else </span>{
            BigInt::from(<span class="kw-2">&amp;</span><span class="self">self</span>.data / <span class="kw-2">&amp;</span>egcd.gcd.data * <span class="kw-2">&amp;</span>other.data)
        };
        (egcd, lcm)
    }
...
<span class="kw">impl </span>BigInt {
    ...
    /// The base 2&lt;sup&gt;32&lt;/sup&gt; digits are ordered least significant digit first.
        ...
        <span class="kw">if </span>sign == NoSign {
            <span class="self">self</span>.set_zero();
        } <span class="kw">else </span>{
            <span class="self">self</span>.data.assign_from_slice(slice);
            <span class="self">self</span>.sign = <span class="kw">if </span><span class="self">self</span>.data.is_zero() { NoSign } <span class="kw">else </span>{ sign };
        }
    }
    ...
    /// ```
        ...
        <span class="kw">let </span>u = BigUint::from_radix_be(buf, radix)<span class="question-mark">?</span>;
        <span class="prelude-val">Some</span>(BigInt::from_biguint(sign, u))
    }
    ...
    /// ```
        ...
        <span class="kw">let </span>u = BigUint::from_radix_le(buf, radix)<span class="question-mark">?</span>;
        <span class="prelude-val">Some</span>(BigInt::from_biguint(sign, u))
    }
    ...
    <span class="doccomment">/// Returns the sign and the `u64` digits representation of the [`BigInt`] ordered least
    /// significant digit first.
    ///
    /// # Examples
    ///
    ...
    </span><span class="kw">pub fn </span>to_u64_digits(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; (Sign, Vec&lt;u64&gt;) {
        (<span class="self">self</span>.sign, <span class="self">self</span>.data.to_u64_digits())
    }

    <span class="doccomment">/// Returns an iterator of `u32` digits representation of the [`BigInt`] ordered least
    /// significant digit first.
    ///
    /// # Examples
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.data.iter_u32_digits()
    }

    <span class="doccomment">/// Returns an iterator of `u64` digits representation of the [`BigInt`] ordered least
    /// significant digit first.
    ///
    /// # Examples
    ///
    ...
    /// ```
        ...
        <span class="self">self</span>.data.iter_u64_digits()
    }
    ...
    /// ```
        ...
        convert::to_signed_bytes_be(<span class="self">self</span>)
    }
    ...
    /// ```
        ...
        convert::to_signed_bytes_le(<span class="self">self</span>)
    }
    ...
    <span class="doccomment">/// Returns the magnitude of the [`BigInt`] as a [`BigUint`].
    ///
    /// # Examples
    ///
    /// ```
    ...
    </span><span class="kw">pub fn </span>magnitude(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>BigUint {
        <span class="kw-2">&amp;</span><span class="self">self</span>.data
    }

    <span class="doccomment">/// Convert this [`BigInt`] into its [`Sign`] and [`BigUint`] magnitude,
    ...
    </span><span class="kw">pub fn </span>into_parts(<span class="self">self</span>) -&gt; (Sign, BigUint) {
        (<span class="self">self</span>.sign, <span class="self">self</span>.data)
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="prelude-val">Some</span>(<span class="self">self </span>+ v)
    }
    ...
    /// or `None` if the entire number is zero.
        ...
        <span class="self">self</span>.data.trailing_zeros()
    }

    <span class="doccomment">/// Returns whether the bit in position `bit` is set,
    /// using the two's complement for negative numbers
    </span><span class="kw">pub fn </span>bit(<span class="kw-2">&amp;</span><span class="self">self</span>, bit: u64) -&gt; bool {
        <span class="kw">if </span><span class="self">self</span>.is_negative() {
            <span class="comment">// Let the binary representation of a number be
            //   ... 0  x 1 0 ... 0
            // Then the two's complement is
            //   ... 1 !x 1 0 ... 0
            // where !x is obtained from x by flipping each bit
            </span><span class="kw">if </span>bit &gt;= u64::from(<span class="kw">crate</span>::big_digit::BITS) * <span class="self">self</span>.len() <span class="kw">as </span>u64 {
                <span class="bool-val">true
            </span>} <span class="kw">else </span>{
                <span class="kw">let </span>trailing_zeros = <span class="self">self</span>.data.trailing_zeros().unwrap();
                <span class="kw">match </span>Ord::cmp(<span class="kw-2">&amp;</span>bit, <span class="kw-2">&amp;</span>trailing_zeros) {
                    Ordering::Less =&gt; <span class="bool-val">false</span>,
                    Ordering::Equal =&gt; <span class="bool-val">true</span>,
                    Ordering::Greater =&gt; !<span class="self">self</span>.data.bit(bit),
                }
            }
        } <span class="kw">else </span>{
            <span class="self">self</span>.data.bit(bit)
        }
    }
    ...
    /// may be needed to store the new digits
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            Sign::Plus =&gt; <span class="self">self</span>.data.set_bit(bit, value),
            Sign::Minus =&gt; bits::set_negative_bit(<span class="self">self</span>, bit, value),
            Sign::NoSign =&gt; {
                <span class="kw">if </span>value {
                    <span class="self">self</span>.data.set_bit(bit, <span class="bool-val">true</span>);
                    <span class="self">self</span>.sign = Sign::Plus;
                } <span class="kw">else </span>{
                    <span class="comment">// Clearing a bit for zero is a no-op
                </span>}
            }
        }
...
<span class="kw">impl </span>num_traits::FromBytes <span class="kw">for </span>BigInt {
    ...
    <span class="kw">fn </span>from_be_bytes(bytes: <span class="kw-2">&amp;</span><span class="self">Self</span>::Bytes) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::from_signed_bytes_be(bytes)
    }

    <span class="kw">fn </span>from_le_bytes(bytes: <span class="kw-2">&amp;</span><span class="self">Self</span>::Bytes) -&gt; <span class="self">Self </span>{
        <span class="self">Self</span>::from_signed_bytes_le(bytes)
    }
}

<span class="kw">impl </span>num_traits::ToBytes <span class="kw">for </span>BigInt {
...
<span class="attr">#[test]
    ...
    <span class="kw">fn </span>check(inp_s: Sign, inp_n: usize, ans_s: Sign, ans_n: usize) {
        <span class="kw">let </span>inp = BigInt::from_biguint(inp_s, BigUint::from(inp_n));
