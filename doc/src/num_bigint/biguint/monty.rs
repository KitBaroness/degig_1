...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">crate</span>::std_alloc::Vec;
...
/// z is guaranteed to satisfy 0 &lt;= z &lt; 2**(n*_W), but it may not be &lt; m.
    ...
    <span class="kw">if </span>c == <span class="number">0 </span>{
        ...
        {
            <span class="kw">let </span>(first, second) = z.data.split_at_mut(n);
            sub_vv(first, second, <span class="kw-2">&amp;</span>m.data);
        }
        z.data = z.data[..n].to_vec();
    }
