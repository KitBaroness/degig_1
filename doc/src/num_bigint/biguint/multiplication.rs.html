...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::addition::{__add2, add2};
...
<span class="kw">use super</span>::{biguint_from_vec, cmp_slice, BigUint, IntDigits};
...
<span class="kw">use </span>num_traits::{CheckedMul, FromPrimitive, One, Zero};
...
/// acc += b * c
...
</span><span class="kw">fn </span>mac3(<span class="kw-2">mut </span>acc: <span class="kw-2">&amp;mut </span>[BigDigit], <span class="kw-2">mut </span>b: <span class="kw-2">&amp;</span>[BigDigit], <span class="kw-2">mut </span>c: <span class="kw-2">&amp;</span>[BigDigit]) {
    <span class="comment">// Least-significant zeros have no effect on the output.
    </span><span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span><span class="number">0</span>) = b.first() {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(nz) = b.iter().position(|<span class="kw-2">&amp;</span>d| d != <span class="number">0</span>) {
            b = <span class="kw-2">&amp;</span>b[nz..];
            acc = <span class="kw-2">&amp;mut </span>acc[nz..];
        } <span class="kw">else </span>{
            <span class="kw">return</span>;
        }
    }
    <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span><span class="number">0</span>) = c.first() {
        <span class="kw">if let </span><span class="prelude-val">Some</span>(nz) = c.iter().position(|<span class="kw-2">&amp;</span>d| d != <span class="number">0</span>) {
            c = <span class="kw-2">&amp;</span>c[nz..];
            acc = <span class="kw-2">&amp;mut </span>acc[nz..];
        } <span class="kw">else </span>{
            <span class="kw">return</span>;
        }
    ...
    <span class="kw">let </span>acc = acc;
    ...
    // of `cargo bench --bench bigint multiply`.
        ...
        add2(acc, <span class="kw-2">&amp;</span>p.data);
        add2(<span class="kw-2">&amp;mut </span>acc[b..], <span class="kw-2">&amp;</span>p.data);
        ...
        </span><span class="kw">let </span><span class="kw-2">mut </span>comp3: BigInt = (r3 - <span class="kw-2">&amp;</span>r1) / <span class="number">3u32</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>comp1: BigInt = (r1 - <span class="kw-2">&amp;</span>r2) &gt;&gt; <span class="number">1</span>;
        <span class="kw">let </span><span class="kw-2">mut </span>comp2: BigInt = r2 - <span class="kw-2">&amp;</span>r0;
        comp3 = ((<span class="kw-2">&amp;</span>comp2 - comp3) &gt;&gt; <span class="number">1</span>) + (<span class="kw-2">&amp;</span>r4 &lt;&lt; <span class="number">1</span>);
        ...
        </span><span class="kw">for </span>(j, result) <span class="kw">in </span>[<span class="kw-2">&amp;</span>r0, <span class="kw-2">&amp;</span>comp1, <span class="kw-2">&amp;</span>comp2, <span class="kw-2">&amp;</span>comp3, <span class="kw-2">&amp;</span>r4].iter().enumerate().rev() {
            <span class="kw">match </span>result.sign() {
                Plus =&gt; add2(<span class="kw-2">&amp;mut </span>acc[i * j..], result.digits()),
                Minus =&gt; sub2(<span class="kw-2">&amp;mut </span>acc[i * j..], result.digits()),
                NoSign =&gt; {}
            }
        }
    }
...
<span class="kw">fn </span>scalar_mul(a: <span class="kw-2">&amp;mut </span>BigUint, b: BigDigit) {
    <span class="kw">match </span>b {
        <span class="number">0 </span>=&gt; a.set_zero(),
        <span class="number">1 </span>=&gt; {}
        <span class="kw">_ </span>=&gt; {
            <span class="kw">if </span>b.is_power_of_two() {
                <span class="kw-2">*</span>a &lt;&lt;= b.trailing_zeros();
            } <span class="kw">else </span>{
                <span class="kw">let </span><span class="kw-2">mut </span>carry = <span class="number">0</span>;
                <span class="kw">for </span>a <span class="kw">in </span>a.data.iter_mut() {
                ...
                <span class="kw">if </span>carry != <span class="number">0 </span>{
                    a.data.push(carry <span class="kw">as </span>BigDigit);
                }
            }
        }
    }
...
<span class="kw">fn </span>sub_sign(<span class="kw-2">mut </span>a: <span class="kw-2">&amp;</span>[BigDigit], <span class="kw-2">mut </span>b: <span class="kw-2">&amp;</span>[BigDigit]) -&gt; (Sign, BigUint) {
    ...
    </span><span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span><span class="number">0</span>) = a.last() {
        a = <span class="kw-2">&amp;</span>a[..a.iter().rposition(|<span class="kw-2">&amp;</span>x| x != <span class="number">0</span>).map_or(<span class="number">0</span>, |i| i + <span class="number">1</span>)];
    }
    <span class="kw">if let </span><span class="prelude-val">Some</span>(<span class="kw-2">&amp;</span><span class="number">0</span>) = b.last() {
...
<span class="macro">macro_rules!</span> impl_mul {
    ($(<span class="kw">impl </span>Mul&lt;<span class="macro-nonterminal">$Other</span>:ty&gt; <span class="kw">for </span><span class="macro-nonterminal">$Self</span>:ty;)<span class="kw-2">*</span>) =&gt; {$(
        <span class="kw">impl </span>Mul&lt;<span class="macro-nonterminal">$Other</span>&gt; <span class="kw">for </span><span class="macro-nonterminal">$Self </span>{
            <span class="kw">type </span>Output = BigUint;

            <span class="attr">#[inline]
            </span><span class="kw">fn </span>mul(<span class="self">self</span>, other: <span class="macro-nonterminal">$Other</span>) -&gt; BigUint {
                <span class="kw">match </span>(<span class="kw-2">&amp;*</span><span class="self">self</span>.data, <span class="kw-2">&amp;*</span>other.data) {
                    <span class="comment">// multiply by zero
                    </span>(<span class="kw-2">&amp;</span>[], <span class="kw">_</span>) | (<span class="kw">_</span>, <span class="kw-2">&amp;</span>[]) =&gt; BigUint::zero(),
                    <span class="comment">// multiply by a scalar
                    </span>(<span class="kw">_</span>, <span class="kw-2">&amp;</span>[digit]) =&gt; <span class="self">self </span>* digit,
                    (<span class="kw-2">&amp;</span>[digit], <span class="kw">_</span>) =&gt; other * digit,
                    <span class="comment">// full multiplication
                    </span>(x, y) =&gt; mul3(x, y),
                }
            }
        }
...
<span class="macro">impl_mul!</span> {
    <span class="kw">impl </span>Mul&lt;BigUint&gt; <span class="kw">for </span>BigUint;
    <span class="kw">impl </span>Mul&lt;BigUint&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigUint;
    <span class="kw">impl </span>Mul&lt;<span class="kw-2">&amp;</span>BigUint&gt; <span class="kw">for </span>BigUint;
    <span class="kw">impl </span>Mul&lt;<span class="kw-2">&amp;</span>BigUint&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigUint;
}

<span class="macro">macro_rules!</span> impl_mul_assign {
    ($(<span class="kw">impl </span>MulAssign&lt;<span class="macro-nonterminal">$Other</span>:ty&gt; <span class="kw">for </span>BigUint;)<span class="kw-2">*</span>) =&gt; {$(
        <span class="kw">impl </span>MulAssign&lt;<span class="macro-nonterminal">$Other</span>&gt; <span class="kw">for </span>BigUint {
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>mul_assign(<span class="kw-2">&amp;mut </span><span class="self">self</span>, other: <span class="macro-nonterminal">$Other</span>) {
                <span class="kw">match </span>(<span class="kw-2">&amp;*</span><span class="self">self</span>.data, <span class="kw-2">&amp;*</span>other.data) {
                    <span class="comment">// multiply by zero
                    </span>(<span class="kw-2">&amp;</span>[], <span class="kw">_</span>) =&gt; {},
                    (<span class="kw">_</span>, <span class="kw-2">&amp;</span>[]) =&gt; <span class="self">self</span>.set_zero(),
                    <span class="comment">// multiply by a scalar
                    </span>(<span class="kw">_</span>, <span class="kw-2">&amp;</span>[digit]) =&gt; <span class="kw-2">*</span><span class="self">self </span><span class="kw-2">*</span>= digit,
                    (<span class="kw-2">&amp;</span>[digit], <span class="kw">_</span>) =&gt; <span class="kw-2">*</span><span class="self">self </span>= other * digit,
                    <span class="comment">// full multiplication
                    </span>(x, y) =&gt; <span class="kw-2">*</span><span class="self">self </span>= mul3(x, y),
                }
            }
        }
    )<span class="kw-2">*</span>}
}
<span class="macro">impl_mul_assign!</span> {
    <span class="kw">impl </span>MulAssign&lt;BigUint&gt; <span class="kw">for </span>BigUint;
    <span class="kw">impl </span>MulAssign&lt;<span class="kw-2">&amp;</span>BigUint&gt; <span class="kw">for </span>BigUint;
}
...
<span class="kw">impl </span>MulAssign&lt;u32&gt; <span class="kw">for </span>BigUint {
    <span class="attr">#[inline]
        ...
        scalar_mul(<span class="self">self</span>, other <span class="kw">as </span>BigDigit);
    }
}
...
<span class="kw">impl </span>MulAssign&lt;u64&gt; <span class="kw">for </span>BigUint {
    ...
    #[inline]
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(other) = BigDigit::from_u64(other) {
            scalar_mul(<span class="self">self</span>, other);
        } <span class="kw">else </span>{
...
<span class="kw">impl </span>MulAssign&lt;u128&gt; <span class="kw">for </span>BigUint {
    ...
    #[inline]
        ...
        <span class="kw">if let </span><span class="prelude-val">Some</span>(other) = BigDigit::from_u128(other) {
            scalar_mul(<span class="self">self</span>, other);
        } <span class="kw">else </span>{
            <span class="kw-2">*</span><span class="self">self </span>= <span class="kw">match </span>u32_from_u128(other) {
                (<span class="number">0</span>, <span class="number">0</span>, c, d) =&gt; mul3(<span class="kw-2">&amp;</span><span class="self">self</span>.data, <span class="kw-2">&amp;</span>[d, c]),
                (<span class="number">0</span>, b, c, d) =&gt; mul3(<span class="kw-2">&amp;</span><span class="self">self</span>.data, <span class="kw-2">&amp;</span>[d, c, b]),
                (a, b, c, d) =&gt; mul3(<span class="kw-2">&amp;</span><span class="self">self</span>.data, <span class="kw-2">&amp;</span>[d, c, b, a]),
            };
        }
    }
