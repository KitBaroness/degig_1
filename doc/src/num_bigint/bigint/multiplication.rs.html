...
<span class="kw">use </span><span class="kw">super</span>::Sign::{<span class="self">self</span>, Minus, NoSign, Plus};
...
<span class="macro">macro_rules!</span> impl_mul {
    ($(<span class="kw">impl </span>Mul&lt;<span class="macro-nonterminal">$Other</span>:ty&gt; <span class="kw">for </span><span class="macro-nonterminal">$Self</span>:ty;)<span class="kw-2">*</span>) =&gt; {$(
        <span class="kw">impl </span>Mul&lt;<span class="macro-nonterminal">$Other</span>&gt; <span class="kw">for </span><span class="macro-nonterminal">$Self </span>{
            ...
            <span class="attr">#[inline]
            </span><span class="kw">fn </span>mul(<span class="self">self</span>, other: <span class="macro-nonterminal">$Other</span>) -&gt; BigInt {
                <span class="comment">// automatically match value/ref
                </span><span class="kw">let </span>BigInt { data: x, .. } = <span class="self">self</span>;
                <span class="kw">let </span>BigInt { data: y, .. } = other;
                BigInt::from_biguint(<span class="self">self</span>.sign * other.sign, x * y)
            }
        }
    )<span class="kw-2">*</span>}
}
<span class="macro">impl_mul!</span> {
    <span class="kw">impl </span>Mul&lt;BigInt&gt; <span class="kw">for </span>BigInt;
    <span class="kw">impl </span>Mul&lt;BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt;
    <span class="kw">impl </span>Mul&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt;
    <span class="kw">impl </span>Mul&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt;
}

<span class="macro">macro_rules!</span> impl_mul_assign {
    ($(<span class="kw">impl </span>MulAssign&lt;<span class="macro-nonterminal">$Other</span>:ty&gt; <span class="kw">for </span>BigInt;)<span class="kw-2">*</span>) =&gt; {$(
        <span class="kw">impl </span>MulAssign&lt;<span class="macro-nonterminal">$Other</span>&gt; <span class="kw">for </span>BigInt {
            <span class="attr">#[inline]
                ...
                <span class="comment">// automatically match value/ref
                </span><span class="kw">let </span>BigInt { data: y, .. } = other;
                <span class="self">self</span>.data <span class="kw-2">*</span>= y;
                <span class="kw">if </span><span class="self">self</span>.data.is_zero() {
                    <span class="self">self</span>.sign = NoSign;
                } <span class="kw">else </span>{
                    <span class="self">self</span>.sign = <span class="self">self</span>.sign * other.sign;
                }
            }
        }
    )<span class="kw-2">*</span>}
...
<span class="macro">impl_mul_assign!</span> {
    <span class="kw">impl </span>MulAssign&lt;BigInt&gt; <span class="kw">for </span>BigInt;
    <span class="kw">impl </span>MulAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt;
}
...
<span class="macro">forward_all_scalar_binop_to_val_val_commutative!</span>(<span class="kw">impl </span>Mul&lt;u128&gt; <span class="kw">for </span>BigInt, mul);
...
<span class="kw">impl </span>Mul&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>MulAssign&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val_commutative!</span>(<span class="kw">impl </span>Mul&lt;i128&gt; <span class="kw">for </span>BigInt, mul);
...
<span class="kw">impl </span>MulAssign&lt;i32&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span>other.checked_uabs() {
            Positive(u) =&gt; <span class="kw-2">*</span><span class="self">self </span><span class="kw-2">*</span>= u,
            Negative(u) =&gt; {
                <span class="self">self</span>.sign = -<span class="self">self</span>.sign;
                <span class="self">self</span>.data <span class="kw-2">*</span>= u;
            }
        }
    }
}
...
<span class="kw">impl </span>Mul&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>MulAssign&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
