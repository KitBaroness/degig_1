...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::Sign::{<span class="self">self</span>, Minus, NoSign, Plus};
<span class="kw">use super</span>::{BigInt, ToBigInt};
...
<span class="kw">use crate</span>::{BigUint, ParseBigIntError, ToBigUint};
...
<span class="kw">use </span>num_traits::{FromPrimitive, Num, One, ToPrimitive, Zero};
...
<span class="kw">impl </span>ToPrimitive <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            ...
            Minus =&gt; {
                <span class="kw">let </span>n = <span class="self">self</span>.data.to_u64()<span class="question-mark">?</span>;
                ...
                <span class="kw">match </span>n.cmp(<span class="kw-2">&amp;</span>m) {
                    Less =&gt; <span class="prelude-val">Some</span>(-(n <span class="kw">as </span>i64)),
                    Equal =&gt; <span class="prelude-val">Some</span>(core::i64::MIN),
                    Greater =&gt; <span class="prelude-val">None</span>,
                }
            }
        }
    }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            ...
            NoSign =&gt; <span class="prelude-val">Some</span>(<span class="number">0</span>),
            Minus =&gt; {
                <span class="kw">let </span>n = <span class="self">self</span>.data.to_u128()<span class="question-mark">?</span>;
                <span class="kw">let </span>m: u128 = <span class="number">1 </span>&lt;&lt; <span class="number">127</span>;
                <span class="kw">match </span>n.cmp(<span class="kw-2">&amp;</span>m) {
                    Less =&gt; <span class="prelude-val">Some</span>(-(n <span class="kw">as </span>i128)),
                    Equal =&gt; <span class="prelude-val">Some</span>(core::i128::MIN),
                    Greater =&gt; <span class="prelude-val">None</span>,
                }
            }
        }
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">let </span>n = <span class="self">self</span>.data.to_f32()<span class="question-mark">?</span>;
        <span class="prelude-val">Some</span>(<span class="kw">if </span><span class="self">self</span>.sign == Minus { -n } <span class="kw">else </span>{ n })
    }

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>to_f64(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;f64&gt; {
        <span class="kw">let </span>n = <span class="self">self</span>.data.to_f64()<span class="question-mark">?</span>;
        <span class="prelude-val">Some</span>(<span class="kw">if </span><span class="self">self</span>.sign == Minus { -n } <span class="kw">else </span>{ n })
    }
}

<span class="macro">macro_rules!</span> impl_try_from_bigint {
    (<span class="macro-nonterminal">$T</span>:ty, <span class="macro-nonterminal">$to_ty</span>:path) =&gt; {
        <span class="attr">#[cfg(has_try_from)]
        </span><span class="kw">impl </span>TryFrom&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="macro-nonterminal">$T </span>{
            <span class="kw">type </span>Error = TryFromBigIntError&lt;()&gt;;

            <span class="attr">#[inline]
            </span><span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span>BigInt) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="macro-nonterminal">$T</span>, TryFromBigIntError&lt;()&gt;&gt; {
                <span class="macro-nonterminal">$to_ty</span>(value).ok_or(TryFromBigIntError::new(()))
            }
        }

        <span class="attr">#[cfg(has_try_from)]
        </span><span class="kw">impl </span>TryFrom&lt;BigInt&gt; <span class="kw">for </span><span class="macro-nonterminal">$T </span>{
            <span class="kw">type </span>Error = TryFromBigIntError&lt;BigInt&gt;;

            <span class="attr">#[inline]
            </span><span class="kw">fn </span>try_from(value: BigInt) -&gt; <span class="prelude-ty">Result</span>&lt;<span class="macro-nonterminal">$T</span>, TryFromBigIntError&lt;BigInt&gt;&gt; {
...
<span class="macro">impl_try_from_bigint!</span>(u8, ToPrimitive::to_u8);
<span class="macro">impl_try_from_bigint!</span>(u16, ToPrimitive::to_u16);
<span class="macro">impl_try_from_bigint!</span>(u32, ToPrimitive::to_u32);
<span class="macro">impl_try_from_bigint!</span>(u64, ToPrimitive::to_u64);
<span class="macro">impl_try_from_bigint!</span>(usize, ToPrimitive::to_usize);
<span class="macro">impl_try_from_bigint!</span>(u128, ToPrimitive::to_u128);

<span class="macro">impl_try_from_bigint!</span>(i8, ToPrimitive::to_i8);
<span class="macro">impl_try_from_bigint!</span>(i16, ToPrimitive::to_i16);
<span class="macro">impl_try_from_bigint!</span>(i32, ToPrimitive::to_i32);
<span class="macro">impl_try_from_bigint!</span>(i64, ToPrimitive::to_i64);
<span class="macro">impl_try_from_bigint!</span>(isize, ToPrimitive::to_isize);
<span class="macro">impl_try_from_bigint!</span>(i128, ToPrimitive::to_i128);
...
<span class="kw">impl </span>FromPrimitive <span class="kw">for </span>BigInt {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span>n &gt;= <span class="number">0.0 </span>{
            ...
            <span class="kw">let </span>x = BigUint::from_f64(-n)<span class="question-mark">?</span>;
            <span class="prelude-val">Some</span>(-BigInt::from(x))
        }
    }
}
...
<span class="kw">impl </span>From&lt;i64&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">if </span>n &gt;= <span class="number">0 </span>{
            ...
            <span class="kw">let </span>u = core::u64::MAX - (n <span class="kw">as </span>u64) + <span class="number">1</span>;
            BigInt {
                sign: Minus,
                data: BigUint::from(u),
            }
...
<span class="kw">impl </span>From&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>from(n: i128) -&gt; <span class="self">Self </span>{
        <span class="kw">if </span>n &gt;= <span class="number">0 </span>{
            BigInt::from(n <span class="kw">as </span>u128)
        } <span class="kw">else </span>{
            <span class="kw">let </span>u = core::u128::MAX - (n <span class="kw">as </span>u128) + <span class="number">1</span>;
            BigInt {
                sign: Minus,
                data: BigUint::from(u),
            }
...
<span class="kw">impl </span>From&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>ToBigUint <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="attr">#[cfg(has_try_from)]
</span><span class="kw">impl </span>TryFrom&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigUint {
    <span class="kw">type </span>Error = TryFromBigIntError&lt;()&gt;;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>try_from(value: <span class="kw-2">&amp;</span>BigInt) -&gt; <span class="prelude-ty">Result</span>&lt;BigUint, TryFromBigIntError&lt;()&gt;&gt; {
        value
            .to_biguint()
...
<span class="attr">#[cfg(has_try_from)]
</span><span class="kw">impl </span>TryFrom&lt;BigInt&gt; <span class="kw">for </span>BigUint {
    <span class="kw">type </span>Error = TryFromBigIntError&lt;BigInt&gt;;

    <span class="attr">#[inline]
    </span><span class="kw">fn </span>try_from(value: BigInt) -&gt; <span class="prelude-ty">Result</span>&lt;BigUint, TryFromBigIntError&lt;BigInt&gt;&gt; {
        <span class="kw">if </span>value.sign() == Sign::Minus {
            <span class="prelude-val">Err</span>(TryFromBigIntError::new(value))
        } <span class="kw">else </span>{
            <span class="prelude-val">Ok</span>(value.data)
        }
    }
}
...
<span class="macro">impl_to_bigint!</span>(i128, FromPrimitive::from_i128);
...
<span class="macro">impl_to_bigint!</span>(u128, FromPrimitive::from_u128);
...
<span class="kw">impl </span>From&lt;bool&gt; <span class="kw">for </span>BigInt {
...
<span class="attr">#[inline]
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>from_signed_bytes_be(digits: <span class="kw-2">&amp;</span>[u8]) -&gt; BigInt {
...
<span class="attr">#[inline]
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>from_signed_bytes_le(digits: <span class="kw-2">&amp;</span>[u8]) -&gt; BigInt {
...
<span class="attr">#[inline]
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>to_signed_bytes_be(x: <span class="kw-2">&amp;</span>BigInt) -&gt; Vec&lt;u8&gt; {
    <span class="kw">let </span><span class="kw-2">mut </span>bytes = x.data.to_bytes_be();
    ...
    <span class="kw">if </span>first_byte &gt; <span class="number">0x7f
        </span>&amp;&amp; !(first_byte == <span class="number">0x80 </span>&amp;&amp; bytes.iter().skip(<span class="number">1</span>).all(Zero::is_zero) &amp;&amp; x.sign == Sign::Minus)
    {
    ...
    <span class="kw">if </span>x.sign == Sign::Minus {
...
<span class="attr">#[inline]
</span><span class="kw">pub</span>(<span class="kw">super</span>) <span class="kw">fn </span>to_signed_bytes_le(x: <span class="kw-2">&amp;</span>BigInt) -&gt; Vec&lt;u8&gt; {
    <span class="kw">let </span><span class="kw-2">mut </span>bytes = x.data.to_bytes_le();
    ...
    </span>I: IntoIterator&lt;Item = <span class="kw-2">&amp;</span><span class="lifetime">'a </span><span class="kw-2">mut </span>u8&gt;,
{
    ...
    <span class="kw">for </span>d <span class="kw">in </span>digits {
        <span class="kw-2">*</span>d = !<span class="kw-2">*</span>d;
