...
</span><span class="kw">impl </span>BitAnd&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
...
<span class="kw">impl </span>BitAnd&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>BitAndAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
...
// clone as needed, avoiding over-allocation
</span><span class="kw">impl </span>BitOr&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>BitOr&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>BitOrAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
...
<span class="kw">impl </span>BitXor&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>BitXorAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    ...
    <span class="kw">if </span>bit &gt;= bits_per_digit * data.len() <span class="kw">as </span>u64 {
        ...
        <span class="kw">if </span>bit &gt; trailing_zeros {
            ...
            <span class="kw">if </span>index_lo == index_hi {
                ...
                <span class="kw">for </span>digit <span class="kw">in </span><span class="kw-2">&amp;mut </span>digits[index_lo + <span class="number">1</span>..index_hi] {
                    <span class="kw-2">*</span>digit = big_digit::MAX;
                }
