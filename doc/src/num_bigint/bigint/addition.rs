...
<span class="kw">impl </span>Add&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
...
<span class="kw">impl </span>Add&lt;BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>Add&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>AddAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val_commutative!</span>(<span class="kw">impl </span>Add&lt;u128&gt; <span class="kw">for </span>BigInt, add);
...
<span class="kw">impl </span>Add&lt;u32&gt; <span class="kw">for </span>BigInt {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            ...
            Plus =&gt; BigInt::from(<span class="self">self</span>.data + other),
...
<span class="kw">impl </span>Add&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>AddAssign&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val_commutative!</span>(<span class="kw">impl </span>Add&lt;i128&gt; <span class="kw">for </span>BigInt, add);
...
<span class="kw">impl </span>Add&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>AddAssign&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
