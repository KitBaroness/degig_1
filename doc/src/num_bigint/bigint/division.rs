...
</pre></div><pre class="rust"><code><span class="kw">use </span><span class="kw">super</span>::CheckedUnsignedAbs::{Negative, Positive};
<span class="kw">use </span><span class="kw">super</span>::Sign::NoSign;
<span class="kw">use super</span>::{BigInt, UnsignedAbs};

<span class="kw">use crate</span>::{IsizePromotion, UsizePromotion};

<span class="kw">use </span>core::ops::{Div, DivAssign, Rem, RemAssign};
<span class="kw">use </span>num_integer::Integer;
<span class="kw">use </span>num_traits::{CheckedDiv, CheckedEuclid, Euclid, Signed, ToPrimitive, Zero};

<span class="macro">forward_all_binop_to_ref_ref!</span>(<span class="kw">impl </span>Div <span class="kw">for </span>BigInt, div);

<span class="kw">impl </span>Div&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
...
<span class="kw">impl </span>DivAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Div&lt;u128&gt; <span class="kw">for </span>BigInt, div);
...
<span class="kw">impl </span>Div&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>DivAssign&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Div&lt;BigInt&gt; <span class="kw">for </span>u128 {
    <span class="kw">type </span>Output = BigInt;
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Div&lt;i128&gt; <span class="kw">for </span>BigInt, div);
...
<span class="kw">impl </span>Div&lt;i32&gt; <span class="kw">for </span>BigInt {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span>other.checked_uabs() {
            Positive(u) =&gt; <span class="self">self </span>/ u,
            Negative(u) =&gt; -<span class="self">self </span>/ u,
        }
    }
}
...
<span class="kw">impl </span>DivAssign&lt;i32&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span>other.checked_uabs() {
            Positive(u) =&gt; <span class="kw-2">*</span><span class="self">self </span>/= u,
            Negative(u) =&gt; {
                <span class="self">self</span>.sign = -<span class="self">self</span>.sign;
                <span class="kw-2">*</span><span class="self">self </span>/= u;
            }
        }
    }
}
...
<span class="kw">impl </span>Div&lt;BigInt&gt; <span class="kw">for </span>i32 {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.checked_uabs() {
            Positive(u) =&gt; u / other,
            Negative(u) =&gt; u / -other,
        }
    }
...
<span class="kw">impl </span>Div&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>DivAssign&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Div&lt;BigInt&gt; <span class="kw">for </span>i128 {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>Rem&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;
    ...
    <span class="attr">#[inline]
        ...
        } <span class="kw">else if let </span><span class="prelude-val">Some</span>(other) = other.to_i32() {
            <span class="self">self </span>% other
...
<span class="kw">impl </span>RemAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Rem&lt;u128&gt; <span class="kw">for </span>BigInt, rem);
...
<span class="kw">impl </span>Rem&lt;BigInt&gt; <span class="kw">for </span>u32 {
    ...
    <span class="attr">#[inline]
        ...
        BigInt::from(<span class="self">self </span>% other.data)
    }
}
...
<span class="kw">impl </span>Rem&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>RemAssign&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Rem&lt;BigInt&gt; <span class="kw">for </span>u128 {
    <span class="kw">type </span>Output = BigInt;
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Rem&lt;i128&gt; <span class="kw">for </span>BigInt, rem);
...
<span class="kw">impl </span>Rem&lt;i32&gt; <span class="kw">for </span>BigInt {
    ...
    <span class="attr">#[inline]
        ...
        <span class="self">self </span>% other.uabs()
    }
}
...
<span class="kw">impl </span>RemAssign&lt;i32&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw-2">*</span><span class="self">self </span>%= other.uabs();
    }
}
...
<span class="kw">impl </span>Rem&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>RemAssign&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Rem&lt;BigInt&gt; <span class="kw">for </span>i128 {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>CheckedEuclid <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>checked_div_euclid(<span class="kw-2">&amp;</span><span class="self">self</span>, v: <span class="kw-2">&amp;</span>BigInt) -&gt; <span class="prelude-ty">Option</span>&lt;BigInt&gt; {
        <span class="kw">if </span>v.is_zero() {
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>checked_rem_euclid(<span class="kw-2">&amp;</span><span class="self">self</span>, v: <span class="kw-2">&amp;</span>BigInt) -&gt; <span class="prelude-ty">Option</span>&lt;BigInt&gt; {
        <span class="kw">if </span>v.is_zero() {
            <span class="kw">return </span><span class="prelude-val">None</span>;
        }
...
<span class="kw">impl </span>Euclid <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>div_euclid(<span class="kw-2">&amp;</span><span class="self">self</span>, v: <span class="kw-2">&amp;</span>BigInt) -&gt; BigInt {
        <span class="kw">let </span>(q, r) = <span class="self">self</span>.div_rem(v);
        <span class="kw">if </span>r.is_negative() {
            <span class="kw">if </span>v.is_positive() {
                q - <span class="number">1
    ...
    <span class="attr">#[inline]
    </span><span class="kw">fn </span>rem_euclid(<span class="kw-2">&amp;</span><span class="self">self</span>, v: <span class="kw-2">&amp;</span>BigInt) -&gt; BigInt {
