...
<span class="kw">impl </span>Sub&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
...
<span class="kw">impl </span>Sub&lt;BigInt&gt; <span class="kw">for </span><span class="kw-2">&amp;</span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>Sub&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>SubAssign&lt;<span class="kw-2">&amp;</span>BigInt&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Sub&lt;u128&gt; <span class="kw">for </span>BigInt, sub);
...
<span class="kw">impl </span>Sub&lt;u32&gt; <span class="kw">for </span>BigInt {
    ...
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span><span class="self">self</span>.sign {
            ...
            Minus =&gt; -BigInt::from(<span class="self">self</span>.data + other),
            Plus =&gt; <span class="kw">match </span><span class="self">self</span>.data.cmp(<span class="kw-2">&amp;</span>From::from(other)) {
                Equal =&gt; Zero::zero(),
                Greater =&gt; BigInt::from(<span class="self">self</span>.data - other),
                Less =&gt; -BigInt::from(other - <span class="self">self</span>.data),
            },
        }
    }
}
...
<span class="kw">impl </span>Sub&lt;BigInt&gt; <span class="kw">for </span>u128 {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>Sub&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>SubAssign&lt;u128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="macro">forward_all_scalar_binop_to_val_val!</span>(<span class="kw">impl </span>Sub&lt;i128&gt; <span class="kw">for </span>BigInt, sub);
...
<span class="kw">impl </span>SubAssign&lt;i32&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
        ...
        <span class="kw">match </span>other.checked_uabs() {
            ...
            Negative(u) =&gt; <span class="kw-2">*</span><span class="self">self </span>+= u,
        }
    }
}
...
<span class="kw">impl </span>Sub&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="kw">type </span>Output = BigInt;
...
<span class="kw">impl </span>SubAssign&lt;i128&gt; <span class="kw">for </span>BigInt {
    <span class="attr">#[inline]
...
<span class="kw">impl </span>Sub&lt;BigInt&gt; <span class="kw">for </span>i128 {
    <span class="kw">type </span>Output = BigInt;
