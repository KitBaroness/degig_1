...
</pre></div><pre class="rust"><code><span class="kw">use crate</span>::{AccountField, AccountsStruct, Ty};
<span class="kw">use </span>heck::SnakeCase;
<span class="kw">use </span>quote::quote;
<span class="kw">use </span>std::str::FromStr;

<span class="comment">// Generates the private `__client_accounts` mod implementation, containing
...
// `Pubkey`s as the types. This is generated for Rust *clients*.
        ...
        .map(|f: <span class="kw-2">&amp;</span>AccountField| <span class="kw">match </span>f {
            ...
            AccountField::Field(f) =&gt; {
                ...
                <span class="kw">if </span>f.is_optional {
                    <span class="macro">quote!</span> {
                        #docs
                        <span class="kw">pub </span>#name: <span class="prelude-ty">Option</span>&lt;Pubkey&gt;
                    }
                } <span class="kw">else </span>{
                    <span class="macro">quote!</span> {
                        #docs
                        <span class="kw">pub </span>#name: Pubkey
                    }
                }
            }
        })
                ...
                <span class="kw">if </span>f.is_optional {
                    <span class="macro">quote!</span> {
                        <span class="kw">if let </span><span class="prelude-val">Some</span>(#name) = <span class="kw-2">&amp;</span><span class="self">self</span>.#name {
                            account_metas.push(#meta(<span class="kw-2">*</span>#name, #is_signer));
                        } <span class="kw">else </span>{
                            account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(<span class="kw">crate</span>::ID, <span class="bool-val">false</span>));
                        }
                    }
                } <span class="kw">else </span>{
                    <span class="macro">quote!</span> {
                        account_metas.push(#meta(<span class="self">self</span>.#name, #is_signer));
                    }
                }
            }
        })
    ...
    <span class="kw">let </span>struct_doc = proc_macro2::TokenStream::from_str(<span class="kw-2">&amp;</span><span class="macro">format!</span>(
        <span class="string">"#[doc = \" Generated client accounts for [`{name}`].\"]"
    </span>))
    .unwrap();
    ...
    <span class="macro">quote!</span> {
        ...
        /// `accounts` module (also generated), which re-exports this.
            ...
            <span class="kw">use </span>anchor_lang::prelude::borsh;
            #(#re_exports)*

            #struct_doc
            <span class="attr">#[derive(anchor_lang::AnchorSerialize)]
            </span><span class="kw">pub struct </span>#name {
                #(#account_struct_fields),*
            }

            <span class="attr">#[automatically_derived]
            </span><span class="kw">impl </span>anchor_lang::ToAccountMetas <span class="kw">for </span>#name {
