...
// so.
    ...
    <span class="kw">let </span>non_inlined_handlers: Vec&lt;proc_macro2::TokenStream&gt; = program
        ...
        .map(|ix| {
            ...
            <span class="kw">let </span>ix_name = generate_ix_variant_name(ix.raw_method.sig.ident.to_string());
            ...
            <span class="kw">let </span>variant_arm = generate_ix_variant(ix.raw_method.sig.ident.to_string(), <span class="kw-2">&amp;</span>ix.args);
...
<span class="kw">fn </span>generate_ix_variant_name(name: String) -&gt; proc_macro2::TokenStream {
