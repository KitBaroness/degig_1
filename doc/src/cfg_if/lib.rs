<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator" content="rustdoc"><meta name="description" content="Source of the Rust file `/Users/jeyakumar/.cargo/registry/src/index.crates.io-6f17d22bba15001f/cfg-if-1.0.0/src/lib.rs`."><title>lib.rs - source</title><script>if(window.location.protocol!=="file:")document.head.insertAdjacentHTML("beforeend","SourceSerif4-Regular-46f98efaafac5295.ttf.woff2,FiraSans-Regular-018c141bf0843ffd.woff2,FiraSans-Medium-8f9a781e4970d388.woff2,SourceCodePro-Regular-562dcc5011b6de7d.ttf.woff2,SourceCodePro-Semibold-d899c5a5c4aeb14a.ttf.woff2".split(",").map(f=>`<link rel="preload" as="font" type="font/woff2" crossorigin href="../../static.files/${f}">`).join(""))</script><link rel="stylesheet" href="../../static.files/normalize-76eba96aa4d2e634.css"><link rel="stylesheet" href="../../static.files/rustdoc-081576b923113409.css"><meta name="rustdoc-vars" data-root-path="../../" data-static-root-path="../../static.files/" data-current-crate="cfg_if" data-themes="" data-resource-suffix="" data-rustdoc-version="1.79.0 (129f3b996 2024-06-10)" data-channel="1.79.0" data-search-js="search-bf21c90c8c1d92b1.js" data-settings-js="settings-4313503d2e1961c2.js" ><script src="../../static.files/storage-e32f0c247825364d.js"></script><script defer src="../../static.files/src-script-e66d777a5a92e9b2.js"></script><script defer src="../../src-files.js"></script><script defer src="../../static.files/main-20a3ad099b048cf2.js"></script><noscript><link rel="stylesheet" href="../../static.files/noscript-09095024cf37855e.css"></noscript><link rel="alternate icon" type="image/png" href="../../static.files/favicon-32x32-422f7d1d52889060.png"><link rel="icon" type="image/svg+xml" href="../../static.files/favicon-2c020d218678b618.svg"></head><body class="rustdoc src"><!--[if lte IE 11]><div class="warning">This old browser is unsupported and will most likely display funky things.</div><![endif]--><nav class="sidebar"><div class="src-sidebar-title"><h2>Files</h2></div></nav><div class="sidebar-resizer"></div><main><nav class="sub"><form class="search-form"><span></span><div id="sidebar-button" tabindex="-1"><a href="../../cfg_if/all.html" title="show sidebar"></a></div><input class="search-input" name="search" aria-label="Run search in the documentation" autocomplete="off" spellcheck="false" placeholder="Type ‘S’ or ‘/’ to search, ‘?’ for more options…" type="search"><div id="help-button" tabindex="-1"><a href="../../help.html" title="help">?</a></div><div id="settings-menu" tabindex="-1"><a href="../../settings.html" title="settings">Settings</a></div></form></nav><section id="main-content" class="content"><div class="example-wrap"><div data-nosnippet><pre class="src-line-numbers"><a href="#1" id="1">1</a>
<a href="#2" id="2">2</a>
<a href="#3" id="3">3</a>
<a href="#4" id="4">4</a>
<a href="#5" id="5">5</a>
...
/// information.
    ...
    <span class="comment">// match if/else chains with a final `else`
        ...
        <span class="kw">if </span><span class="attr">#[cfg(<span class="macro-nonterminal">$meta</span>:meta)] </span>{ $(<span class="macro-nonterminal">$tokens</span>:tt)* }
    ...
    <span class="comment">// match if/else chains lacking a final `else`
        ...
        <span class="kw">if </span><span class="attr">#[cfg(<span class="macro-nonterminal">$i_met</span>:meta)] </span>{ $(<span class="macro-nonterminal">$i_tokens</span>:tt)* }
        $(
            <span class="kw">else if </span><span class="attr">#[cfg(<span class="macro-nonterminal">$e_met</span>:meta)] </span>{ $(<span class="macro-nonterminal">$e_tokens</span>:tt)* }
        )*
    ) =&gt; {
        <span class="macro-nonterminal">$</span><span class="macro">crate::cfg_if!</span> {
            @<span class="macro-nonterminal">__items
    ...
    (@__items ($(<span class="macro-nonterminal">$not</span>:meta,)<span class="kw-2">*</span>) ; ( ($(<span class="macro-nonterminal">$m</span>:meta),<span class="kw-2">*</span>) ($(<span class="macro-nonterminal">$tokens</span>:tt)<span class="kw-2">*</span>) ), $(<span class="macro-nonterminal">$rest</span>:tt)<span class="kw-2">*</span>) =&gt; {
        ...
        </span><span class="attr">#[cfg(all($(<span class="macro-nonterminal">$m</span>,)* not(any($(<span class="macro-nonterminal">$not</span>),<span class="kw-2">*</span>))))] </span><span class="macro-nonterminal">$</span><span class="macro">crate::cfg_if!</span> { @<span class="macro-nonterminal">__identity </span>$(<span class="macro-nonterminal">$tokens</span>)* }
...
<span class="attr">#[cfg(test)]
    ...
    <span class="macro">cfg_if!</span> {
        <span class="kw">if </span><span class="attr">#[cfg(foo)] </span>{
            <span class="kw">fn </span>works2() -&gt; bool { <span class="bool-val">false </span>}
        } <span class="kw">else if </span><span class="attr">#[cfg(test)] </span>{
    ...
    #[allow(clippy::assertions_on_constants)]
        ...
        <span class="macro">cfg_if!</span> {<span class="kw">if </span><span class="attr">#[cfg(debug_assertions)] </span>{
    ...
    <span class="kw">impl </span>Trait <span class="kw">for </span>Struct {
        <span class="macro">cfg_if!</span> {
            <span class="kw">if </span><span class="attr">#[cfg(feature = <span class="string">"blah"</span>)] </span>{
                <span class="kw">fn </span>blah(<span class="kw-2">&amp;</span><span class="self">self</span>) {
