...
</pre></div><pre class="rust"><code><span class="doccomment">//! **arrayvec** provides the types [`ArrayVec`] and [`ArrayString`]: 
...
//!
</span><span class="attr">#![doc(html_root_url=<span class="string">"https://docs.rs/arrayvec/0.7/"</span>)]
