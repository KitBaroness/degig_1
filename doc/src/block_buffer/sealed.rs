...
</pre></div><pre class="rust"><code><span class="kw">use super</span>::{ArrayLength, Block};
...
<span class="doccomment">/// Sealed trait for buffer kinds.
    ...
    <span class="doccomment">/// Split input data into slice of blocks and tail.
