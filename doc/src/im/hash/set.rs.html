...
</span><span class="doccomment">//! An unordered set.
//!
...
<span class="kw">use </span>std::collections::{<span class="self">self</span>, BTreeSet};
...
<span class="kw">use </span>std::ops::{Add, Deref, Mul};

<span class="kw">use </span><span class="kw">crate</span>::nodes::hamt::{hash_key, Drain <span class="kw">as </span>NodeDrain, HashValue, Iter <span class="kw">as </span>NodeIter, Node};
<span class="kw">use </span><span class="kw">crate</span>::ordset::OrdSet;
...
</span><span class="macro">macro_rules!</span> hashset {
    () =&gt; { <span class="macro-nonterminal">$crate::hashset::HashSet::new</span>() };

    ( $(<span class="macro-nonterminal">$x</span>:expr),* ) =&gt; {{
        <span class="kw">let </span><span class="kw-2">mut </span>l = <span class="macro-nonterminal">$crate::hashset::HashSet::new</span>();
        $(
...
<span class="macro">def_pool!</span>(HashSetPool&lt;A&gt;, Node&lt;Value&lt;A&gt;&gt;);

<span class="doccomment">/// An unordered set.
///
/// An immutable hash set using [hash array mapped tries] [1].
///
/// Most operations on this set are O(log&lt;sub&gt;x&lt;/sub&gt; n) for a
...
/// [std::hash::Hash]: https://doc.rust-lang.org/std/hash/trait.Hash.html
/// [std::collections::hash_map::RandomState]: https://doc.rust-lang.org/std/collections/hash_map/struct.RandomState.html
</span><span class="kw">pub struct </span>HashSet&lt;A, S = RandomState&gt; {
    hasher: Ref&lt;S&gt;,
    pool: HashSetPool&lt;A&gt;,
...
<span class="comment">// FIXME lacking specialisation, we can't simply implement `HashValue`
// for `A`, we have to use the `Value&lt;A&gt;` indirection.
</span><span class="kw">impl</span>&lt;A&gt; HashValue <span class="kw">for </span>Value&lt;A&gt;
<span class="kw">where
    </span>A: Hash + Eq,
{
...
<span class="kw">impl</span>&lt;A&gt; HashSet&lt;A, RandomState&gt; {
    ...
    #[must_use]
    </span><span class="kw">pub fn </span>with_pool(pool: <span class="kw-2">&amp;</span>HashSetPool&lt;A&gt;) -&gt; <span class="self">Self </span>{
        <span class="self">Self </span>{
            pool: pool.clone(),
            hasher: Default::default(),
            size: <span class="number">0</span>,
            root: PoolRef::default(<span class="kw-2">&amp;</span>pool.<span class="number">0</span>),
        }
    }
}
...
<span class="kw">impl</span>&lt;A, S&gt; HashSet&lt;A, S&gt; {
    ...
    </span><span class="kw">pub fn </span>pool(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; <span class="kw-2">&amp;</span>HashSetPool&lt;A&gt; {
        <span class="kw-2">&amp;</span><span class="self">self</span>.pool
    }

    <span class="doccomment">/// Construct an empty hash set using the provided hasher.
    </span><span class="attr">#[inline]
    #[must_use]
    ...
    {
        <span class="kw">let </span>pool = HashSetPool::default();
    ...
    <span class="doccomment">/// Construct an empty hash set using the provided memory pool and hasher.
    </span><span class="attr">#[cfg(feature = <span class="string">"pool"</span>)]
    #[inline]
    #[must_use]
    </span><span class="kw">pub fn </span>with_pool_hasher&lt;RS&gt;(pool: <span class="kw-2">&amp;</span>HashSetPool&lt;A&gt;, hasher: RS) -&gt; <span class="self">Self
    </span><span class="kw">where
        </span>Ref&lt;S&gt;: From&lt;RS&gt;,
    {
        <span class="kw">let </span>root = PoolRef::default(<span class="kw-2">&amp;</span>pool.<span class="number">0</span>);
    ...
    <span class="doccomment">/// Get a reference to the set's [`BuildHasher`][BuildHasher].
    ///
    ...
    <span class="doccomment">/// Construct an empty hash set using the same hasher as the current hash set.
    </span><span class="attr">#[inline]
    #[must_use]
    </span><span class="kw">pub fn </span>new_from&lt;A1&gt;(<span class="kw-2">&amp;</span><span class="self">self</span>) -&gt; HashSet&lt;A1, S&gt;
    <span class="kw">where
        </span>A1: Hash + Eq + Clone,
    {
        <span class="kw">let </span>pool = HashSetPool::default();
        <span class="kw">let </span>root = PoolRef::default(<span class="kw-2">&amp;</span>pool.<span class="number">0</span>);
        HashSet {
    ...
    <span class="doccomment">/// Get an iterator over the values in a hash set.
    ///
    ...
    S: BuildHasher,
{
    <span class="kw">fn </span>test_eq(<span class="kw-2">&amp;</span><span class="self">self</span>, other: <span class="kw-2">&amp;</span><span class="self">Self</span>) -&gt; bool {
        ...
        <span class="kw">for </span>value <span class="kw">in </span><span class="self">self</span>.iter() {
            <span class="kw">if </span>!other.contains(value) {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
            seen.insert(value);
        }
        <span class="kw">for </span>value <span class="kw">in </span>other.iter() {
            <span class="kw">if </span>!seen.contains(<span class="kw-2">&amp;</span>value) {
                <span class="kw">return </span><span class="bool-val">false</span>;
            }
        }
    ...
    <span class="kw">where
        </span>BA: Hash + Eq + <span class="question-mark">?</span>Sized,
        A: Borrow&lt;BA&gt;,
    {
        <span class="self">self</span>.root.get(hash_key(<span class="kw-2">&amp;*</span><span class="self">self</span>.hasher, a), <span class="number">0</span>, a).is_some()
    }
    ...
    {
        <span class="kw">let </span>o = other.borrow();
        <span class="self">self</span>.iter().all(|a| o.contains(a))
    }
    ...
    S: BuildHasher,
{
    ...
    /// Time: O(log n)
        ...
        <span class="kw">let </span>hash = hash_key(<span class="kw-2">&amp;*</span><span class="self">self</span>.hasher, <span class="kw-2">&amp;</span>a);
        ...
        <span class="kw">match </span>root.insert(<span class="kw-2">&amp;</span><span class="self">self</span>.pool.<span class="number">0</span>, hash, <span class="number">0</span>, Value(a)) {
            <span class="prelude-val">None </span>=&gt; {
                <span class="self">self</span>.size += <span class="number">1</span>;
                <span class="prelude-val">None
            </span>}
            <span class="prelude-val">Some</span>(Value(old_value)) =&gt; <span class="prelude-val">Some</span>(old_value),
        }
    }

    <span class="doccomment">/// Remove a value from a set if it exists.
    ///
    /// Time: O(log n)
    ...
    {
        <span class="kw">let </span>root = PoolRef::make_mut(<span class="kw-2">&amp;</span><span class="self">self</span>.pool.<span class="number">0</span>, <span class="kw-2">&amp;mut </span><span class="self">self</span>.root);
        <span class="kw">let </span>result = root.remove(<span class="kw-2">&amp;</span><span class="self">self</span>.pool.<span class="number">0</span>, hash_key(<span class="kw-2">&amp;*</span><span class="self">self</span>.hasher, a), <span class="number">0</span>, a);
        <span class="kw">if </span>result.is_some() {
            <span class="self">self</span>.size -= <span class="number">1</span>;
        }
        result.map(|v| v.<span class="number">0</span>)
    }
    ...
    <span class="doccomment">/// Filter out values from a set which don't satisfy a predicate.
    ///
        ...
        </span>F: FnMut(<span class="kw-2">&amp;</span>A) -&gt; bool,
    {
        ...
        <span class="kw">let </span>root = PoolRef::make_mut(<span class="kw-2">&amp;</span><span class="self">self</span>.pool.<span class="number">0</span>, <span class="kw-2">&amp;mut </span><span class="self">self</span>.root);
        <span class="kw">for </span>(value, hash) <span class="kw">in </span>NodeIter::new(<span class="kw-2">&amp;</span>old_root, <span class="self">self</span>.size) {
            <span class="kw">if </span>!f(value) &amp;&amp; root.remove(<span class="kw-2">&amp;</span><span class="self">self</span>.pool.<span class="number">0</span>, hash, <span class="number">0</span>, value).is_some() {
                <span class="self">self</span>.size -= <span class="number">1</span>;
            }
        }
    }
...
</span><span class="kw">impl</span>&lt;A, S&gt; Clone <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Clone,
{
...
<span class="kw">impl</span>&lt;A, S&gt; PartialEq <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq,
...
<span class="kw">impl</span>&lt;A, S&gt; Eq <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; PartialOrd <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone + PartialOrd,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; Ord <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone + Ord,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; Hash <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; Default <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
...
<span class="kw">impl</span>&lt;A, S&gt; Add <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher,
{
    <span class="kw">type </span>Output = HashSet&lt;A, S&gt;;
...
<span class="kw">impl</span>&lt;A, S&gt; Mul <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; Add <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; Mul <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher,
{
...
<span class="kw">impl</span>&lt;A, S&gt; Sum <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S, R&gt; Extend&lt;R&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone + From&lt;R&gt;,
    S: BuildHasher,
{
...
</span><span class="kw">impl</span>&lt;A, S&gt; Debug <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Debug,
    S: BuildHasher,
{
    ...
    </span>A: <span class="lifetime">'a</span>,
{
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="self">self</span>.it.next().map(|(v, <span class="kw">_</span>)| <span class="kw-2">&amp;</span>v.<span class="number">0</span>)
    }
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A&gt; ExactSizeIterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'a</span>, A&gt; {}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A&gt; FusedIterator <span class="kw">for </span>Iter&lt;<span class="lifetime">'a</span>, A&gt; {}
    ...
    </span>A: Hash + Eq + Clone,
{
    ...
    <span class="kw">fn </span>next(<span class="kw-2">&amp;mut </span><span class="self">self</span>) -&gt; <span class="prelude-ty">Option</span>&lt;<span class="self">Self</span>::Item&gt; {
        <span class="self">self</span>.it.next().map(|(v, <span class="kw">_</span>)| v.<span class="number">0</span>)
    }
...
<span class="kw">impl</span>&lt;A&gt; ExactSizeIterator <span class="kw">for </span>ConsumingIter&lt;A&gt; <span class="kw">where </span>A: Hash + Eq + Clone {}

<span class="kw">impl</span>&lt;A&gt; FusedIterator <span class="kw">for </span>ConsumingIter&lt;A&gt; <span class="kw">where </span>A: Hash + Eq + Clone {}

<span class="comment">// Iterator conversions

</span><span class="kw">impl</span>&lt;A, RA, S&gt; FromIterator&lt;RA&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone + From&lt;RA&gt;,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from_iter&lt;T&gt;(i: T) -&gt; <span class="self">Self
    </span><span class="kw">where
        </span>T: IntoIterator&lt;Item = RA&gt;,
    {
        <span class="kw">let </span><span class="kw-2">mut </span>set = <span class="self">Self</span>::default();
        <span class="kw">for </span>value <span class="kw">in </span>i {
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; IntoIterator <span class="kw">for </span><span class="kw-2">&amp;</span><span class="lifetime">'a </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq,
    S: BuildHasher,
{
...
<span class="kw">impl</span>&lt;A, S&gt; IntoIterator <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher,
{
    <span class="kw">type </span>Item = A;
    <span class="kw">type </span>IntoIter = ConsumingIter&lt;<span class="self">Self</span>::Item&gt;;
...
</span><span class="kw">impl</span>&lt;<span class="lifetime">'s</span>, <span class="lifetime">'a</span>, A, OA, SA, SB&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'s </span>HashSet&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>A, SA&gt;&gt; <span class="kw">for </span>HashSet&lt;OA, SB&gt;
<span class="kw">where
    </span>A: ToOwned&lt;Owned = OA&gt; + Hash + Eq + <span class="question-mark">?</span>Sized,
    OA: Borrow&lt;A&gt; + Hash + Eq + Clone,
    SA: BuildHasher,
    SB: BuildHasher + Default,
{
    <span class="kw">fn </span>from(set: <span class="kw-2">&amp;</span>HashSet&lt;<span class="kw-2">&amp;</span>A, SA&gt;) -&gt; <span class="self">Self </span>{
        set.iter().map(|a| (<span class="kw-2">*</span>a).to_owned()).collect()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>[A]&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; From&lt;Vec&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>Vec&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;A, S&gt; From&lt;Vector&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from(vector: Vector&lt;A&gt;) -&gt; <span class="self">Self </span>{
        vector.into_iter().collect()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>Vector&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from(vector: <span class="kw-2">&amp;</span>Vector&lt;A&gt;) -&gt; <span class="self">Self </span>{
        vector.iter().cloned().collect()
    }
}

<span class="kw">impl</span>&lt;A, S&gt; From&lt;collections::HashSet&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Eq + Hash + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>collections::HashSet&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Eq + Hash + Clone,
    S: BuildHasher + Default,
{
...
<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>BTreeSet&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Hash + Eq + Clone,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from(btree_set: <span class="kw-2">&amp;</span>BTreeSet&lt;A&gt;) -&gt; <span class="self">Self </span>{
        btree_set.iter().cloned().collect()
    }
}

<span class="kw">impl</span>&lt;A, S&gt; From&lt;OrdSet&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Ord + Hash + Eq + Clone,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from(ordset: OrdSet&lt;A&gt;) -&gt; <span class="self">Self </span>{
        ordset.into_iter().collect()
    }
}

<span class="kw">impl</span>&lt;<span class="lifetime">'a</span>, A, S&gt; From&lt;<span class="kw-2">&amp;</span><span class="lifetime">'a </span>OrdSet&lt;A&gt;&gt; <span class="kw">for </span>HashSet&lt;A, S&gt;
<span class="kw">where
    </span>A: Ord + Hash + Eq + Clone,
    S: BuildHasher + Default,
{
    <span class="kw">fn </span>from(ordset: <span class="kw-2">&amp;</span>OrdSet&lt;A&gt;) -&gt; <span class="self">Self </span>{
...
#[doc(hidden)]
    ...
    </span><span class="kw">pub use </span><span class="kw">crate</span>::proptest::hash_set;
}

<span class="attr">#[cfg(test)]
</span><span class="kw">mod </span>test {
    <span class="kw">use </span><span class="kw">super</span>::proptest::<span class="kw-2">*</span>;
    <span class="kw">use super</span>::<span class="kw-2">*</span>;
    <span class="kw">use </span><span class="kw">crate</span>::test::LolHasher;
    <span class="kw">use </span>::proptest::num::i16;
    <span class="kw">use </span>::proptest::proptest;
    <span class="kw">use </span>std::hash::BuildHasherDefault;

    <span class="attr">#[test]
    </span><span class="kw">fn </span>insert_failing() {
        <span class="kw">let </span><span class="kw-2">mut </span>set: HashSet&lt;i16, BuildHasherDefault&lt;LolHasher&gt;&gt; = Default::default();
        set.insert(<span class="number">14658</span>);
        <span class="macro">assert_eq!</span>(<span class="number">1</span>, set.len());
        set.insert(-<span class="number">19198</span>);
        <span class="macro">assert_eq!</span>(<span class="number">2</span>, set.len());
    }

    <span class="attr">#[test]
    </span><span class="kw">fn </span>match_strings_with_string_slices() {
        <span class="kw">let </span><span class="kw-2">mut </span>set: HashSet&lt;String&gt; = From::from(<span class="kw-2">&amp;</span><span class="macro">hashset!</span>[<span class="string">"foo"</span>, <span class="string">"bar"</span>]);
    ...
    <span class="attr">#[test]
        ...
        <span class="kw">let </span>set1 = <span class="macro">hashset!</span> {<span class="string">"foo"</span>, <span class="string">"bar"</span>};
        <span class="kw">let </span>set2 = <span class="macro">hashset!</span> {
    ...
    <span class="attr">#[test]
    </span><span class="kw">fn </span>issue_60_drain_iterator_memory_corruption() {
        <span class="kw">use </span><span class="kw">crate</span>::test::MetroHashBuilder;
        <span class="kw">for </span>i <span class="kw">in </span><span class="number">0</span>..<span class="number">1000 </span>{
            <span class="kw">let </span><span class="kw-2">mut </span>lhs = <span class="macro">vec!</span>[<span class="number">0</span>, <span class="number">1</span>, <span class="number">2</span>];
            lhs.sort_unstable();

            <span class="kw">let </span>hasher = Ref::from(MetroHashBuilder::new(i));
            <span class="kw">let </span><span class="kw-2">mut </span>iset: HashSet&lt;<span class="kw">_</span>, MetroHashBuilder&gt; = HashSet::with_hasher(hasher.clone());
            <span class="kw">for </span><span class="kw-2">&amp;</span>i <span class="kw">in </span><span class="kw-2">&amp;</span>lhs {
                iset.insert(i);
            }

            <span class="kw">let </span><span class="kw-2">mut </span>rhs: Vec&lt;<span class="kw">_</span>&gt; = iset.clone().into_iter().collect();
            rhs.sort_unstable();

            <span class="kw">if </span>lhs != rhs {
                <span class="macro">println!</span>(<span class="string">"iteration: {}"</span>, i);
                <span class="macro">println!</span>(<span class="string">"seed: {}"</span>, hasher.seed());
                <span class="macro">println!</span>(<span class="string">"lhs: {}: {:?}"</span>, lhs.len(), <span class="kw-2">&amp;</span>lhs);
                <span class="macro">println!</span>(<span class="string">"rhs: {}: {:?}"</span>, rhs.len(), <span class="kw-2">&amp;</span>rhs);
    ...
    <span class="macro">proptest!</span> {
        <span class="attr">#[test]
        </span><span class="kw">fn </span>proptest_a_set(<span class="kw-2">ref </span>s <span class="kw">in </span>hash_set(<span class="string">".*"</span>, <span class="number">10</span>..<span class="number">100</span>)) {
